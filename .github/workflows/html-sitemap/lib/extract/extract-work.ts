...
import { extractGnavArtifacts, getPlaceholdersUrl } from './gnav.ts';
import { fetchRegionsHtml, getRegionsUrl } from './regions.ts';
import { fetchJson } from '../fetch.ts';
import { fetchQueryIndex } from './query-index.ts';
import { normalizeQueryIndexData } from '../transform/query-index-normalize.ts';
