...
import { resolvePlaceholders, type PlaceholderMap } from '../sources/placeholders.ts';
import { cleanTitle, toProductionUrl, type NormalizedLink, type SiteDomainMap } from './normalize.ts';
