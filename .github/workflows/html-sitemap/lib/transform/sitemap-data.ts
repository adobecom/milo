...
import { relevantExtendedGeos } from '../planning/scope.ts';
import { getBaseGeoDataFile, getBaseGeoExtractDir, getBaseGeoRegionsFile, writeJson } from '../files.ts';
import { loadPlaceholderMap } from '../extract/placeholders.ts';
import { loadRegionLabelMap } from '../extract/regions.ts';
import { buildBaseGeoLinks } from './transform-gnav.ts';
import { buildExtendedGeoLinks, buildOtherSitemapLinks } from './transform-links.ts';
import { normalizeQueryIndexData } from './query-index-normalize.ts';
