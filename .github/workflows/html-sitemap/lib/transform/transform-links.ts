...
import {
  ...
  type NormalizedLink,
} from './query-index-normalize.ts';
import { relevantExtendedGeos, type ExtractUnit } from '../planning/scope.ts';
import type { HtmlSitemapConfig } from '../planning/config.ts';
import { getBaseGeoExtractDir, getExtendedGeoDir } from '../files.ts';
import type { RegionLabelMap } from '../extract/regions.ts';
