...
import { normalizeDaRoot, getRemoteHtmlFilePath } from '../remote/paths.js';
import { getDaAuthHeader } from '../remote/da-auth.js';
import { fetchRemoteHtml } from '../remote/da-source.js';
...
/**
 * @typedef {'changed' | 'unchanged' | 'new'} DiffStatus
 */
...
/**
 * @typedef {UnitStageResult} DiffResult
 */
 ...
 * @param {string} [options.subdomainFilter]
 * @param {string} [options.geoFilter]
 * @param {string} options.daRoot
