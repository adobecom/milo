...
import { buildExtendedGeoLinks, buildOtherSitemapLinks } from '../../lib/data/links.ts';
import type { HtmlSitemapConfig } from '../../lib/config/config.ts';
import type { ExtractUnit } from '../../lib/config/scope.ts';
