...
import { extractGnavArtifacts, parseInlineFragmentPaths, parseTopLevelSections } from '../lib/extract/gnav.ts';
import { buildBaseGeoLinks } from '../lib/transform/transform-gnav.ts';
