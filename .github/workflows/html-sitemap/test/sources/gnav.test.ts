...
import { extractGnavArtifacts, parseInlineFragmentPaths, parseTopLevelSections } from '../../lib/sources/gnav.ts';
import { buildBaseGeoLinks } from '../../lib/data/gnav-sections.ts';
