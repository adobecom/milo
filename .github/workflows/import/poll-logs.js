...
const {
  ...
  GITHUB_SERVER_URL,
  GITHUB_ROLLING_IMPORT_REPOSITORY,
  GITHUB_RUN_ID,
  LAST_RUN_ISO,
...
if (!LOCAL_RUN)
  console.log({
    ...
    GITHUB_ROLLING_IMPORT_REPOSITORY: !!GITHUB_ROLLING_IMPORT_REPOSITORY,
...
function getWorkflowRunUrl() {
  if (GITHUB_SERVER_URL && GITHUB_ROLLING_IMPORT_REPOSITORY && GITHUB_RUN_ID) {
    return `${GITHUB_SERVER_URL}/${GITHUB_ROLLING_IMPORT_REPOSITORY}/actions/runs/${GITHUB_RUN_ID}`;
  }
  return null;
}
