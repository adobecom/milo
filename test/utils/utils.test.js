...
describe('Utils', () => {
  ...
  describe('createTag', async () => {
     ...
     * second parameter is an object of attributes,
     * third parameter is the innerHTML of the tag, can be either node or text,
     * fourth parameter is an object of options,
     *  - parent is the parent element to append the tag to.
     */
    createTag('var', { class: 'foo' }, 'bar', { parent: document.body });
    const varTag = document.querySelector('var.foo');
