...
export const unavAnalyticsTestData = [
  {
    sentData: {
      event: { type: 'click', subtype: 'sign-in' },
      source: { name: 'profile' },
      content: { name: null },
    },
    expectedData: {
      xdm: {},
      data: { web: { webInteraction: { name: 'Sign in|gnav|milo|unav' } } },
    },
  },
  {
    sentData: {
      event: { type: 'render', subtype: 'component' },
      source: { name: 'profile' },
      content: { name: null },
    },
    expectedData: {
      xdm: {},
      data: { web: { webInteraction: { name: 'Account|gnav|milo' } } },
    },
  },
  {
    sentData: {
      event: { type: 'click', subtype: 'account' },
      source: { name: 'profile' },
      content: { name: null },
    },
    expectedData: {
      xdm: {},
      data: { web: { webInteraction: { name: 'View Account|gnav|milo' } } },
    },
  },
  {
    sentData: {
      event: { type: 'click', subtype: 'sign-out' },
      source: { name: 'profile' },
      content: { name: null },
    },
    expectedData: {
      xdm: {},
      data: { web: { webInteraction: { name: 'Sign out|gnav|milo|unav' } } },
    },
  },
  {
    sentData: {
      event: { type: 'render', subtype: 'component' },
      source: { name: 'app-switcher' },
      content: { name: null },
    },
    expectedData: {
      xdm: {},
      data: { web: { webInteraction: { name: 'AppLauncher.appIconToggle' } } },
    },
  },
  {
    sentData: {
      event: { type: 'click', subtype: 'app' },
      source: { name: 'app-switcher' },
      content: { name: 'adobe-express' },
    },
    expectedData: {
      xdm: {},
      data: { web: { webInteraction: { name: 'AppLauncher.appClick.Adobe Express' } } },
    },
  },

  {
    sentData: {
      event: { type: 'click', subtype: 'app' },
      source: { name: 'app-switcher' },
      content: { name: 'adobe-firefly' },
    },
    expectedData: {
      xdm: {},
      data: { web: { webInteraction: { name: 'AppLauncher.appClick.Adobe Firefly' } } },
    },
  },

  {
    sentData: {
      event: { type: 'click', subtype: 'app' },
      source: { name: 'app-switcher' },
      content: { name: 'acrobat' },
    },
    expectedData: {
      xdm: {},
      data: { web: { webInteraction: { name: 'AppLauncher.appClick.Acrobat' } } },
    },
  },

  {
    sentData: {
      event: { type: 'click', subtype: 'app' },
      source: { name: 'app-switcher' },
      content: { name: 'photoshop' },
    },
    expectedData: {
      xdm: {},
      data: { web: { webInteraction: { name: 'AppLauncher.appClick.Photoshop' } } },
    },
  },

  {
    sentData: {
      event: { type: 'click', subtype: 'app' },
      source: { name: 'app-switcher' },
      content: { name: 'lightroom' },
    },
    expectedData: {
      xdm: {},
      data: { web: { webInteraction: { name: 'AppLauncher.appClick.Lightroom' } } },
    },
  },

  {
    ...
    expectedData: {
      xdm: {},
      data: { web: { webInteraction: { name: 'AppLauncher.appClick.Stock' } } },
    },
  },

  {
    sentData: {
      event: { type: 'click', subtype: 'app' },
      source: { name: 'app-switcher' },
      content: { name: 'acrobat-sign' },
    },
    expectedData: {
      xdm: {},
      data: { web: { webInteraction: { name: 'AppLauncher.appClick.Acrobat Sign' } } },
    },
  },

  {
    ...
    expectedData: {
      xdm: {},
      data: { web: { webInteraction: { name: 'AppLauncher.appClick.Fonts' } } },
    },
  },

  {
    sentData: {
      event: { type: 'click', subtype: 'app' },
      source: { name: 'app-switcher' },
      content: { name: 'experience-cloud' },
    },
    expectedData: {
      xdm: {},
      data: { web: { webInteraction: { name: 'AppLauncher.appClick.Experience Cloud' } } },
    },
  },
  {
    sentData: {
      event: { type: 'click', subtype: 'footer' },
      source: { name: 'app-switcher' },
      content: { name: 'adobe-home' },
    },
    expectedData: {
      xdm: {},
      data: { web: { webInteraction: { name: 'AppLauncher.adobe.com' } } },
    },
  },
  {
    sentData: {
      event: { type: 'click', subtype: 'footer' },
      source: { name: 'app-switcher' },
      content: { name: 'all-apps' },
    },
    expectedData: {
      xdm: {},
      data: { web: { webInteraction: { name: 'AppLauncher.allapps' } } },
    },
  },
  {
    sentData: {
...
export const unavDeviceTestingMap = [
  {
    agent: 'Mac',
