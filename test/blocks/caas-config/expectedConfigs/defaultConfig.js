const defaultConfig = {
  collection: {
    ...
    resultsPerPage: 5,
    endpoint:
      'https://www.adobe.com/chimera-api/collection?originSelection=hawks&contentTypeTags=&collectionTags=&excludeContentWithTags=&language=en&country=us&complexQuery=&excludeIds=&currentEntityId=&featuredCards=&hideCtaIds&environment=&draft=false&size=10',
    fallbackEndpoint: '',
    totalCardsToShow: 10,
