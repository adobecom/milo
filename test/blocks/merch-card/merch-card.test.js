...
describe('Catalog Card', () => {
  it('Decorates with mnemonic link', async () => {
    ...
    expect(icon1.outerHTML).to.equal('<merch-icon slot="icons" src="http://localhost:2000/test/blocks/merch-card/mocks/photoshop.svg" alt="Photoshop" size="l" href="https://www.adobe.com/photoshop.html?source=icon2"></merch-icon>');
    expect(icon2.outerHTML).to.equal('<merch-icon slot="icons" src="http://localhost:2000/test/blocks/merch-card/mocks/photoshop.svg" alt="Photoshop" size="l" href="https://www.adobe.com/photoshop.html?source=icon1"></merch-icon>');
