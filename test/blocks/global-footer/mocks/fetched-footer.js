const fetchFooter = ({ regionPickerHash = '/fragments/regions#langnav' }) => `<div>
  ...
  <div>
    <div>
      <picture>
        ...
        srcset="http://localhost:2000/test/blocks/global-footer/mocks/media-icon.png?width=2000&#x26;format=webply&#x26;optimize=medium" media="(min-width: 600px)">
        <source type="image/webp" srcset="http://localhost:2000/test/blocks/global-footer/mocks/media-icon.png?width=750&#x26;format=webply&#x26;optimize=medium">
        <source type="image/png" srcset="http://localhost:2000/test/blocks/global-footer/mocks/media-icon.png?width=2000&#x26;format=png&#x26;optimize=medium" media="(min-width: 600px)">
        <img loading="lazy" alt="" src="http://localhost:2000/test/blocks/global-footer/mocks/media-icon.png?width=750&#x26;format=png&#x26;optimize=medium" width="100" height="98">
      </picture>
    </div>
    <div><a href="https://get.adobe.com/reader/">Adobe Acrobat Reader</a></div>
  </div>
</div>
<div class="link-group">
  <div>
    <div>
      <picture>
        <source type="image/webp" srcset="http://localhost:2000/test/blocks/global-footer/mocks/media-icon.png?width=2000&#x26;format=webply&#x26;optimize=medium" media="(min-width: 600px)">
        <source type="image/webp" srcset="http://localhost:2000/test/blocks/global-footer/mocks/media-icon.png?width=750&#x26;format=webply&#x26;optimize=medium">
        <source type="image/png" srcset="http://localhost:2000/test/blocks/global-footer/mocks/media-icon.png?width=2000&#x26;format=png&#x26;optimize=medium" media="(min-width: 600px)">
        <img loading="lazy" alt="" src="http://localhost:2000/test/blocks/global-footer/mocks/media-icon.png?width=750&#x26;format=png&#x26;optimize=medium" width="100" height="98">
      </picture>
    </div>
    <div><a href="https://www.adobe.com/express/?promoid=Z2G1FSYV&#x26;mv=other">Adobe Express</a></div>
  </div>
</div>
<div class="link-group">
  <div>
    <div>
      <picture>
        ...
        <source type="image/webp" srcset="http://localhost:2000/test/blocks/global-footer/mocks/media-icon.png?width=750&#x26;format=webply&#x26;optimize=medium">
        <source type="image/png" srcset="http://localhost:2000/test/blocks/global-footer/mocks/media-icon.png?width=2000&#x26;format=png&#x26;optimize=medium" media="(min-width: 600px)">
        <img loading="lazy" alt="" src="http://localhost:2000/test/blocks/global-footer/mocks/media-icon.png?width=750&#x26;format=png&#x26;optimize=medium" width="100" height="97">
      </picture>
    </div>
    <div><a href="https://www.adobe.com/products/photoshop/free-trial-download.html">Photoshop</a></div>
  </div>
</div>
<div class="link-group">
  <div>
    ...
    <div><a href="https://www.adobe.com/products/illustrator/free-trial-download.html">Illustrator</a></div>
  </div>
</div>
</div>
<div>
