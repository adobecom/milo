...
describe('MMM', () => {
  ...
  it('Test filters', async () => {
    ...
    expect(copyButton.href).to.not.include('geo');
    expect(copyButton.href).to.not.include('page');
    expect(copyButton.href).to.not.include('tab');
    expect(copyButton.href).to.not.include('query');
    ...
    expect(copyButton.href).to.include('geo');
    expect(copyButton.href).to.not.include('page');
    expect(copyButton.href).to.not.include('tab');
    expect(copyButton.href).to.not.include('query');
    ...
    expect(copyButton.href).to.include('geo');
    expect(copyButton.href).to.include('page');
    expect(copyButton.href).to.not.include('tab');
    expect(copyButton.href).to.not.include('query');
    ...
    expect(copyButton.href).to.not.include('geo');
    expect(copyButton.href).to.include('page');
    expect(copyButton.href).to.include('tab');
    expect(copyButton.href).to.not.include('query');
    ...
    expect(copyButton.href).to.include('page');
    expect(copyButton.href).to.include('tab');
    expect(copyButton.href).to.include('query');
  });
});
