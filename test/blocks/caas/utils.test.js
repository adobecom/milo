...
describe('getConfig', () => {
  ...
  it('should return a caas config object', async () => {
    ...
    expect(config).to.be.eql({
      ...
      featuredCards: ['20c426f6-29e3-5b1d-970e-ca4587e030b3', 'e9d71f5e-e7c9-5d6d-89e9-2ffdad17b8bd'],
  ...
  it('should return localized filters', async () => {
    ...
    expect(config).to.be.eql({
      collection: {
        ...
        resultsPerPage: 5,
        endpoint:
          'https://www.adobe.com/chimera-api/collection/myTargetActivity.json?originSelection=hawks&contentTypeTags=&collectionTags=&excludeContentWithTags=&language=fr&country=be&complexQuery=((%22caas%3Aproducts%2Findesign%22%2BAND%2B%22caas%3Aproducts%2Freader%22)%2BAND%2B(%22caas%3Acountry%2Fbr%22%2BOR%2B%22caas%3Acountry%2Fca%22))%2BAND%2B((%22caas%3Acontent-type%2Fvideo%22%2BAND%2B%22caas%3Acontent-type%2Fblog%22))&excludeIds=&currentEntityId=&featuredCards=16f4b98e-b301-513a-89e4-70596def4763%2Ce9d71f5e-e7c9-5d6d-89e9-2ffdad17b8bd&environment=&draft=true&size=10&flatFile=false',
        fallbackEndpoint: '',
        totalCardsToShow: 10,
        cardStyle: 'half-height',
        ctaAction: '_self',
      ...
      featuredCards: ['16f4b98e-b301-513a-89e4-70596def4763', 'e9d71f5e-e7c9-5d6d-89e9-2ffdad17b8bd'],
      headers: [['X-Adobe-Floodgate', 'pink']],
      hideCtaIds: [''],
      hideCtaTags: [],
      filterPanel: {
