...
- **Target path:** `/Users/victor/dev/milo-forge-fresh/.forge-worktrees/session-4f3f79aa-mshb9ysy/libs/c2/blocks/forge-there-s-always-something-new-with-acrobat` (NEVER libs/blocks/)
- **Milo branch:** `forge/session-4f3f79aa-733` (cut off forge-a-panel)
- **Base branch:** `forge-a-panel`
- **Preview URL (LOCALHOST mode):** `http://localhost:3000/drafts/vhargrave/forge/2562-4f3f79?milolibs=local` — run Phase 5 in
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/victor/dev/milo-forge-fresh/.forge-worktrees/session-4f3f79aa-mshb9ysy/libs/c2/blocks/forge-there-s-always-something-new-with-acrobat/forge-there-s-always-something-new-with-acrobat.js` (`export default
...
5. Phase 8: Forge owns the push — leave the branch `forge/session-4f3f79aa-733` for
