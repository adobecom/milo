...
- **Target path:** `/data/_repos/milo/.forge-worktrees/session-1eb6381f-mrz68idb/libs/c2/blocks/forge-section-2` (NEVER libs/blocks/)
...
- `starter.css` — the section's CSS, scoped under `.sf-sec-2` /
  `.forge-section-2`. Use as the starting point for `forge-section-2.css`; prune rules that don't apply.
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/data/_repos/milo/.forge-worktrees/session-1eb6381f-mrz68idb/libs/c2/blocks/forge-section-2/forge-section-2.js` (`export default
