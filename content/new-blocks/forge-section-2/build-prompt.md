...
- **Target path:** `/Users/bradjohn/Documents/forge-new/milo/.forge-worktrees/session-c2d673f5-ms78pnv6/libs/c2/blocks/forge-section-2` (NEVER libs/blocks/)
- **Milo branch:** `forge/session-c2d673f5-2c8` (cut off forge-a-panel)
- **Base branch:** `forge-a-panel`
- **Preview URL (LOCALHOST mode):** `http://localhost:3000/drafts/local-dev/forge/figma-c2d673?milolibs=local` — run Phase 5 in
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/bradjohn/Documents/forge-new/milo/.forge-worktrees/session-c2d673f5-ms78pnv6/libs/c2/blocks/forge-section-2/forge-section-2.js` (`export default
...
5. Phase 8: Forge owns the push — leave the branch `forge/session-c2d673f5-2c8` for
