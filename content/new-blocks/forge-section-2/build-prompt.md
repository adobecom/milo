...
- **Target path:** `/data/_repos/milo/.forge-worktrees/session-bf0a87e4-ms77jm08/libs/c2/blocks/forge-section-2` (NEVER libs/blocks/)
- **Milo branch:** `forge/session-bf0a87e4-d58` (cut off forge-a-panel)
- **Base branch:** `forge-a-panel`
- **Preview URL (LOCALHOST mode):** `http://localhost:3000/drafts/bradjohn/forge/figma-bf0a87?milolibs=local` — run Phase 5 in
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/data/_repos/milo/.forge-worktrees/session-bf0a87e4-ms77jm08/libs/c2/blocks/forge-section-2/forge-section-2.js` (`export default
...
5. Phase 8: Forge owns the push — leave the branch `forge/session-bf0a87e4-d58` for
