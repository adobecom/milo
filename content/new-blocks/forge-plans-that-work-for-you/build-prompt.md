...
- **Target path:** `/Users/victor/dev/milo-forge-fresh/.forge-worktrees/session-9f95e6b8-ms7dztsy/libs/c2/blocks/forge-plans-that-work-for-you` (NEVER libs/blocks/)
...
- `starter.css` — the section's CSS, scoped under `.sf-sec-9` /
  `.forge-plans-that-work-for-you`. Use as the starting point for `forge-plans-that-work-for-you.css`; prune rules that don't apply.
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/victor/dev/milo-forge-fresh/.forge-worktrees/session-9f95e6b8-ms7dztsy/libs/c2/blocks/forge-plans-that-work-for-you/forge-plans-that-work-for-you.js` (`export default
...
- R3 matcher decision: `new-block` (score: 0.70)
