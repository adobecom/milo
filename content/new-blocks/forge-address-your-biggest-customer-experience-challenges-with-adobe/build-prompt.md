...
- **Target path:** `/data/_repos/milo/.forge-worktrees/session-22cc8b95-ms7x4v2j/libs/c2/blocks/forge-address-your-biggest-customer-experience-challenges-with-adobe` (NEVER libs/blocks/)
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/data/_repos/milo/.forge-worktrees/session-22cc8b95-ms7x4v2j/libs/c2/blocks/forge-address-your-biggest-customer-experience-challenges-with-adobe/forge-address-your-biggest-customer-experience-challenges-with-adobe.js` (`export default
