...
- **Target path:** `/Users/osahin/repos/milo-logs-deploy/src/forge/shared/data/_repos/milo/.forge-worktrees/session-e851c46b-ms76w1r5/libs/c2/blocks/forge-tools-that-work-for-you-3` (NEVER libs/blocks/)
- **Milo branch:** `forge/session-e851c46b-9b9` (cut off forge-a-panel)
- **Base branch:** `forge-a-panel`
- **Preview URL (LOCALHOST mode):** `http://localhost:3000/drafts/osahin/forge/figma-e851c4?milolibs=local` — run Phase 5 in
  ...
  `?milolibs=` delivery.
- **Figma URL:** https://www.figma.com/design/lOFnBFhsYyFWPbSdiPa9us/Hub-%E2%80%94-A.com?node-id=10559-113821
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/osahin/repos/milo-logs-deploy/src/forge/shared/data/_repos/milo/.forge-worktrees/session-e851c46b-ms76w1r5/libs/c2/blocks/forge-tools-that-work-for-you-3/forge-tools-that-work-for-you-3.js` (`export default
...
5. Phase 8: Forge owns the push — leave the branch `forge/session-e851c46b-9b9` for
