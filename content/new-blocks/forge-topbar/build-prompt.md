...
- **Target path:** `/Users/osahin/repos/milo/.forge-worktrees/session-b8e816dd/libs/c2/blocks/forge-topbar` (NEVER libs/blocks/)
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/osahin/repos/milo/.forge-worktrees/session-b8e816dd/libs/c2/blocks/forge-topbar/forge-topbar.js` (`export default
