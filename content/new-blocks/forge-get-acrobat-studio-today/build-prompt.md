...
- **Target path:** `/Users/osahin/repos/milo-logs-deploy-allfeatures/src/forge/shared/data/_repos/milo/.forge-worktrees/session-e1e8d08f-ms36i4g2/libs/c2/blocks/forge-get-acrobat-studio-today` (NEVER libs/blocks/)
...
- `starter.css` — the section's CSS, scoped under `.sf-sec-0` /
  `.forge-get-acrobat-studio-today`. Use as the starting point for `forge-get-acrobat-studio-today.css`; prune rules that don't apply.
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/osahin/repos/milo-logs-deploy-allfeatures/src/forge/shared/data/_repos/milo/.forge-worktrees/session-e1e8d08f-ms36i4g2/libs/c2/blocks/forge-get-acrobat-studio-today/forge-get-acrobat-studio-today.js` (`export default
