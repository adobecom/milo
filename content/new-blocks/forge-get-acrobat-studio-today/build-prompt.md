...
- **Target path:** `/Users/victor/dev/milo-forge-fresh/.forge-worktrees/session-39e6fc58-msfsgzzl/libs/c2/blocks/forge-get-acrobat-studio-today` (NEVER libs/blocks/)
- **Milo branch:** `forge/session-39e6fc58-b6a` (cut off forge-a-panel)
- **Base branch:** `forge-a-panel`
- **Preview URL (LOCALHOST mode):** `http://localhost:3000/drafts/vhargrave/forge/rich-content-hero-39e6fc?milolibs=local` — run Phase 5 in
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/victor/dev/milo-forge-fresh/.forge-worktrees/session-39e6fc58-msfsgzzl/libs/c2/blocks/forge-get-acrobat-studio-today/forge-get-acrobat-studio-today.js` (`export default
...
5. Phase 8: Forge owns the push — leave the branch `forge/session-39e6fc58-b6a` for
