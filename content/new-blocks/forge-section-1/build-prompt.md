...
- **Target path:** `/Users/victor/dev/milo-forge-fresh/.forge-worktrees/session-4f3f79aa-mshb9ysy/libs/c2/blocks/forge-section-1` (NEVER libs/blocks/)
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/victor/dev/milo-forge-fresh/.forge-worktrees/session-4f3f79aa-mshb9ysy/libs/c2/blocks/forge-section-1/forge-section-1.js` (`export default
