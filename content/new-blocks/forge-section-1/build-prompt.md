...
- **Target path:** `/data/_repos/milo/.forge-worktrees/session-bf0a87e4-ms77jm08/libs/c2/blocks/forge-section-1` (NEVER libs/blocks/)
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/data/_repos/milo/.forge-worktrees/session-bf0a87e4-ms77jm08/libs/c2/blocks/forge-section-1/forge-section-1.js` (`export default
