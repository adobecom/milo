...
- **Target path:** `/Users/logan/dev/milo-logs-deploy/src/forge/shared/data/_repos/milo/.forge-worktrees/session-f30cf724-ms58lb6t/libs/c2/blocks/forge-remove-background-from-your-image-for-free` (NEVER libs/blocks/)
- **Milo branch:** `forge/session-f30cf724-fa2` (cut off forge-a-panel)
- **Base branch:** `forge-a-panel`
- **Preview URL (LOCALHOST mode):** `http://localhost:3000/drafts/lzartman/forge/figma-f30cf7?milolibs=local` — run Phase 5 in
  ...
  `?milolibs=` delivery.
- **Figma URL:** https://www.figma.com/design/w2VbLPROC36BO0DA0wBgyY/Doodlebug?node-id=11239-129054&m=dev
...
- `starter.css` — the section's CSS, scoped under `.sf-sec-0` /
  `.forge-remove-background-from-your-image-for-free`. Use as the starting point for `forge-remove-background-from-your-image-for-free.css`; prune rules that don't apply.
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/logan/dev/milo-logs-deploy/src/forge/shared/data/_repos/milo/.forge-worktrees/session-f30cf724-ms58lb6t/libs/c2/blocks/forge-remove-background-from-your-image-for-free/forge-remove-background-from-your-image-for-free.js` (`export default
...
5. Phase 8: Forge owns the push — leave the branch `forge/session-f30cf724-fa2` for
