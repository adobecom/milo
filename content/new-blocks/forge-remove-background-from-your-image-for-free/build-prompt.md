...
- **Target path:** `/Users/logan/dev/milo-logs-deploy/src/forge/shared/data/_repos/milo/.forge-worktrees/session-0eb2b777-ms550fha/libs/c2/blocks/forge-remove-background-from-your-image-for-free` (NEVER libs/blocks/)
- **Milo branch:** `forge/session-0eb2b777-b7e` (cut off forge-a-panel)
- **Base branch:** `forge-a-panel`
- **Preview URL (LOCALHOST mode):** `http://localhost:3000/drafts/lzartman/forge/figma-0eb2b7?milolibs=local` — run Phase 5 in
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/logan/dev/milo-logs-deploy/src/forge/shared/data/_repos/milo/.forge-worktrees/session-0eb2b777-ms550fha/libs/c2/blocks/forge-remove-background-from-your-image-for-free/forge-remove-background-from-your-image-for-free.js` (`export default
...
5. Phase 8: Forge owns the push — leave the branch `forge/session-0eb2b777-b7e` for
