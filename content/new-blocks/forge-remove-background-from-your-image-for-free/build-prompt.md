...
- **Target path:** `/data/_repos/milo/.forge-worktrees/session-dd71cc3f-ms573fj6/libs/c2/blocks/forge-remove-background-from-your-image-for-free` (NEVER libs/blocks/)
- **Milo branch:** `forge/session-dd71cc3f-38f` (cut off forge-a-panel)
- **Base branch:** `forge-a-panel`
- **Preview URL (LOCALHOST mode):** `http://localhost:3000/drafts/lzartman/forge/figma-dd71cc?milolibs=local` — run Phase 5 in
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/data/_repos/milo/.forge-worktrees/session-dd71cc3f-ms573fj6/libs/c2/blocks/forge-remove-background-from-your-image-for-free/forge-remove-background-from-your-image-for-free.js` (`export default
...
5. Phase 8: Forge owns the push — leave the branch `forge/session-dd71cc3f-38f` for
