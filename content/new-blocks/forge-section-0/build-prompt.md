...
- **Target path:** `/Users/osahin/repos/milo-logs-deploy/src/forge/shared/data/_repos/milo/.forge-worktrees/session-678eaf0f-ms36w7ar/libs/c2/blocks/forge-section-0` (NEVER libs/blocks/)
...
- `starter.css` — the section's CSS, scoped under `.sf-sec-0` /
  `.forge-section-0`. Use as the starting point for `forge-section-0.css`; prune rules that don't apply.
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/osahin/repos/milo-logs-deploy/src/forge/shared/data/_repos/milo/.forge-worktrees/session-678eaf0f-ms36w7ar/libs/c2/blocks/forge-section-0/forge-section-0.js` (`export default
