...
- **Target path:** `/Users/bradjohn/Documents/forge-new/milo/.forge-worktrees/session-c2d673f5-ms78pnv6/libs/c2/blocks/forge-explore-what-s-new` (NEVER libs/blocks/)
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/bradjohn/Documents/forge-new/milo/.forge-worktrees/session-c2d673f5-ms78pnv6/libs/c2/blocks/forge-explore-what-s-new/forge-explore-what-s-new.js` (`export default
   async function init(el)`) and `forge-explore-what-s-new.css`. Register in
