...
- **Target path:** `/Users/osahin/repos/milo-logs-deploy-reuse-run/src/forge/shared/data/_repos/milo/.forge-worktrees/session-c5305ca8-ms7li4hk/libs/c2/blocks/forge-tools-that-work-for-you` (NEVER libs/blocks/)
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/osahin/repos/milo-logs-deploy-reuse-run/src/forge/shared/data/_repos/milo/.forge-worktrees/session-c5305ca8-ms7li4hk/libs/c2/blocks/forge-tools-that-work-for-you/forge-tools-that-work-for-you.js` (`export default
...
- R3 matcher decision: `tight-variant` (score: 0.88)
