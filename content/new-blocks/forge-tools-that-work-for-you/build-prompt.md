...
- **Target path:** `/data/_repos/milo/.forge-worktrees/session-d9ab93ed-ms7meyk9/libs/c2/blocks/forge-tools-that-work-for-you` (NEVER libs/blocks/)
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/data/_repos/milo/.forge-worktrees/session-d9ab93ed-ms7meyk9/libs/c2/blocks/forge-tools-that-work-for-you/forge-tools-that-work-for-you.js` (`export default
...
- R3 matcher decision: `new-block` (score: 0.59)
