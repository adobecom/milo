# build-block-from-figma — task: forge-students-and-teachers-save-71
...
- **Block name:** `forge-students-and-teachers-save-71`
- **Target path:** `/data/_repos/milo/.forge-worktrees/session-1e6c8920-ms7wd9bq/libs/c2/blocks/forge-students-and-teachers-save-71` (NEVER libs/blocks/)
...
- `starter.css` — the section's CSS, scoped under `.sf-sec-2` /
  `.forge-students-and-teachers-save-71`. Use as the starting point for `forge-students-and-teachers-save-71.css`; prune rules that don't apply.
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/data/_repos/milo/.forge-worktrees/session-1e6c8920-ms7wd9bq/libs/c2/blocks/forge-students-and-teachers-save-71/forge-students-and-teachers-save-71.js` (`export default
   async function init(el)`) and `forge-students-and-teachers-save-71.css`. Register in
   `C2_BLOCKS` at `libs/utils/utils.js:111`. Emit the L22 test fixture
   (`mocks/body.html` + `forge-students-and-teachers-save-71.test.js`) so forge-block-lint passes.
