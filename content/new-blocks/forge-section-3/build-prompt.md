...
- **Target path:** `/Users/victor/dev/milo-forge-fresh/.forge-worktrees/session-aa965a89-msg6z1ii/libs/c2/blocks/forge-section-3` (NEVER libs/blocks/)
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/victor/dev/milo-forge-fresh/.forge-worktrees/session-aa965a89-msg6z1ii/libs/c2/blocks/forge-section-3/forge-section-3.js` (`export default
