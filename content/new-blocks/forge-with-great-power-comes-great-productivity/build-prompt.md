...
- **Target path:** `/data/_repos/milo/.forge-worktrees/session-1eb6381f-mrz68idb/libs/c2/blocks/forge-with-great-power-comes-great-productivity` (NEVER libs/blocks/)
- **Milo branch:** `forge/session-1eb6381f-27d` (cut off forge-a-panel)
- **Base branch:** `forge-a-panel`
- **Preview URL (LOCALHOST mode):** `http://localhost:3000/drafts/vhargrave/forge/figma-1eb638?milolibs=local` — run Phase 5 in
  ...
  `?milolibs=` delivery.
- **Figma URL:** https://www.figma.com/design/lOFnBFhsYyFWPbSdiPa9us/Hub-%E2%80%94-A.com?node-id=9848-39672&focus-id=9848-39669&view=focus&m=dev
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/data/_repos/milo/.forge-worktrees/session-1eb6381f-mrz68idb/libs/c2/blocks/forge-with-great-power-comes-great-productivity/forge-with-great-power-comes-great-productivity.js` (`export default
...
5. Phase 8: Forge owns the push — leave the branch `forge/session-1eb6381f-27d` for
