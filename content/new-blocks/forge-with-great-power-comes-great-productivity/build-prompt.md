...
- **Target path:** `/data/_repos/milo/.forge-worktrees/session-2393b90b-ms3gn02i/libs/c2/blocks/forge-with-great-power-comes-great-productivity` (NEVER libs/blocks/)
- **Milo branch:** `forge/session-2393b90b-6fb` (cut off forge-a-panel)
- **Base branch:** `forge-a-panel`
- **Preview URL (LOCALHOST mode):** `http://localhost:3000/drafts/vhargrave/forge/figma-2393b9?milolibs=local` — run Phase 5 in
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/data/_repos/milo/.forge-worktrees/session-2393b90b-ms3gn02i/libs/c2/blocks/forge-with-great-power-comes-great-productivity/forge-with-great-power-comes-great-productivity.js` (`export default
...
5. Phase 8: Forge owns the push — leave the branch `forge/session-2393b90b-6fb` for
   shipBlocksToMilo to commit + push and deliver via `?milolibs=`.

## Decision provenance

- R3 matcher decision: `ambiguous` (score: 0.52)
