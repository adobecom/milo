...
**Session:** `e00581d6-396`
**Milo branch:** `forge/session-e00581d6-396` (create with `cd /Users/osahin/repos/milo/.forge-worktrees/session-e00581d6 && git checkout -b forge/session-e00581d6-396 forge-a-panel`)
**Tasks:** 2

| # | Block name | Target path |
|---|---|---|
| 1 | `forge-feds-nav` | `/Users/osahin/repos/milo/.forge-worktrees/session-e00581d6/libs/c2/blocks/forge-feds-nav` |
| 2 | `forge-promo-mock` | `/Users/osahin/repos/milo/.forge-worktrees/session-e00581d6/libs/c2/blocks/forge-promo-mock` |
