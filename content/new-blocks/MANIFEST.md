...
**Session:** `2393b90b-6fb`
**Milo branch:** `forge/session-2393b90b-6fb` (create with `cd /data/_repos/milo/.forge-worktrees/session-2393b90b-ms3gn02i && git checkout -b forge/session-2393b90b-6fb forge-a-panel`)
**Tasks:** 1

| # | Block name | Target path |
|---|---|---|
| 1 | `forge-with-great-power-comes-great-productivity` | `/data/_repos/milo/.forge-worktrees/session-2393b90b-ms3gn02i/libs/c2/blocks/forge-with-great-power-comes-great-productivity` |
