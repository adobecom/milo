...
**Session:** `22cc8b95-53d`
**Milo branch:** `forge/session-22cc8b95-53d` (create with `cd /data/_repos/milo/.forge-worktrees/session-22cc8b95-ms7x4v2j && git checkout -b forge/session-22cc8b95-53d forge-a-panel`)
**Tasks:** 2

| # | Block name | Target path |
|---|---|---|
| 1 | `forge-what-s-new-in-ai-creativity-and-customer-experience` | `/data/_repos/milo/.forge-worktrees/session-22cc8b95-ms7x4v2j/libs/c2/blocks/forge-what-s-new-in-ai-creativity-and-customer-experience` |
| 2 | `forge-address-your-biggest-customer-experience-challenges-with-adobe` | `/data/_repos/milo/.forge-worktrees/session-22cc8b95-ms7x4v2j/libs/c2/blocks/forge-address-your-biggest-customer-experience-challenges-with-adobe` |
