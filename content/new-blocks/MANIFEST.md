...
**Session:** `887c754b-476`
**Milo branch:** `forge/session-887c754b-476` (create with `cd /Users/osahin/repos/milo/.forge-worktrees/session-887c754b && git checkout -b forge/session-887c754b-476 forge-a-panel`)
**Tasks:** 2

| # | Block name | Target path |
|---|---|---|
| 1 | `forge-nav-toolbar` | `/Users/osahin/repos/milo/.forge-worktrees/session-887c754b/libs/c2/blocks/forge-nav-toolbar` |
| 2 | `forge-promo-mockup` | `/Users/osahin/repos/milo/.forge-worktrees/session-887c754b/libs/c2/blocks/forge-promo-mockup` |
