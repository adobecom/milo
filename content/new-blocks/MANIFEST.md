...
**Session:** `6f307ee9-a26`
**Milo branch:** `forge/session-6f307ee9-a26` (create with `cd /data/_repos/milo/.forge-worktrees/session-6f307ee9-ms83bbk8 && git checkout -b forge/session-6f307ee9-a26 forge-a-panel`)
**Tasks:** 1

| # | Block name | Target path |
|---|---|---|
| 1 | `forge-contact` | `/data/_repos/milo/.forge-worktrees/session-6f307ee9-ms83bbk8/libs/c2/blocks/forge-contact` |
