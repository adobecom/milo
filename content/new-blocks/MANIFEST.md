...
**Session:** `dd71cc3f-38f`
**Milo branch:** `forge/session-dd71cc3f-38f` (create with `cd /data/_repos/milo/.forge-worktrees/session-dd71cc3f-ms573fj6 && git checkout -b forge/session-dd71cc3f-38f forge-a-panel`)
**Tasks:** 1

| # | Block name | Target path |
|---|---|---|
| 1 | `forge-remove-background-from-your-image-for-free` | `/data/_repos/milo/.forge-worktrees/session-dd71cc3f-ms573fj6/libs/c2/blocks/forge-remove-background-from-your-image-for-free` |
