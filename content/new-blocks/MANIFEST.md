...
**Session:** `80ca0d70-1f6`
**Milo branch:** `forge/session-80ca0d70-1f6` (create with `cd /Users/logan/dev/milo-logs-deploy/src/forge/shared/data/_repos/milo/.forge-worktrees/session-80ca0d70-ms3yjr74 && git checkout -b forge/session-80ca0d70-1f6 forge-a-panel`)
**Tasks:** 1

| # | Block name | Target path |
|---|---|---|
| 1 | `forge-remove-background-from-your-image-for-free` | `/Users/logan/dev/milo-logs-deploy/src/forge/shared/data/_repos/milo/.forge-worktrees/session-80ca0d70-ms3yjr74/libs/c2/blocks/forge-remove-background-from-your-image-for-free` |
