...
**Session:** `7221a6ef-8ee`
**Milo branch:** `forge/session-7221a6ef-8ee` (create with `cd /Users/osahin/repos/milo/.forge-worktrees/session-7221a6ef && git checkout -b forge/session-7221a6ef-8ee forge-a-panel`)
**Tasks:** 2

| # | Block name | Target path |
|---|---|---|
| 1 | `forge-topbar` | `/Users/osahin/repos/milo/.forge-worktrees/session-7221a6ef/libs/c2/blocks/forge-topbar` |
| 2 | `forge-promo` | `/Users/osahin/repos/milo/.forge-worktrees/session-7221a6ef/libs/c2/blocks/forge-promo` |
