...
- **Target path:** `/Users/victor/dev/milo-forge-fresh/.forge-worktrees/session-9f95e6b8-ms7dztsy/libs/c2/blocks/forge-work-faster-no-matter-the-work` (NEVER libs/blocks/)
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/victor/dev/milo-forge-fresh/.forge-worktrees/session-9f95e6b8-ms7dztsy/libs/c2/blocks/forge-work-faster-no-matter-the-work/forge-work-faster-no-matter-the-work.js` (`export default
