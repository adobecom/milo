...
- **Target path:** `/Users/bradjohn/Documents/forge-new/milo/.forge-worktrees/session-aa00e409-ms9bk8jl/libs/c2/blocks/forge-introducing-color-mode` (NEVER libs/blocks/)
...
- `page-globals.css` — page-level globals (:root tokens, resets, @font-face)
  ...
  (do NOT inline these into `forge-introducing-color-mode.css` — link them from the page head).
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/bradjohn/Documents/forge-new/milo/.forge-worktrees/session-aa00e409-ms9bk8jl/libs/c2/blocks/forge-introducing-color-mode/forge-introducing-color-mode.js` (`export default
