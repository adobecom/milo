...
- **Target path:** `/Users/osahin/repos/milo-logs-deploy/src/forge/shared/data/_repos/milo/.forge-worktrees/session-cab70eab-ms3i2q3t/libs/c2/blocks/forge-get-acrobat-studio-today-1` (NEVER libs/blocks/)
- **Milo branch:** `forge/session-cab70eab-325` (cut off forge-a-panel)
- **Base branch:** `forge-a-panel`
- **Preview URL (LOCALHOST mode):** `http://localhost:3000/drafts/osahin/forge/figma-cab70e?milolibs=local` — run Phase 5 in
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/osahin/repos/milo-logs-deploy/src/forge/shared/data/_repos/milo/.forge-worktrees/session-cab70eab-ms3i2q3t/libs/c2/blocks/forge-get-acrobat-studio-today-1/forge-get-acrobat-studio-today-1.js` (`export default
...
5. Phase 8: Forge owns the push — leave the branch `forge/session-cab70eab-325` for
