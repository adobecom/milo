...
- **Target path:** `/data/_repos/milo/.forge-worktrees/session-7a869f8d-ms4nw7m4/libs/c2/blocks/forge-get-acrobat-studio-today-1` (NEVER libs/blocks/)
- **Milo branch:** `forge/session-7a869f8d-19a` (cut off forge-a-panel)
- **Base branch:** `forge-a-panel`
- **Preview URL (LOCALHOST mode):** `http://localhost:3000/drafts/osahin/forge/figma-7a869f?milolibs=local` — run Phase 5 in
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/data/_repos/milo/.forge-worktrees/session-7a869f8d-ms4nw7m4/libs/c2/blocks/forge-get-acrobat-studio-today-1/forge-get-acrobat-studio-today-1.js` (`export default
...
5. Phase 8: Forge owns the push — leave the branch `forge/session-7a869f8d-19a` for
