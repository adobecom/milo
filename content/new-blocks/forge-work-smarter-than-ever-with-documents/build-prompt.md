...
- **Target path:** `/Users/bradjohn/Documents/forge-new/milo/.forge-worktrees/session-3dc1f062-ms939yzw/libs/c2/blocks/forge-work-smarter-than-ever-with-documents` (NEVER libs/blocks/)
- **Milo branch:** `forge/session-3dc1f062-29f` (cut off forge-a-panel)
- **Base branch:** `forge-a-panel`
- **Preview URL (LOCALHOST mode):** `http://localhost:3000/drafts/local-dev/forge/figma-3dc1f0?milolibs=local` — run Phase 5 in
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/bradjohn/Documents/forge-new/milo/.forge-worktrees/session-3dc1f062-ms939yzw/libs/c2/blocks/forge-work-smarter-than-ever-with-documents/forge-work-smarter-than-ever-with-documents.js` (`export default
...
5. Phase 8: Forge owns the push — leave the branch `forge/session-3dc1f062-29f` for
   shipBlocksToMilo to commit + push and deliver via `?milolibs=`.

## Decision provenance

- R3 matcher decision: `ambiguous` (score: 0.69)
