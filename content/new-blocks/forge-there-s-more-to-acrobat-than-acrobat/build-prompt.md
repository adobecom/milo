...
- **Target path:** `/Users/victor/dev/milo-forge-fresh/.forge-worktrees/session-aa965a89-msg6z1ii/libs/c2/blocks/forge-there-s-more-to-acrobat-than-acrobat` (NEVER libs/blocks/)
- **Milo branch:** `forge/session-aa965a89-2a7` (cut off forge-a-panel)
- **Base branch:** `forge-a-panel`
- **Preview URL (LOCALHOST mode):** `http://localhost:3000/drafts/vhargrave/forge/2562-aa965a?milolibs=local` — run Phase 5 in
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/victor/dev/milo-forge-fresh/.forge-worktrees/session-aa965a89-msg6z1ii/libs/c2/blocks/forge-there-s-more-to-acrobat-than-acrobat/forge-there-s-more-to-acrobat-than-acrobat.js` (`export default
...
5. Phase 8: Forge owns the push — leave the branch `forge/session-aa965a89-2a7` for
   shipBlocksToMilo to commit + push and deliver via `?milolibs=`.

## Decision provenance

- R3 matcher decision: `new-block` (score: 0.52)
