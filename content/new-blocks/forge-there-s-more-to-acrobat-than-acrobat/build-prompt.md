...
- **Target path:** `/data/_repos/milo/.forge-worktrees/session-58469d77-mrzb8sex/libs/c2/blocks/forge-there-s-more-to-acrobat-than-acrobat` (NEVER libs/blocks/)
...
- `starter.css` — the section's CSS, scoped under `.sf-sec-2` /
  `.forge-there-s-more-to-acrobat-than-acrobat`. Use as the starting point for `forge-there-s-more-to-acrobat-than-acrobat.css`; prune rules that don't apply.
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/data/_repos/milo/.forge-worktrees/session-58469d77-mrzb8sex/libs/c2/blocks/forge-there-s-more-to-acrobat-than-acrobat/forge-there-s-more-to-acrobat-than-acrobat.js` (`export default
