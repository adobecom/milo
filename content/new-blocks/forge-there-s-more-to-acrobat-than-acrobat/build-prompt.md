...
- **Target path:** `/Users/victor/dev/milo-forge-fresh/.forge-worktrees/session-39d32251-ms7g8va9/libs/c2/blocks/forge-there-s-more-to-acrobat-than-acrobat` (NEVER libs/blocks/)
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/Users/victor/dev/milo-forge-fresh/.forge-worktrees/session-39d32251-ms7g8va9/libs/c2/blocks/forge-there-s-more-to-acrobat-than-acrobat/forge-there-s-more-to-acrobat-than-acrobat.js` (`export default
