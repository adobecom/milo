...
- **Target path:** `/data/_repos/milo/.forge-worktrees/session-e0abb9ee-ms3o33dn/libs/c2/blocks/forge-create-beautifully` (NEVER libs/blocks/)
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/data/_repos/milo/.forge-worktrees/session-e0abb9ee-ms3o33dn/libs/c2/blocks/forge-create-beautifully/forge-create-beautifully.js` (`export default
