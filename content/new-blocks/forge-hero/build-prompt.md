...
- **Target path:** `/data/_repos/milo/.forge-worktrees/session-cb7a575c-mrxc3lfs/libs/c2/blocks/forge-hero` (NEVER libs/blocks/)
- **Milo branch:** `forge/session-cb7a575c-8db` (cut off forge-a-panel)
- **Base branch:** `forge-a-panel`
- **Preview URL (LOCALHOST mode):** `http://localhost:3000/drafts/anonymous/forge/skyline-reach-new-heights-cb7a57?milolibs=local` — run Phase 5 in
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/data/_repos/milo/.forge-worktrees/session-cb7a575c-mrxc3lfs/libs/c2/blocks/forge-hero/forge-hero.js` (`export default
...
5. Phase 8: Forge owns the push — leave the branch `forge/session-cb7a575c-8db` for
