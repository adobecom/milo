...
- **Target path:** `/data/_repos/milo/.forge-worktrees/session-88c66f57-ms84dj6h/libs/c2/blocks/forge-hero` (NEVER libs/blocks/)
...
2. Phase 1: gather the Figma context via the Figma MCP if the URL is set;
   ...
   missing Figma URL).
3. Phase 4: author `/data/_repos/milo/.forge-worktrees/session-88c66f57-ms84dj6h/libs/c2/blocks/forge-hero/forge-hero.js` (`export default
