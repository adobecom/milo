  ...
  features: [
    {
      ...
      tags: '@mas-ccd @suggested-card @smoke @regression @milo',
    },
    {
      tcid: '1',
    ...
    {
      tcid: '4',
      name: '@MAS-CCD-suggested-seeterms-thin',
      path: '/libs/features/mas/docs/ccd.html',
      data: {
    ...
    {
      tcid: '5',
      name: '@MAS-CCD-suggested-noeyebrow-priceunit-thin',
      path: '/libs/features/mas/docs/ccd.html',
      data: {
    ...
    {
      tcid: '6',
      name: '@MAS-CCD-suggested-seeterms-wide',
      path: '/libs/features/mas/docs/ccd.html',
      data: {
    ...
    {
      tcid: '7',
      name: '@MAS-CCD-suggested-noeyebrow-priceunit-wide',
      path: '/libs/features/mas/docs/ccd.html',
      data: {
