 ...
 *
 * Dependencies are isolated in nala/utils/screenshot-diff/ — that's where the
...
const { validatePath } = require('../../utils/screenshot-diff/lib/utils.js');
const { uploadResultsDir } = require('../../utils/screenshot-diff/lib/upload-s3.js');
const { loadSiteData } = require('../../utils/screenshot-diff/lib/load-data.js');
const config = require('../../utils/screenshot-diff/lib/config.js');
...
async function main() {
  ...
  // the committed local sot.<site>.yml. See nala/utils/screenshot-diff/lib/load-data.js.
