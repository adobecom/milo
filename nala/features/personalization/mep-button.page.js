export default class MepButton {
  constructor(page) {
    ...
    this.targetStatus = page.locator('.mep-section-data span:nth-child(4)').nth(1);
    this.targetStatus2 = page.locator('.mep-section-data span:nth-child(4)').nth(4);
    this.firstManifestType = page.locator('.mep-section-data').nth(0);
