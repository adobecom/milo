...
test.skip('Fail test suite', () => {
  test('1. This one passes, @fail', async () => {
    console.log('This test will pass');
    expect(true).toBe(true);
  });

  test('2. Immediate failure test, @fail', async () => {
  ...
  test('4. Assertion failure test, @fail', async () => {
    console.log('This test will fail on assertion');
    const result = 2 + 2;
    expect(result).toBe(5);
  });

  test('5. Error thrown test, @fail', async () => {
