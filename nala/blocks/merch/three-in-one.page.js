  ...
  constructor(page) {
    ...
    this.ctas = {
      ...
      csParam: {
        ...
        href: 'https://commerce.adobe.com/store/segmentation?cli=mini_plans&ctx=if&co=US&lang=en&ms=COM&ot=BASE&pa=phsp_direct_indirect_team&rtc=t&lo=sl&af=uc_new_user_iframe%2Cuc_new_system_close&cs=t',
      },
      msParam: {
        el: page.locator('[data-wcs-osi="MOTPxRjjKKie1Rn-Shd7Y5_UYWZYaN6UCfjf29oNn7w"][data-modal="d2p"]'),
        href: 'https://commerce.adobe.com/store/segmentation?cli=mini_plans&ctx=if&co=US&lang=en&ms=e&ot=BASE&pa=PA-1176&rtc=t&lo=sl&af=uc_new_user_iframe%2Cuc_new_system_close',
      },
      csParamOverride: {
