...
│ nala/utils/screenshot-diff/index.html│
└─────────────────────────────────┘
              ↑ reads / triggers
              │
┌─────────────────────────────────┐
...
```bash
# On your laptop:
scp nala/utils/screenshot-diff/setup-runner.sh sj1010122072233.corp.adobe.com:~/
...
`https://milo.adobe.com/nala/utils/screenshot-diff/` (after merge to upstream).
For PoC: `https://main--milo--JackySun9.aem.page/nala/utils/screenshot-diff/`.
