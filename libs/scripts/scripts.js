...
const locales = {
  ...
  africa: { ietf: 'en', lang: 'en', reg: '002', tk: 'pps7abe.css', rdn: 'Africa' },
  ...
  mena_ar: { ietf: 'ar', lang: 'ar', reg: '', tk: 'dis2dpj.css', dir: 'rtl', rdn: 'الشرق الأوسط' },
  mena_en: { ietf: 'en', lang: 'en', reg: '', tk: 'pps7abe.css', rdn: 'Middle East' },
