...
const locales = {
  ...
  ae_en: { ietf: 'en-AE', tk: 'hah7vzn.css' },
  ...
  my_en: { ietf: 'en-MY', tk: 'hah7vzn.css' },
  my_ms: { ietf: 'ms-MY', tk: 'qxw8hzm.css' },
  ng: { ietf: 'en-NG', tk: 'hah7vzn.css' },
  nl: { ietf: 'nl-NL', tk: 'qxw8hzm.css' },
  no: { ietf: 'no-NO', tk: 'qxw8hzm.css' },
  nz: { ietf: 'en-NZ', tk: 'hah7vzn.css' },
  pe: { ietf: 'es-PE', tk: 'hah7vzn.css' },
  ph_en: { ietf: 'en-PH', tk: 'hah7vzn.css' },
  ph_fil: { ietf: 'fil-PH', tk: 'qxw8hzm.css' },
  pl: { ietf: 'pl-PL', tk: 'qxw8hzm.css' },
  pr: { ietf: 'es-PR', tk: 'hah7vzn.css' },
  pt: { ietf: 'pt-PT', tk: 'hah7vzn.css' },
  qa_ar: { ietf: 'ar-QA', tk: 'qxw8hzm.css', dir: 'rtl' },
  qa_en: { ietf: 'en-QA', tk: 'hah7vzn.css' },
  ro: { ietf: 'ro-RO', tk: 'qxw8hzm.css' },
  ru: { ietf: 'ru-RU', tk: 'qxw8hzm.css' },
  sa_ar: { ietf: 'ar-SA', tk: 'qxw8hzm.css', dir: 'rtl' },
  sa_en: { ietf: 'en-SA', tk: 'hah7vzn.css' },
  se: { ietf: 'sv-SE', tk: 'qxw8hzm.css' },
  sg: { ietf: 'en-SG', tk: 'hah7vzn.css' },
  si: { ietf: 'sl-SI', tk: 'qxw8hzm.css' },
  sk: { ietf: 'sk-SK', tk: 'qxw8hzm.css' },
  th_en: { ietf: 'en-TH', tk: 'hah7vzn.css' },
  th_th: { ietf: 'th-TH', tk: 'qxw8hzm.css' },
