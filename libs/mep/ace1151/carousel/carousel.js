...
const ace1151ButtonVariant = (el) => {
  ...
  ].forEach((selector) => el.querySelector(selector)?.classList.add('ace1151'));
  el.querySelectorAll('.carousel-slide').forEach((element) => element.classList.add('ace1151'));
};
