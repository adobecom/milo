      ...
      switch (itemType) {
        ...
        case 'secondaryCta':
          ...
          return addMepHighlightAndTargetId(toFragment`<div class="feds-navItem feds-navItem--centered" role="listitem">
              ${decorateCta({ elem: item.classList.contains('merch') ? await (await import('../../../blocks/merch/merch.js')).default(item) : item, type: itemType, index: index + 1 })}
            </div>`, item);
        case 'link': {
          ...
          if (linkElem.classList.contains('merch')) {
            linkElem = await (await import('../../../blocks/merch/merch.js')).default(linkElem);
          }
        ...
        case 'text': {
          ...
          const content = isMerch ? await (await import('../../../blocks/merch/merch.js')).default(item) : item.textContent;
