// branch: twp-panel commit: f19db18cb1184615d0f7d3afead626d724d62121 Wed, 03 Apr 2024 14:13:44 GMT
import{LitElement as h,html as s}from"/libs/deps/lit-all.min.js";var c="(max-width: 767px)";var e="(min-width: 768px)",r="(min-width: 1200px)",a="(min-width: 1600px)";var o=document.createElement("style");o.innerHTML=`
:root {
...
`;document.head.appendChild(o);import{css as m,unsafeCSS as t}from"/libs/deps/lit-all.min.js";var i=m`
    :host {
...
`;var d="merch-subscription-layout",n=class extends h{static styles=[i];render(){return s`
        ...
        `}};window.customElements.define(d,n);export{n as SubscriptionLayout};
