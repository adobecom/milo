// branch: MWPW-142267-merch-crm commit: 2cfefbb1cb33946356a52d6cceba4e87b22fdd84 Thu, 28 Mar 2024 12:58:48 GMT
import { LitElement as O, html as V } from '/libs/deps/lit-all.min.js';
import { LitElement as B } from '/libs/deps/lit-all.min.js';
import { property as P } from '/libs/deps/lit-all.min.js'; import * as se from '/libs/deps/lit-all.min.js';

const y = Object.defineProperty; const D = Object.getOwnPropertyDescriptor; const S = Object.getOwnPropertyNames; const q = Object.prototype.hasOwnProperty; const C = (a, e) => { for (const t in e)y(a, t, { get: e[t], enumerable: !0 }); }; const f = (a, e, t, r) => { if (e && typeof e === 'object' || typeof e === 'function') for (const s of S(e))!q.call(a, s) && s !== t && y(a, s, { get: () => e[s], enumerable: !(r = D(e, s)) || r.enumerable }); return a; }; const g = (a, e, t) => (f(a, e, 'default'), t && f(t, e, 'default')); const i = {}; C(i, { ElementSizes: () => R, SizedMixin: () => F, SpectrumElement: () => d, SpectrumMixin: () => k }); const x = '0.39.4'; const v = new Set(); const E = () => { const a = document.documentElement.dir === 'rtl' ? document.documentElement.dir : 'ltr'; v.forEach((e) => { e.setAttribute('dir', a); }); }; const
  M = new MutationObserver(E); M.observe(document.documentElement, { attributes: !0, attributeFilter: ['dir'] }); const T = (a) => typeof a.startManagingContentDirection < 'u' || a.tagName === 'SP-THEME'; function k(a) {
  class e extends a {
    get isLTR() { return this.dir === 'ltr'; }

    hasVisibleFocusInTree() { const r = ((s = document) => { let c; let o = s.activeElement; for (;o != null && o.shadowRoot && o.shadowRoot.activeElement;)o = o.shadowRoot.activeElement; const m = o ? [o] : []; for (;o;) { const n = o.assignedSlot || o.parentElement || ((c = o.getRootNode()) == null ? void 0 : c.host); n && m.push(n), o = n; } return m; })(this.getRootNode())[0]; if (!r) return !1; try { return r.matches(':focus-visible') || r.matches('.focus-visible'); } catch { return r.matches('.focus-visible'); } }

    connectedCallback() { if (!this.hasAttribute('dir')) { let r = this.assignedSlot || this.parentNode; for (;r !== document.documentElement && !T(r);)r = r.assignedSlot || r.parentNode || r.host; if (this.dir = r.dir === 'rtl' ? r.dir : this.dir || 'ltr', r === document.documentElement)v.add(this); else { const { localName: s } = r; s.search('-') > -1 && !customElements.get(s) ? customElements.whenDefined(s).then(() => { r.startManagingContentDirection(this); }) : r.startManagingContentDirection(this); } this._dirParent = r; } super.connectedCallback(); }

    disconnectedCallback() { super.disconnectedCallback(), this._dirParent && (this._dirParent === document.documentElement ? v.delete(this) : this._dirParent.stopManagingContentDirection(this), this.removeAttribute('dir')); }
  } return e;
} var d = class extends k(B) {}; d.VERSION = x; const L = Object.defineProperty; const A = Object.getOwnPropertyDescriptor; const _ = (a, e, t, r) => { for (var s = r > 1 ? void 0 : r ? A(e, t) : e, c = a.length - 1, o; c >= 0; c--)(o = a[c]) && (s = (r ? o(e, t, s) : o(s)) || s); return r && s && L(e, t, s), s; }; var R = {
  xxs: 'xxs', xs: 'xs', s: 's', m: 'm', l: 'l', xl: 'xl', xxl: 'xxl',
}; function F(a, { validSizes: e = ['s', 'm', 'l', 'xl'], noDefaultSize: t, defaultSize: r = 'm' } = {}) {
  class s extends a {
    constructor() { super(...arguments), this._size = r; }

    get size() { return this._size || r; }

    set size(o) { const m = t ? null : r; const n = o && o.toLocaleLowerCase(); const p = e.includes(n) ? n : m; if (p && this.setAttribute('size', p), this._size === p) return; const H = this._size; this._size = p, this.requestUpdate('size', H); }

    update(o) { !this.hasAttribute('size') && !t && this.setAttribute('size', this.size), super.update(o); }
  } return _([P({ type: String, reflect: !0 })], s.prototype, 'size', 1), s;
}g(i, se);
...
`; const w = U; const N = ['spectrum', 'express']; const X = ['medium', 'large', 'medium-express', 'large-express']; const I = ['light', 'lightest', 'dark', 'darkest', 'light-express', 'lightest-express', 'dark-express', 'darkest-express']; const b = class l extends HTMLElement {
  constructor() { super(), this._dir = '', this._theme = 'spectrum', this._color = '', this._scale = '', this.trackedChildren = new Set(), this._updateRequested = !1, this._contextConsumers = new Map(), this.attachShadow({ mode: 'open' }); const e = document.importNode(l.template.content, !0); this.shadowRoot.appendChild(e), this.shouldAdoptStyles(), this.addEventListener('sp-query-theme', this.onQueryTheme), this.addEventListener('sp-language-context', this._handleContextPresence), this.updateComplete = this.__createDeferredPromise(); }

  static get observedAttributes() { return ['color', 'scale', 'theme', 'lang', 'dir']; }

  set dir(e) { if (e === this.dir) return; this.setAttribute('dir', e), this._dir = e; const t = e === 'rtl' ? e : 'ltr'; this.trackedChildren.forEach((r) => { r.setAttribute('dir', t); }); }

  get dir() { return this._dir; }

  attributeChangedCallback(e, t, r) { t !== r && (e === 'color' ? this.color = r : e === 'scale' ? this.scale = r : e === 'lang' && r ? (this.lang = r, this._provideContext()) : e === 'theme' ? this.theme = r : e === 'dir' && (this.dir = r)); }

  requestUpdate() { window.ShadyCSS !== void 0 && !window.ShadyCSS.nativeShadow ? window.ShadyCSS.styleElement(this) : this.shouldAdoptStyles(); }

  get theme() { const e = l.themeFragmentsByKind.get('theme'); const { name: t } = e && e.get('default') || {}; return this._theme || t || ''; }

  set theme(e) { if (e === this._theme) return; const t = e && N.includes(e) ? e : this.theme; t !== this._theme && (this._theme = t, this.requestUpdate()), t ? this.setAttribute('theme', t) : this.removeAttribute('theme'); }

  get color() { const e = l.themeFragmentsByKind.get('color'); const { name: t } = e && e.get('default') || {}; return this._color || t || ''; }

  set color(e) { if (e === this._color) return; const t = e && I.includes(e) ? e : this.color; t !== this._color && (this._color = t, this.requestUpdate()), t ? this.setAttribute('color', t) : this.removeAttribute('color'); }

  get scale() { const e = l.themeFragmentsByKind.get('scale'); const { name: t } = e && e.get('default') || {}; return this._scale || t || ''; }

  set scale(e) { if (e === this._scale) return; const t = e && X.includes(e) ? e : this.scale; t !== this._scale && (this._scale = t, this.requestUpdate()), t ? this.setAttribute('scale', t) : this.removeAttribute('scale'); }

  get styles() { const e = [...l.themeFragmentsByKind.keys()]; const t = (r, s, c) => { const o = c && c !== 'theme' && this.theme === 'express' ? r.get(`${s}-express`) : r.get(s); const m = s === 'spectrum' || !c || this.hasAttribute(c); if (o && m) return o.styles; }; return [...e.reduce((r, s) => { const c = l.themeFragmentsByKind.get(s); let o; if (s === 'app' || s === 'core')o = t(c, s); else { const { [s]: m } = this; o = t(c, m, s); } return o && r.push(o), r; }, [])]; }

  static get template() { return this.templateElement || (this.templateElement = document.createElement('template'), this.templateElement.innerHTML = '<slot></slot>'), this.templateElement; }

  __createDeferredPromise() { return new Promise((e) => { this.__resolve = e; }); }

  onQueryTheme(e) { if (e.defaultPrevented) return; e.preventDefault(); const { detail: t } = e; t.color = this.color || void 0, t.scale = this.scale || void 0, t.lang = this.lang || document.documentElement.lang || navigator.language, t.theme = this.theme || void 0; }

  connectedCallback() { if (this.shouldAdoptStyles(), window.ShadyCSS !== void 0 && window.ShadyCSS.styleElement(this), l.instances.add(this), !this.hasAttribute('dir')) { let e = this.assignedSlot || this.parentNode; for (;e !== document.documentElement && !(e instanceof l);)e = e.assignedSlot || e.parentNode || e.host; this.dir = e.dir === 'rtl' ? e.dir : 'ltr'; } }

  disconnectedCallback() { l.instances.delete(this); }

  startManagingContentDirection(e) { this.trackedChildren.add(e); }

  stopManagingContentDirection(e) { this.trackedChildren.delete(e); }

  async shouldAdoptStyles() { this._updateRequested || (this.updateComplete = this.__createDeferredPromise(), this._updateRequested = !0, this._updateRequested = await !1, this.adoptStyles(), this.__resolve(!0)); }

  adoptStyles() { const e = this.styles; if (window.ShadyCSS !== void 0 && !window.ShadyCSS.nativeShadow && window.ShadyCSS.ScopingShim) { const t = []; for (const [r, s] of l.themeFragmentsByKind) for (const [c, { styles: o }] of s) { if (c === 'default') continue; let m = o.cssText; l.defaultFragments.has(c) || (m = m.replace(':host', `:host([${r}='${c}'])`)), t.push(m); }window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t, this.localName), window.ShadyCSS.prepareTemplate(l.template, this.localName); } else if (i.supportsAdoptingStyleSheets) { const t = []; for (const r of e)t.push(r.styleSheet); this.shadowRoot.adoptedStyleSheets = t; } else this.shadowRoot.querySelectorAll('style').forEach((t) => t.remove()), e.forEach((t) => { const r = document.createElement('style'); r.textContent = t.cssText, this.shadowRoot.appendChild(r); }); }

  static registerThemeFragment(e, t, r) { const s = l.themeFragmentsByKind.get(t) || new Map(); s.size === 0 && (l.themeFragmentsByKind.set(t, s), s.set('default', { name: e, styles: r }), l.defaultFragments.add(e)), s.set(e, { name: e, styles: r }), l.instances.forEach((c) => c.shouldAdoptStyles()); }

  _provideContext() { this._contextConsumers.forEach(([e, t]) => e(this.lang, t)); }

  _handleContextPresence(e) { e.stopPropagation(); const t = e.composedPath()[0]; if (this._contextConsumers.has(t)) return; this._contextConsumers.set(t, [e.detail.callback, () => this._contextConsumers.delete(t)]); const [r, s] = this._contextConsumers.get(t) || []; r && s && r(this.lang || document.documentElement.lang || navigator.language, s); }
}; b.themeFragmentsByKind = new Map(), b.defaultFragments = new Set(['spectrum']), b.instances = new Set(); const u = b; const G = i.css`
...
`; const z = G; u.registerThemeFragment('spectrum', 'theme', z); u.registerThemeFragment('light', 'color', w); const K = i.css`
...
`; const j = K; u.registerThemeFragment('large', 'scale', j); customElements.define('sp-theme', u); const h = class extends O {
  ...
  render() { return V`<h2>${this.title}</h2>`; }
}; customElements.define('merch-crm', h); export { h as default };
// # sourceMappingURL=merch-crm.js.map
