var D=Object.defineProperty;var M=(i,e,t)=>e in i?D(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var a=(i,e,t)=>M(i,typeof e!="symbol"?e+"":e,t);import{html as x,css as K,LitElement as q,nothing as k}from"/libs/deps/lit-all.min.js";var d=class{constructor(e,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=e,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),e.addController(this)}hostConnected(){var e;(e=this.media)==null||e.addEventListener("change",this.onChange)}hostDisconnected(){var e;(e=this.media)==null||e.removeEventListener("change",this.onChange)}onChange(e){this.matches!==e.matches&&(this.matches=e.matches,this.host.requestUpdate(this.key,!this.matches))}};import{html as H,LitElement as U}from"/libs/deps/lit-all.min.js";var X=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),J=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var w='span[is="inline-price"][data-wcs-osi]',O='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var I='a[is="upt-link"]',ee=`${w},${O},${I}`;var T="merch-search:change";var h="merch-sidenav:select";var te=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var se=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});function u(i,e){let t;return function(){let s=this,o=arguments;clearTimeout(t),t=setTimeout(()=>i.apply(s,o),e)}}function A(i,e={},t=null,s=null){let o=s?document.createElement(i,{is:s}):document.createElement(i);t instanceof HTMLElement?o.appendChild(t):o.innerHTML=t;for(let[n,r]of Object.entries(e))o.setAttribute(n,r);return o}function P(i){if(!window.history.pushState)return;let e=new URL(window.location.href);e.search=`?${i}`,window.history.pushState({path:e.href},"",e.href)}function v(i,e){let t=new URLSearchParams(window.location.hash.slice(1));t.set(i,e),window.location.hash=t.toString()}function S(i=[]){i.forEach(e=>{let t=new URLSearchParams(window.location.search),s=t.get(e);s&&(window.location.hash.includes(`${e}=`)?v(e,s):window.location.hash=window.location.hash?`${window.location.hash}&${e}=${s}`:`${e}=${s}`,t.delete(e),P(t.toString()))})}var f="hashchange";function g(i=window.location.hash){let e=[],t=i.replace(/^#/,"").split("&");for(let s of t){let[o,n=""]=s.split("=");o&&e.push([o,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(e)}function c(i,e){if(i.deeplink){let t={};t[i.deeplink]=e,y(t)}}function y(i){let e=new URLSearchParams(window.location.hash.slice(1));Object.entries(i).forEach(([o,n])=>{n?e.set(o,n):e.delete(o)}),e.sort();let t=e.toString();if(t===window.location.hash)return;let s=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,s)}function l(i){let e=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=g(window.location.hash);i(t)};return e(),window.addEventListener(f,e),()=>{window.removeEventListener(f,e)}}var _=class extends U{get search(){return this.querySelector("sp-search")}constructor(){super(),this.handleInput=()=>{c(this,this.search.value),this.search.value&&this.dispatchEvent(new CustomEvent(T,{bubbles:!0,composed:!0,detail:{type:"search",value:this.search.value}}))},this.handleInputDebounced=u(this.handleInput.bind(this))}connectedCallback(){super.connectedCallback(),this.search&&(this.search.addEventListener("input",this.handleInputDebounced),this.search.addEventListener("submit",this.handleInputSubmit),this.updateComplete.then(()=>{this.setStateFromURL()}),this.startDeeplink())}disconnectedCallback(){super.disconnectedCallback(),this.search.removeEventListener("input",this.handleInputDebounced),this.search.removeEventListener("submit",this.handleInputSubmit),this.stopDeeplink?.()}setStateFromURL(){let t=g()[this.deeplink];t&&(this.search.value=t)}startDeeplink(){this.stopDeeplink=l(({search:e})=>{this.search.value=e??""})}handleInputSubmit(e){e.preventDefault()}render(){return H`<slot></slot>`}};a(_,"properties",{deeplink:{type:String}});customElements.define("merch-search",_);import{html as b,LitElement as V,css as Y,nothing as G}from"/libs/deps/lit-all.min.js";var p=class extends V{constructor(){super(),this.toggleIconColor=!1,this.handleClickDebounced=u(this.handleClick.bind(this))}selectElement(e,t=!0){e.selected=t,e.parentNode.tagName==="SP-SIDENAV-ITEM"&&this.selectElement(e.parentNode,!1);let s=e.querySelector(".selection");s?.setAttribute("selected",t);let o=s?.dataset,n=t&&this.toggleIconColor?o?.light:o?.dark;n&&e.querySelector("img")?.setAttribute("src",n),t&&(this.selectedElement=e,this.selectedText=o?.selectedText||e.label,this.selectedValue=e.value,setTimeout(()=>{e.selected=!0},1),this.dispatchEvent(new CustomEvent(h,{bubbles:!0,composed:!0,detail:{type:"sidenav",value:this.selectedValue,elt:this.selectedElement}})))}markCurrentItem(e){let t=e.closest("sp-sidenav");t&&(t.querySelectorAll("sp-sidenav-item[aria-current]").forEach(s=>{s.removeAttribute("aria-current")}),e.setAttribute("aria-current","true"))}handleClick({target:e},t=!0){let{value:s,parentNode:o}=e;this.selectElement(e),this.markCurrentItem(e),o?.tagName==="SP-SIDENAV"?(o.querySelectorAll("sp-sidenav-item[expanded],sp-sidenav-item[selected]").forEach(n=>{n.value!==s&&(n.expanded=!1,n.removeAttribute("aria-expanded"),this.selectElement(n,!1))}),o.querySelectorAll(".selection[selected=true]").forEach(n=>{let r=n.parentElement;r.value!==s&&this.selectElement(r,!1)})):o?.tagName==="SP-SIDENAV-ITEM"&&([...o.closest("sp-sidenav")?.querySelectorAll(":scope > sp-sidenav-item")].filter(r=>r!==o).forEach(r=>{r.expanded=!1,r.removeAttribute("aria-expanded")}),o.closest("sp-sidenav")?.querySelectorAll("sp-sidenav-item[selected]").forEach(r=>{r.value!==s&&this.selectElement(r,!1)})),t&&c(this,s)}selectionChanged(e){let{target:{value:t,parentNode:s}}=e;this.selectElement(this.querySelector(`sp-sidenav-item[value="${t}"]`)),c(this,t)}startDeeplink(){this.stopDeeplink=l(e=>{let t=e[this.deeplink]??"all",s=this.querySelector(`sp-sidenav-item[value="${t}"]`);s||(s=this.querySelector("sp-sidenav-item:first-child"),v(this.deeplink,s.value)),this.updateComplete.then(()=>{s.firstElementChild?.tagName==="SP-SIDENAV-ITEM"&&(s.expanded=!0,s.setAttribute("aria-expanded","true")),s.parentNode?.tagName==="SP-SIDENAV-ITEM"&&(s.parentNode.expanded=!0,s.parentNode.setAttribute("aria-expanded","true")),this.handleClick({target:s},!!window.location.hash.includes("category"))})})}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.handleClickDebounced),this.updateComplete.then(()=>{this.deeplink&&(S(["filter","single_app"]),this.startDeeplink())})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.handleClickDebounced),this.stopDeeplink?.()}render(){return b`<div
    ...
    `);customElements.define("merch-sidenav-list",p);import{html as B,LitElement as F,css as z}from"/libs/deps/lit-all.min.js";var m=class extends F{constructor(){super(),this.selectedValues=[]}selectionChanged({target:e}){let t=e.getAttribute("name");if(t){let s=this.selectedValues.indexOf(t);e.checked&&s===-1?this.selectedValues.push(t):!e.checked&&s>=0&&this.selectedValues.splice(s,1)}c(this,this.selectedValues.join(","))}addGroupTitle(){let e="sidenav-checkbox-group-title",t=A("h3",{id:e});t.textContent=this.sidenavCheckboxTitle,this.prepend(t),this.setAttribute("role","group"),this.setAttribute("aria-labelledby",e)}startDeeplink(){this.stopDeeplink=l(({types:e})=>{if(e){let t=e.split(",");[...new Set([...t,...this.selectedValues])].forEach(s=>{let o=this.querySelector(`sp-checkbox[name=${s}]`);o&&(o.checked=t.includes(s))}),this.selectedValues=t}else this.selectedValues.forEach(t=>{let s=this.querySelector(`sp-checkbox[name=${t}]`);s&&(s.checked=!1)}),this.selectedValues=[]})}connectedCallback(){super.connectedCallback(),this.updateComplete.then(async()=>{this.addGroupTitle(),this.startDeeplink()})}disconnectedCallback(){this.stopDeeplink?.()}render(){return B`<div aria-label="${this.label}">
        ...
        </div>`}};a(m,"properties",{sidenavCheckboxTitle:{type:String},label:{type:String},deeplink:{type:String},selectedValues:{type:Array,reflect:!0},value:{type:String}}),a(m,"styles",z`
        :host {
            display: block;
            contain: content;
