<<<<<<< HEAD
var P=Object.defineProperty;var g=o=>{throw TypeError(o)};var H=(o,e,t)=>e in o?P(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var i=(o,e,t)=>H(o,typeof e!="symbol"?e+"":e,t),S=(o,e,t)=>e.has(o)||g("Cannot "+t);var A=(o,e,t)=>(S(o,e,"read from private field"),t?t.call(o):e.get(o)),C=(o,e,t)=>e.has(o)?g("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(o):e.set(o,t),b=(o,e,t,s)=>(S(o,e,"write to private field"),s?s.call(o,t):e.set(o,t),t);import{html as V,css as j,LitElement as z}from"/libs/deps/lit-all.min.js";var d=class{constructor(e,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=e,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),e.addController(this)}hostConnected(){var e;(e=this.media)==null||e.addEventListener("change",this.onChange)}hostDisconnected(){var e;(e=this.media)==null||e.removeEventListener("change",this.onChange)}onChange(e){this.matches!==e.matches&&(this.matches=e.matches,this.host.requestUpdate(this.key,!this.matches))}};import{css as U}from"/libs/deps/lit-all.min.js";var E=U`
=======
...
<<<<<<< HEAD
        </div>`}};i(p,"properties",{sidenavCheckboxTitle:{type:String},label:{type:String},deeplink:{type:String},selectedValues:{type:Array,reflect:!0},value:{type:String}}),i(p,"styles",W`
=======
...
<<<<<<< HEAD
    `);customElements.define("merch-sidenav-checkbox-group",p);var D="(max-width: 700px)";var k="(max-width: 1199px)";var M=/iP(ad|hone|od)/.test(window?.navigator?.platform)||window?.navigator?.platform==="MacIntel"&&window.navigator.maxTouchPoints>1,T=!1,_,O=o=>{o&&(M?(document.body.style.position="fixed",o.ontouchmove=e=>{e.targetTouches.length===1&&e.stopPropagation()},T||(document.addEventListener("touchmove",e=>e.preventDefault()),T=!0)):(_=document.body.style.overflow,document.body.style.overflow="hidden"))},I=o=>{o&&(M?(o.ontouchstart=null,o.ontouchmove=null,document.body.style.position="",document.removeEventListener("touchmove",e=>e.preventDefault()),T=!1):_!==void 0&&(document.body.style.overflow=_,_=void 0))};var u,m=class extends z{constructor(){super();C(this,u);i(this,"mobileDevice",new d(this,D));i(this,"mobileAndTablet",new d(this,k));this.modal=!1}get filters(){return this.querySelector("merch-sidenav-list")}get search(){return this.querySelector("merch-search")}render(){return this.mobileAndTablet.matches?this.asDialog:this.asAside}get asDialog(){if(this.modal)return V`
=======
