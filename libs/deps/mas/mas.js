...
`;var wl={backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{size:"l"}},dt=class extends O{getGlobalCSS(){return Wa}get aemFragmentMapping(){return wl}renderLayout(){return g` <div class="content">
                <slot name="icons"></slot> ${this.badge}
