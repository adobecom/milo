...
`;var Nl={backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{size:"s"},allowedSizes:["wide"],mnemonics:{size:"m"}},ft=class extends P{getGlobalCSS(){return es}get aemFragmentMapping(){return Nl}renderLayout(){return x` <div class="content">
                <div class="top-section">
                  <slot name="icons"></slot> 
                  ${this.badge}
                </div>  
