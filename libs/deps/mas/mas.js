...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return Ko}setAriaExpanded(r,n){r.setAttribute("aria-expanded",n)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};p(it,"variantStyle",C`
...
`;var fc=32,ot=class extends I{constructor(r){super(r);p(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);p(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
...
`;var at=class extends I{constructor(t){super(t)}getGlobalCSS(){return Wo}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
...
`;var st=class extends I{constructor(t){super(t)}getGlobalCSS(){return Zo}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
        ${this.promoBottom?"":x`<slot name="promo-text"></slot><slot name="callout-content"></slot>`}
...
`;var qn={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},dt=class extends I{getGlobalCSS(){return ta}get aemFragmentMapping(){return qn}renderLayout(){return x` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
    ...
    `);var Zn=(e,t=!1)=>{switch(e.variant){case"catalog":return new it(e);case"image":return new yr(e);case"inline-heading":return new Tr(e);case"mini-compare-chart":return new ot(e);case"plans":return new at(e);case"product":return new $e(e);case"segment":return new st(e);case"special-offers":return new ct(e);case"twp":return new lt(e);case"ccd-suggested":return new ht(e);case"ccd-slice":return new dt(e);default:return t?void 0:new $e(e)}},ra={catalog:Yn,image:null,"inline-heading":null,"mini-compare-chart":null,plans:null,product:null,segment:null,"special-offers":Xn,twp:null,"ccd-suggested":Wn,"ccd-slice":qn},na=()=>{let e=[];return e.push(it.variantStyle),e.push(ot.variantStyle),e.push($e.variantStyle),e.push(at.variantStyle),e.push(st.variantStyle),e.push(ct.variantStyle),e.push(lt.variantStyle),e.push(ht.variantStyle),e.push(dt.variantStyle),e};var ia=document.createElement("style");ia.innerHTML=`
:root {
