...
`;document.head.appendChild(ko);var _s="merch-card",ws=32,Ut="mini-compare-chart",Mo=e=>`--consonant-merch-card-footer-row-${e}-min-height`,he,ut=class extends re{constructor(){super();C(this,"customerSegment");C(this,"marketSegment");Se(this,he);this.filters={},this.types="",this.selected=!1}updated(r){(r.has("badgeBackgroundColor")||r.has("borderColor"))&&(this.style.border=this.computedBorderStyle),this.updateComplete.then(async()=>{let o=Array.from(this.querySelectorAll('span[is="inline-price"][data-wcs-osi]')).filter(i=>!i.closest('[slot="callout-content"]'));await Promise.all(o.map(i=>i.onceSettled())),this.adjustTitleWidth(),$o()?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())})}get computedBorderStyle(){return this.variant!=="twp"?`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`:""}get evergreen(){return this.classList.contains("intro-pricing")}get stockCheckbox(){return this.checkboxLabel?x`<label id="stock-checkbox">
    ...
    `);customElements.define("merch-icon",Be);var Ss=window.adobeid?.authorize?.(),Re={Authorization:`Bearer ${Ss}`,pragma:"no-cache","cache-control":"no-cache"};async function As({path:e,query:t,variant:r}){let n={};e&&(n.path=e),t&&(n.fullText={text:encodeURIComponent(t),queryMode:"EXACT_WORDS"});let o=new URLSearchParams({query:JSON.stringify({filter:n})}).toString();return fetch(`${this.cfSearchUrl}?${o}`,{headers:Re}).then(i=>i.json()).then(i=>i.items).then(i=>r?i.filter(s=>{let[a]=s.fields.find(c=>c.name==="variant")?.values;return a===r}):i)}async function Ts(e){return fetch(`${this.cfFragmentsUrl}?path=${e}`).then(t=>t.json()).then(({items:[t]})=>t)}var Uo=async e=>{let t=e.headers.get("Etag"),r=await e.json();return r.etag=t,r};async function Do(e){return await fetch(`${this.cfFragmentsUrl}/${e}`,{headers:Re}).then(Uo)}async function Ps(e){let{title:t,fields:r}=e;return await fetch(`${this.cfFragmentsUrl}/${e.id}`,{method:"PUT",headers:{"Content-Type":"application/json","If-Match":e.etag,...Re},body:JSON.stringify({title:t,fields:r})}).then(Uo)}async function Cs(e){let t=await this.getCsrfToken(),r=e.path.split("/").pop(),n=e.path.split("/").slice(0,-1).join("/");if(/copy\s?\d?/.test(e.title)){let i=e.name.match(/copy\s?(\d)?/)[1]||1;r=e.name.replace(/copy\s?\d?/,`copy ${++i}`)}else r=`${r}-copy-1`;let o=new FormData;return o.append("cmd","copyPage"),o.append("srcPath",e.path),o.append("destParentPath",n),o.append("shallow","false"),o.append("_charset_","UTF-8"),o.append("destName",r),o.append("destTitle",e.title),await fetch(this.wcmcommandUrl,{method:"POST",headers:{...Re,"csrf-token":t},body:o}).then(i=>{if(i.ok)return Do(e.path)})}async function Os(e){await fetch(this.cfPublishUrl,{method:"POST",headers:{"Content-Type":"application/json","If-Match":e.etag,...Re},body:JSON.stringify({paths:[e.path],filterReferencesByStatus:["DRAFT","UNPUBLISHED"],workflowModelId:"/var/workflow/models/scheduled_activation_with_references"})})}async function Ls(e){await fetch(`${this.cfFragmentsUrl}/${e.id}`,{method:"DELETE",headers:{"Content-Type":"application/json","If-Match":e.etag,...Re}})}var Dt=class{constructor(t){C(this,"sites",{cf:{fragments:{search:As.bind(this),getCfByPath:Ts.bind(this),getCfById:Do.bind(this),save:Ps.bind(this),copyFragment:Cs.bind(this),publish:Os.bind(this),delete:Ls.bind(this)}}});let r=`https://${t}.adobeaemcloud.com`,n=`${r}/adobe/sites`;this.cfFragmentsUrl=`${n}/cf/fragments`,this.cfSearchUrl=`${this.cfFragmentsUrl}/search`,this.cfPublishUrl=`${this.cfFragmentsUrl}/publish`,this.wcmcommandUrl=`${r}/bin/wcmcommand`,this.csrfTokenUrl=`${r}/libs/granite/csrf/token.json`}async getCsrfToken(){let{token:t}=await fetch(this.csrfTokenUrl,{headers:Re}).then(r=>r.json());return t}};var Go="aem-bucket",Ns={"8a7b6c5d-4e3f-2a1b-9c8d-7e6f5a4b3c2d":"photoshop-lapsed-upgrade","a1b2c3d4-e5f6-7890-abcd-ef1234567890":"photography-upsell"};var Rs={catalog:{title:{tag:"h3",slot:"heading-xs"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{size:"l"}},ah:{title:{tag:"h3",slot:"heading-xxs"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xxs"},ctas:{size:"s"}},"ccd-action":{title:{tag:"h3",slot:"heading-xs"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{size:"l"}},"special-offers":{name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{size:"l"}}};async function $s(e,t,r,n){let o=e.fields.reduce((a,{name:c,multiple:h,values:l})=>(a[c]=h?l:l[0],a),{id:e.id});o.path=o.path,o.model=o.model;let{variant:i="catalog"}=o;r.setAttribute("variant",i);let s=Rs[i]??"catalog";if(o.icon?.forEach(a=>{let c=ve("merch-icon",{slot:"icons",src:a,alt:"",href:"",size:"l"});t(c)}),o.title&&s.title&&t(ve(s.title.tag,{slot:s.title.slot},o.title)),o.backgroundImage&&s.backgroundImage&&t(ve(s.backgroundImage.tag,{slot:s.backgroundImage.slot},`<img loading="lazy" src="${o.backgroundImage}" width="600" height="362">`)),o.prices&&s.prices){let a=o.prices,c=ve(s.prices.tag,{slot:s.prices.slot},a);t(c)}if(o.description&&s.description){let a=ve(s.description.tag,{slot:s.description.slot},o.description);t(a)}if(o.ctas){let a=o.ctas,c=ve("div",{slot:"footer"},a);[...c.querySelectorAll("a")].forEach(h=>{if(n)h.classList.add("con-button"),h.parentElement.tagName==="STRONG"&&h.classList.add("blue"),c.appendChild(h);else{let l=ve("sp-button",{},h);l.addEventListener("click",d=>{d.stopPropagation(),h.click()}),c.appendChild(l)}}),t(c)}}var ye,jr=class{constructor(){Se(this,ye,new Map)}clear(){U(this,ye).clear()}add(...t){t.forEach(r=>{let{path:n}=r;n&&U(this,ye).set(n,r)})}has(t){return U(this,ye).has(t)}get(t){return U(this,ye).get(t)}remove(t){U(this,ye).delete(t)}};ye=new WeakMap;var zo=new jr,We,Vr=class extends HTMLElement{constructor(){super(...arguments);Se(this,We);C(this,"cache",zo);C(this,"refs",[]);C(this,"path");C(this,"consonant",!1)}static get observedAttributes(){return["source","path","consonant"]}attributeChangedCallback(r,n,o){this[r]=o}connectedCallback(){this.consonant=this.hasAttribute("consonant"),this.clearRefs();let r=this.getAttribute(Go)??document.querySelector("mas-studio")?.getAttribute(Go)??"publish-p22655-e59341";Ae(this,We,new Dt(r)),this.fetchData()}clearRefs(){this.refs.forEach(r=>{r.remove()})}refresh(r=!0){this.clearRefs(),this.refs=[],r&&this.cache.remove(this.path),this.fetchData()}async fetchData(){let r=zo.get(this.path);r||(r=await U(this,We).sites.cf.fragments.getCfByPath(this.path));let n=(sessionStorage.getItem("mas_xlg")??window.alloy_all?.data?._adobe_corpnew?.digitalData?.adobe?.xlg)?.split(",")?.map(i=>Ns[i]).find(Boolean),o=r.fields.find(i=>i.name==="xlg")?.values[0];if(n&&o?.includes(n)){let i=await U(this,We).sites.cf.fragments.getCfByPath(`${this.path}-${n}`).catch(()=>null);i&&(r=i)}if(r){$s(r,s=>{this.parentElement.appendChild(s),this.refs.push(s)},this.parentElement,this.consonant);return}}};We=new WeakMap;customElements.define("merch-datasource",Vr);var mt;(function(e){e.ServerError="ServerError",e.ClientError="ClientError",e.UnexpectedError="UnexpectedError"})(mt||(mt={}));var Fo=(e,t,r)=>({type:(o=>o>=500?mt.ServerError:o<400?mt.UnexpectedError:mt.ClientError)(e),message:t,originatingRequest:r,status:e});var Is=function(e,t,r,n){function o(i){return i instanceof r?i:new r(function(s){s(i)})}return new(r||(r=Promise))(function(i,s){function a(l){try{h(n.next(l))}catch(d){s(d)}}function c(l){try{h(n.throw(l))}catch(d){s(d)}}function h(l){l.done?i(l.value):o(l.value).then(a,c)}h((n=n.apply(e,t||[])).next())})},Gt;(function(e){e.AUTHORIZATION="Authorization",e.X_API_KEY="X-Api-Key"})(Gt||(Gt={}));var Br=class{constructor(t){this.fetchOptions=t}commonHeaders(){let t={};return this.fetchOptions.apiKey&&(t[Gt.X_API_KEY]=this.fetchOptions.apiKey),this.fetchOptions.accessToken&&(t[Gt.AUTHORIZATION]=`Bearer ${this.fetchOptions.accessToken}`),t}transformData(t,r){return r?t.map(n=>r(n)):t.map(n=>this.identifyTransform(n))}transformDatum(t,r){return r?r(t):this.identifyTransform(t)}identifyTransform(t){return t}failOnBadStatusOrParseBody(t,r){return Is(this,void 0,void 0,function*(){if(t.ok)return t.json().then(o=>({headers:t.headers,status:t.status,statusText:t.statusText,data:o}));let n=yield t.text();return Promise.reject(Fo(t.status,n,r))})}buildUrl(t,r,n,o,i){var s;let a=(s=this.fetchOptions.baseUrl)!==null&&s!==void 0?s:o(this.fetchOptions.env),c=i(r,n);return this.generateUrl(a,t,c)}generateUrl(t,r,n){let o=new URL(r,t);return n&&(o.search=this.convertToSearchParams(n).toString()),o.toString()}convertToSearchParams(t){return new URLSearchParams(t)}setParams(t,r,n){n!=null&&typeof n=="boolean"?t[r]=String(n):n&&(t[r]=n)}},Wr=Br;var K;(function(e){e.STAGE="STAGE",e.PRODUCTION="PRODUCTION",e.LOCAL="LOCAL"})(K||(K={}));var pt;(function(e){e.STAGE="STAGE",e.PRODUCTION="PROD",e.LOCAL="LOCAL"})(pt||(pt={}));var q;(function(e){e.DRAFT="DRAFT",e.PUBLISHED="PUBLISHED"})(q||(q={}));var $e;(function(e){e.V2="UCv2",e.V3="UCv3"})($e||($e={}));var ee;(function(e){e.CHECKOUT="checkout",e.CHECKOUT_EMAIL="checkout/email",e.SEGMENTATION="segmentation",e.BUNDLE="bundle",e.COMMITMENT="commitment",e.RECOMMENDATION="recommendation",e.EMAIL="email",e.PAYMENT="payment",e.CHANGE_PLAN_TEAM_PLANS="change-plan/team-upgrade/plans",e.CHANGE_PLAN_TEAM_PAYMENT="change-plan/team-upgrade/payment"})(ee||(ee={}));var qr=function(e){var t;return(t=ks.get(e))!==null&&t!==void 0?t:e},ks=new Map([["countrySpecific","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["offerType","ot"],["marketSegment","ms"]]);var Ho=function(e){var t=typeof Symbol=="function"&&Symbol.iterator,r=t&&e[t],n=0;if(r)return r.call(e);if(e&&typeof e.length=="number")return{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}};throw new TypeError(t?"Object is not iterable.":"Symbol.iterator is not defined.")},jo=function(e,t){var r=typeof Symbol=="function"&&e[Symbol.iterator];if(!r)return e;var n=r.call(e),o,i=[],s;try{for(;(t===void 0||t-- >0)&&!(o=n.next()).done;)i.push(o.value)}catch(a){s={error:a}}finally{try{o&&!o.done&&(r=n.return)&&r.call(n)}finally{if(s)throw s.error}}return i};function qe(e,t,r){var n,o;try{for(var i=Ho(Object.entries(e)),s=i.next();!s.done;s=i.next()){var a=jo(s.value,2),c=a[0],h=a[1],l=qr(c);h!=null&&r.has(l)&&t.set(l,h)}}catch(d){n={error:d}}finally{try{s&&!s.done&&(o=i.return)&&o.call(i)}finally{if(n)throw n.error}}}function zt(e){switch(e){case K.PRODUCTION:return"https://commerce.adobe.com";default:return"https://commerce-stg.adobe.com"}}function Ft(e,t){var r,n;for(var o in e){var i=e[o];try{for(var s=(r=void 0,Ho(Object.entries(i))),a=s.next();!a.done;a=s.next()){var c=jo(a.value,2),h=c[0],l=c[1];if(l!=null){var d=qr(h);t.set("items["+o+"]["+d+"]",l)}}}catch(u){r={error:u}}finally{try{a&&!a.done&&(n=s.return)&&n.call(s)}finally{if(r)throw r.error}}}}var Ms=function(e,t){var r={};for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var o=0,n=Object.getOwnPropertySymbols(e);o<n.length;o++)t.indexOf(n[o])<0&&Object.prototype.propertyIsEnumerable.call(e,n[o])&&(r[n[o]]=e[n[o]]);return r},Us=function(e){var t=typeof Symbol=="function"&&Symbol.iterator,r=t&&e[t],n=0;if(r)return r.call(e);if(e&&typeof e.length=="number")return{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}};throw new TypeError(t?"Object is not iterable.":"Symbol.iterator is not defined.")};function Vo(e){zs(e);var t=e.env,r=e.items,n=e.workflowStep,o=Ms(e,["env","items","workflowStep"]),i=new URL(zt(t));return i.pathname=n+"/",Ft(r,i.searchParams),qe(o,i.searchParams,Ds),i.toString()}var Ds=new Set(["cli","co","lang","ctx","cUrl","mv","nglwfdata","otac","promoid","rUrl","sdid","spint","trackingid","code","campaignid","appctxid"]),Gs=["env","workflowStep","clientId","country","items"];function zs(e){var t,r;try{for(var n=Us(Gs),o=n.next();!o.done;o=n.next()){var i=o.value;if(!e[i])throw new Error('Argument "checkoutData" is not valid, missing: '+i)}}catch(s){t={error:s}}finally{try{o&&!o.done&&(r=n.return)&&r.call(n)}finally{if(t)throw t.error}}return!0}var Fs=function(e,t){var r={};for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var o=0,n=Object.getOwnPropertySymbols(e);o<n.length;o++)t.indexOf(n[o])<0&&Object.prototype.propertyIsEnumerable.call(e,n[o])&&(r[n[o]]=e[n[o]]);return r},Hs=function(e){var t=typeof Symbol=="function"&&Symbol.iterator,r=t&&e[t],n=0;if(r)return r.call(e);if(e&&typeof e.length=="number")return{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}};throw new TypeError(t?"Object is not iterable.":"Symbol.iterator is not defined.")},js="p_draft_landscape",Vs="/store/";function Xr(e){Ws(e);var t=e.env,r=e.items,n=e.workflowStep,o=e.ms,i=e.marketSegment,s=e.ot,a=e.offerType,c=e.pa,h=e.productArrangementCode,l=e.landscape,d=Fs(e,["env","items","workflowStep","ms","marketSegment","ot","offerType","pa","productArrangementCode","landscape"]),u={marketSegment:i??o,offerType:a??s,productArrangementCode:h??c},p=new URL(zt(t));return p.pathname=""+Vs+n,n!==ee.SEGMENTATION&&n!==ee.CHANGE_PLAN_TEAM_PLANS&&Ft(r,p.searchParams),n===ee.SEGMENTATION&&qe(u,p.searchParams,Yr),qe(d,p.searchParams,Yr),l===q.DRAFT&&qe({af:js},p.searchParams,Yr),p.toString()}var Yr=new Set(["af","ai","apc","appctxid","cli","co","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),Bs=["env","workflowStep","clientId","country"];function Ws(e){var t,r;try{for(var n=Hs(Bs),o=n.next();!o.done;o=n.next()){var i=o.value;if(!e[i])throw new Error('Argument "checkoutData" is not valid, missing: '+i)}}catch(s){t={error:s}}finally{try{o&&!o.done&&(r=n.return)&&r.call(n)}finally{if(t)throw t.error}}if(e.workflowStep!==ee.SEGMENTATION&&e.workflowStep!==ee.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}function Zr(e,t){switch(e){case $e.V2:return Vo(t);case $e.V3:return Xr(t);default:return console.warn("Unsupported CheckoutType, will use UCv3 as default. Given type: "+e),Xr(t)}}var Jr;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(Jr||(Jr={}));var k;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(k||(k={}));var N;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(N||(N={}));var Qr;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(Qr||(Qr={}));var Kr;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(Kr||(Kr={}));var en;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(en||(en={}));var tn;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(tn||(tn={}));var rn=()=>{};rn.createContext=rn;var qs=q.PUBLISHED,Bo=e=>{switch(e){case K.PRODUCTION:return"https://wcs.adobe.io";case K.STAGE:return"https://wcs-stage.adobe.io";case K.LOCAL:return"http://localhost:3002";default:return"https://wcs-stage.adobe.io"}},Wo=(e,t)=>{var r;return e.api_key=t.apiKey,e.landscape=(r=t.landscape)!==null&&r!==void 0?r:qs,e};var Ys=function(e,t,r,n){function o(i){return i instanceof r?i:new r(function(s){s(i)})}return new(r||(r=Promise))(function(i,s){function a(l){try{h(n.next(l))}catch(d){s(d)}}function c(l){try{h(n.throw(l))}catch(d){s(d)}}function h(l){l.done?i(l.value):o(l.value).then(a,c)}h((n=n.apply(e,t||[])).next())})},nn=class extends Wr{constructor(t){super(t),this.apiPaths={getWebCommerceArtifact:"web_commerce_artifact"},this.getWebCommerceArtifact=(r,n,o,i)=>Ys(this,void 0,void 0,function*(){let s=this.buildUrl(this.apiPaths.getWebCommerceArtifact,n,r,a=>Bo(a),(a,c)=>this.evaluateGetWebCommerceArtifactParams(a,c));return this.fetchOptions.fetch(s,{signal:i,headers:Object.assign({},this.commonHeaders()),mode:"cors"}).then(a=>this.failOnBadStatusOrParseBody(a,`GET ${s}`)).then(a=>{let h=a.data;return{data:this.transformDatum(h,o)}})})}evaluateGetWebCommerceArtifactParams(t,r){let n={};return this.setParams(n,"offer_selector_ids",r.offerSelectorIds.join(",")),this.setParams(n,"country",r.country),this.setParams(n,"language",r.language),this.setParams(n,"currency",r.currency),this.setParams(n,"locale",r.locale),this.setParams(n,"promotion_code",r.promotionCode),Wo(n,t)}},qo=nn;var Ht=e=>new qo(e).getWebCommerceArtifact;var Yo="tacocat.js";var jt=(e,t)=>String(e??"").toLowerCase()==String(t??"").toLowerCase(),Xo=e=>`${e??""}`.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t]??t)??"";function O(e,t={},{metadata:r=!0,search:n=!0,storage:o=!0}={}){let i;if(n&&i==null){let s=new URLSearchParams(window.location.search),a=Ye(n)?n:e;i=s.get(a)}if(o&&i==null){let s=Ye(o)?o:e;i=window.sessionStorage.getItem(s)??window.localStorage.getItem(s)}if(r&&i==null){let s=Qo(Ye(r)?r:e);i=document.documentElement.querySelector(`meta[name="${s}"]`)?.content}return i??t[e]}var Xe=()=>{};var Zo=e=>typeof e=="boolean",Ee=e=>typeof e=="function",Vt=e=>typeof e=="number",Jo=e=>e!=null&&typeof e=="object";var Ye=e=>typeof e=="string",on=e=>Ye(e)&&e,Ze=e=>Vt(e)&&Number.isFinite(e)&&e>0;function Je(e,t=r=>r==null||r===""){return e!=null&&Object.entries(e).forEach(([r,n])=>{t(n)&&delete e[r]}),e}function b(e,t){if(Zo(e))return e;let r=String(e);return r==="1"||r==="true"?!0:r==="0"||r==="false"?!1:t}function de(e,t,r){let n=Object.values(t);return n.find(o=>jt(o,e))??r??n[0]}function Qo(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,r,n)=>`${r}-${n}`).replace(/\W+/gu,"-").toLowerCase()}function Qe(e,t=1){return Vt(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:t}var Xs=Date.now(),sn=()=>`(+${Date.now()-Xs}ms)`,Bt=new Set,Zs=b(O("tacocat.debug",{},{metadata:!1}),typeof process<"u"&&process.env?.DEBUG);function Ko(e){let t=`[${Yo}/${e}]`,r=(s,a,...c)=>s?!0:(o(a,...c),!1),n=Zs?(s,...a)=>{console.debug(`${t} ${s}`,...a,sn())}:()=>{},o=(s,...a)=>{let c=`${t} ${s}`;Bt.forEach(([h])=>h(c,...a))};return{assert:r,debug:n,error:o,warn:(s,...a)=>{let c=`${t} ${s}`;Bt.forEach(([,h])=>h(c,...a))}}}function Js(e,t){let r=[e,t];return Bt.add(r),()=>{Bt.delete(r)}}Js((e,...t)=>{console.error(e,...t,sn())},(e,...t)=>{console.warn(e,...t,sn())});var Qs="no promo",ei="promo-tag",Ks="yellow",ea="neutral",ta=(e,t,r)=>{let n=i=>i||Qs,o=r?` (was "${n(t)}")`:"";return`${n(e)}${o}`},ra="cancel-context",ft=(e,t)=>{let r=e===ra,n=!r&&e?.length>0,o=(n||r)&&(t&&t!=e||!t&&!r),i=o&&n||!o&&!!t,s=i?e||t:void 0;return{effectivePromoCode:s,overridenPromoCode:e,className:i?ei:`${ei} no-promo`,text:ta(s,t,o),variant:i?Ks:ea,isOverriden:o}};var an=function(e,t){return an=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(r,n){r.__proto__=n}||function(r,n){for(var o in n)Object.prototype.hasOwnProperty.call(n,o)&&(r[o]=n[o])},an(e,t)};function gt(e,t){if(typeof t!="function"&&t!==null)throw new TypeError("Class extends value "+String(t)+" is not a constructor or null");an(e,t);function r(){this.constructor=e}e.prototype=t===null?Object.create(t):(r.prototype=t.prototype,new r)}var _=function(){return _=Object.assign||function(t){for(var r,n=1,o=arguments.length;n<o;n++){r=arguments[n];for(var i in r)Object.prototype.hasOwnProperty.call(r,i)&&(t[i]=r[i])}return t},_.apply(this,arguments)};function Wt(e,t,r){if(r||arguments.length===2)for(var n=0,o=t.length,i;n<o;n++)(i||!(n in t))&&(i||(i=Array.prototype.slice.call(t,0,n)),i[n]=t[n]);return e.concat(i||Array.prototype.slice.call(t))}var v;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(v||(v={}));var P;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(P||(P={}));var Ie;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(Ie||(Ie={}));function cn(e){return e.type===P.literal}function ti(e){return e.type===P.argument}function qt(e){return e.type===P.number}function Yt(e){return e.type===P.date}function Xt(e){return e.type===P.time}function Zt(e){return e.type===P.select}function Jt(e){return e.type===P.plural}function ri(e){return e.type===P.pound}function Qt(e){return e.type===P.tag}function Kt(e){return!!(e&&typeof e=="object"&&e.type===Ie.number)}function xt(e){return!!(e&&typeof e=="object"&&e.type===Ie.dateTime)}var ln=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var na=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function ni(e){var t={};return e.replace(na,function(r){var n=r.length;switch(r[0]){case"G":t.era=n===4?"long":n===5?"narrow":"short";break;case"y":t.year=n===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":t.month=["numeric","2-digit","short","long","narrow"][n-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":t.day=["numeric","2-digit"][n-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":t.weekday=n===4?"short":n===5?"narrow":"short";break;case"e":if(n<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][n-4];break;case"c":if(n<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][n-4];break;case"a":t.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":t.hourCycle="h12",t.hour=["numeric","2-digit"][n-1];break;case"H":t.hourCycle="h23",t.hour=["numeric","2-digit"][n-1];break;case"K":t.hourCycle="h11",t.hour=["numeric","2-digit"][n-1];break;case"k":t.hourCycle="h24",t.hour=["numeric","2-digit"][n-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":t.minute=["numeric","2-digit"][n-1];break;case"s":t.second=["numeric","2-digit"][n-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":t.timeZoneName=n<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),t}var oi=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function ci(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var t=e.split(oi).filter(function(u){return u.length>0}),r=[],n=0,o=t;n<o.length;n++){var i=o[n],s=i.split("/");if(s.length===0)throw new Error("Invalid number skeleton");for(var a=s[0],c=s.slice(1),h=0,l=c;h<l.length;h++){var d=l[h];if(d.length===0)throw new Error("Invalid number skeleton")}r.push({stem:a,options:c})}return r}function oa(e){return e.replace(/^(.*?)-/,"")}var ii=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,li=/^(@+)?(\+|#+)?$/g,ia=/(\*)(0+)|(#+)(0+)|(0+)/g,hi=/^(0+)$/;function si(e){var t={};return e.replace(li,function(r,n,o){return typeof o!="string"?(t.minimumSignificantDigits=n.length,t.maximumSignificantDigits=n.length):o==="+"?t.minimumSignificantDigits=n.length:n[0]==="#"?t.maximumSignificantDigits=n.length:(t.minimumSignificantDigits=n.length,t.maximumSignificantDigits=n.length+(typeof o=="string"?o.length:0)),""}),t}function di(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function sa(e){var t;if(e[0]==="E"&&e[1]==="E"?(t={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(t={notation:"scientific"},e=e.slice(1)),t){var r=e.slice(0,2);if(r==="+!"?(t.signDisplay="always",e=e.slice(2)):r==="+?"&&(t.signDisplay="exceptZero",e=e.slice(2)),!hi.test(e))throw new Error("Malformed concise eng/scientific notation");t.minimumIntegerDigits=e.length}return t}function ai(e){var t={},r=di(e);return r||t}function ui(e){for(var t={},r=0,n=e;r<n.length;r++){var o=n[r];switch(o.stem){case"percent":case"%":t.style="percent";continue;case"%x100":t.style="percent",t.scale=100;continue;case"currency":t.style="currency",t.currency=o.options[0];continue;case"group-off":case",_":t.useGrouping=!1;continue;case"precision-integer":case".":t.maximumFractionDigits=0;continue;case"measure-unit":case"unit":t.style="unit",t.unit=oa(o.options[0]);continue;case"compact-short":case"K":t.notation="compact",t.compactDisplay="short";continue;case"compact-long":case"KK":t.notation="compact",t.compactDisplay="long";continue;case"scientific":t=_(_(_({},t),{notation:"scientific"}),o.options.reduce(function(a,c){return _(_({},a),ai(c))},{}));continue;case"engineering":t=_(_(_({},t),{notation:"engineering"}),o.options.reduce(function(a,c){return _(_({},a),ai(c))},{}));continue;case"notation-simple":t.notation="standard";continue;case"unit-width-narrow":t.currencyDisplay="narrowSymbol",t.unitDisplay="narrow";continue;case"unit-width-short":t.currencyDisplay="code",t.unitDisplay="short";continue;case"unit-width-full-name":t.currencyDisplay="name",t.unitDisplay="long";continue;case"unit-width-iso-code":t.currencyDisplay="symbol";continue;case"scale":t.scale=parseFloat(o.options[0]);continue;case"integer-width":if(o.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");o.options[0].replace(ia,function(a,c,h,l,d,u){if(c)t.minimumIntegerDigits=h.length;else{if(l&&d)throw new Error("We currently do not support maximum integer digits");if(u)throw new Error("We currently do not support exact integer digits")}return""});continue}if(hi.test(o.stem)){t.minimumIntegerDigits=o.stem.length;continue}if(ii.test(o.stem)){if(o.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");o.stem.replace(ii,function(a,c,h,l,d,u){return h==="*"?t.minimumFractionDigits=c.length:l&&l[0]==="#"?t.maximumFractionDigits=l.length:d&&u?(t.minimumFractionDigits=d.length,t.maximumFractionDigits=d.length+u.length):(t.minimumFractionDigits=c.length,t.maximumFractionDigits=c.length),""}),o.options.length&&(t=_(_({},t),si(o.options[0])));continue}if(li.test(o.stem)){t=_(_({},t),si(o.stem));continue}var i=di(o.stem);i&&(t=_(_({},t),i));var s=sa(o.stem);s&&(t=_(_({},t),s))}return t}var hn,aa=new RegExp("^"+ln.source+"*"),ca=new RegExp(ln.source+"*$");function y(e,t){return{start:e,end:t}}var la=!!String.prototype.startsWith,ha=!!String.fromCodePoint,da=!!Object.fromEntries,ua=!!String.prototype.codePointAt,ma=!!String.prototype.trimStart,pa=!!String.prototype.trimEnd,fa=!!Number.isSafeInteger,ga=fa?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},un=!0;try{mi=xi("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),un=((hn=mi.exec("a"))===null||hn===void 0?void 0:hn[0])==="a"}catch{un=!1}var mi,pi=la?function(t,r,n){return t.startsWith(r,n)}:function(t,r,n){return t.slice(n,n+r.length)===r},mn=ha?String.fromCodePoint:function(){for(var t=[],r=0;r<arguments.length;r++)t[r]=arguments[r];for(var n="",o=t.length,i=0,s;o>i;){if(s=t[i++],s>1114111)throw RangeError(s+" is not a valid code point");n+=s<65536?String.fromCharCode(s):String.fromCharCode(((s-=65536)>>10)+55296,s%1024+56320)}return n},fi=da?Object.fromEntries:function(t){for(var r={},n=0,o=t;n<o.length;n++){var i=o[n],s=i[0],a=i[1];r[s]=a}return r},gi=ua?function(t,r){return t.codePointAt(r)}:function(t,r){var n=t.length;if(!(r<0||r>=n)){var o=t.charCodeAt(r),i;return o<55296||o>56319||r+1===n||(i=t.charCodeAt(r+1))<56320||i>57343?o:(o-55296<<10)+(i-56320)+65536}},xa=ma?function(t){return t.trimStart()}:function(t){return t.replace(aa,"")},va=pa?function(t){return t.trimEnd()}:function(t){return t.replace(ca,"")};function xi(e,t){return new RegExp(e,t)}var pn;un?(dn=xi("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),pn=function(t,r){var n;dn.lastIndex=r;var o=dn.exec(t);return(n=o[1])!==null&&n!==void 0?n:""}):pn=function(t,r){for(var n=[];;){var o=gi(t,r);if(o===void 0||yi(o)||ba(o))break;n.push(o),r+=o>=65536?2:1}return mn.apply(void 0,n)};var dn,vi=function(){function e(t,r){r===void 0&&(r={}),this.message=t,this.position={offset:0,line:1,column:1},this.ignoreTag=!!r.ignoreTag,this.requiresOtherClause=!!r.requiresOtherClause,this.shouldParseSkeletons=!!r.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(t,r,n){for(var o=[];!this.isEOF();){var i=this.char();if(i===123){var s=this.parseArgument(t,n);if(s.err)return s;o.push(s.val)}else{if(i===125&&t>0)break;if(i===35&&(r==="plural"||r==="selectordinal")){var a=this.clonePosition();this.bump(),o.push({type:P.pound,location:y(a,this.clonePosition())})}else if(i===60&&!this.ignoreTag&&this.peek()===47){if(n)break;return this.error(v.UNMATCHED_CLOSING_TAG,y(this.clonePosition(),this.clonePosition()))}else if(i===60&&!this.ignoreTag&&fn(this.peek()||0)){var s=this.parseTag(t,r);if(s.err)return s;o.push(s.val)}else{var s=this.parseLiteral(t,r);if(s.err)return s;o.push(s.val)}}}return{val:o,err:null}},e.prototype.parseTag=function(t,r){var n=this.clonePosition();this.bump();var o=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:P.literal,value:"<"+o+"/>",location:y(n,this.clonePosition())},err:null};if(this.bumpIf(">")){var i=this.parseMessage(t+1,r,!0);if(i.err)return i;var s=i.val,a=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!fn(this.char()))return this.error(v.INVALID_TAG,y(a,this.clonePosition()));var c=this.clonePosition(),h=this.parseTagName();return o!==h?this.error(v.UNMATCHED_CLOSING_TAG,y(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:P.tag,value:o,children:s,location:y(n,this.clonePosition())},err:null}:this.error(v.INVALID_TAG,y(a,this.clonePosition())))}else return this.error(v.UNCLOSED_TAG,y(n,this.clonePosition()))}else return this.error(v.INVALID_TAG,y(n,this.clonePosition()))},e.prototype.parseTagName=function(){var t=this.offset();for(this.bump();!this.isEOF()&&Ea(this.char());)this.bump();return this.message.slice(t,this.offset())},e.prototype.parseLiteral=function(t,r){for(var n=this.clonePosition(),o="";;){var i=this.tryParseQuote(r);if(i){o+=i;continue}var s=this.tryParseUnquoted(t,r);if(s){o+=s;continue}var a=this.tryParseLeftAngleBracket();if(a){o+=a;continue}break}var c=y(n,this.clonePosition());return{val:{type:P.literal,value:o,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!ya(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(t){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(t==="plural"||t==="selectordinal")break;return null;default:return null}this.bump();var r=[this.char()];for(this.bump();!this.isEOF();){var n=this.char();if(n===39)if(this.peek()===39)r.push(39),this.bump();else{this.bump();break}else r.push(n);this.bump()}return mn.apply(void 0,r)},e.prototype.tryParseUnquoted=function(t,r){if(this.isEOF())return null;var n=this.char();return n===60||n===123||n===35&&(r==="plural"||r==="selectordinal")||n===125&&t>0?null:(this.bump(),mn(n))},e.prototype.parseArgument=function(t,r){var n=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(v.EXPECT_ARGUMENT_CLOSING_BRACE,y(n,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(v.EMPTY_ARGUMENT,y(n,this.clonePosition()));var o=this.parseIdentifierIfPossible().value;if(!o)return this.error(v.MALFORMED_ARGUMENT,y(n,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(v.EXPECT_ARGUMENT_CLOSING_BRACE,y(n,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:P.argument,value:o,location:y(n,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(v.EXPECT_ARGUMENT_CLOSING_BRACE,y(n,this.clonePosition())):this.parseArgumentOptions(t,r,o,n);default:return this.error(v.MALFORMED_ARGUMENT,y(n,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var t=this.clonePosition(),r=this.offset(),n=pn(this.message,r),o=r+n.length;this.bumpTo(o);var i=this.clonePosition(),s=y(t,i);return{value:n,location:s}},e.prototype.parseArgumentOptions=function(t,r,n,o){var i,s=this.clonePosition(),a=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(a){case"":return this.error(v.EXPECT_ARGUMENT_TYPE,y(s,c));case"number":case"date":case"time":{this.bumpSpace();var h=null;if(this.bumpIf(",")){this.bumpSpace();var l=this.clonePosition(),d=this.parseSimpleArgStyleIfPossible();if(d.err)return d;var u=va(d.val);if(u.length===0)return this.error(v.EXPECT_ARGUMENT_STYLE,y(this.clonePosition(),this.clonePosition()));var p=y(l,this.clonePosition());h={style:u,styleLocation:p}}var f=this.tryParseArgumentClose(o);if(f.err)return f;var g=y(o,this.clonePosition());if(h&&pi(h?.style,"::",0)){var A=xa(h.style.slice(2));if(a==="number"){var d=this.parseNumberSkeletonFromString(A,h.styleLocation);return d.err?d:{val:{type:P.number,value:n,location:g,style:d.val},err:null}}else{if(A.length===0)return this.error(v.EXPECT_DATE_TIME_SKELETON,g);var u={type:Ie.dateTime,pattern:A,location:h.styleLocation,parsedOptions:this.shouldParseSkeletons?ni(A):{}},R=a==="date"?P.date:P.time;return{val:{type:R,value:n,location:g,style:u},err:null}}}return{val:{type:a==="number"?P.number:a==="date"?P.date:P.time,value:n,location:g,style:(i=h?.style)!==null&&i!==void 0?i:null},err:null}}case"plural":case"selectordinal":case"select":{var T=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(v.EXPECT_SELECT_ARGUMENT_OPTIONS,y(T,_({},T)));this.bumpSpace();var S=this.parseIdentifierIfPossible(),L=0;if(a!=="select"&&S.value==="offset"){if(!this.bumpIf(":"))return this.error(v.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,y(this.clonePosition(),this.clonePosition()));this.bumpSpace();var d=this.tryParseDecimalInteger(v.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,v.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(d.err)return d;this.bumpSpace(),S=this.parseIdentifierIfPossible(),L=d.val}var E=this.tryParsePluralOrSelectOptions(t,a,r,S);if(E.err)return E;var f=this.tryParseArgumentClose(o);if(f.err)return f;var $=y(o,this.clonePosition());return a==="select"?{val:{type:P.select,value:n,options:fi(E.val),location:$},err:null}:{val:{type:P.plural,value:n,options:fi(E.val),offset:L,pluralType:a==="plural"?"cardinal":"ordinal",location:$},err:null}}default:return this.error(v.INVALID_ARGUMENT_TYPE,y(s,c))}},e.prototype.tryParseArgumentClose=function(t){return this.isEOF()||this.char()!==125?this.error(v.EXPECT_ARGUMENT_CLOSING_BRACE,y(t,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var t=0,r=this.clonePosition();!this.isEOF();){var n=this.char();switch(n){case 39:{this.bump();var o=this.clonePosition();if(!this.bumpUntil("'"))return this.error(v.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,y(o,this.clonePosition()));this.bump();break}case 123:{t+=1,this.bump();break}case 125:{if(t>0)t-=1;else return{val:this.message.slice(r.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(r.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(t,r){var n=[];try{n=ci(t)}catch{return this.error(v.INVALID_NUMBER_SKELETON,r)}return{val:{type:Ie.number,tokens:n,location:r,parsedOptions:this.shouldParseSkeletons?ui(n):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(t,r,n,o){for(var i,s=!1,a=[],c=new Set,h=o.value,l=o.location;;){if(h.length===0){var d=this.clonePosition();if(r!=="select"&&this.bumpIf("=")){var u=this.tryParseDecimalInteger(v.EXPECT_PLURAL_ARGUMENT_SELECTOR,v.INVALID_PLURAL_ARGUMENT_SELECTOR);if(u.err)return u;l=y(d,this.clonePosition()),h=this.message.slice(d.offset,this.offset())}else break}if(c.has(h))return this.error(r==="select"?v.DUPLICATE_SELECT_ARGUMENT_SELECTOR:v.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,l);h==="other"&&(s=!0),this.bumpSpace();var p=this.clonePosition();if(!this.bumpIf("{"))return this.error(r==="select"?v.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:v.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,y(this.clonePosition(),this.clonePosition()));var f=this.parseMessage(t+1,r,n);if(f.err)return f;var g=this.tryParseArgumentClose(p);if(g.err)return g;a.push([h,{value:f.val,location:y(p,this.clonePosition())}]),c.add(h),this.bumpSpace(),i=this.parseIdentifierIfPossible(),h=i.value,l=i.location}return a.length===0?this.error(r==="select"?v.EXPECT_SELECT_ARGUMENT_SELECTOR:v.EXPECT_PLURAL_ARGUMENT_SELECTOR,y(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!s?this.error(v.MISSING_OTHER_CLAUSE,y(this.clonePosition(),this.clonePosition())):{val:a,err:null}},e.prototype.tryParseDecimalInteger=function(t,r){var n=1,o=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(n=-1);for(var i=!1,s=0;!this.isEOF();){var a=this.char();if(a>=48&&a<=57)i=!0,s=s*10+(a-48),this.bump();else break}var c=y(o,this.clonePosition());return i?(s*=n,ga(s)?{val:s,err:null}:this.error(r,c)):this.error(t,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var t=this.position.offset;if(t>=this.message.length)throw Error("out of bound");var r=gi(this.message,t);if(r===void 0)throw Error("Offset "+t+" is at invalid UTF-16 code unit boundary");return r},e.prototype.error=function(t,r){return{val:null,err:{kind:t,message:this.message,location:r}}},e.prototype.bump=function(){if(!this.isEOF()){var t=this.char();t===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=t<65536?1:2)}},e.prototype.bumpIf=function(t){if(pi(this.message,t,this.offset())){for(var r=0;r<t.length;r++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(t){var r=this.offset(),n=this.message.indexOf(t,r);return n>=0?(this.bumpTo(n),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(t){if(this.offset()>t)throw Error("targetOffset "+t+" must be greater than or equal to the current offset "+this.offset());for(t=Math.min(t,this.message.length);;){var r=this.offset();if(r===t)break;if(r>t)throw Error("targetOffset "+t+" is at invalid UTF-16 code unit boundary");if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&yi(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var t=this.char(),r=this.offset(),n=this.message.charCodeAt(r+(t>=65536?2:1));return n??null},e}();function fn(e){return e>=97&&e<=122||e>=65&&e<=90}function ya(e){return fn(e)||e===47}function Ea(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function yi(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function ba(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function gn(e){e.forEach(function(t){if(delete t.location,Zt(t)||Jt(t))for(var r in t.options)delete t.options[r].location,gn(t.options[r].value);else qt(t)&&Kt(t.style)||(Yt(t)||Xt(t))&&xt(t.style)?delete t.style.location:Qt(t)&&gn(t.children)})}function Ei(e,t){t===void 0&&(t={}),t=_({shouldParseSkeletons:!0,requiresOtherClause:!0},t);var r=new vi(e,t).parse();if(r.err){var n=SyntaxError(v[r.err.kind]);throw n.location=r.err.location,n.originalMessage=r.err.message,n}return t?.captureLocation||gn(r.val),r.val}function vt(e,t){var r=t&&t.cache?t.cache:Pa,n=t&&t.serializer?t.serializer:Ta,o=t&&t.strategy?t.strategy:wa;return o(e,{cache:r,serializer:n})}function _a(e){return e==null||typeof e=="number"||typeof e=="boolean"}function bi(e,t,r,n){var o=_a(n)?n:r(n),i=t.get(o);return typeof i>"u"&&(i=e.call(this,n),t.set(o,i)),i}function _i(e,t,r){var n=Array.prototype.slice.call(arguments,3),o=r(n),i=t.get(o);return typeof i>"u"&&(i=e.apply(this,n),t.set(o,i)),i}function xn(e,t,r,n,o){return r.bind(t,e,n,o)}function wa(e,t){var r=e.length===1?bi:_i;return xn(e,this,r,t.cache.create(),t.serializer)}function Sa(e,t){return xn(e,this,_i,t.cache.create(),t.serializer)}function Aa(e,t){return xn(e,this,bi,t.cache.create(),t.serializer)}var Ta=function(){return JSON.stringify(arguments)};function vn(){this.cache=Object.create(null)}vn.prototype.get=function(e){return this.cache[e]};vn.prototype.set=function(e,t){this.cache[e]=t};var Pa={create:function(){return new vn}},er={variadic:Sa,monadic:Aa};var ke;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(ke||(ke={}));var yt=function(e){gt(t,e);function t(r,n,o){var i=e.call(this,r)||this;return i.code=n,i.originalMessage=o,i}return t.prototype.toString=function(){return"[formatjs Error: "+this.code+"] "+this.message},t}(Error);var yn=function(e){gt(t,e);function t(r,n,o,i){return e.call(this,'Invalid values for "'+r+'": "'+n+'". Options are "'+Object.keys(o).join('", "')+'"',ke.INVALID_VALUE,i)||this}return t}(yt);var wi=function(e){gt(t,e);function t(r,n,o){return e.call(this,'Value for "'+r+'" must be of type '+n,ke.INVALID_VALUE,o)||this}return t}(yt);var Si=function(e){gt(t,e);function t(r,n){return e.call(this,'The intl string context variable "'+r+'" was not provided to the string "'+n+'"',ke.MISSING_VALUE,n)||this}return t}(yt);var D;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(D||(D={}));function Ca(e){return e.length<2?e:e.reduce(function(t,r){var n=t[t.length-1];return!n||n.type!==D.literal||r.type!==D.literal?t.push(r):n.value+=r.value,t},[])}function Oa(e){return typeof e=="function"}function Et(e,t,r,n,o,i,s){if(e.length===1&&cn(e[0]))return[{type:D.literal,value:e[0].value}];for(var a=[],c=0,h=e;c<h.length;c++){var l=h[c];if(cn(l)){a.push({type:D.literal,value:l.value});continue}if(ri(l)){typeof i=="number"&&a.push({type:D.literal,value:r.getNumberFormat(t).format(i)});continue}var d=l.value;if(!(o&&d in o))throw new Si(d,s);var u=o[d];if(ti(l)){(!u||typeof u=="string"||typeof u=="number")&&(u=typeof u=="string"||typeof u=="number"?String(u):""),a.push({type:typeof u=="string"?D.literal:D.object,value:u});continue}if(Yt(l)){var p=typeof l.style=="string"?n.date[l.style]:xt(l.style)?l.style.parsedOptions:void 0;a.push({type:D.literal,value:r.getDateTimeFormat(t,p).format(u)});continue}if(Xt(l)){var p=typeof l.style=="string"?n.time[l.style]:xt(l.style)?l.style.parsedOptions:void 0;a.push({type:D.literal,value:r.getDateTimeFormat(t,p).format(u)});continue}if(qt(l)){var p=typeof l.style=="string"?n.number[l.style]:Kt(l.style)?l.style.parsedOptions:void 0;p&&p.scale&&(u=u*(p.scale||1)),a.push({type:D.literal,value:r.getNumberFormat(t,p).format(u)});continue}if(Qt(l)){var f=l.children,g=l.value,A=o[g];if(!Oa(A))throw new wi(g,"function",s);var R=Et(f,t,r,n,o,i),T=A(R.map(function(E){return E.value}));Array.isArray(T)||(T=[T]),a.push.apply(a,T.map(function(E){return{type:typeof E=="string"?D.literal:D.object,value:E}}))}if(Zt(l)){var S=l.options[u]||l.options.other;if(!S)throw new yn(l.value,u,Object.keys(l.options),s);a.push.apply(a,Et(S.value,t,r,n,o));continue}if(Jt(l)){var S=l.options["="+u];if(!S){if(!Intl.PluralRules)throw new yt(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,ke.MISSING_INTL_API,s);var L=r.getPluralRules(t,{type:l.pluralType}).select(u-(l.offset||0));S=l.options[L]||l.options.other}if(!S)throw new yn(l.value,u,Object.keys(l.options),s);a.push.apply(a,Et(S.value,t,r,n,o,u-(l.offset||0)));continue}}return Ca(a)}function La(e,t){return t?_(_(_({},e||{}),t||{}),Object.keys(e).reduce(function(r,n){return r[n]=_(_({},e[n]),t[n]||{}),r},{})):e}function Na(e,t){return t?Object.keys(e).reduce(function(r,n){return r[n]=La(e[n],t[n]),r},_({},e)):e}function En(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function Ra(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:vt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.NumberFormat).bind.apply(t,Wt([void 0],r)))},{cache:En(e.number),strategy:er.variadic}),getDateTimeFormat:vt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.DateTimeFormat).bind.apply(t,Wt([void 0],r)))},{cache:En(e.dateTime),strategy:er.variadic}),getPluralRules:vt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.PluralRules).bind.apply(t,Wt([void 0],r)))},{cache:En(e.pluralRules),strategy:er.variadic})}}var Ai=function(){function e(t,r,n,o){var i=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(s){var a=i.formatToParts(s);if(a.length===1)return a[0].value;var c=a.reduce(function(h,l){return!h.length||l.type!==D.literal||typeof h[h.length-1]!="string"?h.push(l.value):h[h.length-1]+=l.value,h},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(s){return Et(i.ast,i.locales,i.formatters,i.formats,s,void 0,i.message)},this.resolvedOptions=function(){return{locale:Intl.NumberFormat.supportedLocalesOf(i.locales)[0]}},this.getAst=function(){return i.ast},typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:o?.ignoreTag})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Na(e.formats,n),this.locales=r,this.formatters=o&&o.formatters||Ra(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.__parse=Ei,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var Ti=Ai;var $a=/[0-9\-+#]/,Ia=/[^\d\-+#]/g;function Pi(e){return e.search($a)}function ka(e="#.##"){let t={},r=e.length,n=Pi(e);t.prefix=n>0?e.substring(0,n):"";let o=Pi(e.split("").reverse().join("")),i=r-o,s=e.substring(i,i+1),a=i+(s==="."||s===","?1:0);t.suffix=o>0?e.substring(a,r):"",t.mask=e.substring(n,a),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let c=t.mask.match(Ia);return t.decimal=c&&c[c.length-1]||".",t.separator=c&&c[1]&&c[0]||",",c=t.mask.split(t.decimal),t.integer=c[0],t.fraction=c[1],t}function Ma(e,t,r){let n=!1,o={value:e};e<0&&(n=!0,o.value=-o.value),o.sign=n?"-":"",o.value=Number(o.value).toFixed(t.fraction&&t.fraction.length),o.value=Number(o.value).toString();let i=t.fraction&&t.fraction.lastIndexOf("0"),[s="0",a=""]=o.value.split(".");return(!a||a&&a.length<=i)&&(a=i<0?"":(+("0."+a)).toFixed(i+1).replace("0.","")),o.integer=s,o.fraction=a,Ua(o,t),(o.result==="0"||o.result==="")&&(n=!1,o.sign=""),!n&&t.maskHasPositiveSign?o.sign="+":n&&t.maskHasPositiveSign?o.sign="-":n&&(o.sign=r&&r.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),o}function Ua(e,t){e.result="";let r=t.integer.split(t.separator),n=r.join(""),o=n&&n.indexOf("0");if(o>-1)for(;e.integer.length<n.length-o;)e.integer="0"+e.integer;else Number(e.integer)===0&&(e.integer="");let i=r[1]&&r[r.length-1].length;if(i){let s=e.integer.length,a=s%i;for(let c=0;c<s;c++)e.result+=e.integer.charAt(c),!((c-a+1)%i)&&c<s-i&&(e.result+=t.separator)}else e.result=e.integer;return e.result+=t.fraction&&e.fraction?t.decimal+e.fraction:"",e}function Da(e,t,r={}){if(!e||isNaN(Number(t)))return t;let n=ka(e),o=Ma(t,n,r);return n.prefix+o.sign+o.result+n.suffix}var Ci=Da;var Oi=".",Ga=",",Ni=/^\s+/,Ri=/\s+$/,Li="&nbsp;",bt={MONTH:"MONTH",YEAR:"YEAR"},za={[N.ANNUAL]:12,[N.MONTHLY]:1,[N.THREE_YEARS]:36,[N.TWO_YEARS]:24},Fa={CHF:e=>Math.round(e*20)/20},bn=(e,t)=>({accept:e,round:t}),Ha=[bn(({divisor:e,price:t})=>t%e==0,({divisor:e,price:t})=>t/e),bn(({usePrecision:e})=>e,({divisor:e,price:t})=>Math.ceil(Math.floor(t*1e4/e)/100)/100),bn(()=>!0,({divisor:e,price:t})=>Math.ceil(Math.floor(t*100/e)/100))],_n={[k.YEAR]:{[N.MONTHLY]:bt.MONTH,[N.ANNUAL]:bt.YEAR},[k.MONTH]:{[N.MONTHLY]:bt.MONTH}},ja=(e,t)=>e.indexOf(`'${t}'`)===0,Va=(e,t=!0)=>{let r=e.replace(/'.*?'/,"").trim(),n=Ii(r);return!!n?t||(r=r.replace(/[,\.]0+/,n)):r=r.replace(/\s?(#.*0)(?!\s)?/,"$&"+Wa(e)),r},Ba=e=>{let t=qa(e),r=ja(e,t),n=e.replace(/'.*?'/,""),o=Ni.test(n)||Ri.test(n);return{currencySymbol:t,isCurrencyFirst:r,hasCurrencySpace:o}},$i=e=>e.replace(Ni,Li).replace(Ri,Li),Wa=e=>e.match(/#(.?)#/)?.[1]===Oi?Ga:Oi,qa=e=>e.match(/'(.*?)'/)?.[1]??"",Ii=e=>e.match(/0(.?)0/)?.[1]??"";function tr({formatString:e,price:t,usePrecision:r,isIndianPrice:n=!1},o,i=s=>s){let{currencySymbol:s,isCurrencyFirst:a,hasCurrencySpace:c}=Ba(e),h=r?Ii(e):"",l=Va(e,r),d=r?2:0,u=i(t,{currencySymbol:s}),p=n?u.toLocaleString("hi-IN",{minimumFractionDigits:d,maximumFractionDigits:d}):Ci(l,u),f=r?p.lastIndexOf(h):p.length,g=p.substring(0,f),A=p.substring(f+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,p).replace(/SYMBOL/,s),currencySymbol:s,decimals:A,decimalsDelimiter:h,hasCurrencySpace:c,integer:g,isCurrencyFirst:a,recurrenceTerm:o}}var ki=e=>{let{commitment:t,term:r,usePrecision:n}=e,o=za[r]??1;return tr(e,o>1?bt.MONTH:_n[t]?.[r],(i,{currencySymbol:s})=>{let a={divisor:o,price:i,usePrecision:n},{round:c}=Ha.find(({accept:l})=>l(a));if(!c)throw new Error(`Missing rounding rule for: ${JSON.stringify(a)}`);return(Fa[s]??(l=>l))(c(a))})},Mi=({commitment:e,term:t,...r})=>tr(r,_n[e]?.[t]),Ui=e=>{let{commitment:t,term:r}=e;return t===k.YEAR&&r===N.MONTHLY?tr(e,bt.YEAR,n=>n*12):tr(e,_n[t]?.[r])};var Ya={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at {alternativePrice}",strikethroughAriaLabel:"Regularly at {strikethroughPrice}"},Xa=Ko("ConsonantTemplates/price"),Za=/<.+?>/g,Y={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAnnual:"price-annual",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Me={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel"},Ja="TAX_EXCLUSIVE",Qa=e=>Jo(e)?Object.entries(e).filter(([,t])=>Ye(t)||Vt(t)||t===!0).reduce((t,[r,n])=>t+` ${r}${n===!0?"":'="'+Xo(n)+'"'}`,""):"",ne=(e,t,r,n=!1)=>`<span class="${e}${t?"":" "+Y.disabled}"${Qa(r)}>${n?$i(t):t??""}</span>`;function Ka(e,{accessibleLabel:t,currencySymbol:r,decimals:n,decimalsDelimiter:o,hasCurrencySpace:i,integer:s,isCurrencyFirst:a,recurrenceLabel:c,perUnitLabel:h,taxInclusivityLabel:l},d={}){let u=ne(Y.currencySymbol,r),p=ne(Y.currencySpace,i?"&nbsp;":""),f="";return a&&(f+=u+p),f+=ne(Y.integer,s),f+=ne(Y.decimalsDelimiter,o),f+=ne(Y.decimals,n),a||(f+=p+u),f+=ne(Y.recurrence,c,null,!0),f+=ne(Y.unitType,h,null,!0),f+=ne(Y.taxInclusivity,l,!0),ne(e,f,{...d,"aria-label":t})}var Ue=({displayOptical:e=!1,displayStrikethrough:t=!1,displayAnnual:r=!1}={})=>({country:n,displayFormatted:o=!0,displayRecurrence:i=!0,displayPerUnit:s=!1,displayTax:a=!1,language:c,literals:h={}}={},{commitment:l,formatString:d,price:u,priceWithoutDiscount:p,taxDisplay:f,taxTerm:g,term:A,usePrecision:R}={},T={})=>{Object.entries({country:n,formatString:d,language:c,price:u}).forEach(([ce,vr])=>{if(vr==null)throw new Error(`Argument "${ce}" is missing`)});let S={...Ya,...h},L=`${c.toLowerCase()}-${n.toUpperCase()}`;function E(ce,vr){let yr=S[ce];if(yr==null)return"";try{return new Ti(yr.replace(Za,""),L).format(vr)}catch{return Xa.error("Failed to format literal:",yr),""}}let $=t&&p?p:u,G=e?ki:Mi;r&&(G=Ui);let{accessiblePrice:J,recurrenceTerm:Q,...M}=G({commitment:l,formatString:d,term:A,price:e?u:$,usePrecision:R,isIndianPrice:n==="IN"}),W=J,fe="";if(b(i)&&Q){let ce=E(Me.recurrenceAriaLabel,{recurrenceTerm:Q});ce&&(W+=" "+ce),fe=E(Me.recurrenceLabel,{recurrenceTerm:Q})}let we="";if(b(s)){we=E(Me.perUnitLabel,{perUnit:"LICENSE"});let ce=E(Me.perUnitAriaLabel,{perUnit:"LICENSE"});ce&&(W+=" "+ce)}let ae="";b(a)&&g&&(ae=E(f===Ja?Me.taxExclusiveLabel:Me.taxInclusiveLabel,{taxTerm:g}),ae&&(W+=" "+ae)),t&&(W=E(Me.strikethroughAriaLabel,{strikethroughPrice:W}));let te=Y.container;if(e&&(te+=" "+Y.containerOptical),t&&(te+=" "+Y.containerStrikethrough),r&&(te+=" "+Y.containerAnnual),b(o))return Ka(te,{...M,accessibleLabel:W,recurrenceLabel:fe,perUnitLabel:we,taxInclusivityLabel:ae},T);let{currencySymbol:ze,decimals:At,decimalsDelimiter:Tt,hasCurrencySpace:nt,integer:xr,isCurrencyFirst:us}=M,Fe=[xr,Tt,At];us?(Fe.unshift(nt?"\xA0":""),Fe.unshift(ze)):(Fe.push(nt?"\xA0":""),Fe.push(ze)),Fe.push(fe,we,ae);let ms=Fe.join("");return ne(te,ms,T)},Di=()=>(e,t,r)=>{let o=(e.displayOldPrice===void 0||b(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${Ue()(e,t,r)}${o?"&nbsp;"+Ue({displayStrikethrough:!0})(e,t,r):""}`};var wn=Ue(),Sn=Di(),An=Ue({displayOptical:!0}),Tn=Ue({displayStrikethrough:!0}),Pn=Ue({displayAnnual:!0});var ec=(e,t)=>{if(!(!Ze(e)||!Ze(t)))return Math.floor((t-e)/t*100)},Gi=()=>(e,t,r)=>{let{price:n,priceWithoutDiscount:o}=t,i=ec(n,o);return i===void 0?'<span class="no-discount"></span>':`<span class="discount">${i}%</span>`};var Cn=Gi();var On="ABM",Ln="PUF",Nn="M2M",Rn="PERPETUAL",zi="P3Y",tc="TAX_INCLUSIVE_DETAILS",rc="TAX_EXCLUSIVE",Fi={ABM:On,PUF:Ln,M2M:Nn,PERPETUAL:Rn,P3Y:zi},wd={[On]:{commitment:k.YEAR,term:N.MONTHLY},[Ln]:{commitment:k.YEAR,term:N.ANNUAL},[Nn]:{commitment:k.MONTH,term:N.MONTHLY},[Rn]:{commitment:k.PERPETUAL,term:void 0},[zi]:{commitment:k.THREE_MONTHS,term:N.P3Y}},Hi="Value is not an offer",$n=e=>{if(typeof e!="object")return Hi;let{commitment:t,term:r}=e,n=nc(t,r);return{...e,planType:n}};var nc=(e,t)=>{if(e===void 0)return Hi;if(e===""&&t==="")return"";let r="";return e===k.YEAR?t===N.MONTHLY?r=On:t===N.ANNUAL&&(r=Ln):e===k.MONTH?t===N.MONTHLY&&(r=Nn):e===k.PERPETUAL&&(r=Rn),r};function In(e){let{priceDetails:t}=e,{price:r,priceWithoutDiscount:n,priceWithoutTax:o,priceWithoutDiscountAndTax:i,taxDisplay:s}=t;if(s!==tc)return e;let a={...e,priceDetails:{...t,price:o??r,priceWithoutDiscount:i??n,taxDisplay:rc}};return a.offerType==="TRIAL"&&a.priceDetails.price===0&&(a.priceDetails.price=a.priceDetails.priceWithoutDiscount),a}var{freeze:De}=Object,ue=De({...$e}),me=De({...ee}),Z=De({...K}),ji=De({...k}),_t=De({...pt}),Vi=De({...Fi}),Bi=De({...N});var Fn={};fs(Fn,{CLASS_NAME_FAILED:()=>rr,CLASS_NAME_PENDING:()=>nr,CLASS_NAME_RESOLVED:()=>or,ERROR_MESSAGE_BAD_REQUEST:()=>kn,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>Un,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Mn,EVENT_TYPE_ERROR:()=>oc,EVENT_TYPE_FAILED:()=>ir,EVENT_TYPE_PENDING:()=>sr,EVENT_TYPE_READY:()=>Ke,EVENT_TYPE_RESOLVED:()=>ar,LOG_NAMESPACE:()=>Dn,PARAM_AOS_API_KEY:()=>ic,PARAM_ENV:()=>Gn,PARAM_LANDSCAPE:()=>zn,PARAM_WCS_API_KEY:()=>sc,STATE_FAILED:()=>oe,STATE_PENDING:()=>ie,STATE_RESOLVED:()=>se,TAG_NAME_SERVICE:()=>be});var rr="placeholder-failed",nr="placeholder-pending",or="placeholder-resolved",kn="Bad WCS request",Mn="Commerce offer not found",Un="Literals URL not provided",oc="wcms:commerce:error",ir="wcms:placeholder:failed",sr="wcms:placeholder:pending",Ke="wcms:commerce:ready",ar="wcms:placeholder:resolved",Dn="wcms/commerce",Gn="commerce.env",zn="commerce.landscape",ic="commerce.aosKey",sc="commerce.wcsKey",oe="failed",ie="pending",se="resolved",be="wcms-commerce";var Hn={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals"],serializableTypes:["Array","Object"],sampleRate:30,tags:"consumer=milo/commerce"},Wi=new Set,ac=e=>e instanceof Error||typeof e.originatingRequest=="string";function qi(e){if(e==null)return;let t=typeof e;if(t==="function"){let{name:r}=e;return r?`${t} ${r}`:t}if(t==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:n,originatingRequest:o,status:i}=e;return[n,i,o].filter(s=>s).join(" ")}let r=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!Hn.serializableTypes.includes(r))return r}return e}function cc(e,t){if(!Hn.ignoredProperties.includes(e))return qi(t)}var jn={append(e){let{delimiter:t,sampleRate:r,tags:n,clientId:o}=Hn,{message:i,params:s}=e,a=[],c=i,h=[];s.forEach(u=>{u!=null&&(ac(u)?a:h).push(u)}),a.length&&(c+=" ",c+=a.map(qi).join(" "));let{pathname:l,search:d}=window.location;c+=`${t}page=`,c+=l+d,h.length&&(c+=`${t}facts=`,c+=JSON.stringify(h,cc)),Wi.has(c)||(Wi.add(c),window.lana?.log(c,{sampleRate:r,tags:n,clientId:o}))}};var w=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflow:ue.V3,checkoutWorkflowStep:me.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,domainSwitch:!1,env:Z.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsBufferDelay:1,wcsEnv:_t.PRODUCTION,landscape:q.PUBLISHED,wcsBufferLimit:1});function Yi(e,{once:t=!1}={}){let r=null;function n(){let o=document.querySelector(be);o!==r&&(r=o,o&&e(o))}return document.addEventListener(Ke,n,{once:t}),_e(n),()=>document.removeEventListener(Ke,n)}function wt(e,{country:t,forceTaxExclusive:r,perpetual:n}){let o;if(e.length<2)o=e;else{let i=t==="GB"||n?"EN":"MULT",[s,a]=e;o=[s.language===i?s:a]}return r&&(o=o.map(In)),o}var _e=e=>window.setTimeout(e);function et(e,t=1){if(e==null)return[t];let r=(Array.isArray(e)?e:String(e).split(",")).map(Qe).filter(Ze);return r.length||(r=[t]),r}function cr(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(on)}function j(){return window.customElements.get(be)?.instance}var lc="en_US",m={ar:"AR_es",be_en:"BE_en",be_fr:"BE_fr",be_nl:"BE_nl",br:"BR_pt",ca:"CA_en",ch_de:"CH_de",ch_fr:"CH_fr",ch_it:"CH_it",cl:"CL_es",co:"CO_es",la:"DO_es",mx:"MX_es",pe:"PE_es",africa:"MU_en",dk:"DK_da",de:"DE_de",ee:"EE_et",eg_ar:"EG_ar",eg_en:"EG_en",es:"ES_es",fr:"FR_fr",gr_el:"GR_el",gr_en:"GR_en",ie:"IE_en",il_he:"IL_iw",it:"IT_it",lv:"LV_lv",lt:"LT_lt",lu_de:"LU_de",lu_en:"LU_en",lu_fr:"LU_fr",my_en:"MY_en",my_ms:"MY_ms",hu:"HU_hu",mt:"MT_en",mena_en:"DZ_en",mena_ar:"DZ_ar",nl:"NL_nl",no:"NO_nb",pl:"PL_pl",pt:"PT_pt",ro:"RO_ro",si:"SI_sl",sk:"SK_sk",fi:"FI_fi",se:"SE_sv",tr:"TR_tr",uk:"GB_en",at:"AT_de",cz:"CZ_cs",bg:"BG_bg",ru:"RU_ru",ua:"UA_uk",au:"AU_en",in_en:"IN_en",in_hi:"IN_hi",id_en:"ID_en",id_id:"ID_in",nz:"NZ_en",sa_ar:"SA_ar",sa_en:"SA_en",sg:"SG_en",cn:"CN_zh-Hans",tw:"TW_zh-Hant",hk_zh:"HK_zh-hant",jp:"JP_ja",kr:"KR_ko",za:"ZA_en",ng:"NG_en",cr:"CR_es",ec:"EC_es",pr:"US_es",gt:"GT_es",cis_en:"AZ_en",cis_ru:"AZ_ru",sea:"SG_en",th_en:"TH_en",th_th:"TH_th"},pe=Object.freeze({LOCAL:"local",PROD:"prod",STAGE:"stage"});function hc({locale:e={}}={}){if(!e.prefix)return{country:w.country,language:w.language,locale:lc};let t=e.prefix.replace("/","")??"",[r=w.country,n=w.language]=(m[t]??t).split("_",2);return r=r.toUpperCase(),n=n.toLowerCase(),{country:r,language:n,locale:`${n}_${r}`}}function Xi(e={}){let{commerce:t={},locale:r=void 0}=e,o=(e.env?.name===pe.PROD?pe.PROD:de(O(Gn,t,{metadata:!1}),pe,pe.PROD))===pe.STAGE?Z.STAGE:Z.PRODUCTION,i=O("checkoutClientId",t)??w.checkoutClientId,s=de(O("checkoutWorkflow",t),ue,w.checkoutWorkflow),a=me.CHECKOUT;s===ue.V3&&(a=de(O("checkoutWorkflowStep",t),me,w.checkoutWorkflowStep));let c=b(O("displayOldPrice",t),w.displayOldPrice),h=b(O("displayPerUnit",t),w.displayPerUnit),l=b(O("displayRecurrence",t),w.displayRecurrence),d=b(O("displayTax",t),w.displayTax),u=b(O("entitlement",t),w.entitlement),p=b(O("modal",t),w.modal),f=b(O("forceTaxExclusive",t),w.forceTaxExclusive),g=O("promotionCode",t)??w.promotionCode,A=et(O("quantity",t)),R=O("wcsApiKey",t)??w.wcsApiKey,T=e.env?.name===pe.PROD?q.PUBLISHED:de(O(zn,t),q,w.landscape),S=Qe(O("wcsBufferDelay",t),w.wcsBufferDelay),L=Qe(O("wcsBufferLimit",t),w.wcsBufferLimit),E=b(O("domain.switch",t),!1);return{...hc({locale:r}),displayOldPrice:c,checkoutClientId:i,checkoutWorkflow:s,checkoutWorkflowStep:a,displayPerUnit:h,displayRecurrence:l,displayTax:d,entitlement:u,extraOptions:w.extraOptions,modal:p,env:o,forceTaxExclusive:f,priceLiteralsURL:t.priceLiteralsURL,priceLiteralsPromise:t.priceLiteralsPromise,promotionCode:g,quantity:A,wcsApiKey:R,wcsBufferDelay:S,wcsBufferLimit:L,wcsEnv:o===Z.STAGE?_t.STAGE:_t.PRODUCTION,landscape:T,domainSwitch:E}}var Ji="debug",dc="error",uc="info",mc="warn",pc=Date.now(),Vn=new Set,Bn=new Set,Zi=new Map,St=Object.freeze({DEBUG:Ji,ERROR:dc,INFO:uc,WARN:mc}),Qi={append({level:e,message:t,params:r,timestamp:n,source:o}){console[e](`${n}ms [${o}] %c${t}`,"font-weight: bold;",...r)}},Ki={filter:({level:e})=>e!==Ji},fc={filter:()=>!1};function gc(e,t,r,n,o){return{level:e,message:t,namespace:r,get params(){if(n.length===1){let[i]=n;Ee(i)&&(n=i(),Array.isArray(n)||(n=[n]))}return n},source:o,timestamp:Date.now()-pc}}function xc(e){[...Bn].every(t=>t(e))&&Vn.forEach(t=>t(e))}function es(e){let t=(Zi.get(e)??0)+1;Zi.set(e,t);let r=`${e} #${t}`,n=i=>(s,...a)=>xc(gc(i,s,e,a,r)),o=Object.seal({id:r,namespace:e,module(i){return es(`${o.namespace}/${i}`)},debug:n(St.DEBUG),error:n(St.ERROR),info:n(St.INFO),warn:n(St.WARN)});return o}function lr(...e){e.forEach(t=>{let{append:r,filter:n}=t;Ee(n)?Bn.add(n):Ee(r)&&Vn.add(r)})}function vc(e={}){let{name:t}=e,r=b(O("commerce.debug",{search:!0,storage:!0}),t===pe.LOCAL);return lr(r?Qi:Ki),t===pe.PROD&&lr(jn),F}function yc(){Vn.clear(),Bn.clear()}var F={...es(Dn),Level:St,Plugins:{consoleAppender:Qi,debugFilter:Ki,quietFilter:fc,lanaAppender:jn},init:vc,reset:yc,use:lr};var Ec={CLASS_NAME_FAILED:rr,CLASS_NAME_PENDING:nr,CLASS_NAME_RESOLVED:or,EVENT_TYPE_FAILED:ir,EVENT_TYPE_PENDING:sr,EVENT_TYPE_RESOLVED:ar,STATE_FAILED:oe,STATE_PENDING:ie,STATE_RESOLVED:se},bc={[oe]:rr,[ie]:nr,[se]:or},_c={[oe]:ir,[ie]:sr,[se]:ar},ur=new WeakMap;function V(e){if(!ur.has(e)){let t=F.module(e.constructor.is);ur.set(e,{changes:new Map,connected:!1,dispose:Xe,error:void 0,log:t,options:void 0,promises:[],state:ie,timer:null,value:void 0,version:0})}return ur.get(e)}function hr(e){let t=V(e),{error:r,promises:n,state:o}=t;(o===se||o===oe)&&(t.promises=[],o===se?n.forEach(({resolve:i})=>i(e)):o===oe&&n.forEach(({reject:i})=>i(r))),e.dispatchEvent(new CustomEvent(_c[o],{bubbles:!0}))}function dr(e){let t=ur.get(e);[oe,ie,se].forEach(r=>{e.classList.toggle(bc[r],r===t.state)})}var wc={get error(){return V(this).error},get log(){return V(this).log},get options(){return V(this).options},get state(){return V(this).state},get value(){return V(this).value},attributeChangedCallback(e,t,r){V(this).changes.set(e,r),this.requestUpdate()},connectedCallback(){V(this).dispose=Yi(()=>this.requestUpdate(!0))},disconnectedCallback(){let e=V(this);e.connected&&(e.connected=!1,e.log.debug("Disconnected:",{element:this})),e.dispose(),e.dispose=Xe},onceSettled(){let{error:e,promises:t,state:r}=V(this);return se===r?Promise.resolve(this):oe===r?Promise.reject(e):new Promise((n,o)=>{t.push({resolve:n,reject:o})})},toggleResolved(e,t,r){let n=V(this);return e!==n.version?!1:(r!==void 0&&(n.options=r),n.state=se,n.value=t,dr(this),this.log.debug("Resolved:",{element:this,value:t}),_e(()=>hr(this)),!0)},toggleFailed(e,t,r){let n=V(this);return e!==n.version?!1:(r!==void 0&&(n.options=r),n.error=t,n.state=oe,dr(this),n.log.error("Failed:",{element:this,error:t}),_e(()=>hr(this)),!0)},togglePending(e){let t=V(this);return t.version++,e&&(t.options=e),t.state=ie,dr(this),_e(()=>hr(this)),t.version},requestUpdate(e=!1){if(!this.isConnected||!j())return;let t=V(this);if(t.timer)return;let{error:r,options:n,state:o,value:i,version:s}=t;t.state=ie,t.timer=_e(async()=>{t.timer=null;let a=null;if(t.changes.size&&(a=Object.fromEntries(t.changes.entries()),t.changes.clear()),t.connected?t.log.debug("Updated:",{element:this,changes:a}):(t.connected=!0,t.log.debug("Connected:",{element:this,changes:a})),a||e)try{await this.render?.()===!1&&t.state===ie&&t.version===s&&(t.state=o,t.error=r,t.value=i,dr(this),hr(this))}catch(c){this.toggleFailed(t.version,c,n)}})}};function ts(e={}){return Object.entries(e).forEach(([t,r])=>{(r==null||r===""||r?.length===0)&&delete e[t]}),e}function mr(e,t={}){let{tag:r,is:n}=e,o=document.createElement(r,{is:n});return o.setAttribute("is",n),Object.assign(o.dataset,ts(t)),o}function pr(e){let{tag:t,is:r,prototype:n}=e,o=window.customElements.get(r);return o||(Object.defineProperties(n,Object.getOwnPropertyDescriptors(wc)),o=Object.defineProperties(e,Object.getOwnPropertyDescriptors(Ec)),window.customElements.define(r,o,{extends:t})),o}function fr(e,t=document.body){return Array.from(t?.querySelectorAll(`${e.tag}[is="${e.is}"]`)??[])}function gr(e,t={}){return e instanceof HTMLElement?(Object.assign(e.dataset,ts(t)),e):null}var Sc="download",Ac="upgrade",Ge,tt=class tt extends HTMLAnchorElement{constructor(){super();Se(this,Ge);this.addEventListener("click",this.clickHandler)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}static createCheckoutLink(r={},n=""){let o=j();if(!o)return null;let{checkoutMarketSegment:i,checkoutWorkflow:s,checkoutWorkflowStep:a,entitlement:c,upgrade:h,modal:l,perpetual:d,promotionCode:u,quantity:p,wcsOsi:f,extraOptions:g}=o.collectCheckoutOptions(r),A=mr(tt,{checkoutMarketSegment:i,checkoutWorkflow:s,checkoutWorkflowStep:a,entitlement:c,upgrade:h,modal:l,perpetual:d,promotionCode:u,quantity:p,wcsOsi:f,extraOptions:g});return n&&(A.innerHTML=`<span>${n}</span>`),A}static getCheckoutLinks(r){return fr(tt,r)}get isCheckoutLink(){return!0}get placeholder(){return this}clickHandler(r){var n;(n=U(this,Ge))==null||n.call(this,r)}async render(r={}){if(!this.isConnected)return!1;let n=j();if(!n)return!1;this.dataset.imsCountry||n.imsCountryPromise.then(l=>{l&&(this.dataset.imsCountry=l)},Xe);let o=n.collectCheckoutOptions(r,this.placeholder);if(!o.wcsOsi.length)return!1;let i;try{i=JSON.parse(o.extraOptions??"{}")}catch(l){this.placeholder.log.error("cannot parse exta checkout options",l)}let s=this.placeholder.togglePending(o);this.href="";let a=n.resolveOfferSelectors(o),c=await Promise.all(a);c=c.map(l=>wt(l,o));let h=await n.buildCheckoutAction(c.flat(),{...i,...o});return this.renderOffers(c.flat(),o,{},h,s)}renderOffers(r,n,o={},i=void 0,s=void 0){if(!this.isConnected)return!1;let a=j();if(!a)return!1;if(n={...JSON.parse(this.placeholder.dataset.extraOptions??"null"),...n,...o},s??(s=this.placeholder.togglePending(n)),U(this,Ge)&&Ae(this,Ge,void 0),i){this.classList.remove(Sc,Ac),this.placeholder.toggleResolved(s,r,n);let{url:h,text:l,className:d,handler:u}=i;return h&&(this.href=h),l&&(this.firstElementChild.innerHTML=l),d&&this.classList.add(...d.split(" ")),u&&(this.setAttribute("href","#"),Ae(this,Ge,u.bind(this))),!0}else if(r.length){if(this.placeholder.toggleResolved(s,r,n)){let h=a.buildCheckoutURL(r,n);return this.setAttribute("href",h),!0}}else{let h=new Error(`Not provided: ${n?.wcsOsi??"-"}`);if(this.placeholder.toggleFailed(s,h,n))return this.setAttribute("href","#"),!0}return!1}updateOptions(r={}){let n=j();if(!n)return!1;let{checkoutMarketSegment:o,checkoutWorkflow:i,checkoutWorkflowStep:s,entitlement:a,upgrade:c,modal:h,perpetual:l,promotionCode:d,quantity:u,wcsOsi:p}=n.collectCheckoutOptions(r);return gr(this,{checkoutMarketSegment:o,checkoutWorkflow:i,checkoutWorkflowStep:s,entitlement:a,upgrade:c,modal:h,perpetual:l,promotionCode:d,quantity:u,wcsOsi:p}),!0}};Ge=new WeakMap,C(tt,"is","checkout-link"),C(tt,"tag","a");var Wn=tt,qn=pr(Wn);var rs=[m.uk,m.au,m.fr,m.at,m.be_en,m.be_fr,m.be_nl,m.bg,m.ch_de,m.ch_fr,m.ch_it,m.cz,m.de,m.dk,m.ee,m.eg_ar,m.eg_en,m.es,m.fi,m.fr,m.gr_el,m.gr_en,m.hu,m.ie,m.it,m.lu_de,m.lu_en,m.lu_fr,m.nl,m.no,m.pl,m.pt,m.ro,m.se,m.si,m.sk,m.tr,m.ua,m.id_en,m.id_id,m.in_en,m.in_hi,m.jp,m.my_en,m.my_ms,m.nz,m.th_en,m.th_th],Tc={INDIVIDUAL_COM:[m.za,m.lt,m.lv,m.ng,m.sa_ar,m.sa_en,m.za,m.sg,m.kr],TEAM_COM:[m.za,m.lt,m.lv,m.ng,m.za,m.co,m.kr],INDIVIDUAL_EDU:[m.lt,m.lv,m.sa_en,m.sea],TEAM_EDU:[m.sea,m.kr]},rt=class rt extends HTMLSpanElement{static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-perpetual","data-promotion-code","data-tax-exclusive","data-template","data-wcs-osi"]}static createInlinePrice(t){let r=j();if(!r)return null;let{displayOldPrice:n,displayPerUnit:o,displayRecurrence:i,displayTax:s,forceTaxExclusive:a,perpetual:c,promotionCode:h,quantity:l,template:d,wcsOsi:u}=r.collectPriceOptions(t);return mr(rt,{displayOldPrice:n,displayPerUnit:o,displayRecurrence:i,displayTax:s,forceTaxExclusive:a,perpetual:c,promotionCode:h,quantity:l,template:d,wcsOsi:u})}static getInlinePrices(t){return fr(rt,t)}get isInlinePrice(){return!0}get placeholder(){return this}resolveDisplayTaxForGeoAndSegment(t,r,n,o){let i=`${t}_${r}`;if(rs.includes(t)||rs.includes(i))return!0;let s=Tc[`${n}_${o}`];return s?!!(s.includes(t)||s.includes(i)):!1}async resolveDisplayTax(t,r){let[n]=await t.resolveOfferSelectors(r),o=wt(await n,r);if(o?.length){let{country:i,language:s}=r,a=o[0],[c=""]=a.marketSegments;return this.resolveDisplayTaxForGeoAndSegment(i,s,a.customerSegment,c)}}async render(t={}){if(!this.isConnected)return!1;let r=j();if(!r)return!1;let n=r.collectPriceOptions(t,this.placeholder);if(!n.wcsOsi.length)return!1;let o=this.placeholder.togglePending(n);this.innerHTML="";let[i]=r.resolveOfferSelectors(n);return this.renderOffers(wt(await i,n),n,o)}renderOffers(t,r={},n=void 0){if(!this.isConnected)return;let o=j();if(!o)return!1;let i=o.collectPriceOptions({...this.dataset,...r});if(n??(n=this.placeholder.togglePending(i)),t.length){if(this.placeholder.toggleResolved(n,t,i))return this.innerHTML=o.buildPriceHTML(t,i),!0}else{let s=new Error(`Not provided: ${i?.wcsOsi??"-"}`);if(this.placeholder.toggleFailed(n,s,i))return this.innerHTML="",!0}return!1}updateOptions(t){let r=j();if(!r)return!1;let{displayOldPrice:n,displayPerUnit:o,displayRecurrence:i,displayTax:s,forceTaxExclusive:a,perpetual:c,promotionCode:h,quantity:l,template:d,wcsOsi:u}=r.collectPriceOptions(t);return gr(this,{displayOldPrice:n,displayPerUnit:o,displayRecurrence:i,displayTax:s,forceTaxExclusive:a,perpetual:c,promotionCode:h,quantity:l,template:d,wcsOsi:u}),!0}};C(rt,"is","inline-price"),C(rt,"tag","span");var Yn=rt,Xn=pr(Yn);function ns({providers:e,settings:t},r){let n=F.module("checkout");function o(h,l){let{checkoutClientId:d,checkoutWorkflow:u,checkoutWorkflowStep:p,country:f,language:g,promotionCode:A,quantity:R}=t,{checkoutMarketSegment:T,checkoutWorkflow:S=u,checkoutWorkflowStep:L=p,imsCountry:E,country:$=E??f,language:G=g,quantity:J=R,entitlement:Q,upgrade:M,modal:W,perpetual:fe,promotionCode:we=A,wcsOsi:ae,extraOptions:te,...ze}=Object.assign({},l?.dataset??{},h??{}),At=de(S,ue,w.checkoutWorkflow),Tt=me.CHECKOUT;At===ue.V3&&(Tt=de(L,me,w.checkoutWorkflowStep));let nt=Je({...ze,extraOptions:te,checkoutClientId:d,checkoutMarketSegment:T,country:$,quantity:et(J,w.quantity),checkoutWorkflow:At,checkoutWorkflowStep:Tt,language:G,entitlement:b(Q),upgrade:b(M),modal:b(W),perpetual:b(fe),promotionCode:ft(we).effectivePromoCode,wcsOsi:cr(ae)});if(l)for(let xr of e.checkout)xr(l,nt);return nt}async function i(h,l){let d=j(),u=await r.getCheckoutAction?.(h,l,d.imsSignedInPromise);return u||null}function s(h,l){if(!Array.isArray(h)||!h.length||!l)return"";let{env:d,landscape:u}=t,{checkoutClientId:p,checkoutMarketSegment:f,checkoutWorkflow:g,checkoutWorkflowStep:A,country:R,promotionCode:T,quantity:S,...L}=o(l),E=window.frameElement?"if":"fp",$={checkoutPromoCode:T,clientId:p,context:E,country:R,env:d,items:[],marketSegment:f,workflowStep:A,landscape:u,...L};if(h.length===1){let[{offerId:G,offerType:J,productArrangementCode:Q}]=h,{marketSegments:[M]}=h[0];Object.assign($,{marketSegment:M,offerType:J,productArrangementCode:Q}),$.items.push(S[0]===1?{id:G}:{id:G,quantity:S[0]})}else $.items.push(...h.map(({offerId:G},J)=>({id:G,quantity:S[J]??w.quantity})));return Zr(g,$)}let{createCheckoutLink:a,getCheckoutLinks:c}=qn;return{CheckoutLink:qn,CheckoutWorkflow:ue,CheckoutWorkflowStep:me,buildCheckoutAction:i,buildCheckoutURL:s,collectCheckoutOptions:o,createCheckoutLink:a,getCheckoutLinks:c}}function Pc({interval:e=200,maxAttempts:t=25}={}){let r=F.module("ims");return new Promise(n=>{r.debug("Waing for IMS to be ready");let o=0;function i(){window.adobeIMS?.initialized?n():++o>t?(r.debug("Timeout"),n()):setTimeout(i,e)}i()})}function Cc(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function Oc(e){let t=F.module("ims");return e.then(r=>r?window.adobeIMS.getProfile().then(({countryCode:n})=>(t.debug("Got user country:",n),n),n=>{t.error("Unable to get user country:",n)}):null)}function os({}){let e=Pc(),t=Cc(e),r=Oc(t);return{imsReadyPromise:e,imsSignedInPromise:t,imsCountryPromise:r}}function Lc(e){if(!e.priceLiteralsURL)throw new Error(Un);return new Promise(t=>{window.fetch(e.priceLiteralsURL).then(r=>{r.json().then(({data:n})=>{t(n)})})})}async function is(e){let r=await(e.priceLiteralsPromise||Lc(e));if(Array.isArray(r)){let n=i=>r.find(s=>jt(s.lang,i)),o=n(e.language)??n(w.language);if(o)return Object.freeze(o)}return{}}function ss({literals:e,providers:t,settings:r}){function n(a,c){let{country:h,displayOldPrice:l,displayPerUnit:d,displayRecurrence:u,displayTax:p,forceTaxExclusive:f,language:g,promotionCode:A,quantity:R}=r,{displayOldPrice:T=l,displayPerUnit:S=d,displayRecurrence:L=u,displayTax:E=p,forceTaxExclusive:$=f,country:G=h,language:J=g,perpetual:Q,promotionCode:M=A,quantity:W=R,template:fe,wcsOsi:we,...ae}=Object.assign({},c?.dataset??{},a??{}),te=Je({...ae,country:G,displayOldPrice:b(T),displayPerUnit:b(S),displayRecurrence:b(L),displayTax:b(E),forceTaxExclusive:b($),language:J,perpetual:b(Q),promotionCode:ft(M).effectivePromoCode,quantity:et(W,w.quantity),template:fe,wcsOsi:cr(we)});if(c)for(let ze of t.price)ze(c,te);return te}function o(a,c){if(!Array.isArray(a)||!a.length||!c)return"";let{template:h}=c,l;switch(h){case"discount":l=Cn;break;case"strikethrough":l=Tn;break;case"optical":l=An;break;case"annual":l=Pn;break;default:l=c.promotionCode?Sn:wn}let d=n(c);d.literals=Object.assign({},e.price,Je(c.literals??{}));let[u]=a;return u={...u,...u.priceDetails},l(d,u)}let{createInlinePrice:i,getInlinePrices:s}=Xn;return{InlinePrice:Xn,buildPriceHTML:o,collectPriceOptions:n,createInlinePrice:i,getInlinePrices:s}}var Zn="_acom",as={[Z.PRODUCTION]:"https://www.adobe.com",[Z.STAGE]:"https://www.stage.adobe.com",[Z.PRODUCTION+Zn]:"https://www.adobe.com",[Z.STAGE+Zn]:"https://www.stage.adobe.com"};function cs({settings:e}){let t=F.module("wcs"),{env:r,domainSwitch:n,wcsApiKey:o}=e,i=n?as[r+Zn]:as[r],s={apiKey:o,baseUrl:i,fetch:window.fetch.bind(window)},a=Ht(s),c=new Map,h=new Map,l;async function d(f,g,A=!0){let R=Mn;try{t.debug("Fetching:",f),f.offerSelectorIds=f.offerSelectorIds.sort();let{data:T}=await a(f,{apiKey:o,environment:e.wcsEnv,landscape:r===Z.STAGE?"ALL":e.landscape},({resolvedOffers:L})=>({offers:L.map($n)}));t.debug("Fetched:",f,T);let{offers:S}=T??{};g.forEach(({resolve:L},E)=>{let $=S.filter(({offerSelectorIds:G})=>G.includes(E)).flat();$.length&&(g.delete(E),L($))})}catch(T){T.status===404&&f.offerSelectorIds.length>1?(t.debug("Multi-osi 404, fallback to fetch-by-one strategy"),await Promise.allSettled(f.offerSelectorIds.map(S=>d({...f,offerSelectorIds:[S]},g,!1)))):(t.error("Failed:",f,T),R=kn)}A&&g.size&&(t.debug("Missing:",{offerSelectorIds:[...g.keys()]}),g.forEach(T=>{T.reject(new Error(R))}))}function u(){clearTimeout(l);let f=[...h.values()];h.clear(),f.forEach(({options:g,promises:A})=>d(g,A))}function p({country:f,language:g,perpetual:A=!1,promotionCode:R="",wcsOsi:T=[]}){let S=`${g}_${f}`;f!=="GB"&&(g=A?"EN":"MULT");let L=[f,g,R].filter(E=>E).join("-").toLowerCase();return T.map(E=>{let $=`${E}-${L}`;if(!c.has($)){let G=new Promise((J,Q)=>{let M=h.get(L);if(!M){let W={country:f,locale:S,offerSelectorIds:[]};f!=="GB"&&(W.language=g),M={options:W,promises:new Map},h.set(L,M)}R&&(M.options.promotionCode=R),M.options.offerSelectorIds.push(E),M.promises.set(E,{resolve:J,reject:Q}),M.options.offerSelectorIds.length>=e.wcsBufferLimit?u():(t.debug("Queued:",M.options),l||(l=setTimeout(u,e.wcsBufferDelay)))});c.set($,G)}return c.get($)})}return{WcsCommitment:ji,WcsPlanType:Vi,WcsTerm:Bi,resolveOfferSelectors:p}}var B=class extends HTMLElement{get isWcmsCommerce(){return!0}};C(B,"instance"),C(B,"promise",null);window.customElements.define(be,B);async function Nc(e,t){let r=F.init(e.env).module("service");r.debug("Activating:",e);let n={price:{}},o=Object.freeze(Xi(e));try{n.price=await is(o)}catch(c){r.warn("Price literals were not fetched:",c)}let i={checkout:new Set,price:new Set},s=document.createElement(be),a={literals:n,providers:i,settings:o};return B.instance=Object.defineProperties(s,Object.getOwnPropertyDescriptors({...ns(a,t),...os(a),...ss(a),...cs(a),...Fn,Log:F,get defaults(){return w},get literals(){return n},get log(){return F},get providers(){return{checkout(c){return i.checkout.add(c),()=>i.checkout.delete(c)},price(c){return i.price.add(c),()=>i.price.delete(c)}}},get settings(){return o}})),r.debug("Activated:",{literals:n,settings:o,element:s}),document.head.append(s),_e(()=>{let c=new CustomEvent(Ke,{bubbles:!0,cancelable:!1,detail:B.instance});B.instance.dispatchEvent(c)}),B.instance}function ls(){document.head.querySelector(be)?.remove(),B.promise=null,F.reset()}function Jn(e,t){if(Ee(e)){let r=Ee(t)?t():{};return r.force&&ls(),B.promise??(B.promise=Nc(e(),r))}return B.promise}var{searchParams:Qn}=new URL(import.meta.url),Rc=Qn.get("locale")??"US_en",Yu=Qn.get("lang")??"en",hs=Qn.get("env")==="stage",$c=hs?"stage":"prod",Ic=hs?"STAGE":"PROD",kc=()=>({env:{name:$c},commerce:{"commerce.env":Ic},locale:{prefix:Rc}}),Mc=Jn(kc);window.__mas__lib=import.meta.url;var ds=Mc;var em=ds;export{em as default};
