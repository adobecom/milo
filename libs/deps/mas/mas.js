...
`,$o=()=>[C`
        ...
        `}get cardImage(){return x` <div class="image">
            ...
            ${this.badge}
              ...
              >`:"";return x`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){}};tt=new WeakMap,p($t,"styleMap",{});var I=$t;function te(e,t={},r=null,n=null){let i=n?document.createElement(e,{is:n}):document.createElement(e);r instanceof HTMLElement?i.appendChild(r):i.innerHTML=r;for(let[o,a]of Object.entries(t))i.setAttribute(o,a);return i}function br(){return window.matchMedia("(max-width: 767px)").matches}function Uo(){return window.matchMedia("(max-width: 1024px)").matches}var Kn={};Hs(Kn,{CLASS_NAME_FAILED:()=>Rn,CLASS_NAME_HIDDEN:()=>Zs,CLASS_NAME_PENDING:()=>Mn,CLASS_NAME_RESOLVED:()=>Vn,ERROR_MESSAGE_BAD_REQUEST:()=>Er,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>ac,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Hn,EVENT_AEM_ERROR:()=>Re,EVENT_AEM_LOAD:()=>Oe,EVENT_MAS_ERROR:()=>On,EVENT_MAS_READY:()=>Nn,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>kn,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>ic,EVENT_MERCH_CARD_COLLECTION_SORT:()=>nc,EVENT_MERCH_CARD_READY:()=>In,EVENT_MERCH_OFFER_READY:()=>Qs,EVENT_MERCH_OFFER_SELECT_READY:()=>Cn,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>Ar,EVENT_MERCH_SEARCH_CHANGE:()=>rc,EVENT_MERCH_SIDENAV_SELECT:()=>oc,EVENT_MERCH_STOCK_CHANGE:()=>tc,EVENT_MERCH_STORAGE_CHANGE:()=>vr,EVENT_OFFER_SELECTED:()=>ec,EVENT_TYPE_FAILED:()=>$n,EVENT_TYPE_READY:()=>rt,EVENT_TYPE_RESOLVED:()=>Un,LOG_NAMESPACE:()=>Dn,Landscape:()=>Me,NAMESPACE:()=>qs,PARAM_AOS_API_KEY:()=>sc,PARAM_ENV:()=>Bn,PARAM_LANDSCAPE:()=>Gn,PARAM_WCS_API_KEY:()=>cc,STATE_FAILED:()=>ce,STATE_PENDING:()=>Ee,STATE_RESOLVED:()=>le,TAG_NAME_SERVICE:()=>Js,WCS_PROD_URL:()=>zn,WCS_STAGE_URL:()=>Fn});var qs="merch",Zs="hidden",rt="wcms:commerce:ready",Js="mas-commerce-service",Qs="merch-offer:ready",Cn="merch-offer-select:ready",In="merch-card:ready",kn="merch-card:action-menu-toggle",ec="merch-offer:selected",tc="merch-stock:change",vr="merch-storage:change",Ar="merch-quantity-selector:change",rc="merch-search:change",nc="merch-card-collection:sort",ic="merch-card-collection:showmore",oc="merch-sidenav:select",Oe="aem:load",Re="aem:error",Nn="mas:ready",On="mas:error",Rn="placeholder-failed",Mn="placeholder-pending",Vn="placeholder-resolved",Er="Bad WCS request",Hn="Commerce offer not found",ac="Literals URL not provided",$n="mas:failed",Un="mas:resolved",Dn="mas/commerce",Bn="commerce.env",Gn="commerce.landscape",sc="commerce.aosKey",cc="commerce.wcsKey",zn="https://www.adobe.com/web_commerce_artifact",Fn="https://www.stage.adobe.com/web_commerce_artifact_stage",ce="failed",Ee="pending",le="resolved",Me={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"};var Do=`
:root {
...
`;var Sr=class extends I{constructor(t){super(t)}getGlobalCSS(){return Bo}renderLayout(){return x`${this.cardImage}
    <div class="body">
...
`;var yr=class extends I{constructor(t){super(t)}getGlobalCSS(){return Go}renderLayout(){return x` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var hc=32,it=class extends I{constructor(r){super(r);p(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);p(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
...
`;var ot=class extends I{constructor(t){super(t)}getGlobalCSS(){return Fo}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
...
`;var Ve=class extends I{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Ko}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return x` ${this.badge}
...
`;var ct=class extends I{constructor(t){super(t)}getGlobalCSS(){return Xo}renderLayout(){return x`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
...
`;var mc={mnemonics:{size:"m"},backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{slot:"footer",size:"S"},allowedSizes:["wide"]},ht=class extends I{getGlobalCSS(){return qo}get aemFragmentMapping(){return mc}renderLayout(){return x` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
    ...
    `);var jn=(e,t=!1)=>{switch(e.variant){case"catalog":return new nt(e);case"image":return new Sr(e);case"inline-heading":return new yr(e);case"mini-compare-chart":return new it(e);case"plans":return new ot(e);case"product":return new Ve(e);case"segment":return new at(e);case"special-offers":return new st(e);case"twp":return new ct(e);case"ccd-suggested":return new lt(e);case"ccd-slice":return new ht(e);default:return t?void 0:new Ve(e)}},Zo=()=>{let e=[];return e.push(nt.variantStyle),e.push(it.variantStyle),e.push(Ve.variantStyle),e.push(ot.variantStyle),e.push(at.variantStyle),e.push(st.variantStyle),e.push(ct.variantStyle),e.push(lt.variantStyle),e.push(ht.variantStyle),e};var Jo=document.createElement("style");Jo.innerHTML=`
:root {
