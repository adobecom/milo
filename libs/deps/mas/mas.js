...
`;var De=class extends I{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Do}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return x` ${this.badge}
      <div class="body">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
          <slot name="body-xxs"></slot>
      ...
      ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}postCardUpdateHook(){this.card.isConnected&&(pr()||this.adjustProductBodySlots(),this.adjustTitleWidth())}};p(De,"variantStyle",C`
...
`;var ct=class extends I{constructor(t){super(t)}getGlobalCSS(){return Go}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
        ${this.promoBottom?"":x`<slot name="promo-text"></slot><slot name="callout-content"></slot>`}
...
`;var oc={mnemonics:{size:"l"},subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"cta",size:"m"}},dt=class extends I{getGlobalCSS(){return Fo}get aemFragmentMapping(){return oc}renderLayout(){return x`
...
`;var ac={mnemonics:{size:"m"},backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{slot:"footer",size:"s"},allowedSizes:["wide"]},ut=class extends I{getGlobalCSS(){return Ko}get aemFragmentMapping(){return ac}renderLayout(){return x` <div class="content">
    ...
    `);var Gn=(e,t=!1)=>{switch(e.variant){case"catalog":return new ot(e);case"image":return new br(e);case"inline-heading":return new vr(e);case"mini-compare-chart":return new at(e);case"plans":return new st(e);case"product":return new De(e);case"segment":return new ct(e);case"special-offers":return new lt(e);case"twp":return new ht(e);case"ccd-suggested":return new dt(e);case"ccd-slice":return new ut(e);default:return t?void 0:new De(e)}},jo=()=>{let e=[];return e.push(ot.variantStyle),e.push(at.variantStyle),e.push(De.variantStyle),e.push(st.variantStyle),e.push(ct.variantStyle),e.push(lt.variantStyle),e.push(ht.variantStyle),e.push(dt.variantStyle),e.push(ut.variantStyle),e};var Yo=document.createElement("style");Yo.innerHTML=`
:root {
...
`;document.head.appendChild(Yo);var sc="#000000",cc="#F8D904",lc=/(accent|primary|secondary)(-(outline|link))?/,hc="mas:product_code/",dc="daa-ll",Ar="daa-lh";function uc(e,t,r){e.mnemonicIcon?.map((i,o)=>({icon:i,alt:e.mnemonicAlt[o]??"",link:e.mnemonicLink[o]??""}))?.forEach(({icon:i,alt:o,link:a})=>{if(a&&!/^https?:/.test(a))try{a=new URL(`https://${a}`).href.toString()}catch{a="#"}let s={slot:"icons",src:i,size:r?.size??"l"};o&&(s.alt=o),a&&(s.href=a);let c=le("merch-icon",s);t.append(c)})}function mc(e,t){e.badge&&(t.setAttribute("badge-text",e.badge),t.setAttribute("badge-color",e.badgeColor||sc),t.setAttribute("badge-background-color",e.badgeBackgroundColor||cc))}function pc(e,t,r){r?.includes(e.size)&&t.setAttribute("size",e.size)}function fc(e,t,r){e.cardTitle&&r&&t.append(le(r.tag,{slot:r.slot},e.cardTitle))}function gc(e,t,r){e.subtitle&&r&&t.append(le(r.tag,{slot:r.slot},e.subtitle))}function xc(e,t,r,n){if(e.backgroundImage)switch(n){case"ccd-slice":r&&t.append(le(r.tag,{slot:r.slot},`<img loading="lazy" src="${e.backgroundImage}" />`));break;case"ccd-suggested":t.setAttribute("background-image",e.backgroundImage);break}}function bc(e,t,r){if(e.prices&&r){let n=le(r.tag,{slot:r.slot},e.prices);t.append(n)}}function vc(e,t,r){if(e.description&&r){let n=le(r.tag,{slot:r.slot},e.description);t.append(n)}}function Ac(e,t,r,n){n==="ccd-suggested"&&!e.className&&(e.className="primary-link");let i=lc.exec(e.className)?.[0]??"accent",o=i.includes("accent"),a=i.includes("primary"),s=i.includes("secondary"),c=i.includes("-outline");if(i.includes("-link"))return e;let l="fill",d;o||t?d="accent":a?d="primary":s&&(d="secondary"),c&&(l="outline"),e.tabIndex=-1;let u=le("sp-button",{treatment:l,variant:d,tabIndex:0,size:r.ctas.size??"m"},e);return u.addEventListener("click",m=>{m.target!==e&&(m.stopPropagation(),e.click())}),u}function Ec(e,t){return e.classList.add("con-button"),t&&e.classList.add("blue"),e}function Sc(e,t,r,n){if(e.ctas){let{slot:i}=r.ctas,o=le("div",{slot:i},e.ctas),a=[...o.querySelectorAll("a")].map(s=>{let c=s.parentElement.tagName==="STRONG";return t.consonant?Ec(s,c):Ac(s,c,r,n)});o.innerHTML="",o.append(...a),t.append(o)}}function yc(e,t){let{tags:r}=e,n=r?.find(i=>i.startsWith(hc))?.split("/").pop();n&&(t.setAttribute(Ar,n),t.querySelectorAll("a[data-analytics-id]").forEach((i,o)=>{i.setAttribute(dc,`${i.dataset.analyticsId}-${o+1}`)}))}async function Xo(e,t){let{fields:r}=e,{variant:n}=r;if(!n)return;t.querySelectorAll("[slot]").forEach(o=>{o.remove()}),t.removeAttribute("background-image"),t.removeAttribute("badge-background-color"),t.removeAttribute("badge-color"),t.removeAttribute("badge-text"),t.removeAttribute("size"),t.removeAttribute(Ar),t.variant=n,await t.updateComplete;let{aemFragmentMapping:i}=t.variantLayout;i&&(xc(r,t,i.backgroundImage,n),mc(r,t),Sc(r,t,i,n),vc(r,t,i.description),uc(r,t,i.mnemonics),bc(r,t,i.prices),pc(r,t,i.allowedSizes),gc(r,t,i.subtitle),fc(r,t,i.title),yc(r,t))}var Tc="merch-card",Lc=1e4,zn,Mt,Bn,Vt=class extends ee{constructor(){super();D(this,Mt);p(this,"customerSegment");p(this,"marketSegment");p(this,"variantLayout");D(this,zn,!1);this.filters={},this.types="",this.selected=!1,this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this)}firstUpdated(){this.variantLayout=Gn(this,!1),this.variantLayout?.connectedCallbackHook(),this.aemFragment?.updateComplete.catch(()=>{this.style.display="none"})}willUpdate(r){(r.has("variant")||!this.variantLayout)&&(this.variantLayout=Gn(this),this.variantLayout.connectedCallbackHook())}updated(r){(r.has("badgeBackgroundColor")||r.has("borderColor"))&&this.style.setProperty("--merch-card-border",this.computedBorderStyle),this.variantLayout?.postCardUpdateHook(this)}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}get prices(){return Array.from(this.querySelectorAll('span[is="inline-price"][data-wcs-osi]'))}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["twp","ccd-slice","ccd-suggested"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector('span[is="inline-price"]')}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll('a[is="checkout-link"]')??[]]}async toggleStockOffer({target:r}){if(!this.stockOfferOsis)return;let n=this.checkoutLinks;if(n.length!==0)for(let i of n){await i.onceSettled();let o=i.value?.[0]?.planType;if(!o)return;let a=this.stockOfferOsis[o];if(!a)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==a);r.checked&&s.push(a),i.dataset.wcsOsi=s.join(",")}}handleQuantitySelection(r){let n=this.checkoutLinks;for(let i of n)i.dataset.quantity=r.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(r){let n={...this.filters};Object.keys(n).forEach(i=>{if(r){n[i].order=Math.min(n[i].order||2,2);return}let o=n[i].order;o===1||isNaN(o)||(n[i].order=Number(o)+1)}),this.filters=n}includes(r){return this.textContent.match(new RegExp(r,"i"))!==null}connectedCallback(){super.connectedCallback(),this.addEventListener(gr,this.handleQuantitySelection),this.addEventListener(yn,this.merchCardReady,{once:!0}),this.updateComplete.then(()=>{this.merchCardReady()}),this.storageOptions?.addEventListener("change",this.handleStorageChange),this.addEventListener(He,this.handleAemFragmentEvents),this.addEventListener($e,this.handleAemFragmentEvents),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout.disconnectedCallbackHook(),this.removeEventListener(gr,this.handleQuantitySelection),this.storageOptions?.removeEventListener(fr,this.handleStorageChange),this.removeEventListener(He,this.handleAemFragmentEvents),this.removeEventListener($e,this.handleAemFragmentEvents)}async handleAemFragmentEvents(r){if(r.type===He&&be(this,Mt,Bn).call(this,"AEM fragment cannot be loaded"),r.type===$e&&r.target.nodeName==="AEM-FRAGMENT"){let n=r.detail;await Xo(n,this),this.checkReady()}}async checkReady(){let r=Promise.all([...this.querySelectorAll('span[is="inline-price"][data-wcs-osi],a[is="checkout-link"][data-wcs-osi]')].map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(a=>a.classList.contains("placeholder-resolved"))),n=new Promise(o=>setTimeout(()=>o(!1),Lc));if(await Promise.race([r,n])===!0){this.dispatchEvent(new CustomEvent(_n,{bubbles:!0,composed:!0}));return}be(this,Mt,Bn).call(this,"Contains unresolved offers")}get aemFragment(){return this.querySelector("aem-fragment")}get storageOptions(){return this.querySelector("sp-radio-group#storage")}get storageSpecificOfferSelect(){let r=this.storageOptions?.selected;if(r){let n=this.querySelector(`merch-offer-select[storage="${r}"]`);if(n)return n}return this.querySelector("merch-offer-select")}get offerSelect(){return this.storageOptions?this.storageSpecificOfferSelect:this.querySelector("merch-offer-select")}get quantitySelect(){return this.querySelector("merch-quantity-select")}merchCardReady(){this.offerSelect&&!this.offerSelect.planType||this.dispatchEvent(new CustomEvent(Tn,{bubbles:!0}))}handleStorageChange(){let r=this.closest("merch-card")?.offerSelect.cloneNode(!0);r&&this.dispatchEvent(new CustomEvent(fr,{detail:{offerSelect:r},bubbles:!0}))}get dynamicPrice(){return this.querySelector('[slot="price"]')}selectMerchOffer(r){if(r===this.merchOffer)return;this.merchOffer=r;let n=this.dynamicPrice;if(r.price&&n){let i=r.price.cloneNode(!0);n.onceSettled?n.onceSettled().then(()=>{n.replaceWith(i)}):n.replaceWith(i)}}};zn=new WeakMap,Mt=new WeakSet,Bn=function(r){this.dispatchEvent(new CustomEvent(wn,{detail:r,bubbles:!0,composed:!0}))},p(Vt,"properties",{name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:r=>{let[n,i,o]=r.split(",");return{PUF:n,ABM:i,M2M:o}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:r=>Object.fromEntries(r.split(",").map(n=>{let[i,o,a]=n.split(":"),s=Number(o);return[i,{order:isNaN(s)?void 0:s,size:a}]})),toAttribute:r=>Object.entries(r).map(([n,{order:i,size:o}])=>[n,i,o].filter(a=>a!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:Ar,reflect:!0}}),p(Vt,"styles",[ko,jo(),...Oo()]);customElements.define(Tc,Vt);var mt=class extends ee{constructor(){super(),this.size="m",this.alt=""}render(){let{href:t}=this;return t?x`<a href="${t}">
    ...
    `);customElements.define("merch-icon",mt);var Jo=new CSSStyleSheet;Jo.replaceSync(":host { display: contents; }");var _c=document.querySelector('meta[name="aem-base-url"]')?.content??"https://odin.adobe.com",Wo="fragment",qo="author",wc="ims",Zo=e=>{throw new Error(`Failed to get fragment: ${e}`)};async function Pc(e,t,r,n){let i=r?`${e}/adobe/sites/cf/fragments/${t}`:`${e}/adobe/sites/fragments/${t}`,o=await fetch(i,{cache:"default",credentials:"omit",headers:n}).catch(a=>Zo(a.message));return o?.ok||Zo(`${o.status} ${o.statusText}`),o.json()}var Fn,ye,Kn=class{constructor(){D(this,ye,new Map)}clear(){L(this,ye).clear()}add(...t){t.forEach(r=>{let{id:n}=r;n&&L(this,ye).set(n,r)})}has(t){return L(this,ye).has(t)}get(t){return L(this,ye).get(t)}remove(t){L(this,ye).delete(t)}};ye=new WeakMap;var Er=new Kn,Ge,me,Te,$t,pe,pt,fe,Yn,Qo,ea,jn=class extends HTMLElement{constructor(){super();D(this,fe);p(this,"cache",Er);D(this,Ge);D(this,me);D(this,Te);D(this,$t,!1);D(this,pe);D(this,pt,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[Jo];let r=this.getAttribute(wc);["",!0,"true"].includes(r)&&(F(this,$t,!0),Fn||(Fn={Authorization:`Bearer ${window.adobeid?.authorize?.()}`}))}static get observedAttributes(){return[Wo,qo]}attributeChangedCallback(r,n,i){r===Wo&&(F(this,Te,i),this.refresh(!1)),r===qo&&F(this,pt,["","true"].includes(i))}connectedCallback(){if(!L(this,Te)){be(this,fe,Yn).call(this,"Missing fragment id");return}}async refresh(r=!0){L(this,pe)&&!await Promise.race([L(this,pe),Promise.resolve(!1)])||(r&&Er.remove(L(this,Te)),F(this,pe,this.fetchData().then(()=>(this.dispatchEvent(new CustomEvent($e,{detail:this.data,bubbles:!0,composed:!0})),!0)).catch(n=>(be(this,fe,Yn).call(this,"Network error: failed to load fragment"),F(this,pe,null),!1))),L(this,pe))}async fetchData(){F(this,Ge,null),F(this,me,null);let r=Er.get(L(this,Te));r||(r=await Pc(_c,L(this,Te),L(this,pt),L(this,$t)?Fn:void 0),Er.add(r)),F(this,Ge,r)}get updateComplete(){return L(this,pe)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return L(this,me)?L(this,me):(L(this,pt)?be(this,fe,Qo).call(this):be(this,fe,ea).call(this),L(this,me))}};Ge=new WeakMap,me=new WeakMap,Te=new WeakMap,$t=new WeakMap,pe=new WeakMap,pt=new WeakMap,fe=new WeakSet,Yn=function(r){this.classList.add("error"),this.dispatchEvent(new CustomEvent(He,{detail:r,bubbles:!0,composed:!0}))},Qo=function(){let{id:r,tags:n,fields:i}=L(this,Ge);F(this,me,i.reduce((o,{name:a,multiple:s,values:c})=>(o.fields[a]=s?c:c[0],o),{id:r,tags:n,fields:{}}))},ea=function(){let{id:r,tags:n,fields:i}=L(this,Ge);F(this,me,Object.entries(i).reduce((o,[a,s])=>(o.fields[a]=s?.mimeType?s.value:s??"",o),{id:r,tags:n,fields:{}}))};customElements.define("aem-fragment",jn);var ge={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals"],serializableTypes:["Array","Object"],sampleRate:1,tags:"acom",isProdDomain:!1},ta=1e3,ra=new Set;function Cc(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function na(e){if(e==null)return;let t=typeof e;if(t==="function")return e.name?`function ${e.name}`:"function";if(t==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:n,originatingRequest:i,status:o}=e;return[n,o,i].filter(Boolean).join(" ")}let r=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!ge.serializableTypes.includes(r))return r}return e}function Ic(e,t){if(!ge.ignoredProperties.includes(e))return na(t)}var Xn={append(e){if(e.level!=="error")return;let{message:t,params:r}=e,n=[],i=[],o=t;r.forEach(h=>{h!=null&&(Cc(h)?n:i).push(h)}),n.length&&(o+=" "+n.map(na).join(" "));let{pathname:a,search:s}=window.location,c=`${ge.delimiter}page=${a}${s}`;c.length>ta&&(c=`${c.slice(0,ta)}<trunc>`),o+=c,i.length&&(o+=`${ge.delimiter}facts=`,o+=JSON.stringify(i,Ic)),ra.has(o)||(ra.add(o),window.lana?.log(o,ge))}};function ft(e){Object.assign(ge,Object.fromEntries(Object.entries(e).filter(([t,r])=>t in ge&&function(i){Object.assign(ge,Object.fromEntries(Object.entries(i).filter(([o,a])=>o in ge&&a!==""&&a!==null&&a!==void 0&&!Number.isNaN(a))))})))}var Ht;(function(e){e.STAGE="STAGE",e.PRODUCTION="PRODUCTION",e.LOCAL="LOCAL"})(Ht||(Ht={}));var Wn;(function(e){e.STAGE="STAGE",e.PRODUCTION="PROD",e.LOCAL="LOCAL"})(Wn||(Wn={}));var Ut;(function(e){e.DRAFT="DRAFT",e.PUBLISHED="PUBLISHED"})(Ut||(Ut={}));var Be;(function(e){e.V2="UCv2",e.V3="UCv3"})(Be||(Be={}));var Z;(function(e){e.CHECKOUT="checkout",e.CHECKOUT_EMAIL="checkout/email",e.SEGMENTATION="segmentation",e.BUNDLE="bundle",e.COMMITMENT="commitment",e.RECOMMENDATION="recommendation",e.EMAIL="email",e.PAYMENT="payment",e.CHANGE_PLAN_TEAM_PLANS="change-plan/team-upgrade/plans",e.CHANGE_PLAN_TEAM_PAYMENT="change-plan/team-upgrade/payment"})(Z||(Z={}));var qn=function(e){var t;return(t=Nc.get(e))!==null&&t!==void 0?t:e},Nc=new Map([["countrySpecific","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["offerType","ot"],["marketSegment","ms"]]);var ia=function(e){var t=typeof Symbol=="function"&&Symbol.iterator,r=t&&e[t],n=0;if(r)return r.call(e);if(e&&typeof e.length=="number")return{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}};throw new TypeError(t?"Object is not iterable.":"Symbol.iterator is not defined.")},oa=function(e,t){var r=typeof Symbol=="function"&&e[Symbol.iterator];if(!r)return e;var n=r.call(e),i,o=[],a;try{for(;(t===void 0||t-- >0)&&!(i=n.next()).done;)o.push(i.value)}catch(s){a={error:s}}finally{try{i&&!i.done&&(r=n.return)&&r.call(n)}finally{if(a)throw a.error}}return o};function gt(e,t,r){var n,i;try{for(var o=ia(Object.entries(e)),a=o.next();!a.done;a=o.next()){var s=oa(a.value,2),c=s[0],h=s[1],l=qn(c);h!=null&&r.has(l)&&t.set(l,h)}}catch(d){n={error:d}}finally{try{a&&!a.done&&(i=o.return)&&i.call(o)}finally{if(n)throw n.error}}}function Sr(e){switch(e){case Ht.PRODUCTION:return"https://commerce.adobe.com";default:return"https://commerce-stg.adobe.com"}}function yr(e,t){var r,n;for(var i in e){var o=e[i];try{for(var a=(r=void 0,ia(Object.entries(o))),s=a.next();!s.done;s=a.next()){var c=oa(s.value,2),h=c[0],l=c[1];if(l!=null){var d=qn(h);t.set("items["+i+"]["+d+"]",l)}}}catch(u){r={error:u}}finally{try{s&&!s.done&&(n=a.return)&&n.call(a)}finally{if(r)throw r.error}}}}var kc=function(e,t){var r={};for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,n=Object.getOwnPropertySymbols(e);i<n.length;i++)t.indexOf(n[i])<0&&Object.prototype.propertyIsEnumerable.call(e,n[i])&&(r[n[i]]=e[n[i]]);return r},Oc=function(e){var t=typeof Symbol=="function"&&Symbol.iterator,r=t&&e[t],n=0;if(r)return r.call(e);if(e&&typeof e.length=="number")return{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}};throw new TypeError(t?"Object is not iterable.":"Symbol.iterator is not defined.")};function aa(e){Mc(e);var t=e.env,r=e.items,n=e.workflowStep,i=kc(e,["env","items","workflowStep"]),o=new URL(Sr(t));return o.pathname=n+"/",yr(r,o.searchParams),gt(i,o.searchParams,Rc),o.toString()}var Rc=new Set(["cli","co","lang","ctx","cUrl","mv","nglwfdata","otac","promoid","rUrl","sdid","spint","trackingid","code","campaignid","appctxid"]),Vc=["env","workflowStep","clientId","country","items"];function Mc(e){var t,r;try{for(var n=Oc(Vc),i=n.next();!i.done;i=n.next()){var o=i.value;if(!e[o])throw new Error('Argument "checkoutData" is not valid, missing: '+o)}}catch(a){t={error:a}}finally{try{i&&!i.done&&(r=n.return)&&r.call(n)}finally{if(t)throw t.error}}return!0}var $c=function(e,t){var r={};for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,n=Object.getOwnPropertySymbols(e);i<n.length;i++)t.indexOf(n[i])<0&&Object.prototype.propertyIsEnumerable.call(e,n[i])&&(r[n[i]]=e[n[i]]);return r},Hc=function(e){var t=typeof Symbol=="function"&&Symbol.iterator,r=t&&e[t],n=0;if(r)return r.call(e);if(e&&typeof e.length=="number")return{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}};throw new TypeError(t?"Object is not iterable.":"Symbol.iterator is not defined.")},Uc="p_draft_landscape",Dc="/store/";function Jn(e){Bc(e);var t=e.env,r=e.items,n=e.workflowStep,i=e.ms,o=e.marketSegment,a=e.ot,s=e.offerType,c=e.pa,h=e.productArrangementCode,l=e.landscape,d=$c(e,["env","items","workflowStep","ms","marketSegment","ot","offerType","pa","productArrangementCode","landscape"]),u={marketSegment:o??i,offerType:s??a,productArrangementCode:h??c},m=new URL(Sr(t));return m.pathname=""+Dc+n,n!==Z.SEGMENTATION&&n!==Z.CHANGE_PLAN_TEAM_PLANS&&yr(r,m.searchParams),n===Z.SEGMENTATION&&gt(u,m.searchParams,Zn),gt(d,m.searchParams,Zn),l===Ut.DRAFT&&gt({af:Uc},m.searchParams,Zn),m.toString()}var Zn=new Set(["af","ai","apc","appctxid","cli","co","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),Gc=["env","workflowStep","clientId","country"];function Bc(e){var t,r;try{for(var n=Hc(Gc),i=n.next();!i.done;i=n.next()){var o=i.value;if(!e[o])throw new Error('Argument "checkoutData" is not valid, missing: '+o)}}catch(a){t={error:a}}finally{try{i&&!i.done&&(r=n.return)&&r.call(n)}finally{if(t)throw t.error}}if(e.workflowStep!==Z.SEGMENTATION&&e.workflowStep!==Z.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}function Qn(e,t){switch(e){case Be.V2:return aa(t);case Be.V3:return Jn(t);default:return console.warn("Unsupported CheckoutType, will use UCv3 as default. Given type: "+e),Jn(t)}}var ei;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(ei||(ei={}));var U;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(U||(U={}));var k;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(k||(k={}));var ti;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(ti||(ti={}));var ri;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(ri||(ri={}));var ni;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(ni||(ni={}));var ii;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(ii||(ii={}));var sa="tacocat.js";var Tr=(e,t)=>String(e??"").toLowerCase()==String(t??"").toLowerCase(),ca=e=>`${e??""}`.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t]??t)??"";function O(e,t={},{metadata:r=!0,search:n=!0,storage:i=!0}={}){let o;if(n&&o==null){let a=new URLSearchParams(window.location.search),s=xt(n)?n:e;o=a.get(s)}if(i&&o==null){let a=xt(i)?i:e;o=window.sessionStorage.getItem(a)??window.localStorage.getItem(a)}if(r&&o==null){let a=zc(xt(r)?r:e);o=document.documentElement.querySelector(`meta[name="${a}"]`)?.content}return o??t[e]}var bt=()=>{};var la=e=>typeof e=="boolean",Dt=e=>typeof e=="function",Lr=e=>typeof e=="number",ha=e=>e!=null&&typeof e=="object";var xt=e=>typeof e=="string",oi=e=>xt(e)&&e,vt=e=>Lr(e)&&Number.isFinite(e)&&e>0;function At(e,t=r=>r==null||r===""){return e!=null&&Object.entries(e).forEach(([r,n])=>{t(n)&&delete e[r]}),e}function T(e,t){if(la(e))return e;let r=String(e);return r==="1"||r==="true"?!0:r==="0"||r==="false"?!1:t}function Le(e,t,r){let n=Object.values(t);return n.find(i=>Tr(i,e))??r??n[0]}function zc(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,r,n)=>`${r}-${n}`).replace(/\W+/gu,"-").toLowerCase()}function Et(e,t=1){return Lr(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:t}var Fc=Date.now(),ai=()=>`(+${Date.now()-Fc}ms)`,_r=new Set,Kc=T(O("tacocat.debug",{},{metadata:!1}),typeof process<"u"&&process.env?.DEBUG);function da(e){let t=`[${sa}/${e}]`,r=(a,s,...c)=>a?!0:(i(s,...c),!1),n=Kc?(a,...s)=>{console.debug(`${t} ${a}`,...s,ai())}:()=>{},i=(a,...s)=>{let c=`${t} ${a}`;_r.forEach(([h])=>h(c,...s))};return{assert:r,debug:n,error:i,warn:(a,...s)=>{let c=`${t} ${a}`;_r.forEach(([,h])=>h(c,...s))}}}function jc(e,t){let r=[e,t];return _r.add(r),()=>{_r.delete(r)}}jc((e,...t)=>{console.error(e,...t,ai())},(e,...t)=>{console.warn(e,...t,ai())});var Yc="no promo",ua="promo-tag",Xc="yellow",Wc="neutral",qc=(e,t,r)=>{let n=o=>o||Yc,i=r?` (was "${n(t)}")`:"";return`${n(e)}${i}`},Zc="cancel-context",Gt=(e,t)=>{let r=e===Zc,n=!r&&e?.length>0,i=(n||r)&&(t&&t!=e||!t&&!r),o=i&&n||!i&&!!t,a=o?e||t:void 0;return{effectivePromoCode:a,overridenPromoCode:e,className:o?ua:`${ua} no-promo`,text:qc(a,t,i),variant:o?Xc:Wc,isOverriden:i}};var si="ABM",ci="PUF",li="M2M",hi="PERPETUAL",di="P3Y",Jc="TAX_INCLUSIVE_DETAILS",Qc="TAX_EXCLUSIVE",ma={ABM:si,PUF:ci,M2M:li,PERPETUAL:hi,P3Y:di},Lm={[si]:{commitment:U.YEAR,term:k.MONTHLY},[ci]:{commitment:U.YEAR,term:k.ANNUAL},[li]:{commitment:U.MONTH,term:k.MONTHLY},[hi]:{commitment:U.PERPETUAL,term:void 0},[di]:{commitment:U.THREE_MONTHS,term:k.P3Y}},pa="Value is not an offer",wr=e=>{if(typeof e!="object")return pa;let{commitment:t,term:r}=e,n=el(t,r);return{...e,planType:n}};var el=(e,t)=>{switch(e){case void 0:return pa;case"":return"";case U.YEAR:return t===k.MONTHLY?si:t===k.ANNUAL?ci:"";case U.MONTH:return t===k.MONTHLY?li:"";case U.PERPETUAL:return hi;case U.TERM_LICENSE:return t===k.P3Y?di:"";default:return""}};function ui(e){let{priceDetails:t}=e,{price:r,priceWithoutDiscount:n,priceWithoutTax:i,priceWithoutDiscountAndTax:o,taxDisplay:a}=t;if(a!==Jc)return e;let s={...e,priceDetails:{...t,price:i??r,priceWithoutDiscount:o??n,taxDisplay:Qc}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var mi=function(e,t){return mi=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(r,n){r.__proto__=n}||function(r,n){for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(r[i]=n[i])},mi(e,t)};function Bt(e,t){if(typeof t!="function"&&t!==null)throw new TypeError("Class extends value "+String(t)+" is not a constructor or null");mi(e,t);function r(){this.constructor=e}e.prototype=t===null?Object.create(t):(r.prototype=t.prototype,new r)}var E=function(){return E=Object.assign||function(t){for(var r,n=1,i=arguments.length;n<i;n++){r=arguments[n];for(var o in r)Object.prototype.hasOwnProperty.call(r,o)&&(t[o]=r[o])}return t},E.apply(this,arguments)};function Pr(e,t,r){if(r||arguments.length===2)for(var n=0,i=t.length,o;n<i;n++)(o||!(n in t))&&(o||(o=Array.prototype.slice.call(t,0,n)),o[n]=t[n]);return e.concat(o||Array.prototype.slice.call(t))}var v;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(v||(v={}));var P;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(P||(P={}));var ze;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(ze||(ze={}));function pi(e){return e.type===P.literal}function fa(e){return e.type===P.argument}function Cr(e){return e.type===P.number}function Ir(e){return e.type===P.date}function Nr(e){return e.type===P.time}function kr(e){return e.type===P.select}function Or(e){return e.type===P.plural}function ga(e){return e.type===P.pound}function Rr(e){return e.type===P.tag}function Vr(e){return!!(e&&typeof e=="object"&&e.type===ze.number)}function zt(e){return!!(e&&typeof e=="object"&&e.type===ze.dateTime)}var fi=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var tl=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function xa(e){var t={};return e.replace(tl,function(r){var n=r.length;switch(r[0]){case"G":t.era=n===4?"long":n===5?"narrow":"short";break;case"y":t.year=n===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":t.month=["numeric","2-digit","short","long","narrow"][n-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":t.day=["numeric","2-digit"][n-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":t.weekday=n===4?"short":n===5?"narrow":"short";break;case"e":if(n<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][n-4];break;case"c":if(n<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][n-4];break;case"a":t.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":t.hourCycle="h12",t.hour=["numeric","2-digit"][n-1];break;case"H":t.hourCycle="h23",t.hour=["numeric","2-digit"][n-1];break;case"K":t.hourCycle="h11",t.hour=["numeric","2-digit"][n-1];break;case"k":t.hourCycle="h24",t.hour=["numeric","2-digit"][n-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":t.minute=["numeric","2-digit"][n-1];break;case"s":t.second=["numeric","2-digit"][n-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":t.timeZoneName=n<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),t}var ba=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function Sa(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var t=e.split(ba).filter(function(u){return u.length>0}),r=[],n=0,i=t;n<i.length;n++){var o=i[n],a=o.split("/");if(a.length===0)throw new Error("Invalid number skeleton");for(var s=a[0],c=a.slice(1),h=0,l=c;h<l.length;h++){var d=l[h];if(d.length===0)throw new Error("Invalid number skeleton")}r.push({stem:s,options:c})}return r}function rl(e){return e.replace(/^(.*?)-/,"")}var va=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,ya=/^(@+)?(\+|#+)?[rs]?$/g,nl=/(\*)(0+)|(#+)(0+)|(0+)/g,Ta=/^(0+)$/;function Aa(e){var t={};return e[e.length-1]==="r"?t.roundingPriority="morePrecision":e[e.length-1]==="s"&&(t.roundingPriority="lessPrecision"),e.replace(ya,function(r,n,i){return typeof i!="string"?(t.minimumSignificantDigits=n.length,t.maximumSignificantDigits=n.length):i==="+"?t.minimumSignificantDigits=n.length:n[0]==="#"?t.maximumSignificantDigits=n.length:(t.minimumSignificantDigits=n.length,t.maximumSignificantDigits=n.length+(typeof i=="string"?i.length:0)),""}),t}function La(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function il(e){var t;if(e[0]==="E"&&e[1]==="E"?(t={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(t={notation:"scientific"},e=e.slice(1)),t){var r=e.slice(0,2);if(r==="+!"?(t.signDisplay="always",e=e.slice(2)):r==="+?"&&(t.signDisplay="exceptZero",e=e.slice(2)),!Ta.test(e))throw new Error("Malformed concise eng/scientific notation");t.minimumIntegerDigits=e.length}return t}function Ea(e){var t={},r=La(e);return r||t}function _a(e){for(var t={},r=0,n=e;r<n.length;r++){var i=n[r];switch(i.stem){case"percent":case"%":t.style="percent";continue;case"%x100":t.style="percent",t.scale=100;continue;case"currency":t.style="currency",t.currency=i.options[0];continue;case"group-off":case",_":t.useGrouping=!1;continue;case"precision-integer":case".":t.maximumFractionDigits=0;continue;case"measure-unit":case"unit":t.style="unit",t.unit=rl(i.options[0]);continue;case"compact-short":case"K":t.notation="compact",t.compactDisplay="short";continue;case"compact-long":case"KK":t.notation="compact",t.compactDisplay="long";continue;case"scientific":t=E(E(E({},t),{notation:"scientific"}),i.options.reduce(function(c,h){return E(E({},c),Ea(h))},{}));continue;case"engineering":t=E(E(E({},t),{notation:"engineering"}),i.options.reduce(function(c,h){return E(E({},c),Ea(h))},{}));continue;case"notation-simple":t.notation="standard";continue;case"unit-width-narrow":t.currencyDisplay="narrowSymbol",t.unitDisplay="narrow";continue;case"unit-width-short":t.currencyDisplay="code",t.unitDisplay="short";continue;case"unit-width-full-name":t.currencyDisplay="name",t.unitDisplay="long";continue;case"unit-width-iso-code":t.currencyDisplay="symbol";continue;case"scale":t.scale=parseFloat(i.options[0]);continue;case"integer-width":if(i.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");i.options[0].replace(nl,function(c,h,l,d,u,m){if(h)t.minimumIntegerDigits=l.length;else{if(d&&u)throw new Error("We currently do not support maximum integer digits");if(m)throw new Error("We currently do not support exact integer digits")}return""});continue}if(Ta.test(i.stem)){t.minimumIntegerDigits=i.stem.length;continue}if(va.test(i.stem)){if(i.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");i.stem.replace(va,function(c,h,l,d,u,m){return l==="*"?t.minimumFractionDigits=h.length:d&&d[0]==="#"?t.maximumFractionDigits=d.length:u&&m?(t.minimumFractionDigits=u.length,t.maximumFractionDigits=u.length+m.length):(t.minimumFractionDigits=h.length,t.maximumFractionDigits=h.length),""});var o=i.options[0];o==="w"?t=E(E({},t),{trailingZeroDisplay:"stripIfInteger"}):o&&(t=E(E({},t),Aa(o)));continue}if(ya.test(i.stem)){t=E(E({},t),Aa(i.stem));continue}var a=La(i.stem);a&&(t=E(E({},t),a));var s=il(i.stem);s&&(t=E(E({},t),s))}return t}var Ft={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function wa(e,t){for(var r="",n=0;n<e.length;n++){var i=e.charAt(n);if(i==="j"){for(var o=0;n+1<e.length&&e.charAt(n+1)===i;)o++,n++;var a=1+(o&1),s=o<2?1:3+(o>>1),c="a",h=ol(t);for((h=="H"||h=="k")&&(s=0);s-- >0;)r+=c;for(;a-- >0;)r=h+r}else i==="J"?r+="H":r+=i}return r}function ol(e){var t=e.hourCycle;if(t===void 0&&e.hourCycles&&e.hourCycles.length&&(t=e.hourCycles[0]),t)switch(t){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var r=e.language,n;r!=="root"&&(n=e.maximize().region);var i=Ft[n||""]||Ft[r||""]||Ft["".concat(r,"-001")]||Ft["001"];return i[0]}var gi,al=new RegExp("^".concat(fi.source,"*")),sl=new RegExp("".concat(fi.source,"*$"));function S(e,t){return{start:e,end:t}}var cl=!!String.prototype.startsWith,ll=!!String.fromCodePoint,hl=!!Object.fromEntries,dl=!!String.prototype.codePointAt,ul=!!String.prototype.trimStart,ml=!!String.prototype.trimEnd,pl=!!Number.isSafeInteger,fl=pl?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},bi=!0;try{Pa=ka("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),bi=((gi=Pa.exec("a"))===null||gi===void 0?void 0:gi[0])==="a"}catch{bi=!1}var Pa,Ca=cl?function(t,r,n){return t.startsWith(r,n)}:function(t,r,n){return t.slice(n,n+r.length)===r},vi=ll?String.fromCodePoint:function(){for(var t=[],r=0;r<arguments.length;r++)t[r]=arguments[r];for(var n="",i=t.length,o=0,a;i>o;){if(a=t[o++],a>1114111)throw RangeError(a+" is not a valid code point");n+=a<65536?String.fromCharCode(a):String.fromCharCode(((a-=65536)>>10)+55296,a%1024+56320)}return n},Ia=hl?Object.fromEntries:function(t){for(var r={},n=0,i=t;n<i.length;n++){var o=i[n],a=o[0],s=o[1];r[a]=s}return r},Na=dl?function(t,r){return t.codePointAt(r)}:function(t,r){var n=t.length;if(!(r<0||r>=n)){var i=t.charCodeAt(r),o;return i<55296||i>56319||r+1===n||(o=t.charCodeAt(r+1))<56320||o>57343?i:(i-55296<<10)+(o-56320)+65536}},gl=ul?function(t){return t.trimStart()}:function(t){return t.replace(al,"")},xl=ml?function(t){return t.trimEnd()}:function(t){return t.replace(sl,"")};function ka(e,t){return new RegExp(e,t)}var Ai;bi?(xi=ka("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Ai=function(t,r){var n;xi.lastIndex=r;var i=xi.exec(t);return(n=i[1])!==null&&n!==void 0?n:""}):Ai=function(t,r){for(var n=[];;){var i=Na(t,r);if(i===void 0||Ra(i)||Al(i))break;n.push(i),r+=i>=65536?2:1}return vi.apply(void 0,n)};var xi,Oa=function(){function e(t,r){r===void 0&&(r={}),this.message=t,this.position={offset:0,line:1,column:1},this.ignoreTag=!!r.ignoreTag,this.locale=r.locale,this.requiresOtherClause=!!r.requiresOtherClause,this.shouldParseSkeletons=!!r.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(t,r,n){for(var i=[];!this.isEOF();){var o=this.char();if(o===123){var a=this.parseArgument(t,n);if(a.err)return a;i.push(a.val)}else{if(o===125&&t>0)break;if(o===35&&(r==="plural"||r==="selectordinal")){var s=this.clonePosition();this.bump(),i.push({type:P.pound,location:S(s,this.clonePosition())})}else if(o===60&&!this.ignoreTag&&this.peek()===47){if(n)break;return this.error(v.UNMATCHED_CLOSING_TAG,S(this.clonePosition(),this.clonePosition()))}else if(o===60&&!this.ignoreTag&&Ei(this.peek()||0)){var a=this.parseTag(t,r);if(a.err)return a;i.push(a.val)}else{var a=this.parseLiteral(t,r);if(a.err)return a;i.push(a.val)}}}return{val:i,err:null}},e.prototype.parseTag=function(t,r){var n=this.clonePosition();this.bump();var i=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:P.literal,value:"<".concat(i,"/>"),location:S(n,this.clonePosition())},err:null};if(this.bumpIf(">")){var o=this.parseMessage(t+1,r,!0);if(o.err)return o;var a=o.val,s=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!Ei(this.char()))return this.error(v.INVALID_TAG,S(s,this.clonePosition()));var c=this.clonePosition(),h=this.parseTagName();return i!==h?this.error(v.UNMATCHED_CLOSING_TAG,S(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:P.tag,value:i,children:a,location:S(n,this.clonePosition())},err:null}:this.error(v.INVALID_TAG,S(s,this.clonePosition())))}else return this.error(v.UNCLOSED_TAG,S(n,this.clonePosition()))}else return this.error(v.INVALID_TAG,S(n,this.clonePosition()))},e.prototype.parseTagName=function(){var t=this.offset();for(this.bump();!this.isEOF()&&vl(this.char());)this.bump();return this.message.slice(t,this.offset())},e.prototype.parseLiteral=function(t,r){for(var n=this.clonePosition(),i="";;){var o=this.tryParseQuote(r);if(o){i+=o;continue}var a=this.tryParseUnquoted(t,r);if(a){i+=a;continue}var s=this.tryParseLeftAngleBracket();if(s){i+=s;continue}break}var c=S(n,this.clonePosition());return{val:{type:P.literal,value:i,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!bl(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(t){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(t==="plural"||t==="selectordinal")break;return null;default:return null}this.bump();var r=[this.char()];for(this.bump();!this.isEOF();){var n=this.char();if(n===39)if(this.peek()===39)r.push(39),this.bump();else{this.bump();break}else r.push(n);this.bump()}return vi.apply(void 0,r)},e.prototype.tryParseUnquoted=function(t,r){if(this.isEOF())return null;var n=this.char();return n===60||n===123||n===35&&(r==="plural"||r==="selectordinal")||n===125&&t>0?null:(this.bump(),vi(n))},e.prototype.parseArgument=function(t,r){var n=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(v.EXPECT_ARGUMENT_CLOSING_BRACE,S(n,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(v.EMPTY_ARGUMENT,S(n,this.clonePosition()));var i=this.parseIdentifierIfPossible().value;if(!i)return this.error(v.MALFORMED_ARGUMENT,S(n,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(v.EXPECT_ARGUMENT_CLOSING_BRACE,S(n,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:P.argument,value:i,location:S(n,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(v.EXPECT_ARGUMENT_CLOSING_BRACE,S(n,this.clonePosition())):this.parseArgumentOptions(t,r,i,n);default:return this.error(v.MALFORMED_ARGUMENT,S(n,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var t=this.clonePosition(),r=this.offset(),n=Ai(this.message,r),i=r+n.length;this.bumpTo(i);var o=this.clonePosition(),a=S(t,o);return{value:n,location:a}},e.prototype.parseArgumentOptions=function(t,r,n,i){var o,a=this.clonePosition(),s=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(s){case"":return this.error(v.EXPECT_ARGUMENT_TYPE,S(a,c));case"number":case"date":case"time":{this.bumpSpace();var h=null;if(this.bumpIf(",")){this.bumpSpace();var l=this.clonePosition(),d=this.parseSimpleArgStyleIfPossible();if(d.err)return d;var u=xl(d.val);if(u.length===0)return this.error(v.EXPECT_ARGUMENT_STYLE,S(this.clonePosition(),this.clonePosition()));var m=S(l,this.clonePosition());h={style:u,styleLocation:m}}var f=this.tryParseArgumentClose(i);if(f.err)return f;var g=S(i,this.clonePosition());if(h&&Ca(h?.style,"::",0)){var A=gl(h.style.slice(2));if(s==="number"){var d=this.parseNumberSkeletonFromString(A,h.styleLocation);return d.err?d:{val:{type:P.number,value:n,location:g,style:d.val},err:null}}else{if(A.length===0)return this.error(v.EXPECT_DATE_TIME_SKELETON,g);var w=A;this.locale&&(w=wa(A,this.locale));var u={type:ze.dateTime,pattern:w,location:h.styleLocation,parsedOptions:this.shouldParseSkeletons?xa(w):{}},b=s==="date"?P.date:P.time;return{val:{type:b,value:n,location:g,style:u},err:null}}}return{val:{type:s==="number"?P.number:s==="date"?P.date:P.time,value:n,location:g,style:(o=h?.style)!==null&&o!==void 0?o:null},err:null}}case"plural":case"selectordinal":case"select":{var y=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(v.EXPECT_SELECT_ARGUMENT_OPTIONS,S(y,E({},y)));this.bumpSpace();var N=this.parseIdentifierIfPossible(),R=0;if(s!=="select"&&N.value==="offset"){if(!this.bumpIf(":"))return this.error(v.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,S(this.clonePosition(),this.clonePosition()));this.bumpSpace();var d=this.tryParseDecimalInteger(v.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,v.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(d.err)return d;this.bumpSpace(),N=this.parseIdentifierIfPossible(),R=d.val}var V=this.tryParsePluralOrSelectOptions(t,s,r,N);if(V.err)return V;var f=this.tryParseArgumentClose(i);if(f.err)return f;var H=S(i,this.clonePosition());return s==="select"?{val:{type:P.select,value:n,options:Ia(V.val),location:H},err:null}:{val:{type:P.plural,value:n,options:Ia(V.val),offset:R,pluralType:s==="plural"?"cardinal":"ordinal",location:H},err:null}}default:return this.error(v.INVALID_ARGUMENT_TYPE,S(a,c))}},e.prototype.tryParseArgumentClose=function(t){return this.isEOF()||this.char()!==125?this.error(v.EXPECT_ARGUMENT_CLOSING_BRACE,S(t,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var t=0,r=this.clonePosition();!this.isEOF();){var n=this.char();switch(n){case 39:{this.bump();var i=this.clonePosition();if(!this.bumpUntil("'"))return this.error(v.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,S(i,this.clonePosition()));this.bump();break}case 123:{t+=1,this.bump();break}case 125:{if(t>0)t-=1;else return{val:this.message.slice(r.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(r.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(t,r){var n=[];try{n=Sa(t)}catch{return this.error(v.INVALID_NUMBER_SKELETON,r)}return{val:{type:ze.number,tokens:n,location:r,parsedOptions:this.shouldParseSkeletons?_a(n):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(t,r,n,i){for(var o,a=!1,s=[],c=new Set,h=i.value,l=i.location;;){if(h.length===0){var d=this.clonePosition();if(r!=="select"&&this.bumpIf("=")){var u=this.tryParseDecimalInteger(v.EXPECT_PLURAL_ARGUMENT_SELECTOR,v.INVALID_PLURAL_ARGUMENT_SELECTOR);if(u.err)return u;l=S(d,this.clonePosition()),h=this.message.slice(d.offset,this.offset())}else break}if(c.has(h))return this.error(r==="select"?v.DUPLICATE_SELECT_ARGUMENT_SELECTOR:v.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,l);h==="other"&&(a=!0),this.bumpSpace();var m=this.clonePosition();if(!this.bumpIf("{"))return this.error(r==="select"?v.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:v.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,S(this.clonePosition(),this.clonePosition()));var f=this.parseMessage(t+1,r,n);if(f.err)return f;var g=this.tryParseArgumentClose(m);if(g.err)return g;s.push([h,{value:f.val,location:S(m,this.clonePosition())}]),c.add(h),this.bumpSpace(),o=this.parseIdentifierIfPossible(),h=o.value,l=o.location}return s.length===0?this.error(r==="select"?v.EXPECT_SELECT_ARGUMENT_SELECTOR:v.EXPECT_PLURAL_ARGUMENT_SELECTOR,S(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!a?this.error(v.MISSING_OTHER_CLAUSE,S(this.clonePosition(),this.clonePosition())):{val:s,err:null}},e.prototype.tryParseDecimalInteger=function(t,r){var n=1,i=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(n=-1);for(var o=!1,a=0;!this.isEOF();){var s=this.char();if(s>=48&&s<=57)o=!0,a=a*10+(s-48),this.bump();else break}var c=S(i,this.clonePosition());return o?(a*=n,fl(a)?{val:a,err:null}:this.error(r,c)):this.error(t,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var t=this.position.offset;if(t>=this.message.length)throw Error("out of bound");var r=Na(this.message,t);if(r===void 0)throw Error("Offset ".concat(t," is at invalid UTF-16 code unit boundary"));return r},e.prototype.error=function(t,r){return{val:null,err:{kind:t,message:this.message,location:r}}},e.prototype.bump=function(){if(!this.isEOF()){var t=this.char();t===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=t<65536?1:2)}},e.prototype.bumpIf=function(t){if(Ca(this.message,t,this.offset())){for(var r=0;r<t.length;r++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(t){var r=this.offset(),n=this.message.indexOf(t,r);return n>=0?(this.bumpTo(n),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(t){if(this.offset()>t)throw Error("targetOffset ".concat(t," must be greater than or equal to the current offset ").concat(this.offset()));for(t=Math.min(t,this.message.length);;){var r=this.offset();if(r===t)break;if(r>t)throw Error("targetOffset ".concat(t," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&Ra(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var t=this.char(),r=this.offset(),n=this.message.charCodeAt(r+(t>=65536?2:1));return n??null},e}();function Ei(e){return e>=97&&e<=122||e>=65&&e<=90}function bl(e){return Ei(e)||e===47}function vl(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function Ra(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function Al(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function Si(e){e.forEach(function(t){if(delete t.location,kr(t)||Or(t))for(var r in t.options)delete t.options[r].location,Si(t.options[r].value);else Cr(t)&&Vr(t.style)||(Ir(t)||Nr(t))&&zt(t.style)?delete t.style.location:Rr(t)&&Si(t.children)})}function Va(e,t){t===void 0&&(t={}),t=E({shouldParseSkeletons:!0,requiresOtherClause:!0},t);var r=new Oa(e,t).parse();if(r.err){var n=SyntaxError(v[r.err.kind]);throw n.location=r.err.location,n.originalMessage=r.err.message,n}return t?.captureLocation||Si(r.val),r.val}function Kt(e,t){var r=t&&t.cache?t.cache:_l,n=t&&t.serializer?t.serializer:Ll,i=t&&t.strategy?t.strategy:Sl;return i(e,{cache:r,serializer:n})}function El(e){return e==null||typeof e=="number"||typeof e=="boolean"}function Ma(e,t,r,n){var i=El(n)?n:r(n),o=t.get(i);return typeof o>"u"&&(o=e.call(this,n),t.set(i,o)),o}function $a(e,t,r){var n=Array.prototype.slice.call(arguments,3),i=r(n),o=t.get(i);return typeof o>"u"&&(o=e.apply(this,n),t.set(i,o)),o}function yi(e,t,r,n,i){return r.bind(t,e,n,i)}function Sl(e,t){var r=e.length===1?Ma:$a;return yi(e,this,r,t.cache.create(),t.serializer)}function yl(e,t){return yi(e,this,$a,t.cache.create(),t.serializer)}function Tl(e,t){return yi(e,this,Ma,t.cache.create(),t.serializer)}var Ll=function(){return JSON.stringify(arguments)};function Ti(){this.cache=Object.create(null)}Ti.prototype.get=function(e){return this.cache[e]};Ti.prototype.set=function(e,t){this.cache[e]=t};var _l={create:function(){return new Ti}},Mr={variadic:yl,monadic:Tl};var Fe;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(Fe||(Fe={}));var jt=function(e){Bt(t,e);function t(r,n,i){var o=e.call(this,r)||this;return o.code=n,o.originalMessage=i,o}return t.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},t}(Error);var Li=function(e){Bt(t,e);function t(r,n,i,o){return e.call(this,'Invalid values for "'.concat(r,'": "').concat(n,'". Options are "').concat(Object.keys(i).join('", "'),'"'),Fe.INVALID_VALUE,o)||this}return t}(jt);var Ha=function(e){Bt(t,e);function t(r,n,i){return e.call(this,'Value for "'.concat(r,'" must be of type ').concat(n),Fe.INVALID_VALUE,i)||this}return t}(jt);var Ua=function(e){Bt(t,e);function t(r,n){return e.call(this,'The intl string context variable "'.concat(r,'" was not provided to the string "').concat(n,'"'),Fe.MISSING_VALUE,n)||this}return t}(jt);var j;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(j||(j={}));function wl(e){return e.length<2?e:e.reduce(function(t,r){var n=t[t.length-1];return!n||n.type!==j.literal||r.type!==j.literal?t.push(r):n.value+=r.value,t},[])}function Pl(e){return typeof e=="function"}function Yt(e,t,r,n,i,o,a){if(e.length===1&&pi(e[0]))return[{type:j.literal,value:e[0].value}];for(var s=[],c=0,h=e;c<h.length;c++){var l=h[c];if(pi(l)){s.push({type:j.literal,value:l.value});continue}if(ga(l)){typeof o=="number"&&s.push({type:j.literal,value:r.getNumberFormat(t).format(o)});continue}var d=l.value;if(!(i&&d in i))throw new Ua(d,a);var u=i[d];if(fa(l)){(!u||typeof u=="string"||typeof u=="number")&&(u=typeof u=="string"||typeof u=="number"?String(u):""),s.push({type:typeof u=="string"?j.literal:j.object,value:u});continue}if(Ir(l)){var m=typeof l.style=="string"?n.date[l.style]:zt(l.style)?l.style.parsedOptions:void 0;s.push({type:j.literal,value:r.getDateTimeFormat(t,m).format(u)});continue}if(Nr(l)){var m=typeof l.style=="string"?n.time[l.style]:zt(l.style)?l.style.parsedOptions:n.time.medium;s.push({type:j.literal,value:r.getDateTimeFormat(t,m).format(u)});continue}if(Cr(l)){var m=typeof l.style=="string"?n.number[l.style]:Vr(l.style)?l.style.parsedOptions:void 0;m&&m.scale&&(u=u*(m.scale||1)),s.push({type:j.literal,value:r.getNumberFormat(t,m).format(u)});continue}if(Rr(l)){var f=l.children,g=l.value,A=i[g];if(!Pl(A))throw new Ha(g,"function",a);var w=Yt(f,t,r,n,i,o),b=A(w.map(function(R){return R.value}));Array.isArray(b)||(b=[b]),s.push.apply(s,b.map(function(R){return{type:typeof R=="string"?j.literal:j.object,value:R}}))}if(kr(l)){var y=l.options[u]||l.options.other;if(!y)throw new Li(l.value,u,Object.keys(l.options),a);s.push.apply(s,Yt(y.value,t,r,n,i));continue}if(Or(l)){var y=l.options["=".concat(u)];if(!y){if(!Intl.PluralRules)throw new jt(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,Fe.MISSING_INTL_API,a);var N=r.getPluralRules(t,{type:l.pluralType}).select(u-(l.offset||0));y=l.options[N]||l.options.other}if(!y)throw new Li(l.value,u,Object.keys(l.options),a);s.push.apply(s,Yt(y.value,t,r,n,i,u-(l.offset||0)));continue}}return wl(s)}function Cl(e,t){return t?E(E(E({},e||{}),t||{}),Object.keys(e).reduce(function(r,n){return r[n]=E(E({},e[n]),t[n]||{}),r},{})):e}function Il(e,t){return t?Object.keys(e).reduce(function(r,n){return r[n]=Cl(e[n],t[n]),r},E({},e)):e}function _i(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function Nl(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Kt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.NumberFormat).bind.apply(t,Pr([void 0],r,!1)))},{cache:_i(e.number),strategy:Mr.variadic}),getDateTimeFormat:Kt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.DateTimeFormat).bind.apply(t,Pr([void 0],r,!1)))},{cache:_i(e.dateTime),strategy:Mr.variadic}),getPluralRules:Kt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.PluralRules).bind.apply(t,Pr([void 0],r,!1)))},{cache:_i(e.pluralRules),strategy:Mr.variadic})}}var Da=function(){function e(t,r,n,i){var o=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(a){var s=o.formatToParts(a);if(s.length===1)return s[0].value;var c=s.reduce(function(h,l){return!h.length||l.type!==j.literal||typeof h[h.length-1]!="string"?h.push(l.value):h[h.length-1]+=l.value,h},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(a){return Yt(o.ast,o.locales,o.formatters,o.formats,a,void 0,o.message)},this.resolvedOptions=function(){return{locale:o.resolvedLocale.toString()}},this.getAst=function(){return o.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Il(e.formats,n),this.formatters=i&&i.formatters||Nl(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=Va,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var Ga=Da;var kl=/[0-9\-+#]/,Ol=/[^\d\-+#]/g;function Ba(e){return e.search(kl)}function Rl(e="#.##"){let t={},r=e.length,n=Ba(e);t.prefix=n>0?e.substring(0,n):"";let i=Ba(e.split("").reverse().join("")),o=r-i,a=e.substring(o,o+1),s=o+(a==="."||a===","?1:0);t.suffix=i>0?e.substring(s,r):"",t.mask=e.substring(n,s),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let c=t.mask.match(Ol);return t.decimal=c&&c[c.length-1]||".",t.separator=c&&c[1]&&c[0]||",",c=t.mask.split(t.decimal),t.integer=c[0],t.fraction=c[1],t}function Vl(e,t,r){let n=!1,i={value:e};e<0&&(n=!0,i.value=-i.value),i.sign=n?"-":"",i.value=Number(i.value).toFixed(t.fraction&&t.fraction.length),i.value=Number(i.value).toString();let o=t.fraction&&t.fraction.lastIndexOf("0"),[a="0",s=""]=i.value.split(".");return(!s||s&&s.length<=o)&&(s=o<0?"":(+("0."+s)).toFixed(o+1).replace("0.","")),i.integer=a,i.fraction=s,Ml(i,t),(i.result==="0"||i.result==="")&&(n=!1,i.sign=""),!n&&t.maskHasPositiveSign?i.sign="+":n&&t.maskHasPositiveSign?i.sign="-":n&&(i.sign=r&&r.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),i}function Ml(e,t){e.result="";let r=t.integer.split(t.separator),n=r.join(""),i=n&&n.indexOf("0");if(i>-1)for(;e.integer.length<n.length-i;)e.integer="0"+e.integer;else Number(e.integer)===0&&(e.integer="");let o=r[1]&&r[r.length-1].length;if(o){let a=e.integer.length,s=a%o;for(let c=0;c<a;c++)e.result+=e.integer.charAt(c),!((c-s+1)%o)&&c<a-o&&(e.result+=t.separator)}else e.result=e.integer;return e.result+=t.fraction&&e.fraction?t.decimal+e.fraction:"",e}function $l(e,t,r={}){if(!e||isNaN(Number(t)))return t;let n=Rl(e),i=Vl(t,n,r);return n.prefix+i.sign+i.result+n.suffix}var za=$l;var Fa=".",Hl=",",ja=/^\s+/,Ya=/\s+$/,Ka="&nbsp;",Xt={MONTH:"MONTH",YEAR:"YEAR"},Ul={[k.ANNUAL]:12,[k.MONTHLY]:1,[k.THREE_YEARS]:36,[k.TWO_YEARS]:24},Dl={CHF:e=>Math.round(e*20)/20},wi=(e,t)=>({accept:e,round:t}),Gl=[wi(({divisor:e,price:t})=>t%e==0,({divisor:e,price:t})=>t/e),wi(({usePrecision:e})=>e,({divisor:e,price:t})=>Math.ceil(Math.floor(t*1e4/e)/100)/100),wi(()=>!0,({divisor:e,price:t})=>Math.ceil(Math.floor(t*100/e)/100))],Pi={[U.YEAR]:{[k.MONTHLY]:Xt.MONTH,[k.ANNUAL]:Xt.YEAR},[U.MONTH]:{[k.MONTHLY]:Xt.MONTH}},Bl=(e,t)=>e.indexOf(`'${t}'`)===0,zl=(e,t=!0)=>{let r=e.replace(/'.*?'/,"").trim(),n=Wa(r);return!!n?t||(r=r.replace(/[,\.]0+/,n)):r=r.replace(/\s?(#.*0)(?!\s)?/,"$&"+Kl(e)),r},Fl=e=>{let t=jl(e),r=Bl(e,t),n=e.replace(/'.*?'/,""),i=ja.test(n)||Ya.test(n);return{currencySymbol:t,isCurrencyFirst:r,hasCurrencySpace:i}},Xa=e=>e.replace(ja,Ka).replace(Ya,Ka),Kl=e=>e.match(/#(.?)#/)?.[1]===Fa?Hl:Fa,jl=e=>e.match(/'(.*?)'/)?.[1]??"",Wa=e=>e.match(/0(.?)0/)?.[1]??"";function $r({formatString:e,price:t,usePrecision:r,isIndianPrice:n=!1},i,o=a=>a){let{currencySymbol:a,isCurrencyFirst:s,hasCurrencySpace:c}=Fl(e),h=r?Wa(e):"",l=zl(e,r),d=r?2:0,u=o(t,{currencySymbol:a}),m=n?u.toLocaleString("hi-IN",{minimumFractionDigits:d,maximumFractionDigits:d}):za(l,u),f=r?m.lastIndexOf(h):m.length,g=m.substring(0,f),A=m.substring(f+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,m).replace(/SYMBOL/,a),currencySymbol:a,decimals:A,decimalsDelimiter:h,hasCurrencySpace:c,integer:g,isCurrencyFirst:s,recurrenceTerm:i}}var qa=e=>{let{commitment:t,term:r,usePrecision:n}=e,i=Ul[r]??1;return $r(e,i>1?Xt.MONTH:Pi[t]?.[r],(o,{currencySymbol:a})=>{let s={divisor:i,price:o,usePrecision:n},{round:c}=Gl.find(({accept:l})=>l(s));if(!c)throw new Error(`Missing rounding rule for: ${JSON.stringify(s)}`);return(Dl[a]??(l=>l))(c(s))})},Za=({commitment:e,term:t,...r})=>$r(r,Pi[e]?.[t]),Ja=e=>{let{commitment:t,term:r}=e;return t===U.YEAR&&r===k.MONTHLY?$r(e,Xt.YEAR,n=>n*12):$r(e,Pi[t]?.[r])};var Yl={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at {alternativePrice}",strikethroughAriaLabel:"Regularly at {strikethroughPrice}"},Xl=da("ConsonantTemplates/price"),Wl=/<\/?[^>]+(>|$)/g,z={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Ke={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel"},ql="TAX_EXCLUSIVE",Zl=e=>ha(e)?Object.entries(e).filter(([,t])=>xt(t)||Lr(t)||t===!0).reduce((t,[r,n])=>t+` ${r}${n===!0?"":'="'+ca(n)+'"'}`,""):"",X=(e,t,r,n=!1)=>`<span class="${e}${t?"":" "+z.disabled}"${Zl(r)}>${n?Xa(t):t??""}</span>`;function Jl(e,{accessibleLabel:t,currencySymbol:r,decimals:n,decimalsDelimiter:i,hasCurrencySpace:o,integer:a,isCurrencyFirst:s,recurrenceLabel:c,perUnitLabel:h,taxInclusivityLabel:l},d={}){let u=X(z.currencySymbol,r),m=X(z.currencySpace,o?"&nbsp;":""),f="";return s&&(f+=u+m),f+=X(z.integer,a),f+=X(z.decimalsDelimiter,i),f+=X(z.decimals,n),s||(f+=m+u),f+=X(z.recurrence,c,null,!0),f+=X(z.unitType,h,null,!0),f+=X(z.taxInclusivity,l,!0),X(e,f,{...d,"aria-label":t})}var W=({displayOptical:e=!1,displayStrikethrough:t=!1,displayAnnual:r=!1}={})=>({country:n,displayFormatted:i=!0,displayRecurrence:o=!0,displayPerUnit:a=!1,displayTax:s=!1,language:c,literals:h={}}={},{commitment:l,offerSelectorIds:d,formatString:u,price:m,priceWithoutDiscount:f,taxDisplay:g,taxTerm:A,term:w,usePrecision:b}={},y={})=>{Object.entries({country:n,formatString:u,language:c,price:m}).forEach(([se,Fr])=>{if(Fr==null)throw new Error(`Argument "${se}" is missing for osi ${d?.toString()}, country ${n}, language ${c}`)});let N={...Yl,...h},R=`${c.toLowerCase()}-${n.toUpperCase()}`;function V(se,Fr){let Kr=N[se];if(Kr==null)return"";try{return new Ga(Kr.replace(Wl,""),R).format(Fr)}catch{return Xl.error("Failed to format literal:",Kr),""}}let H=t&&f?f:m,oe=e?qa:Za;r&&(oe=Ja);let{accessiblePrice:Xe,recurrenceTerm:we,...We}=oe({commitment:l,formatString:u,term:w,price:e?m:H,usePrecision:b,isIndianPrice:n==="IN"}),J=Xe,xe="";if(T(o)&&we){let se=V(Ke.recurrenceAriaLabel,{recurrenceTerm:we});se&&(J+=" "+se),xe=V(Ke.recurrenceLabel,{recurrenceTerm:we})}let ae="";if(T(a)){ae=V(Ke.perUnitLabel,{perUnit:"LICENSE"});let se=V(Ke.perUnitAriaLabel,{perUnit:"LICENSE"});se&&(J+=" "+se)}let Q="";T(s)&&A&&(Q=V(g===ql?Ke.taxExclusiveLabel:Ke.taxInclusiveLabel,{taxTerm:A}),Q&&(J+=" "+Q)),t&&(J=V(Ke.strikethroughAriaLabel,{strikethroughPrice:J}));let Pe=z.container;if(e&&(Pe+=" "+z.containerOptical),t&&(Pe+=" "+z.containerStrikethrough),r&&(Pe+=" "+z.containerAnnual),T(i))return Jl(Pe,{...We,accessibleLabel:J,recurrenceLabel:xe,perUnitLabel:ae,taxInclusivityLabel:Q},y);let{currencySymbol:ji,decimals:bs,decimalsDelimiter:vs,hasCurrencySpace:Yi,integer:As,isCurrencyFirst:Es}=We,qe=[As,vs,bs];Es?(qe.unshift(Yi?"\xA0":""),qe.unshift(ji)):(qe.push(Yi?"\xA0":""),qe.push(ji)),qe.push(xe,ae,Q);let Ss=qe.join("");return X(Pe,Ss,y)},Qa=()=>(e,t,r)=>{let i=(e.displayOldPrice===void 0||T(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${W()(e,t,r)}${i?"&nbsp;"+W({displayStrikethrough:!0})(e,t,r):""}`},es=()=>(e,t,r)=>{let n={...e,displayTax:!1,displayPerUnit:!1};return`${(e.displayOldPrice===void 0||T(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price?W({displayStrikethrough:!0})(n,t,r)+"&nbsp;":""}${W()(e,t,r)}${X(z.containerAnnualPrefix,"&nbsp;(")}${W({displayAnnual:!0})(n,t,r)}${X(z.containerAnnualSuffix,")")}`},ts=()=>(e,t,r)=>{let n={...e,displayTax:!1,displayPerUnit:!1};return`${W()(e,t,r)}${X(z.containerAnnualPrefix,"&nbsp;(")}${W({displayAnnual:!0})(n,t,r)}${X(z.containerAnnualSuffix,")")}`};var Ci=W(),Ii=Qa(),Ni=W({displayOptical:!0}),ki=W({displayStrikethrough:!0}),Oi=W({displayAnnual:!0}),Ri=ts(),Vi=es();var Ql=(e,t)=>{if(!(!vt(e)||!vt(t)))return Math.floor((t-e)/t*100)},rs=()=>(e,t)=>{let{price:r,priceWithoutDiscount:n}=t,i=Ql(r,n);return i===void 0?'<span class="no-discount"></span>':`<span class="discount">${i}%</span>`};var Mi=rs();var{freeze:Wt}=Object,te=Wt({...Be}),re=Wt({...Z}),je={STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"},$i=Wt({...U}),Hi=Wt({...ma}),Ui=Wt({...k});var ns="mas-commerce-service";function is(e,{once:t=!1}={}){let r=null;function n(){let i=document.querySelector(ns);i!==r&&(r=i,i&&e(i))}return document.addEventListener(it,n,{once:t}),_e(n),()=>document.removeEventListener(it,n)}function qt(e,{country:t,forceTaxExclusive:r,perpetual:n}){let i;if(e.length<2)i=e;else{let o=t==="GB"||n?"EN":"MULT",[a,s]=e;i=[a.language===o?a:s]}return r&&(i=i.map(ui)),i}var _e=e=>window.setTimeout(e);function St(e,t=1){if(e==null)return[t];let r=(Array.isArray(e)?e:String(e).split(",")).map(Et).filter(vt);return r.length||(r=[t]),r}function Hr(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(oi)}function q(){return document.getElementsByTagName(ns)?.[0]}var eh={[he]:Pn,[de]:Cn,[ue]:In},th={[he]:kn,[de]:On,[ue]:Rn},yt=class{constructor(t){p(this,"changes",new Map);p(this,"connected",!1);p(this,"dispose",bt);p(this,"error");p(this,"log");p(this,"options");p(this,"promises",[]);p(this,"state",de);p(this,"timer",null);p(this,"value");p(this,"version",0);p(this,"wrapperElement");this.wrapperElement=t}update(){[he,de,ue].forEach(t=>{this.wrapperElement.classList.toggle(eh[t],t===this.state)})}notify(){(this.state===ue||this.state===he)&&(this.state===ue?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===he&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]),this.wrapperElement.dispatchEvent(new CustomEvent(th[this.state],{bubbles:!0}))}attributeChangedCallback(t,r,n){this.changes.set(t,n),this.requestUpdate()}connectedCallback(){this.dispose=is(()=>this.requestUpdate(!0))}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement})),this.dispose(),this.dispose=bt}onceSettled(){let{error:t,promises:r,state:n}=this;return ue===n?Promise.resolve(this.wrapperElement):he===n?Promise.reject(t):new Promise((i,o)=>{r.push({resolve:i,reject:o})})}toggleResolved(t,r,n){return t!==this.version?!1:(n!==void 0&&(this.options=n),this.state=ue,this.value=r,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:r}),_e(()=>this.notify()),!0)}toggleFailed(t,r,n){return t!==this.version?!1:(n!==void 0&&(this.options=n),this.error=r,this.state=he,this.update(),this.log?.error("Failed:",{element:this.wrapperElement,error:r}),_e(()=>this.notify()),!0)}togglePending(t){return this.version++,t&&(this.options=t),this.state=de,this.update(),_e(()=>this.notify()),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!q()||this.timer)return;let{error:r,options:n,state:i,value:o,version:a}=this;this.state=de,this.timer=_e(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||t)try{await this.wrapperElement.render?.()===!1&&this.state===de&&this.version===a&&(this.state=i,this.error=r,this.value=o,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,n)}})}};function os(e={}){return Object.entries(e).forEach(([t,r])=>{(r==null||r===""||r?.length===0)&&delete e[t]}),e}function Ur(e,t={}){let{tag:r,is:n}=e,i=document.createElement(r,{is:n});return i.setAttribute("is",n),Object.assign(i.dataset,os(t)),i}function Dr(e,t={}){return e instanceof HTMLElement?(Object.assign(e.dataset,os(t)),e):null}var _=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflow:te.V3,checkoutWorkflowStep:re.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,env:je.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsBufferDelay:1,wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:Ue.PUBLISHED,wcsBufferLimit:1});var Di=Object.freeze({LOCAL:"local",PROD:"prod",STAGE:"stage"});function rh({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||_.language),t??(t=e?.split("_")?.[1]||_.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function Gi(e={}){let{commerce:t={}}=e,r=je.PRODUCTION,n=Hn,i=O("checkoutClientId",t)??_.checkoutClientId,o=Le(O("checkoutWorkflow",t),te,_.checkoutWorkflow),a=re.CHECKOUT;o===te.V3&&(a=Le(O("checkoutWorkflowStep",t),re,_.checkoutWorkflowStep));let s=T(O("displayOldPrice",t),_.displayOldPrice),c=T(O("displayPerUnit",t),_.displayPerUnit),h=T(O("displayRecurrence",t),_.displayRecurrence),l=T(O("displayTax",t),_.displayTax),d=T(O("entitlement",t),_.entitlement),u=T(O("modal",t),_.modal),m=T(O("forceTaxExclusive",t),_.forceTaxExclusive),f=O("promotionCode",t)??_.promotionCode,g=St(O("quantity",t)),A=O("wcsApiKey",t)??_.wcsApiKey,w=t?.env==="stage",b=Ue.PUBLISHED;["true",""].includes(t.allowOverride)&&(w=(O(Mn,t,{metadata:!1})?.toLowerCase()??t?.env)==="stage",b=Le(O($n,t),Ue,b)),w&&(r=je.STAGE,n=Un);let N=Et(O("wcsBufferDelay",t),_.wcsBufferDelay),R=Et(O("wcsBufferLimit",t),_.wcsBufferLimit);return{...rh(e),displayOldPrice:s,checkoutClientId:i,checkoutWorkflow:o,checkoutWorkflowStep:a,displayPerUnit:c,displayRecurrence:h,displayTax:l,entitlement:d,extraOptions:_.extraOptions,modal:u,env:r,forceTaxExclusive:m,promotionCode:f,quantity:g,wcsApiKey:A,wcsBufferDelay:N,wcsBufferLimit:R,wcsURL:n,landscape:b}}var Bi={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},nh=Date.now(),zi=new Set,Fi=new Set,as=new Map,ss={append({level:e,message:t,params:r,timestamp:n,source:i}){console[e](`${n}ms [${i}] %c${t}`,"font-weight: bold;",...r)}},cs={filter:({level:e})=>e!==Bi.DEBUG},ih={filter:()=>!1};function oh(e,t,r,n,i){return{level:e,message:t,namespace:r,get params(){return n.length===1&&Dt(n[0])&&(n=n[0](),Array.isArray(n)||(n=[n])),n},source:i,timestamp:Date.now()-nh}}function ah(e){[...Fi].every(t=>t(e))&&zi.forEach(t=>t(e))}function ls(e){let t=(as.get(e)??0)+1;as.set(e,t);let r=`${e} #${t}`,n={id:r,namespace:e,module:i=>ls(`${n.namespace}/${i}`),updateConfig:ft};return Object.values(Bi).forEach(i=>{n[i]=(o,...a)=>ah(oh(i,o,e,a,r))}),Object.seal(n)}function Gr(...e){e.forEach(t=>{let{append:r,filter:n}=t;Dt(n)&&Fi.add(n),Dt(r)&&zi.add(r)})}function sh(e={}){let{name:t}=e,r=T(O("commerce.debug",{search:!0,storage:!0}),t===Di.LOCAL);return Gr(r?ss:cs),t===Di.PROD&&Gr(Xn),Y}function ch(){zi.clear(),Fi.clear()}var Y={...ls(Vn),Level:Bi,Plugins:{consoleAppender:ss,debugFilter:cs,quietFilter:ih,lanaAppender:Xn},init:sh,reset:ch,use:Gr};var lh="download",hh="upgrade",Ye,Zt=class Zt extends HTMLAnchorElement{constructor(){super();D(this,Ye);p(this,"masElement",new yt(this));this.handleClick=this.handleClick.bind(this)}attributeChangedCallback(r,n,i){this.masElement.attributeChangedCallback(r,n,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}static createCheckoutLink(r={},n=""){let i=q();if(!i)return null;let{checkoutMarketSegment:o,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:h,modal:l,perpetual:d,promotionCode:u,quantity:m,wcsOsi:f,extraOptions:g}=i.collectCheckoutOptions(r),A=Ur(Zt,{checkoutMarketSegment:o,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:h,modal:l,perpetual:d,promotionCode:u,quantity:m,wcsOsi:f,extraOptions:g});return n&&(A.innerHTML=`<span>${n}</span>`),A}get isCheckoutLink(){return!0}handleClick(r){var n;if(r.target!==this){r.preventDefault(),r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window}));return}(n=L(this,Ye))==null||n.call(this,r)}async render(r={}){if(!this.isConnected)return!1;let n=q();if(!n)return!1;this.dataset.imsCountry||n.imsCountryPromise.then(l=>{l&&(this.dataset.imsCountry=l)},bt),r.imsCountry=null;let i=n.collectCheckoutOptions(r,this);if(!i.wcsOsi.length)return!1;let o;try{o=JSON.parse(i.extraOptions??"{}")}catch(l){this.masElement.log?.error("cannot parse exta checkout options",l)}let a=this.masElement.togglePending(i);this.href="";let s=n.resolveOfferSelectors(i),c=await Promise.all(s);c=c.map(l=>qt(l,i)),i.country=this.dataset.imsCountry||i.country;let h=await n.buildCheckoutAction?.(c.flat(),{...o,...i},this);return this.renderOffers(c.flat(),i,{},h,a)}renderOffers(r,n,i={},o=void 0,a=void 0){if(!this.isConnected)return!1;let s=Y.module("checkout-link");try{let c=q();if(!c)return!1;if(n={...JSON.parse(this.dataset.extraOptions??"null"),...n,...i},a??(a=this.masElement.togglePending(n)),L(this,Ye)&&F(this,Ye,void 0),o){this.classList.remove(lh,hh),this.masElement.toggleResolved(a,r,n);let{url:l,text:d,className:u,handler:m}=o;return l&&(this.href=l),d&&(this.firstElementChild.innerHTML=d),u&&this.classList.add(...u.split(" ")),m&&(this.setAttribute("href","#"),F(this,Ye,m.bind(this))),!0}else if(r.length){if(this.masElement.toggleResolved(a,r,n)){let l=c.buildCheckoutURL(r,n);return this.setAttribute("href",l),!0}}else{let l=new Error(`Not provided: ${n?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(a,l,n))return this.setAttribute("href","#"),!0}}catch(c){return s.error("Failed to build checkout link: ",c),!0}}updateOptions(r={}){let n=q();if(!n)return!1;let{checkoutMarketSegment:i,checkoutWorkflow:o,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:h,perpetual:l,promotionCode:d,quantity:u,wcsOsi:m}=n.collectCheckoutOptions(r);return Dr(this,{checkoutMarketSegment:i,checkoutWorkflow:o,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:h,perpetual:l,promotionCode:d,quantity:u,wcsOsi:m}),!0}};Ye=new WeakMap,p(Zt,"is","checkout-link"),p(Zt,"tag","a");var ne=Zt;window.customElements.get(ne.is)||window.customElements.define(ne.is,ne,{extends:ne.tag});function hs({providers:e,settings:t}){function r(o,a){let{checkoutClientId:s,checkoutWorkflow:c,checkoutWorkflowStep:h,country:l,language:d,promotionCode:u,quantity:m}=t,{checkoutMarketSegment:f,checkoutWorkflow:g=c,checkoutWorkflowStep:A=h,imsCountry:w,country:b=w??l,language:y=d,quantity:N=m,entitlement:R,upgrade:V,modal:H,perpetual:oe,promotionCode:Xe=u,wcsOsi:we,extraOptions:We,...J}=Object.assign({},a?.dataset??{},o??{}),xe=Le(g,te,_.checkoutWorkflow),ae=re.CHECKOUT;xe===te.V3&&(ae=Le(A,re,_.checkoutWorkflowStep));let Q=At({...J,extraOptions:We,checkoutClientId:s,checkoutMarketSegment:f,country:b,quantity:St(N,_.quantity),checkoutWorkflow:xe,checkoutWorkflowStep:ae,language:y,entitlement:T(R),upgrade:T(V),modal:T(H),perpetual:T(oe),promotionCode:Gt(Xe).effectivePromoCode,wcsOsi:Hr(we)});if(a)for(let Pe of e.checkout)Pe(a,Q);return Q}function n(o,a){if(!Array.isArray(o)||!o.length||!a)return"";let{env:s,landscape:c}=t,{checkoutClientId:h,checkoutMarketSegment:l,checkoutWorkflow:d,checkoutWorkflowStep:u,country:m,promotionCode:f,quantity:g,...A}=r(a),w=window.frameElement?"if":"fp",b={checkoutPromoCode:f,clientId:h,context:w,country:m,env:s,items:[],marketSegment:l,workflowStep:u,landscape:c,...A};if(o.length===1){let[{offerId:y,offerType:N,productArrangementCode:R}]=o,{marketSegments:[V]}=o[0];Object.assign(b,{marketSegment:V,offerType:N,productArrangementCode:R}),b.items.push(g[0]===1?{id:y}:{id:y,quantity:g[0]})}else b.items.push(...o.map(({offerId:y},N)=>({id:y,quantity:g[N]??_.quantity})));return Qn(d,b)}let{createCheckoutLink:i}=ne;return{CheckoutLink:ne,CheckoutWorkflow:te,CheckoutWorkflowStep:re,buildCheckoutURL:n,collectCheckoutOptions:r,createCheckoutLink:i}}function dh({interval:e=200,maxAttempts:t=25}={}){let r=Y.module("ims");return new Promise(n=>{r.debug("Waing for IMS to be ready");let i=0;function o(){window.adobeIMS?.initialized?n():++i>t?(r.debug("Timeout"),n()):setTimeout(o,e)}o()})}function uh(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function mh(e){let t=Y.module("ims");return e.then(r=>r?window.adobeIMS.getProfile().then(({countryCode:n})=>(t.debug("Got user country:",n),n),n=>{t.error("Unable to get user country:",n)}):null)}function ds({}){let e=dh(),t=uh(e),r=mh(t);return{imsReadyPromise:e,imsSignedInPromise:t,imsCountryPromise:r}}async function ms(e,t){let{data:r}=t||await Promise.resolve().then(()=>ks(us(),1));if(Array.isArray(r)){let n=o=>r.find(a=>Tr(a.lang,o)),i=n(e.language)??n(_.language);if(i)return Object.freeze(i)}return{}}var ps=["GB_en","AU_en","FR_fr","AT_de","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GR_el","GR_en","HU_hu","IE_en","IT_it","LU_de","LU_en","LU_fr","NL_nl","NO_nb","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TR_tr","UA_uk","ID_en","ID_in","IN_en","IN_hi","JP_ja","MY_en","MY_ms","NZ_en","TH_en","TH_th"],fh={INDIVIDUAL_COM:["ZA_en","LT_lt","LV_lv","NG_en","SA_ar","SA_en","ZA_en","SG_en","KR_ko"],TEAM_COM:["ZA_en","LT_lt","LV_lv","NG_en","ZA_en","CO_es","KR_ko"],INDIVIDUAL_EDU:["LT_lt","LV_lv","SA_en","SG_en"],TEAM_EDU:["SG_en","KR_ko"]},Jt=class Jt extends HTMLSpanElement{constructor(){super();p(this,"masElement",new yt(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-perpetual","data-promotion-code","data-tax-exclusive","data-template","data-wcs-osi"]}static createInlinePrice(r){let n=q();if(!n)return null;let{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:h,promotionCode:l,quantity:d,template:u,wcsOsi:m}=n.collectPriceOptions(r);return Ur(Jt,{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:h,promotionCode:l,quantity:d,template:u,wcsOsi:m})}get isInlinePrice(){return!0}attributeChangedCallback(r,n,i){this.masElement.attributeChangedCallback(r,n,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}resolveDisplayTaxForGeoAndSegment(r,n,i,o){let a=`${r}_${n}`;if(ps.includes(r)||ps.includes(a))return!0;let s=fh[`${i}_${o}`];return s?!!(s.includes(r)||s.includes(a)):!1}async resolveDisplayTax(r,n){let[i]=await r.resolveOfferSelectors(n),o=qt(await i,n);if(o?.length){let{country:a,language:s}=n,c=o[0],[h=""]=c.marketSegments;return this.resolveDisplayTaxForGeoAndSegment(a,s,c.customerSegment,h)}}async render(r={}){if(!this.isConnected)return!1;let n=q();if(!n)return!1;let i=n.collectPriceOptions(r,this);if(!i.wcsOsi.length)return!1;let o=this.masElement.togglePending(i);this.innerHTML="";let[a]=n.resolveOfferSelectors(i);return this.renderOffers(qt(await a,i),i,o)}renderOffers(r,n={},i=void 0){if(!this.isConnected)return;let o=Y.module("inline-price");try{let a=q();if(!a)return!1;let s=a.collectPriceOptions({...this.dataset,...n},this);if(i??(i=this.masElement.togglePending(s)),r.length){if(this.masElement.toggleResolved(i,r,s))return this.innerHTML=a.buildPriceHTML(r,s),!0}else{let c=new Error(`Not provided: ${s?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,c,s))return this.innerHTML="",!0}}catch(a){return o.error("Failed to build price: ",a),!0}return!1}updateOptions(r){let n=q();if(!n)return!1;let{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:h,promotionCode:l,quantity:d,template:u,wcsOsi:m}=n.collectPriceOptions(r);return Dr(this,{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:h,promotionCode:l,quantity:d,template:u,wcsOsi:m}),!0}};p(Jt,"is","inline-price"),p(Jt,"tag","span");var ie=Jt;window.customElements.get(ie.is)||window.customElements.define(ie.is,ie,{extends:ie.tag});function fs({literals:e,providers:t,settings:r}){function n(a,s){let{country:c,displayOldPrice:h,displayPerUnit:l,displayRecurrence:d,displayTax:u,forceTaxExclusive:m,language:f,promotionCode:g,quantity:A}=r,{displayOldPrice:w=h,displayPerUnit:b=l,displayRecurrence:y=d,displayTax:N=u,forceTaxExclusive:R=m,country:V=c,language:H=f,perpetual:oe,promotionCode:Xe=g,quantity:we=A,template:We,wcsOsi:J,...xe}=Object.assign({},s?.dataset??{},a??{}),ae=At({...xe,country:V,displayOldPrice:T(w),displayPerUnit:T(b),displayRecurrence:T(y),displayTax:T(N),forceTaxExclusive:T(R),language:H,perpetual:T(oe),promotionCode:Gt(Xe).effectivePromoCode,quantity:St(we,_.quantity),template:We,wcsOsi:Hr(J)});if(s)for(let Q of t.price)Q(s,ae);return ae}function i(a,s){if(!Array.isArray(a)||!a.length||!s)return"";let{template:c}=s,h;switch(c){case"discount":h=Mi;break;case"strikethrough":h=ki;break;case"optical":h=Ni;break;case"annual":h=Oi;break;default:s.country==="AU"&&a[0].planType==="ABM"?h=s.promotionCode?Vi:Ri:h=s.promotionCode?Ii:Ci}let l=n(s);l.literals=Object.assign({},e.price,At(s.literals??{}));let[d]=a;return d={...d,...d.priceDetails},h(l,d)}let o=ie.createInlinePrice;return{InlinePrice:ie,buildPriceHTML:i,collectPriceOptions:n,createInlinePrice:o}}function gs({settings:e}){let t=Y.module("wcs"),{env:r,wcsApiKey:n}=e,i=new Map,o=new Map,a;async function s(d,u,m=!0){let f=Nn;t.debug("Fetching:",d);let g="",A,w=(b,y,N)=>`${b}: ${y?.status}, url: ${N.toString()}`;try{if(d.offerSelectorIds=d.offerSelectorIds.sort(),g=new URL(e.wcsURL),g.searchParams.set("offer_selector_ids",d.offerSelectorIds.join(",")),g.searchParams.set("country",d.country),g.searchParams.set("locale",d.locale),g.searchParams.set("landscape",r===je.STAGE?"ALL":e.landscape),g.searchParams.set("api_key",n),d.language&&g.searchParams.set("language",d.language),d.promotionCode&&g.searchParams.set("promotion_code",d.promotionCode),d.currency&&g.searchParams.set("currency",d.currency),A=await fetch(g.toString(),{credentials:"omit"}),A.ok){let b=await A.json();t.debug("Fetched:",d,b);let y=b.resolvedOffers??[];y=y.map(wr),u.forEach(({resolve:N},R)=>{let V=y.filter(({offerSelectorIds:H})=>H.includes(R)).flat();V.length&&(u.delete(R),N(V))})}else A.status===404&&d.offerSelectorIds.length>1?(t.debug("Multi-osi 404, fallback to fetch-by-one strategy"),await Promise.allSettled(d.offerSelectorIds.map(b=>s({...d,offerSelectorIds:[b]},u,!1)))):(f=xr,t.error(w(f,A,g),d))}catch(b){f=xr,t.error(w(f,A,g),d,b)}m&&u.size&&(A?.ok&&t.error(w(f,A,g),d),u.forEach(b=>{b.reject(new Error(f))}))}function c(){clearTimeout(a);let d=[...o.values()];o.clear(),d.forEach(({options:u,promises:m})=>s(u,m))}function h(){let d=i.size;i.clear(),t.debug(`Flushed ${d} cache entries`)}function l({country:d,language:u,perpetual:m=!1,promotionCode:f="",wcsOsi:g=[]}){let A=`${u}_${d}`;d!=="GB"&&(u=m?"EN":"MULT");let w=[d,u,f].filter(b=>b).join("-").toLowerCase();return g.map(b=>{let y=`${b}-${w}`;if(!i.has(y)){let N=new Promise((R,V)=>{let H=o.get(w);if(!H){let oe={country:d,locale:A,offerSelectorIds:[]};d!=="GB"&&(oe.language=u),H={options:oe,promises:new Map},o.set(w,H)}f&&(H.options.promotionCode=f),H.options.offerSelectorIds.push(b),H.promises.set(b,{resolve:R,reject:V}),H.options.offerSelectorIds.length>=e.wcsBufferLimit?c():(t.debug("Queued:",H.options),a||(a=setTimeout(c,e.wcsBufferDelay)))});i.set(y,N)}return i.get(y)})}return{WcsCommitment:$i,WcsPlanType:Hi,WcsTerm:Ui,resolveOfferSelectors:l,flushWcsCache:h}}var Ki="mas-commerce-service",zr,xs,Br=class extends HTMLElement{constructor(){super(...arguments);D(this,zr);p(this,"promise",null)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(n,i,o)=>{let a=await r?.(n,i,this.imsSignedInPromise,o);return a||null})}async activate(){let r=L(this,zr,xs),n=Object.freeze(Gi(r));ft(r.lana);let i=Y.init(r.hostEnv).module("service");i.debug("Activating:",r);let o={price:{}};try{o.price=await ms(n,r.commerce.priceLiterals)}catch{}let a={checkout:new Set,price:new Set},s={literals:o,providers:a,settings:n};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...hs(s),...ds(s),...fs(s),...gs(s),...Dn,Log:Y,get defaults(){return _},get log(){return Y},get providers(){return{checkout(c){return a.checkout.add(c),()=>a.checkout.delete(c)},price(c){return a.price.add(c),()=>a.price.delete(c)}}},get settings(){return n}})),i.debug("Activated:",{literals:o,settings:n}),_e(()=>{let c=new CustomEvent(it,{bubbles:!0,cancelable:!1,detail:this});this.dispatchEvent(c)})}connectedCallback(){this.readyPromise||(this.readyPromise=this.activate())}disconnectedCallback(){this.readyPromise=null}flushWcsCache(){this.flushWcsCache(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCache(),document.querySelectorAll('span[is="inline-price"],a[is="checkout-link"]').forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers")}refreshFragments(){this.flushWcsCache(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh()),this.log.debug("Refreshed AEM fragments")}};zr=new WeakSet,xs=function(){let r={hostEnv:{name:this.getAttribute("host-env")??"prod"},commerce:{env:this.getAttribute("env")},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate"),10),isProdDomain:this.getAttribute("host-env")==="prod"}};return["locale","country","language"].forEach(n=>{let i=this.getAttribute(n);i&&(r[n]=i)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(n=>{let i=this.getAttribute(n);if(i!=null){let o=n.replace(/-([a-z])/g,a=>a[1].toUpperCase());r.commerce[o]=i}}),r},p(Br,"instance");window.customElements.get(Ki)||window.customElements.define(Ki,Br);ft({sampleRate:1});export{ne as CheckoutLink,te as CheckoutWorkflow,re as CheckoutWorkflowStep,_ as Defaults,ie as InlinePrice,Ue as Landscape,Y as Log,Ki as TAG_NAME_SERVICE,$i as WcsCommitment,Hi as WcsPlanType,Ui as WcsTerm,wr as applyPlanType,Gi as getSettings};
