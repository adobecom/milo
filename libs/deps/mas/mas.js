...
`;document.head.appendChild(cs);var Wl="#000000",ql="#F8D904",Zl=/(accent|primary|secondary)(-(outline|link))?/,Jl="mas:product_code/",Ql="daa-ll",Br="daa-lh",eh=["XL","L","M","S"];function th(e,t,r){e.mnemonicIcon?.map((i,o)=>({icon:i,alt:e.mnemonicAlt[o]??"",link:e.mnemonicLink[o]??""}))?.forEach(({icon:i,alt:o,link:a})=>{if(a&&!/^https?:/.test(a))try{a=new URL(`https://${a}`).href.toString()}catch{a="#"}let s={slot:"icons",src:i,size:r?.size??"l"};o&&(s.alt=o),a&&(s.href=a);let c=ae("merch-icon",s);t.append(c)})}function rh(e,t){e.badge&&(t.setAttribute("badge-text",e.badge),t.setAttribute("badge-color",e.badgeColor||Wl),t.setAttribute("badge-background-color",e.badgeBackgroundColor||ql))}function nh(e,t,r){r?.includes(e.size)&&t.setAttribute("size",e.size)}function ih(e,t,r){e.cardTitle&&r&&t.append(ae(r.tag,{slot:r.slot},e.cardTitle))}function oh(e,t,r){e.subtitle&&r&&t.append(ae(r.tag,{slot:r.slot},e.subtitle))}function ah(e,t,r,n){if(e.backgroundImage)switch(n){case"ccd-slice":r&&t.append(ae(r.tag,{slot:r.slot},`<img loading="lazy" src="${e.backgroundImage}" />`));break;case"ccd-suggested":t.setAttribute("background-image",e.backgroundImage);break}}function sh(e,t,r){if(e.prices&&r){let n=ae(r.tag,{slot:r.slot},e.prices);t.append(n)}}function ch(e,t,r){if(e.description&&r){let n=ae(r.tag,{slot:r.slot},e.description);t.append(n)}}function lh(e,t,r,n){let i=t.ctas.size??"M",o=`spectrum-Button--${n}`,a=r?" spectrum-Button--outline":"",s=eh.includes(i)?` spectrum-Button--size${i}`:"",c=`spectrum-Button ${o}${a}${s}`,l=ae("button",{class:c,tabIndex:0},e);return l.addEventListener("click",h=>{h.target!==e&&(h.stopPropagation(),e.click())}),l}function hh(e,t,r,n){let i="fill";r&&(i="outline");let o=ae("sp-button",{treatment:i,variant:n,tabIndex:0,size:t.ctas.size??"m"},e);return o.addEventListener("click",a=>{a.target!==e&&(a.stopPropagation(),e.click())}),o}function dh(e,t){return e.classList.add("con-button"),t&&e.classList.add("blue"),e}function uh(e,t,r,n){if(e.ctas){let{slot:i}=r.ctas,o=ae("div",{slot:i},e.ctas),a=[...o.querySelectorAll("a")].map(s=>{let c=s.parentElement.tagName==="STRONG";if(t.consonant)return dh(s,c);let l=Zl.exec(s.className)?.[0]??"accent",h=l.includes("accent"),d=l.includes("primary"),u=l.includes("secondary"),m=l.includes("-outline");if(l.includes("-link"))return s;let f;return h||c?f="accent":d?f="primary":u&&(f="secondary"),s.tabIndex=-1,t.spectrum==="swc"?hh(s,r,m,f):lh(s,r,m,f)});o.innerHTML="",o.append(...a),t.append(o)}}function mh(e,t){let{tags:r}=e,n=r?.find(i=>i.startsWith(Jl))?.split("/").pop();n&&(t.setAttribute(Br,n),t.querySelectorAll("a[data-analytics-id]").forEach((i,o)=>{i.setAttribute(Ql,`${i.dataset.analyticsId}-${o+1}`)}))}async function ls(e,t){let{fields:r}=e,{variant:n}=r;if(!n)return;t.querySelectorAll("[slot]").forEach(o=>{o.remove()}),t.removeAttribute("background-image"),t.removeAttribute("badge-background-color"),t.removeAttribute("badge-color"),t.removeAttribute("badge-text"),t.removeAttribute("size"),t.removeAttribute(Br),t.variant=n,await t.updateComplete;let{aemFragmentMapping:i}=t.variantLayout;i&&(th(r,t,i.mnemonics),rh(r,t),nh(r,t,i.allowedSizes),ih(r,t,i.title),oh(r,t,i.subtitle),sh(r,t,i.prices),ah(r,t,i.backgroundImage,n),ch(r,t,i.description),uh(r,t,i,n),mh(r,t))}var ph="merch-card",fh=1e4,Di,Wt,Ui,Xt=class extends oe{constructor(){super();U(this,Wt);p(this,"customerSegment");p(this,"marketSegment");p(this,"variantLayout");U(this,Di,!1);this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this)}firstUpdated(){this.variantLayout=$i(this,!1),this.variantLayout?.connectedCallbackHook(),this.aemFragment?.updateComplete.catch(()=>{this.style.display="none"})}willUpdate(r){(r.has("variant")||!this.variantLayout)&&(this.variantLayout=$i(this),this.variantLayout.connectedCallbackHook())}updated(r){(r.has("badgeBackgroundColor")||r.has("borderColor"))&&this.style.setProperty("--merch-card-border",this.computedBorderStyle),this.variantLayout?.postCardUpdateHook(this)}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}get prices(){return Array.from(this.querySelectorAll('span[is="inline-price"][data-wcs-osi]'))}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["twp","ccd-slice","ccd-suggested"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector('span[is="inline-price"]')}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll('a[is="checkout-link"]')??[]]}async toggleStockOffer({target:r}){if(!this.stockOfferOsis)return;let n=this.checkoutLinks;if(n.length!==0)for(let i of n){await i.onceSettled();let o=i.value?.[0]?.planType;if(!o)return;let a=this.stockOfferOsis[o];if(!a)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==a);r.checked&&s.push(a),i.dataset.wcsOsi=s.join(",")}}handleQuantitySelection(r){let n=this.checkoutLinks;for(let i of n)i.dataset.quantity=r.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(r){let n={...this.filters};Object.keys(n).forEach(i=>{if(r){n[i].order=Math.min(n[i].order||2,2);return}let o=n[i].order;o===1||isNaN(o)||(n[i].order=Number(o)+1)}),this.filters=n}includes(r){return this.textContent.match(new RegExp(r,"i"))!==null}connectedCallback(){super.connectedCallback(),this.addEventListener(gr,this.handleQuantitySelection),this.addEventListener($n,this.merchCardReady,{once:!0}),this.updateComplete.then(()=>{this.merchCardReady()}),this.storageOptions?.addEventListener("change",this.handleStorageChange),this.addEventListener(Re,this.handleAemFragmentEvents),this.addEventListener(Oe,this.handleAemFragmentEvents),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout.disconnectedCallbackHook(),this.removeEventListener(gr,this.handleQuantitySelection),this.storageOptions?.removeEventListener(fr,this.handleStorageChange),this.removeEventListener(Re,this.handleAemFragmentEvents),this.removeEventListener(Oe,this.handleAemFragmentEvents)}async handleAemFragmentEvents(r){if(r.type===Re&&be(this,Wt,Ui).call(this,"AEM fragment cannot be loaded"),r.type===Oe&&r.target.nodeName==="AEM-FRAGMENT"){let n=r.detail;await ls(n,this),this.checkReady()}}async checkReady(){let r=Promise.all([...this.querySelectorAll('span[is="inline-price"][data-wcs-osi],a[is="checkout-link"][data-wcs-osi]')].map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(a=>a.classList.contains("placeholder-resolved"))),n=new Promise(o=>setTimeout(()=>o(!1),fh));if(await Promise.race([r,n])===!0){this.dispatchEvent(new CustomEvent(Bn,{bubbles:!0,composed:!0}));return}be(this,Wt,Ui).call(this,"Contains unresolved offers")}get aemFragment(){return this.querySelector("aem-fragment")}get storageOptions(){return this.querySelector("sp-radio-group#storage")}get storageSpecificOfferSelect(){let r=this.storageOptions?.selected;if(r){let n=this.querySelector(`merch-offer-select[storage="${r}"]`);if(n)return n}return this.querySelector("merch-offer-select")}get offerSelect(){return this.storageOptions?this.storageSpecificOfferSelect:this.querySelector("merch-offer-select")}get quantitySelect(){return this.querySelector("merch-quantity-select")}merchCardReady(){this.offerSelect&&!this.offerSelect.planType||this.dispatchEvent(new CustomEvent(Un,{bubbles:!0}))}handleStorageChange(){let r=this.closest("merch-card")?.offerSelect.cloneNode(!0);r&&this.dispatchEvent(new CustomEvent(fr,{detail:{offerSelect:r},bubbles:!0}))}get dynamicPrice(){return this.querySelector('[slot="price"]')}selectMerchOffer(r){if(r===this.merchOffer)return;this.merchOffer=r;let n=this.dynamicPrice;if(r.price&&n){let i=r.price.cloneNode(!0);n.onceSettled?n.onceSettled().then(()=>{n.replaceWith(i)}):n.replaceWith(i)}}};Di=new WeakMap,Wt=new WeakSet,Ui=function(r){this.dispatchEvent(new CustomEvent(Gn,{detail:r,bubbles:!0,composed:!0}))},p(Xt,"properties",{name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:r=>{let[n,i,o]=r.split(",");return{PUF:n,ABM:i,M2M:o}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:r=>Object.fromEntries(r.split(",").map(n=>{let[i,o,a]=n.split(":"),s=Number(o);return[i,{order:isNaN(s)?void 0:s,size:a}]})),toAttribute:r=>Object.entries(r).map(([n,{order:i,size:o}])=>[n,i,o].filter(a=>a!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:Br,reflect:!0}}),p(Xt,"styles",[Ya,ss(),...Xa()]);customElements.define(ph,Xt);var vt=class extends oe{constructor(){super(),this.size="m",this.alt=""}render(){let{href:t}=this;return t?x`<a href="${t}">
    ...
    `);customElements.define("merch-icon",vt);var ms=new CSSStyleSheet;ms.replaceSync(":host { display: contents; }");var gh=document.querySelector('meta[name="aem-base-url"]')?.content??"https://odin.adobe.com",hs="fragment",ds="author",xh="ims",us=e=>{throw new Error(`Failed to get fragment: ${e}`)};async function bh(e,t,r,n){let i=r?`${e}/adobe/sites/cf/fragments/${t}`:`${e}/adobe/sites/fragments/${t}`,o=await fetch(i,{cache:"default",credentials:"omit",headers:n}).catch(a=>us(a.message));return o?.ok||us(`${o.status} ${o.statusText}`),o.json()}var Bi,Le,Gi=class{constructor(){U(this,Le,new Map)}clear(){y(this,Le).clear()}add(...t){t.forEach(r=>{let{id:n}=r;n&&y(this,Le).set(n,r)})}has(t){return y(this,Le).has(t)}get(t){return y(this,Le).get(t)}remove(t){y(this,Le).delete(t)}};Le=new WeakMap;var Gr=new Gi,je,ue,_e,qt,me,At,pe,Fi,ps,fs,zi=class extends HTMLElement{constructor(){super();U(this,pe);p(this,"cache",Gr);U(this,je);U(this,ue);U(this,_e);U(this,qt,!1);U(this,me);U(this,At,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[ms];let r=this.getAttribute(xh);["",!0,"true"].includes(r)&&(F(this,qt,!0),Bi||(Bi={Authorization:`Bearer ${window.adobeid?.authorize?.()}`}))}static get observedAttributes(){return[hs,ds]}attributeChangedCallback(r,n,i){r===hs&&(F(this,_e,i),this.refresh(!1)),r===ds&&F(this,At,["","true"].includes(i))}connectedCallback(){if(!y(this,_e)){be(this,pe,Fi).call(this,"Missing fragment id");return}}async refresh(r=!0){y(this,me)&&!await Promise.race([y(this,me),Promise.resolve(!1)])||(r&&Gr.remove(y(this,_e)),F(this,me,this.fetchData().then(()=>(this.dispatchEvent(new CustomEvent(Oe,{detail:this.data,bubbles:!0,composed:!0})),!0)).catch(n=>(be(this,pe,Fi).call(this,"Network error: failed to load fragment"),F(this,me,null),!1))),y(this,me))}async fetchData(){F(this,je,null),F(this,ue,null);let r=Gr.get(y(this,_e));r||(r=await bh(gh,y(this,_e),y(this,At),y(this,qt)?Bi:void 0),Gr.add(r)),F(this,je,r)}get updateComplete(){return y(this,me)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return y(this,ue)?y(this,ue):(y(this,At)?be(this,pe,ps).call(this):be(this,pe,fs).call(this),y(this,ue))}};je=new WeakMap,ue=new WeakMap,_e=new WeakMap,qt=new WeakMap,me=new WeakMap,At=new WeakMap,pe=new WeakSet,Fi=function(r){this.classList.add("error"),this.dispatchEvent(new CustomEvent(Re,{detail:r,bubbles:!0,composed:!0}))},ps=function(){let{id:r,tags:n,fields:i}=y(this,je);F(this,ue,i.reduce((o,{name:a,multiple:s,values:c})=>(o.fields[a]=s?c:c[0],o),{id:r,tags:n,fields:{}}))},fs=function(){let{id:r,tags:n,fields:i}=y(this,je);F(this,ue,Object.entries(i).reduce((o,[a,s])=>(o.fields[a]=s?.mimeType?s.value:s??"",o),{id:r,tags:n,fields:{}}))};customElements.define("aem-fragment",zi);
