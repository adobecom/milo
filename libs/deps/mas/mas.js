      ...
      `];var ht,jt=class jt{constructor(t){p(this,"card");$(this,ht);this.card=t,this.insertVariantStyle()}getContainer(){return H(this,ht,v(this,ht)??this.card.closest('[class*="-merch-cards"]')??this.card.parentElement),v(this,ht)}insertVariantStyle(){if(!jt.styleMap[this.card.variant]){jt.styleMap[this.card.variant]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(t,r){if(!t)return;let n=`--consonant-merch-card-${this.card.variant}-${r}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),o=parseInt(this.getContainer().style.getPropertyValue(n))||0;i>o&&this.getContainer().style.setProperty(n,`${i}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),x`
        ...
        `}get cardImage(){return x` <div class="image">
            ...
            ${this.badge}
              ...
              >`:"";return x`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){}};ht=new WeakMap,p(jt,"styleMap",{});var k=jt;var fi={};Ec(fi,{CLASS_NAME_FAILED:()=>ti,CLASS_NAME_HIDDEN:()=>Oc,CLASS_NAME_PENDING:()=>ri,CLASS_NAME_RESOLVED:()=>ni,ERROR_MESSAGE_BAD_REQUEST:()=>ii,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>Fc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>oi,EVENT_AEM_ERROR:()=>ze,EVENT_AEM_LOAD:()=>Ge,EVENT_MAS_ERROR:()=>ei,EVENT_MAS_READY:()=>Jn,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Qn,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>Gc,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Bc,EVENT_MERCH_CARD_READY:()=>Zn,EVENT_MERCH_OFFER_READY:()=>Vc,EVENT_MERCH_OFFER_SELECT_READY:()=>Wn,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>ut,EVENT_MERCH_SEARCH_CHANGE:()=>Dc,EVENT_MERCH_SIDENAV_SELECT:()=>zc,EVENT_MERCH_STOCK_CHANGE:()=>Hc,EVENT_MERCH_STORAGE_CHANGE:()=>$r,EVENT_OFFER_SELECTED:()=>Uc,EVENT_TYPE_FAILED:()=>ai,EVENT_TYPE_READY:()=>dt,EVENT_TYPE_RESOLVED:()=>si,HEADER_X_REQUEST_ID:()=>mi,LOG_NAMESPACE:()=>ci,Landscape:()=>ge,MARK_DURATION_SUFFIX:()=>Zt,MARK_START_SUFFIX:()=>_e,MAS_COMMERCE_SERVICE_INIT_TIME_MEASURE_NAME:()=>Wt,MODAL_TYPE_3_IN_1:()=>re,NAMESPACE:()=>Mc,PARAM_AOS_API_KEY:()=>Kc,PARAM_ENV:()=>li,PARAM_LANDSCAPE:()=>hi,PARAM_WCS_API_KEY:()=>Yc,PROVIDER_ENVIRONMENT:()=>pi,SELECTOR_MAS_CHECKOUT_LINK:()=>Xt,SELECTOR_MAS_ELEMENT:()=>qt,SELECTOR_MAS_INLINE_PRICE:()=>Or,SELECTOR_MAS_SP_BUTTON:()=>qn,STATE_FAILED:()=>pe,STATE_PENDING:()=>we,STATE_RESOLVED:()=>fe,TAG_NAME_SERVICE:()=>$c,WCS_PROD_URL:()=>di,WCS_STAGE_URL:()=>ui,WORKFLOW_STEP:()=>Fe});var Mc="merch",Oc="hidden",dt="wcms:commerce:ready",$c="mas-commerce-service",Or='span[is="inline-price"][data-wcs-osi]',Xt='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',qn="sp-button[data-wcs-osi]",qt=`${Or},${Xt}`,Vc="merch-offer:ready",Wn="merch-offer-select:ready",Zn="merch-card:ready",Qn="merch-card:action-menu-toggle",Uc="merch-offer:selected",Hc="merch-stock:change",$r="merch-storage:change",ut="merch-quantity-selector:change",Dc="merch-search:change",Bc="merch-card-collection:sort",Gc="merch-card-collection:showmore",zc="merch-sidenav:select",Ge="aem:load",ze="aem:error",Jn="mas:ready",ei="mas:error",ti="placeholder-failed",ri="placeholder-pending",ni="placeholder-resolved",ii="Bad WCS request",oi="Commerce offer not found",Fc="Literals URL not provided",ai="mas:failed",si="mas:resolved",ci="mas/commerce",li="commerce.env",hi="commerce.landscape",Kc="commerce.aosKey",Yc="commerce.wcsKey",di="https://www.adobe.com/web_commerce_artifact",ui="https://www.stage.adobe.com/web_commerce_artifact_stage",pe="failed",we="pending",fe="resolved",ge={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},mi="X-Request-Id",Wt="mas-commerce-service:initTime",Fe={CHECKOUT:"checkout",CHECKOUT_EMAIL:"checkout/email",SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"},pi={PRODUCTION:"PRODUCTION"},re={TWP:"twp",D2P:"d2p",CRM:"crm"},_e=":start",Zt=":duration";function xa(e,t){let r;return function(){let n=this,i=arguments;clearTimeout(r),r=setTimeout(()=>e.apply(n,i),t)}}function Ke(e,t={},r=null,n=null){let i=n?document.createElement(e,{is:n}):document.createElement(e);r instanceof HTMLElement?i.appendChild(r):i.innerHTML=r;for(let[o,a]of Object.entries(t))i.setAttribute(o,a);return i}function Vr(){return window.matchMedia("(max-width: 767px)")}function mt(){return Vr().matches}function ba(){return window.matchMedia("(max-width: 1024px)").matches}function ne(){let e=document.querySelector("mas-commerce-service");return e?{[Wt]:e.initDuration}:{}}var va=`
:root {
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return va}setAriaExpanded(r,n){r.setAttribute("aria-expanded",n)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};p(pt,"variantStyle",w`
...
`;var Ur=class extends k{constructor(t){super(t)}getGlobalCSS(){return Aa}renderLayout(){return x`${this.cardImage}
    <div class="body">
...
`;var Hr=class extends k{constructor(t){super(t)}getGlobalCSS(){return Ea}renderLayout(){return x` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var xt=class extends k{constructor(t){super(t)}getGlobalCSS(){return wa}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
    ...
    <hr />
    ${this.secureLabelFooter}`}};p(xt,"variantStyle",w`
...
`;var vt=class extends k{constructor(t){super(t)}getGlobalCSS(){return La}renderLayout(){return x`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
...
`;var Ai={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},Et=class extends k{getGlobalCSS(){return Ca}get aemFragmentMapping(){return Ai}renderLayout(){return x` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;var Ei={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color"},allowedColors:{gray:"--spectrum-gray-100"},size:["single","double","triple"]},je=class extends k{getGlobalCSS(){return ka}get aemFragmentMapping(){return Ei}renderLayout(){return x`
  ...
  `);customElements.define("ah-try-buy-widget",je);var yi=(e,t=!1)=>{switch(e.variant){case"catalog":return new pt(e);case"image":return new Ur(e);case"inline-heading":return new Hr(e);case"mini-compare-chart":return new ft(e);case"plans":return new gt(e);case"product":return new Ye(e);case"segment":return new xt(e);case"special-offers":return new bt(e);case"twp":return new vt(e);case"ccd-suggested":return new At(e);case"ccd-slice":return new Et(e);case"ah-try-buy-widget":return new je(e);default:return t?void 0:new Ye(e)}},Ia={catalog:gi,image:null,"inline-heading":null,"mini-compare-chart":null,plans:xi,product:null,segment:null,"special-offers":bi,twp:null,"ccd-suggested":vi,"ccd-slice":Ai,"ah-try-buy-widget":Ei},Na=()=>{let e=[];return e.push(pt.variantStyle),e.push(ft.variantStyle),e.push(Ye.variantStyle),e.push(gt.variantStyle),e.push(xt.variantStyle),e.push(bt.variantStyle),e.push(vt.variantStyle),e.push(At.variantStyle),e.push(Et.variantStyle),e.push(je.variantStyle),e};var Ra=document.createElement("style");Ra.innerHTML=`
:root {
...
`;document.head.appendChild(Ra);var Si;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(Si||(Si={}));var D;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(D||(D={}));var N;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(N||(N={}));var Ti;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(Ti||(Ti={}));var wi;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(wi||(wi={}));var _i;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(_i||(_i={}));var Li;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(Li||(Li={}));var Ma="tacocat.js";var Dr=(e,t)=>String(e??"").toLowerCase()==String(t??"").toLowerCase(),Oa=e=>`${e??""}`.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t]??t)??"";function O(e,t={},{metadata:r=!0,search:n=!0,storage:i=!0}={}){let o;if(n&&o==null){let a=new URLSearchParams(window.location.search),s=yt(n)?n:e;o=a.get(s)}if(i&&o==null){let a=yt(i)?i:e;o=window.sessionStorage.getItem(a)??window.localStorage.getItem(a)}if(r&&o==null){let a=Xc(yt(r)?r:e);o=document.documentElement.querySelector(`meta[name="${a}"]`)?.content}return o??t[e]}var St=()=>{};var $a=e=>typeof e=="boolean",Qt=e=>typeof e=="function",Br=e=>typeof e=="number",Va=e=>e!=null&&typeof e=="object";var yt=e=>typeof e=="string",Pi=e=>yt(e)&&e,Tt=e=>Br(e)&&Number.isFinite(e)&&e>0;function wt(e,t=r=>r==null||r===""){return e!=null&&Object.entries(e).forEach(([r,n])=>{t(n)&&delete e[r]}),e}function _(e,t){if($a(e))return e;let r=String(e);return r==="1"||r==="true"?!0:r==="0"||r==="false"?!1:t}function Le(e,t,r){let n=Object.values(t);return n.find(i=>Dr(i,e))??r??n[0]}function Xc(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,r,n)=>`${r}-${n}`).replace(/\W+/gu,"-").toLowerCase()}function Ci(e,t=1){return Br(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:t}var qc=Date.now(),ki=()=>`(+${Date.now()-qc}ms)`,Gr=new Set,Wc=_(O("tacocat.debug",{},{metadata:!1}),!1);function Ua(e){let t=`[${Ma}/${e}]`,r=(a,s,...c)=>a?!0:(i(s,...c),!1),n=Wc?(a,...s)=>{console.debug(`${t} ${a}`,...s,ki())}:()=>{},i=(a,...s)=>{let c=`${t} ${a}`;Gr.forEach(([l])=>l(c,...s))};return{assert:r,debug:n,error:i,warn:(a,...s)=>{let c=`${t} ${a}`;Gr.forEach(([,l])=>l(c,...s))}}}function Zc(e,t){let r=[e,t];return Gr.add(r),()=>{Gr.delete(r)}}Zc((e,...t)=>{console.error(e,...t,ki())},(e,...t)=>{console.warn(e,...t,ki())});var Qc="no promo",Ha="promo-tag",Jc="yellow",el="neutral",tl=(e,t,r)=>{let n=o=>o||Qc,i=r?` (was "${n(t)}")`:"";return`${n(e)}${i}`},rl="cancel-context",Jt=(e,t)=>{let r=e===rl,n=!r&&e?.length>0,i=(n||r)&&(t&&t!=e||!t&&!r),o=i&&n||!i&&!!t,a=o?e||t:void 0;return{effectivePromoCode:a,overridenPromoCode:e,className:o?Ha:`${Ha} no-promo`,text:tl(a,t,i),variant:o?Jc:el,isOverriden:i}};var Ii="ABM",Ni="PUF",Ri="M2M",Mi="PERPETUAL",Oi="P3Y",nl="TAX_INCLUSIVE_DETAILS",il="TAX_EXCLUSIVE",Da={ABM:Ii,PUF:Ni,M2M:Ri,PERPETUAL:Mi,P3Y:Oi},Hm={[Ii]:{commitment:D.YEAR,term:N.MONTHLY},[Ni]:{commitment:D.YEAR,term:N.ANNUAL},[Ri]:{commitment:D.MONTH,term:N.MONTHLY},[Mi]:{commitment:D.PERPETUAL,term:void 0},[Oi]:{commitment:D.THREE_MONTHS,term:N.P3Y}},Ba="Value is not an offer",zr=e=>{if(typeof e!="object")return Ba;let{commitment:t,term:r}=e,n=ol(t,r);return{...e,planType:n}};var ol=(e,t)=>{switch(e){case void 0:return Ba;case"":return"";case D.YEAR:return t===N.MONTHLY?Ii:t===N.ANNUAL?Ni:"";case D.MONTH:return t===N.MONTHLY?Ri:"";case D.PERPETUAL:return Mi;case D.TERM_LICENSE:return t===N.P3Y?Oi:"";default:return""}};function $i(e){let{priceDetails:t}=e,{price:r,priceWithoutDiscount:n,priceWithoutTax:i,priceWithoutDiscountAndTax:o,taxDisplay:a}=t;if(a!==nl)return e;let s={...e,priceDetails:{...t,price:i??r,priceWithoutDiscount:o??n,taxDisplay:il}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var Vi=function(e,t){return Vi=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(r,n){r.__proto__=n}||function(r,n){for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(r[i]=n[i])},Vi(e,t)};function er(e,t){if(typeof t!="function"&&t!==null)throw new TypeError("Class extends value "+String(t)+" is not a constructor or null");Vi(e,t);function r(){this.constructor=e}e.prototype=t===null?Object.create(t):(r.prototype=t.prototype,new r)}var E=function(){return E=Object.assign||function(t){for(var r,n=1,i=arguments.length;n<i;n++){r=arguments[n];for(var o in r)Object.prototype.hasOwnProperty.call(r,o)&&(t[o]=r[o])}return t},E.apply(this,arguments)};function Fr(e,t,r){if(r||arguments.length===2)for(var n=0,i=t.length,o;n<i;n++)(o||!(n in t))&&(o||(o=Array.prototype.slice.call(t,0,n)),o[n]=t[n]);return e.concat(o||Array.prototype.slice.call(t))}var A;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(A||(A={}));var I;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(I||(I={}));var Xe;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(Xe||(Xe={}));function Ui(e){return e.type===I.literal}function Ga(e){return e.type===I.argument}function Kr(e){return e.type===I.number}function Yr(e){return e.type===I.date}function jr(e){return e.type===I.time}function Xr(e){return e.type===I.select}function qr(e){return e.type===I.plural}function za(e){return e.type===I.pound}function Wr(e){return e.type===I.tag}function Zr(e){return!!(e&&typeof e=="object"&&e.type===Xe.number)}function tr(e){return!!(e&&typeof e=="object"&&e.type===Xe.dateTime)}var Hi=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var al=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function Fa(e){var t={};return e.replace(al,function(r){var n=r.length;switch(r[0]){case"G":t.era=n===4?"long":n===5?"narrow":"short";break;case"y":t.year=n===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":t.month=["numeric","2-digit","short","long","narrow"][n-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":t.day=["numeric","2-digit"][n-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":t.weekday=n===4?"short":n===5?"narrow":"short";break;case"e":if(n<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][n-4];break;case"c":if(n<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][n-4];break;case"a":t.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":t.hourCycle="h12",t.hour=["numeric","2-digit"][n-1];break;case"H":t.hourCycle="h23",t.hour=["numeric","2-digit"][n-1];break;case"K":t.hourCycle="h11",t.hour=["numeric","2-digit"][n-1];break;case"k":t.hourCycle="h24",t.hour=["numeric","2-digit"][n-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":t.minute=["numeric","2-digit"][n-1];break;case"s":t.second=["numeric","2-digit"][n-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":t.timeZoneName=n<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),t}var Ka=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function qa(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var t=e.split(Ka).filter(function(d){return d.length>0}),r=[],n=0,i=t;n<i.length;n++){var o=i[n],a=o.split("/");if(a.length===0)throw new Error("Invalid number skeleton");for(var s=a[0],c=a.slice(1),l=0,h=c;l<h.length;l++){var u=h[l];if(u.length===0)throw new Error("Invalid number skeleton")}r.push({stem:s,options:c})}return r}function sl(e){return e.replace(/^(.*?)-/,"")}var Ya=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,Wa=/^(@+)?(\+|#+)?[rs]?$/g,cl=/(\*)(0+)|(#+)(0+)|(0+)/g,Za=/^(0+)$/;function ja(e){var t={};return e[e.length-1]==="r"?t.roundingPriority="morePrecision":e[e.length-1]==="s"&&(t.roundingPriority="lessPrecision"),e.replace(Wa,function(r,n,i){return typeof i!="string"?(t.minimumSignificantDigits=n.length,t.maximumSignificantDigits=n.length):i==="+"?t.minimumSignificantDigits=n.length:n[0]==="#"?t.maximumSignificantDigits=n.length:(t.minimumSignificantDigits=n.length,t.maximumSignificantDigits=n.length+(typeof i=="string"?i.length:0)),""}),t}function Qa(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function ll(e){var t;if(e[0]==="E"&&e[1]==="E"?(t={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(t={notation:"scientific"},e=e.slice(1)),t){var r=e.slice(0,2);if(r==="+!"?(t.signDisplay="always",e=e.slice(2)):r==="+?"&&(t.signDisplay="exceptZero",e=e.slice(2)),!Za.test(e))throw new Error("Malformed concise eng/scientific notation");t.minimumIntegerDigits=e.length}return t}function Xa(e){var t={},r=Qa(e);return r||t}function Ja(e){for(var t={},r=0,n=e;r<n.length;r++){var i=n[r];switch(i.stem){case"percent":case"%":t.style="percent";continue;case"%x100":t.style="percent",t.scale=100;continue;case"currency":t.style="currency",t.currency=i.options[0];continue;case"group-off":case",_":t.useGrouping=!1;continue;case"precision-integer":case".":t.maximumFractionDigits=0;continue;case"measure-unit":case"unit":t.style="unit",t.unit=sl(i.options[0]);continue;case"compact-short":case"K":t.notation="compact",t.compactDisplay="short";continue;case"compact-long":case"KK":t.notation="compact",t.compactDisplay="long";continue;case"scientific":t=E(E(E({},t),{notation:"scientific"}),i.options.reduce(function(c,l){return E(E({},c),Xa(l))},{}));continue;case"engineering":t=E(E(E({},t),{notation:"engineering"}),i.options.reduce(function(c,l){return E(E({},c),Xa(l))},{}));continue;case"notation-simple":t.notation="standard";continue;case"unit-width-narrow":t.currencyDisplay="narrowSymbol",t.unitDisplay="narrow";continue;case"unit-width-short":t.currencyDisplay="code",t.unitDisplay="short";continue;case"unit-width-full-name":t.currencyDisplay="name",t.unitDisplay="long";continue;case"unit-width-iso-code":t.currencyDisplay="symbol";continue;case"scale":t.scale=parseFloat(i.options[0]);continue;case"integer-width":if(i.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");i.options[0].replace(cl,function(c,l,h,u,d,m){if(l)t.minimumIntegerDigits=h.length;else{if(u&&d)throw new Error("We currently do not support maximum integer digits");if(m)throw new Error("We currently do not support exact integer digits")}return""});continue}if(Za.test(i.stem)){t.minimumIntegerDigits=i.stem.length;continue}if(Ya.test(i.stem)){if(i.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");i.stem.replace(Ya,function(c,l,h,u,d,m){return h==="*"?t.minimumFractionDigits=l.length:u&&u[0]==="#"?t.maximumFractionDigits=u.length:d&&m?(t.minimumFractionDigits=d.length,t.maximumFractionDigits=d.length+m.length):(t.minimumFractionDigits=l.length,t.maximumFractionDigits=l.length),""});var o=i.options[0];o==="w"?t=E(E({},t),{trailingZeroDisplay:"stripIfInteger"}):o&&(t=E(E({},t),ja(o)));continue}if(Wa.test(i.stem)){t=E(E({},t),ja(i.stem));continue}var a=Qa(i.stem);a&&(t=E(E({},t),a));var s=ll(i.stem);s&&(t=E(E({},t),s))}return t}var rr={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function es(e,t){for(var r="",n=0;n<e.length;n++){var i=e.charAt(n);if(i==="j"){for(var o=0;n+1<e.length&&e.charAt(n+1)===i;)o++,n++;var a=1+(o&1),s=o<2?1:3+(o>>1),c="a",l=hl(t);for((l=="H"||l=="k")&&(s=0);s-- >0;)r+=c;for(;a-- >0;)r=l+r}else i==="J"?r+="H":r+=i}return r}function hl(e){var t=e.hourCycle;if(t===void 0&&e.hourCycles&&e.hourCycles.length&&(t=e.hourCycles[0]),t)switch(t){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var r=e.language,n;r!=="root"&&(n=e.maximize().region);var i=rr[n||""]||rr[r||""]||rr["".concat(r,"-001")]||rr["001"];return i[0]}var Di,dl=new RegExp("^".concat(Hi.source,"*")),ul=new RegExp("".concat(Hi.source,"*$"));function y(e,t){return{start:e,end:t}}var ml=!!String.prototype.startsWith,pl=!!String.fromCodePoint,fl=!!Object.fromEntries,gl=!!String.prototype.codePointAt,xl=!!String.prototype.trimStart,bl=!!String.prototype.trimEnd,vl=!!Number.isSafeInteger,Al=vl?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},Gi=!0;try{ts=os("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Gi=((Di=ts.exec("a"))===null||Di===void 0?void 0:Di[0])==="a"}catch{Gi=!1}var ts,rs=ml?function(t,r,n){return t.startsWith(r,n)}:function(t,r,n){return t.slice(n,n+r.length)===r},zi=pl?String.fromCodePoint:function(){for(var t=[],r=0;r<arguments.length;r++)t[r]=arguments[r];for(var n="",i=t.length,o=0,a;i>o;){if(a=t[o++],a>1114111)throw RangeError(a+" is not a valid code point");n+=a<65536?String.fromCharCode(a):String.fromCharCode(((a-=65536)>>10)+55296,a%1024+56320)}return n},ns=fl?Object.fromEntries:function(t){for(var r={},n=0,i=t;n<i.length;n++){var o=i[n],a=o[0],s=o[1];r[a]=s}return r},is=gl?function(t,r){return t.codePointAt(r)}:function(t,r){var n=t.length;if(!(r<0||r>=n)){var i=t.charCodeAt(r),o;return i<55296||i>56319||r+1===n||(o=t.charCodeAt(r+1))<56320||o>57343?i:(i-55296<<10)+(o-56320)+65536}},El=xl?function(t){return t.trimStart()}:function(t){return t.replace(dl,"")},yl=bl?function(t){return t.trimEnd()}:function(t){return t.replace(ul,"")};function os(e,t){return new RegExp(e,t)}var Fi;Gi?(Bi=os("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Fi=function(t,r){var n;Bi.lastIndex=r;var i=Bi.exec(t);return(n=i[1])!==null&&n!==void 0?n:""}):Fi=function(t,r){for(var n=[];;){var i=is(t,r);if(i===void 0||ss(i)||wl(i))break;n.push(i),r+=i>=65536?2:1}return zi.apply(void 0,n)};var Bi,as=function(){function e(t,r){r===void 0&&(r={}),this.message=t,this.position={offset:0,line:1,column:1},this.ignoreTag=!!r.ignoreTag,this.locale=r.locale,this.requiresOtherClause=!!r.requiresOtherClause,this.shouldParseSkeletons=!!r.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(t,r,n){for(var i=[];!this.isEOF();){var o=this.char();if(o===123){var a=this.parseArgument(t,n);if(a.err)return a;i.push(a.val)}else{if(o===125&&t>0)break;if(o===35&&(r==="plural"||r==="selectordinal")){var s=this.clonePosition();this.bump(),i.push({type:I.pound,location:y(s,this.clonePosition())})}else if(o===60&&!this.ignoreTag&&this.peek()===47){if(n)break;return this.error(A.UNMATCHED_CLOSING_TAG,y(this.clonePosition(),this.clonePosition()))}else if(o===60&&!this.ignoreTag&&Ki(this.peek()||0)){var a=this.parseTag(t,r);if(a.err)return a;i.push(a.val)}else{var a=this.parseLiteral(t,r);if(a.err)return a;i.push(a.val)}}}return{val:i,err:null}},e.prototype.parseTag=function(t,r){var n=this.clonePosition();this.bump();var i=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:I.literal,value:"<".concat(i,"/>"),location:y(n,this.clonePosition())},err:null};if(this.bumpIf(">")){var o=this.parseMessage(t+1,r,!0);if(o.err)return o;var a=o.val,s=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!Ki(this.char()))return this.error(A.INVALID_TAG,y(s,this.clonePosition()));var c=this.clonePosition(),l=this.parseTagName();return i!==l?this.error(A.UNMATCHED_CLOSING_TAG,y(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:I.tag,value:i,children:a,location:y(n,this.clonePosition())},err:null}:this.error(A.INVALID_TAG,y(s,this.clonePosition())))}else return this.error(A.UNCLOSED_TAG,y(n,this.clonePosition()))}else return this.error(A.INVALID_TAG,y(n,this.clonePosition()))},e.prototype.parseTagName=function(){var t=this.offset();for(this.bump();!this.isEOF()&&Tl(this.char());)this.bump();return this.message.slice(t,this.offset())},e.prototype.parseLiteral=function(t,r){for(var n=this.clonePosition(),i="";;){var o=this.tryParseQuote(r);if(o){i+=o;continue}var a=this.tryParseUnquoted(t,r);if(a){i+=a;continue}var s=this.tryParseLeftAngleBracket();if(s){i+=s;continue}break}var c=y(n,this.clonePosition());return{val:{type:I.literal,value:i,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!Sl(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(t){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(t==="plural"||t==="selectordinal")break;return null;default:return null}this.bump();var r=[this.char()];for(this.bump();!this.isEOF();){var n=this.char();if(n===39)if(this.peek()===39)r.push(39),this.bump();else{this.bump();break}else r.push(n);this.bump()}return zi.apply(void 0,r)},e.prototype.tryParseUnquoted=function(t,r){if(this.isEOF())return null;var n=this.char();return n===60||n===123||n===35&&(r==="plural"||r==="selectordinal")||n===125&&t>0?null:(this.bump(),zi(n))},e.prototype.parseArgument=function(t,r){var n=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(A.EXPECT_ARGUMENT_CLOSING_BRACE,y(n,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(A.EMPTY_ARGUMENT,y(n,this.clonePosition()));var i=this.parseIdentifierIfPossible().value;if(!i)return this.error(A.MALFORMED_ARGUMENT,y(n,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(A.EXPECT_ARGUMENT_CLOSING_BRACE,y(n,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:I.argument,value:i,location:y(n,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(A.EXPECT_ARGUMENT_CLOSING_BRACE,y(n,this.clonePosition())):this.parseArgumentOptions(t,r,i,n);default:return this.error(A.MALFORMED_ARGUMENT,y(n,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var t=this.clonePosition(),r=this.offset(),n=Fi(this.message,r),i=r+n.length;this.bumpTo(i);var o=this.clonePosition(),a=y(t,o);return{value:n,location:a}},e.prototype.parseArgumentOptions=function(t,r,n,i){var o,a=this.clonePosition(),s=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(s){case"":return this.error(A.EXPECT_ARGUMENT_TYPE,y(a,c));case"number":case"date":case"time":{this.bumpSpace();var l=null;if(this.bumpIf(",")){this.bumpSpace();var h=this.clonePosition(),u=this.parseSimpleArgStyleIfPossible();if(u.err)return u;var d=yl(u.val);if(d.length===0)return this.error(A.EXPECT_ARGUMENT_STYLE,y(this.clonePosition(),this.clonePosition()));var m=y(h,this.clonePosition());l={style:d,styleLocation:m}}var g=this.tryParseArgumentClose(i);if(g.err)return g;var f=y(i,this.clonePosition());if(l&&rs(l?.style,"::",0)){var b=El(l.style.slice(2));if(s==="number"){var u=this.parseNumberSkeletonFromString(b,l.styleLocation);return u.err?u:{val:{type:I.number,value:n,location:f,style:u.val},err:null}}else{if(b.length===0)return this.error(A.EXPECT_DATE_TIME_SKELETON,f);var L=b;this.locale&&(L=es(b,this.locale));var d={type:Xe.dateTime,pattern:L,location:l.styleLocation,parsedOptions:this.shouldParseSkeletons?Fa(L):{}},S=s==="date"?I.date:I.time;return{val:{type:S,value:n,location:f,style:d},err:null}}}return{val:{type:s==="number"?I.number:s==="date"?I.date:I.time,value:n,location:f,style:(o=l?.style)!==null&&o!==void 0?o:null},err:null}}case"plural":case"selectordinal":case"select":{var T=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(A.EXPECT_SELECT_ARGUMENT_OPTIONS,y(T,E({},T)));this.bumpSpace();var C=this.parseIdentifierIfPossible(),R=0;if(s!=="select"&&C.value==="offset"){if(!this.bumpIf(":"))return this.error(A.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,y(this.clonePosition(),this.clonePosition()));this.bumpSpace();var u=this.tryParseDecimalInteger(A.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,A.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(u.err)return u;this.bumpSpace(),C=this.parseIdentifierIfPossible(),R=u.val}var U=this.tryParsePluralOrSelectOptions(t,s,r,C);if(U.err)return U;var g=this.tryParseArgumentClose(i);if(g.err)return g;var j=y(i,this.clonePosition());return s==="select"?{val:{type:I.select,value:n,options:ns(U.val),location:j},err:null}:{val:{type:I.plural,value:n,options:ns(U.val),offset:R,pluralType:s==="plural"?"cardinal":"ordinal",location:j},err:null}}default:return this.error(A.INVALID_ARGUMENT_TYPE,y(a,c))}},e.prototype.tryParseArgumentClose=function(t){return this.isEOF()||this.char()!==125?this.error(A.EXPECT_ARGUMENT_CLOSING_BRACE,y(t,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var t=0,r=this.clonePosition();!this.isEOF();){var n=this.char();switch(n){case 39:{this.bump();var i=this.clonePosition();if(!this.bumpUntil("'"))return this.error(A.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,y(i,this.clonePosition()));this.bump();break}case 123:{t+=1,this.bump();break}case 125:{if(t>0)t-=1;else return{val:this.message.slice(r.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(r.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(t,r){var n=[];try{n=qa(t)}catch{return this.error(A.INVALID_NUMBER_SKELETON,r)}return{val:{type:Xe.number,tokens:n,location:r,parsedOptions:this.shouldParseSkeletons?Ja(n):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(t,r,n,i){for(var o,a=!1,s=[],c=new Set,l=i.value,h=i.location;;){if(l.length===0){var u=this.clonePosition();if(r!=="select"&&this.bumpIf("=")){var d=this.tryParseDecimalInteger(A.EXPECT_PLURAL_ARGUMENT_SELECTOR,A.INVALID_PLURAL_ARGUMENT_SELECTOR);if(d.err)return d;h=y(u,this.clonePosition()),l=this.message.slice(u.offset,this.offset())}else break}if(c.has(l))return this.error(r==="select"?A.DUPLICATE_SELECT_ARGUMENT_SELECTOR:A.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,h);l==="other"&&(a=!0),this.bumpSpace();var m=this.clonePosition();if(!this.bumpIf("{"))return this.error(r==="select"?A.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:A.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,y(this.clonePosition(),this.clonePosition()));var g=this.parseMessage(t+1,r,n);if(g.err)return g;var f=this.tryParseArgumentClose(m);if(f.err)return f;s.push([l,{value:g.val,location:y(m,this.clonePosition())}]),c.add(l),this.bumpSpace(),o=this.parseIdentifierIfPossible(),l=o.value,h=o.location}return s.length===0?this.error(r==="select"?A.EXPECT_SELECT_ARGUMENT_SELECTOR:A.EXPECT_PLURAL_ARGUMENT_SELECTOR,y(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!a?this.error(A.MISSING_OTHER_CLAUSE,y(this.clonePosition(),this.clonePosition())):{val:s,err:null}},e.prototype.tryParseDecimalInteger=function(t,r){var n=1,i=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(n=-1);for(var o=!1,a=0;!this.isEOF();){var s=this.char();if(s>=48&&s<=57)o=!0,a=a*10+(s-48),this.bump();else break}var c=y(i,this.clonePosition());return o?(a*=n,Al(a)?{val:a,err:null}:this.error(r,c)):this.error(t,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var t=this.position.offset;if(t>=this.message.length)throw Error("out of bound");var r=is(this.message,t);if(r===void 0)throw Error("Offset ".concat(t," is at invalid UTF-16 code unit boundary"));return r},e.prototype.error=function(t,r){return{val:null,err:{kind:t,message:this.message,location:r}}},e.prototype.bump=function(){if(!this.isEOF()){var t=this.char();t===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=t<65536?1:2)}},e.prototype.bumpIf=function(t){if(rs(this.message,t,this.offset())){for(var r=0;r<t.length;r++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(t){var r=this.offset(),n=this.message.indexOf(t,r);return n>=0?(this.bumpTo(n),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(t){if(this.offset()>t)throw Error("targetOffset ".concat(t," must be greater than or equal to the current offset ").concat(this.offset()));for(t=Math.min(t,this.message.length);;){var r=this.offset();if(r===t)break;if(r>t)throw Error("targetOffset ".concat(t," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&ss(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var t=this.char(),r=this.offset(),n=this.message.charCodeAt(r+(t>=65536?2:1));return n??null},e}();function Ki(e){return e>=97&&e<=122||e>=65&&e<=90}function Sl(e){return Ki(e)||e===47}function Tl(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function ss(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function wl(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function Yi(e){e.forEach(function(t){if(delete t.location,Xr(t)||qr(t))for(var r in t.options)delete t.options[r].location,Yi(t.options[r].value);else Kr(t)&&Zr(t.style)||(Yr(t)||jr(t))&&tr(t.style)?delete t.style.location:Wr(t)&&Yi(t.children)})}function cs(e,t){t===void 0&&(t={}),t=E({shouldParseSkeletons:!0,requiresOtherClause:!0},t);var r=new as(e,t).parse();if(r.err){var n=SyntaxError(A[r.err.kind]);throw n.location=r.err.location,n.originalMessage=r.err.message,n}return t?.captureLocation||Yi(r.val),r.val}function nr(e,t){var r=t&&t.cache?t.cache:Il,n=t&&t.serializer?t.serializer:kl,i=t&&t.strategy?t.strategy:Ll;return i(e,{cache:r,serializer:n})}function _l(e){return e==null||typeof e=="number"||typeof e=="boolean"}function ls(e,t,r,n){var i=_l(n)?n:r(n),o=t.get(i);return typeof o>"u"&&(o=e.call(this,n),t.set(i,o)),o}function hs(e,t,r){var n=Array.prototype.slice.call(arguments,3),i=r(n),o=t.get(i);return typeof o>"u"&&(o=e.apply(this,n),t.set(i,o)),o}function ji(e,t,r,n,i){return r.bind(t,e,n,i)}function Ll(e,t){var r=e.length===1?ls:hs;return ji(e,this,r,t.cache.create(),t.serializer)}function Pl(e,t){return ji(e,this,hs,t.cache.create(),t.serializer)}function Cl(e,t){return ji(e,this,ls,t.cache.create(),t.serializer)}var kl=function(){return JSON.stringify(arguments)};function Xi(){this.cache=Object.create(null)}Xi.prototype.get=function(e){return this.cache[e]};Xi.prototype.set=function(e,t){this.cache[e]=t};var Il={create:function(){return new Xi}},Qr={variadic:Pl,monadic:Cl};var qe;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(qe||(qe={}));var ir=function(e){er(t,e);function t(r,n,i){var o=e.call(this,r)||this;return o.code=n,o.originalMessage=i,o}return t.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},t}(Error);var qi=function(e){er(t,e);function t(r,n,i,o){return e.call(this,'Invalid values for "'.concat(r,'": "').concat(n,'". Options are "').concat(Object.keys(i).join('", "'),'"'),qe.INVALID_VALUE,o)||this}return t}(ir);var ds=function(e){er(t,e);function t(r,n,i){return e.call(this,'Value for "'.concat(r,'" must be of type ').concat(n),qe.INVALID_VALUE,i)||this}return t}(ir);var us=function(e){er(t,e);function t(r,n){return e.call(this,'The intl string context variable "'.concat(r,'" was not provided to the string "').concat(n,'"'),qe.MISSING_VALUE,n)||this}return t}(ir);var q;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(q||(q={}));function Nl(e){return e.length<2?e:e.reduce(function(t,r){var n=t[t.length-1];return!n||n.type!==q.literal||r.type!==q.literal?t.push(r):n.value+=r.value,t},[])}function Rl(e){return typeof e=="function"}function or(e,t,r,n,i,o,a){if(e.length===1&&Ui(e[0]))return[{type:q.literal,value:e[0].value}];for(var s=[],c=0,l=e;c<l.length;c++){var h=l[c];if(Ui(h)){s.push({type:q.literal,value:h.value});continue}if(za(h)){typeof o=="number"&&s.push({type:q.literal,value:r.getNumberFormat(t).format(o)});continue}var u=h.value;if(!(i&&u in i))throw new us(u,a);var d=i[u];if(Ga(h)){(!d||typeof d=="string"||typeof d=="number")&&(d=typeof d=="string"||typeof d=="number"?String(d):""),s.push({type:typeof d=="string"?q.literal:q.object,value:d});continue}if(Yr(h)){var m=typeof h.style=="string"?n.date[h.style]:tr(h.style)?h.style.parsedOptions:void 0;s.push({type:q.literal,value:r.getDateTimeFormat(t,m).format(d)});continue}if(jr(h)){var m=typeof h.style=="string"?n.time[h.style]:tr(h.style)?h.style.parsedOptions:n.time.medium;s.push({type:q.literal,value:r.getDateTimeFormat(t,m).format(d)});continue}if(Kr(h)){var m=typeof h.style=="string"?n.number[h.style]:Zr(h.style)?h.style.parsedOptions:void 0;m&&m.scale&&(d=d*(m.scale||1)),s.push({type:q.literal,value:r.getNumberFormat(t,m).format(d)});continue}if(Wr(h)){var g=h.children,f=h.value,b=i[f];if(!Rl(b))throw new ds(f,"function",a);var L=or(g,t,r,n,i,o),S=b(L.map(function(R){return R.value}));Array.isArray(S)||(S=[S]),s.push.apply(s,S.map(function(R){return{type:typeof R=="string"?q.literal:q.object,value:R}}))}if(Xr(h)){var T=h.options[d]||h.options.other;if(!T)throw new qi(h.value,d,Object.keys(h.options),a);s.push.apply(s,or(T.value,t,r,n,i));continue}if(qr(h)){var T=h.options["=".concat(d)];if(!T){if(!Intl.PluralRules)throw new ir(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,qe.MISSING_INTL_API,a);var C=r.getPluralRules(t,{type:h.pluralType}).select(d-(h.offset||0));T=h.options[C]||h.options.other}if(!T)throw new qi(h.value,d,Object.keys(h.options),a);s.push.apply(s,or(T.value,t,r,n,i,d-(h.offset||0)));continue}}return Nl(s)}function Ml(e,t){return t?E(E(E({},e||{}),t||{}),Object.keys(e).reduce(function(r,n){return r[n]=E(E({},e[n]),t[n]||{}),r},{})):e}function Ol(e,t){return t?Object.keys(e).reduce(function(r,n){return r[n]=Ml(e[n],t[n]),r},E({},e)):e}function Wi(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function $l(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:nr(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.NumberFormat).bind.apply(t,Fr([void 0],r,!1)))},{cache:Wi(e.number),strategy:Qr.variadic}),getDateTimeFormat:nr(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.DateTimeFormat).bind.apply(t,Fr([void 0],r,!1)))},{cache:Wi(e.dateTime),strategy:Qr.variadic}),getPluralRules:nr(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.PluralRules).bind.apply(t,Fr([void 0],r,!1)))},{cache:Wi(e.pluralRules),strategy:Qr.variadic})}}var ms=function(){function e(t,r,n,i){var o=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(a){var s=o.formatToParts(a);if(s.length===1)return s[0].value;var c=s.reduce(function(l,h){return!l.length||h.type!==q.literal||typeof l[l.length-1]!="string"?l.push(h.value):l[l.length-1]+=h.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(a){return or(o.ast,o.locales,o.formatters,o.formats,a,void 0,o.message)},this.resolvedOptions=function(){return{locale:o.resolvedLocale.toString()}},this.getAst=function(){return o.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Ol(e.formats,n),this.formatters=i&&i.formatters||$l(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=cs,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var ps=ms;var Vl=/[0-9\-+#]/,Ul=/[^\d\-+#]/g;function fs(e){return e.search(Vl)}function Hl(e="#.##"){let t={},r=e.length,n=fs(e);t.prefix=n>0?e.substring(0,n):"";let i=fs(e.split("").reverse().join("")),o=r-i,a=e.substring(o,o+1),s=o+(a==="."||a===","?1:0);t.suffix=i>0?e.substring(s,r):"",t.mask=e.substring(n,s),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let c=t.mask.match(Ul);return t.decimal=c&&c[c.length-1]||".",t.separator=c&&c[1]&&c[0]||",",c=t.mask.split(t.decimal),t.integer=c[0],t.fraction=c[1],t}function Dl(e,t,r){let n=!1,i={value:e};e<0&&(n=!0,i.value=-i.value),i.sign=n?"-":"",i.value=Number(i.value).toFixed(t.fraction&&t.fraction.length),i.value=Number(i.value).toString();let o=t.fraction&&t.fraction.lastIndexOf("0"),[a="0",s=""]=i.value.split(".");return(!s||s&&s.length<=o)&&(s=o<0?"":(+("0."+s)).toFixed(o+1).replace("0.","")),i.integer=a,i.fraction=s,Bl(i,t),(i.result==="0"||i.result==="")&&(n=!1,i.sign=""),!n&&t.maskHasPositiveSign?i.sign="+":n&&t.maskHasPositiveSign?i.sign="-":n&&(i.sign=r&&r.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),i}function Bl(e,t){e.result="";let r=t.integer.split(t.separator),n=r.join(""),i=n&&n.indexOf("0");if(i>-1)for(;e.integer.length<n.length-i;)e.integer="0"+e.integer;else Number(e.integer)===0&&(e.integer="");let o=r[1]&&r[r.length-1].length;if(o){let a=e.integer.length,s=a%o;for(let c=0;c<a;c++)e.result+=e.integer.charAt(c),!((c-s+1)%o)&&c<a-o&&(e.result+=t.separator)}else e.result=e.integer;return e.result+=t.fraction&&e.fraction?t.decimal+e.fraction:"",e}function Gl(e,t,r={}){if(!e||isNaN(Number(t)))return t;let n=Hl(e),i=Dl(t,n,r);return n.prefix+i.sign+i.result+n.suffix}var gs=Gl;var xs=".",zl=",",vs=/^\s+/,As=/\s+$/,bs="&nbsp;",Zi=e=>e*12,Es=(e,t)=>{let{start:r,end:n,displaySummary:{amount:i,duration:o,minProductQuantity:a,outcomeType:s}={}}=e;if(!(i&&o&&s&&a))return!1;let c=t?new Date(t):new Date;if(!r||!n)return!1;let l=new Date(r),h=new Date(n);return c>=l&&c<=h},We={MONTH:"MONTH",YEAR:"YEAR"},Fl={[N.ANNUAL]:12,[N.MONTHLY]:1,[N.THREE_YEARS]:36,[N.TWO_YEARS]:24},Qi=(e,t)=>({accept:e,round:t}),Kl=[Qi(({divisor:e,price:t})=>t%e==0,({divisor:e,price:t})=>t/e),Qi(({usePrecision:e})=>e,({divisor:e,price:t})=>Math.round(t/e*100)/100),Qi(()=>!0,({divisor:e,price:t})=>Math.ceil(Math.floor(t*100/e)/100))],Ji={[D.YEAR]:{[N.MONTHLY]:We.MONTH,[N.ANNUAL]:We.YEAR},[D.MONTH]:{[N.MONTHLY]:We.MONTH}},Yl=(e,t)=>e.indexOf(`'${t}'`)===0,jl=(e,t=!0)=>{let r=e.replace(/'.*?'/,"").trim(),n=Ss(r);return!!n?t||(r=r.replace(/[,\.]0+/,n)):r=r.replace(/\s?(#.*0)(?!\s)?/,"$&"+ql(e)),r},Xl=e=>{let t=Wl(e),r=Yl(e,t),n=e.replace(/'.*?'/,""),i=vs.test(n)||As.test(n);return{currencySymbol:t,isCurrencyFirst:r,hasCurrencySpace:i}},ys=e=>e.replace(vs,bs).replace(As,bs),ql=e=>e.match(/#(.?)#/)?.[1]===xs?zl:xs,Wl=e=>e.match(/'(.*?)'/)?.[1]??"",Ss=e=>e.match(/0(.?)0/)?.[1]??"";function _t({formatString:e,price:t,usePrecision:r,isIndianPrice:n=!1},i,o=a=>a){let{currencySymbol:a,isCurrencyFirst:s,hasCurrencySpace:c}=Xl(e),l=r?Ss(e):"",h=jl(e,r),u=r?2:0,d=o(t,{currencySymbol:a}),m=n?d.toLocaleString("hi-IN",{minimumFractionDigits:u,maximumFractionDigits:u}):gs(h,d),g=r?m.lastIndexOf(l):m.length,f=m.substring(0,g),b=m.substring(g+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,m).replace(/SYMBOL/,a),currencySymbol:a,decimals:b,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:i}}var Ts=e=>{let{commitment:t,term:r,usePrecision:n}=e,i=Fl[r]??1;return _t(e,i>1?We.MONTH:Ji[t]?.[r],o=>{let a={divisor:i,price:o,usePrecision:n},{round:s}=Kl.find(({accept:c})=>c(a));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(a)}`);return s(a)})},ws=({commitment:e,term:t,...r})=>_t(r,Ji[e]?.[t]),_s=e=>{let{commitment:t,instant:r,price:n,originalPrice:i,priceWithoutDiscount:o,promotion:a,quantity:s=1,term:c}=e;if(t===D.YEAR&&c===N.MONTHLY){if(!a)return _t(e,We.YEAR,Zi);let{displaySummary:{outcomeType:l,duration:h,minProductQuantity:u=1}={}}=a;switch(l){case"PERCENTAGE_DISCOUNT":if(s>=u&&Es(a,r)){let d=parseInt(h.replace("P","").replace("M",""));if(isNaN(d))return Zi(n);let m=s*i*d,g=s*o*(12-d),f=Math.floor((m+g)*100)/100;return _t({...e,price:f},We.YEAR)}default:return _t(e,We.YEAR,()=>Zi(o??n))}}return _t(e,Ji[t]?.[c])};var Zl={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at"},Ql=Ua("ConsonantTemplates/price"),Jl=/<\/?[^>]+(>|$)/g,F={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Lt={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},eh="TAX_EXCLUSIVE",th=e=>Va(e)?Object.entries(e).filter(([,t])=>yt(t)||Br(t)||t===!0).reduce((t,[r,n])=>t+` ${r}${n===!0?"":'="'+Oa(n)+'"'}`,""):"",Z=(e,t,r,n=!1)=>`<span class="${e}${t?"":" "+F.disabled}"${th(r)}>${n?ys(t):t??""}</span>`;function rh(e,{accessibleLabel:t,altAccessibleLabel:r,currencySymbol:n,decimals:i,decimalsDelimiter:o,hasCurrencySpace:a,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:h,taxInclusivityLabel:u},d={}){let m=Z(F.currencySymbol,n),g=Z(F.currencySpace,a?"&nbsp;":""),f="";return t?f=`<sr-only class="strikethrough-aria-label">${t}</sr-only>`:r&&(f=`<sr-only class="alt-aria-label">${r}</sr-only>`),c&&(f+=m+g),f+=Z(F.integer,s),f+=Z(F.decimalsDelimiter,o),f+=Z(F.decimals,i),c||(f+=g+m),f+=Z(F.recurrence,l,null,!0),f+=Z(F.unitType,h,null,!0),f+=Z(F.taxInclusivity,u,!0),Z(e,f,{...d})}var Q=({isAlternativePrice:e=!1,displayOptical:t=!1,displayStrikethrough:r=!1,displayAnnual:n=!1,instant:i=void 0}={})=>({country:o,displayFormatted:a=!0,displayRecurrence:s=!0,displayPerUnit:c=!1,displayTax:l=!1,language:h,literals:u={},quantity:d=1}={},{commitment:m,offerSelectorIds:g,formatString:f,price:b,priceWithoutDiscount:L,taxDisplay:S,taxTerm:T,term:C,usePrecision:R,promotion:U}={},j={})=>{Object.entries({country:o,formatString:f,language:h,price:b}).forEach(([gn,xn])=>{if(xn==null)throw new Error(`Argument "${gn}" is missing for osi ${g?.toString()}, country ${o}, language ${h}`)});let W={...Zl,...u},K=`${h.toLowerCase()}-${o.toUpperCase()}`;function B(gn,xn){let bn=W[gn];if(bn==null)return"";try{return new ps(bn.replace(Jl,""),K).format(xn)}catch{return Ql.error("Failed to format literal:",bn),""}}let he=r&&L?L:b,de=t?Ts:ws;n&&(de=_s);let{accessiblePrice:Ie,recurrenceTerm:Ne,...Re}=de({commitment:m,formatString:f,instant:i,isIndianPrice:o==="IN",originalPrice:b,priceWithoutDiscount:L,price:t?b:he,promotion:U,quantity:d,term:C,usePrecision:R}),Ee="",$t="",mn="";_(s)&&Ne&&(mn=B(Lt.recurrenceLabel,{recurrenceTerm:Ne}));let pn="";_(c)&&(pn=B(Lt.perUnitLabel,{perUnit:"LICENSE"}));let fn="";_(l)&&T&&(fn=B(S===eh?Lt.taxExclusiveLabel:Lt.taxInclusiveLabel,{taxTerm:T})),r&&(Ee=B(Lt.strikethroughAriaLabel,{strikethroughPrice:Ee})),e&&($t=B(Lt.alternativePriceAriaLabel,{alternativePrice:$t}));let rt=F.container;if(t&&(rt+=" "+F.containerOptical),r&&(rt+=" "+F.containerStrikethrough),e&&(rt+=" "+F.containerAlternative),n&&(rt+=" "+F.containerAnnual),_(a))return rh(rt,{...Re,accessibleLabel:Ee,altAccessibleLabel:$t,recurrenceLabel:mn,perUnitLabel:pn,taxInclusivityLabel:fn},j);let{currencySymbol:ko,decimals:lc,decimalsDelimiter:hc,hasCurrencySpace:Io,integer:dc,isCurrencyFirst:uc}=Re,nt=[dc,hc,lc];uc?(nt.unshift(Io?"\xA0":""),nt.unshift(ko)):(nt.push(Io?"\xA0":""),nt.push(ko)),nt.push(mn,pn,fn);let mc=nt.join("");return Z(rt,mc,j)},Ls=()=>(e,t,r)=>{let i=(e.displayOldPrice===void 0||_(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${Q({isAlternativePrice:i})(e,t,r)}${i?"&nbsp;"+Q({displayStrikethrough:!0})(e,t,r):""}`},Ps=()=>(e,t,r)=>{let{instant:n}=e;try{n||(n=new URLSearchParams(document.location.search).get("instant")),n&&(n=new Date(n))}catch{n=void 0}let i={...e,displayTax:!1,displayPerUnit:!1},a=(e.displayOldPrice===void 0||_(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${a?Q({displayStrikethrough:!0})(i,t,r)+"&nbsp;":""}${Q({isAlternativePrice:a})(e,t,r)}${Z(F.containerAnnualPrefix,"&nbsp;(")}${Q({displayAnnual:!0,instant:n})(i,t,r)}${Z(F.containerAnnualSuffix,")")}`},Cs=()=>(e,t,r)=>{let n={...e,displayTax:!1,displayPerUnit:!1};return`${Q({isAlternativePrice:e.displayOldPrice})(e,t,r)}${Z(F.containerAnnualPrefix,"&nbsp;(")}${Q({displayAnnual:!0})(n,t,r)}${Z(F.containerAnnualSuffix,")")}`};var eo=Q(),to=Ls(),ro=Q({displayOptical:!0}),no=Q({displayStrikethrough:!0}),io=Q({displayAnnual:!0}),oo=Q({displayOptical:!0,isAlternativePrice:!0}),ao=Q({isAlternativePrice:!0}),so=Cs(),co=Ps();var nh=(e,t)=>{if(!(!Tt(e)||!Tt(t)))return Math.floor((t-e)/t*100)},ks=()=>(e,t)=>{let{price:r,priceWithoutDiscount:n}=t,i=nh(r,n);return i===void 0?'<span class="no-discount"></span>':`<span class="discount">${i}%</span>`};var lo=ks();var{freeze:ar}=Object,ih={V2:"UCv2",V3:"UCv3"},oe=ar({...ih}),oh={CHECKOUT:"checkout",CHECKOUT_EMAIL:"checkout/email",SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"},ae=ar({...oh}),Pe={STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"},ho=ar({...D}),uo=ar({...Da}),mo=ar({...N});var Ze={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,tags:"acom",isProdDomain:!1},Is=1e3;function ah(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function Ns(e){if(e==null)return;let t=typeof e;if(t==="function")return e.name?`function ${e.name}`:"function";if(t==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:n,originatingRequest:i,status:o}=e;return[n,o,i].filter(Boolean).join(" ")}let r=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!Ze.serializableTypes.includes(r))return r}return e}function sh(e,t){if(!Ze.ignoredProperties.includes(e))return Ns(t)}var po={append(e){if(e.level!=="error")return;let{message:t,params:r}=e,n=[],i=[],o=t;r.forEach(l=>{l!=null&&(ah(l)?n:i).push(l)}),n.length&&(o+=" "+n.map(Ns).join(" "));let{pathname:a,search:s}=window.location,c=`${Ze.delimiter}page=${a}${s}`;c.length>Is&&(c=`${c.slice(0,Is)}<trunc>`),o+=c,i.length&&(o+=`${Ze.delimiter}facts=`,o+=JSON.stringify(i,sh)),window.lana?.log(o,Ze)}};function Pt(e){Object.assign(Ze,Object.fromEntries(Object.entries(e).filter(([t,r])=>t in Ze&&r!==""&&r!==null&&r!==void 0&&!Number.isNaN(r))))}var P=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflow:oe.V3,checkoutWorkflowStep:ae.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,env:Pe.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:ge.PUBLISHED});var Rs="mas-commerce-service";function Jr(e,{once:t=!1}={}){let r=null;function n(){let i=document.querySelector(Rs);i!==r&&(r=i,i&&e(i))}return document.addEventListener(dt,n,{once:t}),Qe(n),()=>document.removeEventListener(dt,n)}function sr(e,{country:t,forceTaxExclusive:r,perpetual:n}){let i;if(e.length<2)i=e;else{let o=t==="GB"||n?"EN":"MULT",[a,s]=e;i=[a.language===o?a:s]}return r&&(i=i.map($i)),i}var Qe=e=>window.setTimeout(e);function Ct(e,t=1){if(e==null)return[t];let r=(Array.isArray(e)?e:String(e).split(",")).map(Ci).filter(Tt);return r.length||(r=[t]),r}function en(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(Pi)}function J(){return document.getElementsByTagName(Rs)?.[0]}var fo=Object.freeze({LOCAL:"local",PROD:"prod",STAGE:"stage"});function ch({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||P.language),t??(t=e?.split("_")?.[1]||P.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function go(e={}){let{commerce:t={}}=e,r=Pe.PRODUCTION,n=di,i=O("checkoutClientId",t)??P.checkoutClientId,o=Le(O("checkoutWorkflow",t),oe,P.checkoutWorkflow),a=ae.CHECKOUT;o===oe.V3&&(a=Le(O("checkoutWorkflowStep",t),ae,P.checkoutWorkflowStep));let s=_(O("displayOldPrice",t),P.displayOldPrice),c=_(O("displayPerUnit",t),P.displayPerUnit),l=_(O("displayRecurrence",t),P.displayRecurrence),h=_(O("displayTax",t),P.displayTax),u=_(O("entitlement",t),P.entitlement),d=_(O("modal",t),P.modal),m=_(O("forceTaxExclusive",t),P.forceTaxExclusive),g=O("promotionCode",t)??P.promotionCode,f=Ct(O("quantity",t)),b=O("wcsApiKey",t)??P.wcsApiKey,L=t?.env==="stage",S=ge.PUBLISHED;["true",""].includes(t.allowOverride)&&(L=(O(li,t,{metadata:!1})?.toLowerCase()??t?.env)==="stage",S=Le(O(hi,t),ge,S)),L&&(r=Pe.STAGE,n=ui);let C=O("mas-io-url")??e.masIOUrl??`https://www${r===Pe.STAGE?".stage":""}.adobe.com/mas/io`;return{...ch(e),displayOldPrice:s,checkoutClientId:i,checkoutWorkflow:o,checkoutWorkflowStep:a,displayPerUnit:c,displayRecurrence:l,displayTax:h,entitlement:u,extraOptions:P.extraOptions,modal:d,env:r,forceTaxExclusive:m,promotionCode:g,quantity:f,alternativePrice:P.alternativePrice,wcsApiKey:b,wcsURL:n,landscape:S,masIOUrl:C}}var xo={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},bo=new Set,vo=new Set,Ms=new Map,Os={append({level:e,message:t,params:r,timestamp:n,source:i}){console[e](`${n}ms [${i}] %c${t}`,"font-weight: bold;",...r)}},$s={filter:({level:e})=>e!==xo.DEBUG},lh={filter:()=>!1};function hh(e,t,r,n,i){return{level:e,message:t,namespace:r,get params(){return n.length===1&&Qt(n[0])&&(n=n[0](),Array.isArray(n)||(n=[n])),n},source:i,timestamp:performance.now().toFixed(3)}}function dh(e){[...vo].every(t=>t(e))&&bo.forEach(t=>t(e))}function Vs(e){let t=(Ms.get(e)??0)+1;Ms.set(e,t);let r=`${e} #${t}`,n={id:r,namespace:e,module:i=>Vs(`${n.namespace}/${i}`),updateConfig:Pt};return Object.values(xo).forEach(i=>{n[i]=(o,...a)=>dh(hh(i,o,e,a,r))}),Object.seal(n)}function tn(...e){e.forEach(t=>{let{append:r,filter:n}=t;Qt(n)&&vo.add(n),Qt(r)&&bo.add(r)})}function uh(e={}){let{name:t}=e,r=_(O("commerce.debug",{search:!0,storage:!0}),t===fo.LOCAL);return tn(r?Os:$s),t===fo.PROD&&tn(po),Y}function mh(){bo.clear(),vo.clear()}var Y={...Vs(ci),Level:xo,Plugins:{consoleAppender:Os,debugFilter:$s,quietFilter:lh,lanaAppender:po},init:uh,reset:mh,use:tn};var xe=class e extends Error{constructor(t,r,n){if(super(t,{cause:n}),this.name="MasError",r.response){let i=r.response.headers?.get(mi);i&&(r.requestId=i),r.response.status&&(r.status=r.response.status,r.statusText=r.response.statusText),r.response.url&&(r.url=r.response.url)}delete r.response,this.context=r,Error.captureStackTrace&&Error.captureStackTrace(this,e)}toString(){let t=Object.entries(this.context||{}).map(([n,i])=>`${n}: ${JSON.stringify(i)}`).join(", "),r=`${this.name}: ${this.message}`;return t&&(r+=` (${t})`),this.cause&&(r+=`
Caused by: ${this.cause}`),r}};async function rn(e,t={},r=2,n=100){let i;for(let o=0;o<=r;o++)try{return await fetch(e,t)}catch(a){if(i=a,o>r)break;await new Promise(s=>setTimeout(s,n*(o+1)))}throw i}var Ds=new CSSStyleSheet;Ds.replaceSync(":host { display: contents; }");var Us="fragment",Hs="author",nn="aem-fragment";async function ph(e,t,r){let n=`${nn}:${t}${Zt}`,i;try{if(i=await rn(e,{cache:"default",credentials:"omit"}),!i?.ok){let{startTime:o,duration:a}=performance.measure(n,r);throw new xe("Unexpected fragment response",{response:i,startTime:o,duration:a})}return i.json()}catch{let{startTime:a,duration:s}=performance.measure(n,r);throw i||(i={url:e}),new xe("Failed to fetch fragment",{response:i,startTime:a,duration:s,...ne()})}}var be,Ao=class{constructor(){$(this,be,new Map)}clear(){v(this,be).clear()}addByRequestedId(t,r){v(this,be).set(t,r)}add(...t){t.forEach(r=>{let{id:n}=r;n&&v(this,be).set(n,r)})}has(t){return v(this,be).has(t)}get(t){return v(this,be).get(t)}remove(t){v(this,be).delete(t)}};be=new WeakMap;var cr=new Ao,on,se,ve,kt,It,lr,te,Nt,Je,hr,dr,yo,Eo=class extends HTMLElement{constructor(){super();$(this,dr);p(this,"cache",cr);$(this,on,Y.module(nn));$(this,se,null);$(this,ve,null);$(this,kt,!1);$(this,It,null);$(this,lr,null);$(this,te);$(this,Nt);$(this,Je);$(this,hr,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[Ds]}static get observedAttributes(){return[Us,Hs]}attributeChangedCallback(r,n,i){r===Us&&H(this,te,i),r===Hs&&H(this,hr,["","true"].includes(i))}connectedCallback(){if(!v(this,te)){ue(this,dr,yo).call(this,{message:"Missing fragment id"});return}H(this,It,`${nn}:${v(this,te)}${_e}`),performance.mark(v(this,It)),H(this,Nt,new Promise((r,n)=>{this.dispose=Jr(i=>this.activate(i,r,n))}))}async activate(r,n,i){H(this,lr,r),this.refresh(!1).then(o=>n(o)).catch(o=>i(o))}async refresh(r=!0){if(!(v(this,Je)&&!await Promise.race([v(this,Je),Promise.resolve(!1)])))return r&&cr.remove(v(this,te)),H(this,Je,this.fetchData().then(()=>{let{references:n,referencesTree:i,placeholders:o}=v(this,se)||{};return this.dispatchEvent(new CustomEvent(Ge,{detail:{...this.data,stale:v(this,kt),references:n,referencesTree:i,placeholders:o},bubbles:!0,composed:!0})),!0}).catch(n=>v(this,se)?(cr.addByRequestedId(v(this,te),v(this,se)),!0):(H(this,Nt,null),ue(this,dr,yo).call(this,n),!1))),v(this,Je)}async fetchData(){this.classList.remove("error"),H(this,ve,null);let r=cr.get(v(this,te));if(r){H(this,se,r);return}H(this,kt,!0);let{masIOUrl:n,wcsApiKey:i,locale:o}=v(this,lr).settings,a=`${n}/fragment?id=${v(this,te)}&api_key=${i}&locale=${o}`;r=await ph(a,v(this,te),v(this,It)),cr.addByRequestedId(v(this,te),r),H(this,se,r),H(this,kt,!1)}get updateComplete(){return v(this,Nt)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return v(this,ve)?v(this,ve):(v(this,hr)?this.transformAuthorData():this.transformPublishData(),v(this,ve))}transformAuthorData(){let{fields:r,id:n,tags:i}=v(this,se);H(this,ve,r.reduce((o,{name:a,multiple:s,values:c})=>(o.fields[a]=s?c:c[0],o),{fields:{},id:n,tags:i}))}transformPublishData(){let{fields:r,id:n,tags:i}=v(this,se);H(this,ve,Object.entries(r).reduce((o,[a,s])=>(o.fields[a]=s?.mimeType?s.value:s??"",o),{fields:{},id:n,tags:i}))}};on=new WeakMap,se=new WeakMap,ve=new WeakMap,kt=new WeakMap,It=new WeakMap,lr=new WeakMap,te=new WeakMap,Nt=new WeakMap,Je=new WeakMap,hr=new WeakMap,dr=new WeakSet,yo=function({message:r,context:n}){this.classList.add("error"),v(this,on).error(`aem-fragment: ${r}`,n),this.dispatchEvent(new CustomEvent(ze,{detail:{message:r,...n},bubbles:!0,composed:!0}))};customElements.define(nn,Eo);var ur=class extends X{constructor(){super()}render(){return x`
            <slot name="icon"></slot>
    ...
    `),p(ur,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",ur);var mr=class extends X{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,r)=>{r>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return x`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${this.isMobile&&this.rows.length>this.mobileRows?x`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:x``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};p(mr,"styles",w`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
...
`;var[ag,sg,Ks,Ys,js,cg]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var wo=class extends X{static get properties(){return{closed:{type:Boolean,reflect:!0},selected:{type:Number},min:{type:Number},max:{type:Number},step:{type:Number},maxInput:{type:Number,attribute:"max-input"},defaultValue:{type:Number,attribute:"default-value",reflect:!0},title:{type:String}}}static get styles(){return Fs}constructor(){super(),this.options=[],this.title="",this.closed=!0,this.min=0,this.max=0,this.step=0,this.maxInput=void 0,this.defaultValue=void 0,this.selectedValue=0,this.highlightedIndex=0,this.toggleMenu=this.toggleMenu.bind(this),this.handleClickOutside=this.handleClickOutside.bind(this),this.boundKeydownListener=this.handleKeydown.bind(this),this.addEventListener("keydown",this.boundKeydownListener),window.addEventListener("mousedown",this.handleClickOutside),this.handleKeyupDebounced=xa(this.handleKeyup.bind(this),500)}handleKeyup(){this.handleInput(),this.sendEvent()}handleKeydown(t){switch(t.key){case Ys:this.closed||(t.preventDefault(),this.highlightedIndex=(this.highlightedIndex+1)%this.options.length,this.requestUpdate());break;case Ks:this.closed||(t.preventDefault(),this.highlightedIndex=(this.highlightedIndex-1+this.options.length)%this.options.length,this.requestUpdate());break;case js:if(this.closed)this.closePopover(),this.blur();else{let r=this.options[this.highlightedIndex];if(!r)break;this.selectedValue=r,this.handleMenuOption(this.selectedValue),this.toggleMenu()}break}t.composedPath().includes(this)&&t.stopPropagation()}adjustInput(t,r){this.selectedValue=r,t.value=r,this.highlightedIndex=this.options.indexOf(r)}handleInput(){let t=this.shadowRoot.querySelector(".text-field-input"),r=parseInt(t.value);if(!isNaN(r))if(r>0&&r!==this.selectedValue){let n=r;this.maxInput&&r>this.maxInput&&(n=this.maxInput),this.min&&n<this.min&&(n=this.min),this.adjustInput(t,n)}else this.adjustInput(t,this.min||1)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside),this.removeEventListener("keydown",this.boundKeydownListener)}generateOptionsArray(){let t=[];if(this.step>0)for(let r=this.min;r<=this.max;r+=this.step)t.push(r);return t}updated(t){(t.has("min")||t.has("max")||t.has("step")||t.has("defaultValue"))&&(this.options=this.generateOptionsArray(),this.highlightedIndex=this.defaultValue?this.options.indexOf(this.defaultValue):0,this.handleMenuOption(this.defaultValue?this.defaultValue:this.options[0]),this.requestUpdate())}handleClickOutside(t){t.composedPath().includes(this)||this.closePopover()}toggleMenu(){this.closed=!this.closed}handleMouseEnter(t){this.highlightedIndex=t,this.requestUpdate()}handleMenuOption(t){t===this.max&&this.shadowRoot.querySelector(".text-field-input")?.focus(),this.selectedValue=t,this.sendEvent(),this.closePopover()}sendEvent(){let t=new CustomEvent(ut,{detail:{option:this.selectedValue},bubbles:!0});this.dispatchEvent(t)}closePopover(){this.closed||this.toggleMenu()}get offerSelect(){return this.querySelector("merch-offer-select")}get popover(){return x` <div class="popover ${this.closed?"closed":"open"}">
        ...
        `}};customElements.define("merch-quantity-select",wo);var Kh={[pe]:ti,[we]:ri,[fe]:ni},Yh={[pe]:ai,[fe]:si},Ot=class{constructor(t){p(this,"changes",new Map);p(this,"connected",!1);p(this,"dispose",St);p(this,"error");p(this,"log");p(this,"options");p(this,"promises",[]);p(this,"state",we);p(this,"timer",null);p(this,"value");p(this,"version",0);p(this,"wrapperElement");this.wrapperElement=t,this.log=Y.module("mas-element")}update(){[pe,we,fe].forEach(t=>{this.wrapperElement.classList.toggle(Kh[t],t===this.state)})}notify(){(this.state===fe||this.state===pe)&&(this.state===fe?this.promises.forEach(({resolve:r})=>r(this.wrapperElement)):this.state===pe&&this.promises.forEach(({reject:r})=>r(this.error)),this.promises=[]);let t=this.error;this.error instanceof xe&&(t={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(Yh[this.state],{bubbles:!0,detail:t}))}attributeChangedCallback(t,r,n){this.changes.set(t,n),this.requestUpdate()}connectedCallback(){this.dispose=Jr(()=>this.requestUpdate(!0))}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement})),this.dispose(),this.dispose=St}onceSettled(){let{error:t,promises:r,state:n}=this;return fe===n?Promise.resolve(this.wrapperElement):pe===n?Promise.reject(t):new Promise((i,o)=>{r.push({resolve:i,reject:o})})}toggleResolved(t,r,n){return t!==this.version?!1:(n!==void 0&&(this.options=n),this.state=fe,this.value=r,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:r}),Qe(()=>this.notify()),!0)}toggleFailed(t,r,n){if(t!==this.version)return!1;n!==void 0&&(this.options=n),this.error=r,this.state=pe,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${r.message}`,{element:this.wrapperElement,...r.context,...ne()}),Qe(()=>this.notify()),!0}togglePending(t){return this.version++,t&&(this.options=t),this.state=we,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!J()||this.timer)return;let{error:r,options:n,state:i,value:o,version:a}=this;this.state=we,this.timer=Qe(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||t)try{await this.wrapperElement.render?.()===!1&&this.state===we&&this.version===a&&(this.state=i,this.error=r,this.value=o,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,n)}})}};function Xs(e={}){return Object.entries(e).forEach(([t,r])=>{(r==null||r===""||r?.length===0)&&delete e[t]}),e}function sn(e,t={}){let{tag:r,is:n}=e,i=document.createElement(r,{is:n});return i.setAttribute("is",n),Object.assign(i.dataset,Xs(t)),i}function cn(e,t={}){return e instanceof HTMLElement?(Object.assign(e.dataset,Xs(t)),e):null}var qs="download",Ws="upgrade";function ln(e,t={},r=""){let n=J();if(!n)return null;let{checkoutMarketSegment:i,checkoutWorkflow:o,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:l,perpetual:h,promotionCode:u,quantity:d,wcsOsi:m,extraOptions:g,analyticsId:f}=n.collectCheckoutOptions(t),b=sn(e,{checkoutMarketSegment:i,checkoutWorkflow:o,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:l,perpetual:h,promotionCode:u,quantity:d,wcsOsi:m,extraOptions:g,analyticsId:f});return r&&(b.innerHTML=`<span style="pointer-events: none;">${r}</span>`),b}function hn(e){return class extends e{constructor(){super(...arguments);p(this,"checkoutActionHandler");p(this,"masElement",new Ot(this))}attributeChangedCallback(n,i,o){this.masElement.attributeChangedCallback(n,i,o)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get opens3in1Modal(){let n=document.querySelector("meta[name=mas-ff-3in1]");return Object.values(re).includes(this.getAttribute("data-modal"))&&(!n||n.content!=="off")}requestUpdate(n=!1){return this.masElement.requestUpdate(n)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(n={}){let i=J();if(!i)return!1;this.dataset.imsCountry||i.imsCountryPromise.then(u=>{u&&(this.dataset.imsCountry=u)},St),n.imsCountry=null;let o=i.collectCheckoutOptions(n,this);if(!o.wcsOsi.length)return!1;let a;try{a=JSON.parse(o.extraOptions??"{}")}catch(u){this.masElement.log?.error("cannot parse exta checkout options",u)}let s=this.masElement.togglePending(o);this.setCheckoutUrl("");let c=i.resolveOfferSelectors(o),l=await Promise.all(c);l=l.map(u=>sr(u,o)),o.country=this.dataset.imsCountry||o.country;let h=await i.buildCheckoutAction?.(l.flat(),{...a,...o},this);return this.renderOffers(l.flat(),o,{},h,s)}renderOffers(n,i,o={},a=void 0,s=void 0){let c=J();if(!c)return!1;if(i={...JSON.parse(this.dataset.extraOptions??"null"),...i,...o},s??(s=this.masElement.togglePending(i)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),a){this.classList.remove(qs,Ws),this.masElement.toggleResolved(s,n,i);let{url:h,text:u,className:d,handler:m}=a;h&&this.setCheckoutUrl(h),u&&(this.firstElementChild.innerHTML=u),d&&this.classList.add(...d.split(" ")),m&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=m.bind(this))}if(n.length){if(this.masElement.toggleResolved(s,n,i)){let h=c.buildCheckoutURL(n,i);return!this.classList.contains(qs)&&!this.classList.contains(Ws)&&this.setCheckoutUrl(h),!0}}else{let h=new Error(`Not provided: ${i?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,h,i))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(n){}updateOptions(n={}){let i=J();if(!i)return!1;let{checkoutMarketSegment:o,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:h,perpetual:u,promotionCode:d,quantity:m,wcsOsi:g}=i.collectCheckoutOptions(n);return cn(this,{checkoutMarketSegment:o,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:h,perpetual:u,promotionCode:d,quantity:m,wcsOsi:g}),!0}}}var xr=class xr extends hn(HTMLAnchorElement){static createCheckoutLink(t={},r=""){return ln(xr,t,r)}setCheckoutUrl(t){this.setAttribute("href",t)}get isCheckoutLink(){return!0}clickHandler(t){if(this.checkoutActionHandler){this.checkoutActionHandler?.(t);return}}};p(xr,"is","checkout-link"),p(xr,"tag","a");var ce=xr;window.customElements.get(ce.is)||window.customElements.define(ce.is,ce,{extends:ce.tag});var br=class br extends hn(HTMLButtonElement){static createCheckoutButton(t={},r=""){return ln(br,t,r)}setCheckoutUrl(t){this.setAttribute("data-href",t)}get href(){return this.getAttribute("data-href")}get isCheckoutButton(){return!0}clickHandler(t){if(this.checkoutActionHandler){this.checkoutActionHandler?.(t);return}this.href&&(window.location.href=this.href)}};p(br,"is","checkout-button"),p(br,"tag","button");var tt=br;window.customElements.get(tt.is)||window.customElements.define(tt.is,tt,{extends:tt.tag});var jh="p_draft_landscape",Xh="/store/",qh=new Map([["countrySpecific","cs"],["customerSegment","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["offerType","ot"],["marketSegment","ms"]]),_o=new Set(["af","ai","apc","appctxid","cli","co","cs","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),Wh=["env","workflowStep","clientId","country"],Zs=e=>qh.get(e)??e;function Lo(e,t,r){for(let[n,i]of Object.entries(e)){let o=Zs(n);i!=null&&r.has(o)&&t.set(o,i)}}function Zh(e){switch(e){case pi.PRODUCTION:return"https://commerce.adobe.com";default:return"https://commerce-stg.adobe.com"}}function Qh(e,t){for(let r in e){let n=e[r];for(let[i,o]of Object.entries(n)){if(o==null)continue;let a=Zs(i);t.set(`items[${r}][${a}]`,o)}}}function Jh(e,t,r,n){return!Object.values(re).includes(t)||!e?.searchParams||!r||!n||(e.searchParams.set("rtc","t"),e.searchParams.set("lo","sl"),e.searchParams.get("cli")!=="doc_cloud"&&e.searchParams.set("cli",t===re.CRM?"creative":"mini_plans"),t===re.CRM?e.searchParams.set("af","uc_segmentation_hide_tabs,uc_new_user_iframe,uc_new_system_close"):(t===re.TWP||t===re.D2P)&&(e.searchParams.set("af","uc_new_user_iframe,uc_new_system_close"),r==="INDIVIDUAL"&&n==="EDU"&&e.searchParams.set("ms","e"),r==="TEAM"&&n==="COM"&&e.searchParams.set("cs","t"))),e}function Qs(e){ed(e);let{env:t,items:r,workflowStep:n,ms:i,marketSegment:o,customerSegment:a,ot:s,offerType:c,pa:l,productArrangementCode:h,landscape:u,modal:d,...m}=e,g={marketSegment:o??i,offerType:c??s,productArrangementCode:h??l},f=new URL(Zh(t));return f.pathname=`${Xh}${n}`,n!==Fe.SEGMENTATION&&n!==Fe.CHANGE_PLAN_TEAM_PLANS&&Qh(r,f.searchParams),n===Fe.SEGMENTATION&&Lo(g,f.searchParams,_o),Lo(m,f.searchParams,_o),u===ge.DRAFT&&Lo({af:jh},f.searchParams,_o),f=Jh(f,d,a,o),f.toString()}function ed(e){for(let t of Wh)if(!e[t])throw new Error('Argument "checkoutData" is not valid, missing: '+t);if(e.workflowStep!==Fe.SEGMENTATION&&e.workflowStep!==Fe.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}function Js({providers:e,settings:t}){function r(o,a){let{checkoutClientId:s,checkoutWorkflow:c,checkoutWorkflowStep:l,country:h,language:u,promotionCode:d,quantity:m}=t,{checkoutMarketSegment:g,checkoutWorkflow:f=c,checkoutWorkflowStep:b=l,imsCountry:L,country:S=L??h,language:T=u,quantity:C=m,entitlement:R,upgrade:U,modal:j,perpetual:W,promotionCode:K=d,wcsOsi:B,extraOptions:he,...de}=Object.assign({},a?.dataset??{},o??{}),Ie=Le(f,oe,P.checkoutWorkflow),Ne=ae.CHECKOUT;Ie===oe.V3&&(Ne=Le(b,ae,P.checkoutWorkflowStep));let Re=wt({...de,extraOptions:he,checkoutClientId:s,checkoutMarketSegment:g,country:S,quantity:Ct(C,P.quantity),checkoutWorkflow:Ie,checkoutWorkflowStep:Ne,language:T,entitlement:_(R),upgrade:_(U),modal:j,perpetual:_(W),promotionCode:Jt(K).effectivePromoCode,wcsOsi:en(B)});if(a)for(let Ee of e.checkout)Ee(a,Re);return Re}function n(o,a){if(!Array.isArray(o)||!o.length||!a)return"";let{env:s,landscape:c}=t,{checkoutClientId:l,checkoutMarketSegment:h,checkoutWorkflow:u,checkoutWorkflowStep:d,country:m,promotionCode:g,quantity:f,...b}=r(a),L=window.frameElement||Object.values(re).includes(a.modal)?"if":"fp",S={checkoutPromoCode:g,clientId:l,context:L,country:m,env:s,items:[],marketSegment:h,workflowStep:d,landscape:c,...b};if(o.length===1){let[{offerId:T,offerType:C,productArrangementCode:R}]=o,{marketSegments:[U],customerSegment:j}=o[0];Object.assign(S,{marketSegment:U,customerSegment:j,offerType:C,productArrangementCode:R}),S.items.push(f[0]===1?{id:T}:{id:T,quantity:f[0]})}else S.items.push(...o.map(({offerId:T},C)=>({id:T,quantity:f[C]??P.quantity})));return Qs(S)}let{createCheckoutLink:i}=ce;return{CheckoutLink:ce,CheckoutWorkflow:oe,CheckoutWorkflowStep:ae,buildCheckoutURL:n,collectCheckoutOptions:r,createCheckoutLink:i}}function td({interval:e=200,maxAttempts:t=25}={}){let r=Y.module("ims");return new Promise(n=>{r.debug("Waing for IMS to be ready");let i=0;function o(){window.adobeIMS?.initialized?n():++i>t?(r.debug("Timeout"),n()):setTimeout(o,e)}o()})}function rd(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function nd(e){let t=Y.module("ims");return e.then(r=>r?window.adobeIMS.getProfile().then(({countryCode:n})=>(t.debug("Got user country:",n),n),n=>{t.error("Unable to get user country:",n)}):null)}function ec({}){let e=td(),t=rd(e),r=nd(t);return{imsReadyPromise:e,imsSignedInPromise:t,imsCountryPromise:r}}async function rc(e,t){let{data:r}=t||await Promise.resolve().then(()=>Sc(tc(),1));if(Array.isArray(r)){let n=o=>r.find(a=>Dr(a.lang,o)),i=n(e.language)??n(P.language);if(i)return Object.freeze(i)}return{}}var nc=["GB_en","AU_en","FR_fr","AT_de","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GR_el","GR_en","HU_hu","IE_en","IT_it","LU_de","LU_en","LU_fr","NL_nl","NO_nb","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TR_tr","UA_uk","ID_en","ID_in","IN_en","IN_hi","JP_ja","MY_en","MY_ms","NZ_en","TH_en","TH_th"],od={INDIVIDUAL_COM:["ZA_en","LT_lt","LV_lv","NG_en","SA_ar","SA_en","ZA_en","SG_en","KR_ko"],TEAM_COM:["ZA_en","LT_lt","LV_lv","NG_en","ZA_en","CO_es","KR_ko"],INDIVIDUAL_EDU:["LT_lt","LV_lv","SA_en","SG_en"],TEAM_EDU:["SG_en","KR_ko"]},vr=class vr extends HTMLSpanElement{constructor(){super();p(this,"masElement",new Ot(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-perpetual","data-promotion-code","data-tax-exclusive","data-template","data-wcs-osi"]}static createInlinePrice(r){let n=J();if(!n)return null;let{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:u,alternativePrice:d,template:m,wcsOsi:g}=n.collectPriceOptions(r);return sn(vr,{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:u,alternativePrice:d,template:m,wcsOsi:g})}get isInlinePrice(){return!0}attributeChangedCallback(r,n,i){this.masElement.attributeChangedCallback(r,n,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}resolveDisplayTaxForGeoAndSegment(r,n,i,o){let a=`${r}_${n}`;if(nc.includes(r)||nc.includes(a))return!0;let s=od[`${i}_${o}`];return s?!!(s.includes(r)||s.includes(a)):!1}async resolveDisplayTax(r,n){let[i]=await r.resolveOfferSelectors(n),o=sr(await i,n);if(o?.length){let{country:a,language:s}=n,c=o[0],[l=""]=c.marketSegments;return this.resolveDisplayTaxForGeoAndSegment(a,s,c.customerSegment,l)}}async render(r={}){if(!this.isConnected)return!1;let n=J();if(!n)return!1;let i=n.collectPriceOptions(r,this);if(!i.wcsOsi.length)return!1;let o=this.masElement.togglePending(i);this.innerHTML="";let[a]=n.resolveOfferSelectors(i);return this.renderOffers(sr(await a,i),i,o)}renderOffers(r,n={},i=void 0){if(!this.isConnected)return;let o=J();if(!o)return!1;let a=o.collectPriceOptions({...this.dataset,...n},this);if(i??(i=this.masElement.togglePending(a)),r.length){if(this.masElement.toggleResolved(i,r,a)){this.innerHTML=o.buildPriceHTML(r,a);let s=this.closest("p, h3, div");if(!s||!s.querySelector('span[data-template="strikethrough"]')||s.querySelector(".alt-aria-label"))return!0;let c=s?.querySelectorAll('span[is="inline-price"]');return c.length>1&&c.length===s.querySelectorAll('span[data-template="strikethrough"]').length*2&&c.forEach(l=>{l.dataset.template!=="strikethrough"&&l.options&&!l.options.alternativePrice&&(l.options.alternativePrice=!0,l.innerHTML=o.buildPriceHTML(r,l.options))}),!0}}else{let s=new Error(`Not provided: ${a?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,s,a))return this.innerHTML="",!0}return!1}updateOptions(r){let n=J();if(!n)return!1;let{alternativePrice:i,displayOldPrice:o,displayPerUnit:a,displayRecurrence:s,displayTax:c,forceTaxExclusive:l,perpetual:h,promotionCode:u,quantity:d,template:m,wcsOsi:g}=n.collectPriceOptions(r);return cn(this,{alternativePrice:i,displayOldPrice:o,displayPerUnit:a,displayRecurrence:s,displayTax:c,forceTaxExclusive:l,perpetual:h,promotionCode:u,quantity:d,template:m,wcsOsi:g}),!0}};p(vr,"is","inline-price"),p(vr,"tag","span");var le=vr;window.customElements.get(le.is)||window.customElements.define(le.is,le,{extends:le.tag});function ic({literals:e,providers:t,settings:r}){function n(a,s){let{country:c,displayOldPrice:l,displayPerUnit:h,displayRecurrence:u,displayTax:d,forceTaxExclusive:m,language:g,promotionCode:f,quantity:b,alternativePrice:L}=r,{displayOldPrice:S=l,displayPerUnit:T=h,displayRecurrence:C=u,displayTax:R=d,forceTaxExclusive:U=m,country:j=c,language:W=g,perpetual:K,promotionCode:B=f,quantity:he=b,alternativePrice:de=L,template:Ie,wcsOsi:Ne,...Re}=Object.assign({},s?.dataset??{},a??{}),Ee=wt({...Re,country:j,displayOldPrice:_(S),displayPerUnit:_(T),displayRecurrence:_(C),displayTax:_(R),forceTaxExclusive:_(U),language:W,perpetual:_(K),promotionCode:Jt(B).effectivePromoCode,quantity:Ct(he,P.quantity),alternativePrice:_(de),template:Ie,wcsOsi:en(Ne)});if(s)for(let $t of t.price)$t(s,Ee);return Ee}function i(a,s){if(!Array.isArray(a)||!a.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=lo;break;case"strikethrough":l=no;break;case"annual":l=io;break;default:s.template==="optical"&&s.alternativePrice?l=oo:s.template==="optical"?l=ro:s.country==="AU"&&a[0].planType==="ABM"?l=s.promotionCode?co:so:s.alternativePrice?l=ao:l=s.promotionCode?to:eo}let h=n(s);h.literals=Object.assign({},e.price,wt(s.literals??{}));let[u]=a;return u={...u,...u.priceDetails},l(h,u)}let o=le.createInlinePrice;return{InlinePrice:le,buildPriceHTML:i,collectPriceOptions:n,createInlinePrice:o}}var Po="wcs";function oc({settings:e}){let t=Y.module(Po),{env:r,wcsApiKey:n}=e,i=new Map,o=new Map,a,s=new Map;async function c(d,m,g=!0){let f=oi;t.debug("Fetching:",d);let b="",L;if(d.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let S=new Map(m),[T]=d.offerSelectorIds,C=Date.now()+Math.random().toString(36).substring(2,7),R=`${Po}:${T}:${C}${_e}`,U=`${Po}:${T}:${C}${Zt}`,j,W;try{if(performance.mark(R),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",T),b.searchParams.set("country",d.country),b.searchParams.set("locale",d.locale),b.searchParams.set("landscape",r===Pe.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",n),d.language&&b.searchParams.set("language",d.language),d.promotionCode&&b.searchParams.set("promotion_code",d.promotionCode),d.currency&&b.searchParams.set("currency",d.currency),L=await rn(b.toString(),{credentials:"omit"}),L.ok){let K=[];try{let B=await L.json();t.debug("Fetched:",d,B),K=B.resolvedOffers??[]}catch(B){t.error(`Error parsing JSON: ${B.message}`,{...B.context,...ne()})}K=K.map(zr),m.forEach(({resolve:B},he)=>{let de=K.filter(({offerSelectorIds:Ie})=>Ie.includes(he)).flat();de.length&&(S.delete(he),m.delete(he),B(de))})}else f=ii}catch(K){f=`Network error: ${K.message}`}finally{({startTime:j,duration:W}=performance.measure(U,R)),performance.clearMarks(R),performance.clearMeasures(U)}g&&m.size&&(t.debug("Missing:",{offerSelectorIds:[...m.keys()]}),m.forEach(K=>{K.reject(new xe(f,{...d,response:L,startTime:j,duration:W,...ne()}))}))}function l(){clearTimeout(a);let d=[...o.values()];o.clear(),d.forEach(({options:m,promises:g})=>c(m,g))}function h(){let d=i.size;s=new Map(i),i.clear(),t.debug(`Moved ${d} cache entries to stale cache`)}function u({country:d,language:m,perpetual:g=!1,promotionCode:f="",wcsOsi:b=[]}){let L=`${m}_${d}`;d!=="GB"&&(m=g?"EN":"MULT");let S=[d,m,f].filter(T=>T).join("-").toLowerCase();return b.map(T=>{let C=`${T}-${S}`;if(i.has(C))return i.get(C);let R=new Promise((U,j)=>{let W=o.get(S);if(!W){let K={country:d,locale:L,offerSelectorIds:[]};d!=="GB"&&(K.language=m),W={options:K,promises:new Map},o.set(S,W)}f&&(W.options.promotionCode=f),W.options.offerSelectorIds.push(T),W.promises.set(T,{resolve:U,reject:j}),l()}).catch(U=>{if(s.has(C))return s.get(C);throw U});return i.set(C,R),R})}return{WcsCommitment:ho,WcsPlanType:uo,WcsTerm:mo,resolveOfferSelectors:u,flushWcsCacheInternal:h}}var Co="mas-commerce-service",ac="mas:start",sc="mas:ready",un,cc,dn=class extends HTMLElement{constructor(){super(...arguments);$(this,un);p(this,"readyPromise",null);p(this,"lastLoggingTime",0)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(n,i,o)=>{let a=await r?.(n,i,this.imsSignedInPromise,o);return a||null})}async activate(r){let n=v(this,un,cc),i=Object.freeze(go(n));Pt(n.lana);let o=Y.init(n.hostEnv).module("service");o.debug("Activating:",n);let a={price:{}};try{a.price=await rc(i,n.commerce.priceLiterals)}catch{}let s={checkout:new Set,price:new Set},c={literals:a,providers:s,settings:i};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...Js(c),...ec(c),...ic(c),...oc(c),...fi,Log:Y,get defaults(){return P},get log(){return Y},get providers(){return{checkout(l){return s.checkout.add(l),()=>s.checkout.delete(l)},price(l){return s.price.add(l),()=>s.price.delete(l)}}},get settings(){return i}})),o.debug("Activated:",{literals:a,settings:i}),Qe(()=>{let l=new CustomEvent(dt,{bubbles:!0,cancelable:!1,detail:this});performance.mark(sc),this.initDuration=performance.measure(Wt,ac,sc)?.duration,this.dispatchEvent(l),r(this)}),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(ac),this.readyPromise=new Promise(r=>this.activate(r))}disconnectedCallback(){this.readyPromise=null}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(qt).forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh()),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}logFailedRequests(){let r=[...performance.getEntriesByType("resource")].filter(({startTime:i})=>i>this.lastLoggingTime).filter(({transferSize:i,duration:o,responseStatus:a})=>i===0&&o===0&&a<200||a>=400),n=Array.from(new Map(r.map(i=>[i.name,i])).values());if(n.some(({name:i})=>/(\/fragments\/|web_commerce_artifact)/.test(i))){let i=n.map(({name:o})=>o);this.log.error("Failed requests:",{failedUrls:i,...ne()})}this.lastLoggingTime=performance.now().toFixed(3)}};un=new WeakSet,cc=function(){let r=this.getAttribute("env")??"prod",n={hostEnv:{name:r},commerce:{env:r},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:r==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language"].forEach(i=>{let o=this.getAttribute(i);o&&(n[i]=o)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(i=>{let o=this.getAttribute(i);if(o!=null){let a=i.replace(/-([a-z])/g,s=>s[1].toUpperCase());n.commerce[a]=o}}),n},p(dn,"instance");window.customElements.get(Co)||window.customElements.define(Co,dn);Pt({sampleRate:1});export{ti as CLASS_NAME_FAILED,Oc as CLASS_NAME_HIDDEN,ri as CLASS_NAME_PENDING,ni as CLASS_NAME_RESOLVED,tt as CheckoutButton,ce as CheckoutLink,oe as CheckoutWorkflow,ae as CheckoutWorkflowStep,P as Defaults,ii as ERROR_MESSAGE_BAD_REQUEST,Fc as ERROR_MESSAGE_MISSING_LITERALS_URL,oi as ERROR_MESSAGE_OFFER_NOT_FOUND,ze as EVENT_AEM_ERROR,Ge as EVENT_AEM_LOAD,ei as EVENT_MAS_ERROR,Jn as EVENT_MAS_READY,Qn as EVENT_MERCH_CARD_ACTION_MENU_TOGGLE,Gc as EVENT_MERCH_CARD_COLLECTION_SHOWMORE,Bc as EVENT_MERCH_CARD_COLLECTION_SORT,Zn as EVENT_MERCH_CARD_READY,Vc as EVENT_MERCH_OFFER_READY,Wn as EVENT_MERCH_OFFER_SELECT_READY,ut as EVENT_MERCH_QUANTITY_SELECTOR_CHANGE,Dc as EVENT_MERCH_SEARCH_CHANGE,zc as EVENT_MERCH_SIDENAV_SELECT,Hc as EVENT_MERCH_STOCK_CHANGE,$r as EVENT_MERCH_STORAGE_CHANGE,Uc as EVENT_OFFER_SELECTED,ai as EVENT_TYPE_FAILED,dt as EVENT_TYPE_READY,si as EVENT_TYPE_RESOLVED,mi as HEADER_X_REQUEST_ID,le as InlinePrice,ci as LOG_NAMESPACE,ge as Landscape,Y as Log,Zt as MARK_DURATION_SUFFIX,_e as MARK_START_SUFFIX,Wt as MAS_COMMERCE_SERVICE_INIT_TIME_MEASURE_NAME,re as MODAL_TYPE_3_IN_1,Mc as NAMESPACE,Kc as PARAM_AOS_API_KEY,li as PARAM_ENV,hi as PARAM_LANDSCAPE,Yc as PARAM_WCS_API_KEY,pi as PROVIDER_ENVIRONMENT,Xt as SELECTOR_MAS_CHECKOUT_LINK,qt as SELECTOR_MAS_ELEMENT,Or as SELECTOR_MAS_INLINE_PRICE,qn as SELECTOR_MAS_SP_BUTTON,pe as STATE_FAILED,we as STATE_PENDING,fe as STATE_RESOLVED,Ae as UptLink,di as WCS_PROD_URL,ui as WCS_STAGE_URL,Fe as WORKFLOW_STEP,ho as WcsCommitment,uo as WcsPlanType,mo as WcsTerm,zr as applyPlanType,go as getSettings};
