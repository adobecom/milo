...
`;var zt=class extends O{constructor(t){super(t)}getGlobalCSS(){return ja}renderLayout(){return g` ${this.badge}
      <div class="body">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
          <slot name="body-xxs"></slot>
