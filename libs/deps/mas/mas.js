...
`,Ro=()=>[P`
        ...
        `}get cardImage(){return x` <div class="image">
            ...
            ${this.badge}
              ...
              >`:"";return x`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){}};nt=new WeakMap,p(Rt,"styleMap",{});var I=Rt;function te(e,t={},r=null,n=null){let i=n?document.createElement(e,{is:n}):document.createElement(e);r instanceof HTMLElement?i.appendChild(r):i.innerHTML=r;for(let[o,a]of Object.entries(t))i.setAttribute(o,a);return i}function fr(){return window.matchMedia("(max-width: 767px)").matches}function Vo(){return window.matchMedia("(max-width: 1024px)").matches}var Gn={};Os(Gn,{CLASS_NAME_FAILED:()=>kn,CLASS_NAME_HIDDEN:()=>Ys,CLASS_NAME_PENDING:()=>Nn,CLASS_NAME_RESOLVED:()=>On,ERROR_MESSAGE_BAD_REQUEST:()=>br,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>rc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Rn,EVENT_AEM_ERROR:()=>Me,EVENT_AEM_LOAD:()=>Ve,EVENT_MAS_ERROR:()=>In,EVENT_MAS_READY:()=>Pn,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Cn,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>ec,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Qs,EVENT_MERCH_CARD_READY:()=>wn,EVENT_MERCH_OFFER_READY:()=>Ws,EVENT_MERCH_OFFER_SELECT_READY:()=>_n,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>xr,EVENT_MERCH_SEARCH_CHANGE:()=>Js,EVENT_MERCH_SIDENAV_SELECT:()=>tc,EVENT_MERCH_STOCK_CHANGE:()=>Zs,EVENT_MERCH_STORAGE_CHANGE:()=>gr,EVENT_OFFER_SELECTED:()=>qs,EVENT_TYPE_FAILED:()=>Vn,EVENT_TYPE_READY:()=>it,EVENT_TYPE_RESOLVED:()=>Mn,LOG_NAMESPACE:()=>$n,Landscape:()=>$e,NAMESPACE:()=>js,PARAM_AOS_API_KEY:()=>nc,PARAM_ENV:()=>Hn,PARAM_LANDSCAPE:()=>Un,PARAM_WCS_API_KEY:()=>ic,STATE_FAILED:()=>he,STATE_PENDING:()=>Ee,STATE_RESOLVED:()=>de,TAG_NAME_SERVICE:()=>Xs,WCS_PROD_URL:()=>Dn,WCS_STAGE_URL:()=>Bn});var js="merch",Ys="hidden",it="wcms:commerce:ready",Xs="mas-commerce-service",Ws="merch-offer:ready",_n="merch-offer-select:ready",wn="merch-card:ready",Cn="merch-card:action-menu-toggle",qs="merch-offer:selected",Zs="merch-stock:change",gr="merch-storage:change",xr="merch-quantity-selector:change",Js="merch-search:change",Qs="merch-card-collection:sort",ec="merch-card-collection:showmore",tc="merch-sidenav:select",Ve="aem:load",Me="aem:error",Pn="mas:ready",In="mas:error",kn="placeholder-failed",Nn="placeholder-pending",On="placeholder-resolved",br="Bad WCS request",Rn="Commerce offer not found",rc="Literals URL not provided",Vn="mas:failed",Mn="mas:resolved",$n="mas/commerce",Hn="commerce.env",Un="commerce.landscape",nc="commerce.aosKey",ic="commerce.wcsKey",Dn="https://www.adobe.com/web_commerce_artifact",Bn="https://www.stage.adobe.com/web_commerce_artifact_stage",he="failed",Ee="pending",de="resolved",$e={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"};var Mo=`
:root {
...
`;var Ar=class extends I{constructor(t){super(t)}getGlobalCSS(){return Ho}renderLayout(){return x` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var sc={title:{tag:"p",slot:"heading-xs"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},stockOffer:!0,secureLabel:!0,ctas:{slot:"footer",size:"m"}},st=class extends I{constructor(t){super(t)}get aemFragmentMapping(){return sc}getGlobalCSS(){return Do}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
...
`;var He=class extends I{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Bo}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return x` ${this.badge}
...
`;var ht=class extends I{constructor(t){super(t)}getGlobalCSS(){return Fo}renderLayout(){return x`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
...
`;var hc={mnemonics:{size:"m"},backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{slot:"footer",size:"S"},allowedSizes:["wide"]},ut=class extends I{getGlobalCSS(){return jo}get aemFragmentMapping(){return hc}renderLayout(){return x` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
