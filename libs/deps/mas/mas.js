...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return Da}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenu)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenu)}};g(at,"variantStyle",N`
...
`;var Sl={title:{tag:"h3",slot:"heading-xs"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{size:"l"}},st=class extends O{constructor(t){super(t)}getGlobalCSS(){return Ga}get aemFragmentMapping(){return Sl}renderLayout(){return x` <div class="body">
            <slot name="icons"></slot> ${this.badge}
            <slot name="heading-xs"></slot>
            <slot name="heading-m"></slot>
...
`;var El=32,ct=class extends O{constructor(r){super(r);g(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);g(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){Hr()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};g(ct,"variantStyle",N`
...
`;var lt=class extends O{constructor(t){super(t)}getGlobalCSS(){return Ka}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
        ...
        ${this.secureLabelFooter}`}};g(lt,"variantStyle",N`
    :host([variant='plans']) {
      min-height: 348px;
    }
...
`;var ht=class extends O{constructor(t){super(t)}getGlobalCSS(){return Ba}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
        ${this.promoBottom?"":x`<slot name="promo-text"></slot><slot name="callout-content"></slot>`}
...
`;var dt=class extends O{constructor(t){super(t)}getGlobalCSS(){return Xa}renderLayout(){return x`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
      ...
      <footer><slot name="footer"></slot></footer>`}};g(dt,"variantStyle",N`
    :host([variant='twp']) {
      padding: 4px 10px 5px 10px;
    }
    .twp-badge {
...
`;var yl={backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{size:"s"},allowedSizes:["wide"]},mt=class extends O{getGlobalCSS(){return Wa}get aemFragmentMapping(){return yl}renderLayout(){return x` <div class="content">
                <slot name="icons"></slot> ${this.badge}
                <slot name="body-s"></slot>
                <slot name="footer"></slot>
            </div>
            <slot name="image"></slot>
            <slot></slot>`}};g(mt,"variantStyle",N`
    ...
    `);var Ni=(e,t=!1)=>{switch(e.variant){case"catalog":return new at(e);case"ccd-action":return new st(e);case"image":return new zr(e);case"inline-heading":return new Fr(e);case"mini-compare-chart":return new ct(e);case"plans":return new lt(e);case"product":return new Me(e);case"segment":return new ht(e);case"special-offers":return new ut(e);case"twp":return new dt(e);case"ccd-slice":return new mt(e);default:return t?void 0:new Me(e)}},qa=()=>{let e=[];return e.push(at.variantStyle),e.push(st.variantStyle),e.push(ct.variantStyle),e.push(Me.variantStyle),e.push(lt.variantStyle),e.push(ht.variantStyle),e.push(ut.variantStyle),e.push(dt.variantStyle),e.push(mt.variantStyle),e};var Za=document.createElement("style");Za.innerHTML=`
:root {
