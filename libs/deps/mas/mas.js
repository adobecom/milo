...
`;var Ke=class extends k{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Ta}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return b` ${this.badge}
      ...
      ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}postCardUpdateHook(){this.card.isConnected&&(mt()||this.adjustProductBodySlots(),this.adjustTitleWidth())}};p(Ke,"variantStyle",w`
...
Caused by: ${this.cause}`),r}};async function rn(e,t={},r=2,n=100){let i;for(let o=0;o<=r;o++)try{return await fetch(e,t)}catch(a){if(i=a,o>r)break;await new Promise(s=>setTimeout(s,n*(o+1)))}throw i}var Ds=new CSSStyleSheet;Ds.replaceSync(":host { display: contents; }");var Us="fragment",Hs="author",nn="aem-fragment";async function uh(e,t,r){let n=`${nn}:${t}${Qt}`,i;try{if(i=await rn(e,{cache:"default",credentials:"omit"}),!i?.ok){let{startTime:o,duration:a}=performance.measure(n,r);throw new fe("Unexpected fragment response",{response:i,startTime:o,duration:a})}return i.json()}catch{let{startTime:a,duration:s}=performance.measure(n,r);throw i||(i={url:e}),new fe("Failed to fetch fragment",{response:i,startTime:a,duration:s,...re()})}}var ge,Ao=class{constructor(){$(this,ge,new Map)}clear(){x(this,ge).clear()}addByRequestedId(t,r){x(this,ge).set(t,r)}add(...t){t.forEach(r=>{let{id:n}=r;n&&x(this,ge).set(n,r)})}has(t){return x(this,ge).has(t)}get(t){return x(this,ge).get(t)}remove(t){x(this,ge).delete(t)}};ge=new WeakMap;var lr=new Ao,on,be,xe,kt,It,hr,te,Nt,Qe,Rt,dr,yo,Eo=class extends HTMLElement{constructor(){super();$(this,dr);p(this,"cache",lr);$(this,on,j.module(nn));$(this,be,null);$(this,xe,null);$(this,kt,!1);$(this,It,null);$(this,hr,null);$(this,te);$(this,Nt);$(this,Qe);$(this,Rt,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[Ds]}static get observedAttributes(){return[Us,Hs]}attributeChangedCallback(r,n,i){r===Us&&H(this,te,i),r===Hs&&H(this,Rt,["","true"].includes(i))}connectedCallback(){if(!x(this,te)){he(this,dr,yo).call(this,{message:"Missing fragment id"});return}H(this,It,`${nn}:${x(this,te)}${we}`),performance.mark(x(this,It)),H(this,Nt,new Promise((r,n)=>{this.dispose=Jr(i=>this.activate(i,r,n))}))}async activate(r,n,i){H(this,hr,r);let o=!x(this,Rt);this.refresh(o).then(a=>n(a)).catch(a=>i(a))}async refresh(r=!0){if(!(x(this,Qe)&&!await Promise.race([x(this,Qe),Promise.resolve(!1)])))return r&&lr.remove(x(this,te)),H(this,Qe,this.fetchData().then(()=>(this.dispatchEvent(new CustomEvent(Ge,{detail:{...this.data,stale:x(this,kt)},bubbles:!0,composed:!0})),!0)).catch(n=>x(this,be)?(lr.addByRequestedId(x(this,te),x(this,be)),!0):(H(this,Nt,null),he(this,dr,yo).call(this,n),!1))),x(this,Qe)}async fetchData(){this.classList.remove("error"),H(this,xe,null);let r=lr.get(x(this,te));if(r){H(this,be,r);return}H(this,kt,!0);let{masIOUrl:n,wcsApiKey:i,locale:o}=x(this,hr).settings,a=`${n}/fragment?id=${x(this,te)}&api_key=${i}&locale=${o}`;r=await uh(a,x(this,te),x(this,It)),lr.addByRequestedId(x(this,te),r),H(this,be,r),H(this,kt,!1)}get updateComplete(){return x(this,Nt)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return x(this,xe)?x(this,xe):(x(this,Rt)?this.transformAuthorData():this.transformPublishData(),x(this,xe))}transformAuthorData(){let{fields:r,id:n,tags:i}=x(this,be);H(this,xe,r.reduce((o,{name:a,multiple:s,values:c})=>(o.fields[a]=s?c:c[0],o),{fields:{},id:n,tags:i}))}transformPublishData(){let{fields:r,id:n,tags:i}=x(this,be);H(this,xe,Object.entries(r).reduce((o,[a,s])=>(o.fields[a]=s?.mimeType?s.value:s??"",o),{fields:{},id:n,tags:i}))}};on=new WeakMap,be=new WeakMap,xe=new WeakMap,kt=new WeakMap,It=new WeakMap,hr=new WeakMap,te=new WeakMap,Nt=new WeakMap,Qe=new WeakMap,Rt=new WeakMap,dr=new WeakSet,yo=function({message:r,context:n}){this.classList.add("error"),x(this,on).error(`aem-fragment: ${r}`,n),this.dispatchEvent(new CustomEvent(Be,{detail:{message:r,...n},bubbles:!0,composed:!0}))};customElements.define(nn,Eo);var ur=class extends q{constructor(){super()}render(){return b`
    ...
    `),p(ur,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",ur);var mr=class extends q{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,r)=>{r>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return b`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows?b`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:b``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};p(mr,"styles",w`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
