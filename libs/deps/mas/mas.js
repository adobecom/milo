...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return Da}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenu)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenu)}};x(st,"variantStyle",N`
...
`;var El={title:{tag:"h3",slot:"heading-xs"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{size:"l"}},ct=class extends O{constructor(t){super(t)}getGlobalCSS(){return Ga}get aemFragmentMapping(){return El}renderLayout(){return g` <div class="body">
            <slot name="icons"></slot> ${this.badge}
            <slot name="heading-xs"></slot>
            <slot name="heading-m"></slot>
...
`;var zr=class extends O{constructor(t){super(t)}getGlobalCSS(){return Ha}renderLayout(){return g`${this.cardImage}
    <div class="body">
...
`;var Fr=class extends O{constructor(t){super(t)}getGlobalCSS(){return za}renderLayout(){return g` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var Sl=32,lt=class extends O{constructor(r){super(r);x(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);x(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?g`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){Hr()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};x(lt,"variantStyle",N`
...
`;var ht=class extends O{constructor(t){super(t)}getGlobalCSS(){return Ka}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?g`<label id="stock-checkbox">
        ...
        ${this.secureLabelFooter}`}};x(ht,"variantStyle",N`
    :host([variant='plans']) {
      min-height: 348px;
    }
...
`;var De=class extends O{constructor(t){super(t)}getGlobalCSS(){return ja}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return g` ${this.badge}
      <div class="body">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
          <slot name="body-xxs"></slot>
      ...
      ${this.secureLabelFooter}`}connectedCallbackHook(){super.connectedCallbackHook(),window.addEventListener("resize",this.postCardUpdateHook.bind(this))}postCardUpdateHook(){Hr()||this.adjustProductBodySlots()}};x(De,"variantStyle",N`
...
`;var ut=class extends O{constructor(t){super(t)}getGlobalCSS(){return Ba}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return g` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
        ${this.promoBottom?"":g`<slot name="promo-text"></slot><slot name="callout-content"></slot>`}
    ...
    <hr />
    ${this.secureLabelFooter}`}};x(ut,"variantStyle",N`
...
`;var mt=class extends O{constructor(t){super(t)}getGlobalCSS(){return Xa}renderLayout(){return g`${this.badge}
      ...
      <footer><slot name="footer"></slot></footer>`}};x(mt,"variantStyle",N`
    :host([variant='twp']) {
      padding: 4px 10px 5px 10px;
    }
    .twp-badge {
...
`;var yl={backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{size:"s"},allowedSizes:["wide"]},pt=class extends O{getGlobalCSS(){return Wa}get aemFragmentMapping(){return yl}renderLayout(){return g` <div class="content">
                <slot name="icons"></slot> ${this.badge}
                <slot name="body-s"></slot>
                <slot name="footer"></slot>
            </div>
            <slot name="image"></slot>
            <slot></slot>`}};x(pt,"variantStyle",N`
    ...
    `);var Ni=(e,t=!1)=>{switch(e.variant){case"catalog":return new st(e);case"ccd-action":return new ct(e);case"image":return new zr(e);case"inline-heading":return new Fr(e);case"mini-compare-chart":return new lt(e);case"plans":return new ht(e);case"product":return new De(e);case"segment":return new ut(e);case"special-offers":return new dt(e);case"twp":return new mt(e);case"ccd-slice":return new pt(e);default:return t?void 0:new De(e)}},qa=()=>{let e=[];return e.push(st.variantStyle),e.push(ct.variantStyle),e.push(lt.variantStyle),e.push(De.variantStyle),e.push(ht.variantStyle),e.push(ut.variantStyle),e.push(dt.variantStyle),e.push(mt.variantStyle),e.push(pt.variantStyle),e};var Za=document.createElement("style");Za.innerHTML=`
:root {
...
`;document.head.appendChild(Za);async function Ja(e,t){var a;let r=e.fields.reduce((s,{name:c,multiple:h,values:l})=>(s[c]=h?l:l[0],s),{id:e.id}),{variant:n}=r;if(!n)return;r.model=r.model,t.variant=n,await t.updateComplete;let{aemFragmentMapping:i}=t.variantLayout;if(!i)return;(a=t.variantLayout).refs??(a.refs=[]),t.variantLayout.refs.forEach(s=>s.remove());let o=s=>{t.variantLayout.refs.push(s),t.append(s)};if(r.mnemonicIcon?.forEach((s,c)=>{let h=r.mnemonicLink?.length>c?r.mnemonicLink[c]:"",l=r.mnemonicAlt?.length>c?r.mnemonicAlt[c]:"",u=ve("merch-icon",{slot:"icons",src:s,alt:l,href:h,size:"l"});o(u)}),r.size&&i.allowedSizes?.includes(r.size)&&t.setAttribute("size",r.size),r.cardTitle&&i.title&&o(ve(i.title.tag,{slot:i.title.slot},r.cardTitle)),r.backgroundImage&&i.backgroundImage&&o(ve(i.backgroundImage.tag,{slot:i.backgroundImage.slot},`<img loading="lazy" src="${r.backgroundImage}" />`)),r.prices&&i.prices){let s=r.prices,c=ve(i.prices.tag,{slot:i.prices.slot},s);o(c)}if(r.description&&i.description){let s=ve(i.description.tag,{slot:i.description.slot},r.description);o(s)}if(r.ctas){let s=ve("div",{slot:"footer"},r.ctas),c=[];[...s.querySelectorAll("a")].forEach(h=>{let l=h.parentElement.tagName==="STRONG";if(t.consonant)h.classList.add("con-button"),l&&h.classList.add("blue"),c.push(h);else{let m=ve("sp-button",{treatment:l?"fill":"outline",variant:l?"accent":"primary"},h);m.addEventListener("click",f=>{f.target===m&&(f.stopPropagation(),h.click())}),c.push(m)}}),s.innerHTML="",s.append(...c),o(s)}}var _l="merch-card",zt=class extends oe{constructor(){super();x(this,"customerSegment");x(this,"marketSegment");x(this,"variantLayout");this.filters={},this.types="",this.selected=!1,this.handleLoadEvent=this.handleLoadEvent.bind(this)}firstUpdated(){this.variantLayout=Ni(this,!1),this.variantLayout?.connectedCallbackHook(),this.aemFragment?.updateComplete.catch(()=>{this.style.display="none"})}willUpdate(r){(r.has("variant")||!this.variantLayout)&&(this.variantLayout=Ni(this),this.variantLayout.connectedCallbackHook())}updated(r){(r.has("badgeBackgroundColor")||r.has("borderColor"))&&(this.style.border=this.computedBorderStyle),this.variantLayout?.postCardUpdateHook(this)}get prices(){return Array.from(this.querySelectorAll('span[is="inline-price"][data-wcs-osi]'))}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return this.variant!=="twp"?`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`:""}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector('span[is="inline-price"]')}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll('a[is="checkout-link"]')??[]]}async toggleStockOffer({target:r}){if(!this.stockOfferOsis)return;let n=this.checkoutLinks;if(n.length!==0)for(let i of n){await i.onceSettled();let o=i.value?.[0]?.planType;if(!o)return;let a=this.stockOfferOsis[o];if(!a)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==a);r.checked&&s.push(a),i.dataset.wcsOsi=s.join(",")}}handleQuantitySelection(r){let n=this.checkoutLinks;for(let i of n)i.dataset.quantity=r.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(r){let n={...this.filters};Object.keys(n).forEach(i=>{if(r){n[i].order=Math.min(n[i].order||2,2);return}let o=n[i].order;o===1||isNaN(o)||(n[i].order=Number(o)+1)}),this.filters=n}includes(r){return this.textContent.match(new RegExp(r,"i"))!==null}connectedCallback(){super.connectedCallback(),this.setAttribute("tabindex",this.getAttribute("tabindex")??"0"),this.addEventListener(Ii,this.handleQuantitySelection),this.addEventListener(Ra,this.merchCardReady,{once:!0}),this.updateComplete.then(()=>{this.merchCardReady()}),this.storageOptions?.addEventListener("change",this.handleStorageChange),this.addEventListener(Ht,this.handleLoadEvent)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout.disconnectedCallbackHook(),this.removeEventListener(Ii,this.handleQuantitySelection),this.storageOptions?.removeEventListener(Ci,this.handleStorageChange),this.removeEventListener(Ht,this.handleLoadEvent)}handleLoadEvent(r){if(r.target.nodeName==="AEM-FRAGMENT"){let n=r.detail;if(!n)return;Ja(n,this),this.dispatchEvent(new CustomEvent(Ma,{bubbles:!0,composed:!0}))}}get aemFragment(){return this.querySelector("aem-fragment")}get storageOptions(){return this.querySelector("sp-radio-group#storage")}get storageSpecificOfferSelect(){let r=this.storageOptions?.selected;if(r){let n=this.querySelector(`merch-offer-select[storage="${r}"]`);if(n)return n}return this.querySelector("merch-offer-select")}get offerSelect(){return this.storageOptions?this.storageSpecificOfferSelect:this.querySelector("merch-offer-select")}get quantitySelect(){return this.querySelector("merch-quantity-select")}merchCardReady(){this.offerSelect&&!this.offerSelect.planType||this.dispatchEvent(new CustomEvent($a,{bubbles:!0}))}handleStorageChange(){let r=this.closest("merch-card")?.offerSelect.cloneNode(!0);r&&this.dispatchEvent(new CustomEvent(Ci,{detail:{offerSelect:r},bubbles:!0}))}get dynamicPrice(){return this.querySelector('[slot="price"]')}selectMerchOffer(r){if(r===this.merchOffer)return;this.merchOffer=r;let n=this.dynamicPrice;if(r.price&&n){let i=r.price.cloneNode(!0);n.onceSettled?n.onceSettled().then(()=>{n.replaceWith(i)}):n.replaceWith(i)}}};x(zt,"properties",{name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color"},borderColor:{type:String,attribute:"border-color"},badgeBackgroundColor:{type:String,attribute:"badge-background-color"},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:r=>{let[n,i,o]=r.split(",");return{PUF:n,ABM:i,M2M:o}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:r=>Object.fromEntries(r.split(",").map(n=>{let[i,o,a]=n.split(":"),s=Number(o);return[i,{order:isNaN(s)?void 0:s,size:a}]})),toAttribute:r=>Object.entries(r).map(([n,{order:i,size:o}])=>[n,i,o].filter(a=>a!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object}}),x(zt,"styles",[ka,qa(),...Oa()]);customElements.define(_l,zt);var ft=class extends oe{constructor(){super(),this.size="m",this.alt=""}render(){let{href:t}=this;return t?g`<a href="${t}">
    ...
    `);customElements.define("merch-icon",ft);async function Ll(e){let t=e.headers.get("Etag"),r=await e.json();return r.etag=t,r}async function Qa(e,t,r){let n=await fetch(`${e}/adobe/sites/cf/fragments/${t}`,{headers:r});if(!n.ok)throw new Error(`Failed to get fragment: ${n.status} ${n.statusText}`);return await Ll(n)}var ts=new CSSStyleSheet;ts.replaceSync(":host { display: contents; }");var wl=document.querySelector('meta[name="aem-base-url"]')?.content??"https://publish-p22655-e155390.adobeaemcloud.com",es="fragment",Pl="ims",ki,be,Vi=class{constructor(){ze(this,be,new Map)}clear(){X(this,be).clear()}add(...t){t.forEach(r=>{let{id:n}=r;n&&X(this,be).set(n,r)})}has(t){return X(this,be).has(t)}get(t){return X(this,be).get(t)}remove(t){X(this,be).delete(t)}};be=new WeakMap;var Oi=new Vi,Ri=class extends HTMLElement{constructor(){super();x(this,"cache",Oi);x(this,"data");x(this,"fragmentId");x(this,"consonant",!1);x(this,"ims",!1);x(this,"_readyPromise");this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[ts];let r=this.getAttribute(Pl);["",!0].includes(r)?(this.ims=!0,ki||(ki={Authorization:`Bearer ${window.adobeid?.authorize?.()}`,pragma:"no-cache","cache-control":"no-cache"})):this.ims=!1}static get observedAttributes(){return[es]}attributeChangedCallback(r,n,i){r===es&&(this.fragmentId=i,this.refresh(!1))}async refresh(r=!0){this.fragmentId&&(this._readyPromise&&!await Promise.race([this._readyPromise,Promise.resolve(!1)])||(r&&this.cache.remove(this.fragmentId),this._readyPromise=this.fetchData().then(()=>(this.dispatchEvent(new CustomEvent(Ht,{detail:this.data,bubbles:!0,composed:!0})),!0))))}async fetchData(){let r=Oi.get(this.fragmentId);r||(r=await Qa(wl,this.fragmentId,this.ims?ki:void 0),Oi.add(r)),this.data=r}get updateComplete(){return this._readyPromise??Promise.reject(new Error("AEM fragment cannot be loaded"))}};customElements.define("aem-fragment",Ri);
