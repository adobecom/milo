      ...
      `];var ot,Bt=class Bt{constructor(t){p(this,"card");z(this,ot);this.card=t,this.insertVariantStyle()}getContainer(){return K(this,ot,_(this,ot)??this.card.closest('[class*="-merch-cards"]')??this.card.parentElement),_(this,ot)}insertVariantStyle(){if(!Bt.styleMap[this.card.variant]){Bt.styleMap[this.card.variant]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(t,r){if(!t)return;let n=`--consonant-merch-card-${this.card.variant}-${r}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),o=parseInt(this.getContainer().style.getPropertyValue(n))||0;i>o&&this.getContainer().style.setProperty(n,`${i}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),b`
        ...
        `}get cardImage(){return b` <div class="image">
            ...
            ${this.badge}
              ...
              >`:"";return b`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){}};ot=new WeakMap,p(Bt,"styleMap",{});var C=Bt;function Wo(e,t){let r;return function(){let n=this,i=arguments;clearTimeout(r),r=setTimeout(()=>e.apply(n,i),t)}}function Ne(e,t={},r=null,n=null){let i=n?document.createElement(e,{is:n}):document.createElement(e);r instanceof HTMLElement?i.appendChild(r):i.innerHTML=r;for(let[o,a]of Object.entries(t))i.setAttribute(o,a);return i}function yr(){return window.matchMedia("(max-width: 767px)").matches}function Xo(){return window.matchMedia("(max-width: 1024px)").matches}var Wn={};ec(Wn,{CLASS_NAME_FAILED:()=>Vn,CLASS_NAME_HIDDEN:()=>pc,CLASS_NAME_PENDING:()=>$n,CLASS_NAME_RESOLVED:()=>Hn,ERROR_MESSAGE_BAD_REQUEST:()=>Sr,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>Sc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Un,EVENT_AEM_ERROR:()=>Oe,EVENT_AEM_LOAD:()=>Re,EVENT_MAS_ERROR:()=>Mn,EVENT_MAS_READY:()=>On,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Rn,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>yc,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Ac,EVENT_MERCH_CARD_READY:()=>Nn,EVENT_MERCH_OFFER_READY:()=>gc,EVENT_MERCH_OFFER_SELECT_READY:()=>In,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>st,EVENT_MERCH_SEARCH_CHANGE:()=>vc,EVENT_MERCH_SIDENAV_SELECT:()=>Ec,EVENT_MERCH_STOCK_CHANGE:()=>xc,EVENT_MERCH_STORAGE_CHANGE:()=>Er,EVENT_OFFER_SELECTED:()=>bc,EVENT_TYPE_FAILED:()=>Dn,EVENT_TYPE_READY:()=>at,EVENT_TYPE_RESOLVED:()=>Bn,LOG_NAMESPACE:()=>Gn,Landscape:()=>ae,MODAL_TYPE_3_IN_1:()=>Ve,NAMESPACE:()=>mc,PARAM_AOS_API_KEY:()=>Tc,PARAM_ENV:()=>zn,PARAM_LANDSCAPE:()=>Fn,PARAM_WCS_API_KEY:()=>wc,PROVIDER_ENVIRONMENT:()=>jn,STATE_FAILED:()=>ie,STATE_PENDING:()=>xe,STATE_RESOLVED:()=>oe,TAG_NAME_SERVICE:()=>fc,WCS_PROD_URL:()=>Kn,WCS_STAGE_URL:()=>Yn,WORKFLOW_STEP:()=>Me});var mc="merch",pc="hidden",at="wcms:commerce:ready",fc="mas-commerce-service",gc="merch-offer:ready",In="merch-offer-select:ready",Nn="merch-card:ready",Rn="merch-card:action-menu-toggle",bc="merch-offer:selected",xc="merch-stock:change",Er="merch-storage:change",st="merch-quantity-selector:change",vc="merch-search:change",Ac="merch-card-collection:sort",yc="merch-card-collection:showmore",Ec="merch-sidenav:select",Re="aem:load",Oe="aem:error",On="mas:ready",Mn="mas:error",Vn="placeholder-failed",$n="placeholder-pending",Hn="placeholder-resolved",Sr="Bad WCS request",Un="Commerce offer not found",Sc="Literals URL not provided",Dn="mas:failed",Bn="mas:resolved",Gn="mas/commerce",zn="commerce.env",Fn="commerce.landscape",Tc="commerce.aosKey",wc="commerce.wcsKey",Kn="https://www.adobe.com/web_commerce_artifact",Yn="https://www.stage.adobe.com/web_commerce_artifact_stage",ie="failed",xe="pending",oe="resolved",ae={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},Me={CHECKOUT:"checkout",CHECKOUT_EMAIL:"checkout/email",SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"},jn={PRODUCTION:"PRODUCTION"},Ve={TWP:"twp",D2P:"d2p",CRM:"crm"};var qo=`
:root {
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return qo}setAriaExpanded(r,n){r.setAttribute("aria-expanded",n)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};p(ct,"variantStyle",P`
...
`;var Tr=class extends C{constructor(t){super(t)}getGlobalCSS(){return Zo}renderLayout(){return b`${this.cardImage}
    <div class="body">
...
`;var wr=class extends C{constructor(t){super(t)}getGlobalCSS(){return Qo}renderLayout(){return b` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var Lc=32,lt=class extends C{constructor(r){super(r);p(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);p(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?b`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){yr()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};p(lt,"variantStyle",P`
...
`;var $e=class extends C{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return ta}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return b` ${this.badge}
      ...
      ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}postCardUpdateHook(){this.card.isConnected&&(yr()||this.adjustProductBodySlots(),this.adjustTitleWidth())}};p($e,"variantStyle",P`
...
`;var dt=class extends C{constructor(t){super(t)}getGlobalCSS(){return ra}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return b` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var Zn={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ut=class extends C{constructor(t){super(t)}getGlobalCSS(){return na}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return Zn}renderLayout(){return b`${this.cardImage}
            <div class="body">
...
`;var mt=class extends C{constructor(t){super(t)}getGlobalCSS(){return ia}renderLayout(){return b`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
...
`;var Jn={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},ft=class extends C{getGlobalCSS(){return aa}get aemFragmentMapping(){return Jn}renderLayout(){return b` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;var ei={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color"},allowedColors:{gray:"--spectrum-gray-100"},size:["single","double","triple"]},He=class extends C{getGlobalCSS(){return sa}get aemFragmentMapping(){return ei}renderLayout(){return b`
  ...
  `);customElements.define("ah-try-buy-widget",He);var ti=(e,t=!1)=>{switch(e.variant){case"catalog":return new ct(e);case"image":return new Tr(e);case"inline-heading":return new wr(e);case"mini-compare-chart":return new lt(e);case"plans":return new ht(e);case"product":return new $e(e);case"segment":return new dt(e);case"special-offers":return new ut(e);case"twp":return new mt(e);case"ccd-suggested":return new pt(e);case"ccd-slice":return new ft(e);case"ah-try-buy-widget":return new He(e);default:return t?void 0:new $e(e)}},ca={catalog:Xn,image:null,"inline-heading":null,"mini-compare-chart":null,plans:qn,product:null,segment:null,"special-offers":Zn,twp:null,"ccd-suggested":Qn,"ccd-slice":Jn,"ah-try-buy-widget":ei},la=()=>{let e=[];return e.push(ct.variantStyle),e.push(lt.variantStyle),e.push($e.variantStyle),e.push(ht.variantStyle),e.push(dt.variantStyle),e.push(ut.variantStyle),e.push(mt.variantStyle),e.push(pt.variantStyle),e.push(ft.variantStyle),e.push(He.variantStyle),e};var ha=document.createElement("style");ha.innerHTML=`
:root {
...
`,Be.MISSING_INTL_API,a);var I=r.getPluralRules(t,{type:h.pluralType}).select(u-(h.offset||0));E=h.options[I]||h.options.other}if(!E)throw new Ii(h.value,u,Object.keys(h.options),a);s.push.apply(s,qt(E.value,t,r,n,i,u-(h.offset||0)));continue}}return pl(s)}function gl(e,t){return t?A(A(A({},e||{}),t||{}),Object.keys(e).reduce(function(r,n){return r[n]=A(A({},e[n]),t[n]||{}),r},{})):e}function bl(e,t){return t?Object.keys(e).reduce(function(r,n){return r[n]=gl(e[n],t[n]),r},A({},e)):e}function Ni(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function xl(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Wt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.NumberFormat).bind.apply(t,Ir([void 0],r,!1)))},{cache:Ni(e.number),strategy:Ur.variadic}),getDateTimeFormat:Wt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.DateTimeFormat).bind.apply(t,Ir([void 0],r,!1)))},{cache:Ni(e.dateTime),strategy:Ur.variadic}),getPluralRules:Wt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.PluralRules).bind.apply(t,Ir([void 0],r,!1)))},{cache:Ni(e.pluralRules),strategy:Ur.variadic})}}var qa=function(){function e(t,r,n,i){var o=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(a){var s=o.formatToParts(a);if(s.length===1)return s[0].value;var c=s.reduce(function(l,h){return!l.length||h.type!==F.literal||typeof l[l.length-1]!="string"?l.push(h.value):l[l.length-1]+=h.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(a){return qt(o.ast,o.locales,o.formatters,o.formats,a,void 0,o.message)},this.resolvedOptions=function(){return{locale:o.resolvedLocale.toString()}},this.getAst=function(){return o.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=bl(e.formats,n),this.formatters=i&&i.formatters||xl(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=Ka,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var Za=qa;var vl=/[0-9\-+#]/,Al=/[^\d\-+#]/g;function Qa(e){return e.search(vl)}function yl(e="#.##"){let t={},r=e.length,n=Qa(e);t.prefix=n>0?e.substring(0,n):"";let i=Qa(e.split("").reverse().join("")),o=r-i,a=e.substring(o,o+1),s=o+(a==="."||a===","?1:0);t.suffix=i>0?e.substring(s,r):"",t.mask=e.substring(n,s),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let c=t.mask.match(Al);return t.decimal=c&&c[c.length-1]||".",t.separator=c&&c[1]&&c[0]||",",c=t.mask.split(t.decimal),t.integer=c[0],t.fraction=c[1],t}function El(e,t,r){let n=!1,i={value:e};e<0&&(n=!0,i.value=-i.value),i.sign=n?"-":"",i.value=Number(i.value).toFixed(t.fraction&&t.fraction.length),i.value=Number(i.value).toString();let o=t.fraction&&t.fraction.lastIndexOf("0"),[a="0",s=""]=i.value.split(".");return(!s||s&&s.length<=o)&&(s=o<0?"":(+("0."+s)).toFixed(o+1).replace("0.","")),i.integer=a,i.fraction=s,Sl(i,t),(i.result==="0"||i.result==="")&&(n=!1,i.sign=""),!n&&t.maskHasPositiveSign?i.sign="+":n&&t.maskHasPositiveSign?i.sign="-":n&&(i.sign=r&&r.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),i}function Sl(e,t){e.result="";let r=t.integer.split(t.separator),n=r.join(""),i=n&&n.indexOf("0");if(i>-1)for(;e.integer.length<n.length-i;)e.integer="0"+e.integer;else Number(e.integer)===0&&(e.integer="");let o=r[1]&&r[r.length-1].length;if(o){let a=e.integer.length,s=a%o;for(let c=0;c<a;c++)e.result+=e.integer.charAt(c),!((c-s+1)%o)&&c<a-o&&(e.result+=t.separator)}else e.result=e.integer;return e.result+=t.fraction&&e.fraction?t.decimal+e.fraction:"",e}function Tl(e,t,r={}){if(!e||isNaN(Number(t)))return t;let n=yl(e),i=El(t,n,r);return n.prefix+i.sign+i.result+n.suffix}var Ja=Tl;var es=".",wl=",",rs=/^\s+/,ns=/\s+$/,ts="&nbsp;",Ri=e=>e*12,is=(e,t)=>{let{start:r,end:n,displaySummary:{amount:i,duration:o,minProductQuantity:a,outcomeType:s}={}}=e;if(!(i&&o&&s&&a))return!1;let c=t?new Date(t):new Date;if(!r||!n)return!1;let l=new Date(r),h=new Date(n);return c>=l&&c<=h},Ge={MONTH:"MONTH",YEAR:"YEAR"},Ll={[N.ANNUAL]:12,[N.MONTHLY]:1,[N.THREE_YEARS]:36,[N.TWO_YEARS]:24},Oi=(e,t)=>({accept:e,round:t}),_l=[Oi(({divisor:e,price:t})=>t%e==0,({divisor:e,price:t})=>t/e),Oi(({usePrecision:e})=>e,({divisor:e,price:t})=>Math.round(t/e*100)/100),Oi(()=>!0,({divisor:e,price:t})=>Math.ceil(Math.floor(t*100/e)/100))],Mi={[H.YEAR]:{[N.MONTHLY]:Ge.MONTH,[N.ANNUAL]:Ge.YEAR},[H.MONTH]:{[N.MONTHLY]:Ge.MONTH}},Pl=(e,t)=>e.indexOf(`'${t}'`)===0,Cl=(e,t=!0)=>{let r=e.replace(/'.*?'/,"").trim(),n=as(r);return!!n?t||(r=r.replace(/[,\.]0+/,n)):r=r.replace(/\s?(#.*0)(?!\s)?/,"$&"+Il(e)),r},kl=e=>{let t=Nl(e),r=Pl(e,t),n=e.replace(/'.*?'/,""),i=rs.test(n)||ns.test(n);return{currencySymbol:t,isCurrencyFirst:r,hasCurrencySpace:i}},os=e=>e.replace(rs,ts).replace(ns,ts),Il=e=>e.match(/#(.?)#/)?.[1]===es?wl:es,Nl=e=>e.match(/'(.*?)'/)?.[1]??"",as=e=>e.match(/0(.?)0/)?.[1]??"";function Et({formatString:e,price:t,usePrecision:r,isIndianPrice:n=!1},i,o=a=>a){let{currencySymbol:a,isCurrencyFirst:s,hasCurrencySpace:c}=kl(e),l=r?as(e):"",h=Cl(e,r),d=r?2:0,u=o(t,{currencySymbol:a}),m=n?u.toLocaleString("hi-IN",{minimumFractionDigits:d,maximumFractionDigits:d}):Ja(h,u),g=r?m.lastIndexOf(l):m.length,f=m.substring(0,g),T=m.substring(g+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,m).replace(/SYMBOL/,a),currencySymbol:a,decimals:T,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:i}}var ss=e=>{let{commitment:t,term:r,usePrecision:n}=e,i=Ll[r]??1;return Et(e,i>1?Ge.MONTH:Mi[t]?.[r],o=>{let a={divisor:i,price:o,usePrecision:n},{round:s}=_l.find(({accept:c})=>c(a));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(a)}`);return s(a)})},cs=({commitment:e,term:t,...r})=>Et(r,Mi[e]?.[t]),ls=e=>{let{commitment:t,instant:r,price:n,originalPrice:i,priceWithoutDiscount:o,promotion:a,quantity:s=1,term:c}=e;if(t===H.YEAR&&c===N.MONTHLY){if(!a)return Et(e,Ge.YEAR,Ri);let{displaySummary:{outcomeType:l,duration:h,minProductQuantity:d=1}={}}=a;switch(l){case"PERCENTAGE_DISCOUNT":if(s>=d&&is(a,r)){let u=parseInt(h.replace("P","").replace("M",""));if(isNaN(u))return Ri(n);let m=s*i*u,g=s*o*(12-u),f=Math.floor((m+g)*100)/100;return Et({...e,price:f},Ge.YEAR)}default:return Et(e,Ge.YEAR,()=>Ri(o??n))}}return Et(e,Mi[t]?.[c])};var Rl={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at"},Ol=ya("ConsonantTemplates/price"),Ml=/<\/?[^>]+(>|$)/g,B={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},St={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Vl="TAX_EXCLUSIVE",$l=e=>Aa(e)?Object.entries(e).filter(([,t])=>bt(t)||Pr(t)||t===!0).reduce((t,[r,n])=>t+` ${r}${n===!0?"":'="'+xa(n)+'"'}`,""):"",Y=(e,t,r,n=!1)=>`<span class="${e}${t?"":" "+B.disabled}"${$l(r)}>${n?os(t):t??""}</span>`;function Hl(e,{accessibleLabel:t,altAccessibleLabel:r,currencySymbol:n,decimals:i,decimalsDelimiter:o,hasCurrencySpace:a,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:h,taxInclusivityLabel:d},u={}){let m=Y(B.currencySymbol,n),g=Y(B.currencySpace,a?"&nbsp;":""),f="";return t?f=`<sr-only class="strikethrough-aria-label">${t}</sr-only>`:r&&(f=`<sr-only class="alt-aria-label">${r}</sr-only>`),c&&(f+=m+g),f+=Y(B.integer,s),f+=Y(B.decimalsDelimiter,o),f+=Y(B.decimals,i),c||(f+=g+m),f+=Y(B.recurrence,l,null,!0),f+=Y(B.unitType,h,null,!0),f+=Y(B.taxInclusivity,d,!0),Y(e,f,{...u})}var j=({isAlternativePrice:e=!1,displayOptical:t=!1,displayStrikethrough:r=!1,displayAnnual:n=!1,instant:i=void 0}={})=>({country:o,displayFormatted:a=!0,displayRecurrence:s=!0,displayPerUnit:c=!1,displayTax:l=!1,language:h,literals:d={},quantity:u=1}={},{commitment:m,offerSelectorIds:g,formatString:f,price:T,priceWithoutDiscount:L,taxDisplay:x,taxTerm:E,term:I,usePrecision:O,promotion:G}={},V={})=>{Object.entries({country:o,formatString:f,language:h,price:T}).forEach(([Zr,Qr])=>{if(Qr==null)throw new Error(`Argument "${Zr}" is missing for osi ${g?.toString()}, country ${o}, language ${h}`)});let de={...Rl,...d},Xe=`${h.toLowerCase()}-${o.toUpperCase()}`;function re(Zr,Qr){let Jr=de[Zr];if(Jr==null)return"";try{return new Za(Jr.replace(Ml,""),Xe).format(Qr)}catch{return Ol.error("Failed to format literal:",Jr),""}}let Pt=r&&L?L:T,qe=t?ss:cs;n&&(qe=ls);let{accessiblePrice:Ct,recurrenceTerm:Ee,...Se}=qe({commitment:m,formatString:f,instant:i,isIndianPrice:o==="IN",originalPrice:T,priceWithoutDiscount:L,price:t?T:Pt,promotion:G,quantity:u,term:I,usePrecision:O}),ue="",kt="",Wr="";S(s)&&Ee&&(Wr=re(St.recurrenceLabel,{recurrenceTerm:Ee}));let Xr="";S(c)&&(Xr=re(St.perUnitLabel,{perUnit:"LICENSE"}));let qr="";S(l)&&E&&(qr=re(x===Vl?St.taxExclusiveLabel:St.taxInclusiveLabel,{taxTerm:E})),r&&(ue=re(St.strikethroughAriaLabel,{strikethroughPrice:ue})),e&&(kt=re(St.alternativePriceAriaLabel,{alternativePrice:kt}));let Ze=B.container;if(t&&(Ze+=" "+B.containerOptical),r&&(Ze+=" "+B.containerStrikethrough),e&&(Ze+=" "+B.containerAlternative),n&&(Ze+=" "+B.containerAnnual),S(a))return Hl(Ze,{...Se,accessibleLabel:ue,altAccessibleLabel:kt,recurrenceLabel:Wr,perUnitLabel:Xr,taxInclusivityLabel:qr},V);let{currencySymbol:ao,decimals:Gs,decimalsDelimiter:zs,hasCurrencySpace:so,integer:Fs,isCurrencyFirst:Ks}=Se,Qe=[Fs,zs,Gs];Ks?(Qe.unshift(so?"\xA0":""),Qe.unshift(ao)):(Qe.push(so?"\xA0":""),Qe.push(ao)),Qe.push(Wr,Xr,qr);let Ys=Qe.join("");return Y(Ze,Ys,V)},hs=()=>(e,t,r)=>{let i=(e.displayOldPrice===void 0||S(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${j({isAlternativePrice:i})(e,t,r)}${i?"&nbsp;"+j({displayStrikethrough:!0})(e,t,r):""}`},ds=()=>(e,t,r)=>{let{instant:n}=e;try{n||(n=new URLSearchParams(document.location.search).get("instant")),n&&(n=new Date(n))}catch{n=void 0}let i={...e,displayTax:!1,displayPerUnit:!1},a=(e.displayOldPrice===void 0||S(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${a?j({displayStrikethrough:!0})(i,t,r)+"&nbsp;":""}${j({isAlternativePrice:a})(e,t,r)}${Y(B.containerAnnualPrefix,"&nbsp;(")}${j({displayAnnual:!0,instant:n})(i,t,r)}${Y(B.containerAnnualSuffix,")")}`},us=()=>(e,t,r)=>{let n={...e,displayTax:!1,displayPerUnit:!1};return`${j()(e,t,r)}${Y(B.containerAnnualPrefix,"&nbsp;(")}${j({displayAnnual:!0})(n,t,r)}${Y(B.containerAnnualSuffix,")")}`};var Vi=j(),$i=hs(),Ul=j({displayOptical:!0}),Hi=j({displayStrikethrough:!0}),Ui=j({displayAnnual:!0}),Di=j({displayOptical:!0,isAlternativePrice:!0}),Bi=j({isAlternativePrice:!0}),Gi=us(),zi=ds();var Dl=(e,t)=>{if(!(!vt(e)||!vt(t)))return Math.floor((t-e)/t*100)},ms=()=>(e,t)=>{let{price:r,priceWithoutDiscount:n}=t,i=Dl(r,n);return i===void 0?'<span class="no-discount"></span>':`<span class="discount">${i}%</span>`};var Fi=ms();var{freeze:Zt}=Object,Bl={V2:"UCv2",V3:"UCv3"},Q=Zt({...Bl}),Gl={CHECKOUT:"checkout",CHECKOUT_EMAIL:"checkout/email",SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"},J=Zt({...Gl}),ze={STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"},Ki=Zt({...H}),Yi=Zt({...Sa}),ji=Zt({...N});var ps="mas-commerce-service";function fs(e,{once:t=!1}={}){let r=null;function n(){let i=document.querySelector(ps);i!==r&&(r=i,i&&e(i))}return document.addEventListener(at,n,{once:t}),Fe(n),()=>document.removeEventListener(at,n)}function Qt(e,{country:t,forceTaxExclusive:r,perpetual:n}){let i;if(e.length<2)i=e;else{let o=t==="GB"||n?"EN":"MULT",[a,s]=e;i=[a.language===o?a:s]}return r&&(i=i.map(xi)),i}var Fe=e=>window.setTimeout(e);function Tt(e,t=1){if(e==null)return[t];let r=(Array.isArray(e)?e:String(e).split(",")).map(yt).filter(vt);return r.length||(r=[t]),r}function Dr(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(di)}function W(){return document.getElementsByTagName(ps)?.[0]}function zl(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var Jt,Ke=class Ke extends HTMLAnchorElement{constructor(){super();z(this,Jt,!1);this.setAttribute("is",Ke.is)}get isUptLink(){return!0}initializeWcsData(r,n){this.setAttribute("data-wcs-osi",r),n&&this.setAttribute("data-promotion-code",n),K(this,Jt,!0),this.composePromoTermsUrl()}attributeChangedCallback(r,n,i){_(this,Jt)&&this.composePromoTermsUrl()}composePromoTermsUrl(){let r=this.getAttribute("data-wcs-osi");if(!r){let d=this.closest("merch-card").querySelector("aem-fragment").getAttribute("fragment");console.error(`Missing 'data-wcs-osi' attribute on upt-link. Fragment: ${d}`);return}let n=W(),i=[r],o=this.getAttribute("data-promotion-code"),{country:a,language:s,env:c}=n.settings,l={country:a,language:s,wcsOsi:i,promotionCode:o},h=n.resolveOfferSelectors(l);Promise.all(h).then(([[d]])=>{let u=`locale=${s}_${a}&country=${a}&offer_id=${d.offerId}`;o&&(u+=`&promotion_code=${encodeURIComponent(o)}`),this.href=`${zl(c)}?${u}`}).catch(d=>{console.error(`Could not resolve offer selectors for id: ${r}.`,d.message)})}static createFrom(r){let n=new Ke;for(let i of r.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?n.setAttribute("class",i.value.replace("upt-link","").trim()):n.setAttribute(i.name,i.value));return n.innerHTML=r.innerHTML,n.setAttribute("tabindex",0),n}};Jt=new WeakMap,p(Ke,"is","upt-link"),p(Ke,"tag","a"),p(Ke,"observedAttributes",["data-wcs-osi","data-promotion-code"]);var he=Ke;window.customElements.get(he.is)||window.customElements.define(he.is,he,{extends:he.tag});var Fl="#000000",gs="#F8D904",Kl="#EAEAEA",Yl=/(accent|primary|secondary)(-(outline|link))?/,jl="mas:product_code/",Wl="daa-ll",er="daa-lh",Xl=["XL","L","M","S"],Wi="...";function Ye(e,t,r,n){let i=n[e];if(t[e]&&i){let o={slot:i?.slot},a=t[e];if(i.maxCount&&typeof a=="string"){let[c,l]=sh(a,i.maxCount,i.withSuffix);c!==a&&(o.title=l,a=c)}let s=Ne(i.tag,o,a);r.append(s)}}function ql(e,t,r){e.mnemonicIcon?.map((i,o)=>({icon:i,alt:e.mnemonicAlt[o]??"",link:e.mnemonicLink[o]??""}))?.forEach(({icon:i,alt:o,link:a})=>{if(a&&!/^https?:/.test(a))try{a=new URL(`https://${a}`).href.toString()}catch{a="#"}let s={slot:"icons",src:i,loading:t.loading,size:r?.size??"l"};o&&(s.alt=o),a&&(s.href=a);let c=Ne("merch-icon",s);t.append(c)})}function Zl(e,t){e.badge?(t.setAttribute("badge-text",e.badge),t.setAttribute("badge-color",e.badgeColor||Fl),t.setAttribute("badge-background-color",e.badgeBackgroundColor||gs),t.setAttribute("border-color",e.badgeBackgroundColor||gs)):t.setAttribute("border-color",e.borderColor||Kl)}function Ql(e,t,r){r?.includes(e.size)&&t.setAttribute("size",e.size)}function Jl(e,t,r){Ye("cardTitle",e,t,{cardTitle:r})}function eh(e,t,r){Ye("subtitle",e,t,r)}function th(e,t,r){if(!e.backgroundColor||e.backgroundColor.toLowerCase()==="default"){t.style.removeProperty("--merch-card-custom-background-color"),t.removeAttribute("background-color");return}r?.[e.backgroundColor]&&(t.style.setProperty("--merch-card-custom-background-color",`var(${r[e.backgroundColor]})`),t.setAttribute("background-color",e.backgroundColor))}function rh(e,t,r){e.borderColor&&r&&e.borderColor!=="transparent"&&t.style.setProperty("--merch-card-custom-border-color",`var(--${e.borderColor})`)}function nh(e,t,r){if(e.backgroundImage){let n={loading:t.loading??"lazy",src:e.backgroundImage};if(e.backgroundImageAltText?n.alt=e.backgroundImageAltText:n.role="none",!r)return;if(r?.attribute){t.setAttribute(r.attribute,e.backgroundImage);return}t.append(Ne(r.tag,{slot:r.slot},Ne("img",n)))}}function ih(e,t,r){Ye("prices",e,t,r)}function oh(e,t,r){Ye("promoText",e,t,r),Ye("description",e,t,r),Ye("callout",e,t,r),Ye("quantitySelect",e,t,r)}function ah(e,t,r,n){e.showStockCheckbox&&r.stockOffer&&(t.setAttribute("checkbox-label",n.stockCheckboxLabel),t.setAttribute("stock-offer-osis",n.stockOfferOsis)),n.secureLabel&&r.secureLabel&&t.setAttribute("secure-label",n.secureLabel)}function sh(e,t,r=!0){try{let n=typeof e!="string"?"":e,i=bs(n);if(i.length<=t)return[n,i];let o=0,a=!1,s=r?t-Wi.length<1?1:t-Wi.length:t,c=[];for(let d of n){if(o++,d==="<")if(a=!0,n[o]==="/")c.pop();else{let u="";for(let m of n.substring(o)){if(m===" "||m===">")break;u+=m}c.push(u)}if(d==="/"&&n[o]===">"&&c.pop(),d===">"){a=!1;continue}if(!a&&(s--,s===0))break}let l=n.substring(0,o).trim();if(c.length>0){c[0]==="p"&&c.shift();for(let d of c.reverse())l+=`</${d}>`}return[`${l}${r?Wi:""}`,i]}catch{let i=typeof e=="string"?e:"",o=bs(i);return[i,o]}}function bs(e){if(!e)return"";let t="",r=!1;for(let n of e){if(n==="<"&&(r=!0),n===">"){r=!1;continue}r||(t+=n)}return t}function ch(e,t){t.querySelectorAll("a.upt-link").forEach(n=>{let i=he.createFrom(n);n.replaceWith(i),i.initializeWcsData(e.osi,e.promoCode)})}function lh(e,t,r,n){let o=customElements.get("checkout-button").createCheckoutButton({},e.innerHTML);o.setAttribute("tabindex",0);for(let h of e.attributes)["class","is"].includes(h.name)||o.setAttribute(h.name,h.value);o.firstElementChild?.classList.add("spectrum-Button-label");let a=t.ctas.size??"M",s=`spectrum-Button--${n}`,c=Xl.includes(a)?`spectrum-Button--size${a}`:"spectrum-Button--sizeM",l=["spectrum-Button",s,c];return r&&l.push("spectrum-Button--outline"),o.classList.add(...l),o}function hh(e,t,r,n){let o=customElements.get("checkout-button").createCheckoutButton(e.dataset);e.dataset.analyticsId&&o.setAttribute("data-analytics-id",e.dataset.analyticsId),o.connectedCallback(),o.render();let a="fill";r&&(a="outline");let s=Ne("sp-button",{treatment:a,variant:n,tabIndex:0,size:t.ctas.size??"m",...e.dataset.analyticsId&&{"data-analytics-id":e.dataset.analyticsId}},e.innerHTML);return s.source=o,o.onceSettled().then(c=>{s.setAttribute("data-navigation-url",c.href)}),s.addEventListener("click",c=>{c.defaultPrevented||o.click()}),s}function dh(e,t){return e.classList.add("con-button"),t&&e.classList.add("blue"),e}function uh(e,t,r,n){if(e.ctas){let{slot:i}=r.ctas,o=Ne("div",{slot:i},e.ctas),a=[...o.querySelectorAll("a")].map(s=>{let c=Yl.exec(s.className)?.[0]??"accent",l=c.includes("accent"),h=c.includes("primary"),d=c.includes("secondary"),u=c.includes("-outline"),m=c.includes("-link");if(t.consonant)return dh(s,l);if(m)return s;let g;return l?g="accent":h?g="primary":d&&(g="secondary"),t.spectrum==="swc"?hh(s,r,u,g):lh(s,r,u,g)});o.innerHTML="",o.append(...a),t.append(o)}}function mh(e,t){let{tags:r}=e,n=r?.find(o=>o.startsWith(jl))?.split("/").pop();if(!n)return;t.setAttribute(er,n),[...t.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((o,a)=>{o.setAttribute(Wl,`${o.dataset.analyticsId}-${a+1}`)})}function ph(e){e.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,r])=>{e.querySelectorAll(`a.${t}`).forEach(n=>{n.classList.remove(t),n.classList.add("spectrum-Link",`spectrum-Link--${r}`)})})}function fh(e){e.querySelectorAll("[slot]").forEach(n=>{n.remove()}),["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","badge-background-color","badge-color","badge-text","size",er].forEach(n=>e.removeAttribute(n));let r=["wide-strip","thin-strip"];e.classList.remove(...r)}async function xs(e,t){let{fields:r}=e,{variant:n}=r;if(!n)return;let i={stockCheckboxLabel:"Add a 30-day free trial of Adobe Stock.*",stockOfferOsis:"",secureLabel:"Secure transaction"};fh(t),t.id=e.id,t.removeAttribute("background-image"),t.removeAttribute("background-color"),t.removeAttribute("badge-background-color"),t.removeAttribute("badge-color"),t.removeAttribute("badge-text"),t.removeAttribute("size"),t.classList.remove("wide-strip"),t.classList.remove("thin-strip"),t.removeAttribute(er),t.variant=n,await t.updateComplete;let{aemFragmentMapping:o}=t.variantLayout;o&&(o.style==="consonant"&&t.setAttribute("consonant",!0),ql(r,t,o.mnemonics),Zl(r,t),Ql(r,t,o.size),Jl(r,t,o.title),eh(r,t,o),ih(r,t,o),nh(r,t,o.backgroundImage),th(r,t,o.allowedColors),rh(r,t,o.borderColor),oh(r,t,o),ah(r,t,o,i),ch(r,t),uh(r,t,o,n),mh(r,t),ph(t))}var gh="merch-card",bh=":start",xh=":ready",vh=1e4,vs="merch-card:",rr,Xi,tr=class extends q{constructor(){super();z(this,rr);p(this,"customerSegment");p(this,"marketSegment");p(this,"variantLayout");this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this)}static getFragmentMapping(r){return ca[r]}firstUpdated(){this.variantLayout=ti(this,!1),this.variantLayout?.connectedCallbackHook(),this.aemFragment?.updateComplete.catch(()=>{this.style.display="none"})}willUpdate(r){(r.has("variant")||!this.variantLayout)&&(this.variantLayout=ti(this),this.variantLayout.connectedCallbackHook())}updated(r){(r.has("badgeBackgroundColor")||r.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border",this.computedBorderStyle),this.variantLayout?.postCardUpdateHook(r)}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}get prices(){return Array.from(this.querySelectorAll('span[is="inline-price"][data-wcs-osi]'))}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["twp","ccd-slice","ccd-suggested"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector('span[is="inline-price"]')}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll('a[is="checkout-link"]')??[]]}async toggleStockOffer({target:r}){if(!this.stockOfferOsis)return;let n=this.checkoutLinks;if(n.length!==0)for(let i of n){await i.onceSettled();let o=i.value?.[0]?.planType;if(!o)return;let a=this.stockOfferOsis[o];if(!a)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==a);r.checked&&s.push(a),i.dataset.wcsOsi=s.join(",")}}handleQuantitySelection(r){let n=this.checkoutLinks;for(let i of n)i.dataset.quantity=r.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(r){let n={...this.filters};Object.keys(n).forEach(i=>{if(r){n[i].order=Math.min(n[i].order||2,2);return}let o=n[i].order;o===1||isNaN(o)||(n[i].order=Number(o)+1)}),this.filters=n}includes(r){return this.textContent.match(new RegExp(r,"i"))!==null}connectedCallback(){super.connectedCallback();let r=this.querySelector("aem-fragment")?.getAttribute("fragment");performance.mark(`${vs}${r}${bh}`),this.addEventListener(st,this.handleQuantitySelection),this.addEventListener(In,this.merchCardReady,{once:!0}),this.updateComplete.then(()=>{this.merchCardReady()}),this.storageOptions?.addEventListener("change",this.handleStorageChange),this.addEventListener(Oe,this.handleAemFragmentEvents),this.addEventListener(Re,this.handleAemFragmentEvents),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(st,this.handleQuantitySelection),this.storageOptions?.removeEventListener(Er,this.handleStorageChange),this.removeEventListener(Oe,this.handleAemFragmentEvents),this.removeEventListener(Re,this.handleAemFragmentEvents)}async handleAemFragmentEvents(r){if(r.type===Oe&&me(this,rr,Xi).call(this,"AEM fragment cannot be loaded"),r.type===Re&&r.target.nodeName==="AEM-FRAGMENT"){let n=r.detail;await xs(n,this),this.checkReady()}}async checkReady(){let r=Promise.all([...this.querySelectorAll('span[is="inline-price"][data-wcs-osi],a[is="checkout-link"][data-wcs-osi]')].map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(a=>a.classList.contains("placeholder-resolved"))),n=new Promise(o=>setTimeout(()=>o(!1),vh));if(await Promise.race([r,n])===!0){performance.mark(`${vs}${this.id}${xh}`),this.dispatchEvent(new CustomEvent(On,{bubbles:!0,composed:!0}));return}me(this,rr,Xi).call(this,"Contains unresolved offers")}get aemFragment(){return this.querySelector("aem-fragment")}get storageOptions(){return this.querySelector("sp-radio-group#storage")}get storageSpecificOfferSelect(){let r=this.storageOptions?.selected;if(r){let n=this.querySelector(`merch-offer-select[storage="${r}"]`);if(n)return n}return this.querySelector("merch-offer-select")}get offerSelect(){return this.storageOptions?this.storageSpecificOfferSelect:this.querySelector("merch-offer-select")}get quantitySelect(){return this.querySelector("merch-quantity-select")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let r=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll('a[is="checkout-link"].con-button')).length===2&&r&&r.parentElement.classList.add("footer-column")}merchCardReady(){this.offerSelect&&!this.offerSelect.planType||(this.dispatchEvent(new CustomEvent(Nn,{bubbles:!0})),this.displayFooterElementsInColumn())}handleStorageChange(){let r=this.closest("merch-card")?.offerSelect.cloneNode(!0);r&&this.dispatchEvent(new CustomEvent(Er,{detail:{offerSelect:r},bubbles:!0}))}get dynamicPrice(){return this.querySelector('[slot="price"]')}selectMerchOffer(r){if(r===this.merchOffer)return;this.merchOffer=r;let n=this.dynamicPrice;if(r.price&&n){let i=r.price.cloneNode(!0);n.onceSettled?n.onceSettled().then(()=>{n.replaceWith(i)}):n.replaceWith(i)}}};rr=new WeakSet,Xi=function(r){this.dispatchEvent(new CustomEvent(Mn,{detail:r,bubbles:!0,composed:!0}))},p(tr,"properties",{name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:r=>{if(!r)return;let[n,i,o]=r.split(",");return{PUF:n,ABM:i,M2M:o}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:r=>Object.fromEntries(r.split(",").map(n=>{let[i,o,a]=n.split(":"),s=Number(o);return[i,{order:isNaN(s)?void 0:s,size:a}]})),toAttribute:r=>Object.entries(r).map(([n,{order:i,size:o}])=>[n,i,o].filter(a=>a!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:er,reflect:!0},loading:{type:String}}),p(tr,"styles",[Yo,la(),...jo()]);customElements.define(gh,tr);var wt=class extends q{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:t}=this;return t?b`<a href="${t}">
    ...
    `);customElements.define("merch-icon",wt);var As=P`
    :host {
        box-sizing: border-box;
...
`;var[uf,mf,ys,Es,Ss,pf]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var qi=class extends q{static get properties(){return{closed:{type:Boolean,reflect:!0},selected:{type:Number},min:{type:Number},max:{type:Number},step:{type:Number},maxInput:{type:Number,attribute:"max-input"},defaultValue:{type:Number,attribute:"default-value",reflect:!0},title:{type:String}}}static get styles(){return As}constructor(){super(),this.options=[],this.title="",this.closed=!0,this.min=0,this.max=0,this.step=0,this.maxInput=void 0,this.defaultValue=void 0,this.selectedValue=0,this.highlightedIndex=0,this.toggleMenu=this.toggleMenu.bind(this),this.handleClickOutside=this.handleClickOutside.bind(this),this.boundKeydownListener=this.handleKeydown.bind(this),this.addEventListener("keydown",this.boundKeydownListener),window.addEventListener("mousedown",this.handleClickOutside),this.handleKeyupDebounced=Wo(this.handleKeyup.bind(this),500)}handleKeyup(){this.handleInput(),this.sendEvent()}handleKeydown(t){switch(t.key){case Es:this.closed||(t.preventDefault(),this.highlightedIndex=(this.highlightedIndex+1)%this.options.length,this.requestUpdate());break;case ys:this.closed||(t.preventDefault(),this.highlightedIndex=(this.highlightedIndex-1+this.options.length)%this.options.length,this.requestUpdate());break;case Ss:if(this.closed)this.closePopover(),this.blur();else{let r=this.options[this.highlightedIndex];if(!r)break;this.selectedValue=r,this.handleMenuOption(this.selectedValue),this.toggleMenu()}break}t.composedPath().includes(this)&&t.stopPropagation()}adjustInput(t,r){this.selectedValue=r,t.value=r,this.highlightedIndex=this.options.indexOf(r)}handleInput(){let t=this.shadowRoot.querySelector(".text-field-input"),r=parseInt(t.value);if(!isNaN(r))if(r>0&&r!==this.selectedValue){let n=r;this.maxInput&&r>this.maxInput&&(n=this.maxInput),this.min&&n<this.min&&(n=this.min),this.adjustInput(t,n)}else this.adjustInput(t,this.min||1)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside),this.removeEventListener("keydown",this.boundKeydownListener)}generateOptionsArray(){let t=[];if(this.step>0)for(let r=this.min;r<=this.max;r+=this.step)t.push(r);return t}updated(t){(t.has("min")||t.has("max")||t.has("step")||t.has("defaultValue"))&&(this.options=this.generateOptionsArray(),this.highlightedIndex=this.defaultValue?this.options.indexOf(this.defaultValue):0,this.handleMenuOption(this.defaultValue?this.defaultValue:this.options[0]),this.requestUpdate())}handleClickOutside(t){t.composedPath().includes(this)||this.closePopover()}toggleMenu(){this.closed=!this.closed}handleMouseEnter(t){this.highlightedIndex=t,this.requestUpdate()}handleMenuOption(t){t===this.max&&this.shadowRoot.querySelector(".text-field-input")?.focus(),this.selectedValue=t,this.sendEvent(),this.closePopover()}sendEvent(){let t=new CustomEvent(st,{detail:{option:this.selectedValue},bubbles:!0});this.dispatchEvent(t)}closePopover(){this.closed||this.toggleMenu()}get offerSelect(){return this.querySelector("merch-offer-select")}get popover(){return b` <div class="popover ${this.closed?"closed":"open"}">
        ...
        `}};customElements.define("merch-quantity-select",qi);var je={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals"],serializableTypes:["Array","Object"],sampleRate:1,tags:"acom",isProdDomain:!1},Ts=1e3,ws=new Set;function Ah(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function Ls(e){if(e==null)return;let t=typeof e;if(t==="function")return e.name?`function ${e.name}`:"function";if(t==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:n,originatingRequest:i,status:o}=e;return[n,o,i].filter(Boolean).join(" ")}let r=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!je.serializableTypes.includes(r))return r}return e}function yh(e,t){if(!je.ignoredProperties.includes(e))return Ls(t)}var Zi={append(e){if(e.level!=="error")return;let{message:t,params:r}=e,n=[],i=[],o=t;r.forEach(l=>{l!=null&&(Ah(l)?n:i).push(l)}),n.length&&(o+=" "+n.map(Ls).join(" "));let{pathname:a,search:s}=window.location,c=`${je.delimiter}page=${a}${s}`;c.length>Ts&&(c=`${c.slice(0,Ts)}<trunc>`),o+=c,i.length&&(o+=`${je.delimiter}facts=`,o+=JSON.stringify(i,yh)),ws.has(o)||(ws.add(o),window.lana?.log(o,je))}};function Lt(e){Object.assign(je,Object.fromEntries(Object.entries(e).filter(([t,r])=>t in je&&r!==""&&r!==null&&r!==void 0&&!Number.isNaN(r))))}var w=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflow:Q.V3,checkoutWorkflowStep:J.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,env:ze.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsBufferDelay:1,wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:ae.PUBLISHED,wcsBufferLimit:1});var Qi=Object.freeze({LOCAL:"local",PROD:"prod",STAGE:"stage"});function Eh({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||w.language),t??(t=e?.split("_")?.[1]||w.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function Ji(e={}){let{commerce:t={}}=e,r=ze.PRODUCTION,n=Kn,i=R("checkoutClientId",t)??w.checkoutClientId,o=ye(R("checkoutWorkflow",t),Q,w.checkoutWorkflow),a=J.CHECKOUT;o===Q.V3&&(a=ye(R("checkoutWorkflowStep",t),J,w.checkoutWorkflowStep));let s=S(R("displayOldPrice",t),w.displayOldPrice),c=S(R("displayPerUnit",t),w.displayPerUnit),l=S(R("displayRecurrence",t),w.displayRecurrence),h=S(R("displayTax",t),w.displayTax),d=S(R("entitlement",t),w.entitlement),u=S(R("modal",t),w.modal),m=S(R("forceTaxExclusive",t),w.forceTaxExclusive),g=R("promotionCode",t)??w.promotionCode,f=Tt(R("quantity",t)),T=R("wcsApiKey",t)??w.wcsApiKey,L=t?.env==="stage",x=ae.PUBLISHED;["true",""].includes(t.allowOverride)&&(L=(R(zn,t,{metadata:!1})?.toLowerCase()??t?.env)==="stage",x=ye(R(Fn,t),ae,x)),L&&(r=ze.STAGE,n=Yn);let I=yt(R("wcsBufferDelay",t),w.wcsBufferDelay),O=yt(R("wcsBufferLimit",t),w.wcsBufferLimit);return{...Eh(e),displayOldPrice:s,checkoutClientId:i,checkoutWorkflow:o,checkoutWorkflowStep:a,displayPerUnit:c,displayRecurrence:l,displayTax:h,entitlement:d,extraOptions:w.extraOptions,modal:u,env:r,forceTaxExclusive:m,promotionCode:g,quantity:f,alternativePrice:w.alternativePrice,wcsApiKey:T,wcsBufferDelay:I,wcsBufferLimit:O,wcsURL:n,landscape:x}}var eo={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Sh=Date.now(),to=new Set,ro=new Set,_s=new Map,Ps={append({level:e,message:t,params:r,timestamp:n,source:i}){console[e](`${n}ms [${i}] %c${t}`,"font-weight: bold;",...r)}},Cs={filter:({level:e})=>e!==eo.DEBUG},Th={filter:()=>!1};function wh(e,t,r,n,i){return{level:e,message:t,namespace:r,get params(){return n.length===1&&zt(n[0])&&(n=n[0](),Array.isArray(n)||(n=[n])),n},source:i,timestamp:Date.now()-Sh}}function Lh(e){[...ro].every(t=>t(e))&&to.forEach(t=>t(e))}function ks(e){let t=(_s.get(e)??0)+1;_s.set(e,t);let r=`${e} #${t}`,n={id:r,namespace:e,module:i=>ks(`${n.namespace}/${i}`),updateConfig:Lt};return Object.values(eo).forEach(i=>{n[i]=(o,...a)=>Lh(wh(i,o,e,a,r))}),Object.seal(n)}function Br(...e){e.forEach(t=>{let{append:r,filter:n}=t;zt(n)&&ro.add(n),zt(r)&&to.add(r)})}function _h(e={}){let{name:t}=e,r=S(R("commerce.debug",{search:!0,storage:!0}),t===Qi.LOCAL);return Br(r?Ps:Cs),t===Qi.PROD&&Br(Zi),X}function Ph(){to.clear(),ro.clear()}var X={...ks(Gn),Level:eo,Plugins:{consoleAppender:Ps,debugFilter:Cs,quietFilter:Th,lanaAppender:Zi},init:_h,reset:Ph,use:Br};var Ch={[ie]:Vn,[xe]:$n,[oe]:Hn},kh={[ie]:Dn,[oe]:Bn},_t=class{constructor(t){p(this,"changes",new Map);p(this,"connected",!1);p(this,"dispose",xt);p(this,"error");p(this,"log");p(this,"options");p(this,"promises",[]);p(this,"state",xe);p(this,"timer",null);p(this,"value");p(this,"version",0);p(this,"wrapperElement");this.wrapperElement=t}update(){[ie,xe,oe].forEach(t=>{this.wrapperElement.classList.toggle(Ch[t],t===this.state)})}notify(){(this.state===oe||this.state===ie)&&(this.state===oe?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===ie&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]),this.wrapperElement.dispatchEvent(new CustomEvent(kh[this.state],{bubbles:!0}))}attributeChangedCallback(t,r,n){this.changes.set(t,n),this.requestUpdate()}connectedCallback(){this.dispose=fs(()=>this.requestUpdate(!0))}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement})),this.dispose(),this.dispose=xt}onceSettled(){let{error:t,promises:r,state:n}=this;return oe===n?Promise.resolve(this.wrapperElement):ie===n?Promise.reject(t):new Promise((i,o)=>{r.push({resolve:i,reject:o})})}toggleResolved(t,r,n){return t!==this.version?!1:(n!==void 0&&(this.options=n),this.state=oe,this.value=r,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:r}),Fe(()=>this.notify()),!0)}toggleFailed(t,r,n){return t!==this.version?!1:(n!==void 0&&(this.options=n),this.error=r,this.state=ie,this.update(),this.log?.error("Failed:",{element:this.wrapperElement,error:r}),Fe(()=>this.notify()),!0)}togglePending(t){return this.version++,t&&(this.options=t),this.state=xe,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!W()||this.timer)return;let r=X.module("mas-element"),{error:n,options:i,state:o,value:a,version:s}=this;this.state=xe,this.timer=Fe(async()=>{this.timer=null;let c=null;if(this.changes.size&&(c=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:c}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:c})),c||t)try{await this.wrapperElement.render?.()===!1&&this.state===xe&&this.version===s&&(this.state=o,this.error=n,this.value=a,this.update(),this.notify())}catch(l){r.error("Failed to render mas-element: ",l),this.toggleFailed(this.version,l,i)}})}};function Is(e={}){return Object.entries(e).forEach(([t,r])=>{(r==null||r===""||r?.length===0)&&delete e[t]}),e}function Gr(e,t={}){let{tag:r,is:n}=e,i=document.createElement(r,{is:n});return i.setAttribute("is",n),Object.assign(i.dataset,Is(t)),i}function zr(e,t={}){return e instanceof HTMLElement?(Object.assign(e.dataset,Is(t)),e):null}var Ih="download",Nh="upgrade";function Fr(e,t={},r=""){let n=W();if(!n)return null;let{checkoutMarketSegment:i,checkoutWorkflow:o,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:l,perpetual:h,promotionCode:d,quantity:u,wcsOsi:m,extraOptions:g}=n.collectCheckoutOptions(t),f=Gr(e,{checkoutMarketSegment:i,checkoutWorkflow:o,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:l,perpetual:h,promotionCode:d,quantity:u,wcsOsi:m,extraOptions:g});return r&&(f.innerHTML=`<span style="pointer-events: none;">${r}</span>`),f}function Kr(e){return class extends e{constructor(){super(...arguments);p(this,"checkoutActionHandler");p(this,"masElement",new _t(this))}attributeChangedCallback(n,i,o){this.masElement.attributeChangedCallback(n,i,o)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get opens3in1Modal(){return Object.values(Ve).includes(this.getAttribute("data-modal-type"))&&!!this.href}requestUpdate(n=!1){return this.masElement.requestUpdate(n)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(n={}){let i=W();if(!i)return!1;this.dataset.imsCountry||i.imsCountryPromise.then(d=>{d&&(this.dataset.imsCountry=d)},xt),n.imsCountry=null;let o=i.collectCheckoutOptions(n,this);if(!o.wcsOsi.length)return!1;let a;try{a=JSON.parse(o.extraOptions??"{}")}catch(d){this.masElement.log?.error("cannot parse exta checkout options",d)}let s=this.masElement.togglePending(o);this.setCheckoutUrl("");let c=i.resolveOfferSelectors(o),l=await Promise.all(c);l=l.map(d=>Qt(d,o)),o.country=this.dataset.imsCountry||o.country;let h=await i.buildCheckoutAction?.(l.flat(),{...a,...o},this);return this.renderOffers(l.flat(),o,{},h,s)}add3in1ModalParams(n,i){try{let o=new URL(n);return o.searchParams.set("ctx","if"),i===Ve.CRM?(o.searchParams.set("af","uc_segmentation_hide_tabs,uc_new_user_iframe,uc_new_system_close"),o.searchParams.set("cli","creative")):(o.searchParams.set("af","uc_new_user_iframe,uc_new_system_close"),o.searchParams.set("cli","mini_plans")),o.toString()}catch(o){this.masElement.log?.error("Failed to add 3-in-1 modal parameters",o)}}setModalType(n,i){try{let a=new URL(i).searchParams.get("modal");if([Ve.TWP,Ve.D2P,Ve.CRM].includes(a))return n?.setAttribute("data-modal-type",a),a}catch(o){this.masElement.log?.error("Failed to set modal type",o)}}renderOffers(n,i,o={},a=void 0,s=void 0){let c=W();if(!c)return!1;i={...JSON.parse(this.dataset.extraOptions??"null"),...i,...o},s??(s=this.masElement.togglePending(i)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0);let h;if(a){this.classList.remove(Ih,Nh),this.masElement.toggleResolved(s,n,i);let{url:d,text:u,className:m,handler:g}=a;if(d&&(this.setCheckoutUrl(d),h=this.setModalType(this,d)),u&&(this.firstElementChild.innerHTML=u),m&&this.classList.add(...m.split(" ")),g&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=g.bind(this)),!h)return!0}if(n.length){if(this.masElement.toggleResolved(s,n,i)){let d=c.buildCheckoutURL(n,i),u=a&&h?this.add3in1ModalParams(d,h):d;return this.setCheckoutUrl(u),!0}}else{let d=new Error(`Not provided: ${i?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,d,i))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(n){}updateOptions(n={}){let i=W();if(!i)return!1;let{checkoutMarketSegment:o,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:h,perpetual:d,promotionCode:u,quantity:m,wcsOsi:g}=i.collectCheckoutOptions(n);return zr(this,{checkoutMarketSegment:o,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:h,perpetual:d,promotionCode:u,quantity:m,wcsOsi:g}),!0}}}var nr=class nr extends Kr(HTMLAnchorElement){static createCheckoutLink(t={},r=""){return Fr(nr,t,r)}setCheckoutUrl(t){this.setAttribute("href",t)}get isCheckoutLink(){return!0}clickHandler(t){if(this.checkoutActionHandler){this.checkoutActionHandler?.(t);return}}};p(nr,"is","checkout-link"),p(nr,"tag","a");var ee=nr;window.customElements.get(ee.is)||window.customElements.define(ee.is,ee,{extends:ee.tag});var ir=class ir extends Kr(HTMLButtonElement){static createCheckoutButton(t={},r=""){return Fr(ir,t,r)}setCheckoutUrl(t){this.setAttribute("data-href",t)}get href(){return this.getAttribute("data-href")}get isCheckoutButton(){return!0}clickHandler(t){if(this.checkoutActionHandler){this.checkoutActionHandler?.(t);return}this.href&&(window.location.href=this.href)}};p(ir,"is","checkout-button"),p(ir,"tag","button");var We=ir;window.customElements.get(We.is)||window.customElements.define(We.is,We,{extends:We.tag});var Rh="p_draft_landscape",Oh="/store/",Mh=new Map([["countrySpecific","cs"],["customerSegment","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["offerType","ot"],["marketSegment","ms"]]),no=new Set(["af","ai","apc","appctxid","cli","co","cs","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),Vh=["env","workflowStep","clientId","country"],Ns=e=>Mh.get(e)??e;function io(e,t,r){for(let[n,i]of Object.entries(e)){let o=Ns(n);i!=null&&r.has(o)&&t.set(o,i)}}function $h(e){switch(e){case jn.PRODUCTION:return"https://commerce.adobe.com";default:return"https://commerce-stg.adobe.com"}}function Hh(e,t){for(let r in e){let n=e[r];for(let[i,o]of Object.entries(n)){if(o==null)continue;let a=Ns(i);t.set(`items[${r}][${a}]`,o)}}}function Rs(e){Uh(e);let{env:t,items:r,workflowStep:n,ms:i,marketSegment:o,ot:a,offerType:s,pa:c,productArrangementCode:l,landscape:h,...d}=e,u={marketSegment:o??i,offerType:s??a,productArrangementCode:l??c},m=new URL($h(t));return m.pathname=`${Oh}${n}`,n!==Me.SEGMENTATION&&n!==Me.CHANGE_PLAN_TEAM_PLANS&&Hh(r,m.searchParams),n===Me.SEGMENTATION&&io(u,m.searchParams,no),io(d,m.searchParams,no),h===ae.DRAFT&&io({af:Rh},m.searchParams,no),m.toString()}function Uh(e){for(let t of Vh)if(!e[t])throw new Error('Argument "checkoutData" is not valid, missing: '+t);if(e.workflowStep!==Me.SEGMENTATION&&e.workflowStep!==Me.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}function Os({providers:e,settings:t}){function r(o,a){let{checkoutClientId:s,checkoutWorkflow:c,checkoutWorkflowStep:l,country:h,language:d,promotionCode:u,quantity:m}=t,{checkoutMarketSegment:g,checkoutWorkflow:f=c,checkoutWorkflowStep:T=l,imsCountry:L,country:x=L??h,language:E=d,quantity:I=m,entitlement:O,upgrade:G,modal:V,perpetual:de,promotionCode:Xe=u,wcsOsi:re,extraOptions:Pt,...qe}=Object.assign({},a?.dataset??{},o??{}),Ct=ye(f,Q,w.checkoutWorkflow),Ee=J.CHECKOUT;Ct===Q.V3&&(Ee=ye(T,J,w.checkoutWorkflowStep));let Se=At({...qe,extraOptions:Pt,checkoutClientId:s,checkoutMarketSegment:g,country:x,quantity:Tt(I,w.quantity),checkoutWorkflow:Ct,checkoutWorkflowStep:Ee,language:E,entitlement:S(O),upgrade:S(G),modal:S(V),perpetual:S(de),promotionCode:Ft(Xe).effectivePromoCode,wcsOsi:Dr(re)});if(a)for(let ue of e.checkout)ue(a,Se);return Se}function n(o,a){if(!Array.isArray(o)||!o.length||!a)return"";let{env:s,landscape:c}=t,{checkoutClientId:l,checkoutMarketSegment:h,checkoutWorkflow:d,checkoutWorkflowStep:u,country:m,promotionCode:g,quantity:f,...T}=r(a),L=window.frameElement?"if":"fp",x={checkoutPromoCode:g,clientId:l,context:L,country:m,env:s,items:[],marketSegment:h,workflowStep:u,landscape:c,...T};if(o.length===1){let[{offerId:E,offerType:I,productArrangementCode:O}]=o,{marketSegments:[G]}=o[0];Object.assign(x,{marketSegment:G,offerType:I,productArrangementCode:O}),x.items.push(f[0]===1?{id:E}:{id:E,quantity:f[0]})}else x.items.push(...o.map(({offerId:E},I)=>({id:E,quantity:f[I]??w.quantity})));return Rs(x)}let{createCheckoutLink:i}=ee;return{CheckoutLink:ee,CheckoutWorkflow:Q,CheckoutWorkflowStep:J,buildCheckoutURL:n,collectCheckoutOptions:r,createCheckoutLink:i}}function Dh({interval:e=200,maxAttempts:t=25}={}){let r=X.module("ims");return new Promise(n=>{r.debug("Waing for IMS to be ready");let i=0;function o(){window.adobeIMS?.initialized?n():++i>t?(r.debug("Timeout"),n()):setTimeout(o,e)}o()})}function Bh(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function Gh(e){let t=X.module("ims");return e.then(r=>r?window.adobeIMS.getProfile().then(({countryCode:n})=>(t.debug("Got user country:",n),n),n=>{t.error("Unable to get user country:",n)}):null)}function Ms({}){let e=Dh(),t=Bh(e),r=Gh(t);return{imsReadyPromise:e,imsSignedInPromise:t,imsCountryPromise:r}}async function $s(e,t){let{data:r}=t||await Promise.resolve().then(()=>rc(Vs(),1));if(Array.isArray(r)){let n=o=>r.find(a=>_r(a.lang,o)),i=n(e.language)??n(w.language);if(i)return Object.freeze(i)}return{}}var Hs=["GB_en","AU_en","FR_fr","AT_de","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GR_el","GR_en","HU_hu","IE_en","IT_it","LU_de","LU_en","LU_fr","NL_nl","NO_nb","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TR_tr","UA_uk","ID_en","ID_in","IN_en","IN_hi","JP_ja","MY_en","MY_ms","NZ_en","TH_en","TH_th"],Fh={INDIVIDUAL_COM:["ZA_en","LT_lt","LV_lv","NG_en","SA_ar","SA_en","ZA_en","SG_en","KR_ko"],TEAM_COM:["ZA_en","LT_lt","LV_lv","NG_en","ZA_en","CO_es","KR_ko"],INDIVIDUAL_EDU:["LT_lt","LV_lv","SA_en","SG_en"],TEAM_EDU:["SG_en","KR_ko"]},or=class or extends HTMLSpanElement{constructor(){super();p(this,"masElement",new _t(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-perpetual","data-promotion-code","data-tax-exclusive","data-template","data-wcs-osi"]}static createInlinePrice(r){let n=W();if(!n)return null;let{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:d,alternativePrice:u,template:m,wcsOsi:g}=n.collectPriceOptions(r);return Gr(or,{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:d,alternativePrice:u,template:m,wcsOsi:g})}get isInlinePrice(){return!0}attributeChangedCallback(r,n,i){this.masElement.attributeChangedCallback(r,n,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}resolveDisplayTaxForGeoAndSegment(r,n,i,o){let a=`${r}_${n}`;if(Hs.includes(r)||Hs.includes(a))return!0;let s=Fh[`${i}_${o}`];return s?!!(s.includes(r)||s.includes(a)):!1}async resolveDisplayTax(r,n){let[i]=await r.resolveOfferSelectors(n),o=Qt(await i,n);if(o?.length){let{country:a,language:s}=n,c=o[0],[l=""]=c.marketSegments;return this.resolveDisplayTaxForGeoAndSegment(a,s,c.customerSegment,l)}}async render(r={}){if(!this.isConnected)return!1;let n=W();if(!n)return!1;let i=n.collectPriceOptions(r,this);if(!i.wcsOsi.length)return!1;let o=this.masElement.togglePending(i);this.innerHTML="";let[a]=n.resolveOfferSelectors(i);return this.renderOffers(Qt(await a,i),i,o)}renderOffers(r,n={},i=void 0){if(!this.isConnected)return;let o=W();if(!o)return!1;let a=o.collectPriceOptions({...this.dataset,...n},this);if(i??(i=this.masElement.togglePending(a)),r.length){if(this.masElement.toggleResolved(i,r,a)){this.innerHTML=o.buildPriceHTML(r,a);let s=this.closest("p, h3, div");if(!s||!s.querySelector('span[data-template="strikethrough"]')||s.querySelector(".alt-aria-label"))return!0;let c=s?.querySelectorAll('span[is="inline-price"]');return c.length===2&&c.forEach(l=>{console.log(l),l.dataset.template==="strikethrough"&&!a.alternativePrice&&(a.alternativePrice=!0,this.innerHTML=o.buildPriceHTML(r,a))}),!0}}else{let s=new Error(`Not provided: ${a?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,s,a))return this.innerHTML="",!0}return!1}updateOptions(r){let n=W();if(!n)return!1;let{alternativePrice:i,displayOldPrice:o,displayPerUnit:a,displayRecurrence:s,displayTax:c,forceTaxExclusive:l,perpetual:h,promotionCode:d,quantity:u,template:m,wcsOsi:g}=n.collectPriceOptions(r);return zr(this,{alternativePrice:i,displayOldPrice:o,displayPerUnit:a,displayRecurrence:s,displayTax:c,forceTaxExclusive:l,perpetual:h,promotionCode:d,quantity:u,template:m,wcsOsi:g}),!0}};p(or,"is","inline-price"),p(or,"tag","span");var te=or;window.customElements.get(te.is)||window.customElements.define(te.is,te,{extends:te.tag});function Us({literals:e,providers:t,settings:r}){function n(a,s){let{country:c,displayOldPrice:l,displayPerUnit:h,displayRecurrence:d,displayTax:u,forceTaxExclusive:m,language:g,promotionCode:f,quantity:T,alternativePrice:L}=r,{displayOldPrice:x=l,displayPerUnit:E=h,displayRecurrence:I=d,displayTax:O=u,forceTaxExclusive:G=m,country:V=c,language:de=g,perpetual:Xe,promotionCode:re=f,quantity:Pt=T,alternativePrice:qe=L,template:Ct,wcsOsi:Ee,...Se}=Object.assign({},s?.dataset??{},a??{}),ue=At({...Se,country:V,displayOldPrice:S(x),displayPerUnit:S(E),displayRecurrence:S(I),displayTax:S(O),forceTaxExclusive:S(G),language:de,perpetual:S(Xe),promotionCode:Ft(re).effectivePromoCode,quantity:Tt(Pt,w.quantity),alternativePrice:S(qe),template:Ct,wcsOsi:Dr(Ee)});if(s)for(let kt of t.price)kt(s,ue);return ue}function i(a,s){if(!Array.isArray(a)||!a.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=Fi;break;case"strikethrough":l=Hi;break;case"annual":l=Ui;break;default:s.country==="AU"&&a[0].planType==="ABM"?l=s.promotionCode?zi:Gi:s.template==="optical"&&s.alternativePrice?l=Di:s.alternativePrice?l=Bi:l=s.promotionCode?$i:Vi}let h=n(s);h.literals=Object.assign({},e.price,At(s.literals??{}));let[d]=a;return d={...d,...d.priceDetails},l(h,d)}let o=te.createInlinePrice;return{InlinePrice:te,buildPriceHTML:i,collectPriceOptions:n,createInlinePrice:o}}function Ds({settings:e}){let t=X.module("wcs"),{env:r,wcsApiKey:n}=e,i=new Map,o=new Map,a;async function s(d,u,m=!0){let g=Un;t.debug("Fetching:",d);let f="",T,L=(x,E,I)=>`${x}: ${E?.status}, url: ${I.toString()}`;try{if(d.offerSelectorIds=d.offerSelectorIds.sort(),f=new URL(e.wcsURL),f.searchParams.set("offer_selector_ids",d.offerSelectorIds.join(",")),f.searchParams.set("country",d.country),f.searchParams.set("locale",d.locale),f.searchParams.set("landscape",r===ze.STAGE?"ALL":e.landscape),f.searchParams.set("api_key",n),d.language&&f.searchParams.set("language",d.language),d.promotionCode&&f.searchParams.set("promotion_code",d.promotionCode),d.currency&&f.searchParams.set("currency",d.currency),T=await fetch(f.toString(),{credentials:"omit"}),T.ok){let x=await T.json();t.debug("Fetched:",d,x);let E=x.resolvedOffers??[];E=E.map(kr),u.forEach(({resolve:I},O)=>{let G=E.filter(({offerSelectorIds:V})=>V.includes(O)).flat();G.length&&(u.delete(O),I(G))})}else T.status===404&&d.offerSelectorIds.length>1?(t.debug("Multi-osi 404, fallback to fetch-by-one strategy"),await Promise.allSettled(d.offerSelectorIds.map(x=>s({...d,offerSelectorIds:[x]},u,!1)))):g=Sr}catch(x){g=Sr,t.error(g,d,x)}m&&u.size&&(t.debug("Missing:",{offerSelectorIds:[...u.keys()]}),u.forEach(x=>{x.reject(new Error(L(g,T,f)))}))}function c(){clearTimeout(a);let d=[...o.values()];o.clear(),d.forEach(({options:u,promises:m})=>s(u,m))}function l(){let d=i.size;i.clear(),t.debug(`Flushed ${d} cache entries`)}function h({country:d,language:u,perpetual:m=!1,promotionCode:g="",wcsOsi:f=[]}){let T=`${u}_${d}`;d!=="GB"&&(u=m?"EN":"MULT");let L=[d,u,g].filter(x=>x).join("-").toLowerCase();return f.map(x=>{let E=`${x}-${L}`;if(!i.has(E)){let I=new Promise((O,G)=>{let V=o.get(L);if(!V){let de={country:d,locale:T,offerSelectorIds:[]};d!=="GB"&&(de.language=u),V={options:de,promises:new Map},o.set(L,V)}g&&(V.options.promotionCode=g),V.options.offerSelectorIds.push(x),V.promises.set(x,{resolve:O,reject:G}),V.options.offerSelectorIds.length>=e.wcsBufferLimit?c():(t.debug("Queued:",V.options),a||(a=setTimeout(c,e.wcsBufferDelay)))});i.set(E,I)}return i.get(E)})}return{WcsCommitment:Ki,WcsPlanType:Yi,WcsTerm:ji,resolveOfferSelectors:h,flushWcsCache:l}}var oo="mas-commerce-service",Kh="mas:start",Yh="mas:ready",jr,Bs,Yr=class extends HTMLElement{constructor(){super(...arguments);z(this,jr);p(this,"promise",null)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(n,i,o)=>{let a=await r?.(n,i,this.imsSignedInPromise,o);return a||null})}async activate(){let r=_(this,jr,Bs),n=Object.freeze(Ji(r));Lt(r.lana);let i=X.init(r.hostEnv).module("service");i.debug("Activating:",r);let o={price:{}};try{o.price=await $s(n,r.commerce.priceLiterals)}catch{}let a={checkout:new Set,price:new Set},s={literals:o,providers:a,settings:n};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...Os(s),...Ms(s),...Us(s),...Ds(s),...Wn,Log:X,get defaults(){return w},get log(){return X},get providers(){return{checkout(c){return a.checkout.add(c),()=>a.checkout.delete(c)},price(c){return a.price.add(c),()=>a.price.delete(c)}}},get settings(){return n}})),i.debug("Activated:",{literals:o,settings:n}),Fe(()=>{let c=new CustomEvent(at,{bubbles:!0,cancelable:!1,detail:this});performance.mark(Yh),this.dispatchEvent(c)})}connectedCallback(){this.readyPromise||(performance.mark(Kh),this.readyPromise=this.activate())}disconnectedCallback(){this.readyPromise=null}flushWcsCache(){this.flushWcsCache(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCache(),document.querySelectorAll('span[is="inline-price"],a[is="checkout-link"]').forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers")}refreshFragments(){this.flushWcsCache(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh()),this.log.debug("Refreshed AEM fragments")}};jr=new WeakSet,Bs=function(){let r={hostEnv:{name:this.getAttribute("host-env")??"prod"},commerce:{env:this.getAttribute("env")},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate"),10),isProdDomain:this.getAttribute("host-env")==="prod"}};return["locale","country","language"].forEach(n=>{let i=this.getAttribute(n);i&&(r[n]=i)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(n=>{let i=this.getAttribute(n);if(i!=null){let o=n.replace(/-([a-z])/g,a=>a[1].toUpperCase());r.commerce[o]=i}}),r},p(Yr,"instance");window.customElements.get(oo)||window.customElements.define(oo,Yr);Lt({sampleRate:1});export{Vn as CLASS_NAME_FAILED,pc as CLASS_NAME_HIDDEN,$n as CLASS_NAME_PENDING,Hn as CLASS_NAME_RESOLVED,We as CheckoutButton,ee as CheckoutLink,Q as CheckoutWorkflow,J as CheckoutWorkflowStep,w as Defaults,Sr as ERROR_MESSAGE_BAD_REQUEST,Sc as ERROR_MESSAGE_MISSING_LITERALS_URL,Un as ERROR_MESSAGE_OFFER_NOT_FOUND,Oe as EVENT_AEM_ERROR,Re as EVENT_AEM_LOAD,Mn as EVENT_MAS_ERROR,On as EVENT_MAS_READY,Rn as EVENT_MERCH_CARD_ACTION_MENU_TOGGLE,yc as EVENT_MERCH_CARD_COLLECTION_SHOWMORE,Ac as EVENT_MERCH_CARD_COLLECTION_SORT,Nn as EVENT_MERCH_CARD_READY,gc as EVENT_MERCH_OFFER_READY,In as EVENT_MERCH_OFFER_SELECT_READY,st as EVENT_MERCH_QUANTITY_SELECTOR_CHANGE,vc as EVENT_MERCH_SEARCH_CHANGE,Ec as EVENT_MERCH_SIDENAV_SELECT,xc as EVENT_MERCH_STOCK_CHANGE,Er as EVENT_MERCH_STORAGE_CHANGE,bc as EVENT_OFFER_SELECTED,Dn as EVENT_TYPE_FAILED,at as EVENT_TYPE_READY,Bn as EVENT_TYPE_RESOLVED,te as InlinePrice,Gn as LOG_NAMESPACE,ae as Landscape,X as Log,Ve as MODAL_TYPE_3_IN_1,mc as NAMESPACE,Tc as PARAM_AOS_API_KEY,zn as PARAM_ENV,Fn as PARAM_LANDSCAPE,wc as PARAM_WCS_API_KEY,jn as PROVIDER_ENVIRONMENT,ie as STATE_FAILED,xe as STATE_PENDING,oe as STATE_RESOLVED,he as UptLink,Kn as WCS_PROD_URL,Yn as WCS_STAGE_URL,Me as WORKFLOW_STEP,Ki as WcsCommitment,Yi as WcsPlanType,ji as WcsTerm,kr as applyPlanType,Ji as getSettings};
