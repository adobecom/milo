...
`,Uo=()=>[C`
        ...
        `}get cardImage(){return x` <div class="image">
            ...
            ${this.badge}
              ...
              >`:"";return x`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){}};rt=new WeakMap,p(Ut,"styleMap",{});var P=Ut;function te(e,t={},r=null,n=null){let i=n?document.createElement(e,{is:n}):document.createElement(e);r instanceof HTMLElement?i.appendChild(r):i.innerHTML=r;for(let[o,a]of Object.entries(t))i.setAttribute(o,a);return i}function vr(){return window.matchMedia("(max-width: 767px)").matches}function Do(){return window.matchMedia("(max-width: 1024px)").matches}var jn={};Ds(jn,{CLASS_NAME_FAILED:()=>Vn,CLASS_NAME_HIDDEN:()=>ec,CLASS_NAME_PENDING:()=>Mn,CLASS_NAME_RESOLVED:()=>$n,ERROR_MESSAGE_BAD_REQUEST:()=>yr,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>lc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Hn,EVENT_AEM_ERROR:()=>Re,EVENT_AEM_LOAD:()=>Oe,EVENT_MAS_ERROR:()=>Rn,EVENT_MAS_READY:()=>On,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Nn,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>sc,EVENT_MERCH_CARD_COLLECTION_SORT:()=>ac,EVENT_MERCH_CARD_READY:()=>In,EVENT_MERCH_OFFER_READY:()=>rc,EVENT_MERCH_OFFER_SELECT_READY:()=>kn,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>Er,EVENT_MERCH_SEARCH_CHANGE:()=>oc,EVENT_MERCH_SIDENAV_SELECT:()=>cc,EVENT_MERCH_STOCK_CHANGE:()=>ic,EVENT_MERCH_STORAGE_CHANGE:()=>Ar,EVENT_OFFER_SELECTED:()=>nc,EVENT_TYPE_FAILED:()=>Un,EVENT_TYPE_READY:()=>nt,EVENT_TYPE_RESOLVED:()=>Dn,LOG_NAMESPACE:()=>Bn,Landscape:()=>Ve,NAMESPACE:()=>Qs,PARAM_AOS_API_KEY:()=>hc,PARAM_ENV:()=>Gn,PARAM_LANDSCAPE:()=>zn,PARAM_WCS_API_KEY:()=>dc,STATE_FAILED:()=>ce,STATE_PENDING:()=>Ee,STATE_RESOLVED:()=>le,TAG_NAME_SERVICE:()=>tc,WCS_PROD_URL:()=>Fn,WCS_STAGE_URL:()=>Kn});var Qs="merch",ec="hidden",nt="wcms:commerce:ready",tc="mas-commerce-service",rc="merch-offer:ready",kn="merch-offer-select:ready",In="merch-card:ready",Nn="merch-card:action-menu-toggle",nc="merch-offer:selected",ic="merch-stock:change",Ar="merch-storage:change",Er="merch-quantity-selector:change",oc="merch-search:change",ac="merch-card-collection:sort",sc="merch-card-collection:showmore",cc="merch-sidenav:select",Oe="aem:load",Re="aem:error",On="mas:ready",Rn="mas:error",Vn="placeholder-failed",Mn="placeholder-pending",$n="placeholder-resolved",yr="Bad WCS request",Hn="Commerce offer not found",lc="Literals URL not provided",Un="mas:failed",Dn="mas:resolved",Bn="mas/commerce",Gn="commerce.env",zn="commerce.landscape",hc="commerce.aosKey",dc="commerce.wcsKey",Fn="https://www.adobe.com/web_commerce_artifact",Kn="https://www.stage.adobe.com/web_commerce_artifact_stage",ce="failed",Ee="pending",le="resolved",Ve={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"};var Bo=`
:root {
...
`;var Sr=class extends P{constructor(t){super(t)}getGlobalCSS(){return Go}renderLayout(){return x`${this.cardImage}
    <div class="body">
...
`;var mc=32,ot=class extends P{constructor(r){super(r);p(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);p(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
...
`;var at=class extends P{constructor(t){super(t)}getGlobalCSS(){return Ko}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
...
`;var Me=class extends P{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return jo}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return x` ${this.badge}
      ...
      ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}postCardUpdateHook(){this.card.isConnected&&(vr()||this.adjustProductBodySlots(),this.adjustTitleWidth())}};p(Me,"variantStyle",C`
...
`;var st=class extends P{constructor(t){super(t)}getGlobalCSS(){return Yo}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
        ${this.promoBottom?"":x`<slot name="promo-text"></slot><slot name="callout-content"></slot>`}
...
`;var pc={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ct=class extends P{constructor(t){super(t)}getGlobalCSS(){return Xo}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return pc}renderLayout(){return x`${this.cardImage}
            <div class="body">
...
`;var lt=class extends P{constructor(t){super(t)}getGlobalCSS(){return Wo}renderLayout(){return x`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
...
`;var gc={mnemonics:{size:"m"},backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{slot:"footer",size:"S"},allowedSizes:["wide"]},dt=class extends P{getGlobalCSS(){return Zo}get aemFragmentMapping(){return gc}renderLayout(){return x` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;var xc={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40},description:{tag:"div",slot:"body-xxs",maxCount:200},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},allowedColors:["gray"],allowedSizes:["single","double"]},$e=class extends P{getGlobalCSS(){return Jo}get aemFragmentMapping(){return xc}renderLayout(){return x`
  ...
  `);customElements.define("ah-pricing-widget",$e);var Yn=(e,t=!1)=>{switch(e.variant){case"catalog":return new it(e);case"image":return new Sr(e);case"inline-heading":return new Tr(e);case"mini-compare-chart":return new ot(e);case"plans":return new at(e);case"product":return new Me(e);case"segment":return new st(e);case"special-offers":return new ct(e);case"twp":return new lt(e);case"ccd-suggested":return new ht(e);case"ccd-slice":return new dt(e);case"ah-pricing-widget":return new $e(e);default:return t?void 0:new Me(e)}},Qo=()=>{let e=[];return e.push(it.variantStyle),e.push(ot.variantStyle),e.push(Me.variantStyle),e.push(at.variantStyle),e.push(st.variantStyle),e.push(ct.variantStyle),e.push(lt.variantStyle),e.push(ht.variantStyle),e.push(dt.variantStyle),e.push($e.variantStyle),e};var ea=document.createElement("style");ea.innerHTML=`
:root {
...
`,De.MISSING_INTL_API,a);var I=r.getPluralRules(t,{type:h.pluralType}).select(u-(h.offset||0));y=h.options[I]||h.options.other}if(!y)throw new Ti(h.value,u,Object.keys(h.options),a);s.push.apply(s,Wt(y.value,t,r,n,i,u-(h.offset||0)));continue}}return pl(s)}function gl(e,t){return t?A(A(A({},e||{}),t||{}),Object.keys(e).reduce(function(r,n){return r[n]=A(A({},e[n]),t[n]||{}),r},{})):e}function xl(e,t){return t?Object.keys(e).reduce(function(r,n){return r[n]=gl(e[n],t[n]),r},A({},e)):e}function wi(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function bl(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Yt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.NumberFormat).bind.apply(t,Ir([void 0],r,!1)))},{cache:wi(e.number),strategy:Ur.variadic}),getDateTimeFormat:Yt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.DateTimeFormat).bind.apply(t,Ir([void 0],r,!1)))},{cache:wi(e.dateTime),strategy:Ur.variadic}),getPluralRules:Yt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.PluralRules).bind.apply(t,Ir([void 0],r,!1)))},{cache:wi(e.pluralRules),strategy:Ur.variadic})}}var $a=function(){function e(t,r,n,i){var o=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(a){var s=o.formatToParts(a);if(s.length===1)return s[0].value;var c=s.reduce(function(l,h){return!l.length||h.type!==z.literal||typeof l[l.length-1]!="string"?l.push(h.value):l[l.length-1]+=h.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(a){return Wt(o.ast,o.locales,o.formatters,o.formats,a,void 0,o.message)},this.resolvedOptions=function(){return{locale:o.resolvedLocale.toString()}},this.getAst=function(){return o.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=xl(e.formats,n),this.formatters=i&&i.formatters||bl(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=Na,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var Ha=$a;var vl=/[0-9\-+#]/,Al=/[^\d\-+#]/g;function Ua(e){return e.search(vl)}function El(e="#.##"){let t={},r=e.length,n=Ua(e);t.prefix=n>0?e.substring(0,n):"";let i=Ua(e.split("").reverse().join("")),o=r-i,a=e.substring(o,o+1),s=o+(a==="."||a===","?1:0);t.suffix=i>0?e.substring(s,r):"",t.mask=e.substring(n,s),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let c=t.mask.match(Al);return t.decimal=c&&c[c.length-1]||".",t.separator=c&&c[1]&&c[0]||",",c=t.mask.split(t.decimal),t.integer=c[0],t.fraction=c[1],t}function yl(e,t,r){let n=!1,i={value:e};e<0&&(n=!0,i.value=-i.value),i.sign=n?"-":"",i.value=Number(i.value).toFixed(t.fraction&&t.fraction.length),i.value=Number(i.value).toString();let o=t.fraction&&t.fraction.lastIndexOf("0"),[a="0",s=""]=i.value.split(".");return(!s||s&&s.length<=o)&&(s=o<0?"":(+("0."+s)).toFixed(o+1).replace("0.","")),i.integer=a,i.fraction=s,Sl(i,t),(i.result==="0"||i.result==="")&&(n=!1,i.sign=""),!n&&t.maskHasPositiveSign?i.sign="+":n&&t.maskHasPositiveSign?i.sign="-":n&&(i.sign=r&&r.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),i}function Sl(e,t){e.result="";let r=t.integer.split(t.separator),n=r.join(""),i=n&&n.indexOf("0");if(i>-1)for(;e.integer.length<n.length-i;)e.integer="0"+e.integer;else Number(e.integer)===0&&(e.integer="");let o=r[1]&&r[r.length-1].length;if(o){let a=e.integer.length,s=a%o;for(let c=0;c<a;c++)e.result+=e.integer.charAt(c),!((c-s+1)%o)&&c<a-o&&(e.result+=t.separator)}else e.result=e.integer;return e.result+=t.fraction&&e.fraction?t.decimal+e.fraction:"",e}function Tl(e,t,r={}){if(!e||isNaN(Number(t)))return t;let n=El(e),i=yl(t,n,r);return n.prefix+i.sign+i.result+n.suffix}var Da=Tl;var Ba=".",wl=",",za=/^\s+/,Fa=/\s+$/,Ga="&nbsp;",Li=e=>e*12,Ka=(e,t)=>{let{start:r,end:n,displaySummary:{amount:i,duration:o,minProductQuantity:a,outcomeType:s}={}}=e;if(!(i&&o&&s&&a))return!1;let c=t?new Date(t):new Date;if(!r||!n)return!1;let l=new Date(r),h=new Date(n);return c>=l&&c<=h},Be={MONTH:"MONTH",YEAR:"YEAR"},Ll={[N.ANNUAL]:12,[N.MONTHLY]:1,[N.THREE_YEARS]:36,[N.TWO_YEARS]:24},_i=(e,t)=>({accept:e,round:t}),_l=[_i(({divisor:e,price:t})=>t%e==0,({divisor:e,price:t})=>t/e),_i(({usePrecision:e})=>e,({divisor:e,price:t})=>Math.round(t/e*100)/100),_i(()=>!0,({divisor:e,price:t})=>Math.ceil(Math.floor(t*100/e)/100))],Ci={[H.YEAR]:{[N.MONTHLY]:Be.MONTH,[N.ANNUAL]:Be.YEAR},[H.MONTH]:{[N.MONTHLY]:Be.MONTH}},Cl=(e,t)=>e.indexOf(`'${t}'`)===0,Pl=(e,t=!0)=>{let r=e.replace(/'.*?'/,"").trim(),n=Ya(r);return!!n?t||(r=r.replace(/[,\.]0+/,n)):r=r.replace(/\s?(#.*0)(?!\s)?/,"$&"+Il(e)),r},kl=e=>{let t=Nl(e),r=Cl(e,t),n=e.replace(/'.*?'/,""),i=za.test(n)||Fa.test(n);return{currencySymbol:t,isCurrencyFirst:r,hasCurrencySpace:i}},ja=e=>e.replace(za,Ga).replace(Fa,Ga),Il=e=>e.match(/#(.?)#/)?.[1]===Ba?wl:Ba,Nl=e=>e.match(/'(.*?)'/)?.[1]??"",Ya=e=>e.match(/0(.?)0/)?.[1]??"";function bt({formatString:e,price:t,usePrecision:r,isIndianPrice:n=!1},i,o=a=>a){let{currencySymbol:a,isCurrencyFirst:s,hasCurrencySpace:c}=kl(e),l=r?Ya(e):"",h=Pl(e,r),d=r?2:0,u=o(t,{currencySymbol:a}),m=n?u.toLocaleString("hi-IN",{minimumFractionDigits:d,maximumFractionDigits:d}):Da(h,u),g=r?m.lastIndexOf(l):m.length,f=m.substring(0,g),T=m.substring(g+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,m).replace(/SYMBOL/,a),currencySymbol:a,decimals:T,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:i}}var Xa=e=>{let{commitment:t,term:r,usePrecision:n}=e,i=Ll[r]??1;return bt(e,i>1?Be.MONTH:Ci[t]?.[r],o=>{let a={divisor:i,price:o,usePrecision:n},{round:s}=_l.find(({accept:c})=>c(a));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(a)}`);return s(a)})},Wa=({commitment:e,term:t,...r})=>bt(r,Ci[e]?.[t]),qa=e=>{let{commitment:t,instant:r,price:n,originalPrice:i,priceWithoutDiscount:o,promotion:a,quantity:s=1,term:c}=e;if(t===H.YEAR&&c===N.MONTHLY){if(!a)return bt(e,Be.YEAR,Li);let{displaySummary:{outcomeType:l,duration:h,minProductQuantity:d=1}={}}=a;switch(l){case"PERCENTAGE_DISCOUNT":if(s>=d&&Ka(a,r)){let u=parseInt(h.replace("P","").replace("M",""));if(isNaN(u))return Li(n);let m=s*i*u,g=s*o*(12-u),f=Math.floor((m+g)*100)/100;return bt({...e,price:f},Be.YEAR)}default:return bt(e,Be.YEAR,()=>Li(o??n))}}return bt(e,Ci[t]?.[c])};var Ol={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at {alternativePrice}",strikethroughAriaLabel:"Regularly at {strikethroughPrice}"},Rl=ca("ConsonantTemplates/price"),Vl=/<\/?[^>]+(>|$)/g,G={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Ge={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel"},Ml="TAX_EXCLUSIVE",$l=e=>sa(e)?Object.entries(e).filter(([,t])=>mt(t)||Cr(t)||t===!0).reduce((t,[r,n])=>t+` ${r}${n===!0?"":'="'+oa(n)+'"'}`,""):"",K=(e,t,r,n=!1)=>`<span class="${e}${t?"":" "+G.disabled}"${$l(r)}>${n?ja(t):t??""}</span>`;function Hl(e,{accessibleLabel:t,currencySymbol:r,decimals:n,decimalsDelimiter:i,hasCurrencySpace:o,integer:a,isCurrencyFirst:s,recurrenceLabel:c,perUnitLabel:l,taxInclusivityLabel:h},d={}){let u=K(G.currencySymbol,r),m=K(G.currencySpace,o?"&nbsp;":""),g="";return s&&(g+=u+m),g+=K(G.integer,a),g+=K(G.decimalsDelimiter,i),g+=K(G.decimals,n),s||(g+=m+u),g+=K(G.recurrence,c,null,!0),g+=K(G.unitType,l,null,!0),g+=K(G.taxInclusivity,h,!0),K(e,g,{...d,"aria-label":t})}var W=({displayOptical:e=!1,displayStrikethrough:t=!1,displayAnnual:r=!1,instant:n=void 0}={})=>({country:i,displayFormatted:o=!0,displayRecurrence:a=!0,displayPerUnit:s=!1,displayTax:c=!1,language:l,literals:h={},quantity:d=1}={},{commitment:u,offerSelectorIds:m,formatString:g,price:f,priceWithoutDiscount:T,taxDisplay:L,taxTerm:b,term:y,usePrecision:I,promotion:R}={},U={})=>{Object.entries({country:i,formatString:g,language:l,price:f}).forEach(([ae,Zr])=>{if(Zr==null)throw new Error(`Argument "${ae}" is missing for osi ${m?.toString()}, country ${i}, language ${l}`)});let $={...Ol,...h},me=`${l.toLowerCase()}-${i.toUpperCase()}`;function Z(ae,Zr){let Jr=$[ae];if(Jr==null)return"";try{return new Ha(Jr.replace(Vl,""),me).format(Zr)}catch{return Rl.error("Failed to format literal:",Jr),""}}let Tt=t&&T?T:f,Xe=e?Xa:Wa;r&&(Xe=qa);let{accessiblePrice:wt,recurrenceTerm:pe,...fe}=Xe({commitment:u,formatString:g,instant:n,isIndianPrice:i==="IN",originalPrice:f,priceWithoutDiscount:T,price:e?f:Tt,promotion:R,quantity:d,term:y,usePrecision:I}),J=wt,Lt="";if(S(a)&&pe){let ae=Z(Ge.recurrenceAriaLabel,{recurrenceTerm:pe});ae&&(J+=" "+ae),Lt=Z(Ge.recurrenceLabel,{recurrenceTerm:pe})}let qr="";if(S(s)){qr=Z(Ge.perUnitLabel,{perUnit:"LICENSE"});let ae=Z(Ge.perUnitAriaLabel,{perUnit:"LICENSE"});ae&&(J+=" "+ae)}let _t="";S(c)&&b&&(_t=Z(L===Ml?Ge.taxExclusiveLabel:Ge.taxInclusiveLabel,{taxTerm:b}),_t&&(J+=" "+_t)),t&&(J=Z(Ge.strikethroughAriaLabel,{strikethroughPrice:J}));let Ct=G.container;if(e&&(Ct+=" "+G.containerOptical),t&&(Ct+=" "+G.containerStrikethrough),r&&(Ct+=" "+G.containerAnnual),S(o))return Hl(Ct,{...fe,accessibleLabel:J,recurrenceLabel:Lt,perUnitLabel:qr,taxInclusivityLabel:_t},U);let{currencySymbol:Ji,decimals:Cs,decimalsDelimiter:Ps,hasCurrencySpace:Qi,integer:ks,isCurrencyFirst:Is}=fe,We=[ks,Ps,Cs];Is?(We.unshift(Qi?"\xA0":""),We.unshift(Ji)):(We.push(Qi?"\xA0":""),We.push(Ji)),We.push(Lt,qr,_t);let Ns=We.join("");return K(Ct,Ns,U)},Za=()=>(e,t,r)=>{let i=(e.displayOldPrice===void 0||S(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${W()(e,t,r)}${i?"&nbsp;"+W({displayStrikethrough:!0})(e,t,r):""}`},Ja=()=>(e,t,r)=>{let{instant:n}=e;try{n||(n=new URLSearchParams(document.location.search).get("instant")),n&&(n=new Date(n))}catch{n=void 0}let i={...e,displayTax:!1,displayPerUnit:!1};return`${(e.displayOldPrice===void 0||S(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price?W({displayStrikethrough:!0})(i,t,r)+"&nbsp;":""}${W()(e,t,r)}${K(G.containerAnnualPrefix,"&nbsp;(")}${W({displayAnnual:!0,instant:n})(i,t,r)}${K(G.containerAnnualSuffix,")")}`},Qa=()=>(e,t,r)=>{let n={...e,displayTax:!1,displayPerUnit:!1};return`${W()(e,t,r)}${K(G.containerAnnualPrefix,"&nbsp;(")}${W({displayAnnual:!0})(n,t,r)}${K(G.containerAnnualSuffix,")")}`};var Pi=W(),ki=Za(),Ii=W({displayOptical:!0}),Ni=W({displayStrikethrough:!0}),Oi=W({displayAnnual:!0}),Ri=Qa(),Vi=Ja();var Ul=(e,t)=>{if(!(!ft(e)||!ft(t)))return Math.floor((t-e)/t*100)},es=()=>(e,t)=>{let{price:r,priceWithoutDiscount:n}=t,i=Ul(r,n);return i===void 0?'<span class="no-discount"></span>':`<span class="discount">${i}%</span>`};var Mi=es();var{freeze:qt}=Object,re=qt({...He}),ne=qt({...Q}),ze={STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"},$i=qt({...H}),Hi=qt({...ha}),Ui=qt({...N});var ts="mas-commerce-service";function rs(e,{once:t=!1}={}){let r=null;function n(){let i=document.querySelector(ts);i!==r&&(r=i,i&&e(i))}return document.addEventListener(nt,n,{once:t}),Fe(n),()=>document.removeEventListener(nt,n)}function Zt(e,{country:t,forceTaxExclusive:r,perpetual:n}){let i;if(e.length<2)i=e;else{let o=t==="GB"||n?"EN":"MULT",[a,s]=e;i=[a.language===o?a:s]}return r&&(i=i.map(di)),i}var Fe=e=>window.setTimeout(e);function vt(e,t=1){if(e==null)return[t];let r=(Array.isArray(e)?e:String(e).split(",")).map(xt).filter(ft);return r.length||(r=[t]),r}function Dr(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(ii)}function q(){return document.getElementsByTagName(ts)?.[0]}var Ke={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals"],serializableTypes:["Array","Object"],sampleRate:1,tags:"acom",isProdDomain:!1},ns=1e3,is=new Set;function Dl(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function os(e){if(e==null)return;let t=typeof e;if(t==="function")return e.name?`function ${e.name}`:"function";if(t==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:n,originatingRequest:i,status:o}=e;return[n,o,i].filter(Boolean).join(" ")}let r=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!Ke.serializableTypes.includes(r))return r}return e}function Bl(e,t){if(!Ke.ignoredProperties.includes(e))return os(t)}var Di={append(e){if(e.level!=="error")return;let{message:t,params:r}=e,n=[],i=[],o=t;r.forEach(l=>{l!=null&&(Dl(l)?n:i).push(l)}),n.length&&(o+=" "+n.map(os).join(" "));let{pathname:a,search:s}=window.location,c=`${Ke.delimiter}page=${a}${s}`;c.length>ns&&(c=`${c.slice(0,ns)}<trunc>`),o+=c,i.length&&(o+=`${Ke.delimiter}facts=`,o+=JSON.stringify(i,Bl)),is.has(o)||(is.add(o),window.lana?.log(o,Ke))}};function At(e){Object.assign(Ke,Object.fromEntries(Object.entries(e).filter(([t,r])=>t in Ke&&r!==""&&r!==null&&r!==void 0&&!Number.isNaN(r))))}var w=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflow:re.V3,checkoutWorkflowStep:ne.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,env:ze.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsBufferDelay:1,wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:Ve.PUBLISHED,wcsBufferLimit:1});var Bi=Object.freeze({LOCAL:"local",PROD:"prod",STAGE:"stage"});function Gl({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||w.language),t??(t=e?.split("_")?.[1]||w.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function Gi(e={}){let{commerce:t={}}=e,r=ze.PRODUCTION,n=Fn,i=O("checkoutClientId",t)??w.checkoutClientId,o=ye(O("checkoutWorkflow",t),re,w.checkoutWorkflow),a=ne.CHECKOUT;o===re.V3&&(a=ye(O("checkoutWorkflowStep",t),ne,w.checkoutWorkflowStep));let s=S(O("displayOldPrice",t),w.displayOldPrice),c=S(O("displayPerUnit",t),w.displayPerUnit),l=S(O("displayRecurrence",t),w.displayRecurrence),h=S(O("displayTax",t),w.displayTax),d=S(O("entitlement",t),w.entitlement),u=S(O("modal",t),w.modal),m=S(O("forceTaxExclusive",t),w.forceTaxExclusive),g=O("promotionCode",t)??w.promotionCode,f=vt(O("quantity",t)),T=O("wcsApiKey",t)??w.wcsApiKey,L=t?.env==="stage",b=Ve.PUBLISHED;["true",""].includes(t.allowOverride)&&(L=(O(Gn,t,{metadata:!1})?.toLowerCase()??t?.env)==="stage",b=ye(O(zn,t),Ve,b)),L&&(r=ze.STAGE,n=Kn);let I=xt(O("wcsBufferDelay",t),w.wcsBufferDelay),R=xt(O("wcsBufferLimit",t),w.wcsBufferLimit);return{...Gl(e),displayOldPrice:s,checkoutClientId:i,checkoutWorkflow:o,checkoutWorkflowStep:a,displayPerUnit:c,displayRecurrence:l,displayTax:h,entitlement:d,extraOptions:w.extraOptions,modal:u,env:r,forceTaxExclusive:m,promotionCode:g,quantity:f,wcsApiKey:T,wcsBufferDelay:I,wcsBufferLimit:R,wcsURL:n,landscape:b}}var zi={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},zl=Date.now(),Fi=new Set,Ki=new Set,as=new Map,ss={append({level:e,message:t,params:r,timestamp:n,source:i}){console[e](`${n}ms [${i}] %c${t}`,"font-weight: bold;",...r)}},cs={filter:({level:e})=>e!==zi.DEBUG},Fl={filter:()=>!1};function Kl(e,t,r,n,i){return{level:e,message:t,namespace:r,get params(){return n.length===1&&Gt(n[0])&&(n=n[0](),Array.isArray(n)||(n=[n])),n},source:i,timestamp:Date.now()-zl}}function jl(e){[...Ki].every(t=>t(e))&&Fi.forEach(t=>t(e))}function ls(e){let t=(as.get(e)??0)+1;as.set(e,t);let r=`${e} #${t}`,n={id:r,namespace:e,module:i=>ls(`${n.namespace}/${i}`),updateConfig:At};return Object.values(zi).forEach(i=>{n[i]=(o,...a)=>jl(Kl(i,o,e,a,r))}),Object.seal(n)}function Br(...e){e.forEach(t=>{let{append:r,filter:n}=t;Gt(n)&&Ki.add(n),Gt(r)&&Fi.add(r)})}function Yl(e={}){let{name:t}=e,r=S(O("commerce.debug",{search:!0,storage:!0}),t===Bi.LOCAL);return Br(r?ss:cs),t===Bi.PROD&&Br(Di),Y}function Xl(){Fi.clear(),Ki.clear()}var Y={...ls(Bn),Level:zi,Plugins:{consoleAppender:ss,debugFilter:cs,quietFilter:Fl,lanaAppender:Di},init:Yl,reset:Xl,use:Br};var Wl={[ce]:Vn,[Ee]:Mn,[le]:$n},ql={[ce]:Un,[le]:Dn},Et=class{constructor(t){p(this,"changes",new Map);p(this,"connected",!1);p(this,"dispose",pt);p(this,"error");p(this,"log");p(this,"options");p(this,"promises",[]);p(this,"state",Ee);p(this,"timer",null);p(this,"value");p(this,"version",0);p(this,"wrapperElement");this.wrapperElement=t}update(){[ce,Ee,le].forEach(t=>{this.wrapperElement.classList.toggle(Wl[t],t===this.state)})}notify(){(this.state===le||this.state===ce)&&(this.state===le?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===ce&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]),this.wrapperElement.dispatchEvent(new CustomEvent(ql[this.state],{bubbles:!0}))}attributeChangedCallback(t,r,n){this.changes.set(t,n),this.requestUpdate()}connectedCallback(){this.dispose=rs(()=>this.requestUpdate(!0))}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement})),this.dispose(),this.dispose=pt}onceSettled(){let{error:t,promises:r,state:n}=this;return le===n?Promise.resolve(this.wrapperElement):ce===n?Promise.reject(t):new Promise((i,o)=>{r.push({resolve:i,reject:o})})}toggleResolved(t,r,n){return t!==this.version?!1:(n!==void 0&&(this.options=n),this.state=le,this.value=r,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:r}),Fe(()=>this.notify()),!0)}toggleFailed(t,r,n){return t!==this.version?!1:(n!==void 0&&(this.options=n),this.error=r,this.state=ce,this.update(),this.log?.error("Failed:",{element:this.wrapperElement,error:r}),Fe(()=>this.notify()),!0)}togglePending(t){return this.version++,t&&(this.options=t),this.state=Ee,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!q()||this.timer)return;let r=Y.module("mas-element"),{error:n,options:i,state:o,value:a,version:s}=this;this.state=Ee,this.timer=Fe(async()=>{this.timer=null;let c=null;if(this.changes.size&&(c=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:c}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:c})),c||t)try{await this.wrapperElement.render?.()===!1&&this.state===Ee&&this.version===s&&(this.state=o,this.error=n,this.value=a,this.update(),this.notify())}catch(l){r.error("Failed to render mas-element: ",l),this.toggleFailed(this.version,l,i)}})}};function hs(e={}){return Object.entries(e).forEach(([t,r])=>{(r==null||r===""||r?.length===0)&&delete e[t]}),e}function Gr(e,t={}){let{tag:r,is:n}=e,i=document.createElement(r,{is:n});return i.setAttribute("is",n),Object.assign(i.dataset,hs(t)),i}function zr(e,t={}){return e instanceof HTMLElement?(Object.assign(e.dataset,hs(t)),e):null}var Zl="download",Jl="upgrade";function Fr(e,t={},r=""){let n=q();if(!n)return null;let{checkoutMarketSegment:i,checkoutWorkflow:o,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:l,perpetual:h,promotionCode:d,quantity:u,wcsOsi:m,extraOptions:g}=n.collectCheckoutOptions(t),f=Gr(e,{checkoutMarketSegment:i,checkoutWorkflow:o,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:l,perpetual:h,promotionCode:d,quantity:u,wcsOsi:m,extraOptions:g});return r&&(f.innerHTML=`<span style="pointer-events: none;">${r}</span>`),f}function Kr(e){return class extends e{constructor(){super(...arguments);p(this,"checkoutActionHandler");p(this,"masElement",new Et(this))}attributeChangedCallback(n,i,o){this.masElement.attributeChangedCallback(n,i,o)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}requestUpdate(n=!1){return this.masElement.requestUpdate(n)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(n={}){if(!this.isConnected)return!1;let i=q();if(!i)return!1;this.dataset.imsCountry||i.imsCountryPromise.then(d=>{d&&(this.dataset.imsCountry=d)},pt),n.imsCountry=null;let o=i.collectCheckoutOptions(n,this);if(!o.wcsOsi.length)return!1;let a;try{a=JSON.parse(o.extraOptions??"{}")}catch(d){this.masElement.log?.error("cannot parse exta checkout options",d)}let s=this.masElement.togglePending(o);this.setCheckoutUrl("");let c=i.resolveOfferSelectors(o),l=await Promise.all(c);l=l.map(d=>Zt(d,o)),o.country=this.dataset.imsCountry||o.country;let h=await i.buildCheckoutAction?.(l.flat(),{...a,...o},this);return this.renderOffers(l.flat(),o,{},h,s)}renderOffers(n,i,o={},a=void 0,s=void 0){if(!this.isConnected)return!1;let c=q();if(!c)return!1;if(i={...JSON.parse(this.dataset.extraOptions??"null"),...i,...o},s??(s=this.masElement.togglePending(i)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),a){this.classList.remove(Zl,Jl),this.masElement.toggleResolved(s,n,i);let{url:h,text:d,className:u,handler:m}=a;return h&&this.setCheckoutUrl(h),d&&(this.firstElementChild.innerHTML=d),u&&this.classList.add(...u.split(" ")),m&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=m.bind(this)),!0}else if(n.length){if(this.masElement.toggleResolved(s,n,i)){let h=c.buildCheckoutURL(n,i);return this.setCheckoutUrl(h),!0}}else{let h=new Error(`Not provided: ${i?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,h,i))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(n){}updateOptions(n={}){let i=q();if(!i)return!1;let{checkoutMarketSegment:o,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:h,perpetual:d,promotionCode:u,quantity:m,wcsOsi:g}=i.collectCheckoutOptions(n);return zr(this,{checkoutMarketSegment:o,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:h,perpetual:d,promotionCode:u,quantity:m,wcsOsi:g}),!0}}}var Jt=class Jt extends Kr(HTMLButtonElement){static createCheckoutButton(t={},r=""){return Fr(Jt,t,r)}setCheckoutUrl(t){this.setAttribute("data-href",t)}get href(){return this.getAttribute("data-href")}get isCheckoutButton(){return!0}clickHandler(t){if(this.checkoutActionHandler){this.checkoutActionHandler?.(t);return}this.href&&(window.location.href=this.href)}};p(Jt,"is","checkout-button"),p(Jt,"tag","button");var je=Jt;window.customElements.get(je.is)||window.customElements.define(je.is,je,{extends:je.tag});var Ql="#000000",eh="#F8D904",th=/(accent|primary|secondary)(-(outline|link))?/,rh="mas:product_code/",nh="daa-ll",jr="daa-lh",ih=["XL","L","M","S"];function oh(e,t,r){e.mnemonicIcon?.map((i,o)=>({icon:i,alt:e.mnemonicAlt[o]??"",link:e.mnemonicLink[o]??""}))?.forEach(({icon:i,alt:o,link:a})=>{if(a&&!/^https?:/.test(a))try{a=new URL(`https://${a}`).href.toString()}catch{a="#"}let s={slot:"icons",src:i,size:r?.size??"l"};o&&(s.alt=o),a&&(s.href=a);let c=te("merch-icon",s);t.append(c)})}function ah(e,t){e.badge&&(t.setAttribute("badge-text",e.badge),t.setAttribute("badge-color",e.badgeColor||Ql),t.setAttribute("badge-background-color",e.badgeBackgroundColor||eh))}function sh(e,t,r){r?.includes(e.size)&&t.setAttribute("size",e.size)}function ch(e,t,r){if(e.cardTitle&&r){let n={slot:r.slot},i=e.cardTitle,{maxCount:o}=r;if(o){let[a,s]=ds(e.cardTitle,o);a!==e.cardTitle&&(n.title=s,i=`${a.trim()}...`)}t.append(te(r.tag,n,i))}}function lh(e,t,r){e.subtitle&&r&&t.append(te(r.tag,{slot:r.slot},e.subtitle))}function hh(e,t,r){r?.includes(e.backgroundColor)&&t.setAttribute("background-color",e.backgroundColor)}function dh(e,t,r){if(r?.tag&&e.backgroundImage){let n={loading:"lazy",src:e.backgroundImage};e.backgroundImageAltText?n.alt=e.backgroundImageAltText:n.role="none",t.append(te(r.tag,{slot:r.slot},te("img",n)))}r?.attribute&&t.setAttribute(r.attribute,e.backgroundImage)}function uh(e,t,r){if(e.prices&&r){let n=te(r.tag,{slot:r.slot},e.prices);t.append(n)}}function mh(e,t,r){if(e.description&&r){let n={slot:r.slot},i=e.description,{maxCount:o}=r;if(o){let[a,s]=ds(e.description,o);a!==e.description&&(n.title=s,i=`${a.trim()}...`)}t.append(te(r.tag,n,i))}}function ds(e,t){let r=ph(e);if(r.length<=t)return[e,r];let n=0,i=!1,o=t-3<1?1:t-3;for(let a of e){if(n++,a==="<"&&(i=!0),a===">"){i=!1;continue}if(!i&&(o--,o===0))break}return[e.substring(0,n),r]}function ph(e){let t="",r=!1;for(let n of e){if(n==="<"&&(r=!0),n===">"){r=!1;continue}r||(t+=n)}return t}function fh(e,t,r,n){let o=customElements.get("checkout-button").createCheckoutButton({},e.innerHTML);o.setAttribute("tabindex",0);for(let h of e.attributes)["class","is"].includes(h.name)||o.setAttribute(h.name,h.value);o.firstElementChild?.classList.add("spectrum-Button-label");let a=t.ctas.size??"M",s=`spectrum-Button--${n}`,c=ih.includes(a)?`spectrum-Button--size${a}`:"spectrum-Button--sizeM",l=["spectrum-Button",s,c];return r&&l.push("spectrum-Button--outline"),o.classList.add(...l),o}function gh(e,t,r,n){let i="fill";r&&(i="outline");let o=te("sp-button",{treatment:i,variant:n,tabIndex:0,size:t.ctas.size??"m"},e);return o.addEventListener("click",a=>{a.target!==e&&(a.stopPropagation(),e.click())}),o}function xh(e,t){return e.classList.add("con-button"),t&&e.classList.add("blue"),e}function bh(e,t,r,n){if(e.ctas){let{slot:i}=r.ctas,o=te("div",{slot:i},e.ctas),a=[...o.querySelectorAll("a")].map(s=>{let c=s.parentElement.tagName==="STRONG";if(t.consonant)return xh(s,c);let l=th.exec(s.className)?.[0]??"accent",h=l.includes("accent"),d=l.includes("primary"),u=l.includes("secondary"),m=l.includes("-outline");if(l.includes("-link"))return s;let f;return h||c?f="accent":d?f="primary":u&&(f="secondary"),t.spectrum==="swc"?gh(s,r,m,f):fh(s,r,m,f)});o.innerHTML="",o.append(...a),t.append(o)}}function vh(e,t){let{tags:r}=e,n=r?.find(i=>i.startsWith(rh))?.split("/").pop();n&&(t.setAttribute(jr,n),t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]").forEach((i,o)=>{i.setAttribute(nh,`${i.dataset.analyticsId}-${o+1}`)}))}function Ah(e){e.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,r])=>{e.querySelectorAll(`a.${t}`).forEach(n=>{n.classList.remove(t),n.classList.add("spectrum-Link",`spectrum-Link--${r}`)})})}async function us(e,t){let{fields:r}=e,{variant:n}=r;if(!n)return;t.id=e.id,t.querySelectorAll("[slot]").forEach(o=>{o.remove()}),t.removeAttribute("background-image"),t.removeAttribute("background-color"),t.removeAttribute("badge-background-color"),t.removeAttribute("badge-color"),t.removeAttribute("badge-text"),t.removeAttribute("size"),t.classList.remove("wide-strip"),t.classList.remove("thin-strip"),t.removeAttribute(jr),t.variant=n,await t.updateComplete;let{aemFragmentMapping:i}=t.variantLayout;i&&(oh(r,t,i.mnemonics),ah(r,t),sh(r,t,i.allowedSizes),ch(r,t,i.title),lh(r,t,i.subtitle),uh(r,t,i.prices),dh(r,t,i.backgroundImage,n),hh(r,t,i.allowedColors),mh(r,t,i.description),bh(r,t,i,n),vh(r,t),Ah(t))}var Eh="merch-card",yh=":start",Sh=":ready",Th=1e4,ms="merch-card:",er,ji,Qt=class extends ee{constructor(){super();F(this,er);p(this,"customerSegment");p(this,"marketSegment");p(this,"variantLayout");this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this)}firstUpdated(){this.variantLayout=Yn(this,!1),this.variantLayout?.connectedCallbackHook(),this.aemFragment?.updateComplete.catch(()=>{this.style.display="none"})}willUpdate(r){(r.has("variant")||!this.variantLayout)&&(this.variantLayout=Yn(this),this.variantLayout.connectedCallbackHook())}updated(r){(r.has("badgeBackgroundColor")||r.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border",this.computedBorderStyle),this.variantLayout?.postCardUpdateHook(r)}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}get prices(){return Array.from(this.querySelectorAll('span[is="inline-price"][data-wcs-osi]'))}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["twp","ccd-slice","ccd-suggested"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector('span[is="inline-price"]')}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll('a[is="checkout-link"]')??[]]}async toggleStockOffer({target:r}){if(!this.stockOfferOsis)return;let n=this.checkoutLinks;if(n.length!==0)for(let i of n){await i.onceSettled();let o=i.value?.[0]?.planType;if(!o)return;let a=this.stockOfferOsis[o];if(!a)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==a);r.checked&&s.push(a),i.dataset.wcsOsi=s.join(",")}}handleQuantitySelection(r){let n=this.checkoutLinks;for(let i of n)i.dataset.quantity=r.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(r){let n={...this.filters};Object.keys(n).forEach(i=>{if(r){n[i].order=Math.min(n[i].order||2,2);return}let o=n[i].order;o===1||isNaN(o)||(n[i].order=Number(o)+1)}),this.filters=n}includes(r){return this.textContent.match(new RegExp(r,"i"))!==null}connectedCallback(){super.connectedCallback();let r=this.querySelector("aem-fragment")?.getAttribute("fragment");performance.mark(`${ms}${r}${yh}`),this.addEventListener(Er,this.handleQuantitySelection),this.addEventListener(kn,this.merchCardReady,{once:!0}),this.updateComplete.then(()=>{this.merchCardReady()}),this.storageOptions?.addEventListener("change",this.handleStorageChange),this.addEventListener(Re,this.handleAemFragmentEvents),this.addEventListener(Oe,this.handleAemFragmentEvents),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(Er,this.handleQuantitySelection),this.storageOptions?.removeEventListener(Ar,this.handleStorageChange),this.removeEventListener(Re,this.handleAemFragmentEvents),this.removeEventListener(Oe,this.handleAemFragmentEvents)}async handleAemFragmentEvents(r){if(r.type===Re&&ge(this,er,ji).call(this,"AEM fragment cannot be loaded"),r.type===Oe&&r.target.nodeName==="AEM-FRAGMENT"){let n=r.detail;await us(n,this),this.checkReady()}}async checkReady(){let r=Promise.all([...this.querySelectorAll('span[is="inline-price"][data-wcs-osi],a[is="checkout-link"][data-wcs-osi]')].map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(a=>a.classList.contains("placeholder-resolved"))),n=new Promise(o=>setTimeout(()=>o(!1),Th));if(await Promise.race([r,n])===!0){performance.mark(`${ms}${this.id}${Sh}`),this.dispatchEvent(new CustomEvent(On,{bubbles:!0,composed:!0}));return}ge(this,er,ji).call(this,"Contains unresolved offers")}get aemFragment(){return this.querySelector("aem-fragment")}get storageOptions(){return this.querySelector("sp-radio-group#storage")}get storageSpecificOfferSelect(){let r=this.storageOptions?.selected;if(r){let n=this.querySelector(`merch-offer-select[storage="${r}"]`);if(n)return n}return this.querySelector("merch-offer-select")}get offerSelect(){return this.storageOptions?this.storageSpecificOfferSelect:this.querySelector("merch-offer-select")}get quantitySelect(){return this.querySelector("merch-quantity-select")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let r=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll('a[is="checkout-link"].con-button')).length===2&&r&&r.parentElement.classList.add("footer-column")}merchCardReady(){this.offerSelect&&!this.offerSelect.planType||(this.dispatchEvent(new CustomEvent(In,{bubbles:!0})),this.displayFooterElementsInColumn())}handleStorageChange(){let r=this.closest("merch-card")?.offerSelect.cloneNode(!0);r&&this.dispatchEvent(new CustomEvent(Ar,{detail:{offerSelect:r},bubbles:!0}))}get dynamicPrice(){return this.querySelector('[slot="price"]')}selectMerchOffer(r){if(r===this.merchOffer)return;this.merchOffer=r;let n=this.dynamicPrice;if(r.price&&n){let i=r.price.cloneNode(!0);n.onceSettled?n.onceSettled().then(()=>{n.replaceWith(i)}):n.replaceWith(i)}}};er=new WeakSet,ji=function(r){this.dispatchEvent(new CustomEvent(Rn,{detail:r,bubbles:!0,composed:!0}))},p(Qt,"properties",{name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:r=>{let[n,i,o]=r.split(",");return{PUF:n,ABM:i,M2M:o}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:r=>Object.fromEntries(r.split(",").map(n=>{let[i,o,a]=n.split(":"),s=Number(o);return[i,{order:isNaN(s)?void 0:s,size:a}]})),toAttribute:r=>Object.entries(r).map(([n,{order:i,size:o}])=>[n,i,o].filter(a=>a!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:jr,reflect:!0}}),p(Qt,"styles",[Ho,Qo(),...Uo()]);customElements.define(Eh,Qt);var yt=class extends ee{constructor(){super(),this.size="m",this.alt=""}render(){let{href:t}=this;return t?x`<a href="${t}">
    ...
    `);customElements.define("merch-icon",yt);var xs=new CSSStyleSheet;xs.replaceSync(":host { display: contents; }");var wh=document.querySelector('meta[name="aem-base-url"]')?.content??"https://odin.adobe.com",ps="fragment",fs="author",Lh="ims",gs=e=>{throw new Error(`Failed to get fragment: ${e}`)};async function _h(e,t,r,n){let i=r?`${e}/adobe/sites/cf/fragments/${t}`:`${e}/adobe/sites/fragments/${t}`,o=await fetch(i,{cache:"default",credentials:"omit",headers:n}).catch(a=>gs(a.message));return o?.ok||gs(`${o.status} ${o.statusText}`),o.json()}var Yi,Se,Xi=class{constructor(){F(this,Se,new Map)}clear(){_(this,Se).clear()}add(...t){t.forEach(r=>{let{id:n}=r;n&&_(this,Se).set(n,r)})}has(t){return _(this,Se).has(t)}get(t){return _(this,Se).get(t)}remove(t){_(this,Se).delete(t)}};Se=new WeakMap;var Yr=new Xi,Ye,he,Te,tr,de,St,ue,qi,bs,vs,Wi=class extends HTMLElement{constructor(){super();F(this,ue);p(this,"cache",Yr);F(this,Ye);F(this,he);F(this,Te);F(this,tr,!1);F(this,de);F(this,St,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[xs];let r=this.getAttribute(Lh);["",!0,"true"].includes(r)&&(j(this,tr,!0),Yi||(Yi={Authorization:`Bearer ${window.adobeid?.authorize?.()}`}))}static get observedAttributes(){return[ps,fs]}attributeChangedCallback(r,n,i){r===ps&&(j(this,Te,i),this.refresh(!1)),r===fs&&j(this,St,["","true"].includes(i))}connectedCallback(){if(!_(this,Te)){ge(this,ue,qi).call(this,"Missing fragment id");return}}async refresh(r=!0){_(this,de)&&!await Promise.race([_(this,de),Promise.resolve(!1)])||(r&&Yr.remove(_(this,Te)),j(this,de,this.fetchData().then(()=>(this.dispatchEvent(new CustomEvent(Oe,{detail:this.data,bubbles:!0,composed:!0})),!0)).catch(n=>(ge(this,ue,qi).call(this,"Network error: failed to load fragment"),j(this,de,null),!1))),_(this,de))}async fetchData(){j(this,Ye,null),j(this,he,null);let r=Yr.get(_(this,Te));r||(r=await _h(wh,_(this,Te),_(this,St),_(this,tr)?Yi:void 0),Yr.add(r)),j(this,Ye,r)}get updateComplete(){return _(this,de)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return _(this,he)?_(this,he):(_(this,St)?ge(this,ue,bs).call(this):ge(this,ue,vs).call(this),_(this,he))}};Ye=new WeakMap,he=new WeakMap,Te=new WeakMap,tr=new WeakMap,de=new WeakMap,St=new WeakMap,ue=new WeakSet,qi=function(r){this.classList.add("error"),this.dispatchEvent(new CustomEvent(Re,{detail:r,bubbles:!0,composed:!0}))},bs=function(){let{fields:r,id:n,tags:i}=_(this,Ye);j(this,he,r.reduce((o,{name:a,multiple:s,values:c})=>(o.fields[a]=s?c:c[0],o),{fields:{},id:n,tags:i}))},vs=function(){let{fields:r,id:n,tags:i}=_(this,Ye);j(this,he,Object.entries(r).reduce((o,[a,s])=>(o.fields[a]=s?.mimeType?s.value:s??"",o),{fields:{},id:n,tags:i}))};customElements.define("aem-fragment",Wi);var rr=class rr extends Kr(HTMLAnchorElement){static createCheckoutLink(t={},r=""){return Fr(rr,t,r)}setCheckoutUrl(t){this.setAttribute("href",t)}get isCheckoutLink(){return!0}clickHandler(t){if(this.checkoutActionHandler){this.checkoutActionHandler?.(t);return}}};p(rr,"is","checkout-link"),p(rr,"tag","a");var ie=rr;window.customElements.get(ie.is)||window.customElements.define(ie.is,ie,{extends:ie.tag});function As({providers:e,settings:t}){function r(o,a){let{checkoutClientId:s,checkoutWorkflow:c,checkoutWorkflowStep:l,country:h,language:d,promotionCode:u,quantity:m}=t,{checkoutMarketSegment:g,checkoutWorkflow:f=c,checkoutWorkflowStep:T=l,imsCountry:L,country:b=L??h,language:y=d,quantity:I=m,entitlement:R,upgrade:U,modal:$,perpetual:me,promotionCode:Z=u,wcsOsi:Tt,extraOptions:Xe,...wt}=Object.assign({},a?.dataset??{},o??{}),pe=ye(f,re,w.checkoutWorkflow),fe=ne.CHECKOUT;pe===re.V3&&(fe=ye(T,ne,w.checkoutWorkflowStep));let J=gt({...wt,extraOptions:Xe,checkoutClientId:s,checkoutMarketSegment:g,country:b,quantity:vt(I,w.quantity),checkoutWorkflow:pe,checkoutWorkflowStep:fe,language:y,entitlement:S(R),upgrade:S(U),modal:S($),perpetual:S(me),promotionCode:zt(Z).effectivePromoCode,wcsOsi:Dr(Tt)});if(a)for(let Lt of e.checkout)Lt(a,J);return J}function n(o,a){if(!Array.isArray(o)||!o.length||!a)return"";let{env:s,landscape:c}=t,{checkoutClientId:l,checkoutMarketSegment:h,checkoutWorkflow:d,checkoutWorkflowStep:u,country:m,promotionCode:g,quantity:f,...T}=r(a),L=window.frameElement?"if":"fp",b={checkoutPromoCode:g,clientId:l,context:L,country:m,env:s,items:[],marketSegment:h,workflowStep:u,landscape:c,...T};if(o.length===1){let[{offerId:y,offerType:I,productArrangementCode:R}]=o,{marketSegments:[U]}=o[0];Object.assign(b,{marketSegment:U,offerType:I,productArrangementCode:R}),b.items.push(f[0]===1?{id:y}:{id:y,quantity:f[0]})}else b.items.push(...o.map(({offerId:y},I)=>({id:y,quantity:f[I]??w.quantity})));return Jn(d,b)}let{createCheckoutLink:i}=ie;return{CheckoutLink:ie,CheckoutWorkflow:re,CheckoutWorkflowStep:ne,buildCheckoutURL:n,collectCheckoutOptions:r,createCheckoutLink:i}}function Ch({interval:e=200,maxAttempts:t=25}={}){let r=Y.module("ims");return new Promise(n=>{r.debug("Waing for IMS to be ready");let i=0;function o(){window.adobeIMS?.initialized?n():++i>t?(r.debug("Timeout"),n()):setTimeout(o,e)}o()})}function Ph(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function kh(e){let t=Y.module("ims");return e.then(r=>r?window.adobeIMS.getProfile().then(({countryCode:n})=>(t.debug("Got user country:",n),n),n=>{t.error("Unable to get user country:",n)}):null)}function Es({}){let e=Ch(),t=Ph(e),r=kh(t);return{imsReadyPromise:e,imsSignedInPromise:t,imsCountryPromise:r}}async function Ss(e,t){let{data:r}=t||await Promise.resolve().then(()=>Gs(ys(),1));if(Array.isArray(r)){let n=o=>r.find(a=>_r(a.lang,o)),i=n(e.language)??n(w.language);if(i)return Object.freeze(i)}return{}}var Ts=["GB_en","AU_en","FR_fr","AT_de","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GR_el","GR_en","HU_hu","IE_en","IT_it","LU_de","LU_en","LU_fr","NL_nl","NO_nb","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TR_tr","UA_uk","ID_en","ID_in","IN_en","IN_hi","JP_ja","MY_en","MY_ms","NZ_en","TH_en","TH_th"],Nh={INDIVIDUAL_COM:["ZA_en","LT_lt","LV_lv","NG_en","SA_ar","SA_en","ZA_en","SG_en","KR_ko"],TEAM_COM:["ZA_en","LT_lt","LV_lv","NG_en","ZA_en","CO_es","KR_ko"],INDIVIDUAL_EDU:["LT_lt","LV_lv","SA_en","SG_en"],TEAM_EDU:["SG_en","KR_ko"]},nr=class nr extends HTMLSpanElement{constructor(){super();p(this,"masElement",new Et(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-perpetual","data-promotion-code","data-tax-exclusive","data-template","data-wcs-osi"]}static createInlinePrice(r){let n=q();if(!n)return null;let{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:d,template:u,wcsOsi:m}=n.collectPriceOptions(r);return Gr(nr,{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:d,template:u,wcsOsi:m})}get isInlinePrice(){return!0}attributeChangedCallback(r,n,i){this.masElement.attributeChangedCallback(r,n,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}resolveDisplayTaxForGeoAndSegment(r,n,i,o){let a=`${r}_${n}`;if(Ts.includes(r)||Ts.includes(a))return!0;let s=Nh[`${i}_${o}`];return s?!!(s.includes(r)||s.includes(a)):!1}async resolveDisplayTax(r,n){let[i]=await r.resolveOfferSelectors(n),o=Zt(await i,n);if(o?.length){let{country:a,language:s}=n,c=o[0],[l=""]=c.marketSegments;return this.resolveDisplayTaxForGeoAndSegment(a,s,c.customerSegment,l)}}async render(r={}){if(!this.isConnected)return!1;let n=q();if(!n)return!1;let i=n.collectPriceOptions(r,this);if(!i.wcsOsi.length)return!1;let o=this.masElement.togglePending(i);this.innerHTML="";let[a]=n.resolveOfferSelectors(i);return this.renderOffers(Zt(await a,i),i,o)}renderOffers(r,n={},i=void 0){if(!this.isConnected)return;let o=q();if(!o)return!1;let a=o.collectPriceOptions({...this.dataset,...n},this);if(i??(i=this.masElement.togglePending(a)),r.length){if(this.masElement.toggleResolved(i,r,a))return this.innerHTML=o.buildPriceHTML(r,a),!0}else{let s=new Error(`Not provided: ${a?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,s,a))return this.innerHTML="",!0}return!1}updateOptions(r){let n=q();if(!n)return!1;let{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:d,template:u,wcsOsi:m}=n.collectPriceOptions(r);return zr(this,{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:d,template:u,wcsOsi:m}),!0}};p(nr,"is","inline-price"),p(nr,"tag","span");var oe=nr;window.customElements.get(oe.is)||window.customElements.define(oe.is,oe,{extends:oe.tag});function ws({literals:e,providers:t,settings:r}){function n(a,s){let{country:c,displayOldPrice:l,displayPerUnit:h,displayRecurrence:d,displayTax:u,forceTaxExclusive:m,language:g,promotionCode:f,quantity:T}=r,{displayOldPrice:L=l,displayPerUnit:b=h,displayRecurrence:y=d,displayTax:I=u,forceTaxExclusive:R=m,country:U=c,language:$=g,perpetual:me,promotionCode:Z=f,quantity:Tt=T,template:Xe,wcsOsi:wt,...pe}=Object.assign({},s?.dataset??{},a??{}),fe=gt({...pe,country:U,displayOldPrice:S(L),displayPerUnit:S(b),displayRecurrence:S(y),displayTax:S(I),forceTaxExclusive:S(R),language:$,perpetual:S(me),promotionCode:zt(Z).effectivePromoCode,quantity:vt(Tt,w.quantity),template:Xe,wcsOsi:Dr(wt)});if(s)for(let J of t.price)J(s,fe);return fe}function i(a,s){if(!Array.isArray(a)||!a.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=Mi;break;case"strikethrough":l=Ni;break;case"optical":l=Ii;break;case"annual":l=Oi;break;default:s.country==="AU"&&a[0].planType==="ABM"?l=s.promotionCode?Vi:Ri:l=s.promotionCode?ki:Pi}let h=n(s);h.literals=Object.assign({},e.price,gt(s.literals??{}));let[d]=a;return d={...d,...d.priceDetails},l(h,d)}let o=oe.createInlinePrice;return{InlinePrice:oe,buildPriceHTML:i,collectPriceOptions:n,createInlinePrice:o}}function Ls({settings:e}){let t=Y.module("wcs"),{env:r,wcsApiKey:n}=e,i=new Map,o=new Map,a;async function s(d,u,m=!0){let g=Hn;t.debug("Fetching:",d);let f="",T,L=(b,y,I)=>`${b}: ${y?.status}, url: ${I.toString()}`;try{if(d.offerSelectorIds=d.offerSelectorIds.sort(),f=new URL(e.wcsURL),f.searchParams.set("offer_selector_ids",d.offerSelectorIds.join(",")),f.searchParams.set("country",d.country),f.searchParams.set("locale",d.locale),f.searchParams.set("landscape",r===ze.STAGE?"ALL":e.landscape),f.searchParams.set("api_key",n),d.language&&f.searchParams.set("language",d.language),d.promotionCode&&f.searchParams.set("promotion_code",d.promotionCode),d.currency&&f.searchParams.set("currency",d.currency),T=await fetch(f.toString(),{credentials:"omit"}),T.ok){let b=await T.json();t.debug("Fetched:",d,b);let y=b.resolvedOffers??[];y=y.map(kr),u.forEach(({resolve:I},R)=>{let U=y.filter(({offerSelectorIds:$})=>$.includes(R)).flat();U.length&&(u.delete(R),I(U))})}else T.status===404&&d.offerSelectorIds.length>1?(t.debug("Multi-osi 404, fallback to fetch-by-one strategy"),await Promise.allSettled(d.offerSelectorIds.map(b=>s({...d,offerSelectorIds:[b]},u,!1)))):g=yr}catch(b){g=yr,t.error(g,d,b)}m&&u.size&&(t.debug("Missing:",{offerSelectorIds:[...u.keys()]}),u.forEach(b=>{b.reject(new Error(L(g,T,f)))}))}function c(){clearTimeout(a);let d=[...o.values()];o.clear(),d.forEach(({options:u,promises:m})=>s(u,m))}function l(){let d=i.size;i.clear(),t.debug(`Flushed ${d} cache entries`)}function h({country:d,language:u,perpetual:m=!1,promotionCode:g="",wcsOsi:f=[]}){let T=`${u}_${d}`;d!=="GB"&&(u=m?"EN":"MULT");let L=[d,u,g].filter(b=>b).join("-").toLowerCase();return f.map(b=>{let y=`${b}-${L}`;if(!i.has(y)){let I=new Promise((R,U)=>{let $=o.get(L);if(!$){let me={country:d,locale:T,offerSelectorIds:[]};d!=="GB"&&(me.language=u),$={options:me,promises:new Map},o.set(L,$)}g&&($.options.promotionCode=g),$.options.offerSelectorIds.push(b),$.promises.set(b,{resolve:R,reject:U}),$.options.offerSelectorIds.length>=e.wcsBufferLimit?c():(t.debug("Queued:",$.options),a||(a=setTimeout(c,e.wcsBufferDelay)))});i.set(y,I)}return i.get(y)})}return{WcsCommitment:$i,WcsPlanType:Hi,WcsTerm:Ui,resolveOfferSelectors:h,flushWcsCache:l}}var Zi="mas-commerce-service",Oh="mas:start",Rh="mas:ready",Wr,_s,Xr=class extends HTMLElement{constructor(){super(...arguments);F(this,Wr);p(this,"promise",null)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(n,i,o)=>{let a=await r?.(n,i,this.imsSignedInPromise,o);return a||null})}async activate(){let r=_(this,Wr,_s),n=Object.freeze(Gi(r));At(r.lana);let i=Y.init(r.hostEnv).module("service");i.debug("Activating:",r);let o={price:{}};try{o.price=await Ss(n,r.commerce.priceLiterals)}catch{}let a={checkout:new Set,price:new Set},s={literals:o,providers:a,settings:n};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...As(s),...Es(s),...ws(s),...Ls(s),...jn,Log:Y,get defaults(){return w},get log(){return Y},get providers(){return{checkout(c){return a.checkout.add(c),()=>a.checkout.delete(c)},price(c){return a.price.add(c),()=>a.price.delete(c)}}},get settings(){return n}})),i.debug("Activated:",{literals:o,settings:n}),Fe(()=>{let c=new CustomEvent(nt,{bubbles:!0,cancelable:!1,detail:this});performance.mark(Rh),this.dispatchEvent(c)})}connectedCallback(){this.readyPromise||(performance.mark(Oh),this.readyPromise=this.activate())}disconnectedCallback(){this.readyPromise=null}flushWcsCache(){this.flushWcsCache(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCache(),document.querySelectorAll('span[is="inline-price"],a[is="checkout-link"]').forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers")}refreshFragments(){this.flushWcsCache(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh()),this.log.debug("Refreshed AEM fragments")}};Wr=new WeakSet,_s=function(){let r={hostEnv:{name:this.getAttribute("host-env")??"prod"},commerce:{env:this.getAttribute("env")},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate"),10),isProdDomain:this.getAttribute("host-env")==="prod"}};return["locale","country","language"].forEach(n=>{let i=this.getAttribute(n);i&&(r[n]=i)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(n=>{let i=this.getAttribute(n);if(i!=null){let o=n.replace(/-([a-z])/g,a=>a[1].toUpperCase());r.commerce[o]=i}}),r},p(Xr,"instance");window.customElements.get(Zi)||window.customElements.define(Zi,Xr);At({sampleRate:1});export{je as CheckoutButton,ie as CheckoutLink,re as CheckoutWorkflow,ne as CheckoutWorkflowStep,w as Defaults,oe as InlinePrice,Ve as Landscape,Y as Log,Zi as TAG_NAME_SERVICE,$i as WcsCommitment,Hi as WcsPlanType,Ui as WcsTerm,kr as applyPlanType,Gi as getSettings};
