...
merch-card[variant="catalog"] .payment-details {
  ...
  font-weight: 400;
  line-height: var(--consonant-merch-card-body-line-height);
}`;var lt=class extends R{constructor(r){super(r);g(this,"toggleActionMenu",r=>{let n=r?.type==="mouseleave"?!0:void 0,i=this.card.shadowRoot.querySelector('slot[name="action-menu-content"]');i&&(n||this.card.dispatchEvent(new CustomEvent(Ha,{bubbles:!0,composed:!0,detail:{card:this.card.name,type:"action-menu"}})),i.classList.toggle("hidden",n))})}renderLayout(){return x` <div class="body">
    ...
    <slot></slot>`}getGlobalCSS(){return za}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenu)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenu)}};g(lt,"variantStyle",$`
...
`;var ht=class extends R{constructor(t){super(t)}getGlobalCSS(){return Fa}renderLayout(){return x` <div class="body">
        <slot name="icons"></slot> ${this.badge}
        <slot name="heading-xs"></slot>
        <slot name="heading-m"></slot>
...
`;var zr=class extends R{constructor(t){super(t)}getGlobalCSS(){return ja}renderLayout(){return x`${this.cardImage}
    <div class="body">
...
`;var Fr=class extends R{constructor(t){super(t)}getGlobalCSS(){return Ka}renderLayout(){return x` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var Sl=32,ut=class extends R{constructor(r){super(r);g(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);g(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){Hr()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};g(ut,"variantStyle",$`
...
`;var mt=class extends R{constructor(t){super(t)}getGlobalCSS(){return Ya}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
...
`;var ze=class extends R{constructor(t){super(t)}getGlobalCSS(){return Xa}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return x` ${this.badge}
      <div class="body">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
          <slot name="body-xxs"></slot>
      ...
      ${this.secureLabelFooter}`}postCardUpdateHook(){Hr()||this.adjustProductBodySlots()}};g(ze,"variantStyle",$`
...
`;var dt=class extends R{constructor(t){super(t)}getGlobalCSS(){return Wa}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
        ${this.promoBottom?"":x`<slot name="promo-text"></slot><slot name="callout-content"></slot>`}
    ...
    <hr />
    ${this.secureLabelFooter}`}};g(dt,"variantStyle",$`
...
`;var pt=class extends R{constructor(t){super(t)}getGlobalCSS(){return qa}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return x`${this.cardImage}
          <div class="body">
...
`;var ft=class extends R{constructor(t){super(t)}getGlobalCSS(){return Za}renderLayout(){return x`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
      ...
      <footer><slot name="footer"></slot></footer>`}};g(ft,"variantStyle",$`
    :host([variant='twp']) {
      padding: 4px 10px 5px 10px;
    }
    .twp-badge {
  ...
  `);var Ci=(e,t=!1)=>{switch(e.variant){case"catalog":return new lt(e);case"ccd-action":return new ht(e);case"image":return new zr(e);case"inline-heading":return new Fr(e);case"mini-compare-chart":return new ut(e);case"plans":return new mt(e);case"product":return new ze(e);case"segment":return new dt(e);case"special-offers":return new pt(e);case"twp":return new ft(e);default:return t?void 0:new ze(e)}},Ja=()=>{let e=[];return e.push(lt.variantStyle),e.push(ht.variantStyle),e.push(ut.variantStyle),e.push(ze.variantStyle),e.push(mt.variantStyle),e.push(dt.variantStyle),e.push(pt.variantStyle),e.push(ft.variantStyle),e};var Qa=document.createElement("style");Qa.innerHTML=`
:root {
