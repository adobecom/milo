...
`,Va=()=>{let e=[R`
    ...
    `}get cardImage(){return g` <div class="image">
        ...
        ${this.badge}
          ...
          >`:"";return g`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}};x(Ht,"styleMap",{});var $=Ht;function Ee(e,t={},r){let n=document.createElement(e);r instanceof HTMLElement?n.appendChild(r):n.innerHTML=r;for(let[i,o]of Object.entries(t))n.setAttribute(i,o);return n}function $a(){return window.matchMedia("(max-width: 767px)").matches}function Ra(){return window.matchMedia("(max-width: 1024px)").matches}function Ua(e=1e3){return new Promise(t=>setTimeout(t,e))}var Da="merch-offer-select:ready",Ma="merch-card:ready",Ga="merch-card:action-menu-toggle";var Li="merch-storage:change",wi="merch-quantity-selector:change";var Ha=`
:root {
...
merch-card[variant="catalog"] .payment-details {
  ...
  font-weight: 400;
  line-height: var(--consonant-merch-card-body-line-height);
}`;var ct=class extends ${constructor(r){super(r);x(this,"toggleActionMenu",r=>{let n=r?.type==="mouseleave"?!0:void 0,i=this.card.shadowRoot.querySelector('slot[name="action-menu-content"]');i&&(n||this.card.dispatchEvent(new CustomEvent(Ga,{bubbles:!0,composed:!0,detail:{card:this.card.name,type:"action-menu"}})),i.classList.toggle("hidden",n))})}renderLayout(){return g` <div class="body">
    ...
    ${this.secureLabelFooter}`}getGlobalCSS(){return Ha}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenu)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenu)}};x(ct,"variantStyle",R`
...
`;var lt=class extends ${constructor(t){super(t)}getGlobalCSS(){return za}renderLayout(){return g` <div class="body">
        <slot name="icons"></slot> ${this.badge}
        <slot name="heading-xs"></slot>
        <slot name="heading-m"></slot>
...
`;var Hr=class extends ${constructor(t){super(t)}getGlobalCSS(){return Fa}renderLayout(){return g`${this.cardImage}
    <div class="body">
...
`;var zr=class extends ${constructor(t){super(t)}getGlobalCSS(){return Ka}renderLayout(){return g` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":g`<hr />`} ${this.secureLabelFooter}`}};var ja=`
  :root {
...
`;var Sl=32,ut,ht=class extends ${constructor(r){super(r);ee(this,ut);x(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);x(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?g`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}postCardUpdateHook(){$a()?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};ut=new WeakMap,x(ht,"variantStyle",R`
...
`;var mt=class extends ${constructor(t){super(t)}getGlobalCSS(){return Ba}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?g`<label id="stock-checkbox">
...
`;var zt=class extends ${constructor(t){super(t)}getGlobalCSS(){return Ya}renderLayout(){return g` ${this.badge}
      <div class="body">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
          <slot name="body-xxs"></slot>
...
`;var dt=class extends ${constructor(t){super(t)}getGlobalCSS(){return Xa}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return g` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
        ${this.promoBottom?"":g`<slot name="promo-text"></slot><slot name="callout-content"></slot>`}
    ...
    <hr />
    ${this.secureLabelFooter}`}};x(dt,"variantStyle",R`
...
`;var pt=class extends ${constructor(t){super(t)}getGlobalCSS(){return Wa}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return g`${this.cardImage}
          <div class="body">
...
`;var ft=class extends ${constructor(t){super(t)}getGlobalCSS(){return qa}renderLayout(){return g`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
      ...
      <footer><slot name="footer"></slot></footer>`}};x(ft,"variantStyle",R`
    :host([variant='twp']) {
      padding: 4px 10px 5px 10px;
    }
    .twp-badge {
  ...
  `);var Za=e=>{switch(e.variant){case"catalog":return new ct(e);case"ccd-action":return new lt(e);case"image":return new Hr(e);case"inline-heading":return new zr(e);case"mini-compare-chart":return new ht(e);case"plans":return new mt(e);case"product":return new zt(e);case"segment":return new dt(e);case"special-offers":return new pt(e);case"twp":return new ft(e);default:return new zt(e)}},Ja=()=>{let e=[];return e.push(ct.variantStyle),e.push(lt.variantStyle),e.push(ht.variantStyle),e.push(mt.variantStyle),e.push(dt.variantStyle),e.push(pt.variantStyle),e.push(ft.variantStyle),e};var Qa=document.createElement("style");Qa.innerHTML=`
:root {
...
`;document.head.appendChild(Qa);var El="merch-card",Ft=class extends ae{constructor(){super();x(this,"customerSegment");x(this,"marketSegment");x(this,"variantLayout");this.filters={},this.types="",this.selected=!1}updated(r){(r.has("badgeBackgroundColor")||r.has("borderColor"))&&(this.style.border=this.computedBorderStyle),this.updateComplete.then(async()=>{let i=Array.from(this.querySelectorAll('span[is="inline-price"][data-wcs-osi]')).filter(o=>!o.closest('[slot="callout-content"]'));await Promise.all(i.map(o=>o.onceSettled())),this.variantLayout.postCardUpdateHook(this)})}render(){if(!(!this.isConnected||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return this.variant!=="twp"?`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`:""}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector('span[is="inline-price"]')}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll('a[is="checkout-link"]')??[]]}async toggleStockOffer({target:r}){if(!this.stockOfferOsis)return;let n=this.checkoutLinks;if(n.length!==0)for(let i of n){await i.onceSettled();let o=i.value?.[0]?.planType;if(!o)return;let a=this.stockOfferOsis[o];if(!a)return;let c=i.dataset.wcsOsi.split(",").filter(s=>s!==a);r.checked&&c.push(a),i.dataset.wcsOsi=c.join(",")}}handleQuantitySelection(r){let n=this.checkoutLinks;for(let i of n)i.dataset.quantity=r.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(r){let n={...this.filters};Object.keys(n).forEach(i=>{if(r){n[i].order=Math.min(n[i].order||2,2);return}let o=n[i].order;o===1||isNaN(o)||(n[i].order=Number(o)+1)}),this.filters=n}includes(r){return this.textContent.match(new RegExp(r,"i"))!==null}get startingAt(){return this.classList.contains("starting-at")}connectedCallback(){super.connectedCallback(),this.variantLayout=Za(this),this.variantLayout.connectedCallbackHook(),this.setAttribute("tabindex",this.getAttribute("tabindex")??"0"),this.addEventListener(wi,this.handleQuantitySelection),this.addEventListener(Da,this.merchCardReady,{once:!0}),this.updateComplete.then(()=>{this.merchCardReady()}),this.storageOptions?.addEventListener("change",this.handleStorageChange)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout.disconnectedCallbackHook(),this.removeEventListener(wi,this.handleQuantitySelection),this.storageOptions?.removeEventListener(Li,this.handleStorageChange)}get storageOptions(){return this.querySelector("sp-radio-group#storage")}get storageSpecificOfferSelect(){let r=this.storageOptions?.selected;if(r){let n=this.querySelector(`merch-offer-select[storage="${r}"]`);if(n)return n}return this.querySelector("merch-offer-select")}get offerSelect(){return this.storageOptions?this.storageSpecificOfferSelect:this.querySelector("merch-offer-select")}get quantitySelect(){return this.querySelector("merch-quantity-select")}merchCardReady(){this.offerSelect&&!this.offerSelect.planType||this.dispatchEvent(new CustomEvent(Ma,{bubbles:!0}))}handleStorageChange(){let r=this.closest("merch-card")?.offerSelect.cloneNode(!0);r&&this.dispatchEvent(new CustomEvent(Li,{detail:{offerSelect:r},bubbles:!0}))}get dynamicPrice(){return this.querySelector('[slot="price"]')}selectMerchOffer(r){if(r===this.merchOffer)return;this.merchOffer=r;let n=this.dynamicPrice;if(r.price&&n){let i=r.price.cloneNode(!0);n.onceSettled?n.onceSettled().then(()=>{n.replaceWith(i)}):n.replaceWith(i)}}};x(Ft,"properties",{name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color"},borderColor:{type:String,attribute:"border-color"},badgeBackgroundColor:{type:String,attribute:"badge-background-color"},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuContent:{type:String,attribute:"action-menu-content"},customHr:{type:Boolean,attribute:"custom-hr"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:r=>{let[n,i,o]=r.split(",");return{PUF:n,ABM:i,M2M:o}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:r=>Object.fromEntries(r.split(",").map(n=>{let[i,o,a]=n.split(":"),c=Number(o);return[i,{order:isNaN(c)?void 0:c,size:a}]})),toAttribute:r=>Object.entries(r).map(([n,{order:i,size:o}])=>[n,i,o].filter(a=>a!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object}}),x(Ft,"styles",[ka,Ja(),...Va()]);customElements.define(El,Ft);var gt=class extends ae{constructor(){super(),this.size="m",this.alt=""}render(){let{href:t}=this;return t?g`<a href="${t}">
    ...
    `);customElements.define("merch-icon",gt);var He="Network error",Kt,Fr=class{constructor(t){ee(this,Kt);x(this,"sites",{cf:{fragments:{search:this.searchFragment.bind(this),getByPath:this.getFragmentByPath.bind(this),getById:this.getFragmentById.bind(this),save:this.saveFragment.bind(this),copy:this.copyFragmentClassic.bind(this),publish:this.publishFragment.bind(this),delete:this.deleteFragment.bind(this)}}});te(this,Kt,/^author-/.test(t));let r=`https://${t}.adobeaemcloud.com`,n=`${r}/adobe/sites`;this.cfFragmentsUrl=`${n}/cf/fragments`,this.cfSearchUrl=`${this.cfFragmentsUrl}/search`,this.cfPublishUrl=`${this.cfFragmentsUrl}/publish`,this.wcmcommandUrl=`${r}/bin/wcmcommand`,this.csrfTokenUrl=`${r}/libs/granite/csrf/token.json`,this.headers={Authorization:`Bearer ${sessionStorage.getItem("masAccessToken")??window.adobeid?.authorize?.()}`,pragma:"no-cache","cache-control":"no-cache"}}async getCsrfToken(){let t=await fetch(this.csrfTokenUrl,{headers:this.headers}).catch(n=>{throw new Error(`${He}: ${n.message}`)});if(!t.ok)throw new Error(`Failed to get CSRF token: ${t.status} ${t.statusText}`);let{token:r}=await t.json();return r}async searchFragment({path:t,query:r,variant:n}){let i={};t&&(i.path=t),r&&(i.fullText={text:encodeURIComponent(r),queryMode:"EXACT_WORDS"});let o=new URLSearchParams({query:JSON.stringify({filter:i})}).toString(),a=await fetch(`${this.cfSearchUrl}?${o}`,{headers:this.headers}).catch(h=>{throw new Error(`${He}: ${h.message}`)});if(!a.ok)throw new Error(`Search failed: ${a.status} ${a.statusText}`);let s=(await a.json()).items;return n&&(s=s.filter(h=>{let[l]=h.fields.find(u=>u.name==="variant")?.values;return l===n})),s}async getFragmentByPath(t){let r=G(this,Kt)?this.headers:{},n=await fetch(`${this.cfFragmentsUrl}?path=${t}`,{headers:r}).catch(o=>{throw new Error(`${He}: ${o.message}`)});if(!n.ok)throw new Error(`Failed to get fragment: ${n.status} ${n.statusText}`);let{items:i}=await n.json();if(!i||i.length===0)throw new Error("Fragment not found");return i[0]}async getFragment(t){let r=t.headers.get("Etag"),n=await t.json();return n.etag=r,n}async getFragmentById(t){let r=await fetch(`${this.cfFragmentsUrl}/${t}`,{headers:this.headers});if(!r.ok)throw new Error(`Failed to get fragment: ${r.status} ${r.statusText}`);return await this.getFragment(r)}async saveFragment(t){let{title:r,fields:n}=t,i=await fetch(`${this.cfFragmentsUrl}/${t.id}`,{method:"PUT",headers:{"Content-Type":"application/json","If-Match":t.etag,...this.headers},body:JSON.stringify({title:r,fields:n})}).catch(o=>{throw new Error(`${He}: ${o.message}`)});if(!i.ok)throw new Error(`Failed to save fragment: ${i.status} ${i.statusText}`);return await this.getFragment(i)}async copyFragmentClassic(t){let r=await this.getCsrfToken(),n=t.path.split("/").slice(0,-1).join("/"),i=new FormData;i.append("cmd","copyPage"),i.append("srcPath",t.path),i.append("destParentPath",n),i.append("shallow","false"),i.append("_charset_","UTF-8");let o=await fetch(this.wcmcommandUrl,{method:"POST",headers:{...this.headers,"csrf-token":r},body:i}).catch(m=>{throw new Error(`${He}: ${m.message}`)});if(!o.ok)throw new Error(`Failed to copy fragment: ${o.status} ${o.statusText}`);let a=await o.text(),l=new DOMParser().parseFromString(a,"text/html").getElementById("Message")?.textContent.trim();if(!l)throw new Error("Failed to extract new path from copy response");await Ua();let u=await this.getFragmentByPath(l);return u&&(u=await this.getFragmentById(u.id)),u}async publishFragment(t){let r=await fetch(this.cfPublishUrl,{method:"POST",headers:{"Content-Type":"application/json","If-Match":t.etag,...this.headers},body:JSON.stringify({paths:[t.path],filterReferencesByStatus:["DRAFT","UNPUBLISHED"],workflowModelId:"/var/workflow/models/scheduled_activation_with_references"})}).catch(n=>{throw new Error(`${He}: ${n.message}`)});if(!r.ok)throw new Error(`Failed to publish fragment: ${r.status} ${r.statusText}`);return await r.json()}async deleteFragment(t){let r=await fetch(`${this.cfFragmentsUrl}/${t.id}`,{method:"DELETE",headers:{"Content-Type":"application/json","If-Match":t.etag,...this.headers}}).catch(n=>{throw new Error(`${He}: ${n.message}`)});if(!r.ok)throw new Error(`Failed to delete fragment: ${r.status} ${r.statusText}`);return r}};Kt=new WeakMap;var Tl="aem-bucket",yl="publish-p22655-e155390",Kr={CATALOG:"catalog",AH:"ah",CCD_ACTION:"ccd-action",SPECIAL_OFFERS:"special-offers"},_l={[Kr.CATALOG]:{title:{tag:"h3",slot:"heading-xs"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{size:"l"}},[Kr.AH]:{title:{tag:"h3",slot:"heading-xxs"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xxs"},ctas:{size:"s"}},[Kr.CCD_ACTION]:{title:{tag:"h3",slot:"heading-xs"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{size:"l"}},[Kr.SPECIAL_OFFERS]:{name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{size:"l"}}};async function Ll(e,t,r,n){let i=e.fields.reduce((c,{name:s,multiple:h,values:l})=>(c[s]=h?l:l[0],c),{id:e.id});i.model=i.model;let{variant:o="catalog"}=i;r.setAttribute("variant",o);let a=_l[o]??"catalog";if(i.mnemonicIcon?.forEach((c,s)=>{let h=i.mnemonicLink?.length>s?i.mnemonicLink[s]:"",l=i.mnemonicAlt?.length>s?i.mnemonicAlt[s]:"",u=Ee("merch-icon",{slot:"icons",src:c,alt:l,href:h,size:"l"});t(u)}),i.cardTitle&&a.title&&t(Ee(a.title.tag,{slot:a.title.slot},i.cardTitle)),i.backgroundImage&&a.backgroundImage&&t(Ee(a.backgroundImage.tag,{slot:a.backgroundImage.slot},`<img loading="lazy" src="${i.backgroundImage}" width="600" height="362">`)),i.prices&&a.prices){let c=i.prices,s=Ee(a.prices.tag,{slot:a.prices.slot},c);t(s)}if(i.description&&a.description){let c=Ee(a.description.tag,{slot:a.description.slot},i.description);t(c)}if(i.ctas){let c=Ee("div",{slot:"footer"},i.ctas),s=[];[...c.querySelectorAll("a")].forEach(h=>{let l=h.parentElement.tagName==="STRONG";if(n)h.classList.add("con-button"),l&&h.classList.add("blue"),s.push(h);else{let d=Ee("sp-button",{treatment:l?"fill":"outline",variant:l?"accent":"primary"},h);d.addEventListener("click",f=>{f.stopPropagation(),h.click()}),s.push(d)}}),c.innerHTML="",c.append(...s),t(c)}}var Te,Ci=class{constructor(){ee(this,Te,new Map)}clear(){G(this,Te).clear()}add(...t){t.forEach(r=>{let{path:n}=r;n&&G(this,Te).set(n,r)})}has(t){return G(this,Te).has(t)}get(t){return G(this,Te).get(t)}remove(t){G(this,Te).delete(t)}};Te=new WeakMap;var Pi=new Ci,jt,ze,Ii=class extends HTMLElement{constructor(){super(...arguments);ee(this,jt);x(this,"cache",Pi);x(this,"refs",[]);x(this,"path");x(this,"consonant",!1);ee(this,ze)}static get observedAttributes(){return["source","path","consonant"]}attributeChangedCallback(r,n,i){this[r]=i}connectedCallback(){this.consonant=this.hasAttribute("consonant"),this.clearRefs();let r=this.getAttribute(Tl)??yl;te(this,jt,new Fr(r)),this.refresh(!1)}clearRefs(){this.refs.forEach(r=>{r.remove()})}async refresh(r=!0){this.path&&(G(this,ze)&&!await Promise.race([G(this,ze),Promise.resolve(!1)])||(this.clearRefs(),this.refs=[],r&&this.cache.remove(this.path),te(this,ze,this.fetchData().then(()=>!0))))}async fetchData(){let r=Pi.get(this.path);if(r||(r=await G(this,jt).sites.cf.fragments.getByPath(this.path),Pi.add(r)),r){Ll(r,i=>{this.parentElement.appendChild(i),this.refs.push(i)},this.parentElement,this.consonant);return}}get updateComplete(){return G(this,ze)??Promise.reject(new Error("datasource is not correctly configured"))}};jt=new WeakMap,ze=new WeakMap;customElements.define("merch-datasource",Ii);var{searchParams:es}=new URL(import.meta.url),wl=es.get("locale")??"US_en",ts=es.get("env")==="stage",Pl=ts?"stage":"prod",Cl=ts?"STAGE":"PROD",Il=()=>({env:{name:Pl},commerce:{"commerce.env":Cl},locale:{prefix:wl}}),Nl=It(Il),of=Nl;export{of as default};
