...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
    ...
    <slot></slot>`}getGlobalCSS(){return Ha}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenu)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenu)}};x(st,"variantStyle",R`
...
`;var ct=class extends V{constructor(t){super(t)}getGlobalCSS(){return za}renderLayout(){return g` <div class="body">
        <slot name="icons"></slot> ${this.badge}
        <slot name="heading-xs"></slot>
        <slot name="heading-m"></slot>
...
`;var Hr=class extends V{constructor(t){super(t)}getGlobalCSS(){return Fa}renderLayout(){return g`${this.cardImage}
    <div class="body">
...
`;var zr=class extends V{constructor(t){super(t)}getGlobalCSS(){return ja}renderLayout(){return g` ${this.badge}
    ...
    ${this.card.customHr?"":g`<hr />`} ${this.secureLabelFooter}`}};var Ka=`
  :root {
...
`;var Sl=32,ht,lt=class extends V{constructor(r){super(r);ce(this,ht);x(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);x(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?g`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}postCardUpdateHook(){Va()?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};ht=new WeakMap,x(lt,"variantStyle",R`
...
`;var ut=class extends V{constructor(t){super(t)}getGlobalCSS(){return Ba}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?g`<label id="stock-checkbox">
...
`;var Ht=class extends V{constructor(t){super(t)}getGlobalCSS(){return Ya}renderLayout(){return g` ${this.badge}
      <div class="body">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
          <slot name="body-xxs"></slot>
...
`;var mt=class extends V{constructor(t){super(t)}getGlobalCSS(){return Xa}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return g` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
        ${this.promoBottom?"":g`<slot name="promo-text"></slot><slot name="callout-content"></slot>`}
...
`;var dt=class extends V{constructor(t){super(t)}getGlobalCSS(){return Wa}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return g`${this.cardImage}
          <div class="body">
...
`;var pt=class extends V{constructor(t){super(t)}getGlobalCSS(){return qa}renderLayout(){return g`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
  ...
  `);var Za=e=>{switch(e.variant){case"catalog":return new st(e);case"ccd-action":return new ct(e);case"image":return new Hr(e);case"inline-heading":return new zr(e);case"mini-compare-chart":return new lt(e);case"plans":return new ut(e);case"product":return new Ht(e);case"segment":return new mt(e);case"special-offers":return new dt(e);case"twp":return new pt(e);default:return new Ht(e)}},Ja=()=>{let e=[];return e.push(st.variantStyle),e.push(ct.variantStyle),e.push(lt.variantStyle),e.push(ut.variantStyle),e.push(mt.variantStyle),e.push(dt.variantStyle),e.push(pt.variantStyle),e};var Qa=document.createElement("style");Qa.innerHTML=`
:root {
