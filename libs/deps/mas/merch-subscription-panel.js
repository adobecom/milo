...
`;var L='span[is="inline-price"][data-wcs-osi]',g='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',v=`${L},${g}`;var l="merch-offer-select:ready";var E="merch-offer:selected",d="merch-stock:change";var p="merch-quantity-selector:change";var A="(max-width: 1199px)";var c,r=class extends N{constructor(){super();S(this,c,new i(this,A));this.ready=!1,this.continueText="Continue"}get listLayout(){return n`
