...
`;var L='span[is="inline-price"][data-wcs-osi]',N='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var b=`${L},${N}`;var l="merch-offer-select:ready";var E="merch-offer:selected",d="merch-stock:change";var p="merch-quantity-selector:change";var A="(max-width: 1199px)";var n,r=class extends O{constructor(){super();S(this,n,new i(this,A));this.ready=!1,this.continueText="Continue"}get listLayout(){return c`
