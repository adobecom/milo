var Ne=Object.defineProperty;var de=i=>{throw TypeError(i)};var Oe=(i,t,e)=>t in i?Ne(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var n=(i,t,e)=>Oe(i,typeof t!="symbol"?t+"":t,e),le=(i,t,e)=>t.has(i)||de("Cannot "+e);var m=(i,t,e)=>(le(i,t,"read from private field"),e?e.call(i):t.get(i)),U=(i,t,e)=>t.has(i)?de("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),G=(i,t,e,r)=>(le(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e);import{html as N,css as We,unsafeCSS as Pe,LitElement as Qe,nothing as f}from"../lit-all.min.js";var x="(max-width: 767px)",w="(max-width: 1199px)",d="(min-width: 768px)",c="(min-width: 1200px)",b="(min-width: 1600px)";function B(){return window.matchMedia(x)}function V(){return window.matchMedia(c)}function j(){return B().matches}function q(){return V().matches}var z=class{constructor(t,e){this.key=Symbol("match-media-key"),this.matches=!1,this.host=t,this.host.addController(this),this.media=window.matchMedia(e),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),t.addController(this)}hostConnected(){var t;(t=this.media)==null||t.addEventListener("change",this.onChange)}hostDisconnected(){var t;(t=this.media)==null||t.removeEventListener("change",this.onChange)}onChange(t){this.matches!==t.matches&&(this.matches=t.matches,this.host.requestUpdate(this.key,!this.matches))}};import{html as Y,nothing as ze}from"../lit-all.min.js";var E,$=class ${constructor(t){n(this,"card");U(this,E);this.card=t,this.insertVariantStyle()}getContainer(){return G(this,E,m(this,E)??this.card.closest('[class*="-merch-cards"]')??this.card.parentElement),m(this,E)}insertVariantStyle(){if(!$.styleMap[this.card.variant]){$.styleMap[this.card.variant]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(t,e){if(!t)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,a=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),o=parseInt(this.getContainer().style.getPropertyValue(r))||0;a>o&&this.getContainer().style.setProperty(r,`${a}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Y`
            <div
                id="badge"
        ...
        `}get cardImage(){return Y` <div class="image">
            ...
            >`:ze}get secureLabelFooter(){return Y`<footer>${this.secureLabel}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,e=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||e===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-e-16)}px`)}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){return he(this.card.variant)}};E=new WeakMap,n($,"styleMap",{});var s=$;import{html as ee,css as De}from"../lit-all.min.js";var ct=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),st=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var v='span[is="inline-price"][data-wcs-osi]',$e='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var Ie='a[is="upt-link"]',dt=`${v},${$e},${Ie}`;var me="merch-card:action-menu-toggle";var Z="merch-card-collection:literals-changed",J="merch-card-collection:sidenav-attached";var lt=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var ht=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var pe="legal";var S={alphabetical:"alphabetical",authored:"authored"};var I=(i,t)=>i?.querySelector(`[slot="${t}"]`)?.textContent?.trim();function T(i,t={},e=null,r=null){let a=r?document.createElement(i,{is:r}):document.createElement(i);e instanceof HTMLElement?a.appendChild(e):a.innerHTML=e;for(let[o,l]of Object.entries(t))a.setAttribute(o,l);return a}function ge(){return window.matchMedia("(max-width: 1024px)").matches}var ue=`
:root {
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            ${this.card.actionMenuContent?"":"hidden"}"
                ...
                ${this.promoBottom?"":ee`<slot name="promo-text"></slot
            ...
            <slot></slot>`}getGlobalCSS(){return ue}setAriaExpanded(e,r){e.setAttribute("aria-expanded",r)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};n(A,"variantStyle",De`
    ...
    `);import{html as D}from"../lit-all.min.js";var fe=`
:root {
...
`;var K=class extends s{constructor(t){super(t)}getGlobalCSS(){return fe}renderLayout(){return D`${this.cardImage}
    <div class="body">
    ...
    ${this.evergreen?D`
          ...
          `:D`
              <hr />
              ${this.secureLabelFooter}
          `}`}};import{html as be}from"../lit-all.min.js";var ve=`
:root {
...
`;var W=class extends s{constructor(t){super(t)}getGlobalCSS(){return ve}renderLayout(){return be` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":be`<hr />`} ${this.secureLabelFooter}`}};import{html as C,css as Fe,unsafeCSS as te}from"../lit-all.min.js";var ye=`
  :root {
...
`;var He=32,_=class extends s{constructor(e){super(e);n(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);n(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?C`<slot name="secure-transaction-label">
              <span class="secure-transaction-label"
                  >${this.card.secureLabel}</span
              ></slot
          >`:C`<slot name="secure-transaction-label"></slot>`;return C`<footer>${e}<slot name="footer"></slot></footer>`})}getGlobalCSS(){return ye}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2)return;this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".top-section"),"top-section");let e=["heading-m","body-m","heading-m-price","body-xxs","price-commitment","offers","promo-text","callout-content","addon"];this.card.classList.contains("bullet-list")&&e.push("footer-rows"),e.forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a)),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector("footer"),"footer");let r=this.card.shadowRoot.querySelector(".mini-compare-chart-badge");r&&r.textContent!==""&&this.getContainer().style.setProperty("--consonant-merch-card-mini-compare-chart-top-section-mobile-height","32px")}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.querySelector('[slot="footer-rows"] ul');!e||!e.children||[...e.children].forEach((r,a)=>{let o=Math.max(He,parseFloat(window.getComputedStyle(r).height)||0),l=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(a+1)))||0;o>l&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(a+1),`${o}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(r=>{let a=r.querySelector(".footer-row-cell-description");a&&!a.textContent.trim()&&r.remove()})}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${v}[data-template="price"]`)}get headingMPriceSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-m-price"]')?.assignedElements()[0]}toggleAddon(e){let r=this.mainPrice,a=this.headingMPriceSlot;if(!r&&a){let o=e?.getAttribute("plan-type"),l=null;if(e&&o&&(l=e.querySelector(`p[data-plan-type="${o}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-m-price"]').forEach(h=>h.remove()),e.checked){if(l){let h=T("p",{class:"addon-heading-m-price-addon",slot:"heading-m-price"},l.innerHTML);this.card.appendChild(h)}}else{let h=T("p",{class:"card-heading",id:"free",slot:"heading-m-price"},"Free");this.card.appendChild(h)}}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;let r=this.mainPrice,a=this.card.planType;r&&(await r.onceSettled(),a=r.value?.[0]?.planType),a&&(e.planType=a)}renderLayout(){return C` <div class="top-section${this.badge?" badge":""}">
            <slot name="icons"></slot> ${this.badge}
        </div>
        <slot name="heading-m"></slot>
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(e=>e.onceSettled())),await this.adjustAddon(),j()?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};n(_,"variantStyle",Fe`
  ...
  `);import{html as F,css as Ue,nothing as Q}from"../lit-all.min.js";var we=`
:root {
...
`;var X={title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ee={...function(){let{whatsIncluded:i,size:t,...e}=X;return e}(),title:{tag:"h3",slot:"heading-s"},subtitle:{tag:"p",slot:"subtitle"},secureLabel:!1},Se={...function(){let{whatsIncluded:i,size:t,quantitySelect:e,...r}=X;return r}()},p=class extends s{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,e){t.dataset.template===pe&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return we}adjustSlotPlacement(t,e,r){let a=this.card.shadowRoot,o=a.querySelector("footer"),l=this.card.getAttribute("size"),h=a.querySelector(`footer slot[name="${t}"]`),H=a.querySelector(`.body slot[name="${t}"]`),se=a.querySelector(".body");if((!l||!l.includes("wide"))&&(o?.classList.remove("wide-footer"),h&&h.remove()),!!e.includes(l)){if(o?.classList.toggle("wide-footer",q()),!r&&h){if(H)h.remove();else{let y=se.querySelector(`[data-placeholder-for="${t}"]`);y?y.replaceWith(h):se.appendChild(h)}return}if(r&&H){let y=document.createElement("div");if(y.setAttribute("data-placeholder-for",t),y.classList.add("slot-placeholder"),!h){let ke=H.cloneNode(!0);o.prepend(ke)}H.replaceWith(y)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],q()),this.adjustSlotPlacement("callout-content",["super-wide"],q())}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.remove("hide-tooltip")}))}adjustPrices(){this.headingM&&(this.headingM.setAttribute("role","heading"),this.headingM.setAttribute("aria-level","2"))}postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustLegal(),this.adjustAddon(),this.adjustCallout(),this.adjustPrices()}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${v}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?F`<div class="divider"></div>`:Q}async adjustLegal(){if(await this.card.updateComplete,await customElements.whenDefined("inline-price"),this.legalAdjusted)return;this.legalAdjusted=!0;let t=[],e=this.card.querySelector(`[slot="heading-m"] ${v}[data-template="price"]`);e&&t.push(e);let r=t.map(async a=>{let o=a.cloneNode(!0);await a.onceSettled(),a?.options&&(a.options.displayPerUnit&&(a.dataset.displayPerUnit="false"),a.options.displayTax&&(a.dataset.displayTax="false"),a.options.displayPlanType&&(a.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),a.parentNode.insertBefore(o,a.nextSibling))});await Promise.all(r)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let e=this.mainPrice;if(!e)return;await e.onceSettled();let r=e.value?.[0]?.planType;r&&(t.planType=r)}get stockCheckbox(){return this.card.checkboxLabel?F`<label id="stock-checkbox">
                <input type="checkbox" @change=${this.card.toggleStockOffer}></input>
                <span></span>
                ${this.card.checkboxLabel}
            </label>`:Q}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?Q:F`<slot name="icons"></slot>`}connectedCallbackHook(){let t=B();t?.addEventListener&&t.addEventListener("change",this.adaptForMedia);let e=V();e?.addEventListener&&e.addEventListener("change",this.adaptForMedia)}disconnectedCallbackHook(){let t=B();t?.removeEventListener&&t.removeEventListener("change",this.adaptForMedia);let e=V();e?.removeEventListener&&e.removeEventListener("change",this.adaptForMedia)}renderLayout(){return F` ${this.badge}
            <div class="body">
                ${this.icons}
                <slot name="heading-xs"></slot>
    ...
    `),n(p,"collectionOptions",{customHeaderArea:t=>t.sidenav?F`<slot name="resultsText"></slot>`:Q,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]}});import{html as re,css as Ge}from"../lit-all.min.js";var Te=`
:root {
...
`;var M=class extends s{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Te}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return re` ${this.badge}
    ...
    `);import{html as ae,css as Be}from"../lit-all.min.js";var Ae=`
:root {
...
`;var L=class extends s{constructor(t){super(t)}getGlobalCSS(){return Ae}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return ae` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
        ${this.promoBottom?"":ae`<slot name="promo-text"></slot><slot name="callout-content"></slot>`}
        <slot name="body-xs"></slot>
        ${this.promoBottom?ae`<slot name="promo-text"></slot><slot name="callout-content"></slot>`:""}
    </div>
    <hr />
    ${this.secureLabelFooter}`}};n(L,"variantStyle",Be`
  ...
  `);import{html as ie,css as Ve}from"../lit-all.min.js";var Ce=`
:root {
...
`;var _e={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},R=class extends s{constructor(t){super(t)}getGlobalCSS(){return Ce}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return ie`${this.cardImage}
            <div class="body">
    ...
    `);import{html as je,css as qe}from"../lit-all.min.js";var Me=`
:root {
...
`;var ne={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-l",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)",gradient:"linear-gradient(98deg, #FF477B 3.22%, #5C5CE0 52.98%, #318FFF 101.72%)"}},disabledAttributes:["badgeColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},P=class extends s{getGlobalCSS(){return Me}get aemFragmentMapping(){return ne}get headingSelector(){return'[slot="heading-l"]'}postCardUpdateHook(t){t.has("borderColor")&&this.card.borderColor&&this.card.style.setProperty("--merch-card-custom-border-color",this.card.borderColor)}connectedCallbackHook(){!this.card||this.card.failed||(this.setupMobileAccordion(),this.watchForDefaultCardAttribute(),setTimeout(()=>{this.card?.hasAttribute("data-default-card")&&window.matchMedia("(max-width: 1199px)").matches&&this.card.setAttribute("data-expanded","true")},100))}watchForDefaultCardAttribute(){this.card&&(this.attributeObserver=new MutationObserver(t=>{t.forEach(e=>{e.type==="attributes"&&e.attributeName==="data-default-card"&&this.card.hasAttribute("data-default-card")&&window.matchMedia("(max-width: 1199px)").matches&&this.card.setAttribute("data-expanded","true")})}),this.attributeObserver.observe(this.card,{attributes:!0,attributeOldValue:!0}))}setupMobileAccordion(){let t=this.card;if(!t)return;let e=()=>{if(window.matchMedia("(max-width: 1199px)").matches){let a=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",a?"true":"false")}else t.removeAttribute("data-expanded")};e();let r=window.matchMedia("(max-width: 1199px)");this.mediaQueryListener=a=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia("(max-width: 1199px)").removeEventListener("change",this.mediaQueryListener),this.attributeObserver&&this.attributeObserver.disconnect()}handleChevronClick(t){t.preventDefault(),t.stopPropagation();let e=this.card;if(!e||!window.matchMedia("(max-width: 1199px)").matches)return;let o=e.getAttribute("data-expanded")==="true"?"false":"true";e.setAttribute("data-expanded",o)}renderLayout(){return je`
    ...
    `);import{css as Ye,html as Ke}from"../lit-all.min.js";var Le=`
...
`;var Re={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},k=class extends s{constructor(){super(...arguments);n(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Le}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${v}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Ke`
            ${this.badge}
            <div class="body">
    ...
    `);var oe=new Map,u=(i,t,e=null,r=null,a)=>{oe.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:a})};u("catalog",A,xe,A.variantStyle);u("image",K);u("inline-heading",W);u("mini-compare-chart",_,null,_.variantStyle);u("plans",p,X,p.variantStyle,p.collectionOptions);u("plans-students",p,Se,p.variantStyle,p.collectionOptions);u("plans-education",p,Ee,p.variantStyle,p.collectionOptions);u("product",M,null,M.variantStyle);u("segment",L,null,L.variantStyle);u("special-offers",R,_e,R.variantStyle);u("simplified-pricing-express",P,ne,P.variantStyle);u("mini",k,Re,k.variantStyle);function he(i){return oe.get(i)?.fragmentMapping}function ce(i){return oe.get(i)?.collectionOptions}var Xe={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},Ze=(i,t,e)=>{i.querySelectorAll(`[data-placeholder="${t}"]`).forEach(a=>{a.innerText=e||""})},Je={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},g,O=class extends Qe{constructor(){super();U(this,g);n(this,"tablet",new z(this,d));n(this,"desktop",new z(this,c));this.collection=null,G(this,g,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(Z,this.updateLiterals),this.collection?.addEventListener(J,this.handleSidenavAttached)}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(Z,this.updateLiterals),this.collection?.removeEventListener(J,this.handleSidenavAttached)}willUpdate(){m(this,g).search=this.getVisibility("search"),m(this,g).filter=this.getVisibility("filter"),m(this,g).sort=this.getVisibility("sort"),m(this,g).result=this.getVisibility("result"),m(this,g).custom=this.getVisibility("custom")}parseVisibilityOptions(e,r){if(!e||!Object.hasOwn(e,r))return null;let a=e[r];return a===!1?!1:a===!0?!0:a.includes(this.currentMedia)}getVisibility(e){let r=ce(this.collection?.variant)?.headerVisibility,a=this.parseVisibilityOptions(r,e);return a!==null?a:this.parseVisibilityOptions(Je,e)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!m(this,g).search)return f;let e=I(this,"searchText");return e?N`
        ...
        `:f}get filterAction(){return m(this,g).filter?this.sidenav?N`
            <sp-action-button
              id="filter"
              variant="secondary"
              treatment="outline"
            ...
            ></sp-action-button>
        `:f:f}get sortAction(){if(!m(this,g).sort)return f;let e=I(this,"sortText");if(!e)return;let r=I(this,"popularityText"),a=I(this,"alphabeticallyText");if(!(r&&a))return;let o=this.collection?.sort===S.alphabetical;return N`
            <sp-action-menu
                id="sort"
                size="m"
        ...
        `}get resultSlotName(){let e=`${this.search?"search":"filters"}${this.isMobile||this.isTablet?"Mobile":""}`;return Xe[e][Math.min(this.resultCount,2)]}get resultLabel(){if(!m(this,g).result)return f;if(!this.sidenav)return f;let e=this.search?"search":"filter",r=this.resultCount?this.resultCount===1?"single":"multiple":"none";return N`
          <div id="result" aria-live="polite" type=${e} quantity=${r}>
              <slot name="${this.resultSlotName}"></slot>
          </div>`}get customArea(){if(!m(this,g).custom)return f;let e=ce(this.collection?.variant)?.customHeaderArea;if(!e)return f;let r=e(this.collection);return!r||r===f?f:N`<div id="custom">${r}</div>`}openFilters(e){this.sidenav.showModal(e)}updateLiterals(e){Object.keys(e.detail).forEach(r=>{Ze(this,r,e.detail[r])}),this.requestUpdate()}handleSidenavAttached(){this.requestUpdate()}render(){return N`
          <sp-theme color="light" scale="medium">
            <div id="header">${this.searchAction}${this.filterAction}${this.sortAction}${this.resultLabel}${this.customArea}</div>
          </sp-theme>
        `}};g=new WeakMap,n(O,"styles",We`
        :host {
