...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return zi}setAriaExpanded(r,i){r.setAttribute("aria-expanded",i)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};g(Ue,"variantStyle",Do`
...
`;var Bt=class extends I{constructor(t){super(t)}getGlobalCSS(){return ji}renderLayout(){return ht`${this.cardImage}
    <div class="body">
...
`;var Ut=class extends I{constructor(t){super(t)}getGlobalCSS(){return qi}renderLayout(){return Wi` ${this.badge}
    ...
    ${this.card.customHr?"":Wi`<hr />`} ${this.secureLabelFooter}`}};import{html as Fe,css as Bo,unsafeCSS as Xi}from"../lit-all.min.js";var Yi=`
  :root {
...
`;var Uo=32,$e=class extends I{constructor(r){super(r);g(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);g(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?Fe`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(r=>r.onceSettled())),await this.adjustAddon(),Nt()?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};g($e,"variantStyle",Bo`
  ...
  `);import{html as dt,css as Fo,nothing as Ft}from"../lit-all.min.js";var Ki=`
:root {
...
`;var $t={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Qi={...function(){let{whatsIncluded:e,size:t,...r}=$t;return r}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Zi={...function(){let{subtitle:e,whatsIncluded:t,size:r,quantitySelect:i,...n}=$t;return n}()},q=class extends I{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,r){t.dataset.template===Ur&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Ki}adjustSlotPlacement(t,r,i){let n=this.card.shadowRoot,a=n.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let s=n.querySelector(`footer slot[name="${t}"]`),c=n.querySelector(`.body slot[name="${t}"]`),l=n.querySelector(".body");if(o.includes("wide")||(a?.classList.remove("wide-footer"),s&&s.remove()),!!r.includes(o)){if(a?.classList.toggle("wide-footer",Ot()),!i&&s){if(c)s.remove();else{let h=l.querySelector(`[data-placeholder-for="${t}"]`);h?h.replaceWith(s):l.appendChild(s)}return}if(i&&c){let h=document.createElement("div");if(h.setAttribute("data-placeholder-for",t),h.classList.add("slot-placeholder"),!s){let m=c.cloneNode(!0);a.prepend(m)}c.replaceWith(h)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],Ot()),this.adjustSlotPlacement("callout-content",["super-wide"],Ot())}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==t?t.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==t?t.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let r=this.card.querySelector('[slot="body-xs"]');if(!r)return;let i=r.querySelector("ul");if(!i)return;let n=i.previousElementSibling,a=document.createElement("div");a.classList.add("spacer"),r.insertBefore(a,n);let o=new IntersectionObserver(([s])=>{if(s.boundingClientRect.height===0)return;let c=0,l=this.card.querySelector('[slot="heading-s"]');l&&(c+=ct(l));let h=this.card.querySelector('[slot="subtitle"]');h&&(c+=ct(h));let m=this.card.querySelector('[slot="heading-m"]');m&&(c+=8+ct(m));for(let d of r.childNodes){if(d.classList.contains("spacer"))break;c+=ct(d)}let p=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");c>(parseFloat(p)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${c}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${c}px`),o.disconnect()});o.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists())}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${ee}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?dt`<div class="divider"></div>`:Ft}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],r=this.card.querySelector(`[slot="heading-m"] ${ee}[data-template="price"]`);r&&t.push(r);let i=t.map(async n=>{let a=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),n.parentNode.insertBefore(a,n.nextSibling),await a.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled();let i=r.value?.[0]?.planType;i&&(t.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?dt`<label id="stock-checkbox">
    ...
    `),g(q,"collectionOptions",{customHeaderArea:t=>t.sidenav?dt`<slot name="resultsText"></slot>`:Ft,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]}});import{html as Gr,css as $o}from"../lit-all.min.js";var Ji=`
:root {
...
`;var Ge=class extends I{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Ji}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return Gr` ${this.badge}
    ...
    `);import{html as zr,css as Go}from"../lit-all.min.js";var en=`
:root {
...
`;var ze=class extends I{constructor(t){super(t)}getGlobalCSS(){return en}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return zr` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var rn={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Ve=class extends I{constructor(t){super(t)}getGlobalCSS(){return tn}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return Vr`${this.cardImage}
            <div class="body">
    ...
    `);import{html as Vo,css as jo}from"../lit-all.min.js";var nn=`
:root {
...
`;var Gt=()=>window.matchMedia(ne).matches,jr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},je=class extends I{getGlobalCSS(){return nn}get aemFragmentMapping(){return jr}get headingSelector(){return'[slot="heading-xs"]'}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),requestAnimationFrame(()=>{this.card?.hasAttribute("data-default-card")&&Gt()&&this.card.setAttribute("data-expanded","true")}))}setupAccordion(){let t=this.card;if(!t)return;let r=()=>{if(Gt()){let n=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",n?"true":"false")}else t.removeAttribute("data-expanded")};r();let i=window.matchMedia(ne);this.mediaQueryListener=()=>{r()},i.addEventListener("change",this.mediaQueryListener),this.attributeObserver=new MutationObserver(n=>{n.forEach(a=>{a.type==="attributes"&&a.attributeName==="data-default-card"&&this.card.hasAttribute("data-default-card")&&Gt()&&this.card.setAttribute("data-expanded","true")})}),this.attributeObserver.observe(this.card,{attributes:!0,attributeOldValue:!0})}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(ne).removeEventListener("change",this.mediaQueryListener),this.attributeObserver&&this.attributeObserver.disconnect()}handleChevronClick(t){t.preventDefault(),t.stopPropagation();let r=this.card;if(!r||!Gt())return;let a=r.getAttribute("data-expanded")==="true"?"false":"true";r.setAttribute("data-expanded",a)}renderLayout(){return Vo`
    ...
    `);import{css as qo,html as Wo}from"../lit-all.min.js";var an=`
...
`,Me.MISSING_INTL_API,o);var T=r.getPluralRules(t,{type:h.pluralType}).select(p-(h.offset||0));E=h.options[T]||h.options.other}if(!E)throw new Ai(h.value,p,Object.keys(h.options),o);s.push.apply(s,At(E.value,t,r,i,n,p-(h.offset||0)));continue}}return rc(s)}function nc(e,t){return t?w(w(w({},e||{}),t||{}),Object.keys(e).reduce(function(r,i){return r[i]=w(w({},e[i]),t[i]||{}),r},{})):e}function ac(e,t){return t?Object.keys(e).reduce(function(r,i){return r[i]=nc(e[i],t[i]),r},w({},e)):e}function wi(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function oc(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Et(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.NumberFormat).bind.apply(t,er([void 0],r,!1)))},{cache:wi(e.number),strategy:cr.variadic}),getDateTimeFormat:Et(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.DateTimeFormat).bind.apply(t,er([void 0],r,!1)))},{cache:wi(e.dateTime),strategy:cr.variadic}),getPluralRules:Et(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.PluralRules).bind.apply(t,er([void 0],r,!1)))},{cache:wi(e.pluralRules),strategy:cr.variadic})}}var da=function(){function e(t,r,i,n){var a=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=a.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,h){return!l.length||h.type!==z.literal||typeof l[l.length-1]!="string"?l.push(h.value):l[l.length-1]+=h.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return At(a.ast,a.locales,a.formatters,a.formats,o,void 0,a.message)},this.resolvedOptions=function(){return{locale:a.resolvedLocale.toString()}},this.getAst=function(){return a.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:n?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=ac(e.formats,i),this.formatters=n&&n.formatters||oc(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=oa,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var pa=da;var sc=/[0-9\-+#]/,cc=/[^\d\-+#]/g;function ma(e){return e.search(sc)}function lc(e="#.##"){let t={},r=e.length,i=ma(e);t.prefix=i>0?e.substring(0,i):"";let n=ma(e.split("").reverse().join("")),a=r-n,o=e.substring(a,a+1),s=a+(o==="."||o===","?1:0);t.suffix=n>0?e.substring(s,r):"",t.mask=e.substring(i,s),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let c=t.mask.match(cc);return t.decimal=c&&c[c.length-1]||".",t.separator=c&&c[1]&&c[0]||",",c=t.mask.split(t.decimal),t.integer=c[0],t.fraction=c[1],t}function hc(e,t,r){let i=!1,n={value:e};e<0&&(i=!0,n.value=-n.value),n.sign=i?"-":"",n.value=Number(n.value).toFixed(t.fraction&&t.fraction.length),n.value=Number(n.value).toString();let a=t.fraction&&t.fraction.lastIndexOf("0"),[o="0",s=""]=n.value.split(".");return(!s||s&&s.length<=a)&&(s=a<0?"":(+("0."+s)).toFixed(a+1).replace("0.","")),n.integer=o,n.fraction=s,dc(n,t),(n.result==="0"||n.result==="")&&(i=!1,n.sign=""),!i&&t.maskHasPositiveSign?n.sign="+":i&&t.maskHasPositiveSign?n.sign="-":i&&(n.sign=r&&r.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),n}function dc(e,t){e.result="";let r=t.integer.split(t.separator),i=r.join(""),n=i&&i.indexOf("0");if(n>-1)for(;e.integer.length<i.length-n;)e.integer="0"+e.integer;else Number(e.integer)===0&&(e.integer="");let a=r[1]&&r[r.length-1].length;if(a){let o=e.integer.length,s=o%a;for(let c=0;c<o;c++)e.result+=e.integer.charAt(c),!((c-s+1)%a)&&c<o-a&&(e.result+=t.separator)}else e.result=e.integer;return e.result+=t.fraction&&e.fraction?t.decimal+e.fraction:"",e}function pc(e,t,r={}){if(!e||isNaN(Number(t)))return t;let i=lc(e),n=hc(t,i,r);return i.prefix+n.sign+n.result+i.suffix}var ua=pc;var fa=".",mc=",",xa=/^\s+/,ba=/\s+$/,ga="&nbsp;",Si=e=>e*12,va=(e,t)=>{let{start:r,end:i,displaySummary:{amount:n,duration:a,minProductQuantity:o,outcomeType:s}={}}=e;if(!(n&&a&&s&&o))return!1;let c=t?new Date(t):new Date;if(!r||!i)return!1;let l=new Date(r),h=new Date(i);return c>=l&&c<=h},Ne={MONTH:"MONTH",YEAR:"YEAR"},uc={[J.ANNUAL]:12,[J.MONTHLY]:1,[J.THREE_YEARS]:36,[J.TWO_YEARS]:24},Ti=(e,t)=>({accept:e,round:t}),fc=[Ti(({divisor:e,price:t})=>t%e==0,({divisor:e,price:t})=>t/e),Ti(({usePrecision:e})=>e,({divisor:e,price:t})=>Math.round(t/e*100)/100),Ti(()=>!0,({divisor:e,price:t})=>Math.ceil(Math.floor(t*100/e)/100))],_i={[we.YEAR]:{[J.MONTHLY]:Ne.MONTH,[J.ANNUAL]:Ne.YEAR},[we.MONTH]:{[J.MONTHLY]:Ne.MONTH}},gc=(e,t)=>e.indexOf(`'${t}'`)===0,xc=(e,t=!0)=>{let r=e.replace(/'.*?'/,"").trim(),i=ya(r);return!!i?t||(r=r.replace(/[,\.]0+/,i)):r=r.replace(/\s?(#.*0)(?!\s)?/,"$&"+vc(e)),r},bc=e=>{let t=Ec(e),r=gc(e,t),i=e.replace(/'.*?'/,""),n=xa.test(i)||ba.test(i);return{currencySymbol:t,isCurrencyFirst:r,hasCurrencySpace:n}},Ea=e=>e.replace(xa,ga).replace(ba,ga),vc=e=>e.match(/#(.?)#/)?.[1]===fa?mc:fa,Ec=e=>e.match(/'(.*?)'/)?.[1]??"",ya=e=>e.match(/0(.?)0/)?.[1]??"";function Ke({formatString:e,price:t,usePrecision:r,isIndianPrice:i=!1},n,a=o=>o){let{currencySymbol:o,isCurrencyFirst:s,hasCurrencySpace:c}=bc(e),l=r?ya(e):"",h=xc(e,r),m=r?2:0,p=a(t,{currencySymbol:o}),d=i?p.toLocaleString("hi-IN",{minimumFractionDigits:m,maximumFractionDigits:m}):ua(h,p),f=r?d.lastIndexOf(l):d.length,u=d.substring(0,f),v=d.substring(f+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,d).replace(/SYMBOL/,o),currencySymbol:o,decimals:v,decimalsDelimiter:l,hasCurrencySpace:c,integer:u,isCurrencyFirst:s,recurrenceTerm:n}}var Aa=e=>{let{commitment:t,term:r,usePrecision:i}=e,n=uc[r]??1;return Ke(e,n>1?Ne.MONTH:_i[t]?.[r],a=>{let o={divisor:n,price:a,usePrecision:i},{round:s}=fc.find(({accept:c})=>c(o));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(o)}`);return s(o)})},wa=({commitment:e,term:t,...r})=>Ke(r,_i[e]?.[t]),Sa=e=>{let{commitment:t,instant:r,price:i,originalPrice:n,priceWithoutDiscount:a,promotion:o,quantity:s=1,term:c}=e;if(t===we.YEAR&&c===J.MONTHLY){if(!o)return Ke(e,Ne.YEAR,Si);let{displaySummary:{outcomeType:l,duration:h,minProductQuantity:m=1}={}}=o;switch(l){case"PERCENTAGE_DISCOUNT":if(s>=m&&va(o,r)){let p=parseInt(h.replace("P","").replace("M",""));if(isNaN(p))return Si(i);let d=s*n*p,f=s*a*(12-p),u=Math.round((d+f)*100)/100;return Ke({...e,price:u},Ne.YEAR)}default:return Ke(e,Ne.YEAR,()=>Si(a??i))}}return Ke(e,_i[t]?.[c])};var Pi={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},yc=mn("ConsonantTemplates/price"),Ac=/<\/?[^>]+(>|$)/g,D={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},ye={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Ci="TAX_EXCLUSIVE",wc=e=>hn(e)?Object.entries(e).filter(([,t])=>We(t)||Vt(t)||t===!0).reduce((t,[r,i])=>t+` ${r}${i===!0?"":'="'+ln(i)+'"'}`,""):"",U=(e,t,r,i=!1)=>`<span class="${e}${t?"":" "+D.disabled}"${wc(r)}>${i?Ea(t):t??""}</span>`;function me(e,t,r,i){let n=e[r];if(n==null)return"";try{return new pa(n.replace(Ac,""),t).format(i)}catch{return yc.error("Failed to format literal:",n),""}}function Sc(e,{accessibleLabel:t,altAccessibleLabel:r,currencySymbol:i,decimals:n,decimalsDelimiter:a,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:h,taxInclusivityLabel:m},p={}){let d=U(D.currencySymbol,i),f=U(D.currencySpace,o?"&nbsp;":""),u="";return t?u=`<sr-only class="strikethrough-aria-label">${t}</sr-only>`:r&&(u=`<sr-only class="alt-aria-label">${r}</sr-only>`),c&&(u+=d+f),u+=U(D.integer,s),u+=U(D.decimalsDelimiter,a),u+=U(D.decimals,n),c||(u+=f+d),u+=U(D.recurrence,l,null,!0),u+=U(D.unitType,h,null,!0),u+=U(D.taxInclusivity,m,!0),U(e,u,{...p})}var Y=({isAlternativePrice:e=!1,displayOptical:t=!1,displayStrikethrough:r=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:a,displayFormatted:o=!0,displayRecurrence:s=!0,displayPerUnit:c=!1,displayTax:l=!1,language:h,literals:m={},quantity:p=1,space:d=!1}={},{commitment:f,offerSelectorIds:u,formatString:v,price:_,priceWithoutDiscount:y,taxDisplay:E,taxTerm:T,term:C,usePrecision:M,promotion:B}={},V={})=>{Object.entries({country:a,formatString:v,language:h,price:_}).forEach(([co,lo])=>{if(lo==null)throw new Error(`Argument "${co}" is missing for osi ${u?.toString()}, country ${a}, language ${h}`)});let k={...Pi,...m},L=`${h.toLowerCase()}-${a.toUpperCase()}`,F=r&&y?y:_,Z=t?Aa:wa;i&&(Z=Sa);let{accessiblePrice:ge,recurrenceTerm:ce,...ke}=Z({commitment:f,formatString:v,instant:n,isIndianPrice:a==="IN",originalPrice:_,priceWithoutDiscount:y,price:t?_:F,promotion:B,quantity:p,term:C,usePrecision:M}),dr="",pr="",mr="";b(s)&&ce&&(mr=me(k,L,ye.recurrenceLabel,{recurrenceTerm:ce}));let Ct="";b(c)&&(d&&(Ct+=" "),Ct+=me(k,L,ye.perUnitLabel,{perUnit:"LICENSE"}));let Lt="";b(l)&&T&&(d&&(Lt+=" "),Lt+=me(k,L,E===Ci?ye.taxExclusiveLabel:ye.taxInclusiveLabel,{taxTerm:T})),r&&(dr=me(k,L,ye.strikethroughAriaLabel,{strikethroughPrice:dr})),e&&(pr=me(k,L,ye.alternativePriceAriaLabel,{alternativePrice:pr}));let He=D.container;if(t&&(He+=" "+D.containerOptical),r&&(He+=" "+D.containerStrikethrough),e&&(He+=" "+D.containerAlternative),i&&(He+=" "+D.containerAnnual),b(o))return Sc(He,{...ke,accessibleLabel:dr,altAccessibleLabel:pr,recurrenceLabel:mr,perUnitLabel:Ct,taxInclusivityLabel:Lt},V);let{currencySymbol:Ii,decimals:io,decimalsDelimiter:no,hasCurrencySpace:ki,integer:ao,isCurrencyFirst:oo}=ke,De=[ao,no,io];oo?(De.unshift(ki?"\xA0":""),De.unshift(Ii)):(De.push(ki?"\xA0":""),De.push(Ii)),De.push(mr,Ct,Lt);let so=De.join("");return U(He,so,V)},Ta=()=>(e,t,r)=>{let n=(e.displayOldPrice===void 0||b(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${n?Y({displayStrikethrough:!0})(e,t,r)+"&nbsp;":""}${Y({isAlternativePrice:n})(e,t,r)}`},_a=()=>(e,t,r)=>{let{instant:i}=e;try{i||(i=new URLSearchParams(document.location.search).get("instant")),i&&(i=new Date(i))}catch{i=void 0}let n={...e,displayTax:!1,displayPerUnit:!1},o=(e.displayOldPrice===void 0||b(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${o?Y({displayStrikethrough:!0})(n,t,r)+"&nbsp;":""}${Y({isAlternativePrice:o})(e,t,r)}${U(D.containerAnnualPrefix,"&nbsp;(")}${Y({displayAnnual:!0,instant:i})(n,t,r)}${U(D.containerAnnualSuffix,")")}`},Pa=()=>(e,t,r)=>{let i={...e,displayTax:!1,displayPerUnit:!1};return`${Y({isAlternativePrice:e.displayOldPrice})(e,t,r)}${U(D.containerAnnualPrefix,"&nbsp;(")}${Y({displayAnnual:!0})(i,t,r)}${U(D.containerAnnualSuffix,")")}`};var wt={...D,containerLegal:"price-legal",planType:"price-plan-type"},lr={...ye,planTypeLabel:"planTypeLabel"};function Tc(e,{perUnitLabel:t,taxInclusivityLabel:r,planTypeLabel:i},n={}){let a="";return a+=U(wt.unitType,t,null,!0),r&&i&&(r+=". "),a+=U(wt.taxInclusivity,r,!0),a+=U(wt.planType,i,null),U(e,a,{...n})}var Ca=({country:e,displayPerUnit:t=!1,displayTax:r=!1,displayPlanType:i=!1,language:n,literals:a={}}={},{taxDisplay:o,taxTerm:s,planType:c}={},l={})=>{let h={...Pi,...a},m=`${n.toLowerCase()}-${e.toUpperCase()}`,p="";b(t)&&(p=me(h,m,lr.perUnitLabel,{perUnit:"LICENSE"}));let d="";e==="US"&&n==="en"&&(r=!1),b(r)&&s&&(d=me(h,m,o===Ci?lr.taxExclusiveLabel:lr.taxInclusiveLabel,{taxTerm:s}));let f="";b(i)&&c&&(f=me(h,m,lr.planTypeLabel,{planType:c}));let u=wt.container;return u+=" "+wt.containerLegal,Tc(u,{perUnitLabel:p,taxInclusivityLabel:d,planTypeLabel:f},l)};var La=Y(),Ra=Ta(),Ma=Y({displayOptical:!0}),Na=Y({displayStrikethrough:!0}),Oa=Y({displayAnnual:!0}),Ia=Y({displayOptical:!0,isAlternativePrice:!0}),ka=Y({isAlternativePrice:!0}),Ha=Pa(),Da=_a(),Ba=Ca;var _c=(e,t)=>{if(!(!pt(e)||!pt(t)))return Math.floor((t-e)/t*100)},Ua=()=>(e,t)=>{let{price:r,priceWithoutDiscount:i}=t,n=_c(r,i);return n===void 0?'<span class="no-discount"></span>':`<span class="discount">${n}%</span>`};var Fa=Ua();var Ga="INDIVIDUAL_COM",Li="TEAM_COM",za="INDIVIDUAL_EDU",Ri="TEAM_EDU",$a=["GB_en","AU_en","FR_fr","AT_de","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","GR_el","GR_en","HU_hu","IE_en","IT_it","LU_de","LU_en","LU_fr","NL_nl","NO_nb","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TR_tr","UA_uk","ID_en","ID_in","IN_en","IN_hi","JP_ja","MY_en","MY_ms","NZ_en","TH_en","TH_th"],Pc={[Ga]:["MU_en","LT_lt","LV_lv","NG_en","SA_ar","SA_en","SG_en","KR_ko"],[Li]:["MU_en","LT_lt","LV_lv","NG_en","CO_es","KR_ko"],[za]:["LT_lt","LV_lv","SA_en","SG_en"],[Ri]:["SG_en","KR_ko"]},Cc={MU_en:[!1,!1,!1,!1],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],CO_es:[!1,!0,!1,!1],AT_de:[!1,!1,!1,!0],SG_en:[!1,!1,!1,!0]},Lc=[Ga,Li,za,Ri],Rc=e=>[Li,Ri].includes(e),Mc=(e,t,r,i)=>{let n=`${e}_${t}`,a=`${r}_${i}`,o=Cc[n];if(o){let s=Lc.indexOf(a);return o[s]}return Rc(a)},Nc=(e,t,r,i)=>{let n=`${e}_${t}`;if($a.includes(e)||$a.includes(n))return!0;let a=Pc[`${r}_${i}`];return a?a.includes(e)||a.includes(n)?!0:P.displayTax:P.displayTax},Oc=async(e,t,r,i)=>{let n=Nc(e,t,r,i);return{displayTax:n,forceTaxExclusive:n?Mc(e,t,r,i):P.forceTaxExclusive}},St=class St extends HTMLSpanElement{constructor(){super();g(this,"masElement",new Ee(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi"]}static createInlinePrice(r){let i=W();if(!i)return null;let{displayOldPrice:n,displayPerUnit:a,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:h,perpetual:m,promotionCode:p,quantity:d,alternativePrice:f,template:u,wcsOsi:v}=i.collectPriceOptions(r);return Jt(St,{displayOldPrice:n,displayPerUnit:a,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:h,perpetual:m,promotionCode:p,quantity:d,alternativePrice:f,template:u,wcsOsi:v})}get isInlinePrice(){return!0}attributeChangedCallback(r,i,n){this.masElement.attributeChangedCallback(r,i,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===ae}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}async render(r={}){if(!this.isConnected)return!1;let i=W();if(!i)return!1;let n=i.collectPriceOptions(r,this),a={...i.settings,...n};if(!a.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let[s]=await i.resolveOfferSelectors(a),c=ut(await s,a),[l]=c;if(i.featureFlags[de]){if(n.displayPerUnit===void 0&&(a.displayPerUnit=l.customerSegment!=="INDIVIDUAL"),n.displayTax===void 0||n.forceTaxExclusive===void 0){let{country:h,language:m}=a,[p=""]=l.marketSegments,d=await Oc(h,m,l.customerSegment,p);n.displayTax===void 0&&(a.displayTax=d?.displayTax||a.displayTax),n.forceTaxExclusive===void 0&&(a.forceTaxExclusive=d?.forceTaxExclusive||a.forceTaxExclusive),a.forceTaxExclusive&&(c=ut(c,a))}}else n.displayOldPrice===void 0&&(a.displayOldPrice=!0);return this.renderOffers(c,a,o)}catch(o){throw this.innerHTML="",o}}renderOffers(r,i,n=void 0){if(!this.isConnected)return;let a=W();if(!a)return!1;if(n??(n=this.masElement.togglePending()),r.length){if(this.masElement.toggleResolved(n,r,i)){this.innerHTML=a.buildPriceHTML(r,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=a.buildPriceHTML(r,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(n,o,this.options))return this.innerHTML="",!0}return!1}};g(St,"is","inline-price"),g(St,"tag","span");var ue=St;window.customElements.get(ue.is)||window.customElements.define(ue.is,ue,{extends:ue.tag});function Va({literals:e,providers:t,settings:r}){function i(o,s=null){let c={country:r.country,language:r.language,locale:r.locale,literals:{...e.price}};if(s&&t?.price)for(let M of t.price)M(s,c);let{displayOldPrice:l,displayPerUnit:h,displayRecurrence:m,displayTax:p,displayPlanType:d,forceTaxExclusive:f,perpetual:u,displayAnnual:v,promotionCode:_,quantity:y,alternativePrice:E,wcsOsi:T,...C}=Object.assign(c,s?.dataset??{},o??{});return c=jt(Object.assign({...c,...C,displayOldPrice:b(l),displayPerUnit:b(h),displayRecurrence:b(m),displayTax:b(p),displayPlanType:b(d),forceTaxExclusive:b(f),perpetual:b(u),displayAnnual:b(v),promotionCode:Wt(_).effectivePromoCode,quantity:Ye(y,P.quantity),alternativePrice:b(E),wcsOsi:Kt(T)})),c}function n(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=Fa;break;case"strikethrough":l=Na;break;case"annual":l=Oa;break;case"legal":l=Ba;break;default:s.template==="optical"&&s.alternativePrice?l=Ia:s.template==="optical"?l=Ma:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode?Da:Ha:s.alternativePrice?l=ka:l=s.promotionCode?Ra:La}let[h]=o;return h={...h,...h.priceDetails},l({...r,...s},h)}let a=ue.createInlinePrice;return{InlinePrice:ue,buildPriceHTML:n,collectPriceOptions:i,createInlinePrice:a}}function Ic({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||P.language),t??(t=e?.split("_")?.[1]||P.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function ja(e={},t){let r=t.featureFlags[de],{commerce:i={}}=e,n=le.PRODUCTION,a=Ir,o=O("checkoutClientId",i)??P.checkoutClientId,s=mt(O("checkoutWorkflowStep",i),j,P.checkoutWorkflowStep),c=P.displayOldPrice,l=P.displayPerUnit,h=b(O("displayRecurrence",i),P.displayRecurrence),m=b(O("displayTax",i),P.displayTax),p=b(O("displayPlanType",i),P.displayPlanType),d=b(O("entitlement",i),P.entitlement),f=b(O("modal",i),P.modal),u=b(O("forceTaxExclusive",i),P.forceTaxExclusive),v=O("promotionCode",i)??P.promotionCode,_=Ye(O("quantity",i)),y=O("wcsApiKey",i)??P.wcsApiKey,E=i?.env==="stage",T=ve.PUBLISHED;["true",""].includes(i.allowOverride)&&(E=(O(Nr,i,{metadata:!1})?.toLowerCase()??i?.env)==="stage",T=mt(O(Or,i),ve,T)),E&&(n=le.STAGE,a=kr);let M=O(Mr)??e.preview,B=typeof M<"u"&&M!=="off"&&M!=="false",V={};B&&(V={preview:B});let k=O("mas-io-url")??e.masIOUrl??`https://www${n===le.STAGE?".stage":""}.adobe.com/mas/io`,L=O("preselect-plan")??void 0;return{...Ic(e),...V,displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:h,displayTax:m,displayPlanType:p,entitlement:d,extraOptions:P.extraOptions,modal:f,env:n,forceTaxExclusive:u,promotionCode:v,quantity:_,alternativePrice:P.alternativePrice,wcsApiKey:y,wcsURL:a,landscape:T,masIOUrl:k,...L&&{preselectPlan:L}}}async function qa(e,t={},r=2,i=100){let n;for(let a=0;a<=r;a++)try{let o=await fetch(e,t);return o.retryCount=a,o}catch(o){if(n=o,n.retryCount=a,a>r)break;await new Promise(s=>setTimeout(s,i*(a+1)))}throw n}var Mi="wcs";function Wa({settings:e}){let t=ie.module(Mi),{env:r,wcsApiKey:i}=e,n=new Map,a=new Map,o,s=new Map;async function c(d,f,u=!0){let v=W(),_=Pr;t.debug("Fetching:",d);let y="",E;if(d.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let T=new Map(f),[C]=d.offerSelectorIds,M=Date.now()+Math.random().toString(36).substring(2,7),B=`${Mi}:${C}:${M}${Dr}`,V=`${Mi}:${C}:${M}${Br}`,k;try{if(performance.mark(B),y=new URL(e.wcsURL),y.searchParams.set("offer_selector_ids",C),y.searchParams.set("country",d.country),y.searchParams.set("locale",d.locale),y.searchParams.set("landscape",r===le.STAGE?"ALL":e.landscape),y.searchParams.set("api_key",i),d.language&&y.searchParams.set("language",d.language),d.promotionCode&&y.searchParams.set("promotion_code",d.promotionCode),d.currency&&y.searchParams.set("currency",d.currency),E=await qa(y.toString(),{credentials:"omit"}),E.ok){let L=[];try{let F=await E.json();t.debug("Fetched:",d,F),L=F.resolvedOffers??[]}catch(F){t.error(`Error parsing JSON: ${F.message}`,{...F.context,...v?.duration})}L=L.map(Yt),f.forEach(({resolve:F},Z)=>{let ge=L.filter(({offerSelectorIds:ce})=>ce.includes(Z)).flat();ge.length&&(T.delete(Z),f.delete(Z),F(ge))})}else _=_r}catch(L){_=`Network error: ${L.message}`}finally{k=performance.measure(V,B),performance.clearMarks(B),performance.clearMeasures(V)}if(u&&f.size){t.debug("Missing:",{offerSelectorIds:[...f.keys()]});let L=bn(E);f.forEach(F=>{F.reject(new Xe(_,{...d,...L,response:E,measure:kt(k),...v?.duration}))})}}function l(){clearTimeout(o);let d=[...a.values()];a.clear(),d.forEach(({options:f,promises:u})=>c(f,u))}function h(d){if(!d||typeof d!="object")throw new TypeError("Cache must be a Map or similar object");let f=r===le.STAGE?"stage":"prod",u=d[f];if(!u||typeof u!="object"){t.warn(`No cache found for environment: ${r}`);return}for(let[v,_]of Object.entries(u))n.set(v,Promise.resolve(_.map(Yt)));t.debug(`Prefilled WCS cache with ${u.size} entries`)}function m(){let d=n.size;s=new Map(n),n.clear(),t.debug(`Moved ${d} cache entries to stale cache`)}function p({country:d,language:f,perpetual:u=!1,promotionCode:v="",wcsOsi:_=[]}){let y=`${f}_${d}`;d!=="GB"&&!u&&(f="MULT");let E=[d,f,v].filter(T=>T).join("-").toLowerCase();return _.map(T=>{let C=`${T}-${E}`;if(n.has(C))return n.get(C);let M=new Promise((B,V)=>{let k=a.get(E);if(!k){let L={country:d,locale:y,offerSelectorIds:[]};d!=="GB"&&!u&&(L.language=f),k={options:L,promises:new Map},a.set(E,k)}v&&(k.options.promotionCode=v),k.options.offerSelectorIds.push(T),k.promises.set(T,{resolve:B,reject:V}),l()}).catch(B=>{if(s.has(C))return s.get(C);throw B});return n.set(C,M),M})}return{Commitment:we,PlanType:fn,Term:J,applyPlanType:Yt,resolveOfferSelectors:p,flushWcsCacheInternal:m,prefillWcsCache:h}}var Ya="mas-commerce-service",Xa="mas-commerce-service:start",Ka="mas-commerce-service:ready",Tt,Oe,Ie,Qa,Oi,Ni=class extends HTMLElement{constructor(){super(...arguments);$(this,Ie);$(this,Tt);$(this,Oe);g(this,"lastLoggingTime",0)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(i,n,a)=>{let o=await r?.(i,n,this.imsSignedInPromise,a);return o||null})}get featureFlags(){if(!A(this,Oe)){console.log("++++++++");let r=!!document.querySelector('a[href^="https://mas.adobe.com/studio.html#content-type=merch-card"]'),i=!!document.querySelector("merch-card,merch-card-collection");console.log(et(this,Ie,Oi).call(this,de)),console.log(document.querySelector("merch-card,merch-card-collection")),console.log(document.querySelector('a[href^="https://mas.adobe.com/studio.html#content-type=merch-card"]')),G(this,Oe,{[de]:et(this,Ie,Oi).call(this,de)||i||r}),console.log(A(this,Oe))}return A(this,Oe)}activate(){let r=A(this,Ie,Qa),i=ja(r,this);Qt(r.lana);let n=ie.init(r.hostEnv).module("service");n.debug("Activating:",r);let o={price:Un(i)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:i};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...Hn(c),...Dn(c),...Va(c),...Wa(c),...Fr,Log:ie,get defaults(){return P},get log(){return ie},get providers(){return{checkout(h){return s.checkout.add(h),()=>s.checkout.delete(h)},price(h){return s.price.add(h),()=>s.price.delete(h)},has:h=>s.price.has(h)||s.checkout.has(h)}},get settings(){return i}})),n.debug("Activated:",{literals:o,settings:i});let l=new CustomEvent(It,{bubbles:!0,cancelable:!1,detail:this});performance.mark(Ka),G(this,Tt,performance.measure(Ka,Xa)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(Xa),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(fr).forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":kt(A(this,Tt))}}logFailedRequests(){let r=[...performance.getEntriesByType("resource")].filter(({startTime:n})=>n>this.lastLoggingTime).filter(({transferSize:n,duration:a,responseStatus:o})=>n===0&&a===0&&o<200||o>=400),i=Array.from(new Map(r.map(n=>[n.name,n])).values());if(i.some(({name:n})=>/(\/fragment\?|web_commerce_artifact)/.test(n))){let n=i.map(({name:a})=>a);this.log.error("Failed requests:",{failedUrls:n,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Tt=new WeakMap,Oe=new WeakMap,Ie=new WeakSet,Qa=function(){let r=this.getAttribute("env")??"prod",i={commerce:{env:r},hostEnv:{name:r},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:r==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview"].forEach(n=>{let a=this.getAttribute(n);a&&(i[n]=a)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(n=>{let a=this.getAttribute(n);if(a!=null){let o=n.replace(/-([a-z])/g,s=>s[1].toUpperCase());i.commerce[o]=a}}),i},Oi=function(r){return["on","true",!0].includes(this.getAttribute(`data-${r}`)||O(r))};window.customElements.get(Ya)||window.customElements.define(Ya,Ni);var to="merch-card-collection",kc=2e4,Hc={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansThreeColumns:["three-merch-cards"]},Dc={plans:!0},Bc=(e,{filter:t})=>e.filter(r=>r?.filters&&r?.filters.hasOwnProperty(t)),Uc=(e,{types:t})=>t?(t=t.split(","),e.filter(r=>t.some(i=>r.types.includes(i)))):e,Fc=e=>e.sort((t,r)=>(t.title??"").localeCompare(r.title??"","en",{sensitivity:"base"})),$c=(e,{filter:t})=>e.sort((r,i)=>i.filters[t]?.order==null||isNaN(i.filters[t]?.order)?-1:r.filters[t]?.order==null||isNaN(r.filters[t]?.order)?1:r.filters[t].order-i.filters[t].order),Gc=(e,{search:t})=>t?.length?(t=t.toLowerCase(),e.filter(r=>(r.title??"").toLowerCase().includes(t))):e,Ae,Ze,Pt,hr,ro,Qe=class extends Ja{constructor(){super();$(this,hr);$(this,Ae,{});$(this,Ze);$(this,Pt);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1}render(){return fe`
    ...
    `);Qe.SortOrder=oe;customElements.define(to,Qe);var zc={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},Vc=(e,t,r)=>{e.querySelectorAll(`[data-placeholder="${t}"]`).forEach(n=>{n.innerText=r||""})},jc={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},qc={catalog:"l"},X,Je,_t=class extends Ja{constructor(){super();$(this,X);$(this,Je);g(this,"tablet",new tt(this,H));g(this,"desktop",new tt(this,N));this.collection=null,G(this,X,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(it,this.updateLiterals),this.collection?.addEventListener(nt,this.handleSidenavAttached),G(this,Je,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(it,this.updateLiterals),this.collection?.removeEventListener(nt,this.handleSidenavAttached)}willUpdate(){A(this,X).search=this.getVisibility("search"),A(this,X).filter=this.getVisibility("filter"),A(this,X).sort=this.getVisibility("sort"),A(this,X).result=this.getVisibility("result"),A(this,X).custom=this.getVisibility("custom")}parseVisibilityOptions(r,i){if(!r||!Object.hasOwn(r,i))return null;let n=r[i];return n===!1?!1:n===!0?!0:n.includes(this.currentMedia)}getVisibility(r){let i=A(this,Je).getCollectionOptions(this.collection?.variant)?.headerVisibility,n=this.parseVisibilityOptions(i,r);return n!==null?n:this.parseVisibilityOptions(jc,r)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!A(this,X).search)return se;let r=ot(this,"searchText");return r?fe`
          ...
          `:se}get filterAction(){return A(this,X).filter?this.sidenav?fe`
              <sp-action-button
                id="filter"
                variant="secondary"
                treatment="outline"
              ...
              ></sp-action-button>
          `:se:se}get sortAction(){if(!A(this,X).sort)return se;let r=ot(this,"sortText");if(!r)return;let i=ot(this,"popularityText"),n=ot(this,"alphabeticallyText");if(!(i&&n))return;let a=this.collection?.sort===oe.alphabetical;return fe`
              <sp-action-menu
                  id="sort"
                  size="m"
      ...
      `);customElements.define("merch-card-collection-header",_t);export{Qe as MerchCardCollection,_t as default};
