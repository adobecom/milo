...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
            ...
            <slot></slot>`}getGlobalCSS(){return Xi}setAriaExpanded(r,i){r.setAttribute("aria-expanded",i)}};g($e,"variantStyle",jo`
...
`;var Vt=class extends k{constructor(t){super(t)}getGlobalCSS(){return Zi}renderLayout(){return Ji` ${this.badge}
    ...
    ${this.card.customHr?"":Ji`<hr />`} ${this.secureLabelFooter}`}};import{html as Ge,css as Wo,unsafeCSS as ta}from"../lit-all.min.js";var ea=`
  :root {
...
`;var Yo=32,Ve=class extends k{constructor(r){super(r);g(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);g(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?Ge`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(r=>r.onceSettled())),await this.adjustAddon(),M.isMobile?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};g(Ve,"variantStyle",Wo`
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let r=t.querySelector("strong, b, p");r&&(M.isDesktopOrUp?r.style.display="":r.style.display="none")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?M.isDesktopOrUp?qe`
...
`;var je=class extends k{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return ca}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return Wr` ${this.badge}
...
`;var We=class extends k{constructor(t){super(t)}getGlobalCSS(){return la}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Yr` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var pa={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Ye=class extends k{constructor(t){super(t)}getGlobalCSS(){return da}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return Xr`${this.cardImage}
            <div class="body">
