...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return qi}setAriaExpanded(r,i){r.setAttribute("aria-expanded",i)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};g($e,"variantStyle",Fo`
...
`;var Go=32,ze=class extends O{constructor(r){super(r);g(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);g(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?Ge`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(r=>r.onceSettled())),await this.adjustAddon(),j.isMobile?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};g(ze,"variantStyle",$o`
...
`;var Ve=class extends O{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return rn}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return zr` ${this.badge}
    ...
    `);import{html as Vr,css as jo}from"../lit-all.min.js";var nn=`
:root {
...
`;var je=class extends O{constructor(t){super(t)}getGlobalCSS(){return nn}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Vr` ${this.badge}
    ...
    <hr />
    ${this.secureLabelFooter}`}};g(je,"variantStyle",jo`
  ...
  `);import{html as jr,css as qo}from"../lit-all.min.js";var an=`
:root {
...
`;var on={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},qe=class extends O{constructor(t){super(t)}getGlobalCSS(){return an}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return jr`${this.cardImage}
            ...
            ${this.evergreen?jr`
                  ...
                  `:jr`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};g(qe,"variantStyle",qo`
