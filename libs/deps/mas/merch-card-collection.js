...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return ji}setAriaExpanded(r,i){r.setAttribute("aria-expanded",i)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};g(De,"variantStyle",Bo`
    ...
    `);import{html as ct}from"../lit-all.min.js";var Wi=`
:root {
...
`;var Dt=class extends k{constructor(t){super(t)}getGlobalCSS(){return Wi}renderLayout(){return ct`${this.cardImage}
    <div class="body">
...
`;var Bt=class extends k{constructor(t){super(t)}getGlobalCSS(){return Yi}renderLayout(){return Xi` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":Xi`<hr />`} ${this.secureLabelFooter}`}};import{html as Be,css as Uo,unsafeCSS as Gr}from"../lit-all.min.js";var Ki=`
  :root {
...
`;var Fo=32,Ue=class extends k{constructor(r){super(r);g(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);g(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?Be`<slot name="secure-transaction-label">
  ...
  `);import{html as lt,css as $o,nothing as Ut}from"../lit-all.min.js";var Qi=`
:root {
...
`;var Ft={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Zi={...function(){let{whatsIncluded:e,size:t,...r}=Ft;return r}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Ji={...function(){let{subtitle:e,whatsIncluded:t,size:r,quantitySelect:i,...n}=Ft;return n}()},Y=class extends k{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,r){t.dataset.template===Ur&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Qi}adjustSlotPlacement(t,r,i){let n=this.card.shadowRoot,a=n.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let s=n.querySelector(`footer slot[name="${t}"]`),l=n.querySelector(`.body slot[name="${t}"]`),c=n.querySelector(".body");if(o.includes("wide")||(a?.classList.remove("wide-footer"),s&&s.remove()),!!r.includes(o)){if(a?.classList.toggle("wide-footer",Nt()),!i&&s){if(l)s.remove();else{let d=c.querySelector(`[data-placeholder-for="${t}"]`);d?d.replaceWith(s):c.appendChild(s)}return}if(i&&l){let d=document.createElement("div");if(d.setAttribute("data-placeholder-for",t),d.classList.add("slot-placeholder"),!s){let m=l.cloneNode(!0);a.prepend(m)}l.replaceWith(d)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],Nt()),this.adjustSlotPlacement("callout-content",["super-wide"],Nt())}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==t?t.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==t?t.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustLegal(),this.adjustAddon(),this.adjustCallout()}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${ee}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?lt`<div class="divider"></div>`:Ut}async adjustLegal(){if(await this.card.updateComplete,await customElements.whenDefined("inline-price"),this.legalAdjusted)return;this.legalAdjusted=!0;let t=[],r=this.card.querySelector(`[slot="heading-m"] ${ee}[data-template="price"]`);r&&t.push(r);let i=t.map(async n=>{let a=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),n.parentNode.insertBefore(a,n.nextSibling))});await Promise.all(i)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled();let i=r.value?.[0]?.planType;i&&(t.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?lt`<label id="stock-checkbox">
    ...
    `),g(Y,"collectionOptions",{customHeaderArea:t=>t.sidenav?lt`<slot name="resultsText"></slot>`:Ut,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]}});import{html as zr,css as Go}from"../lit-all.min.js";var en=`
:root {
...
`;var Fe=class extends k{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return en}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return zr` ${this.badge}
    ...
    `);import{html as Vr,css as zo}from"../lit-all.min.js";var tn=`
:root {
...
`;var $e=class extends k{constructor(t){super(t)}getGlobalCSS(){return tn}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Vr` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
  ...
  `);import{html as jr,css as Vo}from"../lit-all.min.js";var rn=`
:root {
...
`;var nn={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Ge=class extends k{constructor(t){super(t)}getGlobalCSS(){return rn}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return jr`${this.cardImage}
            <div class="body">
    ...
    `);import{html as jo,css as qo}from"../lit-all.min.js";var an=`
:root {
...
`;var $t=()=>window.matchMedia(ne).matches,qr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},ze=class extends k{getGlobalCSS(){return an}get aemFragmentMapping(){return qr}get headingSelector(){return'[slot="heading-xs"]'}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),requestAnimationFrame(()=>{this.card?.hasAttribute("data-default-card")&&$t()&&this.card.setAttribute("data-expanded","true")}))}setupAccordion(){let t=this.card;if(!t)return;let r=()=>{if($t()){let n=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",n?"true":"false")}else t.removeAttribute("data-expanded")};r();let i=window.matchMedia(ne);this.mediaQueryListener=()=>{r()},i.addEventListener("change",this.mediaQueryListener),this.attributeObserver=new MutationObserver(n=>{n.forEach(a=>{a.type==="attributes"&&a.attributeName==="data-default-card"&&this.card.hasAttribute("data-default-card")&&$t()&&this.card.setAttribute("data-expanded","true")})}),this.attributeObserver.observe(this.card,{attributes:!0,attributeOldValue:!0})}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(ne).removeEventListener("change",this.mediaQueryListener),this.attributeObserver&&this.attributeObserver.disconnect()}handleChevronClick(t){t.preventDefault(),t.stopPropagation();let r=this.card;if(!r||!$t())return;let a=r.getAttribute("data-expanded")==="true"?"false":"true";r.setAttribute("data-expanded",a)}renderLayout(){return jo`
    ...
    `);import{css as Wo,html as Yo}from"../lit-all.min.js";var on=`
...
`;var sn={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ve=class extends k{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return on}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(r,i){i.literals={...i.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},i.space=!0,i.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let r=this.card.querySelector(`${ee}[data-template="price"]`);if(!r)return;let i=r.cloneNode(!0);this.legal=i,r.dataset.displayTax="false",i.dataset.template="legal",i.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,i.setAttribute("slot","legal"),this.card.appendChild(i)}renderLayout(){return Yo`
            ${this.badge}
            <div class="body">
    ...
    `);var cn=new Map,te=(e,t,r=null,i=null,n)=>{cn.set(e,{class:t,fragmentMapping:r,style:i,collectionOptions:n})};te("catalog",De,qi,De.variantStyle);te("image",Dt);te("inline-heading",Bt);te("mini-compare-chart",Ue,null,Ue.variantStyle);te("plans",Y,Ft,Y.variantStyle,Y.collectionOptions);te("plans-students",Y,Ji,Y.variantStyle,Y.collectionOptions);te("plans-education",Y,Zi,Y.variantStyle,Y.collectionOptions);te("product",Fe,null,Fe.variantStyle);te("segment",$e,null,$e.variantStyle);te("special-offers",Ge,nn,Ge.variantStyle);te("simplified-pricing-express",ze,qr,ze.variantStyle);te("mini",Ve,sn,Ve.variantStyle);function Ht(e){return cn.get(e)?.fragmentMapping}var ln="tacocat.js";var Wr=(e,t)=>String(e??"").toLowerCase()==String(t??"").toLowerCase(),dn=e=>`${e??""}`.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t]??t)??"";function M(e,t={},{metadata:r=!0,search:i=!0,storage:n=!0}={}){let a;if(i&&a==null){let o=new URLSearchParams(window.location.search),s=je(i)?i:e;a=o.get(s)}if(n&&a==null){let o=je(n)?n:e;a=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(r&&a==null){let o=Ko(je(r)?r:e);a=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return a??t[e]}var Xo=e=>typeof e=="boolean",Gt=e=>typeof e=="function",zt=e=>typeof e=="number",hn=e=>e!=null&&typeof e=="object";var je=e=>typeof e=="string",pn=e=>je(e)&&e,dt=e=>zt(e)&&Number.isFinite(e)&&e>0;function Vt(e,t=r=>r==null||r===""){return e!=null&&Object.entries(e).forEach(([r,i])=>{t(i)&&delete e[r]}),e}function x(e,t){if(Xo(e))return e;let r=String(e);return r==="1"||r==="true"?!0:r==="0"||r==="false"?!1:t}function ht(e,t,r){let i=Object.values(t);return i.find(n=>Wr(n,e))??r??i[0]}function Ko(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,r,i)=>`${r}-${i}`).replace(/\W+/gu,"-").toLowerCase()}function mn(e,t=1){return zt(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:t}var Qo=Date.now(),Yr=()=>`(+${Date.now()-Qo}ms)`,jt=new Set,Zo=x(M("tacocat.debug",{},{metadata:!1}),!1);function un(e){let t=`[${ln}/${e}]`,r=(o,s,...l)=>o?!0:(n(s,...l),!1),i=Zo?(o,...s)=>{console.debug(`${t} ${o}`,...s,Yr())}:()=>{},n=(o,...s)=>{let l=`${t} ${o}`;jt.forEach(([c])=>c(l,...s))};return{assert:r,debug:i,error:n,warn:(o,...s)=>{let l=`${t} ${o}`;jt.forEach(([,c])=>c(l,...s))}}}function Jo(e,t){let r=[e,t];return jt.add(r),()=>{jt.delete(r)}}Jo((e,...t)=>{console.error(e,...t,Yr())},(e,...t)=>{console.warn(e,...t,Yr())});var es="no promo",fn="promo-tag",ts="yellow",rs="neutral",is=(e,t,r)=>{let i=a=>a||es,n=r?` (was "${i(t)}")`:"";return`${i(e)}${n}`},ns="cancel-context",qt=(e,t)=>{let r=e===ns,i=!r&&e?.length>0,n=(i||r)&&(t&&t!=e||!t&&!r),a=n&&i||!n&&!!t,o=a?e||t:void 0;return{effectivePromoCode:o,overridenPromoCode:e,className:a?fn:`${fn} no-promo`,text:is(o,t,n),variant:a?ts:rs,isOverriden:n}};var Xr;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(Xr||(Xr={}));var Q;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(Q||(Q={}));var re;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(re||(re={}));var Kr;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(Kr||(Kr={}));var Qr;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(Qr||(Qr={}));var Zr;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(Zr||(Zr={}));var Jr;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(Jr||(Jr={}));var ei="ABM",ti="PUF",ri="M2M",ii="PERPETUAL",ni="P3Y",as="TAX_INCLUSIVE_DETAILS",os="TAX_EXCLUSIVE",gn={ABM:ei,PUF:ti,M2M:ri,PERPETUAL:ii,P3Y:ni},Jd={[ei]:{commitment:Q.YEAR,term:re.MONTHLY},[ti]:{commitment:Q.YEAR,term:re.ANNUAL},[ri]:{commitment:Q.MONTH,term:re.MONTHLY},[ii]:{commitment:Q.PERPETUAL,term:void 0},[ni]:{commitment:Q.THREE_MONTHS,term:re.P3Y}},xn="Value is not an offer",Wt=e=>{if(typeof e!="object")return xn;let{commitment:t,term:r}=e,i=ss(t,r);return{...e,planType:i}};var ss=(e,t)=>{switch(e){case void 0:return xn;case"":return"";case Q.YEAR:return t===re.MONTHLY?ei:t===re.ANNUAL?ti:"";case Q.MONTH:return t===re.MONTHLY?ri:"";case Q.PERPETUAL:return ii;case Q.TERM_LICENSE:return t===re.P3Y?ni:"";default:return""}};function bn(e){let{priceDetails:t}=e,{price:r,priceWithoutDiscount:i,priceWithoutTax:n,priceWithoutDiscountAndTax:a,taxDisplay:o}=t;if(o!==as)return e;let s={...e,priceDetails:{...t,price:n??r,priceWithoutDiscount:a??i,taxDisplay:os}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var cs="mas-commerce-service",ls={requestId:nt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function pt(e,{country:t,forceTaxExclusive:r,perpetual:i}){let n;if(e.length<2)n=e;else{let a=t==="GB"?"EN":"MULT";e.sort((o,s)=>o.language===a?-1:s.language===a?1:0),e.sort((o,s)=>!o.term&&s.term?-1:o.term&&!s.term?1:0),n=[e[0]]}return r&&(n=n.map(bn)),n}var Yt=e=>window.setTimeout(e);function qe(e,t=1){if(e==null)return[t];let r=(Array.isArray(e)?e:String(e).split(",")).map(mn).filter(dt);return r.length||(r=[t]),r}function Xt(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(pn)}function j(){return document.getElementsByTagName(cs)?.[0]}function vn(e){let t={};if(!e?.headers)return t;let r=e.headers;for(let[i,n]of Object.entries(ls)){let a=r.get(n);a&&(a=a.replace(/[,;]/g,"|"),a=a.replace(/[| ]+/g,"|"),t[i]=a)}return t}var _e={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,tags:"acom",isProdDomain:!1},En=1e3;function ds(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function yn(e){if(e==null)return;let t=typeof e;if(t==="function")return e.name?`function ${e.name}`:"function";if(t==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:i,originatingRequest:n,status:a}=e;return[i,a,n].filter(Boolean).join(" ")}let r=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!_e.serializableTypes.includes(r))return r}return e}function hs(e,t){if(!_e.ignoredProperties.includes(e))return yn(t)}var ai={append(e){if(e.level!=="error")return;let{message:t,params:r}=e,i=[],n=[],a=t;r.forEach(c=>{c!=null&&(ds(c)?i:n).push(c)}),i.length&&(a+=" "+i.map(yn).join(" "));let{pathname:o,search:s}=window.location,l=`${_e.delimiter}page=${o}${s}`;l.length>En&&(l=`${l.slice(0,En)}<trunc>`),a+=l,n.length&&(a+=`${_e.delimiter}facts=`,a+=JSON.stringify(n,hs)),window.lana?.log(a,_e)}};function Kt(e){Object.assign(_e,Object.fromEntries(Object.entries(e).filter(([t,r])=>t in _e&&r!==""&&r!==null&&r!==void 0&&!Number.isNaN(r))))}var An={LOCAL:"local",PROD:"prod",STAGE:"stage"},oi={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},si=new Set,ci=new Set,Tn=new Map,Sn={append({level:e,message:t,params:r,timestamp:i,source:n}){console[e](`${i}ms [${n}] %c${t}`,"font-weight: bold;",...r)}},wn={filter:({level:e})=>e!==oi.DEBUG},ps={filter:()=>!1};function ms(e,t,r,i,n){return{level:e,message:t,namespace:r,get params(){return i.length===1&&Gt(i[0])&&(i=i[0](),Array.isArray(i)||(i=[i])),i},source:n,timestamp:performance.now().toFixed(3)}}function us(e){[...ci].every(t=>t(e))&&si.forEach(t=>t(e))}function _n(e){let t=(Tn.get(e)??0)+1;Tn.set(e,t);let r=`${e} #${t}`,i={id:r,namespace:e,module:n=>_n(`${i.namespace}/${n}`),updateConfig:Kt};return Object.values(oi).forEach(n=>{i[n]=(a,...o)=>us(ms(n,a,e,o,r))}),Object.seal(i)}function Qt(...e){e.forEach(t=>{let{append:r,filter:i}=t;Gt(i)&&ci.add(i),Gt(r)&&si.add(r)})}function fs(e={}){let{name:t}=e,r=x(M("commerce.debug",{search:!0,storage:!0}),t===An.LOCAL);return Qt(r?Sn:wn),t===An.PROD&&Qt(ai),ie}function gs(){si.clear(),ci.clear()}var ie={..._n(Rr),Level:oi,Plugins:{consoleAppender:Sn,debugFilter:wn,quietFilter:ps,lanaAppender:ai},init:fs,reset:gs,use:Qt};var We=class e extends Error{constructor(t,r,i){if(super(t,{cause:i}),this.name="MasError",r.response){let n=r.response.headers?.get(nt);n&&(r.requestId=n),r.response.status&&(r.status=r.response.status,r.statusText=r.response.statusText),r.response.url&&(r.url=r.response.url)}delete r.response,this.context=r,Error.captureStackTrace&&Error.captureStackTrace(this,e)}toString(){let t=Object.entries(this.context||{}).map(([i,n])=>`${i}: ${JSON.stringify(n)}`).join(", "),r=`${this.name}: ${this.message}`;return t&&(r+=` (${t})`),this.cause&&(r+=`
Caused by: ${this.cause}`),r}};var xs={[ae]:Tr,[xe]:Sr,[de]:wr},bs={[ae]:Cr,[de]:Lr},mt,Ee=class{constructor(t){$(this,mt);g(this,"changes",new Map);g(this,"connected",!1);g(this,"error");g(this,"log");g(this,"options");g(this,"promises",[]);g(this,"state",xe);g(this,"timer",null);g(this,"value");g(this,"version",0);g(this,"wrapperElement");this.wrapperElement=t,this.log=ie.module("mas-element")}update(){[ae,xe,de].forEach(t=>{this.wrapperElement.classList.toggle(xs[t],t===this.state)})}notify(){(this.state===de||this.state===ae)&&(this.state===de?this.promises.forEach(({resolve:r})=>r(this.wrapperElement)):this.state===ae&&this.promises.forEach(({reject:r})=>r(this.error)),this.promises=[]);let t=this.error;this.error instanceof We&&(t={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(bs[this.state],{bubbles:!0,detail:t}))}attributeChangedCallback(t,r,i){this.changes.set(t,i),this.requestUpdate()}connectedCallback(){G(this,mt,j()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:t,promises:r,state:i}=this;return de===i?Promise.resolve(this.wrapperElement):ae===i?Promise.reject(t):new Promise((n,a)=>{r.push({resolve:n,reject:a})})}toggleResolved(t,r,i){return t!==this.version?!1:(i!==void 0&&(this.options=i),this.state=de,this.value=r,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:r}),Yt(()=>this.notify()),!0)}toggleFailed(t,r,i){if(t!==this.version)return!1;i!==void 0&&(this.options=i),this.error=r,this.state=ae,this.update();let n=this.wrapperElement.getAttribute("is");return this.log?.error(`${n}: Failed to render: ${r.message}`,{element:this.wrapperElement,...r.context,...w(this,mt)?.duration}),Yt(()=>this.notify()),!0}togglePending(t){return this.version++,t&&(this.options=t),this.state=xe,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!j()||this.timer)return;let{error:r,options:i,state:n,value:a,version:o}=this;this.state=xe,this.timer=Yt(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||t)try{await this.wrapperElement.render?.()===!1&&this.state===xe&&this.version===o&&(this.state=n,this.error=r,this.value=a,this.update(),this.notify())}catch(l){this.toggleFailed(this.version,l,i)}})}};mt=new WeakMap;function Pn(e={}){return Object.entries(e).forEach(([t,r])=>{(r==null||r===""||r?.length===0)&&delete e[t]}),e}function Zt(e,t={}){let{tag:r,is:i}=e,n=document.createElement(r,{is:i});return n.setAttribute("is",i),Object.assign(n.dataset,Pn(t)),n}function Jt(e,t={}){return e instanceof HTMLElement?(Object.assign(e.dataset,Pn(t)),e):null}function vs(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var Le,Pe=class Pe extends HTMLAnchorElement{constructor(){super();g(this,"masElement",new Ee(this));$(this,Le);this.setAttribute("is",Pe.is)}get isUptLink(){return!0}initializeWcsData(r,i){this.setAttribute("data-wcs-osi",r),i&&this.setAttribute("data-promotion-code",i)}attributeChangedCallback(r,i,n){this.masElement.attributeChangedCallback(r,i,n)}connectedCallback(){this.masElement.connectedCallback(),G(this,Le,ot()),w(this,Le)&&(this.log=w(this,Le).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),G(this,Le,void 0)}requestUpdate(r=!1){this.masElement.requestUpdate(r)}onceSettled(){return this.masElement.onceSettled()}async render(){let r=ot();if(!r)return!1;this.dataset.imsCountry||r.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let i=r.collectCheckoutOptions({},this);if(!i.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let n=this.masElement.togglePending(i),a=r.resolveOfferSelectors(i);try{let[[o]]=await Promise.all(a),{country:s,language:l,env:c}=i,d=`locale=${l}_${s}&country=${s}&offer_id=${o.offerId}`,m=this.getAttribute("data-promotion-code");m&&(d+=`&promotion_code=${encodeURIComponent(m)}`),this.href=`${vs(c)}?${d}`,this.masElement.toggleResolved(n,o,i)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${i.wcsOsi}.`,o.message);return this.masElement.toggleFailed(n,s,i),!1}}static createFrom(r){let i=new Pe;for(let n of r.attributes)n.name!=="is"&&(n.name==="class"&&n.value.includes("upt-link")?i.setAttribute("class",n.value.replace("upt-link","").trim()):i.setAttribute(n.name,n.value));return i.innerHTML=r.innerHTML,i.setAttribute("tabindex",0),i}};Le=new WeakMap,g(Pe,"is","upt-link"),g(Pe,"tag","a"),g(Pe,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var Ce=Pe;window.customElements.get(Ce.is)||window.customElements.define(Ce.is,Ce,{extends:Ce.tag});function Cn(e){return e&&(e.startsWith("plans")?"plans":e)}var Ln="download",Rn="upgrade",Mn={e:"EDU",t:"TEAM"};function Nn(e,t={},r=""){let i=j();if(!i)return null;let{checkoutMarketSegment:n,checkoutWorkflow:a,checkoutWorkflowStep:o,entitlement:s,upgrade:l,modal:c,perpetual:d,promotionCode:m,quantity:p,wcsOsi:h,extraOptions:u,analyticsId:f}=i.collectCheckoutOptions(t),v=Zt(e,{checkoutMarketSegment:n,checkoutWorkflow:a,checkoutWorkflowStep:o,entitlement:s,upgrade:l,modal:c,perpetual:d,promotionCode:m,quantity:p,wcsOsi:h,extraOptions:u,analyticsId:f});return r&&(v.innerHTML=`<span style="pointer-events: none;">${r}</span>`),v}function On(e){return class extends e{constructor(){super(...arguments);g(this,"checkoutActionHandler");g(this,"masElement",new Ee(this))}attributeChangedCallback(i,n,a){this.masElement.attributeChangedCallback(i,n,a)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get marketSegment(){let i=this.options?.ms??this.value?.[0].marketSegments?.[0];return Mn[i]??i}get customerSegment(){let i=this.options?.cs??this.value?.[0]?.customerSegment;return Mn[i]??i}get is3in1Modal(){return Object.values(Se).includes(this.getAttribute("data-modal"))}get isOpen3in1Modal(){let i=document.querySelector("meta[name=mas-ff-3in1]");return this.is3in1Modal&&(!i||i.content!=="off")}requestUpdate(i=!1){return this.masElement.requestUpdate(i)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(i={}){let n=j();if(!n)return!1;this.dataset.imsCountry||n.imsCountryPromise.then(m=>{m&&(this.dataset.imsCountry=m)}),i.imsCountry=null;let a=n.collectCheckoutOptions(i,this);if(!a.wcsOsi.length)return!1;let o;try{o=JSON.parse(a.extraOptions??"{}")}catch(m){this.masElement.log?.error("cannot parse exta checkout options",m)}let s=this.masElement.togglePending(a);this.setCheckoutUrl("");let l=n.resolveOfferSelectors(a),c=await Promise.all(l);c=c.map(m=>pt(m,a)),a.country=this.dataset.imsCountry||a.country;let d=await n.buildCheckoutAction?.(c.flat(),{...o,...a},this);return this.renderOffers(c.flat(),a,{},d,s)}renderOffers(i,n,a={},o=void 0,s=void 0){let l=j();if(!l)return!1;if(n={...JSON.parse(this.dataset.extraOptions??"{}"),...n,...a},s??(s=this.masElement.togglePending(n)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),o){this.classList.remove(Ln,Rn),this.masElement.toggleResolved(s,i,n);let{url:d,text:m,className:p,handler:h}=o;d&&this.setCheckoutUrl(d),m&&(this.firstElementChild.innerHTML=m),p&&this.classList.add(...p.split(" ")),h&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=h.bind(this))}if(i.length){if(this.masElement.toggleResolved(s,i,n)){if(!this.classList.contains(Ln)&&!this.classList.contains(Rn)){let d=l.buildCheckoutURL(i,n);this.setCheckoutUrl(n.modal==="true"?"#":d)}return!0}}else{let d=new Error(`Not provided: ${n?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,d,n))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(i){}updateOptions(i={}){let n=j();if(!n)return!1;let{checkoutMarketSegment:a,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:l,upgrade:c,modal:d,perpetual:m,promotionCode:p,quantity:h,wcsOsi:u}=n.collectCheckoutOptions(i);return Jt(this,{checkoutMarketSegment:a,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:l,upgrade:c,modal:d,perpetual:m,promotionCode:p,quantity:h,wcsOsi:u}),!0}}}var ut=class ut extends On(HTMLAnchorElement){static createCheckoutLink(t={},r=""){return Nn(ut,t,r)}setCheckoutUrl(t){this.setAttribute("href",t)}get isCheckoutLink(){return!0}clickHandler(t){if(this.checkoutActionHandler){this.checkoutActionHandler?.(t);return}}};g(ut,"is","checkout-link"),g(ut,"tag","a");var he=ut;window.customElements.get(he.is)||window.customElements.define(he.is,he,{extends:he.tag});var Es="p_draft_landscape",ys="/store/",As=new Map([["countrySpecific","cs"],["customerSegment","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["addonProductArrangementCode","ao"],["offerType","ot"],["marketSegment","ms"]]),li=new Set(["af","ai","ao","apc","appctxid","cli","co","cs","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),Ts=["env","workflowStep","clientId","country"],In=e=>As.get(e)??e;function di(e,t,r){for(let[i,n]of Object.entries(e)){let a=In(i);n!=null&&r.has(a)&&t.set(a,n)}}function Ss(e){switch(e){case Hr.PRODUCTION:return"https://commerce.adobe.com";default:return"https://commerce-stg.adobe.com"}}function ws(e,t){for(let r in e){let i=e[r];for(let[n,a]of Object.entries(i)){if(a==null)continue;let o=In(n);t.set(`items[${r}][${o}]`,a)}}}function _s({url:e,modal:t,is3in1:r}){if(!r||!e?.searchParams)return e;e.searchParams.set("rtc","t"),e.searchParams.set("lo","sl");let i=e.searchParams.get("af");return e.searchParams.set("af",[i,"uc_new_user_iframe","uc_new_system_close"].filter(Boolean).join(",")),e.searchParams.get("cli")!=="doc_cloud"&&e.searchParams.set("cli",t===Se.CRM?"creative":"mini_plans"),e}function kn(e){Ps(e);let{env:t,items:r,workflowStep:i,marketSegment:n,customerSegment:a,offerType:o,productArrangementCode:s,landscape:l,modal:c,is3in1:d,preselectPlan:m,...p}=e,h=new URL(Ss(t));if(h.pathname=`${ys}${i}`,i!==W.SEGMENTATION&&i!==W.CHANGE_PLAN_TEAM_PLANS&&ws(r,h.searchParams),di({...p},h.searchParams,li),l===be.DRAFT&&di({af:Es},h.searchParams,li),i===W.SEGMENTATION){let u={marketSegment:n,offerType:o,customerSegment:a,productArrangementCode:s,quantity:r?.[0]?.quantity,addonProductArrangementCode:s?r?.find(f=>f.productArrangementCode!==s)?.productArrangementCode:r?.[1]?.productArrangementCode};m?.toLowerCase()==="edu"?h.searchParams.set("ms","EDU"):m?.toLowerCase()==="team"&&h.searchParams.set("cs","TEAM"),di(u,h.searchParams,li),h.searchParams.get("ot")==="PROMOTION"&&h.searchParams.delete("ot"),h=_s({url:h,modal:c,is3in1:d})}return h.toString()}function Ps(e){for(let t of Ts)if(!e[t])throw new Error('Argument "checkoutData" is not valid, missing: '+t);if(e.workflowStep!==W.SEGMENTATION&&e.workflowStep!==W.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}var _=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflowStep:W.EMAIL,country:"US",displayOldPrice:!1,displayPerUnit:!0,displayRecurrence:!0,displayTax:!1,displayPlanType:!1,env:le.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:be.PUBLISHED});function Hn({settings:e,providers:t}){function r(a,o){let{checkoutClientId:s,checkoutWorkflowStep:l,country:c,language:d,promotionCode:m,quantity:p,preselectPlan:h,env:u}=e,f={checkoutClientId:s,checkoutWorkflowStep:l,country:c,language:d,promotionCode:m,quantity:p,preselectPlan:h,env:u};if(o)for(let Oe of t.checkout)Oe(o,f);let{checkoutMarketSegment:v,checkoutWorkflowStep:P=l,imsCountry:y,country:E=y??c,language:S=d,quantity:C=p,entitlement:O,upgrade:B,modal:q,perpetual:H,promotionCode:R=m,wcsOsi:F,extraOptions:Z,...fe}=Object.assign(f,o?.dataset??{},a??{}),ce=ht(P,W,_.checkoutWorkflowStep);return f=Vt({...fe,extraOptions:Z,checkoutClientId:s,checkoutMarketSegment:v,country:E,quantity:qe(C,_.quantity),checkoutWorkflowStep:ce,language:S,entitlement:x(O),upgrade:x(B),modal:q,perpetual:x(H),promotionCode:qt(R).effectivePromoCode,wcsOsi:Xt(F),preselectPlan:h}),f}function i(a,o){if(!Array.isArray(a)||!a.length||!o)return"";let{env:s,landscape:l}=e,{checkoutClientId:c,checkoutMarketSegment:d,checkoutWorkflowStep:m,country:p,promotionCode:h,quantity:u,preselectPlan:f,ms:v,cs:P,...y}=r(o),E=document.querySelector("meta[name=mas-ff-3in1]"),S=Object.values(Se).includes(o.modal)&&(!E||E.content!=="off"),C=window.frameElement||S?"if":"fp",[{productArrangementCode:O,marketSegments:[B],customerSegment:q,offerType:H}]=a,R=v??B??d,F=P??q;f?.toLowerCase()==="edu"?R="EDU":f?.toLowerCase()==="team"&&(F="TEAM");let Z={is3in1:S,checkoutPromoCode:h,clientId:c,context:C,country:p,env:s,items:[],marketSegment:R,customerSegment:F,offerType:H,productArrangementCode:O,workflowStep:m,landscape:l,...y},fe=u[0]>1?u[0]:void 0;if(a.length===1){let{offerId:ce}=a[0];Z.items.push({id:ce,quantity:fe})}else Z.items.push(...a.map(({offerId:ce,productArrangementCode:Oe})=>({id:ce,quantity:fe,...S?{productArrangementCode:Oe}:{}})));return kn(Z)}let{createCheckoutLink:n}=he;return{CheckoutLink:he,CheckoutWorkflowStep:W,buildCheckoutURL:i,collectCheckoutOptions:r,createCheckoutLink:n}}function Cs({interval:e=200,maxAttempts:t=25}={}){let r=ie.module("ims");return new Promise(i=>{r.debug("Waing for IMS to be ready");let n=0;function a(){window.adobeIMS?.initialized?i():++n>t?(r.debug("Timeout"),i()):setTimeout(a,e)}a()})}function Ls(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function Rs(e){let t=ie.module("ims");return e.then(r=>r?window.adobeIMS.getProfile().then(({countryCode:i})=>(t.debug("Got user country:",i),i),i=>{t.error("Unable to get user country:",i)}):null)}function Dn({}){let e=Cs(),t=Ls(e),r=Rs(t);return{imsReadyPromise:e,imsSignedInPromise:t,imsCountryPromise:r}}var Bn=window.masPriceLiterals;function Un(e){if(Array.isArray(Bn)){let t=i=>Bn.find(n=>Wr(n.lang,i)),r=t(e.language)??t(_.language);if(r)return Object.freeze(r)}return{}}var hi=function(e,t){return hi=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(r,i){r.__proto__=i}||function(r,i){for(var n in i)Object.prototype.hasOwnProperty.call(i,n)&&(r[n]=i[n])},hi(e,t)};function ft(e,t){if(typeof t!="function"&&t!==null)throw new TypeError("Class extends value "+String(t)+" is not a constructor or null");hi(e,t);function r(){this.constructor=e}e.prototype=t===null?Object.create(t):(r.prototype=t.prototype,new r)}var A=function(){return A=Object.assign||function(t){for(var r,i=1,n=arguments.length;i<n;i++){r=arguments[i];for(var a in r)Object.prototype.hasOwnProperty.call(r,a)&&(t[a]=r[a])}return t},A.apply(this,arguments)};function er(e,t,r){if(r||arguments.length===2)for(var i=0,n=t.length,a;i<n;i++)(a||!(i in t))&&(a||(a=Array.prototype.slice.call(t,0,i)),a[i]=t[i]);return e.concat(a||Array.prototype.slice.call(t))}var b;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(b||(b={}));var N;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(N||(N={}));var Re;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(Re||(Re={}));function pi(e){return e.type===N.literal}function Fn(e){return e.type===N.argument}function tr(e){return e.type===N.number}function rr(e){return e.type===N.date}function ir(e){return e.type===N.time}function nr(e){return e.type===N.select}function ar(e){return e.type===N.plural}function $n(e){return e.type===N.pound}function or(e){return e.type===N.tag}function sr(e){return!!(e&&typeof e=="object"&&e.type===Re.number)}function gt(e){return!!(e&&typeof e=="object"&&e.type===Re.dateTime)}var mi=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var Ms=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function Gn(e){var t={};return e.replace(Ms,function(r){var i=r.length;switch(r[0]){case"G":t.era=i===4?"long":i===5?"narrow":"short";break;case"y":t.year=i===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":t.month=["numeric","2-digit","short","long","narrow"][i-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":t.day=["numeric","2-digit"][i-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":t.weekday=i===4?"short":i===5?"narrow":"short";break;case"e":if(i<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][i-4];break;case"c":if(i<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][i-4];break;case"a":t.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":t.hourCycle="h12",t.hour=["numeric","2-digit"][i-1];break;case"H":t.hourCycle="h23",t.hour=["numeric","2-digit"][i-1];break;case"K":t.hourCycle="h11",t.hour=["numeric","2-digit"][i-1];break;case"k":t.hourCycle="h24",t.hour=["numeric","2-digit"][i-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":t.minute=["numeric","2-digit"][i-1];break;case"s":t.second=["numeric","2-digit"][i-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":t.timeZoneName=i<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),t}var zn=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function Wn(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var t=e.split(zn).filter(function(p){return p.length>0}),r=[],i=0,n=t;i<n.length;i++){var a=n[i],o=a.split("/");if(o.length===0)throw new Error("Invalid number skeleton");for(var s=o[0],l=o.slice(1),c=0,d=l;c<d.length;c++){var m=d[c];if(m.length===0)throw new Error("Invalid number skeleton")}r.push({stem:s,options:l})}return r}function Ns(e){return e.replace(/^(.*?)-/,"")}var Vn=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,Yn=/^(@+)?(\+|#+)?[rs]?$/g,Os=/(\*)(0+)|(#+)(0+)|(0+)/g,Xn=/^(0+)$/;function jn(e){var t={};return e[e.length-1]==="r"?t.roundingPriority="morePrecision":e[e.length-1]==="s"&&(t.roundingPriority="lessPrecision"),e.replace(Yn,function(r,i,n){return typeof n!="string"?(t.minimumSignificantDigits=i.length,t.maximumSignificantDigits=i.length):n==="+"?t.minimumSignificantDigits=i.length:i[0]==="#"?t.maximumSignificantDigits=i.length:(t.minimumSignificantDigits=i.length,t.maximumSignificantDigits=i.length+(typeof n=="string"?n.length:0)),""}),t}function Kn(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function Is(e){var t;if(e[0]==="E"&&e[1]==="E"?(t={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(t={notation:"scientific"},e=e.slice(1)),t){var r=e.slice(0,2);if(r==="+!"?(t.signDisplay="always",e=e.slice(2)):r==="+?"&&(t.signDisplay="exceptZero",e=e.slice(2)),!Xn.test(e))throw new Error("Malformed concise eng/scientific notation");t.minimumIntegerDigits=e.length}return t}function qn(e){var t={},r=Kn(e);return r||t}function Qn(e){for(var t={},r=0,i=e;r<i.length;r++){var n=i[r];switch(n.stem){case"percent":case"%":t.style="percent";continue;case"%x100":t.style="percent",t.scale=100;continue;case"currency":t.style="currency",t.currency=n.options[0];continue;case"group-off":case",_":t.useGrouping=!1;continue;case"precision-integer":case".":t.maximumFractionDigits=0;continue;case"measure-unit":case"unit":t.style="unit",t.unit=Ns(n.options[0]);continue;case"compact-short":case"K":t.notation="compact",t.compactDisplay="short";continue;case"compact-long":case"KK":t.notation="compact",t.compactDisplay="long";continue;case"scientific":t=A(A(A({},t),{notation:"scientific"}),n.options.reduce(function(l,c){return A(A({},l),qn(c))},{}));continue;case"engineering":t=A(A(A({},t),{notation:"engineering"}),n.options.reduce(function(l,c){return A(A({},l),qn(c))},{}));continue;case"notation-simple":t.notation="standard";continue;case"unit-width-narrow":t.currencyDisplay="narrowSymbol",t.unitDisplay="narrow";continue;case"unit-width-short":t.currencyDisplay="code",t.unitDisplay="short";continue;case"unit-width-full-name":t.currencyDisplay="name",t.unitDisplay="long";continue;case"unit-width-iso-code":t.currencyDisplay="symbol";continue;case"scale":t.scale=parseFloat(n.options[0]);continue;case"integer-width":if(n.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");n.options[0].replace(Os,function(l,c,d,m,p,h){if(c)t.minimumIntegerDigits=d.length;else{if(m&&p)throw new Error("We currently do not support maximum integer digits");if(h)throw new Error("We currently do not support exact integer digits")}return""});continue}if(Xn.test(n.stem)){t.minimumIntegerDigits=n.stem.length;continue}if(Vn.test(n.stem)){if(n.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");n.stem.replace(Vn,function(l,c,d,m,p,h){return d==="*"?t.minimumFractionDigits=c.length:m&&m[0]==="#"?t.maximumFractionDigits=m.length:p&&h?(t.minimumFractionDigits=p.length,t.maximumFractionDigits=p.length+h.length):(t.minimumFractionDigits=c.length,t.maximumFractionDigits=c.length),""});var a=n.options[0];a==="w"?t=A(A({},t),{trailingZeroDisplay:"stripIfInteger"}):a&&(t=A(A({},t),jn(a)));continue}if(Yn.test(n.stem)){t=A(A({},t),jn(n.stem));continue}var o=Kn(n.stem);o&&(t=A(A({},t),o));var s=Is(n.stem);s&&(t=A(A({},t),s))}return t}var xt={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function Zn(e,t){for(var r="",i=0;i<e.length;i++){var n=e.charAt(i);if(n==="j"){for(var a=0;i+1<e.length&&e.charAt(i+1)===n;)a++,i++;var o=1+(a&1),s=a<2?1:3+(a>>1),l="a",c=ks(t);for((c=="H"||c=="k")&&(s=0);s-- >0;)r+=l;for(;o-- >0;)r=c+r}else n==="J"?r+="H":r+=n}return r}function ks(e){var t=e.hourCycle;if(t===void 0&&e.hourCycles&&e.hourCycles.length&&(t=e.hourCycles[0]),t)switch(t){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var r=e.language,i;r!=="root"&&(i=e.maximize().region);var n=xt[i||""]||xt[r||""]||xt["".concat(r,"-001")]||xt["001"];return n[0]}var ui,Hs=new RegExp("^".concat(mi.source,"*")),Ds=new RegExp("".concat(mi.source,"*$"));function T(e,t){return{start:e,end:t}}var Bs=!!String.prototype.startsWith,Us=!!String.fromCodePoint,Fs=!!Object.fromEntries,$s=!!String.prototype.codePointAt,Gs=!!String.prototype.trimStart,zs=!!String.prototype.trimEnd,Vs=!!Number.isSafeInteger,js=Vs?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},gi=!0;try{Jn=ia("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),gi=((ui=Jn.exec("a"))===null||ui===void 0?void 0:ui[0])==="a"}catch{gi=!1}var Jn,ea=Bs?function(t,r,i){return t.startsWith(r,i)}:function(t,r,i){return t.slice(i,i+r.length)===r},xi=Us?String.fromCodePoint:function(){for(var t=[],r=0;r<arguments.length;r++)t[r]=arguments[r];for(var i="",n=t.length,a=0,o;n>a;){if(o=t[a++],o>1114111)throw RangeError(o+" is not a valid code point");i+=o<65536?String.fromCharCode(o):String.fromCharCode(((o-=65536)>>10)+55296,o%1024+56320)}return i},ta=Fs?Object.fromEntries:function(t){for(var r={},i=0,n=t;i<n.length;i++){var a=n[i],o=a[0],s=a[1];r[o]=s}return r},ra=$s?function(t,r){return t.codePointAt(r)}:function(t,r){var i=t.length;if(!(r<0||r>=i)){var n=t.charCodeAt(r),a;return n<55296||n>56319||r+1===i||(a=t.charCodeAt(r+1))<56320||a>57343?n:(n-55296<<10)+(a-56320)+65536}},qs=Gs?function(t){return t.trimStart()}:function(t){return t.replace(Hs,"")},Ws=zs?function(t){return t.trimEnd()}:function(t){return t.replace(Ds,"")};function ia(e,t){return new RegExp(e,t)}var bi;gi?(fi=ia("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),bi=function(t,r){var i;fi.lastIndex=r;var n=fi.exec(t);return(i=n[1])!==null&&i!==void 0?i:""}):bi=function(t,r){for(var i=[];;){var n=ra(t,r);if(n===void 0||aa(n)||Ks(n))break;i.push(n),r+=n>=65536?2:1}return xi.apply(void 0,i)};var fi,na=function(){function e(t,r){r===void 0&&(r={}),this.message=t,this.position={offset:0,line:1,column:1},this.ignoreTag=!!r.ignoreTag,this.locale=r.locale,this.requiresOtherClause=!!r.requiresOtherClause,this.shouldParseSkeletons=!!r.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(t,r,i){for(var n=[];!this.isEOF();){var a=this.char();if(a===123){var o=this.parseArgument(t,i);if(o.err)return o;n.push(o.val)}else{if(a===125&&t>0)break;if(a===35&&(r==="plural"||r==="selectordinal")){var s=this.clonePosition();this.bump(),n.push({type:N.pound,location:T(s,this.clonePosition())})}else if(a===60&&!this.ignoreTag&&this.peek()===47){if(i)break;return this.error(b.UNMATCHED_CLOSING_TAG,T(this.clonePosition(),this.clonePosition()))}else if(a===60&&!this.ignoreTag&&vi(this.peek()||0)){var o=this.parseTag(t,r);if(o.err)return o;n.push(o.val)}else{var o=this.parseLiteral(t,r);if(o.err)return o;n.push(o.val)}}}return{val:n,err:null}},e.prototype.parseTag=function(t,r){var i=this.clonePosition();this.bump();var n=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:N.literal,value:"<".concat(n,"/>"),location:T(i,this.clonePosition())},err:null};if(this.bumpIf(">")){var a=this.parseMessage(t+1,r,!0);if(a.err)return a;var o=a.val,s=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!vi(this.char()))return this.error(b.INVALID_TAG,T(s,this.clonePosition()));var l=this.clonePosition(),c=this.parseTagName();return n!==c?this.error(b.UNMATCHED_CLOSING_TAG,T(l,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:N.tag,value:n,children:o,location:T(i,this.clonePosition())},err:null}:this.error(b.INVALID_TAG,T(s,this.clonePosition())))}else return this.error(b.UNCLOSED_TAG,T(i,this.clonePosition()))}else return this.error(b.INVALID_TAG,T(i,this.clonePosition()))},e.prototype.parseTagName=function(){var t=this.offset();for(this.bump();!this.isEOF()&&Xs(this.char());)this.bump();return this.message.slice(t,this.offset())},e.prototype.parseLiteral=function(t,r){for(var i=this.clonePosition(),n="";;){var a=this.tryParseQuote(r);if(a){n+=a;continue}var o=this.tryParseUnquoted(t,r);if(o){n+=o;continue}var s=this.tryParseLeftAngleBracket();if(s){n+=s;continue}break}var l=T(i,this.clonePosition());return{val:{type:N.literal,value:n,location:l},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!Ys(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(t){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(t==="plural"||t==="selectordinal")break;return null;default:return null}this.bump();var r=[this.char()];for(this.bump();!this.isEOF();){var i=this.char();if(i===39)if(this.peek()===39)r.push(39),this.bump();else{this.bump();break}else r.push(i);this.bump()}return xi.apply(void 0,r)},e.prototype.tryParseUnquoted=function(t,r){if(this.isEOF())return null;var i=this.char();return i===60||i===123||i===35&&(r==="plural"||r==="selectordinal")||i===125&&t>0?null:(this.bump(),xi(i))},e.prototype.parseArgument=function(t,r){var i=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(b.EXPECT_ARGUMENT_CLOSING_BRACE,T(i,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(b.EMPTY_ARGUMENT,T(i,this.clonePosition()));var n=this.parseIdentifierIfPossible().value;if(!n)return this.error(b.MALFORMED_ARGUMENT,T(i,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(b.EXPECT_ARGUMENT_CLOSING_BRACE,T(i,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:N.argument,value:n,location:T(i,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(b.EXPECT_ARGUMENT_CLOSING_BRACE,T(i,this.clonePosition())):this.parseArgumentOptions(t,r,n,i);default:return this.error(b.MALFORMED_ARGUMENT,T(i,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var t=this.clonePosition(),r=this.offset(),i=bi(this.message,r),n=r+i.length;this.bumpTo(n);var a=this.clonePosition(),o=T(t,a);return{value:i,location:o}},e.prototype.parseArgumentOptions=function(t,r,i,n){var a,o=this.clonePosition(),s=this.parseIdentifierIfPossible().value,l=this.clonePosition();switch(s){case"":return this.error(b.EXPECT_ARGUMENT_TYPE,T(o,l));case"number":case"date":case"time":{this.bumpSpace();var c=null;if(this.bumpIf(",")){this.bumpSpace();var d=this.clonePosition(),m=this.parseSimpleArgStyleIfPossible();if(m.err)return m;var p=Ws(m.val);if(p.length===0)return this.error(b.EXPECT_ARGUMENT_STYLE,T(this.clonePosition(),this.clonePosition()));var h=T(d,this.clonePosition());c={style:p,styleLocation:h}}var u=this.tryParseArgumentClose(n);if(u.err)return u;var f=T(n,this.clonePosition());if(c&&ea(c?.style,"::",0)){var v=qs(c.style.slice(2));if(s==="number"){var m=this.parseNumberSkeletonFromString(v,c.styleLocation);return m.err?m:{val:{type:N.number,value:i,location:f,style:m.val},err:null}}else{if(v.length===0)return this.error(b.EXPECT_DATE_TIME_SKELETON,f);var P=v;this.locale&&(P=Zn(v,this.locale));var p={type:Re.dateTime,pattern:P,location:c.styleLocation,parsedOptions:this.shouldParseSkeletons?Gn(P):{}},y=s==="date"?N.date:N.time;return{val:{type:y,value:i,location:f,style:p},err:null}}}return{val:{type:s==="number"?N.number:s==="date"?N.date:N.time,value:i,location:f,style:(a=c?.style)!==null&&a!==void 0?a:null},err:null}}case"plural":case"selectordinal":case"select":{var E=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(b.EXPECT_SELECT_ARGUMENT_OPTIONS,T(E,A({},E)));this.bumpSpace();var S=this.parseIdentifierIfPossible(),C=0;if(s!=="select"&&S.value==="offset"){if(!this.bumpIf(":"))return this.error(b.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,T(this.clonePosition(),this.clonePosition()));this.bumpSpace();var m=this.tryParseDecimalInteger(b.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,b.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(m.err)return m;this.bumpSpace(),S=this.parseIdentifierIfPossible(),C=m.val}var O=this.tryParsePluralOrSelectOptions(t,s,r,S);if(O.err)return O;var u=this.tryParseArgumentClose(n);if(u.err)return u;var B=T(n,this.clonePosition());return s==="select"?{val:{type:N.select,value:i,options:ta(O.val),location:B},err:null}:{val:{type:N.plural,value:i,options:ta(O.val),offset:C,pluralType:s==="plural"?"cardinal":"ordinal",location:B},err:null}}default:return this.error(b.INVALID_ARGUMENT_TYPE,T(o,l))}},e.prototype.tryParseArgumentClose=function(t){return this.isEOF()||this.char()!==125?this.error(b.EXPECT_ARGUMENT_CLOSING_BRACE,T(t,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var t=0,r=this.clonePosition();!this.isEOF();){var i=this.char();switch(i){case 39:{this.bump();var n=this.clonePosition();if(!this.bumpUntil("'"))return this.error(b.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,T(n,this.clonePosition()));this.bump();break}case 123:{t+=1,this.bump();break}case 125:{if(t>0)t-=1;else return{val:this.message.slice(r.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(r.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(t,r){var i=[];try{i=Wn(t)}catch{return this.error(b.INVALID_NUMBER_SKELETON,r)}return{val:{type:Re.number,tokens:i,location:r,parsedOptions:this.shouldParseSkeletons?Qn(i):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(t,r,i,n){for(var a,o=!1,s=[],l=new Set,c=n.value,d=n.location;;){if(c.length===0){var m=this.clonePosition();if(r!=="select"&&this.bumpIf("=")){var p=this.tryParseDecimalInteger(b.EXPECT_PLURAL_ARGUMENT_SELECTOR,b.INVALID_PLURAL_ARGUMENT_SELECTOR);if(p.err)return p;d=T(m,this.clonePosition()),c=this.message.slice(m.offset,this.offset())}else break}if(l.has(c))return this.error(r==="select"?b.DUPLICATE_SELECT_ARGUMENT_SELECTOR:b.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,d);c==="other"&&(o=!0),this.bumpSpace();var h=this.clonePosition();if(!this.bumpIf("{"))return this.error(r==="select"?b.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:b.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,T(this.clonePosition(),this.clonePosition()));var u=this.parseMessage(t+1,r,i);if(u.err)return u;var f=this.tryParseArgumentClose(h);if(f.err)return f;s.push([c,{value:u.val,location:T(h,this.clonePosition())}]),l.add(c),this.bumpSpace(),a=this.parseIdentifierIfPossible(),c=a.value,d=a.location}return s.length===0?this.error(r==="select"?b.EXPECT_SELECT_ARGUMENT_SELECTOR:b.EXPECT_PLURAL_ARGUMENT_SELECTOR,T(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!o?this.error(b.MISSING_OTHER_CLAUSE,T(this.clonePosition(),this.clonePosition())):{val:s,err:null}},e.prototype.tryParseDecimalInteger=function(t,r){var i=1,n=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(i=-1);for(var a=!1,o=0;!this.isEOF();){var s=this.char();if(s>=48&&s<=57)a=!0,o=o*10+(s-48),this.bump();else break}var l=T(n,this.clonePosition());return a?(o*=i,js(o)?{val:o,err:null}:this.error(r,l)):this.error(t,l)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var t=this.position.offset;if(t>=this.message.length)throw Error("out of bound");var r=ra(this.message,t);if(r===void 0)throw Error("Offset ".concat(t," is at invalid UTF-16 code unit boundary"));return r},e.prototype.error=function(t,r){return{val:null,err:{kind:t,message:this.message,location:r}}},e.prototype.bump=function(){if(!this.isEOF()){var t=this.char();t===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=t<65536?1:2)}},e.prototype.bumpIf=function(t){if(ea(this.message,t,this.offset())){for(var r=0;r<t.length;r++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(t){var r=this.offset(),i=this.message.indexOf(t,r);return i>=0?(this.bumpTo(i),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(t){if(this.offset()>t)throw Error("targetOffset ".concat(t," must be greater than or equal to the current offset ").concat(this.offset()));for(t=Math.min(t,this.message.length);;){var r=this.offset();if(r===t)break;if(r>t)throw Error("targetOffset ".concat(t," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&aa(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var t=this.char(),r=this.offset(),i=this.message.charCodeAt(r+(t>=65536?2:1));return i??null},e}();function vi(e){return e>=97&&e<=122||e>=65&&e<=90}function Ys(e){return vi(e)||e===47}function Xs(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function aa(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function Ks(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function Ei(e){e.forEach(function(t){if(delete t.location,nr(t)||ar(t))for(var r in t.options)delete t.options[r].location,Ei(t.options[r].value);else tr(t)&&sr(t.style)||(rr(t)||ir(t))&&gt(t.style)?delete t.style.location:or(t)&&Ei(t.children)})}function oa(e,t){t===void 0&&(t={}),t=A({shouldParseSkeletons:!0,requiresOtherClause:!0},t);var r=new na(e,t).parse();if(r.err){var i=SyntaxError(b[r.err.kind]);throw i.location=r.err.location,i.originalMessage=r.err.message,i}return t?.captureLocation||Ei(r.val),r.val}function bt(e,t){var r=t&&t.cache?t.cache:rc,i=t&&t.serializer?t.serializer:tc,n=t&&t.strategy?t.strategy:Zs;return n(e,{cache:r,serializer:i})}function Qs(e){return e==null||typeof e=="number"||typeof e=="boolean"}function sa(e,t,r,i){var n=Qs(i)?i:r(i),a=t.get(n);return typeof a>"u"&&(a=e.call(this,i),t.set(n,a)),a}function ca(e,t,r){var i=Array.prototype.slice.call(arguments,3),n=r(i),a=t.get(n);return typeof a>"u"&&(a=e.apply(this,i),t.set(n,a)),a}function yi(e,t,r,i,n){return r.bind(t,e,i,n)}function Zs(e,t){var r=e.length===1?sa:ca;return yi(e,this,r,t.cache.create(),t.serializer)}function Js(e,t){return yi(e,this,ca,t.cache.create(),t.serializer)}function ec(e,t){return yi(e,this,sa,t.cache.create(),t.serializer)}var tc=function(){return JSON.stringify(arguments)};function Ai(){this.cache=Object.create(null)}Ai.prototype.get=function(e){return this.cache[e]};Ai.prototype.set=function(e,t){this.cache[e]=t};var rc={create:function(){return new Ai}},cr={variadic:Js,monadic:ec};var Me;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(Me||(Me={}));var vt=function(e){ft(t,e);function t(r,i,n){var a=e.call(this,r)||this;return a.code=i,a.originalMessage=n,a}return t.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},t}(Error);var Ti=function(e){ft(t,e);function t(r,i,n,a){return e.call(this,'Invalid values for "'.concat(r,'": "').concat(i,'". Options are "').concat(Object.keys(n).join('", "'),'"'),Me.INVALID_VALUE,a)||this}return t}(vt);var la=function(e){ft(t,e);function t(r,i,n){return e.call(this,'Value for "'.concat(r,'" must be of type ').concat(i),Me.INVALID_VALUE,n)||this}return t}(vt);var da=function(e){ft(t,e);function t(r,i){return e.call(this,'The intl string context variable "'.concat(r,'" was not provided to the string "').concat(i,'"'),Me.MISSING_VALUE,i)||this}return t}(vt);var z;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(z||(z={}));function ic(e){return e.length<2?e:e.reduce(function(t,r){var i=t[t.length-1];return!i||i.type!==z.literal||r.type!==z.literal?t.push(r):i.value+=r.value,t},[])}function nc(e){return typeof e=="function"}function Et(e,t,r,i,n,a,o){if(e.length===1&&pi(e[0]))return[{type:z.literal,value:e[0].value}];for(var s=[],l=0,c=e;l<c.length;l++){var d=c[l];if(pi(d)){s.push({type:z.literal,value:d.value});continue}if($n(d)){typeof a=="number"&&s.push({type:z.literal,value:r.getNumberFormat(t).format(a)});continue}var m=d.value;if(!(n&&m in n))throw new da(m,o);var p=n[m];if(Fn(d)){(!p||typeof p=="string"||typeof p=="number")&&(p=typeof p=="string"||typeof p=="number"?String(p):""),s.push({type:typeof p=="string"?z.literal:z.object,value:p});continue}if(rr(d)){var h=typeof d.style=="string"?i.date[d.style]:gt(d.style)?d.style.parsedOptions:void 0;s.push({type:z.literal,value:r.getDateTimeFormat(t,h).format(p)});continue}if(ir(d)){var h=typeof d.style=="string"?i.time[d.style]:gt(d.style)?d.style.parsedOptions:i.time.medium;s.push({type:z.literal,value:r.getDateTimeFormat(t,h).format(p)});continue}if(tr(d)){var h=typeof d.style=="string"?i.number[d.style]:sr(d.style)?d.style.parsedOptions:void 0;h&&h.scale&&(p=p*(h.scale||1)),s.push({type:z.literal,value:r.getNumberFormat(t,h).format(p)});continue}if(or(d)){var u=d.children,f=d.value,v=n[f];if(!nc(v))throw new la(f,"function",o);var P=Et(u,t,r,i,n,a),y=v(P.map(function(C){return C.value}));Array.isArray(y)||(y=[y]),s.push.apply(s,y.map(function(C){return{type:typeof C=="string"?z.literal:z.object,value:C}}))}if(nr(d)){var E=d.options[p]||d.options.other;if(!E)throw new Ti(d.value,p,Object.keys(d.options),o);s.push.apply(s,Et(E.value,t,r,i,n));continue}if(ar(d)){var E=d.options["=".concat(p)];if(!E){if(!Intl.PluralRules)throw new vt(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,Me.MISSING_INTL_API,o);var S=r.getPluralRules(t,{type:d.pluralType}).select(p-(d.offset||0));E=d.options[S]||d.options.other}if(!E)throw new Ti(d.value,p,Object.keys(d.options),o);s.push.apply(s,Et(E.value,t,r,i,n,p-(d.offset||0)));continue}}return ic(s)}function ac(e,t){return t?A(A(A({},e||{}),t||{}),Object.keys(e).reduce(function(r,i){return r[i]=A(A({},e[i]),t[i]||{}),r},{})):e}function oc(e,t){return t?Object.keys(e).reduce(function(r,i){return r[i]=ac(e[i],t[i]),r},A({},e)):e}function Si(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function sc(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:bt(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.NumberFormat).bind.apply(t,er([void 0],r,!1)))},{cache:Si(e.number),strategy:cr.variadic}),getDateTimeFormat:bt(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.DateTimeFormat).bind.apply(t,er([void 0],r,!1)))},{cache:Si(e.dateTime),strategy:cr.variadic}),getPluralRules:bt(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.PluralRules).bind.apply(t,er([void 0],r,!1)))},{cache:Si(e.pluralRules),strategy:cr.variadic})}}var ha=function(){function e(t,r,i,n){var a=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=a.formatToParts(o);if(s.length===1)return s[0].value;var l=s.reduce(function(c,d){return!c.length||d.type!==z.literal||typeof c[c.length-1]!="string"?c.push(d.value):c[c.length-1]+=d.value,c},[]);return l.length<=1?l[0]||"":l},this.formatToParts=function(o){return Et(a.ast,a.locales,a.formatters,a.formats,o,void 0,a.message)},this.resolvedOptions=function(){return{locale:a.resolvedLocale.toString()}},this.getAst=function(){return a.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:n?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=oc(e.formats,i),this.formatters=n&&n.formatters||sc(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=oa,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var pa=ha;var cc=/[0-9\-+#]/,lc=/[^\d\-+#]/g;function ma(e){return e.search(cc)}function dc(e="#.##"){let t={},r=e.length,i=ma(e);t.prefix=i>0?e.substring(0,i):"";let n=ma(e.split("").reverse().join("")),a=r-n,o=e.substring(a,a+1),s=a+(o==="."||o===","?1:0);t.suffix=n>0?e.substring(s,r):"",t.mask=e.substring(i,s),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let l=t.mask.match(lc);return t.decimal=l&&l[l.length-1]||".",t.separator=l&&l[1]&&l[0]||",",l=t.mask.split(t.decimal),t.integer=l[0],t.fraction=l[1],t}function hc(e,t,r){let i=!1,n={value:e};e<0&&(i=!0,n.value=-n.value),n.sign=i?"-":"",n.value=Number(n.value).toFixed(t.fraction&&t.fraction.length),n.value=Number(n.value).toString();let a=t.fraction&&t.fraction.lastIndexOf("0"),[o="0",s=""]=n.value.split(".");return(!s||s&&s.length<=a)&&(s=a<0?"":(+("0."+s)).toFixed(a+1).replace("0.","")),n.integer=o,n.fraction=s,pc(n,t),(n.result==="0"||n.result==="")&&(i=!1,n.sign=""),!i&&t.maskHasPositiveSign?n.sign="+":i&&t.maskHasPositiveSign?n.sign="-":i&&(n.sign=r&&r.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),n}function pc(e,t){e.result="";let r=t.integer.split(t.separator),i=r.join(""),n=i&&i.indexOf("0");if(n>-1)for(;e.integer.length<i.length-n;)e.integer="0"+e.integer;else Number(e.integer)===0&&(e.integer="");let a=r[1]&&r[r.length-1].length;if(a){let o=e.integer.length,s=o%a;for(let l=0;l<o;l++)e.result+=e.integer.charAt(l),!((l-s+1)%a)&&l<o-a&&(e.result+=t.separator)}else e.result=e.integer;return e.result+=t.fraction&&e.fraction?t.decimal+e.fraction:"",e}function mc(e,t,r={}){if(!e||isNaN(Number(t)))return t;let i=dc(e),n=hc(t,i,r);return i.prefix+n.sign+n.result+i.suffix}var ua=mc;var fa=".",uc=",",xa=/^\s+/,ba=/\s+$/,ga="&nbsp;",wi=e=>e*12,va=(e,t)=>{let{start:r,end:i,displaySummary:{amount:n,duration:a,minProductQuantity:o,outcomeType:s}={}}=e;if(!(n&&a&&s&&o))return!1;let l=t?new Date(t):new Date;if(!r||!i)return!1;let c=new Date(r),d=new Date(i);return l>=c&&l<=d},Ne={MONTH:"MONTH",YEAR:"YEAR"},fc={[J.ANNUAL]:12,[J.MONTHLY]:1,[J.THREE_YEARS]:36,[J.TWO_YEARS]:24},_i=(e,t)=>({accept:e,round:t}),gc=[_i(({divisor:e,price:t})=>t%e==0,({divisor:e,price:t})=>t/e),_i(({usePrecision:e})=>e,({divisor:e,price:t})=>Math.round(t/e*100)/100),_i(()=>!0,({divisor:e,price:t})=>Math.ceil(Math.floor(t*100/e)/100))],Pi={[Te.YEAR]:{[J.MONTHLY]:Ne.MONTH,[J.ANNUAL]:Ne.YEAR},[Te.MONTH]:{[J.MONTHLY]:Ne.MONTH}},xc=(e,t)=>e.indexOf(`'${t}'`)===0,bc=(e,t=!0)=>{let r=e.replace(/'.*?'/,"").trim(),i=ya(r);return!!i?t||(r=r.replace(/[,\.]0+/,i)):r=r.replace(/\s?(#.*0)(?!\s)?/,"$&"+Ec(e)),r},vc=e=>{let t=yc(e),r=xc(e,t),i=e.replace(/'.*?'/,""),n=xa.test(i)||ba.test(i);return{currencySymbol:t,isCurrencyFirst:r,hasCurrencySpace:n}},Ea=e=>e.replace(xa,ga).replace(ba,ga),Ec=e=>e.match(/#(.?)#/)?.[1]===fa?uc:fa,yc=e=>e.match(/'(.*?)'/)?.[1]??"",ya=e=>e.match(/0(.?)0/)?.[1]??"";function Ye({formatString:e,price:t,usePrecision:r,isIndianPrice:i=!1},n,a=o=>o){let{currencySymbol:o,isCurrencyFirst:s,hasCurrencySpace:l}=vc(e),c=r?ya(e):"",d=bc(e,r),m=r?2:0,p=a(t,{currencySymbol:o}),h=i?p.toLocaleString("hi-IN",{minimumFractionDigits:m,maximumFractionDigits:m}):ua(d,p),u=r?h.lastIndexOf(c):h.length,f=h.substring(0,u),v=h.substring(u+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,h).replace(/SYMBOL/,o),currencySymbol:o,decimals:v,decimalsDelimiter:c,hasCurrencySpace:l,integer:f,isCurrencyFirst:s,recurrenceTerm:n}}var Aa=e=>{let{commitment:t,term:r,usePrecision:i}=e,n=fc[r]??1;return Ye(e,n>1?Ne.MONTH:Pi[t]?.[r],a=>{let o={divisor:n,price:a,usePrecision:i},{round:s}=gc.find(({accept:l})=>l(o));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(o)}`);return s(o)})},Ta=({commitment:e,term:t,...r})=>Ye(r,Pi[e]?.[t]),Sa=e=>{let{commitment:t,instant:r,price:i,originalPrice:n,priceWithoutDiscount:a,promotion:o,quantity:s=1,term:l}=e;if(t===Te.YEAR&&l===J.MONTHLY){if(!o)return Ye(e,Ne.YEAR,wi);let{displaySummary:{outcomeType:c,duration:d,minProductQuantity:m=1}={}}=o;switch(c){case"PERCENTAGE_DISCOUNT":if(s>=m&&va(o,r)){let p=parseInt(d.replace("P","").replace("M",""));if(isNaN(p))return wi(i);let h=s*n*p,u=s*a*(12-p),f=Math.round((h+u)*100)/100;return Ye({...e,price:f},Ne.YEAR)}default:return Ye(e,Ne.YEAR,()=>wi(a??i))}}return Ye(e,Pi[t]?.[l])};var Ci={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},Ac=un("ConsonantTemplates/price"),Tc=/<\/?[^>]+(>|$)/g,D={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},ye={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Li="TAX_EXCLUSIVE",Sc=e=>hn(e)?Object.entries(e).filter(([,t])=>je(t)||zt(t)||t===!0).reduce((t,[r,i])=>t+` ${r}${i===!0?"":'="'+dn(i)+'"'}`,""):"",U=(e,t,r,i=!1)=>`<span class="${e}${t?"":" "+D.disabled}"${Sc(r)}>${i?Ea(t):t??""}</span>`;function pe(e,t,r,i){let n=e[r];if(n==null)return"";try{return new pa(n.replace(Tc,""),t).format(i)}catch{return Ac.error("Failed to format literal:",n),""}}function wc(e,{accessibleLabel:t,altAccessibleLabel:r,currencySymbol:i,decimals:n,decimalsDelimiter:a,hasCurrencySpace:o,integer:s,isCurrencyFirst:l,recurrenceLabel:c,perUnitLabel:d,taxInclusivityLabel:m},p={}){let h=U(D.currencySymbol,i),u=U(D.currencySpace,o?"&nbsp;":""),f="";return t?f=`<sr-only class="strikethrough-aria-label">${t}</sr-only>`:r&&(f=`<sr-only class="alt-aria-label">${r}</sr-only>`),l&&(f+=h+u),f+=U(D.integer,s),f+=U(D.decimalsDelimiter,a),f+=U(D.decimals,n),l||(f+=u+h),f+=U(D.recurrence,c,null,!0),f+=U(D.unitType,d,null,!0),f+=U(D.taxInclusivity,m,!0),U(e,f,{...p})}var X=({isAlternativePrice:e=!1,displayOptical:t=!1,displayStrikethrough:r=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:a,displayFormatted:o=!0,displayRecurrence:s=!0,displayPerUnit:l=!1,displayTax:c=!1,language:d,literals:m={},quantity:p=1,space:h=!1}={},{commitment:u,offerSelectorIds:f,formatString:v,price:P,priceWithoutDiscount:y,taxDisplay:E,taxTerm:S,term:C,usePrecision:O,promotion:B}={},q={})=>{Object.entries({country:a,formatString:v,language:d,price:P}).forEach(([co,lo])=>{if(lo==null)throw new Error(`Argument "${co}" is missing for osi ${f?.toString()}, country ${a}, language ${d}`)});let H={...Ci,...m},R=`${d.toLowerCase()}-${a.toUpperCase()}`,F=r&&y?y:P,Z=t?Aa:Ta;i&&(Z=Sa);let{accessiblePrice:fe,recurrenceTerm:ce,...Oe}=Z({commitment:u,formatString:v,instant:n,isIndianPrice:a==="IN",originalPrice:P,priceWithoutDiscount:y,price:t?P:F,promotion:B,quantity:p,term:C,usePrecision:O}),hr="",pr="",mr="";x(s)&&ce&&(mr=pe(H,R,ye.recurrenceLabel,{recurrenceTerm:ce}));let _t="";x(l)&&(h&&(_t+=" "),_t+=pe(H,R,ye.perUnitLabel,{perUnit:"LICENSE"}));let Pt="";x(c)&&S&&(h&&(Pt+=" "),Pt+=pe(H,R,E===Li?ye.taxExclusiveLabel:ye.taxInclusiveLabel,{taxTerm:S})),r&&(hr=pe(H,R,ye.strikethroughAriaLabel,{strikethroughPrice:hr})),e&&(pr=pe(H,R,ye.alternativePriceAriaLabel,{alternativePrice:pr}));let Ie=D.container;if(t&&(Ie+=" "+D.containerOptical),r&&(Ie+=" "+D.containerStrikethrough),e&&(Ie+=" "+D.containerAlternative),i&&(Ie+=" "+D.containerAnnual),x(o))return wc(Ie,{...Oe,accessibleLabel:hr,altAccessibleLabel:pr,recurrenceLabel:mr,perUnitLabel:_t,taxInclusivityLabel:Pt},q);let{currencySymbol:Ii,decimals:io,decimalsDelimiter:no,hasCurrencySpace:ki,integer:ao,isCurrencyFirst:oo}=Oe,ke=[ao,no,io];oo?(ke.unshift(ki?"\xA0":""),ke.unshift(Ii)):(ke.push(ki?"\xA0":""),ke.push(Ii)),ke.push(mr,_t,Pt);let so=ke.join("");return U(Ie,so,q)},wa=()=>(e,t,r)=>{let n=(e.displayOldPrice===void 0||x(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${n?X({displayStrikethrough:!0})(e,t,r)+"&nbsp;":""}${X({isAlternativePrice:n})(e,t,r)}`},_a=()=>(e,t,r)=>{let{instant:i}=e;try{i||(i=new URLSearchParams(document.location.search).get("instant")),i&&(i=new Date(i))}catch{i=void 0}let n={...e,displayTax:!1,displayPerUnit:!1},o=(e.displayOldPrice===void 0||x(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${o?X({displayStrikethrough:!0})(n,t,r)+"&nbsp;":""}${X({isAlternativePrice:o})(e,t,r)}${U(D.containerAnnualPrefix,"&nbsp;(")}${X({displayAnnual:!0,instant:i})(n,t,r)}${U(D.containerAnnualSuffix,")")}`},Pa=()=>(e,t,r)=>{let i={...e,displayTax:!1,displayPerUnit:!1};return`${X({isAlternativePrice:e.displayOldPrice})(e,t,r)}${U(D.containerAnnualPrefix,"&nbsp;(")}${X({displayAnnual:!0})(i,t,r)}${U(D.containerAnnualSuffix,")")}`};var yt={...D,containerLegal:"price-legal",planType:"price-plan-type"},lr={...ye,planTypeLabel:"planTypeLabel"};function _c(e,{perUnitLabel:t,taxInclusivityLabel:r,planTypeLabel:i},n={}){let a="";return a+=U(yt.unitType,t,null,!0),r&&i&&(r+=". "),a+=U(yt.taxInclusivity,r,!0),a+=U(yt.planType,i,null),U(e,a,{...n})}var Ca=({country:e,displayPerUnit:t=!1,displayTax:r=!1,displayPlanType:i=!1,language:n,literals:a={}}={},{taxDisplay:o,taxTerm:s,planType:l}={},c={})=>{let d={...Ci,...a},m=`${n.toLowerCase()}-${e.toUpperCase()}`,p="";x(t)&&(p=pe(d,m,lr.perUnitLabel,{perUnit:"LICENSE"}));let h="";e==="US"&&n==="en"&&(r=!1),x(r)&&s&&(h=pe(d,m,o===Li?lr.taxExclusiveLabel:lr.taxInclusiveLabel,{taxTerm:s}));let u="";x(i)&&l&&(u=pe(d,m,lr.planTypeLabel,{planType:l}));let f=yt.container;return f+=" "+yt.containerLegal,_c(f,{perUnitLabel:p,taxInclusivityLabel:h,planTypeLabel:u},c)};var La=X(),Ra=wa(),Ma=X({displayOptical:!0}),Na=X({displayStrikethrough:!0}),Oa=X({displayAnnual:!0}),Ia=X({displayOptical:!0,isAlternativePrice:!0}),ka=X({isAlternativePrice:!0}),Ha=Pa(),Da=_a(),Ba=Ca;var Pc=(e,t)=>{if(!(!dt(e)||!dt(t)))return Math.floor((t-e)/t*100)},Ua=()=>(e,t)=>{let{price:r,priceWithoutDiscount:i}=t,n=Pc(r,i);return n===void 0?'<span class="no-discount"></span>':`<span class="discount">${n}%</span>`};var Fa=Ua();var Ga="INDIVIDUAL_COM",Ri="TEAM_COM",za="INDIVIDUAL_EDU",Mi="TEAM_EDU",$a=["GB_en","AU_en","FR_fr","AT_de","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","GR_el","GR_en","HU_hu","IE_en","IT_it","LU_de","LU_en","LU_fr","NL_nl","NO_nb","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TR_tr","UA_uk","ID_en","ID_in","IN_en","IN_hi","JP_ja","MY_en","MY_ms","NZ_en","TH_en","TH_th"],Cc={[Ga]:["MU_en","LT_lt","LV_lv","NG_en","SA_ar","SA_en","SG_en","KR_ko"],[Ri]:["MU_en","LT_lt","LV_lv","NG_en","CO_es","KR_ko"],[za]:["LT_lt","LV_lv","SA_en","SG_en"],[Mi]:["SG_en","KR_ko"]},Lc={MU_en:[!1,!1,!1,!1],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],CO_es:[!1,!0,!1,!1],AT_de:[!1,!1,!1,!0],SG_en:[!1,!1,!1,!0]},Rc=[Ga,Ri,za,Mi],Mc=e=>[Ri,Mi].includes(e),Nc=(e,t,r,i)=>{let n=`${e}_${t}`,a=`${r}_${i}`,o=Lc[n];if(o){let s=Rc.indexOf(a);return o[s]}return Mc(a)},Oc=(e,t,r,i)=>{let n=`${e}_${t}`;if($a.includes(e)||$a.includes(n))return!0;let a=Cc[`${r}_${i}`];return a?a.includes(e)||a.includes(n)?!0:_.displayTax:_.displayTax},Ic=async(e,t,r,i)=>{let n=Oc(e,t,r,i);return{displayTax:n,forceTaxExclusive:n?Nc(e,t,r,i):_.forceTaxExclusive}},At=class At extends HTMLSpanElement{constructor(){super();g(this,"masElement",new Ee(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi"]}static createInlinePrice(r){let i=j();if(!i)return null;let{displayOldPrice:n,displayPerUnit:a,displayRecurrence:o,displayTax:s,displayPlanType:l,displayAnnual:c,forceTaxExclusive:d,perpetual:m,promotionCode:p,quantity:h,alternativePrice:u,template:f,wcsOsi:v}=i.collectPriceOptions(r);return Zt(At,{displayOldPrice:n,displayPerUnit:a,displayRecurrence:o,displayTax:s,displayPlanType:l,displayAnnual:c,forceTaxExclusive:d,perpetual:m,promotionCode:p,quantity:h,alternativePrice:u,template:f,wcsOsi:v})}get isInlinePrice(){return!0}attributeChangedCallback(r,i,n){this.masElement.attributeChangedCallback(r,i,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===ae}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}async render(r={}){if(!this.isConnected)return!1;let i=j();if(!i)return!1;let n=i.collectPriceOptions(r,this),a={...i.settings,...n};if(!a.wcsOsi.length)return!1;if(i.featureFlags[ve]&&(n.displayTax===void 0||n.forceTaxExclusive===void 0)){let[l]=await i.resolveOfferSelectors(a),c=pt(await l,a);if(c?.length){let{country:d,language:m}=a,p=c[0],[h=""]=p.marketSegments,u=await Ic(d,m,p.customerSegment,h);n.displayTax===void 0&&(a.displayTax=u?.displayTax||a.displayTax),n.forceTaxExclusive===void 0&&(a.forceTaxExclusive=u?.forceTaxExclusive||a.forceTaxExclusive)}}let o=this.masElement.togglePending(a);this.innerHTML="";let[s]=i.resolveOfferSelectors(a);try{let l=await s;return this.renderOffers(pt(l,a),o)}catch(l){throw this.innerHTML="",l}}renderOffers(r,i=void 0){if(!this.isConnected)return;let n=j();if(!n)return!1;if(i??(i=this.masElement.togglePending()),r.length){if(this.masElement.toggleResolved(i,r)){this.innerHTML=n.buildPriceHTML(r,this.options);let a=this.closest("p, h3, div");if(!a||!a.querySelector('span[data-template="strikethrough"]')||a.querySelector(".alt-aria-label"))return!0;let o=a?.querySelectorAll('span[is="inline-price"]');return o.length>1&&o.length===a.querySelectorAll('span[data-template="strikethrough"]').length*2&&o.forEach(s=>{s.dataset.template!=="strikethrough"&&s.options&&!s.options.alternativePrice&&!s.isFailed&&(s.options.alternativePrice=!0,s.innerHTML=n.buildPriceHTML(r,s.options))}),!0}}else{let a=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,a,this.options))return this.innerHTML="",!0}return!1}updateOptions(r){let i=j();if(!i)return!1;let{alternativePrice:n,displayOldPrice:a,displayPerUnit:o,displayRecurrence:s,displayTax:l,forceTaxExclusive:c,perpetual:d,promotionCode:m,quantity:p,template:h,wcsOsi:u}=i.collectPriceOptions(r);return Jt(this,{alternativePrice:n,displayOldPrice:a,displayPerUnit:o,displayRecurrence:s,displayTax:l,forceTaxExclusive:c,perpetual:d,promotionCode:m,quantity:p,template:h,wcsOsi:u}),!0}};g(At,"is","inline-price"),g(At,"tag","span");var me=At;window.customElements.get(me.is)||window.customElements.define(me.is,me,{extends:me.tag});function Va({literals:e,providers:t,settings:r}){function i(o,s=null){let l={country:r.country,language:r.language,locale:r.locale,literals:{...e.price}};if(s&&t?.price)for(let O of t.price)O(s,l);let{displayOldPrice:c,displayPerUnit:d,displayRecurrence:m,displayTax:p,displayPlanType:h,forceTaxExclusive:u,perpetual:f,displayAnnual:v,promotionCode:P,quantity:y,alternativePrice:E,wcsOsi:S,...C}=Object.assign(l,s?.dataset??{},o??{});return l=Vt(Object.assign({...l,...C,displayOldPrice:x(c),displayPerUnit:x(d),displayRecurrence:x(m),displayTax:x(p),displayPlanType:x(h),forceTaxExclusive:x(u),perpetual:x(f),displayAnnual:x(v),promotionCode:qt(P).effectivePromoCode,quantity:qe(y,_.quantity),alternativePrice:x(E),wcsOsi:Xt(S)})),l}function n(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:l}=s,c;switch(l){case"discount":c=Fa;break;case"strikethrough":c=Na;break;case"annual":c=Oa;break;case"legal":c=Ba;break;default:s.template==="optical"&&s.alternativePrice?c=Ia:s.template==="optical"?c=Ma:s.displayAnnual&&o[0].planType==="ABM"?c=s.promotionCode?Da:Ha:s.alternativePrice?c=ka:c=s.promotionCode?Ra:La}let[d]=o;return d={...d,...d.priceDetails},c({...r,...s},d)}let a=me.createInlinePrice;return{InlinePrice:me,buildPriceHTML:n,collectPriceOptions:i,createInlinePrice:a}}function kc({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||_.language),t??(t=e?.split("_")?.[1]||_.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function ja(e={},t){let r=t.featureFlags[ve],{commerce:i={}}=e,n=le.PRODUCTION,a=Ir,o=M("checkoutClientId",i)??_.checkoutClientId,s=ht(M("checkoutWorkflowStep",i),W,_.checkoutWorkflowStep),l=x(M("displayOldPrice",i),r?_.displayOldPrice:!_.displayOldPrice),c=x(M("displayPerUnit",i),r?_.displayPerUnit:!_.displayPerUnit),d=x(M("displayRecurrence",i),_.displayRecurrence),m=x(M("displayTax",i),_.displayTax),p=x(M("displayPlanType",i),_.displayPlanType),h=x(M("entitlement",i),_.entitlement),u=x(M("modal",i),_.modal),f=x(M("forceTaxExclusive",i),_.forceTaxExclusive),v=M("promotionCode",i)??_.promotionCode,P=qe(M("quantity",i)),y=M("wcsApiKey",i)??_.wcsApiKey,E=i?.env==="stage",S=be.PUBLISHED;["true",""].includes(i.allowOverride)&&(E=(M(Nr,i,{metadata:!1})?.toLowerCase()??i?.env)==="stage",S=ht(M(Or,i),be,S)),E&&(n=le.STAGE,a=kr);let O=M(Mr)??e.preview,B=typeof O<"u"&&O!=="off"&&O!=="false",q={};B&&(q={preview:B});let H=M("mas-io-url")??e.masIOUrl??`https://www${n===le.STAGE?".stage":""}.adobe.com/mas/io`,R=M("preselect-plan")??void 0;return{...kc(e),...q,displayOldPrice:l,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:c,displayRecurrence:d,displayTax:m,displayPlanType:p,entitlement:h,extraOptions:_.extraOptions,modal:u,env:n,forceTaxExclusive:f,promotionCode:v,quantity:P,alternativePrice:_.alternativePrice,wcsApiKey:y,wcsURL:a,landscape:S,masIOUrl:H,...R&&{preselectPlan:R}}}async function qa(e,t={},r=2,i=100){let n;for(let a=0;a<=r;a++)try{let o=await fetch(e,t);return o.retryCount=a,o}catch(o){if(n=o,n.retryCount=a,a>r)break;await new Promise(s=>setTimeout(s,i*(a+1)))}throw n}var Ni="wcs";function Wa({settings:e}){let t=ie.module(Ni),{env:r,wcsApiKey:i}=e,n=new Map,a=new Map,o,s=new Map;async function l(h,u,f=!0){let v=j(),P=Pr;t.debug("Fetching:",h);let y="",E;if(h.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let S=new Map(u),[C]=h.offerSelectorIds,O=Date.now()+Math.random().toString(36).substring(2,7),B=`${Ni}:${C}:${O}${Dr}`,q=`${Ni}:${C}:${O}${Br}`,H;try{if(performance.mark(B),y=new URL(e.wcsURL),y.searchParams.set("offer_selector_ids",C),y.searchParams.set("country",h.country),y.searchParams.set("locale",h.locale),y.searchParams.set("landscape",r===le.STAGE?"ALL":e.landscape),y.searchParams.set("api_key",i),h.language&&y.searchParams.set("language",h.language),h.promotionCode&&y.searchParams.set("promotion_code",h.promotionCode),h.currency&&y.searchParams.set("currency",h.currency),E=await qa(y.toString(),{credentials:"omit"}),E.ok){let R=[];try{let F=await E.json();t.debug("Fetched:",h,F),R=F.resolvedOffers??[]}catch(F){t.error(`Error parsing JSON: ${F.message}`,{...F.context,...v?.duration})}R=R.map(Wt),u.forEach(({resolve:F},Z)=>{let fe=R.filter(({offerSelectorIds:ce})=>ce.includes(Z)).flat();fe.length&&(S.delete(Z),u.delete(Z),F(fe))})}else P=_r}catch(R){P=`Network error: ${R.message}`}finally{H=performance.measure(q,B),performance.clearMarks(B),performance.clearMeasures(q)}if(f&&u.size){t.debug("Missing:",{offerSelectorIds:[...u.keys()]});let R=vn(E);u.forEach(F=>{F.reject(new We(P,{...h,...R,response:E,measure:It(H),...v?.duration}))})}}function c(){clearTimeout(o);let h=[...a.values()];a.clear(),h.forEach(({options:u,promises:f})=>l(u,f))}function d(h){if(!h||typeof h!="object")throw new TypeError("Cache must be a Map or similar object");let u=r===le.STAGE?"stage":"prod",f=h[u];if(!f||typeof f!="object"){t.warn(`No cache found for environment: ${r}`);return}for(let[v,P]of Object.entries(f))n.set(v,Promise.resolve(P.map(Wt)));t.debug(`Prefilled WCS cache with ${f.size} entries`)}function m(){let h=n.size;s=new Map(n),n.clear(),t.debug(`Moved ${h} cache entries to stale cache`)}function p({country:h,language:u,perpetual:f=!1,promotionCode:v="",wcsOsi:P=[]}){let y=`${u}_${h}`;h!=="GB"&&!f&&(u="MULT");let E=[h,u,v].filter(S=>S).join("-").toLowerCase();return P.map(S=>{let C=`${S}-${E}`;if(n.has(C))return n.get(C);let O=new Promise((B,q)=>{let H=a.get(E);if(!H){let R={country:h,locale:y,offerSelectorIds:[]};h!=="GB"&&!f&&(R.language=u),H={options:R,promises:new Map},a.set(E,H)}v&&(H.options.promotionCode=v),H.options.offerSelectorIds.push(S),H.promises.set(S,{resolve:B,reject:q}),c()}).catch(B=>{if(s.has(C))return s.get(C);throw B});return n.set(C,O),O})}return{Commitment:Te,PlanType:gn,Term:J,applyPlanType:Wt,resolveOfferSelectors:p,flushWcsCacheInternal:m,prefillWcsCache:d}}var Ya="mas-commerce-service",Xa="mas-commerce-service:start",Ka="mas-commerce-service:ready",Tt,Xe,Ke,Qa,Za,Oi=class extends HTMLElement{constructor(){super(...arguments);$(this,Ke);$(this,Tt);$(this,Xe);g(this,"lastLoggingTime",0)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(i,n,a)=>{let o=await r?.(i,n,this.imsSignedInPromise,a);return o||null})}get featureFlags(){return w(this,Xe)||G(this,Xe,{[ve]:Ct(this,Ke,Za).call(this,ve)}),w(this,Xe)}activate(){let r=w(this,Ke,Qa),i=ja(r,this);Kt(r.lana);let n=ie.init(r.hostEnv).module("service");n.debug("Activating:",r);let o={price:Un(i)},s={checkout:new Set,price:new Set},l={literals:o,providers:s,settings:i};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...Hn(l),...Dn(l),...Va(l),...Wa(l),...Fr,Log:ie,get defaults(){return _},get log(){return ie},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return i}})),n.debug("Activated:",{literals:o,settings:i});let c=new CustomEvent(Ot,{bubbles:!0,cancelable:!1,detail:this});performance.mark(Ka),G(this,Tt,performance.measure(Ka,Xa)),this.dispatchEvent(c),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(Xa),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(fr).forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":It(w(this,Tt))}}logFailedRequests(){let r=[...performance.getEntriesByType("resource")].filter(({startTime:n})=>n>this.lastLoggingTime).filter(({transferSize:n,duration:a,responseStatus:o})=>n===0&&a===0&&o<200||o>=400),i=Array.from(new Map(r.map(n=>[n.name,n])).values());if(i.some(({name:n})=>/(\/fragment\?|web_commerce_artifact)/.test(n))){let n=i.map(({name:a})=>a);this.log.error("Failed requests:",{failedUrls:n,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Tt=new WeakMap,Xe=new WeakMap,Ke=new WeakSet,Qa=function(){let r=this.getAttribute("env")??"prod",i={commerce:{env:r},hostEnv:{name:r},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:r==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview"].forEach(n=>{let a=this.getAttribute(n);a&&(i[n]=a)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(n=>{let a=this.getAttribute(n);if(a!=null){let o=n.replace(/-([a-z])/g,s=>s[1].toUpperCase());i.commerce[o]=a}}),i},Za=function(r){return["on","true",!0].includes(this.getAttribute(`data-${r}`)||M(r))};window.customElements.get(Ya)||window.customElements.define(Ya,Oi);var to="merch-card-collection",Dc=2e4,Bc={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansThreeColumns:["three-merch-cards"]},Uc={plans:!0},Fc=(e,{filter:t})=>e.filter(r=>r?.filters&&r?.filters.hasOwnProperty(t)),$c=(e,{types:t})=>t?(t=t.split(","),e.filter(r=>t.some(i=>r.types.includes(i)))):e,Gc=e=>e.sort((t,r)=>(t.title??"").localeCompare(r.title??"","en",{sensitivity:"base"})),zc=(e,{filter:t})=>e.sort((r,i)=>i.filters[t]?.order==null||isNaN(i.filters[t]?.order)?-1:r.filters[t]?.order==null||isNaN(r.filters[t]?.order)?1:r.filters[t].order-i.filters[t].order),Vc=(e,{search:t})=>t?.length?(t=t.toLowerCase(),e.filter(r=>(r.title??"").toLowerCase().includes(t))):e,Ae,Ze,wt,dr,ro,Qe=class extends eo{constructor(){super();$(this,dr);$(this,Ae,{});$(this,Ze);$(this,wt);this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1}render(){return ue`
            <slot></slot>
            ${this.footer}`}checkReady(){if(!this.querySelector("aem-fragment"))return Promise.resolve(!0);let i=new Promise(n=>setTimeout(()=>n(!1),Dc));return Promise.race([this.hydrationReady,i])}updated(r){if(!this.querySelector("merch-card"))return;let i=window.scrollY||document.documentElement.scrollTop,n=[...this.children].filter(c=>c.tagName==="MERCH-CARD");if(n.length===0)return;r.has("singleApp")&&this.singleApp&&n.forEach(c=>{c.updateFilters(c.name===this.singleApp)});let a=this.sort===oe.alphabetical?Gc:zc,s=[Fc,$c,Vc,a].reduce((c,d)=>d(c,this),n).map((c,d)=>[c,d]);if(this.resultCount=s.length,this.page&&this.limit){let c=this.page*this.limit;this.hasMore=s.length>c,s=s.filter(([,d])=>d<c)}let l=new Map(s.reverse());for(let c of l.keys())this.prepend(c);n.forEach(c=>{l.has(c)?(c.size=c.filters[this.filter]?.size,c.style.removeProperty("display"),c.requestUpdate()):(c.style.display="none",c.size=void 0)}),window.scrollTo(0,i),this.updateComplete.then(()=>{this.dispatchLiteralsChanged(),this.sidenav&&!this.literalsHandlerAttached&&(this.sidenav.addEventListener(vr,()=>{this.dispatchLiteralsChanged()}),this.literalsHandlerAttached=!0)})}dispatchLiteralsChanged(){this.dispatchEvent(new CustomEvent(rt,{detail:{resultCount:this.resultCount,searchTerm:this.search,filter:this.sidenav?.filters?.selectedText}}))}buildOverrideMap(){G(this,Ae,{}),this.overrides?.split(",").forEach(r=>{let[i,n]=r?.split(":");i&&n&&(w(this,Ae)[i]=n)})}connectedCallback(){super.connectedCallback(),G(this,Ze,ot()),w(this,Ze)&&G(this,wt,w(this,Ze).Log.module(to)),this.buildOverrideMap(),this.init()}async init(){await this.hydrate(),this.sidenav=this.parentElement.querySelector("merch-sidenav"),this.filtered?(this.filter=this.filtered,this.page=1):this.startDeeplink(),this.initializePlaceholders()}disconnectedCallback(){super.disconnectedCallback(),this.stopDeeplink?.()}initializeHeader(){let r=document.createElement("merch-card-collection-header");r.collection=this,r.classList.add(this.variant),this.parentElement.insertBefore(r,this),this.header=r,this.querySelectorAll("[placeholder]").forEach(n=>{let a=n.getAttribute("slot");this.header.placeholderKeys.includes(a)&&this.header.append(n)})}initializePlaceholders(){let r=this.data?.placeholders||{};for(let i of Object.keys(r)){let n=r[i],a=n.includes("<p>")?"div":"p",o=document.createElement(a);o.setAttribute("slot",i),o.setAttribute("placeholder",""),o.innerHTML=n,this.append(o)}}attachSidenav(r,i=!0){r&&(i&&this.parentElement.prepend(r),this.sidenav=r,this.sidenav.variant=this.variant,this.sidenav.classList.add(this.variant),Uc[this.variant]&&this.sidenav.setAttribute("autoclose",""),this.initializeHeader(),this.dispatchEvent(new CustomEvent(it)))}async hydrate(){if(this.hydrating)return!1;let r=this.querySelector("aem-fragment");if(!r)return;this.hydrating=!0;let i;this.hydrationReady=new Promise(o=>{i=o});let n=this;function a(o,s){let l={cards:[],hierarchy:[],placeholders:o.placeholders};function c(d,m){for(let p of m){if(p.fieldName==="cards"){if(l.cards.findIndex(f=>f.id===p.identifier)!==-1)continue;l.cards.push(o.references[p.identifier].value);continue}let{fields:h}=o.references[p.identifier].value,u={label:h.label||"",icon:h.icon,iconLight:h.iconLight,queryLabel:h.queryLabel,cards:h.cards?h.cards.map(f=>s[f]||f):[],collections:[]};h.defaultchild&&(u.defaultchild=s[h.defaultchild]||h.defaultchild),d.push(u),c(u.collections,p.referencesTree)}}return c(l.hierarchy,o.referencesTree),l.hierarchy.length===0&&(n.filtered="all"),l}r.addEventListener(yr,o=>{Ct(this,dr,ro).call(this,"Error loading AEM fragment",o.detail),this.hydrating=!1,r.remove()}),r.addEventListener(Er,async o=>{this.data=a(o.detail,w(this,Ae));let{cards:s,hierarchy:l}=this.data,c=l.length===0&&o.detail.fields?.defaultchild?w(this,Ae)[o.detail.fields.defaultchild]||o.detail.fields.defaultchild:null;r.cache.add(...s);let d=(h,u)=>{for(let f of h)if(f.defaultchild===u||f.collections&&d(f.collections,u))return!0;return!1};for(let h of s){let P=function(E){for(let S of E){let C=S.cards.indexOf(f);if(C===-1)continue;let O=S.queryLabel??S?.label?.toLowerCase()??"";u.filters[O]={order:C+1,size:h.fields.size},P(S.collections)}},u=document.createElement("merch-card"),f=w(this,Ae)[h.id]||h.id;u.setAttribute("consonant",""),u.setAttribute("style",""),Ht(h.fields.variant)?.supportsDefaultChild&&(c?f===c:d(l,f))&&u.setAttribute("data-default-card","true"),P(l);let y=document.createElement("aem-fragment");y.setAttribute("fragment",f),u.append(y),Object.keys(u.filters).length===0&&(u.filters={all:{order:s.indexOf(h)+1,size:h.fields.size}}),this.append(u)}let m="",p=Cn(s[0]?.fields?.variant);this.variant=p,p==="plans"&&s.length===3&&!s.some(h=>h.fields?.size?.includes("wide"))&&(m="ThreeColumns"),p&&this.classList.add("merch-card-collection",p,...Bc[`${p}${m}`]||[]),this.displayResult=!0,this.hydrating=!1,r.remove(),i()}),await this.hydrationReady}get footer(){if(!this.filtered)return ue`<div id="footer">
