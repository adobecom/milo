var Fi=Object.defineProperty;var $i=e=>{throw TypeError(e)};var fo=(e,t,r)=>t in e?Fi(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var go=(e,t)=>{for(var r in t)Fi(e,r,{get:t[r],enumerable:!0})};var g=(e,t,r)=>fo(e,typeof t!="symbol"?t+"":t,r),gr=(e,t,r)=>t.has(e)||$i("Cannot "+r);var S=(e,t,r)=>(gr(e,t,"read from private field"),r?r.call(e):t.get(e)),$=(e,t,r)=>t.has(e)?$i("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),G=(e,t,r,i)=>(gr(e,t,"write to private field"),i?i.call(e,r):t.set(e,r),r),Ot=(e,t,r)=>(gr(e,t,"access private method"),r);import{html as fe,LitElement as io,css as no,unsafeCSS as ro,nothing as oe}from"../lit-all.min.js";var K="(max-width: 767px)",ce="(max-width: 1199px)",D="(min-width: 768px)",L="(min-width: 1200px)",xe="(min-width: 1600px)";function kt(){return window.matchMedia(K)}function It(){return window.matchMedia(L)}function Ht(){return kt().matches}function de(){return It().matches}var nt=class{constructor(t,r){this.key=Symbol("match-media-key"),this.matches=!1,this.host=t,this.host.addController(this),this.media=window.matchMedia(r),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),t.addController(this)}hostConnected(){var t;(t=this.media)==null||t.addEventListener("change",this.onChange)}hostDisconnected(){var t;(t=this.media)==null||t.removeEventListener("change",this.onChange)}onChange(t){this.matches!==t.matches&&(this.matches=t.matches,this.host.requestUpdate(this.key,!this.matches))}};var Gi="hashchange";function xo(e=window.location.hash){let t=[],r=e.replace(/^#/,"").split("&");for(let i of r){let[n,a=""]=i.split("=");n&&t.push([n,decodeURIComponent(a.replace(/\+/g," "))])}return Object.fromEntries(t)}function at(e){let t=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([n,a])=>{a?t.set(n,a):t.delete(n)}),t.sort();let r=t.toString();if(r===window.location.hash)return;let i=window.scrollY||document.documentElement.scrollTop;window.location.hash=r,window.scrollTo(0,i)}function zi(e){let t=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let r=xo(window.location.hash);e(r)};return t(),window.addEventListener(Gi,t),()=>{window.removeEventListener(Gi,t)}}var Gr={};go(Gr,{CLASS_NAME_FAILED:()=>Tr,CLASS_NAME_HIDDEN:()=>vo,CLASS_NAME_PENDING:()=>_r,CLASS_NAME_RESOLVED:()=>Pr,CheckoutWorkflow:()=>ko,CheckoutWorkflowStep:()=>j,Commitment:()=>Se,ERROR_MESSAGE_BAD_REQUEST:()=>Cr,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>Mo,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Lr,EVENT_AEM_ERROR:()=>Ar,EVENT_AEM_LOAD:()=>wr,EVENT_MAS_ERROR:()=>Sr,EVENT_MAS_READY:()=>Ro,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>Co,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>br,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>ot,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>yr,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>st,EVENT_MERCH_CARD_COLLECTION_SORT:()=>vr,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>Po,EVENT_MERCH_OFFER_READY:()=>wo,EVENT_MERCH_OFFER_SELECT_READY:()=>Ao,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>Te,EVENT_MERCH_SEARCH_CHANGE:()=>Lo,EVENT_MERCH_SIDENAV_SELECT:()=>Er,EVENT_MERCH_STOCK_CHANGE:()=>To,EVENT_MERCH_STORAGE_CHANGE:()=>_o,EVENT_OFFER_SELECTED:()=>So,EVENT_TYPE_FAILED:()=>Rr,EVENT_TYPE_READY:()=>Dt,EVENT_TYPE_RESOLVED:()=>Mr,Env:()=>le,FF_DEFAULTS:()=>ye,HEADER_X_REQUEST_ID:()=>ct,LOG_NAMESPACE:()=>Nr,Landscape:()=>ve,MARK_DURATION_SUFFIX:()=>Fr,MARK_START_SUFFIX:()=>Ur,MODAL_TYPE_3_IN_1:()=>_e,NAMESPACE:()=>bo,PARAM_AOS_API_KEY:()=>No,PARAM_ENV:()=>kr,PARAM_LANDSCAPE:()=>Ir,PARAM_MAS_PREVIEW:()=>Or,PARAM_WCS_API_KEY:()=>Oo,PROVIDER_ENVIRONMENT:()=>Br,SELECTOR_MAS_CHECKOUT_LINK:()=>Vi,SELECTOR_MAS_ELEMENT:()=>xr,SELECTOR_MAS_INLINE_PRICE:()=>te,SELECTOR_MAS_SP_BUTTON:()=>Eo,SELECTOR_MAS_UPT_LINK:()=>qi,SORT_ORDER:()=>ae,STATE_FAILED:()=>ne,STATE_PENDING:()=>be,STATE_RESOLVED:()=>pe,TAG_NAME_SERVICE:()=>yo,TEMPLATE_PRICE:()=>Io,TEMPLATE_PRICE_ANNUAL:()=>Do,TEMPLATE_PRICE_LEGAL:()=>$r,TEMPLATE_PRICE_STRIKETHROUGH:()=>Ho,Term:()=>ee,WCS_PROD_URL:()=>Hr,WCS_STAGE_URL:()=>Dr});var Se=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),ee=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),bo="merch",vo="hidden",Dt="wcms:commerce:ready",yo="mas-commerce-service",te='span[is="inline-price"][data-wcs-osi]',Vi='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',Eo="sp-button[data-wcs-osi]",qi='a[is="upt-link"]',xr=`${te},${Vi},${qi}`,wo="merch-offer:ready",Ao="merch-offer-select:ready",br="merch-card:action-menu-toggle",So="merch-offer:selected",To="merch-stock:change",_o="merch-storage:change",Te="merch-quantity-selector:change",Po="merch-card-quantity:change",Co="merch-modal:addon-and-quantity-update",Lo="merch-search:change",vr="merch-card-collection:sort",ot="merch-card-collection:literals-changed",st="merch-card-collection:sidenav-attached",yr="merch-card-collection:showmore",Er="merch-sidenav:select",wr="aem:load",Ar="aem:error",Ro="mas:ready",Sr="mas:error",Tr="placeholder-failed",_r="placeholder-pending",Pr="placeholder-resolved",Cr="Bad WCS request",Lr="Commerce offer not found",Mo="Literals URL not provided",Rr="mas:failed",Mr="mas:resolved",Nr="mas/commerce",Or="mas.preview",kr="commerce.env",Ir="commerce.landscape",No="commerce.aosKey",Oo="commerce.wcsKey",Hr="https://www.adobe.com/web_commerce_artifact",Dr="https://www.stage.adobe.com/web_commerce_artifact_stage",ne="failed",be="pending",pe="resolved",ve={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},ct="X-Request-Id",j=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),ko="UCv3",le=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),Br={PRODUCTION:"PRODUCTION"},_e={TWP:"twp",D2P:"d2p",CRM:"crm"},Ur=":start",Fr=":duration",Io="price",Ho="price-strikethrough",Do="annual",$r="legal",ye="mas-ff-defaults",ae={alphabetical:"alphabetical",authored:"authored"};var Bo="mas-commerce-service";var lt=(e,t)=>e?.querySelector(`[slot="${t}"]`)?.textContent?.trim();function Pe(e,t={},r=null,i=null){let n=i?document.createElement(e,{is:i}):document.createElement(e);r instanceof HTMLElement?n.appendChild(r):n.innerHTML=r;for(let[a,o]of Object.entries(t))n.setAttribute(a,o);return n}function Bt(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function zr(){return window.matchMedia("(max-width: 1024px)").matches}function dt(){return document.getElementsByTagName(Bo)?.[0]}function pt(e){let t=window.getComputedStyle(e);return e.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}import{html as Ut,nothing as Uo}from"../lit-all.min.js";var Ue,ht=class ht{constructor(t){g(this,"card");$(this,Ue);this.card=t,this.insertVariantStyle()}getContainer(){return G(this,Ue,S(this,Ue)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),S(this,Ue)}insertVariantStyle(){if(!ht.styleMap[this.card.variant]){ht.styleMap[this.card.variant]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(t,r){if(!t)return;let i=`--consonant-merch-card-${this.card.variant}-${r}-height`,n=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),a=parseInt(this.getContainer().style.getPropertyValue(i))||0;n>a&&this.getContainer().style.setProperty(i,`${n}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Ut`
            <div
                id="badge"
        ...
        `}get cardImage(){return Ut` <div class="image">
            ...
            >`:Uo}get secureLabelFooter(){return Ut`<footer>${this.secureLabel}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return Ft(this.card.variant)}};Ue=new WeakMap,g(ht,"styleMap",{});var O=ht;import{html as Vr,css as Fo}from"../lit-all.min.js";var ji=`
:root {
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
    ...
    `);import{html as mt}from"../lit-all.min.js";var Yi=`
:root {
...
`;var $t=class extends O{constructor(t){super(t)}getGlobalCSS(){return Yi}renderLayout(){return mt`${this.cardImage}
    <div class="body">
...
`;var Gt=class extends O{constructor(t){super(t)}getGlobalCSS(){return Xi}renderLayout(){return Ki` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":Ki`<hr />`} ${this.secureLabelFooter}`}};import{html as $e,css as $o,unsafeCSS as Zi}from"../lit-all.min.js";var Qi=`
  :root {
...
`;var Go=32,Ge=class extends O{constructor(r){super(r);g(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);g(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?$e`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(r=>r.onceSettled())),await this.adjustAddon(),Ht()?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};g(Ge,"variantStyle",$o`
  ...
  `);import{html as ut,css as zo,nothing as zt}from"../lit-all.min.js";var Ji=`
:root {
...
`;var Vt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},en={...function(){let{whatsIncluded:e,size:t,...r}=Vt;return r}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},tn={...function(){let{subtitle:e,whatsIncluded:t,size:r,quantitySelect:i,...n}=Vt;return n}()},W=class extends O{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,r){t.dataset.template===$r&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Ji}adjustSlotPlacement(t,r,i){let n=this.card.shadowRoot,a=n.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let s=n.querySelector(`footer slot[name="${t}"]`),c=n.querySelector(`.body slot[name="${t}"]`),l=n.querySelector(".body");if(o.includes("wide")||(a?.classList.remove("wide-footer"),s&&s.remove()),!!r.includes(o)){if(a?.classList.toggle("wide-footer",de()),!i&&s){if(c)s.remove();else{let d=l.querySelector(`[data-placeholder-for="${t}"]`);d?d.replaceWith(s):l.appendChild(s)}return}if(i&&c){let d=document.createElement("div");if(d.setAttribute("data-placeholder-for",t),d.classList.add("slot-placeholder"),!s){let m=c.cloneNode(!0);a.prepend(m)}c.replaceWith(d)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],de()),this.adjustSlotPlacement("callout-content",["super-wide"],de())}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==t?t.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==t?t.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let r=this.card.querySelector('[slot="body-xs"]');if(!r)return;let i=r.querySelector("ul");if(!i)return;let n=i.previousElementSibling,a=document.createElement("div");a.classList.add("spacer"),r.insertBefore(a,n);let o=new IntersectionObserver(([s])=>{if(s.boundingClientRect.height===0)return;let c=0,l=this.card.querySelector('[slot="heading-s"]');l&&(c+=pt(l));let d=this.card.querySelector('[slot="subtitle"]');d&&(c+=pt(d));let m=this.card.querySelector('[slot="heading-m"]');m&&(c+=8+pt(m));for(let p of r.childNodes){if(p.classList.contains("spacer"))break;c+=pt(p)}let h=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");c>(parseFloat(h)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${c}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${c}px`),o.disconnect()});o.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists())}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${te}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?ut`<div class="divider"></div>`:zt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],r=this.card.querySelector(`[slot="heading-m"] ${te}[data-template="price"]`);r&&t.push(r);let i=t.map(async n=>{let a=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),n.parentNode.insertBefore(a,n.nextSibling),await a.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled();let i=r.value?.[0]?.planType;i&&(t.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?ut`<label id="stock-checkbox">
    ...
    `),g(W,"collectionOptions",{customHeaderArea:t=>t.sidenav?ut`<slot name="resultsText"></slot>`:zt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]}});import{html as qr,css as Vo}from"../lit-all.min.js";var rn=`
:root {
...
`;var ze=class extends O{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return rn}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return qr` ${this.badge}
    ...
    `);import{html as jr,css as qo}from"../lit-all.min.js";var nn=`
:root {
...
`;var Ve=class extends O{constructor(t){super(t)}getGlobalCSS(){return nn}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return jr` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
    ...
    <hr />
    ${this.secureLabelFooter}`}};g(Ve,"variantStyle",qo`
  ...
  `);import{html as Wr,css as jo}from"../lit-all.min.js";var an=`
:root {
...
`;var on={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},qe=class extends O{constructor(t){super(t)}getGlobalCSS(){return an}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return Wr`${this.cardImage}
            ...
            ${this.evergreen?Wr`
                  ...
                  `:Wr`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};g(qe,"variantStyle",jo`
...
`;var Xr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"l"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:[]},We=class extends O{getGlobalCSS(){return cn}get aemFragmentMapping(){return Xr}get headingSelector(){return'[slot="heading-xs"]'}syncHeights(){if(this.card.getBoundingClientRect().width<=2)return;let t=this.card.querySelector('[slot="short-description"]');t&&this.updateCardElementMinHeight(t,"short-description");let r=this.card.querySelector('[slot="price"]');r&&this.updateCardElementMinHeight(r,"price");let i=this.card.querySelector('[slot="cta"]');i&&this.updateCardElementMinHeight(i,"cta")}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,await Promise.all(this.card.prices.map(t=>t.onceSettled())),window.matchMedia("(min-width: 1025px)").matches)){let t=this.getContainer();if(!t)return;let r=`--consonant-merch-card-${this.card.variant}`,i=t.style.getPropertyValue(`${r}-price-height`);requestAnimationFrame(i?()=>{this.syncHeights()}:()=>{t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(a=>a.variantLayout?.syncHeights?.())})}}renderLayout(){return Xo`
            <div class="badge-wrapper">
                <slot name="badge"></slot>
            </div>
            <div class="card-content">
...
`;var dn={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ye=class extends O{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return ln}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(r,i){i.literals={...i.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},i.space=!0,i.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let r=this.card.querySelector(`${te}[data-template="price"]`);if(!r)return;let i=r.cloneNode(!0);this.legal=i,r.dataset.displayTax="false",i.dataset.template="legal",i.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,i.setAttribute("slot","legal"),this.card.appendChild(i)}renderLayout(){return Zo`
    ...
    `);var pn=new Map,Q=(e,t,r=null,i=null,n)=>{pn.set(e,{class:t,fragmentMapping:r,style:i,collectionOptions:n})};Q("catalog",Fe,Wi,Fe.variantStyle);Q("image",$t);Q("inline-heading",Gt);Q("mini-compare-chart",Ge,null,Ge.variantStyle);Q("plans",W,Vt,W.variantStyle,W.collectionOptions);Q("plans-students",W,tn,W.variantStyle,W.collectionOptions);Q("plans-education",W,en,W.variantStyle,W.collectionOptions);Q("product",ze,null,ze.variantStyle);Q("segment",Ve,null,Ve.variantStyle);Q("special-offers",qe,on,qe.variantStyle);Q("simplified-pricing-express",je,Yr,je.variantStyle);Q("full-pricing-express",We,Xr,We.variantStyle);Q("mini",Ye,dn,Ye.variantStyle);function Ft(e){return pn.get(e)?.fragmentMapping}var hn="tacocat.js";var Kr=(e,t)=>String(e??"").toLowerCase()==String(t??"").toLowerCase(),mn=e=>`${e??""}`.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t]??t)??"";function k(e,t={},{metadata:r=!0,search:i=!0,storage:n=!0}={}){let a;if(i&&a==null){let o=new URLSearchParams(window.location.search),s=Xe(i)?i:e;a=o.get(s)}if(n&&a==null){let o=Xe(n)?n:e;a=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(r&&a==null){let o=es(Xe(r)?r:e);a=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return a??t[e]}var Jo=e=>typeof e=="boolean",qt=e=>typeof e=="function",jt=e=>typeof e=="number",un=e=>e!=null&&typeof e=="object";var Xe=e=>typeof e=="string",fn=e=>Xe(e)&&e,ft=e=>jt(e)&&Number.isFinite(e)&&e>0;function Wt(e,t=r=>r==null||r===""){return e!=null&&Object.entries(e).forEach(([r,i])=>{t(i)&&delete e[r]}),e}function v(e,t){if(Jo(e))return e;let r=String(e);return r==="1"||r==="true"?!0:r==="0"||r==="false"?!1:t}function gt(e,t,r){let i=Object.values(t);return i.find(n=>Kr(n,e))??r??i[0]}function es(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,r,i)=>`${r}-${i}`).replace(/\W+/gu,"-").toLowerCase()}function gn(e,t=1){return jt(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:t}var ts=Date.now(),Qr=()=>`(+${Date.now()-ts}ms)`,Yt=new Set,rs=v(k("tacocat.debug",{},{metadata:!1}),!1);function xn(e){let t=`[${hn}/${e}]`,r=(o,s,...c)=>o?!0:(n(s,...c),!1),i=rs?(o,...s)=>{console.debug(`${t} ${o}`,...s,Qr())}:()=>{},n=(o,...s)=>{let c=`${t} ${o}`;Yt.forEach(([l])=>l(c,...s))};return{assert:r,debug:i,error:n,warn:(o,...s)=>{let c=`${t} ${o}`;Yt.forEach(([,l])=>l(c,...s))}}}function is(e,t){let r=[e,t];return Yt.add(r),()=>{Yt.delete(r)}}is((e,...t)=>{console.error(e,...t,Qr())},(e,...t)=>{console.warn(e,...t,Qr())});var ns="no promo",bn="promo-tag",as="yellow",os="neutral",ss=(e,t,r)=>{let i=a=>a||ns,n=r?` (was "${i(t)}")`:"";return`${i(e)}${n}`},cs="cancel-context",Xt=(e,t)=>{let r=e===cs,i=!r&&e?.length>0,n=(i||r)&&(t&&t!=e||!t&&!r),a=n&&i||!n&&!!t,o=a?e||t:void 0;return{effectivePromoCode:o,overridenPromoCode:e,className:a?bn:`${bn} no-promo`,text:ss(o,t,n),variant:a?as:os,isOverriden:n}};var Zr;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(Zr||(Zr={}));var Z;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(Z||(Z={}));var re;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(re||(re={}));var Jr;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(Jr||(Jr={}));var ei;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(ei||(ei={}));var ti;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(ti||(ti={}));var ri;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(ri||(ri={}));var ii="ABM",ni="PUF",ai="M2M",oi="PERPETUAL",si="P3Y",ls="TAX_INCLUSIVE_DETAILS",ds="TAX_EXCLUSIVE",vn={ABM:ii,PUF:ni,M2M:ai,PERPETUAL:oi,P3Y:si},sp={[ii]:{commitment:Z.YEAR,term:re.MONTHLY},[ni]:{commitment:Z.YEAR,term:re.ANNUAL},[ai]:{commitment:Z.MONTH,term:re.MONTHLY},[oi]:{commitment:Z.PERPETUAL,term:void 0},[si]:{commitment:Z.THREE_MONTHS,term:re.P3Y}},yn="Value is not an offer",Kt=e=>{if(typeof e!="object")return yn;let{commitment:t,term:r}=e,i=ps(t,r);return{...e,planType:i}};var ps=(e,t)=>{switch(e){case void 0:return yn;case"":return"";case Z.YEAR:return t===re.MONTHLY?ii:t===re.ANNUAL?ni:"";case Z.MONTH:return t===re.MONTHLY?ai:"";case Z.PERPETUAL:return oi;case Z.TERM_LICENSE:return t===re.P3Y?si:"";default:return""}};function En(e){let{priceDetails:t}=e,{price:r,priceWithoutDiscount:i,priceWithoutTax:n,priceWithoutDiscountAndTax:a,taxDisplay:o}=t;if(o!==ls)return e;let s={...e,priceDetails:{...t,price:n??r,priceWithoutDiscount:a??i,taxDisplay:ds}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var hs="mas-commerce-service",ms={requestId:ct,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function xt(e,{country:t,forceTaxExclusive:r}){let i;if(e.length<2)i=e;else{let n=t==="GB"?"EN":"MULT";e.sort((a,o)=>a.language===n?-1:o.language===n?1:0),e.sort((a,o)=>!a.term&&o.term?-1:a.term&&!o.term?1:0),i=[e[0]]}return r&&(i=i.map(En)),i}var Qt=e=>window.setTimeout(e);function Ke(e,t=1){if(e==null)return[t];let r=(Array.isArray(e)?e:String(e).split(",")).map(gn).filter(ft);return r.length||(r=[t]),r}function Zt(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(fn)}function Y(){return document.getElementsByTagName(hs)?.[0]}function wn(e){let t={};if(!e?.headers)return t;let r=e.headers;for(let[i,n]of Object.entries(ms)){let a=r.get(n);a&&(a=a.replace(/[,;]/g,"|"),a=a.replace(/[| ]+/g,"|"),t[i]=a)}return t}var Ce={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,tags:"acom",isProdDomain:!1},An=1e3;function us(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function Sn(e){if(e==null)return;let t=typeof e;if(t==="function")return e.name?`function ${e.name}`:"function";if(t==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:i,originatingRequest:n,status:a}=e;return[i,a,n].filter(Boolean).join(" ")}let r=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!Ce.serializableTypes.includes(r))return r}return e}function fs(e,t){if(!Ce.ignoredProperties.includes(e))return Sn(t)}var ci={append(e){if(e.level!=="error")return;let{message:t,params:r}=e,i=[],n=[],a=t;r.forEach(l=>{l!=null&&(us(l)?i:n).push(l)}),i.length&&(a+=" "+i.map(Sn).join(" "));let{pathname:o,search:s}=window.location,c=`${Ce.delimiter}page=${o}${s}`;c.length>An&&(c=`${c.slice(0,An)}<trunc>`),a+=c,n.length&&(a+=`${Ce.delimiter}facts=`,a+=JSON.stringify(n,fs)),window.lana?.log(a,Ce)}};function Jt(e){Object.assign(Ce,Object.fromEntries(Object.entries(e).filter(([t,r])=>t in Ce&&r!==""&&r!==null&&r!==void 0&&!Number.isNaN(r))))}var Tn={LOCAL:"local",PROD:"prod",STAGE:"stage"},li={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},di=new Set,pi=new Set,_n=new Map,Pn={append({level:e,message:t,params:r,timestamp:i,source:n}){console[e](`${i}ms [${n}] %c${t}`,"font-weight: bold;",...r)}},Cn={filter:({level:e})=>e!==li.DEBUG},gs={filter:()=>!1};function xs(e,t,r,i,n){return{level:e,message:t,namespace:r,get params(){return i.length===1&&qt(i[0])&&(i=i[0](),Array.isArray(i)||(i=[i])),i},source:n,timestamp:performance.now().toFixed(3)}}function bs(e){[...pi].every(t=>t(e))&&di.forEach(t=>t(e))}function Ln(e){let t=(_n.get(e)??0)+1;_n.set(e,t);let r=`${e} #${t}`,i={id:r,namespace:e,module:n=>Ln(`${i.namespace}/${n}`),updateConfig:Jt};return Object.values(li).forEach(n=>{i[n]=(a,...o)=>bs(xs(n,a,e,o,r))}),Object.seal(i)}function er(...e){e.forEach(t=>{let{append:r,filter:i}=t;qt(i)&&pi.add(i),qt(r)&&di.add(r)})}function vs(e={}){let{name:t}=e,r=v(k("commerce.debug",{search:!0,storage:!0}),t===Tn.LOCAL);return er(r?Pn:Cn),t===Tn.PROD&&er(ci),ie}function ys(){di.clear(),pi.clear()}var ie={...Ln(Nr),Level:li,Plugins:{consoleAppender:Pn,debugFilter:Cn,quietFilter:gs,lanaAppender:ci},init:vs,reset:ys,use:er};var Qe=class e extends Error{constructor(t,r,i){if(super(t,{cause:i}),this.name="MasError",r.response){let n=r.response.headers?.get(ct);n&&(r.requestId=n),r.response.status&&(r.status=r.response.status,r.statusText=r.response.statusText),r.response.url&&(r.url=r.response.url)}delete r.response,this.context=r,Error.captureStackTrace&&Error.captureStackTrace(this,e)}toString(){let t=Object.entries(this.context||{}).map(([i,n])=>`${i}: ${JSON.stringify(n)}`).join(", "),r=`${this.name}: ${this.message}`;return t&&(r+=` (${t})`),this.cause&&(r+=`
Caused by: ${this.cause}`),r}};var Es={[ne]:Tr,[be]:_r,[pe]:Pr},ws={[ne]:Rr,[pe]:Mr},bt,Ee=class{constructor(t){$(this,bt);g(this,"changes",new Map);g(this,"connected",!1);g(this,"error");g(this,"log");g(this,"options");g(this,"promises",[]);g(this,"state",be);g(this,"timer",null);g(this,"value");g(this,"version",0);g(this,"wrapperElement");this.wrapperElement=t,this.log=ie.module("mas-element")}update(){[ne,be,pe].forEach(t=>{this.wrapperElement.classList.toggle(Es[t],t===this.state)})}notify(){(this.state===pe||this.state===ne)&&(this.state===pe?this.promises.forEach(({resolve:r})=>r(this.wrapperElement)):this.state===ne&&this.promises.forEach(({reject:r})=>r(this.error)),this.promises=[]);let t=this.error;this.error instanceof Qe&&(t={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(ws[this.state],{bubbles:!0,detail:t}))}attributeChangedCallback(t,r,i){this.changes.set(t,i),this.requestUpdate()}connectedCallback(){G(this,bt,Y()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:t,promises:r,state:i}=this;return pe===i?Promise.resolve(this.wrapperElement):ne===i?Promise.reject(t):new Promise((n,a)=>{r.push({resolve:n,reject:a})})}toggleResolved(t,r,i){return t!==this.version?!1:(i!==void 0&&(this.options=i),this.state=pe,this.value=r,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:r}),Qt(()=>this.notify()),!0)}toggleFailed(t,r,i){if(t!==this.version)return!1;i!==void 0&&(this.options=i),this.error=r,this.state=ne,this.update();let n=this.wrapperElement.getAttribute("is");return this.log?.error(`${n}: Failed to render: ${r.message}`,{element:this.wrapperElement,...r.context,...S(this,bt)?.duration}),Qt(()=>this.notify()),!0}togglePending(t){return this.version++,t&&(this.options=t),this.state=be,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!Y()||this.timer)return;let{error:r,options:i,state:n,value:a,version:o}=this;this.state=be,this.timer=Qt(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||t)try{await this.wrapperElement.render?.()===!1&&this.state===be&&this.version===o&&(this.state=n,this.error=r,this.value=a,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,i)}})}};bt=new WeakMap;function Rn(e={}){return Object.entries(e).forEach(([t,r])=>{(r==null||r===""||r?.length===0)&&delete e[t]}),e}function tr(e,t={}){let{tag:r,is:i}=e,n=document.createElement(r,{is:i});return n.setAttribute("is",i),Object.assign(n.dataset,Rn(t)),n}function Mn(e,t={}){return e instanceof HTMLElement?(Object.assign(e.dataset,Rn(t)),e):null}function As(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var Me,Le=class Le extends HTMLAnchorElement{constructor(){super();g(this,"masElement",new Ee(this));$(this,Me);this.setAttribute("is",Le.is)}get isUptLink(){return!0}initializeWcsData(r,i){this.setAttribute("data-wcs-osi",r),i&&this.setAttribute("data-promotion-code",i)}attributeChangedCallback(r,i,n){this.masElement.attributeChangedCallback(r,i,n)}connectedCallback(){this.masElement.connectedCallback(),G(this,Me,dt()),S(this,Me)&&(this.log=S(this,Me).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),G(this,Me,void 0)}requestUpdate(r=!1){this.masElement.requestUpdate(r)}onceSettled(){return this.masElement.onceSettled()}async render(){let r=dt();if(!r)return!1;this.dataset.imsCountry||r.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let i=r.collectCheckoutOptions({},this);if(!i.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let n=this.masElement.togglePending(i),a=r.resolveOfferSelectors(i);try{let[[o]]=await Promise.all(a),{country:s,language:c,env:l}=i,d=`locale=${c}_${s}&country=${s}&offer_id=${o.offerId}`,m=this.getAttribute("data-promotion-code");m&&(d+=`&promotion_code=${encodeURIComponent(m)}`),this.href=`${As(l)}?${d}`,this.masElement.toggleResolved(n,o,i)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${i.wcsOsi}.`,o.message);return this.masElement.toggleFailed(n,s,i),!1}}static createFrom(r){let i=new Le;for(let n of r.attributes)n.name!=="is"&&(n.name==="class"&&n.value.includes("upt-link")?i.setAttribute("class",n.value.replace("upt-link","").trim()):i.setAttribute(n.name,n.value));return i.innerHTML=r.innerHTML,i.setAttribute("tabindex",0),i}};Me=new WeakMap,g(Le,"is","upt-link"),g(Le,"tag","a"),g(Le,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var Re=Le;window.customElements.get(Re.is)||window.customElements.define(Re.is,Re,{extends:Re.tag});function Nn(e){return e&&(e.startsWith("plans")?"plans":e)}var Ss=/[0-9\-+#]/,Ts=/[^\d\-+#]/g;function On(e){return e.search(Ss)}function _s(e="#.##"){let t={},r=e.length,i=On(e);t.prefix=i>0?e.substring(0,i):"";let n=On(e.split("").reverse().join("")),a=r-n,o=e.substring(a,a+1),s=a+(o==="."||o===","?1:0);t.suffix=n>0?e.substring(s,r):"",t.mask=e.substring(i,s),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let c=t.mask.match(Ts);return t.decimal=c&&c[c.length-1]||".",t.separator=c&&c[1]&&c[0]||",",c=t.mask.split(t.decimal),t.integer=c[0],t.fraction=c[1],t}function Ps(e,t,r){let i=!1,n={value:e};e<0&&(i=!0,n.value=-n.value),n.sign=i?"-":"",n.value=Number(n.value).toFixed(t.fraction&&t.fraction.length),n.value=Number(n.value).toString();let a=t.fraction&&t.fraction.lastIndexOf("0"),[o="0",s=""]=n.value.split(".");return(!s||s&&s.length<=a)&&(s=a<0?"":(+("0."+s)).toFixed(a+1).replace("0.","")),n.integer=o,n.fraction=s,Cs(n,t),(n.result==="0"||n.result==="")&&(i=!1,n.sign=""),!i&&t.maskHasPositiveSign?n.sign="+":i&&t.maskHasPositiveSign?n.sign="-":i&&(n.sign=r&&r.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),n}function Cs(e,t){e.result="";let r=t.integer.split(t.separator),i=r.join(""),n=i&&i.indexOf("0");if(n>-1)for(;e.integer.length<i.length-n;)e.integer="0"+e.integer;else Number(e.integer)===0&&(e.integer="");let a=r[1]&&r[r.length-1].length;if(a){let o=e.integer.length,s=o%a;for(let c=0;c<o;c++)e.result+=e.integer.charAt(c),!((c-s+1)%a)&&c<o-a&&(e.result+=t.separator)}else e.result=e.integer;return e.result+=t.fraction&&e.fraction?t.decimal+e.fraction:"",e}function Ls(e,t,r={}){if(!e||isNaN(Number(t)))return t;let i=_s(e),n=Ps(t,i,r);return i.prefix+n.sign+n.result+i.suffix}var kn=Ls;var In=".",Rs=",",Dn=/^\s+/,Bn=/\s+$/,Hn="&nbsp;",hi=e=>e*12,Oe=(e,t,r=1)=>{if(!e)return!1;let{start:i,end:n,displaySummary:{amount:a,duration:o,minProductQuantity:s=1,outcomeType:c}={}}=e;if(!(a&&o&&c)||r<s)return!1;let l=t?new Date(t):new Date;if(!i||!n)return!1;let d=new Date(i),m=new Date(n);return l>=d&&l<=m},Ne={MONTH:"MONTH",YEAR:"YEAR"},Ms={[ee.ANNUAL]:12,[ee.MONTHLY]:1,[ee.THREE_YEARS]:36,[ee.TWO_YEARS]:24},mi=(e,t)=>({accept:e,round:t}),Ns=[mi(({divisor:e,price:t})=>t%e==0,({divisor:e,price:t})=>t/e),mi(({usePrecision:e})=>e,({divisor:e,price:t})=>Math.round(t/e*100)/100),mi(()=>!0,({divisor:e,price:t})=>Math.ceil(Math.floor(t*100/e)/100))],ui={[Se.YEAR]:{[ee.MONTHLY]:Ne.MONTH,[ee.ANNUAL]:Ne.YEAR},[Se.MONTH]:{[ee.MONTHLY]:Ne.MONTH}},Os=(e,t)=>e.indexOf(`'${t}'`)===0,ks=(e,t=!0)=>{let r=e.replace(/'.*?'/,"").trim(),i=Fn(r);return!!i?t||(r=r.replace(/[,\.]0+/,i)):r=r.replace(/\s?(#.*0)(?!\s)?/,"$&"+Hs(e)),r},Is=e=>{let t=Ds(e),r=Os(e,t),i=e.replace(/'.*?'/,""),n=Dn.test(i)||Bn.test(i);return{currencySymbol:t,isCurrencyFirst:r,hasCurrencySpace:n}},Un=e=>e.replace(Dn,Hn).replace(Bn,Hn),Hs=e=>e.match(/#(.?)#/)?.[1]===In?Rs:In,Ds=e=>e.match(/'(.*?)'/)?.[1]??"",Fn=e=>e.match(/0(.?)0/)?.[1]??"";function Ze({formatString:e,price:t,usePrecision:r,isIndianPrice:i=!1},n,a=o=>o){let{currencySymbol:o,isCurrencyFirst:s,hasCurrencySpace:c}=Is(e),l=r?Fn(e):"",d=ks(e,r),m=r?2:0,h=a(t,{currencySymbol:o}),p=i?h.toLocaleString("hi-IN",{minimumFractionDigits:m,maximumFractionDigits:m}):kn(d,h),u=r?p.lastIndexOf(l):p.length,f=p.substring(0,u),E=p.substring(u+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,p).replace(/SYMBOL/,o),currencySymbol:o,decimals:E,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:n}}var $n=e=>{let{commitment:t,term:r,usePrecision:i}=e,n=Ms[r]??1;return Ze(e,n>1?Ne.MONTH:ui[t]?.[r],a=>{let o={divisor:n,price:a,usePrecision:i},{round:s}=Ns.find(({accept:c})=>c(o));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(o)}`);return s(o)})},Gn=({commitment:e,term:t,...r})=>Ze(r,ui[e]?.[t]),zn=e=>{let{commitment:t,instant:r,price:i,originalPrice:n,priceWithoutDiscount:a,promotion:o,quantity:s=1,term:c}=e;if(t===Se.YEAR&&c===ee.MONTHLY){if(!o)return Ze(e,Ne.YEAR,hi);let{displaySummary:{outcomeType:l,duration:d}={}}=o;switch(l){case"PERCENTAGE_DISCOUNT":if(Oe(o,r,s)){let m=parseInt(d.replace("P","").replace("M",""));if(isNaN(m))return hi(i);let h=n*m,p=a*(12-m),u=Math.round((h+p)*100)/100;return Ze({...e,price:u},Ne.YEAR)}default:return Ze(e,Ne.YEAR,()=>hi(a??i))}}return Ze(e,ui[t]?.[c])};var Vn="download",qn="upgrade",jn={e:"EDU",t:"TEAM"};function Wn(e,t={},r=""){let i=Y();if(!i)return null;let{checkoutMarketSegment:n,checkoutWorkflow:a,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:m,quantity:h,wcsOsi:p,extraOptions:u,analyticsId:f}=i.collectCheckoutOptions(t),E=tr(e,{checkoutMarketSegment:n,checkoutWorkflow:a,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:m,quantity:h,wcsOsi:p,extraOptions:u,analyticsId:f});return r&&(E.innerHTML=`<span style="pointer-events: none;">${r}</span>`),E}function Yn(e){return class extends e{constructor(){super(...arguments);g(this,"checkoutActionHandler");g(this,"masElement",new Ee(this))}attributeChangedCallback(i,n,a){this.masElement.attributeChangedCallback(i,n,a)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get marketSegment(){let i=this.options?.ms??this.value?.[0].marketSegments?.[0];return jn[i]??i}get customerSegment(){let i=this.options?.cs??this.value?.[0]?.customerSegment;return jn[i]??i}get is3in1Modal(){return Object.values(_e).includes(this.getAttribute("data-modal"))}get isOpen3in1Modal(){let i=document.querySelector("meta[name=mas-ff-3in1]");return this.is3in1Modal&&(!i||i.content!=="off")}requestUpdate(i=!1){return this.masElement.requestUpdate(i)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(i={}){let n=Y();if(!n)return!1;this.dataset.imsCountry||n.imsCountryPromise.then(p=>{p&&(this.dataset.imsCountry=p)}),i.imsCountry=null;let a=n.collectCheckoutOptions(i,this);if(!a.wcsOsi.length)return!1;let o;try{o=JSON.parse(a.extraOptions??"{}")}catch(p){this.masElement.log?.error("cannot parse exta checkout options",p)}let s=this.masElement.togglePending(a);this.setCheckoutUrl("");let c=n.resolveOfferSelectors(a),l=await Promise.all(c);l=l.map(p=>xt(p,a));let d=l.flat().find(p=>p.promotion);!Oe(d?.promotion,d?.promotion?.displaySummary?.instant,a.quantity[0])&&a.promotionCode&&delete a.promotionCode,a.country=this.dataset.imsCountry||a.country;let h=await n.buildCheckoutAction?.(l.flat(),{...o,...a},this);return this.renderOffers(l.flat(),a,{},h,s)}renderOffers(i,n,a={},o=void 0,s=void 0){let c=Y();if(!c)return!1;if(n={...JSON.parse(this.dataset.extraOptions??"{}"),...n,...a},s??(s=this.masElement.togglePending(n)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),o){this.classList.remove(Vn,qn),this.masElement.toggleResolved(s,i,n);let{url:d,text:m,className:h,handler:p}=o;d&&this.setCheckoutUrl(d),m&&(this.firstElementChild.innerHTML=m),h&&this.classList.add(...h.split(" ")),p&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=p.bind(this))}if(i.length){if(this.masElement.toggleResolved(s,i,n)){if(!this.classList.contains(Vn)&&!this.classList.contains(qn)){let d=c.buildCheckoutURL(i,n);this.setCheckoutUrl(n.modal==="true"?"#":d)}return!0}}else{let d=new Error(`Not provided: ${n?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,d,n))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(i){}updateOptions(i={}){let n=Y();if(!n)return!1;let{checkoutMarketSegment:a,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:m,promotionCode:h,quantity:p,wcsOsi:u}=n.collectCheckoutOptions(i);return Mn(this,{checkoutMarketSegment:a,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:m,promotionCode:h,quantity:p,wcsOsi:u}),!0}}}var vt=class vt extends Yn(HTMLAnchorElement){static createCheckoutLink(t={},r=""){return Wn(vt,t,r)}setCheckoutUrl(t){this.setAttribute("href",t)}get isCheckoutLink(){return!0}clickHandler(t){if(this.checkoutActionHandler){this.checkoutActionHandler?.(t);return}}};g(vt,"is","checkout-link"),g(vt,"tag","a");var he=vt;window.customElements.get(he.is)||window.customElements.define(he.is,he,{extends:he.tag});var Bs="p_draft_landscape",Us="/store/",Fs=new Map([["countrySpecific","cs"],["customerSegment","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["addonProductArrangementCode","ao"],["offerType","ot"],["marketSegment","ms"]]),fi=new Set(["af","ai","ao","apc","appctxid","cli","co","cs","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),$s=["env","workflowStep","clientId","country"],Xn=e=>Fs.get(e)??e;function gi(e,t,r){for(let[i,n]of Object.entries(e)){let a=Xn(i);n!=null&&r.has(a)&&t.set(a,n)}}function Gs(e){switch(e){case Br.PRODUCTION:return"https://commerce.adobe.com";default:return"https://commerce-stg.adobe.com"}}function zs(e,t){for(let r in e){let i=e[r];for(let[n,a]of Object.entries(i)){if(a==null)continue;let o=Xn(n);t.set(`items[${r}][${o}]`,a)}}}function Vs({url:e,modal:t,is3in1:r}){if(!r||!e?.searchParams)return e;e.searchParams.set("rtc","t"),e.searchParams.set("lo","sl");let i=e.searchParams.get("af");return e.searchParams.set("af",[i,"uc_new_user_iframe","uc_new_system_close"].filter(Boolean).join(",")),e.searchParams.get("cli")!=="doc_cloud"&&e.searchParams.set("cli",t===_e.CRM?"creative":"mini_plans"),e}function Kn(e){qs(e);let{env:t,items:r,workflowStep:i,marketSegment:n,customerSegment:a,offerType:o,productArrangementCode:s,landscape:c,modal:l,is3in1:d,preselectPlan:m,...h}=e,p=new URL(Gs(t));if(p.pathname=`${Us}${i}`,i!==j.SEGMENTATION&&i!==j.CHANGE_PLAN_TEAM_PLANS&&zs(r,p.searchParams),gi({...h},p.searchParams,fi),c===ve.DRAFT&&gi({af:Bs},p.searchParams,fi),i===j.SEGMENTATION){let u={marketSegment:n,offerType:o,customerSegment:a,productArrangementCode:s,quantity:r?.[0]?.quantity,addonProductArrangementCode:s?r?.find(f=>f.productArrangementCode!==s)?.productArrangementCode:r?.[1]?.productArrangementCode};m?.toLowerCase()==="edu"?p.searchParams.set("ms","EDU"):m?.toLowerCase()==="team"&&p.searchParams.set("cs","TEAM"),gi(u,p.searchParams,fi),p.searchParams.get("ot")==="PROMOTION"&&p.searchParams.delete("ot"),p=Vs({url:p,modal:l,is3in1:d})}return p.toString()}function qs(e){for(let t of $s)if(!e[t])throw new Error('Argument "checkoutData" is not valid, missing: '+t);if(e.workflowStep!==j.SEGMENTATION&&e.workflowStep!==j.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}var P=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflowStep:j.EMAIL,country:"US",displayOldPrice:!1,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,displayPlanType:!1,env:le.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:ve.PUBLISHED});function Qn({settings:e,providers:t}){function r(a,o){let{checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:m,quantity:h,preselectPlan:p,env:u}=e,f={checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:m,quantity:h,preselectPlan:p,env:u};if(o)for(let He of t.checkout)He(o,f);let{checkoutMarketSegment:E,checkoutWorkflowStep:C=c,imsCountry:y,country:x=y??l,language:T=d,quantity:_=h,entitlement:N,upgrade:U,modal:q,perpetual:F,promotionCode:R=m,wcsOsi:H,extraOptions:J,...se}=Object.assign(f,o?.dataset??{},a??{}),ge=gt(C,j,P.checkoutWorkflowStep);return f=Wt({...se,extraOptions:J,checkoutClientId:s,checkoutMarketSegment:E,country:x,quantity:Ke(_,P.quantity),checkoutWorkflowStep:ge,language:T,entitlement:v(N),upgrade:v(U),modal:q,perpetual:v(F),promotionCode:Xt(R).effectivePromoCode,wcsOsi:Zt(H),preselectPlan:p}),f}function i(a,o){if(!Array.isArray(a)||!a.length||!o)return"";let{env:s,landscape:c}=e,{checkoutClientId:l,checkoutMarketSegment:d,checkoutWorkflowStep:m,country:h,promotionCode:p,quantity:u,preselectPlan:f,ms:E,cs:C,...y}=r(o),x=document.querySelector("meta[name=mas-ff-3in1]"),T=Object.values(_e).includes(o.modal)&&(!x||x.content!=="off"),_=window.frameElement||T?"if":"fp",[{productArrangementCode:N,marketSegments:[U],customerSegment:q,offerType:F}]=a,R=E??U??d,H=C??q;f?.toLowerCase()==="edu"?R="EDU":f?.toLowerCase()==="team"&&(H="TEAM");let J={is3in1:T,checkoutPromoCode:p,clientId:l,context:_,country:h,env:s,items:[],marketSegment:R,customerSegment:H,offerType:F,productArrangementCode:N,workflowStep:m,landscape:c,...y},se=u[0]>1?u[0]:void 0;if(a.length===1){let{offerId:ge}=a[0];J.items.push({id:ge,quantity:se})}else J.items.push(...a.map(({offerId:ge,productArrangementCode:He})=>({id:ge,quantity:se,...T?{productArrangementCode:He}:{}})));return Kn(J)}let{createCheckoutLink:n}=he;return{CheckoutLink:he,CheckoutWorkflowStep:j,buildCheckoutURL:i,collectCheckoutOptions:r,createCheckoutLink:n}}function js({interval:e=200,maxAttempts:t=25}={}){let r=ie.module("ims");return new Promise(i=>{r.debug("Waing for IMS to be ready");let n=0;function a(){window.adobeIMS?.initialized?i():++n>t?(r.debug("Timeout"),i()):setTimeout(a,e)}a()})}function Ws(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function Ys(e){let t=ie.module("ims");return e.then(r=>r?window.adobeIMS.getProfile().then(({countryCode:i})=>(t.debug("Got user country:",i),i),i=>{t.error("Unable to get user country:",i)}):null)}function Zn({}){let e=js(),t=Ws(e),r=Ys(t);return{imsReadyPromise:e,imsSignedInPromise:t,imsCountryPromise:r}}var Jn=window.masPriceLiterals;function ea(e){if(Array.isArray(Jn)){let t=i=>Jn.find(n=>Kr(n.lang,i)),r=t(e.language)??t(P.language);if(r)return Object.freeze(r)}return{}}var xi=function(e,t){return xi=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(r,i){r.__proto__=i}||function(r,i){for(var n in i)Object.prototype.hasOwnProperty.call(i,n)&&(r[n]=i[n])},xi(e,t)};function yt(e,t){if(typeof t!="function"&&t!==null)throw new TypeError("Class extends value "+String(t)+" is not a constructor or null");xi(e,t);function r(){this.constructor=e}e.prototype=t===null?Object.create(t):(r.prototype=t.prototype,new r)}var w=function(){return w=Object.assign||function(t){for(var r,i=1,n=arguments.length;i<n;i++){r=arguments[i];for(var a in r)Object.prototype.hasOwnProperty.call(r,a)&&(t[a]=r[a])}return t},w.apply(this,arguments)};function rr(e,t,r){if(r||arguments.length===2)for(var i=0,n=t.length,a;i<n;i++)(a||!(i in t))&&(a||(a=Array.prototype.slice.call(t,0,i)),a[i]=t[i]);return e.concat(a||Array.prototype.slice.call(t))}var b;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(b||(b={}));var M;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(M||(M={}));var ke;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(ke||(ke={}));function bi(e){return e.type===M.literal}function ta(e){return e.type===M.argument}function ir(e){return e.type===M.number}function nr(e){return e.type===M.date}function ar(e){return e.type===M.time}function or(e){return e.type===M.select}function sr(e){return e.type===M.plural}function ra(e){return e.type===M.pound}function cr(e){return e.type===M.tag}function lr(e){return!!(e&&typeof e=="object"&&e.type===ke.number)}function Et(e){return!!(e&&typeof e=="object"&&e.type===ke.dateTime)}var vi=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var Xs=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function ia(e){var t={};return e.replace(Xs,function(r){var i=r.length;switch(r[0]){case"G":t.era=i===4?"long":i===5?"narrow":"short";break;case"y":t.year=i===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":t.month=["numeric","2-digit","short","long","narrow"][i-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":t.day=["numeric","2-digit"][i-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":t.weekday=i===4?"short":i===5?"narrow":"short";break;case"e":if(i<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][i-4];break;case"c":if(i<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][i-4];break;case"a":t.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":t.hourCycle="h12",t.hour=["numeric","2-digit"][i-1];break;case"H":t.hourCycle="h23",t.hour=["numeric","2-digit"][i-1];break;case"K":t.hourCycle="h11",t.hour=["numeric","2-digit"][i-1];break;case"k":t.hourCycle="h24",t.hour=["numeric","2-digit"][i-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":t.minute=["numeric","2-digit"][i-1];break;case"s":t.second=["numeric","2-digit"][i-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":t.timeZoneName=i<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),t}var na=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function ca(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var t=e.split(na).filter(function(h){return h.length>0}),r=[],i=0,n=t;i<n.length;i++){var a=n[i],o=a.split("/");if(o.length===0)throw new Error("Invalid number skeleton");for(var s=o[0],c=o.slice(1),l=0,d=c;l<d.length;l++){var m=d[l];if(m.length===0)throw new Error("Invalid number skeleton")}r.push({stem:s,options:c})}return r}function Ks(e){return e.replace(/^(.*?)-/,"")}var aa=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,la=/^(@+)?(\+|#+)?[rs]?$/g,Qs=/(\*)(0+)|(#+)(0+)|(0+)/g,da=/^(0+)$/;function oa(e){var t={};return e[e.length-1]==="r"?t.roundingPriority="morePrecision":e[e.length-1]==="s"&&(t.roundingPriority="lessPrecision"),e.replace(la,function(r,i,n){return typeof n!="string"?(t.minimumSignificantDigits=i.length,t.maximumSignificantDigits=i.length):n==="+"?t.minimumSignificantDigits=i.length:i[0]==="#"?t.maximumSignificantDigits=i.length:(t.minimumSignificantDigits=i.length,t.maximumSignificantDigits=i.length+(typeof n=="string"?n.length:0)),""}),t}function pa(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function Zs(e){var t;if(e[0]==="E"&&e[1]==="E"?(t={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(t={notation:"scientific"},e=e.slice(1)),t){var r=e.slice(0,2);if(r==="+!"?(t.signDisplay="always",e=e.slice(2)):r==="+?"&&(t.signDisplay="exceptZero",e=e.slice(2)),!da.test(e))throw new Error("Malformed concise eng/scientific notation");t.minimumIntegerDigits=e.length}return t}function sa(e){var t={},r=pa(e);return r||t}function ha(e){for(var t={},r=0,i=e;r<i.length;r++){var n=i[r];switch(n.stem){case"percent":case"%":t.style="percent";continue;case"%x100":t.style="percent",t.scale=100;continue;case"currency":t.style="currency",t.currency=n.options[0];continue;case"group-off":case",_":t.useGrouping=!1;continue;case"precision-integer":case".":t.maximumFractionDigits=0;continue;case"measure-unit":case"unit":t.style="unit",t.unit=Ks(n.options[0]);continue;case"compact-short":case"K":t.notation="compact",t.compactDisplay="short";continue;case"compact-long":case"KK":t.notation="compact",t.compactDisplay="long";continue;case"scientific":t=w(w(w({},t),{notation:"scientific"}),n.options.reduce(function(c,l){return w(w({},c),sa(l))},{}));continue;case"engineering":t=w(w(w({},t),{notation:"engineering"}),n.options.reduce(function(c,l){return w(w({},c),sa(l))},{}));continue;case"notation-simple":t.notation="standard";continue;case"unit-width-narrow":t.currencyDisplay="narrowSymbol",t.unitDisplay="narrow";continue;case"unit-width-short":t.currencyDisplay="code",t.unitDisplay="short";continue;case"unit-width-full-name":t.currencyDisplay="name",t.unitDisplay="long";continue;case"unit-width-iso-code":t.currencyDisplay="symbol";continue;case"scale":t.scale=parseFloat(n.options[0]);continue;case"integer-width":if(n.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");n.options[0].replace(Qs,function(c,l,d,m,h,p){if(l)t.minimumIntegerDigits=d.length;else{if(m&&h)throw new Error("We currently do not support maximum integer digits");if(p)throw new Error("We currently do not support exact integer digits")}return""});continue}if(da.test(n.stem)){t.minimumIntegerDigits=n.stem.length;continue}if(aa.test(n.stem)){if(n.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");n.stem.replace(aa,function(c,l,d,m,h,p){return d==="*"?t.minimumFractionDigits=l.length:m&&m[0]==="#"?t.maximumFractionDigits=m.length:h&&p?(t.minimumFractionDigits=h.length,t.maximumFractionDigits=h.length+p.length):(t.minimumFractionDigits=l.length,t.maximumFractionDigits=l.length),""});var a=n.options[0];a==="w"?t=w(w({},t),{trailingZeroDisplay:"stripIfInteger"}):a&&(t=w(w({},t),oa(a)));continue}if(la.test(n.stem)){t=w(w({},t),oa(n.stem));continue}var o=pa(n.stem);o&&(t=w(w({},t),o));var s=Zs(n.stem);s&&(t=w(w({},t),s))}return t}var wt={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function ma(e,t){for(var r="",i=0;i<e.length;i++){var n=e.charAt(i);if(n==="j"){for(var a=0;i+1<e.length&&e.charAt(i+1)===n;)a++,i++;var o=1+(a&1),s=a<2?1:3+(a>>1),c="a",l=Js(t);for((l=="H"||l=="k")&&(s=0);s-- >0;)r+=c;for(;o-- >0;)r=l+r}else n==="J"?r+="H":r+=n}return r}function Js(e){var t=e.hourCycle;if(t===void 0&&e.hourCycles&&e.hourCycles.length&&(t=e.hourCycles[0]),t)switch(t){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var r=e.language,i;r!=="root"&&(i=e.maximize().region);var n=wt[i||""]||wt[r||""]||wt["".concat(r,"-001")]||wt["001"];return n[0]}var yi,ec=new RegExp("^".concat(vi.source,"*")),tc=new RegExp("".concat(vi.source,"*$"));function A(e,t){return{start:e,end:t}}var rc=!!String.prototype.startsWith,ic=!!String.fromCodePoint,nc=!!Object.fromEntries,ac=!!String.prototype.codePointAt,oc=!!String.prototype.trimStart,sc=!!String.prototype.trimEnd,cc=!!Number.isSafeInteger,lc=cc?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},wi=!0;try{ua=ba("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),wi=((yi=ua.exec("a"))===null||yi===void 0?void 0:yi[0])==="a"}catch{wi=!1}var ua,fa=rc?function(t,r,i){return t.startsWith(r,i)}:function(t,r,i){return t.slice(i,i+r.length)===r},Ai=ic?String.fromCodePoint:function(){for(var t=[],r=0;r<arguments.length;r++)t[r]=arguments[r];for(var i="",n=t.length,a=0,o;n>a;){if(o=t[a++],o>1114111)throw RangeError(o+" is not a valid code point");i+=o<65536?String.fromCharCode(o):String.fromCharCode(((o-=65536)>>10)+55296,o%1024+56320)}return i},ga=nc?Object.fromEntries:function(t){for(var r={},i=0,n=t;i<n.length;i++){var a=n[i],o=a[0],s=a[1];r[o]=s}return r},xa=ac?function(t,r){return t.codePointAt(r)}:function(t,r){var i=t.length;if(!(r<0||r>=i)){var n=t.charCodeAt(r),a;return n<55296||n>56319||r+1===i||(a=t.charCodeAt(r+1))<56320||a>57343?n:(n-55296<<10)+(a-56320)+65536}},dc=oc?function(t){return t.trimStart()}:function(t){return t.replace(ec,"")},pc=sc?function(t){return t.trimEnd()}:function(t){return t.replace(tc,"")};function ba(e,t){return new RegExp(e,t)}var Si;wi?(Ei=ba("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Si=function(t,r){var i;Ei.lastIndex=r;var n=Ei.exec(t);return(i=n[1])!==null&&i!==void 0?i:""}):Si=function(t,r){for(var i=[];;){var n=xa(t,r);if(n===void 0||ya(n)||uc(n))break;i.push(n),r+=n>=65536?2:1}return Ai.apply(void 0,i)};var Ei,va=function(){function e(t,r){r===void 0&&(r={}),this.message=t,this.position={offset:0,line:1,column:1},this.ignoreTag=!!r.ignoreTag,this.locale=r.locale,this.requiresOtherClause=!!r.requiresOtherClause,this.shouldParseSkeletons=!!r.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(t,r,i){for(var n=[];!this.isEOF();){var a=this.char();if(a===123){var o=this.parseArgument(t,i);if(o.err)return o;n.push(o.val)}else{if(a===125&&t>0)break;if(a===35&&(r==="plural"||r==="selectordinal")){var s=this.clonePosition();this.bump(),n.push({type:M.pound,location:A(s,this.clonePosition())})}else if(a===60&&!this.ignoreTag&&this.peek()===47){if(i)break;return this.error(b.UNMATCHED_CLOSING_TAG,A(this.clonePosition(),this.clonePosition()))}else if(a===60&&!this.ignoreTag&&Ti(this.peek()||0)){var o=this.parseTag(t,r);if(o.err)return o;n.push(o.val)}else{var o=this.parseLiteral(t,r);if(o.err)return o;n.push(o.val)}}}return{val:n,err:null}},e.prototype.parseTag=function(t,r){var i=this.clonePosition();this.bump();var n=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:M.literal,value:"<".concat(n,"/>"),location:A(i,this.clonePosition())},err:null};if(this.bumpIf(">")){var a=this.parseMessage(t+1,r,!0);if(a.err)return a;var o=a.val,s=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!Ti(this.char()))return this.error(b.INVALID_TAG,A(s,this.clonePosition()));var c=this.clonePosition(),l=this.parseTagName();return n!==l?this.error(b.UNMATCHED_CLOSING_TAG,A(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:M.tag,value:n,children:o,location:A(i,this.clonePosition())},err:null}:this.error(b.INVALID_TAG,A(s,this.clonePosition())))}else return this.error(b.UNCLOSED_TAG,A(i,this.clonePosition()))}else return this.error(b.INVALID_TAG,A(i,this.clonePosition()))},e.prototype.parseTagName=function(){var t=this.offset();for(this.bump();!this.isEOF()&&mc(this.char());)this.bump();return this.message.slice(t,this.offset())},e.prototype.parseLiteral=function(t,r){for(var i=this.clonePosition(),n="";;){var a=this.tryParseQuote(r);if(a){n+=a;continue}var o=this.tryParseUnquoted(t,r);if(o){n+=o;continue}var s=this.tryParseLeftAngleBracket();if(s){n+=s;continue}break}var c=A(i,this.clonePosition());return{val:{type:M.literal,value:n,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!hc(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(t){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(t==="plural"||t==="selectordinal")break;return null;default:return null}this.bump();var r=[this.char()];for(this.bump();!this.isEOF();){var i=this.char();if(i===39)if(this.peek()===39)r.push(39),this.bump();else{this.bump();break}else r.push(i);this.bump()}return Ai.apply(void 0,r)},e.prototype.tryParseUnquoted=function(t,r){if(this.isEOF())return null;var i=this.char();return i===60||i===123||i===35&&(r==="plural"||r==="selectordinal")||i===125&&t>0?null:(this.bump(),Ai(i))},e.prototype.parseArgument=function(t,r){var i=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(b.EXPECT_ARGUMENT_CLOSING_BRACE,A(i,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(b.EMPTY_ARGUMENT,A(i,this.clonePosition()));var n=this.parseIdentifierIfPossible().value;if(!n)return this.error(b.MALFORMED_ARGUMENT,A(i,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(b.EXPECT_ARGUMENT_CLOSING_BRACE,A(i,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:M.argument,value:n,location:A(i,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(b.EXPECT_ARGUMENT_CLOSING_BRACE,A(i,this.clonePosition())):this.parseArgumentOptions(t,r,n,i);default:return this.error(b.MALFORMED_ARGUMENT,A(i,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var t=this.clonePosition(),r=this.offset(),i=Si(this.message,r),n=r+i.length;this.bumpTo(n);var a=this.clonePosition(),o=A(t,a);return{value:i,location:o}},e.prototype.parseArgumentOptions=function(t,r,i,n){var a,o=this.clonePosition(),s=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(s){case"":return this.error(b.EXPECT_ARGUMENT_TYPE,A(o,c));case"number":case"date":case"time":{this.bumpSpace();var l=null;if(this.bumpIf(",")){this.bumpSpace();var d=this.clonePosition(),m=this.parseSimpleArgStyleIfPossible();if(m.err)return m;var h=pc(m.val);if(h.length===0)return this.error(b.EXPECT_ARGUMENT_STYLE,A(this.clonePosition(),this.clonePosition()));var p=A(d,this.clonePosition());l={style:h,styleLocation:p}}var u=this.tryParseArgumentClose(n);if(u.err)return u;var f=A(n,this.clonePosition());if(l&&fa(l?.style,"::",0)){var E=dc(l.style.slice(2));if(s==="number"){var m=this.parseNumberSkeletonFromString(E,l.styleLocation);return m.err?m:{val:{type:M.number,value:i,location:f,style:m.val},err:null}}else{if(E.length===0)return this.error(b.EXPECT_DATE_TIME_SKELETON,f);var C=E;this.locale&&(C=ma(E,this.locale));var h={type:ke.dateTime,pattern:C,location:l.styleLocation,parsedOptions:this.shouldParseSkeletons?ia(C):{}},y=s==="date"?M.date:M.time;return{val:{type:y,value:i,location:f,style:h},err:null}}}return{val:{type:s==="number"?M.number:s==="date"?M.date:M.time,value:i,location:f,style:(a=l?.style)!==null&&a!==void 0?a:null},err:null}}case"plural":case"selectordinal":case"select":{var x=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(b.EXPECT_SELECT_ARGUMENT_OPTIONS,A(x,w({},x)));this.bumpSpace();var T=this.parseIdentifierIfPossible(),_=0;if(s!=="select"&&T.value==="offset"){if(!this.bumpIf(":"))return this.error(b.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,A(this.clonePosition(),this.clonePosition()));this.bumpSpace();var m=this.tryParseDecimalInteger(b.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,b.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(m.err)return m;this.bumpSpace(),T=this.parseIdentifierIfPossible(),_=m.val}var N=this.tryParsePluralOrSelectOptions(t,s,r,T);if(N.err)return N;var u=this.tryParseArgumentClose(n);if(u.err)return u;var U=A(n,this.clonePosition());return s==="select"?{val:{type:M.select,value:i,options:ga(N.val),location:U},err:null}:{val:{type:M.plural,value:i,options:ga(N.val),offset:_,pluralType:s==="plural"?"cardinal":"ordinal",location:U},err:null}}default:return this.error(b.INVALID_ARGUMENT_TYPE,A(o,c))}},e.prototype.tryParseArgumentClose=function(t){return this.isEOF()||this.char()!==125?this.error(b.EXPECT_ARGUMENT_CLOSING_BRACE,A(t,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var t=0,r=this.clonePosition();!this.isEOF();){var i=this.char();switch(i){case 39:{this.bump();var n=this.clonePosition();if(!this.bumpUntil("'"))return this.error(b.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,A(n,this.clonePosition()));this.bump();break}case 123:{t+=1,this.bump();break}case 125:{if(t>0)t-=1;else return{val:this.message.slice(r.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(r.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(t,r){var i=[];try{i=ca(t)}catch{return this.error(b.INVALID_NUMBER_SKELETON,r)}return{val:{type:ke.number,tokens:i,location:r,parsedOptions:this.shouldParseSkeletons?ha(i):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(t,r,i,n){for(var a,o=!1,s=[],c=new Set,l=n.value,d=n.location;;){if(l.length===0){var m=this.clonePosition();if(r!=="select"&&this.bumpIf("=")){var h=this.tryParseDecimalInteger(b.EXPECT_PLURAL_ARGUMENT_SELECTOR,b.INVALID_PLURAL_ARGUMENT_SELECTOR);if(h.err)return h;d=A(m,this.clonePosition()),l=this.message.slice(m.offset,this.offset())}else break}if(c.has(l))return this.error(r==="select"?b.DUPLICATE_SELECT_ARGUMENT_SELECTOR:b.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,d);l==="other"&&(o=!0),this.bumpSpace();var p=this.clonePosition();if(!this.bumpIf("{"))return this.error(r==="select"?b.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:b.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,A(this.clonePosition(),this.clonePosition()));var u=this.parseMessage(t+1,r,i);if(u.err)return u;var f=this.tryParseArgumentClose(p);if(f.err)return f;s.push([l,{value:u.val,location:A(p,this.clonePosition())}]),c.add(l),this.bumpSpace(),a=this.parseIdentifierIfPossible(),l=a.value,d=a.location}return s.length===0?this.error(r==="select"?b.EXPECT_SELECT_ARGUMENT_SELECTOR:b.EXPECT_PLURAL_ARGUMENT_SELECTOR,A(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!o?this.error(b.MISSING_OTHER_CLAUSE,A(this.clonePosition(),this.clonePosition())):{val:s,err:null}},e.prototype.tryParseDecimalInteger=function(t,r){var i=1,n=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(i=-1);for(var a=!1,o=0;!this.isEOF();){var s=this.char();if(s>=48&&s<=57)a=!0,o=o*10+(s-48),this.bump();else break}var c=A(n,this.clonePosition());return a?(o*=i,lc(o)?{val:o,err:null}:this.error(r,c)):this.error(t,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var t=this.position.offset;if(t>=this.message.length)throw Error("out of bound");var r=xa(this.message,t);if(r===void 0)throw Error("Offset ".concat(t," is at invalid UTF-16 code unit boundary"));return r},e.prototype.error=function(t,r){return{val:null,err:{kind:t,message:this.message,location:r}}},e.prototype.bump=function(){if(!this.isEOF()){var t=this.char();t===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=t<65536?1:2)}},e.prototype.bumpIf=function(t){if(fa(this.message,t,this.offset())){for(var r=0;r<t.length;r++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(t){var r=this.offset(),i=this.message.indexOf(t,r);return i>=0?(this.bumpTo(i),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(t){if(this.offset()>t)throw Error("targetOffset ".concat(t," must be greater than or equal to the current offset ").concat(this.offset()));for(t=Math.min(t,this.message.length);;){var r=this.offset();if(r===t)break;if(r>t)throw Error("targetOffset ".concat(t," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&ya(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var t=this.char(),r=this.offset(),i=this.message.charCodeAt(r+(t>=65536?2:1));return i??null},e}();function Ti(e){return e>=97&&e<=122||e>=65&&e<=90}function hc(e){return Ti(e)||e===47}function mc(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function ya(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function uc(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function _i(e){e.forEach(function(t){if(delete t.location,or(t)||sr(t))for(var r in t.options)delete t.options[r].location,_i(t.options[r].value);else ir(t)&&lr(t.style)||(nr(t)||ar(t))&&Et(t.style)?delete t.style.location:cr(t)&&_i(t.children)})}function Ea(e,t){t===void 0&&(t={}),t=w({shouldParseSkeletons:!0,requiresOtherClause:!0},t);var r=new va(e,t).parse();if(r.err){var i=SyntaxError(b[r.err.kind]);throw i.location=r.err.location,i.originalMessage=r.err.message,i}return t?.captureLocation||_i(r.val),r.val}function At(e,t){var r=t&&t.cache?t.cache:yc,i=t&&t.serializer?t.serializer:vc,n=t&&t.strategy?t.strategy:gc;return n(e,{cache:r,serializer:i})}function fc(e){return e==null||typeof e=="number"||typeof e=="boolean"}function wa(e,t,r,i){var n=fc(i)?i:r(i),a=t.get(n);return typeof a>"u"&&(a=e.call(this,i),t.set(n,a)),a}function Aa(e,t,r){var i=Array.prototype.slice.call(arguments,3),n=r(i),a=t.get(n);return typeof a>"u"&&(a=e.apply(this,i),t.set(n,a)),a}function Pi(e,t,r,i,n){return r.bind(t,e,i,n)}function gc(e,t){var r=e.length===1?wa:Aa;return Pi(e,this,r,t.cache.create(),t.serializer)}function xc(e,t){return Pi(e,this,Aa,t.cache.create(),t.serializer)}function bc(e,t){return Pi(e,this,wa,t.cache.create(),t.serializer)}var vc=function(){return JSON.stringify(arguments)};function Ci(){this.cache=Object.create(null)}Ci.prototype.get=function(e){return this.cache[e]};Ci.prototype.set=function(e,t){this.cache[e]=t};var yc={create:function(){return new Ci}},dr={variadic:xc,monadic:bc};var Ie;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(Ie||(Ie={}));var St=function(e){yt(t,e);function t(r,i,n){var a=e.call(this,r)||this;return a.code=i,a.originalMessage=n,a}return t.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},t}(Error);var Li=function(e){yt(t,e);function t(r,i,n,a){return e.call(this,'Invalid values for "'.concat(r,'": "').concat(i,'". Options are "').concat(Object.keys(n).join('", "'),'"'),Ie.INVALID_VALUE,a)||this}return t}(St);var Sa=function(e){yt(t,e);function t(r,i,n){return e.call(this,'Value for "'.concat(r,'" must be of type ').concat(i),Ie.INVALID_VALUE,n)||this}return t}(St);var Ta=function(e){yt(t,e);function t(r,i){return e.call(this,'The intl string context variable "'.concat(r,'" was not provided to the string "').concat(i,'"'),Ie.MISSING_VALUE,i)||this}return t}(St);var z;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(z||(z={}));function Ec(e){return e.length<2?e:e.reduce(function(t,r){var i=t[t.length-1];return!i||i.type!==z.literal||r.type!==z.literal?t.push(r):i.value+=r.value,t},[])}function wc(e){return typeof e=="function"}function Tt(e,t,r,i,n,a,o){if(e.length===1&&bi(e[0]))return[{type:z.literal,value:e[0].value}];for(var s=[],c=0,l=e;c<l.length;c++){var d=l[c];if(bi(d)){s.push({type:z.literal,value:d.value});continue}if(ra(d)){typeof a=="number"&&s.push({type:z.literal,value:r.getNumberFormat(t).format(a)});continue}var m=d.value;if(!(n&&m in n))throw new Ta(m,o);var h=n[m];if(ta(d)){(!h||typeof h=="string"||typeof h=="number")&&(h=typeof h=="string"||typeof h=="number"?String(h):""),s.push({type:typeof h=="string"?z.literal:z.object,value:h});continue}if(nr(d)){var p=typeof d.style=="string"?i.date[d.style]:Et(d.style)?d.style.parsedOptions:void 0;s.push({type:z.literal,value:r.getDateTimeFormat(t,p).format(h)});continue}if(ar(d)){var p=typeof d.style=="string"?i.time[d.style]:Et(d.style)?d.style.parsedOptions:i.time.medium;s.push({type:z.literal,value:r.getDateTimeFormat(t,p).format(h)});continue}if(ir(d)){var p=typeof d.style=="string"?i.number[d.style]:lr(d.style)?d.style.parsedOptions:void 0;p&&p.scale&&(h=h*(p.scale||1)),s.push({type:z.literal,value:r.getNumberFormat(t,p).format(h)});continue}if(cr(d)){var u=d.children,f=d.value,E=n[f];if(!wc(E))throw new Sa(f,"function",o);var C=Tt(u,t,r,i,n,a),y=E(C.map(function(_){return _.value}));Array.isArray(y)||(y=[y]),s.push.apply(s,y.map(function(_){return{type:typeof _=="string"?z.literal:z.object,value:_}}))}if(or(d)){var x=d.options[h]||d.options.other;if(!x)throw new Li(d.value,h,Object.keys(d.options),o);s.push.apply(s,Tt(x.value,t,r,i,n));continue}if(sr(d)){var x=d.options["=".concat(h)];if(!x){if(!Intl.PluralRules)throw new St(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,Ie.MISSING_INTL_API,o);var T=r.getPluralRules(t,{type:d.pluralType}).select(h-(d.offset||0));x=d.options[T]||d.options.other}if(!x)throw new Li(d.value,h,Object.keys(d.options),o);s.push.apply(s,Tt(x.value,t,r,i,n,h-(d.offset||0)));continue}}return Ec(s)}function Ac(e,t){return t?w(w(w({},e||{}),t||{}),Object.keys(e).reduce(function(r,i){return r[i]=w(w({},e[i]),t[i]||{}),r},{})):e}function Sc(e,t){return t?Object.keys(e).reduce(function(r,i){return r[i]=Ac(e[i],t[i]),r},w({},e)):e}function Ri(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function Tc(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:At(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.NumberFormat).bind.apply(t,rr([void 0],r,!1)))},{cache:Ri(e.number),strategy:dr.variadic}),getDateTimeFormat:At(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.DateTimeFormat).bind.apply(t,rr([void 0],r,!1)))},{cache:Ri(e.dateTime),strategy:dr.variadic}),getPluralRules:At(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.PluralRules).bind.apply(t,rr([void 0],r,!1)))},{cache:Ri(e.pluralRules),strategy:dr.variadic})}}var _a=function(){function e(t,r,i,n){var a=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=a.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==z.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return Tt(a.ast,a.locales,a.formatters,a.formats,o,void 0,a.message)},this.resolvedOptions=function(){return{locale:a.resolvedLocale.toString()}},this.getAst=function(){return a.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:n?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Sc(e.formats,i),this.formatters=n&&n.formatters||Tc(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=Ea,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var Pa=_a;var Mi={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},_c=xn("ConsonantTemplates/price"),Pc=/<\/?[^>]+(>|$)/g,I={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},we={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Ni="TAX_EXCLUSIVE",Cc=e=>un(e)?Object.entries(e).filter(([,t])=>Xe(t)||jt(t)||t===!0).reduce((t,[r,i])=>t+` ${r}${i===!0?"":'="'+mn(i)+'"'}`,""):"",B=(e,t,r,i=!1)=>`<span class="${e}${t?"":" "+I.disabled}"${Cc(r)}>${i?Un(t):t??""}</span>`;function me(e,t,r,i){let n=e[r];if(n==null)return"";try{return new Pa(n.replace(Pc,""),t).format(i)}catch{return _c.error("Failed to format literal:",n),""}}function Lc(e,{accessibleLabel:t,altAccessibleLabel:r,currencySymbol:i,decimals:n,decimalsDelimiter:a,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:m},h={}){let p=B(I.currencySymbol,i),u=B(I.currencySpace,o?"&nbsp;":""),f="";return t?f=`<sr-only class="strikethrough-aria-label">${t}</sr-only>`:r&&(f=`<sr-only class="alt-aria-label">${r}</sr-only>`),c&&(f+=p+u),f+=B(I.integer,s),f+=B(I.decimalsDelimiter,a),f+=B(I.decimals,n),c||(f+=u+p),f+=B(I.recurrence,l,null,!0),f+=B(I.unitType,d,null,!0),f+=B(I.taxInclusivity,m,!0),B(e,f,{...h})}var V=({isAlternativePrice:e=!1,displayOptical:t=!1,displayStrikethrough:r=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:a,displayFormatted:o=!0,displayRecurrence:s=!0,displayPerUnit:c=!1,displayTax:l=!1,language:d,literals:m={},quantity:h=1,space:p=!1,isPromoApplied:u=!1}={},{commitment:f,offerSelectorIds:E,formatString:C,price:y,priceWithoutDiscount:x,taxDisplay:T,taxTerm:_,term:N,usePrecision:U,promotion:q}={},F={})=>{Object.entries({country:a,formatString:C,language:d,price:y}).forEach(([mo,uo])=>{if(uo==null)throw new Error(`Argument "${mo}" is missing for osi ${E?.toString()}, country ${a}, language ${d}`)});let R={...Mi,...m},H=`${d.toLowerCase()}-${a.toUpperCase()}`,J=r&&x?x:y;q&&!u&&x&&(J=x);let se=t?$n:Gn;i&&(se=zn);let{accessiblePrice:ge,recurrenceTerm:He,...Di}=se({commitment:f,formatString:C,instant:n,isIndianPrice:a==="IN",originalPrice:y,priceWithoutDiscount:x,price:t?y:J,promotion:q,quantity:h,term:N,usePrecision:U}),mr="",ur="",fr="";v(s)&&He&&(fr=me(R,H,we.recurrenceLabel,{recurrenceTerm:He}));let Mt="";v(c)&&(p&&(Mt+=" "),Mt+=me(R,H,we.perUnitLabel,{perUnit:"LICENSE"}));let Nt="";v(l)&&_&&(p&&(Nt+=" "),Nt+=me(R,H,T===Ni?we.taxExclusiveLabel:we.taxInclusiveLabel,{taxTerm:_})),r&&(mr=me(R,H,we.strikethroughAriaLabel,{strikethroughPrice:mr})),e&&(ur=me(R,H,we.alternativePriceAriaLabel,{alternativePrice:ur}));let De=I.container;if(t&&(De+=" "+I.containerOptical),r&&(De+=" "+I.containerStrikethrough),e&&(De+=" "+I.containerAlternative),i&&(De+=" "+I.containerAnnual),v(o))return Lc(De,{...Di,accessibleLabel:mr,altAccessibleLabel:ur,recurrenceLabel:fr,perUnitLabel:Mt,taxInclusivityLabel:Nt},F);let{currencySymbol:Bi,decimals:so,decimalsDelimiter:co,hasCurrencySpace:Ui,integer:lo,isCurrencyFirst:po}=Di,Be=[lo,co,so];po?(Be.unshift(Ui?"\xA0":""),Be.unshift(Bi)):(Be.push(Ui?"\xA0":""),Be.push(Bi)),Be.push(fr,Mt,Nt);let ho=Be.join("");return B(De,ho,F)},Ca=()=>(e,t,r)=>{let i=Oe(t.promotion,t.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),a=(e.displayOldPrice===void 0||v(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price&&(!t.promotion||i);return`${a?V({displayStrikethrough:!0})({isPromoApplied:i,...e},t,r)+"&nbsp;":""}${V({isAlternativePrice:a})({isPromoApplied:i,...e},t,r)}`},La=()=>(e,t,r)=>{let{instant:i}=e;try{i||(i=new URLSearchParams(document.location.search).get("instant")),i&&(i=new Date(i))}catch{i=void 0}let n=Oe(t.promotion,i,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),a={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:n};if(!n)return V()(e,{...t,price:t.priceWithoutDiscount},r)+B(I.containerAnnualPrefix,"&nbsp;(")+V({displayAnnual:!0,instant:i})(a,{...t,price:t.priceWithoutDiscount},r)+B(I.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||v(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${s?V({displayStrikethrough:!0})(a,t,r)+"&nbsp;":""}${V({isAlternativePrice:s})({isPromoApplied:n,...e},t,r)}${B(I.containerAnnualPrefix,"&nbsp;(")}${V({displayAnnual:!0,instant:i})(a,t,r)}${B(I.containerAnnualSuffix,")")}`},Ra=()=>(e,t,r)=>{let i={...e,displayTax:!1,displayPerUnit:!1};return`${V({isAlternativePrice:e.displayOldPrice})(e,t,r)}${B(I.containerAnnualPrefix,"&nbsp;(")}${V({displayAnnual:!0})(i,t,r)}${B(I.containerAnnualSuffix,")")}`};var _t={...I,containerLegal:"price-legal",planType:"price-plan-type"},pr={...we,planTypeLabel:"planTypeLabel"};function Rc(e,{perUnitLabel:t,taxInclusivityLabel:r,planTypeLabel:i},n={}){let a="";return a+=B(_t.unitType,t,null,!0),r&&i&&(r+=". "),a+=B(_t.taxInclusivity,r,!0),a+=B(_t.planType,i,null),B(e,a,{...n})}var Ma=({country:e,displayPerUnit:t=!1,displayTax:r=!1,displayPlanType:i=!1,language:n,literals:a={}}={},{taxDisplay:o,taxTerm:s,planType:c}={},l={})=>{let d={...Mi,...a},m=`${n.toLowerCase()}-${e.toUpperCase()}`,h="";v(t)&&(h=me(d,m,pr.perUnitLabel,{perUnit:"LICENSE"}));let p="";e==="US"&&n==="en"&&(r=!1),v(r)&&s&&(p=me(d,m,o===Ni?pr.taxExclusiveLabel:pr.taxInclusiveLabel,{taxTerm:s}));let u="";v(i)&&c&&(u=me(d,m,pr.planTypeLabel,{planType:c}));let f=_t.container;return f+=" "+_t.containerLegal,Rc(f,{perUnitLabel:h,taxInclusivityLabel:p,planTypeLabel:u},l)};var Na=V(),Oa=Ca(),ka=V({displayOptical:!0}),Ia=V({displayStrikethrough:!0}),Ha=V({displayAnnual:!0}),Da=V({displayOptical:!0,isAlternativePrice:!0}),Ba=V({isAlternativePrice:!0}),Ua=Ra(),Fa=La(),$a=Ma;var Mc=(e,t)=>{if(!(!ft(e)||!ft(t)))return Math.floor((t-e)/t*100)},Ga=()=>(e,t)=>{let{price:r,priceWithoutDiscount:i}=t,n=Mc(r,i);return n===void 0?'<span class="no-discount"></span>':`<span class="discount">${n}%</span>`};var za=Ga();var qa="INDIVIDUAL_COM",Oi="TEAM_COM",ja="INDIVIDUAL_EDU",ki="TEAM_EDU",Va=["GB_en","AU_en","FR_fr","AT_de","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","GR_el","GR_en","HU_hu","IE_en","IT_it","LU_de","LU_en","LU_fr","NL_nl","NO_nb","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TR_tr","UA_uk","ID_en","ID_in","IN_en","IN_hi","JP_ja","MY_en","MY_ms","NZ_en","TH_en","TH_th"],Nc={[qa]:["MU_en","LT_lt","LV_lv","NG_en","SA_ar","SA_en","SG_en","KR_ko"],[Oi]:["MU_en","LT_lt","LV_lv","NG_en","CO_es","KR_ko"],[ja]:["LT_lt","LV_lv","SA_en","SG_en"],[ki]:["SG_en","KR_ko"]},Oc={MU_en:[!1,!1,!1,!1],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],CO_es:[!1,!0,!1,!1],AT_de:[!1,!1,!1,!0],SG_en:[!1,!1,!1,!0]},kc=[qa,Oi,ja,ki],Ic=e=>[Oi,ki].includes(e),Hc=(e,t,r,i)=>{let n=`${e}_${t}`,a=`${r}_${i}`,o=Oc[n];if(o){let s=kc.indexOf(a);return o[s]}return Ic(a)},Dc=(e,t,r,i)=>{let n=`${e}_${t}`;if(Va.includes(e)||Va.includes(n))return!0;let a=Nc[`${r}_${i}`];return a?a.includes(e)||a.includes(n)?!0:P.displayTax:P.displayTax},Bc=async(e,t,r,i)=>{let n=Dc(e,t,r,i);return{displayTax:n,forceTaxExclusive:n?Hc(e,t,r,i):P.forceTaxExclusive}},Pt=class Pt extends HTMLSpanElement{constructor(){super();g(this,"masElement",new Ee(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(r){let i=Y();if(!i)return null;let{displayOldPrice:n,displayPerUnit:a,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:m,promotionCode:h,quantity:p,alternativePrice:u,template:f,wcsOsi:E}=i.collectPriceOptions(r);return tr(Pt,{displayOldPrice:n,displayPerUnit:a,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:m,promotionCode:h,quantity:p,alternativePrice:u,template:f,wcsOsi:E})}get isInlinePrice(){return!0}attributeChangedCallback(r,i,n){this.masElement.attributeChangedCallback(r,i,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===ne}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}async render(r={}){if(!this.isConnected)return!1;let i=Y();if(!i)return!1;let n=i.collectPriceOptions(r,this),a={...i.settings,...n};if(!a.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let[s]=await i.resolveOfferSelectors(a),c=xt(await s,a),[l]=c;if(i.featureFlags[ye]){if(n.displayPerUnit===void 0&&(a.displayPerUnit=l.customerSegment!=="INDIVIDUAL"),n.displayTax===void 0||n.forceTaxExclusive===void 0){let{country:d,language:m}=a,[h=""]=l.marketSegments,p=await Bc(d,m,l.customerSegment,h);n.displayTax===void 0&&(a.displayTax=p?.displayTax||a.displayTax),n.forceTaxExclusive===void 0&&(a.forceTaxExclusive=p?.forceTaxExclusive||a.forceTaxExclusive),a.forceTaxExclusive&&(c=xt(c,a))}}else n.displayOldPrice===void 0&&(a.displayOldPrice=!0);return this.renderOffers(c,a,o)}catch(o){throw this.innerHTML="",o}}renderOffers(r,i,n=void 0){if(!this.isConnected)return;let a=Y();if(!a)return!1;if(n??(n=this.masElement.togglePending()),r.length){if(this.masElement.toggleResolved(n,r,i)){this.innerHTML=a.buildPriceHTML(r,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=a.buildPriceHTML(r,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(n,o,this.options))return this.innerHTML="",!0}return!1}};g(Pt,"is","inline-price"),g(Pt,"tag","span");var ue=Pt;window.customElements.get(ue.is)||window.customElements.define(ue.is,ue,{extends:ue.tag});function Wa({literals:e,providers:t,settings:r}){function i(o,s=null){let c={country:r.country,language:r.language,locale:r.locale,literals:{...e.price}};if(s&&t?.price)for(let N of t.price)N(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:m,displayTax:h,displayPlanType:p,forceTaxExclusive:u,perpetual:f,displayAnnual:E,promotionCode:C,quantity:y,alternativePrice:x,wcsOsi:T,..._}=Object.assign(c,s?.dataset??{},o??{});return c=Wt(Object.assign({...c,..._,displayOldPrice:v(l),displayPerUnit:v(d),displayRecurrence:v(m),displayTax:v(h),displayPlanType:v(p),forceTaxExclusive:v(u),perpetual:v(f),displayAnnual:v(E),promotionCode:Xt(C).effectivePromoCode,quantity:Ke(y,P.quantity),alternativePrice:v(x),wcsOsi:Zt(T)})),c}function n(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=za;break;case"strikethrough":l=Ia;break;case"annual":l=Ha;break;case"legal":l=$a;break;default:s.template==="optical"&&s.alternativePrice?l=Da:s.template==="optical"?l=ka:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode?Fa:Ua:s.alternativePrice?l=Ba:l=s.promotionCode?Oa:Na}let[d]=o;return d={...d,...d.priceDetails},l({...r,...s},d)}let a=ue.createInlinePrice;return{InlinePrice:ue,buildPriceHTML:n,collectPriceOptions:i,createInlinePrice:a}}function Uc({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||P.language),t??(t=e?.split("_")?.[1]||P.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function Ya(e={},t){let r=t.featureFlags[ye],{commerce:i={}}=e,n=le.PRODUCTION,a=Hr,o=k("checkoutClientId",i)??P.checkoutClientId,s=gt(k("checkoutWorkflowStep",i),j,P.checkoutWorkflowStep),c=P.displayOldPrice,l=P.displayPerUnit,d=v(k("displayRecurrence",i),P.displayRecurrence),m=v(k("displayTax",i),P.displayTax),h=v(k("displayPlanType",i),P.displayPlanType),p=v(k("entitlement",i),P.entitlement),u=v(k("modal",i),P.modal),f=v(k("forceTaxExclusive",i),P.forceTaxExclusive),E=k("promotionCode",i)??P.promotionCode,C=Ke(k("quantity",i)),y=k("wcsApiKey",i)??P.wcsApiKey,x=i?.env==="stage",T=ve.PUBLISHED;["true",""].includes(i.allowOverride)&&(x=(k(kr,i,{metadata:!1})?.toLowerCase()??i?.env)==="stage",T=gt(k(Ir,i),ve,T)),x&&(n=le.STAGE,a=Dr);let N=k(Or)??e.preview,U=typeof N<"u"&&N!=="off"&&N!=="false",q={};U&&(q={preview:U});let F=k("mas-io-url")??e.masIOUrl??`https://www${n===le.STAGE?".stage":""}.adobe.com/mas/io`,R=k("preselect-plan")??void 0;return{...Uc(e),...q,displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:m,displayPlanType:h,entitlement:p,extraOptions:P.extraOptions,modal:u,env:n,forceTaxExclusive:f,promotionCode:E,quantity:C,alternativePrice:P.alternativePrice,wcsApiKey:y,wcsURL:a,landscape:T,masIOUrl:F,...R&&{preselectPlan:R}}}async function Xa(e,t={},r=2,i=100){let n;for(let a=0;a<=r;a++)try{let o=await fetch(e,t);return o.retryCount=a,o}catch(o){if(n=o,n.retryCount=a,a>r)break;await new Promise(s=>setTimeout(s,i*(a+1)))}throw n}var Ii="wcs";function Ka({settings:e}){let t=ie.module(Ii),{env:r,wcsApiKey:i}=e,n=new Map,a=new Map,o,s=new Map;async function c(p,u,f=!0){let E=Y(),C=Lr;t.debug("Fetching:",p);let y="",x;if(p.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let T=new Map(u),[_]=p.offerSelectorIds,N=Date.now()+Math.random().toString(36).substring(2,7),U=`${Ii}:${_}:${N}${Ur}`,q=`${Ii}:${_}:${N}${Fr}`,F;try{if(performance.mark(U),y=new URL(e.wcsURL),y.searchParams.set("offer_selector_ids",_),y.searchParams.set("country",p.country),y.searchParams.set("locale",p.locale),y.searchParams.set("landscape",r===le.STAGE?"ALL":e.landscape),y.searchParams.set("api_key",i),p.language&&y.searchParams.set("language",p.language),p.promotionCode&&y.searchParams.set("promotion_code",p.promotionCode),p.currency&&y.searchParams.set("currency",p.currency),x=await Xa(y.toString(),{credentials:"omit"}),x.ok){let R=[];try{let H=await x.json();t.debug("Fetched:",p,H),R=H.resolvedOffers??[]}catch(H){t.error(`Error parsing JSON: ${H.message}`,{...H.context,...E?.duration})}R=R.map(Kt),u.forEach(({resolve:H},J)=>{let se=R.filter(({offerSelectorIds:ge})=>ge.includes(J)).flat();se.length&&(T.delete(J),u.delete(J),H(se))})}else C=Cr}catch(R){C=`Network error: ${R.message}`}finally{F=performance.measure(q,U),performance.clearMarks(U),performance.clearMeasures(q)}if(f&&u.size){t.debug("Missing:",{offerSelectorIds:[...u.keys()]});let R=wn(x);u.forEach(H=>{H.reject(new Qe(C,{...p,...R,response:x,measure:Bt(F),...E?.duration}))})}}function l(){clearTimeout(o);let p=[...a.values()];a.clear(),p.forEach(({options:u,promises:f})=>c(u,f))}function d(p){if(!p||typeof p!="object")throw new TypeError("Cache must be a Map or similar object");let u=r===le.STAGE?"stage":"prod",f=p[u];if(!f||typeof f!="object"){t.warn(`No cache found for environment: ${r}`);return}for(let[E,C]of Object.entries(f))n.set(E,Promise.resolve(C.map(Kt)));t.debug(`Prefilled WCS cache with ${f.size} entries`)}function m(){let p=n.size;s=new Map(n),n.clear(),t.debug(`Moved ${p} cache entries to stale cache`)}function h({country:p,language:u,perpetual:f=!1,promotionCode:E="",wcsOsi:C=[]}){let y=`${u}_${p}`;p!=="GB"&&!f&&(u="MULT");let x=[p,u,E].filter(T=>T).join("-").toLowerCase();return C.map(T=>{let _=`${T}-${x}`;if(n.has(_))return n.get(_);let N=new Promise((U,q)=>{let F=a.get(x);if(!F){let R={country:p,locale:y,offerSelectorIds:[]};p!=="GB"&&!f&&(R.language=u),F={options:R,promises:new Map},a.set(x,F)}E&&(F.options.promotionCode=E),F.options.offerSelectorIds.push(T),F.promises.set(T,{resolve:U,reject:q}),l()}).catch(U=>{if(s.has(_))return s.get(_);throw U});return n.set(_,N),N})}return{Commitment:Se,PlanType:vn,Term:ee,applyPlanType:Kt,resolveOfferSelectors:h,flushWcsCacheInternal:m,prefillWcsCache:d}}var Qa="mas-commerce-service",Za="mas-commerce-service:start",Ja="mas-commerce-service:ready",Ct,Je,et,eo,to,Hi=class extends HTMLElement{constructor(){super(...arguments);$(this,et);$(this,Ct);$(this,Je);g(this,"lastLoggingTime",0)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(i,n,a)=>{let o=await r?.(i,n,this.imsSignedInPromise,a);return o||null})}get featureFlags(){return S(this,Je)||G(this,Je,{[ye]:Ot(this,et,to).call(this,ye)}),S(this,Je)}activate(){let r=S(this,et,eo),i=Ya(r,this);Jt(r.lana);let n=ie.init(r.hostEnv).module("service");n.debug("Activating:",r);let o={price:ea(i)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:i};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...Qn(c),...Zn(c),...Wa(c),...Ka(c),...Gr,Log:ie,get defaults(){return P},get log(){return ie},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return i}})),n.debug("Activated:",{literals:o,settings:i});let l=new CustomEvent(Dt,{bubbles:!0,cancelable:!1,detail:this});performance.mark(Ja),G(this,Ct,performance.measure(Ja,Za)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(Za),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(xr).forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":Bt(S(this,Ct))}}logFailedRequests(){let r=[...performance.getEntriesByType("resource")].filter(({startTime:n})=>n>this.lastLoggingTime).filter(({transferSize:n,duration:a,responseStatus:o})=>n===0&&a===0&&o<200||o>=400),i=Array.from(new Map(r.map(n=>[n.name,n])).values());if(i.some(({name:n})=>/(\/fragment\?|web_commerce_artifact)/.test(n))){let n=i.map(({name:a})=>a);this.log.error("Failed requests:",{failedUrls:n,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Ct=new WeakMap,Je=new WeakMap,et=new WeakSet,eo=function(){let r=this.getAttribute("env")??"prod",i={commerce:{env:r},hostEnv:{name:r},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:r==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview"].forEach(n=>{let a=this.getAttribute(n);a&&(i[n]=a)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(n=>{let a=this.getAttribute(n);if(a!=null){let o=n.replace(/-([a-z])/g,s=>s[1].toUpperCase());i.commerce[o]=a}}),i},to=function(r){return["on","true",!0].includes(this.getAttribute(`data-${r}`)||k(r))};window.customElements.get(Qa)||window.customElements.define(Qa,Hi);var ao="merch-card-collection",Fc=2e4,$c={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansThreeColumns:["three-merch-cards"]},Gc={plans:!0},zc=(e,{filter:t})=>e.filter(r=>r?.filters&&r?.filters.hasOwnProperty(t)),Vc=(e,{types:t})=>t?(t=t.split(","),e.filter(r=>t.some(i=>r.types.includes(i)))):e,qc=e=>e.sort((t,r)=>(t.title??"").localeCompare(r.title??"","en",{sensitivity:"base"})),jc=(e,{filter:t})=>e.sort((r,i)=>i.filters[t]?.order==null||isNaN(i.filters[t]?.order)?-1:r.filters[t]?.order==null||isNaN(r.filters[t]?.order)?1:r.filters[t].order-i.filters[t].order),Wc=(e,{search:t})=>t?.length?(t=t.toLowerCase(),e.filter(r=>(r.title??"").toLowerCase().includes(t))):e,Ae,rt,Rt,hr,oo,tt=class extends io{constructor(){super();$(this,hr);$(this,Ae,{});$(this,rt);$(this,Rt);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1}render(){return fe`
            <slot></slot>
            ${this.footer}`}checkReady(){if(!this.querySelector("aem-fragment"))return Promise.resolve(!0);let i=new Promise(n=>setTimeout(()=>n(!1),Fc));return Promise.race([this.hydrationReady,i])}updated(r){if(!this.querySelector("merch-card"))return;let i=window.scrollY||document.documentElement.scrollTop,n=[...this.children].filter(l=>l.tagName==="MERCH-CARD");if(n.length===0)return;r.has("singleApp")&&this.singleApp&&n.forEach(l=>{l.updateFilters(l.name===this.singleApp)});let a=this.sort===ae.alphabetical?qc:jc,s=[zc,Vc,Wc,a].reduce((l,d)=>d(l,this),n).map((l,d)=>[l,d]);if(this.resultCount=s.length,this.page&&this.limit){let l=this.page*this.limit;this.hasMore=s.length>l,s=s.filter(([,d])=>d<l)}let c=new Map(s.reverse());for(let l of c.keys())this.prepend(l);n.forEach(l=>{c.has(l)?(l.size=l.filters[this.filter]?.size,l.style.removeProperty("display"),l.requestUpdate()):(l.style.display="none",l.size=void 0)}),window.scrollTo(0,i),this.updateComplete.then(()=>{this.dispatchLiteralsChanged(),this.sidenav&&!this.literalsHandlerAttached&&(this.sidenav.addEventListener(Er,()=>{this.dispatchLiteralsChanged()}),this.literalsHandlerAttached=!0)})}dispatchLiteralsChanged(){this.dispatchEvent(new CustomEvent(ot,{detail:{resultCount:this.resultCount,searchTerm:this.search,filter:this.sidenav?.filters?.selectedText}}))}buildOverrideMap(){G(this,Ae,{}),this.overrides?.split(",").forEach(r=>{let[i,n]=r?.split(":");i&&n&&(S(this,Ae)[i]=n)})}connectedCallback(){super.connectedCallback(),G(this,rt,dt()),S(this,rt)&&G(this,Rt,S(this,rt).Log.module(ao)),this.buildOverrideMap(),this.init()}async init(){await this.hydrate(),this.sidenav=this.parentElement.querySelector("merch-sidenav"),this.filtered?(this.filter=this.filtered,this.page=1):this.startDeeplink(),this.initializePlaceholders()}disconnectedCallback(){super.disconnectedCallback(),this.stopDeeplink?.()}initializeHeader(){let r=document.createElement("merch-card-collection-header");r.collection=this,r.classList.add(this.variant),this.parentElement.insertBefore(r,this),this.header=r,this.querySelectorAll("[placeholder]").forEach(n=>{let a=n.getAttribute("slot");this.header.placeholderKeys.includes(a)&&this.header.append(n)})}initializePlaceholders(){let r=this.data?.placeholders||{};for(let i of Object.keys(r)){let n=r[i],a=n.includes("<p>")?"div":"p",o=document.createElement(a);o.setAttribute("slot",i),o.setAttribute("placeholder",""),o.innerHTML=n,this.append(o)}}attachSidenav(r,i=!0){r&&(i&&this.parentElement.prepend(r),this.sidenav=r,this.sidenav.variant=this.variant,this.sidenav.classList.add(this.variant),Gc[this.variant]&&this.sidenav.setAttribute("autoclose",""),this.initializeHeader(),this.dispatchEvent(new CustomEvent(st)))}async hydrate(){if(this.hydrating)return!1;let r=this.querySelector("aem-fragment");if(!r)return;this.id=r.getAttribute("fragment"),this.hydrating=!0;let i;this.hydrationReady=new Promise(o=>{i=o});let n=this;function a(o,s){let c={cards:[],hierarchy:[],placeholders:o.placeholders};function l(d,m){for(let h of m){if(h.fieldName==="cards"){if(c.cards.findIndex(f=>f.id===h.identifier)!==-1)continue;c.cards.push(o.references[h.identifier].value);continue}let{fields:p}=o.references[h.identifier].value,u={label:p.label||"",icon:p.icon,iconLight:p.iconLight,queryLabel:p.queryLabel,cards:p.cards?p.cards.map(f=>s[f]||f):[],collections:[]};p.defaultchild&&(u.defaultchild=s[p.defaultchild]||p.defaultchild),d.push(u),l(u.collections,h.referencesTree)}}return l(c.hierarchy,o.referencesTree),c.hierarchy.length===0&&(n.filtered="all"),c}r.addEventListener(Ar,o=>{Ot(this,hr,oo).call(this,"Error loading AEM fragment",o.detail),this.hydrating=!1,r.remove()}),r.addEventListener(wr,async o=>{this.data=a(o.detail,S(this,Ae));let{cards:s,hierarchy:c}=this.data,l=c.length===0&&o.detail.fields?.defaultchild?S(this,Ae)[o.detail.fields.defaultchild]||o.detail.fields.defaultchild:null;r.cache.add(...s);let d=(p,u)=>{for(let f of p)if(f.defaultchild===u||f.collections&&d(f.collections,u))return!0;return!1};for(let p of s){let C=function(x){for(let T of x){let _=T.cards.indexOf(f);if(_===-1)continue;let N=T.queryLabel??T?.label?.toLowerCase()??"";u.filters[N]={order:_+1,size:p.fields.size},C(T.collections)}},u=document.createElement("merch-card"),f=S(this,Ae)[p.id]||p.id;u.setAttribute("consonant",""),u.setAttribute("style",""),Ft(p.fields.variant)?.supportsDefaultChild&&(l?f===l:d(c,f))&&u.setAttribute("data-default-card","true"),C(c);let y=document.createElement("aem-fragment");y.setAttribute("fragment",f),u.append(y),Object.keys(u.filters).length===0&&(u.filters={all:{order:s.indexOf(p)+1,size:p.fields.size}}),this.append(u)}let m="",h=Nn(s[0]?.fields?.variant);this.variant=h,h==="plans"&&s.length===3&&!s.some(p=>p.fields?.size?.includes("wide"))&&(m="ThreeColumns"),h&&this.classList.add("merch-card-collection",h,...$c[`${h}${m}`]||[]),this.displayResult=!0,this.hydrating=!1,r.remove(),i(!0)}),await this.hydrationReady}get footer(){if(!this.filtered)return fe`<div id="footer">
        ...
        </sp-button>`}sortChanged(r){r.target.value===ae.authored?at({sort:void 0}):at({sort:r.target.value}),this.dispatchEvent(new CustomEvent(vr,{bubbles:!0,composed:!0,detail:{value:r.target.value}}))}async showMore(){this.dispatchEvent(new CustomEvent(yr,{bubbles:!0,composed:!0}));let r=this.page+1;at({page:r}),this.page=r,await this.updateComplete}startDeeplink(){this.stopDeeplink=zi(({category:r,filter:i,types:n,sort:a,search:o,single_app:s,page:c})=>{i=i||r,!this.filtered&&i&&i!==this.filter&&setTimeout(()=>{at({page:void 0}),this.page=1},1),this.filtered||(this.filter=i??this.filter),this.types=n??"",this.search=o??"",this.singleApp=s,this.sort=a,this.page=Number(c)||1})}openFilters(r){this.sidenav?.showModal(r)}};Ae=new WeakMap,rt=new WeakMap,Rt=new WeakMap,hr=new WeakSet,oo=function(r,i={},n=!0){S(this,Rt).error(`merch-card-collection: ${r}`,i),this.failed=!0,n&&this.dispatchEvent(new CustomEvent(Sr,{detail:{...i,message:r},bubbles:!0,composed:!0}))},g(tt,"properties",{id:{type:String,attribute:"id",reflect:!0},displayResult:{type:Boolean,attribute:"display-result"},filter:{type:String,attribute:"filter",reflect:!0},filtered:{type:String,attribute:"filtered",reflect:!0},hasMore:{type:Boolean},limit:{type:Number,attribute:"limit"},overrides:{type:String},page:{type:Number,attribute:"page",reflect:!0},resultCount:{type:Number},search:{type:String,attribute:"search",reflect:!0},sidenav:{type:Object},singleApp:{type:String,attribute:"single-app",reflect:!0},sort:{type:String,attribute:"sort",default:ae.authored,reflect:!0},types:{type:String,attribute:"types",reflect:!0}}),g(tt,"styles",no`
        #footer {
            grid-column: 1 / -1;
    ...
    `);tt.SortOrder=ae;customElements.define(ao,tt);var Yc={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},Xc=(e,t,r)=>{e.querySelectorAll(`[data-placeholder="${t}"]`).forEach(n=>{n.innerText=r||""})},Kc={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},Qc={catalog:"l"},X,it,Lt=class extends io{constructor(){super();$(this,X);$(this,it);g(this,"tablet",new nt(this,D));g(this,"desktop",new nt(this,L));this.collection=null,G(this,X,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(ot,this.updateLiterals),this.collection?.addEventListener(st,this.handleSidenavAttached),G(this,it,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(ot,this.updateLiterals),this.collection?.removeEventListener(st,this.handleSidenavAttached)}willUpdate(){S(this,X).search=this.getVisibility("search"),S(this,X).filter=this.getVisibility("filter"),S(this,X).sort=this.getVisibility("sort"),S(this,X).result=this.getVisibility("result"),S(this,X).custom=this.getVisibility("custom")}parseVisibilityOptions(r,i){if(!r||!Object.hasOwn(r,i))return null;let n=r[i];return n===!1?!1:n===!0?!0:n.includes(this.currentMedia)}getVisibility(r){let i=S(this,it).getCollectionOptions(this.collection?.variant)?.headerVisibility,n=this.parseVisibilityOptions(i,r);return n!==null?n:this.parseVisibilityOptions(Kc,r)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!S(this,X).search)return oe;let r=lt(this,"searchText");return r?fe`
          ...
          `:oe}get filterAction(){return S(this,X).filter?this.sidenav?fe`
              <sp-action-button
                id="filter"
                variant="secondary"
                treatment="outline"
              ...
              ></sp-action-button>
          `:oe:oe}get sortAction(){if(!S(this,X).sort)return oe;let r=lt(this,"sortText");if(!r)return;let i=lt(this,"popularityText"),n=lt(this,"alphabeticallyText");if(!(i&&n))return;let a=this.collection?.sort===ae.alphabetical;return fe`
              <sp-action-menu
                  id="sort"
                  size="m"
      ...
      `);customElements.define("merch-card-collection-header",Lt);export{tt as MerchCardCollection,Lt as default};
