...
`,De.MISSING_INTL_API,o);var C=r.getPluralRules(t,{type:d.pluralType}).select(m-(d.offset||0));b=d.options[C]||d.options.other}if(!b)throw new Ri(d.value,m,Object.keys(d.options),o);s.push.apply(s,Ct(b.value,t,r,i,n,m-(d.offset||0)));continue}}return Ac(s)}function Tc(e,t){return t?T(T(T({},e||{}),t||{}),Object.keys(e).reduce(function(r,i){return r[i]=T(T({},e[i]),t[i]||{}),r},{})):e}function _c(e,t){return t?Object.keys(e).reduce(function(r,i){return r[i]=Tc(e[i],t[i]),r},T({},e)):e}function Mi(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function Cc(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Tt(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.NumberFormat).bind.apply(t,rr([void 0],r,!1)))},{cache:Mi(e.number),strategy:dr.variadic}),getDateTimeFormat:Tt(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.DateTimeFormat).bind.apply(t,rr([void 0],r,!1)))},{cache:Mi(e.dateTime),strategy:dr.variadic}),getPluralRules:Tt(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.PluralRules).bind.apply(t,rr([void 0],r,!1)))},{cache:Mi(e.pluralRules),strategy:dr.variadic})}}var Pa=function(){function e(t,r,i,n){var a=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=a.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==V.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return Ct(a.ast,a.locales,a.formatters,a.formats,o,void 0,a.message)},this.resolvedOptions=function(){return{locale:a.resolvedLocale.toString()}},this.getAst=function(){return a.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:n?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=_c(e.formats,i),this.formatters=n&&n.formatters||Cc(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=Aa,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var La=Pa;var Ni={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},Pc=vn("ConsonantTemplates/price"),Lc=/<\/?[^>]+(>|$)/g,I={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Se={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Oi="TAX_EXCLUSIVE",Rc=e=>gn(e)?Object.entries(e).filter(([,t])=>Ke(t)||jt(t)||t===!0).reduce((t,[r,i])=>t+` ${r}${i===!0?"":'="'+fn(i)+'"'}`,""):"",B=(e,t,r,i=!1)=>`<span class="${e}${t?"":" "+I.disabled}"${Rc(r)}>${i?$n(t):t??""}</span>`;function Mc(e){e=e.replaceAll("</a>","&lt;/a&gt;");let t=/<a [^>]+(>|$)/g;return e.match(t)?.forEach(i=>{let n=i.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(i,n)}),e}function Nc(e){e=e.replaceAll("&lt;/a&gt;","</a>");let t=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(t)?.forEach(i=>{let n=i.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(i,n)}),e}function ge(e,t,r,i){let n=e[r];if(n==null)return"";let a=n.includes("<"),o=n.includes("<a ");try{n=o?Mc(n):n,n=a?n.replace(Lc,""):n;let s=new La(n,t).format(i);return o?Nc(s):s}catch{return Pc.error("Failed to format literal:",n),""}}function Oc(e,{accessibleLabel:t,altAccessibleLabel:r,currencySymbol:i,decimals:n,decimalsDelimiter:a,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:u},m={}){let p=B(I.currencySymbol,i),h=B(I.currencySpace,o?"&nbsp;":""),f="";return t?f=`<sr-only class="strikethrough-aria-label">${t}</sr-only>`:r&&(f=`<sr-only class="alt-aria-label">${r}</sr-only>`),c&&(f+=p+h),f+=B(I.integer,s),f+=B(I.decimalsDelimiter,a),f+=B(I.decimals,n),c||(f+=h+p),f+=B(I.recurrence,l,null,!0),f+=B(I.unitType,d,null,!0),f+=B(I.taxInclusivity,u,!0),B(e,f,{...m})}var q=({isAlternativePrice:e=!1,displayOptical:t=!1,displayStrikethrough:r=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:a,displayFormatted:o=!0,displayRecurrence:s=!0,displayPerUnit:c=!1,displayTax:l=!1,language:d,literals:u={},quantity:m=1,space:p=!1,isPromoApplied:h=!1}={},{commitment:f,offerSelectorIds:x,formatString:E,price:v,priceWithoutDiscount:b,taxDisplay:C,taxTerm:N,term:R,usePrecision:U,promotion:$}={},Y={})=>{Object.entries({country:a,formatString:E,language:d,price:v}).forEach(([fo,go])=>{if(go==null)throw new Error(`Argument "${fo}" is missing for osi ${x?.toString()}, country ${a}, language ${d}`)});let F={...Ni,...u},H=`${d.toLowerCase()}-${a.toUpperCase()}`,P;$&&!h&&b?P=e?v:b:r&&b?P=b:P=v;let te=t?zn:Vn;i&&(te=qn);let{accessiblePrice:de,recurrenceTerm:ve,...Bi}=te({commitment:f,formatString:E,instant:n,isIndianPrice:a==="IN",originalPrice:v,priceWithoutDiscount:b,price:t?v:P,promotion:$,quantity:m,term:R,usePrecision:U}),mr="",ur="",fr="";w(s)&&ve&&(fr=ge(F,H,Se.recurrenceLabel,{recurrenceTerm:ve}));let kt="";w(c)&&(p&&(kt+=" "),kt+=ge(F,H,Se.perUnitLabel,{perUnit:"LICENSE"}));let It="";w(l)&&N&&(p&&(It+=" "),It+=ge(F,H,C===Oi?Se.taxExclusiveLabel:Se.taxInclusiveLabel,{taxTerm:N})),r&&(mr=ge(F,H,Se.strikethroughAriaLabel,{strikethroughPrice:mr})),e&&(ur=ge(F,H,Se.alternativePriceAriaLabel,{alternativePrice:ur}));let Be=I.container;if(t&&(Be+=" "+I.containerOptical),r&&(Be+=" "+I.containerStrikethrough),e&&(Be+=" "+I.containerAlternative),i&&(Be+=" "+I.containerAnnual),w(o))return Oc(Be,{...Bi,accessibleLabel:mr,altAccessibleLabel:ur,recurrenceLabel:fr,perUnitLabel:kt,taxInclusivityLabel:It},Y);let{currencySymbol:Ui,decimals:lo,decimalsDelimiter:po,hasCurrencySpace:Fi,integer:ho,isCurrencyFirst:mo}=Bi,Ue=[ho,po,lo];mo?(Ue.unshift(Fi?"\xA0":""),Ue.unshift(Ui)):(Ue.push(Fi?"\xA0":""),Ue.push(Ui)),Ue.push(fr,kt,It);let uo=Ue.join("");return B(Be,uo,Y)},Ra=()=>(e,t,r)=>{let i=Ie(t.promotion,t.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),a=(e.displayOldPrice===void 0||w(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price&&(!t.promotion||i);return`${a?q({displayStrikethrough:!0})({isPromoApplied:i,...e},t,r)+"&nbsp;":""}${q({isAlternativePrice:a})({isPromoApplied:i,...e},t,r)}`},Ma=()=>(e,t,r)=>{let{instant:i}=e;try{i||(i=new URLSearchParams(document.location.search).get("instant")),i&&(i=new Date(i))}catch{i=void 0}let n=Ie(t.promotion,i,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),a={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:n};if(!n)return q()(e,{...t,price:t.priceWithoutDiscount},r)+B(I.containerAnnualPrefix,"&nbsp;(")+q({displayAnnual:!0,instant:i})(a,{...t,price:t.priceWithoutDiscount},r)+B(I.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||w(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${s?q({displayStrikethrough:!0})(a,t,r)+"&nbsp;":""}${q({isAlternativePrice:s})({isPromoApplied:n,...e},t,r)}${B(I.containerAnnualPrefix,"&nbsp;(")}${q({displayAnnual:!0,instant:i})(a,t,r)}${B(I.containerAnnualSuffix,")")}`},Na=()=>(e,t,r)=>{let i={...e,displayTax:!1,displayPerUnit:!1};return`${q({isAlternativePrice:e.displayOldPrice})(e,t,r)}${B(I.containerAnnualPrefix,"&nbsp;(")}${q({displayAnnual:!0})(i,t,r)}${B(I.containerAnnualSuffix,")")}`};var Pt={...I,containerLegal:"price-legal",planType:"price-plan-type"},pr={...Se,planTypeLabel:"planTypeLabel"};function kc(e,{perUnitLabel:t,taxInclusivityLabel:r,planTypeLabel:i},n={}){let a="";return a+=B(Pt.unitType,t,null,!0),r&&i&&(r+=". "),a+=B(Pt.taxInclusivity,r,!0),a+=B(Pt.planType,i,null),B(e,a,{...n})}var Oa=({country:e,displayPerUnit:t=!1,displayTax:r=!1,displayPlanType:i=!1,language:n,literals:a={}}={},{taxDisplay:o,taxTerm:s,planType:c}={},l={})=>{let d={...Ni,...a},u=`${n.toLowerCase()}-${e.toUpperCase()}`,m="";w(t)&&(m=ge(d,u,pr.perUnitLabel,{perUnit:"LICENSE"}));let p="";e==="US"&&n==="en"&&(r=!1),w(r)&&s&&(p=ge(d,u,o===Oi?pr.taxExclusiveLabel:pr.taxInclusiveLabel,{taxTerm:s}));let h="";w(i)&&c&&(h=ge(d,u,pr.planTypeLabel,{planType:c}));let f=Pt.container;return f+=" "+Pt.containerLegal,kc(f,{perUnitLabel:m,taxInclusivityLabel:p,planTypeLabel:h},l)};var ka=q(),Ia=Ra(),Ha=q({displayOptical:!0}),Da=q({displayStrikethrough:!0}),Ba=q({displayAnnual:!0}),Ua=q({displayOptical:!0,isAlternativePrice:!0}),Fa=q({isAlternativePrice:!0}),$a=Na(),Ga=Ma(),za=Oa;var Ic=(e,t)=>{if(!(!xt(e)||!xt(t)))return Math.floor((t-e)/t*100)},Va=()=>(e,t)=>{let{price:r,priceWithoutDiscount:i}=t,n=Ic(r,i);return n===void 0?'<span class="no-discount"></span>':`<span class="discount">${n}%</span>`};var qa=Va();var Ya="INDIVIDUAL_COM",ki="TEAM_COM",Wa="INDIVIDUAL_EDU",Ii="TEAM_EDU",ja=["GB_en","AU_en","FR_fr","AT_de","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","GR_el","GR_en","HU_hu","IE_en","IT_it","LU_de","LU_en","LU_fr","NL_nl","NO_nb","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TR_tr","UA_uk","ID_en","ID_in","IN_en","IN_hi","JP_ja","MY_en","MY_ms","NZ_en","TH_en","TH_th"],Hc={[Ya]:["MU_en","LT_lt","LV_lv","NG_en","SA_ar","SA_en","SG_en","KR_ko"],[ki]:["MU_en","LT_lt","LV_lv","NG_en","CO_es","KR_ko"],[Wa]:["LT_lt","LV_lv","SA_en","SG_en"],[Ii]:["SG_en","KR_ko"]},Dc={MU_en:[!1,!1,!1,!1],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],CO_es:[!1,!0,!1,!1],AT_de:[!1,!1,!1,!0],SG_en:[!1,!1,!1,!0]},Bc=[Ya,ki,Wa,Ii],Uc=e=>[ki,Ii].includes(e),Fc=(e,t,r,i)=>{let n=`${e}_${t}`,a=`${r}_${i}`,o=Dc[n];if(o){let s=Bc.indexOf(a);return o[s]}return Uc(a)},$c=(e,t,r,i)=>{let n=`${e}_${t}`;if(ja.includes(e)||ja.includes(n))return!0;let a=Hc[`${r}_${i}`];return a?a.includes(e)||a.includes(n)?!0:A.displayTax:A.displayTax},Gc=async(e,t,r,i)=>{let n=$c(e,t,r,i);return{displayTax:n,forceTaxExclusive:n?Fc(e,t,r,i):A.forceTaxExclusive}},Lt=class Lt extends HTMLSpanElement{constructor(){super();g(this,"masElement",new Ae(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(r){let i=K();if(!i)return null;let{displayOldPrice:n,displayPerUnit:a,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:u,promotionCode:m,quantity:p,alternativePrice:h,template:f,wcsOsi:x}=i.collectPriceOptions(r);return tr(Lt,{displayOldPrice:n,displayPerUnit:a,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:u,promotionCode:m,quantity:p,alternativePrice:h,template:f,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(r,i,n){this.masElement.attributeChangedCallback(r,i,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===se}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}async render(r={}){if(!this.isConnected)return!1;let i=K();if(!i)return!1;let n=i.collectPriceOptions(r,this),a={...i.settings,...n};if(!a.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let[s]=await i.resolveOfferSelectors(a),c=vt(await s,a),[l]=c;if(i.featureFlags[ue]||a[ue]){if(n.displayPerUnit===void 0&&(a.displayPerUnit=l.customerSegment!=="INDIVIDUAL"),n.displayTax===void 0||n.forceTaxExclusive===void 0){let{country:d,language:u}=a,[m=""]=l.marketSegments,p=await Gc(d,u,l.customerSegment,m);n.displayTax===void 0&&(a.displayTax=p?.displayTax||a.displayTax),n.forceTaxExclusive===void 0&&(a.forceTaxExclusive=p?.forceTaxExclusive||a.forceTaxExclusive),a.forceTaxExclusive&&(c=vt(c,a))}}else n.displayOldPrice===void 0&&(a.displayOldPrice=!0);return this.renderOffers(c,a,o)}catch(o){throw this.innerHTML="",o}}renderOffers(r,i,n=void 0){if(!this.isConnected)return;let a=K();if(!a)return!1;if(n??(n=this.masElement.togglePending()),r.length){if(this.masElement.toggleResolved(n,r,i)){this.innerHTML=a.buildPriceHTML(r,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=a.buildPriceHTML(r,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(n,o,this.options))return this.innerHTML="",!0}return!1}};g(Lt,"is","inline-price"),g(Lt,"tag","span");var xe=Lt;window.customElements.get(xe.is)||window.customElements.define(xe.is,xe,{extends:xe.tag});function Xa({literals:e,providers:t,settings:r}){function i(o,s=null){let c={country:r.country,language:r.language,locale:r.locale,literals:{...e.price}};if(s&&t?.price)for(let R of t.price)R(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:u,displayTax:m,displayPlanType:p,forceTaxExclusive:h,perpetual:f,displayAnnual:x,promotionCode:E,quantity:v,alternativePrice:b,wcsOsi:C,...N}=Object.assign(c,s?.dataset??{},o??{});return c=Yt(Object.assign({...c,...N,displayOldPrice:w(l),displayPerUnit:w(d),displayRecurrence:w(u),displayTax:w(m),displayPlanType:w(p),forceTaxExclusive:w(h),perpetual:w(f),displayAnnual:w(x),promotionCode:Xt(E).effectivePromoCode,quantity:Qe(v,A.quantity),alternativePrice:w(b),wcsOsi:Zt(C)})),c}function n(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=qa;break;case"strikethrough":l=Da;break;case"annual":l=Ba;break;case"legal":l=za;break;default:s.template==="optical"&&s.alternativePrice?l=Ua:s.template==="optical"?l=Ha:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode?Ga:$a:s.alternativePrice?l=Fa:l=s.promotionCode?Ia:ka}let[d]=o;return d={...d,...d.priceDetails},l({...r,...s},d)}let a=xe.createInlinePrice;return{InlinePrice:xe,buildPriceHTML:n,collectPriceOptions:i,createInlinePrice:a}}function zc({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||A.language),t??(t=e?.split("_")?.[1]||A.country),e??(e=dt.includes(`${r}_${t}`)?`${r}_${t}`:`${A.language}_${A.country}`),{locale:e,country:t,language:r}}function Ka(e={},t){let r=t.featureFlags[ue],{commerce:i={}}=e,n=he.PRODUCTION,a=Hr,o=k("checkoutClientId",i)??A.checkoutClientId,s=bt(k("checkoutWorkflowStep",i),W,A.checkoutWorkflowStep),c=A.displayOldPrice,l=A.displayPerUnit,d=w(k("displayRecurrence",i),A.displayRecurrence),u=w(k("displayTax",i),A.displayTax),m=w(k("displayPlanType",i),A.displayPlanType),p=w(k("entitlement",i),A.entitlement),h=w(k("modal",i),A.modal),f=w(k("forceTaxExclusive",i),A.forceTaxExclusive),x=k("promotionCode",i)??A.promotionCode,E=Qe(k("quantity",i)),v=k("wcsApiKey",i)??A.wcsApiKey,b=i?.env==="stage",C=we.PUBLISHED;["true",""].includes(i.allowOverride)&&(b=(k(kr,i,{metadata:!1})?.toLowerCase()??i?.env)==="stage",C=bt(k(Ir,i),we,C)),b&&(n=he.STAGE,a=Dr);let R=k(Or)??e.preview,U=typeof R<"u"&&R!=="off"&&R!=="false",$={};U&&($={preview:U});let Y=k("mas-io-url")??e.masIOUrl??`https://www${n===he.STAGE?".stage":""}.adobe.com/mas/io`,F=k("preselect-plan")??void 0;return{...zc(e),...$,displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:u,displayPlanType:m,entitlement:p,extraOptions:A.extraOptions,modal:h,env:n,forceTaxExclusive:f,promotionCode:x,quantity:E,alternativePrice:A.alternativePrice,wcsApiKey:v,wcsURL:a,landscape:C,masIOUrl:Y,...F&&{preselectPlan:F}}}async function Qa(e,t={},r=2,i=100){let n;for(let a=0;a<=r;a++)try{let o=await fetch(e,t);return o.retryCount=a,o}catch(o){if(n=o,n.retryCount=a,a>r)break;await new Promise(s=>setTimeout(s,i*(a+1)))}throw n}var Hi="wcs";function Za({settings:e}){let t=oe.module(Hi),{env:r,wcsApiKey:i}=e,n=new Map,a=new Map,o,s=new Map;async function c(h,f,x=!0){let E=K(),v=Lr;t.debug("Fetching:",h);let b="",C;if(h.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let N=new Map(f),[R]=h.offerSelectorIds,U=Date.now()+Math.random().toString(36).substring(2,7),$=`${Hi}:${R}:${U}${Ur}`,Y=`${Hi}:${R}:${U}${Fr}`,F;try{if(performance.mark($),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",R),b.searchParams.set("country",h.country),b.searchParams.set("locale",h.locale),b.searchParams.set("landscape",r===he.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",i),h.language&&b.searchParams.set("language",h.language),h.promotionCode&&b.searchParams.set("promotion_code",h.promotionCode),h.currency&&b.searchParams.set("currency",h.currency),C=await Qa(b.toString(),{credentials:"omit"}),C.ok){let H=[];try{let P=await C.json();t.debug("Fetched:",h,P),H=P.resolvedOffers??[]}catch(P){t.error(`Error parsing JSON: ${P.message}`,{...P.context,...E?.duration})}H=H.map(Kt),f.forEach(({resolve:P},te)=>{let de=H.filter(({offerSelectorIds:ve})=>ve.includes(te)).flat();de.length&&(N.delete(te),f.delete(te),P(de))})}else v=Pr}catch(H){v=`Network error: ${H.message}`}finally{F=performance.measure(Y,$),performance.clearMarks($),performance.clearMeasures(Y)}if(x&&f.size){t.debug("Missing:",{offerSelectorIds:[...f.keys()]});let H=Sn(C);f.forEach(P=>{P.reject(new Ze(v,{...h,...H,response:C,measure:Bt(F),...E?.duration}))})}}function l(){clearTimeout(o);let h=[...a.values()];a.clear(),h.forEach(({options:f,promises:x})=>c(f,x))}function d(h){if(!h||typeof h!="object")throw new TypeError("Cache must be a Map or similar object");let f=r===he.STAGE?"stage":"prod",x=h[f];if(!x||typeof x!="object"){t.warn(`No cache found for environment: ${r}`);return}for(let[E,v]of Object.entries(x))n.set(E,Promise.resolve(v.map(Kt)));t.debug(`Prefilled WCS cache with ${x.size} entries`)}function u(){let h=n.size;s=new Map(n),n.clear(),t.debug(`Moved ${h} cache entries to stale cache`)}function m(h,f,x){let E=h!=="GB"&&!x?"MULT":"en",v=Gr.includes(h)?h:A.country;return{validCountry:v,validLanguage:E,validLocale:dt.includes(`${f}_${v}`)?`${f}_${v}`:`${A.language}_${A.country}`}}function p({country:h,language:f,perpetual:x=!1,promotionCode:E="",wcsOsi:v=[]}){let{validCountry:b,validLanguage:C,validLocale:N}=m(h,f,x),R=[b,C,E].filter(U=>U).join("-").toLowerCase();return v.map(U=>{let $=`${U}-${R}`;if(n.has($))return n.get($);let Y=new Promise((F,H)=>{let P=a.get(R);P||(P={options:{country:b,locale:N,...h!=="GB"&&!x&&{language:C},offerSelectorIds:[]},promises:new Map},a.set(R,P)),E&&(P.options.promotionCode=E),P.options.offerSelectorIds.push(U),P.promises.set(U,{resolve:F,reject:H}),l()}).catch(F=>{if(s.has($))return s.get($);throw F});return n.set($,Y),Y})}return{Commitment:_e,PlanType:En,Term:ie,applyPlanType:Kt,resolveOfferSelectors:p,flushWcsCacheInternal:u,prefillWcsCache:d,normalizeCountryLanguageAndLocale:m}}var Ja="mas-commerce-service",eo="mas-commerce-service:start",to="mas-commerce-service:ready",Rt,et,tt,ro,io,Di=class extends HTMLElement{constructor(){super(...arguments);G(this,tt);G(this,Rt);G(this,et);g(this,"lastLoggingTime",0)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(i,n,a)=>{let o=await r?.(i,n,this.imsSignedInPromise,a);return o||null})}get featureFlags(){return S(this,et)||z(this,et,{[ue]:Ht(this,tt,io).call(this,ue)}),S(this,et)}activate(){let r=S(this,tt,ro),i=Ka(r,this);Jt(r.lana);let n=oe.init(r.hostEnv).module("service");n.debug("Activating:",r);let o={price:ra(i)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:i};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...Jn(c),...ea(c),...Xa(c),...Za(c),...zr,Log:oe,get defaults(){return A},get log(){return oe},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return i}})),n.debug("Activated:",{literals:o,settings:i});let l=new CustomEvent(Dt,{bubbles:!0,cancelable:!1,detail:this});performance.mark(to),z(this,Rt,performance.measure(to,eo)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(eo),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(xr).forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":Bt(S(this,Rt))}}logFailedRequests(){let r=[...performance.getEntriesByType("resource")].filter(({startTime:n})=>n>this.lastLoggingTime).filter(({transferSize:n,duration:a,responseStatus:o})=>n===0&&a===0&&o<200||o>=400),i=Array.from(new Map(r.map(n=>[n.name,n])).values());if(i.some(({name:n})=>/(\/fragment\?|web_commerce_artifact)/.test(n))){let n=i.map(({name:a})=>a);this.log.error("Failed requests:",{failedUrls:n,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Rt=new WeakMap,et=new WeakMap,tt=new WeakSet,ro=function(){let r=this.getAttribute("env")??"prod",i={commerce:{env:r},hostEnv:{name:r},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:r==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview"].forEach(n=>{let a=this.getAttribute(n);a&&(i[n]=a)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(n=>{let a=this.getAttribute(n);if(a!=null){let o=n.replace(/-([a-z])/g,s=>s[1].toUpperCase());i.commerce[o]=a}}),i},io=function(r){return["on","true",!0].includes(this.getAttribute(`data-${r}`)||k(r))};window.customElements.get(Ja)||window.customElements.define(Ja,Di);var so="merch-card-collection",Vc=2e4,qc={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansThreeColumns:["three-merch-cards"]},jc={plans:!0},Yc=(e,{filter:t})=>e.filter(r=>r?.filters&&r?.filters.hasOwnProperty(t)),Wc=(e,{types:t})=>t?(t=t.split(","),e.filter(r=>t.some(i=>r.types.includes(i)))):e,Xc=e=>e.sort((t,r)=>(t.title??"").localeCompare(r.title??"","en",{sensitivity:"base"})),Kc=(e,{filter:t})=>e.sort((r,i)=>i.filters[t]?.order==null||isNaN(i.filters[t]?.order)?-1:r.filters[t]?.order==null||isNaN(r.filters[t]?.order)?1:r.filters[t].order-i.filters[t].order),Qc=(e,{search:t})=>t?.length?(t=t.toLowerCase(),e.filter(r=>(r.title??"").toLowerCase().includes(t))):e,Te,it,Nt,Ot,hr,co,rt=class extends ao{constructor(){super();G(this,hr);G(this,Te,{});G(this,it);G(this,Nt);G(this,Ot);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[]}render(){return be`
    ...
    `);rt.SortOrder=ce;customElements.define(so,rt);var Zc={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},Jc=(e,t,r)=>{e.querySelectorAll(`[data-placeholder="${t}"]`).forEach(n=>{n.innerText=r||""})},el={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},tl={catalog:"l"},Q,nt,Mt=class extends ao{constructor(){super();G(this,Q);G(this,nt);g(this,"tablet",new ot(this,D));g(this,"desktop",new ot(this,L));this.collection=null,z(this,Q,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(ye,this.updateLiterals),this.collection?.addEventListener(ct,this.handleSidenavAttached),z(this,nt,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(ye,this.updateLiterals),this.collection?.removeEventListener(ct,this.handleSidenavAttached)}willUpdate(){S(this,Q).search=this.getVisibility("search"),S(this,Q).filter=this.getVisibility("filter"),S(this,Q).sort=this.getVisibility("sort"),S(this,Q).result=this.getVisibility("result"),S(this,Q).custom=this.getVisibility("custom")}parseVisibilityOptions(r,i){if(!r||!Object.hasOwn(r,i))return null;let n=r[i];return n===!1?!1:n===!0?!0:n.includes(this.currentMedia)}getVisibility(r){let i=S(this,nt)?.getCollectionOptions(this.collection?.variant)?.headerVisibility,n=this.parseVisibilityOptions(i,r);return n!==null?n:this.parseVisibilityOptions(el,r)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!S(this,Q).search)return le;let r=pt(this,"searchText");return r?be`
          ...
          `:le}get filterAction(){return S(this,Q).filter?this.sidenav?be`
              <sp-action-button
                id="filter"
                variant="secondary"
                treatment="outline"
              ...
              ></sp-action-button>
          `:le:le}get sortAction(){if(!S(this,Q).sort)return le;let r=pt(this,"sortText");if(!r)return;let i=pt(this,"popularityText"),n=pt(this,"alphabeticallyText");if(!(i&&n))return;let a=this.collection?.sort===ce.alphabetical;return be`
              <sp-action-menu
                  id="sort"
                  size="m"
          ...
          `}get resultSlotName(){let r=`${this.search?"search":"filters"}${this.isMobile||this.isTablet?"Mobile":""}`;return Zc[r][Math.min(this.resultCount,2)]}get resultLabel(){if(!S(this,Q).result)return le;if(!this.sidenav)return le;let r=this.search?"search":"filter",i=this.resultCount?this.resultCount===1?"single":"multiple":"none";return be`
            <div id="result" aria-live="polite" type=${r} quantity=${i}>
                <slot name="${this.resultSlotName}"></slot>
            </div>`}get customArea(){if(!S(this,Q).custom)return le;let r=S(this,nt)?.getCollectionOptions(this.collection?.variant)?.customHeaderArea;if(!r)return le;let i=r(this.collection);return!i||i===le?le:be`<div id="custom" role="heading" aria-level="2">${i}</div>`}openFilters(r){this.sidenav.showModal(r)}updateLiterals(r){Object.keys(r.detail).forEach(i=>{Jc(this,i,r.detail[i])}),this.requestUpdate()}handleSidenavAttached(){this.requestUpdate()}render(){return be`
            <sp-theme color="light" scale="medium">
