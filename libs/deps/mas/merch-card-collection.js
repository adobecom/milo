...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return Bi}setAriaExpanded(r,i){r.setAttribute("aria-expanded",i)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};g(Oe,"variantStyle",Mo`
...
`;var Ot=class extends I{constructor(t){super(t)}getGlobalCSS(){return Fi}renderLayout(){return tt`${this.cardImage}
    <div class="body">
...
`;var It=class extends I{constructor(t){super(t)}getGlobalCSS(){return Gi}renderLayout(){return $i` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":$i`<hr />`} ${this.secureLabelFooter}`}};import{html as Ie,css as No,unsafeCSS as Dr}from"../lit-all.min.js";var zi=`
  :root {
...
`;var Oo=32,He=class extends I{constructor(r){super(r);g(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);g(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?Ie`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(r=>r.onceSettled())),await this.adjustAddon(),Pt()?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};g(He,"variantStyle",No`
  ...
  `);import{html as rt,css as Io,nothing as Ht}from"../lit-all.min.js";var Vi=`
:root {
...
`;var kt={title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ji={...function(){let{whatsIncluded:e,size:t,...r}=kt;return r}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Yi={...function(){let{subtitle:e,whatsIncluded:t,size:r,quantitySelect:i,...n}=kt;return n}()},Y=class extends I{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,r){t.dataset.template===Ir&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Vi}adjustSlotPlacement(t,r,i){let n=this.card.shadowRoot,a=n.querySelector("footer"),o=this.card.getAttribute("size"),s=n.querySelector(`footer slot[name="${t}"]`),l=n.querySelector(`.body slot[name="${t}"]`),c=n.querySelector(".body");if((!o||!o.includes("wide"))&&(a?.classList.remove("wide-footer"),s&&s.remove()),!!r.includes(o)){if(a?.classList.toggle("wide-footer",Ct()),!i&&s){if(l)s.remove();else{let h=c.querySelector(`[data-placeholder-for="${t}"]`);h?h.replaceWith(s):c.appendChild(s)}return}if(i&&l){let h=document.createElement("div");if(h.setAttribute("data-placeholder-for",t),h.classList.add("slot-placeholder"),!s){let m=l.cloneNode(!0);a.prepend(m)}l.replaceWith(h)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],Ct()),this.adjustSlotPlacement("callout-content",["super-wide"],Ct())}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==t?t.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==t?t.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustLegal(),this.adjustAddon(),this.adjustCallout()}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${ie}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?rt`<div class="divider"></div>`:Ht}async adjustLegal(){if(await this.card.updateComplete,await customElements.whenDefined("inline-price"),this.legalAdjusted)return;this.legalAdjusted=!0;let t=[],r=this.card.querySelector(`[slot="heading-m"] ${ie}[data-template="price"]`);r&&t.push(r);let i=t.map(async n=>{let a=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),n.parentNode.insertBefore(a,n.nextSibling))});await Promise.all(i)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled();let i=r.value?.[0]?.planType;i&&(t.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?rt`<label id="stock-checkbox">
    ...
    `),g(Y,"collectionOptions",{customHeaderArea:t=>t.sidenav?rt`<slot name="resultsText"></slot>`:Ht,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]}});import{html as Br,css as Ho}from"../lit-all.min.js";var qi=`
:root {
...
`;var ke=class extends I{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return qi}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return Br` ${this.badge}
    ...
    `);import{html as Ur,css as ko}from"../lit-all.min.js";var Wi=`
:root {
...
`;var De=class extends I{constructor(t){super(t)}getGlobalCSS(){return Wi}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Ur` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var Ki={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Be=class extends I{constructor(t){super(t)}getGlobalCSS(){return Xi}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return Fr`${this.cardImage}
            <div class="body">
...
`,_e.MISSING_INTL_API,o);var T=r.getPluralRules(t,{type:h.pluralType}).select(p-(h.offset||0));E=h.options[T]||h.options.other}if(!E)throw new Ei(h.value,p,Object.keys(h.options),o);s.push.apply(s,ut(E.value,t,r,i,n,p-(h.offset||0)));continue}}return Qs(s)}function Js(e,t){return t?S(S(S({},e||{}),t||{}),Object.keys(e).reduce(function(r,i){return r[i]=S(S({},e[i]),t[i]||{}),r},{})):e}function ec(e,t){return t?Object.keys(e).reduce(function(r,i){return r[i]=Js(e[i],t[i]),r},S({},e)):e}function yi(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function tc(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:pt(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.NumberFormat).bind.apply(t,Xt([void 0],r,!1)))},{cache:yi(e.number),strategy:ir.variadic}),getDateTimeFormat:pt(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.DateTimeFormat).bind.apply(t,Xt([void 0],r,!1)))},{cache:yi(e.dateTime),strategy:ir.variadic}),getPluralRules:pt(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.PluralRules).bind.apply(t,Xt([void 0],r,!1)))},{cache:yi(e.pluralRules),strategy:ir.variadic})}}var oa=function(){function e(t,r,i,n){var a=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=a.formatToParts(o);if(s.length===1)return s[0].value;var l=s.reduce(function(c,h){return!c.length||h.type!==G.literal||typeof c[c.length-1]!="string"?c.push(h.value):c[c.length-1]+=h.value,c},[]);return l.length<=1?l[0]||"":l},this.formatToParts=function(o){return ut(a.ast,a.locales,a.formatters,a.formats,o,void 0,a.message)},this.resolvedOptions=function(){return{locale:a.resolvedLocale.toString()}},this.getAst=function(){return a.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:n?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=ec(e.formats,i),this.formatters=n&&n.formatters||tc(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=ta,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var sa=oa;var rc=/[0-9\-+#]/,ic=/[^\d\-+#]/g;function ca(e){return e.search(rc)}function nc(e="#.##"){let t={},r=e.length,i=ca(e);t.prefix=i>0?e.substring(0,i):"";let n=ca(e.split("").reverse().join("")),a=r-n,o=e.substring(a,a+1),s=a+(o==="."||o===","?1:0);t.suffix=n>0?e.substring(s,r):"",t.mask=e.substring(i,s),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let l=t.mask.match(ic);return t.decimal=l&&l[l.length-1]||".",t.separator=l&&l[1]&&l[0]||",",l=t.mask.split(t.decimal),t.integer=l[0],t.fraction=l[1],t}function ac(e,t,r){let i=!1,n={value:e};e<0&&(i=!0,n.value=-n.value),n.sign=i?"-":"",n.value=Number(n.value).toFixed(t.fraction&&t.fraction.length),n.value=Number(n.value).toString();let a=t.fraction&&t.fraction.lastIndexOf("0"),[o="0",s=""]=n.value.split(".");return(!s||s&&s.length<=a)&&(s=a<0?"":(+("0."+s)).toFixed(a+1).replace("0.","")),n.integer=o,n.fraction=s,oc(n,t),(n.result==="0"||n.result==="")&&(i=!1,n.sign=""),!i&&t.maskHasPositiveSign?n.sign="+":i&&t.maskHasPositiveSign?n.sign="-":i&&(n.sign=r&&r.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),n}function oc(e,t){e.result="";let r=t.integer.split(t.separator),i=r.join(""),n=i&&i.indexOf("0");if(n>-1)for(;e.integer.length<i.length-n;)e.integer="0"+e.integer;else Number(e.integer)===0&&(e.integer="");let a=r[1]&&r[r.length-1].length;if(a){let o=e.integer.length,s=o%a;for(let l=0;l<o;l++)e.result+=e.integer.charAt(l),!((l-s+1)%a)&&l<o-a&&(e.result+=t.separator)}else e.result=e.integer;return e.result+=t.fraction&&e.fraction?t.decimal+e.fraction:"",e}function sc(e,t,r={}){if(!e||isNaN(Number(t)))return t;let i=nc(e),n=ac(t,i,r);return i.prefix+n.sign+n.result+i.suffix}var la=sc;var ha=".",cc=",",pa=/^\s+/,ma=/\s+$/,da="&nbsp;",Si=e=>e*12,ua=(e,t)=>{let{start:r,end:i,displaySummary:{amount:n,duration:a,minProductQuantity:o,outcomeType:s}={}}=e;if(!(n&&a&&s&&o))return!1;let l=t?new Date(t):new Date;if(!r||!i)return!1;let c=new Date(r),h=new Date(i);return l>=c&&l<=h},Pe={MONTH:"MONTH",YEAR:"YEAR"},lc={[J.ANNUAL]:12,[J.MONTHLY]:1,[J.THREE_YEARS]:36,[J.TWO_YEARS]:24},Ai=(e,t)=>({accept:e,round:t}),hc=[Ai(({divisor:e,price:t})=>t%e==0,({divisor:e,price:t})=>t/e),Ai(({usePrecision:e})=>e,({divisor:e,price:t})=>Math.round(t/e*100)/100),Ai(()=>!0,({divisor:e,price:t})=>Math.ceil(Math.floor(t*100/e)/100))],Ti={[ye.YEAR]:{[J.MONTHLY]:Pe.MONTH,[J.ANNUAL]:Pe.YEAR},[ye.MONTH]:{[J.MONTHLY]:Pe.MONTH}},dc=(e,t)=>e.indexOf(`'${t}'`)===0,pc=(e,t=!0)=>{let r=e.replace(/'.*?'/,"").trim(),i=ga(r);return!!i?t||(r=r.replace(/[,\.]0+/,i)):r=r.replace(/\s?(#.*0)(?!\s)?/,"$&"+uc(e)),r},mc=e=>{let t=fc(e),r=dc(e,t),i=e.replace(/'.*?'/,""),n=pa.test(i)||ma.test(i);return{currencySymbol:t,isCurrencyFirst:r,hasCurrencySpace:n}},fa=e=>e.replace(pa,da).replace(ma,da),uc=e=>e.match(/#(.?)#/)?.[1]===ha?cc:ha,fc=e=>e.match(/'(.*?)'/)?.[1]??"",ga=e=>e.match(/0(.?)0/)?.[1]??"";function je({formatString:e,price:t,usePrecision:r,isIndianPrice:i=!1},n,a=o=>o){let{currencySymbol:o,isCurrencyFirst:s,hasCurrencySpace:l}=mc(e),c=r?ga(e):"",h=pc(e,r),m=r?2:0,p=a(t,{currencySymbol:o}),d=i?p.toLocaleString("hi-IN",{minimumFractionDigits:m,maximumFractionDigits:m}):la(h,p),u=r?d.lastIndexOf(c):d.length,f=d.substring(0,u),v=d.substring(u+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,d).replace(/SYMBOL/,o),currencySymbol:o,decimals:v,decimalsDelimiter:c,hasCurrencySpace:l,integer:f,isCurrencyFirst:s,recurrenceTerm:n}}var xa=e=>{let{commitment:t,term:r,usePrecision:i}=e,n=lc[r]??1;return je(e,n>1?Pe.MONTH:Ti[t]?.[r],a=>{let o={divisor:n,price:a,usePrecision:i},{round:s}=hc.find(({accept:l})=>l(o));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(o)}`);return s(o)})},ba=({commitment:e,term:t,...r})=>je(r,Ti[e]?.[t]),va=e=>{let{commitment:t,instant:r,price:i,originalPrice:n,priceWithoutDiscount:a,promotion:o,quantity:s=1,term:l}=e;if(t===ye.YEAR&&l===J.MONTHLY){if(!o)return je(e,Pe.YEAR,Si);let{displaySummary:{outcomeType:c,duration:h,minProductQuantity:m=1}={}}=o;switch(c){case"PERCENTAGE_DISCOUNT":if(s>=m&&ua(o,r)){let p=parseInt(h.replace("P","").replace("M",""));if(isNaN(p))return Si(i);let d=s*n*p,u=s*a*(12-p),f=Math.round((d+u)*100)/100;return je({...e,price:f},Pe.YEAR)}default:return je(e,Pe.YEAR,()=>Si(a??i))}}return je(e,Ti[t]?.[l])};var wi={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},gc=hn("ConsonantTemplates/price"),xc=/<\/?[^>]+(>|$)/g,D={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},ve={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},_i="TAX_EXCLUSIVE",bc=e=>sn(e)?Object.entries(e).filter(([,t])=>Ge(t)||Bt(t)||t===!0).reduce((t,[r,i])=>t+` ${r}${i===!0?"":'="'+on(i)+'"'}`,""):"",U=(e,t,r,i=!1)=>`<span class="${e}${t?"":" "+D.disabled}"${bc(r)}>${i?fa(t):t??""}</span>`;function de(e,t,r,i){let n=e[r];if(n==null)return"";try{return new sa(n.replace(xc,""),t).format(i)}catch{return gc.error("Failed to format literal:",n),""}}function vc(e,{accessibleLabel:t,altAccessibleLabel:r,currencySymbol:i,decimals:n,decimalsDelimiter:a,hasCurrencySpace:o,integer:s,isCurrencyFirst:l,recurrenceLabel:c,perUnitLabel:h,taxInclusivityLabel:m},p={}){let d=U(D.currencySymbol,i),u=U(D.currencySpace,o?"&nbsp;":""),f="";return t?f=`<sr-only class="strikethrough-aria-label">${t}</sr-only>`:r&&(f=`<sr-only class="alt-aria-label">${r}</sr-only>`),l&&(f+=d+u),f+=U(D.integer,s),f+=U(D.decimalsDelimiter,a),f+=U(D.decimals,n),l||(f+=u+d),f+=U(D.recurrence,c,null,!0),f+=U(D.unitType,h,null,!0),f+=U(D.taxInclusivity,m,!0),U(e,f,{...p})}var q=({isAlternativePrice:e=!1,displayOptical:t=!1,displayStrikethrough:r=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:a,displayFormatted:o=!0,displayRecurrence:s=!0,displayPerUnit:l=!1,displayTax:c=!1,language:h,literals:m={},quantity:p=1,space:d=!1}={},{commitment:u,offerSelectorIds:f,formatString:v,price:_,priceWithoutDiscount:y,taxDisplay:E,taxTerm:T,term:P,usePrecision:O,promotion:B}={},z={})=>{Object.entries({country:a,formatString:v,language:h,price:_}).forEach(([io,no])=>{if(no==null)throw new Error(`Argument "${io}" is missing for osi ${f?.toString()}, country ${a}, language ${h}`)});let H={...wi,...m},R=`${h.toLowerCase()}-${a.toUpperCase()}`,F=r&&y?y:_,Q=t?xa:ba;i&&(Q=va);let{accessiblePrice:ue,recurrenceTerm:se,...Ce}=Q({commitment:u,formatString:v,instant:n,isIndianPrice:a==="IN",originalPrice:_,priceWithoutDiscount:y,price:t?_:F,promotion:B,quantity:p,term:P,usePrecision:O}),or="",sr="",cr="";x(s)&&se&&(cr=de(H,R,ve.recurrenceLabel,{recurrenceTerm:se}));let yt="";x(l)&&(d&&(yt+=" "),yt+=de(H,R,ve.perUnitLabel,{perUnit:"LICENSE"}));let St="";x(c)&&T&&(d&&(St+=" "),St+=de(H,R,E===_i?ve.taxExclusiveLabel:ve.taxInclusiveLabel,{taxTerm:T})),r&&(or=de(H,R,ve.strikethroughAriaLabel,{strikethroughPrice:or})),e&&(sr=de(H,R,ve.alternativePriceAriaLabel,{alternativePrice:sr}));let Le=D.container;if(t&&(Le+=" "+D.containerOptical),r&&(Le+=" "+D.containerStrikethrough),e&&(Le+=" "+D.containerAlternative),i&&(Le+=" "+D.containerAnnual),x(o))return vc(Le,{...Ce,accessibleLabel:or,altAccessibleLabel:sr,recurrenceLabel:cr,perUnitLabel:yt,taxInclusivityLabel:St},z);let{currencySymbol:Mi,decimals:Za,decimalsDelimiter:Ja,hasCurrencySpace:Ni,integer:eo,isCurrencyFirst:to}=Ce,Re=[eo,Ja,Za];to?(Re.unshift(Ni?"\xA0":""),Re.unshift(Mi)):(Re.push(Ni?"\xA0":""),Re.push(Mi)),Re.push(cr,yt,St);let ro=Re.join("");return U(Le,ro,z)},Ea=()=>(e,t,r)=>{let n=(e.displayOldPrice===void 0||x(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${n?q({displayStrikethrough:!0})(e,t,r)+"&nbsp;":""}${q({isAlternativePrice:n})(e,t,r)}`},ya=()=>(e,t,r)=>{let{instant:i}=e;try{i||(i=new URLSearchParams(document.location.search).get("instant")),i&&(i=new Date(i))}catch{i=void 0}let n={...e,displayTax:!1,displayPerUnit:!1},o=(e.displayOldPrice===void 0||x(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${o?q({displayStrikethrough:!0})(n,t,r)+"&nbsp;":""}${q({isAlternativePrice:o})(e,t,r)}${U(D.containerAnnualPrefix,"&nbsp;(")}${q({displayAnnual:!0,instant:i})(n,t,r)}${U(D.containerAnnualSuffix,")")}`},Sa=()=>(e,t,r)=>{let i={...e,displayTax:!1,displayPerUnit:!1};return`${q({isAlternativePrice:e.displayOldPrice})(e,t,r)}${U(D.containerAnnualPrefix,"&nbsp;(")}${q({displayAnnual:!0})(i,t,r)}${U(D.containerAnnualSuffix,")")}`};var ft={...D,containerLegal:"price-legal",planType:"price-plan-type"},nr={...ve,planTypeLabel:"planTypeLabel"};function Ec(e,{perUnitLabel:t,taxInclusivityLabel:r,planTypeLabel:i},n={}){let a="";return a+=U(ft.unitType,t,null,!0),r&&i&&(r+=". "),a+=U(ft.taxInclusivity,r,!0),a+=U(ft.planType,i,null),U(e,a,{...n})}var Aa=({country:e,displayPerUnit:t=!1,displayTax:r=!1,displayPlanType:i=!1,language:n,literals:a={}}={},{taxDisplay:o,taxTerm:s,planType:l}={},c={})=>{let h={...wi,...a},m=`${n.toLowerCase()}-${e.toUpperCase()}`,p="";x(t)&&(p=de(h,m,nr.perUnitLabel,{perUnit:"LICENSE"}));let d="";e==="US"&&n==="en"&&(r=!1),x(r)&&s&&(d=de(h,m,o===_i?nr.taxExclusiveLabel:nr.taxInclusiveLabel,{taxTerm:s}));let u="";x(i)&&l&&(u=de(h,m,nr.planTypeLabel,{planType:l}));let f=ft.container;return f+=" "+ft.containerLegal,Ec(f,{perUnitLabel:p,taxInclusivityLabel:d,planTypeLabel:u},c)};var Ta=q(),wa=Ea(),_a=q({displayOptical:!0}),Pa=q({displayStrikethrough:!0}),Ca=q({displayAnnual:!0}),La=q({displayOptical:!0,isAlternativePrice:!0}),Ra=q({isAlternativePrice:!0}),Ma=Sa(),Na=ya(),Oa=Aa;var yc=(e,t)=>{if(!(!nt(e)||!nt(t)))return Math.floor((t-e)/t*100)},Ia=()=>(e,t)=>{let{price:r,priceWithoutDiscount:i}=t,n=yc(r,i);return n===void 0?'<span class="no-discount"></span>':`<span class="discount">${n}%</span>`};var Ha=Ia();var Da="INDIVIDUAL_COM",Pi="TEAM_COM",Ba="INDIVIDUAL_EDU",Ci="TEAM_EDU",ka=["GB_en","AU_en","FR_fr","AT_de","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","GR_el","GR_en","HU_hu","IE_en","IT_it","LU_de","LU_en","LU_fr","NL_nl","NO_nb","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TR_tr","UA_uk","ID_en","ID_in","IN_en","IN_hi","JP_ja","MY_en","MY_ms","NZ_en","TH_en","TH_th"],Sc={[Da]:["MU_en","LT_lt","LV_lv","NG_en","SA_ar","SA_en","SG_en","KR_ko"],[Pi]:["MU_en","LT_lt","LV_lv","NG_en","CO_es","KR_ko"],[Ba]:["LT_lt","LV_lv","SA_en","SG_en"],[Ci]:["SG_en","KR_ko"]},Ac={MU_en:[!1,!1,!1,!1],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],CO_es:[!1,!0,!1,!1],AT_de:[!1,!1,!1,!0],SG_en:[!1,!1,!1,!0]},Tc=[Da,Pi,Ba,Ci],wc=e=>[Pi,Ci].includes(e),_c=(e,t,r,i)=>{let n=`${e}_${t}`,a=`${r}_${i}`,o=Ac[n];if(o){let s=Tc.indexOf(a);return o[s]}return wc(a)},Pc=(e,t,r,i)=>{let n=`${e}_${t}`;if(ka.includes(e)||ka.includes(n))return!0;let a=Sc[`${r}_${i}`];return a?a.includes(e)||a.includes(n)?!0:w.displayTax:w.displayTax},Cc=async(e,t,r,i)=>{let n=Pc(e,t,r,i);return{displayTax:n,forceTaxExclusive:n?_c(e,t,r,i):w.forceTaxExclusive}},gt=class gt extends HTMLSpanElement{constructor(){super();g(this,"masElement",new Ve(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi"]}static createInlinePrice(r){let i=$();if(!i)return null;let{displayOldPrice:n,displayPerUnit:a,displayRecurrence:o,displayTax:s,displayPlanType:l,displayAnnual:c,forceTaxExclusive:h,perpetual:m,promotionCode:p,quantity:d,alternativePrice:u,template:f,wcsOsi:v}=i.collectPriceOptions(r);return qt(gt,{displayOldPrice:n,displayPerUnit:a,displayRecurrence:o,displayTax:s,displayPlanType:l,displayAnnual:c,forceTaxExclusive:h,perpetual:m,promotionCode:p,quantity:d,alternativePrice:u,template:f,wcsOsi:v})}get isInlinePrice(){return!0}attributeChangedCallback(r,i,n){this.masElement.attributeChangedCallback(r,i,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===ne}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}async render(r={}){if(!this.isConnected)return!1;let i=$();if(!i)return!1;let n=i.collectPriceOptions(r,this),a={...i.settings,...n};if(!a.wcsOsi.length)return!1;if(i.featureFlags[be]&&(n.displayTax===void 0||n.forceTaxExclusive===void 0)){let[l]=await i.resolveOfferSelectors(a),c=ot(await l,a);if(c?.length){let{country:h,language:m}=a,p=c[0],[d=""]=p.marketSegments,u=await Cc(h,m,p.customerSegment,d);n.displayTax===void 0&&(a.displayTax=u?.displayTax||a.displayTax),n.forceTaxExclusive===void 0&&(a.forceTaxExclusive=u?.forceTaxExclusive||a.forceTaxExclusive)}}let o=this.masElement.togglePending(a);this.innerHTML="";let[s]=i.resolveOfferSelectors(a);try{let l=await s;return this.renderOffers(ot(l,a),o)}catch(l){throw this.innerHTML="",l}}renderOffers(r,i=void 0){if(!this.isConnected)return;let n=$();if(!n)return!1;if(i??(i=this.masElement.togglePending()),r.length){if(this.masElement.toggleResolved(i,r)){this.innerHTML=n.buildPriceHTML(r,this.options);let a=this.closest("p, h3, div");if(!a||!a.querySelector('span[data-template="strikethrough"]')||a.querySelector(".alt-aria-label"))return!0;let o=a?.querySelectorAll('span[is="inline-price"]');return o.length>1&&o.length===a.querySelectorAll('span[data-template="strikethrough"]').length*2&&o.forEach(s=>{s.dataset.template!=="strikethrough"&&s.options&&!s.options.alternativePrice&&!s.isFailed&&(s.options.alternativePrice=!0,s.innerHTML=n.buildPriceHTML(r,s.options))}),!0}}else{let a=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,a,this.options))return this.innerHTML="",!0}return!1}updateOptions(r){let i=$();if(!i)return!1;let{alternativePrice:n,displayOldPrice:a,displayPerUnit:o,displayRecurrence:s,displayTax:l,forceTaxExclusive:c,perpetual:h,promotionCode:m,quantity:p,template:d,wcsOsi:u}=i.collectPriceOptions(r);return Wt(this,{alternativePrice:n,displayOldPrice:a,displayPerUnit:o,displayRecurrence:s,displayTax:l,forceTaxExclusive:c,perpetual:h,promotionCode:m,quantity:p,template:d,wcsOsi:u}),!0}};g(gt,"is","inline-price"),g(gt,"tag","span");var pe=gt;window.customElements.get(pe.is)||window.customElements.define(pe.is,pe,{extends:pe.tag});function Ua({literals:e,providers:t,settings:r}){function i(o,s=null){let l={country:r.country,language:r.language,locale:r.locale,literals:structuredClone(e.price)};if(s&&t?.price)for(let O of t.price)O(s,l);let{displayOldPrice:c,displayPerUnit:h,displayRecurrence:m,displayTax:p,displayPlanType:d,forceTaxExclusive:u,perpetual:f,displayAnnual:v,promotionCode:_,quantity:y,alternativePrice:E,wcsOsi:T,...P}=Object.assign(l,s?.dataset??{},o??{});return l=Ut(Object.assign({...l,...P,displayOldPrice:x(c),displayPerUnit:x(h),displayRecurrence:x(m),displayTax:x(p),displayPlanType:x(d),forceTaxExclusive:x(u),perpetual:x(f),displayAnnual:x(v),promotionCode:Gt(_).effectivePromoCode,quantity:$e(y,w.quantity),alternativePrice:x(E),wcsOsi:Vt(T)})),l}function n(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:l}=s,c;switch(l){case"discount":c=Ha;break;case"strikethrough":c=Pa;break;case"annual":c=Ca;break;case"legal":c=Oa;break;default:s.template==="optical"&&s.alternativePrice?c=La:s.template==="optical"?c=_a:s.displayAnnual&&o[0].planType==="ABM"?c=s.promotionCode?Na:Ma:s.alternativePrice?c=Ra:c=s.promotionCode?wa:Ta}let[h]=o;return h={...h,...h.priceDetails},c({...r,...s},h)}let a=pe.createInlinePrice;return{InlinePrice:pe,buildPriceHTML:n,collectPriceOptions:i,createInlinePrice:a}}function Lc({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||w.language),t??(t=e?.split("_")?.[1]||w.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function Fa(e={},t){let r=t.featureFlags[be],{commerce:i={}}=e,n=ce.PRODUCTION,a=Lr,o=M("checkoutClientId",i)??w.checkoutClientId,s=at(M("checkoutWorkflowStep",i),j,w.checkoutWorkflowStep),l=x(M("displayOldPrice",i),r?w.displayOldPrice:!w.displayOldPrice),c=x(M("displayPerUnit",i),r?w.displayPerUnit:!w.displayPerUnit),h=x(M("displayRecurrence",i),w.displayRecurrence),m=x(M("displayTax",i),w.displayTax),p=x(M("displayPlanType",i),w.displayPlanType),d=x(M("entitlement",i),w.entitlement),u=x(M("modal",i),w.modal),f=x(M("forceTaxExclusive",i),w.forceTaxExclusive),v=M("promotionCode",i)??w.promotionCode,_=$e(M("quantity",i)),y=M("wcsApiKey",i)??w.wcsApiKey,E=i?.env==="stage",T=xe.PUBLISHED;["true",""].includes(i.allowOverride)&&(E=(M(Pr,i,{metadata:!1})?.toLowerCase()??i?.env)==="stage",T=at(M(Cr,i),xe,T)),E&&(n=ce.STAGE,a=Rr);let O=M(_r)??e.preview,B=typeof O<"u"&&O!=="off"&&O!=="false",z={};B&&(z={preview:B});let H=M("mas-io-url")??e.masIOUrl??`https://www${n===ce.STAGE?".stage":""}.adobe.com/mas/io`,R=M("preselect-plan")??void 0;return{...Lc(e),...z,displayOldPrice:l,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:c,displayRecurrence:h,displayTax:m,displayPlanType:p,entitlement:d,extraOptions:w.extraOptions,modal:u,env:n,forceTaxExclusive:f,promotionCode:v,quantity:_,alternativePrice:w.alternativePrice,wcsApiKey:y,wcsURL:a,landscape:T,masIOUrl:H,...R&&{preselectPlan:R}}}async function Ga(e,t={},r=2,i=100){let n;for(let a=0;a<=r;a++)try{let o=await fetch(e,t);return o.retryCount=a,o}catch(o){if(n=o,n.retryCount=a,a>r)break;await new Promise(s=>setTimeout(s,i*(a+1)))}throw n}var Li="wcs";function $a({settings:e}){let t=re.module(Li),{env:r,wcsApiKey:i}=e,n=new Map,a=new Map,o,s=new Map;async function l(d,u,f=!0){let v=$(),_=Sr;t.debug("Fetching:",d);let y="",E;if(d.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let T=new Map(u),[P]=d.offerSelectorIds,O=Date.now()+Math.random().toString(36).substring(2,7),B=`${Li}:${P}:${O}${Nr}`,z=`${Li}:${P}:${O}${Or}`,H;try{if(performance.mark(B),y=new URL(e.wcsURL),y.searchParams.set("offer_selector_ids",P),y.searchParams.set("country",d.country),y.searchParams.set("locale",d.locale),y.searchParams.set("landscape",r===ce.STAGE?"ALL":e.landscape),y.searchParams.set("api_key",i),d.language&&y.searchParams.set("language",d.language),d.promotionCode&&y.searchParams.set("promotion_code",d.promotionCode),d.currency&&y.searchParams.set("currency",d.currency),E=await Ga(y.toString(),{credentials:"omit"}),E.ok){let R=[];try{let F=await E.json();t.debug("Fetched:",d,F),R=F.resolvedOffers??[]}catch(F){t.error(`Error parsing JSON: ${F.message}`,{...F.context,...v?.duration})}R=R.map($t),u.forEach(({resolve:F},Q)=>{let ue=R.filter(({offerSelectorIds:se})=>se.includes(Q)).flat();ue.length&&(T.delete(Q),u.delete(Q),F(ue))})}else _=yr}catch(R){_=`Network error: ${R.message}`}finally{H=performance.measure(z,B),performance.clearMarks(B),performance.clearMeasures(z)}if(f&&u.size){t.debug("Missing:",{offerSelectorIds:[...u.keys()]});let R=fn(E);u.forEach(F=>{F.reject(new ze(_,{...d,...R,response:E,measure:Nt(H),...v?.duration}))})}}function c(){clearTimeout(o);let d=[...a.values()];a.clear(),d.forEach(({options:u,promises:f})=>l(u,f))}function h(d){if(!d||typeof d!="object")throw new TypeError("Cache must be a Map or similar object");let u=r===ce.STAGE?"stage":"prod",f=d[u];if(!f||typeof f!="object"){t.warn(`No cache found for environment: ${r}`);return}for(let[v,_]of Object.entries(f))n.set(v,Promise.resolve(_.map($t)));t.debug(`Prefilled WCS cache with ${f.size} entries`)}function m(){let d=n.size;s=new Map(n),n.clear(),t.debug(`Moved ${d} cache entries to stale cache`)}function p({country:d,language:u,perpetual:f=!1,promotionCode:v="",wcsOsi:_=[]}){let y=`${u}_${d}`;d!=="GB"&&!f&&(u="MULT");let E=[d,u,v].filter(T=>T).join("-").toLowerCase();return _.map(T=>{let P=`${T}-${E}`;if(n.has(P))return n.get(P);let O=new Promise((B,z)=>{let H=a.get(E);if(!H){let R={country:d,locale:y,offerSelectorIds:[]};d!=="GB"&&!f&&(R.language=u),H={options:R,promises:new Map},a.set(E,H)}v&&(H.options.promotionCode=v),H.options.offerSelectorIds.push(T),H.promises.set(T,{resolve:B,reject:z}),c()}).catch(B=>{if(s.has(P))return s.get(P);throw B});return n.set(P,O),O})}return{Commitment:ye,PlanType:pn,Term:J,applyPlanType:$t,resolveOfferSelectors:p,flushWcsCacheInternal:m,prefillWcsCache:h}}var za="mas-commerce-service",Va="mas-commerce-service:start",ja="mas-commerce-service:ready",xt,Ye,qe,Ya,qa,Ri=class extends HTMLElement{constructor(){super(...arguments);V(this,qe);V(this,xt);V(this,Ye);g(this,"lastLoggingTime",0)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(i,n,a)=>{let o=await r?.(i,n,this.imsSignedInPromise,a);return o||null})}get featureFlags(){return C(this,Ye)||Z(this,Ye,{[be]:At(this,qe,qa).call(this,be)}),C(this,Ye)}activate(){let r=C(this,qe,Ya),i=Fa(r,this);jt(r.lana);let n=re.init(r.hostEnv).module("service");n.debug("Activating:",r);let o={price:In(i)},s={checkout:new Set,price:new Set},l={literals:o,providers:s,settings:i};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...Mn(l),...Nn(l),...Ua(l),...$a(l),...Hr,Log:re,get defaults(){return w},get log(){return re},get providers(){return{checkout(h){return s.checkout.add(h),()=>s.checkout.delete(h)},price(h){return s.price.add(h),()=>s.price.delete(h)},has:h=>s.price.has(h)||s.checkout.has(h)}},get settings(){return i}})),n.debug("Activated:",{literals:o,settings:i});let c=new CustomEvent(Mt,{bubbles:!0,cancelable:!1,detail:this});performance.mark(ja),Z(this,xt,performance.measure(ja,Va)),this.dispatchEvent(c),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(Va),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(hr).forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":Nt(C(this,xt))}}logFailedRequests(){let r=[...performance.getEntriesByType("resource")].filter(({startTime:n})=>n>this.lastLoggingTime).filter(({transferSize:n,duration:a,responseStatus:o})=>n===0&&a===0&&o<200||o>=400),i=Array.from(new Map(r.map(n=>[n.name,n])).values());if(i.some(({name:n})=>/(\/fragment\?|web_commerce_artifact)/.test(n))){let n=i.map(({name:a})=>a);this.log.error("Failed requests:",{failedUrls:n,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};xt=new WeakMap,Ye=new WeakMap,qe=new WeakSet,Ya=function(){let r=this.getAttribute("env")??"prod",i={commerce:{env:r},hostEnv:{name:r},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:r==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview"].forEach(n=>{let a=this.getAttribute(n);a&&(i[n]=a)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(n=>{let a=this.getAttribute(n);if(a!=null){let o=n.replace(/-([a-z])/g,s=>s[1].toUpperCase());i.commerce[o]=a}}),i},qa=function(r){return["on","true",!0].includes(this.getAttribute(`data-${r}`)||M(r))};window.customElements.get(za)||window.customElements.define(za,Ri);var Ka="merch-card-collection",Mc=2e4,Nc={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansThreeColumns:["three-merch-cards"]},Oc={plans:!0},Ic=(e,{filter:t})=>e.filter(r=>r.filters.hasOwnProperty(t)),Hc=(e,{types:t})=>t?(t=t.split(","),e.filter(r=>t.some(i=>r.types.includes(i)))):e,kc=e=>e.sort((t,r)=>(t.title??"").localeCompare(r.title??"","en",{sensitivity:"base"})),Dc=(e,{filter:t})=>e.sort((r,i)=>i.filters[t]?.order==null||isNaN(i.filters[t]?.order)?-1:r.filters[t]?.order==null||isNaN(r.filters[t]?.order)?1:r.filters[t].order-i.filters[t].order),Bc=(e,{search:t})=>t?.length?(t=t.toLowerCase(),e.filter(r=>(r.title??"").toLowerCase().includes(t))):e,Ee,vt,Et,ar,Qa,We=class extends Xa{constructor(){super();V(this,ar);V(this,Ee,{});V(this,vt);V(this,Et);this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1}render(){return me`
      ...
      `);customElements.define("merch-card-collection-header",bt);export{We as MerchCardCollection,bt as default};
