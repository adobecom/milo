var Rn=Object.defineProperty;var Nn=e=>{throw TypeError(e)};var ro=(e,t,r)=>t in e?Rn(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var no=(e,t)=>{for(var r in t)Rn(e,r,{get:t[r],enumerable:!0})};var g=(e,t,r)=>ro(e,typeof t!="symbol"?t+"":t,r),or=(e,t,r)=>t.has(e)||Nn("Cannot "+r);var C=(e,t,r)=>(or(e,t,"read from private field"),r?r.call(e):t.get(e)),z=(e,t,r)=>t.has(e)?Nn("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),Z=(e,t,r,n)=>(or(e,t,"write to private field"),n?n.call(e,r):t.set(e,r),r),At=(e,t,r)=>(or(e,t,"access private method"),r);import{html as ue,LitElement as qi,css as _c,unsafeCSS as ji,nothing as oe}from"../lit-all.min.js";var X="(max-width: 767px)",_t="(max-width: 1199px)",H="(min-width: 768px)",M="(min-width: 1200px)",fe="(min-width: 1600px)";function wt(){return window.matchMedia(X)}function Pt(){return window.matchMedia(M)}function Ct(){return wt().matches}function Lt(){return Pt().matches}var Ke=class{constructor(t,r){this.key=Symbol("match-media-key"),this.matches=!1,this.host=t,this.host.addController(this),this.media=window.matchMedia(r),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),t.addController(this)}hostConnected(){var t;(t=this.media)==null||t.addEventListener("change",this.onChange)}hostDisconnected(){var t;(t=this.media)==null||t.removeEventListener("change",this.onChange)}onChange(t){this.matches!==t.matches&&(this.matches=t.matches,this.host.requestUpdate(this.key,!this.matches))}};import{html as Rt,nothing as ao}from"../lit-all.min.js";var Ne,Qe=class Qe{constructor(t){g(this,"card");z(this,Ne);this.card=t,this.insertVariantStyle()}getContainer(){return Z(this,Ne,C(this,Ne)??this.card.closest('[class*="-merch-cards"]')??this.card.parentElement),C(this,Ne)}insertVariantStyle(){if(!Qe.styleMap[this.card.variant]){Qe.styleMap[this.card.variant]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(t,r){if(!t)return;let n=`--consonant-merch-card-${this.card.variant}-${r}-height`,a=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),i=parseInt(this.getContainer().style.getPropertyValue(n))||0;a>i&&this.getContainer().style.setProperty(n,`${a}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Rt`
            <div
                id="badge"
        ...
        `}get cardImage(){return Rt` <div class="image">
            ...
            >`:ao}get secureLabelFooter(){return Rt`<footer>${this.secureLabel}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){return Mn(this.card.variant)}};Ne=new WeakMap,g(Qe,"styleMap",{});var D=Qe;import{html as Or,css as Co}from"../lit-all.min.js";var Mr={};no(Mr,{CLASS_NAME_FAILED:()=>fr,CLASS_NAME_HIDDEN:()=>oo,CLASS_NAME_PENDING:()=>gr,CLASS_NAME_RESOLVED:()=>xr,CheckoutWorkflow:()=>To,CheckoutWorkflowStep:()=>j,Commitment:()=>Se,ERROR_MESSAGE_BAD_REQUEST:()=>Er,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>bo,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>vr,EVENT_AEM_ERROR:()=>ur,EVENT_AEM_LOAD:()=>mr,EVENT_MAS_ERROR:()=>pr,EVENT_MAS_READY:()=>vo,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>xo,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>cr,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>Ze,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>hr,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>Je,EVENT_MERCH_CARD_COLLECTION_SORT:()=>lr,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>go,EVENT_MERCH_OFFER_READY:()=>lo,EVENT_MERCH_OFFER_SELECT_READY:()=>ho,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>fo,EVENT_MERCH_SEARCH_CHANGE:()=>Eo,EVENT_MERCH_SIDENAV_SELECT:()=>dr,EVENT_MERCH_STOCK_CHANGE:()=>uo,EVENT_MERCH_STORAGE_CHANGE:()=>po,EVENT_OFFER_SELECTED:()=>mo,EVENT_TYPE_FAILED:()=>br,EVENT_TYPE_READY:()=>Nt,EVENT_TYPE_RESOLVED:()=>yr,Env:()=>ce,FF_DEFAULTS:()=>ve,HEADER_X_REQUEST_ID:()=>et,LOG_NAMESPACE:()=>Sr,Landscape:()=>xe,MARK_DURATION_SUFFIX:()=>Rr,MARK_START_SUFFIX:()=>Lr,MODAL_TYPE_3_IN_1:()=>Ee,NAMESPACE:()=>io,PARAM_AOS_API_KEY:()=>yo,PARAM_ENV:()=>Ar,PARAM_LANDSCAPE:()=>_r,PARAM_MAS_PREVIEW:()=>Tr,PARAM_WCS_API_KEY:()=>So,PROVIDER_ENVIRONMENT:()=>Cr,SELECTOR_MAS_CHECKOUT_LINK:()=>On,SELECTOR_MAS_ELEMENT:()=>sr,SELECTOR_MAS_INLINE_PRICE:()=>re,SELECTOR_MAS_SP_BUTTON:()=>co,SELECTOR_MAS_UPT_LINK:()=>In,SORT_ORDER:()=>ae,STATE_FAILED:()=>ne,STATE_PENDING:()=>ge,STATE_RESOLVED:()=>le,TAG_NAME_SERVICE:()=>so,TEMPLATE_PRICE:()=>Ao,TEMPLATE_PRICE_ANNUAL:()=>wo,TEMPLATE_PRICE_LEGAL:()=>Nr,TEMPLATE_PRICE_STRIKETHROUGH:()=>_o,Term:()=>J,WCS_PROD_URL:()=>wr,WCS_STAGE_URL:()=>Pr});var Se=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),J=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),io="merch",oo="hidden",Nt="wcms:commerce:ready",so="mas-commerce-service",re='span[is="inline-price"][data-wcs-osi]',On='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',co="sp-button[data-wcs-osi]",In='a[is="upt-link"]',sr=`${re},${On},${In}`,lo="merch-offer:ready",ho="merch-offer-select:ready",cr="merch-card:action-menu-toggle",mo="merch-offer:selected",uo="merch-stock:change",po="merch-storage:change",fo="merch-quantity-selector:change",go="merch-card-quantity:change",xo="merch-modal:addon-and-quantity-update",Eo="merch-search:change",lr="merch-card-collection:sort",Ze="merch-card-collection:literals-changed",Je="merch-card-collection:sidenav-attached",hr="merch-card-collection:showmore",dr="merch-sidenav:select",mr="aem:load",ur="aem:error",vo="mas:ready",pr="mas:error",fr="placeholder-failed",gr="placeholder-pending",xr="placeholder-resolved",Er="Bad WCS request",vr="Commerce offer not found",bo="Literals URL not provided",br="mas:failed",yr="mas:resolved",Sr="mas/commerce",Tr="mas.preview",Ar="commerce.env",_r="commerce.landscape",yo="commerce.aosKey",So="commerce.wcsKey",wr="https://www.adobe.com/web_commerce_artifact",Pr="https://www.stage.adobe.com/web_commerce_artifact_stage",ne="failed",ge="pending",le="resolved",xe={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},et="X-Request-Id",j=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),To="UCv3",ce=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),Cr={PRODUCTION:"PRODUCTION"},Ee={TWP:"twp",D2P:"d2p",CRM:"crm"},Lr=":start",Rr=":duration",Ao="price",_o="price-strikethrough",wo="annual",Nr="legal",ve="mas-ff-defaults",ae={alphabetical:"alphabetical",authored:"authored"};var Po="mas-commerce-service";var tt=(e,t)=>e?.querySelector(`[slot="${t}"]`)?.textContent?.trim();function Me(e,t={},r=null,n=null){let a=n?document.createElement(e,{is:n}):document.createElement(e);r instanceof HTMLElement?a.appendChild(r):a.innerHTML=r;for(let[i,o]of Object.entries(t))a.setAttribute(i,o);return a}function Mt(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function Hn(){return window.matchMedia("(max-width: 1024px)").matches}function Dn(){return document.getElementsByTagName(Po)?.[0]}var kn=`
:root {
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return kn}setAriaExpanded(r,n){r.setAttribute("aria-expanded",n)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};g(Oe,"variantStyle",Co`
    ...
    `);import{html as rt}from"../lit-all.min.js";var Bn=`
:root {
...
`;var Ot=class extends D{constructor(t){super(t)}getGlobalCSS(){return Bn}renderLayout(){return rt`${this.cardImage}
    <div class="body">
...
`;var It=class extends D{constructor(t){super(t)}getGlobalCSS(){return Fn}renderLayout(){return Gn` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":Gn`<hr />`} ${this.secureLabelFooter}`}};import{html as Ie,css as Lo,unsafeCSS as Ir}from"../lit-all.min.js";var $n=`
  :root {
...
`;var Ro=32,He=class extends D{constructor(r){super(r);g(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);g(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?Ie`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(r=>r.onceSettled())),await this.adjustAddon(),Ct()?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};g(He,"variantStyle",Lo`
  ...
  `);import{html as nt,css as No,nothing as Ht}from"../lit-all.min.js";var Vn=`
:root {
...
`;var Dt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},zn={...function(){let{whatsIncluded:e,size:t,...r}=Dt;return r}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},jn={...function(){let{subtitle:e,whatsIncluded:t,size:r,quantitySelect:n,...a}=Dt;return a}()},q=class extends D{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,r){t.dataset.template===Nr&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Vn}adjustSlotPlacement(t,r,n){let a=this.card.shadowRoot,i=a.querySelector("footer"),o=this.card.getAttribute("size"),s=a.querySelector(`footer slot[name="${t}"]`),l=a.querySelector(`.body slot[name="${t}"]`),c=a.querySelector(".body");if((!o||!o.includes("wide"))&&(i?.classList.remove("wide-footer"),s&&s.remove()),!!r.includes(o)){if(i?.classList.toggle("wide-footer",Lt()),!n&&s){if(l)s.remove();else{let h=c.querySelector(`[data-placeholder-for="${t}"]`);h?h.replaceWith(s):c.appendChild(s)}return}if(n&&l){let h=document.createElement("div");if(h.setAttribute("data-placeholder-for",t),h.classList.add("slot-placeholder"),!s){let u=l.cloneNode(!0);i.prepend(u)}l.replaceWith(h)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],Lt()),this.adjustSlotPlacement("callout-content",["super-wide"],Lt())}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==t?t.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==t?t.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustLegal(),this.adjustAddon(),this.adjustCallout()}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${re}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?nt`<div class="divider"></div>`:Ht}async adjustLegal(){if(await this.card.updateComplete,await customElements.whenDefined("inline-price"),this.legalAdjusted)return;this.legalAdjusted=!0;let t=[],r=this.card.querySelector(`[slot="heading-m"] ${re}[data-template="price"]`);r&&t.push(r);let n=t.map(async a=>{let i=a.cloneNode(!0);await a.onceSettled(),a?.options&&(a.options.displayPerUnit&&(a.dataset.displayPerUnit="false"),a.options.displayTax&&(a.dataset.displayTax="false"),a.options.displayPlanType&&(a.dataset.displayPlanType="false"),i.setAttribute("data-template","legal"),a.parentNode.insertBefore(i,a.nextSibling))});await Promise.all(n)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let r=this.mainPrice;if(!r)return;await r.onceSettled();let n=r.value?.[0]?.planType;n&&(t.planType=n)}get stockCheckbox(){return this.card.checkboxLabel?nt`<label id="stock-checkbox">
    ...
    `),g(q,"collectionOptions",{customHeaderArea:t=>t.sidenav?nt`<slot name="resultsText"></slot>`:Ht,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]}});import{html as Hr,css as Mo}from"../lit-all.min.js";var qn=`
:root {
...
`;var De=class extends D{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return qn}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return Hr` ${this.badge}
    ...
    `);import{html as Dr,css as Oo}from"../lit-all.min.js";var Yn=`
:root {
...
`;var ke=class extends D{constructor(t){super(t)}getGlobalCSS(){return Yn}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Dr` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
    ...
    <hr />
    ${this.secureLabelFooter}`}};g(ke,"variantStyle",Oo`
...
`;var Xn={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Ue=class extends D{constructor(t){super(t)}getGlobalCSS(){return Wn}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return kr`${this.cardImage}
            <div class="body">
            ...
            ${this.evergreen?kr`
                  ...
                  `:kr`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};g(Ue,"variantStyle",Io`
...
`;var Qn={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Be=class extends D{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Kn}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(r,n){n.literals={...n.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},n.space=!0,n.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let r=this.card.querySelector(`${re}[data-template="price"]`);if(!r)return;let n=r.cloneNode(!0);this.legal=n,r.dataset.displayTax="false",n.dataset.template="legal",n.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,n.setAttribute("slot","legal"),this.card.appendChild(n)}renderLayout(){return Do`
    ...
    `);var Ur=new Map,ie=(e,t,r=null,n=null,a)=>{Ur.set(e,{class:t,fragmentMapping:r,style:n,collectionOptions:a})};ie("catalog",Oe,Un,Oe.variantStyle);ie("image",Ot);ie("inline-heading",It);ie("mini-compare-chart",He,null,He.variantStyle);ie("plans",q,Dt,q.variantStyle,q.collectionOptions);ie("plans-students",q,jn,q.variantStyle,q.collectionOptions);ie("plans-education",q,zn,q.variantStyle,q.collectionOptions);ie("product",De,null,De.variantStyle);ie("segment",ke,null,ke.variantStyle);ie("special-offers",Ue,Xn,Ue.variantStyle);ie("mini",Be,Qn,Be.variantStyle);function Mn(e){return Ur.get(e)?.fragmentMapping}function Br(e){return Ur.get(e)?.collectionOptions}var Zn="hashchange";function ko(e=window.location.hash){let t=[],r=e.replace(/^#/,"").split("&");for(let n of r){let[a,i=""]=n.split("=");a&&t.push([a,decodeURIComponent(i.replace(/\+/g," "))])}return Object.fromEntries(t)}function at(e){let t=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([a,i])=>{i?t.set(a,i):t.delete(a)}),t.sort();let r=t.toString();if(r===window.location.hash)return;let n=window.scrollY||document.documentElement.scrollTop;window.location.hash=r,window.scrollTo(0,n)}function Jn(e){let t=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let r=ko(window.location.hash);e(r)};return t(),window.addEventListener(Zn,t),()=>{window.removeEventListener(Zn,t)}}import{css as Uo,unsafeCSS as ea}from"../lit-all.min.js";var ta=Uo`
    #header,
    #resultText,
    #footer {
        grid-column: 1 / -1;
...
`,_e.MISSING_INTL_API,o);var w=r.getPluralRules(t,{type:h.pluralType}).select(m-(h.offset||0));y=h.options[w]||h.options.other}if(!y)throw new xn(h.value,m,Object.keys(h.options),o);s.push.apply(s,ft(y.value,t,r,n,a,m-(h.offset||0)));continue}}return qs(s)}function Ws(e,t){return t?S(S(S({},e||{}),t||{}),Object.keys(e).reduce(function(r,n){return r[n]=S(S({},e[n]),t[n]||{}),r},{})):e}function Xs(e,t){return t?Object.keys(e).reduce(function(r,n){return r[n]=Ws(e[n],t[n]),r},S({},e)):e}function En(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function Ks(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:ut(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.NumberFormat).bind.apply(t,Xt([void 0],r,!1)))},{cache:En(e.number),strategy:nr.variadic}),getDateTimeFormat:ut(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.DateTimeFormat).bind.apply(t,Xt([void 0],r,!1)))},{cache:En(e.dateTime),strategy:nr.variadic}),getPluralRules:ut(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.PluralRules).bind.apply(t,Xt([void 0],r,!1)))},{cache:En(e.pluralRules),strategy:nr.variadic})}}var ni=function(){function e(t,r,n,a){var i=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=i.formatToParts(o);if(s.length===1)return s[0].value;var l=s.reduce(function(c,h){return!c.length||h.type!==G.literal||typeof c[c.length-1]!="string"?c.push(h.value):c[c.length-1]+=h.value,c},[]);return l.length<=1?l[0]||"":l},this.formatToParts=function(o){return ft(i.ast,i.locales,i.formatters,i.formats,o,void 0,i.message)},this.resolvedOptions=function(){return{locale:i.resolvedLocale.toString()}},this.getAst=function(){return i.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:a?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Xs(e.formats,n),this.formatters=a&&a.formatters||Ks(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=Za,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var ai=ni;var Qs=/[0-9\-+#]/,Zs=/[^\d\-+#]/g;function ii(e){return e.search(Qs)}function Js(e="#.##"){let t={},r=e.length,n=ii(e);t.prefix=n>0?e.substring(0,n):"";let a=ii(e.split("").reverse().join("")),i=r-a,o=e.substring(i,i+1),s=i+(o==="."||o===","?1:0);t.suffix=a>0?e.substring(s,r):"",t.mask=e.substring(n,s),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let l=t.mask.match(Zs);return t.decimal=l&&l[l.length-1]||".",t.separator=l&&l[1]&&l[0]||",",l=t.mask.split(t.decimal),t.integer=l[0],t.fraction=l[1],t}function ec(e,t,r){let n=!1,a={value:e};e<0&&(n=!0,a.value=-a.value),a.sign=n?"-":"",a.value=Number(a.value).toFixed(t.fraction&&t.fraction.length),a.value=Number(a.value).toString();let i=t.fraction&&t.fraction.lastIndexOf("0"),[o="0",s=""]=a.value.split(".");return(!s||s&&s.length<=i)&&(s=i<0?"":(+("0."+s)).toFixed(i+1).replace("0.","")),a.integer=o,a.fraction=s,tc(a,t),(a.result==="0"||a.result==="")&&(n=!1,a.sign=""),!n&&t.maskHasPositiveSign?a.sign="+":n&&t.maskHasPositiveSign?a.sign="-":n&&(a.sign=r&&r.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),a}function tc(e,t){e.result="";let r=t.integer.split(t.separator),n=r.join(""),a=n&&n.indexOf("0");if(a>-1)for(;e.integer.length<n.length-a;)e.integer="0"+e.integer;else Number(e.integer)===0&&(e.integer="");let i=r[1]&&r[r.length-1].length;if(i){let o=e.integer.length,s=o%i;for(let l=0;l<o;l++)e.result+=e.integer.charAt(l),!((l-s+1)%i)&&l<o-i&&(e.result+=t.separator)}else e.result=e.integer;return e.result+=t.fraction&&e.fraction?t.decimal+e.fraction:"",e}function rc(e,t,r={}){if(!e||isNaN(Number(t)))return t;let n=Js(e),a=ec(t,n,r);return n.prefix+a.sign+a.result+n.suffix}var oi=rc;var si=".",nc=",",li=/^\s+/,hi=/\s+$/,ci="&nbsp;",vn=e=>e*12,di=(e,t)=>{let{start:r,end:n,displaySummary:{amount:a,duration:i,minProductQuantity:o,outcomeType:s}={}}=e;if(!(a&&i&&s&&o))return!1;let l=t?new Date(t):new Date;if(!r||!n)return!1;let c=new Date(r),h=new Date(n);return l>=c&&l<=h},we={MONTH:"MONTH",YEAR:"YEAR"},ac={[J.ANNUAL]:12,[J.MONTHLY]:1,[J.THREE_YEARS]:36,[J.TWO_YEARS]:24},bn=(e,t)=>({accept:e,round:t}),ic=[bn(({divisor:e,price:t})=>t%e==0,({divisor:e,price:t})=>t/e),bn(({usePrecision:e})=>e,({divisor:e,price:t})=>Math.round(t/e*100)/100),bn(()=>!0,({divisor:e,price:t})=>Math.ceil(Math.floor(t*100/e)/100))],yn={[Se.YEAR]:{[J.MONTHLY]:we.MONTH,[J.ANNUAL]:we.YEAR},[Se.MONTH]:{[J.MONTHLY]:we.MONTH}},oc=(e,t)=>e.indexOf(`'${t}'`)===0,sc=(e,t=!0)=>{let r=e.replace(/'.*?'/,"").trim(),n=ui(r);return!!n?t||(r=r.replace(/[,\.]0+/,n)):r=r.replace(/\s?(#.*0)(?!\s)?/,"$&"+lc(e)),r},cc=e=>{let t=hc(e),r=oc(e,t),n=e.replace(/'.*?'/,""),a=li.test(n)||hi.test(n);return{currencySymbol:t,isCurrencyFirst:r,hasCurrencySpace:a}},mi=e=>e.replace(li,ci).replace(hi,ci),lc=e=>e.match(/#(.?)#/)?.[1]===si?nc:si,hc=e=>e.match(/'(.*?)'/)?.[1]??"",ui=e=>e.match(/0(.?)0/)?.[1]??"";function ze({formatString:e,price:t,usePrecision:r,isIndianPrice:n=!1},a,i=o=>o){let{currencySymbol:o,isCurrencyFirst:s,hasCurrencySpace:l}=cc(e),c=r?ui(e):"",h=sc(e,r),u=r?2:0,m=i(t,{currencySymbol:o}),d=n?m.toLocaleString("hi-IN",{minimumFractionDigits:u,maximumFractionDigits:u}):oi(h,m),f=r?d.lastIndexOf(c):d.length,p=d.substring(0,f),v=d.substring(f+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,d).replace(/SYMBOL/,o),currencySymbol:o,decimals:v,decimalsDelimiter:c,hasCurrencySpace:l,integer:p,isCurrencyFirst:s,recurrenceTerm:a}}var pi=e=>{let{commitment:t,term:r,usePrecision:n}=e,a=ac[r]??1;return ze(e,a>1?we.MONTH:yn[t]?.[r],i=>{let o={divisor:a,price:i,usePrecision:n},{round:s}=ic.find(({accept:l})=>l(o));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(o)}`);return s(o)})},fi=({commitment:e,term:t,...r})=>ze(r,yn[e]?.[t]),gi=e=>{let{commitment:t,instant:r,price:n,originalPrice:a,priceWithoutDiscount:i,promotion:o,quantity:s=1,term:l}=e;if(t===Se.YEAR&&l===J.MONTHLY){if(!o)return ze(e,we.YEAR,vn);let{displaySummary:{outcomeType:c,duration:h,minProductQuantity:u=1}={}}=o;switch(c){case"PERCENTAGE_DISCOUNT":if(s>=u&&di(o,r)){let m=parseInt(h.replace("P","").replace("M",""));if(isNaN(m))return vn(n);let d=s*a*m,f=s*i*(12-m),p=Math.round((d+f)*100)/100;return ze({...e,price:p},we.YEAR)}default:return ze(e,we.YEAR,()=>vn(i??n))}}return ze(e,yn[t]?.[l])};var Sn={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},dc=sa("ConsonantTemplates/price"),mc=/<\/?[^>]+(>|$)/g,k={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},be={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Tn="TAX_EXCLUSIVE",uc=e=>aa(e)?Object.entries(e).filter(([,t])=>Fe(t)||Ut(t)||t===!0).reduce((t,[r,n])=>t+` ${r}${n===!0?"":'="'+na(n)+'"'}`,""):"",B=(e,t,r,n=!1)=>`<span class="${e}${t?"":" "+k.disabled}"${uc(r)}>${n?mi(t):t??""}</span>`;function de(e,t,r,n){let a=e[r];if(a==null)return"";try{return new ai(a.replace(mc,""),t).format(n)}catch{return dc.error("Failed to format literal:",a),""}}function pc(e,{accessibleLabel:t,altAccessibleLabel:r,currencySymbol:n,decimals:a,decimalsDelimiter:i,hasCurrencySpace:o,integer:s,isCurrencyFirst:l,recurrenceLabel:c,perUnitLabel:h,taxInclusivityLabel:u},m={}){let d=B(k.currencySymbol,n),f=B(k.currencySpace,o?"&nbsp;":""),p="";return t?p=`<sr-only class="strikethrough-aria-label">${t}</sr-only>`:r&&(p=`<sr-only class="alt-aria-label">${r}</sr-only>`),l&&(p+=d+f),p+=B(k.integer,s),p+=B(k.decimalsDelimiter,i),p+=B(k.decimals,a),l||(p+=f+d),p+=B(k.recurrence,c,null,!0),p+=B(k.unitType,h,null,!0),p+=B(k.taxInclusivity,u,!0),B(e,p,{...m})}var Y=({isAlternativePrice:e=!1,displayOptical:t=!1,displayStrikethrough:r=!1,displayAnnual:n=!1,instant:a=void 0}={})=>({country:i,displayFormatted:o=!0,displayRecurrence:s=!0,displayPerUnit:l=!1,displayTax:c=!1,language:h,literals:u={},quantity:m=1,space:d=!1}={},{commitment:f,offerSelectorIds:p,formatString:v,price:A,priceWithoutDiscount:b,taxDisplay:y,taxTerm:w,term:P,usePrecision:O,promotion:U}={},$={})=>{Object.entries({country:i,formatString:v,language:h,price:A}).forEach(([eo,to])=>{if(to==null)throw new Error(`Argument "${eo}" is missing for osi ${p?.toString()}, country ${i}, language ${h}`)});let I={...Sn,...u},L=`${h.toLowerCase()}-${i.toUpperCase()}`,F=r&&b?b:A,Q=t?pi:fi;n&&(Q=gi);let{accessiblePrice:pe,recurrenceTerm:se,...ye}=Q({commitment:f,formatString:v,instant:a,isIndianPrice:i==="IN",originalPrice:A,priceWithoutDiscount:b,price:t?A:F,promotion:U,quantity:m,term:P,usePrecision:O}),We="",Ce="",Xe="";x(s)&&se&&(Xe=de(I,L,be.recurrenceLabel,{recurrenceTerm:se}));let St="";x(l)&&(d&&(St+=" "),St+=de(I,L,be.perUnitLabel,{perUnit:"LICENSE"}));let Tt="";x(c)&&w&&(d&&(Tt+=" "),Tt+=de(I,L,y===Tn?be.taxExclusiveLabel:be.taxInclusiveLabel,{taxTerm:w})),r&&(We=de(I,L,be.strikethroughAriaLabel,{strikethroughPrice:We})),e&&(Ce=de(I,L,be.alternativePriceAriaLabel,{alternativePrice:Ce}));let Le=k.container;if(t&&(Le+=" "+k.containerOptical),r&&(Le+=" "+k.containerStrikethrough),e&&(Le+=" "+k.containerAlternative),n&&(Le+=" "+k.containerAnnual),x(o))return pc(Le,{...ye,accessibleLabel:We,altAccessibleLabel:Ce,recurrenceLabel:Xe,perUnitLabel:St,taxInclusivityLabel:Tt},$);let{currencySymbol:Cn,decimals:Xi,decimalsDelimiter:Ki,hasCurrencySpace:Ln,integer:Qi,isCurrencyFirst:Zi}=ye,Re=[Qi,Ki,Xi];Zi?(Re.unshift(Ln?"\xA0":""),Re.unshift(Cn)):(Re.push(Ln?"\xA0":""),Re.push(Cn)),Re.push(Xe,St,Tt);let Ji=Re.join("");return B(Le,Ji,$)},xi=()=>(e,t,r)=>{let a=(e.displayOldPrice===void 0||x(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${a?Y({displayStrikethrough:!0})(e,t,r)+"&nbsp;":""}${Y({isAlternativePrice:a})(e,t,r)}`},Ei=()=>(e,t,r)=>{let{instant:n}=e;try{n||(n=new URLSearchParams(document.location.search).get("instant")),n&&(n=new Date(n))}catch{n=void 0}let a={...e,displayTax:!1,displayPerUnit:!1},o=(e.displayOldPrice===void 0||x(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${o?Y({displayStrikethrough:!0})(a,t,r)+"&nbsp;":""}${Y({isAlternativePrice:o})(e,t,r)}${B(k.containerAnnualPrefix,"&nbsp;(")}${Y({displayAnnual:!0,instant:n})(a,t,r)}${B(k.containerAnnualSuffix,")")}`},vi=()=>(e,t,r)=>{let n={...e,displayTax:!1,displayPerUnit:!1};return`${Y({isAlternativePrice:e.displayOldPrice})(e,t,r)}${B(k.containerAnnualPrefix,"&nbsp;(")}${Y({displayAnnual:!0})(n,t,r)}${B(k.containerAnnualSuffix,")")}`};var gt={...k,containerLegal:"price-legal",planType:"price-plan-type"},ar={...be,planTypeLabel:"planTypeLabel"};function fc(e,{perUnitLabel:t,taxInclusivityLabel:r,planTypeLabel:n},a={}){let i="";return i+=B(gt.unitType,t,null,!0),r&&n&&(r+=". "),i+=B(gt.taxInclusivity,r,!0),i+=B(gt.planType,n,null),B(e,i,{...a})}var bi=({country:e,displayPerUnit:t=!1,displayTax:r=!1,displayPlanType:n=!1,language:a,literals:i={}}={},{taxDisplay:o,taxTerm:s,planType:l}={},c={})=>{let h={...Sn,...i},u=`${a.toLowerCase()}-${e.toUpperCase()}`,m="";x(t)&&(m=de(h,u,ar.perUnitLabel,{perUnit:"LICENSE"}));let d="";e==="US"&&a==="en"&&(r=!1),x(r)&&s&&(d=de(h,u,o===Tn?ar.taxExclusiveLabel:ar.taxInclusiveLabel,{taxTerm:s}));let f="";x(n)&&l&&(f=de(h,u,ar.planTypeLabel,{planType:l}));let p=gt.container;return p+=" "+gt.containerLegal,fc(p,{perUnitLabel:m,taxInclusivityLabel:d,planTypeLabel:f},c)};var yi=Y(),Si=xi(),Ti=Y({displayOptical:!0}),Ai=Y({displayStrikethrough:!0}),_i=Y({displayAnnual:!0}),wi=Y({displayOptical:!0,isAlternativePrice:!0}),Pi=Y({isAlternativePrice:!0}),Ci=vi(),Li=Ei(),Ri=bi;var gc=(e,t)=>{if(!(!it(e)||!it(t)))return Math.floor((t-e)/t*100)},Ni=()=>(e,t)=>{let{price:r,priceWithoutDiscount:n}=t,a=gc(r,n);return a===void 0?'<span class="no-discount"></span>':`<span class="discount">${a}%</span>`};var Mi=Ni();var Ii="INDIVIDUAL_COM",An="TEAM_COM",Hi="INDIVIDUAL_EDU",_n="TEAM_EDU",Oi=["GB_en","AU_en","FR_fr","AT_de","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","GR_el","GR_en","HU_hu","IE_en","IT_it","LU_de","LU_en","LU_fr","NL_nl","NO_nb","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TR_tr","UA_uk","ID_en","ID_in","IN_en","IN_hi","JP_ja","MY_en","MY_ms","NZ_en","TH_en","TH_th"],xc={[Ii]:["MU_en","LT_lt","LV_lv","NG_en","SA_ar","SA_en","SG_en","KR_ko"],[An]:["MU_en","LT_lt","LV_lv","NG_en","CO_es","KR_ko"],[Hi]:["LT_lt","LV_lv","SA_en","SG_en"],[_n]:["SG_en","KR_ko"]},Ec={MU_en:[!1,!1,!1,!1],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],CO_es:[!1,!0,!1,!1],AT_de:[!1,!1,!1,!0],SG_en:[!1,!1,!1,!0]},vc=[Ii,An,Hi,_n],bc=e=>[An,_n].includes(e),yc=(e,t,r,n)=>{let a=`${e}_${t}`,i=`${r}_${n}`,o=Ec[a];if(o){let s=vc.indexOf(i);return o[s]}return bc(i)},Sc=(e,t,r,n)=>{let a=`${e}_${t}`;if(Oi.includes(e)||Oi.includes(a))return!0;let i=xc[`${r}_${n}`];return i?i.includes(e)||i.includes(a)?!0:_.displayTax:_.displayTax},Tc=async(e,t,r,n)=>{let a=Sc(e,t,r,n);return{displayTax:a,forceTaxExclusive:a?yc(e,t,r,n):_.forceTaxExclusive}},xt=class xt extends HTMLSpanElement{constructor(){super();g(this,"masElement",new Ve(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi"]}static createInlinePrice(r){let n=V();if(!n)return null;let{displayOldPrice:a,displayPerUnit:i,displayRecurrence:o,displayTax:s,displayPlanType:l,displayAnnual:c,forceTaxExclusive:h,perpetual:u,promotionCode:m,quantity:d,alternativePrice:f,template:p,wcsOsi:v}=n.collectPriceOptions(r);return Yt(xt,{displayOldPrice:a,displayPerUnit:i,displayRecurrence:o,displayTax:s,displayPlanType:l,displayAnnual:c,forceTaxExclusive:h,perpetual:u,promotionCode:m,quantity:d,alternativePrice:f,template:p,wcsOsi:v})}get isInlinePrice(){return!0}attributeChangedCallback(r,n,a){this.masElement.attributeChangedCallback(r,n,a)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===ne}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}async render(r={}){if(!this.isConnected)return!1;let n=V();if(!n)return!1;let a=n.collectPriceOptions(r,this),i={...n.settings,...a};if(!i.wcsOsi.length)return!1;if(n.featureFlags[ve]&&(a.displayTax===void 0||a.forceTaxExclusive===void 0)){let[l]=await n.resolveOfferSelectors(i),c=st(await l,i);if(c?.length){let{country:h,language:u}=i,m=c[0],[d=""]=m.marketSegments,f=await Tc(h,u,m.customerSegment,d);a.displayTax===void 0&&(i.displayTax=f?.displayTax||i.displayTax),a.forceTaxExclusive===void 0&&(i.forceTaxExclusive=f?.forceTaxExclusive||i.forceTaxExclusive)}}let o=this.masElement.togglePending(i);this.innerHTML="";let[s]=n.resolveOfferSelectors(i);try{let l=await s;return this.renderOffers(st(l,i),o)}catch(l){throw this.innerHTML="",l}}renderOffers(r,n=void 0){if(!this.isConnected)return;let a=V();if(!a)return!1;if(n??(n=this.masElement.togglePending()),r.length){if(this.masElement.toggleResolved(n,r)){this.innerHTML=a.buildPriceHTML(r,this.options);let i=this.closest("p, h3, div");if(!i||!i.querySelector('span[data-template="strikethrough"]')||i.querySelector(".alt-aria-label"))return!0;let o=i?.querySelectorAll('span[is="inline-price"]');return o.length>1&&o.length===i.querySelectorAll('span[data-template="strikethrough"]').length*2&&o.forEach(s=>{s.dataset.template!=="strikethrough"&&s.options&&!s.options.alternativePrice&&!s.isFailed&&(s.options.alternativePrice=!0,s.innerHTML=a.buildPriceHTML(r,s.options))}),!0}}else{let i=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(n,i,this.options))return this.innerHTML="",!0}return!1}updateOptions(r){let n=V();if(!n)return!1;let{alternativePrice:a,displayOldPrice:i,displayPerUnit:o,displayRecurrence:s,displayTax:l,forceTaxExclusive:c,perpetual:h,promotionCode:u,quantity:m,template:d,wcsOsi:f}=n.collectPriceOptions(r);return Wt(this,{alternativePrice:a,displayOldPrice:i,displayPerUnit:o,displayRecurrence:s,displayTax:l,forceTaxExclusive:c,perpetual:h,promotionCode:u,quantity:m,template:d,wcsOsi:f}),!0}};g(xt,"is","inline-price"),g(xt,"tag","span");var me=xt;window.customElements.get(me.is)||window.customElements.define(me.is,me,{extends:me.tag});function Di({literals:e,providers:t,settings:r}){function n(o,s=null){let l={country:r.country,language:r.language,locale:r.locale,literals:structuredClone(e.price)};if(s&&t?.price)for(let O of t.price)O(s,l);let{displayOldPrice:c,displayPerUnit:h,displayRecurrence:u,displayTax:m,displayPlanType:d,forceTaxExclusive:f,perpetual:p,displayAnnual:v,promotionCode:A,quantity:b,alternativePrice:y,wcsOsi:w,...P}=Object.assign(l,s?.dataset??{},o??{});return l=Bt(Object.assign({...l,...P,displayOldPrice:x(c),displayPerUnit:x(h),displayRecurrence:x(u),displayTax:x(m),displayPlanType:x(d),forceTaxExclusive:x(f),perpetual:x(p),displayAnnual:x(v),promotionCode:Gt(A).effectivePromoCode,quantity:Ge(b,_.quantity),alternativePrice:x(y),wcsOsi:zt(w)})),l}function a(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:l}=s,c;switch(l){case"discount":c=Mi;break;case"strikethrough":c=Ai;break;case"annual":c=_i;break;case"legal":c=Ri;break;default:s.template==="optical"&&s.alternativePrice?c=wi:s.template==="optical"?c=Ti:s.displayAnnual&&o[0].planType==="ABM"?c=s.promotionCode?Li:Ci:s.alternativePrice?c=Pi:c=s.promotionCode?Si:yi}let[h]=o;return h={...h,...h.priceDetails},c({...r,...s},h)}let i=me.createInlinePrice;return{InlinePrice:me,buildPriceHTML:a,collectPriceOptions:n,createInlinePrice:i}}function Ac({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||_.language),t??(t=e?.split("_")?.[1]||_.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function ki(e={},t){let r=t.featureFlags[ve],{commerce:n={}}=e,a=ce.PRODUCTION,i=wr,o=R("checkoutClientId",n)??_.checkoutClientId,s=ot(R("checkoutWorkflowStep",n),j,_.checkoutWorkflowStep),l=x(R("displayOldPrice",n),r?_.displayOldPrice:!_.displayOldPrice),c=x(R("displayPerUnit",n),r?_.displayPerUnit:!_.displayPerUnit),h=x(R("displayRecurrence",n),_.displayRecurrence),u=x(R("displayTax",n),_.displayTax),m=x(R("displayPlanType",n),_.displayPlanType),d=x(R("entitlement",n),_.entitlement),f=x(R("modal",n),_.modal),p=x(R("forceTaxExclusive",n),_.forceTaxExclusive),v=R("promotionCode",n)??_.promotionCode,A=Ge(R("quantity",n)),b=R("wcsApiKey",n)??_.wcsApiKey,y=n?.env==="stage",w=xe.PUBLISHED;["true",""].includes(n.allowOverride)&&(y=(R(Ar,n,{metadata:!1})?.toLowerCase()??n?.env)==="stage",w=ot(R(_r,n),xe,w)),y&&(a=ce.STAGE,i=Pr);let O=R(Tr)??e.preview,U=typeof O<"u"&&O!=="off"&&O!=="false",$={};U&&($={preview:U});let I=R("mas-io-url")??e.masIOUrl??`https://www${a===ce.STAGE?".stage":""}.adobe.com/mas/io`,L=R("preselect-plan")??void 0;return{...Ac(e),...$,displayOldPrice:l,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:c,displayRecurrence:h,displayTax:u,displayPlanType:m,entitlement:d,extraOptions:_.extraOptions,modal:f,env:a,forceTaxExclusive:p,promotionCode:v,quantity:A,alternativePrice:_.alternativePrice,wcsApiKey:b,wcsURL:i,landscape:w,masIOUrl:I,...L&&{preselectPlan:L}}}async function Ui(e,t={},r=2,n=100){let a;for(let i=0;i<=r;i++)try{let o=await fetch(e,t);return o.retryCount=i,o}catch(o){if(a=o,a.retryCount=i,i>r)break;await new Promise(s=>setTimeout(s,n*(i+1)))}throw a}var wn="wcs";function Bi({settings:e}){let t=te.module(wn),{env:r,wcsApiKey:n}=e,a=new Map,i=new Map,o,s=new Map;async function l(d,f,p=!0){let v=V(),A=vr;t.debug("Fetching:",d);let b="",y;if(d.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let w=new Map(f),[P]=d.offerSelectorIds,O=Date.now()+Math.random().toString(36).substring(2,7),U=`${wn}:${P}:${O}${Lr}`,$=`${wn}:${P}:${O}${Rr}`,I;try{if(performance.mark(U),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",P),b.searchParams.set("country",d.country),b.searchParams.set("locale",d.locale),b.searchParams.set("landscape",r===ce.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",n),d.language&&b.searchParams.set("language",d.language),d.promotionCode&&b.searchParams.set("promotion_code",d.promotionCode),d.currency&&b.searchParams.set("currency",d.currency),y=await Ui(b.toString(),{credentials:"omit"}),y.ok){let L=[];try{let F=await y.json();t.debug("Fetched:",d,F),L=F.resolvedOffers??[]}catch(F){t.error(`Error parsing JSON: ${F.message}`,{...F.context,...v?.duration})}L=L.map($t),f.forEach(({resolve:F},Q)=>{let pe=L.filter(({offerSelectorIds:se})=>se.includes(Q)).flat();pe.length&&(w.delete(Q),f.delete(Q),F(pe))})}else A=Er}catch(L){A=`Network error: ${L.message}`}finally{I=performance.measure($,U),performance.clearMarks(U),performance.clearMeasures($)}if(p&&f.size){t.debug("Missing:",{offerSelectorIds:[...f.keys()]});let L=ma(y);f.forEach(F=>{F.reject(new $e(A,{...d,...L,response:y,measure:Mt(I),...v?.duration}))})}}function c(){clearTimeout(o);let d=[...i.values()];i.clear(),d.forEach(({options:f,promises:p})=>l(f,p))}function h(d){if(!d||typeof d!="object")throw new TypeError("Cache must be a Map or similar object");let f=r===ce.STAGE?"stage":"prod",p=d[f];if(!p||typeof p!="object"){t.warn(`No cache found for environment: ${r}`);return}for(let[v,A]of Object.entries(p))a.set(v,Promise.resolve(A.map($t)));t.debug(`Prefilled WCS cache with ${p.size} entries`)}function u(){let d=a.size;s=new Map(a),a.clear(),t.debug(`Moved ${d} cache entries to stale cache`)}function m({country:d,language:f,perpetual:p=!1,promotionCode:v="",wcsOsi:A=[]}){let b=`${f}_${d}`;d!=="GB"&&!p&&(f="MULT");let y=[d,f,v].filter(w=>w).join("-").toLowerCase();return A.map(w=>{let P=`${w}-${y}`;if(a.has(P))return a.get(P);let O=new Promise((U,$)=>{let I=i.get(y);if(!I){let L={country:d,locale:b,offerSelectorIds:[]};d!=="GB"&&!p&&(L.language=f),I={options:L,promises:new Map},i.set(y,I)}v&&(I.options.promotionCode=v),I.options.offerSelectorIds.push(w),I.promises.set(w,{resolve:U,reject:$}),c()}).catch(U=>{if(s.has(P))return s.get(P);throw U});return a.set(P,O),O})}return{Commitment:Se,PlanType:la,Term:J,applyPlanType:$t,resolveOfferSelectors:m,flushWcsCacheInternal:u,prefillWcsCache:h}}var Fi="mas-commerce-service",Gi="mas-commerce-service:start",$i="mas-commerce-service:ready",Et,je,qe,Vi,zi,Pn=class extends HTMLElement{constructor(){super(...arguments);z(this,qe);z(this,Et);z(this,je);g(this,"lastLoggingTime",0)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(n,a,i)=>{let o=await r?.(n,a,this.imsSignedInPromise,i);return o||null})}get featureFlags(){return C(this,je)||Z(this,je,{[ve]:At(this,qe,zi).call(this,ve)}),C(this,je)}activate(){let r=C(this,qe,Vi),n=ki(r,this);jt(r.lana);let a=te.init(r.hostEnv).module("service");a.debug("Activating:",r);let o={price:Na(n)},s={checkout:new Set,price:new Set},l={literals:o,providers:s,settings:n};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...Ca(l),...La(l),...Di(l),...Bi(l),...Mr,Log:te,get defaults(){return _},get log(){return te},get providers(){return{checkout(h){return s.checkout.add(h),()=>s.checkout.delete(h)},price(h){return s.price.add(h),()=>s.price.delete(h)},has:h=>s.price.has(h)||s.checkout.has(h)}},get settings(){return n}})),a.debug("Activated:",{literals:o,settings:n});let c=new CustomEvent(Nt,{bubbles:!0,cancelable:!1,detail:this});performance.mark($i),Z(this,Et,performance.measure($i,Gi)),this.dispatchEvent(c),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(Gi),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(sr).forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":Mt(C(this,Et))}}logFailedRequests(){let r=[...performance.getEntriesByType("resource")].filter(({startTime:a})=>a>this.lastLoggingTime).filter(({transferSize:a,duration:i,responseStatus:o})=>a===0&&i===0&&o<200||o>=400),n=Array.from(new Map(r.map(a=>[a.name,a])).values());if(n.some(({name:a})=>/(\/fragment\?|web_commerce_artifact)/.test(a))){let a=n.map(({name:i})=>i);this.log.error("Failed requests:",{failedUrls:a,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Et=new WeakMap,je=new WeakMap,qe=new WeakSet,Vi=function(){let r=this.getAttribute("env")??"prod",n={commerce:{env:r},hostEnv:{name:r},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:r==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview"].forEach(a=>{let i=this.getAttribute(a);i&&(n[a]=i)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(a=>{let i=this.getAttribute(a);if(i!=null){let o=a.replace(/-([a-z])/g,s=>s[1].toUpperCase());n.commerce[o]=i}}),n},zi=function(r){return["on","true",!0].includes(this.getAttribute(`data-${r}`)||R(r))};window.customElements.get(Fi)||window.customElements.define(Fi,Pn);var Yi="merch-card-collection",wc=2e4,Pc={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansThreeColumns:["three-merch-cards"]},Cc={plans:!0},Lc=(e,{filter:t})=>e.filter(r=>r.filters.hasOwnProperty(t)),Rc=(e,{types:t})=>t?(t=t.split(","),e.filter(r=>t.some(n=>r.types.includes(n)))):e,Nc=e=>e.sort((t,r)=>(t.title??"").localeCompare(r.title??"","en",{sensitivity:"base"})),Mc=(e,{filter:t})=>e.sort((r,n)=>n.filters[t]?.order==null||isNaN(n.filters[t]?.order)?-1:r.filters[t]?.order==null||isNaN(r.filters[t]?.order)?1:r.filters[t].order-n.filters[t].order),Oc=(e,{search:t})=>t?.length?(t=t.toLowerCase(),e.filter(r=>(r.title??"").toLowerCase().includes(t))):e,Pe,bt,yt,ir,Wi,Ye=class extends qi{constructor(){super();z(this,ir);z(this,Pe,{});z(this,bt);z(this,yt);this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1}render(){return ue`
        ...
        >
          ...
          `:oe}get filterAction(){return C(this,W).filter?this.sidenav?ue`
              ...
              ></sp-action-button>
          `:oe:oe}get sortAction(){if(!C(this,W).sort)return oe;let r=tt(this,"sortText");if(!r)return;let n=tt(this,"popularityText"),a=tt(this,"alphabeticallyText");if(!(n&&a))return;let i=this.collection?.sort===ae.alphabetical;return ue`
              <sp-action-menu
                  id="sort"
                  size="m"
      ...
      `);customElements.define("merch-card-collection-header",vt);export{Ye as MerchCardCollection,vt as default};
