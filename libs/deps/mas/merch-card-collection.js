...
`;var Vt=class extends N{constructor(t){super(t)}getGlobalCSS(){return Ji}renderLayout(){return ea` ${this.badge}
    ...
    ${this.card.customHr?"":ea`<hr />`} ${this.secureLabelFooter}`}};import{html as Ge,css as Xo,unsafeCSS as ra}from"../lit-all.min.js";var ta=`
  :root {
...
`;var Ko=32,Ve=class extends N{constructor(r){super(r);g(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);g(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?Ge`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(r=>r.onceSettled())),await this.adjustAddon(),L.isMobile?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};g(Ve,"variantStyle",Xo`
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let r=t.querySelector("strong, b, p");r&&(L.isDesktopOrUp?r.style.display="":r.style.display="none")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?L.isDesktopOrUp?qe`
        ...
        `:Wt}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?qe`<slot name="icons"></slot>`:Wt}connectedCallbackHook(){this.handleMediaChange=()=>{this.adaptForMedia(),this.updateShortDescriptionVisibility(),this.card.requestUpdate()},L.matchMobile.addEventListener("change",this.handleMediaChange),L.matchDesktopOrUp.addEventListener("change",this.handleMediaChange)}disconnectedCallbackHook(){L.matchMobile.removeEventListener("change",this.handleMediaChange),L.matchDesktopOrUp.removeEventListener("change",this.handleMediaChange)}renderLayout(){return qe` ${this.badge}
            ...
            <slot></slot>`}};g(Ae,"variantStyle",Zo`
...
`,Be.MISSING_INTL_API,o);var v=r.getPluralRules(t,{type:d.pluralType}).select(m-(d.offset||0));x=d.options[v]||d.options.other}if(!x)throw new Ri(d.value,m,Object.keys(d.options),o);s.push.apply(s,Lt(x.value,t,r,i,a,m-(d.offset||0)));continue}}return kc(s)}function Nc(e,t){return t?S(S(S({},e||{}),t||{}),Object.keys(e).reduce(function(r,i){return r[i]=S(S({},e[i]),t[i]||{}),r},{})):e}function Oc(e,t){return t?Object.keys(e).reduce(function(r,i){return r[i]=Nc(e[i],t[i]),r},S({},e)):e}function Ni(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function Ic(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Ct(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.NumberFormat).bind.apply(t,or([void 0],r,!1)))},{cache:Ni(e.number),strategy:ur.variadic}),getDateTimeFormat:Ct(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.DateTimeFormat).bind.apply(t,or([void 0],r,!1)))},{cache:Ni(e.dateTime),strategy:ur.variadic}),getPluralRules:Ct(function(){for(var t,r=[],i=0;i<arguments.length;i++)r[i]=arguments[i];return new((t=Intl.PluralRules).bind.apply(t,or([void 0],r,!1)))},{cache:Ni(e.pluralRules),strategy:ur.variadic})}}var On=function(){function e(t,r,i,a){var n=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==W.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return Lt(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:a?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Oc(e.formats,i),this.formatters=a&&a.formatters||Ic(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=Ln,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var In=On;var Oi={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},Dc=Aa("ConsonantTemplates/price"),Hc=/<\/?[^>]+(>|$)/g,B={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Te={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Ii="TAX_EXCLUSIVE",Bc=e=>ya(e)?Object.entries(e).filter(([,t])=>Ze(t)||Xt(t)||t===!0).reduce((t,[r,i])=>t+` ${r}${i===!0?"":'="'+ba(i)+'"'}`,""):"",F=(e,t,r,i=!1)=>`<span class="${e}${t?"":" "+B.disabled}"${Bc(r)}>${i?qa(t):t??""}</span>`;function Uc(e){e=e.replaceAll("</a>","&lt;/a&gt;");let t=/<a [^>]+(>|$)/g;return e.match(t)?.forEach(i=>{let a=i.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(i,a)}),e}function Fc(e){e=e.replaceAll("&lt;/a&gt;","</a>");let t=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(t)?.forEach(i=>{let a=i.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(i,a)}),e}function xe(e,t,r,i){let a=e[r];if(a==null)return"";let n=a.includes("<"),o=a.includes("<a ");try{a=o?Uc(a):a,a=n?a.replace(Hc,""):a;let s=new In(a,t).format(i);return o?Fc(s):s}catch{return Dc.error("Failed to format literal:",a),""}}function zc(e,{accessibleLabel:t,altAccessibleLabel:r,currencySymbol:i,decimals:a,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:u},m={}){let p=F(B.currencySymbol,i),h=F(B.currencySpace,o?"&nbsp;":""),f="";return t?f=`<sr-only class="strikethrough-aria-label">${t}</sr-only>`:r&&(f=`<sr-only class="alt-aria-label">${r}</sr-only>`),c&&(f+=p+h),f+=F(B.integer,s),f+=F(B.decimalsDelimiter,n),f+=F(B.decimals,a),c||(f+=h+p),f+=F(B.recurrence,l,null,!0),f+=F(B.unitType,d,null,!0),f+=F(B.taxInclusivity,u,!0),F(e,f,{...m})}var Y=({isAlternativePrice:e=!1,displayOptical:t=!1,displayStrikethrough:r=!1,displayAnnual:i=!1,instant:a=void 0}={})=>({country:n,displayFormatted:o=!0,displayRecurrence:s=!0,displayPerUnit:c=!1,displayTax:l=!1,language:d,literals:u={},quantity:m=1,space:p=!1,isPromoApplied:h=!1}={},{commitment:f,offerSelectorIds:y,formatString:_,price:b,priceWithoutDiscount:x,taxDisplay:v,taxTerm:R,term:M,usePrecision:H,promotion:$}={},X={})=>{Object.entries({country:n,formatString:_,language:d,price:b}).forEach(([Eo,wo])=>{if(wo==null)throw new Error(`Argument "${Eo}" is missing for osi ${y?.toString()}, country ${n}, language ${d}`)});let z={...Oi,...u},U=`${d.toLowerCase()}-${n.toUpperCase()}`,k;$&&!h&&x?k=e?b:x:r&&x?k=x:k=b;let ae=t?Wa:Ya;i&&(ae=Xa);let{accessiblePrice:he,recurrenceTerm:ye,...Fi}=ae({commitment:f,formatString:_,instant:a,isIndianPrice:n==="IN",originalPrice:b,priceWithoutDiscount:x,price:t?b:k,promotion:$,quantity:m,term:M,usePrecision:H}),xr="",vr="",br="";w(s)&&ye&&(br=xe(z,U,Te.recurrenceLabel,{recurrenceTerm:ye}));let Dt="";w(c)&&(p&&(Dt+=" "),Dt+=xe(z,U,Te.perUnitLabel,{perUnit:"LICENSE"}));let Ht="";w(l)&&R&&(p&&(Ht+=" "),Ht+=xe(z,U,v===Ii?Te.taxExclusiveLabel:Te.taxInclusiveLabel,{taxTerm:R})),r&&(xr=xe(z,U,Te.strikethroughAriaLabel,{strikethroughPrice:xr})),e&&(vr=xe(z,U,Te.alternativePriceAriaLabel,{alternativePrice:vr}));let Ue=B.container;if(t&&(Ue+=" "+B.containerOptical),r&&(Ue+=" "+B.containerStrikethrough),e&&(Ue+=" "+B.containerAlternative),i&&(Ue+=" "+B.containerAnnual),w(o))return zc(Ue,{...Fi,accessibleLabel:xr,altAccessibleLabel:vr,recurrenceLabel:br,perUnitLabel:Dt,taxInclusivityLabel:Ht},X);let{currencySymbol:zi,decimals:go,decimalsDelimiter:xo,hasCurrencySpace:$i,integer:vo,isCurrencyFirst:bo}=Fi,Fe=[vo,xo,go];bo?(Fe.unshift($i?"\xA0":""),Fe.unshift(zi)):(Fe.push($i?"\xA0":""),Fe.push(zi)),Fe.push(br,Dt,Ht);let yo=Fe.join("");return F(Ue,yo,X)},Dn=()=>(e,t,r)=>{let i=De(t.promotion,t.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||w(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price&&(!t.promotion||i);return`${n?Y({displayStrikethrough:!0})({isPromoApplied:i,...e},t,r)+"&nbsp;":""}${Y({isAlternativePrice:n})({isPromoApplied:i,...e},t,r)}`},Hn=()=>(e,t,r)=>{let{instant:i}=e;try{i||(i=new URLSearchParams(document.location.search).get("instant")),i&&(i=new Date(i))}catch{i=void 0}let a=De(t.promotion,i,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:a};if(!a)return Y()(e,{...t,price:t.priceWithoutDiscount},r)+F(B.containerAnnualPrefix,"&nbsp;(")+Y({displayAnnual:!0,instant:i})(n,{...t,price:t.priceWithoutDiscount},r)+F(B.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||w(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${s?Y({displayStrikethrough:!0})(n,t,r)+"&nbsp;":""}${Y({isAlternativePrice:s})({isPromoApplied:a,...e},t,r)}${F(B.containerAnnualPrefix,"&nbsp;(")}${Y({displayAnnual:!0,instant:i})(n,t,r)}${F(B.containerAnnualSuffix,")")}`},Bn=()=>(e,t,r)=>{let i={...e,displayTax:!1,displayPerUnit:!1};return`${Y({isAlternativePrice:e.displayOldPrice})(e,t,r)}${F(B.containerAnnualPrefix,"&nbsp;(")}${Y({displayAnnual:!0})(i,t,r)}${F(B.containerAnnualSuffix,")")}`};var Mt={...B,containerLegal:"price-legal",planType:"price-plan-type"},fr={...Te,planTypeLabel:"planTypeLabel"};function $c(e,{perUnitLabel:t,taxInclusivityLabel:r,planTypeLabel:i},a={}){let n="";return n+=F(Mt.unitType,t,null,!0),r&&i&&(r+=". "),n+=F(Mt.taxInclusivity,r,!0),n+=F(Mt.planType,i,null),F(e,n,{...a})}var Un=({country:e,displayPerUnit:t=!1,displayTax:r=!1,displayPlanType:i=!1,language:a,literals:n={}}={},{taxDisplay:o,taxTerm:s,planType:c}={},l={})=>{let d={...Oi,...n},u=`${a.toLowerCase()}-${e.toUpperCase()}`,m="";w(t)&&(m=xe(d,u,fr.perUnitLabel,{perUnit:"LICENSE"}));let p="";e==="US"&&a==="en"&&(r=!1),w(r)&&s&&(p=xe(d,u,o===Ii?fr.taxExclusiveLabel:fr.taxInclusiveLabel,{taxTerm:s}));let h="";w(i)&&c&&(h=xe(d,u,fr.planTypeLabel,{planType:c}));let f=Mt.container;return f+=" "+Mt.containerLegal,$c(f,{perUnitLabel:m,taxInclusivityLabel:p,planTypeLabel:h},l)};var Fn=Y(),zn=Dn(),$n=Y({displayOptical:!0}),Gn=Y({displayStrikethrough:!0}),Vn=Y({displayAnnual:!0}),qn=Y({displayOptical:!0,isAlternativePrice:!0}),jn=Y({isAlternativePrice:!0}),Wn=Bn(),Yn=Hn(),Xn=Un;var Gc=(e,t)=>{if(!(!bt(e)||!bt(t)))return Math.floor((t-e)/t*100)},Kn=()=>(e,t)=>{let{price:r,priceWithoutDiscount:i}=t,a=Gc(r,i);return a===void 0?'<span class="no-discount"></span>':`<span class="discount">${a}%</span>`};var Qn=Kn();var Jn="INDIVIDUAL_COM",Di="TEAM_COM",eo="INDIVIDUAL_EDU",Hi="TEAM_EDU",Zn=["GB_en","AU_en","FR_fr","AT_de","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","GR_el","GR_en","HU_hu","IE_en","IT_it","LU_de","LU_en","LU_fr","NL_nl","NO_nb","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TR_tr","UA_uk","ID_en","ID_in","IN_en","IN_hi","JP_ja","MY_en","MY_ms","NZ_en","TH_en","TH_th"],Vc={[Jn]:["MU_en","LT_lt","LV_lv","NG_en","SA_ar","SA_en","SG_en","KR_ko"],[Di]:["MU_en","LT_lt","LV_lv","NG_en","CO_es","KR_ko"],[eo]:["LT_lt","LV_lv","SA_en","SG_en"],[Hi]:["SG_en","KR_ko"]},qc={MU_en:[!1,!1,!1,!1],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],CO_es:[!1,!0,!1,!1],AT_de:[!1,!1,!1,!0],SG_en:[!1,!1,!1,!0]},jc=[Jn,Di,eo,Hi],Wc=e=>[Di,Hi].includes(e),Yc=(e,t,r,i)=>{let a=`${e}_${t}`,n=`${r}_${i}`,o=qc[a];if(o){let s=jc.indexOf(n);return o[s]}return Wc(n)},Xc=(e,t,r,i)=>{let a=`${e}_${t}`;if(Zn.includes(e)||Zn.includes(a))return!0;let n=Vc[`${r}_${i}`];return n?n.includes(e)||n.includes(a)?!0:C.displayTax:C.displayTax},Kc=async(e,t,r,i)=>{let a=Xc(e,t,r,i);return{displayTax:a,forceTaxExclusive:a?Yc(e,t,r,i):C.forceTaxExclusive}},kt=class kt extends HTMLSpanElement{constructor(){super();g(this,"masElement",new Se(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(r){let i=ee();if(!i)return null;let{displayOldPrice:a,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:u,promotionCode:m,quantity:p,alternativePrice:h,template:f,wcsOsi:y}=i.collectPriceOptions(r);return ar(kt,{displayOldPrice:a,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:u,promotionCode:m,quantity:p,alternativePrice:h,template:f,wcsOsi:y})}get isInlinePrice(){return!0}attributeChangedCallback(r,i,a){this.masElement.attributeChangedCallback(r,i,a)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===le}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}async render(r={}){if(!this.isConnected)return!1;let i=ee();if(!i)return!1;let a=i.collectPriceOptions(r,this),n={...i.settings,...a};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let[s]=await i.resolveOfferSelectors(n),c=Et(await s,n),[l]=c;if(i.featureFlags[fe]||n[fe]){if(a.displayPerUnit===void 0&&(n.displayPerUnit=l.customerSegment!=="INDIVIDUAL"),a.displayTax===void 0||a.forceTaxExclusive===void 0){let{country:d,language:u}=n,[m=""]=l.marketSegments,p=await Kc(d,u,l.customerSegment,m);a.displayTax===void 0&&(n.displayTax=p?.displayTax||n.displayTax),a.forceTaxExclusive===void 0&&(n.forceTaxExclusive=p?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(c=Et(c,n))}}else a.displayOldPrice===void 0&&(n.displayOldPrice=!0);return this.renderOffers(c,n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(r,i,a=void 0){if(!this.isConnected)return;let n=ee();if(!n)return!1;if(a??(a=this.masElement.togglePending()),r.length){if(this.masElement.toggleResolved(a,r,i)){this.innerHTML=n.buildPriceHTML(r,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(r,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(a,o,this.options))return this.innerHTML="",!0}return!1}};g(kt,"is","inline-price"),g(kt,"tag","span");var ve=kt;window.customElements.get(ve.is)||window.customElements.define(ve.is,ve,{extends:ve.tag});function to({literals:e,providers:t,settings:r}){function i(o,s=null){let c={country:r.country,language:r.language,locale:r.locale,literals:{...e.price}};if(s&&t?.price)for(let M of t.price)M(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:u,displayTax:m,displayPlanType:p,forceTaxExclusive:h,perpetual:f,displayAnnual:y,promotionCode:_,quantity:b,alternativePrice:x,wcsOsi:v,...R}=Object.assign(c,s?.dataset??{},o??{});return c=Kt(Object.assign({...c,...R,displayOldPrice:w(l),displayPerUnit:w(d),displayRecurrence:w(u),displayTax:w(m),displayPlanType:w(p),forceTaxExclusive:w(h),perpetual:w(f),displayAnnual:w(y),promotionCode:Zt(_).effectivePromoCode,quantity:Je(b,C.quantity),alternativePrice:w(x),wcsOsi:tr(v)})),c}function a(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=Qn;break;case"strikethrough":l=Gn;break;case"annual":l=Vn;break;case"legal":l=Xn;break;default:s.template==="optical"&&s.alternativePrice?l=qn:s.template==="optical"?l=$n:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode?Yn:Wn:s.alternativePrice?l=jn:l=s.promotionCode?zn:Fn}let[d]=o;return d={...d,...d.priceDetails},l({...r,...s},d)}let n=ve.createInlinePrice;return{InlinePrice:ve,buildPriceHTML:a,collectPriceOptions:i,createInlinePrice:n}}function Qc({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||C.language),t??(t=e?.split("_")?.[1]||C.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function ro(e={},t){let r=t.featureFlags[fe],{commerce:i={}}=e,a=me.PRODUCTION,n=Fr,o=D("checkoutClientId",i)??C.checkoutClientId,s=yt(D("checkoutWorkflowStep",i),Q,C.checkoutWorkflowStep),c=C.displayOldPrice,l=C.displayPerUnit,d=w(D("displayRecurrence",i),C.displayRecurrence),u=w(D("displayTax",i),C.displayTax),m=w(D("displayPlanType",i),C.displayPlanType),p=w(D("entitlement",i),C.entitlement),h=w(D("modal",i),C.modal),f=w(D("forceTaxExclusive",i),C.forceTaxExclusive),y=D("promotionCode",i)??C.promotionCode,_=Je(D("quantity",i)),b=D("wcsApiKey",i)??C.wcsApiKey,x=i?.env==="stage",v=we.PUBLISHED;["true",""].includes(i.allowOverride)&&(x=(D(Br,i,{metadata:!1})?.toLowerCase()??i?.env)==="stage",v=yt(D(Ur,i),we,v)),x&&(a=me.STAGE,n=zr);let M=D(Hr)??e.preview,H=typeof M<"u"&&M!=="off"&&M!=="false",$={};H&&($={preview:H});let X=D("mas-io-url")??e.masIOUrl??`https://www${a===me.STAGE?".stage":""}.adobe.com/mas/io`,z=D("preselect-plan")??void 0;return{...Qc(e),...$,displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:u,displayPlanType:m,entitlement:p,extraOptions:C.extraOptions,modal:h,env:a,forceTaxExclusive:f,promotionCode:y,quantity:_,alternativePrice:C.alternativePrice,wcsApiKey:b,wcsURL:n,landscape:v,masIOUrl:X,...z&&{preselectPlan:z}}}async function io(e,t={},r=2,i=100){let a;for(let n=0;n<=r;n++)try{let o=await fetch(e,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>r)break;await new Promise(s=>setTimeout(s,i*(n+1)))}throw a}var Bi="wcs";function ao({settings:e}){let t=se.module(Bi),{env:r,wcsApiKey:i}=e,a=new Map,n=new Map,o,s=new Map;async function c(h,f,y=!0){let _=ee(),b=Nr;t.debug("Fetching:",h);let x="",v;if(h.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let R=new Map(f),[M]=h.offerSelectorIds,H=Date.now()+Math.random().toString(36).substring(2,7),$=`${Bi}:${M}:${H}${Gr}`,X=`${Bi}:${M}:${H}${Vr}`,z;try{if(performance.mark($),x=new URL(e.wcsURL),x.searchParams.set("offer_selector_ids",M),x.searchParams.set("country",h.country),x.searchParams.set("locale",h.locale),x.searchParams.set("landscape",r===me.STAGE?"ALL":e.landscape),x.searchParams.set("api_key",i),h.language&&x.searchParams.set("language",h.language),h.promotionCode&&x.searchParams.set("promotion_code",h.promotionCode),h.currency&&x.searchParams.set("currency",h.currency),v=await io(x.toString(),{credentials:"omit"}),v.ok){let U=[];try{let k=await v.json();t.debug("Fetched:",h,k),U=k.resolvedOffers??[]}catch(k){t.error(`Error parsing JSON: ${k.message}`,{...k.context,..._?.duration})}U=U.map(Jt),f.forEach(({resolve:k},ae)=>{let he=U.filter(({offerSelectorIds:ye})=>ye.includes(ae)).flat();he.length&&(R.delete(ae),f.delete(ae),k(he))})}else b=Rr}catch(U){b=`Network error: ${U.message}`}finally{z=performance.measure(X,$),performance.clearMarks($),performance.clearMeasures(X)}if(y&&f.size){t.debug("Missing:",{offerSelectorIds:[...f.keys()]});let U=Pa(v);f.forEach(k=>{k.reject(new et(b,{...h,...U,response:v,measure:Ft(z),..._?.duration}))})}}function l(){clearTimeout(o);let h=[...n.values()];n.clear(),h.forEach(({options:f,promises:y})=>c(f,y))}function d(h){if(!h||typeof h!="object")throw new TypeError("Cache must be a Map or similar object");let f=r===me.STAGE?"stage":"prod",y=h[f];if(!y||typeof y!="object"){t.warn(`No cache found for environment: ${r}`);return}for(let[_,b]of Object.entries(y))a.set(_,Promise.resolve(b.map(Jt)));t.debug(`Prefilled WCS cache with ${y.size} entries`)}function u(){let h=a.size;s=new Map(a),a.clear(),t.debug(`Moved ${h} cache entries to stale cache`)}function m(h,f,y){let _=h!=="GB"&&!y?"MULT":"en",b=qr.includes(h)?h:C.country;return{validCountry:b,validLanguage:_,locale:`${f}_${b}`}}function p({country:h,language:f,perpetual:y=!1,promotionCode:_="",wcsOsi:b=[]}){let{validCountry:x,validLanguage:v,locale:R}=m(h,f,y),M=[x,v,_].filter(H=>H).join("-").toLowerCase();return b.map(H=>{let $=`${H}-${M}`;if(a.has($))return a.get($);let X=new Promise((z,U)=>{let k=n.get(M);k||(k={options:{country:x,locale:R,...v==="MULT"&&{language:v},offerSelectorIds:[]},promises:new Map},n.set(M,k)),_&&(k.options.promotionCode=_),k.options.offerSelectorIds.push(H),k.promises.set(H,{resolve:z,reject:U}),l()}).catch(z=>{if(s.has($))return s.get($);throw z});return a.set($,X),X})}return{Commitment:Ce,PlanType:Ta,Term:ne,applyPlanType:Jt,resolveOfferSelectors:p,flushWcsCacheInternal:u,prefillWcsCache:d,normalizeCountryLanguageAndLocale:m}}var no="mas-commerce-service",oo="mas-commerce-service:start",so="mas-commerce-service:ready",Rt,rt,it,co,lo,Ui=class extends HTMLElement{constructor(){super(...arguments);G(this,it);G(this,Rt);G(this,rt);g(this,"lastLoggingTime",0)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(i,a,n)=>{let o=await r?.(i,a,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return A(this,rt)||q(this,rt,{[fe]:Bt(this,it,lo).call(this,fe)}),A(this,rt)}activate(){let r=A(this,it,co),i=ro(r,this);rr(r.lana);let a=se.init(r.hostEnv).module("service");a.debug("Activating:",r);let o={price:cn(i)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:i};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...nn(c),...on(c),...to(c),...ao(c),...jr,Log:se,get defaults(){return C},get log(){return se},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return i}})),a.debug("Activated:",{literals:o,settings:i});let l=new CustomEvent(Ut,{bubbles:!0,cancelable:!1,detail:this});performance.mark(so),q(this,Rt,performance.measure(so,oo)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(oo),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(Er).forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":Ft(A(this,Rt))}}logFailedRequests(){let r=[...performance.getEntriesByType("resource")].filter(({startTime:a})=>a>this.lastLoggingTime).filter(({transferSize:a,duration:n,responseStatus:o})=>a===0&&n===0&&o<200||o>=400),i=Array.from(new Map(r.map(a=>[a.name,a])).values());if(i.some(({name:a})=>/(\/fragment\?|web_commerce_artifact)/.test(a))){let a=i.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:a,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};Rt=new WeakMap,rt=new WeakMap,it=new WeakSet,co=function(){let r=this.getAttribute("env")??"prod",i={commerce:{env:r},hostEnv:{name:r},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:r==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview"].forEach(a=>{let n=this.getAttribute(a);n&&(i[a]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(a=>{let n=this.getAttribute(a);if(n!=null){let o=a.replace(/-([a-z])/g,s=>s[1].toUpperCase());i.commerce[o]=n}}),i},lo=function(r){return["on","true",!0].includes(this.getAttribute(`data-${r}`)||D(r))};window.customElements.get(no)||window.customElements.define(no,Ui);var uo="merch-card-collection",Zc=2e4,Jc={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansThreeColumns:["three-merch-cards"]},el={plans:!0},tl=(e,{filter:t})=>e.filter(r=>r?.filters&&r?.filters.hasOwnProperty(t)),rl=(e,{types:t})=>t?(t=t.split(","),e.filter(r=>t.some(i=>r.types.includes(i)))):e,il=e=>e.sort((t,r)=>(t.title??"").localeCompare(r.title??"","en",{sensitivity:"base"})),al=(e,{filter:t})=>e.sort((r,i)=>i.filters[t]?.order==null||isNaN(i.filters[t]?.order)?-1:r.filters[t]?.order==null||isNaN(r.filters[t]?.order)?1:r.filters[t].order-i.filters[t].order),nl=(e,{search:t})=>t?.length?(t=t.toLowerCase(),e.filter(r=>(r.title??"").toLowerCase().includes(t))):e,_e,nt,Ot,It,gr,fo,at=class extends ho{constructor(){super();G(this,gr);G(this,_e,{});G(this,nt);G(this,Ot);G(this,It);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[]}render(){return be`
    ...
    `);at.SortOrder=de;customElements.define(uo,at);var ol={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},sl=(e,t,r)=>{e.querySelectorAll(`[data-placeholder="${t}"]`).forEach(a=>{a.innerText=r||""})},cl={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},ll={catalog:"l"},te,ot,Nt=class extends ho{constructor(){super();G(this,te);G(this,ot);g(this,"tablet",new ct(this,I));g(this,"desktop",new ct(this,P));this.collection=null,q(this,te,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(ce,this.updateLiterals),this.collection?.addEventListener(dt,this.handleSidenavAttached),q(this,ot,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(ce,this.updateLiterals),this.collection?.removeEventListener(dt,this.handleSidenavAttached)}willUpdate(){A(this,te).search=this.getVisibility("search"),A(this,te).filter=this.getVisibility("filter"),A(this,te).sort=this.getVisibility("sort"),A(this,te).result=this.getVisibility("result"),A(this,te).custom=this.getVisibility("custom")}parseVisibilityOptions(r,i){if(!r||!Object.hasOwn(r,i))return null;let a=r[i];return a===!1?!1:a===!0?!0:a.includes(this.currentMedia)}getVisibility(r){let i=A(this,ot)?.getCollectionOptions(this.collection?.variant)?.headerVisibility,a=this.parseVisibilityOptions(i,r);return a!==null?a:this.parseVisibilityOptions(cl,r)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!A(this,te).search)return pe;let r=mt(this,"searchText");return r?be`
          ...
          `:pe}get filterAction(){return A(this,te).filter?this.sidenav?be`
              <sp-action-button
                id="filter"
                variant="secondary"
                treatment="outline"
              ...
              ></sp-action-button>
          `:pe:pe}get sortAction(){if(!A(this,te).sort)return pe;let r=mt(this,"sortText");if(!r)return;let i=mt(this,"popularityText"),a=mt(this,"alphabeticallyText");if(!(i&&a))return;let n=this.collection?.sort===de.alphabetical;return be`
              <sp-action-menu
                  id="sort"
                  size="m"
          ...
          `}get resultSlotName(){let r=`${this.search?"search":"filters"}${this.isMobile||this.isTablet?"Mobile":""}`;return ol[r][Math.min(this.resultCount,2)]}get resultLabel(){if(!A(this,te).result)return pe;if(!this.sidenav)return pe;let r=this.search?"search":"filter",i=this.resultCount?this.resultCount===1?"single":"multiple":"none";return be`
