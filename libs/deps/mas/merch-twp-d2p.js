...
`;var v="(max-width: 1199px)";var S="merch-card:ready";var T="merch-offer:selected";var _="merch-storage:change",y="merch-quantity-selector:change";var D=":start",P=":ready",F=`mas${D}`,G=`mas${P}`;function L(o=window.location.hash){let t=[],e=o.replace(/^#/,"").split("&");for(let s of e){let[r,n=""]=s.split("=");r&&t.push([r,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(t)}var $="merch-twp-d2p",u="individuals",g="business",C="education",c,E,d,x,m=class extends M{constructor(){super();a(this,"selectedTab",this.preselectedTab());p(this,c);p(this,E);p(this,d);p(this,x,new f(this,v));a(this,"individualsText","Individuals");a(this,"businessText","Business");a(this,"educationText","Students and teachers");a(this,"continueText","Continue");a(this,"ready",!1);this.step=1,b(this,d,this.handleOfferSelected.bind(this)),this.handleWhatsIncludedClick=this.handleWhatsIncludedClick.bind(this)}get log(){return l(this,c)||b(this,c,document.head.querySelector("wcms-commerce")?.Log.module("twp")),l(this,c)}get individualsTab(){return this.cciCards.length===0?i``:i`
