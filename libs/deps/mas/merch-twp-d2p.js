var N=Object.defineProperty;var k=(o,t,e)=>t in o?N(o,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):o[t]=e;var a=(o,t,e)=>(k(o,typeof t!="symbol"?t+"":t,e),e),A=(o,t,e)=>{if(!t.has(o))throw TypeError("Cannot "+e)};var l=(o,t,e)=>(A(o,t,"read from private field"),e?e.call(o):t.get(o)),p=(o,t,e)=>{if(t.has(o))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(o):t.set(o,e)},x=(o,t,e,s)=>(A(o,t,"write to private field"),s?s.call(o,e):t.set(o,e),e);import{LitElement as O,html as i}from"../lit-all.min.js";var f=class{constructor(t,e){this.key=Symbol("match-media-key"),this.matches=!1,this.host=t,this.host.addController(this),this.media=window.matchMedia(e),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),t.addController(this)}hostConnected(){var t;(t=this.media)==null||t.addEventListener("change",this.onChange)}hostDisconnected(){var t;(t=this.media)==null||t.removeEventListener("change",this.onChange)}onChange(t){this.matches!==t.matches&&(this.matches=t.matches,this.host.requestUpdate(this.key,!this.matches))}};import{css as I}from"../lit-all.min.js";var w=I`
    :host {
        display: flex;
...
`;var v="(max-width: 1199px)";var S="merch-card:ready";var T="merch-offer:selected";var _="merch-storage:change",R="merch-quantity-selector:change";function y(o=window.location.hash){let t=[],e=o.replace(/^#/,"").split("&");for(let s of e){let[r,n=""]=s.split("=");r&&t.push([r,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(t)}var P="merch-twp-d2p",u="individuals",g="business",C="education",c,E,d,b,m=class extends O{constructor(){super();a(this,"selectedTab",this.preselectedTab());p(this,c,void 0);p(this,E,void 0);p(this,d,void 0);p(this,b,new f(this,v));a(this,"individualsText","Individuals");a(this,"businessText","Business");a(this,"educationText","Students and teachers");a(this,"continueText","Continue");a(this,"ready",!1);this.step=1,x(this,d,this.handleOfferSelected.bind(this)),this.handleWhatsIncludedClick=this.handleWhatsIncludedClick.bind(this)}get log(){return l(this,c)||x(this,c,document.head.querySelector("wcms-commerce")?.Log.module("twp")),l(this,c)}get individualsTab(){return this.cciCards.length===0?i``:i`
        ...
        `}get showSubscriptionPanelInStep1(){return l(this,b).matches?!1:this.cciCards.length<3}get continueButton(){return this.showSubscriptionPanelInStep1?i``:i`
        ...
        `}selectSingleCard(e){e.setAttribute("data-slot",e.getAttribute("slot")),e.setAttribute("slot","single-card"),this.singleCard=e}unSelectSingleCard(){this.singleCard&&(this.singleCard.setAttribute("slot",this.singleCard.getAttribute("data-slot")),this.singleCard.removeAttribute("data-slot"),this.step=1,this.singleCard=void 0)}handleContinue(){this.step=2,this.selectSingleCard(this.cardToSelect),x(this,E,[...this.singleCard.querySelectorAll("merch-icon")].map(e=>e.cloneNode(!0)))}handleBack(){this.unSelectSingleCard()}get cardToSelect(){return this.selectedTabPanel?.card??this.querySelector("merch-card[aria-selected]")}get selectedCard(){return this.singleCard??this.selectedTabPanel.card}get mobileStepTwo(){return this.singleCard?i`
