var y=Object.defineProperty;var I=(i,t,e)=>t in i?y(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var r=(i,t,e)=>(I(i,typeof t!="symbol"?t+"":t,e),e),A=(i,t,e)=>{if(!t.has(i))throw TypeError("Cannot "+e)};var c=(i,t,e)=>(A(i,t,"read from private field"),e?e.call(i):t.get(i)),p=(i,t,e)=>{if(t.has(i))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(i):t.set(i,e)},b=(i,t,e,s)=>(A(i,t,"write to private field"),s?s.call(i,e):t.set(i,e),e);import{LitElement as P,html as o}from"../lit-all.min.js";var g=class{constructor(t,e){this.key=Symbol("match-media-key"),this.matches=!1,this.host=t,this.host.addController(this),this.media=window.matchMedia(e),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),t.addController(this)}hostConnected(){var t;(t=this.media)==null||t.addEventListener("change",this.onChange)}hostDisconnected(){var t;(t=this.media)==null||t.removeEventListener("change",this.onChange)}onChange(t){this.matches!==t.matches&&(this.matches=t.matches,this.host.requestUpdate(this.key,!this.matches))}};import{css as O}from"../lit-all.min.js";var w=O`
    :host {
        display: flex;
...
`;var R="(max-width: 1199px)";var M='span[is="inline-price"][data-wcs-osi]',k='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var q=`${M},${k}`;var _="merch-card:ready";var T="merch-offer:selected";var S="merch-storage:change",N="merch-quantity-selector:change";function L(i=window.location.hash){let t=[],e=i.replace(/^#/,"").split("&");for(let s of e){let[a,n=""]=s.split("=");a&&t.push([a,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(t)}var D="merch-twp-d2p",u="individuals",f="business",C="education",l,E,d,x,m=class extends P{constructor(){super();r(this,"selectedTab",this.preselectedTab());p(this,l,void 0);p(this,E,void 0);p(this,d,void 0);p(this,x,new g(this,R));r(this,"individualsText","Individuals");r(this,"businessText","Business");r(this,"educationText","Students and teachers");r(this,"continueText","Continue");r(this,"ready",!1);this.step=1,b(this,d,this.handleOfferSelected.bind(this)),this.handleWhatsIncludedClick=this.handleWhatsIncludedClick.bind(this)}get log(){return c(this,l)||b(this,l,document.head.querySelector("wcms-commerce")?.Log.module("twp")),c(this,l)}get individualsTab(){return this.cciCards.length===0?o``:o`
        ...
        `}get showSubscriptionPanelInStep1(){return c(this,x).matches?!1:this.cciCards.length<3}get continueButton(){return this.showSubscriptionPanelInStep1?o``:o`
