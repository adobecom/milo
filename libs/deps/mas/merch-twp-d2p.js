var I=Object.defineProperty;var A=o=>{throw TypeError(o)};var O=(o,t,e)=>t in o?I(o,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):o[t]=e;var r=(o,t,e)=>O(o,typeof t!="symbol"?t+"":t,e),w=(o,t,e)=>t.has(o)||A("Cannot "+e);var c=(o,t,e)=>(w(o,t,"read from private field"),e?e.call(o):t.get(o)),p=(o,t,e)=>t.has(o)?A("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(o):t.set(o,e),b=(o,t,e,s)=>(w(o,t,"write to private field"),s?s.call(o,e):t.set(o,e),e);import{LitElement as D,html as i}from"../lit-all.min.js";var g=class{constructor(t,e){this.key=Symbol("match-media-key"),this.matches=!1,this.host=t,this.host.addController(this),this.media=window.matchMedia(e),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),t.addController(this)}hostConnected(){var t;(t=this.media)==null||t.addEventListener("change",this.onChange)}hostDisconnected(){var t;(t=this.media)==null||t.removeEventListener("change",this.onChange)}onChange(t){this.matches!==t.matches&&(this.matches=t.matches,this.host.requestUpdate(this.key,!this.matches))}};import{css as M}from"../lit-all.min.js";var R=M`
    :host {
        display: flex;
...
`;var N="(max-width: 1199px)";var k='span[is="inline-price"][data-wcs-osi]',P='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var G=`${k},${P}`;var _="merch-card:ready";var T="merch-offer:selected";var S="merch-storage:change",L="merch-quantity-selector:change";function v(o=window.location.hash){let t=[],e=o.replace(/^#/,"").split("&");for(let s of e){let[a,n=""]=s.split("=");a&&t.push([a,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(t)}var $="merch-twp-d2p",u="individuals",f="business",C="education",l,E,d,x,m=class extends D{constructor(){super();r(this,"selectedTab",this.preselectedTab());p(this,l);p(this,E);p(this,d);p(this,x,new g(this,N));r(this,"individualsText","Individuals");r(this,"businessText","Business");r(this,"educationText","Students and teachers");r(this,"continueText","Continue");r(this,"ready",!1);this.step=1,b(this,d,this.handleOfferSelected.bind(this)),this.handleWhatsIncludedClick=this.handleWhatsIncludedClick.bind(this)}get log(){return c(this,l)||b(this,l,document.head.querySelector("wcms-commerce")?.Log.module("twp")),c(this,l)}get individualsTab(){return this.cciCards.length===0?i``:i`
        ...
        `}get showSubscriptionPanelInStep1(){return c(this,x).matches?!1:this.cciCards.length<3}get continueButton(){return this.showSubscriptionPanelInStep1?i``:i`
