var $o=Object.defineProperty;var Or=e=>{throw TypeError(e)};var Vo=(e,t,r)=>t in e?$o(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var f=(e,t,r)=>Vo(e,typeof t!="symbol"?t+"":t,r),Lt=(e,t,r)=>t.has(e)||Or("Cannot "+r);var g=(e,t,r)=>(Lt(e,t,"read from private field"),r?r.call(e):t.get(e)),P=(e,t,r)=>t.has(e)?Or("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),L=(e,t,r,n)=>(Lt(e,t,"write to private field"),n?n.call(e,r):t.set(e,r),r),F=(e,t,r)=>(Lt(e,t,"access private method"),r);import{LitElement as ms}from"../lit-all.min.js";import{LitElement as jo,html as Ir,css as Yo}from"../lit-all.min.js";var h=class extends jo{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:t}=this;return t?Ir`<a href="${t}">
                  <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />
              </a>`:Ir` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};f(h,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),f(h,"styles",Yo`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
      ...
      `];import{html as et}from"../lit-all.min.js";var he,Oe=class Oe{constructor(t){f(this,"card");P(this,he);this.card=t,this.insertVariantStyle()}getContainer(){return L(this,he,g(this,he)??this.card.closest('[class*="-merch-cards"]')??this.card.parentElement),g(this,he)}insertVariantStyle(){if(!Oe.styleMap[this.card.variant]){Oe.styleMap[this.card.variant]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(t,r){if(!t)return;let n=`--consonant-merch-card-${this.card.variant}-${r}-height`,o=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),a=parseInt(this.getContainer().style.getPropertyValue(n))||0;o>a&&this.getContainer().style.setProperty(n,`${o}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),et`
        ...
        `}get cardImage(){return et` <div class="image">
            ...
            ${this.badge}
              ...
              >`:"";return et`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){}};he=new WeakMap,f(Oe,"styleMap",{});var S=Oe;import{html as It,css as Wo}from"../lit-all.min.js";var Ct="wcms:commerce:ready";var Rt='span[is="inline-price"][data-wcs-osi]',tt='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',Ur="sp-button[data-wcs-osi]",zr=`${Rt},${tt}`;var Gr="merch-offer-select:ready",Fr="merch-card:ready",$r="merch-card:action-menu-toggle";var Nt="merch-storage:change",Mt="merch-quantity-selector:change";var de="aem:load",me="aem:error",Vr="mas:ready",jr="mas:error";var Yr="mas/commerce";var Ot={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},Wr="X-Request-Id",Xr="mas-commerce-service:initTime";var Ie=":start",qr=":duration";function Q(e,t={},r=null,n=null){let o=n?document.createElement(e,{is:n}):document.createElement(e);r instanceof HTMLElement?o.appendChild(r):o.innerHTML=r;for(let[a,i]of Object.entries(t))o.setAttribute(a,i);return o}function rt(){return window.matchMedia("(max-width: 767px)").matches}function Kr(){return window.matchMedia("(max-width: 1024px)").matches}function nt(){let e=document.querySelector("mas-commerce-service");return e?{[Xr]:e.initDuration}:{}}var Zr=`
:root {
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return Zr}setAriaExpanded(r,n){r.setAttribute("aria-expanded",n)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};f(ue,"variantStyle",Wo`
...
`;var at=class extends S{constructor(t){super(t)}getGlobalCSS(){return Jr}renderLayout(){return en` ${this.badge}
    ...
    ${this.card.customHr?"":en`<hr />`} ${this.secureLabelFooter}`}};import{html as pe,css as Xo,unsafeCSS as rn}from"../lit-all.min.js";var tn=`
  :root {
...
`;var qo=32,fe=class extends S{constructor(r){super(r);f(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);f(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?pe`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){rt()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};f(fe,"variantStyle",Xo`
...
`;var J=class extends S{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return an}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return Bt` ${this.badge}
      ...
      ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}postCardUpdateHook(){this.card.isConnected&&(rt()||this.adjustProductBodySlots(),this.adjustTitleWidth())}};f(J,"variantStyle",Zo`
...
`;var $t={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color"},allowedColors:{gray:"--spectrum-gray-100"},size:["single","double","triple"]},ee=class extends S{getGlobalCSS(){return mn}get aemFragmentMapping(){return $t}renderLayout(){return ia`
  ...
  `);customElements.define("ah-try-buy-widget",ee);var Vt=(e,t=!1)=>{switch(e.variant){case"catalog":return new ue(e);case"image":return new ot(e);case"inline-heading":return new at(e);case"mini-compare-chart":return new fe(e);case"plans":return new ge(e);case"product":return new J(e);case"segment":return new xe(e);case"special-offers":return new be(e);case"twp":return new ye(e);case"ccd-suggested":return new ve(e);case"ccd-slice":return new Ee(e);case"ah-try-buy-widget":return new ee(e);default:return t?void 0:new J(e)}},un={catalog:kt,image:null,"inline-heading":null,"mini-compare-chart":null,plans:Ht,product:null,segment:null,"special-offers":zt,twp:null,"ccd-suggested":Gt,"ccd-slice":Ft,"ah-try-buy-widget":$t},pn=()=>{let e=[];return e.push(ue.variantStyle),e.push(fe.variantStyle),e.push(J.variantStyle),e.push(ge.variantStyle),e.push(xe.variantStyle),e.push(be.variantStyle),e.push(ye.variantStyle),e.push(ve.variantStyle),e.push(Ee.variantStyle),e.push(ee.variantStyle),e};var fn=document.createElement("style");fn.innerHTML=`
:root {
