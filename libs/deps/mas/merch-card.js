...
`,U=()=>{let c=[_`
    ...
    `),c};var[V,W,G,K,Y,Be]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Q=document.createElement("style");Q.innerHTML=`
:root {
