...
`;var Nt=class extends f{constructor(e){super(e)}getGlobalCSS(){return Ae}renderLayout(){return ft`${this.cardImage}
    <div class="body">
    ...
    ${this.evergreen?ft`
          ...
          `:ft`
              <hr />
              ${this.secureLabelFooter}
          `}`}};import{html as Ce}from"../lit-all.min.js";var Te=`
:root {
...
`;var Ot=class extends f{constructor(e){super(e)}getGlobalCSS(){return Te}renderLayout(){return Ce` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":Ce`<hr />`} ${this.secureLabelFooter}`}};import{html as ot,css as ir,unsafeCSS as jt}from"../lit-all.min.js";var ke=`
  :root {
...
`;var cr=32,nt=class extends f{constructor(t){super(t);d(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);d(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?ot`<slot name="secure-transaction-label">
  ...
  `);import{html as B,css as sr,nothing as xt}from"../lit-all.min.js";var _e=`
:root {
...
`;var zt={title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant"},Le={...function(){let{whatsIncluded:o,size:e,...t}=zt;return t}(),title:{tag:"h3",slot:"heading-s"},subtitle:{tag:"p",slot:"subtitle"},secureLabel:!1},Re={...function(){let{whatsIncluded:o,size:e,quantitySelect:t,...r}=zt;return r}()},w=class extends f{constructor(e){super(e),this.adaptForMobile=this.adaptForMobile.bind(this)}priceOptionsProvider(e,t){e.dataset.template===ve&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return _e}adaptForMobile(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}let e=this.card.shadowRoot,t=e.querySelector("footer"),r=this.card.getAttribute("size"),n=e.querySelector("footer #stock-checkbox"),a=e.querySelector(".body #stock-checkbox"),i=e.querySelector(".body");if(!r||!r.includes("wide")){t?.classList.remove("wide-footer"),n&&n.remove();return}let s=Q();if(t?.classList.toggle("wide-footer",!s),s&&n){a?n.remove():i.appendChild(n);return}!s&&a&&(n?a.remove():t.prepend(a))}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.remove("hide-tooltip")}))}postCardUpdateHook(){this.adaptForMobile(),this.adjustTitleWidth(),this.adjustLegal(),this.adjustAddon(),this.adjustCallout()}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${v}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?B`<div class="divider"></div>`:xt}async adjustLegal(){if(await this.card.updateComplete,this.legalAdjusted)return;this.legalAdjusted=!0;let e=[],t=this.card.querySelector(`[slot="heading-m"] ${v}[data-template="price"]`);t&&e.push(t),this.card.querySelectorAll(`[slot="body-xs"] ${v}[data-template="price"]`).forEach(a=>e.push(a));let n=e.map(async a=>{let i=a.cloneNode(!0);await a.onceSettled(),a?.options&&(a.options.displayPerUnit&&(a.dataset.displayPerUnit="false"),a.options.displayTax&&(a.dataset.displayTax="false"),a.options.displayPlanType&&(a.dataset.displayPlanType="false"),i.setAttribute("data-template","legal"),a.parentNode.insertBefore(i,a.nextSibling))});await Promise.all(n)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;let t=this.mainPrice;if(!t)return;await t.onceSettled();let r=t.value?.[0]?.planType;r&&(e.planType=r)}get stockCheckbox(){return this.card.checkboxLabel?B`<label id="stock-checkbox">
    ...
    `),d(w,"collectionOptions",{customHeaderArea:e=>e.sidenav?B`<slot name="resultsText"></slot>`:xt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]}});import{html as Gt,css as dr}from"../lit-all.min.js";var Me=`
:root {
...
`;var H=class extends f{constructor(e){super(e),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Me}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return Gt` ${this.badge}
...
Caused by: ${this.cause}`),t}};var pr={requestId:Ct,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function Ie(o){let e={};if(!o?.headers)return e;let t=o.headers;for(let[r,n]of Object.entries(pr)){let a=t.get(n);a&&(a=a.replace(/[,;]/g,"|"),a=a.replace(/[| ]+/g,"|"),e[r]=a)}return e}async function De(o,e={},t=2,r=100){let n;for(let a=0;a<=t;a++)try{let i=await fetch(o,e);return i.retryCount=a,i}catch(i){if(n=i,n.retryCount=a,a>t)break;await new Promise(s=>setTimeout(s,r*(a+1)))}throw n}var Fe="fragment",Be="author",He="preview",Xt="aem-fragment",N,Zt=class{constructor(){m(this,N,new Map)}clear(){c(this,N).clear()}addByRequestedId(e,t){c(this,N).set(e,t)}put(e,t){c(this,N).set(e,t)}add(...e){e.forEach(t=>{let{id:r}=t;r&&c(this,N).set(r,t)})}has(e){return c(this,N).has(e)}get(e){return c(this,N).get(e)}remove(e){c(this,N).delete(e)}};N=new WeakMap;var $t=new Zt,ct,O,z,x,C,A,_,vt,yt,st,L,Ue,qe,te,je,Jt=class extends HTMLElement{constructor(){super(...arguments);m(this,L);d(this,"cache",$t);m(this,ct);m(this,O,null);m(this,z,null);m(this,x,{url:null,retryCount:0,stale:!1,measure:null,status:null});m(this,C,null);m(this,A);m(this,_);m(this,vt,!1);m(this,yt,0);m(this,st)}static get observedAttributes(){return[Fe,Be,He]}attributeChangedCallback(t,r,n){t===Fe&&h(this,A,n),t===Be&&h(this,vt,["","true"].includes(n)),t===He&&h(this,st,n)}connectedCallback(){if(!c(this,_)){if(c(this,C)??h(this,C,Z(this)),h(this,st,c(this,C).settings?.preview),c(this,ct)??h(this,ct,c(this,C).log.module(`${Xt}[${c(this,A)}]`)),!c(this,A)||c(this,A)==="#"){S(this,L,te).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,x)).filter(([t,r])=>r!=null).map(([t,r])=>[`aem-fragment:${t}`,r]))}async refresh(t=!0){if(c(this,_)&&!await Promise.race([c(this,_),Promise.resolve(!1)]))return;t&&$t.remove(c(this,A));try{h(this,_,S(this,L,je).call(this)),await c(this,_)}catch(s){return S(this,L,te).call(this,s.message),!1}let{references:r,referencesTree:n,placeholders:a,wcs:i}=c(this,O)||{};return i&&!$e("mas.disableWcsCache")&&c(this,C).prefillWcsCache(i),this.dispatchEvent(new CustomEvent(K,{detail:{...this.data,references:r,referencesTree:n,placeholders:a,...c(this,x)},bubbles:!0,composed:!0})),c(this,_)}get updateComplete(){return c(this,_)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,z)?c(this,z):(c(this,vt)?this.transformAuthorData():this.transformPublishData(),c(this,z))}transformAuthorData(){let{fields:t,id:r,tags:n,settings:a={}}=c(this,O);h(this,z,t.reduce((i,{name:s,multiple:l,values:p})=>(i.fields[s]=l?p:p[0],i),{fields:{},id:r,tags:n,settings:a}))}transformPublishData(){let{fields:t,id:r,tags:n,settings:a={}}=c(this,O);h(this,z,Object.entries(t).reduce((i,[s,l])=>(i.fields[s]=l?.mimeType?l.value:l??"",i),{fields:{},id:r,tags:n,settings:a}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let n=r.trim().toLowerCase();if(n==="local")return"http://localhost:3030/studio/libs/fragment-client.js";if(n==="main")return"https://mas.adobe.com/studio/libs/fragment-client.js";let{hostname:a}=window.location,i=a.endsWith(".page")?"page":"live";return n.includes("--mas--")?`https://${n}.aem.${i}/studio/libs/fragment-client.js`:n.includes("--")?`https://${n}.aem.${i}/studio/libs/fragment-client.js`:`https://${n}--mas--adobecom.aem.${i}/studio/libs/fragment-client.js`}async generatePreview(){let t=this.getFragmentClientUrl(),{previewFragment:r}=await import(t);return await r(c(this,A),{locale:c(this,C).settings.locale,apiKey:c(this,C).settings.wcsApiKey})}};ct=new WeakMap,O=new WeakMap,z=new WeakMap,x=new WeakMap,C=new WeakMap,A=new WeakMap,_=new WeakMap,vt=new WeakMap,yt=new WeakMap,st=new WeakMap,L=new WeakSet,Ue=async function(t){ce(this,yt)._++;let r=`${Xt}:${c(this,A)}:${c(this,yt)}`,n=`${r}${kt}`,a=`${r}${_t}`;if(c(this,st))return await this.generatePreview();performance.mark(n);let i;try{if(c(this,x).stale=!1,c(this,x).url=t,i=await De(t,{cache:"default",credentials:"omit"}),S(this,L,qe).call(this,i),c(this,x).status=i?.status,c(this,x).measure=X(performance.measure(a,n)),c(this,x).retryCount=i.retryCount,!i?.ok)throw new bt("Unexpected fragment response",{response:i,...c(this,C).duration});return await i.json()}catch(s){if(c(this,x).measure=X(performance.measure(a,n)),c(this,x).retryCount=s.retryCount,c(this,O))return c(this,x).stale=!0,c(this,ct).error("Serving stale data",c(this,x)),c(this,O);let l=s.message??"unknown";throw new bt(`Failed to fetch fragment: ${l}`,{})}},qe=function(t){Object.assign(c(this,x),Ie(t))},te=function(t){h(this,_,null),c(this,x).message=t,this.classList.add("error");let r={...c(this,x),...c(this,C).duration};c(this,ct).error(t,r),this.dispatchEvent(new CustomEvent(W,{detail:r,bubbles:!0,composed:!0}))},je=async function(){this.classList.remove("error"),h(this,z,null);let t=$t.get(c(this,A));if(t)return h(this,O,t),!0;let{masIOUrl:r,wcsApiKey:n,locale:a}=c(this,C).settings,i=`${r}/fragment?id=${c(this,A)}&api_key=${n}&locale=${a}`;return t=await S(this,L,Ue).call(this,i),$t.addByRequestedId(c(this,A),t),h(this,O,t),!0};customElements.define(Xt,Jt);import{LitElement as gr,html as ur,css as fr}from"../lit-all.min.js";var dt=class extends gr{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return ur`<div class="badge">
    ...
    `);customElements.define("merch-badge",dt);import{html as xr,css as br,LitElement as vr}from"../lit-all.min.js";var Et=class extends vr{constructor(){super()}render(){return xr`
            <slot name="icon"></slot>
