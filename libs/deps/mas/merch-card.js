var vo=Object.defineProperty;var ur=e=>{throw TypeError(e)};var Eo=(e,t,r)=>t in e?vo(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var f=(e,t,r)=>Eo(e,typeof t!="symbol"?t+"":t,r),pt=(e,t,r)=>t.has(e)||ur("Cannot "+r);var X=(e,t,r)=>(pt(e,t,"read from private field"),r?r.call(e):t.get(e)),ie=(e,t,r)=>t.has(e)?ur("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),Ue=(e,t,r,n)=>(pt(e,t,"write to private field"),n?n.call(e,r):t.set(e,r),r),ft=(e,t,r)=>(pt(e,t,"access private method"),r);import{LitElement as Na}from"../lit-all.min.js";import{LitElement as yo,html as pr,css as So}from"../lit-all.min.js";var d=class extends yo{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:t}=this;return t?pr`<a href="${t}">
                  <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />
              </a>`:pr` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};f(d,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),f(d,"styles",So`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
