...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return $r}setAriaExpanded(r,n){r.setAttribute("aria-expanded",n)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};f(pe,"variantStyle",Ho`
...
`;var Ze=class extends A{constructor(t){super(t)}getGlobalCSS(){return Vr}renderLayout(){return Br` ${this.badge}
    ...
    ${this.card.customHr?"":Br`<hr />`} ${this.secureLabelFooter}`}};import{html as fe,css as Vo,unsafeCSS as Wr}from"../lit-all.min.js";var jr=`
  :root {
...
`;var Bo=32,ge=class extends A{constructor(r){super(r);f(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);f(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?fe`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){Ke()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};f(ge,"variantStyle",Vo`
...
`;var xe=class extends A{constructor(t){super(t)}getGlobalCSS(){return Yr}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?Je`<label id="stock-checkbox">
        ...
        ${this.secureLabelFooter}`}};f(xe,"variantStyle",jo`
    :host([variant='plans']) {
      min-height: 348px;
    }
...
`;var ye=class extends A{constructor(t){super(t)}getGlobalCSS(){return Xr}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Ct` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var Rt={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},be=class extends A{constructor(t){super(t)}getGlobalCSS(){return Kr}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return Rt}renderLayout(){return Nt`${this.cardImage}
            ...
            ${this.evergreen?Nt`
                  ...
                  `:Nt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};f(be,"variantStyle",qo`
...
`;var ve=class extends A{constructor(t){super(t)}getGlobalCSS(){return Qr}renderLayout(){return Xo`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
      ...
      <footer><slot name="footer"></slot></footer>`}};f(ve,"variantStyle",Ko`
    :host([variant='twp']) {
      padding: 4px 10px 5px 10px;
    }
    .twp-badge {
...
`;var Ot={backgroundImage:{attribute:"background-image"},badge:!0,ctas:{slot:"cta",size:"M"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"p",slot:"price"},size:[],subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"}},Ee=class extends A{getGlobalCSS(){return Zr}get aemFragmentMapping(){return Ot}get stripStyle(){return this.card.backgroundImage?`
        ...
        `:""}renderLayout(){return Qo` <div style="${this.stripStyle}" class="body">
            ...
            <slot></slot>`}postCardUpdateHook(t){t.has("backgroundImage")&&this.styleBackgroundImage()}styleBackgroundImage(){if(this.card.classList.remove("thin-strip"),this.card.classList.remove("wide-strip"),!this.card.backgroundImage)return;let t=new Image;t.src=this.card.backgroundImage,t.onload=()=>{t.width>8?this.card.classList.add("wide-strip"):t.width===8&&this.card.classList.add("thin-strip")}}};f(Ee,"variantStyle",Zo`
...
`;var Mt={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},we=class extends A{getGlobalCSS(){return Jr}get aemFragmentMapping(){return Mt}renderLayout(){return Jo` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
            ...
            <slot></slot>`}};f(we,"variantStyle",ea`
        :host([variant='ccd-slice']) {
    ...
    `);var kt=(e,t=!1)=>{switch(e.variant){case"catalog":return new pe(e);case"image":return new Qe(e);case"inline-heading":return new Ze(e);case"mini-compare-chart":return new ge(e);case"plans":return new xe(e);case"product":return new Z(e);case"segment":return new ye(e);case"special-offers":return new be(e);case"twp":return new ve(e);case"ccd-suggested":return new Ee(e);case"ccd-slice":return new we(e);default:return t?void 0:new Z(e)}},en={catalog:Pt,image:null,"inline-heading":null,"mini-compare-chart":null,plans:null,product:null,segment:null,"special-offers":Rt,twp:null,"ccd-suggested":Ot,"ccd-slice":Mt},tn=()=>{let e=[];return e.push(pe.variantStyle),e.push(ge.variantStyle),e.push(Z.variantStyle),e.push(xe.variantStyle),e.push(ye.variantStyle),e.push(be.variantStyle),e.push(ve.variantStyle),e.push(Ee.variantStyle),e.push(we.variantStyle),e};var rn=document.createElement("style");rn.innerHTML=`
:root {
