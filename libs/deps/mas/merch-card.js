var jr=Object.defineProperty;var Ne=o=>{throw TypeError(o)};var Gr=(o,e,t)=>e in o?jr(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var l=(o,e,t)=>Gr(o,typeof e!="symbol"?e+"":e,t),le=(o,e,t)=>e.has(o)||Ne("Cannot "+t);var c=(o,e,t)=>(le(o,e,"read from private field"),t?t.call(o):e.get(o)),u=(o,e,t)=>e.has(o)?Ne("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(o):e.set(o,t),h=(o,e,t,r)=>(le(o,e,"write to private field"),r?r.call(o,t):e.set(o,t),t),w=(o,e,t)=>(le(o,e,"access private method"),t);var $e=(o,e,t,r)=>({set _(n){h(o,e,n,t)},get _(){return c(o,e,r)}});import{LitElement as mn}from"../lit-all.min.js";import{css as Ie,unsafeCSS as ze}from"../lit-all.min.js";var C="(max-width: 767px)",Ft="(max-width: 1199px)",b="(min-width: 768px)",f="(min-width: 1200px)",N="(min-width: 1600px)";function Bt(){return window.matchMedia(C)}function Ut(){return window.matchMedia(f)}function Ht(){return Bt().matches}function qt(){return Ut().matches}var De=Ie`
    :host {
...
`;var Jt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},sr={...function(){let{whatsIncluded:o,size:e,...t}=Jt;return t}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},lr={...function(){let{subtitle:o,whatsIncluded:e,size:t,quantitySelect:r,...n}=Jt;return n}()},A=class extends v{constructor(e){super(e),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,t){e.dataset.template===Ze&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return cr}adjustSlotPlacement(e,t,r){let n=this.card.shadowRoot,a=n.querySelector("footer"),i=this.card.getAttribute("size"),s=n.querySelector(`footer slot[name="${e}"]`),d=n.querySelector(`.body slot[name="${e}"]`),m=n.querySelector(".body");if((!i||!i.includes("wide"))&&(a?.classList.remove("wide-footer"),s&&s.remove()),!!t.includes(i)){if(a?.classList.toggle("wide-footer",qt()),!r&&s){if(d)s.remove();else{let p=m.querySelector(`[data-placeholder-for="${e}"]`);p?p.replaceWith(s):m.appendChild(s)}return}if(r&&d){let p=document.createElement("div");if(p.setAttribute("data-placeholder-for",e),p.classList.add("slot-placeholder"),!s){let g=d.cloneNode(!0);a.prepend(g)}d.replaceWith(p)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],qt()),this.adjustSlotPlacement("callout-content",["super-wide"],qt())}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.remove("hide-tooltip")}))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let t=this.card.querySelector('[slot="body-xs"]');if(!t)return;let r=t.querySelector("ul");if(!r)return;let n=r.previousElementSibling,a=document.createElement("div");a.classList.add("spacer"),t.insertBefore(a,n);let i=new IntersectionObserver(([s])=>{if(s.boundingClientRect.height===0)return;let d=0,m=this.card.querySelector('[slot="heading-s"]');m&&(d+=Tt(m));let p=this.card.querySelector('[slot="subtitle"]');p&&(d+=Tt(p));let g=this.card.querySelector('[slot="heading-m"]');g&&(d+=8+Tt(g));for(let ot of t.childNodes){if(ot.classList.contains("spacer"))break;d+=Tt(ot)}let k=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");d>(parseFloat(k)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${d}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${d}px`),i.disconnect()});i.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists())}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${x}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Pt`<div class="divider"></div>`:Zt}async adjustLegal(){if(this.legalAdjusted)return;this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],t=this.card.querySelector(`[slot="heading-m"] ${x}[data-template="price"]`);t&&e.push(t);let r=e.map(async n=>{let a=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),n.parentNode.insertBefore(a,n.nextSibling),await a.onceSettled())});await Promise.all(r)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled();let r=t.value?.[0]?.planType;r&&(e.planType=r)}get stockCheckbox(){return this.card.checkboxLabel?Pt`<label id="stock-checkbox">
    ...
    `),l(A,"collectionOptions",{customHeaderArea:e=>e.sidenav?Pt`<slot name="resultsText"></slot>`:Zt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]}});import{html as ue,css as no}from"../lit-all.min.js";var dr=`
:root {
...
`;var ut=class extends v{constructor(e){super(e),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return dr}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return ue` ${this.badge}
...
`;var gt=class extends v{constructor(e){super(e)}getGlobalCSS(){return hr}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return ge` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var pr={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ft=class extends v{constructor(e){super(e)}getGlobalCSS(){return mr}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return fe`${this.cardImage}
    ...
    `);import{css as co,html as so}from"../lit-all.min.js";var ur=`
...
`;var gr={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},xt=class extends v{constructor(){super(...arguments);l(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return ur}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${x}[data-template="price"]`);if(!t)return;let r=t.cloneNode(!0);this.legal=r,t.dataset.displayTax="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return so`
            ${this.badge}
            <div class="body">
    ...
    `);var xe=new Map,L=(o,e,t=null,r=null,n)=>{xe.set(o,{class:e,fragmentMapping:t,style:r,collectionOptions:n})};L("catalog",ht,rr,ht.variantStyle);L("image",Qt);L("inline-heading",Xt);L("mini-compare-chart",pt,null,pt.variantStyle);L("plans",A,Jt,A.variantStyle,A.collectionOptions);L("plans-students",A,lr,A.variantStyle,A.collectionOptions);L("plans-education",A,sr,A.variantStyle,A.collectionOptions);L("product",ut,null,ut.variantStyle);L("segment",gt,null,gt.variantStyle);L("special-offers",ft,pr,ft.variantStyle);L("mini",xt,gr,xt.variantStyle);var be=o=>{let e=xe.get(o.variant);if(!e)return;let{class:t,style:r}=e;if(r)try{let n=new CSSStyleSheet;n.replaceSync(r.cssText),o.shadowRoot.adoptedStyleSheets.push(n)}catch{let a=document.createElement("style");a.textContent=r.cssText,o.shadowRoot.appendChild(a)}return new t(o)};function Wt(o){return xe.get(o)?.fragmentMapping}var fr=document.createElement("style");fr.innerHTML=`
:root {
...
Caused by: ${this.cause}`),t}};var mo="mas-commerce-service",po={requestId:jt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var re=o=>window.setTimeout(o);function ye(){return document.getElementsByTagName(mo)?.[0]}function br(o){let e={};if(!o?.headers)return e;let t=o.headers;for(let[r,n]of Object.entries(po)){let a=t.get(n);a&&(a=a.replace(/[,;]/g,"|"),a=a.replace(/[| ]+/g,"|"),e[r]=a)}return e}async function vr(o,e={},t=2,r=100){let n;for(let a=0;a<=t;a++)try{let i=await fetch(o,e);return i.retryCount=a,i}catch(i){if(n=i,n.retryCount=a,a>t)break;await new Promise(s=>setTimeout(s,r*(a+1)))}throw n}var yr="fragment",Er="author",wr="preview",Sr="loading",Ar="timeout",Ee="aem-fragment",Tr="eager",kr="cache",uo=[Tr,kr],$,W,R,we=class{constructor(){u(this,$,new Map);u(this,W,new Map);u(this,R,new Map)}clear(){c(this,$).clear(),c(this,W).clear(),c(this,R).clear()}add(e){if(!this.has(e.id)&&!this.has(e.fields?.originalId)){if(c(this,$).set(e.id,e),e.fields?.originalId&&c(this,$).set(e.fields.originalId,e),c(this,R).has(e.id)){let[,t]=c(this,R).get(e.id);t()}if(c(this,R).has(e.fields?.originalId)){let[,t]=c(this,R).get(e.fields?.originalId);t()}if(e.references)for(let t in e.references){let{type:r,value:n}=e.references[t];r==="content-fragment"&&(n.settings={...e?.settings,...n.settings},n.placeholders={...e?.placeholders,...n.placeholders},n.dictionary={...e?.dictionary,...n.dictionary},n.priceLiterals={...e?.priceLiterals,...n.priceLiterals},this.add(n,e))}}}has(e){return c(this,$).has(e)}entries(){return c(this,$).entries()}get(e){return c(this,$).get(e)}getAsPromise(e){let[t]=c(this,R).get(e)??[];if(t)return t;let r;return t=new Promise(n=>{r=n,this.has(e)&&n()}),c(this,R).set(e,[t,r]),t}getFetchInfo(e){let t=c(this,W).get(e);return t||(t={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,W).set(e,t)),t}remove(e){c(this,$).delete(e),c(this,W).delete(e),c(this,R).delete(e)}};$=new WeakMap,W=new WeakMap,R=new WeakMap;var q=new we,bt,z,D,_,T,y,Mt,Ot,P,Nt,$t,vt,M,Cr,Lr,Se,_r,oe=class extends HTMLElement{constructor(){super(...arguments);u(this,M);l(this,"cache",q);u(this,bt);u(this,z,null);u(this,D,null);u(this,_,null);u(this,T);u(this,y);u(this,Mt,Tr);u(this,Ot,5e3);u(this,P);u(this,Nt,!1);u(this,$t,0);u(this,vt)}static get observedAttributes(){return[yr,Sr,Ar,Er,wr]}attributeChangedCallback(t,r,n){t===yr&&(h(this,T,n),h(this,y,q.getFetchInfo(n))),t===Sr&&uo.includes(n)&&h(this,Mt,n),t===Ar&&h(this,Ot,parseInt(n,10)),t===Er&&h(this,Nt,["","true"].includes(n)),t===wr&&h(this,vt,n)}connectedCallback(){if(!c(this,P)){if(c(this,_)??h(this,_,V(this)),h(this,vt,c(this,_).settings?.preview),c(this,bt)??h(this,bt,c(this,_).log.module(`${Ee}[${c(this,T)}]`)),!c(this,T)||c(this,T)==="#"){c(this,y)??h(this,y,q.getFetchInfo("missing-fragment-id")),w(this,M,Se).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,y)).filter(([t,r])=>r!=null).map(([t,r])=>[`aem-fragment:${t}`,r]))}async refresh(t=!0){if(c(this,P)&&!await Promise.race([c(this,P),Promise.resolve(!1)]))return;t&&q.remove(c(this,T)),c(this,Mt)===kr&&await Promise.race([q.getAsPromise(c(this,T)),new Promise(s=>setTimeout(s,c(this,Ot)))]);try{h(this,P,w(this,M,_r).call(this)),await c(this,P)}catch(s){return w(this,M,Se).call(this,s.message),!1}let{references:r,referencesTree:n,placeholders:a,wcs:i}=c(this,z)||{};return i&&!te("mas.disableWcsCache")&&c(this,_).prefillWcsCache(i),this.dispatchEvent(new CustomEvent(at,{detail:{...this.data,references:r,referencesTree:n,placeholders:a,...c(this,y)},bubbles:!0,composed:!0})),c(this,P)}get updateComplete(){return c(this,P)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,D)?c(this,D):(c(this,Nt)?this.transformAuthorData():this.transformPublishData(),c(this,D))}transformAuthorData(){let{fields:t,id:r,tags:n,settings:a={},priceLiterals:i={},dictionary:s={},placeholders:d={}}=c(this,z);h(this,D,t.reduce((m,{name:p,multiple:g,values:k})=>(m.fields[p]=g?k:k[0],m),{fields:{},id:r,tags:n,settings:a,priceLiterals:i,dictionary:s,placeholders:d}))}transformPublishData(){let{fields:t,id:r,tags:n,settings:a={},priceLiterals:i={},dictionary:s={},placeholders:d={}}=c(this,z);h(this,D,Object.entries(t).reduce((m,[p,g])=>(m.fields[p]=g?.mimeType?g.value:g??"",m),{fields:{},id:r,tags:n,settings:a,priceLiterals:i,dictionary:s,placeholders:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let n=r.trim().toLowerCase();if(n==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:a}=window.location,i=a.endsWith(".page")?"page":"live";return n.includes("--")?`https://${n}.aem.${i}/studio/libs/fragment-client.js`:`https://${n}--mas--adobecom.aem.${i}/studio/libs/fragment-client.js`}async generatePreview(){let t=this.getFragmentClientUrl(),{previewFragment:r}=await import(t);return await r(c(this,T),{locale:c(this,_).settings.locale,apiKey:c(this,_).settings.wcsApiKey})}};bt=new WeakMap,z=new WeakMap,D=new WeakMap,_=new WeakMap,T=new WeakMap,y=new WeakMap,Mt=new WeakMap,Ot=new WeakMap,P=new WeakMap,Nt=new WeakMap,$t=new WeakMap,vt=new WeakMap,M=new WeakSet,Cr=async function(t){$e(this,$t)._++;let r=`${Ee}:${c(this,T)}:${c(this,$t)}`,n=`${r}${Gt}`,a=`${r}${Vt}`;if(c(this,vt))return await this.generatePreview();performance.mark(n);let i;try{if(c(this,y).stale=!1,c(this,y).url=t,i=await vr(t,{cache:"default",credentials:"omit"}),w(this,M,Lr).call(this,i),c(this,y).status=i?.status,c(this,y).measure=ct(performance.measure(a,n)),c(this,y).retryCount=i.retryCount,!i?.ok)throw new K("Unexpected fragment response",{response:i,...c(this,_).duration});return await i.json()}catch(s){if(c(this,y).measure=ct(performance.measure(a,n)),c(this,y).retryCount=s.retryCount,c(this,z))return c(this,y).stale=!0,c(this,bt).error("Serving stale data",c(this,y)),c(this,z);let d=s.message??"unknown";throw new K(`Failed to fetch fragment: ${d}`,{})}},Lr=function(t){Object.assign(c(this,y),br(t))},Se=function(t){h(this,P,null),c(this,y).message=t,this.classList.add("error");let r={...c(this,y),...c(this,_).duration};c(this,bt).error(t,r),this.dispatchEvent(new CustomEvent(it,{detail:r,bubbles:!0,composed:!0}))},_r=async function(){var s;this.classList.remove("error"),h(this,D,null);let t=q.get(c(this,T));if(t)return h(this,z,t),!0;let{masIOUrl:r,wcsApiKey:n,locale:a}=c(this,_).settings,i=`${r}/fragment?id=${c(this,T)}&api_key=${n}&locale=${a}`;return t=await w(this,M,Cr).call(this,i),(s=t.fields).originalId??(s.originalId=c(this,T)),q.add(t),h(this,z,t),!0},l(oe,"cache",q);customElements.define(Ee,oe);import{LitElement as go,html as fo,css as xo}from"../lit-all.min.js";var yt=class extends go{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return fo`<div class="badge">
    ...
    `);customElements.define("merch-badge",yt);import{html as bo,css as vo,LitElement as yo}from"../lit-all.min.js";var zt=class extends yo{constructor(){super()}render(){return bo`
            <slot name="icon"></slot>
    ...
    `),l(zt,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",zt);import{html as Ae,css as Eo,LitElement as wo}from"../lit-all.min.js";var It=class extends wo{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((e,t)=>{t>=5&&(e.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Ae`<slot name="heading"></slot>
