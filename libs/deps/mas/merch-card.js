...
`;var bo=32,oe=class extends w{constructor(r){super(r);u(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);u(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?ne`<slot name="secure-transaction-label">
  ...
  `);import{html as $e,css as vo}from"../lit-all.min.js";var Nr=`
:root {
...
`;var ie=class extends w{constructor(t){super(t)}getGlobalCSS(){return Nr}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?$e`<label id="stock-checkbox">
  ...
  `);import{html as xt,css as yo}from"../lit-all.min.js";var Rr=`
:root {
...
`;var W=class extends w{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Rr}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return xt` ${this.badge}
...
`;var Ro={mnemonics:{size:"m"},backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{slot:"footer",size:"S"},allowedSizes:["wide"]},le=class extends w{getGlobalCSS(){return kr}get aemFragmentMapping(){return Ro}renderLayout(){return Po` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
            ...
            <slot></slot>`}};u(le,"variantStyle",No`
        :host([variant='ccd-slice']) {
