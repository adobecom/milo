...
`;var wi=32,xe=class extends b{constructor(e){super(e);l(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);l(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?fe`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(e=>e.onceSettled())),await this.adjustAddon(),U()?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};l(xe,"variantStyle",yi`
...
`;var Ct={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"l"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:[]},Ee=class extends b{constructor(t){super(t)}getGlobalCSS(){return Cr}get aemFragmentMapping(){return Ct}get headingSelector(){return'[slot="heading-xs"]'}syncHeights(){if(this.card.getBoundingClientRect().width<=2)return;let t=this.card.querySelector('[slot="short-description"]');t&&this.updateCardElementMinHeight(t,"short-description");let e=this.card.querySelector('[slot="price"]');e&&this.updateCardElementMinHeight(e,"price");let r=this.card.querySelector('[slot="cta"]');r&&this.updateCardElementMinHeight(r,"cta")}async syncAllCardsInContainer(){let t=this.getContainer();if(!t)return;let e=t.querySelectorAll('merch-card[variant="full-pricing-express"]');if(!e.length)return;let r=`--consonant-merch-card-${this.card.variant}`;["price","cta","short-description"].forEach(a=>{t.style.removeProperty(`${r}-${a}-height`)}),await Promise.all(Array.from(e).flatMap(a=>a.prices?.map(n=>n.onceSettled?.())||[])),requestAnimationFrame(()=>{e.forEach(a=>a.variantLayout?.syncHeights?.())})}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,await Promise.all(this.card.prices.map(t=>t.onceSettled())),!U())){let t=this.getContainer();if(!t)return;let e=`--consonant-merch-card-${this.card.variant}`;t.style.getPropertyValue(`${e}-price-height`)||t.style.getPropertyValue(`${e}-cta-height`)||t.style.getPropertyValue(`${e}-short-description-height`)?this.syncHeights():await this.syncAllCardsInContainer()}}connectedCallbackHook(){!this.card||this.card.failed||(this.boundPostCardUpdateHook=this.postCardUpdateHook.bind(this),window.addEventListener("resize",this.boundPostCardUpdateHook),setTimeout(async()=>{this.setupVisibilityDetection(),U()||this.getContainer()&&await this.syncAllCardsInContainer()},100))}setupVisibilityDetection(){this.visibilityObserver=Ze(async t=>{U()||this.getContainer()&&await this.syncAllCardsInContainer()}),this.visibilityObserver.observe(this.card)}disconnectedCallbackHook(){this.boundPostCardUpdateHook&&window.removeEventListener("resize",this.boundPostCardUpdateHook),this.visibilityObserver&&(this.visibilityObserver.disconnect(),this.visibilityObserver=null)}renderLayout(){return Li`
            <div class="badge-wrapper">
                <slot name="badge"></slot>
            </div>
            <div class="card-content">
