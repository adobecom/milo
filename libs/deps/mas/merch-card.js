var jo=Object.defineProperty;var Hr=e=>{throw TypeError(e)};var Yo=(e,t,r)=>t in e?jo(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var p=(e,t,r)=>Yo(e,typeof t!="symbol"?t+"":t,r),Rt=(e,t,r)=>t.has(e)||Hr("Cannot "+r);var g=(e,t,r)=>(Rt(e,t,"read from private field"),r?r.call(e):t.get(e)),L=(e,t,r)=>t.has(e)?Hr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),P=(e,t,r,n)=>(Rt(e,t,"write to private field"),n?n.call(e,r):t.set(e,r),r),$=(e,t,r)=>(Rt(e,t,"access private method"),r);import{LitElement as gs}from"../lit-all.min.js";import{LitElement as Wo,html as Br,css as qo}from"../lit-all.min.js";var h=class extends Wo{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:t}=this;return t?Br`<a href="${t}">
                  <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />
              </a>`:Br` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};p(h,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),p(h,"styles",qo`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
      ...
      `];import{html as rt}from"../lit-all.min.js";var he,Oe=class Oe{constructor(t){p(this,"card");L(this,he);this.card=t,this.insertVariantStyle()}getContainer(){return P(this,he,g(this,he)??this.card.closest('[class*="-merch-cards"]')??this.card.parentElement),g(this,he)}insertVariantStyle(){if(!Oe.styleMap[this.card.variant]){Oe.styleMap[this.card.variant]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(t,r){if(!t)return;let n=`--consonant-merch-card-${this.card.variant}-${r}-height`,o=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),a=parseInt(this.getContainer().style.getPropertyValue(n))||0;o>a&&this.getContainer().style.setProperty(n,`${o}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),rt`
        ...
        `}get cardImage(){return rt` <div class="image">
            ...
            ${this.badge}
              ...
              >`:"";return rt`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){}};he=new WeakMap,p(Oe,"styleMap",{});var S=Oe;import{html as Ht,css as Xo}from"../lit-all.min.js";var Nt="wcms:commerce:ready";var Mt='span[is="inline-price"][data-wcs-osi]',nt='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',Fr="sp-button[data-wcs-osi]",$r=`${Mt},${nt}`;var Vr="merch-offer-select:ready",jr="merch-card:ready",Yr="merch-card:action-menu-toggle";var Ot="merch-storage:change",It="merch-quantity-selector:change";var de="aem:load",me="aem:error",Wr="mas:ready",qr="mas:error";var Xr="mas/commerce";var kt={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},Kr="X-Request-Id",Zr="mas-commerce-service:initTime";var Ie=":start",Qr=":duration";function Q(e,t={},r=null,n=null){let o=n?document.createElement(e,{is:n}):document.createElement(e);r instanceof HTMLElement?o.appendChild(r):o.innerHTML=r;for(let[a,i]of Object.entries(t))o.setAttribute(a,i);return o}function ot(){return window.matchMedia("(max-width: 767px)")}function ue(){return ot().matches}function Jr(){return window.matchMedia("(max-width: 1024px)").matches}function at(){let e=document.querySelector("mas-commerce-service");return e?{[Zr]:e.initDuration}:{}}var en=`
:root {
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return en}setAriaExpanded(r,n){r.setAttribute("aria-expanded",n)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};p(pe,"variantStyle",Xo`
    ...
    `);import{html as ke}from"../lit-all.min.js";var tn=`
:root {
...
`;var it=class extends S{constructor(t){super(t)}getGlobalCSS(){return tn}renderLayout(){return ke`${this.cardImage}
    <div class="body">
...
`;var Zo=32,ge=class extends S{constructor(r){super(r);p(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);p(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?fe`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){ue()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};p(ge,"variantStyle",Ko`
...
`;var Dt={title:{tag:"p",slot:"heading-xs"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},stockOffer:!0,secureLabel:!0,badge:!0,size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant"},xe=class extends S{constructor(t){super(t),this.adaptForMobile=this.adaptForMobile.bind(this)}get aemFragmentMapping(){return Dt}getGlobalCSS(){return sn}adaptForMobile(){let t=this.card.shadowRoot,r=t.querySelector("footer"),n=this.card.getAttribute("size"),o=t.querySelector("footer #stock-checkbox"),a=t.querySelector(".body #stock-checkbox"),i=t.querySelector(".body");if(!n){r.classList.remove("wide-footer"),o&&o.remove();return}let s=ue();if(r&&r.classList.toggle("wide-footer",!s),s&&o){a?o.remove():i.appendChild(o);return}!s&&a&&(o?a.remove():r.prepend(a)),this.card.closest("merch-card-collection,overlay-trigger")||this.card.removeAttribute("size")}postCardUpdateHook(){this.adaptForMobile(),this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?cn`<label id="stock-checkbox">
        ...
        ${this.secureLabelFooter}`}};p(xe,"variantStyle",Qo`
    :host([variant='plans']) {
      min-height: 348px;
    }
...
`;var J=class extends S{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return ln}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return Ut` ${this.badge}
      ...
      ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}postCardUpdateHook(){this.card.isConnected&&(ue()||this.adjustProductBodySlots(),this.adjustTitleWidth())}};p(J,"variantStyle",Jo`
...
`;var be=class extends S{constructor(t){super(t)}getGlobalCSS(){return hn}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return zt` ${this.badge}
    ...
    <hr />
    ${this.secureLabelFooter}`}};p(be,"variantStyle",ea`
...
`;var Ft={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ye=class extends S{constructor(t){super(t)}getGlobalCSS(){return dn}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return Ft}renderLayout(){return Gt`${this.cardImage}
            <div class="body">
            ...
            ${this.evergreen?Gt`
                  ...
                  `:Gt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};p(ye,"variantStyle",ta`
...
`;var ve=class extends S{constructor(t){super(t)}getGlobalCSS(){return mn}renderLayout(){return ra`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
      ...
      <footer><slot name="footer"></slot></footer>`}};p(ve,"variantStyle",na`
    :host([variant='twp']) {
      padding: 4px 10px 5px 10px;
    }
    .twp-badge {
  ...
  `);import{html as oa,css as aa}from"../lit-all.min.js";var un=`
...
`;var $t={backgroundImage:{attribute:"background-image"},badge:!0,ctas:{slot:"cta",size:"M"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"p",slot:"price"},size:[],subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"}},Ee=class extends S{getGlobalCSS(){return un}get aemFragmentMapping(){return $t}get stripStyle(){return this.card.backgroundImage?`
        ...
        `:""}renderLayout(){return oa` <div style="${this.stripStyle}" class="body">
            ...
            <slot></slot>`}postCardUpdateHook(t){t.has("backgroundImage")&&this.styleBackgroundImage()}styleBackgroundImage(){if(this.card.classList.remove("thin-strip"),this.card.classList.remove("wide-strip"),!this.card.backgroundImage)return;let t=new Image;t.src=this.card.backgroundImage,t.onload=()=>{t.width>8?this.card.classList.add("wide-strip"):t.width===8&&this.card.classList.add("thin-strip")}}};p(Ee,"variantStyle",aa`
    ...
    `);import{html as ia,css as sa}from"../lit-all.min.js";var pn=`
...
`;var Vt={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},we=class extends S{getGlobalCSS(){return pn}get aemFragmentMapping(){return Vt}renderLayout(){return ia` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
            ...
            <slot></slot>`}};p(we,"variantStyle",sa`
        :host([variant='ccd-slice']) {
...
`;var jt={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color"},allowedColors:{gray:"--spectrum-gray-100"},size:["single","double","triple"]},ee=class extends S{getGlobalCSS(){return fn}get aemFragmentMapping(){return jt}renderLayout(){return ca`
  ...
  `);customElements.define("ah-try-buy-widget",ee);var Yt=(e,t=!1)=>{switch(e.variant){case"catalog":return new pe(e);case"image":return new it(e);case"inline-heading":return new st(e);case"mini-compare-chart":return new ge(e);case"plans":return new xe(e);case"product":return new J(e);case"segment":return new be(e);case"special-offers":return new ye(e);case"twp":return new ve(e);case"ccd-suggested":return new Ee(e);case"ccd-slice":return new we(e);case"ah-try-buy-widget":return new ee(e);default:return t?void 0:new J(e)}},gn={catalog:Bt,image:null,"inline-heading":null,"mini-compare-chart":null,plans:Dt,product:null,segment:null,"special-offers":Ft,twp:null,"ccd-suggested":$t,"ccd-slice":Vt,"ah-try-buy-widget":jt},xn=()=>{let e=[];return e.push(pe.variantStyle),e.push(ge.variantStyle),e.push(J.variantStyle),e.push(xe.variantStyle),e.push(be.variantStyle),e.push(ye.variantStyle),e.push(ve.variantStyle),e.push(Ee.variantStyle),e.push(we.variantStyle),e.push(ee.variantStyle),e};var bn=document.createElement("style");bn.innerHTML=`
:root {
