...
Caused by: ${this.cause}`),e}};var Ui="mas-commerce-service",qi={requestId:Xe,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var ht=i=>window.setTimeout(i);function Mt(){return document.getElementsByTagName(Ui)?.[0]}function Fr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(qi)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Ir(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var Br="fragment",Hr="author",Ur="preview",qr="loading",jr="timeout",Rt="aem-fragment",Gr="eager",Vr="cache",ji=[Gr,Vr],F,te,O,Ot=class{constructor(){g(this,F,new Map);g(this,te,new Map);g(this,O,new Map)}clear(){c(this,F).clear(),c(this,te).clear(),c(this,O).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,F).set(t.id,t),t.fields?.originalId&&c(this,F).set(t.fields.originalId,t),c(this,O).has(t.id)){let[,r]=c(this,O).get(t.id);r()}if(c(this,O).has(t.fields?.originalId)){let[,r]=c(this,O).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,F).has(t)}entries(){return c(this,F).entries()}get(t){return c(this,F).get(t)}getAsPromise(t){let[e]=c(this,O).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,O).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,te).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,te).set(t,e)),e}remove(t){c(this,F).delete(t),c(this,te).delete(t),c(this,O).delete(t)}};F=new WeakMap,te=new WeakMap,O=new WeakMap;var Y=new Ot,Te,N,H,M,z,w,qe,je,D,Ge,Ve,Le,$,Yr,Kr,Nt,Wr,mt=class extends HTMLElement{constructor(){super(...arguments);g(this,$);l(this,"cache",Y);g(this,Te);g(this,N,null);g(this,H,null);g(this,M,null);g(this,z);g(this,w);g(this,qe,Gr);g(this,je,5e3);g(this,D);g(this,Ge,!1);g(this,Ve,0);g(this,Le)}static get observedAttributes(){return[Br,qr,jr,Hr,Ur]}attributeChangedCallback(e,r,a){e===Br&&(m(this,z,a),m(this,w,Y.getFetchInfo(a))),e===qr&&ji.includes(a)&&m(this,qe,a),e===jr&&m(this,je,parseInt(a,10)),e===Hr&&m(this,Ge,["","true"].includes(a)),e===Ur&&m(this,Le,a)}connectedCallback(){if(!c(this,D)){if(c(this,M)??m(this,M,Z(this)),m(this,Le,c(this,M).settings?.preview),c(this,Te)??m(this,Te,c(this,M).log.module(`${Rt}[${c(this,z)}]`)),!c(this,z)||c(this,z)==="#"){c(this,w)??m(this,w,Y.getFetchInfo("missing-fragment-id")),A(this,$,Nt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,w)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,D)&&!await Promise.race([c(this,D),Promise.resolve(!1)]))return;e&&Y.remove(c(this,z)),c(this,qe)===Vr&&await Promise.race([Y.getAsPromise(c(this,z)),new Promise(s=>setTimeout(s,c(this,je)))]);try{m(this,D,A(this,$,Wr).call(this)),await c(this,D)}catch(s){return A(this,$,Nt).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,N)||{};return o&&!dt("mas.disableWcsCache")&&c(this,M).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(pe,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,w)},bubbles:!0,composed:!0})),c(this,D)}get updateComplete(){return c(this,D)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,H)?c(this,H):(c(this,Ge)?this.transformAuthorData():this.transformPublishData(),c(this,H))}get rawData(){return c(this,N)}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,N);m(this,H,e.reduce((p,{name:h,multiple:b,values:P})=>(p.fields[h]=b?P:P[0],p),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,N);m(this,H,Object.entries(e).reduce((p,[h,b])=>(p.fields[h]=b?.mimeType?b.value:b??"",p),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,z),{locale:c(this,M).settings.locale,apiKey:c(this,M).settings.wcsApiKey})}};Te=new WeakMap,N=new WeakMap,H=new WeakMap,M=new WeakMap,z=new WeakMap,w=new WeakMap,qe=new WeakMap,je=new WeakMap,D=new WeakMap,Ge=new WeakMap,Ve=new WeakMap,Le=new WeakMap,$=new WeakSet,Yr=async function(e){Kt(this,Ve)._++;let r=`${Rt}:${c(this,z)}:${c(this,Ve)}`,a=`${r}${Ze}`,n=`${r}${Je}`;if(c(this,Le))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,w).stale=!1,c(this,w).url=e,o=await Ir(e,{cache:"default",credentials:"omit"}),A(this,$,Kr).call(this,o),c(this,w).status=o?.status,c(this,w).measure=me(performance.measure(n,a)),c(this,w).retryCount=o.retryCount,!o?.ok)throw new ee("Unexpected fragment response",{response:o,...c(this,M).duration});return await o.json()}catch(s){if(c(this,w).measure=me(performance.measure(n,a)),c(this,w).retryCount=s.retryCount,c(this,N))return c(this,w).stale=!0,c(this,Te).error("Serving stale data",c(this,w)),c(this,N);let d=s.message??"unknown";throw new ee(`Failed to fetch fragment: ${d}`,{})}},Kr=function(e){Object.assign(c(this,w),Fr(e))},Nt=function(e){m(this,D,null),c(this,w).message=e,this.classList.add("error");let r={...c(this,w),...c(this,M).duration};c(this,Te).error(e,r),this.dispatchEvent(new CustomEvent(he,{detail:r,bubbles:!0,composed:!0}))},Wr=async function(){var d;this.classList.remove("error"),m(this,H,null);let e=Y.get(c(this,z));if(e)return m(this,N,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,M).settings,s=`${r}/fragment?id=${c(this,z)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await A(this,$,Yr).call(this,s),(d=e.fields).originalId??(d.originalId=c(this,z)),Y.add(e),m(this,N,e),!0},l(mt,"cache",Y);customElements.define(Rt,mt);import{LitElement as Gi,html as Vi,css as Yi}from"../lit-all.min.js";var _e=class extends Gi{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Vi`<div class="badge">
            ${this.text}
