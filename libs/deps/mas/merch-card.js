...
`;var G=class extends l{constructor(e){super(e)}getGlobalCSS(){return yt}renderLayout(){return N`${this.cardImage}
    <div class="body">
...
`;var V=class extends l{constructor(e){super(e)}getGlobalCSS(){return wt}renderLayout(){return Et` ${this.badge}
    ...
    ${this.card.customHr?"":Et`<hr />`} ${this.secureLabelFooter}`}};import{html as k,css as Gt,unsafeCSS as kt}from"../lit-all.min.js";var St=`
  :root {
...
`;var Vt=32,A=class extends l{constructor(t){super(t);c(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);c(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?k`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){I()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(t=>t.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};c(A,"variantStyle",Gt`
