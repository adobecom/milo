var uo=Object.defineProperty;var ir=e=>{throw TypeError(e)};var fo=(e,t,r)=>t in e?uo(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var p=(e,t,r)=>fo(e,typeof t!="symbol"?t+"":t,r),ht=(e,t,r)=>t.has(e)||ir("Cannot "+r);var dt=(e,t,r)=>(ht(e,t,"read from private field"),r?r.call(e):t.get(e)),Ie=(e,t,r)=>t.has(e)?ir("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),sr=(e,t,r,n)=>(ht(e,t,"write to private field"),n?n.call(e,r):t.set(e,r),r),mt=(e,t,r)=>(ht(e,t,"access private method"),r);import{LitElement as Ri}from"../lit-all.min.js";import{LitElement as go,html as cr,css as xo}from"../lit-all.min.js";var d=class extends go{constructor(){super(),this.size="m",this.alt=""}render(){let{href:t}=this;return t?cr`<a href="${t}">
                  <img src="${this.src}" alt="${this.alt}" loading="lazy" />
              </a>`:cr` <img src="${this.src}" alt="${this.alt}" loading="lazy" />`}};p(d,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0}}),p(d,"styles",xo`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
...
`;var Mo={mnemonics:{size:"m"},backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{slot:"footer",size:"S"},allowedSizes:["wide"]},de=class extends E{getGlobalCSS(){return Dr}get aemFragmentMapping(){return Mo}renderLayout(){return Oo` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
            ...
            <slot></slot>`}};p(de,"variantStyle",Ho`
        :host([variant='ccd-slice']) {
