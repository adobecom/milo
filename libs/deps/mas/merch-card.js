var qt=Object.defineProperty;var jt=i=>{throw TypeError(i)};var ai=(i,t,e)=>t in i?qt(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var ni=(i,t)=>()=>(i&&(t=i(i=0)),t);var oi=(i,t)=>{for(var e in t)qt(i,e,{get:t[e],enumerable:!0})};var l=(i,t,e)=>ai(i,typeof t!="symbol"?t+"":t,e),ft=(i,t,e)=>t.has(i)||jt("Cannot "+e);var c=(i,t,e)=>(ft(i,t,"read from private field"),e?e.call(i):t.get(i)),g=(i,t,e)=>t.has(i)?jt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),p=(i,t,e,r)=>(ft(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),E=(i,t,e)=>(ft(i,t,"access private method"),e);var Gt=(i,t,e,r)=>({set _(a){p(i,t,a,e)},get _(){return c(i,t,r)}});var xt={};oi(xt,{default:()=>W});import{LitElement as si,html as Ke,css as ci}from"../lit-all.min.js";function li(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var W,bt=ni(()=>{W=class extends si{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs"}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Ke`<merch-icon 
            src="${this.src}" 
            size="${this.size}"
        ></merch-icon>`:Ke`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;return t?li()?Ke`
    ...
    `);customElements.define("mas-mnemonic",W)});import{LitElement as Ma}from"../lit-all.min.js";import{css as Yt,unsafeCSS as Vt}from"../lit-all.min.js";var L="(max-width: 767px)",Y="(max-width: 1199px)",x="(min-width: 768px)",u="(min-width: 1200px)",N="(min-width: 1600px)";function Ve(){return window.matchMedia(L)}function Ye(){return window.matchMedia(u)}function K(){return Ve().matches}function z(){return Ye().matches}var Kt=Yt`
    :host {
...
`,Wt=()=>[Yt`
      ...
      `];import{LitElement as di,html as Xt,css as pi}from"../lit-all.min.js";function hi(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var ce=class extends di{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(hi())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",a="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,a=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,a=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",a);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>bt())}e.remove()})}render(){let{href:t}=this;return t?Xt`<a href="${t}">
              ...
              </a>`:Xt` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};l(ce,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),l(ce,"styles",pi`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",ce);var Va=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),Ya=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var v='span[is="inline-price"][data-wcs-osi]',H='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var mi='a[is="upt-link"]',Qt=`${v},${H},${mi}`;var Zt="merch-offer-select:ready",Jt="merch-card:action-menu-toggle";var vt="merch-quantity-selector:change",er="merch-card-quantity:change",yt="merch-modal:addon-and-quantity-update";var le="aem:load",de="aem:error",tr="mas:ready",rr="mas:error",ir="placeholder-failed",ar="placeholder-pending",nr="placeholder-resolved";var or="mas:failed",Pe="mas:resolved",sr="mas/commerce";var U="failed",X="pending",q="resolved";var We="X-Request-Id",Ka=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var Wa=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Xe=":start",Qe=":duration";var cr="legal";var gi="mas-commerce-service";function lr(i,t){let e;return function(){let r=this,a=arguments;clearTimeout(e),e=setTimeout(()=>i.apply(r,a),t)}}function A(i,t={},e=null,r=null){let a=r?document.createElement(i,{is:r}):document.createElement(i);e instanceof HTMLElement?a.appendChild(e):a.innerHTML=e;for(let[n,o]of Object.entries(t))a.setAttribute(n,o);return a}function pe(i){return`startTime:${i.startTime.toFixed(2)}|duration:${i.duration.toFixed(2)}`}function dr(){return window.matchMedia("(max-width: 1024px)").matches}function Q(){return document.getElementsByTagName(gi)?.[0]}function ze(i){let t=window.getComputedStyle(i);return i.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}function Ze(i,t={}){let e={threshold:.01,...t};return new IntersectionObserver(async r=>{let a=r[0];a.isIntersecting&&a.target.clientHeight>0&&await i(a)},e)}var Re,Z,Me,Oe,he,Je=class extends HTMLElement{constructor(){super();g(this,Re,"");g(this,Z);g(this,Me,[]);g(this,Oe,[]);g(this,he);p(this,he,lr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,Z)?this.parentElement.style.borderRadius=c(this,Z):c(this,Z)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=c(this,Me).map((r,a)=>{let n=c(this,Oe)[a]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${c(this,Re)}, ${e})`}connectedCallback(){c(this,he).call(this)}attributeChangedCallback(e,r,a){e==="border-radius"&&p(this,Z,a?.trim()),e==="colors"&&a?p(this,Me,a?.split(",").map(n=>n.trim())??[]):e==="positions"&&a?p(this,Oe,a?.split(",").map(n=>n.trim())??[]):e==="angle"&&p(this,Re,a?.trim()??""),c(this,he).call(this)}};Re=new WeakMap,Z=new WeakMap,Me=new WeakMap,Oe=new WeakMap,he=new WeakMap;customElements.define("merch-gradient",Je);import{LitElement as ui,html as fi,css as xi}from"../lit-all.min.js";var me=class extends ui{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${t}"] ${v}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Pe,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Pe,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return fi`
            <input
                type="checkbox"
                id="addon-checkbox"
    ...
    `);customElements.define("merch-addon",me);import{html as et,nothing as bi}from"../lit-all.min.js";var ge,Ne=class Ne{constructor(t){l(this,"card");g(this,ge);this.card=t,this.insertVariantStyle()}getContainer(){return p(this,ge,c(this,ge)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),c(this,ge)}insertVariantStyle(){if(!Ne.styleMap[this.card.variant]){Ne.styleMap[this.card.variant]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(t,e){if(!t)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,a=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=parseInt(this.getContainer().style.getPropertyValue(r))||0;a>n&&this.getContainer().style.setProperty(r,`${a}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),et`
        ...
        `}get cardImage(){return et` <div class="image">
            ...
            >`:bi}get secureLabelFooter(){return et`<footer>${this.secureLabel}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,e=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||e===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-e-16)}px`)}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return tt(this.card.variant)}};ge=new WeakMap,l(Ne,"styleMap",{});var b=Ne;import{html as wt,css as vi}from"../lit-all.min.js";var pr=`
:root {
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return pr}setAriaExpanded(e,r){e.setAttribute("aria-expanded",r)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};l(ue,"variantStyle",vi`
    ...
    `);import{html as $e}from"../lit-all.min.js";var mr=`
:root {
...
`;var rt=class extends b{constructor(t){super(t)}getGlobalCSS(){return mr}renderLayout(){return $e`${this.cardImage}
    <div class="body">
...
`;var it=class extends b{constructor(t){super(t)}getGlobalCSS(){return gr}renderLayout(){return ur` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":ur`<hr />`} ${this.secureLabelFooter}`}};import{html as fe,css as yi,unsafeCSS as xr}from"../lit-all.min.js";var fr=`
  :root {
...
`;var wi=32,xe=class extends b{constructor(e){super(e);l(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);l(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?fe`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(e=>e.onceSettled())),await this.adjustAddon(),K()?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};l(xe,"variantStyle",yi`
  ...
  `);import{html as Ie,css as Ei,nothing as at}from"../lit-all.min.js";var br=`
:root {
...
`;var nt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},vr={...function(){let{whatsIncluded:i,size:t,...e}=nt;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},yr={...function(){let{subtitle:i,whatsIncluded:t,size:e,quantitySelect:r,...a}=nt;return a}()},k=class extends b{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,e){t.dataset.template===cr&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return br}adjustSlotPlacement(t,e,r){let a=this.card.shadowRoot,n=a.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let s=a.querySelector(`footer slot[name="${t}"]`),d=a.querySelector(`.body slot[name="${t}"]`),h=a.querySelector(".body");if(o.includes("wide")||(n?.classList.remove("wide-footer"),s&&s.remove()),!!e.includes(o)){if(n?.classList.toggle("wide-footer",z()),!r&&s){if(d)s.remove();else{let m=h.querySelector(`[data-placeholder-for="${t}"]`);m?m.replaceWith(s):h.appendChild(s)}return}if(r&&d){let m=document.createElement("div");if(m.setAttribute("data-placeholder-for",t),m.classList.add("slot-placeholder"),!s){let f=d.cloneNode(!0);n.prepend(f)}d.replaceWith(m)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],z()),this.adjustSlotPlacement("callout-content",["super-wide"],z())}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.remove("hide-tooltip")}))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let e=this.card.querySelector('[slot="body-xs"]');if(!e)return;let r=e.querySelector("ul");if(!r)return;let a=r.previousElementSibling,n=document.createElement("div");n.classList.add("spacer"),e.insertBefore(n,a);let o=new IntersectionObserver(([s])=>{if(s.boundingClientRect.height===0)return;let d=0,h=this.card.querySelector('[slot="heading-s"]');h&&(d+=ze(h));let m=this.card.querySelector('[slot="subtitle"]');m&&(d+=ze(m));let f=this.card.querySelector('[slot="heading-m"]');f&&(d+=8+ze(f));for(let se of e.childNodes){if(se.classList.contains("spacer"))break;d+=ze(se)}let T=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");d>(parseFloat(T)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${d}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${d}px`),o.disconnect()});o.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists())}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${v}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Ie`<div class="divider"></div>`:at}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],e=this.card.querySelector(`[slot="heading-m"] ${v}[data-template="price"]`);e&&t.push(e);let r=t.map(async a=>{let n=a.cloneNode(!0);await a.onceSettled(),a?.options&&(a.options.displayPerUnit&&(a.dataset.displayPerUnit="false"),a.options.displayTax&&(a.dataset.displayTax="false"),a.options.displayPlanType&&(a.dataset.displayPlanType="false"),n.setAttribute("data-template","legal"),a.parentNode.insertBefore(n,a.nextSibling),await n.onceSettled())});await Promise.all(r)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let e=this.mainPrice;if(!e)return;await e.onceSettled();let r=e.value?.[0]?.planType;r&&(t.planType=r)}get stockCheckbox(){return this.card.checkboxLabel?Ie`<label id="stock-checkbox">
    ...
    `),l(k,"collectionOptions",{customHeaderArea:t=>t.sidenav?Ie`<slot name="resultsText"></slot>`:at,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]}});import{html as Et,css as Si}from"../lit-all.min.js";var wr=`
:root {
...
`;var be=class extends b{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return wr}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return Et` ${this.badge}
...
`;var ve=class extends b{constructor(t){super(t)}getGlobalCSS(){return Er}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return St` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var Ar={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ye=class extends b{constructor(t){super(t)}getGlobalCSS(){return Sr}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return At`${this.cardImage}
            <div class="body">
...
`;var Ct={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"l"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:[]},Ee=class extends b{constructor(t){super(t)}getGlobalCSS(){return Cr}get aemFragmentMapping(){return Ct}get headingSelector(){return'[slot="heading-xs"]'}syncHeights(){if(this.card.getBoundingClientRect().width<=2)return;let t=this.card.querySelector('[slot="short-description"]');t&&this.updateCardElementMinHeight(t,"short-description");let e=this.card.querySelector('[slot="price"]');e&&this.updateCardElementMinHeight(e,"price");let r=this.card.querySelector('[slot="cta"]');r&&this.updateCardElementMinHeight(r,"cta")}async syncAllCardsInContainer(){let t=this.getContainer();if(!t)return;let e=t.querySelectorAll('merch-card[variant="full-pricing-express"]');if(!e.length)return;let r=`--consonant-merch-card-${this.card.variant}`;["price","cta","short-description"].forEach(a=>{t.style.removeProperty(`${r}-${a}-height`)}),await Promise.all(Array.from(e).flatMap(a=>a.prices?.map(n=>n.onceSettled?.())||[])),requestAnimationFrame(()=>{e.forEach(a=>a.variantLayout?.syncHeights?.())})}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,await Promise.all(this.card.prices.map(t=>t.onceSettled())),!K())){let t=this.getContainer();if(!t)return;let e=`--consonant-merch-card-${this.card.variant}`;t.style.getPropertyValue(`${e}-price-height`)||t.style.getPropertyValue(`${e}-cta-height`)||t.style.getPropertyValue(`${e}-short-description-height`)?this.syncHeights():await this.syncAllCardsInContainer()}}connectedCallbackHook(){!this.card||this.card.failed||(this.boundPostCardUpdateHook=this.postCardUpdateHook.bind(this),window.addEventListener("resize",this.boundPostCardUpdateHook),setTimeout(()=>this.setupVisibilityDetection(),100))}setupVisibilityDetection(){this.visibilityObserver=Ze(async t=>{K()||this.getContainer()&&await this.syncAllCardsInContainer()}),this.visibilityObserver.observe(this.card)}disconnectedCallbackHook(){this.boundPostCardUpdateHook&&window.removeEventListener("resize",this.boundPostCardUpdateHook),this.visibilityObserver&&(this.visibilityObserver.disconnect(),this.visibilityObserver=null)}renderLayout(){return Li`
            <div class="badge-wrapper">
                <slot name="badge"></slot>
            </div>
            <div class="card-content">
...
`;var Lr={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Se=class extends b{constructor(){super(...arguments);l(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Tr}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${v}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return zi`
    ...
    `);var ot=new Map,S=(i,t,e=null,r=null,a)=>{ot.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:a})};S("catalog",ue,hr,ue.variantStyle);S("image",rt);S("inline-heading",it);S("mini-compare-chart",xe,null,xe.variantStyle);S("plans",k,nt,k.variantStyle,k.collectionOptions);S("plans-students",k,yr,k.variantStyle,k.collectionOptions);S("plans-education",k,vr,k.variantStyle,k.collectionOptions);S("product",be,null,be.variantStyle);S("segment",ve,null,ve.variantStyle);S("special-offers",ye,Ar,ye.variantStyle);S("simplified-pricing-express",we,kt,we.variantStyle);S("full-pricing-express",Ee,Ct,Ee.variantStyle);S("mini",Se,Lr,Se.variantStyle);var Tt=i=>{let t=ot.get(i.variant);if(!t)return;let{class:e,style:r}=t;if(r)try{let a=new CSSStyleSheet;a.replaceSync(r.cssText),i.shadowRoot.adoptedStyleSheets.push(a)}catch{let n=document.createElement("style");n.textContent=r.cssText,i.shadowRoot.appendChild(n)}return new e(i)};function tt(i){return ot.get(i)?.fragmentMapping}function _r(i){return ot.get(i)?.collectionOptions}var Pr=document.createElement("style");Pr.innerHTML=`
:root {
...
`;document.head.appendChild(Pr);function st(i,t={},{metadata:e=!0,search:r=!0,storage:a=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),s=Lt(r)?r:i;n=o.get(s)}if(a&&n==null){let o=Lt(a)?a:i;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Mi(Lt(e)?e:i);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[i]}var Ri=i=>typeof i=="boolean",ct=i=>typeof i=="function";var Lt=i=>typeof i=="string";function zr(i,t){if(Ri(i))return i;let e=String(i);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function Mi(i=""){return String(i).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var J=class i extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let a=e.response.headers?.get(We);a&&(e.requestId=a),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,i)}toString(){let t=Object.entries(this.context||{}).map(([r,a])=>`${r}: ${JSON.stringify(a)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var Oi="mas-commerce-service",Ni={requestId:We,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var lt=i=>window.setTimeout(i);function _t(){return document.getElementsByTagName(Oi)?.[0]}function Rr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(Ni)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Mr(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var Or="fragment",Nr="author",$r="preview",Ir="loading",Dr="timeout",Pt="aem-fragment",Fr="eager",Br="cache",$i=[Fr,Br],$,ee,R,zt=class{constructor(){g(this,$,new Map);g(this,ee,new Map);g(this,R,new Map)}clear(){c(this,$).clear(),c(this,ee).clear(),c(this,R).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,$).set(t.id,t),t.fields?.originalId&&c(this,$).set(t.fields.originalId,t),c(this,R).has(t.id)){let[,r]=c(this,R).get(t.id);r()}if(c(this,R).has(t.fields?.originalId)){let[,r]=c(this,R).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,$).has(t)}entries(){return c(this,$).entries()}get(t){return c(this,$).get(t)}getAsPromise(t){let[e]=c(this,R).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,R).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,ee).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,ee).set(t,e)),e}remove(t){c(this,$).delete(t),c(this,ee).delete(t),c(this,R).delete(t)}};$=new WeakMap,ee=new WeakMap,R=new WeakMap;var j=new zt,Ae,I,F,_,C,y,De,Fe,M,Be,He,ke,O,Hr,Ur,Rt,qr,dt=class extends HTMLElement{constructor(){super(...arguments);g(this,O);l(this,"cache",j);g(this,Ae);g(this,I,null);g(this,F,null);g(this,_,null);g(this,C);g(this,y);g(this,De,Fr);g(this,Fe,5e3);g(this,M);g(this,Be,!1);g(this,He,0);g(this,ke)}static get observedAttributes(){return[Or,Ir,Dr,Nr,$r]}attributeChangedCallback(e,r,a){e===Or&&(p(this,C,a),p(this,y,j.getFetchInfo(a))),e===Ir&&$i.includes(a)&&p(this,De,a),e===Dr&&p(this,Fe,parseInt(a,10)),e===Nr&&p(this,Be,["","true"].includes(a)),e===$r&&p(this,ke,a)}connectedCallback(){if(!c(this,M)){if(c(this,_)??p(this,_,Q(this)),p(this,ke,c(this,_).settings?.preview),c(this,Ae)??p(this,Ae,c(this,_).log.module(`${Pt}[${c(this,C)}]`)),!c(this,C)||c(this,C)==="#"){c(this,y)??p(this,y,j.getFetchInfo("missing-fragment-id")),E(this,O,Rt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,y)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,M)&&!await Promise.race([c(this,M),Promise.resolve(!1)]))return;e&&j.remove(c(this,C)),c(this,De)===Br&&await Promise.race([j.getAsPromise(c(this,C)),new Promise(s=>setTimeout(s,c(this,Fe)))]);try{p(this,M,E(this,O,qr).call(this)),await c(this,M)}catch(s){return E(this,O,Rt).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,I)||{};return o&&!st("mas.disableWcsCache")&&c(this,_).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(le,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,y)},bubbles:!0,composed:!0})),c(this,M)}get updateComplete(){return c(this,M)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,F)?c(this,F):(c(this,Be)?this.transformAuthorData():this.transformPublishData(),c(this,F))}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,I);p(this,F,e.reduce((h,{name:m,multiple:f,values:T})=>(h.fields[m]=f?T:T[0],h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,I);p(this,F,Object.entries(e).reduce((h,[m,f])=>(h.fields[m]=f?.mimeType?f.value:f??"",h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,C),{locale:c(this,_).settings.locale,apiKey:c(this,_).settings.wcsApiKey})}};Ae=new WeakMap,I=new WeakMap,F=new WeakMap,_=new WeakMap,C=new WeakMap,y=new WeakMap,De=new WeakMap,Fe=new WeakMap,M=new WeakMap,Be=new WeakMap,He=new WeakMap,ke=new WeakMap,O=new WeakSet,Hr=async function(e){Gt(this,He)._++;let r=`${Pt}:${c(this,C)}:${c(this,He)}`,a=`${r}${Xe}`,n=`${r}${Qe}`;if(c(this,ke))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,y).stale=!1,c(this,y).url=e,o=await Mr(e,{cache:"default",credentials:"omit"}),E(this,O,Ur).call(this,o),c(this,y).status=o?.status,c(this,y).measure=pe(performance.measure(n,a)),c(this,y).retryCount=o.retryCount,!o?.ok)throw new J("Unexpected fragment response",{response:o,...c(this,_).duration});return await o.json()}catch(s){if(c(this,y).measure=pe(performance.measure(n,a)),c(this,y).retryCount=s.retryCount,c(this,I))return c(this,y).stale=!0,c(this,Ae).error("Serving stale data",c(this,y)),c(this,I);let d=s.message??"unknown";throw new J(`Failed to fetch fragment: ${d}`,{})}},Ur=function(e){Object.assign(c(this,y),Rr(e))},Rt=function(e){p(this,M,null),c(this,y).message=e,this.classList.add("error");let r={...c(this,y),...c(this,_).duration};c(this,Ae).error(e,r),this.dispatchEvent(new CustomEvent(de,{detail:r,bubbles:!0,composed:!0}))},qr=async function(){var d;this.classList.remove("error"),p(this,F,null);let e=j.get(c(this,C));if(e)return p(this,I,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,_).settings,s=`${r}/fragment?id=${c(this,C)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await E(this,O,Hr).call(this,s),(d=e.fields).originalId??(d.originalId=c(this,C)),j.add(e),p(this,I,e),!0},l(dt,"cache",j);customElements.define(Pt,dt);import{LitElement as Ii,html as Di,css as Fi}from"../lit-all.min.js";var Ce=class extends Ii{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return Di`<div class="badge">
            ${this.text}
    ...
    `);customElements.define("merch-badge",Ce);import{html as Bi,css as Hi,LitElement as Ui}from"../lit-all.min.js";var Ue=class extends Ui{constructor(){super()}render(){return Bi`
            <slot name="icon"></slot>
    ...
    `),l(Ue,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Ue);import{html as Mt,css as qi,LitElement as ji}from"../lit-all.min.js";var qe=class extends ji{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Mt`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${this.isMobile&&this.rows.length>this.mobileRows?Mt`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Mt``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};l(qe,"styles",qi`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
