var jr=Object.defineProperty;var Oe=o=>{throw TypeError(o)};var Gr=(o,e,t)=>e in o?jr(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var l=(o,e,t)=>Gr(o,typeof e!="symbol"?e+"":e,t),le=(o,e,t)=>e.has(o)||Oe("Cannot "+t);var c=(o,e,t)=>(le(o,e,"read from private field"),t?t.call(o):e.get(o)),m=(o,e,t)=>e.has(o)?Oe("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(o):e.set(o,t),h=(o,e,t,r)=>(le(o,e,"write to private field"),r?r.call(o,t):e.set(o,t),t),w=(o,e,t)=>(le(o,e,"access private method"),t);var Ne=(o,e,t,r)=>({set _(n){h(o,e,n,t)},get _(){return c(o,e,r)}});import{LitElement as hn}from"../lit-all.min.js";import{css as $e,unsafeCSS as ze}from"../lit-all.min.js";var T="(max-width: 767px)",It="(max-width: 1199px)",b="(min-width: 768px)",u="(min-width: 1200px)",N="(min-width: 1600px)";function Dt(){return window.matchMedia(T)}function Ft(){return window.matchMedia(u)}function Bt(){return Dt().matches}function Ut(){return Ft().matches}var Ie=$e`
    :host {
...
`;var ro=32,mt=class extends v{constructor(t){super(t);l(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);l(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?ht`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(t=>t.onceSettled())),await this.adjustAddon(),Bt()?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};l(mt,"variantStyle",eo`
...
Caused by: ${this.cause}`),t}};var mo="mas-commerce-service",po={requestId:Ht,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var ee=o=>window.setTimeout(o);function ve(){return document.getElementsByTagName(mo)?.[0]}function br(o){let e={};if(!o?.headers)return e;let t=o.headers;for(let[r,n]of Object.entries(po)){let a=t.get(n);a&&(a=a.replace(/[,;]/g,"|"),a=a.replace(/[| ]+/g,"|"),e[r]=a)}return e}async function vr(o,e={},t=2,r=100){let n;for(let a=0;a<=t;a++)try{let i=await fetch(o,e);return i.retryCount=a,i}catch(i){if(n=i,n.retryCount=a,a>t)break;await new Promise(s=>setTimeout(s,r*(a+1)))}throw n}var yr="fragment",Er="author",wr="preview",Sr="loading",Ar="timeout",ye="aem-fragment",kr="eager",Tr="cache",go=[kr,Tr],z,Q,R,Ee=class{constructor(){m(this,z,new Map);m(this,Q,new Map);m(this,R,new Map)}clear(){c(this,z).clear(),c(this,Q).clear(),c(this,R).clear()}add(e){if(!this.has(e.id)&&!this.has(e.fields?.originalId)){if(c(this,z).set(e.id,e),e.fields?.originalId&&c(this,z).set(e.fields.originalId,e),c(this,R).has(e.id)){let[,t]=c(this,R).get(e.id);t()}if(c(this,R).has(e.fields?.originalId)){let[,t]=c(this,R).get(e.fields?.originalId);t()}if(e.references)for(let t in e.references){let{type:r,value:n}=e.references[t];r==="content-fragment"&&(n.settings={...e?.settings,...n.settings},n.placeholders={...e?.placeholders,...n.placeholders},n.dictionary={...e?.dictionary,...n.dictionary},n.priceLiterals={...e?.priceLiterals,...n.priceLiterals},this.add(n,e))}}}has(e){return c(this,z).has(e)}entries(){return c(this,z).entries()}get(e){return c(this,z).get(e)}getAsPromise(e){let[t]=c(this,R).get(e)??[];if(t)return t;let r;return t=new Promise(n=>{r=n,this.has(e)&&n()}),c(this,R).set(e,[t,r]),t}getFetchInfo(e){let t=c(this,Q).get(e);return t||(t={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,Q).set(e,t)),t}remove(e){c(this,z).delete(e),c(this,Q).delete(e),c(this,R).delete(e)}};z=new WeakMap,Q=new WeakMap,R=new WeakMap;var q=new Ee,xt,$,D,L,k,y,Rt,Pt,P,Mt,Ot,bt,M,Cr,Lr,we,_r,re=class extends HTMLElement{constructor(){super(...arguments);m(this,M);l(this,"cache",q);m(this,xt);m(this,$,null);m(this,D,null);m(this,L,null);m(this,k);m(this,y);m(this,Rt,kr);m(this,Pt,5e3);m(this,P);m(this,Mt,!1);m(this,Ot,0);m(this,bt)}static get observedAttributes(){return[yr,Sr,Ar,Er,wr]}attributeChangedCallback(t,r,n){t===yr&&(h(this,k,n),h(this,y,q.getFetchInfo(n))),t===Sr&&go.includes(n)&&h(this,Rt,n),t===Ar&&h(this,Pt,parseInt(n,10)),t===Er&&h(this,Mt,["","true"].includes(n)),t===wr&&h(this,bt,n)}connectedCallback(){if(!c(this,P)){if(c(this,L)??h(this,L,Y(this)),h(this,bt,c(this,L).settings?.preview),c(this,xt)??h(this,xt,c(this,L).log.module(`${ye}[${c(this,k)}]`)),!c(this,k)||c(this,k)==="#"){c(this,y)??h(this,y,q.getFetchInfo("missing-fragment-id")),w(this,M,we).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,y)).filter(([t,r])=>r!=null).map(([t,r])=>[`aem-fragment:${t}`,r]))}async refresh(t=!0){if(c(this,P)&&!await Promise.race([c(this,P),Promise.resolve(!1)]))return;t&&q.remove(c(this,k)),c(this,Rt)===Tr&&await Promise.race([q.getAsPromise(c(this,k)),new Promise(s=>setTimeout(s,c(this,Pt)))]);try{h(this,P,w(this,M,_r).call(this)),await c(this,P)}catch(s){return w(this,M,we).call(this,s.message),!1}let{references:r,referencesTree:n,placeholders:a,wcs:i}=c(this,$)||{};return i&&!Jt("mas.disableWcsCache")&&c(this,L).prefillWcsCache(i),this.dispatchEvent(new CustomEvent(nt,{detail:{...this.data,references:r,referencesTree:n,placeholders:a,...c(this,y)},bubbles:!0,composed:!0})),c(this,P)}get updateComplete(){return c(this,P)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,D)?c(this,D):(c(this,Mt)?this.transformAuthorData():this.transformPublishData(),c(this,D))}transformAuthorData(){let{fields:t,id:r,tags:n,settings:a={},priceLiterals:i={},dictionary:s={},placeholders:d={}}=c(this,$);h(this,D,t.reduce((p,{name:g,multiple:x,values:_})=>(p.fields[g]=x?_:_[0],p),{fields:{},id:r,tags:n,settings:a,priceLiterals:i,dictionary:s,placeholders:d}))}transformPublishData(){let{fields:t,id:r,tags:n,settings:a={},priceLiterals:i={},dictionary:s={},placeholders:d={}}=c(this,$);h(this,D,Object.entries(t).reduce((p,[g,x])=>(p.fields[g]=x?.mimeType?x.value:x??"",p),{fields:{},id:r,tags:n,settings:a,priceLiterals:i,dictionary:s,placeholders:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let n=r.trim().toLowerCase();if(n==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:a}=window.location,i=a.endsWith(".page")?"page":"live";return n.includes("--")?`https://${n}.aem.${i}/studio/libs/fragment-client.js`:`https://${n}--mas--adobecom.aem.${i}/studio/libs/fragment-client.js`}async generatePreview(){let t=this.getFragmentClientUrl(),{previewFragment:r}=await import(t);return await r(c(this,k),{locale:c(this,L).settings.locale,apiKey:c(this,L).settings.wcsApiKey})}};xt=new WeakMap,$=new WeakMap,D=new WeakMap,L=new WeakMap,k=new WeakMap,y=new WeakMap,Rt=new WeakMap,Pt=new WeakMap,P=new WeakMap,Mt=new WeakMap,Ot=new WeakMap,bt=new WeakMap,M=new WeakSet,Cr=async function(t){Ne(this,Ot)._++;let r=`${ye}:${c(this,k)}:${c(this,Ot)}`,n=`${r}${qt}`,a=`${r}${jt}`;if(c(this,bt))return await this.generatePreview();performance.mark(n);let i;try{if(c(this,y).stale=!1,c(this,y).url=t,i=await vr(t,{cache:"default",credentials:"omit"}),w(this,M,Lr).call(this,i),c(this,y).status=i?.status,c(this,y).measure=it(performance.measure(a,n)),c(this,y).retryCount=i.retryCount,!i?.ok)throw new W("Unexpected fragment response",{response:i,...c(this,L).duration});return await i.json()}catch(s){if(c(this,y).measure=it(performance.measure(a,n)),c(this,y).retryCount=s.retryCount,c(this,$))return c(this,y).stale=!0,c(this,xt).error("Serving stale data",c(this,y)),c(this,$);let d=s.message??"unknown";throw new W(`Failed to fetch fragment: ${d}`,{})}},Lr=function(t){Object.assign(c(this,y),br(t))},we=function(t){h(this,P,null),c(this,y).message=t,this.classList.add("error");let r={...c(this,y),...c(this,L).duration};c(this,xt).error(t,r),this.dispatchEvent(new CustomEvent(at,{detail:r,bubbles:!0,composed:!0}))},_r=async function(){var s;this.classList.remove("error"),h(this,D,null);let t=q.get(c(this,k));if(t)return h(this,$,t),!0;let{masIOUrl:r,wcsApiKey:n,locale:a}=c(this,L).settings,i=`${r}/fragment?id=${c(this,k)}&api_key=${n}&locale=${a}`;return t=await w(this,M,Cr).call(this,i),(s=t.fields).originalId??(s.originalId=c(this,k)),q.add(t),h(this,$,t),!0},l(re,"cache",q);customElements.define(ye,re);import{LitElement as uo,html as fo,css as xo}from"../lit-all.min.js";var vt=class extends uo{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return fo`<div class="badge">
    ...
    `);customElements.define("merch-badge",vt);import{html as bo,css as vo,LitElement as yo}from"../lit-all.min.js";var Nt=class extends yo{constructor(){super()}render(){return bo`
            <slot name="icon"></slot>
    ...
    `),l(Nt,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Nt);import{html as Se,css as Eo,LitElement as wo}from"../lit-all.min.js";var zt=class extends wo{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((e,t)=>{t>=5&&(e.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Se`<slot name="heading"></slot>
