var Gt=Object.defineProperty;var Vt=i=>{throw TypeError(i)};var ni=(i,t,e)=>t in i?Gt(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var oi=(i,t)=>()=>(i&&(t=i(i=0)),t);var si=(i,t)=>{for(var e in t)Gt(i,e,{get:t[e],enumerable:!0})};var d=(i,t,e)=>ni(i,typeof t!="symbol"?t+"":t,e),xt=(i,t,e)=>t.has(i)||Vt("Cannot "+e);var c=(i,t,e)=>(xt(i,t,"read from private field"),e?e.call(i):t.get(i)),g=(i,t,e)=>t.has(i)?Vt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),p=(i,t,e,r)=>(xt(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),E=(i,t,e)=>(xt(i,t,"access private method"),e);var Yt=(i,t,e,r)=>({set _(a){p(i,t,a,e)},get _(){return c(i,t,r)}});var bt={};si(bt,{default:()=>K});import{LitElement as ci,html as Ke,css as li}from"../lit-all.min.js";function di(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var K,vt=oi(()=>{K=class extends ci{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs"}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Ke`<merch-icon 
            src="${this.src}" 
            size="${this.size}"
    ...
    `);customElements.define("mas-mnemonic",K)});import{LitElement as Oa}from"../lit-all.min.js";import{css as Kt,unsafeCSS as Wt}from"../lit-all.min.js";var S="(max-width: 767px)",P="(max-width: 1199px)",x="(min-width: 768px)",u="(min-width: 1200px)",N="(min-width: 1600px)";function Ve(){return window.matchMedia(S)}function Ye(){return window.matchMedia(u)}function F(){return Ve().matches}function We(){return Ye().matches}var Xt=Kt`
    :host {
...
`,Qt=()=>[Kt`
      ...
      `];import{LitElement as pi,html as Zt,css as hi}from"../lit-all.min.js";function mi(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var ce=class extends pi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(mi())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",a="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,a=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,a=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",a);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>vt())}e.remove()})}render(){let{href:t}=this;return t?Zt`<a href="${t}">
                  <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />
              </a>`:Zt` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};d(ce,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),d(ce,"styles",hi`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",ce);var Ya=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),Wa=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var v='span[is="inline-price"][data-wcs-osi]',q='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var gi='a[is="upt-link"]',Jt=`${v},${q},${gi}`;var er="merch-offer-select:ready",tr="merch-card:action-menu-toggle";var yt="merch-quantity-selector:change",rr="merch-card-quantity:change",wt="merch-modal:addon-and-quantity-update";var B="merch-card-collection:ready";var le="aem:load",de="aem:error",ir="mas:ready",ar="mas:error",nr="placeholder-failed",or="placeholder-pending",sr="placeholder-resolved";var cr="mas:failed",Re="mas:resolved",lr="mas/commerce";var j="failed",X="pending",G="resolved";var Xe="X-Request-Id",Ka=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var Xa=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Qe=":start",Ze=":duration";var dr="legal";var ui="mas-commerce-service";function pr(i,t){let e;return function(){let r=this,a=arguments;clearTimeout(e),e=setTimeout(()=>i.apply(r,a),t)}}function C(i,t={},e=null,r=null){let a=r?document.createElement(i,{is:r}):document.createElement(i);e instanceof HTMLElement?a.appendChild(e):a.innerHTML=e;for(let[n,o]of Object.entries(t))a.setAttribute(n,o);return a}function pe(i){return`startTime:${i.startTime.toFixed(2)}|duration:${i.duration.toFixed(2)}`}function hr(){return window.matchMedia("(max-width: 1024px)").matches}function Q(){return document.getElementsByTagName(ui)?.[0]}function Pe(i){let t=window.getComputedStyle(i);return i.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var Me,Z,ze,Oe,he,Je=class extends HTMLElement{constructor(){super();g(this,Me,"");g(this,Z);g(this,ze,[]);g(this,Oe,[]);g(this,he);p(this,he,pr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,Z)?this.parentElement.style.borderRadius=c(this,Z):c(this,Z)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=c(this,ze).map((r,a)=>{let n=c(this,Oe)[a]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${c(this,Me)}, ${e})`}connectedCallback(){c(this,he).call(this)}attributeChangedCallback(e,r,a){e==="border-radius"&&p(this,Z,a?.trim()),e==="colors"&&a?p(this,ze,a?.split(",").map(n=>n.trim())??[]):e==="positions"&&a?p(this,Oe,a?.split(",").map(n=>n.trim())??[]):e==="angle"&&p(this,Me,a?.trim()??""),c(this,he).call(this)}};Me=new WeakMap,Z=new WeakMap,ze=new WeakMap,Oe=new WeakMap,he=new WeakMap;customElements.define("merch-gradient",Je);import{LitElement as fi,html as xi,css as bi}from"../lit-all.min.js";var me=class extends fi{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${t}"] ${v}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Re,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Re,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return xi`
            <input
                type="checkbox"
                id="addon-checkbox"
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return mr}setAriaExpanded(e,r){e.setAttribute("aria-expanded",r)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};d(ue,"variantStyle",yi`
    ...
    `);import{html as $e}from"../lit-all.min.js";var ur=`
:root {
...
`;var rt=class extends b{constructor(t){super(t)}getGlobalCSS(){return ur}renderLayout(){return $e`${this.cardImage}
    <div class="body">
...
`;var it=class extends b{constructor(t){super(t)}getGlobalCSS(){return fr}renderLayout(){return xr` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":xr`<hr />`} ${this.secureLabelFooter}`}};import{html as fe,css as wi,unsafeCSS as St}from"../lit-all.min.js";var br=`
  :root {
...
`;var Ei=32,xe=class extends b{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?fe`<slot name="secure-transaction-label">
              <span class="secure-transaction-label"
                  >${this.card.secureLabel}</span
              ></slot
          >`:fe`<slot name="secure-transaction-label"></slot>`;return fe`<footer>${e}<slot name="footer"></slot></footer>`});this.handleCollectionReady=this.handleCollectionReady.bind(this)}getGlobalCSS(){return br}handleCollectionReady(){F()||requestAnimationFrame(()=>{this.syncHeights()})}connectedCallbackHook(){let e=this.card.closest("merch-card-collection");e&&e.addEventListener(B,this.handleCollectionReady)}disconnectedCallbackHook(){let e=this.card.closest("merch-card-collection");e&&e.removeEventListener(B,this.handleCollectionReady)}syncHeights(){if(this.card.getBoundingClientRect().width<=2)return;this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".top-section"),"top-section");let e=["heading-m","body-m","heading-m-price","body-xxs","price-commitment","offers","promo-text","callout-content","addon"];this.card.classList.contains("bullet-list")&&e.push("footer-rows"),e.forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a)),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector("footer"),"footer");let r=this.card.shadowRoot.querySelector(".mini-compare-chart-badge");r&&r.textContent!==""&&this.getContainer().style.setProperty("--consonant-merch-card-mini-compare-chart-top-section-mobile-height","32px"),this.adjustMiniCompareFooterRows()}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.querySelector('[slot="footer-rows"] ul');!e||!e.children||[...e.children].forEach((r,a)=>{let n=Math.max(Ei,parseFloat(window.getComputedStyle(r).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(a+1)))||0;n>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(a+1),`${n}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(r=>{let a=r.querySelector(".footer-row-cell-description");a&&!a.textContent.trim()&&r.remove()})}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${v}[data-template="price"]`)}get headingMPriceSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-m-price"]')?.assignedElements()[0]}toggleAddon(e){let r=this.mainPrice,a=this.headingMPriceSlot;if(!r&&a){let n=e?.getAttribute("plan-type"),o=null;if(e&&n&&(o=e.querySelector(`p[data-plan-type="${n}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-m-price"]').forEach(s=>s.remove()),e.checked){if(o){let s=C("p",{class:"addon-heading-m-price-addon",slot:"heading-m-price"},o.innerHTML);this.card.appendChild(s)}}else{let s=C("p",{class:"card-heading",id:"free",slot:"heading-m-price"},"Free");this.card.appendChild(s)}}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;let r=this.mainPrice,a=this.card.planType;r&&(await r.onceSettled(),a=r.value?.[0]?.planType),a&&(e.planType=a)}renderLayout(){return fe` <div class="top-section${this.badge?" badge":""}">
            <slot name="icons"></slot> ${this.badge}
        </div>
        <slot name="heading-m"></slot>
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(e=>e.onceSettled())),await this.adjustAddon(),F()?this.removeEmptyRows():this.syncHeights()}};d(xe,"variantStyle",wi`
  ...
  `);import{html as De,css as Si,nothing as at}from"../lit-all.min.js";var vr=`
:root {
...
`;var nt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},yr={...function(){let{whatsIncluded:i,size:t,...e}=nt;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},wr={...function(){let{subtitle:i,whatsIncluded:t,size:e,quantitySelect:r,...a}=nt;return a}()},k=class extends b{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,e){t.dataset.template===dr&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return vr}adjustSlotPlacement(t,e,r){let a=this.card.shadowRoot,n=a.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let s=a.querySelector(`footer slot[name="${t}"]`),l=a.querySelector(`.body slot[name="${t}"]`),h=a.querySelector(".body");if(o.includes("wide")||(n?.classList.remove("wide-footer"),s&&s.remove()),!!e.includes(o)){if(n?.classList.toggle("wide-footer",We()),!r&&s){if(l)s.remove();else{let m=h.querySelector(`[data-placeholder-for="${t}"]`);m?m.replaceWith(s):h.appendChild(s)}return}if(r&&l){let m=document.createElement("div");if(m.setAttribute("data-placeholder-for",t),m.classList.add("slot-placeholder"),!s){let f=l.cloneNode(!0);n.prepend(f)}l.replaceWith(m)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],We()),this.adjustSlotPlacement("callout-content",["super-wide"],We())}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.remove("hide-tooltip")}))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let e=this.card.querySelector('[slot="body-xs"]');if(!e)return;let r=e.querySelector("ul");if(!r)return;let a=r.previousElementSibling,n=document.createElement("div");n.classList.add("spacer"),e.insertBefore(n,a);let o=new IntersectionObserver(([s])=>{if(s.boundingClientRect.height===0)return;let l=0,h=this.card.querySelector('[slot="heading-s"]');h&&(l+=Pe(h));let m=this.card.querySelector('[slot="subtitle"]');m&&(l+=Pe(m));let f=this.card.querySelector('[slot="heading-m"]');f&&(l+=8+Pe(f));for(let se of e.childNodes){if(se.classList.contains("spacer"))break;l+=Pe(se)}let L=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(L)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),o.disconnect()});o.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists())}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${v}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?De`<div class="divider"></div>`:at}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],e=this.card.querySelector(`[slot="heading-m"] ${v}[data-template="price"]`);e&&t.push(e);let r=t.map(async a=>{let n=a.cloneNode(!0);await a.onceSettled(),a?.options&&(a.options.displayPerUnit&&(a.dataset.displayPerUnit="false"),a.options.displayTax&&(a.dataset.displayTax="false"),a.options.displayPlanType&&(a.dataset.displayPlanType="false"),n.setAttribute("data-template","legal"),a.parentNode.insertBefore(n,a.nextSibling),await n.onceSettled())});await Promise.all(r)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let e=this.mainPrice;if(!e)return;await e.onceSettled();let r=e.value?.[0]?.planType;r&&(t.planType=r)}get stockCheckbox(){return this.card.checkboxLabel?De`<label id="stock-checkbox">
    ...
    `),d(k,"collectionOptions",{customHeaderArea:t=>t.sidenav?De`<slot name="resultsText"></slot>`:at,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]}});import{html as At,css as Ai}from"../lit-all.min.js";var Er=`
:root {
...
`;var be=class extends b{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.handleCollectionReady=this.handleCollectionReady.bind(this)}getGlobalCSS(){return Er}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return At` ${this.badge}
            ...
            ${this.secureLabelFooter}`}handleCollectionReady(){F()||requestAnimationFrame(()=>{this.syncHeights()})}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook);let t=this.card.closest("merch-card-collection");t&&t.addEventListener(B,this.handleCollectionReady)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook);let t=this.card.closest("merch-card-collection");t&&t.removeEventListener(B,this.handleCollectionReady)}postCardUpdateHook(){this.card.isConnected&&(this.adjustAddon(),F()||this.syncHeights(),this.adjustTitleWidth())}get headingXSSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-xs"]').assignedElements()[0]}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${v}[data-template="price"]`)}toggleAddon(t){let e=this.mainPrice,r=this.headingXSSlot;if(!e&&r){let a=t?.getAttribute("plan-type"),n=null;if(t&&a&&(n=t.querySelector(`p[data-plan-type="${a}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-xs"]').forEach(o=>o.remove()),t.checked){if(n){let o=C("p",{class:"addon-heading-xs-price-addon",slot:"heading-xs"},n.innerHTML);this.card.appendChild(o)}}else{let o=C("p",{class:"card-heading",id:"free",slot:"heading-xs"},"Free");this.card.appendChild(o)}}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;let e=this.mainPrice,r=this.card.planType;e&&(await e.onceSettled(),r=e.value?.[0]?.planType),r&&(t.planType=r)}};d(be,"variantStyle",Ai`
    ...
    `);import{html as Ct,css as Ci}from"../lit-all.min.js";var Sr=`
:root {
...
`;var ve=class extends b{constructor(t){super(t)}getGlobalCSS(){return Sr}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Ct` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
    ...
    <hr />
    ${this.secureLabelFooter}`}};d(ve,"variantStyle",Ci`
  ...
  `);import{html as kt,css as ki}from"../lit-all.min.js";var Ar=`
:root {
...
`;var Cr={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ye=class extends b{constructor(t){super(t)}getGlobalCSS(){return Ar}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return kt`${this.cardImage}
            ...
            ${this.evergreen?kt`
                  ...
                  `:kt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};d(ye,"variantStyle",ki`
...
`;var ot=()=>window.matchMedia(P).matches,Tt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},we=class extends b{getGlobalCSS(){return kr}get aemFragmentMapping(){return Tt}get headingSelector(){return'[slot="heading-xs"]'}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),requestAnimationFrame(()=>{this.card?.hasAttribute("data-default-card")&&ot()&&this.card.setAttribute("data-expanded","true")}))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(ot()){let a=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",a?"true":"false")}else t.removeAttribute("data-expanded")};e();let r=window.matchMedia(P);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener),this.attributeObserver=new MutationObserver(a=>{a.forEach(n=>{n.type==="attributes"&&n.attributeName==="data-default-card"&&this.card.hasAttribute("data-default-card")&&ot()&&this.card.setAttribute("data-expanded","true")})}),this.attributeObserver.observe(this.card,{attributes:!0,attributeOldValue:!0})}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(P).removeEventListener("change",this.mediaQueryListener),this.attributeObserver&&this.attributeObserver.disconnect()}handleChevronClick(t){t.preventDefault(),t.stopPropagation();let e=this.card;if(!e||!ot())return;let n=e.getAttribute("data-expanded")==="true"?"false":"true";e.setAttribute("data-expanded",n)}renderLayout(){return Ti`
    ...
    `);import{html as _i,css as Ri}from"../lit-all.min.js";var Tr=`
:root {
...
`;var Lt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"shortDescription",maxCount:3e3,withSuffix:!1},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"l"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:[]},Ee=class extends b{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Tr}get aemFragmentMapping(){return Lt}get headingSelector(){return'[slot="heading-xs"]'}updateCardElementMinHeight(t,e){if(!t)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,a=Math.max(0,t.offsetHeight||0),n=parseInt(this.getContainer().style.getPropertyValue(r))||0;a>n&&this.getContainer().style.setProperty(r,`${a}px`)}updateCardElementMinHeightValue(t,e){if(!t)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,a=this.getContainer(),n=parseInt(a.style.getPropertyValue(r))||0;t>n&&a.style.setProperty(r,`${t}px`)}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.querySelector('[slot="body-s"]');if(t){t.offsetHeight;let n=window.getComputedStyle(t),o=parseFloat(n.marginTop)||0,s=parseFloat(n.marginBottom)||0,l=t.offsetHeight+o+s;this.updateCardElementMinHeightValue(l,"description")}let e=this.card.querySelector('[slot="price"]');if(e){e.offsetHeight;let n=window.getComputedStyle(e),o=parseFloat(n.marginTop)||0,s=parseFloat(n.marginBottom)||0,l=e.offsetHeight+o+s;this.updateCardElementMinHeightValue(l,"price")}let r=this.card.querySelector('[slot="cta"]');if(r){r.offsetHeight;let n=window.getComputedStyle(r),o=parseFloat(n.marginTop)||0,s=parseFloat(n.marginBottom)||0,l=r.offsetHeight+o+s;this.updateCardElementMinHeightValue(l,"cta")}let a=this.card.querySelector('[slot="shortDescription"]');if(a){a.offsetHeight;let n=window.getComputedStyle(a),o=parseFloat(n.marginTop)||0,s=parseFloat(n.marginBottom)||0,l=a.offsetHeight+o+s;this.updateCardElementMinHeightValue(l,"shortDescription")}}forceRemeasure(){let t=this.getContainer();t&&(t.style.removeProperty(`--consonant-merch-card-${this.card.variant}-description-height`),t.style.removeProperty(`--consonant-merch-card-${this.card.variant}-price-height`),t.style.removeProperty(`--consonant-merch-card-${this.card.variant}-cta-height`),t.style.removeProperty(`--consonant-merch-card-${this.card.variant}-shortDescription-height`),this.syncHeights())}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length&&await Promise.all(this.card.prices.map(t=>t.onceSettled?.())),F()||requestAnimationFrame(()=>{this.syncHeights()}))}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook),this.handleCollectionReady=async()=>{F()||(this.card.prices?.length&&await Promise.all(this.card.prices.map(e=>e.onceSettled?.())),requestAnimationFrame(()=>{setTimeout(()=>{this.syncHeights()},200)}))};let t=this.card.closest("merch-card-collection");t&&t.addEventListener(B,this.handleCollectionReady)}disconnectedCallbackHook(){if(window.removeEventListener("resize",this.postCardUpdateHook),this.handleCollectionReady){let t=this.card.closest("merch-card-collection");t&&t.removeEventListener(B,this.handleCollectionReady)}}renderLayout(){return _i`
    ...
    `);import{css as Pi,html as Mi}from"../lit-all.min.js";var Lr=`
...
`;var _r={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Se=class extends b{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Lr}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${v}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Mi`
    ...
    `);var st=new Map,A=(i,t,e=null,r=null,a)=>{st.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:a})};A("catalog",ue,gr,ue.variantStyle);A("image",rt);A("inline-heading",it);A("mini-compare-chart",xe,null,xe.variantStyle);A("plans",k,nt,k.variantStyle,k.collectionOptions);A("plans-students",k,wr,k.variantStyle,k.collectionOptions);A("plans-education",k,yr,k.variantStyle,k.collectionOptions);A("product",be,null,be.variantStyle);A("segment",ve,null,ve.variantStyle);A("special-offers",ye,Cr,ye.variantStyle);A("simplified-pricing-express",we,Tt,we.variantStyle);A("full-pricing-express",Ee,Lt,Ee.variantStyle);A("mini",Se,_r,Se.variantStyle);var _t=i=>{let t=st.get(i.variant);if(!t)return;let{class:e,style:r}=t;if(r)try{let a=new CSSStyleSheet;a.replaceSync(r.cssText),i.shadowRoot.adoptedStyleSheets.push(a)}catch{let n=document.createElement("style");n.textContent=r.cssText,i.shadowRoot.appendChild(n)}return new e(i)};function tt(i){return st.get(i)?.fragmentMapping}function Rr(i){return st.get(i)?.collectionOptions}var Pr=document.createElement("style");Pr.innerHTML=`
:root {
...
`;document.head.appendChild(Pr);function ct(i,t={},{metadata:e=!0,search:r=!0,storage:a=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),s=Rt(r)?r:i;n=o.get(s)}if(a&&n==null){let o=Rt(a)?a:i;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Oi(Rt(e)?e:i);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[i]}var zi=i=>typeof i=="boolean",lt=i=>typeof i=="function";var Rt=i=>typeof i=="string";function Mr(i,t){if(zi(i))return i;let e=String(i);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function Oi(i=""){return String(i).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var J=class i extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let a=e.response.headers?.get(Xe);a&&(e.requestId=a),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,i)}toString(){let t=Object.entries(this.context||{}).map(([r,a])=>`${r}: ${JSON.stringify(a)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var Ni="mas-commerce-service",$i={requestId:Xe,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var dt=i=>window.setTimeout(i);function Pt(){return document.getElementsByTagName(Ni)?.[0]}function zr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries($i)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Or(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var Nr="fragment",$r="author",Dr="preview",Ir="loading",Fr="timeout",Mt="aem-fragment",Br="eager",Hr="cache",Di=[Br,Hr],$,ee,M,zt=class{constructor(){g(this,$,new Map);g(this,ee,new Map);g(this,M,new Map)}clear(){c(this,$).clear(),c(this,ee).clear(),c(this,M).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,$).set(t.id,t),t.fields?.originalId&&c(this,$).set(t.fields.originalId,t),c(this,M).has(t.id)){let[,r]=c(this,M).get(t.id);r()}if(c(this,M).has(t.fields?.originalId)){let[,r]=c(this,M).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,$).has(t)}entries(){return c(this,$).entries()}get(t){return c(this,$).get(t)}getAsPromise(t){let[e]=c(this,M).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,M).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,ee).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,ee).set(t,e)),e}remove(t){c(this,$).delete(t),c(this,ee).delete(t),c(this,M).delete(t)}};$=new WeakMap,ee=new WeakMap,M=new WeakMap;var V=new zt,Ae,D,H,_,T,y,Ie,Fe,z,Be,He,Ce,O,Ur,qr,Ot,jr,pt=class extends HTMLElement{constructor(){super(...arguments);g(this,O);d(this,"cache",V);g(this,Ae);g(this,D,null);g(this,H,null);g(this,_,null);g(this,T);g(this,y);g(this,Ie,Br);g(this,Fe,5e3);g(this,z);g(this,Be,!1);g(this,He,0);g(this,Ce)}static get observedAttributes(){return[Nr,Ir,Fr,$r,Dr]}attributeChangedCallback(e,r,a){e===Nr&&(p(this,T,a),p(this,y,V.getFetchInfo(a))),e===Ir&&Di.includes(a)&&p(this,Ie,a),e===Fr&&p(this,Fe,parseInt(a,10)),e===$r&&p(this,Be,["","true"].includes(a)),e===Dr&&p(this,Ce,a)}connectedCallback(){if(!c(this,z)){if(c(this,_)??p(this,_,Q(this)),p(this,Ce,c(this,_).settings?.preview),c(this,Ae)??p(this,Ae,c(this,_).log.module(`${Mt}[${c(this,T)}]`)),!c(this,T)||c(this,T)==="#"){c(this,y)??p(this,y,V.getFetchInfo("missing-fragment-id")),E(this,O,Ot).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,y)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,z)&&!await Promise.race([c(this,z),Promise.resolve(!1)]))return;e&&V.remove(c(this,T)),c(this,Ie)===Hr&&await Promise.race([V.getAsPromise(c(this,T)),new Promise(s=>setTimeout(s,c(this,Fe)))]);try{p(this,z,E(this,O,jr).call(this)),await c(this,z)}catch(s){return E(this,O,Ot).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,D)||{};return o&&!ct("mas.disableWcsCache")&&c(this,_).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(le,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,y)},bubbles:!0,composed:!0})),c(this,z)}get updateComplete(){return c(this,z)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,H)?c(this,H):(c(this,Be)?this.transformAuthorData():this.transformPublishData(),c(this,H))}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={}}=c(this,D);p(this,H,e.reduce((h,{name:m,multiple:f,values:L})=>(h.fields[m]=f?L:L[0],h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:l}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={}}=c(this,D);p(this,H,Object.entries(e).reduce((h,[m,f])=>(h.fields[m]=f?.mimeType?f.value:f??"",h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:l}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,T),{locale:c(this,_).settings.locale,apiKey:c(this,_).settings.wcsApiKey})}};Ae=new WeakMap,D=new WeakMap,H=new WeakMap,_=new WeakMap,T=new WeakMap,y=new WeakMap,Ie=new WeakMap,Fe=new WeakMap,z=new WeakMap,Be=new WeakMap,He=new WeakMap,Ce=new WeakMap,O=new WeakSet,Ur=async function(e){Yt(this,He)._++;let r=`${Mt}:${c(this,T)}:${c(this,He)}`,a=`${r}${Qe}`,n=`${r}${Ze}`;if(c(this,Ce))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,y).stale=!1,c(this,y).url=e,o=await Or(e,{cache:"default",credentials:"omit"}),E(this,O,qr).call(this,o),c(this,y).status=o?.status,c(this,y).measure=pe(performance.measure(n,a)),c(this,y).retryCount=o.retryCount,!o?.ok)throw new J("Unexpected fragment response",{response:o,...c(this,_).duration});return await o.json()}catch(s){if(c(this,y).measure=pe(performance.measure(n,a)),c(this,y).retryCount=s.retryCount,c(this,D))return c(this,y).stale=!0,c(this,Ae).error("Serving stale data",c(this,y)),c(this,D);let l=s.message??"unknown";throw new J(`Failed to fetch fragment: ${l}`,{})}},qr=function(e){Object.assign(c(this,y),zr(e))},Ot=function(e){p(this,z,null),c(this,y).message=e,this.classList.add("error");let r={...c(this,y),...c(this,_).duration};c(this,Ae).error(e,r),this.dispatchEvent(new CustomEvent(de,{detail:r,bubbles:!0,composed:!0}))},jr=async function(){var l;this.classList.remove("error"),p(this,H,null);let e=V.get(c(this,T));if(e)return p(this,D,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,_).settings,s=`${r}/fragment?id=${c(this,T)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await E(this,O,Ur).call(this,s),(l=e.fields).originalId??(l.originalId=c(this,T)),V.add(e),p(this,D,e),!0},d(pt,"cache",V);customElements.define(Mt,pt);import{LitElement as Ii,html as Fi,css as Bi}from"../lit-all.min.js";var ke=class extends Ii{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return Fi`<div class="badge">
            ${this.text}
        </div>`}};d(ke,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"}}),d(ke,"styles",Bi`
        :host {
            display: block;
    ...
    `),d(Ue,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Ue);import{html as Nt,css as ji,LitElement as Gi}from"../lit-all.min.js";var qe=class extends Gi{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Nt`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${this.isMobile&&this.rows.length>this.mobileRows?Nt`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Nt``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};d(qe,"styles",ji`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
