...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
    ...
    `);import{html as Be}from"../lit-all.min.js";var Yr=`
:root {
...
`;var nt=class extends S{constructor(t){super(t)}getGlobalCSS(){return Yr}renderLayout(){return Be`${this.cardImage}
    <div class="body">
