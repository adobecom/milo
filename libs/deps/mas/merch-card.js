var jt=Object.defineProperty;var Gt=i=>{throw TypeError(i)};var ni=(i,t,e)=>t in i?jt(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var oi=(i,t)=>()=>(i&&(t=i(i=0)),t);var si=(i,t)=>{for(var e in t)jt(i,e,{get:t[e],enumerable:!0})};var d=(i,t,e)=>ni(i,typeof t!="symbol"?t+"":t,e),ft=(i,t,e)=>t.has(i)||Gt("Cannot "+e);var c=(i,t,e)=>(ft(i,t,"read from private field"),e?e.call(i):t.get(i)),g=(i,t,e)=>t.has(i)?Gt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),h=(i,t,e,r)=>(ft(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),w=(i,t,e)=>(ft(i,t,"access private method"),e);var Vt=(i,t,e,r)=>({set _(a){h(i,t,a,e)},get _(){return c(i,t,r)}});var xt={};si(xt,{default:()=>W});import{LitElement as ci,html as Ye,css as li}from"../lit-all.min.js";function di(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var W,bt=oi(()=>{W=class extends ci{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs"}get effectiveContent(){return this.tooltipText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.placement||"top"}renderIcon(){return this.src?Ye`<merch-icon 
            src="${this.src}" 
            size="${this.size}"
        ></merch-icon>`:Ye`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;return t?di()?Ye`
            ...
            `:this.renderIcon()}};d(W,"properties",{content:{type:String},placement:{type:String},variant:{type:String},src:{type:String},size:{type:String},tooltipText:{type:String,attribute:"tooltip-text"},tooltipPlacement:{type:String,attribute:"tooltip-placement"}}),d(W,"styles",li`
        :host {
            display: contents;
            overflow: visible;
        }
    ...
    `);customElements.define("mas-tooltip",W)});import{LitElement as za}from"../lit-all.min.js";import{css as Kt,unsafeCSS as Yt}from"../lit-all.min.js";var L="(max-width: 767px)",R="(max-width: 1199px)",x="(min-width: 768px)",u="(min-width: 1200px)",I="(min-width: 1600px)";function qe(){return window.matchMedia(L)}function je(){return window.matchMedia(u)}function Ge(){return qe().matches}function Ve(){return je().matches}var Wt=Kt`
    :host {
...
`,Qt=()=>[Kt`
      ...
      `];import{LitElement as hi,html as Xt,css as pi}from"../lit-all.min.js";function mi(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var ce=class extends hi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(mi())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",a="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,a=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,a=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-tooltip");n.setAttribute("content",r),n.setAttribute("placement",a);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>bt())}e.remove()})}render(){let{href:t}=this;return t?Xt`<a href="${t}">
                  <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />
              </a>`:Xt` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};d(ce,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),d(ce,"styles",pi`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",ce);var Va=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),Ya=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var b='span[is="inline-price"][data-wcs-osi]',j='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var gi='a[is="upt-link"]',Zt=`${b},${j},${gi}`;var Jt="merch-offer-select:ready",er="merch-card:action-menu-toggle";var vt="merch-quantity-selector:change",tr="merch-card-quantity:change",yt="merch-modal:addon-and-quantity-update";var le="aem:load",de="aem:error",rr="mas:ready",ir="mas:error",ar="placeholder-failed",nr="placeholder-pending",or="placeholder-resolved";var sr="mas:failed",_e="mas:resolved",cr="mas/commerce";var G="failed",Q="pending",V="resolved";var Ke="X-Request-Id",Ka=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var Wa=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var We=":start",Qe=":duration";var lr="legal";var ui="mas-commerce-service";function dr(i,t){let e;return function(){let r=this,a=arguments;clearTimeout(e),e=setTimeout(()=>i.apply(r,a),t)}}function S(i,t={},e=null,r=null){let a=r?document.createElement(i,{is:r}):document.createElement(i);e instanceof HTMLElement?a.appendChild(e):a.innerHTML=e;for(let[n,o]of Object.entries(t))a.setAttribute(n,o);return a}function he(i){return`startTime:${i.startTime.toFixed(2)}|duration:${i.duration.toFixed(2)}`}function hr(){return window.matchMedia("(max-width: 1024px)").matches}function X(){return document.getElementsByTagName(ui)?.[0]}function Pe(i){let t=window.getComputedStyle(i);return i.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var Re,Z,Me,ze,pe,Xe=class extends HTMLElement{constructor(){super();g(this,Re,"");g(this,Z);g(this,Me,[]);g(this,ze,[]);g(this,pe);h(this,pe,dr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,Z)?this.parentElement.style.borderRadius=c(this,Z):c(this,Z)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=c(this,Me).map((r,a)=>{let n=c(this,ze)[a]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${c(this,Re)}, ${e})`}connectedCallback(){c(this,pe).call(this)}attributeChangedCallback(e,r,a){e==="border-radius"&&h(this,Z,a?.trim()),e==="colors"&&a?h(this,Me,a?.split(",").map(n=>n.trim())??[]):e==="positions"&&a?h(this,ze,a?.split(",").map(n=>n.trim())??[]):e==="angle"&&h(this,Re,a?.trim()??""),c(this,pe).call(this)}};Re=new WeakMap,Z=new WeakMap,Me=new WeakMap,ze=new WeakMap,pe=new WeakMap;customElements.define("merch-gradient",Xe);import{LitElement as fi,html as xi,css as bi}from"../lit-all.min.js";var me=class extends fi{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${t}"] ${b}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(_e,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(_e,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return xi`
            <input
                type="checkbox"
                id="addon-checkbox"
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return pr}setAriaExpanded(e,r){e.setAttribute("aria-expanded",r)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};d(ue,"variantStyle",yi`
    ...
    `);import{html as Oe}from"../lit-all.min.js";var gr=`
:root {
...
`;var et=class extends v{constructor(t){super(t)}getGlobalCSS(){return gr}renderLayout(){return Oe`${this.cardImage}
    <div class="body">
...
`;var tt=class extends v{constructor(t){super(t)}getGlobalCSS(){return ur}renderLayout(){return fr` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":fr`<hr />`} ${this.secureLabelFooter}`}};import{html as fe,css as Ei,unsafeCSS as br}from"../lit-all.min.js";var xr=`
  :root {
...
`;var wi=32,xe=class extends v{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?fe`<slot name="secure-transaction-label">
              <span class="secure-transaction-label"
                  >${this.card.secureLabel}</span
              ></slot
          >`:fe`<slot name="secure-transaction-label"></slot>`;return fe`<footer>${e}<slot name="footer"></slot></footer>`})}getGlobalCSS(){return xr}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2)return;this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".top-section"),"top-section");let e=["heading-m","body-m","heading-m-price","body-xxs","price-commitment","offers","promo-text","callout-content","addon"];this.card.classList.contains("bullet-list")&&e.push("footer-rows"),e.forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a)),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector("footer"),"footer"),this.card.shadowRoot.querySelector(".mini-compare-chart-badge")?.textContent!==""&&this.getContainer().style.setProperty("--consonant-merch-card-mini-compare-chart-top-section-mobile-height","32px")}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.querySelector('[slot="footer-rows"] ul');!e||!e.children||[...e.children].forEach((r,a)=>{let n=Math.max(wi,parseFloat(window.getComputedStyle(r).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(a+1)))||0;n>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(a+1),`${n}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(r=>{let a=r.querySelector(".footer-row-cell-description");a&&!a.textContent.trim()&&r.remove()})}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${b}[data-template="price"]`)}get headingMPriceSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-m-price"]')?.assignedElements()[0]}toggleAddon(e){let r=this.mainPrice,a=this.headingMPriceSlot;if(!r&&a){let n=e?.getAttribute("plan-type"),o=null;if(e&&n&&(o=e.querySelector(`p[data-plan-type="${n}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-m-price"]').forEach(s=>s.remove()),e.checked){if(o){let s=S("p",{class:"addon-heading-m-price-addon",slot:"heading-m-price"},o.innerHTML);this.card.appendChild(s)}}else{let s=S("p",{class:"card-heading",id:"free",slot:"heading-m-price"},"Free");this.card.appendChild(s)}}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;let r=this.mainPrice,a=this.card.planType;r&&(await r.onceSettled(),a=r.value?.[0]?.planType),a&&(e.planType=a)}renderLayout(){return fe` <div class="top-section${this.badge?" badge":""}">
            <slot name="icons"></slot> ${this.badge}
        </div>
        <slot name="heading-m"></slot>
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(e=>e.onceSettled())),await this.adjustAddon(),Ge()?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};d(xe,"variantStyle",Ei`
  ...
  `);import{html as Ne,css as Si,nothing as rt}from"../lit-all.min.js";var vr=`
:root {
...
`;var it={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},yr={...function(){let{whatsIncluded:i,size:t,...e}=it;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Er={...function(){let{subtitle:i,whatsIncluded:t,size:e,quantitySelect:r,...a}=it;return a}()},A=class extends v{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,e){t.dataset.template===lr&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return vr}adjustSlotPlacement(t,e,r){let a=this.card.shadowRoot,n=a.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let s=a.querySelector(`footer slot[name="${t}"]`),l=a.querySelector(`.body slot[name="${t}"]`),p=a.querySelector(".body");if(o.includes("wide")||(n?.classList.remove("wide-footer"),s&&s.remove()),!!e.includes(o)){if(n?.classList.toggle("wide-footer",Ve()),!r&&s){if(l)s.remove();else{let m=p.querySelector(`[data-placeholder-for="${t}"]`);m?m.replaceWith(s):p.appendChild(s)}return}if(r&&l){let m=document.createElement("div");if(m.setAttribute("data-placeholder-for",t),m.classList.add("slot-placeholder"),!s){let f=l.cloneNode(!0);n.prepend(f)}l.replaceWith(m)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],Ve()),this.adjustSlotPlacement("callout-content",["super-wide"],Ve())}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.remove("hide-tooltip")}))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let e=this.card.querySelector('[slot="body-xs"]');if(!e)return;let r=e.querySelector("ul");if(!r)return;let a=r.previousElementSibling,n=document.createElement("div");n.classList.add("spacer"),e.insertBefore(n,a);let o=new IntersectionObserver(([s])=>{if(s.boundingClientRect.height===0)return;let l=0,p=this.card.querySelector('[slot="heading-s"]');p&&(l+=Pe(p));let m=this.card.querySelector('[slot="subtitle"]');m&&(l+=Pe(m));let f=this.card.querySelector('[slot="heading-m"]');f&&(l+=8+Pe(f));for(let se of e.childNodes){if(se.classList.contains("spacer"))break;l+=Pe(se)}let T=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(T)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),o.disconnect()});o.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists())}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${b}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Ne`<div class="divider"></div>`:rt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],e=this.card.querySelector(`[slot="heading-m"] ${b}[data-template="price"]`);e&&t.push(e);let r=t.map(async a=>{let n=a.cloneNode(!0);await a.onceSettled(),a?.options&&(a.options.displayPerUnit&&(a.dataset.displayPerUnit="false"),a.options.displayTax&&(a.dataset.displayTax="false"),a.options.displayPlanType&&(a.dataset.displayPlanType="false"),n.setAttribute("data-template","legal"),a.parentNode.insertBefore(n,a.nextSibling),await n.onceSettled())});await Promise.all(r)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let e=this.mainPrice;if(!e)return;await e.onceSettled();let r=e.value?.[0]?.planType;r&&(t.planType=r)}get stockCheckbox(){return this.card.checkboxLabel?Ne`<label id="stock-checkbox">
    ...
    `),d(A,"collectionOptions",{customHeaderArea:t=>t.sidenav?Ne`<slot name="resultsText"></slot>`:rt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]}});import{html as wt,css as Ai}from"../lit-all.min.js";var wr=`
:root {
...
`;var be=class extends v{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return wr}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return wt` ${this.badge}
    ...
    `);import{html as St,css as ki}from"../lit-all.min.js";var Sr=`
:root {
...
`;var ve=class extends v{constructor(t){super(t)}getGlobalCSS(){return Sr}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return St` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
  ...
  `);import{html as At,css as Ci}from"../lit-all.min.js";var Ar=`
:root {
...
`;var kr={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ye=class extends v{constructor(t){super(t)}getGlobalCSS(){return Ar}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return At`${this.cardImage}
            <div class="body">
...
`;var at=()=>window.matchMedia(R).matches,kt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Ee=class extends v{getGlobalCSS(){return Cr}get aemFragmentMapping(){return kt}get headingSelector(){return'[slot="heading-xs"]'}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),requestAnimationFrame(()=>{this.card?.hasAttribute("data-default-card")&&at()&&this.card.setAttribute("data-expanded","true")}))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(at()){let a=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",a?"true":"false")}else t.removeAttribute("data-expanded")};e();let r=window.matchMedia(R);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener),this.attributeObserver=new MutationObserver(a=>{a.forEach(n=>{n.type==="attributes"&&n.attributeName==="data-default-card"&&this.card.hasAttribute("data-default-card")&&at()&&this.card.setAttribute("data-expanded","true")})}),this.attributeObserver.observe(this.card,{attributes:!0,attributeOldValue:!0})}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(R).removeEventListener("change",this.mediaQueryListener),this.attributeObserver&&this.attributeObserver.disconnect()}handleChevronClick(t){t.preventDefault(),t.stopPropagation();let e=this.card;if(!e||!at())return;let n=e.getAttribute("data-expanded")==="true"?"false":"true";e.setAttribute("data-expanded",n)}renderLayout(){return Ti`
    ...
    `);import{css as _i,html as Pi}from"../lit-all.min.js";var Tr=`
...
`;var Lr={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},we=class extends v{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Tr}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${b}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Pi`
            ${this.badge}
            <div class="body">
    ...
    `);var nt=new Map,_r=new WeakMap,Pr=new Map,k=(i,t,e=null,r=null,a)=>{nt.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:a})};k("catalog",ue,mr,ue.variantStyle);k("image",et);k("inline-heading",tt);k("mini-compare-chart",xe,null,xe.variantStyle);k("plans",A,it,A.variantStyle,A.collectionOptions);k("plans-students",A,Er,A.variantStyle,A.collectionOptions);k("plans-education",A,yr,A.variantStyle,A.collectionOptions);k("product",be,null,be.variantStyle);k("segment",ve,null,ve.variantStyle);k("special-offers",ye,kr,ye.variantStyle);k("simplified-pricing-express",Ee,kt,Ee.variantStyle);k("mini",we,Lr,we.variantStyle);var Ri=(i,t,e)=>{try{let r=Pr.get(i.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),Pr.set(i.variant,r)),e?.styleSheet&&e.styleSheet!==r){let a=i.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);a!==-1&&i.shadowRoot.adoptedStyleSheets.splice(a,1)}return i.shadowRoot.adoptedStyleSheets.includes(r)||i.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let a=document.createElement("style");a.textContent=t.cssText,a.setAttribute("data-variant-style",i.variant);let n=e?.styleElement||i.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),i.shadowRoot.appendChild(a),{styleElement:a}}},Ct=i=>{let t=nt.get(i.variant);if(!t)return;let{class:e,style:r}=t,a=_r.get(i);if(a?.appliedVariant===i.variant)return new e(i);let n=r?Ri(i,r,a):{};return _r.set(i,{appliedVariant:i.variant,...n}),new e(i)};function Je(i){return nt.get(i)?.fragmentMapping}function Rr(i){return nt.get(i)?.collectionOptions}var H=null,Tt=()=>{if(H)return H;if(window.__masGlobalStyleSheet)H=window.__masGlobalStyleSheet;else{H=new CSSStyleSheet;let i=`
:root {
...
`;H.replaceSync(i),window.__masGlobalStyleSheet=H,document.adoptedStyleSheets.includes(H)||(document.adoptedStyleSheets=[...document.adoptedStyleSheets,H])}return H},Zo=Tt();function ot(i,t={},{metadata:e=!0,search:r=!0,storage:a=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),s=Lt(r)?r:i;n=o.get(s)}if(a&&n==null){let o=Lt(a)?a:i;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=zi(Lt(e)?e:i);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[i]}var Mi=i=>typeof i=="boolean",st=i=>typeof i=="function";var Lt=i=>typeof i=="string";function Mr(i,t){if(Mi(i))return i;let e=String(i);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function zi(i=""){return String(i).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var J=class i extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let a=e.response.headers?.get(Ke);a&&(e.requestId=a),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,i)}toString(){let t=Object.entries(this.context||{}).map(([r,a])=>`${r}: ${JSON.stringify(a)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var Oi="mas-commerce-service",Ni={requestId:Ke,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var ct=i=>window.setTimeout(i);function _t(){return document.getElementsByTagName(Oi)?.[0]}function zr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(Ni)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Or(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var Nr="fragment",$r="author",Ir="preview",Dr="loading",Fr="timeout",Pt="aem-fragment",Br="eager",Hr="cache",$i=[Br,Hr],D,ee,z,Rt=class{constructor(){g(this,D,new Map);g(this,ee,new Map);g(this,z,new Map)}clear(){c(this,D).clear(),c(this,ee).clear(),c(this,z).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,D).set(t.id,t),t.fields?.originalId&&c(this,D).set(t.fields.originalId,t),c(this,z).has(t.id)){let[,r]=c(this,z).get(t.id);r()}if(c(this,z).has(t.fields?.originalId)){let[,r]=c(this,z).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,D).has(t)}entries(){return c(this,D).entries()}get(t){return c(this,D).get(t)}getAsPromise(t){let[e]=c(this,z).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,z).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,ee).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,ee).set(t,e)),e}remove(t){c(this,D).delete(t),c(this,ee).delete(t),c(this,z).delete(t)}};D=new WeakMap,ee=new WeakMap,z=new WeakMap;var Y=new Rt,Se,F,U,_,C,y,$e,Ie,O,De,Fe,Ae,N,Ur,qr,Mt,jr,lt=class extends HTMLElement{constructor(){super(...arguments);g(this,N);d(this,"cache",Y);g(this,Se);g(this,F,null);g(this,U,null);g(this,_,null);g(this,C);g(this,y);g(this,$e,Br);g(this,Ie,5e3);g(this,O);g(this,De,!1);g(this,Fe,0);g(this,Ae)}static get observedAttributes(){return[Nr,Dr,Fr,$r,Ir]}attributeChangedCallback(e,r,a){e===Nr&&(h(this,C,a),h(this,y,Y.getFetchInfo(a))),e===Dr&&$i.includes(a)&&h(this,$e,a),e===Fr&&h(this,Ie,parseInt(a,10)),e===$r&&h(this,De,["","true"].includes(a)),e===Ir&&h(this,Ae,a)}connectedCallback(){if(!c(this,O)){if(c(this,_)??h(this,_,X(this)),h(this,Ae,c(this,_).settings?.preview),c(this,Se)??h(this,Se,c(this,_).log.module(`${Pt}[${c(this,C)}]`)),!c(this,C)||c(this,C)==="#"){c(this,y)??h(this,y,Y.getFetchInfo("missing-fragment-id")),w(this,N,Mt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,y)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,O)&&!await Promise.race([c(this,O),Promise.resolve(!1)]))return;e&&Y.remove(c(this,C)),c(this,$e)===Hr&&await Promise.race([Y.getAsPromise(c(this,C)),new Promise(s=>setTimeout(s,c(this,Ie)))]);try{h(this,O,w(this,N,jr).call(this)),await c(this,O)}catch(s){return w(this,N,Mt).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,F)||{};return o&&!ot("mas.disableWcsCache")&&c(this,_).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(le,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,y)},bubbles:!0,composed:!0})),c(this,O)}get updateComplete(){return c(this,O)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,U)?c(this,U):(c(this,De)?this.transformAuthorData():this.transformPublishData(),c(this,U))}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={}}=c(this,F);h(this,U,e.reduce((p,{name:m,multiple:f,values:T})=>(p.fields[m]=f?T:T[0],p),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:l}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={}}=c(this,F);h(this,U,Object.entries(e).reduce((p,[m,f])=>(p.fields[m]=f?.mimeType?f.value:f??"",p),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:l}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,C),{locale:c(this,_).settings.locale,apiKey:c(this,_).settings.wcsApiKey})}};Se=new WeakMap,F=new WeakMap,U=new WeakMap,_=new WeakMap,C=new WeakMap,y=new WeakMap,$e=new WeakMap,Ie=new WeakMap,O=new WeakMap,De=new WeakMap,Fe=new WeakMap,Ae=new WeakMap,N=new WeakSet,Ur=async function(e){Vt(this,Fe)._++;let r=`${Pt}:${c(this,C)}:${c(this,Fe)}`,a=`${r}${We}`,n=`${r}${Qe}`;if(c(this,Ae))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,y).stale=!1,c(this,y).url=e,o=await Or(e,{cache:"default",credentials:"omit"}),w(this,N,qr).call(this,o),c(this,y).status=o?.status,c(this,y).measure=he(performance.measure(n,a)),c(this,y).retryCount=o.retryCount,!o?.ok)throw new J("Unexpected fragment response",{response:o,...c(this,_).duration});return await o.json()}catch(s){if(c(this,y).measure=he(performance.measure(n,a)),c(this,y).retryCount=s.retryCount,c(this,F))return c(this,y).stale=!0,c(this,Se).error("Serving stale data",c(this,y)),c(this,F);let l=s.message??"unknown";throw new J(`Failed to fetch fragment: ${l}`,{})}},qr=function(e){Object.assign(c(this,y),zr(e))},Mt=function(e){h(this,O,null),c(this,y).message=e,this.classList.add("error");let r={...c(this,y),...c(this,_).duration};c(this,Se).error(e,r),this.dispatchEvent(new CustomEvent(de,{detail:r,bubbles:!0,composed:!0}))},jr=async function(){var l;this.classList.remove("error"),h(this,U,null);let e=Y.get(c(this,C));if(e)return h(this,F,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,_).settings,s=`${r}/fragment?id=${c(this,C)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await w(this,N,Ur).call(this,s),(l=e.fields).originalId??(l.originalId=c(this,C)),Y.add(e),h(this,F,e),!0},d(lt,"cache",Y);customElements.define(Pt,lt);import{LitElement as Ii,html as Di,css as Fi}from"../lit-all.min.js";var ke=class extends Ii{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return Di`<div class="badge">
            ${this.text}
    ...
    `),d(Be,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Be);import{html as zt,css as qi,LitElement as ji}from"../lit-all.min.js";var He=class extends ji{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return zt`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${this.isMobile&&this.rows.length>this.mobileRows?zt`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:zt``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};d(He,"styles",qi`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),d(He,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",He);var te={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,tags:"acom",isProdDomain:!1},Gr=1e3;function Gi(i){return i instanceof Error||typeof i?.originatingRequest=="string"}function Vr(i){if(i==null)return;let t=typeof i;if(t==="function")return i.name?`function ${i.name}`:"function";if(t==="object"){if(i instanceof Error)return i.message;if(typeof i.originatingRequest=="string"){let{message:r,originatingRequest:a,status:n}=i;return[r,n,a].filter(Boolean).join(" ")}let e=i[Symbol.toStringTag]??Object.getPrototypeOf(i).constructor.name;if(!te.serializableTypes.includes(e))return e}return i}function Vi(i,t){if(!te.ignoredProperties.includes(i))return Vr(t)}var Ot={append(i){if(i.level!=="error")return;let{message:t,params:e}=i,r=[],a=[],n=t;e.forEach(p=>{p!=null&&(Gi(p)?r:a).push(p)}),r.length&&(n+=" "+r.map(Vr).join(" "));let{pathname:o,search:s}=window.location,l=`${te.delimiter}page=${o}${s}`;l.length>Gr&&(l=`${l.slice(0,Gr)}<trunc>`),n+=l,a.length&&(n+=`${te.delimiter}facts=`,n+=JSON.stringify(a,Vi)),window.lana?.log(n,te)}};function Yr(i){Object.assign(te,Object.fromEntries(Object.entries(i).filter(([t,e])=>t in te&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Kr={LOCAL:"local",PROD:"prod",STAGE:"stage"},Nt={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},$t=new Set,It=new Set,Wr=new Map,Qr={append({level:i,message:t,params:e,timestamp:r,source:a}){console[i](`${r}ms [${a}] %c${t}`,"font-weight: bold;",...e)}},Xr={filter:({level:i})=>i!==Nt.DEBUG},Yi={filter:()=>!1};function Ki(i,t,e,r,a){return{level:i,message:t,namespace:e,get params(){return r.length===1&&st(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:a,timestamp:performance.now().toFixed(3)}}function Wi(i){[...It].every(t=>t(i))&&$t.forEach(t=>t(i))}function Zr(i){let t=(Wr.get(i)??0)+1;Wr.set(i,t);let e=`${i} #${t}`,r={id:e,namespace:i,module:a=>Zr(`${r.namespace}/${a}`),updateConfig:Yr};return Object.values(Nt).forEach(a=>{r[a]=(n,...o)=>Wi(Ki(a,n,i,o,e))}),Object.seal(r)}function dt(...i){i.forEach(t=>{let{append:e,filter:r}=t;st(r)&&It.add(r),st(e)&&$t.add(e)})}function Qi(i={}){let{name:t}=i,e=Mr(ot("commerce.debug",{search:!0,storage:!0}),t===Kr.LOCAL);return dt(e?Qr:Xr),t===Kr.PROD&&dt(Ot),Dt}function Xi(){$t.clear(),It.clear()}var Dt={...Zr(cr),Level:Nt,Plugins:{consoleAppender:Qr,debugFilter:Xr,quietFilter:Yi,lanaAppender:Ot},init:Qi,reset:Xi,use:dt};var Zi={[G]:ar,[Q]:nr,[V]:or},Ji={[G]:sr,[V]:_e},Ue,ht=class{constructor(t){g(this,Ue);d(this,"changes",new Map);d(this,"connected",!1);d(this,"error");d(this,"log");d(this,"options");d(this,"promises",[]);d(this,"state",Q);d(this,"timer",null);d(this,"value");d(this,"version",0);d(this,"wrapperElement");this.wrapperElement=t,this.log=Dt.module("mas-element")}update(){[G,Q,V].forEach(t=>{this.wrapperElement.classList.toggle(Zi[t],t===this.state)})}notify(){(this.state===V||this.state===G)&&(this.state===V?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===G&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let t=this.error;this.error instanceof J&&(t={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(Ji[this.state],{bubbles:!0,detail:t}))}attributeChangedCallback(t,e,r){this.changes.set(t,r),this.requestUpdate()}connectedCallback(){h(this,Ue,_t()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:t,promises:e,state:r}=this;return V===r?Promise.resolve(this.wrapperElement):G===r?Promise.reject(t):new Promise((a,n)=>{e.push({resolve:a,reject:n})})}toggleResolved(t,e,r){return t!==this.version?!1:(r!==void 0&&(this.options=r),this.state=V,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),ct(()=>this.notify()),!0)}toggleFailed(t,e,r){if(t!==this.version)return!1;r!==void 0&&(this.options=r),this.error=e,this.state=G,this.update();let a=this.wrapperElement.getAttribute("is");return this.log?.error(`${a}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...c(this,Ue)?.duration}),ct(()=>this.notify()),!0}togglePending(t){return this.version++,t&&(this.options=t),this.state=Q,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!_t()||this.timer)return;let{error:e,options:r,state:a,value:n,version:o}=this;this.state=Q,this.timer=ct(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||t)try{await this.wrapperElement.render?.()===!1&&this.state===Q&&this.version===o&&(this.state=a,this.error=e,this.value=n,this.update(),this.notify())}catch(l){this.toggleFailed(this.version,l,r)}})}};Ue=new WeakMap;function ea(i){return`https://${i==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var ie,re=class re extends HTMLAnchorElement{constructor(){super();d(this,"masElement",new ht(this));g(this,ie);this.setAttribute("is",re.is)}get isUptLink(){return!0}initializeWcsData(e,r){this.setAttribute("data-wcs-osi",e),r&&this.setAttribute("data-promotion-code",r)}attributeChangedCallback(e,r,a){this.masElement.attributeChangedCallback(e,r,a)}connectedCallback(){this.masElement.connectedCallback(),h(this,ie,X()),c(this,ie)&&(this.log=c(this,ie).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),h(this,ie,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=X();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let r=e.collectCheckoutOptions({},this);if(!r.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let a=this.masElement.togglePending(r),n=e.resolveOfferSelectors(r);try{let[[o]]=await Promise.all(n),{country:s,language:l,env:p}=r,m=`locale=${l}_${s}&country=${s}&offer_id=${o.offerId}`,f=this.getAttribute("data-promotion-code");f&&(m+=`&promotion_code=${encodeURIComponent(f)}`),this.href=`${ea(p)}?${m}`,this.masElement.toggleResolved(a,o,r)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${r.wcsOsi}.`,o.message);return this.masElement.toggleFailed(a,s,r),!1}}static createFrom(e){let r=new re;for(let a of e.attributes)a.name!=="is"&&(a.name==="class"&&a.value.includes("upt-link")?r.setAttribute("class",a.value.replace("upt-link","").trim()):r.setAttribute(a.name,a.value));return r.innerHTML=e.innerHTML,r.setAttribute("tabindex",0),r}};ie=new WeakMap,d(re,"is","upt-link"),d(re,"tag","a"),d(re,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var K=re;window.customElements.get(K.is)||window.customElements.define(K.is,K,{extends:K.tag});var ta="#000000",Ft="#F8D904",ra="#EAEAEA",ia="#31A547",aa=/(accent|primary|secondary)(-(outline|link))?/,na="mas:product_code/",oa="daa-ll",mt="daa-lh",sa=["XL","L","M","S"],Bt="...";function $(i,t,e,r){let a=r[i];if(t[i]&&a){let n={slot:a?.slot},o=t[i];if(a.maxCount&&typeof o=="string"){let[l,p]=Aa(o,a.maxCount,a.withSuffix);l!==o&&(n.title=p,o=l)}let s=S(a.tag,n,o);e.append(s)}}function ca(i,t,e){let r=i.mnemonicIcon?.map((n,o)=>({icon:n,alt:i.mnemonicAlt[o]??"",link:i.mnemonicLink[o]??""}));r?.forEach(({icon:n,alt:o,link:s})=>{if(s&&!/^https?:/.test(s))try{s=new URL(`https://${s}`).href.toString()}catch{s="#"}let l={slot:"icons",src:n,loading:t.loading,size:e?.size??"l"};o&&(l.alt=o),s&&(l.href=s);let p=S("merch-icon",l);t.append(p)});let a=t.shadowRoot.querySelector('slot[name="icons"]');!r?.length&&a&&a.remove()}function la(i,t,e){if(e.badge?.slot){if(i.badge?.length&&!i.badge?.startsWith("<merch-badge")){let r=Ft,a=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(r=e.badge?.default,i.borderColor||(a=!0));let n=i.badgeBackgroundColor||r,o=i.borderColor||"";a&&(o=e.badge?.default,i.borderColor=e.badge?.default),i.badge=`<merch-badge variant="${i.variant}" background-color="${n}" border-color="${o}">${i.badge}</merch-badge>`}$("badge",i,t,e)}else i.badge?(t.setAttribute("badge-text",i.badge),e.disabledAttributes?.includes("badgeColor")||t.setAttribute("badge-color",i.badgeColor||ta),e.disabledAttributes?.includes("badgeBackgroundColor")||t.setAttribute("badge-background-color",i.badgeBackgroundColor||Ft),t.setAttribute("border-color",i.badgeBackgroundColor||Ft)):t.setAttribute("border-color",i.borderColor||ra)}function da(i,t,e){if(e.trialBadge&&i.trialBadge){if(!i.trialBadge.startsWith("<merch-badge")){let r=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&i.trialBadgeBorderColor||ia;i.trialBadge=`<merch-badge variant="${i.variant}" border-color="${r}">${i.trialBadge}</merch-badge>`}$("trialBadge",i,t,e)}}function ha(i,t,e){e?.includes(i.size)&&t.setAttribute("size",i.size)}function pa(i,t){i.cardName&&t.setAttribute("name",i.cardName)}function ma(i,t,e){$("cardTitle",i,t,{cardTitle:e})}function ga(i,t,e){$("subtitle",i,t,e)}function ua(i,t,e,r){if(!i.backgroundColor||i.backgroundColor.toLowerCase()==="default"){t.style.removeProperty("--merch-card-custom-background-color"),t.removeAttribute("background-color");return}e?.[i.backgroundColor]?(t.style.setProperty("--merch-card-custom-background-color",`var(${e[i.backgroundColor]})`),t.setAttribute("background-color",i.backgroundColor)):r?.attribute&&i.backgroundColor&&(t.setAttribute(r.attribute,i.backgroundColor),t.style.removeProperty("--merch-card-custom-background-color"))}function fa(i,t,e){let r=e?.borderColor,a="--consonant-merch-card-border-color";if(i.borderColor?.toLowerCase()==="transparent")t.style.setProperty(a,"transparent");else if(i.borderColor&&r)if(r?.specialValues?.[i.borderColor]?.includes("gradient")||/-gradient/.test(i.borderColor)){t.setAttribute("gradient-border","true");let s=i.borderColor;if(r?.specialValues){for(let[l,p]of Object.entries(r.specialValues))if(p===i.borderColor){s=l;break}}t.setAttribute("border-color",s),t.style.removeProperty(a)}else t.style.setProperty(a,`var(--${i.borderColor})`)}function xa(i,t,e){if(i.backgroundImage){let r={loading:t.loading??"lazy",src:i.backgroundImage};if(i.backgroundImageAltText?r.alt=i.backgroundImageAltText:r.role="none",!e)return;if(e?.attribute){t.setAttribute(e.attribute,i.backgroundImage);return}t.append(S(e.tag,{slot:e.slot},S("img",r)))}}function pt(i){return!i||typeof i!="string"||i.includes("<mas-tooltip")&&Promise.resolve().then(()=>(bt(),xt)).catch(console.error),i}function ba(i,t,e){i.prices&&(i.prices=pt(i.prices)),$("prices",i,t,e)}function ei(i,t,e){let r=i.hasAttribute("data-wcs-osi")&&!!i.getAttribute("data-wcs-osi"),a=i.className||"",n=aa.exec(a)?.[0]??"accent",o=n.includes("accent"),s=n.includes("primary"),l=n.includes("secondary"),p=n.includes("-outline"),m=n.includes("-link");i.classList.remove("accent","primary","secondary");let f;if(t.consonant)f=La(i,o,r,m,s);else if(m)f=i;else{let T;o?T="accent":s?T="primary":l&&(T="secondary"),f=t.spectrum==="swc"?Ta(i,e,p,T,r):Ca(i,e,p,T,r)}return f}function va(i,t){let{slot:e}=t?.description,r=i.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);r.length&&r.forEach(a=>{let n=ei(a,i,t);a.replaceWith(n)})}function ya(i,t,e){i.description&&(i.description=pt(i.description)),i.promoText&&(i.promoText=pt(i.promoText)),$("promoText",i,t,e),$("description",i,t,e),va(t,e),$("callout",i,t,e),$("quantitySelect",i,t,e),$("whatsIncluded",i,t,e)}function Ea(i,t,e){if(!e.addon)return;let r=i.addon?.replace(/[{}]/g,"");if(!r||/disabled/.test(r))return;let a=S("merch-addon",{slot:"addon"},r);[...a.querySelectorAll(b)].forEach(n=>{let o=n.parentElement;o?.nodeName==="P"&&o.setAttribute("data-plan-type","")}),t.append(a)}function wa(i,t,e){i.addonConfirmation&&$("addonConfirmation",i,t,e)}function Sa(i,t,e,r){r?.secureLabel&&e?.secureLabel&&t.setAttribute("secure-label",r.secureLabel)}function Aa(i,t,e=!0){try{let r=typeof i!="string"?"":i,a=Jr(r);if(a.length<=t)return[r,a];let n=0,o=!1,s=e?t-Bt.length<1?1:t-Bt.length:t,l=[];for(let f of r){if(n++,f==="<")if(o=!0,r[n]==="/")l.pop();else{let T="";for(let se of r.substring(n)){if(se===" "||se===">")break;T+=se}l.push(T)}if(f==="/"&&r[n]===">"&&l.pop(),f===">"){o=!1;continue}if(!o&&(s--,s===0))break}let p=r.substring(0,n).trim();if(l.length>0){l[0]==="p"&&l.shift();for(let f of l.reverse())p+=`</${f}>`}return[`${p}${e?Bt:""}`,a]}catch{let a=typeof i=="string"?i:"",n=Jr(a);return[a,n]}}function Jr(i){if(!i)return"";let t="",e=!1;for(let r of i){if(r==="<"&&(e=!0),r===">"){e=!1;continue}e||(t+=r)}return t}function ka(i,t){t.querySelectorAll("a.upt-link").forEach(r=>{let a=K.createFrom(r);r.replaceWith(a),a.initializeWcsData(i.osi,i.promoCode)})}function Ca(i,t,e,r,a){let n=i;a?n=customElements.get("checkout-button").createCheckoutButton({},i.innerHTML):n.innerHTML=`<span>${n.textContent}</span>`,n.setAttribute("tabindex",0);for(let m of i.attributes)["class","is"].includes(m.name)||n.setAttribute(m.name,m.value);n.firstElementChild?.classList.add("spectrum-Button-label");let o=t?.ctas?.size??"M",s=`spectrum-Button--${r}`,l=sa.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",p=["spectrum-Button",s,l];return e&&p.push("spectrum-Button--outline"),n.classList.add(...p),n}function Ta(i,t,e,r,a){let n=i;a&&(n=customElements.get("checkout-button").createCheckoutButton(i.dataset),n.connectedCallback(),n.render());let o="fill";e&&(o="outline");let s=S("sp-button",{treatment:o,variant:r,tabIndex:0,size:t?.ctas?.size??"m",...i.dataset.analyticsId&&{"data-analytics-id":i.dataset.analyticsId}},i.innerHTML);return s.source=n,(a?n.onceSettled():Promise.resolve(n)).then(l=>{s.setAttribute("data-navigation-url",l.href)}),s.addEventListener("click",l=>{l.defaultPrevented||n.click()}),s}function La(i,t,e,r,a){let n=i;return e&&(n=customElements.get("checkout-link").createCheckoutLink(i.dataset,i.innerHTML)),r||(n.classList.add("button","con-button"),t&&n.classList.add("blue"),a&&n.classList.add("primary")),n}function _a(i,t,e,r){if(i.ctas){i.ctas=pt(i.ctas);let{slot:a}=e.ctas,n=S("div",{slot:a},i.ctas),o=[...n.querySelectorAll("a")].map(s=>ei(s,t,e));n.innerHTML="",n.append(...o),t.append(n)}}function Pa(i,t){let{tags:e}=i,r=e?.find(n=>n.startsWith(na))?.split("/").pop();if(!r)return;t.setAttribute(mt,r),[...t.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((n,o)=>{n.setAttribute(oa,`${n.dataset.analyticsId}-${o+1}`)})}function Ra(i){i.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,e])=>{i.querySelectorAll(`a.${t}`).forEach(r=>{r.classList.remove(t),r.classList.add("spectrum-Link",`spectrum-Link--${e}`)})})}function Ma(i){i.querySelectorAll("[slot]").forEach(r=>{r.remove()}),i.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","badge-background-color","badge-color","badge-text","gradient-border","size",mt].forEach(r=>i.removeAttribute(r));let e=["wide-strip","thin-strip"];i.classList.remove(...e)}async function ti(i,t){if(!i){let l=t?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${l}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${l}).`)}if(!i.fields){let l=i.id||"unknown",p=t?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${p}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${p}) is missing 'fields'.`)}let{id:e,fields:r,settings:a={},priceLiterals:n}=i,{variant:o}=r;if(!o)throw new Error(`hydrate: no variant found in payload ${e}`);Ma(t),t.settings=a,n&&(t.priceLiterals=n),t.id??(t.id=i.id),t.variant=o,await t.updateComplete;let{aemFragmentMapping:s}=t.variantLayout;if(!s)throw new Error(`hydrate: variant mapping not found for ${e}`);s.style==="consonant"&&t.setAttribute("consonant",!0),ca(r,t,s.mnemonics),la(r,t,s),da(r,t,s),ha(r,t,s.size),pa(r,t),ma(r,t,s.title),ga(r,t,s),ba(r,t,s),xa(r,t,s.backgroundImage),ua(r,t,s.allowedColors,s.backgroundColor),fa(r,t,s),ya(r,t,s),Ea(r,t,s),wa(r,t,s),Sa(r,t,s,a),ka(r,t),_a(r,t,s,o),Pa(r,t),Ra(t)}var qt="merch-card",Ht=2e4,ri="merch-card:";function ii(i,t){let e=i.closest(qt);if(!e)return t;e.priceLiterals&&(t.literals??(t.literals={}),Object.assign(t.literals,e.priceLiterals)),e.variantLayout?.priceOptionsProvider?.(i,t)}function Oa(i){i.providers.has(ii)||i.providers.price(ii)}var Na=0,Ce,Te,Le,q,ne,B,oe,E,ae,gt,ai,ut,P=class P extends za{constructor(){super();g(this,E);g(this,Ce);g(this,Te);g(this,Le);g(this,q);g(this,ne);g(this,B);g(this,oe,new Promise(e=>{h(this,B,e)}));d(this,"customerSegment");d(this,"marketSegment");d(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}firstUpdated(){this.variantLayout=Ct(this),this.variantLayout?.connectedCallbackHook()}willUpdate(e){(e.has("variant")||!this.variantLayout)&&(this.variantLayout=Ct(this),this.variantLayout?.connectedCallbackHook())}updated(e){(e.has("badgeBackgroundColor")||e.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border",this.computedBorderStyle),e.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(e)}catch(r){w(this,E,ae).call(this,`Error in postCardUpdateHook: ${r.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["ccd-slice","ccd-suggested","ah-promoted-plans","simplified-pricing-express"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector(b)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(j)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(j)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(j)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:e}){if(!this.stockOfferOsis)return;let r=this.checkoutLinks;if(r.length!==0)for(let a of r){await a.onceSettled();let n=a.value?.[0]?.planType;if(!n)return;let o=this.stockOfferOsis[n];if(!o)return;let s=a.dataset.wcsOsi.split(",").filter(l=>l!==o);e.checked&&s.push(o),a.dataset.wcsOsi=s.join(",")}}changeHandler(e){e.target.tagName==="MERCH-ADDON"&&this.toggleAddon(e.target)}toggleAddon(e){this.variantLayout?.toggleAddon?.(e);let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length===0)return;let a=n=>{let{offerType:o,planType:s}=n.value?.[0]??{};if(!o||!s)return;let l=e.getOsi(s,o),p=(n.dataset.wcsOsi||"").split(",").filter(m=>m&&m!==l);e.checked&&p.push(l),n.dataset.wcsOsi=p.join(",")};r.forEach(a)}handleQuantitySelection(e){let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length!==0)for(let a of r)a.dataset.quantity=e.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(e){let r={...this.filters};Object.keys(r).forEach(a=>{if(e){r[a].order=Math.min(r[a].order||2,2);return}let n=r[a].order;n===1||Number.isNaN(Number(n))||(r[a].order=Number(n)+1)}),this.filters=r}includes(e){return this.textContent.match(new RegExp(e,"i"))!==null}connectedCallback(){var r;super.connectedCallback(),c(this,Te)||h(this,Te,Na++),this.aemFragment||((r=c(this,B))==null||r.call(this),h(this,B,void 0)),P.globalStyleSheet&&this.shadowRoot&&!this.shadowRoot.adoptedStyleSheets.includes(P.globalStyleSheet)&&(this.shadowRoot.adoptedStyleSheets=[...this.shadowRoot.adoptedStyleSheets,P.globalStyleSheet]),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let e=this.id??c(this,Te);h(this,ne,`${ri}${e}${We}`),h(this,Ce,`${ri}${e}${Qe}`),performance.mark(c(this,ne)),h(this,q,X()),Oa(c(this,q)),h(this,Le,c(this,q).Log.module(qt)),this.addEventListener(vt,this.handleQuantitySelection),this.addEventListener(yt,this.handleAddonAndQuantityUpdate),this.addEventListener(Jt,this.handleMerchOfferSelectReady),this.addEventListener(de,this.handleAemFragmentEvents),this.addEventListener(le,this.handleAemFragmentEvents),this.addEventListener("change",this.changeHandler),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(vt,this.handleQuantitySelection),this.removeEventListener(de,this.handleAemFragmentEvents),this.removeEventListener(le,this.handleAemFragmentEvents),this.removeEventListener("change",this.changeHandler),this.removeEventListener(yt,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(e){var r;if(this.isConnected&&(e.type===de&&w(this,E,ae).call(this,"AEM fragment cannot be loaded"),e.type===le&&(this.failed=!1,e.target.nodeName==="AEM-FRAGMENT"))){let a=e.detail;try{c(this,B)||h(this,oe,new Promise(n=>{h(this,B,n)})),ti(a,this)}catch(n){w(this,E,ae).call(this,`hydration has failed: ${n.message}`)}finally{(r=c(this,B))==null||r.call(this),h(this,B,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected)return;c(this,oe)&&(await c(this,oe),h(this,oe,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let e=new Promise(s=>setTimeout(()=>s("timeout"),Ht));if(this.aemFragment){let s=await Promise.race([this.aemFragment.updateComplete,e]);if(s===!1||s==="timeout"){let l=s==="timeout"?`AEM fragment was not resolved within ${Ht} timeout`:"AEM fragment cannot be loaded";w(this,E,ae).call(this,l,{},!1);return}}let r=[...this.querySelectorAll(Zt)],a=Promise.all(r.map(s=>s.onceSettled().catch(()=>s))).then(s=>s.every(l=>l.classList.contains("placeholder-resolved"))),n=await Promise.race([a,e]);if(n===!0){this.measure=performance.measure(c(this,Ce),c(this,ne));let s={...this.aemFragment?.fetchInfo,...c(this,q).duration,measure:he(this.measure)};return this.dispatchEvent(new CustomEvent(rr,{bubbles:!0,composed:!0,detail:s})),this}this.measure=performance.measure(c(this,Ce),c(this,ne));let o={measure:he(this.measure),...c(this,q).duration};n==="timeout"?w(this,E,ae).call(this,`Contains offers that were not resolved within ${Ht} timeout`,o):w(this,E,ae).call(this,"Contains unresolved offers",o)}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let e=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(j)).length===2&&e&&e.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:e,items:r}}){if(!e||!r?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let n=this.checkoutLinks.find(m=>m.getAttribute("data-modal-id")===e);if(!n)return;let s=new URL(n.getAttribute("href")).searchParams.get("pa"),l=r.find(m=>m.productArrangementCode===s)?.quantity,p=!!r.find(m=>m.productArrangementCode!==s);if(l&&this.quantitySelect?.dispatchEvent(new CustomEvent(tr,{detail:{quantity:l},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==p){this.toggleStockOffer({target:this.addonCheckbox});let m=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(m,"target",{writable:!1,value:{checked:p}}),this.addonCheckbox.handleChange(m)}}get prices(){return Array.from(this.querySelectorAll(b))}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let e=this.querySelector(".price.price-alternative");if(e||(e=this.querySelector(`${b}[data-template="price"] > span`)),!!e)return e=e.innerText,e}get regularPrice(){return c(this,E,gt)?.innerText}get promotionCode(){let e=[...this.querySelectorAll(`${b}[data-promotion-code],${j}[data-promotion-code]`)].map(a=>a.dataset.promotionCode),r=[...new Set(e)];return r.length>1&&c(this,Le)?.warn(`Multiple different promotion codes found: ${r.join(", ")}`),e[0]}get annualPrice(){return this.querySelector(`${b}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(c(this,E,ai)??c(this,E,gt))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return c(this,E,gt)?.querySelector("span.price-recurrence")?.textContent?.trim()}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let e=this.querySelector('a[is="upt-link"]');if(e)return w(this,E,ut).call(this,e)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){let e=this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${j}, a`);return Array.from(e??[])}get primaryCta(){return w(this,E,ut).call(this,this.ctas.find(e=>e.variant==="accent"||e.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return w(this,E,ut).call(this,this.ctas.find(e=>e.variant!=="accent"&&!e.matches(".spectrum-Button--accent,.con-button.blue")))}};Ce=new WeakMap,Te=new WeakMap,Le=new WeakMap,q=new WeakMap,ne=new WeakMap,B=new WeakMap,oe=new WeakMap,E=new WeakSet,ae=function(e,r={},a=!0){if(!this.isConnected)return;let{aemFragment:n}=this,o=n?.getAttribute("fragment");o=`[${o}]`;let s={...this.aemFragment.fetchInfo,...c(this,q).duration,...r,message:e};c(this,Le).error(`merch-card${o}: ${e}`,s),this.failed=!0,a&&this.dispatchEvent(new CustomEvent(ir,{bubbles:!0,composed:!0,detail:s}))},gt=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${b}[data-template="price"] > span`)},ai=function(){return this.querySelector(`${b}[data-template="legal"]`)},ut=function(e){if(e)return{text:e.innerText.trim(),analyticsId:e.dataset.analyticsId,href:e.getAttribute("href")??e.dataset.href}},d(P,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:e=>{if(!e)return;let[r,a,n]=e.split(",");return{PUF:r,ABM:a,M2M:n}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:e=>Object.fromEntries(e.split(",").map(r=>{let[a,n,o]=r.split(":"),s=Number(n);return[a,{order:Number.isNaN(Number(s))?void 0:s,size:o}]})),toAttribute:e=>Object.entries(e).map(([r,{order:a,size:n}])=>[r,a,n].filter(o=>o!==void 0).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:mt,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),d(P,"styles",[Wt,...Qt()]),d(P,"globalStyleSheet",null),P.globalStyleSheet=Tt(),d(P,"registerVariant",k),d(P,"getCollectionOptions",Rr),d(P,"getFragmentMapping",Je);var Ut=P;customElements.define(qt,Ut);export{Ut as MerchCard};
