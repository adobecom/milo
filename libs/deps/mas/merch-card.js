var to=Object.defineProperty;var ir=e=>{throw TypeError(e)};var ro=(e,t,r)=>t in e?to(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var f=(e,t,r)=>ro(e,typeof t!="symbol"?t+"":t,r),dt=(e,t,r)=>t.has(e)||ir("Cannot "+r);var E=(e,t,r)=>(dt(e,t,"read from private field"),r?r.call(e):t.get(e)),N=(e,t,r)=>t.has(e)?ir("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),R=(e,t,r,n)=>(dt(e,t,"write to private field"),n?n.call(e,r):t.set(e,r),r),Y=(e,t,r)=>(dt(e,t,"access private method"),r);import{LitElement as ui}from"../lit-all.min.js";import{LitElement as no,html as sr,css as oo}from"../lit-all.min.js";var d=class extends no{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:t}=this;return t?sr`<a href="${t}">
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return br}setAriaExpanded(r,n){r.setAttribute("aria-expanded",n)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};f(pe,"variantStyle",ao`
...
`;var Xe=class extends w{constructor(t){super(t)}getGlobalCSS(){return vr}renderLayout(){return Er` ${this.badge}
    ...
    ${this.card.customHr?"":Er`<hr />`} ${this.secureLabelFooter}`}};import{html as fe,css as io,unsafeCSS as Sr}from"../lit-all.min.js";var wr=`
  :root {
...
`;var so=32,ge=class extends w{constructor(r){super(r);f(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);f(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?fe`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){Ye()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};f(ge,"variantStyle",io`
...
`;var gt={title:{tag:"p",slot:"heading-xs"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},stockOffer:!0,secureLabel:!0,ctas:{slot:"footer",size:"m"},style:"consonant"},xe=class extends w{constructor(t){super(t)}get aemFragmentMapping(){return gt}getGlobalCSS(){return Ar}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?Tr`<label id="stock-checkbox">
        ...
        ${this.secureLabelFooter}`}};f(xe,"variantStyle",co`
    :host([variant='plans']) {
      min-height: 348px;
    }
  ...
  `);import{html as xt,css as ho}from"../lit-all.min.js";var _r=`
:root {
...
`;var ee=class extends w{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return _r}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return xt` ${this.badge}
      ...
      ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}postCardUpdateHook(){this.card.isConnected&&(Ye()||this.adjustProductBodySlots(),this.adjustTitleWidth())}};f(ee,"variantStyle",ho`
...
`;var be=class extends w{constructor(t){super(t)}getGlobalCSS(){return Lr}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return bt` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
    ...
    <hr />
    ${this.secureLabelFooter}`}};f(be,"variantStyle",lo`
...
`;var vt={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ye=class extends w{constructor(t){super(t)}getGlobalCSS(){return Pr}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return vt}renderLayout(){return yt`${this.cardImage}
            <div class="body">
            ...
            ${this.evergreen?yt`
                  ...
                  `:yt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};f(ye,"variantStyle",mo`
...
`;var ve=class extends w{constructor(t){super(t)}getGlobalCSS(){return Cr}renderLayout(){return uo`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
      ...
      <footer><slot name="footer"></slot></footer>`}};f(ve,"variantStyle",po`
    :host([variant='twp']) {
      padding: 4px 10px 5px 10px;
    }
    .twp-badge {
...
`;var Et={backgroundImage:{attribute:"background-image"},badge:!0,ctas:{slot:"cta",size:"M"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"p",slot:"price"},size:[],subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"}},Ee=class extends w{getGlobalCSS(){return Nr}get aemFragmentMapping(){return Et}get stripStyle(){return this.card.backgroundImage?`
        ...
        `:""}renderLayout(){return fo` <div style="${this.stripStyle}" class="body">
            ...
            <slot></slot>`}postCardUpdateHook(t){t.has("backgroundImage")&&this.styleBackgroundImage()}styleBackgroundImage(){if(this.card.classList.remove("thin-strip"),this.card.classList.remove("wide-strip"),!this.card.backgroundImage)return;let t=new Image;t.src=this.card.backgroundImage,t.onload=()=>{t.width>8?this.card.classList.add("wide-strip"):t.width===8&&this.card.classList.add("thin-strip")}}};f(Ee,"variantStyle",go`
...
`;var wt={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},we=class extends w{getGlobalCSS(){return Rr}get aemFragmentMapping(){return wt}renderLayout(){return xo` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
            ...
            <slot></slot>`}};f(we,"variantStyle",bo`
        :host([variant='ccd-slice']) {
...
`;var St={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color"},allowedColors:{gray:"--spectrum-gray-100"},size:["single","double","triple"]},te=class extends w{getGlobalCSS(){return Mr}get aemFragmentMapping(){return St}renderLayout(){return yo`
  ...
  `);customElements.define("ah-try-buy-widget",te);var At=(e,t=!1)=>{switch(e.variant){case"catalog":return new pe(e);case"image":return new We(e);case"inline-heading":return new Xe(e);case"mini-compare-chart":return new ge(e);case"plans":return new xe(e);case"product":return new ee(e);case"segment":return new be(e);case"special-offers":return new ye(e);case"twp":return new ve(e);case"ccd-suggested":return new Ee(e);case"ccd-slice":return new we(e);case"ah-try-buy-widget":return new te(e);default:return t?void 0:new ee(e)}},Hr={catalog:ft,image:null,"inline-heading":null,"mini-compare-chart":null,plans:gt,product:null,segment:null,"special-offers":vt,twp:null,"ccd-suggested":Et,"ccd-slice":wt,"ah-try-buy-widget":St},Ir=()=>{let e=[];return e.push(pe.variantStyle),e.push(ge.variantStyle),e.push(ee.variantStyle),e.push(xe.variantStyle),e.push(be.variantStyle),e.push(ye.variantStyle),e.push(ve.variantStyle),e.push(Ee.variantStyle),e.push(we.variantStyle),e.push(te.variantStyle),e};var Or=document.createElement("style");Or.innerHTML=`
:root {
