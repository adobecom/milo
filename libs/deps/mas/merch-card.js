var Ht=Object.defineProperty;var Ut=a=>{throw TypeError(a)};var ea=(a,t,e)=>t in a?Ht(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var qt=(a,t)=>()=>(a&&(t=a(a=0)),t);var ta=(a,t)=>{for(var e in t)Ht(a,e,{get:t[e],enumerable:!0})};var d=(a,t,e)=>ea(a,typeof t!="symbol"?t+"":t,e),pt=(a,t,e)=>t.has(a)||Ut("Cannot "+e);var s=(a,t,e)=>(pt(a,t,"read from private field"),e?e.call(a):t.get(a)),m=(a,t,e)=>t.has(a)?Ut("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),h=(a,t,e,r)=>(pt(a,t,"write to private field"),r?r.call(a,e):t.set(a,e),e),w=(a,t,e)=>(pt(a,t,"access private method"),e);var jt=(a,t,e,r)=>({set _(i){h(a,t,i,e)},get _(){return s(a,t,r)}});var mt={};ta(mt,{default:()=>G});import{LitElement as ra,html as je,css as aa}from"../lit-all.min.js";function ia(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var G,gt=qt(()=>{ut();G=class extends ra{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs"}get effectiveContent(){return this.tooltipText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.placement||"top"}renderIcon(){return this.src?je`<merch-icon 
            src="${this.src}" 
            size="${this.size}"
    ...
    `);customElements.define("merch-icon",oe)});import{LitElement as ki}from"../lit-all.min.js";import{css as Vt,unsafeCSS as Gt}from"../lit-all.min.js";var _="(max-width: 767px)",ie="(max-width: 1199px)",v="(min-width: 768px)",u="(min-width: 1200px)",O="(min-width: 1600px)";function Be(){return window.matchMedia(_)}function He(){return window.matchMedia(u)}function Ue(){return Be().matches}function qe(){return He().matches}var Yt=Vt`
    :host {
...
`,Kt=()=>[Vt`
      ...
      `];ut();var Fi=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),Bi=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var f='span[is="inline-price"][data-wcs-osi]',B='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var ca='a[is="upt-link"]',Qt=`${f},${B},${ca}`;var Xt="merch-offer-select:ready",Zt="merch-card:action-menu-toggle";var ft="merch-quantity-selector:change",Jt="merch-card-quantity:change",xt="merch-modal:addon-and-quantity-update";var ne="aem:load",se="aem:error",er="mas:ready",tr="mas:error",rr="placeholder-failed",ar="placeholder-pending",ir="placeholder-resolved";var or="mas:failed",Ce="mas:resolved",nr="mas/commerce";var H="failed",V="pending",U="resolved";var Ge="X-Request-Id",Hi=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var Ui=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Ve=":start",Ye=":duration";var sr="legal";var da="mas-commerce-service";function cr(a,t){let e;return function(){let r=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(r,i),t)}}function S(a,t={},e=null,r=null){let i=r?document.createElement(a,{is:r}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[o,n]of Object.entries(t))i.setAttribute(o,n);return i}function ce(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function dr(){return window.matchMedia("(max-width: 1024px)").matches}function Y(){return document.getElementsByTagName(da)?.[0]}var Te,K,Le,_e,de,Ke=class extends HTMLElement{constructor(){super();m(this,Te,"");m(this,K);m(this,Le,[]);m(this,_e,[]);m(this,de);h(this,de,cr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,s(this,K)?this.parentElement.style.borderRadius=s(this,K):s(this,K)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=s(this,Le).map((r,i)=>{let o=s(this,_e)[i]||"";return`${r} ${o}`}).join(", ");return`linear-gradient(${s(this,Te)}, ${e})`}connectedCallback(){s(this,de).call(this)}attributeChangedCallback(e,r,i){e==="border-radius"&&h(this,K,i?.trim()),e==="colors"&&i?h(this,Le,i?.split(",").map(o=>o.trim())??[]):e==="positions"&&i?h(this,_e,i?.split(",").map(o=>o.trim())??[]):e==="angle"&&h(this,Te,i?.trim()??""),s(this,de).call(this)}};Te=new WeakMap,K=new WeakMap,Le=new WeakMap,_e=new WeakMap,de=new WeakMap;customElements.define("merch-gradient",Ke);import{LitElement as la,html as ha,css as pa}from"../lit-all.min.js";var le=class extends la{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let o=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${t}"] ${f}[data-offer-type="${c}"]`).join(", ");return this.querySelector(o)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Ce,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Ce,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}render(){return ha`
            ...
            <label for="addon-checkbox" part="label">
                <slot></slot>
            </label>`}};d(le,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),d(le,"styles",pa`
        :host {
            --merch-addon-gap: 9px;
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return lr}setAriaExpanded(e,r){e.setAttribute("aria-expanded",r)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};d(pe,"variantStyle",ga`
...
`;var Ze=class extends x{constructor(t){super(t)}getGlobalCSS(){return mr}renderLayout(){return gr` ${this.badge}
    ...
    ${this.card.customHr?"":gr`<hr />`} ${this.secureLabelFooter}`}};import{html as me,css as ua,unsafeCSS as vt}from"../lit-all.min.js";var ur=`
  :root {
...
`;var fa=32,ge=class extends x{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?me`<slot name="secure-transaction-label">
              <span class="secure-transaction-label"
                  >${this.card.secureLabel}</span
              ></slot
          >`:me`<slot name="secure-transaction-label"></slot>`;return me`<footer>${e}<slot name="footer"></slot></footer>`})}getGlobalCSS(){return ur}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2)return;this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".top-section"),"top-section");let e=["heading-m","body-m","heading-m-price","body-xxs","price-commitment","offers","promo-text","callout-content","addon"];this.card.classList.contains("bullet-list")&&e.push("footer-rows"),e.forEach(i=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${i}"]`),i)),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector("footer"),"footer");let r=this.card.shadowRoot.querySelector(".mini-compare-chart-badge");r&&r.textContent!==""&&this.getContainer().style.setProperty("--consonant-merch-card-mini-compare-chart-top-section-mobile-height","32px")}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.querySelector('[slot="footer-rows"] ul');!e||!e.children||[...e.children].forEach((r,i)=>{let o=Math.max(fa,parseFloat(window.getComputedStyle(r).height)||0),n=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(i+1)))||0;o>n&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(i+1),`${o}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(r=>{let i=r.querySelector(".footer-row-cell-description");i&&!i.textContent.trim()&&r.remove()})}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${f}[data-template="price"]`)}get headingMPriceSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-m-price"]')?.assignedElements()[0]}toggleAddon(e){let r=this.mainPrice,i=this.headingMPriceSlot;if(!r&&i){let o=e?.getAttribute("plan-type"),n=null;if(e&&o&&(n=e.querySelector(`p[data-plan-type="${o}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-m-price"]').forEach(c=>c.remove()),e.checked){if(n){let c=S("p",{class:"addon-heading-m-price-addon",slot:"heading-m-price"},n.innerHTML);this.card.appendChild(c)}}else{let c=S("p",{class:"card-heading",id:"free",slot:"heading-m-price"},"Free");this.card.appendChild(c)}}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;let r=this.mainPrice,i=this.card.planType;r&&(await r.onceSettled(),i=r.value?.[0]?.planType),i&&(e.planType=i)}renderLayout(){return me` <div class="top-section${this.badge?" badge":""}">
            <slot name="icons"></slot> ${this.badge}
        </div>
        <slot name="heading-m"></slot>
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(e=>e.onceSettled())),await this.adjustAddon(),Ue()?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};d(ge,"variantStyle",ua`
...
`;var et={title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant"},xr={...function(){let{whatsIncluded:a,size:t,...e}=et;return e}(),title:{tag:"h3",slot:"heading-s"},subtitle:{tag:"p",slot:"subtitle"},secureLabel:!1},br={...function(){let{whatsIncluded:a,size:t,quantitySelect:e,...r}=et;return r}()},A=class extends x{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,e){t.dataset.template===sr&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return fr}adjustSlotPlacement(t,e,r){let i=this.card.shadowRoot,o=i.querySelector("footer"),n=this.card.getAttribute("size"),c=i.querySelector(`footer slot[name="${t}"]`),l=i.querySelector(`.body slot[name="${t}"]`),p=i.querySelector(".body");if((!n||!n.includes("wide"))&&(o?.classList.remove("wide-footer"),c&&c.remove()),!!e.includes(n)){if(o?.classList.toggle("wide-footer",qe()),!r&&c){if(l)c.remove();else{let g=p.querySelector(`[data-placeholder-for="${t}"]`);g?g.replaceWith(c):p.appendChild(c)}return}if(r&&l){let g=document.createElement("div");if(g.setAttribute("data-placeholder-for",t),g.classList.add("slot-placeholder"),!c){let b=l.cloneNode(!0);o.prepend(b)}l.replaceWith(g)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],qe()),this.adjustSlotPlacement("callout-content",["super-wide"],qe())}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.remove("hide-tooltip")}))}adjustPrices(){this.headingM&&(this.headingM.setAttribute("role","heading"),this.headingM.setAttribute("aria-level","2"))}postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustLegal(),this.adjustAddon(),this.adjustCallout(),this.adjustPrices()}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${f}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Re`<div class="divider"></div>`:Je}async adjustLegal(){if(await this.card.updateComplete,this.legalAdjusted)return;this.legalAdjusted=!0;let t=[],e=this.card.querySelector(`[slot="heading-m"] ${f}[data-template="price"]`);e&&t.push(e);let r=t.map(async i=>{let o=i.cloneNode(!0);await i.onceSettled(),i?.options&&(i.options.displayPerUnit&&(i.dataset.displayPerUnit="false"),i.options.displayTax&&(i.dataset.displayTax="false"),i.options.displayPlanType&&(i.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),i.parentNode.insertBefore(o,i.nextSibling))});await Promise.all(r)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let e=this.mainPrice;if(!e)return;await e.onceSettled();let r=e.value?.[0]?.planType;r&&(t.planType=r)}get stockCheckbox(){return this.card.checkboxLabel?Re`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}`}};d(A,"variantStyle",xa`
        :host([variant^='plans']) {
            min-height: 273px;
...
`;var fe=class extends x{constructor(t){super(t)}getGlobalCSS(){return yr}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Et` ${this.badge}
    ...
    <hr />
    ${this.secureLabelFooter}`}};d(fe,"variantStyle",va`
...
`;var wr={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},xe=class extends x{constructor(t){super(t)}getGlobalCSS(){return Er}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return wt`${this.cardImage}
            ...
            ${this.evergreen?wt`
                  ...
                  `:wt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};d(xe,"variantStyle",ya`
...
`;var kr={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},ve=class extends x{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Ar}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${f}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Aa`
    ...
    `);var At=new Map,k=(a,t,e=null,r=null,i)=>{At.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};k("catalog",pe,hr,pe.variantStyle);k("image",Xe);k("inline-heading",Ze);k("mini-compare-chart",ge,null,ge.variantStyle);k("plans",A,et,A.variantStyle,A.collectionOptions);k("plans-students",A,br,A.variantStyle,A.collectionOptions);k("plans-education",A,xr,A.variantStyle,A.collectionOptions);k("product",ue,null,ue.variantStyle);k("segment",fe,null,fe.variantStyle);k("special-offers",xe,wr,xe.variantStyle);k("simplified-pricing-express",be,St,be.variantStyle);k("mini",ve,kr,ve.variantStyle);var kt=a=>{let t=At.get(a.variant);if(!t)return;let{class:e,style:r}=t;if(r)try{let i=new CSSStyleSheet;i.replaceSync(r.cssText),a.shadowRoot.adoptedStyleSheets.push(i)}catch{let o=document.createElement("style");o.textContent=r.cssText,a.shadowRoot.appendChild(o)}return new e(a)};function Qe(a){return At.get(a)?.fragmentMapping}var Cr=document.createElement("style");Cr.innerHTML=`
:root {
...
`;document.head.appendChild(Cr);function tt(a,t={},{metadata:e=!0,search:r=!0,storage:i=!0}={}){let o;if(r&&o==null){let n=new URLSearchParams(window.location.search),c=Ct(r)?r:a;o=n.get(c)}if(i&&o==null){let n=Ct(i)?i:a;o=window.sessionStorage.getItem(n)??window.localStorage.getItem(n)}if(e&&o==null){let n=Ca(Ct(e)?e:a);o=document.documentElement.querySelector(`meta[name="${n}"]`)?.content}return o??t[a]}var ka=a=>typeof a=="boolean",rt=a=>typeof a=="function";var Ct=a=>typeof a=="string";function Tr(a,t){if(ka(a))return a;let e=String(a);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function Ca(a=""){return String(a).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var W=class a extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let i=e.response.headers?.get(Ge);i&&(e.requestId=i),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,a)}toString(){let t=Object.entries(this.context||{}).map(([r,i])=>`${r}: ${JSON.stringify(i)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var Ta="mas-commerce-service",La={requestId:Ge,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var at=a=>window.setTimeout(a);function Tt(){return document.getElementsByTagName(Ta)?.[0]}function Lr(a){let t={};if(!a?.headers)return t;let e=a.headers;for(let[r,i]of Object.entries(La)){let o=e.get(i);o&&(o=o.replace(/[,;]/g,"|"),o=o.replace(/[| ]+/g,"|"),t[r]=o)}return t}async function _r(a,t={},e=2,r=100){let i;for(let o=0;o<=e;o++)try{let n=await fetch(a,t);return n.retryCount=o,n}catch(n){if(i=n,i.retryCount=o,o>e)break;await new Promise(c=>setTimeout(c,r*(o+1)))}throw i}var Pr="fragment",Mr="author",Rr="preview",zr="loading",Or="timeout",Lt="aem-fragment",Nr="eager",$r="cache",_a=[Nr,$r],N,Q,P,_t=class{constructor(){m(this,N,new Map);m(this,Q,new Map);m(this,P,new Map)}clear(){s(this,N).clear(),s(this,Q).clear(),s(this,P).clear()}add(t){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(s(this,N).set(t.id,t),t.fields?.originalId&&s(this,N).set(t.fields.originalId,t),s(this,P).has(t.id)){let[,e]=s(this,P).get(t.id);e()}if(s(this,P).has(t.fields?.originalId)){let[,e]=s(this,P).get(t.fields?.originalId);e()}if(t.references)for(let e in t.references){let{type:r,value:i}=t.references[e];r==="content-fragment"&&(i.settings={...t?.settings,...i.settings},i.placeholders={...t?.placeholders,...i.placeholders},i.dictionary={...t?.dictionary,...i.dictionary},i.priceLiterals={...t?.priceLiterals,...i.priceLiterals},this.add(i,t))}}}has(t){return s(this,N).has(t)}entries(){return s(this,N).entries()}get(t){return s(this,N).get(t)}getAsPromise(t){let[e]=s(this,P).get(t)??[];if(e)return e;let r;return e=new Promise(i=>{r=i,this.has(t)&&i()}),s(this,P).set(t,[e,r]),e}getFetchInfo(t){let e=s(this,Q).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,Q).set(t,e)),e}remove(t){s(this,N).delete(t),s(this,Q).delete(t),s(this,P).delete(t)}};N=new WeakMap,Q=new WeakMap,P=new WeakMap;var q=new _t,ye,$,D,T,C,y,ze,Oe,M,Ne,$e,Ee,R,Ir,Dr,Pt,Fr,it=class extends HTMLElement{constructor(){super(...arguments);m(this,R);d(this,"cache",q);m(this,ye);m(this,$,null);m(this,D,null);m(this,T,null);m(this,C);m(this,y);m(this,ze,Nr);m(this,Oe,5e3);m(this,M);m(this,Ne,!1);m(this,$e,0);m(this,Ee)}static get observedAttributes(){return[Pr,zr,Or,Mr,Rr]}attributeChangedCallback(e,r,i){e===Pr&&(h(this,C,i),h(this,y,q.getFetchInfo(i))),e===zr&&_a.includes(i)&&h(this,ze,i),e===Or&&h(this,Oe,parseInt(i,10)),e===Mr&&h(this,Ne,["","true"].includes(i)),e===Rr&&h(this,Ee,i)}connectedCallback(){if(!s(this,M)){if(s(this,T)??h(this,T,Y(this)),h(this,Ee,s(this,T).settings?.preview),s(this,ye)??h(this,ye,s(this,T).log.module(`${Lt}[${s(this,C)}]`)),!s(this,C)||s(this,C)==="#"){s(this,y)??h(this,y,q.getFetchInfo("missing-fragment-id")),w(this,R,Pt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,y)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(s(this,M)&&!await Promise.race([s(this,M),Promise.resolve(!1)]))return;e&&q.remove(s(this,C)),s(this,ze)===$r&&await Promise.race([q.getAsPromise(s(this,C)),new Promise(c=>setTimeout(c,s(this,Oe)))]);try{h(this,M,w(this,R,Fr).call(this)),await s(this,M)}catch(c){return w(this,R,Pt).call(this,c.message),!1}let{references:r,referencesTree:i,placeholders:o,wcs:n}=s(this,$)||{};return n&&!tt("mas.disableWcsCache")&&s(this,T).prefillWcsCache(n),this.dispatchEvent(new CustomEvent(ne,{detail:{...this.data,references:r,referencesTree:i,placeholders:o,...s(this,y)},bubbles:!0,composed:!0})),s(this,M)}get updateComplete(){return s(this,M)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,D)?s(this,D):(s(this,Ne)?this.transformAuthorData():this.transformPublishData(),s(this,D))}transformAuthorData(){let{fields:e,id:r,tags:i,settings:o={},priceLiterals:n={},dictionary:c={},placeholders:l={}}=s(this,$);h(this,D,e.reduce((p,{name:g,multiple:b,values:L})=>(p.fields[g]=b?L:L[0],p),{fields:{},id:r,tags:i,settings:o,priceLiterals:n,dictionary:c,placeholders:l}))}transformPublishData(){let{fields:e,id:r,tags:i,settings:o={},priceLiterals:n={},dictionary:c={},placeholders:l={}}=s(this,$);h(this,D,Object.entries(e).reduce((p,[g,b])=>(p.fields[g]=b?.mimeType?b.value:b??"",p),{fields:{},id:r,tags:i,settings:o,priceLiterals:n,dictionary:c,placeholders:l}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let i=r.trim().toLowerCase();if(i==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:o}=window.location,n=o.endsWith(".page")?"page":"live";return i.includes("--")?`https://${i}.aem.${n}/studio/libs/fragment-client.js`:`https://${i}--mas--adobecom.aem.${n}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(s(this,C),{locale:s(this,T).settings.locale,apiKey:s(this,T).settings.wcsApiKey})}};ye=new WeakMap,$=new WeakMap,D=new WeakMap,T=new WeakMap,C=new WeakMap,y=new WeakMap,ze=new WeakMap,Oe=new WeakMap,M=new WeakMap,Ne=new WeakMap,$e=new WeakMap,Ee=new WeakMap,R=new WeakSet,Ir=async function(e){jt(this,$e)._++;let r=`${Lt}:${s(this,C)}:${s(this,$e)}`,i=`${r}${Ve}`,o=`${r}${Ye}`;if(s(this,Ee))return await this.generatePreview();performance.mark(i);let n;try{if(s(this,y).stale=!1,s(this,y).url=e,n=await _r(e,{cache:"default",credentials:"omit"}),w(this,R,Dr).call(this,n),s(this,y).status=n?.status,s(this,y).measure=ce(performance.measure(o,i)),s(this,y).retryCount=n.retryCount,!n?.ok)throw new W("Unexpected fragment response",{response:n,...s(this,T).duration});return await n.json()}catch(c){if(s(this,y).measure=ce(performance.measure(o,i)),s(this,y).retryCount=c.retryCount,s(this,$))return s(this,y).stale=!0,s(this,ye).error("Serving stale data",s(this,y)),s(this,$);let l=c.message??"unknown";throw new W(`Failed to fetch fragment: ${l}`,{})}},Dr=function(e){Object.assign(s(this,y),Lr(e))},Pt=function(e){h(this,M,null),s(this,y).message=e,this.classList.add("error");let r={...s(this,y),...s(this,T).duration};s(this,ye).error(e,r),this.dispatchEvent(new CustomEvent(se,{detail:r,bubbles:!0,composed:!0}))},Fr=async function(){var c;this.classList.remove("error"),h(this,D,null);let e=q.get(s(this,C));if(e)return h(this,$,e),!0;let{masIOUrl:r,wcsApiKey:i,locale:o}=s(this,T).settings,n=`${r}/fragment?id=${s(this,C)}&api_key=${i}&locale=${o}`;return e=await w(this,R,Ir).call(this,n),(c=e.fields).originalId??(c.originalId=s(this,C)),q.add(e),h(this,$,e),!0},d(it,"cache",q);customElements.define(Lt,it);import{LitElement as Pa,html as Ma,css as Ra}from"../lit-all.min.js";var we=class extends Pa{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return Ma`<div class="badge">
            ${this.text}
        </div>`}};d(we,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"}}),d(we,"styles",Ra`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",we);import{html as za,css as Oa,LitElement as Na}from"../lit-all.min.js";var Ie=class extends Na{constructor(){super()}render(){return za`
            <slot name="icon"></slot>
