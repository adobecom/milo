var qt=Object.defineProperty;var jt=i=>{throw TypeError(i)};var ii=(i,t,e)=>t in i?qt(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var ai=(i,t)=>()=>(i&&(t=i(i=0)),t);var ni=(i,t)=>{for(var e in t)qt(i,e,{get:t[e],enumerable:!0})};var l=(i,t,e)=>ii(i,typeof t!="symbol"?t+"":t,e),ut=(i,t,e)=>t.has(i)||jt("Cannot "+e);var c=(i,t,e)=>(ut(i,t,"read from private field"),e?e.call(i):t.get(i)),m=(i,t,e)=>t.has(i)?jt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),p=(i,t,e,r)=>(ut(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),E=(i,t,e)=>(ut(i,t,"access private method"),e);var Gt=(i,t,e,r)=>({set _(a){p(i,t,a,e)},get _(){return c(i,t,r)}});var ft={};ni(ft,{default:()=>Y});import{LitElement as oi,html as Ge,css as si}from"../lit-all.min.js";function ci(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var Y,xt=ai(()=>{Y=class extends oi{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs"}get effectiveContent(){return this.tooltipText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.placement||"top"}renderIcon(){return this.src?Ge`<merch-icon 
            src="${this.src}" 
            size="${this.size}"
        ></merch-icon>`:Ge`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;return t?ci()?Ge`
...
Caused by: ${this.cause}`),e}};var zi="mas-commerce-service",Ni={requestId:Ve,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var ot=i=>window.setTimeout(i);function _t(){return document.getElementsByTagName(zi)?.[0]}function Rr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(Ni)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Mr(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var zr="fragment",Nr="author",Or="preview",$r="loading",Ir="timeout",Pt="aem-fragment",Dr="eager",Fr="cache",Oi=[Dr,Fr],$,Z,R,Rt=class{constructor(){m(this,$,new Map);m(this,Z,new Map);m(this,R,new Map)}clear(){c(this,$).clear(),c(this,Z).clear(),c(this,R).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,$).set(t.id,t),t.fields?.originalId&&c(this,$).set(t.fields.originalId,t),c(this,R).has(t.id)){let[,r]=c(this,R).get(t.id);r()}if(c(this,R).has(t.fields?.originalId)){let[,r]=c(this,R).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,$).has(t)}entries(){return c(this,$).entries()}get(t){return c(this,$).get(t)}getAsPromise(t){let[e]=c(this,R).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,R).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,Z).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,Z).set(t,e)),e}remove(t){c(this,$).delete(t),c(this,Z).delete(t),c(this,R).delete(t)}};$=new WeakMap,Z=new WeakMap,R=new WeakMap;var j=new Rt,we,I,F,_,T,y,Ne,Oe,M,$e,Ie,Ee,z,Br,Ur,Mt,Hr,st=class extends HTMLElement{constructor(){super(...arguments);m(this,z);l(this,"cache",j);m(this,we);m(this,I,null);m(this,F,null);m(this,_,null);m(this,T);m(this,y);m(this,Ne,Dr);m(this,Oe,5e3);m(this,M);m(this,$e,!1);m(this,Ie,0);m(this,Ee)}static get observedAttributes(){return[zr,$r,Ir,Nr,Or]}attributeChangedCallback(e,r,a){e===zr&&(p(this,T,a),p(this,y,j.getFetchInfo(a))),e===$r&&Oi.includes(a)&&p(this,Ne,a),e===Ir&&p(this,Oe,parseInt(a,10)),e===Nr&&p(this,$e,["","true"].includes(a)),e===Or&&p(this,Ee,a)}connectedCallback(){if(!c(this,M)){if(c(this,_)??p(this,_,K(this)),p(this,Ee,c(this,_).settings?.preview),c(this,we)??p(this,we,c(this,_).log.module(`${Pt}[${c(this,T)}]`)),!c(this,T)||c(this,T)==="#"){c(this,y)??p(this,y,j.getFetchInfo("missing-fragment-id")),E(this,z,Mt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,y)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,M)&&!await Promise.race([c(this,M),Promise.resolve(!1)]))return;e&&j.remove(c(this,T)),c(this,Ne)===Fr&&await Promise.race([j.getAsPromise(c(this,T)),new Promise(s=>setTimeout(s,c(this,Oe)))]);try{p(this,M,E(this,z,Hr).call(this)),await c(this,M)}catch(s){return E(this,z,Mt).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,I)||{};return o&&!at("mas.disableWcsCache")&&c(this,_).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(oe,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,y)},bubbles:!0,composed:!0})),c(this,M)}get updateComplete(){return c(this,M)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,F)?c(this,F):(c(this,$e)?this.transformAuthorData():this.transformPublishData(),c(this,F))}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,I);p(this,F,e.reduce((h,{name:g,multiple:v,values:P})=>(h.fields[g]=v?P:P[0],h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,I);p(this,F,Object.entries(e).reduce((h,[g,v])=>(h.fields[g]=v?.mimeType?v.value:v??"",h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,T),{locale:c(this,_).settings.locale,apiKey:c(this,_).settings.wcsApiKey})}};we=new WeakMap,I=new WeakMap,F=new WeakMap,_=new WeakMap,T=new WeakMap,y=new WeakMap,Ne=new WeakMap,Oe=new WeakMap,M=new WeakMap,$e=new WeakMap,Ie=new WeakMap,Ee=new WeakMap,z=new WeakSet,Br=async function(e){Gt(this,Ie)._++;let r=`${Pt}:${c(this,T)}:${c(this,Ie)}`,a=`${r}${Ye}`,n=`${r}${We}`;if(c(this,Ee))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,y).stale=!1,c(this,y).url=e,o=await Mr(e,{cache:"default",credentials:"omit"}),E(this,z,Ur).call(this,o),c(this,y).status=o?.status,c(this,y).measure=ce(performance.measure(n,a)),c(this,y).retryCount=o.retryCount,!o?.ok)throw new Q("Unexpected fragment response",{response:o,...c(this,_).duration});return await o.json()}catch(s){if(c(this,y).measure=ce(performance.measure(n,a)),c(this,y).retryCount=s.retryCount,c(this,I))return c(this,y).stale=!0,c(this,we).error("Serving stale data",c(this,y)),c(this,I);let d=s.message??"unknown";throw new Q(`Failed to fetch fragment: ${d}`,{})}},Ur=function(e){Object.assign(c(this,y),Rr(e))},Mt=function(e){p(this,M,null),c(this,y).message=e,this.classList.add("error");let r={...c(this,y),...c(this,_).duration};c(this,we).error(e,r),this.dispatchEvent(new CustomEvent(se,{detail:r,bubbles:!0,composed:!0}))},Hr=async function(){var d;this.classList.remove("error"),p(this,F,null);let e=j.get(c(this,T));if(e)return p(this,I,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,_).settings,s=`${r}/fragment?id=${c(this,T)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await E(this,z,Br).call(this,s),(d=e.fields).originalId??(d.originalId=c(this,T)),j.add(e),p(this,I,e),!0},l(st,"cache",j);customElements.define(Pt,st);import{LitElement as $i,html as Ii,css as Di}from"../lit-all.min.js";var Se=class extends $i{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return Ii`<div class="badge">
    ...
    `);customElements.define("merch-badge",Se);import{html as Fi,css as Bi,LitElement as Ui}from"../lit-all.min.js";var De=class extends Ui{constructor(){super()}render(){return Fi`
            <slot name="icon"></slot>
    ...
    `),l(De,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",De);import{html as zt,css as Hi,LitElement as qi}from"../lit-all.min.js";var Fe=class extends qi{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return zt`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows?zt`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:zt``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};l(Fe,"styles",Hi`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
