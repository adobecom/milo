var jt=Object.defineProperty;var Gt=i=>{throw TypeError(i)};var ai=(i,t,e)=>t in i?jt(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var ni=(i,t)=>()=>(i&&(t=i(i=0)),t);var oi=(i,t)=>{for(var e in t)jt(i,e,{get:t[e],enumerable:!0})};var l=(i,t,e)=>ai(i,typeof t!="symbol"?t+"":t,e),ut=(i,t,e)=>t.has(i)||Gt("Cannot "+e);var c=(i,t,e)=>(ut(i,t,"read from private field"),e?e.call(i):t.get(i)),m=(i,t,e)=>t.has(i)?Gt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),p=(i,t,e,r)=>(ut(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),E=(i,t,e)=>(ut(i,t,"access private method"),e);var Vt=(i,t,e,r)=>({set _(a){p(i,t,a,e)},get _(){return c(i,t,r)}});var ft={};oi(ft,{default:()=>K});import{LitElement as si,html as Ve,css as ci}from"../lit-all.min.js";function li(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var K,xt=ni(()=>{K=class extends si{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs"}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Ve`<merch-icon 
            src="${this.src}" 
            size="${this.size}"
        ></merch-icon>`:Ve`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;return t?li()?Ve`
            ...
            `:this.renderIcon()}};l(K,"properties",{content:{type:String},placement:{type:String},variant:{type:String},src:{type:String},size:{type:String},tooltipText:{type:String,attribute:"tooltip-text"},tooltipPlacement:{type:String,attribute:"tooltip-placement"},mnemonicText:{type:String,attribute:"mnemonic-text"},mnemonicPlacement:{type:String,attribute:"mnemonic-placement"}}),l(K,"styles",ci`
        :host {
            display: contents;
            overflow: visible;
        }
    ...
    `);customElements.define("mas-mnemonic",K)});import{LitElement as za}from"../lit-all.min.js";import{css as Kt,unsafeCSS as Yt}from"../lit-all.min.js";var S="(max-width: 767px)",R="(max-width: 1199px)",f="(min-width: 768px)",u="(min-width: 1200px)",O="(min-width: 1600px)";function qe(){return window.matchMedia(S)}function je(){return window.matchMedia(u)}function Y(){return qe().matches}function Ge(){return je().matches}var Wt=Kt`
    :host {
...
`,Xt=()=>[Kt`
      ...
      `];import{LitElement as di,html as Qt,css as pi}from"../lit-all.min.js";function hi(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var oe=class extends di{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(hi())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",a="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,a=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,a=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",a);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>xt())}e.remove()})}render(){let{href:t}=this;return t?Qt`<a href="${t}">
                  <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />
              </a>`:Qt` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};l(oe,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),l(oe,"styles",pi`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",oe);var Va=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),Ya=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var b='span[is="inline-price"][data-wcs-osi]',H='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var mi='a[is="upt-link"]',Zt=`${b},${H},${mi}`;var Jt="merch-offer-select:ready",er="merch-card:action-menu-toggle";var bt="merch-quantity-selector:change",tr="merch-card-quantity:change",vt="merch-modal:addon-and-quantity-update";var yt="merch-card-collection:ready";var se="aem:load",ce="aem:error",rr="mas:ready",ir="mas:error",ar="placeholder-failed",nr="placeholder-pending",or="placeholder-resolved";var sr="mas:failed",Le="mas:resolved",cr="mas/commerce";var U="failed",W="pending",q="resolved";var Ye="X-Request-Id",Ka=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var Wa=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Ke=":start",We=":duration";var lr="legal";var gi="mas-commerce-service";function dr(i,t){let e;return function(){let r=this,a=arguments;clearTimeout(e),e=setTimeout(()=>i.apply(r,a),t)}}function k(i,t={},e=null,r=null){let a=r?document.createElement(i,{is:r}):document.createElement(i);e instanceof HTMLElement?a.appendChild(e):a.innerHTML=e;for(let[n,o]of Object.entries(t))a.setAttribute(n,o);return a}function le(i){return`startTime:${i.startTime.toFixed(2)}|duration:${i.duration.toFixed(2)}`}function pr(){return window.matchMedia("(max-width: 1024px)").matches}function X(){return document.getElementsByTagName(gi)?.[0]}var _e,Q,Pe,Re,de,Xe=class extends HTMLElement{constructor(){super();m(this,_e,"");m(this,Q);m(this,Pe,[]);m(this,Re,[]);m(this,de);p(this,de,dr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,Q)?this.parentElement.style.borderRadius=c(this,Q):c(this,Q)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=c(this,Pe).map((r,a)=>{let n=c(this,Re)[a]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${c(this,_e)}, ${e})`}connectedCallback(){c(this,de).call(this)}attributeChangedCallback(e,r,a){e==="border-radius"&&p(this,Q,a?.trim()),e==="colors"&&a?p(this,Pe,a?.split(",").map(n=>n.trim())??[]):e==="positions"&&a?p(this,Re,a?.split(",").map(n=>n.trim())??[]):e==="angle"&&p(this,_e,a?.trim()??""),c(this,de).call(this)}};_e=new WeakMap,Q=new WeakMap,Pe=new WeakMap,Re=new WeakMap,de=new WeakMap;customElements.define("merch-gradient",Xe);import{LitElement as ui,html as fi,css as xi}from"../lit-all.min.js";var pe=class extends ui{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${t}"] ${b}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Le,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Le,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return fi`
            <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};l(pe,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),l(pe,"styles",xi`
        :host {
            --merch-addon-gap: 9px;
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return hr}setAriaExpanded(e,r){e.setAttribute("aria-expanded",r)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};l(me,"variantStyle",vi`
    ...
    `);import{html as ze}from"../lit-all.min.js";var gr=`
:root {
...
`;var Je=class extends x{constructor(t){super(t)}getGlobalCSS(){return gr}renderLayout(){return ze`${this.cardImage}
    <div class="body">
...
`;var et=class extends x{constructor(t){super(t)}getGlobalCSS(){return ur}renderLayout(){return fr` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":fr`<hr />`} ${this.secureLabelFooter}`}};import{html as ge,css as yi,unsafeCSS as Et}from"../lit-all.min.js";var xr=`
  :root {
...
`;var wi=32,ue=class extends x{constructor(e){super(e);l(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);l(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?ge`<slot name="secure-transaction-label">
              <span class="secure-transaction-label"
                  >${this.card.secureLabel}</span
              ></slot
          >`:ge`<slot name="secure-transaction-label"></slot>`;return ge`<footer>${e}<slot name="footer"></slot></footer>`})}getGlobalCSS(){return xr}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2)return;this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".top-section"),"top-section");let e=["heading-m","body-m","heading-m-price","body-xxs","price-commitment","offers","promo-text","callout-content","addon"];this.card.classList.contains("bullet-list")&&e.push("footer-rows"),e.forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a)),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector("footer"),"footer");let r=this.card.shadowRoot.querySelector(".mini-compare-chart-badge");r&&r.textContent!==""&&this.getContainer().style.setProperty("--consonant-merch-card-mini-compare-chart-top-section-mobile-height","32px")}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.querySelector('[slot="footer-rows"] ul');!e||!e.children||[...e.children].forEach((r,a)=>{let n=Math.max(wi,parseFloat(window.getComputedStyle(r).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(a+1)))||0;n>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(a+1),`${n}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(r=>{let a=r.querySelector(".footer-row-cell-description");a&&!a.textContent.trim()&&r.remove()})}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${b}[data-template="price"]`)}get headingMPriceSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-m-price"]')?.assignedElements()[0]}toggleAddon(e){let r=this.mainPrice,a=this.headingMPriceSlot;if(!r&&a){let n=e?.getAttribute("plan-type"),o=null;if(e&&n&&(o=e.querySelector(`p[data-plan-type="${n}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-m-price"]').forEach(s=>s.remove()),e.checked){if(o){let s=k("p",{class:"addon-heading-m-price-addon",slot:"heading-m-price"},o.innerHTML);this.card.appendChild(s)}}else{let s=k("p",{class:"card-heading",id:"free",slot:"heading-m-price"},"Free");this.card.appendChild(s)}}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;let r=this.mainPrice,a=this.card.planType;r&&(await r.onceSettled(),a=r.value?.[0]?.planType),a&&(e.planType=a)}renderLayout(){return ge` <div class="top-section${this.badge?" badge":""}">
            <slot name="icons"></slot> ${this.badge}
        </div>
        <slot name="heading-m"></slot>
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(e=>e.onceSettled())),await this.adjustAddon(),Y()?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};l(ue,"variantStyle",yi`
  ...
  `);import{html as Ne,css as Ei,nothing as tt}from"../lit-all.min.js";var br=`
:root {
...
`;var rt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},vr={...function(){let{whatsIncluded:i,size:t,...e}=rt;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},yr={...function(){let{subtitle:i,whatsIncluded:t,size:e,quantitySelect:r,...a}=rt;return a}()},C=class extends x{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,e){t.dataset.template===lr&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return br}adjustSlotPlacement(t,e,r){let a=this.card.shadowRoot,n=a.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let s=a.querySelector(`footer slot[name="${t}"]`),d=a.querySelector(`.body slot[name="${t}"]`),h=a.querySelector(".body");if(o.includes("wide")||(n?.classList.remove("wide-footer"),s&&s.remove()),!!e.includes(o)){if(n?.classList.toggle("wide-footer",Ge()),!r&&s){if(d)s.remove();else{let g=h.querySelector(`[data-placeholder-for="${t}"]`);g?g.replaceWith(s):h.appendChild(s)}return}if(r&&d){let g=document.createElement("div");if(g.setAttribute("data-placeholder-for",t),g.classList.add("slot-placeholder"),!s){let v=d.cloneNode(!0);n.prepend(v)}d.replaceWith(g)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],Ge()),this.adjustSlotPlacement("callout-content",["super-wide"],Ge())}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.remove("hide-tooltip")}))}postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustLegal(),this.adjustAddon(),this.adjustCallout()}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${b}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Ne`<div class="divider"></div>`:tt}async adjustLegal(){if(await this.card.updateComplete,await customElements.whenDefined("inline-price"),this.legalAdjusted)return;this.legalAdjusted=!0;let t=[],e=this.card.querySelector(`[slot="heading-m"] ${b}[data-template="price"]`);e&&t.push(e);let r=t.map(async a=>{let n=a.cloneNode(!0);await a.onceSettled(),a?.options&&(a.options.displayPerUnit&&(a.dataset.displayPerUnit="false"),a.options.displayTax&&(a.dataset.displayTax="false"),a.options.displayPlanType&&(a.dataset.displayPlanType="false"),n.setAttribute("data-template","legal"),a.parentNode.insertBefore(n,a.nextSibling))});await Promise.all(r)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let e=this.mainPrice;if(!e)return;await e.onceSettled();let r=e.value?.[0]?.planType;r&&(t.planType=r)}get stockCheckbox(){return this.card.checkboxLabel?Ne`<label id="stock-checkbox">
    ...
    `),l(C,"collectionOptions",{customHeaderArea:t=>t.sidenav?Ne`<slot name="resultsText"></slot>`:tt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]}});import{html as St,css as Si}from"../lit-all.min.js";var wr=`
:root {
...
`;var fe=class extends x{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return wr}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return St` ${this.badge}
...
`;var xe=class extends x{constructor(t){super(t)}getGlobalCSS(){return Er}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return At` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
    ...
    <hr />
    ${this.secureLabelFooter}`}};l(xe,"variantStyle",Ai`
...
`;var Ar={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},be=class extends x{constructor(t){super(t)}getGlobalCSS(){return Sr}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return kt`${this.cardImage}
            <div class="body">
            ...
            ${this.evergreen?kt`
                  ...
                  `:kt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};l(be,"variantStyle",ki`
...
`;var Tt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},description2:{tag:"div",slot:"description2",maxCount:3e3,withSuffix:!1},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"l"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:[]},ye=class extends x{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Cr}get aemFragmentMapping(){return Tt}get headingSelector(){return'[slot="heading-xs"]'}updateCardElementMinHeight(t,e){if(!t)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,a=Math.max(0,t.offsetHeight||0),n=parseInt(this.getContainer().style.getPropertyValue(r))||0;a>n&&this.getContainer().style.setProperty(r,`${a}px`)}updateCardElementMinHeightValue(t,e){if(!t)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,a=this.getContainer(),n=parseInt(a.style.getPropertyValue(r))||0;t>n&&a.style.setProperty(r,`${t}px`)}adjustFullPricingExpressSlots(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.querySelector('[slot="price"]');if(t){t.offsetHeight;let a=window.getComputedStyle(t),n=parseFloat(a.marginTop)||0,o=parseFloat(a.marginBottom)||0,s=t.offsetHeight+n+o;this.updateCardElementMinHeightValue(s,"price")}let e=this.card.querySelector('[slot="cta"]');if(e){e.offsetHeight;let a=window.getComputedStyle(e),n=parseFloat(a.marginTop)||0,o=parseFloat(a.marginBottom)||0,s=e.offsetHeight+n+o;this.updateCardElementMinHeightValue(s,"cta")}let r=this.card.querySelector('[slot="description2"]');if(r){r.offsetHeight;let a=window.getComputedStyle(r),n=parseFloat(a.marginTop)||0,o=parseFloat(a.marginBottom)||0,s=r.offsetHeight+n+o;this.updateCardElementMinHeightValue(s,"description2")}}forceRemeasure(){let t=this.getContainer();t&&(t.style.removeProperty(`--consonant-merch-card-${this.card.variant}-price-height`),t.style.removeProperty(`--consonant-merch-card-${this.card.variant}-cta-height`),t.style.removeProperty(`--consonant-merch-card-${this.card.variant}-description2-height`),this.adjustFullPricingExpressSlots())}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length&&await Promise.all(this.card.prices.map(t=>t.onceSettled?.())),Y()||requestAnimationFrame(()=>{this.adjustFullPricingExpressSlots()}))}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook),this.handleCollectionReady=async()=>{Y()||(this.card.prices?.length&&await Promise.all(this.card.prices.map(e=>e.onceSettled?.())),requestAnimationFrame(()=>{setTimeout(()=>{this.adjustFullPricingExpressSlots()},200)}))};let t=this.card.closest("merch-card-collection");t&&t.addEventListener(yt,this.handleCollectionReady)}disconnectedCallbackHook(){if(window.removeEventListener("resize",this.postCardUpdateHook),this.handleCollectionReady){let t=this.card.closest("merch-card-collection");t&&t.removeEventListener(yt,this.handleCollectionReady)}}renderLayout(){return Li`
            <div class="badge-wrapper">
                <slot name="badge"></slot>
            </div>
            <div class="card-content">
...
`;var Lr={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},we=class extends x{constructor(){super(...arguments);l(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Tr}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${b}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Ri`
    ...
    `);var at=new Map,A=(i,t,e=null,r=null,a)=>{at.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:a})};A("catalog",me,mr,me.variantStyle);A("image",Je);A("inline-heading",et);A("mini-compare-chart",ue,null,ue.variantStyle);A("plans",C,rt,C.variantStyle,C.collectionOptions);A("plans-students",C,yr,C.variantStyle,C.collectionOptions);A("plans-education",C,vr,C.variantStyle,C.collectionOptions);A("product",fe,null,fe.variantStyle);A("segment",xe,null,xe.variantStyle);A("special-offers",be,Ar,be.variantStyle);A("simplified-pricing-express",ve,Ct,ve.variantStyle);A("full-pricing-express",ye,Tt,ye.variantStyle);A("mini",we,Lr,we.variantStyle);var Lt=i=>{let t=at.get(i.variant);if(!t)return;let{class:e,style:r}=t;if(r)try{let a=new CSSStyleSheet;a.replaceSync(r.cssText),i.shadowRoot.adoptedStyleSheets.push(a)}catch{let n=document.createElement("style");n.textContent=r.cssText,i.shadowRoot.appendChild(n)}return new e(i)};function Ze(i){return at.get(i)?.fragmentMapping}function _r(i){return at.get(i)?.collectionOptions}var Pr=document.createElement("style");Pr.innerHTML=`
:root {
...
`;document.head.appendChild(Pr);function nt(i,t={},{metadata:e=!0,search:r=!0,storage:a=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),s=_t(r)?r:i;n=o.get(s)}if(a&&n==null){let o=_t(a)?a:i;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=zi(_t(e)?e:i);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[i]}var Mi=i=>typeof i=="boolean",ot=i=>typeof i=="function";var _t=i=>typeof i=="string";function Rr(i,t){if(Mi(i))return i;let e=String(i);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function zi(i=""){return String(i).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var Z=class i extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let a=e.response.headers?.get(Ye);a&&(e.requestId=a),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,i)}toString(){let t=Object.entries(this.context||{}).map(([r,a])=>`${r}: ${JSON.stringify(a)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var Ni="mas-commerce-service",Oi={requestId:Ye,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var st=i=>window.setTimeout(i);function Pt(){return document.getElementsByTagName(Ni)?.[0]}function Mr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(Oi)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function zr(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var Nr="fragment",Or="author",$r="preview",Ir="loading",Dr="timeout",Rt="aem-fragment",Fr="eager",Br="cache",$i=[Fr,Br],$,J,M,Mt=class{constructor(){m(this,$,new Map);m(this,J,new Map);m(this,M,new Map)}clear(){c(this,$).clear(),c(this,J).clear(),c(this,M).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,$).set(t.id,t),t.fields?.originalId&&c(this,$).set(t.fields.originalId,t),c(this,M).has(t.id)){let[,r]=c(this,M).get(t.id);r()}if(c(this,M).has(t.fields?.originalId)){let[,r]=c(this,M).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,$).has(t)}entries(){return c(this,$).entries()}get(t){return c(this,$).get(t)}getAsPromise(t){let[e]=c(this,M).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,M).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,J).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,J).set(t,e)),e}remove(t){c(this,$).delete(t),c(this,J).delete(t),c(this,M).delete(t)}};$=new WeakMap,J=new WeakMap,M=new WeakMap;var j=new Mt,Ee,I,F,L,T,y,Oe,$e,z,Ie,De,Se,N,Hr,Ur,zt,qr,ct=class extends HTMLElement{constructor(){super(...arguments);m(this,N);l(this,"cache",j);m(this,Ee);m(this,I,null);m(this,F,null);m(this,L,null);m(this,T);m(this,y);m(this,Oe,Fr);m(this,$e,5e3);m(this,z);m(this,Ie,!1);m(this,De,0);m(this,Se)}static get observedAttributes(){return[Nr,Ir,Dr,Or,$r]}attributeChangedCallback(e,r,a){e===Nr&&(p(this,T,a),p(this,y,j.getFetchInfo(a))),e===Ir&&$i.includes(a)&&p(this,Oe,a),e===Dr&&p(this,$e,parseInt(a,10)),e===Or&&p(this,Ie,["","true"].includes(a)),e===$r&&p(this,Se,a)}connectedCallback(){if(!c(this,z)){if(c(this,L)??p(this,L,X(this)),p(this,Se,c(this,L).settings?.preview),c(this,Ee)??p(this,Ee,c(this,L).log.module(`${Rt}[${c(this,T)}]`)),!c(this,T)||c(this,T)==="#"){c(this,y)??p(this,y,j.getFetchInfo("missing-fragment-id")),E(this,N,zt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,y)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,z)&&!await Promise.race([c(this,z),Promise.resolve(!1)]))return;e&&j.remove(c(this,T)),c(this,Oe)===Br&&await Promise.race([j.getAsPromise(c(this,T)),new Promise(s=>setTimeout(s,c(this,$e)))]);try{p(this,z,E(this,N,qr).call(this)),await c(this,z)}catch(s){return E(this,N,zt).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,I)||{};return o&&!nt("mas.disableWcsCache")&&c(this,L).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(se,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,y)},bubbles:!0,composed:!0})),c(this,z)}get updateComplete(){return c(this,z)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,F)?c(this,F):(c(this,Ie)?this.transformAuthorData():this.transformPublishData(),c(this,F))}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,I);p(this,F,e.reduce((h,{name:g,multiple:v,values:P})=>(h.fields[g]=v?P:P[0],h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,I);p(this,F,Object.entries(e).reduce((h,[g,v])=>(h.fields[g]=v?.mimeType?v.value:v??"",h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,T),{locale:c(this,L).settings.locale,apiKey:c(this,L).settings.wcsApiKey})}};Ee=new WeakMap,I=new WeakMap,F=new WeakMap,L=new WeakMap,T=new WeakMap,y=new WeakMap,Oe=new WeakMap,$e=new WeakMap,z=new WeakMap,Ie=new WeakMap,De=new WeakMap,Se=new WeakMap,N=new WeakSet,Hr=async function(e){Vt(this,De)._++;let r=`${Rt}:${c(this,T)}:${c(this,De)}`,a=`${r}${Ke}`,n=`${r}${We}`;if(c(this,Se))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,y).stale=!1,c(this,y).url=e,o=await zr(e,{cache:"default",credentials:"omit"}),E(this,N,Ur).call(this,o),c(this,y).status=o?.status,c(this,y).measure=le(performance.measure(n,a)),c(this,y).retryCount=o.retryCount,!o?.ok)throw new Z("Unexpected fragment response",{response:o,...c(this,L).duration});return await o.json()}catch(s){if(c(this,y).measure=le(performance.measure(n,a)),c(this,y).retryCount=s.retryCount,c(this,I))return c(this,y).stale=!0,c(this,Ee).error("Serving stale data",c(this,y)),c(this,I);let d=s.message??"unknown";throw new Z(`Failed to fetch fragment: ${d}`,{})}},Ur=function(e){Object.assign(c(this,y),Mr(e))},zt=function(e){p(this,z,null),c(this,y).message=e,this.classList.add("error");let r={...c(this,y),...c(this,L).duration};c(this,Ee).error(e,r),this.dispatchEvent(new CustomEvent(ce,{detail:r,bubbles:!0,composed:!0}))},qr=async function(){var d;this.classList.remove("error"),p(this,F,null);let e=j.get(c(this,T));if(e)return p(this,I,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,L).settings,s=`${r}/fragment?id=${c(this,T)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await E(this,N,Hr).call(this,s),(d=e.fields).originalId??(d.originalId=c(this,T)),j.add(e),p(this,I,e),!0},l(ct,"cache",j);customElements.define(Rt,ct);import{LitElement as Ii,html as Di,css as Fi}from"../lit-all.min.js";var Ae=class extends Ii{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return Di`<div class="badge">
            ${this.text}
        </div>`}};l(Ae,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"}}),l(Ae,"styles",Fi`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",Ae);import{html as Bi,css as Hi,LitElement as Ui}from"../lit-all.min.js";var Fe=class extends Ui{constructor(){super()}render(){return Bi`
            <slot name="icon"></slot>
    ...
    `),l(Fe,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Fe);import{html as Nt,css as qi,LitElement as ji}from"../lit-all.min.js";var Be=class extends ji{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Nt`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${this.isMobile&&this.rows.length>this.mobileRows?Nt`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Nt``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};l(Be,"styles",qi`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
