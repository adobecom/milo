var Wt=Object.defineProperty;var Qt=i=>{throw TypeError(i)};var ui=(i,t,e)=>t in i?Wt(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var fi=(i,t)=>()=>(i&&(t=i(i=0)),t);var xi=(i,t)=>{for(var e in t)Wt(i,e,{get:t[e],enumerable:!0})};var d=(i,t,e)=>ui(i,typeof t!="symbol"?t+"":t,e),yt=(i,t,e)=>t.has(i)||Qt("Cannot "+e);var c=(i,t,e)=>(yt(i,t,"read from private field"),e?e.call(i):t.get(i)),u=(i,t,e)=>t.has(i)?Qt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),m=(i,t,e,r)=>(yt(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),k=(i,t,e)=>(yt(i,t,"access private method"),e);var Xt=(i,t,e,r)=>({set _(a){m(i,t,a,e)},get _(){return c(i,t,r)}});var wt={};xi(wt,{default:()=>J});import{LitElement as vi,html as Xe,css as bi}from"../lit-all.min.js";function yi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var J,Et=fi(()=>{J=class extends vi{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs"}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Xe`<merch-icon 
            src="${this.src}" 
            size="${this.size}"
        ></merch-icon>`:Xe`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;return t?yi()?Xe`
            ...
            `:this.renderIcon()}};d(J,"properties",{content:{type:String},placement:{type:String},variant:{type:String},src:{type:String},size:{type:String},tooltipText:{type:String,attribute:"tooltip-text"},tooltipPlacement:{type:String,attribute:"tooltip-placement"},mnemonicText:{type:String,attribute:"mnemonic-text"},mnemonicPlacement:{type:String,attribute:"mnemonic-placement"}}),d(J,"styles",bi`
        :host {
            display: contents;
            overflow: visible;
        }
    ...
    `);customElements.define("mas-mnemonic",J)});import{LitElement as Va}from"../lit-all.min.js";import{css as er,unsafeCSS as Jt}from"../lit-all.min.js";var w="(max-width: 767px)",A="(max-width: 1199px)",b="(min-width: 768px)",f="(min-width: 1200px)",T="(min-width: 1600px)",Zt={matchMobile:window.matchMedia(w),matchDesktop:window.matchMedia(`${f} and (not ${T})`),matchDesktopOrUp:window.matchMedia(f),matchLargeDesktop:window.matchMedia(T),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=Zt;function De(){return Zt.isDesktop}var tr=er`
    :host {
...
`,rr=()=>[er`
      ...
      /* Laptop */
      @media screen and ${Jt(f)} {
          :host([size='wide']) {
              grid-column: span 2;
          }
      }
      `];import{LitElement as wi,html as ir,css as Ei}from"../lit-all.min.js";function Si(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var he=class extends wi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(Si())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",a="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,a=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,a=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",a);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>Et())}e.remove()})}render(){let{href:t}=this;return t?ir`<a href="${t}">
                  <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />
              </a>`:ir` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};d(he,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),d(he,"styles",Ei`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",he);var sn=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),cn=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var y='span[is="inline-price"][data-wcs-osi]',Y='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var ki='a[is="upt-link"]',ar=`${y},${Y},${ki}`;var nr="merch-offer-select:ready",or="merch-card:action-menu-toggle";var q="merch-quantity-selector:change",sr="merch-card-quantity:change",St="merch-modal:addon-and-quantity-update";var me="merch-card-collection:literals-changed";var ge="aem:load",ue="aem:error",cr="mas:ready",lr="mas:error",dr="placeholder-failed",pr="placeholder-pending",hr="placeholder-resolved";var mr="mas:failed",Ne="mas:resolved",gr="mas/commerce";var K="failed",ee="pending",W="resolved";var Ze="X-Request-Id",ln=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var dn=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Je=":start",et=":duration";var tt="legal",ur="mas-ff-defaults";var Ai="mas-commerce-service";function fr(i,t){let e;return function(){let r=this,a=arguments;clearTimeout(e),e=setTimeout(()=>i.apply(r,a),t)}}function L(i,t={},e=null,r=null){let a=r?document.createElement(i,{is:r}):document.createElement(i);e instanceof HTMLElement?a.appendChild(e):a.innerHTML=e;for(let[n,o]of Object.entries(t))a.setAttribute(n,o);return a}function fe(i){return`startTime:${i.startTime.toFixed(2)}|duration:${i.duration.toFixed(2)}`}function kt(){return window.matchMedia("(max-width: 1024px)").matches}function te(){return document.getElementsByTagName(Ai)?.[0]}function $e(i){let t=window.getComputedStyle(i);return i.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var Ie,re,Be,He,xe,rt=class extends HTMLElement{constructor(){super();u(this,Ie,"");u(this,re);u(this,Be,[]);u(this,He,[]);u(this,xe);m(this,xe,fr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,re)?this.parentElement.style.borderRadius=c(this,re):c(this,re)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=c(this,Be).map((r,a)=>{let n=c(this,He)[a]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${c(this,Ie)}, ${e})`}connectedCallback(){c(this,xe).call(this)}attributeChangedCallback(e,r,a){e==="border-radius"&&m(this,re,a?.trim()),e==="colors"&&a?m(this,Be,a?.split(",").map(n=>n.trim())??[]):e==="positions"&&a?m(this,He,a?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,Ie,a?.trim()??""),c(this,xe).call(this)}};Ie=new WeakMap,re=new WeakMap,Be=new WeakMap,He=new WeakMap,xe=new WeakMap;customElements.define("merch-gradient",rt);import{LitElement as Ci,html as Ti,css as Li}from"../lit-all.min.js";var ve=class extends Ci{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${t}"] ${y}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Ne,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Ne,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return Ti`
            <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};d(ve,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),d(ve,"styles",Li`
        :host {
            --merch-addon-gap: 9px;
    ...
    `);customElements.define("merch-addon",ve);import{html as it,nothing as _i}from"../lit-all.min.js";var be,O=class O{constructor(t){d(this,"card");u(this,be);this.card=t}getContainer(){return m(this,be,c(this,be)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),c(this,be)}static async ensureVariantStyle(t,e){if(O.variantStyleSheets.has(t))return Promise.resolve(O.variantStyleSheets.get(t));if(O.initializationPromises.has(t))return O.initializationPromises.get(t);let r=new Promise(a=>{try{let n=new CSSStyleSheet;n.replaceSync(e),O.variantStyleSheets.set(t,n),document.adoptedStyleSheets.includes(n)||(document.adoptedStyleSheets=[...document.adoptedStyleSheets,n]),a(n)}catch(n){console.error(`Failed to create stylesheet for variant ${t}:`,n),a(null)}});return O.initializationPromises.set(t,r),r}async insertVariantStyle(){let{variant:t}=this.card,e=this.getGlobalCSS();if(!e)return;let r=await O.ensureVariantStyle(t,e);r&&this.card.shadowRoot&&!this.card.shadowRoot.adoptedStyleSheets.includes(r)&&(this.card.shadowRoot.adoptedStyleSheets=[...this.card.shadowRoot.adoptedStyleSheets,r])}updateCardElementMinHeight(t,e){if(!t)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,a=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=parseInt(this.getContainer().style.getPropertyValue(r))||0;a>n&&this.getContainer().style.setProperty(r,`${a}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),it`
            <div
                id="badge"
        ...
        `}get cardImage(){return it` <div class="image">
            ...
            >`:_i}get secureLabelFooter(){return it`<footer>${this.secureLabel}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,e=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||e===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-e-16)}px`)}async postCardUpdateHook(){}connectedCallbackHook(){this.insertVariantStyle()}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return at(this.card.variant)}};be=new WeakMap,d(O,"variantStyleSheets",new Map),d(O,"initializationPromises",new Map);var v=O;import{html as At,css as zi}from"../lit-all.min.js";var xr=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as qe}from"../lit-all.min.js";var br=`
:root {
...
`;var nt=class extends v{constructor(t){super(t)}getGlobalCSS(){return br}renderLayout(){return qe`${this.cardImage}
    <div class="body">
...
`;var ot=class extends v{constructor(t){super(t)}getGlobalCSS(){return yr}renderLayout(){return wr` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":wr`<hr />`} ${this.secureLabelFooter}`}};import{html as we,css as Pi,unsafeCSS as Sr}from"../lit-all.min.js";var Er=`
  :root {
...
`;var Mi=32,Ee=class extends v{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?we`<slot name="secure-transaction-label">
              <span class="secure-transaction-label"
                  >${this.card.secureLabel}</span
              ></slot
          >`:we`<slot name="secure-transaction-label"></slot>`;return we`<footer>${e}<slot name="footer"></slot></footer>`});this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}connectedCallbackHook(){this.card.addEventListener(q,this.updatePriceQuantity)}disconnectedCallbackHook(){this.card.removeEventListener(q,this.updatePriceQuantity)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}getGlobalCSS(){return Er}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2)return;this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".top-section"),"top-section");let e=["heading-m","body-m","heading-m-price","body-xxs","price-commitment","offers","promo-text","callout-content"];this.card.classList.contains("bullet-list")&&e.push("footer-rows"),e.forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a)),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector("footer"),"footer"),this.card.shadowRoot.querySelector(".mini-compare-chart-badge")?.textContent!==""&&this.getContainer().style.setProperty("--consonant-merch-card-mini-compare-chart-top-section-mobile-height","32px")}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.querySelector('[slot="footer-rows"] ul');!e||!e.children||[...e.children].forEach((r,a)=>{let n=Math.max(Mi,parseFloat(window.getComputedStyle(r).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(a+1)))||0;n>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(a+1),`${n}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(r=>{let a=r.querySelector(".footer-row-cell-description");a&&!a.textContent.trim()&&r.remove()})}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${y}[data-template="price"]`)}get headingMPriceSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-m-price"]')?.assignedElements()[0]}toggleAddon(e){let r=this.mainPrice,a=this.headingMPriceSlot;if(!r&&a){let n=e?.getAttribute("plan-type"),o=null;if(e&&n&&(o=e.querySelector(`p[data-plan-type="${n}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-m-price"]').forEach(s=>s.remove()),e.checked){if(o){let s=L("p",{class:"addon-heading-m-price-addon",slot:"heading-m-price"},o.innerHTML);this.card.appendChild(s)}}else{let s=L("p",{class:"card-heading",id:"free",slot:"heading-m-price"},"Free");this.card.appendChild(s)}}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;let r=this.mainPrice,a=this.card.planType;if(r&&(await r.onceSettled(),a=r.value?.[0]?.planType),!a)return;e.planType=a,this.card.querySelector("merch-addon[plan-type]")?.updateComplete.then(()=>{this.updateCardElementMinHeight(this.card.shadowRoot.querySelector('slot[name="addon"]'),"addon")})}renderLayout(){return we` <div class="top-section${this.badge?" badge":""}">
            <slot name="icons"></slot> ${this.badge}
        </div>
        <slot name="heading-m"></slot>
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(e=>e.onceSettled())),await this.adjustAddon(),x.isMobile?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};d(Ee,"variantStyle",Pi`
  ...
  `);import{html as Ue,css as Ri,nothing as st}from"../lit-all.min.js";var kr=`
:root {
...
`;var ct={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ar={...function(){let{whatsIncluded:i,size:t,...e}=ct;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Cr={...function(){let{subtitle:i,whatsIncluded:t,size:e,quantitySelect:r,...a}=ct;return a}()},_=class extends v{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,e){t.dataset.template===tt&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return kr}adjustSlotPlacement(t,e,r){let a=this.card.shadowRoot,n=a.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let s=a.querySelector(`footer slot[name="${t}"]`),l=a.querySelector(`.body slot[name="${t}"]`),h=a.querySelector(".body");if(o.includes("wide")||(n?.classList.remove("wide-footer"),s&&s.remove()),!!e.includes(o)){if(n?.classList.toggle("wide-footer",x.isDesktopOrUp),!r&&s){if(l)s.remove();else{let p=h.querySelector(`[data-placeholder-for="${t}"]`);p?p.replaceWith(s):h.appendChild(s)}return}if(r&&l){let p=document.createElement("div");if(p.setAttribute("data-placeholder-for",t),p.classList.add("slot-placeholder"),!s){let g=l.cloneNode(!0);n.prepend(g)}l.replaceWith(p)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],x.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],x.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.remove("hide-tooltip")}))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let e=this.card.querySelector('[slot="body-xs"]');if(!e)return;let r=e.querySelector("ul");if(!r)return;let a=r.previousElementSibling,n=document.createElement("div");n.classList.add("spacer"),e.insertBefore(n,a);let o=new IntersectionObserver(([s])=>{if(s.boundingClientRect.height===0)return;let l=0,h=this.card.querySelector('[slot="heading-s"]');h&&(l+=$e(h));let p=this.card.querySelector('[slot="subtitle"]');p&&(l+=$e(p));let g=this.card.querySelector('[slot="heading-m"]');g&&(l+=8+$e(g));for(let pe of e.childNodes){if(pe.classList.contains("spacer"))break;l+=$e(pe)}let P=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(P)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),o.disconnect()});o.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists())}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${y}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Ue`<div class="divider"></div>`:st}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],e=this.card.querySelector(`[slot="heading-m"] ${y}[data-template="price"]`);e&&t.push(e);let r=t.map(async a=>{let n=a.cloneNode(!0);await a.onceSettled(),a?.options&&(a.options.displayPerUnit&&(a.dataset.displayPerUnit="false"),a.options.displayTax&&(a.dataset.displayTax="false"),a.options.displayPlanType&&(a.dataset.displayPlanType="false"),n.setAttribute("data-template","legal"),a.parentNode.insertBefore(n,a.nextSibling),await n.onceSettled())});await Promise.all(r)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let e=this.mainPrice;if(!e)return;await e.onceSettled();let r=e.value?.[0]?.planType;r&&(t.planType=r)}get stockCheckbox(){return this.card.checkboxLabel?Ue`<label id="stock-checkbox">
                <input type="checkbox" @change=${this.card.toggleStockOffer}></input>
                <span></span>
                ${this.card.checkboxLabel}
            </label>`:st}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?st:Ue`<slot name="icons"></slot>`}connectedCallbackHook(){x.matchMobile.addEventListener("change",this.adaptForMedia),x.matchDesktopOrUp.addEventListener("change",this.adaptForMedia)}disconnectedCallbackHook(){x.matchMobile.removeEventListener("change",this.adaptForMedia),x.matchDesktopOrUp.removeEventListener("change",this.adaptForMedia)}renderLayout(){return Ue` ${this.badge}
            <div class="body">
                ${this.icons}
                <slot name="heading-xs"></slot>
    ...
    `),d(_,"collectionOptions",{customHeaderArea:t=>t.sidenav?Ue`<slot name="resultsText"></slot>`:st,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let e=()=>{let r=t.querySelectorAll("merch-card");for(let n of r)n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"));if(!x.isDesktop)return;let a=0;for(let n of r){if(n.style.display==="none")continue;let o=n.getAttribute("size"),s=o==="wide"?2:o==="super-wide"?3:1;s===2&&a%3===2&&(n.setAttribute("data-size",o),n.removeAttribute("size"),s=1),a+=s}};x.matchDesktop.addEventListener("change",e),t.addEventListener(me,e),t.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",e),t.removeEventListener(me,e)})}});import{html as U,css as Fi,unsafeCSS as Lr,nothing as lt}from"../lit-all.min.js";var Tr=`
@font-face {
...
`)[0].trim()}updateShortDescriptionVisibility(){let t=this.card.querySelector('[slot="short-description"]');if(!t)return;let e=t.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?U`
        ...
        `:U`
            ...
            `:lt}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?U`<slot name="icons"></slot>`:lt}get secureLabelFooter(){return U`<footer>${this.secureLabel}<slot name="quantity-select"></slot><slot name="footer"></slot></footer>`}connectedCallbackHook(){this.handleMediaChange=()=>{this.adaptForMedia(),this.updateShortDescriptionVisibility(),this.card.requestUpdate(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>{this.syncHeights()})},x.matchMobile.addEventListener("change",this.handleMediaChange),x.matchDesktopOrUp.addEventListener("change",this.handleMediaChange)}disconnectedCallbackHook(){x.matchMobile.removeEventListener("change",this.handleMediaChange),x.matchDesktopOrUp.removeEventListener("change",this.handleMediaChange)}renderLayout(){let e=this.card.getAttribute("size")==="wide";return U` ${this.badge}
            <div class="body">
                ${e?U`
    ...
    `),d(Q,"collectionOptions",{customHeaderArea:t=>t.sidenav?U`<slot name="resultsText"></slot>`:lt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let e=()=>{let r=t.querySelectorAll("merch-card");if(r.forEach(n=>{n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"))}),!x.isDesktop)return;let a=0;r.forEach(n=>{if(n.style.display==="none")return;let o=n.getAttribute("size"),s=o==="wide"?2:o==="super-wide"?3:1;s===2&&a%3===2&&(n.setAttribute("data-size",o),n.removeAttribute("size"),s=1),a+=s})};x.matchDesktop.addEventListener("change",e),t.addEventListener(me,e),t.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",e),t.removeEventListener(me,e)})}});import{html as Ct,css as Oi}from"../lit-all.min.js";var zr=`
:root {
...
`;var Se=class extends v{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return zr}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return Ct` ${this.badge}
    ...
    `);import{html as Tt,css as Di}from"../lit-all.min.js";var Pr=`
:root {
...
`;var ke=class extends v{constructor(t){super(t)}getGlobalCSS(){return Pr}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Tt` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
    ...
    <hr />
    ${this.secureLabelFooter}`}};d(ke,"variantStyle",Di`
  ...
  `);import{html as Lt,css as Ni}from"../lit-all.min.js";var Mr=`
:root {
...
`;var Rr={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Ae=class extends v{constructor(t){super(t)}getGlobalCSS(){return Mr}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return Lt`${this.cardImage}
            <div class="body">
            ...
            ${this.evergreen?Lt`
                  ...
                  `:Lt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};d(Ae,"variantStyle",Ni`
    ...
    `);import{html as $i,css as Ii}from"../lit-all.min.js";var Fr=`
:root {
...
`;var _t={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Ce=class extends v{getGlobalCSS(){return Fr}get aemFragmentMapping(){return _t}get headingSelector(){return'[slot="heading-xs"]'}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.querySelector('[slot="body-xs"]');t&&this.updateCardElementMinHeight(t,"description");let e=this.card.querySelector('[slot="price"]');e&&this.updateCardElementMinHeight(e,"price")}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length&&await Promise.all(this.card.prices.map(t=>t.onceSettled?.())),De())){let t=this.getContainer();if(!t)return;let e=`--consonant-merch-card-${this.card.variant}`,r=t.style.getPropertyValue(`${e}-description-height`);requestAnimationFrame(r?()=>{this.syncHeights()}:()=>{t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(n=>n.variantLayout?.syncHeights?.())})}}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!De()&&this.card.setAttribute("data-expanded","true"))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(De())t.removeAttribute("data-expanded");else{let a=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",a?"true":"false")}};e();let r=window.matchMedia(A);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(A).removeEventListener("change",this.mediaQueryListener)}handleChevronClick(t){t.preventDefault(),t.stopPropagation();let e=this.card;if(!e||De())return;let n=e.getAttribute("data-expanded")==="true"?"false":"true";e.setAttribute("data-expanded",n)}renderLayout(){return $i`
...
`;var zt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"l"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:[]},Te=class extends v{getGlobalCSS(){return Or}get aemFragmentMapping(){return zt}get headingSelector(){return'[slot="heading-xs"]'}syncHeights(){if(this.card.getBoundingClientRect().width<=2)return;let t=this.card.querySelector('[slot="short-description"]');t&&this.updateCardElementMinHeight(t,"short-description");let e=this.card.querySelector('[slot="price"]');e&&this.updateCardElementMinHeight(e,"price");let r=this.card.querySelector('[slot="cta"]');r&&this.updateCardElementMinHeight(r,"cta")}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,await Promise.all(this.card.prices.map(t=>t.onceSettled())),window.matchMedia("(min-width: 1025px)").matches)){let t=this.getContainer();if(!t)return;let e=`--consonant-merch-card-${this.card.variant}`,r=t.style.getPropertyValue(`${e}-price-height`);requestAnimationFrame(r?()=>{this.syncHeights()}:()=>{t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(n=>n.variantLayout?.syncHeights?.())})}}renderLayout(){return Bi`
    ...
    `);import{css as qi,html as Ui}from"../lit-all.min.js";var Dr=`
...
`;var Nr={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Le=class extends v{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Dr}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${y}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Ui`
            ${this.badge}
            <div class="body">
    ...
    `);var dt=new Map,$r=new WeakMap,Ir=new Map,C=(i,t,e=null,r=null,a)=>{dt.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:a})};C("catalog",ye,vr,ye.variantStyle);C("image",nt);C("inline-heading",ot);C("mini-compare-chart",Ee,null,Ee.variantStyle);C("plans",_,ct,_.variantStyle,_.collectionOptions);C("plans-students",_,Cr,_.variantStyle,_.collectionOptions);C("plans-education",_,Ar,_.variantStyle,_.collectionOptions);C("plans-v2",Q,_r,Q.variantStyle,Q.collectionOptions);C("product",Se,null,Se.variantStyle);C("segment",ke,null,ke.variantStyle);C("special-offers",Ae,Rr,Ae.variantStyle);C("simplified-pricing-express",Ce,_t,Ce.variantStyle);C("full-pricing-express",Te,zt,Te.variantStyle);C("mini",Le,Nr,Le.variantStyle);var ji=(i,t,e)=>{try{let r=Ir.get(i.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),Ir.set(i.variant,r)),e?.styleSheet&&e.styleSheet!==r){let a=i.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);a!==-1&&i.shadowRoot.adoptedStyleSheets.splice(a,1)}return i.shadowRoot.adoptedStyleSheets.includes(r)||i.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let a=document.createElement("style");a.textContent=t.cssText,a.setAttribute("data-variant-style",i.variant);let n=e?.styleElement||i.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),i.shadowRoot.appendChild(a),{styleElement:a}}},Pt=i=>{let t=dt.get(i.variant);if(!t)return;let{class:e,style:r}=t,a=$r.get(i);if(a?.appliedVariant===i.variant)return new e(i);let n=r?ji(i,r,a):{};return $r.set(i,{appliedVariant:i.variant,...n}),new e(i)};function at(i){return dt.get(i)?.fragmentMapping}function Br(i){return dt.get(i)?.collectionOptions}var j=null,Mt=()=>{if(j)return j;if(window.__masGlobalStyleSheet)j=window.__masGlobalStyleSheet;else{j=new CSSStyleSheet;let i=`
:root {
...
`;j.replaceSync(i),window.__masGlobalStyleSheet=j,document.adoptedStyleSheets.includes(j)||(document.adoptedStyleSheets=[...document.adoptedStyleSheets,j])}return j},_s=Mt();function pt(i,t={},{metadata:e=!0,search:r=!0,storage:a=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),s=Rt(r)?r:i;n=o.get(s)}if(a&&n==null){let o=Rt(a)?a:i;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Vi(Rt(e)?e:i);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[i]}var Gi=i=>typeof i=="boolean",ht=i=>typeof i=="function";var Rt=i=>typeof i=="string";function Hr(i,t){if(Gi(i))return i;let e=String(i);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function Vi(i=""){return String(i).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var ie=class i extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let a=e.response.headers?.get(Ze);a&&(e.requestId=a),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,i)}toString(){let t=Object.entries(this.context||{}).map(([r,a])=>`${r}: ${JSON.stringify(a)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var Yi="mas-commerce-service",Ki={requestId:Ze,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var mt=i=>window.setTimeout(i);function Ft(){return document.getElementsByTagName(Yi)?.[0]}function qr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(Ki)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Ur(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var jr="fragment",Gr="author",Vr="preview",Yr="loading",Kr="timeout",Ot="aem-fragment",Wr="eager",Qr="cache",Wi=[Wr,Qr],I,ae,D,Dt=class{constructor(){u(this,I,new Map);u(this,ae,new Map);u(this,D,new Map)}clear(){c(this,I).clear(),c(this,ae).clear(),c(this,D).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,I).set(t.id,t),t.fields?.originalId&&c(this,I).set(t.fields.originalId,t),c(this,D).has(t.id)){let[,r]=c(this,D).get(t.id);r()}if(c(this,D).has(t.fields?.originalId)){let[,r]=c(this,D).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,I).has(t)}entries(){return c(this,I).entries()}get(t){return c(this,I).get(t)}getAsPromise(t){let[e]=c(this,D).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,D).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,ae).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,ae).set(t,e)),e}remove(t){c(this,I).delete(t),c(this,ae).delete(t),c(this,D).delete(t)}};I=new WeakMap,ae=new WeakMap,D=new WeakMap;var X=new Dt,_e,B,G,M,z,E,je,Ge,N,Ve,Ye,ze,$,Xr,Zr,Nt,Jr,gt=class extends HTMLElement{constructor(){super(...arguments);u(this,$);d(this,"cache",X);u(this,_e);u(this,B,null);u(this,G,null);u(this,M,null);u(this,z);u(this,E);u(this,je,Wr);u(this,Ge,5e3);u(this,N);u(this,Ve,!1);u(this,Ye,0);u(this,ze)}static get observedAttributes(){return[jr,Yr,Kr,Gr,Vr]}attributeChangedCallback(e,r,a){e===jr&&(m(this,z,a),m(this,E,X.getFetchInfo(a))),e===Yr&&Wi.includes(a)&&m(this,je,a),e===Kr&&m(this,Ge,parseInt(a,10)),e===Gr&&m(this,Ve,["","true"].includes(a)),e===Vr&&m(this,ze,a)}connectedCallback(){if(!c(this,N)){if(c(this,M)??m(this,M,te(this)),m(this,ze,c(this,M).settings?.preview),c(this,_e)??m(this,_e,c(this,M).log.module(`${Ot}[${c(this,z)}]`)),!c(this,z)||c(this,z)==="#"){c(this,E)??m(this,E,X.getFetchInfo("missing-fragment-id")),k(this,$,Nt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,E)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,N)&&!await Promise.race([c(this,N),Promise.resolve(!1)]))return;e&&X.remove(c(this,z)),c(this,je)===Qr&&await Promise.race([X.getAsPromise(c(this,z)),new Promise(s=>setTimeout(s,c(this,Ge)))]);try{m(this,N,k(this,$,Jr).call(this)),await c(this,N)}catch(s){return k(this,$,Nt).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,B)||{};return o&&!pt("mas.disableWcsCache")&&c(this,M).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ge,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,E)},bubbles:!0,composed:!0})),c(this,N)}get updateComplete(){return c(this,N)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,G)?c(this,G):(c(this,Ve)?this.transformAuthorData():this.transformPublishData(),c(this,G))}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={}}=c(this,B);m(this,G,e.reduce((h,{name:p,multiple:g,values:P})=>(h.fields[p]=g?P:P[0],h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:l}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={}}=c(this,B);m(this,G,Object.entries(e).reduce((h,[p,g])=>(h.fields[p]=g?.mimeType?g.value:g??"",h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:l}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,z),{locale:c(this,M).settings.locale,apiKey:c(this,M).settings.wcsApiKey})}};_e=new WeakMap,B=new WeakMap,G=new WeakMap,M=new WeakMap,z=new WeakMap,E=new WeakMap,je=new WeakMap,Ge=new WeakMap,N=new WeakMap,Ve=new WeakMap,Ye=new WeakMap,ze=new WeakMap,$=new WeakSet,Xr=async function(e){Xt(this,Ye)._++;let r=`${Ot}:${c(this,z)}:${c(this,Ye)}`,a=`${r}${Je}`,n=`${r}${et}`;if(c(this,ze))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,E).stale=!1,c(this,E).url=e,o=await Ur(e,{cache:"default",credentials:"omit"}),k(this,$,Zr).call(this,o),c(this,E).status=o?.status,c(this,E).measure=fe(performance.measure(n,a)),c(this,E).retryCount=o.retryCount,!o?.ok)throw new ie("Unexpected fragment response",{response:o,...c(this,M).duration});return await o.json()}catch(s){if(c(this,E).measure=fe(performance.measure(n,a)),c(this,E).retryCount=s.retryCount,c(this,B))return c(this,E).stale=!0,c(this,_e).error("Serving stale data",c(this,E)),c(this,B);let l=s.message??"unknown";throw new ie(`Failed to fetch fragment: ${l}`,{})}},Zr=function(e){Object.assign(c(this,E),qr(e))},Nt=function(e){m(this,N,null),c(this,E).message=e,this.classList.add("error");let r={...c(this,E),...c(this,M).duration};c(this,_e).error(e,r),this.dispatchEvent(new CustomEvent(ue,{detail:r,bubbles:!0,composed:!0}))},Jr=async function(){var l;this.classList.remove("error"),m(this,G,null);let e=X.get(c(this,z));if(e)return m(this,B,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,M).settings,s=`${r}/fragment?id=${c(this,z)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await k(this,$,Xr).call(this,s),(l=e.fields).originalId??(l.originalId=c(this,z)),X.add(e),m(this,B,e),!0},d(gt,"cache",X);customElements.define(Ot,gt);import{LitElement as Qi,html as Xi,css as Zi}from"../lit-all.min.js";var Pe=class extends Qi{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Xi`<div class="badge">
            ${this.text}
        </div>`}};d(Pe,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"}}),d(Pe,"styles",Zi`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",Pe);import{html as Ji,css as ea,LitElement as ta}from"../lit-all.min.js";var Ke=class extends ta{constructor(){super()}render(){return Ji`
            <slot name="icon"></slot>
    ...
    `),d(We,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",We);var ne={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,tags:"acom",isProdDomain:!1},ei=1e3;function aa(i){return i instanceof Error||typeof i?.originatingRequest=="string"}function ti(i){if(i==null)return;let t=typeof i;if(t==="function")return i.name?`function ${i.name}`:"function";if(t==="object"){if(i instanceof Error)return i.message;if(typeof i.originatingRequest=="string"){let{message:r,originatingRequest:a,status:n}=i;return[r,n,a].filter(Boolean).join(" ")}let e=i[Symbol.toStringTag]??Object.getPrototypeOf(i).constructor.name;if(!ne.serializableTypes.includes(e))return e}return i}function na(i,t){if(!ne.ignoredProperties.includes(i))return ti(t)}var It={append(i){if(i.level!=="error")return;let{message:t,params:e}=i,r=[],a=[],n=t;e.forEach(h=>{h!=null&&(aa(h)?r:a).push(h)}),r.length&&(n+=" "+r.map(ti).join(" "));let{pathname:o,search:s}=window.location,l=`${ne.delimiter}page=${o}${s}`;l.length>ei&&(l=`${l.slice(0,ei)}<trunc>`),n+=l,a.length&&(n+=`${ne.delimiter}facts=`,n+=JSON.stringify(a,na)),window.lana?.log(n,ne)}};function ri(i){Object.assign(ne,Object.fromEntries(Object.entries(i).filter(([t,e])=>t in ne&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var ii={LOCAL:"local",PROD:"prod",STAGE:"stage"},Bt={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Ht=new Set,qt=new Set,ai=new Map,ni={append({level:i,message:t,params:e,timestamp:r,source:a}){console[i](`${r}ms [${a}] %c${t}`,"font-weight: bold;",...e)}},oi={filter:({level:i})=>i!==Bt.DEBUG},oa={filter:()=>!1};function sa(i,t,e,r,a){return{level:i,message:t,namespace:e,get params(){return r.length===1&&ht(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:a,timestamp:performance.now().toFixed(3)}}function ca(i){[...qt].every(t=>t(i))&&Ht.forEach(t=>t(i))}function si(i){let t=(ai.get(i)??0)+1;ai.set(i,t);let e=`${i} #${t}`,r={id:e,namespace:i,module:a=>si(`${r.namespace}/${a}`),updateConfig:ri};return Object.values(Bt).forEach(a=>{r[a]=(n,...o)=>ca(sa(a,n,i,o,e))}),Object.seal(r)}function ut(...i){i.forEach(t=>{let{append:e,filter:r}=t;ht(r)&&qt.add(r),ht(e)&&Ht.add(e)})}function la(i={}){let{name:t}=i,e=Hr(pt("commerce.debug",{search:!0,storage:!0}),t===ii.LOCAL);return ut(e?ni:oi),t===ii.PROD&&ut(It),Ut}function da(){Ht.clear(),qt.clear()}var Ut={...si(gr),Level:Bt,Plugins:{consoleAppender:ni,debugFilter:oi,quietFilter:oa,lanaAppender:It},init:la,reset:da,use:ut};var pa={[K]:dr,[ee]:pr,[W]:hr},ha={[K]:mr,[W]:Ne},Qe,ft=class{constructor(t){u(this,Qe);d(this,"changes",new Map);d(this,"connected",!1);d(this,"error");d(this,"log");d(this,"options");d(this,"promises",[]);d(this,"state",ee);d(this,"timer",null);d(this,"value");d(this,"version",0);d(this,"wrapperElement");this.wrapperElement=t,this.log=Ut.module("mas-element")}update(){[K,ee,W].forEach(t=>{this.wrapperElement.classList.toggle(pa[t],t===this.state)})}notify(){(this.state===W||this.state===K)&&(this.state===W?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===K&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let t=this.error;this.error instanceof ie&&(t={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(ha[this.state],{bubbles:!0,detail:t}))}attributeChangedCallback(t,e,r){this.changes.set(t,r),this.requestUpdate()}connectedCallback(){m(this,Qe,Ft()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:t,promises:e,state:r}=this;return W===r?Promise.resolve(this.wrapperElement):K===r?Promise.reject(t):new Promise((a,n)=>{e.push({resolve:a,reject:n})})}toggleResolved(t,e,r){return t!==this.version?!1:(r!==void 0&&(this.options=r),this.state=W,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),mt(()=>this.notify()),!0)}toggleFailed(t,e,r){if(t!==this.version)return!1;r!==void 0&&(this.options=r),this.error=e,this.state=K,this.update();let a=this.wrapperElement.getAttribute("is");return this.log?.error(`${a}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...c(this,Qe)?.duration}),mt(()=>this.notify()),!0}togglePending(t){return this.version++,t&&(this.options=t),this.state=ee,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!Ft()||this.timer)return;let{error:e,options:r,state:a,value:n,version:o}=this;this.state=ee,this.timer=mt(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||t)try{await this.wrapperElement.render?.()===!1&&this.state===ee&&this.version===o&&(this.state=a,this.error=e,this.value=n,this.update(),this.notify())}catch(l){this.toggleFailed(this.version,l,r)}})}};Qe=new WeakMap;function ma(i){return`https://${i==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var se,oe=class oe extends HTMLAnchorElement{constructor(){super();d(this,"masElement",new ft(this));u(this,se);this.setAttribute("is",oe.is)}get isUptLink(){return!0}initializeWcsData(e,r){this.setAttribute("data-wcs-osi",e),r&&this.setAttribute("data-promotion-code",r)}attributeChangedCallback(e,r,a){this.masElement.attributeChangedCallback(e,r,a)}connectedCallback(){this.masElement.connectedCallback(),m(this,se,te()),c(this,se)&&(this.log=c(this,se).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),m(this,se,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=te();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let r=e.collectCheckoutOptions({},this);if(!r.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let a=this.masElement.togglePending(r),n=e.resolveOfferSelectors(r);try{let[[o]]=await Promise.all(n),{country:s,language:l,env:h}=r,p=`locale=${l}_${s}&country=${s}&offer_id=${o.offerId}`,g=this.getAttribute("data-promotion-code");g&&(p+=`&promotion_code=${encodeURIComponent(g)}`),this.href=`${ma(h)}?${p}`,this.masElement.toggleResolved(a,o,r)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${r.wcsOsi}.`,o.message);return this.masElement.toggleFailed(a,s,r),!1}}static createFrom(e){let r=new oe;for(let a of e.attributes)a.name!=="is"&&(a.name==="class"&&a.value.includes("upt-link")?r.setAttribute("class",a.value.replace("upt-link","").trim()):r.setAttribute(a.name,a.value));return r.innerHTML=e.innerHTML,r.setAttribute("tabindex",0),r}};se=new WeakMap,d(oe,"is","upt-link"),d(oe,"tag","a"),d(oe,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var Z=oe;window.customElements.get(Z.is)||window.customElements.define(Z.is,Z,{extends:Z.tag});var ga="#000000",jt="#F8D904",ua="#EAEAEA",fa="#31A547",xa=/(accent|primary|secondary)(-(outline|link))?/,va="mas:product_code/",ba="daa-ll",xt="daa-lh",ya=["XL","L","M","S"],Gt="...";function R(i,t,e,r){let a=r[i];if(t[i]&&a){let n={slot:a?.slot,...a?.attributes},o=t[i];if(a.maxCount&&typeof o=="string"){let[l,h]=Na(o,a.maxCount,a.withSuffix);l!==o&&(n.title=h,o=l)}let s=L(a.tag,n,o);e.append(s)}}function wa(i,t,e){let r=i.mnemonicIcon?.map((n,o)=>({icon:n,alt:i.mnemonicAlt[o]??"",link:i.mnemonicLink[o]??""}));r?.forEach(({icon:n,alt:o,link:s})=>{if(s&&!/^https?:/.test(s))try{s=new URL(`https://${s}`).href.toString()}catch{s="#"}let l={slot:"icons",src:n,loading:t.loading,size:e?.size??"l"};o&&(l.alt=o),s&&(l.href=s);let h=L("merch-icon",l);t.append(h)});let a=t.shadowRoot.querySelector('slot[name="icons"]');a&&(a.style.display=r?.length?null:"none")}function Ea(i,t,e){if(e.badge?.slot){if(i.badge?.length&&!i.badge?.startsWith("<merch-badge")){let r=jt,a=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(r=e.badge?.default,i.borderColor||(a=!0));let n=i.badgeBackgroundColor||r,o=i.borderColor||"";a&&(o=e.badge?.default,i.borderColor=e.badge?.default),i.badge=`<merch-badge variant="${i.variant}" background-color="${n}" border-color="${o}">${i.badge}</merch-badge>`}R("badge",i,t,e)}else i.badge?(t.setAttribute("badge-text",i.badge),e.disabledAttributes?.includes("badgeColor")||t.setAttribute("badge-color",i.badgeColor||ga),e.disabledAttributes?.includes("badgeBackgroundColor")||t.setAttribute("badge-background-color",i.badgeBackgroundColor||jt),t.setAttribute("border-color",i.badgeBackgroundColor||jt)):t.setAttribute("border-color",i.borderColor||ua)}function Sa(i,t,e){if(e.trialBadge&&i.trialBadge){if(!i.trialBadge.startsWith("<merch-badge")){let r=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&i.trialBadgeBorderColor||fa;i.trialBadge=`<merch-badge variant="${i.variant}" border-color="${r}">${i.trialBadge}</merch-badge>`}R("trialBadge",i,t,e)}}function ka(i,t,e){e?.includes(i.size)&&t.setAttribute("size",i.size)}function Aa(i,t){i.cardName&&t.setAttribute("name",i.cardName)}function Ca(i,t,e){i.cardTitle&&(i.cardTitle=Me(i.cardTitle)),R("cardTitle",i,t,{cardTitle:e})}function Ta(i,t,e){R("subtitle",i,t,e)}function La(i,t,e,r){if(!i.backgroundColor||i.backgroundColor.toLowerCase()==="default"){t.style.removeProperty("--merch-card-custom-background-color"),t.removeAttribute("background-color");return}e?.[i.backgroundColor]?(t.style.setProperty("--merch-card-custom-background-color",`var(${e[i.backgroundColor]})`),t.setAttribute("background-color",i.backgroundColor)):r?.attribute&&i.backgroundColor&&(t.setAttribute(r.attribute,i.backgroundColor),t.style.removeProperty("--merch-card-custom-background-color"))}function _a(i,t,e){let r=e?.borderColor,a="--consonant-merch-card-border-color";if(i.borderColor?.toLowerCase()==="transparent")t.style.setProperty(a,"transparent");else if(i.borderColor&&r){let o=r?.specialValues?.[i.borderColor]?.includes("gradient")||/-gradient/.test(i.borderColor),s=/^spectrum-.*-plans$/.test(i.borderColor);if(o){t.setAttribute("gradient-border","true");let l=i.borderColor;if(r?.specialValues){for(let[h,p]of Object.entries(r.specialValues))if(p===i.borderColor){l=h;break}}t.setAttribute("border-color",l),t.style.removeProperty(a)}else s?(t.setAttribute("border-color",i.borderColor),t.style.setProperty(a,`var(--${i.borderColor})`)):t.style.setProperty(a,`var(--${i.borderColor})`)}}function za(i,t,e){if(i.backgroundImage){let r={loading:t.loading??"lazy",src:i.backgroundImage};if(i.backgroundImageAltText?r.alt=i.backgroundImageAltText:r.role="none",!e)return;if(e?.attribute){t.setAttribute(e.attribute,i.backgroundImage);return}t.append(L(e.tag,{slot:e.slot},L("img",r)))}}function Me(i){return!i||typeof i!="string"||i.includes("<mas-mnemonic")&&Promise.resolve().then(()=>(Et(),wt)).catch(console.error),i}function Pa(i,t,e){i.prices&&(i.prices=Me(i.prices)),R("prices",i,t,e)}function li(i,t,e){let r=i.hasAttribute("data-wcs-osi")&&!!i.getAttribute("data-wcs-osi"),a=i.className||"",n=xa.exec(a)?.[0]??"accent",o=n.includes("accent"),s=n.includes("primary"),l=n.includes("secondary"),h=n.includes("-outline"),p=n.includes("-link");i.classList.remove("accent","primary","secondary");let g;if(t.consonant)g=Ha(i,o,r,p,s);else if(p)g=i;else{let P;o?P="accent":s?P="primary":l&&(P="secondary"),g=t.spectrum==="swc"?Ba(i,e,h,P,r):Ia(i,e,h,P,r)}return g}function Ma(i,t){let{slot:e}=t?.description,r=i.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);r.length&&r.forEach(a=>{let n=li(a,i,t);a.replaceWith(n)})}function Ra(i,t,e){i.description&&(i.description=Me(i.description)),i.promoText&&(i.promoText=Me(i.promoText)),i.shortDescription&&(i.shortDescription=Me(i.shortDescription)),R("promoText",i,t,e),R("description",i,t,e),R("shortDescription",i,t,e),i.shortDescription&&(t.setAttribute("action-menu","true"),i.actionMenuLabel||t.setAttribute("action-menu-label","More options")),Ma(t,e),R("callout",i,t,e),R("quantitySelect",i,t,e),R("whatsIncluded",i,t,e)}function Fa(i,t,e){if(!e.addon)return;let r=i.addon?.replace(/[{}]/g,"");if(!r||/disabled/.test(r))return;let a=L("merch-addon",{slot:"addon"},r);[...a.querySelectorAll(y)].forEach(n=>{let o=n.parentElement;o?.nodeName==="P"&&o.setAttribute("data-plan-type","")}),t.append(a)}function Oa(i,t,e){i.addonConfirmation&&R("addonConfirmation",i,t,e)}function Da(i,t,e,r){r?.secureLabel&&e?.secureLabel&&t.setAttribute("secure-label",r.secureLabel)}function Na(i,t,e=!0){try{let r=typeof i!="string"?"":i,a=ci(r);if(a.length<=t)return[r,a];let n=0,o=!1,s=e?t-Gt.length<1?1:t-Gt.length:t,l=[];for(let g of r){if(n++,g==="<")if(o=!0,r[n]==="/")l.pop();else{let P="";for(let pe of r.substring(n)){if(pe===" "||pe===">")break;P+=pe}l.push(P)}if(g==="/"&&r[n]===">"&&l.pop(),g===">"){o=!1;continue}if(!o&&(s--,s===0))break}let h=r.substring(0,n).trim();if(l.length>0){l[0]==="p"&&l.shift();for(let g of l.reverse())h+=`</${g}>`}return[`${h}${e?Gt:""}`,a]}catch{let a=typeof i=="string"?i:"",n=ci(a);return[a,n]}}function ci(i){if(!i)return"";let t="",e=!1;for(let r of i){if(r==="<"&&(e=!0),r===">"){e=!1;continue}e||(t+=r)}return t}function $a(i,t){t.querySelectorAll("a.upt-link").forEach(r=>{let a=Z.createFrom(r);r.replaceWith(a),a.initializeWcsData(i.osi,i.promoCode)})}function Ia(i,t,e,r,a){let n=i;a?n=customElements.get("checkout-button").createCheckoutButton({},i.innerHTML):n.innerHTML=`<span>${n.textContent}</span>`,n.setAttribute("tabindex",0);for(let p of i.attributes)["class","is"].includes(p.name)||n.setAttribute(p.name,p.value);n.firstElementChild?.classList.add("spectrum-Button-label");let o=t?.ctas?.size??"M",s=`spectrum-Button--${r}`,l=ya.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",h=["spectrum-Button",s,l];return e&&h.push("spectrum-Button--outline"),n.classList.add(...h),n}function Ba(i,t,e,r,a){let n=i;a&&(n=customElements.get("checkout-button").createCheckoutButton(i.dataset),n.connectedCallback(),n.render());let o="fill";e&&(o="outline");let s=L("sp-button",{treatment:o,variant:r,tabIndex:0,size:t?.ctas?.size??"m",...i.dataset.analyticsId&&{"data-analytics-id":i.dataset.analyticsId}},i.innerHTML);return s.source=n,(a?n.onceSettled():Promise.resolve(n)).then(l=>{s.setAttribute("data-navigation-url",l.href)}),s.addEventListener("click",l=>{l.defaultPrevented||n.click()}),s}function Ha(i,t,e,r,a){let n=i;return e&&(n=customElements.get("checkout-link").createCheckoutLink(i.dataset,i.innerHTML)),r||(n.classList.add("button","con-button"),t&&n.classList.add("blue"),a&&n.classList.add("primary")),n}function qa(i,t,e,r){if(i.ctas){i.ctas=Me(i.ctas);let{slot:a}=e.ctas,n=L("div",{slot:a},i.ctas),o=[...n.querySelectorAll("a")].map(s=>li(s,t,e));n.innerHTML="",n.append(...o),t.append(n)}}function Ua(i,t){let{tags:e}=i,r=e?.find(n=>n.startsWith(va))?.split("/").pop();if(!r)return;t.setAttribute(xt,r),[...t.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((n,o)=>{n.setAttribute(ba,`${n.dataset.analyticsId}-${o+1}`)})}function ja(i){i.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,e])=>{i.querySelectorAll(`a.${t}`).forEach(r=>{r.classList.remove(t),r.classList.add("spectrum-Link",`spectrum-Link--${e}`)})})}function Ga(i){i.querySelectorAll("[slot]").forEach(r=>{r.remove()}),i.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","badge-background-color","badge-color","badge-text","gradient-border","size",xt].forEach(r=>i.removeAttribute(r));let e=["wide-strip","thin-strip"];i.classList.remove(...e)}async function di(i,t){if(!i){let l=t?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${l}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${l}).`)}if(!i.fields){let l=i.id||"unknown",h=t?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${h}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${h}) is missing 'fields'.`)}let{id:e,fields:r,settings:a={},priceLiterals:n}=i,{variant:o}=r;if(!o)throw new Error(`hydrate: no variant found in payload ${e}`);Ga(t),t.settings=a,n&&(t.priceLiterals=n),t.id??(t.id=i.id),t.variant=o,await t.updateComplete;let{aemFragmentMapping:s}=t.variantLayout;if(!s)throw new Error(`hydrate: variant mapping not found for ${e}`);s.style==="consonant"&&t.setAttribute("consonant",!0),wa(r,t,s.mnemonics),Ea(r,t,s),Sa(r,t,s),ka(r,t,s.size),Aa(r,t),Ca(r,t,s.title),Ta(r,t,s),Pa(r,t,s),za(r,t,s.backgroundImage),La(r,t,s.allowedColors,s.backgroundColor),_a(r,t,s),Ra(r,t,s),Fa(r,t,s),Oa(r,t,s),Da(r,t,s,a),$a(r,t),qa(r,t,s,o),Ua(r,t),ja(t)}var Kt="merch-card",Vt=2e4,pi="merch-card:",Ya=["full-pricing-express","simplified-pricing-express"];function hi(i,t){let e=i.closest(Kt);if(!e)return t;e.priceLiterals&&(t.literals??(t.literals={}),Object.assign(t.literals,e.priceLiterals)),e.aemFragment&&(t[ur]=!0),e.variantLayout?.priceOptionsProvider?.(i,t)}function Ka(i){i.providers.has(hi)||i.providers.price(hi)}var mi=new IntersectionObserver(i=>{i.forEach(t=>{t.target.clientHeight!==0&&(mi.unobserve(t.target),t.target.requestUpdate())})}),Wa=0,Re,Fe,Oe,V,le,H,de,S,ce,vt,gi,bt,F=class F extends Va{constructor(){super();u(this,S);u(this,Re);u(this,Fe);u(this,Oe);u(this,V);u(this,le);u(this,H);u(this,de,new Promise(e=>{m(this,H,e)}));d(this,"customerSegment");d(this,"marketSegment");d(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}firstUpdated(){this.variantLayout=Pt(this),this.variantLayout?.connectedCallbackHook()}willUpdate(e){(e.has("variant")||!this.variantLayout)&&(this.variantLayout=Pt(this),this.variantLayout?.connectedCallbackHook())}updated(e){(e.has("badgeBackgroundColor")||e.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border",this.computedBorderStyle),e.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(e)}catch(r){k(this,S,ce).call(this,`Error in postCardUpdateHook: ${r.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["ccd-slice","ccd-suggested","ah-promoted-plans","simplified-pricing-express","full-pricing-express"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector(y)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(Y)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(Y)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(Y)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:e}){if(!this.stockOfferOsis)return;let r=this.checkoutLinks;if(r.length!==0)for(let a of r){await a.onceSettled();let n=a.value?.[0]?.planType;if(!n)return;let o=this.stockOfferOsis[n];if(!o)return;let s=a.dataset.wcsOsi.split(",").filter(l=>l!==o);e.checked&&s.push(o),a.dataset.wcsOsi=s.join(",")}}changeHandler(e){e.target.tagName==="MERCH-ADDON"&&this.toggleAddon(e.target)}toggleAddon(e){this.variantLayout?.toggleAddon?.(e);let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length===0)return;let a=n=>{let{offerType:o,planType:s}=n.value?.[0]??{};if(!o||!s)return;let l=e.getOsi(s,o),h=(n.dataset.wcsOsi||"").split(",").filter(p=>p&&p!==l);e.checked&&h.push(l),n.dataset.wcsOsi=h.join(",")};r.forEach(a)}handleQuantitySelection(e){let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length!==0)for(let a of r)a.dataset.quantity=e.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(e){let r={...this.filters};Object.keys(r).forEach(a=>{if(e){r[a].order=Math.min(r[a].order||2,2);return}let n=r[a].order;n===1||Number.isNaN(Number(n))||(r[a].order=Number(n)+1)}),this.filters=r}includes(e){return this.textContent.match(new RegExp(e,"i"))!==null}connectedCallback(){var r;super.connectedCallback(),c(this,Fe)||m(this,Fe,Wa++),this.aemFragment||((r=c(this,H))==null||r.call(this),m(this,H,void 0)),F.globalStyleSheet&&this.shadowRoot&&!this.shadowRoot.adoptedStyleSheets.includes(F.globalStyleSheet)&&(this.shadowRoot.adoptedStyleSheets=[...this.shadowRoot.adoptedStyleSheets,F.globalStyleSheet]),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let e=this.id??c(this,Fe);m(this,le,`${pi}${e}${Je}`),m(this,Re,`${pi}${e}${et}`),performance.mark(c(this,le)),m(this,V,te()),Ka(c(this,V)),m(this,Oe,c(this,V).Log.module(Kt)),this.addEventListener(q,this.handleQuantitySelection),this.addEventListener(St,this.handleAddonAndQuantityUpdate),this.addEventListener(nr,this.handleMerchOfferSelectReady),this.addEventListener(ue,this.handleAemFragmentEvents),this.addEventListener(ge,this.handleAemFragmentEvents),this.addEventListener("change",this.changeHandler),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(q,this.handleQuantitySelection),this.removeEventListener(ue,this.handleAemFragmentEvents),this.removeEventListener(ge,this.handleAemFragmentEvents),this.removeEventListener("change",this.changeHandler),this.removeEventListener(St,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(e){var r;if(this.isConnected&&(e.type===ue&&k(this,S,ce).call(this,"AEM fragment cannot be loaded"),e.type===ge&&(this.failed=!1,e.target.nodeName==="AEM-FRAGMENT"))){let a=e.detail;try{c(this,H)||m(this,de,new Promise(n=>{m(this,H,n)})),di(a,this)}catch(n){k(this,S,ce).call(this,`hydration has failed: ${n.message}`)}finally{(r=c(this,H))==null||r.call(this),m(this,H,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected)return;c(this,de)&&(await c(this,de),Ya.includes(this.variantLayout)&&mi.observe(this),m(this,de,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let e=new Promise(s=>setTimeout(()=>s("timeout"),Vt));if(this.aemFragment){let s=await Promise.race([this.aemFragment.updateComplete,e]);if(s===!1||s==="timeout"){let l=s==="timeout"?`AEM fragment was not resolved within ${Vt} timeout`:"AEM fragment cannot be loaded";k(this,S,ce).call(this,l,{},!1);return}}let r=[...this.querySelectorAll(ar)],a=Promise.all(r.map(s=>s.onceSettled().catch(()=>s))).then(s=>s.every(l=>l.classList.contains("placeholder-resolved"))),n=await Promise.race([a,e]);if(n===!0){this.measure=performance.measure(c(this,Re),c(this,le));let s={...this.aemFragment?.fetchInfo,...c(this,V).duration,measure:fe(this.measure)};return this.dispatchEvent(new CustomEvent(cr,{bubbles:!0,composed:!0,detail:s})),this}this.measure=performance.measure(c(this,Re),c(this,le));let o={measure:fe(this.measure),...c(this,V).duration};n==="timeout"?k(this,S,ce).call(this,`Contains offers that were not resolved within ${Vt} timeout`,o):k(this,S,ce).call(this,"Contains unresolved offers",o)}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let e=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(Y)).length===2&&e&&e.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:e,items:r}}){if(!e||!r?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let n=this.checkoutLinks.find(p=>p.getAttribute("data-modal-id")===e);if(!n)return;let s=new URL(n.getAttribute("href")).searchParams.get("pa"),l=r.find(p=>p.productArrangementCode===s)?.quantity,h=!!r.find(p=>p.productArrangementCode!==s);if(l&&this.quantitySelect?.dispatchEvent(new CustomEvent(sr,{detail:{quantity:l},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==h){this.toggleStockOffer({target:this.addonCheckbox});let p=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(p,"target",{writable:!1,value:{checked:h}}),this.addonCheckbox.handleChange(p)}}get prices(){return Array.from(this.querySelectorAll(y))}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let e=this.querySelector(".price.price-alternative");if(e||(e=this.querySelector(`${y}[data-template="price"] > span`)),!!e)return e=e.innerText,e}get regularPrice(){return c(this,S,vt)?.innerText}get promotionCode(){let e=[...this.querySelectorAll(`${y}[data-promotion-code],${Y}[data-promotion-code]`)].map(a=>a.dataset.promotionCode),r=[...new Set(e)];return r.length>1&&c(this,Oe)?.warn(`Multiple different promotion codes found: ${r.join(", ")}`),e[0]}get annualPrice(){return this.querySelector(`${y}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(c(this,S,gi)??c(this,S,vt))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return c(this,S,vt)?.querySelector("span.price-recurrence")?.textContent?.trim()}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let e=this.querySelector('a[is="upt-link"]');if(e)return k(this,S,bt).call(this,e)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){let e=this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${Y}, a`);return Array.from(e??[])}get primaryCta(){return k(this,S,bt).call(this,this.ctas.find(e=>e.variant==="accent"||e.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return k(this,S,bt).call(this,this.ctas.find(e=>e.variant!=="accent"&&!e.matches(".spectrum-Button--accent,.con-button.blue")))}};Re=new WeakMap,Fe=new WeakMap,Oe=new WeakMap,V=new WeakMap,le=new WeakMap,H=new WeakMap,de=new WeakMap,S=new WeakSet,ce=function(e,r={},a=!0){if(!this.isConnected)return;let{aemFragment:n}=this,o=n?.getAttribute("fragment");o=`[${o}]`;let s={...this.aemFragment.fetchInfo,...c(this,V).duration,...r,message:e};c(this,Oe).error(`merch-card${o}: ${e}`,s),this.failed=!0,a&&this.dispatchEvent(new CustomEvent(lr,{bubbles:!0,composed:!0,detail:s}))},vt=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${y}[data-template="price"] > span`)},gi=function(){return this.querySelector(`${y}[data-template="legal"]`)},bt=function(e){if(e)return{text:e.innerText.trim(),analyticsId:e.dataset.analyticsId,href:e.getAttribute("href")??e.dataset.href}},d(F,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:e=>{if(!e)return;let[r,a,n]=e.split(",");return{PUF:r,ABM:a,M2M:n}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:e=>Object.fromEntries(e.split(",").map(r=>{let[a,n,o]=r.split(":"),s=Number(n);return[a,{order:Number.isNaN(Number(s))?void 0:s,size:o}]})),toAttribute:e=>Object.entries(e).map(([r,{order:a,size:n}])=>[r,a,n].filter(o=>o!==void 0).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:xt,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),d(F,"styles",[tr,...rr()]),d(F,"globalStyleSheet",null),F.globalStyleSheet=Mt(),d(F,"registerVariant",C),d(F,"getCollectionOptions",Br),d(F,"getFragmentMapping",at);var Yt=F;customElements.define(Kt,Yt);export{Yt as MerchCard};
