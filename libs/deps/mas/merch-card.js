var Ht=Object.defineProperty;var Ut=i=>{throw TypeError(i)};var ni=(i,t,e)=>t in i?Ht(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var oi=(i,t)=>()=>(i&&(t=i(i=0)),t);var si=(i,t)=>{for(var e in t)Ht(i,e,{get:t[e],enumerable:!0})};var l=(i,t,e)=>ni(i,typeof t!="symbol"?t+"":t,e),gt=(i,t,e)=>t.has(i)||Ut("Cannot "+e);var c=(i,t,e)=>(gt(i,t,"read from private field"),e?e.call(i):t.get(i)),g=(i,t,e)=>t.has(i)?Ut("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),p=(i,t,e,r)=>(gt(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),E=(i,t,e)=>(gt(i,t,"access private method"),e);var qt=(i,t,e,r)=>({set _(a){p(i,t,a,e)},get _(){return c(i,t,r)}});var ut={};si(ut,{default:()=>W});import{LitElement as ci,html as Ye,css as li}from"../lit-all.min.js";function di(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var W,ft=oi(()=>{W=class extends ci{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs"}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Ye`<merch-icon 
            src="${this.src}" 
            size="${this.size}"
...
`;var be=class extends x{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return wr}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return yt` ${this.badge}
    ...
    `);import{html as wt,css as ki}from"../lit-all.min.js";var Er=`
:root {
...
`;var ve=class extends x{constructor(t){super(t)}getGlobalCSS(){return Er}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return wt` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
  ...
  `);import{html as Et,css as Ci}from"../lit-all.min.js";var Sr=`
:root {
...
`;var Ar={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ye=class extends x{constructor(t){super(t)}getGlobalCSS(){return Sr}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return Et`${this.cardImage}
            <div class="body">
...
`;document.head.appendChild(Pr);function nt(i,t={},{metadata:e=!0,search:r=!0,storage:a=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),s=Ct(r)?r:i;n=o.get(s)}if(a&&n==null){let o=Ct(a)?a:i;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Ni(Ct(e)?e:i);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[i]}var Mi=i=>typeof i=="boolean",ot=i=>typeof i=="function";var Ct=i=>typeof i=="string";function zr(i,t){if(Mi(i))return i;let e=String(i);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function Ni(i=""){return String(i).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var J=class i extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let a=e.response.headers?.get(Ke);a&&(e.requestId=a),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,i)}toString(){let t=Object.entries(this.context||{}).map(([r,a])=>`${r}: ${JSON.stringify(a)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var Oi="mas-commerce-service",$i={requestId:Ke,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var st=i=>window.setTimeout(i);function Tt(){return document.getElementsByTagName(Oi)?.[0]}function Rr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries($i)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Mr(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var Nr="fragment",Or="author",$r="preview",Ir="loading",Dr="timeout",Lt="aem-fragment",Fr="eager",Br="cache",Ii=[Fr,Br],I,ee,N,_t=class{constructor(){g(this,I,new Map);g(this,ee,new Map);g(this,N,new Map)}clear(){c(this,I).clear(),c(this,ee).clear(),c(this,N).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,I).set(t.id,t),t.fields?.originalId&&c(this,I).set(t.fields.originalId,t),c(this,N).has(t.id)){let[,r]=c(this,N).get(t.id);r()}if(c(this,N).has(t.fields?.originalId)){let[,r]=c(this,N).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,I).has(t)}entries(){return c(this,I).entries()}get(t){return c(this,I).get(t)}getAsPromise(t){let[e]=c(this,N).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,N).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,ee).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,ee).set(t,e)),e}remove(t){c(this,I).delete(t),c(this,ee).delete(t),c(this,N).delete(t)}};I=new WeakMap,ee=new WeakMap,N=new WeakMap;var V=new _t,Ae,D,H,R,T,y,Be,He,O,Ue,qe,ke,$,Hr,Ur,Pt,qr,ct=class extends HTMLElement{constructor(){super(...arguments);g(this,$);l(this,"cache",V);g(this,Ae);g(this,D,null);g(this,H,null);g(this,R,null);g(this,T);g(this,y);g(this,Be,Fr);g(this,He,5e3);g(this,O);g(this,Ue,!1);g(this,qe,0);g(this,ke)}static get observedAttributes(){return[Nr,Ir,Dr,Or,$r]}attributeChangedCallback(e,r,a){e===Nr&&(p(this,T,a),p(this,y,V.getFetchInfo(a))),e===Ir&&Ii.includes(a)&&p(this,Be,a),e===Dr&&p(this,He,parseInt(a,10)),e===Or&&p(this,Ue,["","true"].includes(a)),e===$r&&p(this,ke,a)}connectedCallback(){if(!c(this,O)){if(c(this,R)??p(this,R,X(this)),p(this,ke,c(this,R).settings?.preview),c(this,Ae)??p(this,Ae,c(this,R).log.module(`${Lt}[${c(this,T)}]`)),!c(this,T)||c(this,T)==="#"){c(this,y)??p(this,y,V.getFetchInfo("missing-fragment-id")),E(this,$,Pt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,y)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,O)&&!await Promise.race([c(this,O),Promise.resolve(!1)]))return;e&&V.remove(c(this,T)),c(this,Be)===Br&&await Promise.race([V.getAsPromise(c(this,T)),new Promise(s=>setTimeout(s,c(this,He)))]);try{p(this,O,E(this,$,qr).call(this)),await c(this,O)}catch(s){return E(this,$,Pt).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,D)||{};return o&&!nt("mas.disableWcsCache")&&c(this,R).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(le,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,y)},bubbles:!0,composed:!0})),c(this,O)}get updateComplete(){return c(this,O)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,H)?c(this,H):(c(this,Ue)?this.transformAuthorData():this.transformPublishData(),c(this,H))}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,D);p(this,H,e.reduce((h,{name:m,multiple:f,values:L})=>(h.fields[m]=f?L:L[0],h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,D);p(this,H,Object.entries(e).reduce((h,[m,f])=>(h.fields[m]=f?.mimeType?f.value:f??"",h),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,T),{locale:c(this,R).settings.locale,apiKey:c(this,R).settings.wcsApiKey})}};Ae=new WeakMap,D=new WeakMap,H=new WeakMap,R=new WeakMap,T=new WeakMap,y=new WeakMap,Be=new WeakMap,He=new WeakMap,O=new WeakMap,Ue=new WeakMap,qe=new WeakMap,ke=new WeakMap,$=new WeakSet,Hr=async function(e){qt(this,qe)._++;let r=`${Lt}:${c(this,T)}:${c(this,qe)}`,a=`${r}${We}`,n=`${r}${Qe}`;if(c(this,ke))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,y).stale=!1,c(this,y).url=e,o=await Mr(e,{cache:"default",credentials:"omit"}),E(this,$,Ur).call(this,o),c(this,y).status=o?.status,c(this,y).measure=pe(performance.measure(n,a)),c(this,y).retryCount=o.retryCount,!o?.ok)throw new J("Unexpected fragment response",{response:o,...c(this,R).duration});return await o.json()}catch(s){if(c(this,y).measure=pe(performance.measure(n,a)),c(this,y).retryCount=s.retryCount,c(this,D))return c(this,y).stale=!0,c(this,Ae).error("Serving stale data",c(this,y)),c(this,D);let d=s.message??"unknown";throw new J(`Failed to fetch fragment: ${d}`,{})}},Ur=function(e){Object.assign(c(this,y),Rr(e))},Pt=function(e){p(this,O,null),c(this,y).message=e,this.classList.add("error");let r={...c(this,y),...c(this,R).duration};c(this,Ae).error(e,r),this.dispatchEvent(new CustomEvent(de,{detail:r,bubbles:!0,composed:!0}))},qr=async function(){var d;this.classList.remove("error"),p(this,H,null);let e=V.get(c(this,T));if(e)return p(this,D,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,R).settings,s=`${r}/fragment?id=${c(this,T)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await E(this,$,Hr).call(this,s),(d=e.fields).originalId??(d.originalId=c(this,T)),V.add(e),p(this,D,e),!0},l(ct,"cache",V);customElements.define(Lt,ct);import{LitElement as Di,html as Fi,css as Bi}from"../lit-all.min.js";var Ce=class extends Di{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return Fi`<div class="badge">
            ${this.text}
