var Wt=Object.defineProperty;var Qt=i=>{throw TypeError(i)};var ui=(i,t,e)=>t in i?Wt(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var fi=(i,t)=>()=>(i&&(t=i(i=0)),t);var xi=(i,t)=>{for(var e in t)Wt(i,e,{get:t[e],enumerable:!0})};var d=(i,t,e)=>ui(i,typeof t!="symbol"?t+"":t,e),yt=(i,t,e)=>t.has(i)||Qt("Cannot "+e);var c=(i,t,e)=>(yt(i,t,"read from private field"),e?e.call(i):t.get(i)),u=(i,t,e)=>t.has(i)?Qt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),m=(i,t,e,r)=>(yt(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),k=(i,t,e)=>(yt(i,t,"access private method"),e);var Xt=(i,t,e,r)=>({set _(a){m(i,t,a,e)},get _(){return c(i,t,r)}});var wt={};xi(wt,{default:()=>Z});import{LitElement as vi,html as Xe,css as bi}from"../lit-all.min.js";function yi(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var Z,Et=fi(()=>{Z=class extends vi{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs"}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Xe`<merch-icon 
            src="${this.src}" 
            size="${this.size}"
        ></merch-icon>`:Xe`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;return t?yi()?Xe`
            ...
            `:this.renderIcon()}};d(Z,"properties",{content:{type:String},placement:{type:String},variant:{type:String},src:{type:String},size:{type:String},tooltipText:{type:String,attribute:"tooltip-text"},tooltipPlacement:{type:String,attribute:"tooltip-placement"},mnemonicText:{type:String,attribute:"mnemonic-text"},mnemonicPlacement:{type:String,attribute:"mnemonic-placement"}}),d(Z,"styles",bi`
        :host {
            display: contents;
            overflow: visible;
        }
    ...
    `);customElements.define("mas-mnemonic",Z)});import{LitElement as Va}from"../lit-all.min.js";import{css as er,unsafeCSS as Jt}from"../lit-all.min.js";var w="(max-width: 767px)",A="(max-width: 1199px)",b="(min-width: 768px)",f="(min-width: 1200px)",T="(min-width: 1600px)",Zt={matchMobile:window.matchMedia(w),matchDesktop:window.matchMedia(`${f} and (not ${T})`),matchDesktopOrUp:window.matchMedia(f),matchLargeDesktop:window.matchMedia(T),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=Zt;function De(){return Zt.isDesktop}var tr=er`
    :host {
...
`,rr=()=>[er`
    ...
    `);customElements.define("merch-addon",ve);import{html as it,nothing as _i}from"../lit-all.min.js";var be,re=class re{constructor(t){d(this,"card");u(this,be);this.card=t}getContainer(){return m(this,be,c(this,be)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),c(this,be)}static ensureVariantStyle(t,e){if(re.variantStyleSheets.has(t))return re.variantStyleSheets.get(t);try{let r=new CSSStyleSheet;return r.replaceSync(e),re.variantStyleSheets.set(t,r),document.adoptedStyleSheets.includes(r)||(document.adoptedStyleSheets=[...document.adoptedStyleSheets,r]),r}catch(r){return console.error(`Failed to create stylesheet for variant ${t}:`,r),null}}insertVariantStyle(){let{variant:t}=this.card,e=this.getGlobalCSS();if(!e)return;let r=re.ensureVariantStyle(t,e);r&&this.card.shadowRoot&&!this.card.shadowRoot.adoptedStyleSheets.includes(r)&&(this.card.shadowRoot.adoptedStyleSheets=[...this.card.shadowRoot.adoptedStyleSheets,r])}updateCardElementMinHeight(t,e){if(!t)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,a=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=parseInt(this.getContainer().style.getPropertyValue(r))||0;a>n&&this.getContainer().style.setProperty(r,`${a}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),it`
            <div
                id="badge"
