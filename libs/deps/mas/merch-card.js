...
merch-card[variant="catalog"] .payment-details {
  ...
  font-weight: 400;
  line-height: var(--consonant-merch-card-body-line-height);
}`;var Ce={title:{tag:"h3",slot:"heading-xs"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{size:"l"},allowedSizes:["wide","super-wide"]},y=class extends m{constructor(e){super(e)}get aemFragmentMapping(){return Ce}renderLayout(){return F` <div class="body">
    ...
    `};import{html as U,css as ze}from"../lit-all.min.js";var ce=`
:root {
...
`;var ke={title:{tag:"h3",slot:"heading-xs"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{size:"l"}},w=class extends m{constructor(e){super(e)}getGlobalCSS(){return ce}get aemFragmentMapping(){return ke}renderLayout(){return U` <div class="body">
            <slot name="icons"></slot> ${this.badge}
            <slot name="heading-xs"></slot>
            <slot name="heading-m"></slot>
...
`;var z=class extends m{constructor(e){super(e)}getGlobalCSS(){return pe}renderLayout(){return I` ${this.badge}
      <div class="body">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
          <slot name="body-xxs"></slot>
...
`;var k=class extends m{constructor(e){super(e)}getGlobalCSS(){return ge}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return q` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var He={backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{size:"s"},allowedSizes:["wide"]},_=class extends m{getGlobalCSS(){return fe}get aemFragmentMapping(){return He}renderLayout(){return Pe` <div class="content">
                <slot name="icons"></slot> ${this.badge}
    ...
    `};var K=(r,e=!1)=>{switch(r.variant){case"catalog":return new y(r);case"ccd-action":return new w(r);case"image":return new $(r);case"inline-heading":return new R(r);case"mini-compare-chart":return new S(r);case"plans":return new C(r);case"product":return new z(r);case"segment":return new k(r);case"special-offers":return new L(r);case"twp":return new T(r);case"ccd-slice":return new _(r);default:return e?void 0:new z(r)}},ve=()=>{let r=[];return r.push(y.variantStyle),r.push(w.variantStyle),r.push(S.variantStyle),r.push(C.variantStyle),r.push(k.variantStyle),r.push(L.variantStyle),r.push(T.variantStyle),r.push(_.variantStyle),r};var be=document.createElement("style");be.innerHTML=`
:root {
