var jt=Object.defineProperty;var Gt=i=>{throw TypeError(i)};var ai=(i,t,e)=>t in i?jt(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var ni=(i,t)=>()=>(i&&(t=i(i=0)),t);var oi=(i,t)=>{for(var e in t)jt(i,e,{get:t[e],enumerable:!0})};var l=(i,t,e)=>ai(i,typeof t!="symbol"?t+"":t,e),ft=(i,t,e)=>t.has(i)||Gt("Cannot "+e);var s=(i,t,e)=>(ft(i,t,"read from private field"),e?e.call(i):t.get(i)),h=(i,t,e)=>t.has(i)?Gt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),p=(i,t,e,r)=>(ft(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),E=(i,t,e)=>(ft(i,t,"access private method"),e);var Vt=(i,t,e,r)=>({set _(a){p(i,t,a,e)},get _(){return s(i,t,r)}});var xt={};oi(xt,{default:()=>W});import{LitElement as si,html as Ye,css as ci}from"../lit-all.min.js";function li(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var W,bt=ni(()=>{W=class extends si{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs"}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Ye`<merch-icon 
            src="${this.src}" 
            size="${this.size}"
    ...
    `);customElements.define("mas-mnemonic",W)});import{LitElement as za}from"../lit-all.min.js";import{css as Kt,unsafeCSS as Yt}from"../lit-all.min.js";var S="(max-width: 767px)",R="(max-width: 1199px)",f="(min-width: 768px)",u="(min-width: 1200px)",O="(min-width: 1600px)";function je(){return window.matchMedia(S)}function Ge(){return window.matchMedia(u)}function K(){return je().matches}function Ve(){return Ge().matches}var Wt=Kt`
    :host {
...
`,Xt=()=>[Kt`
      ...
      `];import{LitElement as di,html as Qt,css as pi}from"../lit-all.min.js";function hi(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var se=class extends di{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(hi())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",a="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,a=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,a=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",a);let o=this.querySelector("img"),c=this.querySelector("a");c&&c.contains(o)?n.appendChild(c):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>bt())}e.remove()})}render(){let{href:t}=this;return t?Qt`<a href="${t}">
                  <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />
              </a>`:Qt` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};l(se,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),l(se,"styles",pi`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",se);var Va=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),Ya=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var b='span[is="inline-price"][data-wcs-osi]',H='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var mi='a[is="upt-link"]',Zt=`${b},${H},${mi}`;var Jt="merch-offer-select:ready",er="merch-card:action-menu-toggle";var vt="merch-quantity-selector:change",tr="merch-card-quantity:change",yt="merch-modal:addon-and-quantity-update";var ce="aem:load",le="aem:error",rr="mas:ready",ir="mas:error",ar="placeholder-failed",nr="placeholder-pending",or="placeholder-resolved";var sr="mas:failed",_e="mas:resolved",cr="mas/commerce";var U="failed",X="pending",q="resolved";var Ke="X-Request-Id",Ka=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var Wa=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var We=":start",Xe=":duration";var lr="legal";var gi="mas-commerce-service";function dr(i,t){let e;return function(){let r=this,a=arguments;clearTimeout(e),e=setTimeout(()=>i.apply(r,a),t)}}function k(i,t={},e=null,r=null){let a=r?document.createElement(i,{is:r}):document.createElement(i);e instanceof HTMLElement?a.appendChild(e):a.innerHTML=e;for(let[n,o]of Object.entries(t))a.setAttribute(n,o);return a}function de(i){return`startTime:${i.startTime.toFixed(2)}|duration:${i.duration.toFixed(2)}`}function pr(){return window.matchMedia("(max-width: 1024px)").matches}function Q(){return document.getElementsByTagName(gi)?.[0]}var Pe,Z,Re,Me,pe,Qe=class extends HTMLElement{constructor(){super();h(this,Pe,"");h(this,Z);h(this,Re,[]);h(this,Me,[]);h(this,pe);p(this,pe,dr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,s(this,Z)?this.parentElement.style.borderRadius=s(this,Z):s(this,Z)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=s(this,Re).map((r,a)=>{let n=s(this,Me)[a]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${s(this,Pe)}, ${e})`}connectedCallback(){s(this,pe).call(this)}attributeChangedCallback(e,r,a){e==="border-radius"&&p(this,Z,a?.trim()),e==="colors"&&a?p(this,Re,a?.split(",").map(n=>n.trim())??[]):e==="positions"&&a?p(this,Me,a?.split(",").map(n=>n.trim())??[]):e==="angle"&&p(this,Pe,a?.trim()??""),s(this,pe).call(this)}};Pe=new WeakMap,Z=new WeakMap,Re=new WeakMap,Me=new WeakMap,pe=new WeakMap;customElements.define("merch-gradient",Qe);import{LitElement as ui,html as fi,css as xi}from"../lit-all.min.js";var he=class extends ui{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${t}"] ${b}[data-offer-type="${c}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(_e,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(_e,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return fi`
            <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};l(he,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),l(he,"styles",xi`
        :host {
            --merch-addon-gap: 9px;
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return hr}setAriaExpanded(e,r){e.setAttribute("aria-expanded",r)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};l(ge,"variantStyle",vi`
    ...
    `);import{html as Ne}from"../lit-all.min.js";var gr=`
:root {
...
`;var et=class extends x{constructor(t){super(t)}getGlobalCSS(){return gr}renderLayout(){return Ne`${this.cardImage}
    <div class="body">
...
`;var tt=class extends x{constructor(t){super(t)}getGlobalCSS(){return ur}renderLayout(){return fr` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var wi=32,fe=class extends x{constructor(e){super(e);l(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);l(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?ue`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(e=>e.onceSettled())),await this.adjustAddon(),K()?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};l(fe,"variantStyle",yi`
  ...
  `);import{html as Oe,css as Ei,nothing as rt}from"../lit-all.min.js";var br=`
:root {
...
`;var it={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},vr={...function(){let{whatsIncluded:i,size:t,...e}=it;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},yr={...function(){let{subtitle:i,whatsIncluded:t,size:e,quantitySelect:r,...a}=it;return a}()},C=class extends x{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,e){t.dataset.template===lr&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return br}adjustSlotPlacement(t,e,r){let a=this.card.shadowRoot,n=a.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let c=a.querySelector(`footer slot[name="${t}"]`),d=a.querySelector(`.body slot[name="${t}"]`),m=a.querySelector(".body");if(o.includes("wide")||(n?.classList.remove("wide-footer"),c&&c.remove()),!!e.includes(o)){if(n?.classList.toggle("wide-footer",Ve()),!r&&c){if(d)c.remove();else{let g=m.querySelector(`[data-placeholder-for="${t}"]`);g?g.replaceWith(c):m.appendChild(c)}return}if(r&&d){let g=document.createElement("div");if(g.setAttribute("data-placeholder-for",t),g.classList.add("slot-placeholder"),!c){let v=d.cloneNode(!0);n.prepend(v)}d.replaceWith(g)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],Ve()),this.adjustSlotPlacement("callout-content",["super-wide"],Ve())}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.remove("hide-tooltip")}))}postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustLegal(),this.adjustAddon(),this.adjustCallout()}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${b}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Oe`<div class="divider"></div>`:rt}async adjustLegal(){if(await this.card.updateComplete,await customElements.whenDefined("inline-price"),this.legalAdjusted)return;this.legalAdjusted=!0;let t=[],e=this.card.querySelector(`[slot="heading-m"] ${b}[data-template="price"]`);e&&t.push(e);let r=t.map(async a=>{let n=a.cloneNode(!0);await a.onceSettled(),a?.options&&(a.options.displayPerUnit&&(a.dataset.displayPerUnit="false"),a.options.displayTax&&(a.dataset.displayTax="false"),a.options.displayPlanType&&(a.dataset.displayPlanType="false"),n.setAttribute("data-template","legal"),a.parentNode.insertBefore(n,a.nextSibling))});await Promise.all(r)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let e=this.mainPrice;if(!e)return;await e.onceSettled();let r=e.value?.[0]?.planType;r&&(t.planType=r)}get stockCheckbox(){return this.card.checkboxLabel?Oe`<label id="stock-checkbox">
                <input type="checkbox" @change=${this.card.toggleStockOffer}></input>
                <span></span>
                ${this.card.checkboxLabel}
            </label>`:rt}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?rt:Oe`<slot name="icons"></slot>`}connectedCallbackHook(){let t=je();t?.addEventListener&&t.addEventListener("change",this.adaptForMedia);let e=Ge();e?.addEventListener&&e.addEventListener("change",this.adaptForMedia)}disconnectedCallbackHook(){let t=je();t?.removeEventListener&&t.removeEventListener("change",this.adaptForMedia);let e=Ge();e?.removeEventListener&&e.removeEventListener("change",this.adaptForMedia)}renderLayout(){return Oe` ${this.badge}
            <div class="body">
                ${this.icons}
                <slot name="heading-xs"></slot>
    ...
    `),l(C,"collectionOptions",{customHeaderArea:t=>t.sidenav?Oe`<slot name="resultsText"></slot>`:rt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]}});import{html as St,css as Si}from"../lit-all.min.js";var wr=`
:root {
...
`;var xe=class extends x{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return wr}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return St` ${this.badge}
    ...
    `);import{html as At,css as Ai}from"../lit-all.min.js";var Er=`
:root {
...
`;var be=class extends x{constructor(t){super(t)}getGlobalCSS(){return Er}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return At` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
    ...
    <hr />
    ${this.secureLabelFooter}`}};l(be,"variantStyle",Ai`
  ...
  `);import{html as kt,css as ki}from"../lit-all.min.js";var Sr=`
:root {
...
`;var Ar={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ve=class extends x{constructor(t){super(t)}getGlobalCSS(){return Sr}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return kt`${this.cardImage}
            <div class="body">
            ...
            ${this.evergreen?kt`
                  ...
                  `:kt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};l(ve,"variantStyle",ki`
...
`;var at=()=>window.matchMedia(R).matches,Ct={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},ye=class extends x{getGlobalCSS(){return kr}get aemFragmentMapping(){return Ct}get headingSelector(){return'[slot="heading-xs"]'}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),requestAnimationFrame(()=>{this.card?.hasAttribute("data-default-card")&&at()&&this.card.setAttribute("data-expanded","true")}))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(at()){let a=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",a?"true":"false")}else t.removeAttribute("data-expanded")};e();let r=window.matchMedia(R);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener),this.attributeObserver=new MutationObserver(a=>{a.forEach(n=>{n.type==="attributes"&&n.attributeName==="data-default-card"&&this.card.hasAttribute("data-default-card")&&at()&&this.card.setAttribute("data-expanded","true")})}),this.attributeObserver.observe(this.card,{attributes:!0,attributeOldValue:!0})}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(R).removeEventListener("change",this.mediaQueryListener),this.attributeObserver&&this.attributeObserver.disconnect()}handleChevronClick(t){t.preventDefault(),t.stopPropagation();let e=this.card;if(!e||!at())return;let n=e.getAttribute("data-expanded")==="true"?"false":"true";e.setAttribute("data-expanded",n)}renderLayout(){return Ci`
    ...
    `);import{html as Li,css as _i}from"../lit-all.min.js";var Cr=`
:root {
...
/* Tablet - 2 columns */
@media screen and ${f} and (max-width: 1199px) {
    merch-card-collection.full-pricing-express {
...
`;var Tt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},description2:{tag:"div",slot:"description2",maxCount:3e3,withSuffix:!1},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"l"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:[]},j,we=class extends x{constructor(){super(...arguments);h(this,j)}getGlobalCSS(){return Cr}get aemFragmentMapping(){return Tt}get headingSelector(){return'[slot="heading-xs"]'}adjustFullPricingExpressSlots(){this.card.getBoundingClientRect().width!==0&&(this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".header"),"header"),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector('slot[name="body-s"]'),"body-s"),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".price-container"),"price-container"),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".cta"),"cta"),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".card-content"),"card-content"))}postCardUpdateHook(){this.card.isConnected&&(K()||this.adjustFullPricingExpressSlots())}connectedCallbackHook(){K()||(p(this,j,()=>{this.adjustFullPricingExpressSlots()}),window.addEventListener("resize",s(this,j)))}disconnectedCallbackHook(){s(this,j)&&(window.removeEventListener("resize",s(this,j)),p(this,j,null))}renderLayout(){return Li`
            <div class="badge-wrapper">
                <slot name="badge"></slot>
            </div>
            <div class="card-content">
            ...
            <slot></slot>
        `}};j=new WeakMap,l(we,"variantStyle",_i`
    ...
    `);import{css as Pi,html as Ri}from"../lit-all.min.js";var Tr=`
...
`;var Lr={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ee=class extends x{constructor(){super(...arguments);l(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Tr}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${b}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Ri`
            ${this.badge}
            <div class="body">
    ...
    `);var nt=new Map,A=(i,t,e=null,r=null,a)=>{nt.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:a})};A("catalog",ge,mr,ge.variantStyle);A("image",et);A("inline-heading",tt);A("mini-compare-chart",fe,null,fe.variantStyle);A("plans",C,it,C.variantStyle,C.collectionOptions);A("plans-students",C,yr,C.variantStyle,C.collectionOptions);A("plans-education",C,vr,C.variantStyle,C.collectionOptions);A("product",xe,null,xe.variantStyle);A("segment",be,null,be.variantStyle);A("special-offers",ve,Ar,ve.variantStyle);A("simplified-pricing-express",ye,Ct,ye.variantStyle);A("full-pricing-express",we,Tt,we.variantStyle);A("mini",Ee,Lr,Ee.variantStyle);var Lt=i=>{let t=nt.get(i.variant);if(!t)return;let{class:e,style:r}=t;if(r)try{let a=new CSSStyleSheet;a.replaceSync(r.cssText),i.shadowRoot.adoptedStyleSheets.push(a)}catch{let n=document.createElement("style");n.textContent=r.cssText,i.shadowRoot.appendChild(n)}return new e(i)};function Je(i){return nt.get(i)?.fragmentMapping}function _r(i){return nt.get(i)?.collectionOptions}var Pr=document.createElement("style");Pr.innerHTML=`
:root {
...
`;document.head.appendChild(Pr);function ot(i,t={},{metadata:e=!0,search:r=!0,storage:a=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),c=_t(r)?r:i;n=o.get(c)}if(a&&n==null){let o=_t(a)?a:i;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=zi(_t(e)?e:i);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[i]}var Mi=i=>typeof i=="boolean",st=i=>typeof i=="function";var _t=i=>typeof i=="string";function Rr(i,t){if(Mi(i))return i;let e=String(i);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function zi(i=""){return String(i).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var J=class i extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let a=e.response.headers?.get(Ke);a&&(e.requestId=a),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,i)}toString(){let t=Object.entries(this.context||{}).map(([r,a])=>`${r}: ${JSON.stringify(a)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var Ni="mas-commerce-service",Oi={requestId:Ke,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var ct=i=>window.setTimeout(i);function Pt(){return document.getElementsByTagName(Ni)?.[0]}function Mr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(Oi)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function zr(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,r*(n+1)))}throw a}var Nr="fragment",Or="author",$r="preview",Ir="loading",Dr="timeout",Rt="aem-fragment",Fr="eager",Br="cache",$i=[Fr,Br],$,ee,M,Mt=class{constructor(){h(this,$,new Map);h(this,ee,new Map);h(this,M,new Map)}clear(){s(this,$).clear(),s(this,ee).clear(),s(this,M).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(s(this,$).set(t.id,t),t.fields?.originalId&&s(this,$).set(t.fields.originalId,t),s(this,M).has(t.id)){let[,r]=s(this,M).get(t.id);r()}if(s(this,M).has(t.fields?.originalId)){let[,r]=s(this,M).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return s(this,$).has(t)}entries(){return s(this,$).entries()}get(t){return s(this,$).get(t)}getAsPromise(t){let[e]=s(this,M).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),s(this,M).set(t,[e,r]),e}getFetchInfo(t){let e=s(this,ee).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,ee).set(t,e)),e}remove(t){s(this,$).delete(t),s(this,ee).delete(t),s(this,M).delete(t)}};$=new WeakMap,ee=new WeakMap,M=new WeakMap;var G=new Mt,Se,I,F,L,T,y,$e,Ie,z,De,Fe,Ae,N,Hr,Ur,zt,qr,lt=class extends HTMLElement{constructor(){super(...arguments);h(this,N);l(this,"cache",G);h(this,Se);h(this,I,null);h(this,F,null);h(this,L,null);h(this,T);h(this,y);h(this,$e,Fr);h(this,Ie,5e3);h(this,z);h(this,De,!1);h(this,Fe,0);h(this,Ae)}static get observedAttributes(){return[Nr,Ir,Dr,Or,$r]}attributeChangedCallback(e,r,a){e===Nr&&(p(this,T,a),p(this,y,G.getFetchInfo(a))),e===Ir&&$i.includes(a)&&p(this,$e,a),e===Dr&&p(this,Ie,parseInt(a,10)),e===Or&&p(this,De,["","true"].includes(a)),e===$r&&p(this,Ae,a)}connectedCallback(){if(!s(this,z)){if(s(this,L)??p(this,L,Q(this)),p(this,Ae,s(this,L).settings?.preview),s(this,Se)??p(this,Se,s(this,L).log.module(`${Rt}[${s(this,T)}]`)),!s(this,T)||s(this,T)==="#"){s(this,y)??p(this,y,G.getFetchInfo("missing-fragment-id")),E(this,N,zt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,y)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(s(this,z)&&!await Promise.race([s(this,z),Promise.resolve(!1)]))return;e&&G.remove(s(this,T)),s(this,$e)===Br&&await Promise.race([G.getAsPromise(s(this,T)),new Promise(c=>setTimeout(c,s(this,Ie)))]);try{p(this,z,E(this,N,qr).call(this)),await s(this,z)}catch(c){return E(this,N,zt).call(this,c.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=s(this,I)||{};return o&&!ot("mas.disableWcsCache")&&s(this,L).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(ce,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...s(this,y)},bubbles:!0,composed:!0})),s(this,z)}get updateComplete(){return s(this,z)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,F)?s(this,F):(s(this,De)?this.transformAuthorData():this.transformPublishData(),s(this,F))}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:c={},placeholders:d={}}=s(this,I);p(this,F,e.reduce((m,{name:g,multiple:v,values:P})=>(m.fields[g]=v?P:P[0],m),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:c,placeholders:d}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:c={},placeholders:d={}}=s(this,I);p(this,F,Object.entries(e).reduce((m,[g,v])=>(m.fields[g]=v?.mimeType?v.value:v??"",m),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:c,placeholders:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(s(this,T),{locale:s(this,L).settings.locale,apiKey:s(this,L).settings.wcsApiKey})}};Se=new WeakMap,I=new WeakMap,F=new WeakMap,L=new WeakMap,T=new WeakMap,y=new WeakMap,$e=new WeakMap,Ie=new WeakMap,z=new WeakMap,De=new WeakMap,Fe=new WeakMap,Ae=new WeakMap,N=new WeakSet,Hr=async function(e){Vt(this,Fe)._++;let r=`${Rt}:${s(this,T)}:${s(this,Fe)}`,a=`${r}${We}`,n=`${r}${Xe}`;if(s(this,Ae))return await this.generatePreview();performance.mark(a);let o;try{if(s(this,y).stale=!1,s(this,y).url=e,o=await zr(e,{cache:"default",credentials:"omit"}),E(this,N,Ur).call(this,o),s(this,y).status=o?.status,s(this,y).measure=de(performance.measure(n,a)),s(this,y).retryCount=o.retryCount,!o?.ok)throw new J("Unexpected fragment response",{response:o,...s(this,L).duration});return await o.json()}catch(c){if(s(this,y).measure=de(performance.measure(n,a)),s(this,y).retryCount=c.retryCount,s(this,I))return s(this,y).stale=!0,s(this,Se).error("Serving stale data",s(this,y)),s(this,I);let d=c.message??"unknown";throw new J(`Failed to fetch fragment: ${d}`,{})}},Ur=function(e){Object.assign(s(this,y),Mr(e))},zt=function(e){p(this,z,null),s(this,y).message=e,this.classList.add("error");let r={...s(this,y),...s(this,L).duration};s(this,Se).error(e,r),this.dispatchEvent(new CustomEvent(le,{detail:r,bubbles:!0,composed:!0}))},qr=async function(){var d;this.classList.remove("error"),p(this,F,null);let e=G.get(s(this,T));if(e)return p(this,I,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=s(this,L).settings,c=`${r}/fragment?id=${s(this,T)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),e=await E(this,N,Hr).call(this,c),(d=e.fields).originalId??(d.originalId=s(this,T)),G.add(e),p(this,I,e),!0},l(lt,"cache",G);customElements.define(Rt,lt);import{LitElement as Ii,html as Di,css as Fi}from"../lit-all.min.js";var ke=class extends Ii{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return Di`<div class="badge">
            ${this.text}
        </div>`}};l(ke,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"}}),l(ke,"styles",Fi`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",ke);import{html as Bi,css as Hi,LitElement as Ui}from"../lit-all.min.js";var Be=class extends Ui{constructor(){super()}render(){return Bi`
            <slot name="icon"></slot>
    ...
    `),l(Be,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Be);import{html as Nt,css as qi,LitElement as ji}from"../lit-all.min.js";var He=class extends ji{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Nt`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${this.isMobile&&this.rows.length>this.mobileRows?Nt`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Nt``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};l(He,"styles",qi`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),l(He,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",He);var te={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,tags:"acom",isProdDomain:!1},jr=1e3;function Gi(i){return i instanceof Error||typeof i?.originatingRequest=="string"}function Gr(i){if(i==null)return;let t=typeof i;if(t==="function")return i.name?`function ${i.name}`:"function";if(t==="object"){if(i instanceof Error)return i.message;if(typeof i.originatingRequest=="string"){let{message:r,originatingRequest:a,status:n}=i;return[r,n,a].filter(Boolean).join(" ")}let e=i[Symbol.toStringTag]??Object.getPrototypeOf(i).constructor.name;if(!te.serializableTypes.includes(e))return e}return i}function Vi(i,t){if(!te.ignoredProperties.includes(i))return Gr(t)}var Ot={append(i){if(i.level!=="error")return;let{message:t,params:e}=i,r=[],a=[],n=t;e.forEach(m=>{m!=null&&(Gi(m)?r:a).push(m)}),r.length&&(n+=" "+r.map(Gr).join(" "));let{pathname:o,search:c}=window.location,d=`${te.delimiter}page=${o}${c}`;d.length>jr&&(d=`${d.slice(0,jr)}<trunc>`),n+=d,a.length&&(n+=`${te.delimiter}facts=`,n+=JSON.stringify(a,Vi)),window.lana?.log(n,te)}};function Vr(i){Object.assign(te,Object.fromEntries(Object.entries(i).filter(([t,e])=>t in te&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Yr={LOCAL:"local",PROD:"prod",STAGE:"stage"},$t={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},It=new Set,Dt=new Set,Kr=new Map,Wr={append({level:i,message:t,params:e,timestamp:r,source:a}){console[i](`${r}ms [${a}] %c${t}`,"font-weight: bold;",...e)}},Xr={filter:({level:i})=>i!==$t.DEBUG},Yi={filter:()=>!1};function Ki(i,t,e,r,a){return{level:i,message:t,namespace:e,get params(){return r.length===1&&st(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:a,timestamp:performance.now().toFixed(3)}}function Wi(i){[...Dt].every(t=>t(i))&&It.forEach(t=>t(i))}function Qr(i){let t=(Kr.get(i)??0)+1;Kr.set(i,t);let e=`${i} #${t}`,r={id:e,namespace:i,module:a=>Qr(`${r.namespace}/${a}`),updateConfig:Vr};return Object.values($t).forEach(a=>{r[a]=(n,...o)=>Wi(Ki(a,n,i,o,e))}),Object.seal(r)}function dt(...i){i.forEach(t=>{let{append:e,filter:r}=t;st(r)&&Dt.add(r),st(e)&&It.add(e)})}function Xi(i={}){let{name:t}=i,e=Rr(ot("commerce.debug",{search:!0,storage:!0}),t===Yr.LOCAL);return dt(e?Wr:Xr),t===Yr.PROD&&dt(Ot),Ft}function Qi(){It.clear(),Dt.clear()}var Ft={...Qr(cr),Level:$t,Plugins:{consoleAppender:Wr,debugFilter:Xr,quietFilter:Yi,lanaAppender:Ot},init:Xi,reset:Qi,use:dt};var Zi={[U]:ar,[X]:nr,[q]:or},Ji={[U]:sr,[q]:_e},Ue,pt=class{constructor(t){h(this,Ue);l(this,"changes",new Map);l(this,"connected",!1);l(this,"error");l(this,"log");l(this,"options");l(this,"promises",[]);l(this,"state",X);l(this,"timer",null);l(this,"value");l(this,"version",0);l(this,"wrapperElement");this.wrapperElement=t,this.log=Ft.module("mas-element")}update(){[U,X,q].forEach(t=>{this.wrapperElement.classList.toggle(Zi[t],t===this.state)})}notify(){(this.state===q||this.state===U)&&(this.state===q?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===U&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let t=this.error;this.error instanceof J&&(t={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(Ji[this.state],{bubbles:!0,detail:t}))}attributeChangedCallback(t,e,r){this.changes.set(t,r),this.requestUpdate()}connectedCallback(){p(this,Ue,Pt()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:t,promises:e,state:r}=this;return q===r?Promise.resolve(this.wrapperElement):U===r?Promise.reject(t):new Promise((a,n)=>{e.push({resolve:a,reject:n})})}toggleResolved(t,e,r){return t!==this.version?!1:(r!==void 0&&(this.options=r),this.state=q,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),ct(()=>this.notify()),!0)}toggleFailed(t,e,r){if(t!==this.version)return!1;r!==void 0&&(this.options=r),this.error=e,this.state=U,this.update();let a=this.wrapperElement.getAttribute("is");return this.log?.error(`${a}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...s(this,Ue)?.duration}),ct(()=>this.notify()),!0}togglePending(t){return this.version++,t&&(this.options=t),this.state=X,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!Pt()||this.timer)return;let{error:e,options:r,state:a,value:n,version:o}=this;this.state=X,this.timer=ct(async()=>{this.timer=null;let c=null;if(this.changes.size&&(c=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:c}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:c})),c||t)try{await this.wrapperElement.render?.()===!1&&this.state===X&&this.version===o&&(this.state=a,this.error=e,this.value=n,this.update(),this.notify())}catch(d){this.toggleFailed(this.version,d,r)}})}};Ue=new WeakMap;function ea(i){return`https://${i==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var ie,re=class re extends HTMLAnchorElement{constructor(){super();l(this,"masElement",new pt(this));h(this,ie);this.setAttribute("is",re.is)}get isUptLink(){return!0}initializeWcsData(e,r){this.setAttribute("data-wcs-osi",e),r&&this.setAttribute("data-promotion-code",r)}attributeChangedCallback(e,r,a){this.masElement.attributeChangedCallback(e,r,a)}connectedCallback(){this.masElement.connectedCallback(),p(this,ie,Q()),s(this,ie)&&(this.log=s(this,ie).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),p(this,ie,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=Q();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let r=e.collectCheckoutOptions({},this);if(!r.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let a=this.masElement.togglePending(r),n=e.resolveOfferSelectors(r);try{let[[o]]=await Promise.all(n),{country:c,language:d,env:m}=r,g=`locale=${d}_${c}&country=${c}&offer_id=${o.offerId}`,v=this.getAttribute("data-promotion-code");v&&(g+=`&promotion_code=${encodeURIComponent(v)}`),this.href=`${ea(m)}?${g}`,this.masElement.toggleResolved(a,o,r)}catch(o){let c=new Error(`Could not resolve offer selectors for id: ${r.wcsOsi}.`,o.message);return this.masElement.toggleFailed(a,c,r),!1}}static createFrom(e){let r=new re;for(let a of e.attributes)a.name!=="is"&&(a.name==="class"&&a.value.includes("upt-link")?r.setAttribute("class",a.value.replace("upt-link","").trim()):r.setAttribute(a.name,a.value));return r.innerHTML=e.innerHTML,r.setAttribute("tabindex",0),r}};ie=new WeakMap,l(re,"is","upt-link"),l(re,"tag","a"),l(re,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var V=re;window.customElements.get(V.is)||window.customElements.define(V.is,V,{extends:V.tag});var ta="#000000",Bt="#F8D904",ra="#EAEAEA",ia="#31A547",aa=/(accent|primary|secondary)(-(outline|link))?/,na="mas:product_code/",oa="daa-ll",ht="daa-lh",sa=["XL","L","M","S"],Ht="...";function _(i,t,e,r){let a=r[i];if(t[i]&&a){let n={slot:a?.slot},o=t[i];if(a.maxCount&&typeof o=="string"){let[d,m]=Aa(o,a.maxCount,a.withSuffix);d!==o&&(n.title=m,o=d)}let c=k(a.tag,n,o);e.append(c)}}function ca(i,t,e){let r=i.mnemonicIcon?.map((n,o)=>({icon:n,alt:i.mnemonicAlt[o]??"",link:i.mnemonicLink[o]??""}));r?.forEach(({icon:n,alt:o,link:c})=>{if(c&&!/^https?:/.test(c))try{c=new URL(`https://${c}`).href.toString()}catch{c="#"}let d={slot:"icons",src:n,loading:t.loading,size:e?.size??"l"};o&&(d.alt=o),c&&(d.href=c);let m=k("merch-icon",d);t.append(m)});let a=t.shadowRoot.querySelector('slot[name="icons"]');!r?.length&&a&&a.remove()}function la(i,t,e){if(e.badge?.slot){if(i.badge?.length&&!i.badge?.startsWith("<merch-badge")){let r=Bt,a=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(r=e.badge?.default,i.borderColor||(a=!0));let n=i.badgeBackgroundColor||r,o=i.borderColor||"";a&&(o=e.badge?.default,i.borderColor=e.badge?.default),i.badge=`<merch-badge variant="${i.variant}" background-color="${n}" border-color="${o}">${i.badge}</merch-badge>`}_("badge",i,t,e)}else i.badge?(t.setAttribute("badge-text",i.badge),e.disabledAttributes?.includes("badgeColor")||t.setAttribute("badge-color",i.badgeColor||ta),e.disabledAttributes?.includes("badgeBackgroundColor")||t.setAttribute("badge-background-color",i.badgeBackgroundColor||Bt),t.setAttribute("border-color",i.badgeBackgroundColor||Bt)):t.setAttribute("border-color",i.borderColor||ra)}function da(i,t,e){if(e.trialBadge&&i.trialBadge){if(!i.trialBadge.startsWith("<merch-badge")){let r=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&i.trialBadgeBorderColor||ia;i.trialBadge=`<merch-badge variant="${i.variant}" border-color="${r}">${i.trialBadge}</merch-badge>`}_("trialBadge",i,t,e)}}function pa(i,t,e){e?.includes(i.size)&&t.setAttribute("size",i.size)}function ha(i,t){i.cardName&&t.setAttribute("name",i.cardName)}function ma(i,t,e){_("cardTitle",i,t,{cardTitle:e})}function ga(i,t,e){_("subtitle",i,t,e)}function ua(i,t,e,r){if(!i.backgroundColor||i.backgroundColor.toLowerCase()==="default"){t.style.removeProperty("--merch-card-custom-background-color"),t.removeAttribute("background-color");return}e?.[i.backgroundColor]?(t.style.setProperty("--merch-card-custom-background-color",`var(${e[i.backgroundColor]})`),t.setAttribute("background-color",i.backgroundColor)):r?.attribute&&i.backgroundColor&&(t.setAttribute(r.attribute,i.backgroundColor),t.style.removeProperty("--merch-card-custom-background-color"))}function fa(i,t,e){let r=e?.borderColor,a="--consonant-merch-card-border-color";if(i.borderColor?.toLowerCase()==="transparent")t.style.setProperty(a,"transparent");else if(i.borderColor&&r)if(r?.specialValues?.[i.borderColor]?.includes("gradient")||/-gradient/.test(i.borderColor)){t.setAttribute("gradient-border","true");let c=i.borderColor;if(r?.specialValues){for(let[d,m]of Object.entries(r.specialValues))if(m===i.borderColor){c=d;break}}t.setAttribute("border-color",c),t.style.removeProperty(a)}else t.style.setProperty(a,`var(--${i.borderColor})`)}function xa(i,t,e){if(i.backgroundImage){let r={loading:t.loading??"lazy",src:i.backgroundImage};if(i.backgroundImageAltText?r.alt=i.backgroundImageAltText:r.role="none",!e)return;if(e?.attribute){t.setAttribute(e.attribute,i.backgroundImage);return}t.append(k(e.tag,{slot:e.slot},k("img",r)))}}function qe(i){return!i||typeof i!="string"||i.includes("<mas-mnemonic")&&Promise.resolve().then(()=>(bt(),xt)).catch(console.error),i}function ba(i,t,e){i.prices&&(i.prices=qe(i.prices)),_("prices",i,t,e)}function Jr(i,t,e){let r=i.hasAttribute("data-wcs-osi")&&!!i.getAttribute("data-wcs-osi"),a=i.className||"",n=aa.exec(a)?.[0]??"accent",o=n.includes("accent"),c=n.includes("primary"),d=n.includes("secondary"),m=n.includes("-outline"),g=n.includes("-link");i.classList.remove("accent","primary","secondary");let v;if(t.consonant)v=La(i,o,r,g,c);else if(g)v=i;else{let P;o?P="accent":c?P="primary":d&&(P="secondary"),v=t.spectrum==="swc"?Ta(i,e,m,P,r):Ca(i,e,m,P,r)}return v}function va(i,t){let{slot:e}=t?.description,r=i.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);r.length&&r.forEach(a=>{let n=Jr(a,i,t);a.replaceWith(n)})}function ya(i,t,e){i.description&&(i.description=qe(i.description)),i.promoText&&(i.promoText=qe(i.promoText)),i.description2&&(i.description2=qe(i.description2)),_("promoText",i,t,e),_("description",i,t,e),_("description2",i,t,e),va(t,e),_("callout",i,t,e),_("quantitySelect",i,t,e),_("whatsIncluded",i,t,e)}function wa(i,t,e){if(!e.addon)return;let r=i.addon?.replace(/[{}]/g,"");if(!r||/disabled/.test(r))return;let a=k("merch-addon",{slot:"addon"},r);[...a.querySelectorAll(b)].forEach(n=>{let o=n.parentElement;o?.nodeName==="P"&&o.setAttribute("data-plan-type","")}),t.append(a)}function Ea(i,t,e){i.addonConfirmation&&_("addonConfirmation",i,t,e)}function Sa(i,t,e,r){r?.secureLabel&&e?.secureLabel&&t.setAttribute("secure-label",r.secureLabel)}function Aa(i,t,e=!0){try{let r=typeof i!="string"?"":i,a=Zr(r);if(a.length<=t)return[r,a];let n=0,o=!1,c=e?t-Ht.length<1?1:t-Ht.length:t,d=[];for(let v of r){if(n++,v==="<")if(o=!0,r[n]==="/")d.pop();else{let P="";for(let ut of r.substring(n)){if(ut===" "||ut===">")break;P+=ut}d.push(P)}if(v==="/"&&r[n]===">"&&d.pop(),v===">"){o=!1;continue}if(!o&&(c--,c===0))break}let m=r.substring(0,n).trim();if(d.length>0){d[0]==="p"&&d.shift();for(let v of d.reverse())m+=`</${v}>`}return[`${m}${e?Ht:""}`,a]}catch{let a=typeof i=="string"?i:"",n=Zr(a);return[a,n]}}function Zr(i){if(!i)return"";let t="",e=!1;for(let r of i){if(r==="<"&&(e=!0),r===">"){e=!1;continue}e||(t+=r)}return t}function ka(i,t){t.querySelectorAll("a.upt-link").forEach(r=>{let a=V.createFrom(r);r.replaceWith(a),a.initializeWcsData(i.osi,i.promoCode)})}function Ca(i,t,e,r,a){let n=i;a?n=customElements.get("checkout-button").createCheckoutButton({},i.innerHTML):n.innerHTML=`<span>${n.textContent}</span>`,n.setAttribute("tabindex",0);for(let g of i.attributes)["class","is"].includes(g.name)||n.setAttribute(g.name,g.value);n.firstElementChild?.classList.add("spectrum-Button-label");let o=t?.ctas?.size??"M",c=`spectrum-Button--${r}`,d=sa.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",m=["spectrum-Button",c,d];return e&&m.push("spectrum-Button--outline"),n.classList.add(...m),n}function Ta(i,t,e,r,a){let n=i;a&&(n=customElements.get("checkout-button").createCheckoutButton(i.dataset),n.connectedCallback(),n.render());let o="fill";e&&(o="outline");let c=k("sp-button",{treatment:o,variant:r,tabIndex:0,size:t?.ctas?.size??"m",...i.dataset.analyticsId&&{"data-analytics-id":i.dataset.analyticsId}},i.innerHTML);return c.source=n,(a?n.onceSettled():Promise.resolve(n)).then(d=>{c.setAttribute("data-navigation-url",d.href)}),c.addEventListener("click",d=>{d.defaultPrevented||n.click()}),c}function La(i,t,e,r,a){let n=i;return e&&(n=customElements.get("checkout-link").createCheckoutLink(i.dataset,i.innerHTML)),r||(n.classList.add("button","con-button"),t&&n.classList.add("blue"),a&&n.classList.add("primary")),n}function _a(i,t,e,r){if(i.ctas){i.ctas=qe(i.ctas);let{slot:a}=e.ctas,n=k("div",{slot:a},i.ctas),o=[...n.querySelectorAll("a")].map(c=>Jr(c,t,e));n.innerHTML="",n.append(...o),t.append(n)}}function Pa(i,t){let{tags:e}=i,r=e?.find(n=>n.startsWith(na))?.split("/").pop();if(!r)return;t.setAttribute(ht,r),[...t.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((n,o)=>{n.setAttribute(oa,`${n.dataset.analyticsId}-${o+1}`)})}function Ra(i){i.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,e])=>{i.querySelectorAll(`a.${t}`).forEach(r=>{r.classList.remove(t),r.classList.add("spectrum-Link",`spectrum-Link--${e}`)})})}function Ma(i){i.querySelectorAll("[slot]").forEach(r=>{r.remove()}),i.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","badge-background-color","badge-color","badge-text","gradient-border","size",ht].forEach(r=>i.removeAttribute(r));let e=["wide-strip","thin-strip"];i.classList.remove(...e)}async function ei(i,t){if(!i){let d=t?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${d}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${d}).`)}if(!i.fields){let d=i.id||"unknown",m=t?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${d}' (merchCard id: ${m}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${d}' (merchCard id: ${m}) is missing 'fields'.`)}let{id:e,fields:r,settings:a={},priceLiterals:n}=i,{variant:o}=r;if(!o)throw new Error(`hydrate: no variant found in payload ${e}`);Ma(t),t.settings=a,n&&(t.priceLiterals=n),t.id??(t.id=i.id),t.variant=o,await t.updateComplete;let{aemFragmentMapping:c}=t.variantLayout;if(!c)throw new Error(`hydrate: variant mapping not found for ${e}`);c.style==="consonant"&&t.setAttribute("consonant",!0),ca(r,t,c.mnemonics),la(r,t,c),da(r,t,c),pa(r,t,c.size),ha(r,t),ma(r,t,c.title),ga(r,t,c),ba(r,t,c),xa(r,t,c.backgroundImage),ua(r,t,c.allowedColors,c.backgroundColor),fa(r,t,c),ya(r,t,c),wa(r,t,c),Ea(r,t,c),Sa(r,t,c,a),ka(r,t),_a(r,t,c,o),Pa(r,t),Ra(t)}var qt="merch-card",Ut=2e4,ti="merch-card:";function ri(i,t){let e=i.closest(qt);if(!e)return t;e.priceLiterals&&(t.literals??(t.literals={}),Object.assign(t.literals,e.priceLiterals)),e.variantLayout?.priceOptionsProvider?.(i,t)}function Na(i){i.providers.has(ri)||i.providers.price(ri)}var Oa=0,Ce,Te,Le,B,ne,D,oe,w,ae,mt,ii,gt,Y=class extends za{constructor(){super();h(this,w);h(this,Ce);h(this,Te);h(this,Le);h(this,B);h(this,ne);h(this,D);h(this,oe,new Promise(e=>{p(this,D,e)}));l(this,"customerSegment");l(this,"marketSegment");l(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}firstUpdated(){this.variantLayout=Lt(this),this.variantLayout?.connectedCallbackHook()}willUpdate(e){(e.has("variant")||!this.variantLayout)&&(this.variantLayout=Lt(this),this.variantLayout?.connectedCallbackHook())}updated(e){(e.has("badgeBackgroundColor")||e.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border",this.computedBorderStyle),e.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(e)}catch(r){E(this,w,ae).call(this,`Error in postCardUpdateHook: ${r.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["ccd-slice","ccd-suggested","ah-promoted-plans","simplified-pricing-express","full-pricing-express"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector(b)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(H)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(H)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(H)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:e}){if(!this.stockOfferOsis)return;let r=this.checkoutLinks;if(r.length!==0)for(let a of r){await a.onceSettled();let n=a.value?.[0]?.planType;if(!n)return;let o=this.stockOfferOsis[n];if(!o)return;let c=a.dataset.wcsOsi.split(",").filter(d=>d!==o);e.checked&&c.push(o),a.dataset.wcsOsi=c.join(",")}}changeHandler(e){e.target.tagName==="MERCH-ADDON"&&this.toggleAddon(e.target)}toggleAddon(e){this.variantLayout?.toggleAddon?.(e);let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length===0)return;let a=n=>{let{offerType:o,planType:c}=n.value?.[0]??{};if(!o||!c)return;let d=e.getOsi(c,o),m=(n.dataset.wcsOsi||"").split(",").filter(g=>g&&g!==d);e.checked&&m.push(d),n.dataset.wcsOsi=m.join(",")};r.forEach(a)}handleQuantitySelection(e){let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length!==0)for(let a of r)a.dataset.quantity=e.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(e){let r={...this.filters};Object.keys(r).forEach(a=>{if(e){r[a].order=Math.min(r[a].order||2,2);return}let n=r[a].order;n===1||isNaN(n)||(r[a].order=Number(n)+1)}),this.filters=r}includes(e){return this.textContent.match(new RegExp(e,"i"))!==null}connectedCallback(){var r;super.connectedCallback(),s(this,Te)||p(this,Te,Oa++),this.aemFragment||((r=s(this,D))==null||r.call(this),p(this,D,void 0)),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let e=this.id??s(this,Te);p(this,ne,`${ti}${e}${We}`),p(this,Ce,`${ti}${e}${Xe}`),performance.mark(s(this,ne)),p(this,B,Q()),Na(s(this,B)),p(this,Le,s(this,B).Log.module(qt)),this.addEventListener(vt,this.handleQuantitySelection),this.addEventListener(yt,this.handleAddonAndQuantityUpdate),this.addEventListener(Jt,this.handleMerchOfferSelectReady),this.addEventListener(le,this.handleAemFragmentEvents),this.addEventListener(ce,this.handleAemFragmentEvents),this.addEventListener("change",this.changeHandler),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(vt,this.handleQuantitySelection),this.removeEventListener(le,this.handleAemFragmentEvents),this.removeEventListener(ce,this.handleAemFragmentEvents),this.removeEventListener("change",this.changeHandler),this.removeEventListener(yt,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(e){var r;if(this.isConnected&&(e.type===le&&E(this,w,ae).call(this,"AEM fragment cannot be loaded"),e.type===ce&&(this.failed=!1,e.target.nodeName==="AEM-FRAGMENT"))){let a=e.detail;try{s(this,D)||p(this,oe,new Promise(n=>{p(this,D,n)})),ei(a,this)}catch(n){E(this,w,ae).call(this,`hydration has failed: ${n.message}`)}finally{(r=s(this,D))==null||r.call(this),p(this,D,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected)return;s(this,oe)&&(await s(this,oe),p(this,oe,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let e=new Promise(o=>setTimeout(()=>o("timeout"),Ut));if(this.aemFragment){let o=await Promise.race([this.aemFragment.updateComplete,e]);if(o===!1||o==="timeout"){let c=o==="timeout"?`AEM fragment was not resolved within ${Ut} timeout`:"AEM fragment cannot be loaded";E(this,w,ae).call(this,c,{},!1);return}}let r=[...this.querySelectorAll(Zt)],a=Promise.all(r.map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(c=>c.classList.contains("placeholder-resolved"))),n=await Promise.race([a,e]);if(n===!0){this.measure=performance.measure(s(this,Ce),s(this,ne));let o={...this.aemFragment?.fetchInfo,...s(this,B).duration,measure:de(this.measure)};return this.dispatchEvent(new CustomEvent(rr,{bubbles:!0,composed:!0,detail:o})),this}else{this.measure=performance.measure(s(this,Ce),s(this,ne));let o={measure:de(this.measure),...s(this,B).duration};n==="timeout"?E(this,w,ae).call(this,`Contains offers that were not resolved within ${Ut} timeout`,o):E(this,w,ae).call(this,"Contains unresolved offers",o)}}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let e=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(H)).length===2&&e&&e.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:e,items:r}}){if(!e||!r?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let n=this.checkoutLinks.find(g=>g.getAttribute("data-modal-id")===e);if(!n)return;let c=new URL(n.getAttribute("href")).searchParams.get("pa"),d=r.find(g=>g.productArrangementCode===c)?.quantity,m=!!r.find(g=>g.productArrangementCode!==c);if(d&&this.quantitySelect?.dispatchEvent(new CustomEvent(tr,{detail:{quantity:d},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==m){this.toggleStockOffer({target:this.addonCheckbox});let g=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(g,"target",{writable:!1,value:{checked:m}}),this.addonCheckbox.handleChange(g)}}get prices(){return Array.from(this.querySelectorAll(b))}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let e=this.querySelector(".price.price-alternative");if(e||(e=this.querySelector(`${b}[data-template="price"] > span`)),!!e)return e=e.innerText,e}get regularPrice(){return s(this,w,mt)?.innerText}get promotionCode(){let e=[...this.querySelectorAll(`${b}[data-promotion-code],${H}[data-promotion-code]`)].map(a=>a.dataset.promotionCode),r=[...new Set(e)];return r.length>1&&s(this,Le)?.warn(`Multiple different promotion codes found: ${r.join(", ")}`),e[0]}get annualPrice(){return this.querySelector(`${b}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(s(this,w,ii)??s(this,w,mt))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return s(this,w,mt)?.querySelector("span.price-recurrence")?.textContent?.trim()}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let e=this.querySelector('a[is="upt-link"]');if(e)return E(this,w,gt).call(this,e)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){let e=this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${H}, a`);return Array.from(e??[])}get primaryCta(){return E(this,w,gt).call(this,this.ctas.find(e=>e.variant==="accent"||e.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return E(this,w,gt).call(this,this.ctas.find(e=>e.variant!=="accent"&&!e.matches(".spectrum-Button--accent,.con-button.blue")))}};Ce=new WeakMap,Te=new WeakMap,Le=new WeakMap,B=new WeakMap,ne=new WeakMap,D=new WeakMap,oe=new WeakMap,w=new WeakSet,ae=function(e,r={},a=!0){if(!this.isConnected)return;let o=this.aemFragment?.getAttribute("fragment");o=`[${o}]`;let c={...this.aemFragment.fetchInfo,...s(this,B).duration,...r,message:e};s(this,Le).error(`merch-card${o}: ${e}`,c),this.failed=!0,a&&this.dispatchEvent(new CustomEvent(ir,{bubbles:!0,composed:!0,detail:c}))},mt=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${b}[data-template="price"] > span`)},ii=function(){return this.querySelector(`${b}[data-template="legal"]`)},gt=function(e){if(e)return{text:e.innerText.trim(),analyticsId:e.dataset.analyticsId,href:e.getAttribute("href")??e.dataset.href}},l(Y,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:e=>{if(!e)return;let[r,a,n]=e.split(",");return{PUF:r,ABM:a,M2M:n}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:e=>Object.fromEntries(e.split(",").map(r=>{let[a,n,o]=r.split(":"),c=Number(n);return[a,{order:isNaN(c)?void 0:c,size:o}]})),toAttribute:e=>Object.entries(e).map(([r,{order:a,size:n}])=>[r,a,n].filter(o=>o!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:ht,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),l(Y,"styles",[Wt,...Xt()]),l(Y,"registerVariant",A),l(Y,"getCollectionOptions",_r),l(Y,"getFragmentMapping",Je);customElements.define(qt,Y);export{Y as MerchCard};
