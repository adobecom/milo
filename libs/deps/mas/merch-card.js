...
`;var wt={size:[],mnemonics:{size:"l"},badge:!0,subtitle:{tag:"h4",slot:"detail-s"},backgroundImage:{attribute:"background-image"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"cta",size:"M"}},le=class extends w{getGlobalCSS(){return Gr}get aemFragmentMapping(){return wt}get stripStyle(){return this.card.backgroundImage?`
