...
`;var Nt=class extends f{constructor(e){super(e)}getGlobalCSS(){return Te}renderLayout(){return Ce` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":Ce`<hr />`} ${this.secureLabelFooter}`}};import{html as rt,css as ir,unsafeCSS as Vt}from"../lit-all.min.js";var ke=`
  :root {
