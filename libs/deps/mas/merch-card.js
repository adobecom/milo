...
import { css as css10, html as html12 } from "../lit-all.min.js";
...
__publicField(Mini, "variantStyle", css10`
        :host([variant='mini']) {
            min-width: 209px;
            min-height: 103px;
...
// src/merch-badge.js
import { LitElement as LitElement3, html as html13, css as css11 } from "../lit-all.min.js";
...
__publicField(MerchBadge, "styles", css11`
        :host {
            display: block;
...
import { html as html14, css as css12, LitElement as LitElement4 } from "../lit-all.min.js";
...
__publicField(MerchMnemonicList, "styles", css12`
        :host {
            display: flex;
            flex-wrap: nowrap;
            gap: 8px;
...
import { html as html15, css as css13, LitElement as LitElement5 } from "../lit-all.min.js";
var MerchWhatsIncluded = class extends LitElement5 {
  ...
  render() {
    return html15`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${this.isMobile && this.rows.length > this.mobileRows ? html15`<div @click=${this.toggle} class="see-more">
...
__publicField(MerchWhatsIncluded, "styles", css13`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
