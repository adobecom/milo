var Ut=Object.defineProperty;var qt=i=>{throw TypeError(i)};var ai=(i,t,e)=>t in i?Ut(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var oi=(i,t)=>()=>(i&&(t=i(i=0)),t);var si=(i,t)=>{for(var e in t)Ut(i,e,{get:t[e],enumerable:!0})};var l=(i,t,e)=>ai(i,typeof t!="symbol"?t+"":t,e),gt=(i,t,e)=>t.has(i)||qt("Cannot "+e);var c=(i,t,e)=>(gt(i,t,"read from private field"),e?e.call(i):t.get(i)),g=(i,t,e)=>t.has(i)?qt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),p=(i,t,e,r)=>(gt(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),E=(i,t,e)=>(gt(i,t,"access private method"),e);var Gt=(i,t,e,r)=>({set _(n){p(i,t,n,e)},get _(){return c(i,t,r)}});var ut={};si(ut,{default:()=>W});import{LitElement as ci,html as Ye,css as li}from"../lit-all.min.js";function di(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var W,ft=oi(()=>{W=class extends ci{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs"}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Ye`<merch-icon 
            src="${this.src}" 
            size="${this.size}"
        ></merch-icon>`:Ye`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;return t?di()?Ye`
    ...
    `);customElements.define("mas-mnemonic",W)});import{LitElement as Nn}from"../lit-all.min.js";import{css as Yt,unsafeCSS as Vt}from"../lit-all.min.js";var L="(max-width: 767px)",R="(max-width: 1199px)",b="(min-width: 768px)",u="(min-width: 1200px)",P="(min-width: 1600px)",jt={matchMobile:window.matchMedia(L),matchDesktop:window.matchMedia(`${u} and (not ${P})`),matchDesktopOrUp:window.matchMedia(u),matchLargeDesktop:window.matchMedia(P),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},S=jt;function Re(){return jt.isDesktop}var Kt=Yt`
    :host {
...
`,Wt=()=>[Yt`
      ...
      `];import{LitElement as pi,html as Qt,css as hi}from"../lit-all.min.js";function mi(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var ce=class extends pi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(mi())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",n="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,n=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let a=e.querySelector("sp-tooltip");a&&(r=a.textContent,n=a.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let a=document.createElement("mas-mnemonic");a.setAttribute("content",r),a.setAttribute("placement",n);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?a.appendChild(s):o&&a.appendChild(o),this.innerHTML="",this.appendChild(a),Promise.resolve().then(()=>ft())}e.remove()})}render(){let{href:t}=this;return t?Qt`<a href="${t}">
                  <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />
              </a>`:Qt` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};l(ce,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),l(ce,"styles",hi`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",ce);var Wn=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),Qn=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var v='span[is="inline-price"][data-wcs-osi]',q='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var gi='a[is="upt-link"]',Xt=`${v},${q},${gi}`;var Zt="merch-offer-select:ready",Jt="merch-card:action-menu-toggle";var B="merch-quantity-selector:change",er="merch-card-quantity:change",xt="merch-modal:addon-and-quantity-update";var bt="merch-card-collection:literals-changed";var le="aem:load",de="aem:error",tr="mas:ready",rr="mas:error",ir="placeholder-failed",nr="placeholder-pending",ar="placeholder-resolved";var or="mas:failed",Me="mas:resolved",sr="mas/commerce";var G="failed",Q="pending",j="resolved";var Ke="X-Request-Id",Xn=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var Zn=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var We=":start",Qe=":duration";var cr="legal",lr="mas-ff-defaults";var ui="mas-commerce-service";function dr(i,t){let e;return function(){let r=this,n=arguments;clearTimeout(e),e=setTimeout(()=>i.apply(r,n),t)}}function k(i,t={},e=null,r=null){let n=r?document.createElement(i,{is:r}):document.createElement(i);e instanceof HTMLElement?n.appendChild(e):n.innerHTML=e;for(let[a,o]of Object.entries(t))n.setAttribute(a,o);return n}function pe(i){return`startTime:${i.startTime.toFixed(2)}|duration:${i.duration.toFixed(2)}`}function vt(){return window.matchMedia("(max-width: 1024px)").matches}function X(){return document.getElementsByTagName(ui)?.[0]}function ze(i){let t=window.getComputedStyle(i);return i.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var Oe,Z,Ne,Ie,he,Xe=class extends HTMLElement{constructor(){super();g(this,Oe,"");g(this,Z);g(this,Ne,[]);g(this,Ie,[]);g(this,he);p(this,he,dr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,Z)?this.parentElement.style.borderRadius=c(this,Z):c(this,Z)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=c(this,Ne).map((r,n)=>{let a=c(this,Ie)[n]||"";return`${r} ${a}`}).join(", ");return`linear-gradient(${c(this,Oe)}, ${e})`}connectedCallback(){c(this,he).call(this)}attributeChangedCallback(e,r,n){e==="border-radius"&&p(this,Z,n?.trim()),e==="colors"&&n?p(this,Ne,n?.split(",").map(a=>a.trim())??[]):e==="positions"&&n?p(this,Ie,n?.split(",").map(a=>a.trim())??[]):e==="angle"&&p(this,Oe,n?.trim()??""),c(this,he).call(this)}};Oe=new WeakMap,Z=new WeakMap,Ne=new WeakMap,Ie=new WeakMap,he=new WeakMap;customElements.define("merch-gradient",Xe);import{LitElement as fi,html as xi,css as bi}from"../lit-all.min.js";var me=class extends fi{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let a=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${t}"] ${v}[data-offer-type="${s}"]`).join(", ");return this.querySelector(a)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Me,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Me,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return xi`
            <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};l(me,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),l(me,"styles",bi`
        :host {
            --merch-addon-gap: 9px;
    ...
    `);customElements.define("merch-addon",me);import{html as Ze,nothing as vi}from"../lit-all.min.js";var ge,$e=class $e{constructor(t){l(this,"card");g(this,ge);this.card=t,this.insertVariantStyle()}getContainer(){return p(this,ge,c(this,ge)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),c(this,ge)}insertVariantStyle(){if(!$e.styleMap[this.card.variant]){$e.styleMap[this.card.variant]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(t,e){if(!t)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,n=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),a=parseInt(this.getContainer().style.getPropertyValue(r))||0;n>a&&this.getContainer().style.setProperty(r,`${n}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Ze`
            <div
                id="badge"
        ...
        `}get cardImage(){return Ze` <div class="image">
            ...
            >`:vi}get secureLabelFooter(){return Ze`<footer>${this.secureLabel}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,e=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||e===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-e-16)}px`)}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return Je(this.card.variant)}};ge=new WeakMap,l($e,"styleMap",{});var x=$e;import{html as yt,css as yi}from"../lit-all.min.js";var pr=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
            ...
            <slot></slot>`}getGlobalCSS(){return pr}setAriaExpanded(e,r){e.setAttribute("aria-expanded",r)}connectedCallbackHook(){this.card.addEventListener("mouseenter",this.showActionMenuOnHover),this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.addEventListener("focusin",this.showActionMenuOnHover),this.card.addEventListener("focusout",this.handleCardFocusOut),this.card.addEventListener("keydown",this.handleKeyDown)}disconnectedCallbackHook(){this.card.removeEventListener("mouseenter",this.showActionMenuOnHover),this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.removeEventListener("focusin",this.showActionMenuOnHover),this.card.removeEventListener("focusout",this.handleCardFocusOut),this.card.removeEventListener("keydown",this.handleKeyDown)}};l(ue,"variantStyle",yi`
    ...
    `);import{html as De}from"../lit-all.min.js";var mr=`
:root {
...
`;var et=class extends x{constructor(t){super(t)}getGlobalCSS(){return mr}renderLayout(){return De`${this.cardImage}
    <div class="body">
    ...
    ${this.evergreen?De`
          ...
          `:De`
              <hr />
              ${this.secureLabelFooter}
          `}`}};import{html as ur}from"../lit-all.min.js";var gr=`
:root {
...
`;var tt=class extends x{constructor(t){super(t)}getGlobalCSS(){return gr}renderLayout(){return ur` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":ur`<hr />`} ${this.secureLabelFooter}`}};import{html as fe,css as wi,unsafeCSS as xr}from"../lit-all.min.js";var fr=`
  :root {
...
`;var Ei=32,xe=class extends x{constructor(e){super(e);l(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);l(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?fe`<slot name="secure-transaction-label">
              <span class="secure-transaction-label"
                  >${this.card.secureLabel}</span
              ></slot
          >`:fe`<slot name="secure-transaction-label"></slot>`;return fe`<footer>${e}<slot name="footer"></slot></footer>`});this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}connectedCallbackHook(){this.card.addEventListener(B,this.updatePriceQuantity)}disconnectedCallbackHook(){this.card.removeEventListener(B,this.updatePriceQuantity)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}getGlobalCSS(){return fr}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2)return;this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".top-section"),"top-section");let e=["heading-m","body-m","heading-m-price","body-xxs","price-commitment","offers","promo-text","callout-content"];this.card.classList.contains("bullet-list")&&e.push("footer-rows"),e.forEach(n=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${n}"]`),n)),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector("footer"),"footer"),this.card.shadowRoot.querySelector(".mini-compare-chart-badge")?.textContent!==""&&this.getContainer().style.setProperty("--consonant-merch-card-mini-compare-chart-top-section-mobile-height","32px")}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.querySelector('[slot="footer-rows"] ul');!e||!e.children||[...e.children].forEach((r,n)=>{let a=Math.max(Ei,parseFloat(window.getComputedStyle(r).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(n+1)))||0;a>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(n+1),`${a}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(r=>{let n=r.querySelector(".footer-row-cell-description");n&&!n.textContent.trim()&&r.remove()})}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${v}[data-template="price"]`)}get headingMPriceSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-m-price"]')?.assignedElements()[0]}toggleAddon(e){let r=this.mainPrice,n=this.headingMPriceSlot;if(!r&&n){let a=e?.getAttribute("plan-type"),o=null;if(e&&a&&(o=e.querySelector(`p[data-plan-type="${a}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-m-price"]').forEach(s=>s.remove()),e.checked){if(o){let s=k("p",{class:"addon-heading-m-price-addon",slot:"heading-m-price"},o.innerHTML);this.card.appendChild(s)}}else{let s=k("p",{class:"card-heading",id:"free",slot:"heading-m-price"},"Free");this.card.appendChild(s)}}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;let r=this.mainPrice,n=this.card.planType;if(r&&(await r.onceSettled(),n=r.value?.[0]?.planType),!n)return;e.planType=n,this.card.querySelector("merch-addon[plan-type]")?.updateComplete.then(()=>{this.updateCardElementMinHeight(this.card.shadowRoot.querySelector('slot[name="addon"]'),"addon")})}renderLayout(){return fe` <div class="top-section${this.badge?" badge":""}">
            <slot name="icons"></slot> ${this.badge}
        </div>
        <slot name="heading-m"></slot>
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(e=>e.onceSettled())),await this.adjustAddon(),S.isMobile?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};l(xe,"variantStyle",wi`
  ...
  `);import{html as Fe,css as Si,nothing as rt}from"../lit-all.min.js";var br=`
:root {
...
`;var it={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},vr={...function(){let{whatsIncluded:i,size:t,...e}=it;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},yr={...function(){let{subtitle:i,whatsIncluded:t,size:e,quantitySelect:r,...n}=it;return n}()},C=class extends x{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,e){t.dataset.template===cr&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return br}adjustSlotPlacement(t,e,r){let n=this.card.shadowRoot,a=n.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let s=n.querySelector(`footer slot[name="${t}"]`),d=n.querySelector(`.body slot[name="${t}"]`),h=n.querySelector(".body");if(o.includes("wide")||(a?.classList.remove("wide-footer"),s&&s.remove()),!!e.includes(o)){if(a?.classList.toggle("wide-footer",S.isDesktopOrUp),!r&&s){if(d)s.remove();else{let m=h.querySelector(`[data-placeholder-for="${t}"]`);m?m.replaceWith(s):h.appendChild(s)}return}if(r&&d){let m=document.createElement("div");if(m.setAttribute("data-placeholder-for",t),m.classList.add("slot-placeholder"),!s){let f=d.cloneNode(!0);a.prepend(f)}d.replaceWith(m)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],S.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],S.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.remove("hide-tooltip")}))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let e=this.card.querySelector('[slot="body-xs"]');if(!e)return;let r=e.querySelector("ul");if(!r)return;let n=r.previousElementSibling,a=document.createElement("div");a.classList.add("spacer"),e.insertBefore(a,n);let o=new IntersectionObserver(([s])=>{if(s.boundingClientRect.height===0)return;let d=0,h=this.card.querySelector('[slot="heading-s"]');h&&(d+=ze(h));let m=this.card.querySelector('[slot="subtitle"]');m&&(d+=ze(m));let f=this.card.querySelector('[slot="heading-m"]');f&&(d+=8+ze(f));for(let se of e.childNodes){if(se.classList.contains("spacer"))break;d+=ze(se)}let _=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");d>(parseFloat(_)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${d}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${d}px`),o.disconnect()});o.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists())}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${v}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Fe`<div class="divider"></div>`:rt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],e=this.card.querySelector(`[slot="heading-m"] ${v}[data-template="price"]`);e&&t.push(e);let r=t.map(async n=>{let a=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),n.parentNode.insertBefore(a,n.nextSibling),await a.onceSettled())});await Promise.all(r)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let e=this.mainPrice;if(!e)return;await e.onceSettled();let r=e.value?.[0]?.planType;r&&(t.planType=r)}get stockCheckbox(){return this.card.checkboxLabel?Fe`<label id="stock-checkbox">
    ...
    `),l(C,"collectionOptions",{customHeaderArea:t=>t.sidenav?Fe`<slot name="resultsText"></slot>`:rt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let e=()=>{let r=t.querySelectorAll("merch-card");for(let a of r)a.hasAttribute("data-size")&&(a.setAttribute("size",a.getAttribute("data-size")),a.removeAttribute("data-size"));if(!S.isDesktop)return;let n=0;for(let a of r){if(a.style.display==="none")continue;let o=a.getAttribute("size"),s=o==="wide"?2:o==="super-wide"?3:1;s===2&&n%3===2&&(a.setAttribute("data-size",o),a.removeAttribute("size"),s=1),n+=s}};S.matchDesktop.addEventListener("change",e),t.addEventListener(bt,e),t.onUnmount.push(()=>{S.matchDesktop.removeEventListener("change",e),t.removeEventListener(bt,e)})}});import{html as wt,css as Ai}from"../lit-all.min.js";var wr=`
:root {
...
`;var be=class extends x{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return wr}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return wt` ${this.badge}
            ...
            ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook),this.card.addEventListener(B,this.updatePriceQuantity)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook),this.card.removeEventListener(B,this.updatePriceQuantity)}postCardUpdateHook(){this.card.isConnected&&(this.adjustAddon(),S.isMobile||this.adjustProductBodySlots(),this.adjustTitleWidth())}get headingXSSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-xs"]').assignedElements()[0]}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${v}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}toggleAddon(t){let e=this.mainPrice,r=this.headingXSSlot;if(!e&&r){let n=t?.getAttribute("plan-type"),a=null;if(t&&n&&(a=t.querySelector(`p[data-plan-type="${n}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-xs"]').forEach(o=>o.remove()),t.checked){if(a){let o=k("p",{class:"addon-heading-xs-price-addon",slot:"heading-xs"},a.innerHTML);this.card.appendChild(o)}}else{let o=k("p",{class:"card-heading",id:"free",slot:"heading-xs"},"Free");this.card.appendChild(o)}}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;let e=this.mainPrice,r=this.card.planType;e&&(await e.onceSettled(),r=e.value?.[0]?.planType),r&&(t.planType=r)}};l(be,"variantStyle",Ai`
...
`;var ve=class extends x{constructor(t){super(t)}getGlobalCSS(){return Er}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Et` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
    ...
    <hr />
    ${this.secureLabelFooter}`}};l(ve,"variantStyle",ki`
  ...
  `);import{html as St,css as Ci}from"../lit-all.min.js";var Sr=`
:root {
...
`;var Ar={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ye=class extends x{constructor(t){super(t)}getGlobalCSS(){return Sr}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return St`${this.cardImage}
            <div class="body">
            ...
            ${this.evergreen?St`
                  ...
                  `:St`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};l(ye,"variantStyle",Ci`
    ...
    `);import{html as Ti,css as _i}from"../lit-all.min.js";var kr=`
:root {
...
`;var At={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},we=class extends x{getGlobalCSS(){return kr}get aemFragmentMapping(){return At}get headingSelector(){return'[slot="heading-xs"]'}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.querySelector('[slot="body-xs"]');t&&this.updateCardElementMinHeight(t,"description");let e=this.card.querySelector('[slot="price"]');e&&this.updateCardElementMinHeight(e,"price")}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length&&await Promise.all(this.card.prices.map(t=>t.onceSettled?.())),Re())){let t=this.getContainer();if(!t)return;let e=`--consonant-merch-card-${this.card.variant}`,r=t.style.getPropertyValue(`${e}-description-height`);requestAnimationFrame(r?()=>{this.syncHeights()}:()=>{t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(a=>a.variantLayout?.syncHeights?.())})}}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!Re()&&this.card.setAttribute("data-expanded","true"))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(Re())t.removeAttribute("data-expanded");else{let n=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",n?"true":"false")}};e();let r=window.matchMedia(R);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(R).removeEventListener("change",this.mediaQueryListener)}handleChevronClick(t){t.preventDefault(),t.stopPropagation();let e=this.card;if(!e||Re())return;let a=e.getAttribute("data-expanded")==="true"?"false":"true";e.setAttribute("data-expanded",a)}renderLayout(){return Ti`
    ...
    `);import{html as Li,css as Pi}from"../lit-all.min.js";var Cr=`
:root {
...
`;var kt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"l"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:[]},Ee=class extends x{getGlobalCSS(){return Cr}get aemFragmentMapping(){return kt}get headingSelector(){return'[slot="heading-xs"]'}syncHeights(){if(this.card.getBoundingClientRect().width<=2)return;let t=this.card.querySelector('[slot="short-description"]');t&&this.updateCardElementMinHeight(t,"short-description");let e=this.card.querySelector('[slot="price"]');e&&this.updateCardElementMinHeight(e,"price");let r=this.card.querySelector('[slot="cta"]');r&&this.updateCardElementMinHeight(r,"cta")}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,await Promise.all(this.card.prices.map(t=>t.onceSettled())),window.matchMedia("(min-width: 1025px)").matches)){let t=this.getContainer();if(!t)return;let e=`--consonant-merch-card-${this.card.variant}`,r=t.style.getPropertyValue(`${e}-price-height`);requestAnimationFrame(r?()=>{this.syncHeights()}:()=>{t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(a=>a.variantLayout?.syncHeights?.())})}}renderLayout(){return Li`
            <div class="badge-wrapper">
                <slot name="badge"></slot>
            </div>
            <div class="card-content">
    ...
    `);import{css as Ri,html as Mi}from"../lit-all.min.js";var Tr=`
...
`;var _r={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Se=class extends x{constructor(){super(...arguments);l(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Tr}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${v}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return Mi`
            ${this.badge}
            <div class="body">
    ...
    `);var nt=new Map,A=(i,t,e=null,r=null,n)=>{nt.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:n})};A("catalog",ue,hr,ue.variantStyle);A("image",et);A("inline-heading",tt);A("mini-compare-chart",xe,null,xe.variantStyle);A("plans",C,it,C.variantStyle,C.collectionOptions);A("plans-students",C,yr,C.variantStyle,C.collectionOptions);A("plans-education",C,vr,C.variantStyle,C.collectionOptions);A("product",be,null,be.variantStyle);A("segment",ve,null,ve.variantStyle);A("special-offers",ye,Ar,ye.variantStyle);A("simplified-pricing-express",we,At,we.variantStyle);A("full-pricing-express",Ee,kt,Ee.variantStyle);A("mini",Se,_r,Se.variantStyle);var Ct=i=>{let t=nt.get(i.variant);if(!t)return;let{class:e,style:r}=t;if(r)try{let n=new CSSStyleSheet;n.replaceSync(r.cssText),i.shadowRoot.adoptedStyleSheets.push(n)}catch{let a=document.createElement("style");a.textContent=r.cssText,i.shadowRoot.appendChild(a)}return new e(i)};function Je(i){return nt.get(i)?.fragmentMapping}function Lr(i){return nt.get(i)?.collectionOptions}var Pr=document.createElement("style");Pr.innerHTML=`
:root {
...
`;document.head.appendChild(Pr);function at(i,t={},{metadata:e=!0,search:r=!0,storage:n=!0}={}){let a;if(r&&a==null){let o=new URLSearchParams(window.location.search),s=Tt(r)?r:i;a=o.get(s)}if(n&&a==null){let o=Tt(n)?n:i;a=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&a==null){let o=Oi(Tt(e)?e:i);a=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return a??t[i]}var zi=i=>typeof i=="boolean",ot=i=>typeof i=="function";var Tt=i=>typeof i=="string";function Rr(i,t){if(zi(i))return i;let e=String(i);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function Oi(i=""){return String(i).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var J=class i extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let n=e.response.headers?.get(Ke);n&&(e.requestId=n),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,i)}toString(){let t=Object.entries(this.context||{}).map(([r,n])=>`${r}: ${JSON.stringify(n)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var Ni="mas-commerce-service",Ii={requestId:Ke,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var st=i=>window.setTimeout(i);function _t(){return document.getElementsByTagName(Ni)?.[0]}function Mr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,n]of Object.entries(Ii)){let a=e.get(n);a&&(a=a.replace(/[,;]/g,"|"),a=a.replace(/[| ]+/g,"|"),t[r]=a)}return t}async function zr(i,t={},e=2,r=100){let n;for(let a=0;a<=e;a++)try{let o=await fetch(i,t);return o.retryCount=a,o}catch(o){if(n=o,n.retryCount=a,a>e)break;await new Promise(s=>setTimeout(s,r*(a+1)))}throw n}var Or="fragment",Nr="author",Ir="preview",$r="loading",Dr="timeout",Lt="aem-fragment",Fr="eager",Br="cache",$i=[Fr,Br],$,ee,O,Pt=class{constructor(){g(this,$,new Map);g(this,ee,new Map);g(this,O,new Map)}clear(){c(this,$).clear(),c(this,ee).clear(),c(this,O).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,$).set(t.id,t),t.fields?.originalId&&c(this,$).set(t.fields.originalId,t),c(this,O).has(t.id)){let[,r]=c(this,O).get(t.id);r()}if(c(this,O).has(t.fields?.originalId)){let[,r]=c(this,O).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:n,value:a}=t.references[r];n==="content-fragment"&&(a.settings={...t?.settings,...a.settings},a.placeholders={...t?.placeholders,...a.placeholders},a.dictionary={...t?.dictionary,...a.dictionary},a.priceLiterals={...t?.priceLiterals,...a.priceLiterals},this.add(a,t))}}}has(t){return c(this,$).has(t)}entries(){return c(this,$).entries()}get(t){return c(this,$).get(t)}getAsPromise(t){let[e]=c(this,O).get(t)??[];if(e)return e;let r;return e=new Promise(n=>{r=n,this.has(t)&&n()}),c(this,O).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,ee).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,ee).set(t,e)),e}remove(t){c(this,$).delete(t),c(this,ee).delete(t),c(this,O).delete(t)}};$=new WeakMap,ee=new WeakMap,O=new WeakMap;var V=new Pt,Ae,D,H,M,T,y,Be,He,N,Ue,qe,ke,I,Hr,Ur,Rt,qr,ct=class extends HTMLElement{constructor(){super(...arguments);g(this,I);l(this,"cache",V);g(this,Ae);g(this,D,null);g(this,H,null);g(this,M,null);g(this,T);g(this,y);g(this,Be,Fr);g(this,He,5e3);g(this,N);g(this,Ue,!1);g(this,qe,0);g(this,ke)}static get observedAttributes(){return[Or,$r,Dr,Nr,Ir]}attributeChangedCallback(e,r,n){e===Or&&(p(this,T,n),p(this,y,V.getFetchInfo(n))),e===$r&&$i.includes(n)&&p(this,Be,n),e===Dr&&p(this,He,parseInt(n,10)),e===Nr&&p(this,Ue,["","true"].includes(n)),e===Ir&&p(this,ke,n)}connectedCallback(){if(!c(this,N)){if(c(this,M)??p(this,M,X(this)),p(this,ke,c(this,M).settings?.preview),c(this,Ae)??p(this,Ae,c(this,M).log.module(`${Lt}[${c(this,T)}]`)),!c(this,T)||c(this,T)==="#"){c(this,y)??p(this,y,V.getFetchInfo("missing-fragment-id")),E(this,I,Rt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,y)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,N)&&!await Promise.race([c(this,N),Promise.resolve(!1)]))return;e&&V.remove(c(this,T)),c(this,Be)===Br&&await Promise.race([V.getAsPromise(c(this,T)),new Promise(s=>setTimeout(s,c(this,He)))]);try{p(this,N,E(this,I,qr).call(this)),await c(this,N)}catch(s){return E(this,I,Rt).call(this,s.message),!1}let{references:r,referencesTree:n,placeholders:a,wcs:o}=c(this,D)||{};return o&&!at("mas.disableWcsCache")&&c(this,M).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(le,{detail:{...this.data,references:r,referencesTree:n,placeholders:a,...c(this,y)},bubbles:!0,composed:!0})),c(this,N)}get updateComplete(){return c(this,N)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,H)?c(this,H):(c(this,Ue)?this.transformAuthorData():this.transformPublishData(),c(this,H))}transformAuthorData(){let{fields:e,id:r,tags:n,settings:a={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,D);p(this,H,e.reduce((h,{name:m,multiple:f,values:_})=>(h.fields[m]=f?_:_[0],h),{fields:{},id:r,tags:n,settings:a,priceLiterals:o,dictionary:s,placeholders:d}))}transformPublishData(){let{fields:e,id:r,tags:n,settings:a={},priceLiterals:o={},dictionary:s={},placeholders:d={}}=c(this,D);p(this,H,Object.entries(e).reduce((h,[m,f])=>(h.fields[m]=f?.mimeType?f.value:f??"",h),{fields:{},id:r,tags:n,settings:a,priceLiterals:o,dictionary:s,placeholders:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let n=r.trim().toLowerCase();if(n==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:a}=window.location,o=a.endsWith(".page")?"page":"live";return n.includes("--")?`https://${n}.aem.${o}/studio/libs/fragment-client.js`:`https://${n}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,T),{locale:c(this,M).settings.locale,apiKey:c(this,M).settings.wcsApiKey})}};Ae=new WeakMap,D=new WeakMap,H=new WeakMap,M=new WeakMap,T=new WeakMap,y=new WeakMap,Be=new WeakMap,He=new WeakMap,N=new WeakMap,Ue=new WeakMap,qe=new WeakMap,ke=new WeakMap,I=new WeakSet,Hr=async function(e){Gt(this,qe)._++;let r=`${Lt}:${c(this,T)}:${c(this,qe)}`,n=`${r}${We}`,a=`${r}${Qe}`;if(c(this,ke))return await this.generatePreview();performance.mark(n);let o;try{if(c(this,y).stale=!1,c(this,y).url=e,o=await zr(e,{cache:"default",credentials:"omit"}),E(this,I,Ur).call(this,o),c(this,y).status=o?.status,c(this,y).measure=pe(performance.measure(a,n)),c(this,y).retryCount=o.retryCount,!o?.ok)throw new J("Unexpected fragment response",{response:o,...c(this,M).duration});return await o.json()}catch(s){if(c(this,y).measure=pe(performance.measure(a,n)),c(this,y).retryCount=s.retryCount,c(this,D))return c(this,y).stale=!0,c(this,Ae).error("Serving stale data",c(this,y)),c(this,D);let d=s.message??"unknown";throw new J(`Failed to fetch fragment: ${d}`,{})}},Ur=function(e){Object.assign(c(this,y),Mr(e))},Rt=function(e){p(this,N,null),c(this,y).message=e,this.classList.add("error");let r={...c(this,y),...c(this,M).duration};c(this,Ae).error(e,r),this.dispatchEvent(new CustomEvent(de,{detail:r,bubbles:!0,composed:!0}))},qr=async function(){var d;this.classList.remove("error"),p(this,H,null);let e=V.get(c(this,T));if(e)return p(this,D,e),!0;let{masIOUrl:r,wcsApiKey:n,country:a,locale:o}=c(this,M).settings,s=`${r}/fragment?id=${c(this,T)}&api_key=${n}&locale=${o}`;return a&&!o.endsWith(`_${a}`)&&(s+=`&country=${a}`),e=await E(this,I,Hr).call(this,s),(d=e.fields).originalId??(d.originalId=c(this,T)),V.add(e),p(this,D,e),!0},l(ct,"cache",V);customElements.define(Lt,ct);import{LitElement as Di,html as Fi,css as Bi}from"../lit-all.min.js";var Ce=class extends Di{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return Fi`<div class="badge">
            ${this.text}
        </div>`}};l(Ce,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"}}),l(Ce,"styles",Bi`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",Ce);import{html as Hi,css as Ui,LitElement as qi}from"../lit-all.min.js";var Ge=class extends qi{constructor(){super()}render(){return Hi`
            <slot name="icon"></slot>
    ...
    `),l(Ge,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Ge);import{html as Mt,css as Gi,LitElement as ji}from"../lit-all.min.js";var je=class extends ji{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Mt`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${this.isMobile&&this.rows.length>this.mobileRows?Mt`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Mt``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};l(je,"styles",Gi`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),l(je,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",je);var te={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,tags:"acom",isProdDomain:!1},Gr=1e3;function Vi(i){return i instanceof Error||typeof i?.originatingRequest=="string"}function jr(i){if(i==null)return;let t=typeof i;if(t==="function")return i.name?`function ${i.name}`:"function";if(t==="object"){if(i instanceof Error)return i.message;if(typeof i.originatingRequest=="string"){let{message:r,originatingRequest:n,status:a}=i;return[r,a,n].filter(Boolean).join(" ")}let e=i[Symbol.toStringTag]??Object.getPrototypeOf(i).constructor.name;if(!te.serializableTypes.includes(e))return e}return i}function Yi(i,t){if(!te.ignoredProperties.includes(i))return jr(t)}var zt={append(i){if(i.level!=="error")return;let{message:t,params:e}=i,r=[],n=[],a=t;e.forEach(h=>{h!=null&&(Vi(h)?r:n).push(h)}),r.length&&(a+=" "+r.map(jr).join(" "));let{pathname:o,search:s}=window.location,d=`${te.delimiter}page=${o}${s}`;d.length>Gr&&(d=`${d.slice(0,Gr)}<trunc>`),a+=d,n.length&&(a+=`${te.delimiter}facts=`,a+=JSON.stringify(n,Yi)),window.lana?.log(a,te)}};function Vr(i){Object.assign(te,Object.fromEntries(Object.entries(i).filter(([t,e])=>t in te&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Yr={LOCAL:"local",PROD:"prod",STAGE:"stage"},Ot={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Nt=new Set,It=new Set,Kr=new Map,Wr={append({level:i,message:t,params:e,timestamp:r,source:n}){console[i](`${r}ms [${n}] %c${t}`,"font-weight: bold;",...e)}},Qr={filter:({level:i})=>i!==Ot.DEBUG},Ki={filter:()=>!1};function Wi(i,t,e,r,n){return{level:i,message:t,namespace:e,get params(){return r.length===1&&ot(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:n,timestamp:performance.now().toFixed(3)}}function Qi(i){[...It].every(t=>t(i))&&Nt.forEach(t=>t(i))}function Xr(i){let t=(Kr.get(i)??0)+1;Kr.set(i,t);let e=`${i} #${t}`,r={id:e,namespace:i,module:n=>Xr(`${r.namespace}/${n}`),updateConfig:Vr};return Object.values(Ot).forEach(n=>{r[n]=(a,...o)=>Qi(Wi(n,a,i,o,e))}),Object.seal(r)}function lt(...i){i.forEach(t=>{let{append:e,filter:r}=t;ot(r)&&It.add(r),ot(e)&&Nt.add(e)})}function Xi(i={}){let{name:t}=i,e=Rr(at("commerce.debug",{search:!0,storage:!0}),t===Yr.LOCAL);return lt(e?Wr:Qr),t===Yr.PROD&&lt(zt),$t}function Zi(){Nt.clear(),It.clear()}var $t={...Xr(sr),Level:Ot,Plugins:{consoleAppender:Wr,debugFilter:Qr,quietFilter:Ki,lanaAppender:zt},init:Xi,reset:Zi,use:lt};var Ji={[G]:ir,[Q]:nr,[j]:ar},en={[G]:or,[j]:Me},Ve,dt=class{constructor(t){g(this,Ve);l(this,"changes",new Map);l(this,"connected",!1);l(this,"error");l(this,"log");l(this,"options");l(this,"promises",[]);l(this,"state",Q);l(this,"timer",null);l(this,"value");l(this,"version",0);l(this,"wrapperElement");this.wrapperElement=t,this.log=$t.module("mas-element")}update(){[G,Q,j].forEach(t=>{this.wrapperElement.classList.toggle(Ji[t],t===this.state)})}notify(){(this.state===j||this.state===G)&&(this.state===j?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===G&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let t=this.error;this.error instanceof J&&(t={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(en[this.state],{bubbles:!0,detail:t}))}attributeChangedCallback(t,e,r){this.changes.set(t,r),this.requestUpdate()}connectedCallback(){p(this,Ve,_t()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:t,promises:e,state:r}=this;return j===r?Promise.resolve(this.wrapperElement):G===r?Promise.reject(t):new Promise((n,a)=>{e.push({resolve:n,reject:a})})}toggleResolved(t,e,r){return t!==this.version?!1:(r!==void 0&&(this.options=r),this.state=j,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),st(()=>this.notify()),!0)}toggleFailed(t,e,r){if(t!==this.version)return!1;r!==void 0&&(this.options=r),this.error=e,this.state=G,this.update();let n=this.wrapperElement.getAttribute("is");return this.log?.error(`${n}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...c(this,Ve)?.duration}),st(()=>this.notify()),!0}togglePending(t){return this.version++,t&&(this.options=t),this.state=Q,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!_t()||this.timer)return;let{error:e,options:r,state:n,value:a,version:o}=this;this.state=Q,this.timer=st(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||t)try{await this.wrapperElement.render?.()===!1&&this.state===Q&&this.version===o&&(this.state=n,this.error=e,this.value=a,this.update(),this.notify())}catch(d){this.toggleFailed(this.version,d,r)}})}};Ve=new WeakMap;function tn(i){return`https://${i==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var ie,re=class re extends HTMLAnchorElement{constructor(){super();l(this,"masElement",new dt(this));g(this,ie);this.setAttribute("is",re.is)}get isUptLink(){return!0}initializeWcsData(e,r){this.setAttribute("data-wcs-osi",e),r&&this.setAttribute("data-promotion-code",r)}attributeChangedCallback(e,r,n){this.masElement.attributeChangedCallback(e,r,n)}connectedCallback(){this.masElement.connectedCallback(),p(this,ie,X()),c(this,ie)&&(this.log=c(this,ie).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),p(this,ie,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=X();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let r=e.collectCheckoutOptions({},this);if(!r.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let n=this.masElement.togglePending(r),a=e.resolveOfferSelectors(r);try{let[[o]]=await Promise.all(a),{country:s,language:d,env:h}=r,m=`locale=${d}_${s}&country=${s}&offer_id=${o.offerId}`,f=this.getAttribute("data-promotion-code");f&&(m+=`&promotion_code=${encodeURIComponent(f)}`),this.href=`${tn(h)}?${m}`,this.masElement.toggleResolved(n,o,r)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${r.wcsOsi}.`,o.message);return this.masElement.toggleFailed(n,s,r),!1}}static createFrom(e){let r=new re;for(let n of e.attributes)n.name!=="is"&&(n.name==="class"&&n.value.includes("upt-link")?r.setAttribute("class",n.value.replace("upt-link","").trim()):r.setAttribute(n.name,n.value));return r.innerHTML=e.innerHTML,r.setAttribute("tabindex",0),r}};ie=new WeakMap,l(re,"is","upt-link"),l(re,"tag","a"),l(re,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var Y=re;window.customElements.get(Y.is)||window.customElements.define(Y.is,Y,{extends:Y.tag});var rn="#000000",Dt="#F8D904",nn="#EAEAEA",an="#31A547",on=/(accent|primary|secondary)(-(outline|link))?/,sn="mas:product_code/",cn="daa-ll",pt="daa-lh",ln=["XL","L","M","S"],Ft="...";function z(i,t,e,r){let n=r[i];if(t[i]&&n){let a={slot:n?.slot,...n?.attributes},o=t[i];if(n.maxCount&&typeof o=="string"){let[d,h]=Cn(o,n.maxCount,n.withSuffix);d!==o&&(a.title=h,o=d)}let s=k(n.tag,a,o);e.append(s)}}function dn(i,t,e){let r=i.mnemonicIcon?.map((a,o)=>({icon:a,alt:i.mnemonicAlt[o]??"",link:i.mnemonicLink[o]??""}));r?.forEach(({icon:a,alt:o,link:s})=>{if(s&&!/^https?:/.test(s))try{s=new URL(`https://${s}`).href.toString()}catch{s="#"}let d={slot:"icons",src:a,loading:t.loading,size:e?.size??"l"};o&&(d.alt=o),s&&(d.href=s);let h=k("merch-icon",d);t.append(h)});let n=t.shadowRoot.querySelector('slot[name="icons"]');n&&(n.style.display=r?.length?null:"none")}function pn(i,t,e){if(e.badge?.slot){if(i.badge?.length&&!i.badge?.startsWith("<merch-badge")){let r=Dt,n=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(r=e.badge?.default,i.borderColor||(n=!0));let a=i.badgeBackgroundColor||r,o=i.borderColor||"";n&&(o=e.badge?.default,i.borderColor=e.badge?.default),i.badge=`<merch-badge variant="${i.variant}" background-color="${a}" border-color="${o}">${i.badge}</merch-badge>`}z("badge",i,t,e)}else i.badge?(t.setAttribute("badge-text",i.badge),e.disabledAttributes?.includes("badgeColor")||t.setAttribute("badge-color",i.badgeColor||rn),e.disabledAttributes?.includes("badgeBackgroundColor")||t.setAttribute("badge-background-color",i.badgeBackgroundColor||Dt),t.setAttribute("border-color",i.badgeBackgroundColor||Dt)):t.setAttribute("border-color",i.borderColor||nn)}function hn(i,t,e){if(e.trialBadge&&i.trialBadge){if(!i.trialBadge.startsWith("<merch-badge")){let r=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&i.trialBadgeBorderColor||an;i.trialBadge=`<merch-badge variant="${i.variant}" border-color="${r}">${i.trialBadge}</merch-badge>`}z("trialBadge",i,t,e)}}function mn(i,t,e){e?.includes(i.size)&&t.setAttribute("size",i.size)}function gn(i,t){i.cardName&&t.setAttribute("name",i.cardName)}function un(i,t,e){i.cardTitle&&(i.cardTitle=Te(i.cardTitle)),z("cardTitle",i,t,{cardTitle:e})}function fn(i,t,e){z("subtitle",i,t,e)}function xn(i,t,e,r){if(!i.backgroundColor||i.backgroundColor.toLowerCase()==="default"){t.style.removeProperty("--merch-card-custom-background-color"),t.removeAttribute("background-color");return}e?.[i.backgroundColor]?(t.style.setProperty("--merch-card-custom-background-color",`var(${e[i.backgroundColor]})`),t.setAttribute("background-color",i.backgroundColor)):r?.attribute&&i.backgroundColor&&(t.setAttribute(r.attribute,i.backgroundColor),t.style.removeProperty("--merch-card-custom-background-color"))}function bn(i,t,e){let r=e?.borderColor,n="--consonant-merch-card-border-color";if(i.borderColor?.toLowerCase()==="transparent")t.style.setProperty(n,"transparent");else if(i.borderColor&&r)if(r?.specialValues?.[i.borderColor]?.includes("gradient")||/-gradient/.test(i.borderColor)){t.setAttribute("gradient-border","true");let s=i.borderColor;if(r?.specialValues){for(let[d,h]of Object.entries(r.specialValues))if(h===i.borderColor){s=d;break}}t.setAttribute("border-color",s),t.style.removeProperty(n)}else t.style.setProperty(n,`var(--${i.borderColor})`)}function vn(i,t,e){if(i.backgroundImage){let r={loading:t.loading??"lazy",src:i.backgroundImage};if(i.backgroundImageAltText?r.alt=i.backgroundImageAltText:r.role="none",!e)return;if(e?.attribute){t.setAttribute(e.attribute,i.backgroundImage);return}t.append(k(e.tag,{slot:e.slot},k("img",r)))}}function Te(i){return!i||typeof i!="string"||i.includes("<mas-mnemonic")&&Promise.resolve().then(()=>(ft(),ut)).catch(console.error),i}function yn(i,t,e){i.prices&&(i.prices=Te(i.prices)),z("prices",i,t,e)}function Jr(i,t,e){let r=i.hasAttribute("data-wcs-osi")&&!!i.getAttribute("data-wcs-osi"),n=i.className||"",a=on.exec(n)?.[0]??"accent",o=a.includes("accent"),s=a.includes("primary"),d=a.includes("secondary"),h=a.includes("-outline"),m=a.includes("-link");i.classList.remove("accent","primary","secondary");let f;if(t.consonant)f=Pn(i,o,r,m,s);else if(m)f=i;else{let _;o?_="accent":s?_="primary":d&&(_="secondary"),f=t.spectrum==="swc"?Ln(i,e,h,_,r):_n(i,e,h,_,r)}return f}function wn(i,t){let{slot:e}=t?.description,r=i.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);r.length&&r.forEach(n=>{let a=Jr(n,i,t);n.replaceWith(a)})}function En(i,t,e){i.description&&(i.description=Te(i.description)),i.promoText&&(i.promoText=Te(i.promoText)),i.shortDescription&&(i.shortDescription=Te(i.shortDescription)),z("promoText",i,t,e),z("description",i,t,e),z("shortDescription",i,t,e),i.shortDescription&&(t.setAttribute("action-menu","true"),i.actionMenuLabel||t.setAttribute("action-menu-label","More options")),wn(t,e),z("callout",i,t,e),z("quantitySelect",i,t,e),z("whatsIncluded",i,t,e)}function Sn(i,t,e){if(!e.addon)return;let r=i.addon?.replace(/[{}]/g,"");if(!r||/disabled/.test(r))return;let n=k("merch-addon",{slot:"addon"},r);[...n.querySelectorAll(v)].forEach(a=>{let o=a.parentElement;o?.nodeName==="P"&&o.setAttribute("data-plan-type","")}),t.append(n)}function An(i,t,e){i.addonConfirmation&&z("addonConfirmation",i,t,e)}function kn(i,t,e,r){r?.secureLabel&&e?.secureLabel&&t.setAttribute("secure-label",r.secureLabel)}function Cn(i,t,e=!0){try{let r=typeof i!="string"?"":i,n=Zr(r);if(n.length<=t)return[r,n];let a=0,o=!1,s=e?t-Ft.length<1?1:t-Ft.length:t,d=[];for(let f of r){if(a++,f==="<")if(o=!0,r[a]==="/")d.pop();else{let _="";for(let se of r.substring(a)){if(se===" "||se===">")break;_+=se}d.push(_)}if(f==="/"&&r[a]===">"&&d.pop(),f===">"){o=!1;continue}if(!o&&(s--,s===0))break}let h=r.substring(0,a).trim();if(d.length>0){d[0]==="p"&&d.shift();for(let f of d.reverse())h+=`</${f}>`}return[`${h}${e?Ft:""}`,n]}catch{let n=typeof i=="string"?i:"",a=Zr(n);return[n,a]}}function Zr(i){if(!i)return"";let t="",e=!1;for(let r of i){if(r==="<"&&(e=!0),r===">"){e=!1;continue}e||(t+=r)}return t}function Tn(i,t){t.querySelectorAll("a.upt-link").forEach(r=>{let n=Y.createFrom(r);r.replaceWith(n),n.initializeWcsData(i.osi,i.promoCode)})}function _n(i,t,e,r,n){let a=i;n?a=customElements.get("checkout-button").createCheckoutButton({},i.innerHTML):a.innerHTML=`<span>${a.textContent}</span>`,a.setAttribute("tabindex",0);for(let m of i.attributes)["class","is"].includes(m.name)||a.setAttribute(m.name,m.value);a.firstElementChild?.classList.add("spectrum-Button-label");let o=t?.ctas?.size??"M",s=`spectrum-Button--${r}`,d=ln.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",h=["spectrum-Button",s,d];return e&&h.push("spectrum-Button--outline"),a.classList.add(...h),a}function Ln(i,t,e,r,n){let a=i;n&&(a=customElements.get("checkout-button").createCheckoutButton(i.dataset),a.connectedCallback(),a.render());let o="fill";e&&(o="outline");let s=k("sp-button",{treatment:o,variant:r,tabIndex:0,size:t?.ctas?.size??"m",...i.dataset.analyticsId&&{"data-analytics-id":i.dataset.analyticsId}},i.innerHTML);return s.source=a,(n?a.onceSettled():Promise.resolve(a)).then(d=>{s.setAttribute("data-navigation-url",d.href)}),s.addEventListener("click",d=>{d.defaultPrevented||a.click()}),s}function Pn(i,t,e,r,n){let a=i;return e&&(a=customElements.get("checkout-link").createCheckoutLink(i.dataset,i.innerHTML)),r||(a.classList.add("button","con-button"),t&&a.classList.add("blue"),n&&a.classList.add("primary")),a}function Rn(i,t,e,r){if(i.ctas){i.ctas=Te(i.ctas);let{slot:n}=e.ctas,a=k("div",{slot:n},i.ctas),o=[...a.querySelectorAll("a")].map(s=>Jr(s,t,e));a.innerHTML="",a.append(...o),t.append(a)}}function Mn(i,t){let{tags:e}=i,r=e?.find(a=>a.startsWith(sn))?.split("/").pop();if(!r)return;t.setAttribute(pt,r),[...t.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((a,o)=>{a.setAttribute(cn,`${a.dataset.analyticsId}-${o+1}`)})}function zn(i){i.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,e])=>{i.querySelectorAll(`a.${t}`).forEach(r=>{r.classList.remove(t),r.classList.add("spectrum-Link",`spectrum-Link--${e}`)})})}function On(i){i.querySelectorAll("[slot]").forEach(r=>{r.remove()}),i.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","badge-background-color","badge-color","badge-text","gradient-border","size",pt].forEach(r=>i.removeAttribute(r));let e=["wide-strip","thin-strip"];i.classList.remove(...e)}async function ei(i,t){if(!i){let d=t?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${d}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${d}).`)}if(!i.fields){let d=i.id||"unknown",h=t?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${d}' (merchCard id: ${h}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${d}' (merchCard id: ${h}) is missing 'fields'.`)}let{id:e,fields:r,settings:n={},priceLiterals:a}=i,{variant:o}=r;if(!o)throw new Error(`hydrate: no variant found in payload ${e}`);On(t),t.settings=n,a&&(t.priceLiterals=a),t.id??(t.id=i.id),t.variant=o,await t.updateComplete;let{aemFragmentMapping:s}=t.variantLayout;if(!s)throw new Error(`hydrate: variant mapping not found for ${e}`);s.style==="consonant"&&t.setAttribute("consonant",!0),dn(r,t,s.mnemonics),pn(r,t,s),hn(r,t,s),mn(r,t,s.size),gn(r,t),un(r,t,s.title),fn(r,t,s),yn(r,t,s),vn(r,t,s.backgroundImage),xn(r,t,s.allowedColors,s.backgroundColor),bn(r,t,s),En(r,t,s),Sn(r,t,s),An(r,t,s),kn(r,t,s,n),Tn(r,t),Rn(r,t,s,o),Mn(r,t),zn(t)}var Ht="merch-card",Bt=2e4,ti="merch-card:",In=["full-pricing-express","simplified-pricing-express"];function ri(i,t){let e=i.closest(Ht);if(!e)return t;e.priceLiterals&&(t.literals??(t.literals={}),Object.assign(t.literals,e.priceLiterals)),e.aemFragment&&(t[lr]=!0),e.variantLayout?.priceOptionsProvider?.(i,t)}function $n(i){i.providers.has(ri)||i.providers.price(ri)}var ii=new IntersectionObserver(i=>{i.forEach(t=>{t.target.clientHeight!==0&&(ii.unobserve(t.target),t.target.requestUpdate())})}),Dn=0,_e,Le,Pe,U,ae,F,oe,w,ne,ht,ni,mt,K=class extends Nn{constructor(){super();g(this,w);g(this,_e);g(this,Le);g(this,Pe);g(this,U);g(this,ae);g(this,F);g(this,oe,new Promise(e=>{p(this,F,e)}));l(this,"customerSegment");l(this,"marketSegment");l(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}firstUpdated(){this.variantLayout=Ct(this),this.variantLayout?.connectedCallbackHook()}willUpdate(e){(e.has("variant")||!this.variantLayout)&&(this.variantLayout=Ct(this),this.variantLayout?.connectedCallbackHook())}updated(e){(e.has("badgeBackgroundColor")||e.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border",this.computedBorderStyle),e.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(e)}catch(r){E(this,w,ne).call(this,`Error in postCardUpdateHook: ${r.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["ccd-slice","ccd-suggested","ah-promoted-plans","simplified-pricing-express","full-pricing-express"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector(v)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(q)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(q)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(q)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:e}){if(!this.stockOfferOsis)return;let r=this.checkoutLinks;if(r.length!==0)for(let n of r){await n.onceSettled();let a=n.value?.[0]?.planType;if(!a)return;let o=this.stockOfferOsis[a];if(!o)return;let s=n.dataset.wcsOsi.split(",").filter(d=>d!==o);e.checked&&s.push(o),n.dataset.wcsOsi=s.join(",")}}changeHandler(e){e.target.tagName==="MERCH-ADDON"&&this.toggleAddon(e.target)}toggleAddon(e){this.variantLayout?.toggleAddon?.(e);let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length===0)return;let n=a=>{let{offerType:o,planType:s}=a.value?.[0]??{};if(!o||!s)return;let d=e.getOsi(s,o),h=(a.dataset.wcsOsi||"").split(",").filter(m=>m&&m!==d);e.checked&&h.push(d),a.dataset.wcsOsi=h.join(",")};r.forEach(n)}handleQuantitySelection(e){let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length!==0)for(let n of r)n.dataset.quantity=e.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(e){let r={...this.filters};Object.keys(r).forEach(n=>{if(e){r[n].order=Math.min(r[n].order||2,2);return}let a=r[n].order;a===1||isNaN(a)||(r[n].order=Number(a)+1)}),this.filters=r}includes(e){return this.textContent.match(new RegExp(e,"i"))!==null}connectedCallback(){var r;super.connectedCallback(),c(this,Le)||p(this,Le,Dn++),this.aemFragment||((r=c(this,F))==null||r.call(this),p(this,F,void 0)),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let e=this.id??c(this,Le);p(this,ae,`${ti}${e}${We}`),p(this,_e,`${ti}${e}${Qe}`),performance.mark(c(this,ae)),p(this,U,X()),$n(c(this,U)),p(this,Pe,c(this,U).Log.module(Ht)),this.addEventListener(B,this.handleQuantitySelection),this.addEventListener(xt,this.handleAddonAndQuantityUpdate),this.addEventListener(Zt,this.handleMerchOfferSelectReady),this.addEventListener(de,this.handleAemFragmentEvents),this.addEventListener(le,this.handleAemFragmentEvents),this.addEventListener("change",this.changeHandler),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(B,this.handleQuantitySelection),this.removeEventListener(de,this.handleAemFragmentEvents),this.removeEventListener(le,this.handleAemFragmentEvents),this.removeEventListener("change",this.changeHandler),this.removeEventListener(xt,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(e){var r;if(this.isConnected&&(e.type===de&&E(this,w,ne).call(this,"AEM fragment cannot be loaded"),e.type===le&&(this.failed=!1,e.target.nodeName==="AEM-FRAGMENT"))){let n=e.detail;try{c(this,F)||p(this,oe,new Promise(a=>{p(this,F,a)})),ei(n,this)}catch(a){E(this,w,ne).call(this,`hydration has failed: ${a.message}`)}finally{(r=c(this,F))==null||r.call(this),p(this,F,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected)return;c(this,oe)&&(await c(this,oe),In.includes(this.variantLayout)&&ii.observe(this),p(this,oe,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let e=new Promise(o=>setTimeout(()=>o("timeout"),Bt));if(this.aemFragment){let o=await Promise.race([this.aemFragment.updateComplete,e]);if(o===!1||o==="timeout"){let s=o==="timeout"?`AEM fragment was not resolved within ${Bt} timeout`:"AEM fragment cannot be loaded";E(this,w,ne).call(this,s,{},!1);return}}let r=[...this.querySelectorAll(Xt)],n=Promise.all(r.map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(s=>s.classList.contains("placeholder-resolved"))),a=await Promise.race([n,e]);if(a===!0){this.measure=performance.measure(c(this,_e),c(this,ae));let o={...this.aemFragment?.fetchInfo,...c(this,U).duration,measure:pe(this.measure)};return this.dispatchEvent(new CustomEvent(tr,{bubbles:!0,composed:!0,detail:o})),this}else{this.measure=performance.measure(c(this,_e),c(this,ae));let o={measure:pe(this.measure),...c(this,U).duration};a==="timeout"?E(this,w,ne).call(this,`Contains offers that were not resolved within ${Bt} timeout`,o):E(this,w,ne).call(this,"Contains unresolved offers",o)}}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let e=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(q)).length===2&&e&&e.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:e,items:r}}){if(!e||!r?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let a=this.checkoutLinks.find(m=>m.getAttribute("data-modal-id")===e);if(!a)return;let s=new URL(a.getAttribute("href")).searchParams.get("pa"),d=r.find(m=>m.productArrangementCode===s)?.quantity,h=!!r.find(m=>m.productArrangementCode!==s);if(d&&this.quantitySelect?.dispatchEvent(new CustomEvent(er,{detail:{quantity:d},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==h){this.toggleStockOffer({target:this.addonCheckbox});let m=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(m,"target",{writable:!1,value:{checked:h}}),this.addonCheckbox.handleChange(m)}}get prices(){return Array.from(this.querySelectorAll(v))}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let e=this.querySelector(".price.price-alternative");if(e||(e=this.querySelector(`${v}[data-template="price"] > span`)),!!e)return e=e.innerText,e}get regularPrice(){return c(this,w,ht)?.innerText}get promotionCode(){let e=[...this.querySelectorAll(`${v}[data-promotion-code],${q}[data-promotion-code]`)].map(n=>n.dataset.promotionCode),r=[...new Set(e)];return r.length>1&&c(this,Pe)?.warn(`Multiple different promotion codes found: ${r.join(", ")}`),e[0]}get annualPrice(){return this.querySelector(`${v}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(c(this,w,ni)??c(this,w,ht))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return c(this,w,ht)?.querySelector("span.price-recurrence")?.textContent?.trim()}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let e=this.querySelector('a[is="upt-link"]');if(e)return E(this,w,mt).call(this,e)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){let e=this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${q}, a`);return Array.from(e??[])}get primaryCta(){return E(this,w,mt).call(this,this.ctas.find(e=>e.variant==="accent"||e.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return E(this,w,mt).call(this,this.ctas.find(e=>e.variant!=="accent"&&!e.matches(".spectrum-Button--accent,.con-button.blue")))}};_e=new WeakMap,Le=new WeakMap,Pe=new WeakMap,U=new WeakMap,ae=new WeakMap,F=new WeakMap,oe=new WeakMap,w=new WeakSet,ne=function(e,r={},n=!0){if(!this.isConnected)return;let o=this.aemFragment?.getAttribute("fragment");o=`[${o}]`;let s={...this.aemFragment.fetchInfo,...c(this,U).duration,...r,message:e};c(this,Pe).error(`merch-card${o}: ${e}`,s),this.failed=!0,n&&this.dispatchEvent(new CustomEvent(rr,{bubbles:!0,composed:!0,detail:s}))},ht=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${v}[data-template="price"] > span`)},ni=function(){return this.querySelector(`${v}[data-template="legal"]`)},mt=function(e){if(e)return{text:e.innerText.trim(),analyticsId:e.dataset.analyticsId,href:e.getAttribute("href")??e.dataset.href}},l(K,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:e=>{if(!e)return;let[r,n,a]=e.split(",");return{PUF:r,ABM:n,M2M:a}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:e=>Object.fromEntries(e.split(",").map(r=>{let[n,a,o]=r.split(":"),s=Number(a);return[n,{order:isNaN(s)?void 0:s,size:o}]})),toAttribute:e=>Object.entries(e).map(([r,{order:n,size:a}])=>[r,n,a].filter(o=>o!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:pt,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),l(K,"styles",[Kt,...Wt()]),l(K,"registerVariant",A),l(K,"getCollectionOptions",Lr),l(K,"getFragmentMapping",Je);customElements.define(Ht,K);export{K as MerchCard};
