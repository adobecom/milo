var Ut=Object.defineProperty;var qt=i=>{throw TypeError(i)};var ai=(i,t,e)=>t in i?Ut(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var ni=(i,t)=>()=>(i&&(t=i(i=0)),t);var oi=(i,t)=>{for(var e in t)Ut(i,e,{get:t[e],enumerable:!0})};var l=(i,t,e)=>ai(i,typeof t!="symbol"?t+"":t,e),ut=(i,t,e)=>t.has(i)||qt("Cannot "+e);var c=(i,t,e)=>(ut(i,t,"read from private field"),e?e.call(i):t.get(i)),g=(i,t,e)=>t.has(i)?qt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),p=(i,t,e,r)=>(ut(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),E=(i,t,e)=>(ut(i,t,"access private method"),e);var jt=(i,t,e,r)=>({set _(a){p(i,t,a,e)},get _(){return c(i,t,r)}});var ft={};oi(ft,{default:()=>K});import{LitElement as si,html as Ke,css as ci}from"../lit-all.min.js";function li(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var K,xt=ni(()=>{K=class extends si{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs"}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Ke`<merch-icon 
    ...
    `);customElements.define("mas-mnemonic",K)});import{LitElement as Ma}from"../lit-all.min.js";import{css as Vt,unsafeCSS as Gt}from"../lit-all.min.js";var L="(max-width: 767px)",N="(max-width: 1199px)",x="(min-width: 768px)",u="(min-width: 1200px)",O="(min-width: 1600px)";function Ve(){return window.matchMedia(L)}function Ye(){return window.matchMedia(u)}function se(){return Ve().matches}function F(){return Ye().matches}var Yt=Vt`
    :host {
...
`;var At={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},we=class extends b{constructor(t){super(t)}getGlobalCSS(){return Ar}get aemFragmentMapping(){return At}get headingSelector(){return'[slot="heading-xs"]'}updateCardElementMinHeightValue(t,e){if(!t)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,a=this.getContainer(),n=parseInt(a.style.getPropertyValue(r))||0;t>n&&a.style.setProperty(r,`${t}px`)}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.querySelector('[slot="body-xs"]');if(t){let r=t.offsetHeight;this.updateCardElementMinHeightValue(r,"description")}let e=this.card.querySelector('[slot="price"]');if(e){let r=e.offsetHeight;this.updateCardElementMinHeightValue(r,"price")}}async waitForPrices(){this.card.prices?.length&&await Promise.all(this.card.prices.map(t=>t.onceSettled?.()))}async syncAllCardsInContainer(t){let e=t.querySelectorAll('merch-card[variant="simplified-pricing-express"]');if(!e.length)return;let r=`--consonant-merch-card-${this.card.variant}`;["description","price"].forEach(a=>{t.style.removeProperty(`${r}-${a}-height`)}),await Promise.all(Array.from(e).flatMap(a=>a.prices?.map(n=>n.onceSettled?.())||[])),requestAnimationFrame(()=>{e.forEach(a=>a.variantLayout?.syncHeights?.())})}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,await this.waitForPrices(),F())){let t=this.getContainer();if(!t)return;let e=`--consonant-merch-card-${this.card.variant}`;t.style.getPropertyValue(`${e}-description-height`)||t.style.getPropertyValue(`${e}-price-height`)?this.syncHeights():await this.syncAllCardsInContainer(t)}}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!F()&&this.card.setAttribute("data-expanded","true"))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(F())t.removeAttribute("data-expanded");else{let a=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",a?"true":"false")}};e();let r=window.matchMedia(N);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(N).removeEventListener("change",this.mediaQueryListener)}handleChevronClick(t){t.preventDefault(),t.stopPropagation();let e=this.card;if(!e||F())return;let n=e.getAttribute("data-expanded")==="true"?"false":"true";e.setAttribute("data-expanded",n)}renderLayout(){return Ci`
