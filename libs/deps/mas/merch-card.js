var go=Object.defineProperty;var sr=e=>{throw TypeError(e)};var xo=(e,t,r)=>t in e?go(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var p=(e,t,r)=>xo(e,typeof t!="symbol"?t+"":t,r),ht=(e,t,r)=>t.has(e)||sr("Cannot "+r);var mt=(e,t,r)=>(ht(e,t,"read from private field"),r?r.call(e):t.get(e)),Be=(e,t,r)=>t.has(e)?sr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),cr=(e,t,r,n)=>(ht(e,t,"write to private field"),n?n.call(e,r):t.set(e,r),r),dt=(e,t,r)=>(ht(e,t,"access private method"),r);import{LitElement as Na}from"../lit-all.min.js";import{LitElement as bo,html as lr,css as vo}from"../lit-all.min.js";var m=class extends bo{constructor(){super(),this.size="m",this.alt=""}render(){let{href:t}=this;return t?lr`<a href="${t}">
    ...
    `);customElements.define("merch-icon",m);import{css as mr,unsafeCSS as hr}from"../lit-all.min.js";var z="(max-width: 767px)",De="(max-width: 1199px)",T="(min-width: 768px)",A="(min-width: 1200px)",M="(min-width: 1600px)";var dr=mr`
    :host {
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
    ...
    `);import{html as ye}from"../lit-all.min.js";var Lr=`
:root {
...
`;var $e=class extends S{constructor(t){super(t)}getGlobalCSS(){return Lr}renderLayout(){return ye`${this.cardImage}
    <div class="body">
...
`;var Ve=class extends S{constructor(t){super(t)}getGlobalCSS(){return Cr}renderLayout(){return Pr` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":Pr`<hr />`} ${this.secureLabelFooter}`}};import{html as ie,css as wo,unsafeCSS as Rr}from"../lit-all.min.js";var Nr=`
  :root {
...
`;var So=32,ae=class extends S{constructor(r){super(r);p(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);p(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?ie`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){Ge()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};p(ae,"variantStyle",wo`
  ...
  `);import{html as je,css as Ao}from"../lit-all.min.js";var Or=`
:root {
...
`;var se=class extends S{constructor(t){super(t)}getGlobalCSS(){return Or}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?je`<label id="stock-checkbox">
  ...
  `);import{html as bt,css as To}from"../lit-all.min.js";var Hr=`
:root {
...
`;var W=class extends S{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Hr}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return bt` ${this.badge}
      ...
      ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}postCardUpdateHook(){this.card.isConnected&&(Ge()||this.adjustProductBodySlots(),this.adjustTitleWidth())}};p(W,"variantStyle",To`
  ...
  `);import{html as vt,css as _o}from"../lit-all.min.js";var Mr=`
:root {
...
`;var ce=class extends S{constructor(t){super(t)}getGlobalCSS(){return Mr}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return vt` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
    ...
    <hr />
    ${this.secureLabelFooter}`}};p(ce,"variantStyle",_o`
  ...
  `);import{html as yt,css as Lo}from"../lit-all.min.js";var Ir=`
:root {
...
`;var Co={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},le=class extends S{constructor(t){super(t)}getGlobalCSS(){return Ir}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return Co}renderLayout(){return yt`${this.cardImage}
            ...
            ${this.evergreen?yt`
                  ...
                  `:yt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};p(le,"variantStyle",Lo`
    ...
    `);import{html as Po,css as No}from"../lit-all.min.js";var kr=`
:root {
...
`;var he=class extends S{constructor(t){super(t)}getGlobalCSS(){return kr}renderLayout(){return Po`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
      ...
      <footer><slot name="footer"></slot></footer>`}};p(he,"variantStyle",No`
    :host([variant='twp']) {
      padding: 4px 10px 5px 10px;
    }
    .twp-badge {
...
`;var Ho={mnemonics:{size:"l"},subtitle:{tag:"h4",slot:"detail-s"},backgroundImage:{attribute:"background-image"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"cta",size:"M"}},me=class extends S{getGlobalCSS(){return Br}get aemFragmentMapping(){return Ho}get stripStyle(){return this.card.backgroundImage?`
        ...
        `:""}renderLayout(){return Ro` <div style="${this.stripStyle}" class="body">
            ...
            <slot></slot>`}postCardUpdateHook(t){t.has("backgroundImage")&&this.styleBackgroundImage()}styleBackgroundImage(){if(this.card.classList.remove("thin-strip"),this.card.classList.remove("wide-strip"),!this.card.backgroundImage)return;let t=new Image;t.src=this.card.backgroundImage,t.onload=()=>{t.width>8?this.card.classList.add("wide-strip"):t.width===8&&this.card.classList.add("thin-strip")}}};p(me,"variantStyle",Oo`
    ...
    `);import{html as Mo,css as Io}from"../lit-all.min.js";var Dr=`
...
`;var ko={mnemonics:{size:"m"},backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{slot:"footer",size:"S"},allowedSizes:["wide"]},de=class extends S{getGlobalCSS(){return Dr}get aemFragmentMapping(){return ko}renderLayout(){return Mo` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
            ...
            <slot></slot>`}};p(de,"variantStyle",Io`
        :host([variant='ccd-slice']) {
