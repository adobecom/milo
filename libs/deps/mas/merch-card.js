...
`;var Co={mnemonics:{size:"l"},subtitle:{tag:"h4",slot:"detail-s"},backgroundImage:{attribute:"background-image"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"cta",size:"M"}},le=class extends w{getGlobalCSS(){return Ir}get aemFragmentMapping(){return Co}get stripStyle(){return this.card.backgroundImage?`
        ...
        `:""}renderLayout(){return _o` <div style="${this.stripStyle}" class="body">
            ...
            <slot></slot>`}postCardUpdateHook(t){t.has("backgroundImage")&&this.styleBackgroundImage()}styleBackgroundImage(){if(this.card.classList.remove("thin-strip"),this.card.classList.remove("wide-strip"),!this.card.backgroundImage)return;let t=new Image;t.src=this.card.backgroundImage,t.onload=()=>{t.width>8?this.card.classList.add("wide-strip"):t.width===8&&this.card.classList.add("thin-strip")}}};u(le,"variantStyle",Lo`
...
`;var Ro={mnemonics:{size:"m"},backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{slot:"footer",size:"S"},allowedSizes:["wide"]},he=class extends w{getGlobalCSS(){return kr}get aemFragmentMapping(){return Ro}renderLayout(){return Po` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
            ...
            <slot></slot>`}};u(he,"variantStyle",No`
        :host([variant='ccd-slice']) {
    ...
    `);var yt=(e,t=!1)=>{switch(e.variant){case"catalog":return new re(e);case"image":return new ze(e);case"inline-heading":return new Fe(e);case"mini-compare-chart":return new oe(e);case"plans":return new ie(e);case"product":return new W(e);case"segment":return new ae(e);case"special-offers":return new se(e);case"twp":return new ce(e);case"ccd-suggested":return new le(e);case"ccd-slice":return new he(e);default:return t?void 0:new W(e)}},Br=()=>{let e=[];return e.push(re.variantStyle),e.push(oe.variantStyle),e.push(W.variantStyle),e.push(ie.variantStyle),e.push(ae.variantStyle),e.push(se.variantStyle),e.push(ce.variantStyle),e.push(le.variantStyle),e.push(he.variantStyle),e};var Dr=document.createElement("style");Dr.innerHTML=`
:root {
