...
`;var ro=32,pt=class extends v{constructor(t){super(t);l(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);l(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?mt`<slot name="secure-transaction-label">
        ...
        ${this.card.classList.contains("bullet-list")?mt`<slot name="heading-m-price"></slot>
          ...
          <slot name="body-xxs"></slot>`:mt`<slot name="body-m"></slot>
...
`;var Xt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},cr={...function(){let{whatsIncluded:o,size:e,...t}=Xt;return t}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},sr={...function(){let{subtitle:o,whatsIncluded:e,size:t,quantitySelect:r,...n}=Xt;return n}()},A=class extends v{constructor(e){super(e),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,t){e.dataset.template===Xe&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return ir}adjustSlotPlacement(e,t,r){let n=this.card.shadowRoot,a=n.querySelector("footer"),i=this.card.getAttribute("size");if(!i)return;let s=n.querySelector(`footer slot[name="${e}"]`),d=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(i.includes("wide")||(a?.classList.remove("wide-footer"),s&&s.remove()),!!t.includes(i)){if(a?.classList.toggle("wide-footer",Bt()),!r&&s){if(d)s.remove();else{let g=p.querySelector(`[data-placeholder-for="${e}"]`);g?g.replaceWith(s):p.appendChild(s)}return}if(r&&d){let g=document.createElement("div");if(g.setAttribute("data-placeholder-for",e),g.classList.add("slot-placeholder"),!s){let x=d.cloneNode(!0);a.prepend(x)}d.replaceWith(g)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],Bt()),this.adjustSlotPlacement("callout-content",["super-wide"],Bt())}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.remove("hide-tooltip")}))}postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustLegal(),this.adjustAddon(),this.adjustCallout()}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${f}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Rt`<div class="divider"></div>`:Qt}async adjustLegal(){if(await this.card.updateComplete,await customElements.whenDefined("inline-price"),this.legalAdjusted)return;this.legalAdjusted=!0;let e=[],t=this.card.querySelector(`[slot="heading-m"] ${f}[data-template="price"]`);t&&e.push(t);let r=e.map(async n=>{let a=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),n.parentNode.insertBefore(a,n.nextSibling))});await Promise.all(r)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled();let r=t.value?.[0]?.planType;r&&(e.planType=r)}get stockCheckbox(){return this.card.checkboxLabel?Rt`<label id="stock-checkbox">
    ...
    `),l(A,"collectionOptions",{customHeaderArea:e=>e.sidenav?Rt`<slot name="resultsText"></slot>`:Qt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]}});import{html as ge,css as no}from"../lit-all.min.js";var lr=`
:root {
...
`;var gt=class extends v{constructor(e){super(e),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return lr}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return ge` ${this.badge}
...
`;var gr={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},xt=class extends v{constructor(){super(...arguments);l(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return pr}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${f}[data-template="price"]`);if(!t)return;let r=t.cloneNode(!0);this.legal=r,t.dataset.displayTax="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return so`
    ...
    `);var Zt=new Map,C=(o,e,t=null,r=null,n)=>{Zt.set(o,{class:e,fragmentMapping:t,style:r,collectionOptions:n})};C("catalog",ht,er,ht.variantStyle);C("image",Kt);C("inline-heading",Wt);C("mini-compare-chart",pt,null,pt.variantStyle);C("plans",A,Xt,A.variantStyle,A.collectionOptions);C("plans-students",A,sr,A.variantStyle,A.collectionOptions);C("plans-education",A,cr,A.variantStyle,A.collectionOptions);C("product",gt,null,gt.variantStyle);C("segment",ut,null,ut.variantStyle);C("special-offers",ft,mr,ft.variantStyle);C("mini",xt,gr,xt.variantStyle);var xe=o=>{let e=Zt.get(o.variant);if(!e)return;let{class:t,style:r}=e;if(r)try{let n=new CSSStyleSheet;n.replaceSync(r.cssText),o.shadowRoot.adoptedStyleSheets.push(n)}catch{let a=document.createElement("style");a.textContent=r.cssText,o.shadowRoot.appendChild(a)}return new t(o)};function Yt(o){return Zt.get(o)?.fragmentMapping}function ur(o){return Zt.get(o)?.collectionOptions}var fr=document.createElement("style");fr.innerHTML=`
:root {
...
Caused by: ${this.cause}`),t}};var mo="mas-commerce-service",po={requestId:Ht,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var ee=o=>window.setTimeout(o);function ve(){return document.getElementsByTagName(mo)?.[0]}function br(o){let e={};if(!o?.headers)return e;let t=o.headers;for(let[r,n]of Object.entries(po)){let a=t.get(n);a&&(a=a.replace(/[,;]/g,"|"),a=a.replace(/[| ]+/g,"|"),e[r]=a)}return e}async function vr(o,e={},t=2,r=100){let n;for(let a=0;a<=t;a++)try{let i=await fetch(o,e);return i.retryCount=a,i}catch(i){if(n=i,n.retryCount=a,a>t)break;await new Promise(s=>setTimeout(s,r*(a+1)))}throw n}var yr="fragment",Er="author",wr="preview",Sr="loading",Ar="timeout",ye="aem-fragment",kr="eager",Tr="cache",go=[kr,Tr],z,Q,R,Ee=class{constructor(){m(this,z,new Map);m(this,Q,new Map);m(this,R,new Map)}clear(){c(this,z).clear(),c(this,Q).clear(),c(this,R).clear()}add(e,t=!0){if(!this.has(e.id)&&!this.has(e.fields?.originalId)){if(c(this,z).set(e.id,e),e.fields?.originalId&&c(this,z).set(e.fields.originalId,e),c(this,R).has(e.id)){let[,r]=c(this,R).get(e.id);r()}if(c(this,R).has(e.fields?.originalId)){let[,r]=c(this,R).get(e.fields?.originalId);r()}if(!(!t||typeof e.references!="object"||Array.isArray(e.references)))for(let r in e.references){let{type:n,value:a}=e.references[r];n==="content-fragment"&&(a.settings={...e?.settings,...a.settings},a.placeholders={...e?.placeholders,...a.placeholders},a.dictionary={...e?.dictionary,...a.dictionary},a.priceLiterals={...e?.priceLiterals,...a.priceLiterals},this.add(a,e))}}}has(e){return c(this,z).has(e)}entries(){return c(this,z).entries()}get(e){return c(this,z).get(e)}getAsPromise(e){let[t]=c(this,R).get(e)??[];if(t)return t;let r;return t=new Promise(n=>{r=n,this.has(e)&&n()}),c(this,R).set(e,[t,r]),t}getFetchInfo(e){let t=c(this,Q).get(e);return t||(t={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,Q).set(e,t)),t}remove(e){c(this,z).delete(e),c(this,Q).delete(e),c(this,R).delete(e)}};z=new WeakMap,Q=new WeakMap,R=new WeakMap;var q=new Ee,bt,$,D,L,k,y,Pt,Mt,P,Nt,Ot,vt,M,Cr,Lr,we,_r,re=class extends HTMLElement{constructor(){super(...arguments);m(this,M);l(this,"cache",q);m(this,bt);m(this,$,null);m(this,D,null);m(this,L,null);m(this,k);m(this,y);m(this,Pt,kr);m(this,Mt,5e3);m(this,P);m(this,Nt,!1);m(this,Ot,0);m(this,vt)}static get observedAttributes(){return[yr,Sr,Ar,Er,wr]}attributeChangedCallback(t,r,n){t===yr&&(h(this,k,n),h(this,y,q.getFetchInfo(n))),t===Sr&&go.includes(n)&&h(this,Pt,n),t===Ar&&h(this,Mt,parseInt(n,10)),t===Er&&h(this,Nt,["","true"].includes(n)),t===wr&&h(this,vt,n)}connectedCallback(){if(!c(this,P)){if(c(this,L)??h(this,L,Y(this)),h(this,vt,c(this,L).settings?.preview),c(this,bt)??h(this,bt,c(this,L).log.module(`${ye}[${c(this,k)}]`)),!c(this,k)||c(this,k)==="#"){c(this,y)??h(this,y,q.getFetchInfo("missing-fragment-id")),w(this,M,we).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,y)).filter(([t,r])=>r!=null).map(([t,r])=>[`aem-fragment:${t}`,r]))}async refresh(t=!0){if(c(this,P)&&!await Promise.race([c(this,P),Promise.resolve(!1)]))return;t&&q.remove(c(this,k)),c(this,Pt)===Tr&&await Promise.race([q.getAsPromise(c(this,k)),new Promise(s=>setTimeout(s,c(this,Mt)))]);try{h(this,P,w(this,M,_r).call(this)),await c(this,P)}catch(s){return w(this,M,we).call(this,s.message),!1}let{references:r,referencesTree:n,placeholders:a,wcs:i}=c(this,$)||{};return i&&!Jt("mas.disableWcsCache")&&c(this,L).prefillWcsCache(i),this.dispatchEvent(new CustomEvent(at,{detail:{...this.data,references:r,referencesTree:n,placeholders:a,...c(this,y)},bubbles:!0,composed:!0})),c(this,P)}get updateComplete(){return c(this,P)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,D)?c(this,D):(c(this,Nt)?this.transformAuthorData():this.transformPublishData(),c(this,D))}transformAuthorData(){let{fields:t,id:r,tags:n,settings:a={},priceLiterals:i={},dictionary:s={},placeholders:d={}}=c(this,$);h(this,D,t.reduce((p,{name:g,multiple:x,values:_})=>(p.fields[g]=x?_:_[0],p),{fields:{},id:r,tags:n,settings:a,priceLiterals:i,dictionary:s,placeholders:d}))}transformPublishData(){let{fields:t,id:r,tags:n,settings:a={},priceLiterals:i={},dictionary:s={},placeholders:d={}}=c(this,$);h(this,D,Object.entries(t).reduce((p,[g,x])=>(p.fields[g]=x?.mimeType?x.value:x??"",p),{fields:{},id:r,tags:n,settings:a,priceLiterals:i,dictionary:s,placeholders:d}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let n=r.trim().toLowerCase();if(n==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:a}=window.location,i=a.endsWith(".page")?"page":"live";return n.includes("--")?`https://${n}.aem.${i}/studio/libs/fragment-client.js`:`https://${n}--mas--adobecom.aem.${i}/studio/libs/fragment-client.js`}async generatePreview(){let t=this.getFragmentClientUrl(),{previewFragment:r}=await import(t);return await r(c(this,k),{locale:c(this,L).settings.locale,apiKey:c(this,L).settings.wcsApiKey})}};bt=new WeakMap,$=new WeakMap,D=new WeakMap,L=new WeakMap,k=new WeakMap,y=new WeakMap,Pt=new WeakMap,Mt=new WeakMap,P=new WeakMap,Nt=new WeakMap,Ot=new WeakMap,vt=new WeakMap,M=new WeakSet,Cr=async function(t){Oe(this,Ot)._++;let r=`${ye}:${c(this,k)}:${c(this,Ot)}`,n=`${r}${qt}`,a=`${r}${jt}`;if(c(this,vt))return await this.generatePreview();performance.mark(n);let i;try{if(c(this,y).stale=!1,c(this,y).url=t,i=await vr(t,{cache:"default",credentials:"omit"}),w(this,M,Lr).call(this,i),c(this,y).status=i?.status,c(this,y).measure=ct(performance.measure(a,n)),c(this,y).retryCount=i.retryCount,!i?.ok)throw new W("Unexpected fragment response",{response:i,...c(this,L).duration});return await i.json()}catch(s){if(c(this,y).measure=ct(performance.measure(a,n)),c(this,y).retryCount=s.retryCount,c(this,$))return c(this,y).stale=!0,c(this,bt).error("Serving stale data",c(this,y)),c(this,$);let d=s.message??"unknown";throw new W(`Failed to fetch fragment: ${d}`,{})}},Lr=function(t){Object.assign(c(this,y),br(t))},we=function(t){h(this,P,null),c(this,y).message=t,this.classList.add("error");let r={...c(this,y),...c(this,L).duration};c(this,bt).error(t,r),this.dispatchEvent(new CustomEvent(it,{detail:r,bubbles:!0,composed:!0}))},_r=async function(){var d;this.classList.remove("error"),h(this,D,null);let t=q.get(c(this,k));if(t)return h(this,$,t),!0;let{masIOUrl:r,wcsApiKey:n,country:a,locale:i}=c(this,L).settings,s=`${r}/fragment?id=${c(this,k)}&api_key=${n}&locale=${i}`;return a&&!i.endsWith(`_${a}`)&&(s+=`&country=${a}`),t=await w(this,M,Cr).call(this,s),(d=t.fields).originalId??(d.originalId=c(this,k)),q.add(t),h(this,$,t),!0},l(re,"cache",q);customElements.define(ye,re);import{LitElement as uo,html as fo,css as xo}from"../lit-all.min.js";var yt=class extends uo{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return fo`<div class="badge">
    ...
    `),l(zt,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",zt);import{html as Se,css as Eo,LitElement as wo}from"../lit-all.min.js";var $t=class extends wo{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((e,t)=>{t>=5&&(e.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Se`<slot name="heading"></slot>
