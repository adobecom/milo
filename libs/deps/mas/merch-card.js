...
`,le=()=>[se`
    ...
    `);customElements.define("merch-icon",j);var so=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),lo=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var v='span[is="inline-price"][data-wcs-osi]',Y='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var me=`${v},${Y}`;var pe="merch-offer-select:ready",ge="merch-card:action-menu-toggle";var Bt="merch-quantity-selector:change",ue="merch-card-quantity:change",Ht="merch-modal:addon-and-quantity-update";var K="aem:load",W="aem:error",fe="mas:ready",xe="mas:error";var Ut="mas:resolved";var Tt="X-Request-Id",ho=Object.freeze({CHECKOUT:"checkout",CHECKOUT_EMAIL:"checkout/email",SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),mo=Object.freeze({V2:"UCv2",V3:"UCv3"}),po=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Ct=":start",_t=":duration";var be="legal";var Ze="mas-commerce-service";function ve(o,e){let t;return function(){let r=this,a=arguments;clearTimeout(t),t=setTimeout(()=>o.apply(r,a),e)}}function E(o,e={},t=null,r=null){let a=r?document.createElement(o,{is:r}):document.createElement(o);t instanceof HTMLElement?a.appendChild(t):a.innerHTML=t;for(let[n,i]of Object.entries(e))a.setAttribute(n,i);return a}function Lt(){return window.matchMedia("(max-width: 767px)")}function Q(){return Lt().matches}function X(o){return`startTime:${o.startTime.toFixed(2)}|duration:${o.duration.toFixed(2)}`}function ye(){return window.matchMedia("(max-width: 1024px)").matches}function Z(){return document.getElementsByTagName(Ze)?.[0]}var pt,B,gt,ut,J,Rt=class extends HTMLElement{constructor(){super();m(this,pt,"");m(this,B);m(this,gt,[]);m(this,ut,[]);m(this,J);h(this,J,ve(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,B)?this.parentElement.style.borderRadius=c(this,B):c(this,B)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let t=c(this,gt).map((r,a)=>{let n=c(this,ut)[a]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${c(this,pt)}, ${t})`}connectedCallback(){c(this,J).call(this)}attributeChangedCallback(t,r,a){t==="border-radius"&&h(this,B,a?.trim()),t==="colors"&&a?h(this,gt,a?.split(",").map(n=>n.trim())??[]):t==="positions"&&a?h(this,ut,a?.split(",").map(n=>n.trim())??[]):t==="angle"&&h(this,pt,a?.trim()??""),c(this,J).call(this)}};pt=new WeakMap,B=new WeakMap,gt=new WeakMap,ut=new WeakMap,J=new WeakMap;customElements.define("merch-gradient",Rt);import{LitElement as Je,html as tr,css as er}from"../lit-all.min.js";var tt=class extends Je{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this)}getOsi(e,t){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[t]||[t]).map(s=>`p[data-plan-type="${e}"] ${v}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(Ut,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Ut,this.updatePlanType)}updatePlanType(e){if(e.target.tagName!=="SPAN")return;let t=e.target,r=t?.value?.[0];r&&(t.setAttribute("data-offer-type",r.offerType),t.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(e){this.checked=e.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}render(){return tr`
            <label for="addon-checkbox" part="label">
                ...
                <span></span>
                <slot></slot>
            </label>`}};d(tt,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0}}),d(tt,"styles",er`
        :host {
    ...
    `);customElements.define("merch-addon",tt);import{html as Mt,nothing as rr}from"../lit-all.min.js";var et,ft=class ft{constructor(e){d(this,"card");m(this,et);this.card=e,this.insertVariantStyle()}getContainer(){return h(this,et,c(this,et)??this.card.closest('[class*="-merch-cards"]')??this.card.parentElement),c(this,et)}insertVariantStyle(){if(!ft.styleMap[this.card.variant]){ft.styleMap[this.card.variant]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(e,t){if(!e)return;let r=`--consonant-merch-card-${this.card.variant}-${t}-height`,a=Math.max(0,parseInt(window.getComputedStyle(e).height)||0),n=parseInt(this.getContainer().style.getPropertyValue(r))||0;a>n&&this.getContainer().style.setProperty(r,`${a}px`)}get badge(){let e;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(e=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Mt`
        ...
        `}get cardImage(){return Mt` <div class="image">
            ...
            >`:rr}get secureLabelFooter(){return Mt`<footer>${this.secureLabel}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let e=this.card.getBoundingClientRect().width,t=this.card.badgeElement?.getBoundingClientRect().width||0;e===0||t===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(e-t-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){return Pt(this.card.variant)}};et=new WeakMap,d(ft,"styleMap",{});var f=ft;import{html as qt,css as or}from"../lit-all.min.js";var Ee=`
:root {
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return Ee}setAriaExpanded(t,r){t.setAttribute("aria-expanded",r)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};d(rt,"variantStyle",or`
...
`;var Ot=class extends f{constructor(e){super(e)}getGlobalCSS(){return Ae}renderLayout(){return ke` ${this.badge}
    ...
    ${this.card.customHr?"":ke`<hr />`} ${this.secureLabelFooter}`}};import{html as ot,css as ar,unsafeCSS as Gt}from"../lit-all.min.js";var Te=`
  :root {
...
`;var nr=32,at=class extends f{constructor(t){super(t);d(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);d(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?ot`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(t=>t.onceSettled())),await this.adjustAddon(),Q()?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};d(at,"variantStyle",ar`
  ...
  `);import{html as D,css as ir,nothing as nt}from"../lit-all.min.js";var Ce=`
:root {
...
`;var it=class extends f{constructor(e){super(e)}getGlobalCSS(){return Me}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return jt` ${this.badge}
    ...
    <hr />
    ${this.secureLabelFooter}`}};d(it,"variantStyle",sr`
...
`;var ze={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ct=class extends f{constructor(e){super(e)}getGlobalCSS(){return Pe}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return Yt`${this.cardImage}
            ...
            ${this.evergreen?Yt`
                  ...
                  `:Yt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};d(ct,"variantStyle",dr`
...
Caused by: ${this.cause}`),t}};var lr={requestId:Tt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function Ne(o){let e={};if(!o?.headers)return e;let t=o.headers;for(let[r,a]of Object.entries(lr)){let n=t.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),e[r]=n)}return e}async function $e(o,e={},t=2,r=100){let a;for(let n=0;n<=t;n++)try{let i=await fetch(o,e);return i.retryCount=n,i}catch(i){if(a=i,a.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var Ie="fragment",De="author",Fe="preview",Qt="aem-fragment",z,Xt=class{constructor(){m(this,z,new Map)}clear(){c(this,z).clear()}addByRequestedId(e,t){c(this,z).set(e,t)}put(e,t){c(this,z).set(e,t)}add(...e){e.forEach(t=>{let{id:r}=t;r&&c(this,z).set(r,t)})}has(e){return c(this,z).has(e)}get(e){return c(this,z).get(e)}remove(e){c(this,z).delete(e)}};z=new WeakMap;var $t=new Xt,st,O,N,x,T,S,C,vt,yt,dt,_,Be,He,Jt,Ue,Zt=class extends HTMLElement{constructor(){super(...arguments);m(this,_);d(this,"cache",$t);m(this,st);m(this,O,null);m(this,N,null);m(this,x,{url:null,retryCount:0,stale:!1,measure:null,status:null});m(this,T,null);m(this,S);m(this,C);m(this,vt,!1);m(this,yt,0);m(this,dt)}static get observedAttributes(){return[Ie,De,Fe]}attributeChangedCallback(t,r,a){t===Ie&&h(this,S,a),t===De&&h(this,vt,["","true"].includes(a)),t===Fe&&h(this,dt,a)}connectedCallback(){if(!c(this,C)){if(c(this,T)??h(this,T,Z(this)),h(this,dt,c(this,T).settings?.preview),c(this,st)??h(this,st,c(this,T).log.module(`${Qt}[${c(this,S)}]`)),!c(this,S)||c(this,S)==="#"){w(this,_,Jt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,x)).filter(([t,r])=>r!=null).map(([t,r])=>[`aem-fragment:${t}`,r]))}async refresh(t=!0){if(c(this,C)&&!await Promise.race([c(this,C),Promise.resolve(!1)]))return;t&&$t.remove(c(this,S));try{h(this,C,w(this,_,Ue).call(this)),await c(this,C)}catch(i){return w(this,_,Jt).call(this,i.message),!1}let{references:r,referencesTree:a,placeholders:n}=c(this,O)||{};return this.dispatchEvent(new CustomEvent(K,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,x)},bubbles:!0,composed:!0})),c(this,C)}get updateComplete(){return c(this,C)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,N)?c(this,N):(c(this,vt)?this.transformAuthorData():this.transformPublishData(),c(this,N))}transformAuthorData(){let{fields:t,id:r,tags:a,settings:n={}}=c(this,O);h(this,N,t.reduce((i,{name:s,multiple:l,values:p})=>(i.fields[s]=l?p:p[0],i),{fields:{},id:r,tags:a,settings:n}))}transformPublishData(){let{fields:t,id:r,tags:a,settings:n={}}=c(this,O);h(this,N,Object.entries(t).reduce((i,[s,l])=>(i.fields[s]=l?.mimeType?l.value:l??"",i),{fields:{},id:r,tags:a,settings:n}))}async generatePreview(){let{previewFragment:t}=await import("https://mas.adobe.com/studio/libs/fragment-client.js");return await t(c(this,S),{locale:c(this,T).settings.locale,apiKey:c(this,T).settings.wcsApiKey})}};st=new WeakMap,O=new WeakMap,N=new WeakMap,x=new WeakMap,T=new WeakMap,S=new WeakMap,C=new WeakMap,vt=new WeakMap,yt=new WeakMap,dt=new WeakMap,_=new WeakSet,Be=async function(t){ie(this,yt)._++;let r=`${Qt}:${c(this,S)}:${c(this,yt)}`,a=`${r}${Ct}`,n=`${r}${_t}`;if(c(this,dt))return await this.generatePreview();performance.mark(a);let i;try{if(c(this,x).stale=!1,c(this,x).url=t,i=await $e(t,{cache:"default",credentials:"omit"}),w(this,_,He).call(this,i),c(this,x).status=i?.status,c(this,x).measure=X(performance.measure(n,a)),c(this,x).retryCount=i.retryCount,!i?.ok)throw new bt("Unexpected fragment response",{response:i,...c(this,T).duration});return await i.json()}catch(s){if(c(this,x).measure=X(performance.measure(n,a)),c(this,x).retryCount=s.retryCount,c(this,O))return c(this,x).stale=!0,c(this,st).error("Serving stale data",c(this,x)),c(this,O);let l=s.message??"unknown";throw new bt(`Failed to fetch fragment: ${l}`,{})}},He=function(t){Object.assign(c(this,x),Ne(t))},Jt=function(t){h(this,C,null),c(this,x).message=t,this.classList.add("error");let r={...c(this,x),...c(this,T).duration};c(this,st).error(t,r),this.dispatchEvent(new CustomEvent(W,{detail:r,bubbles:!0,composed:!0}))},Ue=async function(){this.classList.remove("error"),h(this,N,null);let t=$t.get(c(this,S));if(t)return h(this,O,t),!0;let{masIOUrl:r,wcsApiKey:a,locale:n}=c(this,T).settings,i=`${r}/fragment?id=${c(this,S)}&api_key=${a}&locale=${n}`;return t=await w(this,_,Be).call(this,i),$t.addByRequestedId(c(this,S),t),h(this,O,t),!0};customElements.define(Qt,Zt);import{LitElement as hr,html as mr,css as pr}from"../lit-all.min.js";var lt=class extends hr{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return mr`<div class="badge">
    ...
    `);customElements.define("merch-badge",lt);import{html as gr,css as ur,LitElement as fr}from"../lit-all.min.js";var Et=class extends fr{constructor(){super()}render(){return gr`
            <slot name="icon"></slot>
    ...
    `),d(Et,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Et);import{html as te,css as xr,LitElement as br}from"../lit-all.min.js";var wt=class extends br{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((e,t)=>{t>=5&&(e.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return te`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${this.isMobile&&this.rows.length>this.mobileRows?te`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:te``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};d(wt,"styles",xr`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
