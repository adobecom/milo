...
`;var O=class extends m{constructor(t){super(t)}getGlobalCSS(){return st}renderLayout(){return dt` ${this.badge}
  ...
  merch-card[variant="mini-compare-chart"] .card-heading [is="inline-price"] .price.price-annual,
