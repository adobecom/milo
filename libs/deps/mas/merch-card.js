...
Caused by: ${this.cause}`),t}};async function Me(o,e={},t=2,r=100){let a;for(let n=0;n<=t;n++)try{return await fetch(o,e)}catch(c){if(a=c,n>t)break;await new Promise(i=>setTimeout(i,r*(n+1)))}throw a}var Ne=new CSSStyleSheet;Ne.replaceSync(":host { display: contents; }");var Pe="fragment",ze="author",Mt="aem-fragment",k,Gt=class{constructor(){p(this,k,new Map)}clear(){s(this,k).clear()}addByRequestedId(e,t){s(this,k).set(e,t)}add(...e){e.forEach(t=>{let{id:r}=t;r&&s(this,k).set(r,t)})}has(e){return s(this,k).has(e)}get(e){return s(this,k).get(e)}remove(e){s(this,k).delete(e)}};k=new WeakMap;var gt=new Gt,ut,T,C,et,rt,N,E,_,ft,xt,Yt,Vt=class extends HTMLElement{constructor(){super();p(this,xt);d(this,"cache",gt);p(this,ut);p(this,T,null);p(this,C,null);p(this,et,!1);p(this,rt,null);p(this,N,null);p(this,E);p(this,_);p(this,ft,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[Ne]}static get observedAttributes(){return[Pe,ze]}attributeChangedCallback(t,r,a){t===Pe&&h(this,E,a),t===ze&&h(this,ft,["","true"].includes(a))}connectedCallback(){if(!s(this,_)){if(h(this,N,Y(this)),h(this,ut,s(this,N).log.module(Mt)),h(this,rt,`${Mt}:${s(this,E)}${it}`),performance.mark(s(this,rt)),!s(this,E)){w(this,xt,Yt).call(this,{message:"Missing fragment id"});return}this.refresh(!1)}}async getFragmentById(t,r,a){let n=`${Mt}:${r}${me}`,c;try{if(c=await Me(t,{cache:"default",credentials:"omit"}),!c?.ok){let{startTime:i,duration:l}=performance.measure(n,a);throw new pt("Unexpected fragment response",{response:c,startTime:i,duration:l,...s(this,N).duration})}return c.json()}catch{let{startTime:l,duration:m}=performance.measure(n,a);throw c||(c={url:t}),new pt("Failed to fetch fragment",{response:c,startTime:l,duration:m,...s(this,N).duration})}}async refresh(t=!0){if(!(s(this,_)&&!await Promise.race([s(this,_),Promise.resolve(!1)])))return t&&gt.remove(s(this,E)),h(this,_,this.fetchData().then(()=>{let{references:r,referencesTree:a,placeholders:n}=s(this,T)||{};return this.dispatchEvent(new CustomEvent(q,{detail:{...this.data,stale:s(this,et),references:r,referencesTree:a,placeholders:n},bubbles:!0,composed:!0})),!0}).catch(r=>s(this,T)?(gt.addByRequestedId(s(this,E),s(this,T)),!0):(w(this,xt,Yt).call(this,r),!1))),s(this,_)}async fetchData(){this.classList.remove("error"),h(this,C,null);let t=gt.get(s(this,E));if(t){h(this,T,t);return}h(this,et,!0);let{masIOUrl:r,wcsApiKey:a,locale:n}=s(this,N).settings,c=`${r}/fragment?id=${s(this,E)}&api_key=${a}&locale=${n}`;t=await this.getFragmentById(c,s(this,E),s(this,rt)),gt.addByRequestedId(s(this,E),t),h(this,T,t),h(this,et,!1)}get updateComplete(){return s(this,_)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,C)?s(this,C):(s(this,ft)?this.transformAuthorData():this.transformPublishData(),s(this,C))}transformAuthorData(){let{fields:t,id:r,tags:a,settings:n={}}=s(this,T);h(this,C,t.reduce((c,{name:i,multiple:l,values:m})=>(c.fields[i]=l?m:m[0],c),{fields:{},id:r,tags:a,settings:n}))}transformPublishData(){let{fields:t,id:r,tags:a,settings:n={}}=s(this,T);h(this,C,Object.entries(t).reduce((c,[i,l])=>(c.fields[i]=l?.mimeType?l.value:l??"",c),{fields:{},id:r,tags:a,settings:n}))}};ut=new WeakMap,T=new WeakMap,C=new WeakMap,et=new WeakMap,rt=new WeakMap,N=new WeakMap,E=new WeakMap,_=new WeakMap,ft=new WeakMap,xt=new WeakSet,Yt=function({message:t,context:r}){this.classList.add("error"),s(this,ut).error(`aem-fragment: ${t}`,r),this.dispatchEvent(new CustomEvent(G,{detail:{message:t,...r},bubbles:!0,composed:!0}))};customElements.define(Mt,Vt);import{LitElement as er,html as rr,css as or}from"../lit-all.min.js";var ot=class extends er{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return rr`<div class="plans-badge">
            ${this.text}
