...
`,he=()=>[de`
      ...
      `];import{LitElement as Ze,html as me,css as Je}from"../lit-all.min.js";var Y=class extends Ze{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:e}=this;return e?me`<a href="${e}">
                  <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />
              </a>`:me` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};d(Y,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),d(Y,"styles",Je`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",Y);var lo=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),ho=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var b='span[is="inline-price"][data-wcs-osi]',Ct='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var pe=`${b},${Ct}`;var ge="merch-offer-select:ready",ue="merch-card:action-menu-toggle";var Bt="merch-quantity-selector:change",fe="merch-card-quantity:change",Ut="merch-modal:addon-and-quantity-update";var K="aem:load",W="aem:error",xe="mas:ready",be="mas:error";var qt="mas:resolved";var _t="X-Request-Id",mo=Object.freeze({CHECKOUT:"checkout",CHECKOUT_EMAIL:"checkout/email",SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),po=Object.freeze({V2:"UCv2",V3:"UCv3"}),go=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Lt=":start",Rt=":duration";var ve="legal";var tr="mas-commerce-service";function ye(o,e){let t;return function(){let r=this,a=arguments;clearTimeout(t),t=setTimeout(()=>o.apply(r,a),e)}}function v(o,e={},t=null,r=null){let a=r?document.createElement(o,{is:r}):document.createElement(o);t instanceof HTMLElement?a.appendChild(t):a.innerHTML=t;for(let[n,i]of Object.entries(e))a.setAttribute(n,i);return a}function Mt(){return window.matchMedia("(max-width: 767px)")}function Q(){return Mt().matches}function X(o){return`startTime:${o.startTime.toFixed(2)}|duration:${o.duration.toFixed(2)}`}function Ee(){return window.matchMedia("(max-width: 1024px)").matches}function Z(){return document.getElementsByTagName(tr)?.[0]}var gt,H,ut,ft,J,Pt=class extends HTMLElement{constructor(){super();p(this,gt,"");p(this,H);p(this,ut,[]);p(this,ft,[]);p(this,J);m(this,J,ye(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,H)?this.parentElement.style.borderRadius=c(this,H):c(this,H)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let t=c(this,ut).map((r,a)=>{let n=c(this,ft)[a]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${c(this,gt)}, ${t})`}connectedCallback(){c(this,J).call(this)}attributeChangedCallback(t,r,a){t==="border-radius"&&m(this,H,a?.trim()),t==="colors"&&a?m(this,ut,a?.split(",").map(n=>n.trim())??[]):t==="positions"&&a?m(this,ft,a?.split(",").map(n=>n.trim())??[]):t==="angle"&&m(this,gt,a?.trim()??""),c(this,J).call(this)}};gt=new WeakMap,H=new WeakMap,ut=new WeakMap,ft=new WeakMap,J=new WeakMap;customElements.define("merch-gradient",Pt);import{LitElement as er,html as rr,css as or}from"../lit-all.min.js";var tt=class extends er{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this)}getOsi(e,t){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[t]||[t]).map(s=>`p[data-plan-type="${e}"] ${b}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(qt,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(qt,this.updatePlanType)}updatePlanType(e){if(e.target.tagName!=="SPAN")return;let t=e.target,r=t?.value?.[0];r&&(t.setAttribute("data-offer-type",r.offerType),t.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(e){this.checked=e.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}render(){return rr`
    ...
    `);customElements.define("merch-addon",tt);import{html as zt,nothing as ar}from"../lit-all.min.js";var et,xt=class xt{constructor(e){d(this,"card");p(this,et);this.card=e,this.insertVariantStyle()}getContainer(){return m(this,et,c(this,et)??this.card.closest('[class*="-merch-cards"]')??this.card.parentElement),c(this,et)}insertVariantStyle(){if(!xt.styleMap[this.card.variant]){xt.styleMap[this.card.variant]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(e,t){if(!e)return;let r=`--consonant-merch-card-${this.card.variant}-${t}-height`,a=Math.max(0,parseInt(window.getComputedStyle(e).height)||0),n=parseInt(this.getContainer().style.getPropertyValue(r))||0;a>n&&this.getContainer().style.setProperty(r,`${a}px`)}get badge(){let e;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(e=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),zt`
        ...
        `}get cardImage(){return zt` <div class="image">
            ...
            >`:ar}get secureLabelFooter(){return zt`<footer>${this.secureLabel}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let e=this.card.getBoundingClientRect().width,t=this.card.badgeElement?.getBoundingClientRect().width||0;e===0||t===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(e-t-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){return Ot(this.card.variant)}};et=new WeakMap,d(xt,"styleMap",{});var f=xt;import{html as Gt,css as nr}from"../lit-all.min.js";var we=`
:root {
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
    ...
    `);import{html as bt}from"../lit-all.min.js";var Ae=`
:root {
...
`;var Nt=class extends f{constructor(e){super(e)}getGlobalCSS(){return Ae}renderLayout(){return bt`${this.cardImage}
    <div class="body">
...
`;var $t=class extends f{constructor(e){super(e)}getGlobalCSS(){return Te}renderLayout(){return ke` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":ke`<hr />`} ${this.secureLabelFooter}`}};import{html as ot,css as ir,unsafeCSS as Vt}from"../lit-all.min.js";var Ce=`
  :root {
...
`;var cr=32,at=class extends f{constructor(t){super(t);d(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);d(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?ot`<slot name="secure-transaction-label">
  ...
  `);import{html as I,css as sr,nothing as nt}from"../lit-all.min.js";var _e=`
:root {
...
`;var it=class extends f{constructor(e){super(e)}getGlobalCSS(){return Pe}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Yt` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var Oe={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ct=class extends f{constructor(e){super(e)}getGlobalCSS(){return ze}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return Kt`${this.cardImage}
            <div class="body">
    ...
    `);var Wt=new Map,S=(o,e,t=null,r=null)=>{Wt.set(o,{class:e,fragmentMapping:t,style:r})};S("catalog",rt,Se,rt.variantStyle);S("image",Nt);S("inline-heading",$t);S("mini-compare-chart",at,null,at.variantStyle);S("plans",M,It,M.variantStyle);S("plans-students",M,Re,M.variantStyle);S("plans-education",M,Le,M.variantStyle);S("product",B,null,B.variantStyle);S("segment",it,null,it.variantStyle);S("special-offers",ct,Oe,ct.variantStyle);var Qt=(o,e=!1)=>{let t=Wt.get(o.variant);if(!t)return e?void 0:new B(o);let{class:r,style:a}=t;if(a){let n=new CSSStyleSheet;n.replaceSync(a.cssText),o.shadowRoot.adoptedStyleSheets.push(n)}return new r(o)};function Ot(o){return Wt.get(o)?.fragmentMapping}var Ne=document.createElement("style");Ne.innerHTML=`
:root {
...
Caused by: ${this.cause}`),t}};var mr={requestId:_t,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function $e(o){let e={};if(!o?.headers)return e;let t=o.headers;for(let[r,a]of Object.entries(mr)){let n=t.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),e[r]=n)}return e}async function Ie(o,e={},t=2,r=100){let a;for(let n=0;n<=t;n++)try{let i=await fetch(o,e);return i.retryCount=n,i}catch(i){if(a=i,a.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var Be=new CSSStyleSheet;Be.replaceSync(":host { display: contents; }");var De="fragment",Fe="author",He="preview",Xt="aem-fragment",P,Zt=class{constructor(){p(this,P,new Map)}clear(){c(this,P).clear()}addByRequestedId(e,t){c(this,P).set(e,t)}put(e,t){c(this,P).set(e,t)}add(...e){e.forEach(t=>{let{id:r}=t;r&&c(this,P).set(r,t)})}has(e){return c(this,P).has(e)}get(e){return c(this,P).get(e)}remove(e){c(this,P).delete(e)}};P=new WeakMap;var Dt=new Zt,st,z,O,x,T,w,k,yt,Et,dt,C,Ue,qe,te,Ge,Jt=class extends HTMLElement{constructor(){super();p(this,C);d(this,"cache",Dt);p(this,st);p(this,z,null);p(this,O,null);p(this,x,{url:null,retryCount:0,stale:!1,measure:null,status:null});p(this,T,null);p(this,w);p(this,k);p(this,yt,!1);p(this,Et,0);p(this,dt);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[Be]}static get observedAttributes(){return[De,Fe,He]}attributeChangedCallback(t,r,a){t===De&&m(this,w,a),t===Fe&&m(this,yt,["","true"].includes(a)),t===He&&m(this,dt,a)}connectedCallback(){if(!c(this,k)){if(c(this,T)??m(this,T,Z(this)),m(this,dt,c(this,T).settings?.preview),c(this,st)??m(this,st,c(this,T).log.module(`${Xt}[${c(this,w)}]`)),!c(this,w)||c(this,w)==="#"){E(this,C,te).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,x)).filter(([t,r])=>r!=null).map(([t,r])=>[`aem-fragment:${t}`,r]))}async refresh(t=!0){if(c(this,k)&&!await Promise.race([c(this,k),Promise.resolve(!1)]))return;t&&Dt.remove(c(this,w));try{m(this,k,E(this,C,Ge).call(this)),await c(this,k)}catch(i){return E(this,C,te).call(this,i.message),!1}let{references:r,referencesTree:a,placeholders:n}=c(this,z)||{};return this.dispatchEvent(new CustomEvent(K,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,x)},bubbles:!0,composed:!0})),c(this,k)}get updateComplete(){return c(this,k)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,O)?c(this,O):(c(this,yt)?this.transformAuthorData():this.transformPublishData(),c(this,O))}transformAuthorData(){let{fields:t,id:r,tags:a,settings:n={}}=c(this,z);m(this,O,t.reduce((i,{name:s,multiple:l,values:h})=>(i.fields[s]=l?h:h[0],i),{fields:{},id:r,tags:a,settings:n}))}transformPublishData(){let{fields:t,id:r,tags:a,settings:n={}}=c(this,z);m(this,O,Object.entries(t).reduce((i,[s,l])=>(i.fields[s]=l?.mimeType?l.value:l??"",i),{fields:{},id:r,tags:a,settings:n}))}async generatePreview(){let{previewFragment:t}=await import("https://mas.adobe.com/studio/libs/fragment-client.js");return await t(c(this,w),{locale:c(this,T).settings.locale,apiKey:c(this,T).settings.wcsApiKey})}};st=new WeakMap,z=new WeakMap,O=new WeakMap,x=new WeakMap,T=new WeakMap,w=new WeakMap,k=new WeakMap,yt=new WeakMap,Et=new WeakMap,dt=new WeakMap,C=new WeakSet,Ue=async function(t){ce(this,Et)._++;let r=`${Xt}:${c(this,w)}:${c(this,Et)}`,a=`${r}${Lt}`,n=`${r}${Rt}`;if(c(this,dt))return await this.generatePreview();performance.mark(a);let i;try{if(c(this,x).stale=!1,c(this,x).url=t,i=await Ie(t,{cache:"default",credentials:"omit"}),E(this,C,qe).call(this,i),c(this,x).status=i?.status,c(this,x).measure=X(performance.measure(n,a)),c(this,x).retryCount=i.retryCount,!i?.ok)throw new vt("Unexpected fragment response",{response:i,...c(this,T).duration});return await i.json()}catch(s){if(c(this,x).measure=X(performance.measure(n,a)),c(this,x).retryCount=s.retryCount,c(this,z))return c(this,x).stale=!0,c(this,st).error("Serving stale data",c(this,x)),c(this,z);let l=s.message??"unknown";throw new vt(`Failed to fetch fragment: ${l}`,{})}},qe=function(t){Object.assign(c(this,x),$e(t))},te=function(t){m(this,k,null),c(this,x).message=t,this.classList.add("error");let r={...c(this,x),...c(this,T).duration};c(this,st).error(t,r),this.dispatchEvent(new CustomEvent(W,{detail:r,bubbles:!0,composed:!0}))},Ge=async function(){this.classList.remove("error"),m(this,O,null);let t=Dt.get(c(this,w));if(t)return m(this,z,t),!0;let{masIOUrl:r,wcsApiKey:a,locale:n}=c(this,T).settings,i=`${r}/fragment?id=${c(this,w)}&api_key=${a}&locale=${n}`;return t=await E(this,C,Ue).call(this,i),Dt.addByRequestedId(c(this,w),t),m(this,z,t),!0};customElements.define(Xt,Jt);import{LitElement as pr,html as gr,css as ur}from"../lit-all.min.js";var lt=class extends pr{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return gr`<div class="badge">
    ...
    `);customElements.define("merch-badge",lt);import{html as fr,css as xr,LitElement as br}from"../lit-all.min.js";var wt=class extends br{constructor(){super()}render(){return fr`
            <slot name="icon"></slot>
    ...
    `),d(wt,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",wt);import{html as ee,css as vr,LitElement as yr}from"../lit-all.min.js";var St=class extends yr{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((e,t)=>{t>=5&&(e.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return ee`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${this.isMobile&&this.rows.length>this.mobileRows?ee`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:ee``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};d(St,"styles",vr`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
