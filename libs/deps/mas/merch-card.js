import{LitElement as se}from"../lit-all.min.js";import{LitElement as zt,html as Z,css as At}from"../lit-all.min.js";var n=class extends zt{static properties={size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0}};constructor(){super(),this.size="m",this.alt=""}render(){let{href:t}=this;return t?Z`<a href="${t}">
                  <img src="${this.src}" alt="${this.alt}" loading="lazy" />
              </a>`:Z` <img src="${this.src}" alt="${this.alt}" loading="lazy" />`}static styles=At`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `};customElements.define("merch-icon",n);import{css as X,unsafeCSS as J}from"../lit-all.min.js";var f="(max-width: 767px)",M="(max-width: 1199px)",m="(min-width: 768px)",l="(min-width: 1200px)",g="(min-width: 1600px)";var tt=X`
    :host {
        position: relative;
        display: flex;
...
merch-card[variant="catalog"] .payment-details {
  ...
  font-weight: 400;
  line-height: var(--consonant-merch-card-body-line-height);
}`;var Tt={title:{tag:"h3",slot:"heading-xs"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},allowedSizes:["wide","super-wide"]},y=class extends h{constructor(t){super(t)}get aemFragmentMapping(){return Tt}renderLayout(){return V` <div class="body">
    ...
    `};import{html as U,css as _t}from"../lit-all.min.js";var dt=`
:root {
...
`;var Mt={title:{tag:"h3",slot:"heading-xs"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},w=class extends h{constructor(t){super(t)}getGlobalCSS(){return dt}get aemFragmentMapping(){return Mt}renderLayout(){return U` <div class="body">
            <slot name="icons"></slot> ${this.badge}
            <slot name="heading-xs"></slot>
            <slot name="heading-m"></slot>
    ...
    `};import{html as E}from"../lit-all.min.js";var ht=`
:root {
...
`;var P=class extends h{constructor(t){super(t)}getGlobalCSS(){return ht}renderLayout(){return E`${this.cardImage}
    <div class="body">
...
`;var F=class extends h{constructor(t){super(t)}getGlobalCSS(){return lt}renderLayout(){return mt` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":mt`<hr />`} ${this.secureLabelFooter}`}};import{html as H,css as Rt,unsafeCSS as gt}from"../lit-all.min.js";var pt=`
  :root {
...
`;var $t=32,S=class extends h{constructor(t){super(t)}getRowMinHeightPropertyName=t=>`--consonant-merch-card-footer-row-${t}-min-height`;getGlobalCSS(){return pt}getMiniCompareFooter=()=>{let t=this.card.secureLabel?H`<slot name="secure-transaction-label">
  ...
  `};import{html as D,css as Ot}from"../lit-all.min.js";var ut=`
:root {
...
`;var k=class extends h{constructor(t){super(t)}getGlobalCSS(){return ut}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?D`<label id="stock-checkbox">
  ...
  `};import{html as I,css as Nt}from"../lit-all.min.js";var xt=`
:root {
...
`;var b=class extends h{constructor(t){super(t)}getGlobalCSS(){return xt}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return I` ${this.badge}
      <div class="body">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
          <slot name="body-xxs"></slot>
  ...
  `};import{html as q,css as Pt}from"../lit-all.min.js";var ft=`
:root {
...
`;var C=class extends h{constructor(t){super(t)}getGlobalCSS(){return ft}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return q` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
  ...
  `};import{html as j,css as Ft}from"../lit-all.min.js";var vt=`
:root {
...
`;var Ht={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},z=class extends h{constructor(t){super(t)}getGlobalCSS(){return vt}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return Ht}renderLayout(){return j`${this.cardImage}
            <div class="body">
...
`;var A=class extends h{constructor(t){super(t)}getGlobalCSS(){return bt}renderLayout(){return Dt`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
  ...
  `};import{html as Gt,css as Vt}from"../lit-all.min.js";var yt=`
:root {
...
`;var Ut={mnemonics:{size:"l"},subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"cta",size:"m"}},L=class extends h{getGlobalCSS(){return yt}get aemFragmentMapping(){return Ut}renderLayout(){return Gt`
  ...
  `};import{html as It,css as qt}from"../lit-all.min.js";var wt=`
:root {
...
`;var jt={mnemonics:{size:"m"},backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{slot:"footer",size:"s"},allowedSizes:["wide"]},T=class extends h{getGlobalCSS(){return wt}get aemFragmentMapping(){return jt}renderLayout(){return It` <div class="content">
                <div class="top-section">
                  <slot name="icons"></slot> 
                  ${this.badge}
                </div>  
    ...
    `};var K=(r,t=!1)=>{switch(r.variant){case"catalog":return new y(r);case"ccd-action":return new w(r);case"image":return new P(r);case"inline-heading":return new F(r);case"mini-compare-chart":return new S(r);case"plans":return new k(r);case"product":return new b(r);case"segment":return new C(r);case"special-offers":return new z(r);case"twp":return new A(r);case"ccd-suggested":return new L(r);case"ccd-slice":return new T(r);default:return t?void 0:new b(r)}},Et=()=>{let r=[];return r.push(y.variantStyle),r.push(w.variantStyle),r.push(S.variantStyle),r.push(b.variantStyle),r.push(k.variantStyle),r.push(C.variantStyle),r.push(z.variantStyle),r.push(A.variantStyle),r.push(L.variantStyle),r.push(T.variantStyle),r};var St=document.createElement("style");St.innerHTML=`
:root {
