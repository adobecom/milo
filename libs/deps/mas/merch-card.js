...
`,he=()=>[de`
    ...
    `);customElements.define("merch-addon",tt);import{html as Rt,nothing as ar}from"../lit-all.min.js";var et,ft=class ft{constructor(e){d(this,"card");m(this,et);this.card=e,this.insertVariantStyle()}getContainer(){return h(this,et,c(this,et)??this.card.closest('[class*="-merch-cards"]')??this.card.parentElement),c(this,et)}insertVariantStyle(){if(!ft.styleMap[this.card.variant]){ft.styleMap[this.card.variant]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(e,t){if(!e)return;let r=`--consonant-merch-card-${this.card.variant}-${t}-height`,a=Math.max(0,parseInt(window.getComputedStyle(e).height)||0),n=parseInt(this.getContainer().style.getPropertyValue(r))||0;a>n&&this.getContainer().style.setProperty(r,`${a}px`)}get badge(){let e;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(e=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Rt`
        ...
        `}get cardImage(){return Rt` <div class="image">
            ...
            >`:ar}get secureLabelFooter(){return Rt`<footer>${this.secureLabel}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let e=this.card.getBoundingClientRect().width,t=this.card.badgeElement?.getBoundingClientRect().width||0;e===0||t===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(e-t-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){return Mt(this.card.variant)}};et=new WeakMap,d(ft,"styleMap",{});var f=ft;import{html as qt,css as nr}from"../lit-all.min.js";var we=`
:root {
...
`;var Pt=class extends f{constructor(e){super(e)}getGlobalCSS(){return Ae}renderLayout(){return xt`${this.cardImage}
    <div class="body">
