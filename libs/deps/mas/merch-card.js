var ro=Object.defineProperty;var ir=e=>{throw TypeError(e)};var no=(e,t,r)=>t in e?ro(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var g=(e,t,r)=>no(e,typeof t!="symbol"?t+"":t,r),dt=(e,t,r)=>t.has(e)||ir("Cannot "+r);var E=(e,t,r)=>(dt(e,t,"read from private field"),r?r.call(e):t.get(e)),N=(e,t,r)=>t.has(e)?ir("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),R=(e,t,r,n)=>(dt(e,t,"write to private field"),n?n.call(e,r):t.set(e,r),r),Y=(e,t,r)=>(dt(e,t,"access private method"),r);import{LitElement as pi}from"../lit-all.min.js";import{LitElement as oo,html as sr,css as ao}from"../lit-all.min.js";var d=class extends oo{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:t}=this;return t?sr`<a href="${t}">
    ...
    `);customElements.define("merch-icon",d);import{css as hr,unsafeCSS as cr}from"../lit-all.min.js";var W="(max-width: 767px)",Ve="(max-width: 1199px)",T="(min-width: 768px)",A="(min-width: 1200px)",O="(min-width: 1600px)";var lr=hr`
    :host {
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return br}setAriaExpanded(r,n){r.setAttribute("aria-expanded",n)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};g(ge,"variantStyle",io`
...
`;var We=class extends w{constructor(t){super(t)}getGlobalCSS(){return vr}renderLayout(){return Ce`${this.cardImage}
    <div class="body">
    ...
    ${this.evergreen?Ce`
          ...
          `:Ce`
              <hr />
              ${this.secureLabelFooter}
          `}`}};import{html as Er}from"../lit-all.min.js";var yr=`
:root {
...
`;var Xe=class extends w{constructor(t){super(t)}getGlobalCSS(){return yr}renderLayout(){return Er` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":Er`<hr />`} ${this.secureLabelFooter}`}};import{html as fe,css as so,unsafeCSS as Sr}from"../lit-all.min.js";var wr=`
  :root {
...
`;var co=32,xe=class extends w{constructor(r){super(r);g(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);g(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?fe`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){Ye()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};g(xe,"variantStyle",so`
...
`;var ft={title:{tag:"p",slot:"heading-xs"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},stockOffer:!0,secureLabel:!0,badge:!0,ctas:{slot:"footer",size:"m"},style:"consonant"},be=class extends w{constructor(t){super(t)}get aemFragmentMapping(){return ft}getGlobalCSS(){return Ar}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?Tr`<label id="stock-checkbox">
        ...
        ${this.secureLabelFooter}`}};g(be,"variantStyle",ho`
    :host([variant='plans']) {
...
`;var ve=class extends w{constructor(t){super(t)}getGlobalCSS(){return Lr}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return bt` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
    ...
    <hr />
    ${this.secureLabelFooter}`}};g(ve,"variantStyle",mo`
...
`;var Ee=class extends w{constructor(t){super(t)}getGlobalCSS(){return Cr}renderLayout(){return po`${this.badge}
      ...
      <footer><slot name="footer"></slot></footer>`}};g(Ee,"variantStyle",go`
    :host([variant='twp']) {
      padding: 4px 10px 5px 10px;
    }
    .twp-badge {
...
`;var Et={backgroundImage:{attribute:"background-image"},badge:!0,ctas:{slot:"cta",size:"M"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"p",slot:"price"},size:[],subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"}},we=class extends w{getGlobalCSS(){return Nr}get aemFragmentMapping(){return Et}get stripStyle(){return this.card.backgroundImage?`
        ...
        `:""}renderLayout(){return fo` <div style="${this.stripStyle}" class="body">
            ...
            <slot></slot>`}postCardUpdateHook(t){t.has("backgroundImage")&&this.styleBackgroundImage()}styleBackgroundImage(){if(this.card.classList.remove("thin-strip"),this.card.classList.remove("wide-strip"),!this.card.backgroundImage)return;let t=new Image;t.src=this.card.backgroundImage,t.onload=()=>{t.width>8?this.card.classList.add("wide-strip"):t.width===8&&this.card.classList.add("thin-strip")}}};g(we,"variantStyle",xo`
    ...
    `);import{html as bo,css as vo}from"../lit-all.min.js";var Rr=`
...
`;var wt={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},Se=class extends w{getGlobalCSS(){return Rr}get aemFragmentMapping(){return wt}renderLayout(){return bo` <div class="content">
            ...
            <slot></slot>`}};g(Se,"variantStyle",vo`
        :host([variant='ccd-slice']) {
    ...
    `);import{html as yo,css as Eo}from"../lit-all.min.js";var Mr=`
...
`;var St={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color"},allowedColors:{gray:"--spectrum-gray-100"},size:["single","double","triple"]},te=class extends w{getGlobalCSS(){return Mr}get aemFragmentMapping(){return St}renderLayout(){return yo`
  ...
  `);customElements.define("ah-try-buy-widget",te);var At=(e,t=!1)=>{switch(e.variant){case"catalog":return new ge(e);case"image":return new We(e);case"inline-heading":return new Xe(e);case"mini-compare-chart":return new xe(e);case"plans":return new be(e);case"product":return new ee(e);case"segment":return new ve(e);case"special-offers":return new ye(e);case"twp":return new Ee(e);case"ccd-suggested":return new we(e);case"ccd-slice":return new Se(e);case"ah-try-buy-widget":return new te(e);default:return t?void 0:new ee(e)}},Hr={catalog:gt,image:null,"inline-heading":null,"mini-compare-chart":null,plans:ft,product:null,segment:null,"special-offers":yt,twp:null,"ccd-suggested":Et,"ccd-slice":wt,"ah-try-buy-widget":St},Ir=()=>{let e=[];return e.push(ge.variantStyle),e.push(xe.variantStyle),e.push(ee.variantStyle),e.push(be.variantStyle),e.push(ve.variantStyle),e.push(ye.variantStyle),e.push(Ee.variantStyle),e.push(we.variantStyle),e.push(Se.variantStyle),e.push(te.variantStyle),e};var kr=document.createElement("style");kr.innerHTML=`
:root {
