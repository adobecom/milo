var jt=Object.defineProperty;var Gt=i=>{throw TypeError(i)};var ai=(i,t,e)=>t in i?jt(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var oi=(i,t)=>()=>(i&&(t=i(i=0)),t);var si=(i,t)=>{for(var e in t)jt(i,e,{get:t[e],enumerable:!0})};var d=(i,t,e)=>ai(i,typeof t!="symbol"?t+"":t,e),xt=(i,t,e)=>t.has(i)||Gt("Cannot "+e);var c=(i,t,e)=>(xt(i,t,"read from private field"),e?e.call(i):t.get(i)),g=(i,t,e)=>t.has(i)?Gt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),p=(i,t,e,r)=>(xt(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),E=(i,t,e)=>(xt(i,t,"access private method"),e);var Vt=(i,t,e,r)=>({set _(n){p(i,t,n,e)},get _(){return c(i,t,r)}});var bt={};si(bt,{default:()=>W});import{LitElement as ci,html as Ke,css as li}from"../lit-all.min.js";function di(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var W,vt=oi(()=>{W=class extends ci{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs"}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Ke`<merch-icon 
    ...
    `);customElements.define("mas-mnemonic",W)});import{LitElement as Nn}from"../lit-all.min.js";import{css as Wt,unsafeCSS as Yt}from"../lit-all.min.js";var L="(max-width: 767px)",_="(max-width: 1199px)",x="(min-width: 768px)",u="(min-width: 1200px)",N="(min-width: 1600px)";function Ve(){return window.matchMedia(L)}function Ye(){return window.matchMedia(u)}function $(){return Ve().matches}function We(){return Ye().matches}var Kt=Wt`
    :host {
...
`;var Ei=32,xe=class extends b{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?fe`<slot name="secure-transaction-label">
  ...
  `);import{html as Ie,css as Si,nothing as nt}from"../lit-all.min.js";var vr=`
:root {
...
`;var at={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},yr={...function(){let{whatsIncluded:i,size:t,...e}=at;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},wr={...function(){let{subtitle:i,whatsIncluded:t,size:e,quantitySelect:r,...n}=at;return n}()},C=class extends b{constructor(t){super(t),this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,e){t.dataset.template===lr&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return vr}adjustSlotPlacement(t,e,r){let n=this.card.shadowRoot,a=n.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let s=n.querySelector(`footer slot[name="${t}"]`),l=n.querySelector(`.body slot[name="${t}"]`),h=n.querySelector(".body");if(o.includes("wide")||(a?.classList.remove("wide-footer"),s&&s.remove()),!!e.includes(o)){if(a?.classList.toggle("wide-footer",We()),!r&&s){if(l)s.remove();else{let m=h.querySelector(`[data-placeholder-for="${t}"]`);m?m.replaceWith(s):h.appendChild(s)}return}if(r&&l){let m=document.createElement("div");if(m.setAttribute("data-placeholder-for",t),m.classList.add("slot-placeholder"),!s){let f=l.cloneNode(!0);a.prepend(f)}l.replaceWith(m)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],We()),this.adjustSlotPlacement("callout-content",["super-wide"],We())}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",e=>{e.preventDefault(),e.target!==t?t.classList.add("hide-tooltip"):e.target.classList.remove("hide-tooltip")}))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let e=this.card.querySelector('[slot="body-xs"]');if(!e)return;let r=e.querySelector("ul");if(!r)return;let n=r.previousElementSibling,a=document.createElement("div");a.classList.add("spacer"),e.insertBefore(a,n);let o=new IntersectionObserver(([s])=>{if(s.boundingClientRect.height===0)return;let l=0,h=this.card.querySelector('[slot="heading-s"]');h&&(l+=Re(h));let m=this.card.querySelector('[slot="subtitle"]');m&&(l+=Re(m));let f=this.card.querySelector('[slot="heading-m"]');f&&(l+=8+Re(f));for(let oe of e.childNodes){if(oe.classList.contains("spacer"))break;l+=Re(oe)}let T=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(T)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),o.disconnect()});o.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustTitleWidth(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists())}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${v}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Ie`<div class="divider"></div>`:nt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],e=this.card.querySelector(`[slot="heading-m"] ${v}[data-template="price"]`);e&&t.push(e);let r=t.map(async n=>{let a=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),n.parentNode.insertBefore(a,n.nextSibling),await a.onceSettled())});await Promise.all(r)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let e=this.mainPrice;if(!e)return;await e.onceSettled();let r=e.value?.[0]?.planType;r&&(t.planType=r)}get stockCheckbox(){return this.card.checkboxLabel?Ie`<label id="stock-checkbox">
    ...
    `),d(C,"collectionOptions",{customHeaderArea:t=>t.sidenav?Ie`<slot name="resultsText"></slot>`:nt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]}});import{html as St,css as Ai}from"../lit-all.min.js";var Er=`
:root {
...
`;var be=class extends b{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.handleCollectionReady=this.handleCollectionReady.bind(this)}getGlobalCSS(){return Er}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return St` ${this.badge}
    ...
    `);import{html as At,css as Ci}from"../lit-all.min.js";var Sr=`
:root {
...
`;var ve=class extends b{constructor(t){super(t)}getGlobalCSS(){return Sr}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return At` ${this.badge}
  ...
  `);import{html as Ct,css as ki}from"../lit-all.min.js";var Ar=`
:root {
...
`;var Cr={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ye=class extends b{constructor(t){super(t)}getGlobalCSS(){return Ar}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return Ct`${this.cardImage}
            <div class="body">
...
`;var _r={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Se=class extends b{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Lr}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${v}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return zi`
    ...
    `);var st=new Map,S=(i,t,e=null,r=null,n)=>{st.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:n})};S("catalog",ue,mr,ue.variantStyle);S("image",rt);S("inline-heading",it);S("mini-compare-chart",xe,null,xe.variantStyle);S("plans",C,at,C.variantStyle,C.collectionOptions);S("plans-students",C,wr,C.variantStyle,C.collectionOptions);S("plans-education",C,yr,C.variantStyle,C.collectionOptions);S("product",be,null,be.variantStyle);S("segment",ve,null,ve.variantStyle);S("special-offers",ye,Cr,ye.variantStyle);S("simplified-pricing-express",we,kt,we.variantStyle);S("full-pricing-express",Ee,Tt,Ee.variantStyle);S("mini",Se,_r,Se.variantStyle);var Lt=i=>{let t=st.get(i.variant);if(!t)return;let{class:e,style:r}=t;if(r)try{let n=new CSSStyleSheet;n.replaceSync(r.cssText),i.shadowRoot.adoptedStyleSheets.push(n)}catch{let a=document.createElement("style");a.textContent=r.cssText,i.shadowRoot.appendChild(a)}return new e(i)};function tt(i){return st.get(i)?.fragmentMapping}function Pr(i){return st.get(i)?.collectionOptions}var Rr=document.createElement("style");Rr.innerHTML=`
:root {
...
`;document.head.appendChild(Rr);function ct(i,t={},{metadata:e=!0,search:r=!0,storage:n=!0}={}){let a;if(r&&a==null){let o=new URLSearchParams(window.location.search),s=_t(r)?r:i;a=o.get(s)}if(n&&a==null){let o=_t(n)?n:i;a=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&a==null){let o=Oi(_t(e)?e:i);a=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return a??t[i]}var Mi=i=>typeof i=="boolean",lt=i=>typeof i=="function";var _t=i=>typeof i=="string";function zr(i,t){if(Mi(i))return i;let e=String(i);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function Oi(i=""){return String(i).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var Z=class i extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let n=e.response.headers?.get(Xe);n&&(e.requestId=n),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,i)}toString(){let t=Object.entries(this.context||{}).map(([r,n])=>`${r}: ${JSON.stringify(n)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var Ni="mas-commerce-service",$i={requestId:Xe,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var dt=i=>window.setTimeout(i);function Pt(){return document.getElementsByTagName(Ni)?.[0]}function Mr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,n]of Object.entries($i)){let a=e.get(n);a&&(a=a.replace(/[,;]/g,"|"),a=a.replace(/[| ]+/g,"|"),t[r]=a)}return t}async function Or(i,t={},e=2,r=100){let n;for(let a=0;a<=e;a++)try{let o=await fetch(i,t);return o.retryCount=a,o}catch(o){if(n=o,n.retryCount=a,a>e)break;await new Promise(s=>setTimeout(s,r*(a+1)))}throw n}var Nr="fragment",$r="author",Ir="preview",Dr="loading",Fr="timeout",Rt="aem-fragment",Hr="eager",Br="cache",Ii=[Hr,Br],I,J,z,zt=class{constructor(){g(this,I,new Map);g(this,J,new Map);g(this,z,new Map)}clear(){c(this,I).clear(),c(this,J).clear(),c(this,z).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,I).set(t.id,t),t.fields?.originalId&&c(this,I).set(t.fields.originalId,t),c(this,z).has(t.id)){let[,r]=c(this,z).get(t.id);r()}if(c(this,z).has(t.fields?.originalId)){let[,r]=c(this,z).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:n,value:a}=t.references[r];n==="content-fragment"&&(a.settings={...t?.settings,...a.settings},a.placeholders={...t?.placeholders,...a.placeholders},a.dictionary={...t?.dictionary,...a.dictionary},a.priceLiterals={...t?.priceLiterals,...a.priceLiterals},this.add(a,t))}}}has(t){return c(this,I).has(t)}entries(){return c(this,I).entries()}get(t){return c(this,I).get(t)}getAsPromise(t){let[e]=c(this,z).get(t)??[];if(e)return e;let r;return e=new Promise(n=>{r=n,this.has(t)&&n()}),c(this,z).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,J).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,J).set(t,e)),e}remove(t){c(this,I).delete(t),c(this,J).delete(t),c(this,z).delete(t)}};I=new WeakMap,J=new WeakMap,z=new WeakMap;var G=new zt,Ae,D,H,P,k,y,De,Fe,M,He,Be,Ce,O,Ur,qr,Mt,jr,pt=class extends HTMLElement{constructor(){super(...arguments);g(this,O);d(this,"cache",G);g(this,Ae);g(this,D,null);g(this,H,null);g(this,P,null);g(this,k);g(this,y);g(this,De,Hr);g(this,Fe,5e3);g(this,M);g(this,He,!1);g(this,Be,0);g(this,Ce)}static get observedAttributes(){return[Nr,Dr,Fr,$r,Ir]}attributeChangedCallback(e,r,n){e===Nr&&(p(this,k,n),p(this,y,G.getFetchInfo(n))),e===Dr&&Ii.includes(n)&&p(this,De,n),e===Fr&&p(this,Fe,parseInt(n,10)),e===$r&&p(this,He,["","true"].includes(n)),e===Ir&&p(this,Ce,n)}connectedCallback(){if(!c(this,M)){if(c(this,P)??p(this,P,X(this)),p(this,Ce,c(this,P).settings?.preview),c(this,Ae)??p(this,Ae,c(this,P).log.module(`${Rt}[${c(this,k)}]`)),!c(this,k)||c(this,k)==="#"){c(this,y)??p(this,y,G.getFetchInfo("missing-fragment-id")),E(this,O,Mt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,y)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,M)&&!await Promise.race([c(this,M),Promise.resolve(!1)]))return;e&&G.remove(c(this,k)),c(this,De)===Br&&await Promise.race([G.getAsPromise(c(this,k)),new Promise(s=>setTimeout(s,c(this,Fe)))]);try{p(this,M,E(this,O,jr).call(this)),await c(this,M)}catch(s){return E(this,O,Mt).call(this,s.message),!1}let{references:r,referencesTree:n,placeholders:a,wcs:o}=c(this,D)||{};return o&&!ct("mas.disableWcsCache")&&c(this,P).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(le,{detail:{...this.data,references:r,referencesTree:n,placeholders:a,...c(this,y)},bubbles:!0,composed:!0})),c(this,M)}get updateComplete(){return c(this,M)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,H)?c(this,H):(c(this,He)?this.transformAuthorData():this.transformPublishData(),c(this,H))}transformAuthorData(){let{fields:e,id:r,tags:n,settings:a={},priceLiterals:o={},dictionary:s={},placeholders:l={}}=c(this,D);p(this,H,e.reduce((h,{name:m,multiple:f,values:T})=>(h.fields[m]=f?T:T[0],h),{fields:{},id:r,tags:n,settings:a,priceLiterals:o,dictionary:s,placeholders:l}))}transformPublishData(){let{fields:e,id:r,tags:n,settings:a={},priceLiterals:o={},dictionary:s={},placeholders:l={}}=c(this,D);p(this,H,Object.entries(e).reduce((h,[m,f])=>(h.fields[m]=f?.mimeType?f.value:f??"",h),{fields:{},id:r,tags:n,settings:a,priceLiterals:o,dictionary:s,placeholders:l}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let n=r.trim().toLowerCase();if(n==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:a}=window.location,o=a.endsWith(".page")?"page":"live";return n.includes("--")?`https://${n}.aem.${o}/studio/libs/fragment-client.js`:`https://${n}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,k),{locale:c(this,P).settings.locale,apiKey:c(this,P).settings.wcsApiKey})}};Ae=new WeakMap,D=new WeakMap,H=new WeakMap,P=new WeakMap,k=new WeakMap,y=new WeakMap,De=new WeakMap,Fe=new WeakMap,M=new WeakMap,He=new WeakMap,Be=new WeakMap,Ce=new WeakMap,O=new WeakSet,Ur=async function(e){Vt(this,Be)._++;let r=`${Rt}:${c(this,k)}:${c(this,Be)}`,n=`${r}${Qe}`,a=`${r}${Ze}`;if(c(this,Ce))return await this.generatePreview();performance.mark(n);let o;try{if(c(this,y).stale=!1,c(this,y).url=e,o=await Or(e,{cache:"default",credentials:"omit"}),E(this,O,qr).call(this,o),c(this,y).status=o?.status,c(this,y).measure=pe(performance.measure(a,n)),c(this,y).retryCount=o.retryCount,!o?.ok)throw new Z("Unexpected fragment response",{response:o,...c(this,P).duration});return await o.json()}catch(s){if(c(this,y).measure=pe(performance.measure(a,n)),c(this,y).retryCount=s.retryCount,c(this,D))return c(this,y).stale=!0,c(this,Ae).error("Serving stale data",c(this,y)),c(this,D);let l=s.message??"unknown";throw new Z(`Failed to fetch fragment: ${l}`,{})}},qr=function(e){Object.assign(c(this,y),Mr(e))},Mt=function(e){p(this,M,null),c(this,y).message=e,this.classList.add("error");let r={...c(this,y),...c(this,P).duration};c(this,Ae).error(e,r),this.dispatchEvent(new CustomEvent(de,{detail:r,bubbles:!0,composed:!0}))},jr=async function(){var l;this.classList.remove("error"),p(this,H,null);let e=G.get(c(this,k));if(e)return p(this,D,e),!0;let{masIOUrl:r,wcsApiKey:n,country:a,locale:o}=c(this,P).settings,s=`${r}/fragment?id=${c(this,k)}&api_key=${n}&locale=${o}`;return a&&!o.endsWith(`_${a}`)&&(s+=`&country=${a}`),e=await E(this,O,Ur).call(this,s),(l=e.fields).originalId??(l.originalId=c(this,k)),G.add(e),p(this,D,e),!0},d(pt,"cache",G);customElements.define(Rt,pt);import{LitElement as Di,html as Fi,css as Hi}from"../lit-all.min.js";var ke=class extends Di{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return Fi`<div class="badge">
            ${this.text}
        </div>`}};d(ke,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"}}),d(ke,"styles",Hi`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",ke);import{html as Bi,css as Ui,LitElement as qi}from"../lit-all.min.js";var Ue=class extends qi{constructor(){super()}render(){return Bi`
            <slot name="icon"></slot>
    ...
    `),d(qe,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",qe);var ee={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,tags:"acom",isProdDomain:!1},Gr=1e3;function Vi(i){return i instanceof Error||typeof i?.originatingRequest=="string"}function Vr(i){if(i==null)return;let t=typeof i;if(t==="function")return i.name?`function ${i.name}`:"function";if(t==="object"){if(i instanceof Error)return i.message;if(typeof i.originatingRequest=="string"){let{message:r,originatingRequest:n,status:a}=i;return[r,a,n].filter(Boolean).join(" ")}let e=i[Symbol.toStringTag]??Object.getPrototypeOf(i).constructor.name;if(!ee.serializableTypes.includes(e))return e}return i}function Yi(i,t){if(!ee.ignoredProperties.includes(i))return Vr(t)}var Nt={append(i){if(i.level!=="error")return;let{message:t,params:e}=i,r=[],n=[],a=t;e.forEach(h=>{h!=null&&(Vi(h)?r:n).push(h)}),r.length&&(a+=" "+r.map(Vr).join(" "));let{pathname:o,search:s}=window.location,l=`${ee.delimiter}page=${o}${s}`;l.length>Gr&&(l=`${l.slice(0,Gr)}<trunc>`),a+=l,n.length&&(a+=`${ee.delimiter}facts=`,a+=JSON.stringify(n,Yi)),window.lana?.log(a,ee)}};function Yr(i){Object.assign(ee,Object.fromEntries(Object.entries(i).filter(([t,e])=>t in ee&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Wr={LOCAL:"local",PROD:"prod",STAGE:"stage"},$t={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},It=new Set,Dt=new Set,Kr=new Map,Xr={append({level:i,message:t,params:e,timestamp:r,source:n}){console[i](`${r}ms [${n}] %c${t}`,"font-weight: bold;",...e)}},Qr={filter:({level:i})=>i!==$t.DEBUG},Wi={filter:()=>!1};function Ki(i,t,e,r,n){return{level:i,message:t,namespace:e,get params(){return r.length===1&&lt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:n,timestamp:performance.now().toFixed(3)}}function Xi(i){[...Dt].every(t=>t(i))&&It.forEach(t=>t(i))}function Zr(i){let t=(Kr.get(i)??0)+1;Kr.set(i,t);let e=`${i} #${t}`,r={id:e,namespace:i,module:n=>Zr(`${r.namespace}/${n}`),updateConfig:Yr};return Object.values($t).forEach(n=>{r[n]=(a,...o)=>Xi(Ki(n,a,i,o,e))}),Object.seal(r)}function ht(...i){i.forEach(t=>{let{append:e,filter:r}=t;lt(r)&&Dt.add(r),lt(e)&&It.add(e)})}function Qi(i={}){let{name:t}=i,e=zr(ct("commerce.debug",{search:!0,storage:!0}),t===Wr.LOCAL);return ht(e?Xr:Qr),t===Wr.PROD&&ht(Nt),Ft}function Zi(){It.clear(),Dt.clear()}var Ft={...Zr(cr),Level:$t,Plugins:{consoleAppender:Xr,debugFilter:Qr,quietFilter:Wi,lanaAppender:Nt},init:Qi,reset:Zi,use:ht};var Ji={[q]:nr,[K]:ar,[j]:or},en={[q]:sr,[j]:Pe},je,mt=class{constructor(t){g(this,je);d(this,"changes",new Map);d(this,"connected",!1);d(this,"error");d(this,"log");d(this,"options");d(this,"promises",[]);d(this,"state",K);d(this,"timer",null);d(this,"value");d(this,"version",0);d(this,"wrapperElement");this.wrapperElement=t,this.log=Ft.module("mas-element")}update(){[q,K,j].forEach(t=>{this.wrapperElement.classList.toggle(Ji[t],t===this.state)})}notify(){(this.state===j||this.state===q)&&(this.state===j?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===q&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let t=this.error;this.error instanceof Z&&(t={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(en[this.state],{bubbles:!0,detail:t}))}attributeChangedCallback(t,e,r){this.changes.set(t,r),this.requestUpdate()}connectedCallback(){p(this,je,Pt()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:t,promises:e,state:r}=this;return j===r?Promise.resolve(this.wrapperElement):q===r?Promise.reject(t):new Promise((n,a)=>{e.push({resolve:n,reject:a})})}toggleResolved(t,e,r){return t!==this.version?!1:(r!==void 0&&(this.options=r),this.state=j,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),dt(()=>this.notify()),!0)}toggleFailed(t,e,r){if(t!==this.version)return!1;r!==void 0&&(this.options=r),this.error=e,this.state=q,this.update();let n=this.wrapperElement.getAttribute("is");return this.log?.error(`${n}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...c(this,je)?.duration}),dt(()=>this.notify()),!0}togglePending(t){return this.version++,t&&(this.options=t),this.state=K,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!Pt()||this.timer)return;let{error:e,options:r,state:n,value:a,version:o}=this;this.state=K,this.timer=dt(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||t)try{await this.wrapperElement.render?.()===!1&&this.state===K&&this.version===o&&(this.state=n,this.error=e,this.value=a,this.update(),this.notify())}catch(l){this.toggleFailed(this.version,l,r)}})}};je=new WeakMap;function tn(i){return`https://${i==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var re,te=class te extends HTMLAnchorElement{constructor(){super();d(this,"masElement",new mt(this));g(this,re);this.setAttribute("is",te.is)}get isUptLink(){return!0}initializeWcsData(e,r){this.setAttribute("data-wcs-osi",e),r&&this.setAttribute("data-promotion-code",r)}attributeChangedCallback(e,r,n){this.masElement.attributeChangedCallback(e,r,n)}connectedCallback(){this.masElement.connectedCallback(),p(this,re,X()),c(this,re)&&(this.log=c(this,re).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),p(this,re,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=X();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let r=e.collectCheckoutOptions({},this);if(!r.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let n=this.masElement.togglePending(r),a=e.resolveOfferSelectors(r);try{let[[o]]=await Promise.all(a),{country:s,language:l,env:h}=r,m=`locale=${l}_${s}&country=${s}&offer_id=${o.offerId}`,f=this.getAttribute("data-promotion-code");f&&(m+=`&promotion_code=${encodeURIComponent(f)}`),this.href=`${tn(h)}?${m}`,this.masElement.toggleResolved(n,o,r)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${r.wcsOsi}.`,o.message);return this.masElement.toggleFailed(n,s,r),!1}}static createFrom(e){let r=new te;for(let n of e.attributes)n.name!=="is"&&(n.name==="class"&&n.value.includes("upt-link")?r.setAttribute("class",n.value.replace("upt-link","").trim()):r.setAttribute(n.name,n.value));return r.innerHTML=e.innerHTML,r.setAttribute("tabindex",0),r}};re=new WeakMap,d(te,"is","upt-link"),d(te,"tag","a"),d(te,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var V=te;window.customElements.get(V.is)||window.customElements.define(V.is,V,{extends:V.tag});var rn="#000000",Ht="#F8D904",nn="#EAEAEA",an="#31A547",on=/(accent|primary|secondary)(-(outline|link))?/,sn="mas:product_code/",cn="daa-ll",gt="daa-lh",ln=["XL","L","M","S"],Bt="...";function R(i,t,e,r){let n=r[i];if(t[i]&&n){let a={slot:n?.slot},o=t[i];if(n.maxCount&&typeof o=="string"){let[l,h]=kn(o,n.maxCount,n.withSuffix);l!==o&&(a.title=h,o=l)}let s=A(n.tag,a,o);e.append(s)}}function dn(i,t,e){let r=i.mnemonicIcon?.map((a,o)=>({icon:a,alt:i.mnemonicAlt[o]??"",link:i.mnemonicLink[o]??""}));r?.forEach(({icon:a,alt:o,link:s})=>{if(s&&!/^https?:/.test(s))try{s=new URL(`https://${s}`).href.toString()}catch{s="#"}let l={slot:"icons",src:a,loading:t.loading,size:e?.size??"l"};o&&(l.alt=o),s&&(l.href=s);let h=A("merch-icon",l);t.append(h)});let n=t.shadowRoot.querySelector('slot[name="icons"]');!r?.length&&n&&n.remove()}function pn(i,t,e){if(e.badge?.slot){if(i.badge?.length&&!i.badge?.startsWith("<merch-badge")){let r=Ht,n=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(r=e.badge?.default,i.borderColor||(n=!0));let a=i.badgeBackgroundColor||r,o=i.borderColor||"";n&&(o=e.badge?.default,i.borderColor=e.badge?.default),i.badge=`<merch-badge variant="${i.variant}" background-color="${a}" border-color="${o}">${i.badge}</merch-badge>`}R("badge",i,t,e)}else i.badge?(t.setAttribute("badge-text",i.badge),e.disabledAttributes?.includes("badgeColor")||t.setAttribute("badge-color",i.badgeColor||rn),e.disabledAttributes?.includes("badgeBackgroundColor")||t.setAttribute("badge-background-color",i.badgeBackgroundColor||Ht),t.setAttribute("border-color",i.badgeBackgroundColor||Ht)):t.setAttribute("border-color",i.borderColor||nn)}function hn(i,t,e){if(e.trialBadge&&i.trialBadge){if(!i.trialBadge.startsWith("<merch-badge")){let r=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&i.trialBadgeBorderColor||an;i.trialBadge=`<merch-badge variant="${i.variant}" border-color="${r}">${i.trialBadge}</merch-badge>`}R("trialBadge",i,t,e)}}function mn(i,t,e){e?.includes(i.size)&&t.setAttribute("size",i.size)}function gn(i,t){i.cardName&&t.setAttribute("name",i.cardName)}function un(i,t,e){R("cardTitle",i,t,{cardTitle:e})}function fn(i,t,e){R("subtitle",i,t,e)}function xn(i,t,e,r){if(!i.backgroundColor||i.backgroundColor.toLowerCase()==="default"){t.style.removeProperty("--merch-card-custom-background-color"),t.removeAttribute("background-color");return}e?.[i.backgroundColor]?(t.style.setProperty("--merch-card-custom-background-color",`var(${e[i.backgroundColor]})`),t.setAttribute("background-color",i.backgroundColor)):r?.attribute&&i.backgroundColor&&(t.setAttribute(r.attribute,i.backgroundColor),t.style.removeProperty("--merch-card-custom-background-color"))}function bn(i,t,e){let r=e?.borderColor,n="--consonant-merch-card-border-color";if(i.borderColor?.toLowerCase()==="transparent")t.style.setProperty(n,"transparent");else if(i.borderColor&&r)if(r?.specialValues?.[i.borderColor]?.includes("gradient")||/-gradient/.test(i.borderColor)){t.setAttribute("gradient-border","true");let s=i.borderColor;if(r?.specialValues){for(let[l,h]of Object.entries(r.specialValues))if(h===i.borderColor){s=l;break}}t.setAttribute("border-color",s),t.style.removeProperty(n)}else t.style.setProperty(n,`var(--${i.borderColor})`)}function vn(i,t,e){if(i.backgroundImage){let r={loading:t.loading??"lazy",src:i.backgroundImage};if(i.backgroundImageAltText?r.alt=i.backgroundImageAltText:r.role="none",!e)return;if(e?.attribute){t.setAttribute(e.attribute,i.backgroundImage);return}t.append(A(e.tag,{slot:e.slot},A("img",r)))}}function Ge(i){return!i||typeof i!="string"||i.includes("<mas-mnemonic")&&Promise.resolve().then(()=>(vt(),bt)).catch(console.error),i}function yn(i,t,e){i.prices&&(i.prices=Ge(i.prices)),R("prices",i,t,e)}function ei(i,t,e){let r=i.hasAttribute("data-wcs-osi")&&!!i.getAttribute("data-wcs-osi"),n=i.className||"",a=on.exec(n)?.[0]??"accent",o=a.includes("accent"),s=a.includes("primary"),l=a.includes("secondary"),h=a.includes("-outline"),m=a.includes("-link");i.classList.remove("accent","primary","secondary");let f;if(t.consonant)f=Pn(i,o,r,m,s);else if(m)f=i;else{let T;o?T="accent":s?T="primary":l&&(T="secondary"),f=t.spectrum==="swc"?_n(i,e,h,T,r):Ln(i,e,h,T,r)}return f}function wn(i,t){let{slot:e}=t?.description,r=i.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);r.length&&r.forEach(n=>{let a=ei(n,i,t);n.replaceWith(a)})}function En(i,t,e){i.description&&(i.description=Ge(i.description)),i.promoText&&(i.promoText=Ge(i.promoText)),i.shortDescription&&(i.shortDescription=Ge(i.shortDescription)),R("promoText",i,t,e),R("description",i,t,e),R("shortDescription",i,t,e),wn(t,e),R("callout",i,t,e),R("quantitySelect",i,t,e),R("whatsIncluded",i,t,e)}function Sn(i,t,e){if(!e.addon)return;let r=i.addon?.replace(/[{}]/g,"");if(!r||/disabled/.test(r))return;let n=A("merch-addon",{slot:"addon"},r);[...n.querySelectorAll(v)].forEach(a=>{let o=a.parentElement;o?.nodeName==="P"&&o.setAttribute("data-plan-type","")}),t.append(n)}function An(i,t,e){i.addonConfirmation&&R("addonConfirmation",i,t,e)}function Cn(i,t,e,r){r?.secureLabel&&e?.secureLabel&&t.setAttribute("secure-label",r.secureLabel)}function kn(i,t,e=!0){try{let r=typeof i!="string"?"":i,n=Jr(r);if(n.length<=t)return[r,n];let a=0,o=!1,s=e?t-Bt.length<1?1:t-Bt.length:t,l=[];for(let f of r){if(a++,f==="<")if(o=!0,r[a]==="/")l.pop();else{let T="";for(let oe of r.substring(a)){if(oe===" "||oe===">")break;T+=oe}l.push(T)}if(f==="/"&&r[a]===">"&&l.pop(),f===">"){o=!1;continue}if(!o&&(s--,s===0))break}let h=r.substring(0,a).trim();if(l.length>0){l[0]==="p"&&l.shift();for(let f of l.reverse())h+=`</${f}>`}return[`${h}${e?Bt:""}`,n]}catch{let n=typeof i=="string"?i:"",a=Jr(n);return[n,a]}}function Jr(i){if(!i)return"";let t="",e=!1;for(let r of i){if(r==="<"&&(e=!0),r===">"){e=!1;continue}e||(t+=r)}return t}function Tn(i,t){t.querySelectorAll("a.upt-link").forEach(r=>{let n=V.createFrom(r);r.replaceWith(n),n.initializeWcsData(i.osi,i.promoCode)})}function Ln(i,t,e,r,n){let a=i;n?a=customElements.get("checkout-button").createCheckoutButton({},i.innerHTML):a.innerHTML=`<span>${a.textContent}</span>`,a.setAttribute("tabindex",0);for(let m of i.attributes)["class","is"].includes(m.name)||a.setAttribute(m.name,m.value);a.firstElementChild?.classList.add("spectrum-Button-label");let o=t?.ctas?.size??"M",s=`spectrum-Button--${r}`,l=ln.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",h=["spectrum-Button",s,l];return e&&h.push("spectrum-Button--outline"),a.classList.add(...h),a}function _n(i,t,e,r,n){let a=i;n&&(a=customElements.get("checkout-button").createCheckoutButton(i.dataset),a.connectedCallback(),a.render());let o="fill";e&&(o="outline");let s=A("sp-button",{treatment:o,variant:r,tabIndex:0,size:t?.ctas?.size??"m",...i.dataset.analyticsId&&{"data-analytics-id":i.dataset.analyticsId}},i.innerHTML);return s.source=a,(n?a.onceSettled():Promise.resolve(a)).then(l=>{s.setAttribute("data-navigation-url",l.href)}),s.addEventListener("click",l=>{l.defaultPrevented||a.click()}),s}function Pn(i,t,e,r,n){let a=i;return e&&(a=customElements.get("checkout-link").createCheckoutLink(i.dataset,i.innerHTML)),r||(a.classList.add("button","con-button"),t&&a.classList.add("blue"),n&&a.classList.add("primary")),a}function Rn(i,t,e,r){if(i.ctas){i.ctas=Ge(i.ctas);let{slot:n}=e.ctas,a=A("div",{slot:n},i.ctas),o=[...a.querySelectorAll("a")].map(s=>ei(s,t,e));a.innerHTML="",a.append(...o),t.append(a)}}function zn(i,t){let{tags:e}=i,r=e?.find(a=>a.startsWith(sn))?.split("/").pop();if(!r)return;t.setAttribute(gt,r),[...t.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((a,o)=>{a.setAttribute(cn,`${a.dataset.analyticsId}-${o+1}`)})}function Mn(i){i.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,e])=>{i.querySelectorAll(`a.${t}`).forEach(r=>{r.classList.remove(t),r.classList.add("spectrum-Link",`spectrum-Link--${e}`)})})}function On(i){i.querySelectorAll("[slot]").forEach(r=>{r.remove()}),i.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","badge-background-color","badge-color","badge-text","gradient-border","size",gt].forEach(r=>i.removeAttribute(r));let e=["wide-strip","thin-strip"];i.classList.remove(...e)}async function ti(i,t){if(!i){let l=t?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${l}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${l}).`)}if(!i.fields){let l=i.id||"unknown",h=t?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${h}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${h}) is missing 'fields'.`)}let{id:e,fields:r,settings:n={},priceLiterals:a}=i,{variant:o}=r;if(!o)throw new Error(`hydrate: no variant found in payload ${e}`);On(t),t.settings=n,a&&(t.priceLiterals=a),t.id??(t.id=i.id),t.variant=o,await t.updateComplete;let{aemFragmentMapping:s}=t.variantLayout;if(!s)throw new Error(`hydrate: variant mapping not found for ${e}`);s.style==="consonant"&&t.setAttribute("consonant",!0),dn(r,t,s.mnemonics),pn(r,t,s),hn(r,t,s),mn(r,t,s.size),gn(r,t),un(r,t,s.title),fn(r,t,s),yn(r,t,s),vn(r,t,s.backgroundImage),xn(r,t,s.allowedColors,s.backgroundColor),bn(r,t,s),En(r,t,s),Sn(r,t,s),An(r,t,s),Cn(r,t,s,n),Tn(r,t),Rn(r,t,s,o),zn(r,t),Mn(t)}var qt="merch-card",Ut=2e4,ri="merch-card:";function ii(i,t){let e=i.closest(qt);if(!e)return t;e.priceLiterals&&(t.literals??(t.literals={}),Object.assign(t.literals,e.priceLiterals)),e.variantLayout?.priceOptionsProvider?.(i,t)}function $n(i){i.providers.has(ii)||i.providers.price(ii)}var In=0,Te,Le,_e,B,ne,F,ae,w,ie,ut,ni,ft,Y=class extends Nn{constructor(){super();g(this,w);g(this,Te);g(this,Le);g(this,_e);g(this,B);g(this,ne);g(this,F);g(this,ae,new Promise(e=>{p(this,F,e)}));d(this,"customerSegment");d(this,"marketSegment");d(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}firstUpdated(){this.variantLayout=Lt(this),this.variantLayout?.connectedCallbackHook()}willUpdate(e){(e.has("variant")||!this.variantLayout)&&(this.variantLayout=Lt(this),this.variantLayout?.connectedCallbackHook())}updated(e){(e.has("badgeBackgroundColor")||e.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border",this.computedBorderStyle),e.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(e)}catch(r){E(this,w,ie).call(this,`Error in postCardUpdateHook: ${r.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["ccd-slice","ccd-suggested","ah-promoted-plans","simplified-pricing-express","full-pricing-express"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector(v)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(U)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(U)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(U)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:e}){if(!this.stockOfferOsis)return;let r=this.checkoutLinks;if(r.length!==0)for(let n of r){await n.onceSettled();let a=n.value?.[0]?.planType;if(!a)return;let o=this.stockOfferOsis[a];if(!o)return;let s=n.dataset.wcsOsi.split(",").filter(l=>l!==o);e.checked&&s.push(o),n.dataset.wcsOsi=s.join(",")}}changeHandler(e){e.target.tagName==="MERCH-ADDON"&&this.toggleAddon(e.target)}toggleAddon(e){this.variantLayout?.toggleAddon?.(e);let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length===0)return;let n=a=>{let{offerType:o,planType:s}=a.value?.[0]??{};if(!o||!s)return;let l=e.getOsi(s,o),h=(a.dataset.wcsOsi||"").split(",").filter(m=>m&&m!==l);e.checked&&h.push(l),a.dataset.wcsOsi=h.join(",")};r.forEach(n)}handleQuantitySelection(e){let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length!==0)for(let n of r)n.dataset.quantity=e.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(e){let r={...this.filters};Object.keys(r).forEach(n=>{if(e){r[n].order=Math.min(r[n].order||2,2);return}let a=r[n].order;a===1||isNaN(a)||(r[n].order=Number(a)+1)}),this.filters=r}includes(e){return this.textContent.match(new RegExp(e,"i"))!==null}connectedCallback(){var r;super.connectedCallback(),c(this,Le)||p(this,Le,In++),this.aemFragment||((r=c(this,F))==null||r.call(this),p(this,F,void 0)),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let e=this.id??c(this,Le);p(this,ne,`${ri}${e}${Qe}`),p(this,Te,`${ri}${e}${Ze}`),performance.mark(c(this,ne)),p(this,B,X()),$n(c(this,B)),p(this,_e,c(this,B).Log.module(qt)),this.addEventListener(yt,this.handleQuantitySelection),this.addEventListener(wt,this.handleAddonAndQuantityUpdate),this.addEventListener(Jt,this.handleMerchOfferSelectReady),this.addEventListener(de,this.handleAemFragmentEvents),this.addEventListener(le,this.handleAemFragmentEvents),this.addEventListener("change",this.changeHandler),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(yt,this.handleQuantitySelection),this.removeEventListener(de,this.handleAemFragmentEvents),this.removeEventListener(le,this.handleAemFragmentEvents),this.removeEventListener("change",this.changeHandler),this.removeEventListener(wt,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(e){var r;if(this.isConnected&&(e.type===de&&E(this,w,ie).call(this,"AEM fragment cannot be loaded"),e.type===le&&(this.failed=!1,e.target.nodeName==="AEM-FRAGMENT"))){let n=e.detail;try{c(this,F)||p(this,ae,new Promise(a=>{p(this,F,a)})),ti(n,this)}catch(a){E(this,w,ie).call(this,`hydration has failed: ${a.message}`)}finally{(r=c(this,F))==null||r.call(this),p(this,F,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected)return;c(this,ae)&&(await c(this,ae),p(this,ae,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let e=new Promise(o=>setTimeout(()=>o("timeout"),Ut));if(this.aemFragment){let o=await Promise.race([this.aemFragment.updateComplete,e]);if(o===!1||o==="timeout"){let s=o==="timeout"?`AEM fragment was not resolved within ${Ut} timeout`:"AEM fragment cannot be loaded";E(this,w,ie).call(this,s,{},!1);return}}let r=[...this.querySelectorAll(Zt)],n=Promise.all(r.map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(s=>s.classList.contains("placeholder-resolved"))),a=await Promise.race([n,e]);if(a===!0){this.measure=performance.measure(c(this,Te),c(this,ne));let o={...this.aemFragment?.fetchInfo,...c(this,B).duration,measure:pe(this.measure)};return this.dispatchEvent(new CustomEvent(rr,{bubbles:!0,composed:!0,detail:o})),this}else{this.measure=performance.measure(c(this,Te),c(this,ne));let o={measure:pe(this.measure),...c(this,B).duration};a==="timeout"?E(this,w,ie).call(this,`Contains offers that were not resolved within ${Ut} timeout`,o):E(this,w,ie).call(this,"Contains unresolved offers",o)}}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let e=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(U)).length===2&&e&&e.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:e,items:r}}){if(!e||!r?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let a=this.checkoutLinks.find(m=>m.getAttribute("data-modal-id")===e);if(!a)return;let s=new URL(a.getAttribute("href")).searchParams.get("pa"),l=r.find(m=>m.productArrangementCode===s)?.quantity,h=!!r.find(m=>m.productArrangementCode!==s);if(l&&this.quantitySelect?.dispatchEvent(new CustomEvent(tr,{detail:{quantity:l},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==h){this.toggleStockOffer({target:this.addonCheckbox});let m=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(m,"target",{writable:!1,value:{checked:h}}),this.addonCheckbox.handleChange(m)}}get prices(){return Array.from(this.querySelectorAll(v))}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let e=this.querySelector(".price.price-alternative");if(e||(e=this.querySelector(`${v}[data-template="price"] > span`)),!!e)return e=e.innerText,e}get regularPrice(){return c(this,w,ut)?.innerText}get promotionCode(){let e=[...this.querySelectorAll(`${v}[data-promotion-code],${U}[data-promotion-code]`)].map(n=>n.dataset.promotionCode),r=[...new Set(e)];return r.length>1&&c(this,_e)?.warn(`Multiple different promotion codes found: ${r.join(", ")}`),e[0]}get annualPrice(){return this.querySelector(`${v}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(c(this,w,ni)??c(this,w,ut))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return c(this,w,ut)?.querySelector("span.price-recurrence")?.textContent?.trim()}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let e=this.querySelector('a[is="upt-link"]');if(e)return E(this,w,ft).call(this,e)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){let e=this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${U}, a`);return Array.from(e??[])}get primaryCta(){return E(this,w,ft).call(this,this.ctas.find(e=>e.variant==="accent"||e.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return E(this,w,ft).call(this,this.ctas.find(e=>e.variant!=="accent"&&!e.matches(".spectrum-Button--accent,.con-button.blue")))}};Te=new WeakMap,Le=new WeakMap,_e=new WeakMap,B=new WeakMap,ne=new WeakMap,F=new WeakMap,ae=new WeakMap,w=new WeakSet,ie=function(e,r={},n=!0){if(!this.isConnected)return;let o=this.aemFragment?.getAttribute("fragment");o=`[${o}]`;let s={...this.aemFragment.fetchInfo,...c(this,B).duration,...r,message:e};c(this,_e).error(`merch-card${o}: ${e}`,s),this.failed=!0,n&&this.dispatchEvent(new CustomEvent(ir,{bubbles:!0,composed:!0,detail:s}))},ut=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${v}[data-template="price"] > span`)},ni=function(){return this.querySelector(`${v}[data-template="legal"]`)},ft=function(e){if(e)return{text:e.innerText.trim(),analyticsId:e.dataset.analyticsId,href:e.getAttribute("href")??e.dataset.href}},d(Y,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:e=>{if(!e)return;let[r,n,a]=e.split(",");return{PUF:r,ABM:n,M2M:a}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:e=>Object.fromEntries(e.split(",").map(r=>{let[n,a,o]=r.split(":"),s=Number(a);return[n,{order:isNaN(s)?void 0:s,size:o}]})),toAttribute:e=>Object.entries(e).map(([r,{order:n,size:a}])=>[r,n,a].filter(o=>o!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:gt,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),d(Y,"styles",[Kt,...Xt()]),d(Y,"registerVariant",S),d(Y,"getCollectionOptions",Pr),d(Y,"getFragmentMapping",tt);customElements.define(qt,Y);export{Y as MerchCard};
