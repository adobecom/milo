import{LitElement as se}from"../lit-all.min.js";import{LitElement as zt,html as J,css as At}from"../lit-all.min.js";var n=class extends zt{static properties={size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0}};constructor(){super(),this.size="m",this.alt=""}render(){let{href:t}=this;return t?J`<a href="${t}">
...
`,rt=()=>[tt`
        ...
        `}return""}get secureLabelFooter(){let t=this.card.secureLabel?R`<span class="secure-transaction-label"
              ...
              >`:"";return R`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,e=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||e===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-e-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){}};import{html as U,css as Lt}from"../lit-all.min.js";function u(r,t={},e){let o=document.createElement(r);e instanceof HTMLElement?o.appendChild(e):o.innerHTML=e;for(let[a,s]of Object.entries(t))o.setAttribute(a,s);return o}function $(){return window.matchMedia("(max-width: 767px)").matches}function ot(){return window.matchMedia("(max-width: 1024px)").matches}var at="merch-offer-select:ready",nt="merch-card:ready",ct="merch-card:action-menu-toggle";var G="merch-storage:change",V="merch-quantity-selector:change";var O="aem:load",N="aem:error",it="mas:ready",st="mas:error";var dt=`
:root {
...
merch-card[variant="catalog"] .payment-details {
  ...
  font-weight: 400;
  line-height: var(--consonant-merch-card-body-line-height);
}`;var Tt={title:{tag:"h3",slot:"heading-xs"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},allowedSizes:["wide","super-wide"]},b=class extends h{constructor(t){super(t)}get aemFragmentMapping(){return Tt}renderLayout(){return U` <div class="body">
    ...
    `};import{html as I,css as _t}from"../lit-all.min.js";var ht=`
:root {
...
`;var Mt={title:{tag:"h3",slot:"heading-xs"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},y=class extends h{constructor(t){super(t)}getGlobalCSS(){return ht}get aemFragmentMapping(){return Mt}renderLayout(){return I` <div class="body">
            <slot name="icons"></slot> ${this.badge}
            <slot name="heading-xs"></slot>
            <slot name="heading-m"></slot>
            ${this.promoBottom?I`<slot name="body-xs"></slot
                      ><slot name="promo-text"></slot>`:I`<slot name="promo-text"></slot
                      ><slot name="body-xs"></slot>`}
    ...
    `};import{html as w}from"../lit-all.min.js";var lt=`
:root {
...
`;var P=class extends h{constructor(t){super(t)}getGlobalCSS(){return lt}renderLayout(){return w`${this.cardImage}
    <div class="body">
...
`;var H=class extends h{constructor(t){super(t)}getGlobalCSS(){return mt}renderLayout(){return pt` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":pt`<hr />`} ${this.secureLabelFooter}`}};import{html as D,css as Rt,unsafeCSS as ut}from"../lit-all.min.js";var gt=`
  :root {
...
`;var $t=32,E=class extends h{constructor(t){super(t)}getRowMinHeightPropertyName=t=>`--consonant-merch-card-footer-row-${t}-min-height`;getGlobalCSS(){return gt}getMiniCompareFooter=()=>{let t=this.card.secureLabel?D`<slot name="secure-transaction-label">
  ...
  `};import{html as B,css as Ot}from"../lit-all.min.js";var xt=`
:root {
...
`;var S=class extends h{constructor(t){super(t)}getGlobalCSS(){return xt}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?B`<label id="stock-checkbox">
...
`;var k=class extends h{constructor(t){super(t)}getGlobalCSS(){return vt}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return j` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
  ...
  `};import{html as K,css as Ht}from"../lit-all.min.js";var bt=`
:root {
...
`;var Dt={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},C=class extends h{constructor(t){super(t)}getGlobalCSS(){return bt}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return Dt}renderLayout(){return K`${this.cardImage}
            <div class="body">
...
`;var z=class extends h{constructor(t){super(t)}getGlobalCSS(){return yt}renderLayout(){return Bt`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
...
`;var Ut={subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"cta",size:"s"}},A=class extends h{getGlobalCSS(){return wt}get aemFragmentMapping(){return Ut}renderLayout(){return Gt`
...
`;var jt={backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{slot:"footer",size:"s"},allowedSizes:["wide"]},L=class extends h{getGlobalCSS(){return Et}get aemFragmentMapping(){return jt}renderLayout(){return It` <div class="content">
                <div class="top-section">
                  <slot name="icons"></slot> 
                  ${this.badge}
                </div>  
