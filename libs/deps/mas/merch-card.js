...
`;var Ot=class extends f{constructor(e){super(e)}getGlobalCSS(){return Ae}renderLayout(){return Te` ${this.badge}
    ...
    ${this.card.customHr?"":Te`<hr />`} ${this.secureLabelFooter}`}};import{html as ot,css as ar,unsafeCSS as Gt}from"../lit-all.min.js";var ke=`
  :root {
...
`;var nr=32,at=class extends f{constructor(t){super(t);d(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);d(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?ot`<slot name="secure-transaction-label">
  ...
  `);import{html as H,css as ir,nothing as zt}from"../lit-all.min.js";var Ce=`
:root {
...
`;var Nt={title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant"},_e={...function(){let{whatsIncluded:o,...e}=Nt;return e}(),title:{tag:"h3",slot:"heading-s"},subtitle:{tag:"p",slot:"subtitle"},secureLabel:!1},Le={...function(){let{whatsIncluded:o,size:e,quantitySelect:t,...r}=Nt;return r}()},w=class extends f{constructor(e){super(e),this.adaptForMobile=this.adaptForMobile.bind(this)}priceOptionsProvider(e,t){e.dataset.template===be&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Ce}adaptForMobile(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}let e=this.card.shadowRoot,t=e.querySelector("footer"),r=this.card.getAttribute("size"),a=e.querySelector("footer #stock-checkbox"),n=e.querySelector(".body #stock-checkbox"),i=e.querySelector(".body");if(!r){t?.classList.remove("wide-footer"),a&&a.remove();return}let s=Q();if(t?.classList.toggle("wide-footer",!s),s&&a){n?a.remove():i.appendChild(a);return}!s&&n&&(a?n.remove():t.prepend(n))}postCardUpdateHook(){this.adaptForMobile(),this.adjustTitleWidth(),this.adjustLegal(),this.adjustAddon()}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${v}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?H`<div class="divider"></div>`:zt}async adjustLegal(){if(await this.card.updateComplete,this.legalAdjusted)return;this.legalAdjusted=!0;let e=[],t=this.card.querySelector(`[slot="heading-m"] ${v}[data-template="price"]`);t&&e.push(t),this.card.querySelectorAll(`[slot="body-xs"] ${v}[data-template="price"]`).forEach(n=>e.push(n));let a=e.map(async n=>{let i=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),i.setAttribute("data-template","legal"),n.parentNode.insertBefore(i,n.nextSibling))});await Promise.all(a)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;let t=this.mainPrice;if(!t)return;await t.onceSettled();let r=t.value?.[0]?.planType;r&&(e.planType=r)}get stockCheckbox(){return this.card.checkboxLabel?H`<label id="stock-checkbox">
            ...
            ${this.plansSecureLabelFooter}`}};d(w,"variantStyle",ir`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),d(w,"collectionOptions",{customHeaderArea:()=>H`<slot name="resultsText"></slot>`,headerVisibility:{search:!1,sort:!1,custom:["desktop"]}});import{html as Vt,css as cr}from"../lit-all.min.js";var Re=`
:root {
...
`;var Oe={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},it=class extends f{constructor(e){super(e)}getGlobalCSS(){return Pe}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return Yt`${this.cardImage}
    ...
    `);var Kt=new Map,T=(o,e,t=null,r=null,a)=>{Kt.set(o,{class:e,fragmentMapping:t,style:r,collectionOptions:a})};T("catalog",rt,we,rt.variantStyle);T("image",Pt);T("inline-heading",Ot);T("mini-compare-chart",at,null,at.variantStyle);T("plans",w,Nt,w.variantStyle,w.collectionOptions);T("plans-students",w,Le,w.variantStyle,w.collectionOptions);T("plans-education",w,_e,w.variantStyle,w.collectionOptions);T("product",B,null,B.variantStyle);T("segment",nt,null,nt.variantStyle);T("special-offers",it,Oe,it.variantStyle);var Wt=(o,e=!1)=>{let t=Kt.get(o.variant);if(!t)return e?void 0:new B(o);let{class:r,style:a}=t;if(a)try{let n=new CSSStyleSheet;n.replaceSync(a.cssText),o.shadowRoot.adoptedStyleSheets.push(n)}catch{let i=document.createElement("style");i.textContent=a.cssText,o.shadowRoot.appendChild(i)}return new r(o)};function Mt(o){return Kt.get(o)?.fragmentMapping}var ze=document.createElement("style");ze.innerHTML=`
:root {
