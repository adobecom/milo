...
`,le=()=>[se`
      ...
      `];import{LitElement as Xe,html as he,css as Ze}from"../lit-all.min.js";var V=class extends Xe{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:e}=this;return e?he`<a href="${e}">
                  <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />
              </a>`:he` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};d(V,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),d(V,"styles",Ze`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-addon",J);import{html as Rt,nothing as or}from"../lit-all.min.js";var tt,ut=class ut{constructor(e){d(this,"card");m(this,tt);this.card=e,this.insertVariantStyle()}getContainer(){return h(this,tt,c(this,tt)??this.card.closest('[class*="-merch-cards"]')??this.card.parentElement),c(this,tt)}insertVariantStyle(){if(!ut.styleMap[this.card.variant]){ut.styleMap[this.card.variant]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(e,t){if(!e)return;let r=`--consonant-merch-card-${this.card.variant}-${t}-height`,a=Math.max(0,parseInt(window.getComputedStyle(e).height)||0),n=parseInt(this.getContainer().style.getPropertyValue(r))||0;a>n&&this.getContainer().style.setProperty(r,`${a}px`)}get badge(){let e;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(e=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),Rt`
        ...
        `}get cardImage(){return Rt` <div class="image">
            ...
            >`:or}get secureLabelFooter(){return Rt`<footer>${this.secureLabel}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let e=this.card.getBoundingClientRect().width,t=this.card.badgeElement?.getBoundingClientRect().width||0;e===0||t===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(e-t-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){return Mt(this.card.variant)}};tt=new WeakMap,d(ut,"styleMap",{});var f=ut;import{html as qt,css as ar}from"../lit-all.min.js";var Ee=`
:root {
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return Ee}setAriaExpanded(t,r){t.setAttribute("aria-expanded",r)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};d(et,"variantStyle",ar`
...
`;var zt=class extends f{constructor(e){super(e)}getGlobalCSS(){return Ae}renderLayout(){return Te` ${this.badge}
    ...
    ${this.card.customHr?"":Te`<hr />`} ${this.secureLabelFooter}`}};import{html as rt,css as nr,unsafeCSS as Gt}from"../lit-all.min.js";var ke=`
  :root {
...
`;var ir=32,ot=class extends f{constructor(t){super(t);d(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);d(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?rt`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(t=>t.onceSettled())),await this.adjustAddon(),W()?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};d(ot,"variantStyle",nr`
  ...
  `);import{html as at,css as cr,nothing as Nt}from"../lit-all.min.js";var Ce=`
:root {
...
`;var nt=class extends f{constructor(e){super(e)}getGlobalCSS(){return Me}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return jt` ${this.badge}
    ...
    <hr />
    ${this.secureLabelFooter}`}};d(nt,"variantStyle",dr`
...
`;var ze={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},it=class extends f{constructor(e){super(e)}getGlobalCSS(){return Pe}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return Yt`${this.cardImage}
            ...
            ${this.evergreen?Yt`
                  ...
                  `:Yt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};d(it,"variantStyle",lr`
    ...
    `);var Kt=new Map,A=(o,e,t=null,r=null)=>{Kt.set(o,{class:e,fragmentMapping:t,style:r})};A("catalog",et,we,et.variantStyle);A("image",Pt);A("inline-heading",zt);A("mini-compare-chart",ot,null,ot.variantStyle);A("plans",P,Ot,P.variantStyle);A("plans-students",P,Le,P.variantStyle);A("plans-education",P,_e,P.variantStyle);A("product",B,null,B.variantStyle);A("segment",nt,null,nt.variantStyle);A("special-offers",it,ze,it.variantStyle);var Wt=(o,e=!1)=>{let t=Kt.get(o.variant);if(!t)return e?void 0:new B(o);let{class:r,style:a}=t;if(a){let n=new CSSStyleSheet;n.replaceSync(a.cssText),o.shadowRoot.adoptedStyleSheets.push(n)}return new r(o)};function Mt(o){return Kt.get(o)?.fragmentMapping}var Ne=document.createElement("style");Ne.innerHTML=`
:root {
...
Caused by: ${this.cause}`),t}};var hr={requestId:Tt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function Oe(o){let e={};if(!o?.headers)return e;let t=o.headers;for(let[r,a]of Object.entries(hr)){let n=t.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),e[r]=n)}return e}async function $e(o,e={},t=2,r=100){let a;for(let n=0;n<=t;n++)try{let i=await fetch(o,e);return i.retryCount=n,i}catch(i){if(a=i,a.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var Be=new CSSStyleSheet;Be.replaceSync(":host { display: contents; }");var Ie="fragment",De="author",Fe="preview",Qt="aem-fragment",z,Xt=class{constructor(){m(this,z,new Map)}clear(){c(this,z).clear()}addByRequestedId(e,t){c(this,z).set(e,t)}put(e,t){c(this,z).set(e,t)}add(...e){e.forEach(t=>{let{id:r}=t;r&&c(this,z).set(r,t)})}has(e){return c(this,z).has(e)}get(e){return c(this,z).get(e)}remove(e){c(this,z).delete(e)}};z=new WeakMap;var $t=new Xt,ct,N,O,x,k,S,C,bt,vt,st,_,He,Ue,Jt,qe,Zt=class extends HTMLElement{constructor(){super();m(this,_);d(this,"cache",$t);m(this,ct);m(this,N,null);m(this,O,null);m(this,x,{url:null,retryCount:0,stale:!1,measure:null,status:null});m(this,k,null);m(this,S);m(this,C);m(this,bt,!1);m(this,vt,0);m(this,st);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[Be]}static get observedAttributes(){return[Ie,De,Fe]}attributeChangedCallback(t,r,a){t===Ie&&h(this,S,a),t===De&&h(this,bt,["","true"].includes(a)),t===Fe&&h(this,st,a)}connectedCallback(){if(!c(this,C)){if(c(this,k)??h(this,k,X(this)),h(this,st,c(this,k).settings?.preview),c(this,ct)??h(this,ct,c(this,k).log.module(`${Qt}[${c(this,S)}]`)),!c(this,S)||c(this,S)==="#"){w(this,_,Jt).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,x)).filter(([t,r])=>r!=null).map(([t,r])=>[`aem-fragment:${t}`,r]))}async refresh(t=!0){if(c(this,C)&&!await Promise.race([c(this,C),Promise.resolve(!1)]))return;t&&$t.remove(c(this,S));try{h(this,C,w(this,_,qe).call(this)),await c(this,C)}catch(i){return w(this,_,Jt).call(this,i.message),!1}let{references:r,referencesTree:a,placeholders:n}=c(this,N)||{};return this.dispatchEvent(new CustomEvent(Y,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,x)},bubbles:!0,composed:!0})),c(this,C)}get updateComplete(){return c(this,C)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,O)?c(this,O):(c(this,bt)?this.transformAuthorData():this.transformPublishData(),c(this,O))}transformAuthorData(){let{fields:t,id:r,tags:a,settings:n={}}=c(this,N);h(this,O,t.reduce((i,{name:s,multiple:l,values:p})=>(i.fields[s]=l?p:p[0],i),{fields:{},id:r,tags:a,settings:n}))}transformPublishData(){let{fields:t,id:r,tags:a,settings:n={}}=c(this,N);h(this,O,Object.entries(t).reduce((i,[s,l])=>(i.fields[s]=l?.mimeType?l.value:l??"",i),{fields:{},id:r,tags:a,settings:n}))}async generatePreview(){let{previewFragment:t}=await import("https://mas.adobe.com/studio/libs/fragment-client.js");return await t(c(this,S),{locale:c(this,k).settings.locale,apiKey:c(this,k).settings.wcsApiKey})}};ct=new WeakMap,N=new WeakMap,O=new WeakMap,x=new WeakMap,k=new WeakMap,S=new WeakMap,C=new WeakMap,bt=new WeakMap,vt=new WeakMap,st=new WeakMap,_=new WeakSet,He=async function(t){ie(this,vt)._++;let r=`${Qt}:${c(this,S)}:${c(this,vt)}`,a=`${r}${kt}`,n=`${r}${Ct}`;if(c(this,st))return await this.generatePreview();performance.mark(a);let i;try{if(c(this,x).stale=!1,c(this,x).url=t,i=await $e(t,{cache:"default",credentials:"omit"}),w(this,_,Ue).call(this,i),c(this,x).status=i?.status,c(this,x).measure=Q(performance.measure(n,a)),c(this,x).retryCount=i.retryCount,!i?.ok)throw new xt("Unexpected fragment response",{response:i,...c(this,k).duration});return await i.json()}catch(s){if(c(this,x).measure=Q(performance.measure(n,a)),c(this,x).retryCount=s.retryCount,c(this,N))return c(this,x).stale=!0,c(this,ct).error("Serving stale data",c(this,x)),c(this,N);let l=s.message??"unknown";throw new xt(`Failed to fetch fragment: ${l}`,{})}},Ue=function(t){Object.assign(c(this,x),Oe(t))},Jt=function(t){h(this,C,null),c(this,x).message=t,this.classList.add("error");let r={...c(this,x),...c(this,k).duration};c(this,ct).error(t,r),this.dispatchEvent(new CustomEvent(K,{detail:r,bubbles:!0,composed:!0}))},qe=async function(){this.classList.remove("error"),h(this,O,null);let t=$t.get(c(this,S));if(t)return h(this,N,t),!0;let{masIOUrl:r,wcsApiKey:a,locale:n}=c(this,k).settings,i=`${r}/fragment?id=${c(this,S)}&api_key=${a}&locale=${n}`;return t=await w(this,_,He).call(this,i),$t.addByRequestedId(c(this,S),t),h(this,N,t),!0};customElements.define(Qt,Zt);import{LitElement as mr,html as pr,css as gr}from"../lit-all.min.js";var dt=class extends mr{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return pr`<div class="badge">
    ...
    `);customElements.define("merch-badge",dt);import{html as ur,css as fr,LitElement as xr}from"../lit-all.min.js";var yt=class extends xr{constructor(){super()}render(){return ur`
            <slot name="icon"></slot>
