var $o=Object.defineProperty;var Cr=e=>{throw TypeError(e)};var Vo=(e,t,r)=>t in e?$o(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var u=(e,t,r)=>Vo(e,typeof t!="symbol"?t+"":t,r),_t=(e,t,r)=>t.has(e)||Cr("Cannot "+r);var E=(e,t,r)=>(_t(e,t,"read from private field"),r?r.call(e):t.get(e)),R=(e,t,r)=>t.has(e)?Cr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),N=(e,t,r,n)=>(_t(e,t,"write to private field"),n?n.call(e,r):t.set(e,r),r),X=(e,t,r)=>(_t(e,t,"access private method"),r);import{LitElement as os}from"../lit-all.min.js";import{LitElement as jo,html as Pr,css as Yo}from"../lit-all.min.js";var m=class extends jo{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:t}=this;return t?Pr`<a href="${t}">
    ...
    `);customElements.define("merch-icon",m);import{css as Nr,unsafeCSS as Rr}from"../lit-all.min.js";var K="(max-width: 767px)",et="(max-width: 1199px)",_="(min-width: 768px)",T="(min-width: 1200px)",B="(min-width: 1600px)";var Or=Nr`
    :host {
...
`,Mr=()=>[Nr`
        ...
        `}get cardImage(){return tt` <div class="image">
            ...
            ${this.badge}
              ...
              >`:"";return tt`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){}};fe=new WeakMap,u(Ie,"styleMap",{});var A=Ie;import{html as Nt,css as Wo}from"../lit-all.min.js";function U(e,t={},r=null,n=null){let o=n?document.createElement(e,{is:n}):document.createElement(e);r instanceof HTMLElement?o.appendChild(r):o.innerHTML=r;for(let[i,a]of Object.entries(t))o.setAttribute(i,a);return o}function rt(){return window.matchMedia("(max-width: 767px)").matches}function Hr(){return window.matchMedia("(max-width: 1024px)").matches}var Lt="wcms:commerce:ready";var Ir="merch-offer-select:ready",kr="merch-card:ready",Br="merch-card:action-menu-toggle";var Ct="merch-storage:change",Pt="merch-quantity-selector:change";var ge="aem:load",xe="aem:error",Dr="mas:ready",Ur="mas:error",Gr="placeholder-failed",zr="placeholder-pending",Fr="placeholder-resolved";var $r="mas:failed",Vr="mas:resolved",jr="mas/commerce";var Z="failed",ne="pending",Q="resolved",Rt={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"};var Yr=`
:root {
...
`;var nt=class extends A{constructor(t){super(t)}getGlobalCSS(){return Wr}renderLayout(){return ke`${this.cardImage}
    <div class="body">
...
`;var Ee=class extends A{constructor(t){super(t)}getGlobalCSS(){return Qr}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?it`<label id="stock-checkbox">
  ...
  `);import{html as Mt,css as Zo}from"../lit-all.min.js";var Jr=`
:root {
...
`;var oe=class extends A{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Jr}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return Mt` ${this.badge}
  ...
  `);import{html as Ht,css as Qo}from"../lit-all.min.js";var en=`
:root {
...
`;var we=class extends A{constructor(t){super(t)}getGlobalCSS(){return en}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Ht` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var Dt={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},_e=class extends A{getGlobalCSS(){return on}get aemFragmentMapping(){return Dt}renderLayout(){return oi` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
    ...
    `);var Ut=(e,t=!1)=>{switch(e.variant){case"catalog":return new be(e);case"image":return new nt(e);case"inline-heading":return new ot(e);case"mini-compare-chart":return new ye(e);case"plans":return new Ee(e);case"product":return new oe(e);case"segment":return new we(e);case"special-offers":return new Se(e);case"twp":return new Ae(e);case"ccd-suggested":return new Te(e);case"ccd-slice":return new _e(e);default:return t?void 0:new oe(e)}},an={catalog:Ot,image:null,"inline-heading":null,"mini-compare-chart":null,plans:null,product:null,segment:null,"special-offers":kt,twp:null,"ccd-suggested":Bt,"ccd-slice":Dt},sn=()=>{let e=[];return e.push(be.variantStyle),e.push(ye.variantStyle),e.push(oe.variantStyle),e.push(Ee.variantStyle),e.push(we.variantStyle),e.push(Se.variantStyle),e.push(Ae.variantStyle),e.push(Te.variantStyle),e.push(_e.variantStyle),e};var cn=document.createElement("style");cn.innerHTML=`
:root {
