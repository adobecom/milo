...
`,E=()=>{let m=[v`
    ...
    `),m};var[z,$,C,S,R,F]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var A=document.createElement("style");A.innerHTML=`
:root {
