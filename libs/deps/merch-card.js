// branch: MWPW-152181 commit: 765c49bb7c10a5dbb34fa081054f5f32a61c9c79 Tue, 30 Jul 2024 05:53:02 GMT
import{html as o,LitElement as ae,nothing as oe}from"/libs/deps/lit-all.min.js";import{LitElement as J,html as O,css as X}from"/libs/deps/lit-all.min.js";var h=class extends J{static properties={size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0}};constructor(){super(),this.size="m",this.alt=""}render(){let{href:e}=this;return e?O`<a href="${e}">
...
`,F=()=>{let c=[A`
    ...
    `),c};var[U,V,W,G,K,Ge]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Y=document.createElement("style");Y.innerHTML=`
:root {
