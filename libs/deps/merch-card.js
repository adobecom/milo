...
`,d=(r,e=!0)=>{let t=[b`
        ...
        `),t};var[v,y,$,z,E,S]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var C=document.createElement("style"),m=r=>`
@media screen and ${u} {
    .one-merch-card.${r},
    .two-merch-cards.${r},
    .three-merch-cards.${r},
