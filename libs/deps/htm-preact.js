// v3.1.0 from https://unpkg.com/htm@3.1.0/preact/standalone.module.js
/* c8 ignore start */
var e,
  n,
  _,
...
function a(n, _, t) {
  ...
  if (
    (arguments.length > 2 && (l.children = arguments.length > 3 ? e.call(arguments, 2) : t),
...
function m(e) {
  ((!e.__d && (e.__d = !0) && t.push(e) && !g.__r++) || r !== n.debounceRendering) &&
  ...
  for (_.__k = [], a = 0; a < n.length; a++)
    if (
      ...
      P(e, m, (y = y || l), o, r, u, c, s, f),
        ...
        (d = m.ref) &&
          y.ref != d &&
          (x || (x = []), y.ref && x.push(y.ref, null, m), x.push(d, m.__c || g, m)),
        null != g
          ? (null == k && (k = g),
            'function' == typeof m.type && null != m.__k && m.__k === y.__k
              ? (m.__d = s = b(m, s, e))
              : (s = C(e, m, y, H, g, s)),
            f || 'option' !== _.type ? 'function' == typeof _.type && (_.__d = s) : (e.value = ''))
...
function b(e, n, _) {
  ...
  for (t = 0; t < e.__k.length; t++)
    (o = e.__k[t]) &&
      ((o.__ = e), (n = 'function' == typeof o.type ? b(o, n, _) : C(_, o, o, e.__k, o.__e, n)));
  return n;
}
...
function x(e, n, _) {
  '-' === n[0]
    ? e.setProperty(n, _)
    : (e[n] = null == _ ? '' : 'number' != typeof _ || c.test(n) ? _ : _ + 'px');
}
      ...
      if (
        ...
        t.__c
          ...
          : ('prototype' in E && E.prototype.render
              ? (_.__c = a = new E(b, x))
              : ((_.__c = a = new d(b, x)), (a.constructor = E), (a.render = A)),
            C && C.sub(a),
            (a.props = b),
            a.state || (a.state = {}),
            (a.context = x),
...
(e = i.slice),
        ...
        if ((_ = n.__c) && !_.__)
          try {
            if (
              ...
              null != _.componentDidCatch && (_.componentDidCatch(e), (o = _.__d)),
              o)
            )
              return (_.__E = _);
          } catch (n) {
  ...
  (d.prototype.setState = function (e, n) {
    var _;
    (_ = null != this.__s && this.__s !== this.state ? this.__s : (this.__s = s({}, this.state))),
...
function ee(e) {
  var n = N.context[e.__c],
    _ = j(L++, 9);
  return (_.c = e), n ? (null == _.__ && ((_.__ = !0), n.sub(N)), n.props.value) : e.__;
}
function ne(e, _) {
                    ...
                    1 === t
                      ...
                      : t &&
                        ('=' === n
                          ? ((t = 5), (_ = o), (o = ''))
                          : '/' === n && (t < 5 || '>' === e[i][c + 1])
                          ? (l(), 3 === t && (u = u[0]), (t = u), (u = u[0]).push(2, 0, t), (t = 0))
                          : ' ' === n || '\t' === n || '\n' === n || '\r' === n
                          ? (l(), (t = 2))
                          : (o += n)),
                    3 === t && '!--' === o && ((t = 4), (u = u[0]));
