    ...
    namespace Commerce {
        ...
        interface Instance
            ...
            readonly providers: {
                 ...
                 */
                placeholder(provider: Checkout.provideCheckoutOptions): () => void;
                /**
        ...
        module Checkout {
            ...
            interface PlaceholderConstructor
                ...
                getCheckoutLinks(container?: HTMLElement): Placeholder[];
            }
        ...
        module Price {
            ...
            interface PlaceholderConstructor
                 ...
                 */
                getInlinePrices(container?: HTMLElement): Placeholder[];
            }
...
export declare const TAG_NAME_COMMERCE_SERVICE: string;
 ...
 * When called for first time with `callback` function provided
