...
const API_ENDPOINTS = {
  stage: 'https://14257-miloemailcollection-dev.adobeioruntime.net/api/v1/web/email-collection',
  ...
  return [
    ...
    (el) => {
      ...
      if (!fields.email
        || !metadata.campaignId
        || !metadata.mpsSname
        || !metadata.consentId) return 'Section metadata is missing email/campaing-id/mps-sname/consent-id field';
