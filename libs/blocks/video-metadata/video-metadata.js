...
function addBroadcastEventField(videoObj, blockKey, blockValue) {
  ...
  switch (key) {
    ...
    case 'end-date':
      ...
      break;
    default:
      window.lana.log(`VideoMetadata -- Unknown BroadcastEvent property: ${blockKey}`, { tags: 'video-metadata', severity: 'warning' });
      break;
  }
}
...
function addClipField(videoObj, blockKey, blockValue) {
  ...
  switch (key) {
    ...
    case 'url':
      ...
      break;
    default:
      window.lana.log(`VideoMetadata -- Unhandled Clip property: ${blockKey}`, { tags: 'video-metadata', severity: 'warning' });
      break;
  }
}
...
function addSeekToActionField(videoObj, blockKey, blockValue) {
  ...
  switch (key) {
    ...
    case 'start-offset-input':
      ...
      break;
    default:
      window.lana.log(`VideoMetadata -- Unhandled SeekToAction property: ${blockKey}`, { tags: 'video-metadata', severity: 'warning' });
      break;
  }
}
  ...
  Object.entries(record).forEach(([key, blockVal]) => {
    ...
    switch (true) {
      ...
      case SEEK_TO_ACTION_RE.test(blockKey):
        ...
        break;
      default:
        window.lana.log(`VideoMetadata -- Unhandled VideoObject property: ${blockKey}`, { tags: 'video-metadata', severity: 'warning' });
        break;
    }
  });
