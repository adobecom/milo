...
function getSidenav(collection) {
  ...
  // Add role="button" to filter items for better screen reader UX
  // Filter items change content on the page rather than navigate, so button role is more appropriate
