...
function getHardcodedFallbackStep(wcsOsi, checkoutClientId) {
  ...
  const osiToStepMap = {
    ...
    'VQpXGYJh-MBOcGPvokz_INgE88dj3KIyMJaU-iIQxlY': 'recommendation',
    'b-xXdWqVkpll0yBirom1c4bI3FwdXvNCy1HtHZV2yfU': 'recommendation',
    ZfP6XPHxvTFnOS_Hd4q9taPkKHinmf6PCozeJEmzqNI: 'recommendation',
    'NNe0xkjqasLN3Q0ASuv3ZB4zSQW-iVN4TBoHOkQBEOA': 'recommendation',
    zX46r0tn5frbNvEMCdBg5WhZnq2hfl0qamka1iZGKTY: 'recommendation',
