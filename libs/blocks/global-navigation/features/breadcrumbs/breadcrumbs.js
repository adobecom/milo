...
const createWithBase = async (el) => {
  ...
  try {
    ...
    lanaLog({ e, message: 'Breadcrumbs failed fetching base' ,  tags: ['info', 'gnav-breadcrumbs']});
    return null;
  }
};
...
export default async function init(el) {
  try {
    ...
    lanaLog({ e, message: 'Breadcrumbs failed rendering' ,  tags: ['error', 'gnav-breadcrumbs']});
    return null;
  }
}
