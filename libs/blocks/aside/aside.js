...
function decorateLayout(el) {
  ...
  const foregroundMedia = foreground.querySelector(':scope > div:not(.text) :is(.video-container, video, a[href*=".mp4"], a[href*="tv.adobe.com"])')?.closest('div:not(.video-container)');
