...
const FOCUSABLES = 'a:not(.hide-video), button:not([disabled], .locale-modal-v2 .paddle), input:not([disabled]), textarea, select:not([disabled]), details, [tabindex]:not([tabindex="-1"])';
