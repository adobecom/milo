...
const SortPanel = () => {
  ...
  const SortOptions = html`
    ...
    <div class="sort-options">
      ...
      <${Input} label="Last Modified: (Oldest to Newest)" prop="sortModifiedAsc" type="checkbox" />
      <${Input} label="Last Modified: (Newest to Oldest)" prop="sortModifiedDesc" type="checkbox" />
