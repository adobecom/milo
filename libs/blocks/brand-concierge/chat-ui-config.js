export default {
  ...
  behavior: {
    ...
    input: {
      ...
      showAiChatIcon: { icon: '<svg title="Ask" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg"><mask id="bc-chat-mask" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="26" height="26"><path d="M8.1248 24.6975C7.99531 24.6975 7.86582 24.6721 7.74267 24.62C7.38339 24.4664 7.1498 24.1135 7.1498 23.7225V19.4975H6.1748C3.48721 19.4975 1.2998 17.3101 1.2998 14.6225V7.47247C1.2998 4.78488 3.48721 2.59747 6.1748 2.59747H11.3139C11.8521 2.59747 12.2889 3.0342 12.2889 3.57247C12.2889 4.11075 11.8521 4.54747 11.3139 4.54747H6.1748C4.56251 4.54747 3.2498 5.86017 3.2498 7.47247V14.6225C3.2498 16.2348 4.56251 17.5475 6.1748 17.5475H8.1248C8.66308 17.5475 9.0998 17.9842 9.0998 18.5225V21.4297L12.8487 17.8204C13.0303 17.6452 13.2728 17.5475 13.5254 17.5475H19.8248C21.4371 17.5475 22.7498 16.2348 22.7498 14.6225V12.9696C22.7498 12.4313 23.1865 11.9945 23.7248 11.9945C24.2631 11.9945 24.6998 12.4313 24.6998 12.9696V14.6225C24.6998 17.3101 22.5124 19.4975 19.8248 19.4975H13.9189L8.80147 24.4245C8.61611 24.6035 8.37236 24.6975 8.1248 24.6975Z" fill="#292929"></path><path d="M17.2617 11.8079C17.0167 11.8079 16.7704 11.7444 16.5482 11.6162C16.0074 11.3052 15.7332 10.6869 15.8639 10.0775L16.4619 7.31505L14.5639 5.22159C14.145 4.75948 14.0726 4.0879 14.3837 3.54835C14.696 3.0088 15.3206 2.73458 15.9223 2.86407L18.6848 3.46202L20.7783 1.56407C21.2404 1.14639 21.9158 1.0753 22.4515 1.3838C22.9924 1.69484 23.2666 2.31309 23.1358 2.92247L22.5379 5.68497L24.4358 7.77842C24.8548 8.24053 24.9271 8.91211 24.6161 9.45166C24.3038 9.99249 23.6843 10.2692 23.0774 10.1359L20.3149 9.538L18.2215 11.4359C17.9511 11.681 17.6083 11.8079 17.2617 11.8079ZM17.0979 5.11367L18.0856 6.20293C18.3929 6.53808 18.5211 7.01034 18.4246 7.4623L18.1136 8.90196L19.2028 7.91426C19.5392 7.60703 20.0166 7.48008 20.4622 7.5753L21.9018 7.88633L20.9141 6.79708C20.6069 6.46192 20.4787 5.98966 20.5752 5.5377L20.8862 4.09806L19.797 5.08576C19.4618 5.39425 18.987 5.52374 18.5376 5.42472L17.0979 5.11367Z" fill="#292929"></path><path d="M10.3125 14.9551C10.1449 14.9551 9.97734 14.912 9.82499 14.8243C9.45809 14.6123 9.2702 14.1883 9.35907 13.7744L9.59012 12.708L8.8576 11.9006C8.57322 11.587 8.5237 11.1249 8.73572 10.758C8.94774 10.3911 9.37429 10.2109 9.78563 10.2921L10.852 10.5232L11.6594 9.79064C11.9743 9.50627 12.4339 9.45675 12.802 9.66877C13.1689 9.88078 13.3568 10.3048 13.2679 10.7187L13.0369 11.7851L13.7694 12.5925C14.0538 12.9061 14.1033 13.3682 13.8913 13.7351C13.6793 14.102 13.2515 14.2861 12.8414 14.201L11.775 13.9699L10.9676 14.7025C10.7835 14.8688 10.5486 14.9551 10.3125 14.9551Z" fill="#292929"></path></mask><g mask="url(#bc-chat-mask)"><rect width="26" height="26" fill="url(#bc-chat-fill)"></rect></g><defs><linearGradient id="bc-chat-fill" x1="-4.82083" y1="7.8963" x2="35.6711" y2="13.6628" gradientUnits="userSpaceOnUse"><stop offset="0.059183" stop-color="#9A3CF9"></stop><stop offset="0.344409" stop-color="#E743C8"></stop><stop offset="0.58317" stop-color="#ED457E"></stop><stop offset="0.84223" stop-color="#FF7918"></stop></linearGradient></defs></svg>' },
    },
    chat: {
  ...
  theme: {
    ...
    '--citations-button-padding': '9px 8px 9px 11px',
