...
const PADLOCK_IMG = `<img class="secure-transaction-icon-img" loading="lazy" alt="secure-transaction-icon icon" src="${base}/blocks/merch-pod/img/secure-transaction-icon.svg" height="12" width="15">`;
...
const decorateFooter = (el, podType) => {
  ...
  const decorateWithSecureTransactionSign = () => {
    ...
    const secureElement = createTag('span', { class: 'secure-transaction-icon' }, PADLOCK_IMG);
