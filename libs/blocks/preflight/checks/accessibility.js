/**
 * Preflight accessibility check used by the API and captureMetrics.
 * Runs axe-core & a11y checks to return a result compatible with the
 * getPreflightResults so accessibility can be included in the metrics payload
 * sent to the backend. The preflight modal UI uses the same runAccessibilityTest
 * via the accessibility block.
 */
