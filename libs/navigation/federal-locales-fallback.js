/*
 * Snapshot of federal/utils/locales.js, vendored as a fallback for when the
 * live cross-origin fetch in navigation.js (resolveLocales) fails (CORS,
 * network error, federal origin down). Pulled from
 * https://main--federal--adobecom.aem.page/federal/utils/locales.js.
 * This is a point-in-time copy and will drift from the source over time;
 * update it periodically rather than treating it as authoritative.
 */
export default {
