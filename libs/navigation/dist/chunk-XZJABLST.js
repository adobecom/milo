...
async function createMartechMetadata(placeholders, config, column) {
  ...
  await import("./attributes-JBNSX35B.js").then(({ processTrackingLabels }) => {
...
var combineMepSources = async (persEnabled, promoEnabled, mepParam) => {
  ...
  if (promoEnabled) {
    const { default: getPromoManifests } = await import("./promo-utils-7ZAMIX3W.js");
...
async function callMartech(config) {
  const { getTargetPersonalization } = await import("./martech-WZTIIXGW.js");
...
//# sourceMappingURL=chunk-XZJABLST.js.map
