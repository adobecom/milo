...
// bootstrapper.js
async function bootstrapBlock(initBlock, blockConfig) {
  const { name, targetEl, layout, noBorder, jarvis } = blockConfig;
  const { getConfig, createTag, loadScript } = await import("./utils-IERWOBZX.js");
  const setNavLayout = () => {
  ...
  if (blockConfig.targetEl === "footer") {
    const { loadPrivacy } = await import("./delayed-CEINYTGH.js");
    setTimeout(() => {
...
export {
  bootstrapBlock as default
};
//# sourceMappingURL=bootstrapper-OPTZNGC6.js.map
