...
var setupKeyboardNav = async () => {
  keyboardNav = keyboardNav || new Promise(async (resolve) => {
    const { default: KeyboardNavigation } = await import("./keyboard-XYUA6ROY.js");
...
var Gnav = class {
      ...
      try {
        ...
        if (this.searchPresent()) {
          const [
            ...
            import("./gnav-search-RC54QTIH.js"),
  ...
  decorateAppPrompt = async ({ getAnchorState } = {}) => {
    ...
    const [
      ...
      import("./webapp-prompt-SDK5JF5J.js"),
  ...
  decorateGenericLogo = ({ selector, classPrefix, includeLabel = true, analyticsValue } = {}) => {
    ...
    const imageEl = renderImage ? toFragment`<span class="${classPrefix}-image">${getImageEl()}</span>` : "";
  ...
  decorateAside = async () => {
    ...
    const { default: decorate } = await import("./aside-WAJVO34U.js");
  ...
  decorateBreadcrumbs = async () => {
    ...
    const { default: createBreadcrumbs } = await import("./breadcrumbs-DSP4XQ77.js");
...
var getSource = async () => {
  ...
  if (dynamicNavKey) {
    const { default: dynamicNav } = await import("./dynamic-navigation-VPFP6RV7.js");
...
//# sourceMappingURL=global-navigation-HE6AFK52.js.map
