...
async function init(a) {
  ...
  if (mep?.fragments?.[path]) {
    const { handleFragmentCommand } = await import("./personalization-DCXT7K44.js");
  ...
  if (a.dataset.manifestId || a.dataset.adobeTargetTestid) {
    const { updateFragDataProps } = await import("./personalization-DCXT7K44.js");
    updateFragDataProps(a, inline, sections, fragment);
  }
  if (mep?.commands?.length) {
    const { handleCommands } = await import("./personalization-DCXT7K44.js");
...
//# sourceMappingURL=fragment-WO6WLZWW.js.map
