...
var insertInlineFrag = (sections, a, relHref) => {
...
async function init(a) {
  ...
  if (mep?.fragments?.[path]) {
    const { handleFragmentCommand } = await import("./personalization-CN5N3ZMO.js");
  ...
  if (a.dataset.manifestId || a.dataset.adobeTargetTestid || mep?.commands?.length || placeholders) {
    const { updateFragDataProps, handleCommands, replacePlaceholders } = await import("./personalization-CN5N3ZMO.js");
...
//# sourceMappingURL=fragment-WRBFU54Z.js.map
