...
var Footer = class {
  ...
  decorateRegionPicker = async () => {
    ...
    if (url.hash !== "") {
      ...
      const { default: initModal } = await import("./modal-JZCKO3U4.js");
      ...
      const loadRegionNav = async () => {
        ...
        if (block) {
          ...
          const { default: initRegionNav } = await import("./region-nav-XIO725PL.js");
          initRegionNav(block);
      ...
      const { default: loadRegionSelector } = await import("./region-nav-XIO725PL.js");
      loadStyle(`${base}/blocks/region-nav/region-nav.css`);
...
//# sourceMappingURL=global-footer-RKXQBHDV.js.map
