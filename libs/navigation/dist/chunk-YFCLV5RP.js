...
var getBlockProps = (fVal, miloLibs, origin) => {
  let val = fVal;
...
async function createMartechMetadata(placeholders, config, column) {
  ...
  await import("./attributes-72BJCYAO.js").then(({ processTrackingLabels }) => {
...
var combineMepSources = async (persEnabled, promoEnabled, mepParam) => {
  ...
  if (promoEnabled) {
    const { default: getPromoManifests } = await import("./promo-utils-TBPN5XQU.js");
...
async function callMartech(config) {
  const { getTargetPersonalization } = await import("./martech-IAZXAYEY.js");
...
//# sourceMappingURL=chunk-YFCLV5RP.js.map
