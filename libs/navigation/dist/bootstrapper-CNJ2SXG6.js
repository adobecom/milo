...
async function bootstrapBlock(initBlock, blockConfig) {
  ...
  const { getConfig, createTag, loadScript } = await import("./utils-5PPNVIT6.js");
  const setNavLayout = () => {
  ...
  if (blockConfig.targetEl === "footer") {
    const { loadPrivacy } = await import("./delayed-HNOHT2CA.js");
    setTimeout(() => {
...
//# sourceMappingURL=bootstrapper-CNJ2SXG6.js.map
