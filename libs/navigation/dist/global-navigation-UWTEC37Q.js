...
var setupKeyboardNav = async () => {
  keyboardNav = keyboardNav || new Promise(async (resolve) => {
    const { default: KeyboardNavigation } = await import("./keyboard-S6OXUVVP.js");
...
var Gnav = class {
      ...
      try {
        ...
        if (this.searchPresent()) {
          const [
            ...
            import("./gnav-search-CZSWEN73.js"),
  ...
  decorateAppPrompt = async ({ getAnchorState } = {}) => {
    ...
    const [
      ...
      import("./webapp-prompt-D4XVB3ZL.js"),
  ...
  decorateAside = async () => {
    ...
    const { default: decorate } = await import("./aside-3A4QYQCL.js");
  ...
  decorateBreadcrumbs = async () => {
    ...
    const { default: createBreadcrumbs } = await import("./breadcrumbs-TABD6U2G.js");
...
var getSource = async () => {
  ...
  if (dynamicNavKey) {
    const { default: dynamicNav } = await import("./dynamic-navigation-3LHZLN6G.js");
...
//# sourceMappingURL=global-navigation-UWTEC37Q.js.map
