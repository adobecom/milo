...
// ../martech/attributes.js
var INVALID_CHARACTERS = /[^\u00C0-\u1FFF\u2C00-\uD7FF\w]+/g;
var LEAD_UNDERSCORES = /^_+|_+$/g;
...
var RE_ALPHANUM = /[^0-9a-z]/gi;
var RE_TRIM_UNDERSCORE = /^_+|_+$/g;
var analyticsGetLabel = (txt) => txt.replaceAll("&", "and").replace(RE_ALPHANUM, "_").replace(RE_TRIM_UNDERSCORE, "");
var analyticsDecorateList = (li, idx) => {
...
//# sourceMappingURL=chunk-JW7KOVAP.js.map
