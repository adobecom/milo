// Auto-scaffolded smoke fixture for the authored Milo block forge-work-smarter-than-ever-with-documents.
...
describe('forge-work-smarter-than-ever-with-documents', () => {
  ...
  it('decorates the EDS-rendered block and stamps the forge marker', async () => {
    ...
    const block = document.querySelector('.forge-work-smarter-than-ever-with-documents');
    expect(block, 'mock body has the block root').to.exist;
    await init(block);
    expect(block.dataset.forgeAuthored).to.equal('forge-work-smarter-than-ever-with-documents');
  });
});
