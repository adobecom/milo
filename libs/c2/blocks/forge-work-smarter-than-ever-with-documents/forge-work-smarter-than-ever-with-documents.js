/**
 * forge-work-smarter-than-ever-with-documents — a Milo C2 block authored by Forge for a section that matched no
 ...
 * (`block > div > div > <content>`). The scoped stylesheet `forge-work-smarter-than-ever-with-documents.css`
