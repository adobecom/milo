/**
 * forge-create-at-the-highest-level — a Milo C2 block authored by Forge for a section that matched no
 ...
 * (`block > div > div > <content>`). The scoped stylesheet `forge-create-at-the-highest-level.css`
...
const BLOCK = 'forge-create-at-the-highest-level';
