/**
 * forge-remove-background-from-your-image-for-free — a Milo C2 block authored by Forge for a section that matched no
 ...
 * (`block > div > div > <content>`). The scoped stylesheet `forge-remove-background-from-your-image-for-free.css`
...
const BLOCK = 'forge-remove-background-from-your-image-for-free';
