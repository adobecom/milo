...
// truncates it.
const CARD_OPEN_DAA_LL = 'card_open--firefly_globe';
const ENTER_GALLERY_DAA_LL = 'enter_gallery_kbd--firefly_globe';
...
export default function createGalleryA11y({
  ...
  function setup() {
    ...
    ['.firefly-globe-a11y', '.firefly-globe-a11y-cards'].forEach((sel) => {
    ...
    widgetEl.className = 'firefly-globe-a11y';
    ...
    if (galleryInstructions) {
      ...
      descEl.className = 'firefly-globe-a11y-tip';
      descEl.id = `firefly-globe-a11y-desc-${gid}`;
    ...
    cardsEl.className = 'firefly-globe-a11y-cards';
    cardsEl.inert = true;
    ...
    for (let n = 0; n < count; n += 1) {
      ...
      btn.type = 'button';
      btn.className = 'firefly-globe-a11y-card';
