// Auto-scaffolded smoke fixture for the authored Milo block forge-explore-what-s-new.
...
describe('forge-explore-what-s-new', () => {
  ...
  it('decorates the EDS-rendered block and stamps the forge marker', async () => {
    ...
    await init(block);
    expect(block.dataset.forgeAuthored).to.equal('forge-explore-what-s-new');
  });
});
