/**
 * forge-keep-the-momentum-going — a Milo C2 block authored by Forge for a section that matched no
 ...
 * (`block > div > div > <content>`). The scoped stylesheet `forge-keep-the-momentum-going.css`
...
const BLOCK = 'forge-keep-the-momentum-going';
