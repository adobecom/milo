/**
 * forge-create-beautifully-with-adobe-express — a Milo C2 block authored by Forge for a section that matched no
 ...
 * (`block > div > div > <content>`). The scoped stylesheet `forge-create-beautifully-with-adobe-express.css`
...
const BLOCK = 'forge-create-beautifully-with-adobe-express';
