// Auto-scaffolded smoke fixture for the authored Milo block forge-create-beautifully.
...
describe('forge-create-beautifully', () => {
  ...
  it('decorates the EDS-rendered block and stamps the forge marker', async () => {
    ...
    await init(block);
    expect(block.dataset.forgeAuthored).to.equal('forge-create-beautifully');
  });
});
