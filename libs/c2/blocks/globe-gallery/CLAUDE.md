...
- **All eight shipped JS files (`globe-gallery.js`, `src/authoring.js`, `src/shaders.js`,
  ...
  exceptions: 3 `no-use-before-define` in `globe-gallery.js` for genuine forward refs (the rAF
