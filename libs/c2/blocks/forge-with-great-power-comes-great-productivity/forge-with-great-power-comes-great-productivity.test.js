// Auto-scaffolded smoke fixture for the authored Milo block forge-with-great-power-comes-great-productivity.
...
describe('forge-with-great-power-comes-great-productivity', () => {
  ...
  it('decorates the EDS-rendered block and stamps the forge marker', async () => {
    ...
    const block = document.querySelector('.forge-with-great-power-comes-great-productivity');
