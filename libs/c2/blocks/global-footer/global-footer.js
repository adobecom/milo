...
const ADOBE_LOGO = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 179.35 46.86">
  <path d="M76.93,30.93l-1.92,5.93c-0.08,0.2-0.2,0.32-0.44,0.32h-4.64c-0.28,0-0.36-0.16-0.32-0.4l8.01-23.1
...
class Footer {
  ...
  decorateLogo = () => {
    const logoClass = isDarkMode() ? 'dark-logo' : 'light-logo';
    return toFragment`
      <span class="footer-logo" role="img" aria-label="Adobe">
        <span class="footer-logo-image ${logoClass}">${ADOBE_LOGO}</span>
      </span>`;
  };
