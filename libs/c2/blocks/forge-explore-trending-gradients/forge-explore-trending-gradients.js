/**
 * forge-explore-trending-gradients — a Milo C2 block authored by Forge for a section that matched no
 ...
 * (`block > div > div > <content>`). The scoped stylesheet `forge-explore-trending-gradients.css`
...
const BLOCK = 'forge-explore-trending-gradients';
