// forge-jump — Milo block authored by Forge from a section that matched no
// existing C2 block. EDS wraps the table-cell content in extra `<div>` row/cell
// wrappers (`block > div > div > <content>`); the scoped CSS in forge-jump.css
...
export default async function init(el) {
  ...
  el.dataset.forgeAuthored = 'forge-jump';
}
