// Auto-scaffolded smoke fixture for the authored Milo block forge-get-acrobat-studio-today-1.
...
describe('forge-get-acrobat-studio-today-1', () => {
  ...
  it('decorates the EDS-rendered block and stamps the forge marker', async () => {
    ...
    await init(block);
    expect(block.dataset.forgeAuthored).to.equal('forge-get-acrobat-studio-today-1');
  });
});
