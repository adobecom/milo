/**
 * forge-promo-mockup — a Milo C2 block authored by Forge for a section that matched no
 ...
 * (`block > div > div > <content>`). The scoped stylesheet `forge-promo-mockup.css`
...
const BLOCK = 'forge-promo-mockup';
