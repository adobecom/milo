...
export const PERSONALIZATION_TAGS = {
  ...
  android: () => PERSONALIZATION_TAGS['mobile-device']() && !PERSONALIZATION_TAGS.mac(),
  ios: () => /iPad|iPhone|iPod|Macintosh/.test(navigator.userAgent) && PERSONALIZATION_TAGS['mobile-device'](),
  windows: () => navigator.userAgent.includes('Windows'),
  mac: () => navigator.userAgent.includes('Macintosh') && PERSONALIZATION_TAGS.desktop(),
  'mobile-device': () => navigator.maxTouchPoints > 1 && !PERSONALIZATION_TAGS.windows(),
