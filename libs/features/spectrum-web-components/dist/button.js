...
import{SizedMixin as B}from"/libs/features/spectrum-web-components/dist/base.js";import{property as i}from"/libs/features/spectrum-web-components/dist/base.js";import{html as b}from"/libs/features/spectrum-web-components/dist/base.js";import{property as p,query as k}from"/libs/features/spectrum-web-components/dist/base.js";import{LikeAnchor as w}from"/libs/features/spectrum-web-components/dist/shared.js";import{Focusable as x}from"/libs/features/spectrum-web-components/dist/shared.js";import{ObserveSlotText as z}from"/libs/features/spectrum-web-components/dist/shared.js";import{css as h}from"/libs/features/spectrum-web-components/dist/base.js";var y=h`
...
`,v=E;var q=Object.defineProperty,L=Object.getOwnPropertyDescriptor,l=(s,t,o,e)=>{for(var r=e>1?void 0:e?L(t,o):t,n=s.length-1,u;n>=0;n--)(u=s[n])&&(r=(e?u(t,o,r):u(r))||r);return e&&r&&q(t,o,r),r},C=["accent","primary","secondary","negative","white","black"];var c=class extends B(a,{noDefaultSize:!0}){constructor(){super(...arguments),this._variant="accent",this.treatment="fill"}static get styles(){return[...super.styles,v]}get variant(){return this._variant}set variant(t){if(t!==this.variant){switch(this.requestUpdate("variant",this.variant),t){case"cta":this._variant="accent";break;case"overBackground":this.removeAttribute("variant"),this.static="white",this.treatment="outline";return;case"white":case"black":this.static=t,this.removeAttribute("variant");return;case null:return;default:C.includes(t)?this._variant=t:this._variant="accent";break}this.setAttribute("variant",this.variant)}}set quiet(t){this.treatment=t?"outline":"fill"}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("variant")||this.setAttribute("variant",this.variant)}};l([i()],c.prototype,"variant",1),l([i({type:String,reflect:!0})],c.prototype,"static",2),l([i({reflect:!0})],c.prototype,"treatment",2),l([i({type:Boolean})],c.prototype,"quiet",1);import{defineElement as P}from"/libs/features/spectrum-web-components/dist/base.js";P("sp-button",c);
