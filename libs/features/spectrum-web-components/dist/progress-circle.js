...
import{html as d,SizedMixin as h,SpectrumElement as b}from"/libs/features/spectrum-web-components/dist/base.js";import{property as i,query as v}from"/libs/features/spectrum-web-components/dist/base.js";import{getLabelFromSlot as k}from"/libs/features/spectrum-web-components/dist/shared.js";import{ifDefined as z}from"/libs/features/spectrum-web-components/dist/base.js";import{css as g}from"/libs/features/spectrum-web-components/dist/base.js";var f=g`
...
`,m=f;var p=Object.defineProperty,u=Object.getOwnPropertyDescriptor,s=(c,r,a,o)=>{for(var e=o>1?void 0:o?u(r,a):r,n=c.length-1,l;n>=0;n--)(l=c[n])&&(e=(o?l(r,a,e):l(e))||e);return o&&e&&p(r,a,e),e},t=class extends h(b,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.indeterminate=!1,this.label="",this.overBackground=!1,this.progress=0}static get styles(){return[m]}makeRotation(r){return this.indeterminate?void 0:`transform: rotate(${r}deg);`}willUpdate(r){r.has("overBackground")&&(this.static=this.overBackground?"white":this.static||void 0)}render(){let r=[this.makeRotation(-180+3.6*Math.min(this.progress,50)),this.makeRotation(-180+3.6*Math.max(this.progress-50,0))],a=["Mask1","Mask2"];return d`
        ...
        `}handleSlotchange(){let r=k(this.label,this.slotEl);r&&(this.label=r)}firstUpdated(r){super.firstUpdated(r),this.hasAttribute("role")||this.setAttribute("role","progressbar")}updated(r){super.updated(r),!this.indeterminate&&r.has("progress")?this.setAttribute("aria-valuenow",""+this.progress):this.hasAttribute("aria-valuenow")&&this.removeAttribute("aria-valuenow"),r.has("label")&&(this.label.length?this.setAttribute("aria-label",this.label):this.removeAttribute("aria-label"))}};s([i({type:Boolean,reflect:!0})],t.prototype,"indeterminate",2),s([i({type:String})],t.prototype,"label",2),s([i({type:Boolean,reflect:!0,attribute:"over-background"})],t.prototype,"overBackground",2),s([i({reflect:!0})],t.prototype,"static",2),s([i({type:Number})],t.prototype,"progress",2),s([v("slot")],t.prototype,"slotEl",2);import{defineElement as y}from"/libs/features/spectrum-web-components/dist/base.js";y("sp-progress-circle",t);
