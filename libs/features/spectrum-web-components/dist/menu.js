...
import{html as E,SizedMixin as z,SpectrumElement as R}from"/libs/features/spectrum-web-components/dist/base.js";import{property as u,query as D}from"/libs/features/spectrum-web-components/dist/base.js";import{css as S}from"/libs/features/spectrum-web-components/dist/base.js";var C=S`
...
`,x=U;import W from"/libs/features/spectrum-web-components/dist/icons/checkmark.js";var b=class{constructor(e,{target:t,config:o,callback:i,skipInitial:r}){this.t=new Set,this.o=!1,this.i=!1,this.h=e,t!==null&&this.t.add(t??e),this.l=o,this.o=r??this.o,this.callback=i,window.MutationObserver?(this.u=new MutationObserver(n=>{this.handleChanges(n),this.h.requestUpdate()}),e.addController(this)):console.warn("MutationController error: browser does not support MutationObserver.")}handleChanges(e){this.value=this.callback?.(e,this.u)}hostConnected(){for(let e of this.t)this.observe(e)}hostDisconnected(){this.disconnect()}async hostUpdated(){let e=this.u.takeRecords();(e.length||!this.o&&this.i)&&this.handleChanges(e),this.i=!1}observe(e){this.t.add(e),this.u.observe(e,this.l),this.i=!0,this.h.requestUpdate()}disconnect(){this.u.disconnect()}};var T=Object.defineProperty,F=Object.getOwnPropertyDescriptor,m=(c,e,t,o)=>{for(var i=o>1?void 0:o?F(e,t):e,r=c.length-1,n;r>=0;r--)(n=c[r])&&(i=(o?n(e,t,i):n(i))||i);return o&&i&&T(e,t,i),i},K=100,k=class extends Event{constructor(e){super("sp-menu-item-added-or-updated",{bubbles:!0,composed:!0}),this.menuCascade=new WeakMap,this.clear(e)}clear(e){this._item=e,this.currentAncestorWithSelects=void 0,e.menuData={cleanupSteps:[],focusRoot:void 0,selectionRoot:void 0,parentMenu:void 0},this.menuCascade=new WeakMap}get item(){return this._item}},s=class extends j(_(B(q,'[slot="icon"]'))){constructor(){super(),this.active=!1,this.focused=!1,this.selected=!1,this._value="",this.hasSubmenu=!1,this.noWrap=!1,this.open=!1,this.proxyFocus=()=>{this.focus()},this.handleBeforetoggle=e=>{e.newState==="closed"&&(this.open=!0,this.overlayElement.manuallyKeepOpen(),this.overlayElement.removeEventListener("beforetoggle",this.handleBeforetoggle))},this.recentlyLeftChild=!1,this.willDispatchUpdate=!1,this.menuData={focusRoot:void 0,parentMenu:void 0,selectionRoot:void 0,cleanupSteps:[]},this.addEventListener("click",this.handleClickCapture,{capture:!0}),new b(this,{config:{characterData:!0,childList:!0,subtree:!0},callback:()=>{this.breakItemChildrenCache()}})}static get styles(){return[x,W,H]}get value(){return this._value||this.itemText}set value(e){e!==this._value&&(this._value=e||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return this.itemChildren.content.reduce((e,t)=>e+(t.textContent||"").trim(),"")}get focusElement(){return this}get hasIcon(){return this.slotContentIsPresent}get itemChildren(){if(!this.iconSlot||!this.contentSlot)return{icon:[],content:[]};if(this._itemChildren)return this._itemChildren;let e=this.iconSlot.assignedElements().map(o=>{let i=o.cloneNode(!0);return i.removeAttribute("slot"),i.classList.toggle("icon"),i}),t=this.contentSlot.assignedNodes().map(o=>o.cloneNode(!0));return this._itemChildren={icon:e,content:t},this._itemChildren}click(){this.disabled||this.shouldProxyClick()||super.click()}handleClickCapture(e){if(this.disabled)return e.preventDefault(),e.stopImmediatePropagation(),e.stopPropagation(),!1}shouldProxyClick(){let e=!1;return this.anchorElement&&(this.anchorElement.click(),e=!0),e}breakItemChildrenCache(){this._itemChildren=void 0,this.triggerUpdate()}renderSubmenu(){let e=f`
            ...
            ></slot>
        `;return this.hasSubmenu?(import("/libs/features/spectrum-web-components/dist/overlay.js"),import("/libs/features/spectrum-web-components/dist/popover.js"),f`
            <sp-overlay
                .triggerElement=${this}
