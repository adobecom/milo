...
import{html as r,SizedMixin as C}from"/libs/features/spectrum-web-components/dist/base.js";import{property as u}from"/libs/features/spectrum-web-components/dist/base.js";import{html as p}from"/libs/features/spectrum-web-components/dist/base.js";import{property as d,query as x}from"/libs/features/spectrum-web-components/dist/base.js";import{ifDefined as f}from"/libs/features/spectrum-web-components/dist/base.js";import{Focusable as g}from"/libs/features/spectrum-web-components/dist/shared.js";var v=Object.defineProperty,k=Object.getOwnPropertyDescriptor,l=(i,o,a,e)=>{for(var c=e>1?void 0:e?k(o,a):o,h=i.length-1,s;h>=0;h--)(s=i[h])&&(c=(e?s(o,a,c):s(c))||c);return e&&c&&v(o,a,c),c},t=class extends g{constructor(){super(...arguments),this.checked=!1,this.readonly=!1}get focusElement(){return this.inputElement}handleChange(){if(this.readonly){this.inputElement.checked=this.checked;return}this.checked=this.inputElement.checked;let o=new CustomEvent("change",{bubbles:!0,cancelable:!0,composed:!0});this.dispatchEvent(o)||(this.checked=!this.inputElement.checked,this.inputElement.checked=this.checked)}render(){return p`
            <input
            ...
            />
        `}};l([d({type:Boolean,reflect:!0})],t.prototype,"checked",2),l([d({type:Boolean,reflect:!0})],t.prototype,"readonly",2),l([d({type:String,reflect:!0})],t.prototype,"name",2),l([x("#input")],t.prototype,"inputElement",2);import"/libs/features/spectrum-web-components/dist/icons-ui.js";import"/libs/features/spectrum-web-components/dist/icons-ui.js";import"/libs/features/spectrum-web-components/dist/icons-ui.js";import"/libs/features/spectrum-web-components/dist/icons-ui.js";import"/libs/features/spectrum-web-components/dist/icons-ui.js";import"/libs/features/spectrum-web-components/dist/icons-ui.js";import"/libs/features/spectrum-web-components/dist/icons-ui.js";import"/libs/features/spectrum-web-components/dist/icons-ui.js";import{css as z}from"/libs/features/spectrum-web-components/dist/base.js";var y=z`
...
`,m=y;import j from"/libs/features/spectrum-web-components/dist/icons/checkmark.js";import E from"/libs/features/spectrum-web-components/dist/icons/dash.js";var w=Object.defineProperty,I=Object.getOwnPropertyDescriptor,b=(i,o,a,e)=>{for(var c=e>1?void 0:e?I(o,a):o,h=i.length-1,s;h>=0;h--)(s=i[h])&&(c=(e?s(o,a,c):s(c))||c);return e&&c&&w(o,a,c),c},D={s:r`
        <sp-icon-checkmark75
            id="checkmark"
    ...
    `,xl:r`
        ...
        ></sp-icon-dash300>
    `},n=class extends C(t,{noDefaultSize:!0}){constructor(){super(...arguments),this.indeterminate=!1,this.invalid=!1,this.emphasized=!1}static get styles(){return[m,j,E]}handleChange(){this.indeterminate=!1,super.handleChange()}render(){return r`
            ${super.render()}
            <span id="box">
                ${D[this.size]}
                ${T[this.size]}
        ...
        `}updated(o){super.updated(o),o.has("invalid")&&(this.invalid?this.inputElement.setAttribute("aria-invalid","true"):this.inputElement.removeAttribute("aria-invalid")),o.has("indeterminate")&&(this.inputElement.indeterminate=this.indeterminate)}};b([u({type:Boolean,reflect:!0})],n.prototype,"indeterminate",2),b([u({type:Boolean,reflect:!0})],n.prototype,"invalid",2),b([u({type:Boolean,reflect:!0})],n.prototype,"emphasized",2);import{defineElement as U}from"/libs/features/spectrum-web-components/dist/base.js";U("sp-checkbox",n);
