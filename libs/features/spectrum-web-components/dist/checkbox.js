...
import{html as r,SizedMixin as C,SpectrumElement as p}from"/libs/features/spectrum-web-components/dist/base.js";import{property as l}from"/libs/features/spectrum-web-components/dist/base.js";import{html as x}from"/libs/features/spectrum-web-components/dist/base.js";import{property as b,query as f}from"/libs/features/spectrum-web-components/dist/base.js";import{ifDefined as g}from"/libs/features/spectrum-web-components/dist/base.js";var v=Object.defineProperty,k=Object.getOwnPropertyDescriptor,d=(a,o,i,e)=>{for(var c=e>1?void 0:e?k(o,i):o,h=a.length-1,s;h>=0;h--)(s=a[h])&&(c=(e?s(o,i,c):s(c))||c);return e&&c&&v(o,i,c),c};function u(a){class o extends a{constructor(){super(...arguments),this.checked=!1,this.readonly=!1}handleChange(){if(this.readonly){this.inputElement.checked=this.checked;return}this.checked=this.inputElement.checked;let e=new CustomEvent("change",{bubbles:!0,cancelable:!0,composed:!0});this.dispatchEvent(e)||(this.checked=!this.inputElement.checked,this.inputElement.checked=this.checked)}render(){return x`
                <input
                    id="input"
                ...
                />
            `}}return d([b({type:Boolean,reflect:!0})],o.prototype,"checked",2),d([b({type:String,reflect:!0})],o.prototype,"name",2),d([b({type:Boolean,reflect:!0})],o.prototype,"readonly",2),d([f("#input")],o.prototype,"inputElement",2),o}import{css as z}from"/libs/features/spectrum-web-components/dist/base.js";var y=z`
...
`,m=y;import"/libs/features/spectrum-web-components/dist/icons-ui.js";import"/libs/features/spectrum-web-components/dist/icons-ui.js";import"/libs/features/spectrum-web-components/dist/icons-ui.js";import"/libs/features/spectrum-web-components/dist/icons-ui.js";import"/libs/features/spectrum-web-components/dist/icons-ui.js";import"/libs/features/spectrum-web-components/dist/icons-ui.js";import"/libs/features/spectrum-web-components/dist/icons-ui.js";import"/libs/features/spectrum-web-components/dist/icons-ui.js";import j from"/libs/features/spectrum-web-components/dist/icons/checkmark.js";import E from"/libs/features/spectrum-web-components/dist/icons/dash.js";var w=Object.defineProperty,I=Object.getOwnPropertyDescriptor,n=(a,o,i,e)=>{for(var c=e>1?void 0:e?I(o,i):o,h=a.length-1,s;h>=0;h--)(s=a[h])&&(c=(e?s(o,i,c):s(c))||c);return e&&c&&w(o,i,c),c},B={s:()=>r`
            <sp-icon-checkmark75
                id="checkmark"
