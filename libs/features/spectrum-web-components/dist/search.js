...
`,d=p;var v=Object.defineProperty,f=Object.getOwnPropertyDescriptor,c=(o,r,s,a)=>{for(var t=a>1?void 0:a?f(r,s):r,u=o.length-1,l;u>=0;u--)(l=o[u])&&(t=(a?l(r,s,t):l(t))||t);return a&&t&&v(r,s,t),t},z=o=>o.stopPropagation(),e=class extends x{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,d]}handleSubmit(r){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||r.preventDefault()}handleKeydown(r){let{code:s}=r;!this.value||s!=="Escape"||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return h`
            <form
                action=${this.action}
                id="form"
