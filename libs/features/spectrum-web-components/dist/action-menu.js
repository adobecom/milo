...
import{html as i}from"./base.js";import{state as v}from"./base.js";import{ifDefined as c}from"./base.js";import{property as h}from"./base.js";import{DESCRIPTION_ID as y,PickerBase as g}from"./picker.js";import"./action-button.js";import{ObserveSlotPresence as $}from"./shared.js";import{ObserveSlotText as x}from"./shared.js";import"./icons-workflow.js";import{css as u}from"./base.js";var m=u`
...
`,p=m;import{SlottableRequestEvent as O}from"./overlay.js";var b=Object.defineProperty,f=Object.getOwnPropertyDescriptor,d=(n,t,l,s)=>{for(var e=s>1?void 0:s?f(t,l):t,a=n.length-1,r;a>=0;a--)(r=n[a])&&(e=(s?r(t,l,e):r(e))||e);return s&&e&&b(t,l,e),e},o=class extends $(x(g,"label"),'[slot="label-only"]'){constructor(){super(...arguments),this.selects=void 0,this.static=void 0,this.listRole="menu",this.itemRole="menuitem",this.handleSlottableRequest=t=>{this.dispatchEvent(new O(t.name,t.data))}}static get styles(){return[p]}get hasLabel(){return this.slotHasContent}get labelOnly(){return this.slotContentIsPresent}get buttonContent(){return[i`
        ...
        `}update(t){t.has("invalid")&&(this.invalid=!1),super.update(t)}};d([h({type:String})],o.prototype,"selects",2),d([h({type:String,reflect:!0})],o.prototype,"static",2),d([v()],o.prototype,"labelOnly",1);import{defineElement as S}from"./base.js";S("sp-action-menu",o);
