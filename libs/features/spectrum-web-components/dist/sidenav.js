...
`,y=D;var F=Object.defineProperty,N=Object.getOwnPropertyDescriptor,H=(o,e,t,s)=>{for(var r=s>1?void 0:s?N(e,t):e,n=o.length-1,a;n>=0;n--)(a=o[n])&&(r=(s?a(e,t,r):a(r))||r);return s&&r&&F(e,t,r),r},d=class extends P{constructor(){super(...arguments),this.label=""}static get styles(){return[l,y]}update(e){this.hasAttribute("slot")||(this.slot="descendant"),super.update(e)}render(){return O`
        ...
        `}willUpdate(){if(!this.hasUpdated){let e=this.querySelector("[selected]");e&&(this.value=e.value)}}updated(e){super.updated(e),e.has("manageTabIndex")&&(this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage())}};m([p({type:Boolean,reflect:!0,attribute:"manage-tab-index"})],i.prototype,"manageTabIndex",2),m([p({reflect:!0})],i.prototype,"value",2),m([p({reflect:!0})],i.prototype,"variant",2),m([p({reflect:!0})],i.prototype,"label",2);import{defineElement as L}from"/libs/features/spectrum-web-components/dist/base.js";L("sp-sidenav",i);import{defineElement as J}from"/libs/features/spectrum-web-components/dist/base.js";J("sp-sidenav-item",u);
