...
`,m=h;import $ from"/libs/features/spectrum-web-components/dist/icons/checkmark.js";var g=Object.defineProperty,b=Object.getOwnPropertyDescriptor,i=(s,e,o,d)=>{for(var a=d>1?void 0:d?b(e,o):e,p=s.length-1,f;p>=0;p--)(f=s[p])&&(a=(d?f(e,o,a):f(a))||a);return d&&a&&g(e,o,a),a},T=["text","url","tel","email","password"],t=class extends w(k(q,{noDefaultSize:!0})){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.rows=-1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[m,$]}set type(e){let o=this._type;this._type=e,this.requestUpdate("type",o)}get type(){var e;return(e=T.find(o=>o===this._type))!=null?e:"text"}set value(e){if(e===this.value)return;let o=this._value;this._value=e,this.requestUpdate("value",o)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(e,o,d="none"){this.inputElement.setSelectionRange(e,o,d)}select(){this.inputElement.select()}handleInput(e){if(this.allowedKeys&&this.inputElement.value&&!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){let o=this.inputElement.selectionStart-1;this.inputElement.value=this.value.toString(),this.inputElement.setSelectionRange(o,o);return}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(e){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?c`
        ...
        `}update(e){(e.has("value")||e.has("required")&&this.required)&&this.updateComplete.then(()=>{this.checkValidity()}),super.update(e)}checkValidity(){let e=this.inputElement.checkValidity();return(this.required||this.value&&this.pattern)&&((this.disabled||this.multiline)&&this.pattern&&(e=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())),typeof this.minlength<"u"&&(e=e&&this.value.toString().length>=this.minlength),this.valid=e,this.invalid=!e),e}};i([v()],t.prototype,"appliedLabel",2),i([r({attribute:"allowed-keys"})],t.prototype,"allowedKeys",2),i([r({type:Boolean,reflect:!0})],t.prototype,"focused",2),i([z(".input:not(#sizer)")],t.prototype,"inputElement",2),i([r({type:Boolean,reflect:!0})],t.prototype,"invalid",2),i([r()],t.prototype,"label",2),i([r({type:String,reflect:!0})],t.prototype,"name",2),i([r()],t.prototype,"placeholder",2),i([v()],t.prototype,"type",1),i([r({attribute:"type",reflect:!0})],t.prototype,"_type",2),i([r()],t.prototype,"pattern",2),i([r({type:Boolean,reflect:!0})],t.prototype,"grows",2),i([r({type:Number})],t.prototype,"maxlength",2),i([r({type:Number})],t.prototype,"minlength",2),i([r({type:Boolean,reflect:!0})],t.prototype,"multiline",2),i([r({type:Boolean,reflect:!0})],t.prototype,"readonly",2),i([r({type:Number})],t.prototype,"rows",2),i([r({type:Boolean,reflect:!0})],t.prototype,"valid",2),i([r({type:String})],t.prototype,"value",1),i([r({type:Boolean,reflect:!0})],t.prototype,"quiet",2),i([r({type:Boolean,reflect:!0})],t.prototype,"required",2),i([r({type:String,reflect:!0})],t.prototype,"autocomplete",2);var n=class extends t{constructor(){super(...arguments),this._value=""}set value(e){if(e===this.value)return;let o=this._value;this._value=e,this.requestUpdate("value",o)}get value(){return this._value}};i([r({type:String})],n.prototype,"value",1);import{defineElement as E}from"/libs/features/spectrum-web-components/dist/base.js";E("sp-textfield",n);export{n as Textfield,t as TextfieldBase};
