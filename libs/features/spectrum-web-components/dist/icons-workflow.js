...
import{html as k}from"./base.js";import{IconBase as E}from"./icon.js";var u,o=function(t,...e){return u?u(t,...e):e.reduce((r,i,S)=>r+i+t[S+1],t[0])},a=t=>{u=t};var w=({width:t=24,height:e=24,hidden:r=!1,title:i="Alert"}={})=>o`<svg
  ...
  >
    ...
    />
  </svg>`;var v=({width:t=24,height:e=24,hidden:r=!1,title:i="Alert Triangle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var s=class extends E{render(){return a(k),this.spectrumVersion===1?w({hidden:!this.label,title:this.label}):v({hidden:!this.label,title:this.label})}};import{defineElement as O}from"./base.js";O("sp-icon-alert",s);import{html as D}from"./base.js";import{IconBase as G}from"./icon.js";var x=({width:t=24,height:e=24,hidden:r=!1,title:i="Help"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var $=({width:t=24,height:e=24,hidden:r=!1,title:i="Help Circle"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var l=class extends G{render(){return a(D),this.spectrumVersion===1?x({hidden:!this.label,title:this.label}):$({hidden:!this.label,title:this.label})}};import{defineElement as y}from"./base.js";y("sp-icon-help",l);import{html as j}from"./base.js";import{IconBase as q}from"./icon.js";var C=({width:t=24,height:e=24,hidden:r=!1,title:i="Link Out Light"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    `;var h=class extends q{render(){return a(j),this.spectrumVersion===1?C({hidden:!this.label,title:this.label}):m({hidden:!this.label,title:this.label})}};import{defineElement as z}from"./base.js";z("sp-icon-link-out-light",h);import{html as F}from"./base.js";import{IconBase as J}from"./icon.js";var T=({width:t=24,height:e=24,hidden:r=!1,title:i="Magnify"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var b=({width:t=24,height:e=24,hidden:r=!1,title:i="Search"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var n=class extends J{render(){return a(F),this.spectrumVersion===1?T({hidden:!this.label,title:this.label}):b({hidden:!this.label,title:this.label})}};import{defineElement as K}from"./base.js";K("sp-icon-magnify",n);import{html as N}from"./base.js";import{IconBase as P}from"./icon.js";var I=({width:t=24,height:e=24,hidden:r=!1,title:i="User"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var Z=({width:t=24,height:e=24,hidden:r=!1,title:i="User"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var p=class extends P{render(){return a(N),this.spectrumVersion===2?I({hidden:!this.label,title:this.label}):Z({hidden:!this.label,title:this.label})}};import{defineElement as Q}from"./base.js";Q("sp-icon-user",p);import{html as R}from"./base.js";import{IconBase as W}from"./icon.js";var L=({width:t=24,height:e=24,hidden:r=!1,title:i="User Group"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var B=({width:t=24,height:e=24,hidden:r=!1,title:i="User Group"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var c=class extends W{render(){return a(R),this.spectrumVersion===2?L({hidden:!this.label,title:this.label}):B({hidden:!this.label,title:this.label})}};import{defineElement as X}from"./base.js";X("sp-icon-user-group",c);import{html as Y}from"./base.js";import{IconBase as _}from"./icon.js";var H=({width:t=24,height:e=24,hidden:r=!1,title:i="Book"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var d=class extends _{render(){return a(Y),this.spectrumVersion===1?H({hidden:!this.label,title:this.label}):m({hidden:!this.label,title:this.label})}};import{defineElement as t0}from"./base.js";t0("sp-icon-book",d);import{html as e0}from"./base.js";import{IconBase as r0}from"./icon.js";var V=({width:t=24,height:e=24,hidden:r=!1,title:i="Download"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`;var M=({width:t=24,height:e=24,hidden:r=!1,title:i="Save To"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${e}"
    viewBox="0 0 36 36"
    width="${t}"
  ...
  >
    ...
    />
  </svg>`;var g=class extends r0{render(){return a(e0),this.spectrumVersion===2?V({hidden:!this.label,title:this.label}):M({hidden:!this.label,title:this.label})}};import{defineElement as i0}from"./base.js";i0("sp-icon-download",g);import{html as o0}from"./base.js";import{IconBase as a0}from"./icon.js";var U=({width:t=24,height:e=24,hidden:r=!1,title:i="Open In"}={})=>o`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${t}"
    height="${e}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    />
  </svg>`;var f=class extends a0{render(){return a(o0),this.spectrumVersion===2?U({hidden:!this.label,title:this.label}):A({hidden:!this.label,title:this.label})}};import{defineElement as s0}from"./base.js";s0("sp-icon-open-in",f);
