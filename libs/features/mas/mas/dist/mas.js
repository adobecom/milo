...
`;var lt=class extends P{constructor(t){super(t)}getGlobalCSS(){return Ba}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?g`<label id="stock-checkbox">
...
`;document.head.appendChild(Ja);var _l="#000000",Ll="#F8D904";async function Qa(e,t){var a;let r=e.fields.reduce((s,{name:c,multiple:l,values:h})=>(s[c]=l?h:h[0],s),{id:e.id}),{variant:n}=r;if(!n)return;t.variantLayout?.refs?.forEach(s=>s.remove()),t.variant=n,await t.updateComplete,(a=t.variantLayout).refs??(a.refs=[]);let{aemFragmentMapping:i}=t.variantLayout;if(!i)return;let o=s=>{t.variantLayout.refs.push(s),t.append(s)};if(r.mnemonicIcon?.forEach((s,c)=>{let l=r.mnemonicLink?.length>c?r.mnemonicLink[c]:"",h=r.mnemonicAlt?.length>c?r.mnemonicAlt[c]:"",u=he("merch-icon",{slot:"icons",src:s,alt:h,href:l,size:"l"});o(u)}),r.badge&&(t.setAttribute("badge-text",r.badge),t.setAttribute("badge-color",r.badgeColor||_l),t.setAttribute("badge-background-color",r.badgeBackgroundColor||Ll)),r.size?i.allowedSizes?.includes(r.size)&&t.setAttribute("size",r.size):t.removeAttribute("size"),r.cardTitle&&i.title&&o(he(i.title.tag,{slot:i.title.slot},r.cardTitle)),r.subtitle&&i.subtitle&&o(he(i.subtitle.tag,{slot:i.subtitle.slot},r.subtitle)),r.backgroundImage&&i.backgroundImage&&o(he(i.backgroundImage.tag,{slot:i.backgroundImage.slot},`<img loading="lazy" src="${r.backgroundImage}" />`)),r.prices&&i.prices){let s=r.prices,c=he(i.prices.tag,{slot:i.prices.slot},s);o(c)}if(r.description&&i.description){let s=he(i.description.tag,{slot:i.description.slot},r.description);o(s)}if(r.ctas){let{slot:s,button:c=!0}=i.ctas,l=he("div",{slot:s??"footer"},r.ctas),h=[];[...l.querySelectorAll("a")].forEach(u=>{let d=u.parentElement.tagName==="STRONG";if(t.consonant)u.classList.add("con-button"),d&&u.classList.add("blue"),h.push(u);else{if(!c){h.push(u);return}let f=he("sp-button",{treatment:d?"fill":"outline",variant:d?"accent":"primary"},u);f.addEventListener("click",S=>{S.target===f&&(S.stopPropagation(),u.click())}),h.push(f)}}),l.innerHTML="",l.append(...h),o(l)}}var wl="merch-card",Pl=2e3,Pi,Kt,wi,Bt=class extends ie{constructor(){super();J(this,Kt);p(this,"customerSegment");p(this,"marketSegment");p(this,"variantLayout");J(this,Pi,!1);this.filters={},this.types="",this.selected=!1,this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this)}firstUpdated(){this.variantLayout=Li(this,!1),this.variantLayout?.connectedCallbackHook(),this.aemFragment?.updateComplete.catch(()=>{this.style.display="none"})}willUpdate(r){(r.has("variant")||!this.variantLayout)&&(this.variantLayout=Li(this),this.variantLayout.connectedCallbackHook())}updated(r){(r.has("badgeBackgroundColor")||r.has("borderColor"))&&(this.style.border=this.computedBorderStyle),this.variantLayout?.postCardUpdateHook(this)}get theme(){return this.closest("sp-theme")}get prices(){return Array.from(this.querySelectorAll('span[is="inline-price"][data-wcs-osi]'))}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["twp","ccd-slice"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector('span[is="inline-price"]')}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll('a[is="checkout-link"]')??[]]}async toggleStockOffer({target:r}){if(!this.stockOfferOsis)return;let n=this.checkoutLinks;if(n.length!==0)for(let i of n){await i.onceSettled();let o=i.value?.[0]?.planType;if(!o)return;let a=this.stockOfferOsis[o];if(!a)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==a);r.checked&&s.push(a),i.dataset.wcsOsi=s.join(",")}}handleQuantitySelection(r){let n=this.checkoutLinks;for(let i of n)i.dataset.quantity=r.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(r){let n={...this.filters};Object.keys(n).forEach(i=>{if(r){n[i].order=Math.min(n[i].order||2,2);return}let o=n[i].order;o===1||isNaN(o)||(n[i].order=Number(o)+1)}),this.filters=n}includes(r){return this.textContent.match(new RegExp(r,"i"))!==null}connectedCallback(){super.connectedCallback(),this.setAttribute("tabindex",this.getAttribute("tabindex")??"0"),this.addEventListener(_i,this.handleQuantitySelection),this.addEventListener(Ra,this.merchCardReady,{once:!0}),this.updateComplete.then(()=>{this.merchCardReady()}),this.storageOptions?.addEventListener("change",this.handleStorageChange),this.addEventListener(ot,this.handleAemFragmentEvents),this.addEventListener(it,this.handleAemFragmentEvents),this.aemFragment||this.checkReady()}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout.disconnectedCallbackHook(),this.removeEventListener(_i,this.handleQuantitySelection),this.storageOptions?.removeEventListener(yi,this.handleStorageChange),this.removeEventListener(ot,this.handleAemFragmentEvents),this.removeEventListener(it,this.handleAemFragmentEvents)}async handleAemFragmentEvents(r){if(r.type===ot&&He(this,Kt,wi).call(this,"AEM fragment cannot be loaded"),r.type===it&&r.target.nodeName==="AEM-FRAGMENT"){let n=r.detail;await Qa(n,this),this.checkReady()}}async checkReady(){let r=Promise.all([...this.querySelectorAll('span[is="inline-price"][data-wcs-osi],a[is="checkout-link"][data-wcs-osi]')].map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(a=>a.classList.contains("placeholder-resolved"))),n=new Promise(o=>setTimeout(()=>o(!1),Pl));if(await Promise.race([r,n])===!0){this.dispatchEvent(new CustomEvent(Ma,{bubbles:!0,composed:!0}));return}He(this,Kt,wi).call(this,"Contains unresolved offers")}get aemFragment(){return this.querySelector("aem-fragment")}get storageOptions(){return this.querySelector("sp-radio-group#storage")}get storageSpecificOfferSelect(){let r=this.storageOptions?.selected;if(r){let n=this.querySelector(`merch-offer-select[storage="${r}"]`);if(n)return n}return this.querySelector("merch-offer-select")}get offerSelect(){return this.storageOptions?this.storageSpecificOfferSelect:this.querySelector("merch-offer-select")}get quantitySelect(){return this.querySelector("merch-quantity-select")}merchCardReady(){this.offerSelect&&!this.offerSelect.planType||this.dispatchEvent(new CustomEvent(Va,{bubbles:!0}))}handleStorageChange(){let r=this.closest("merch-card")?.offerSelect.cloneNode(!0);r&&this.dispatchEvent(new CustomEvent(yi,{detail:{offerSelect:r},bubbles:!0}))}get dynamicPrice(){return this.querySelector('[slot="price"]')}selectMerchOffer(r){if(r===this.merchOffer)return;this.merchOffer=r;let n=this.dynamicPrice;if(r.price&&n){let i=r.price.cloneNode(!0);n.onceSettled?n.onceSettled().then(()=>{n.replaceWith(i)}):n.replaceWith(i)}}};Pi=new WeakMap,Kt=new WeakSet,wi=function(r){this.dispatchEvent(new CustomEvent(Ua,{detail:r,bubbles:!0,composed:!0}))},p(Bt,"properties",{name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color"},borderColor:{type:String,attribute:"border-color"},badgeBackgroundColor:{type:String,attribute:"badge-background-color"},stripSize:{type:String,attribute:"strip-size"},stripBackground:{type:String,attribute:"strip-background"},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:r=>{let[n,i,o]=r.split(",");return{PUF:n,ABM:i,M2M:o}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:r=>Object.fromEntries(r.split(",").map(n=>{let[i,o,a]=n.split(":"),s=Number(o);return[i,{order:isNaN(s)?void 0:s,size:a}]})),toAttribute:r=>Object.entries(r).map(([n,{order:i,size:o}])=>[n,i,o].filter(a=>a!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object}}),p(Bt,"styles",[Ia,Za(),...ka()]);customElements.define(wl,Bt);var ft=class extends ie{constructor(){super(),this.size="m",this.alt=""}render(){let{href:t}=this;return t?g`<a href="${t}">
    ...
    `);customElements.define("merch-icon",ft);async function Cl(e){let t=e.headers.get("Etag"),r=await e.json();return r.etag=t,r}async function es(e,t,r){let n=await fetch(`${e}/adobe/sites/cf/fragments/${t}`,{headers:r});if(!n.ok)throw new Error(`Failed to get fragment: ${n.status} ${n.statusText}`);return await Cl(n)}var rs=new CSSStyleSheet;rs.replaceSync(":host { display: contents; }");var Nl=document.querySelector('meta[name="aem-base-url"]')?.content??"https://publish-p22655-e155390.adobeaemcloud.com",ts="fragment",Il="ims",Ci,ve,Ni=class{constructor(){J(this,ve,new Map)}clear(){K(this,ve).clear()}add(...t){t.forEach(r=>{let{id:n}=r;n&&K(this,ve).set(n,r)})}has(t){return K(this,ve).has(t)}get(t){return K(this,ve).get(t)}remove(t){K(this,ve).delete(t)}};ve=new WeakMap;var Rr=new Ni,jt,ki,Ii=class extends HTMLElement{constructor(){super();J(this,jt);p(this,"cache",Rr);p(this,"data");p(this,"fragmentId");p(this,"consonant",!1);p(this,"ims",!1);p(this,"_readyPromise");this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[rs];let r=this.getAttribute(Il);["",!0].includes(r)?(this.ims=!0,Ci||(Ci={Authorization:`Bearer ${window.adobeid?.authorize?.()}`,pragma:"no-cache","cache-control":"no-cache"})):this.ims=!1}static get observedAttributes(){return[ts]}attributeChangedCallback(r,n,i){r===ts&&(this.fragmentId=i,this.refresh(!1))}connectedCallback(){if(!this.fragmentId){He(this,jt,ki).call(this,"Missing fragment id");return}}async refresh(r=!0){this._readyPromise&&!await Promise.race([this._readyPromise,Promise.resolve(!1)])||(r&&Rr.remove(this.fragmentId),this._readyPromise=this.fetchData().then(()=>(this.dispatchEvent(new CustomEvent(it,{detail:this.data,bubbles:!0,composed:!0})),!0)).catch(()=>(He(this,jt,ki).call(this,"Network error: failed to load fragment"),this._readyPromise=null,!1)))}async fetchData(){let r=Rr.get(this.fragmentId);r||(r=await es(Nl,this.fragmentId,this.ims?Ci:void 0),Rr.add(r)),this.data=r}get updateComplete(){return this._readyPromise??Promise.reject(new Error("AEM fragment cannot be loaded"))}};jt=new WeakSet,ki=function(r){this.classList.add("error"),this.dispatchEvent(new CustomEvent(ot,{detail:r,bubbles:!0,composed:!0}))};customElements.define("aem-fragment",Ii);
