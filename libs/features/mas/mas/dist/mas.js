...
`;var El={title:{tag:"h3",slot:"heading-xs"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{size:"l"}},lt=class extends P{constructor(t){super(t)}getGlobalCSS(){return Ha}get aemFragmentMapping(){return El}renderLayout(){return g` <div class="body">
            <slot name="icons"></slot> ${this.badge}
            <slot name="heading-xs"></slot>
            <slot name="heading-m"></slot>
...
`;var Or=class extends P{constructor(t){super(t)}getGlobalCSS(){return za}renderLayout(){return g`${this.cardImage}
    <div class="body">
...
`;var Vr=class extends P{constructor(t){super(t)}getGlobalCSS(){return Fa}renderLayout(){return g` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var ut=class extends P{constructor(t){super(t)}getGlobalCSS(){return Ba}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?g`<label id="stock-checkbox">
...
`;var dt=class extends P{constructor(t){super(t)}getGlobalCSS(){return Ya}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return g` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
        ${this.promoBottom?"":g`<slot name="promo-text"></slot><slot name="callout-content"></slot>`}
...
`;var pt=class extends P{constructor(t){super(t)}getGlobalCSS(){return Wa}renderLayout(){return g`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
...
`;var yl={subtitle:{tag:"h4",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"cta",size:"s",button:!1}},ft=class extends P{getGlobalCSS(){return qa}get aemFragmentMapping(){return yl}renderLayout(){return g`
...
`;var _l={backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{size:"s"},allowedSizes:["wide"]},gt=class extends P{getGlobalCSS(){return Za}get aemFragmentMapping(){return _l}renderLayout(){return g` <div class="content">
                <slot name="icons"></slot> ${this.badge}
