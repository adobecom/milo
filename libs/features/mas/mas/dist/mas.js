...
`;var ut=class extends P{constructor(t){super(t)}getGlobalCSS(){return Ba}renderLayout(){return g`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
...
`;document.head.appendChild(Wa);async function qa(e,t){var a;let r=e.fields.reduce((s,{name:c,multiple:l,values:h})=>(s[c]=l?h:h[0],s),{id:e.id}),{variant:n}=r;if(!n)return;r.model=r.model,t.variantLayout?.refs?.forEach(s=>s.remove()),t.variant=n,await t.updateComplete,(a=t.variantLayout).refs??(a.refs=[]);let{aemFragmentMapping:i}=t.variantLayout;if(!i)return;let o=s=>{t.variantLayout.refs.push(s),t.append(s)};if(r.mnemonicIcon?.forEach((s,c)=>{let l=r.mnemonicLink?.length>c?r.mnemonicLink[c]:"",h=r.mnemonicAlt?.length>c?r.mnemonicAlt[c]:"",u=le("merch-icon",{slot:"icons",src:s,alt:h,href:l,size:"l"});o(u)}),r.size?i.allowedSizes?.includes(r.size)&&t.setAttribute("size",r.size):t.removeAttribute("size"),r.cardTitle&&i.title&&o(le(i.title.tag,{slot:i.title.slot},r.cardTitle)),r.subtitle&&i.subtitle&&o(le(i.subtitle.tag,{slot:i.subtitle.slot},r.subtitle)),r.backgroundImage&&i.backgroundImage&&o(le(i.backgroundImage.tag,{slot:i.backgroundImage.slot},`<img loading="lazy" src="${r.backgroundImage}" />`)),r.prices&&i.prices){let s=r.prices,c=le(i.prices.tag,{slot:i.prices.slot},s);o(c)}if(r.description&&i.description){let s=le(i.description.tag,{slot:i.description.slot},r.description);o(s)}if(r.ctas){let{slot:s,button:c=!0}=i.ctas,l=le("div",{slot:s??"footer"},r.ctas),h=[];[...l.querySelectorAll("a")].forEach(u=>{let d=u.parentElement.tagName==="STRONG";if(t.consonant)u.classList.add("con-button"),d&&u.classList.add("blue"),h.push(u);else{if(!c){h.push(u);return}let f=le("sp-button",{treatment:d?"fill":"outline",variant:d?"accent":"primary"},u);f.addEventListener("click",E=>{E.target===f&&(E.stopPropagation(),u.click())}),h.push(f)}}),l.innerHTML="",l.append(...h),o(l)}}var yl="merch-card",_l=2e3,_i,Ft,yi,zt=class extends ne{constructor(){super();Z(this,Ft);p(this,"customerSegment");p(this,"marketSegment");p(this,"variantLayout");Z(this,_i,!1);this.filters={},this.types="",this.selected=!1,this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this)}firstUpdated(){this.variantLayout=Ti(this,!1),this.variantLayout?.connectedCallbackHook(),this.aemFragment?.updateComplete.catch(()=>{this.style.display="none"})}willUpdate(r){(r.has("variant")||!this.variantLayout)&&(this.variantLayout=Ti(this),this.variantLayout.connectedCallbackHook())}updated(r){(r.has("badgeBackgroundColor")||r.has("borderColor"))&&(this.style.border=this.computedBorderStyle),this.variantLayout?.postCardUpdateHook(this)}get theme(){return this.closest("sp-theme")}get prices(){return Array.from(this.querySelectorAll('span[is="inline-price"][data-wcs-osi]'))}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return this.variant!=="twp"?`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`:""}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector('span[is="inline-price"]')}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll('a[is="checkout-link"]')??[]]}async toggleStockOffer({target:r}){if(!this.stockOfferOsis)return;let n=this.checkoutLinks;if(n.length!==0)for(let i of n){await i.onceSettled();let o=i.value?.[0]?.planType;if(!o)return;let a=this.stockOfferOsis[o];if(!a)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==a);r.checked&&s.push(a),i.dataset.wcsOsi=s.join(",")}}handleQuantitySelection(r){let n=this.checkoutLinks;for(let i of n)i.dataset.quantity=r.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(r){let n={...this.filters};Object.keys(n).forEach(i=>{if(r){n[i].order=Math.min(n[i].order||2,2);return}let o=n[i].order;o===1||isNaN(o)||(n[i].order=Number(o)+1)}),this.filters=n}includes(r){return this.textContent.match(new RegExp(r,"i"))!==null}connectedCallback(){super.connectedCallback(),this.setAttribute("tabindex",this.getAttribute("tabindex")??"0"),this.addEventListener(Si,this.handleQuantitySelection),this.addEventListener(Ia,this.merchCardReady,{once:!0}),this.updateComplete.then(()=>{this.merchCardReady()}),this.storageOptions?.addEventListener("change",this.handleStorageChange),this.addEventListener(it,this.handleAemFragmentEvents),this.addEventListener(nt,this.handleAemFragmentEvents),this.aemFragment||this.checkReady()}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout.disconnectedCallbackHook(),this.removeEventListener(Si,this.handleQuantitySelection),this.storageOptions?.removeEventListener(Ei,this.handleStorageChange),this.removeEventListener(it,this.handleAemFragmentEvents),this.removeEventListener(nt,this.handleAemFragmentEvents)}async handleAemFragmentEvents(r){if(r.type===it&&Ge(this,Ft,yi).call(this,"AEM fragment cannot be loaded"),r.type===nt&&r.target.nodeName==="AEM-FRAGMENT"){let n=r.detail;await qa(n,this),this.checkReady()}}async checkReady(){let r=Promise.all([...this.querySelectorAll('span[is="inline-price"][data-wcs-osi],a[is="checkout-link"][data-wcs-osi]')].map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(a=>a.classList.contains("placeholder-resolved"))),n=new Promise(o=>setTimeout(()=>o(!1),_l));if(await Promise.race([r,n])===!0){this.dispatchEvent(new CustomEvent(Va,{bubbles:!0,composed:!0}));return}Ge(this,Ft,yi).call(this,"Contains unresolved offers")}get aemFragment(){return this.querySelector("aem-fragment")}get storageOptions(){return this.querySelector("sp-radio-group#storage")}get storageSpecificOfferSelect(){let r=this.storageOptions?.selected;if(r){let n=this.querySelector(`merch-offer-select[storage="${r}"]`);if(n)return n}return this.querySelector("merch-offer-select")}get offerSelect(){return this.storageOptions?this.storageSpecificOfferSelect:this.querySelector("merch-offer-select")}get quantitySelect(){return this.querySelector("merch-quantity-select")}merchCardReady(){this.offerSelect&&!this.offerSelect.planType||this.dispatchEvent(new CustomEvent(ka,{bubbles:!0}))}handleStorageChange(){let r=this.closest("merch-card")?.offerSelect.cloneNode(!0);r&&this.dispatchEvent(new CustomEvent(Ei,{detail:{offerSelect:r},bubbles:!0}))}get dynamicPrice(){return this.querySelector('[slot="price"]')}selectMerchOffer(r){if(r===this.merchOffer)return;this.merchOffer=r;let n=this.dynamicPrice;if(r.price&&n){let i=r.price.cloneNode(!0);n.onceSettled?n.onceSettled().then(()=>{n.replaceWith(i)}):n.replaceWith(i)}}};_i=new WeakMap,Ft=new WeakSet,yi=function(r){this.dispatchEvent(new CustomEvent(Ra,{detail:r,bubbles:!0,composed:!0}))},p(zt,"properties",{name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color"},borderColor:{type:String,attribute:"border-color"},badgeBackgroundColor:{type:String,attribute:"badge-background-color"},stripSize:{type:String,attribute:"strip-size"},stripBackground:{type:String,attribute:"strip-background"},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:r=>{let[n,i,o]=r.split(",");return{PUF:n,ABM:i,M2M:o}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:r=>Object.fromEntries(r.split(",").map(n=>{let[i,o,a]=n.split(":"),s=Number(o);return[i,{order:isNaN(s)?void 0:s,size:a}]})),toAttribute:r=>Object.entries(r).map(([n,{order:i,size:o}])=>[n,i,o].filter(a=>a!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object}}),p(zt,"styles",[Pa,Xa(),...Ca()]);customElements.define(yl,zt);var pt=class extends ne{constructor(){super(),this.size="m",this.alt=""}render(){let{href:t}=this;return t?g`<a href="${t}">
    ...
    `);customElements.define("merch-icon",pt);async function Ll(e){let t=e.headers.get("Etag"),r=await e.json();return r.etag=t,r}async function Za(e,t,r){let n=await fetch(`${e}/adobe/sites/cf/fragments/${t}`,{headers:r});if(!n.ok)throw new Error(`Failed to get fragment: ${n.status} ${n.statusText}`);return await Ll(n)}var Qa=new CSSStyleSheet;Qa.replaceSync(":host { display: contents; }");var wl=document.querySelector('meta[name="aem-base-url"]')?.content??"https://publish-p22655-e155390.adobeaemcloud.com",Ja="fragment",Pl="ims",Li,be,wi=class{constructor(){Z(this,be,new Map)}clear(){K(this,be).clear()}add(...t){t.forEach(r=>{let{id:n}=r;n&&K(this,be).set(n,r)})}has(t){return K(this,be).has(t)}get(t){return K(this,be).get(t)}remove(t){K(this,be).delete(t)}};be=new WeakMap;var Or=new wi,Kt,Ci,Pi=class extends HTMLElement{constructor(){super();Z(this,Kt);p(this,"cache",Or);p(this,"data");p(this,"fragmentId");p(this,"consonant",!1);p(this,"ims",!1);p(this,"_readyPromise");this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[Qa];let r=this.getAttribute(Pl);["",!0].includes(r)?(this.ims=!0,Li||(Li={Authorization:`Bearer ${window.adobeid?.authorize?.()}`,pragma:"no-cache","cache-control":"no-cache"})):this.ims=!1}static get observedAttributes(){return[Ja]}attributeChangedCallback(r,n,i){r===Ja&&(this.fragmentId=i,this.refresh(!1))}connectedCallback(){if(!this.fragmentId){Ge(this,Kt,Ci).call(this,"Missing fragment id");return}}async refresh(r=!0){this._readyPromise&&!await Promise.race([this._readyPromise,Promise.resolve(!1)])||(r&&Or.remove(this.fragmentId),this._readyPromise=this.fetchData().then(()=>(this.dispatchEvent(new CustomEvent(nt,{detail:this.data,bubbles:!0,composed:!0})),!0)).catch(()=>(Ge(this,Kt,Ci).call(this,"Network error: failed to load fragment"),this._readyPromise=null,!1)))}async fetchData(){let r=Or.get(this.fragmentId);r||(r=await Za(wl,this.fragmentId,this.ims?Li:void 0),Or.add(r)),this.data=r}get updateComplete(){return this._readyPromise??Promise.reject(new Error("AEM fragment cannot be loaded"))}};Kt=new WeakSet,Ci=function(r){this.classList.add("error"),this.dispatchEvent(new CustomEvent(it,{detail:r,bubbles:!0,composed:!0}))};customElements.define("aem-fragment",Pi);
