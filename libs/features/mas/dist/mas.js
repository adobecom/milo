...
`;var jn={size:[],mnemonics:{size:"l"},badge:!0,subtitle:{tag:"h4",slot:"detail-s"},backgroundImage:{attribute:"background-image"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"cta",size:"M"}},dt=class extends I{getGlobalCSS(){return qo}get aemFragmentMapping(){return jn}get stripStyle(){return this.card.backgroundImage?`
