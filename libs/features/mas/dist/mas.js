...
.data;
var yi=Object.defineProperty;var Ei=e=>{throw TypeError(e)};var yc=(e,t,r)=>t in e?yi(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var Ec=(e,t)=>{for(var r in t)yi(e,r,{get:t[r],enumerable:!0})};var p=(e,t,r)=>yc(e,typeof t!="symbol"?t+"":t,r),Ao=(e,t,r)=>t.has(e)||Ei("Cannot "+r);var b=(e,t,r)=>(Ao(e,t,"read from private field"),r?r.call(e):t.get(e)),L=(e,t,r)=>t.has(e)?Ei("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),R=(e,t,r,o)=>(Ao(e,t,"write to private field"),o?o.call(e,r):t.set(e,r),r),de=(e,t,r)=>(Ao(e,t,"access private method"),r);(function(){let r={clientId:"",endpoint:"https://www.adobe.com/lana/ll",endpointStage:"https://www.stage.adobe.com/lana/ll",errorType:"e",sampleRate:1,tags:"",implicitSampleRate:1,useProd:!0,isProdDomain:!1},o=new Set(["d","debug","i","info","w","warn","e","error","c","critical"]),n=window;function i(){let{host:d}=window.location;return d.substring(d.length-10)===".adobe.com"&&d.substring(d.length-15)!==".corp.adobe.com"&&d.substring(d.length-16)!==".stage.adobe.com"}function a(d,u){d||(d={}),u||(u={});function m(g){return d[g]!==void 0?d[g]:u[g]!==void 0?u[g]:r[g]}return Object.keys(r).reduce((g,f)=>(g[f]=m(f),g),{})}function s(){return n.location.search.toLowerCase().indexOf("lanadebug")!==-1}function c(){return n.location.host.toLowerCase().indexOf("localhost")!==-1}function l(d,u){d=d&&d.stack?d.stack:d||"",d.length>2e3&&(d=`${d.slice(0,2e3)}<trunc>`);let m=a(u,n.lana.options);if(!m.clientId){console.warn("LANA ClientID is not set in options.");return}let g;if(u&&u.severity!==void 0)if(o.has(u.severity))g=u.severity;else{let M=s()||n.lana.debug?"d":"i";console.warn(`LANA: Invalid severity '${u.severity}'. Defaulting to '${M}'.`),g=M}else n.lana.debug&&(g="d");let w=parseInt(new URL(window.location).searchParams.get("lana-sample"),10)||(m.errorType==="i"?m.implicitSampleRate:m.sampleRate);if(!n.lana.debug&&!n.lana.localhost&&w<=Math.random()*100)return;let A=i()||m.isProdDomain,C=!A||!m.useProd?m.endpointStage:m.endpoint,E=[`m=${encodeURIComponent(d)}`,`c=${encodeURI(m.clientId)}`,`s=${w}`,`t=${encodeURI(m.errorType)}`];if(g&&E.push(`r=${encodeURI(g)}`),m.tags&&E.push(`tags=${encodeURI(m.tags)}`),(!A||n.lana.debug||n.lana.localhost)&&console.log("LANA Msg: ",d,`
Opts:`,m),!n.lana.localhost||n.lana.debug){let _=new XMLHttpRequest;return n.lana.debug&&(E.push("d"),_.addEventListener("load",()=>{console.log("LANA response:",_.responseText)})),_.open("GET",`${C}?${E.join("&")}`),_.send(),_}}function h(d){l(d.reason||d.error||d.message,{errorType:"i"})}n.lana={debug:!1,log:l,options:a(n.lana&&n.lana.options)},s()&&(n.lana.debug=!0),c()&&(n.lana.localhost=!0),n.addEventListener("error",h),n.addEventListener("unhandledrejection",h)})();var Vo={};Ec(Vo,{CLASS_NAME_FAILED:()=>Lo,CLASS_NAME_HIDDEN:()=>Ac,CLASS_NAME_PENDING:()=>Ro,CLASS_NAME_RESOLVED:()=>Oo,CheckoutWorkflow:()=>ie,CheckoutWorkflowStep:()=>V,Commitment:()=>De,ERROR_MESSAGE_BAD_REQUEST:()=>$o,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>Rc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Mo,EVENT_AEM_ERROR:()=>ze,EVENT_AEM_LOAD:()=>Be,EVENT_MAS_ERROR:()=>ko,EVENT_MAS_READY:()=>Po,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>To,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>kc,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Pc,EVENT_MERCH_CARD_READY:()=>So,EVENT_MERCH_OFFER_READY:()=>ht,EVENT_MERCH_OFFER_SELECT_READY:()=>Gt,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>ue,EVENT_MERCH_SEARCH_CHANGE:()=>Cc,EVENT_MERCH_SIDENAV_SELECT:()=>Lc,EVENT_MERCH_STOCK_CHANGE:()=>Sc,EVENT_MERCH_STORAGE_CHANGE:()=>Tc,EVENT_OFFER_SELECTED:()=>Co,EVENT_TYPE_FAILED:()=>No,EVENT_TYPE_READY:()=>Sr,EVENT_TYPE_RESOLVED:()=>Io,Env:()=>fe,HEADER_X_REQUEST_ID:()=>Fo,LOG_NAMESPACE:()=>Ho,Landscape:()=>Te,MARK_DURATION_SUFFIX:()=>Vt,MARK_START_SUFFIX:()=>Ce,MODAL_TYPE_3_IN_1:()=>ae,NAMESPACE:()=>wc,PARAM_AOS_API_KEY:()=>Oc,PARAM_ENV:()=>Do,PARAM_LANDSCAPE:()=>Uo,PARAM_WCS_API_KEY:()=>$c,PROVIDER_ENVIRONMENT:()=>Go,SELECTOR_MAS_CHECKOUT_LINK:()=>Ue,SELECTOR_MAS_ELEMENT:()=>Ft,SELECTOR_MAS_INLINE_PRICE:()=>Tr,SELECTOR_MAS_SP_BUTTON:()=>_o,STATE_FAILED:()=>me,STATE_PENDING:()=>Se,STATE_RESOLVED:()=>pe,TAG_NAME_SERVICE:()=>_c,Term:()=>te,WCS_PROD_URL:()=>Bo,WCS_STAGE_URL:()=>zo});var De=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),te=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),wc="merch",Ac="hidden",Sr="wcms:commerce:ready",_c="mas-commerce-service",Tr='span[is="inline-price"][data-wcs-osi]',Ue='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',_o="sp-button[data-wcs-osi]",Ft=`${Tr},${Ue}`,ht="merch-offer:ready",Gt="merch-offer-select:ready",So="merch-card:ready",To="merch-card:action-menu-toggle",Co="merch-offer:selected",Sc="merch-stock:change",Tc="merch-storage:change",ue="merch-quantity-selector:change",Cc="merch-search:change",Pc="merch-card-collection:sort",kc="merch-card-collection:showmore",Lc="merch-sidenav:select",Be="aem:load",ze="aem:error",Po="mas:ready",ko="mas:error",Lo="placeholder-failed",Ro="placeholder-pending",Oo="placeholder-resolved",$o="Bad WCS request",Mo="Commerce offer not found",Rc="Literals URL not provided",No="mas:failed",Io="mas:resolved",Ho="mas/commerce",Do="commerce.env",Uo="commerce.landscape",Oc="commerce.aosKey",$c="commerce.wcsKey",Bo="https://www.adobe.com/web_commerce_artifact",zo="https://www.stage.adobe.com/web_commerce_artifact_stage",me="failed",Se="pending",pe="resolved",Te={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},Fo="X-Request-Id",V=Object.freeze({CHECKOUT:"checkout",CHECKOUT_EMAIL:"checkout/email",SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),ie=Object.freeze({V2:"UCv2",V3:"UCv3"}),fe=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),Go={PRODUCTION:"PRODUCTION"},ae={TWP:"twp",D2P:"d2p",CRM:"crm"},Ce=":start",Vt=":duration";var wi="tacocat.js";var jo=(e,t)=>String(e??"").toLowerCase()==String(t??"").toLowerCase(),Ai=e=>`${e??""}`.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t]??t)??"";function I(e,t={},{metadata:r=!0,search:o=!0,storage:n=!0}={}){let i;if(o&&i==null){let a=new URLSearchParams(window.location.search),s=dt(o)?o:e;i=a.get(s)}if(n&&i==null){let a=dt(n)?n:e;i=window.sessionStorage.getItem(a)??window.localStorage.getItem(a)}if(r&&i==null){let a=Nc(dt(r)?r:e);i=document.documentElement.querySelector(`meta[name="${a}"]`)?.content}return i??t[e]}var Mc=e=>typeof e=="boolean",Cr=e=>typeof e=="function",Pr=e=>typeof e=="number",_i=e=>e!=null&&typeof e=="object";var dt=e=>typeof e=="string",Si=e=>dt(e)&&e,jt=e=>Pr(e)&&Number.isFinite(e)&&e>0;function qt(e,t=r=>r==null||r===""){return e!=null&&Object.entries(e).forEach(([r,o])=>{t(o)&&delete e[r]}),e}function P(e,t){if(Mc(e))return e;let r=String(e);return r==="1"||r==="true"?!0:r==="0"||r==="false"?!1:t}function Fe(e,t,r){let o=Object.values(t);return o.find(n=>jo(n,e))??r??o[0]}function Nc(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,r,o)=>`${r}-${o}`).replace(/\W+/gu,"-").toLowerCase()}function Ti(e,t=1){return Pr(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:t}var Ic=Date.now(),qo=()=>`(+${Date.now()-Ic}ms)`,kr=new Set,Hc=P(I("tacocat.debug",{},{metadata:!1}),typeof process<"u"&&process.env?.DEBUG);function Ci(e){let t=`[${wi}/${e}]`,r=(a,s,...c)=>a?!0:(n(s,...c),!1),o=Hc?(a,...s)=>{console.debug(`${t} ${a}`,...s,qo())}:()=>{},n=(a,...s)=>{let c=`${t} ${a}`;kr.forEach(([l])=>l(c,...s))};return{assert:r,debug:o,error:n,warn:(a,...s)=>{let c=`${t} ${a}`;kr.forEach(([,l])=>l(c,...s))}}}function Dc(e,t){let r=[e,t];return kr.add(r),()=>{kr.delete(r)}}Dc((e,...t)=>{console.error(e,...t,qo())},(e,...t)=>{console.warn(e,...t,qo())});var Uc="no promo",Pi="promo-tag",Bc="yellow",zc="neutral",Fc=(e,t,r)=>{let o=i=>i||Uc,n=r?` (was "${o(t)}")`:"";return`${o(e)}${n}`},Gc="cancel-context",Lr=(e,t)=>{let r=e===Gc,o=!r&&e?.length>0,n=(o||r)&&(t&&t!=e||!t&&!r),i=n&&o||!n&&!!t,a=i?e||t:void 0;return{effectivePromoCode:a,overridenPromoCode:e,className:i?Pi:`${Pi} no-promo`,text:Fc(a,t,n),variant:i?Bc:zc,isOverriden:n}};var Wo;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(Wo||(Wo={}));var J;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(J||(J={}));var re;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(re||(re={}));var Yo;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(Yo||(Yo={}));var Xo;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(Xo||(Xo={}));var Ko;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(Ko||(Ko={}));var Zo;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(Zo||(Zo={}));var Qo="ABM",Jo="PUF",en="M2M",tn="PERPETUAL",rn="P3Y",Vc="TAX_INCLUSIVE_DETAILS",jc="TAX_EXCLUSIVE",ki={ABM:Qo,PUF:Jo,M2M:en,PERPETUAL:tn,P3Y:rn},dd={[Qo]:{commitment:J.YEAR,term:re.MONTHLY},[Jo]:{commitment:J.YEAR,term:re.ANNUAL},[en]:{commitment:J.MONTH,term:re.MONTHLY},[tn]:{commitment:J.PERPETUAL,term:void 0},[rn]:{commitment:J.THREE_MONTHS,term:re.P3Y}},Li="Value is not an offer",Rr=e=>{if(typeof e!="object")return Li;let{commitment:t,term:r}=e,o=qc(t,r);return{...e,planType:o}};var qc=(e,t)=>{switch(e){case void 0:return Li;case"":return"";case J.YEAR:return t===re.MONTHLY?Qo:t===re.ANNUAL?Jo:"";case J.MONTH:return t===re.MONTHLY?en:"";case J.PERPETUAL:return tn;case J.TERM_LICENSE:return t===re.P3Y?rn:"";default:return""}};function Ri(e){let{priceDetails:t}=e,{price:r,priceWithoutDiscount:o,priceWithoutTax:n,priceWithoutDiscountAndTax:i,taxDisplay:a}=t;if(a!==Vc)return e;let s={...e,priceDetails:{...t,price:n??r,priceWithoutDiscount:i??o,taxDisplay:jc}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var Wc="mas-commerce-service";function Wt(e,{country:t,forceTaxExclusive:r,perpetual:o}){let n;if(e.length<2)n=e;else{let i=t==="GB"||o?"EN":"MULT",[a,s]=e;n=[a.language===i?a:s]}return r&&(n=n.map(Ri)),n}var Or=e=>window.setTimeout(e);function ut(e,t=1){if(e==null)return[t];let r=(Array.isArray(e)?e:String(e).split(",")).map(Ti).filter(jt);return r.length||(r=[t]),r}function $r(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(Si)}function X(){return document.getElementsByTagName(Wc)?.[0]}var Ge={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,tags:"acom",isProdDomain:!1},Oi=1e3;function Yc(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function $i(e){if(e==null)return;let t=typeof e;if(t==="function")return e.name?`function ${e.name}`:"function";if(t==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:o,originatingRequest:n,status:i}=e;return[o,i,n].filter(Boolean).join(" ")}let r=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!Ge.serializableTypes.includes(r))return r}return e}function Xc(e,t){if(!Ge.ignoredProperties.includes(e))return $i(t)}var on={append(e){if(e.level!=="error")return;let{message:t,params:r}=e,o=[],n=[],i=t;r.forEach(l=>{l!=null&&(Yc(l)?o:n).push(l)}),o.length&&(i+=" "+o.map($i).join(" "));let{pathname:a,search:s}=window.location,c=`${Ge.delimiter}page=${a}${s}`;c.length>Oi&&(c=`${c.slice(0,Oi)}<trunc>`),i+=c,n.length&&(i+=`${Ge.delimiter}facts=`,i+=JSON.stringify(n,Xc)),window.lana?.log(i,Ge)}};function mt(e){Object.assign(Ge,Object.fromEntries(Object.entries(e).filter(([t,r])=>t in Ge&&r!==""&&r!==null&&r!==void 0&&!Number.isNaN(r))))}var Mi={LOCAL:"local",PROD:"prod",STAGE:"stage"},nn={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},an=new Set,sn=new Set,Ni=new Map,Ii={append({level:e,message:t,params:r,timestamp:o,source:n}){console[e](`${o}ms [${n}] %c${t}`,"font-weight: bold;",...r)}},Hi={filter:({level:e})=>e!==nn.DEBUG},Kc={filter:()=>!1};function Zc(e,t,r,o,n){return{level:e,message:t,namespace:r,get params(){return o.length===1&&Cr(o[0])&&(o=o[0](),Array.isArray(o)||(o=[o])),o},source:n,timestamp:performance.now().toFixed(3)}}function Qc(e){[...sn].every(t=>t(e))&&an.forEach(t=>t(e))}function Di(e){let t=(Ni.get(e)??0)+1;Ni.set(e,t);let r=`${e} #${t}`,o={id:r,namespace:e,module:n=>Di(`${o.namespace}/${n}`),updateConfig:mt};return Object.values(nn).forEach(n=>{o[n]=(i,...a)=>Qc(Zc(n,i,e,a,r))}),Object.seal(o)}function Mr(...e){e.forEach(t=>{let{append:r,filter:o}=t;Cr(o)&&sn.add(o),Cr(r)&&an.add(r)})}function Jc(e={}){let{name:t}=e,r=P(I("commerce.debug",{search:!0,storage:!0}),t===Mi.LOCAL);return Mr(r?Ii:Hi),t===Mi.PROD&&Mr(on),ee}function el(){an.clear(),sn.clear()}var ee={...Di(Ho),Level:nn,Plugins:{consoleAppender:Ii,debugFilter:Hi,quietFilter:Kc,lanaAppender:on},init:Jc,reset:el,use:Mr};var ge=class e extends Error{constructor(t,r,o){if(super(t,{cause:o}),this.name="MasError",r.response){let n=r.response.headers?.get(Fo);n&&(r.requestId=n),r.response.status&&(r.status=r.response.status,r.statusText=r.response.statusText),r.response.url&&(r.url=r.response.url)}delete r.response,this.context=r,Error.captureStackTrace&&Error.captureStackTrace(this,e)}toString(){let t=Object.entries(this.context||{}).map(([o,n])=>`${o}: ${JSON.stringify(n)}`).join(", "),r=`${this.name}: ${this.message}`;return t&&(r+=` (${t})`),this.cause&&(r+=`
Caused by: ${this.cause}`),r}};var tl={[me]:Lo,[Se]:Ro,[pe]:Oo},rl={[me]:No,[pe]:Io},Yt,pt=class{constructor(t){L(this,Yt);p(this,"changes",new Map);p(this,"connected",!1);p(this,"error");p(this,"log");p(this,"options");p(this,"promises",[]);p(this,"state",Se);p(this,"timer",null);p(this,"value");p(this,"version",0);p(this,"wrapperElement");this.wrapperElement=t,this.log=ee.module("mas-element")}update(){[me,Se,pe].forEach(t=>{this.wrapperElement.classList.toggle(tl[t],t===this.state)})}notify(){(this.state===pe||this.state===me)&&(this.state===pe?this.promises.forEach(({resolve:r})=>r(this.wrapperElement)):this.state===me&&this.promises.forEach(({reject:r})=>r(this.error)),this.promises=[]);let t=this.error;this.error instanceof ge&&(t={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(rl[this.state],{bubbles:!0,detail:t}))}attributeChangedCallback(t,r,o){this.changes.set(t,o),this.requestUpdate()}connectedCallback(){R(this,Yt,X()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:t,promises:r,state:o}=this;return pe===o?Promise.resolve(this.wrapperElement):me===o?Promise.reject(t):new Promise((n,i)=>{r.push({resolve:n,reject:i})})}toggleResolved(t,r,o){return t!==this.version?!1:(o!==void 0&&(this.options=o),this.state=pe,this.value=r,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:r}),Or(()=>this.notify()),!0)}toggleFailed(t,r,o){if(t!==this.version)return!1;o!==void 0&&(this.options=o),this.error=r,this.state=me,this.update();let n=this.wrapperElement.getAttribute("is");return this.log?.error(`${n}: Failed to render: ${r.message}`,{element:this.wrapperElement,...r.context,...b(this,Yt)?.duration}),Or(()=>this.notify()),!0}togglePending(t){return this.version++,t&&(this.options=t),this.state=Se,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!X()||this.timer)return;let{error:r,options:o,state:n,value:i,version:a}=this;this.state=Se,this.timer=Or(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||t)try{await this.wrapperElement.render?.()===!1&&this.state===Se&&this.version===a&&(this.state=n,this.error=r,this.value=i,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,o)}})}};Yt=new WeakMap;function Ui(e={}){return Object.entries(e).forEach(([t,r])=>{(r==null||r===""||r?.length===0)&&delete e[t]}),e}function Nr(e,t={}){let{tag:r,is:o}=e,n=document.createElement(r,{is:o});return n.setAttribute("is",o),Object.assign(n.dataset,Ui(t)),n}function Ir(e,t={}){return e instanceof HTMLElement?(Object.assign(e.dataset,Ui(t)),e):null}var Bi="download",zi="upgrade";function Hr(e,t={},r=""){let o=X();if(!o)return null;let{checkoutMarketSegment:n,checkoutWorkflow:i,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:l,perpetual:h,promotionCode:d,quantity:u,wcsOsi:m,extraOptions:g,analyticsId:f}=o.collectCheckoutOptions(t),w=Nr(e,{checkoutMarketSegment:n,checkoutWorkflow:i,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:l,perpetual:h,promotionCode:d,quantity:u,wcsOsi:m,extraOptions:g,analyticsId:f});return r&&(w.innerHTML=`<span style="pointer-events: none;">${r}</span>`),w}function Dr(e){return class extends e{constructor(){super(...arguments);p(this,"checkoutActionHandler");p(this,"masElement",new pt(this))}attributeChangedCallback(o,n,i){this.masElement.attributeChangedCallback(o,n,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isOpen3in1Modal(){let o=document.querySelector("meta[name=mas-ff-3in1]");return Object.values(ae).includes(this.getAttribute("data-modal"))&&(!o||o.content!=="off")}requestUpdate(o=!1){return this.masElement.requestUpdate(o)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(o={}){let n=X();if(!n)return!1;this.dataset.imsCountry||n.imsCountryPromise.then(d=>{d&&(this.dataset.imsCountry=d)}),o.imsCountry=null;let i=n.collectCheckoutOptions(o,this);if(!i.wcsOsi.length)return!1;let a;try{a=JSON.parse(i.extraOptions??"{}")}catch(d){this.masElement.log?.error("cannot parse exta checkout options",d)}let s=this.masElement.togglePending(i);this.setCheckoutUrl("");let c=n.resolveOfferSelectors(i),l=await Promise.all(c);l=l.map(d=>Wt(d,i)),i.country=this.dataset.imsCountry||i.country;let h=await n.buildCheckoutAction?.(l.flat(),{...a,...i},this);return this.renderOffers(l.flat(),i,{},h,s)}renderOffers(o,n,i={},a=void 0,s=void 0){let c=X();if(!c)return!1;if(n={...JSON.parse(this.dataset.extraOptions??"null"),...n,...i},s??(s=this.masElement.togglePending(n)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),a){this.classList.remove(Bi,zi),this.masElement.toggleResolved(s,o,n);let{url:h,text:d,className:u,handler:m}=a;h&&this.setCheckoutUrl(h),d&&(this.firstElementChild.innerHTML=d),u&&this.classList.add(...u.split(" ")),m&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=m.bind(this))}if(o.length){if(this.masElement.toggleResolved(s,o,n)){if(!this.classList.contains(Bi)&&!this.classList.contains(zi)){let h=c.buildCheckoutURL(o,n);this.setCheckoutUrl(n.modal==="true"?"#":h)}return!0}}else{let h=new Error(`Not provided: ${n?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,h,n))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(o){}updateOptions(o={}){let n=X();if(!n)return!1;let{checkoutMarketSegment:i,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:h,perpetual:d,promotionCode:u,quantity:m,wcsOsi:g}=n.collectCheckoutOptions(o);return Ir(this,{checkoutMarketSegment:i,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:h,perpetual:d,promotionCode:u,quantity:m,wcsOsi:g}),!0}}}var Xt=class Xt extends Dr(HTMLAnchorElement){static createCheckoutLink(t={},r=""){return Hr(Xt,t,r)}setCheckoutUrl(t){this.setAttribute("href",t)}get isCheckoutLink(){return!0}clickHandler(t){if(this.checkoutActionHandler){this.checkoutActionHandler?.(t);return}}};p(Xt,"is","checkout-link"),p(Xt,"tag","a");var xe=Xt;window.customElements.get(xe.is)||window.customElements.define(xe.is,xe,{extends:xe.tag});var ol="p_draft_landscape",nl="/store/",il=new Map([["countrySpecific","cs"],["customerSegment","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["offerType","ot"],["marketSegment","ms"]]),cn=new Set(["af","ai","apc","appctxid","cli","co","cs","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),al=["env","workflowStep","clientId","country"],Fi=e=>il.get(e)??e;function ln(e,t,r){for(let[o,n]of Object.entries(e)){let i=Fi(o);n!=null&&r.has(i)&&t.set(i,n)}}function sl(e){switch(e){case Go.PRODUCTION:return"https://commerce.adobe.com";default:return"https://commerce-stg.adobe.com"}}function cl(e,t){for(let r in e){let o=e[r];for(let[n,i]of Object.entries(o)){if(i==null)continue;let a=Fi(n);t.set(`items[${r}][${a}]`,i)}}}function ll(e,t,r,o){return!Object.values(ae).includes(t)||!e?.searchParams||!r||!o||(e.searchParams.set("rtc","t"),e.searchParams.set("lo","sl"),e.searchParams.get("cli")!=="doc_cloud"&&e.searchParams.set("cli",t===ae.CRM?"creative":"mini_plans"),t===ae.CRM?e.searchParams.set("af","uc_segmentation_hide_tabs,uc_new_user_iframe,uc_new_system_close"):(t===ae.TWP||t===ae.D2P)&&(e.searchParams.set("af","uc_new_user_iframe,uc_new_system_close"),r==="INDIVIDUAL"&&o==="EDU"&&e.searchParams.set("ms","e"),r==="TEAM"&&o==="COM"&&e.searchParams.set("cs","t"))),e}function Gi(e){hl(e);let{env:t,items:r,workflowStep:o,ms:n,marketSegment:i,customerSegment:a,ot:s,offerType:c,pa:l,productArrangementCode:h,landscape:d,modal:u,...m}=e,g={marketSegment:i??n,offerType:c??s,productArrangementCode:h??l},f=new URL(sl(t));return f.pathname=`${nl}${o}`,o!==V.SEGMENTATION&&o!==V.CHANGE_PLAN_TEAM_PLANS&&cl(r,f.searchParams),o===V.SEGMENTATION&&ln(g,f.searchParams,cn),ln(m,f.searchParams,cn),d===Te.DRAFT&&ln({af:ol},f.searchParams,cn),f=ll(f,u,a,i),f.toString()}function hl(e){for(let t of al)if(!e[t])throw new Error('Argument "checkoutData" is not valid, missing: '+t);if(e.workflowStep!==V.SEGMENTATION&&e.workflowStep!==V.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}var k=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflow:ie.V3,checkoutWorkflowStep:V.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,env:fe.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:Te.PUBLISHED});function Vi({providers:e,settings:t}){function r(i,a){let{checkoutClientId:s,checkoutWorkflow:c,checkoutWorkflowStep:l,country:h,language:d,promotionCode:u,quantity:m}=t,{checkoutMarketSegment:g,checkoutWorkflow:f=c,checkoutWorkflowStep:w=l,imsCountry:A,country:C=A??h,language:E=d,quantity:_=m,entitlement:M,upgrade:H,modal:j,perpetual:Y,promotionCode:ne=u,wcsOsi:U,extraOptions:Q,...se}=Object.assign({},a?.dataset??{},i??{}),_e=Fe(f,ie,k.checkoutWorkflow),he=V.CHECKOUT;_e===ie.V3&&(he=Fe(w,V,k.checkoutWorkflowStep));let Ie=qt({...se,extraOptions:Q,checkoutClientId:s,checkoutMarketSegment:g,country:C,quantity:ut(_,k.quantity),checkoutWorkflow:_e,checkoutWorkflowStep:he,language:E,entitlement:P(M),upgrade:P(H),modal:j,perpetual:P(Y),promotionCode:Lr(ne).effectivePromoCode,wcsOsi:$r(U)});if(a)for(let He of e.checkout)He(a,Ie);return Ie}function o(i,a){if(!Array.isArray(i)||!i.length||!a)return"";let{env:s,landscape:c}=t,{checkoutClientId:l,checkoutMarketSegment:h,checkoutWorkflow:d,checkoutWorkflowStep:u,country:m,promotionCode:g,quantity:f,...w}=r(a),A=window.frameElement||Object.values(ae).includes(a.modal)?"if":"fp",C={checkoutPromoCode:g,clientId:l,context:A,country:m,env:s,items:[],marketSegment:h,workflowStep:u,landscape:c,...w};if(i.length===1){let[{offerId:E,offerType:_,productArrangementCode:M}]=i,{marketSegments:[H],customerSegment:j}=i[0];Object.assign(C,{marketSegment:H,customerSegment:j,offerType:_,productArrangementCode:M}),C.items.push(f[0]===1?{id:E}:{id:E,quantity:f[0]})}else C.items.push(...i.map(({offerId:E},_)=>({id:E,quantity:f[_]??k.quantity})));return Gi(C)}let{createCheckoutLink:n}=xe;return{CheckoutLink:xe,CheckoutWorkflow:ie,CheckoutWorkflowStep:V,buildCheckoutURL:o,collectCheckoutOptions:r,createCheckoutLink:n}}function dl({interval:e=200,maxAttempts:t=25}={}){let r=ee.module("ims");return new Promise(o=>{r.debug("Waing for IMS to be ready");let n=0;function i(){window.adobeIMS?.initialized?o():++n>t?(r.debug("Timeout"),o()):setTimeout(i,e)}i()})}function ul(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function ml(e){let t=ee.module("ims");return e.then(r=>r?window.adobeIMS.getProfile().then(({countryCode:o})=>(t.debug("Got user country:",o),o),o=>{t.error("Unable to get user country:",o)}):null)}function ji({}){let e=dl(),t=ul(e),r=ml(t);return{imsReadyPromise:e,imsSignedInPromise:t,imsCountryPromise:r}}var qi=window.masPriceLiterals;function Wi(e){if(Array.isArray(qi)){let t=o=>qi.find(n=>jo(n.lang,o)),r=t(e.language)??t(k.language);if(r)return Object.freeze(r)}return{}}var hn=function(e,t){return hn=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(r,o){r.__proto__=o}||function(r,o){for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(r[n]=o[n])},hn(e,t)};function Kt(e,t){if(typeof t!="function"&&t!==null)throw new TypeError("Class extends value "+String(t)+" is not a constructor or null");hn(e,t);function r(){this.constructor=e}e.prototype=t===null?Object.create(t):(r.prototype=t.prototype,new r)}var S=function(){return S=Object.assign||function(t){for(var r,o=1,n=arguments.length;o<n;o++){r=arguments[o];for(var i in r)Object.prototype.hasOwnProperty.call(r,i)&&(t[i]=r[i])}return t},S.apply(this,arguments)};function Ur(e,t,r){if(r||arguments.length===2)for(var o=0,n=t.length,i;o<n;o++)(i||!(o in t))&&(i||(i=Array.prototype.slice.call(t,0,o)),i[o]=t[o]);return e.concat(i||Array.prototype.slice.call(t))}var y;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(y||(y={}));var $;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})($||($={}));var Ve;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(Ve||(Ve={}));function dn(e){return e.type===$.literal}function Yi(e){return e.type===$.argument}function Br(e){return e.type===$.number}function zr(e){return e.type===$.date}function Fr(e){return e.type===$.time}function Gr(e){return e.type===$.select}function Vr(e){return e.type===$.plural}function Xi(e){return e.type===$.pound}function jr(e){return e.type===$.tag}function qr(e){return!!(e&&typeof e=="object"&&e.type===Ve.number)}function Zt(e){return!!(e&&typeof e=="object"&&e.type===Ve.dateTime)}var un=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var pl=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function Ki(e){var t={};return e.replace(pl,function(r){var o=r.length;switch(r[0]){case"G":t.era=o===4?"long":o===5?"narrow":"short";break;case"y":t.year=o===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":t.month=["numeric","2-digit","short","long","narrow"][o-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":t.day=["numeric","2-digit"][o-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":t.weekday=o===4?"short":o===5?"narrow":"short";break;case"e":if(o<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][o-4];break;case"c":if(o<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][o-4];break;case"a":t.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":t.hourCycle="h12",t.hour=["numeric","2-digit"][o-1];break;case"H":t.hourCycle="h23",t.hour=["numeric","2-digit"][o-1];break;case"K":t.hourCycle="h11",t.hour=["numeric","2-digit"][o-1];break;case"k":t.hourCycle="h24",t.hour=["numeric","2-digit"][o-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":t.minute=["numeric","2-digit"][o-1];break;case"s":t.second=["numeric","2-digit"][o-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":t.timeZoneName=o<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),t}var Zi=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function ta(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var t=e.split(Zi).filter(function(u){return u.length>0}),r=[],o=0,n=t;o<n.length;o++){var i=n[o],a=i.split("/");if(a.length===0)throw new Error("Invalid number skeleton");for(var s=a[0],c=a.slice(1),l=0,h=c;l<h.length;l++){var d=h[l];if(d.length===0)throw new Error("Invalid number skeleton")}r.push({stem:s,options:c})}return r}function fl(e){return e.replace(/^(.*?)-/,"")}var Qi=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,ra=/^(@+)?(\+|#+)?[rs]?$/g,gl=/(\*)(0+)|(#+)(0+)|(0+)/g,oa=/^(0+)$/;function Ji(e){var t={};return e[e.length-1]==="r"?t.roundingPriority="morePrecision":e[e.length-1]==="s"&&(t.roundingPriority="lessPrecision"),e.replace(ra,function(r,o,n){return typeof n!="string"?(t.minimumSignificantDigits=o.length,t.maximumSignificantDigits=o.length):n==="+"?t.minimumSignificantDigits=o.length:o[0]==="#"?t.maximumSignificantDigits=o.length:(t.minimumSignificantDigits=o.length,t.maximumSignificantDigits=o.length+(typeof n=="string"?n.length:0)),""}),t}function na(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function xl(e){var t;if(e[0]==="E"&&e[1]==="E"?(t={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(t={notation:"scientific"},e=e.slice(1)),t){var r=e.slice(0,2);if(r==="+!"?(t.signDisplay="always",e=e.slice(2)):r==="+?"&&(t.signDisplay="exceptZero",e=e.slice(2)),!oa.test(e))throw new Error("Malformed concise eng/scientific notation");t.minimumIntegerDigits=e.length}return t}function ea(e){var t={},r=na(e);return r||t}function ia(e){for(var t={},r=0,o=e;r<o.length;r++){var n=o[r];switch(n.stem){case"percent":case"%":t.style="percent";continue;case"%x100":t.style="percent",t.scale=100;continue;case"currency":t.style="currency",t.currency=n.options[0];continue;case"group-off":case",_":t.useGrouping=!1;continue;case"precision-integer":case".":t.maximumFractionDigits=0;continue;case"measure-unit":case"unit":t.style="unit",t.unit=fl(n.options[0]);continue;case"compact-short":case"K":t.notation="compact",t.compactDisplay="short";continue;case"compact-long":case"KK":t.notation="compact",t.compactDisplay="long";continue;case"scientific":t=S(S(S({},t),{notation:"scientific"}),n.options.reduce(function(c,l){return S(S({},c),ea(l))},{}));continue;case"engineering":t=S(S(S({},t),{notation:"engineering"}),n.options.reduce(function(c,l){return S(S({},c),ea(l))},{}));continue;case"notation-simple":t.notation="standard";continue;case"unit-width-narrow":t.currencyDisplay="narrowSymbol",t.unitDisplay="narrow";continue;case"unit-width-short":t.currencyDisplay="code",t.unitDisplay="short";continue;case"unit-width-full-name":t.currencyDisplay="name",t.unitDisplay="long";continue;case"unit-width-iso-code":t.currencyDisplay="symbol";continue;case"scale":t.scale=parseFloat(n.options[0]);continue;case"integer-width":if(n.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");n.options[0].replace(gl,function(c,l,h,d,u,m){if(l)t.minimumIntegerDigits=h.length;else{if(d&&u)throw new Error("We currently do not support maximum integer digits");if(m)throw new Error("We currently do not support exact integer digits")}return""});continue}if(oa.test(n.stem)){t.minimumIntegerDigits=n.stem.length;continue}if(Qi.test(n.stem)){if(n.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");n.stem.replace(Qi,function(c,l,h,d,u,m){return h==="*"?t.minimumFractionDigits=l.length:d&&d[0]==="#"?t.maximumFractionDigits=d.length:u&&m?(t.minimumFractionDigits=u.length,t.maximumFractionDigits=u.length+m.length):(t.minimumFractionDigits=l.length,t.maximumFractionDigits=l.length),""});var i=n.options[0];i==="w"?t=S(S({},t),{trailingZeroDisplay:"stripIfInteger"}):i&&(t=S(S({},t),Ji(i)));continue}if(ra.test(n.stem)){t=S(S({},t),Ji(n.stem));continue}var a=na(n.stem);a&&(t=S(S({},t),a));var s=xl(n.stem);s&&(t=S(S({},t),s))}return t}var Qt={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function aa(e,t){for(var r="",o=0;o<e.length;o++){var n=e.charAt(o);if(n==="j"){for(var i=0;o+1<e.length&&e.charAt(o+1)===n;)i++,o++;var a=1+(i&1),s=i<2?1:3+(i>>1),c="a",l=bl(t);for((l=="H"||l=="k")&&(s=0);s-- >0;)r+=c;for(;a-- >0;)r=l+r}else n==="J"?r+="H":r+=n}return r}function bl(e){var t=e.hourCycle;if(t===void 0&&e.hourCycles&&e.hourCycles.length&&(t=e.hourCycles[0]),t)switch(t){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var r=e.language,o;r!=="root"&&(o=e.maximize().region);var n=Qt[o||""]||Qt[r||""]||Qt["".concat(r,"-001")]||Qt["001"];return n[0]}var mn,vl=new RegExp("^".concat(un.source,"*")),yl=new RegExp("".concat(un.source,"*$"));function T(e,t){return{start:e,end:t}}var El=!!String.prototype.startsWith,wl=!!String.fromCodePoint,Al=!!Object.fromEntries,_l=!!String.prototype.codePointAt,Sl=!!String.prototype.trimStart,Tl=!!String.prototype.trimEnd,Cl=!!Number.isSafeInteger,Pl=Cl?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},fn=!0;try{sa=da("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),fn=((mn=sa.exec("a"))===null||mn===void 0?void 0:mn[0])==="a"}catch{fn=!1}var sa,ca=El?function(t,r,o){return t.startsWith(r,o)}:function(t,r,o){return t.slice(o,o+r.length)===r},gn=wl?String.fromCodePoint:function(){for(var t=[],r=0;r<arguments.length;r++)t[r]=arguments[r];for(var o="",n=t.length,i=0,a;n>i;){if(a=t[i++],a>1114111)throw RangeError(a+" is not a valid code point");o+=a<65536?String.fromCharCode(a):String.fromCharCode(((a-=65536)>>10)+55296,a%1024+56320)}return o},la=Al?Object.fromEntries:function(t){for(var r={},o=0,n=t;o<n.length;o++){var i=n[o],a=i[0],s=i[1];r[a]=s}return r},ha=_l?function(t,r){return t.codePointAt(r)}:function(t,r){var o=t.length;if(!(r<0||r>=o)){var n=t.charCodeAt(r),i;return n<55296||n>56319||r+1===o||(i=t.charCodeAt(r+1))<56320||i>57343?n:(n-55296<<10)+(i-56320)+65536}},kl=Sl?function(t){return t.trimStart()}:function(t){return t.replace(vl,"")},Ll=Tl?function(t){return t.trimEnd()}:function(t){return t.replace(yl,"")};function da(e,t){return new RegExp(e,t)}var xn;fn?(pn=da("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),xn=function(t,r){var o;pn.lastIndex=r;var n=pn.exec(t);return(o=n[1])!==null&&o!==void 0?o:""}):xn=function(t,r){for(var o=[];;){var n=ha(t,r);if(n===void 0||ma(n)||$l(n))break;o.push(n),r+=n>=65536?2:1}return gn.apply(void 0,o)};var pn,ua=function(){function e(t,r){r===void 0&&(r={}),this.message=t,this.position={offset:0,line:1,column:1},this.ignoreTag=!!r.ignoreTag,this.locale=r.locale,this.requiresOtherClause=!!r.requiresOtherClause,this.shouldParseSkeletons=!!r.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(t,r,o){for(var n=[];!this.isEOF();){var i=this.char();if(i===123){var a=this.parseArgument(t,o);if(a.err)return a;n.push(a.val)}else{if(i===125&&t>0)break;if(i===35&&(r==="plural"||r==="selectordinal")){var s=this.clonePosition();this.bump(),n.push({type:$.pound,location:T(s,this.clonePosition())})}else if(i===60&&!this.ignoreTag&&this.peek()===47){if(o)break;return this.error(y.UNMATCHED_CLOSING_TAG,T(this.clonePosition(),this.clonePosition()))}else if(i===60&&!this.ignoreTag&&bn(this.peek()||0)){var a=this.parseTag(t,r);if(a.err)return a;n.push(a.val)}else{var a=this.parseLiteral(t,r);if(a.err)return a;n.push(a.val)}}}return{val:n,err:null}},e.prototype.parseTag=function(t,r){var o=this.clonePosition();this.bump();var n=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:$.literal,value:"<".concat(n,"/>"),location:T(o,this.clonePosition())},err:null};if(this.bumpIf(">")){var i=this.parseMessage(t+1,r,!0);if(i.err)return i;var a=i.val,s=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!bn(this.char()))return this.error(y.INVALID_TAG,T(s,this.clonePosition()));var c=this.clonePosition(),l=this.parseTagName();return n!==l?this.error(y.UNMATCHED_CLOSING_TAG,T(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:$.tag,value:n,children:a,location:T(o,this.clonePosition())},err:null}:this.error(y.INVALID_TAG,T(s,this.clonePosition())))}else return this.error(y.UNCLOSED_TAG,T(o,this.clonePosition()))}else return this.error(y.INVALID_TAG,T(o,this.clonePosition()))},e.prototype.parseTagName=function(){var t=this.offset();for(this.bump();!this.isEOF()&&Ol(this.char());)this.bump();return this.message.slice(t,this.offset())},e.prototype.parseLiteral=function(t,r){for(var o=this.clonePosition(),n="";;){var i=this.tryParseQuote(r);if(i){n+=i;continue}var a=this.tryParseUnquoted(t,r);if(a){n+=a;continue}var s=this.tryParseLeftAngleBracket();if(s){n+=s;continue}break}var c=T(o,this.clonePosition());return{val:{type:$.literal,value:n,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!Rl(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(t){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(t==="plural"||t==="selectordinal")break;return null;default:return null}this.bump();var r=[this.char()];for(this.bump();!this.isEOF();){var o=this.char();if(o===39)if(this.peek()===39)r.push(39),this.bump();else{this.bump();break}else r.push(o);this.bump()}return gn.apply(void 0,r)},e.prototype.tryParseUnquoted=function(t,r){if(this.isEOF())return null;var o=this.char();return o===60||o===123||o===35&&(r==="plural"||r==="selectordinal")||o===125&&t>0?null:(this.bump(),gn(o))},e.prototype.parseArgument=function(t,r){var o=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(y.EXPECT_ARGUMENT_CLOSING_BRACE,T(o,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(y.EMPTY_ARGUMENT,T(o,this.clonePosition()));var n=this.parseIdentifierIfPossible().value;if(!n)return this.error(y.MALFORMED_ARGUMENT,T(o,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(y.EXPECT_ARGUMENT_CLOSING_BRACE,T(o,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:$.argument,value:n,location:T(o,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(y.EXPECT_ARGUMENT_CLOSING_BRACE,T(o,this.clonePosition())):this.parseArgumentOptions(t,r,n,o);default:return this.error(y.MALFORMED_ARGUMENT,T(o,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var t=this.clonePosition(),r=this.offset(),o=xn(this.message,r),n=r+o.length;this.bumpTo(n);var i=this.clonePosition(),a=T(t,i);return{value:o,location:a}},e.prototype.parseArgumentOptions=function(t,r,o,n){var i,a=this.clonePosition(),s=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(s){case"":return this.error(y.EXPECT_ARGUMENT_TYPE,T(a,c));case"number":case"date":case"time":{this.bumpSpace();var l=null;if(this.bumpIf(",")){this.bumpSpace();var h=this.clonePosition(),d=this.parseSimpleArgStyleIfPossible();if(d.err)return d;var u=Ll(d.val);if(u.length===0)return this.error(y.EXPECT_ARGUMENT_STYLE,T(this.clonePosition(),this.clonePosition()));var m=T(h,this.clonePosition());l={style:u,styleLocation:m}}var g=this.tryParseArgumentClose(n);if(g.err)return g;var f=T(n,this.clonePosition());if(l&&ca(l?.style,"::",0)){var w=kl(l.style.slice(2));if(s==="number"){var d=this.parseNumberSkeletonFromString(w,l.styleLocation);return d.err?d:{val:{type:$.number,value:o,location:f,style:d.val},err:null}}else{if(w.length===0)return this.error(y.EXPECT_DATE_TIME_SKELETON,f);var A=w;this.locale&&(A=aa(w,this.locale));var u={type:Ve.dateTime,pattern:A,location:l.styleLocation,parsedOptions:this.shouldParseSkeletons?Ki(A):{}},C=s==="date"?$.date:$.time;return{val:{type:C,value:o,location:f,style:u},err:null}}}return{val:{type:s==="number"?$.number:s==="date"?$.date:$.time,value:o,location:f,style:(i=l?.style)!==null&&i!==void 0?i:null},err:null}}case"plural":case"selectordinal":case"select":{var E=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(y.EXPECT_SELECT_ARGUMENT_OPTIONS,T(E,S({},E)));this.bumpSpace();var _=this.parseIdentifierIfPossible(),M=0;if(s!=="select"&&_.value==="offset"){if(!this.bumpIf(":"))return this.error(y.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,T(this.clonePosition(),this.clonePosition()));this.bumpSpace();var d=this.tryParseDecimalInteger(y.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,y.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(d.err)return d;this.bumpSpace(),_=this.parseIdentifierIfPossible(),M=d.val}var H=this.tryParsePluralOrSelectOptions(t,s,r,_);if(H.err)return H;var g=this.tryParseArgumentClose(n);if(g.err)return g;var j=T(n,this.clonePosition());return s==="select"?{val:{type:$.select,value:o,options:la(H.val),location:j},err:null}:{val:{type:$.plural,value:o,options:la(H.val),offset:M,pluralType:s==="plural"?"cardinal":"ordinal",location:j},err:null}}default:return this.error(y.INVALID_ARGUMENT_TYPE,T(a,c))}},e.prototype.tryParseArgumentClose=function(t){return this.isEOF()||this.char()!==125?this.error(y.EXPECT_ARGUMENT_CLOSING_BRACE,T(t,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var t=0,r=this.clonePosition();!this.isEOF();){var o=this.char();switch(o){case 39:{this.bump();var n=this.clonePosition();if(!this.bumpUntil("'"))return this.error(y.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,T(n,this.clonePosition()));this.bump();break}case 123:{t+=1,this.bump();break}case 125:{if(t>0)t-=1;else return{val:this.message.slice(r.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(r.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(t,r){var o=[];try{o=ta(t)}catch{return this.error(y.INVALID_NUMBER_SKELETON,r)}return{val:{type:Ve.number,tokens:o,location:r,parsedOptions:this.shouldParseSkeletons?ia(o):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(t,r,o,n){for(var i,a=!1,s=[],c=new Set,l=n.value,h=n.location;;){if(l.length===0){var d=this.clonePosition();if(r!=="select"&&this.bumpIf("=")){var u=this.tryParseDecimalInteger(y.EXPECT_PLURAL_ARGUMENT_SELECTOR,y.INVALID_PLURAL_ARGUMENT_SELECTOR);if(u.err)return u;h=T(d,this.clonePosition()),l=this.message.slice(d.offset,this.offset())}else break}if(c.has(l))return this.error(r==="select"?y.DUPLICATE_SELECT_ARGUMENT_SELECTOR:y.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,h);l==="other"&&(a=!0),this.bumpSpace();var m=this.clonePosition();if(!this.bumpIf("{"))return this.error(r==="select"?y.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:y.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,T(this.clonePosition(),this.clonePosition()));var g=this.parseMessage(t+1,r,o);if(g.err)return g;var f=this.tryParseArgumentClose(m);if(f.err)return f;s.push([l,{value:g.val,location:T(m,this.clonePosition())}]),c.add(l),this.bumpSpace(),i=this.parseIdentifierIfPossible(),l=i.value,h=i.location}return s.length===0?this.error(r==="select"?y.EXPECT_SELECT_ARGUMENT_SELECTOR:y.EXPECT_PLURAL_ARGUMENT_SELECTOR,T(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!a?this.error(y.MISSING_OTHER_CLAUSE,T(this.clonePosition(),this.clonePosition())):{val:s,err:null}},e.prototype.tryParseDecimalInteger=function(t,r){var o=1,n=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(o=-1);for(var i=!1,a=0;!this.isEOF();){var s=this.char();if(s>=48&&s<=57)i=!0,a=a*10+(s-48),this.bump();else break}var c=T(n,this.clonePosition());return i?(a*=o,Pl(a)?{val:a,err:null}:this.error(r,c)):this.error(t,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var t=this.position.offset;if(t>=this.message.length)throw Error("out of bound");var r=ha(this.message,t);if(r===void 0)throw Error("Offset ".concat(t," is at invalid UTF-16 code unit boundary"));return r},e.prototype.error=function(t,r){return{val:null,err:{kind:t,message:this.message,location:r}}},e.prototype.bump=function(){if(!this.isEOF()){var t=this.char();t===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=t<65536?1:2)}},e.prototype.bumpIf=function(t){if(ca(this.message,t,this.offset())){for(var r=0;r<t.length;r++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(t){var r=this.offset(),o=this.message.indexOf(t,r);return o>=0?(this.bumpTo(o),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(t){if(this.offset()>t)throw Error("targetOffset ".concat(t," must be greater than or equal to the current offset ").concat(this.offset()));for(t=Math.min(t,this.message.length);;){var r=this.offset();if(r===t)break;if(r>t)throw Error("targetOffset ".concat(t," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&ma(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var t=this.char(),r=this.offset(),o=this.message.charCodeAt(r+(t>=65536?2:1));return o??null},e}();function bn(e){return e>=97&&e<=122||e>=65&&e<=90}function Rl(e){return bn(e)||e===47}function Ol(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function ma(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function $l(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function vn(e){e.forEach(function(t){if(delete t.location,Gr(t)||Vr(t))for(var r in t.options)delete t.options[r].location,vn(t.options[r].value);else Br(t)&&qr(t.style)||(zr(t)||Fr(t))&&Zt(t.style)?delete t.style.location:jr(t)&&vn(t.children)})}function pa(e,t){t===void 0&&(t={}),t=S({shouldParseSkeletons:!0,requiresOtherClause:!0},t);var r=new ua(e,t).parse();if(r.err){var o=SyntaxError(y[r.err.kind]);throw o.location=r.err.location,o.originalMessage=r.err.message,o}return t?.captureLocation||vn(r.val),r.val}function Jt(e,t){var r=t&&t.cache?t.cache:Ul,o=t&&t.serializer?t.serializer:Dl,n=t&&t.strategy?t.strategy:Nl;return n(e,{cache:r,serializer:o})}function Ml(e){return e==null||typeof e=="number"||typeof e=="boolean"}function fa(e,t,r,o){var n=Ml(o)?o:r(o),i=t.get(n);return typeof i>"u"&&(i=e.call(this,o),t.set(n,i)),i}function ga(e,t,r){var o=Array.prototype.slice.call(arguments,3),n=r(o),i=t.get(n);return typeof i>"u"&&(i=e.apply(this,o),t.set(n,i)),i}function yn(e,t,r,o,n){return r.bind(t,e,o,n)}function Nl(e,t){var r=e.length===1?fa:ga;return yn(e,this,r,t.cache.create(),t.serializer)}function Il(e,t){return yn(e,this,ga,t.cache.create(),t.serializer)}function Hl(e,t){return yn(e,this,fa,t.cache.create(),t.serializer)}var Dl=function(){return JSON.stringify(arguments)};function En(){this.cache=Object.create(null)}En.prototype.get=function(e){return this.cache[e]};En.prototype.set=function(e,t){this.cache[e]=t};var Ul={create:function(){return new En}},Wr={variadic:Il,monadic:Hl};var je;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(je||(je={}));var er=function(e){Kt(t,e);function t(r,o,n){var i=e.call(this,r)||this;return i.code=o,i.originalMessage=n,i}return t.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},t}(Error);var wn=function(e){Kt(t,e);function t(r,o,n,i){return e.call(this,'Invalid values for "'.concat(r,'": "').concat(o,'". Options are "').concat(Object.keys(n).join('", "'),'"'),je.INVALID_VALUE,i)||this}return t}(er);var xa=function(e){Kt(t,e);function t(r,o,n){return e.call(this,'Value for "'.concat(r,'" must be of type ').concat(o),je.INVALID_VALUE,n)||this}return t}(er);var ba=function(e){Kt(t,e);function t(r,o){return e.call(this,'The intl string context variable "'.concat(r,'" was not provided to the string "').concat(o,'"'),je.MISSING_VALUE,o)||this}return t}(er);var q;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(q||(q={}));function Bl(e){return e.length<2?e:e.reduce(function(t,r){var o=t[t.length-1];return!o||o.type!==q.literal||r.type!==q.literal?t.push(r):o.value+=r.value,t},[])}function zl(e){return typeof e=="function"}function tr(e,t,r,o,n,i,a){if(e.length===1&&dn(e[0]))return[{type:q.literal,value:e[0].value}];for(var s=[],c=0,l=e;c<l.length;c++){var h=l[c];if(dn(h)){s.push({type:q.literal,value:h.value});continue}if(Xi(h)){typeof i=="number"&&s.push({type:q.literal,value:r.getNumberFormat(t).format(i)});continue}var d=h.value;if(!(n&&d in n))throw new ba(d,a);var u=n[d];if(Yi(h)){(!u||typeof u=="string"||typeof u=="number")&&(u=typeof u=="string"||typeof u=="number"?String(u):""),s.push({type:typeof u=="string"?q.literal:q.object,value:u});continue}if(zr(h)){var m=typeof h.style=="string"?o.date[h.style]:Zt(h.style)?h.style.parsedOptions:void 0;s.push({type:q.literal,value:r.getDateTimeFormat(t,m).format(u)});continue}if(Fr(h)){var m=typeof h.style=="string"?o.time[h.style]:Zt(h.style)?h.style.parsedOptions:o.time.medium;s.push({type:q.literal,value:r.getDateTimeFormat(t,m).format(u)});continue}if(Br(h)){var m=typeof h.style=="string"?o.number[h.style]:qr(h.style)?h.style.parsedOptions:void 0;m&&m.scale&&(u=u*(m.scale||1)),s.push({type:q.literal,value:r.getNumberFormat(t,m).format(u)});continue}if(jr(h)){var g=h.children,f=h.value,w=n[f];if(!zl(w))throw new xa(f,"function",a);var A=tr(g,t,r,o,n,i),C=w(A.map(function(M){return M.value}));Array.isArray(C)||(C=[C]),s.push.apply(s,C.map(function(M){return{type:typeof M=="string"?q.literal:q.object,value:M}}))}if(Gr(h)){var E=h.options[u]||h.options.other;if(!E)throw new wn(h.value,u,Object.keys(h.options),a);s.push.apply(s,tr(E.value,t,r,o,n));continue}if(Vr(h)){var E=h.options["=".concat(u)];if(!E){if(!Intl.PluralRules)throw new er(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,je.MISSING_INTL_API,a);var _=r.getPluralRules(t,{type:h.pluralType}).select(u-(h.offset||0));E=h.options[_]||h.options.other}if(!E)throw new wn(h.value,u,Object.keys(h.options),a);s.push.apply(s,tr(E.value,t,r,o,n,u-(h.offset||0)));continue}}return Bl(s)}function Fl(e,t){return t?S(S(S({},e||{}),t||{}),Object.keys(e).reduce(function(r,o){return r[o]=S(S({},e[o]),t[o]||{}),r},{})):e}function Gl(e,t){return t?Object.keys(e).reduce(function(r,o){return r[o]=Fl(e[o],t[o]),r},S({},e)):e}function An(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function Vl(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Jt(function(){for(var t,r=[],o=0;o<arguments.length;o++)r[o]=arguments[o];return new((t=Intl.NumberFormat).bind.apply(t,Ur([void 0],r,!1)))},{cache:An(e.number),strategy:Wr.variadic}),getDateTimeFormat:Jt(function(){for(var t,r=[],o=0;o<arguments.length;o++)r[o]=arguments[o];return new((t=Intl.DateTimeFormat).bind.apply(t,Ur([void 0],r,!1)))},{cache:An(e.dateTime),strategy:Wr.variadic}),getPluralRules:Jt(function(){for(var t,r=[],o=0;o<arguments.length;o++)r[o]=arguments[o];return new((t=Intl.PluralRules).bind.apply(t,Ur([void 0],r,!1)))},{cache:An(e.pluralRules),strategy:Wr.variadic})}}var va=function(){function e(t,r,o,n){var i=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(a){var s=i.formatToParts(a);if(s.length===1)return s[0].value;var c=s.reduce(function(l,h){return!l.length||h.type!==q.literal||typeof l[l.length-1]!="string"?l.push(h.value):l[l.length-1]+=h.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(a){return tr(i.ast,i.locales,i.formatters,i.formats,a,void 0,i.message)},this.resolvedOptions=function(){return{locale:i.resolvedLocale.toString()}},this.getAst=function(){return i.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:n?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Gl(e.formats,o),this.formatters=n&&n.formatters||Vl(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=pa,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var ya=va;var jl=/[0-9\-+#]/,ql=/[^\d\-+#]/g;function Ea(e){return e.search(jl)}function Wl(e="#.##"){let t={},r=e.length,o=Ea(e);t.prefix=o>0?e.substring(0,o):"";let n=Ea(e.split("").reverse().join("")),i=r-n,a=e.substring(i,i+1),s=i+(a==="."||a===","?1:0);t.suffix=n>0?e.substring(s,r):"",t.mask=e.substring(o,s),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let c=t.mask.match(ql);return t.decimal=c&&c[c.length-1]||".",t.separator=c&&c[1]&&c[0]||",",c=t.mask.split(t.decimal),t.integer=c[0],t.fraction=c[1],t}function Yl(e,t,r){let o=!1,n={value:e};e<0&&(o=!0,n.value=-n.value),n.sign=o?"-":"",n.value=Number(n.value).toFixed(t.fraction&&t.fraction.length),n.value=Number(n.value).toString();let i=t.fraction&&t.fraction.lastIndexOf("0"),[a="0",s=""]=n.value.split(".");return(!s||s&&s.length<=i)&&(s=i<0?"":(+("0."+s)).toFixed(i+1).replace("0.","")),n.integer=a,n.fraction=s,Xl(n,t),(n.result==="0"||n.result==="")&&(o=!1,n.sign=""),!o&&t.maskHasPositiveSign?n.sign="+":o&&t.maskHasPositiveSign?n.sign="-":o&&(n.sign=r&&r.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),n}function Xl(e,t){e.result="";let r=t.integer.split(t.separator),o=r.join(""),n=o&&o.indexOf("0");if(n>-1)for(;e.integer.length<o.length-n;)e.integer="0"+e.integer;else Number(e.integer)===0&&(e.integer="");let i=r[1]&&r[r.length-1].length;if(i){let a=e.integer.length,s=a%i;for(let c=0;c<a;c++)e.result+=e.integer.charAt(c),!((c-s+1)%i)&&c<a-i&&(e.result+=t.separator)}else e.result=e.integer;return e.result+=t.fraction&&e.fraction?t.decimal+e.fraction:"",e}function Kl(e,t,r={}){if(!e||isNaN(Number(t)))return t;let o=Wl(e),n=Yl(t,o,r);return o.prefix+n.sign+n.result+o.suffix}var wa=Kl;var Aa=".",Zl=",",Sa=/^\s+/,Ta=/\s+$/,_a="&nbsp;",_n=e=>e*12,Ca=(e,t)=>{let{start:r,end:o,displaySummary:{amount:n,duration:i,minProductQuantity:a,outcomeType:s}={}}=e;if(!(n&&i&&s&&a))return!1;let c=t?new Date(t):new Date;if(!r||!o)return!1;let l=new Date(r),h=new Date(o);return c>=l&&c<=h},qe={MONTH:"MONTH",YEAR:"YEAR"},Ql={[te.ANNUAL]:12,[te.MONTHLY]:1,[te.THREE_YEARS]:36,[te.TWO_YEARS]:24},Sn=(e,t)=>({accept:e,round:t}),Jl=[Sn(({divisor:e,price:t})=>t%e==0,({divisor:e,price:t})=>t/e),Sn(({usePrecision:e})=>e,({divisor:e,price:t})=>Math.round(t/e*100)/100),Sn(()=>!0,({divisor:e,price:t})=>Math.ceil(Math.floor(t*100/e)/100))],Tn={[De.YEAR]:{[te.MONTHLY]:qe.MONTH,[te.ANNUAL]:qe.YEAR},[De.MONTH]:{[te.MONTHLY]:qe.MONTH}},eh=(e,t)=>e.indexOf(`'${t}'`)===0,th=(e,t=!0)=>{let r=e.replace(/'.*?'/,"").trim(),o=ka(r);return!!o?t||(r=r.replace(/[,\.]0+/,o)):r=r.replace(/\s?(#.*0)(?!\s)?/,"$&"+oh(e)),r},rh=e=>{let t=nh(e),r=eh(e,t),o=e.replace(/'.*?'/,""),n=Sa.test(o)||Ta.test(o);return{currencySymbol:t,isCurrencyFirst:r,hasCurrencySpace:n}},Pa=e=>e.replace(Sa,_a).replace(Ta,_a),oh=e=>e.match(/#(.?)#/)?.[1]===Aa?Zl:Aa,nh=e=>e.match(/'(.*?)'/)?.[1]??"",ka=e=>e.match(/0(.?)0/)?.[1]??"";function ft({formatString:e,price:t,usePrecision:r,isIndianPrice:o=!1},n,i=a=>a){let{currencySymbol:a,isCurrencyFirst:s,hasCurrencySpace:c}=rh(e),l=r?ka(e):"",h=th(e,r),d=r?2:0,u=i(t,{currencySymbol:a}),m=o?u.toLocaleString("hi-IN",{minimumFractionDigits:d,maximumFractionDigits:d}):wa(h,u),g=r?m.lastIndexOf(l):m.length,f=m.substring(0,g),w=m.substring(g+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,m).replace(/SYMBOL/,a),currencySymbol:a,decimals:w,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:n}}var La=e=>{let{commitment:t,term:r,usePrecision:o}=e,n=Ql[r]??1;return ft(e,n>1?qe.MONTH:Tn[t]?.[r],i=>{let a={divisor:n,price:i,usePrecision:o},{round:s}=Jl.find(({accept:c})=>c(a));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(a)}`);return s(a)})},Ra=({commitment:e,term:t,...r})=>ft(r,Tn[e]?.[t]),Oa=e=>{let{commitment:t,instant:r,price:o,originalPrice:n,priceWithoutDiscount:i,promotion:a,quantity:s=1,term:c}=e;if(t===De.YEAR&&c===te.MONTHLY){if(!a)return ft(e,qe.YEAR,_n);let{displaySummary:{outcomeType:l,duration:h,minProductQuantity:d=1}={}}=a;switch(l){case"PERCENTAGE_DISCOUNT":if(s>=d&&Ca(a,r)){let u=parseInt(h.replace("P","").replace("M",""));if(isNaN(u))return _n(o);let m=s*n*u,g=s*i*(12-u),f=Math.floor((m+g)*100)/100;return ft({...e,price:f},qe.YEAR)}default:return ft(e,qe.YEAR,()=>_n(i??o))}}return ft(e,Tn[t]?.[c])};var ih={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at"},ah=Ci("ConsonantTemplates/price"),sh=/<\/?[^>]+(>|$)/g,B={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},gt={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},ch="TAX_EXCLUSIVE",lh=e=>_i(e)?Object.entries(e).filter(([,t])=>dt(t)||Pr(t)||t===!0).reduce((t,[r,o])=>t+` ${r}${o===!0?"":'="'+Ai(o)+'"'}`,""):"",K=(e,t,r,o=!1)=>`<span class="${e}${t?"":" "+B.disabled}"${lh(r)}>${o?Pa(t):t??""}</span>`;function hh(e,{accessibleLabel:t,altAccessibleLabel:r,currencySymbol:o,decimals:n,decimalsDelimiter:i,hasCurrencySpace:a,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:h,taxInclusivityLabel:d},u={}){let m=K(B.currencySymbol,o),g=K(B.currencySpace,a?"&nbsp;":""),f="";return t?f=`<sr-only class="strikethrough-aria-label">${t}</sr-only>`:r&&(f=`<sr-only class="alt-aria-label">${r}</sr-only>`),c&&(f+=m+g),f+=K(B.integer,s),f+=K(B.decimalsDelimiter,i),f+=K(B.decimals,n),c||(f+=g+m),f+=K(B.recurrence,l,null,!0),f+=K(B.unitType,h,null,!0),f+=K(B.taxInclusivity,d,!0),K(e,f,{...u})}var Z=({isAlternativePrice:e=!1,displayOptical:t=!1,displayStrikethrough:r=!1,displayAnnual:o=!1,instant:n=void 0}={})=>({country:i,displayFormatted:a=!0,displayRecurrence:s=!0,displayPerUnit:c=!1,displayTax:l=!1,language:h,literals:d={},quantity:u=1}={},{commitment:m,offerSelectorIds:g,formatString:f,price:w,priceWithoutDiscount:A,taxDisplay:C,taxTerm:E,term:_,usePrecision:M,promotion:H}={},j={})=>{Object.entries({country:i,formatString:f,language:h,price:w}).forEach(([yo,Eo])=>{if(Eo==null)throw new Error(`Argument "${yo}" is missing for osi ${g?.toString()}, country ${i}, language ${h}`)});let Y={...ih,...d},ne=`${h.toLowerCase()}-${i.toUpperCase()}`;function U(yo,Eo){let wo=Y[yo];if(wo==null)return"";try{return new ya(wo.replace(sh,""),ne).format(Eo)}catch{return ah.error("Failed to format literal:",wo),""}}let Q=r&&A?A:w,se=t?La:Ra;o&&(se=Oa);let{accessiblePrice:_e,recurrenceTerm:he,...Ie}=se({commitment:m,formatString:f,instant:n,isIndianPrice:i==="IN",originalPrice:w,priceWithoutDiscount:A,price:t?w:Q,promotion:H,quantity:u,term:_,usePrecision:M}),He="",st="",zt="";P(s)&&he&&(zt=U(gt.recurrenceLabel,{recurrenceTerm:he}));let bo="";P(c)&&(bo=U(gt.perUnitLabel,{perUnit:"LICENSE"}));let vo="";P(l)&&E&&(vo=U(C===ch?gt.taxExclusiveLabel:gt.taxInclusiveLabel,{taxTerm:E})),r&&(He=U(gt.strikethroughAriaLabel,{strikethroughPrice:He})),e&&(st=U(gt.alternativePriceAriaLabel,{alternativePrice:st}));let ct=B.container;if(t&&(ct+=" "+B.containerOptical),r&&(ct+=" "+B.containerStrikethrough),e&&(ct+=" "+B.containerAlternative),o&&(ct+=" "+B.containerAnnual),P(a))return hh(ct,{...Ie,accessibleLabel:He,altAccessibleLabel:st,recurrenceLabel:zt,perUnitLabel:bo,taxInclusivityLabel:vo},j);let{currencySymbol:bi,decimals:fc,decimalsDelimiter:gc,hasCurrencySpace:vi,integer:xc,isCurrencyFirst:bc}=Ie,lt=[xc,gc,fc];bc?(lt.unshift(vi?"\xA0":""),lt.unshift(bi)):(lt.push(vi?"\xA0":""),lt.push(bi)),lt.push(zt,bo,vo);let vc=lt.join("");return K(ct,vc,j)},$a=()=>(e,t,r)=>{let n=(e.displayOldPrice===void 0||P(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${n?Z({displayStrikethrough:!0})(e,t,r)+"&nbsp;":""}${Z({isAlternativePrice:n})(e,t,r)}`},Ma=()=>(e,t,r)=>{let{instant:o}=e;try{o||(o=new URLSearchParams(document.location.search).get("instant")),o&&(o=new Date(o))}catch{o=void 0}let n={...e,displayTax:!1,displayPerUnit:!1},a=(e.displayOldPrice===void 0||P(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${a?Z({displayStrikethrough:!0})(n,t,r)+"&nbsp;":""}${Z({isAlternativePrice:a})(e,t,r)}${K(B.containerAnnualPrefix,"&nbsp;(")}${Z({displayAnnual:!0,instant:o})(n,t,r)}${K(B.containerAnnualSuffix,")")}`},Na=()=>(e,t,r)=>{let o={...e,displayTax:!1,displayPerUnit:!1};return`${Z({isAlternativePrice:e.displayOldPrice})(e,t,r)}${K(B.containerAnnualPrefix,"&nbsp;(")}${Z({displayAnnual:!0})(o,t,r)}${K(B.containerAnnualSuffix,")")}`};var Ia=Z(),Ha=$a(),Da=Z({displayOptical:!0}),Ua=Z({displayStrikethrough:!0}),Ba=Z({displayAnnual:!0}),za=Z({displayOptical:!0,isAlternativePrice:!0}),Fa=Z({isAlternativePrice:!0}),Ga=Na(),Va=Ma();var dh=(e,t)=>{if(!(!jt(e)||!jt(t)))return Math.floor((t-e)/t*100)},ja=()=>(e,t)=>{let{price:r,priceWithoutDiscount:o}=t,n=dh(r,o);return n===void 0?'<span class="no-discount"></span>':`<span class="discount">${n}%</span>`};var qa=ja();var Wa=["GB_en","AU_en","FR_fr","AT_de","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GR_el","GR_en","HU_hu","IE_en","IT_it","LU_de","LU_en","LU_fr","NL_nl","NO_nb","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TR_tr","UA_uk","ID_en","ID_in","IN_en","IN_hi","JP_ja","MY_en","MY_ms","NZ_en","TH_en","TH_th"],uh={INDIVIDUAL_COM:["ZA_en","LT_lt","LV_lv","NG_en","SA_ar","SA_en","ZA_en","SG_en","KR_ko"],TEAM_COM:["ZA_en","LT_lt","LV_lv","NG_en","ZA_en","CO_es","KR_ko"],INDIVIDUAL_EDU:["LT_lt","LV_lv","SA_en","SG_en"],TEAM_EDU:["SG_en","KR_ko"]},rr=class rr extends HTMLSpanElement{constructor(){super();p(this,"masElement",new pt(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-annual","data-perpetual","data-promotion-code","data-tax-exclusive","data-template","data-wcs-osi"]}static createInlinePrice(r){let o=X();if(!o)return null;let{displayOldPrice:n,displayPerUnit:i,displayRecurrence:a,displayTax:s,displayAnnual:c,forceTaxExclusive:l,perpetual:h,promotionCode:d,quantity:u,alternativePrice:m,template:g,wcsOsi:f}=o.collectPriceOptions(r);return Nr(rr,{displayOldPrice:n,displayPerUnit:i,displayRecurrence:a,displayTax:s,displayAnnual:c,forceTaxExclusive:l,perpetual:h,promotionCode:d,quantity:u,alternativePrice:m,template:g,wcsOsi:f})}get isInlinePrice(){return!0}attributeChangedCallback(r,o,n){this.masElement.attributeChangedCallback(r,o,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}resolveDisplayTaxForGeoAndSegment(r,o,n,i){let a=`${r}_${o}`;if(Wa.includes(r)||Wa.includes(a))return!0;let s=uh[`${n}_${i}`];return s?!!(s.includes(r)||s.includes(a)):!1}async resolveDisplayTax(r,o){let[n]=await r.resolveOfferSelectors(o),i=Wt(await n,o);if(i?.length){let{country:a,language:s}=o,c=i[0],[l=""]=c.marketSegments;return this.resolveDisplayTaxForGeoAndSegment(a,s,c.customerSegment,l)}}async render(r={}){if(!this.isConnected)return!1;let o=X();if(!o)return!1;let n=o.collectPriceOptions(r,this);if(!n.wcsOsi.length)return!1;let i=this.masElement.togglePending(n);this.innerHTML="";let[a]=o.resolveOfferSelectors(n);return this.renderOffers(Wt(await a,n),n,i)}renderOffers(r,o={},n=void 0){if(!this.isConnected)return;let i=X();if(!i)return!1;let a=i.collectPriceOptions({...this.dataset,...o},this);if(n??(n=this.masElement.togglePending(a)),r.length){if(this.masElement.toggleResolved(n,r,a)){this.innerHTML=i.buildPriceHTML(r,a);let s=this.closest("p, h3, div");if(!s||!s.querySelector('span[data-template="strikethrough"]')||s.querySelector(".alt-aria-label"))return!0;let c=s?.querySelectorAll('span[is="inline-price"]');return c.length>1&&c.length===s.querySelectorAll('span[data-template="strikethrough"]').length*2&&c.forEach(l=>{l.dataset.template!=="strikethrough"&&l.options&&!l.options.alternativePrice&&(l.options.alternativePrice=!0,l.innerHTML=i.buildPriceHTML(r,l.options))}),!0}}else{let s=new Error(`Not provided: ${a?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(n,s,a))return this.innerHTML="",!0}return!1}updateOptions(r){let o=X();if(!o)return!1;let{alternativePrice:n,displayOldPrice:i,displayPerUnit:a,displayRecurrence:s,displayTax:c,forceTaxExclusive:l,perpetual:h,promotionCode:d,quantity:u,template:m,wcsOsi:g}=o.collectPriceOptions(r);return Ir(this,{alternativePrice:n,displayOldPrice:i,displayPerUnit:a,displayRecurrence:s,displayTax:c,forceTaxExclusive:l,perpetual:h,promotionCode:d,quantity:u,template:m,wcsOsi:g}),!0}};p(rr,"is","inline-price"),p(rr,"tag","span");var be=rr;window.customElements.get(be.is)||window.customElements.define(be.is,be,{extends:be.tag});function Ya({literals:e,providers:t,settings:r}){function o(a,s){let{country:c,displayOldPrice:l,displayPerUnit:h,displayRecurrence:d,displayTax:u,forceTaxExclusive:m,language:g,promotionCode:f,quantity:w,alternativePrice:A}=r,{displayOldPrice:C=l,displayPerUnit:E=h,displayRecurrence:_=d,displayTax:M=u,forceTaxExclusive:H=m,country:j=c,language:Y=g,perpetual:ne,displayAnnual:U,promotionCode:Q=f,quantity:se=w,alternativePrice:_e=A,template:he,wcsOsi:Ie,...He}=Object.assign({},s?.dataset??{},a??{}),st=qt({...He,country:j,displayOldPrice:P(C),displayPerUnit:P(E),displayRecurrence:P(_),displayTax:P(M),displayAnnual:P(U),forceTaxExclusive:P(H),language:Y,perpetual:P(ne),promotionCode:Lr(Q).effectivePromoCode,quantity:ut(se,k.quantity),alternativePrice:P(_e),template:he,wcsOsi:$r(Ie)});if(s)for(let zt of t.price)zt(s,st);return st}function n(a,s){if(!Array.isArray(a)||!a.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=qa;break;case"strikethrough":l=Ua;break;case"annual":l=Ba;break;default:s.template==="optical"&&s.alternativePrice?l=za:s.template==="optical"?l=Da:s.displayAnnual&&a[0].planType==="ABM"?l=s.promotionCode?Va:Ga:s.alternativePrice?l=Fa:l=s.promotionCode?Ha:Ia}let h=o(s);h.literals=Object.assign({},e.price,qt(s.literals??{}));let[d]=a;return d={...d,...d.priceDetails},l(h,d)}let i=be.createInlinePrice;return{InlinePrice:be,buildPriceHTML:n,collectPriceOptions:o,createInlinePrice:i}}function mh({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||k.language),t??(t=e?.split("_")?.[1]||k.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function Xa(e={}){let{commerce:t={}}=e,r=fe.PRODUCTION,o=Bo,n=I("checkoutClientId",t)??k.checkoutClientId,i=Fe(I("checkoutWorkflow",t),ie,k.checkoutWorkflow),a=V.CHECKOUT;i===ie.V3&&(a=Fe(I("checkoutWorkflowStep",t),V,k.checkoutWorkflowStep));let s=P(I("displayOldPrice",t),k.displayOldPrice),c=P(I("displayPerUnit",t),k.displayPerUnit),l=P(I("displayRecurrence",t),k.displayRecurrence),h=P(I("displayTax",t),k.displayTax),d=P(I("entitlement",t),k.entitlement),u=P(I("modal",t),k.modal),m=P(I("forceTaxExclusive",t),k.forceTaxExclusive),g=I("promotionCode",t)??k.promotionCode,f=ut(I("quantity",t)),w=I("wcsApiKey",t)??k.wcsApiKey,A=t?.env==="stage",C=Te.PUBLISHED;["true",""].includes(t.allowOverride)&&(A=(I(Do,t,{metadata:!1})?.toLowerCase()??t?.env)==="stage",C=Fe(I(Uo,t),Te,C)),A&&(r=fe.STAGE,o=zo);let _=I("mas-io-url")??e.masIOUrl??`https://www${r===fe.STAGE?".stage":""}.adobe.com/mas/io`;return{...mh(e),displayOldPrice:s,checkoutClientId:n,checkoutWorkflow:i,checkoutWorkflowStep:a,displayPerUnit:c,displayRecurrence:l,displayTax:h,entitlement:d,extraOptions:k.extraOptions,modal:u,env:r,forceTaxExclusive:m,promotionCode:g,quantity:f,alternativePrice:k.alternativePrice,wcsApiKey:w,wcsURL:o,landscape:C,masIOUrl:_}}async function Yr(e,t={},r=2,o=100){let n;for(let i=0;i<=r;i++)try{return await fetch(e,t)}catch(a){if(n=a,i>r)break;await new Promise(s=>setTimeout(s,o*(i+1)))}throw n}var Cn="wcs";function Ka({settings:e}){let t=ee.module(Cn),{env:r,wcsApiKey:o}=e,n=new Map,i=new Map,a,s=new Map;async function c(u,m,g=!0){let f=X(),w=Mo;t.debug("Fetching:",u);let A="",C;if(u.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let E=new Map(m),[_]=u.offerSelectorIds,M=Date.now()+Math.random().toString(36).substring(2,7),H=`${Cn}:${_}:${M}${Ce}`,j=`${Cn}:${_}:${M}${Vt}`,Y,ne;try{if(performance.mark(H),A=new URL(e.wcsURL),A.searchParams.set("offer_selector_ids",_),A.searchParams.set("country",u.country),A.searchParams.set("locale",u.locale),A.searchParams.set("landscape",r===fe.STAGE?"ALL":e.landscape),A.searchParams.set("api_key",o),u.language&&A.searchParams.set("language",u.language),u.promotionCode&&A.searchParams.set("promotion_code",u.promotionCode),u.currency&&A.searchParams.set("currency",u.currency),C=await Yr(A.toString(),{credentials:"omit"}),C.ok){let U=[];try{let Q=await C.json();t.debug("Fetched:",u,Q),U=Q.resolvedOffers??[]}catch(Q){t.error(`Error parsing JSON: ${Q.message}`,{...Q.context,...f?.duration})}U=U.map(Rr),m.forEach(({resolve:Q},se)=>{let _e=U.filter(({offerSelectorIds:he})=>he.includes(se)).flat();_e.length&&(E.delete(se),m.delete(se),Q(_e))})}else w=$o}catch(U){w=`Network error: ${U.message}`}finally{({startTime:Y,duration:ne}=performance.measure(j,H)),performance.clearMarks(H),performance.clearMeasures(j)}g&&m.size&&(t.debug("Missing:",{offerSelectorIds:[...m.keys()]}),m.forEach(U=>{U.reject(new ge(w,{...u,response:C,startTime:Y,duration:ne,...f?.duration}))}))}function l(){clearTimeout(a);let u=[...i.values()];i.clear(),u.forEach(({options:m,promises:g})=>c(m,g))}function h(){let u=n.size;s=new Map(n),n.clear(),t.debug(`Moved ${u} cache entries to stale cache`)}function d({country:u,language:m,perpetual:g=!1,promotionCode:f="",wcsOsi:w=[]}){let A=`${m}_${u}`;u!=="GB"&&(m=g?"EN":"MULT");let C=[u,m,f].filter(E=>E).join("-").toLowerCase();return w.map(E=>{let _=`${E}-${C}`;if(n.has(_))return n.get(_);let M=new Promise((H,j)=>{let Y=i.get(C);if(!Y){let ne={country:u,locale:A,offerSelectorIds:[]};u!=="GB"&&(ne.language=m),Y={options:ne,promises:new Map},i.set(C,Y)}f&&(Y.options.promotionCode=f),Y.options.offerSelectorIds.push(E),Y.promises.set(E,{resolve:H,reject:j}),l()}).catch(H=>{if(s.has(_))return s.get(_);throw H});return n.set(_,M),M})}return{Commitment:De,PlanType:ki,Term:te,applyPlanType:Rr,resolveOfferSelectors:d,flushWcsCacheInternal:h}}var Za="mas-commerce-service",Qa="mas:start",Ja="mas:ready",es="mas-commerce-service:initTime",or,Xr,ts,Pn=class extends HTMLElement{constructor(){super(...arguments);L(this,Xr);L(this,or);p(this,"lastLoggingTime",0)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(o,n,i)=>{let a=await r?.(o,n,this.imsSignedInPromise,i);return a||null})}activate(){let r=b(this,Xr,ts),o=Object.freeze(Xa(r));mt(r.lana);let n=ee.init(r.hostEnv).module("service");n.debug("Activating:",r);let a={price:Wi(o)},s={checkout:new Set,price:new Set},c={literals:a,providers:s,settings:o};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...Vi(c),...ji(c),...Ya(c),...Ka(c),...Vo,Log:ee,get defaults(){return k},get log(){return ee},get providers(){return{checkout(h){return s.checkout.add(h),()=>s.checkout.delete(h)},price(h){return s.price.add(h),()=>s.price.delete(h)}}},get settings(){return o}})),n.debug("Activated:",{literals:a,settings:o});let l=new CustomEvent(Sr,{bubbles:!0,cancelable:!1,detail:this});performance.mark(Ja),R(this,or,performance.measure(es,Qa,Ja)?.duration),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(Qa),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(Ft).forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh()),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{[es]:b(this,or)}}logFailedRequests(){let r=[...performance.getEntriesByType("resource")].filter(({startTime:n})=>n>this.lastLoggingTime).filter(({transferSize:n,duration:i,responseStatus:a})=>n===0&&i===0&&a<200||a>=400),o=Array.from(new Map(r.map(n=>[n.name,n])).values());if(o.some(({name:n})=>/(\/fragments\/|web_commerce_artifact)/.test(n))){let n=o.map(({name:i})=>i);this.log.error("Failed requests:",{failedUrls:n,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};or=new WeakMap,Xr=new WeakSet,ts=function(){let r=this.getAttribute("env")??"prod",o={hostEnv:{name:r},commerce:{env:r},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:r==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language"].forEach(n=>{let i=this.getAttribute(n);i&&(o[n]=i)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(n=>{let i=this.getAttribute(n);if(i!=null){let a=n.replace(/-([a-z])/g,s=>s[1].toUpperCase());o.commerce[a]=i}}),o};window.customElements.get(Za)||window.customElements.define(Za,Pn);var nr=class nr extends Dr(HTMLButtonElement){static createCheckoutButton(t={},r=""){return Hr(nr,t,r)}setCheckoutUrl(t){this.setAttribute("data-href",t)}get href(){return this.getAttribute("data-href")}get isCheckoutButton(){return!0}clickHandler(t){if(this.checkoutActionHandler){this.checkoutActionHandler?.(t);return}this.href&&(window.location.href=this.href)}};p(nr,"is","checkout-button"),p(nr,"tag","button");var xt=nr;window.customElements.get(xt.is)||window.customElements.define(xt.is,xt,{extends:xt.tag});var ph="mas-commerce-service";function rs(e,t){let r;return function(){let o=this,n=arguments;clearTimeout(r),r=setTimeout(()=>e.apply(o,n),t)}}function We(e,t={},r=null,o=null){let n=o?document.createElement(e,{is:o}):document.createElement(e);r instanceof HTMLElement?n.appendChild(r):n.innerHTML=r;for(let[i,a]of Object.entries(t))n.setAttribute(i,a);return n}function Kr(){return window.matchMedia("(max-width: 767px)")}function bt(){return Kr().matches}function os(){return window.matchMedia("(max-width: 1024px)").matches}function vt(){return document.getElementsByTagName(ph)?.[0]}function fh(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var ir,Ye=class Ye extends HTMLAnchorElement{constructor(){super();L(this,ir,!1);this.setAttribute("is",Ye.is)}get isUptLink(){return!0}initializeWcsData(r,o){this.setAttribute("data-wcs-osi",r),o&&this.setAttribute("data-promotion-code",o),R(this,ir,!0),this.composePromoTermsUrl()}attributeChangedCallback(r,o,n){b(this,ir)&&this.composePromoTermsUrl()}composePromoTermsUrl(){let r=this.getAttribute("data-wcs-osi");if(!r){let d=this.closest("merch-card").querySelector("aem-fragment").getAttribute("fragment");console.error(`Missing 'data-wcs-osi' attribute on upt-link. Fragment: ${d}`);return}let o=vt(),n=[r],i=this.getAttribute("data-promotion-code"),{country:a,language:s,env:c}=o.settings,l={country:a,language:s,wcsOsi:n,promotionCode:i},h=o.resolveOfferSelectors(l);Promise.all(h).then(([[d]])=>{let u=`locale=${s}_${a}&country=${a}&offer_id=${d.offerId}`;i&&(u+=`&promotion_code=${encodeURIComponent(i)}`),this.href=`${fh(c)}?${u}`}).catch(d=>{console.error(`Could not resolve offer selectors for id: ${r}.`,d.message)})}static createFrom(r){let o=new Ye;for(let n of r.attributes)n.name!=="is"&&(n.name==="class"&&n.value.includes("upt-link")?o.setAttribute("class",n.value.replace("upt-link","").trim()):o.setAttribute(n.name,n.value));return o.innerHTML=r.innerHTML,o.setAttribute("tabindex",0),o}};ir=new WeakMap,p(Ye,"is","upt-link"),p(Ye,"tag","a"),p(Ye,"observedAttributes",["data-wcs-osi","data-promotion-code"]);var Pe=Ye;window.customElements.get(Pe.is)||window.customElements.define(Pe.is,Pe,{extends:Pe.tag});var Zr=window,Jr=Zr.ShadowRoot&&(Zr.ShadyCSS===void 0||Zr.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,is=Symbol(),ns=new WeakMap,Qr=class{constructor(t,r,o){if(this._$cssResult$=!0,o!==is)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=r}get styleSheet(){let t=this.o,r=this.t;if(Jr&&t===void 0){let o=r!==void 0&&r.length===1;o&&(t=ns.get(r)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),o&&ns.set(r,t))}return t}toString(){return this.cssText}},as=e=>new Qr(typeof e=="string"?e:e+"",void 0,is);var kn=(e,t)=>{Jr?e.adoptedStyleSheets=t.map(r=>r instanceof CSSStyleSheet?r:r.styleSheet):t.forEach(r=>{let o=document.createElement("style"),n=Zr.litNonce;n!==void 0&&o.setAttribute("nonce",n),o.textContent=r.cssText,e.appendChild(o)})},eo=Jr?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let r="";for(let o of t.cssRules)r+=o.cssText;return as(r)})(e):e;var Ln,to=window,ss=to.trustedTypes,gh=ss?ss.emptyScript:"",cs=to.reactiveElementPolyfillSupport,On={toAttribute(e,t){switch(t){case Boolean:e=e?gh:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let r=e;switch(t){case Boolean:r=e!==null;break;case Number:r=e===null?null:Number(e);break;case Object:case Array:try{r=JSON.parse(e)}catch{r=null}}return r}},ls=(e,t)=>t!==e&&(t==t||e==e),Rn={attribute:!0,type:String,converter:On,reflect:!1,hasChanged:ls},$n="finalized",Xe=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this._$Eu()}static addInitializer(t){var r;this.finalize(),((r=this.h)!==null&&r!==void 0?r:this.h=[]).push(t)}static get observedAttributes(){this.finalize();let t=[];return this.elementProperties.forEach((r,o)=>{let n=this._$Ep(o,r);n!==void 0&&(this._$Ev.set(n,o),t.push(n))}),t}static createProperty(t,r=Rn){if(r.state&&(r.attribute=!1),this.finalize(),this.elementProperties.set(t,r),!r.noAccessor&&!this.prototype.hasOwnProperty(t)){let o=typeof t=="symbol"?Symbol():"__"+t,n=this.getPropertyDescriptor(t,o,r);n!==void 0&&Object.defineProperty(this.prototype,t,n)}}static getPropertyDescriptor(t,r,o){return{get(){return this[r]},set(n){let i=this[t];this[r]=n,this.requestUpdate(t,i,o)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)||Rn}static finalize(){if(this.hasOwnProperty($n))return!1;this[$n]=!0;let t=Object.getPrototypeOf(this);if(t.finalize(),t.h!==void 0&&(this.h=[...t.h]),this.elementProperties=new Map(t.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){let r=this.properties,o=[...Object.getOwnPropertyNames(r),...Object.getOwnPropertySymbols(r)];for(let n of o)this.createProperty(n,r[n])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(t){let r=[];if(Array.isArray(t)){let o=new Set(t.flat(1/0).reverse());for(let n of o)r.unshift(eo(n))}else t!==void 0&&r.push(eo(t));return r}static _$Ep(t,r){let o=r.attribute;return o===!1?void 0:typeof o=="string"?o:typeof t=="string"?t.toLowerCase():void 0}_$Eu(){var t;this._$E_=new Promise(r=>this.enableUpdating=r),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(t=this.constructor.h)===null||t===void 0||t.forEach(r=>r(this))}addController(t){var r,o;((r=this._$ES)!==null&&r!==void 0?r:this._$ES=[]).push(t),this.renderRoot!==void 0&&this.isConnected&&((o=t.hostConnected)===null||o===void 0||o.call(t))}removeController(t){var r;(r=this._$ES)===null||r===void 0||r.splice(this._$ES.indexOf(t)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((t,r)=>{this.hasOwnProperty(r)&&(this._$Ei.set(r,this[r]),delete this[r])})}createRenderRoot(){var t;let r=(t=this.shadowRoot)!==null&&t!==void 0?t:this.attachShadow(this.constructor.shadowRootOptions);return kn(r,this.constructor.elementStyles),r}connectedCallback(){var t;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$ES)===null||t===void 0||t.forEach(r=>{var o;return(o=r.hostConnected)===null||o===void 0?void 0:o.call(r)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$ES)===null||t===void 0||t.forEach(r=>{var o;return(o=r.hostDisconnected)===null||o===void 0?void 0:o.call(r)})}attributeChangedCallback(t,r,o){this._$AK(t,o)}_$EO(t,r,o=Rn){var n;let i=this.constructor._$Ep(t,o);if(i!==void 0&&o.reflect===!0){let a=(((n=o.converter)===null||n===void 0?void 0:n.toAttribute)!==void 0?o.converter:On).toAttribute(r,o.type);this._$El=t,a==null?this.removeAttribute(i):this.setAttribute(i,a),this._$El=null}}_$AK(t,r){var o;let n=this.constructor,i=n._$Ev.get(t);if(i!==void 0&&this._$El!==i){let a=n.getPropertyOptions(i),s=typeof a.converter=="function"?{fromAttribute:a.converter}:((o=a.converter)===null||o===void 0?void 0:o.fromAttribute)!==void 0?a.converter:On;this._$El=i,this[i]=s.fromAttribute(r,a.type),this._$El=null}}requestUpdate(t,r,o){let n=!0;t!==void 0&&(((o=o||this.constructor.getPropertyOptions(t)).hasChanged||ls)(this[t],r)?(this._$AL.has(t)||this._$AL.set(t,r),o.reflect===!0&&this._$El!==t&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(t,o))):n=!1),!this.isUpdatePending&&n&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(r){Promise.reject(r)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var t;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((n,i)=>this[i]=n),this._$Ei=void 0);let r=!1,o=this._$AL;try{r=this.shouldUpdate(o),r?(this.willUpdate(o),(t=this._$ES)===null||t===void 0||t.forEach(n=>{var i;return(i=n.hostUpdate)===null||i===void 0?void 0:i.call(n)}),this.update(o)):this._$Ek()}catch(n){throw r=!1,this._$Ek(),n}r&&this._$AE(o)}willUpdate(t){}_$AE(t){var r;(r=this._$ES)===null||r===void 0||r.forEach(o=>{var n;return(n=o.hostUpdated)===null||n===void 0?void 0:n.call(o)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(t){return!0}update(t){this._$EC!==void 0&&(this._$EC.forEach((r,o)=>this._$EO(o,this[o],r)),this._$EC=void 0),this._$Ek()}updated(t){}firstUpdated(t){}};Xe[$n]=!0,Xe.elementProperties=new Map,Xe.elementStyles=[],Xe.shadowRootOptions={mode:"open"},cs?.({ReactiveElement:Xe}),((Ln=to.reactiveElementVersions)!==null&&Ln!==void 0?Ln:to.reactiveElementVersions=[]).push("1.6.3");var Mn,ro=window,yt=ro.trustedTypes,hs=yt?yt.createPolicy("lit-html",{createHTML:e=>e}):void 0,In="$lit$",ke=`lit$${(Math.random()+"").slice(9)}$`,xs="?"+ke,xh=`<${xs}>`,Qe=document,oo=()=>Qe.createComment(""),sr=e=>e===null||typeof e!="object"&&typeof e!="function",bs=Array.isArray,bh=e=>bs(e)||typeof e?.[Symbol.iterator]=="function",Nn=`[ 	
\f\r]`,ar=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ds=/-->/g,us=/>/g,Ke=RegExp(`>|${Nn}(?:([^\\s"'>=/]+)(${Nn}*=${Nn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ms=/'/g,ps=/"/g,vs=/^(?:script|style|textarea|title)$/i,ys=e=>(t,...r)=>({_$litType$:e,strings:t,values:r}),up=ys(1),mp=ys(2),cr=Symbol.for("lit-noChange"),z=Symbol.for("lit-nothing"),fs=new WeakMap,Ze=Qe.createTreeWalker(Qe,129,null,!1);function Es(e,t){if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return hs!==void 0?hs.createHTML(t):t}var vh=(e,t)=>{let r=e.length-1,o=[],n,i=t===2?"<svg>":"",a=ar;for(let s=0;s<r;s++){let c=e[s],l,h,d=-1,u=0;for(;u<c.length&&(a.lastIndex=u,h=a.exec(c),h!==null);)u=a.lastIndex,a===ar?h[1]==="!--"?a=ds:h[1]!==void 0?a=us:h[2]!==void 0?(vs.test(h[2])&&(n=RegExp("</"+h[2],"g")),a=Ke):h[3]!==void 0&&(a=Ke):a===Ke?h[0]===">"?(a=n??ar,d=-1):h[1]===void 0?d=-2:(d=a.lastIndex-h[2].length,l=h[1],a=h[3]===void 0?Ke:h[3]==='"'?ps:ms):a===ps||a===ms?a=Ke:a===ds||a===us?a=ar:(a=Ke,n=void 0);let m=a===Ke&&e[s+1].startsWith("/>")?" ":"";i+=a===ar?c+xh:d>=0?(o.push(l),c.slice(0,d)+In+c.slice(d)+ke+m):c+ke+(d===-2?(o.push(void 0),s):m)}return[Es(e,i+(e[r]||"<?>")+(t===2?"</svg>":"")),o]},lr=class e{constructor({strings:t,_$litType$:r},o){let n;this.parts=[];let i=0,a=0,s=t.length-1,c=this.parts,[l,h]=vh(t,r);if(this.el=e.createElement(l,o),Ze.currentNode=this.el.content,r===2){let d=this.el.content,u=d.firstChild;u.remove(),d.append(...u.childNodes)}for(;(n=Ze.nextNode())!==null&&c.length<s;){if(n.nodeType===1){if(n.hasAttributes()){let d=[];for(let u of n.getAttributeNames())if(u.endsWith(In)||u.startsWith(ke)){let m=h[a++];if(d.push(u),m!==void 0){let g=n.getAttribute(m.toLowerCase()+In).split(ke),f=/([.?@])?(.*)/.exec(m);c.push({type:1,index:i,name:f[2],strings:g,ctor:f[1]==="."?Dn:f[1]==="?"?Un:f[1]==="@"?Bn:wt})}else c.push({type:6,index:i})}for(let u of d)n.removeAttribute(u)}if(vs.test(n.tagName)){let d=n.textContent.split(ke),u=d.length-1;if(u>0){n.textContent=yt?yt.emptyScript:"";for(let m=0;m<u;m++)n.append(d[m],oo()),Ze.nextNode(),c.push({type:2,index:++i});n.append(d[u],oo())}}}else if(n.nodeType===8)if(n.data===xs)c.push({type:2,index:i});else{let d=-1;for(;(d=n.data.indexOf(ke,d+1))!==-1;)c.push({type:7,index:i}),d+=ke.length-1}i++}}static createElement(t,r){let o=Qe.createElement("template");return o.innerHTML=t,o}};function Et(e,t,r=e,o){var n,i,a,s;if(t===cr)return t;let c=o!==void 0?(n=r._$Co)===null||n===void 0?void 0:n[o]:r._$Cl,l=sr(t)?void 0:t._$litDirective$;return c?.constructor!==l&&((i=c?._$AO)===null||i===void 0||i.call(c,!1),l===void 0?c=void 0:(c=new l(e),c._$AT(e,r,o)),o!==void 0?((a=(s=r)._$Co)!==null&&a!==void 0?a:s._$Co=[])[o]=c:r._$Cl=c),c!==void 0&&(t=Et(e,c._$AS(e,t.values),c,o)),t}var Hn=class{constructor(t,r){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=r}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var r;let{el:{content:o},parts:n}=this._$AD,i=((r=t?.creationScope)!==null&&r!==void 0?r:Qe).importNode(o,!0);Ze.currentNode=i;let a=Ze.nextNode(),s=0,c=0,l=n[0];for(;l!==void 0;){if(s===l.index){let h;l.type===2?h=new no(a,a.nextSibling,this,t):l.type===1?h=new l.ctor(a,l.name,l.strings,this,t):l.type===6&&(h=new zn(a,this,t)),this._$AV.push(h),l=n[++c]}s!==l?.index&&(a=Ze.nextNode(),s++)}return Ze.currentNode=Qe,i}v(t){let r=0;for(let o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(t,o,r),r+=o.strings.length-2):o._$AI(t[r])),r++}},no=class e{constructor(t,r,o,n){var i;this.type=2,this._$AH=z,this._$AN=void 0,this._$AA=t,this._$AB=r,this._$AM=o,this.options=n,this._$Cp=(i=n?.isConnected)===null||i===void 0||i}get _$AU(){var t,r;return(r=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&r!==void 0?r:this._$Cp}get parentNode(){let t=this._$AA.parentNode,r=this._$AM;return r!==void 0&&t?.nodeType===11&&(t=r.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,r=this){t=Et(this,t,r),sr(t)?t===z||t==null||t===""?(this._$AH!==z&&this._$AR(),this._$AH=z):t!==this._$AH&&t!==cr&&this._(t):t._$litType$!==void 0?this.g(t):t.nodeType!==void 0?this.$(t):bh(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==z&&sr(this._$AH)?this._$AA.nextSibling.data=t:this.$(Qe.createTextNode(t)),this._$AH=t}g(t){var r;let{values:o,_$litType$:n}=t,i=typeof n=="number"?this._$AC(t):(n.el===void 0&&(n.el=lr.createElement(Es(n.h,n.h[0]),this.options)),n);if(((r=this._$AH)===null||r===void 0?void 0:r._$AD)===i)this._$AH.v(o);else{let a=new Hn(i,this),s=a.u(this.options);a.v(o),this.$(s),this._$AH=a}}_$AC(t){let r=fs.get(t.strings);return r===void 0&&fs.set(t.strings,r=new lr(t)),r}T(t){bs(this._$AH)||(this._$AH=[],this._$AR());let r=this._$AH,o,n=0;for(let i of t)n===r.length?r.push(o=new e(this.k(oo()),this.k(oo()),this,this.options)):o=r[n],o._$AI(i),n++;n<r.length&&(this._$AR(o&&o._$AB.nextSibling,n),r.length=n)}_$AR(t=this._$AA.nextSibling,r){var o;for((o=this._$AP)===null||o===void 0||o.call(this,!1,!0,r);t&&t!==this._$AB;){let n=t.nextSibling;t.remove(),t=n}}setConnected(t){var r;this._$AM===void 0&&(this._$Cp=t,(r=this._$AP)===null||r===void 0||r.call(this,t))}},wt=class{constructor(t,r,o,n,i){this.type=1,this._$AH=z,this._$AN=void 0,this.element=t,this.name=r,this._$AM=n,this.options=i,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=z}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,r=this,o,n){let i=this.strings,a=!1;if(i===void 0)t=Et(this,t,r,0),a=!sr(t)||t!==this._$AH&&t!==cr,a&&(this._$AH=t);else{let s=t,c,l;for(t=i[0],c=0;c<i.length-1;c++)l=Et(this,s[o+c],r,c),l===cr&&(l=this._$AH[c]),a||(a=!sr(l)||l!==this._$AH[c]),l===z?t=z:t!==z&&(t+=(l??"")+i[c+1]),this._$AH[c]=l}a&&!n&&this.j(t)}j(t){t===z?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},Dn=class extends wt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===z?void 0:t}},yh=yt?yt.emptyScript:"",Un=class extends wt{constructor(){super(...arguments),this.type=4}j(t){t&&t!==z?this.element.setAttribute(this.name,yh):this.element.removeAttribute(this.name)}},Bn=class extends wt{constructor(t,r,o,n,i){super(t,r,o,n,i),this.type=5}_$AI(t,r=this){var o;if((t=(o=Et(this,t,r,0))!==null&&o!==void 0?o:z)===cr)return;let n=this._$AH,i=t===z&&n!==z||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,a=t!==z&&(n===z||i);i&&this.element.removeEventListener(this.name,this,n),a&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var r,o;typeof this._$AH=="function"?this._$AH.call((o=(r=this.options)===null||r===void 0?void 0:r.host)!==null&&o!==void 0?o:this.element,t):this._$AH.handleEvent(t)}},zn=class{constructor(t,r,o){this.element=t,this.type=6,this._$AN=void 0,this._$AM=r,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(t){Et(this,t)}};var gs=ro.litHtmlPolyfillSupport;gs?.(lr,no),((Mn=ro.litHtmlVersions)!==null&&Mn!==void 0?Mn:ro.litHtmlVersions=[]).push("2.8.0");var io=window,ao=io.ShadowRoot&&(io.ShadyCSS===void 0||io.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Fn=Symbol(),ws=new WeakMap,hr=class{constructor(t,r,o){if(this._$cssResult$=!0,o!==Fn)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=r}get styleSheet(){let t=this.o,r=this.t;if(ao&&t===void 0){let o=r!==void 0&&r.length===1;o&&(t=ws.get(r)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),o&&ws.set(r,t))}return t}toString(){return this.cssText}},Le=e=>new hr(typeof e=="string"?e:e+"",void 0,Fn),v=(e,...t)=>{let r=e.length===1?e[0]:t.reduce((o,n,i)=>o+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+e[i+1],e[0]);return new hr(r,e,Fn)},Gn=(e,t)=>{ao?e.adoptedStyleSheets=t.map(r=>r instanceof CSSStyleSheet?r:r.styleSheet):t.forEach(r=>{let o=document.createElement("style"),n=io.litNonce;n!==void 0&&o.setAttribute("nonce",n),o.textContent=r.cssText,e.appendChild(o)})},so=ao?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let r="";for(let o of t.cssRules)r+=o.cssText;return Le(r)})(e):e;var Vn,co=window,As=co.trustedTypes,Eh=As?As.emptyScript:"",_s=co.reactiveElementPolyfillSupport,qn={toAttribute(e,t){switch(t){case Boolean:e=e?Eh:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let r=e;switch(t){case Boolean:r=e!==null;break;case Number:r=e===null?null:Number(e);break;case Object:case Array:try{r=JSON.parse(e)}catch{r=null}}return r}},Ss=(e,t)=>t!==e&&(t==t||e==e),jn={attribute:!0,type:String,converter:qn,reflect:!1,hasChanged:Ss},Wn="finalized",ve=class extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this._$Eu()}static addInitializer(t){var r;this.finalize(),((r=this.h)!==null&&r!==void 0?r:this.h=[]).push(t)}static get observedAttributes(){this.finalize();let t=[];return this.elementProperties.forEach((r,o)=>{let n=this._$Ep(o,r);n!==void 0&&(this._$Ev.set(n,o),t.push(n))}),t}static createProperty(t,r=jn){if(r.state&&(r.attribute=!1),this.finalize(),this.elementProperties.set(t,r),!r.noAccessor&&!this.prototype.hasOwnProperty(t)){let o=typeof t=="symbol"?Symbol():"__"+t,n=this.getPropertyDescriptor(t,o,r);n!==void 0&&Object.defineProperty(this.prototype,t,n)}}static getPropertyDescriptor(t,r,o){return{get(){return this[r]},set(n){let i=this[t];this[r]=n,this.requestUpdate(t,i,o)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)||jn}static finalize(){if(this.hasOwnProperty(Wn))return!1;this[Wn]=!0;let t=Object.getPrototypeOf(this);if(t.finalize(),t.h!==void 0&&(this.h=[...t.h]),this.elementProperties=new Map(t.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){let r=this.properties,o=[...Object.getOwnPropertyNames(r),...Object.getOwnPropertySymbols(r)];for(let n of o)this.createProperty(n,r[n])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(t){let r=[];if(Array.isArray(t)){let o=new Set(t.flat(1/0).reverse());for(let n of o)r.unshift(so(n))}else t!==void 0&&r.push(so(t));return r}static _$Ep(t,r){let o=r.attribute;return o===!1?void 0:typeof o=="string"?o:typeof t=="string"?t.toLowerCase():void 0}_$Eu(){var t;this._$E_=new Promise(r=>this.enableUpdating=r),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(t=this.constructor.h)===null||t===void 0||t.forEach(r=>r(this))}addController(t){var r,o;((r=this._$ES)!==null&&r!==void 0?r:this._$ES=[]).push(t),this.renderRoot!==void 0&&this.isConnected&&((o=t.hostConnected)===null||o===void 0||o.call(t))}removeController(t){var r;(r=this._$ES)===null||r===void 0||r.splice(this._$ES.indexOf(t)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((t,r)=>{this.hasOwnProperty(r)&&(this._$Ei.set(r,this[r]),delete this[r])})}createRenderRoot(){var t;let r=(t=this.shadowRoot)!==null&&t!==void 0?t:this.attachShadow(this.constructor.shadowRootOptions);return Gn(r,this.constructor.elementStyles),r}connectedCallback(){var t;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$ES)===null||t===void 0||t.forEach(r=>{var o;return(o=r.hostConnected)===null||o===void 0?void 0:o.call(r)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$ES)===null||t===void 0||t.forEach(r=>{var o;return(o=r.hostDisconnected)===null||o===void 0?void 0:o.call(r)})}attributeChangedCallback(t,r,o){this._$AK(t,o)}_$EO(t,r,o=jn){var n;let i=this.constructor._$Ep(t,o);if(i!==void 0&&o.reflect===!0){let a=(((n=o.converter)===null||n===void 0?void 0:n.toAttribute)!==void 0?o.converter:qn).toAttribute(r,o.type);this._$El=t,a==null?this.removeAttribute(i):this.setAttribute(i,a),this._$El=null}}_$AK(t,r){var o;let n=this.constructor,i=n._$Ev.get(t);if(i!==void 0&&this._$El!==i){let a=n.getPropertyOptions(i),s=typeof a.converter=="function"?{fromAttribute:a.converter}:((o=a.converter)===null||o===void 0?void 0:o.fromAttribute)!==void 0?a.converter:qn;this._$El=i,this[i]=s.fromAttribute(r,a.type),this._$El=null}}requestUpdate(t,r,o){let n=!0;t!==void 0&&(((o=o||this.constructor.getPropertyOptions(t)).hasChanged||Ss)(this[t],r)?(this._$AL.has(t)||this._$AL.set(t,r),o.reflect===!0&&this._$El!==t&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(t,o))):n=!1),!this.isUpdatePending&&n&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(r){Promise.reject(r)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var t;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((n,i)=>this[i]=n),this._$Ei=void 0);let r=!1,o=this._$AL;try{r=this.shouldUpdate(o),r?(this.willUpdate(o),(t=this._$ES)===null||t===void 0||t.forEach(n=>{var i;return(i=n.hostUpdate)===null||i===void 0?void 0:i.call(n)}),this.update(o)):this._$Ek()}catch(n){throw r=!1,this._$Ek(),n}r&&this._$AE(o)}willUpdate(t){}_$AE(t){var r;(r=this._$ES)===null||r===void 0||r.forEach(o=>{var n;return(n=o.hostUpdated)===null||n===void 0?void 0:n.call(o)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(t){return!0}update(t){this._$EC!==void 0&&(this._$EC.forEach((r,o)=>this._$EO(o,this[o],r)),this._$EC=void 0),this._$Ek()}updated(t){}firstUpdated(t){}};ve[Wn]=!0,ve.elementProperties=new Map,ve.elementStyles=[],ve.shadowRootOptions={mode:"open"},_s?.({ReactiveElement:ve}),((Vn=co.reactiveElementVersions)!==null&&Vn!==void 0?Vn:co.reactiveElementVersions=[]).push("1.6.3");var Yn,lo=window,At=lo.trustedTypes,Ts=At?At.createPolicy("lit-html",{createHTML:e=>e}):void 0,Kn="$lit$",Re=`lit$${(Math.random()+"").slice(9)}$`,$s="?"+Re,wh=`<${$s}>`,tt=document,ur=()=>tt.createComment(""),mr=e=>e===null||typeof e!="object"&&typeof e!="function",Ms=Array.isArray,Ah=e=>Ms(e)||typeof e?.[Symbol.iterator]=="function",Xn=`[ 	
\f\r]`,dr=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Cs=/-->/g,Ps=/>/g,Je=RegExp(`>|${Xn}(?:([^\\s"'>=/]+)(${Xn}*=${Xn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ks=/'/g,Ls=/"/g,Ns=/^(?:script|style|textarea|title)$/i,Is=e=>(t,...r)=>({_$litType$:e,strings:t,values:r}),x=Is(1),vp=Is(2),rt=Symbol.for("lit-noChange"),F=Symbol.for("lit-nothing"),Rs=new WeakMap,et=tt.createTreeWalker(tt,129,null,!1);function Hs(e,t){if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ts!==void 0?Ts.createHTML(t):t}var _h=(e,t)=>{let r=e.length-1,o=[],n,i=t===2?"<svg>":"",a=dr;for(let s=0;s<r;s++){let c=e[s],l,h,d=-1,u=0;for(;u<c.length&&(a.lastIndex=u,h=a.exec(c),h!==null);)u=a.lastIndex,a===dr?h[1]==="!--"?a=Cs:h[1]!==void 0?a=Ps:h[2]!==void 0?(Ns.test(h[2])&&(n=RegExp("</"+h[2],"g")),a=Je):h[3]!==void 0&&(a=Je):a===Je?h[0]===">"?(a=n??dr,d=-1):h[1]===void 0?d=-2:(d=a.lastIndex-h[2].length,l=h[1],a=h[3]===void 0?Je:h[3]==='"'?Ls:ks):a===Ls||a===ks?a=Je:a===Cs||a===Ps?a=dr:(a=Je,n=void 0);let m=a===Je&&e[s+1].startsWith("/>")?" ":"";i+=a===dr?c+wh:d>=0?(o.push(l),c.slice(0,d)+Kn+c.slice(d)+Re+m):c+Re+(d===-2?(o.push(void 0),s):m)}return[Hs(e,i+(e[r]||"<?>")+(t===2?"</svg>":"")),o]},pr=class e{constructor({strings:t,_$litType$:r},o){let n;this.parts=[];let i=0,a=0,s=t.length-1,c=this.parts,[l,h]=_h(t,r);if(this.el=e.createElement(l,o),et.currentNode=this.el.content,r===2){let d=this.el.content,u=d.firstChild;u.remove(),d.append(...u.childNodes)}for(;(n=et.nextNode())!==null&&c.length<s;){if(n.nodeType===1){if(n.hasAttributes()){let d=[];for(let u of n.getAttributeNames())if(u.endsWith(Kn)||u.startsWith(Re)){let m=h[a++];if(d.push(u),m!==void 0){let g=n.getAttribute(m.toLowerCase()+Kn).split(Re),f=/([.?@])?(.*)/.exec(m);c.push({type:1,index:i,name:f[2],strings:g,ctor:f[1]==="."?Qn:f[1]==="?"?Jn:f[1]==="@"?ei:St})}else c.push({type:6,index:i})}for(let u of d)n.removeAttribute(u)}if(Ns.test(n.tagName)){let d=n.textContent.split(Re),u=d.length-1;if(u>0){n.textContent=At?At.emptyScript:"";for(let m=0;m<u;m++)n.append(d[m],ur()),et.nextNode(),c.push({type:2,index:++i});n.append(d[u],ur())}}}else if(n.nodeType===8)if(n.data===$s)c.push({type:2,index:i});else{let d=-1;for(;(d=n.data.indexOf(Re,d+1))!==-1;)c.push({type:7,index:i}),d+=Re.length-1}i++}}static createElement(t,r){let o=tt.createElement("template");return o.innerHTML=t,o}};function _t(e,t,r=e,o){var n,i,a,s;if(t===rt)return t;let c=o!==void 0?(n=r._$Co)===null||n===void 0?void 0:n[o]:r._$Cl,l=mr(t)?void 0:t._$litDirective$;return c?.constructor!==l&&((i=c?._$AO)===null||i===void 0||i.call(c,!1),l===void 0?c=void 0:(c=new l(e),c._$AT(e,r,o)),o!==void 0?((a=(s=r)._$Co)!==null&&a!==void 0?a:s._$Co=[])[o]=c:r._$Cl=c),c!==void 0&&(t=_t(e,c._$AS(e,t.values),c,o)),t}var Zn=class{constructor(t,r){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=r}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var r;let{el:{content:o},parts:n}=this._$AD,i=((r=t?.creationScope)!==null&&r!==void 0?r:tt).importNode(o,!0);et.currentNode=i;let a=et.nextNode(),s=0,c=0,l=n[0];for(;l!==void 0;){if(s===l.index){let h;l.type===2?h=new fr(a,a.nextSibling,this,t):l.type===1?h=new l.ctor(a,l.name,l.strings,this,t):l.type===6&&(h=new ti(a,this,t)),this._$AV.push(h),l=n[++c]}s!==l?.index&&(a=et.nextNode(),s++)}return et.currentNode=tt,i}v(t){let r=0;for(let o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(t,o,r),r+=o.strings.length-2):o._$AI(t[r])),r++}},fr=class e{constructor(t,r,o,n){var i;this.type=2,this._$AH=F,this._$AN=void 0,this._$AA=t,this._$AB=r,this._$AM=o,this.options=n,this._$Cp=(i=n?.isConnected)===null||i===void 0||i}get _$AU(){var t,r;return(r=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&r!==void 0?r:this._$Cp}get parentNode(){let t=this._$AA.parentNode,r=this._$AM;return r!==void 0&&t?.nodeType===11&&(t=r.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,r=this){t=_t(this,t,r),mr(t)?t===F||t==null||t===""?(this._$AH!==F&&this._$AR(),this._$AH=F):t!==this._$AH&&t!==rt&&this._(t):t._$litType$!==void 0?this.g(t):t.nodeType!==void 0?this.$(t):Ah(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==F&&mr(this._$AH)?this._$AA.nextSibling.data=t:this.$(tt.createTextNode(t)),this._$AH=t}g(t){var r;let{values:o,_$litType$:n}=t,i=typeof n=="number"?this._$AC(t):(n.el===void 0&&(n.el=pr.createElement(Hs(n.h,n.h[0]),this.options)),n);if(((r=this._$AH)===null||r===void 0?void 0:r._$AD)===i)this._$AH.v(o);else{let a=new Zn(i,this),s=a.u(this.options);a.v(o),this.$(s),this._$AH=a}}_$AC(t){let r=Rs.get(t.strings);return r===void 0&&Rs.set(t.strings,r=new pr(t)),r}T(t){Ms(this._$AH)||(this._$AH=[],this._$AR());let r=this._$AH,o,n=0;for(let i of t)n===r.length?r.push(o=new e(this.k(ur()),this.k(ur()),this,this.options)):o=r[n],o._$AI(i),n++;n<r.length&&(this._$AR(o&&o._$AB.nextSibling,n),r.length=n)}_$AR(t=this._$AA.nextSibling,r){var o;for((o=this._$AP)===null||o===void 0||o.call(this,!1,!0,r);t&&t!==this._$AB;){let n=t.nextSibling;t.remove(),t=n}}setConnected(t){var r;this._$AM===void 0&&(this._$Cp=t,(r=this._$AP)===null||r===void 0||r.call(this,t))}},St=class{constructor(t,r,o,n,i){this.type=1,this._$AH=F,this._$AN=void 0,this.element=t,this.name=r,this._$AM=n,this.options=i,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=F}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,r=this,o,n){let i=this.strings,a=!1;if(i===void 0)t=_t(this,t,r,0),a=!mr(t)||t!==this._$AH&&t!==rt,a&&(this._$AH=t);else{let s=t,c,l;for(t=i[0],c=0;c<i.length-1;c++)l=_t(this,s[o+c],r,c),l===rt&&(l=this._$AH[c]),a||(a=!mr(l)||l!==this._$AH[c]),l===F?t=F:t!==F&&(t+=(l??"")+i[c+1]),this._$AH[c]=l}a&&!n&&this.j(t)}j(t){t===F?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},Qn=class extends St{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===F?void 0:t}},Sh=At?At.emptyScript:"",Jn=class extends St{constructor(){super(...arguments),this.type=4}j(t){t&&t!==F?this.element.setAttribute(this.name,Sh):this.element.removeAttribute(this.name)}},ei=class extends St{constructor(t,r,o,n,i){super(t,r,o,n,i),this.type=5}_$AI(t,r=this){var o;if((t=(o=_t(this,t,r,0))!==null&&o!==void 0?o:F)===rt)return;let n=this._$AH,i=t===F&&n!==F||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,a=t!==F&&(n===F||i);i&&this.element.removeEventListener(this.name,this,n),a&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var r,o;typeof this._$AH=="function"?this._$AH.call((o=(r=this.options)===null||r===void 0?void 0:r.host)!==null&&o!==void 0?o:this.element,t):this._$AH.handleEvent(t)}},ti=class{constructor(t,r,o){this.element=t,this.type=6,this._$AN=void 0,this._$AM=r,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(t){_t(this,t)}};var Os=lo.litHtmlPolyfillSupport;Os?.(pr,fr),((Yn=lo.litHtmlVersions)!==null&&Yn!==void 0?Yn:lo.litHtmlVersions=[]).push("2.8.0");var Ds=(e,t,r)=>{var o,n;let i=(o=r?.renderBefore)!==null&&o!==void 0?o:t,a=i._$litPart$;if(a===void 0){let s=(n=r?.renderBefore)!==null&&n!==void 0?n:null;i._$litPart$=a=new fr(t.insertBefore(ur(),s),s,void 0,r??{})}return a._$AI(e),a};var ri,oi;var N=class extends ve{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,r;let o=super.createRenderRoot();return(t=(r=this.renderOptions).renderBefore)!==null&&t!==void 0||(r.renderBefore=o.firstChild),o}update(t){let r=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Ds(r,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!1)}render(){return rt}};N.finalized=!0,N._$litElement$=!0,(ri=globalThis.litElementHydrateSupport)===null||ri===void 0||ri.call(globalThis,{LitElement:N});var Us=globalThis.litElementPolyfillSupport;Us?.({LitElement:N});((oi=globalThis.litElementVersions)!==null&&oi!==void 0?oi:globalThis.litElementVersions=[]).push("3.3.3");var Oe="(max-width: 767px)",ho="(max-width: 1199px)",G="(min-width: 768px)",D="(min-width: 1200px)",ce="(min-width: 1600px)";var Bs=v`
>>>>>>> 53c5fbdaa324289e39b4e35feb15a80b0fa09047
    :host {
...
<<<<<<< HEAD
      `];var Ct=class extends I{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:t}=this;return t?x`<a href="${t}">
                  <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />
              </a>`:x` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};m(Ct,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),m(Ct,"styles",E`
=======
      `];var Tt=class extends N{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:t}=this;return t?x`<a href="${t}">
                  <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />
              </a>`:x` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};p(Tt,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),p(Tt,"styles",v`
>>>>>>> 53c5fbdaa324289e39b4e35feb15a80b0fa09047
        :host {
            --img-width: 32px;
            --img-height: 32px;
...
<<<<<<< HEAD
            <slot></slot>`}getGlobalCSS(){return Ws}setAriaExpanded(r,o){r.setAttribute("aria-expanded",o)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};m(Lt,"variantStyle",E`
=======
            <slot></slot>`}getGlobalCSS(){return Fs}setAriaExpanded(r,o){r.setAttribute("aria-expanded",o)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};p(Pt,"variantStyle",v`
>>>>>>> 53c5fbdaa324289e39b4e35feb15a80b0fa09047
...
<<<<<<< HEAD
`;var uo=class extends ${constructor(t){super(t)}getGlobalCSS(){return Ys}renderLayout(){return x`${this.cardImage}
=======
`;var uo=class extends O{constructor(t){super(t)}getGlobalCSS(){return Gs}renderLayout(){return x`${this.cardImage}
>>>>>>> 53c5fbdaa324289e39b4e35feb15a80b0fa09047
    <div class="body">
...
<<<<<<< HEAD
`;var mo=class extends ${constructor(t){super(t)}getGlobalCSS(){return Xs}renderLayout(){return x` ${this.badge}
=======
`;var mo=class extends O{constructor(t){super(t)}getGlobalCSS(){return Vs}renderLayout(){return x` ${this.badge}
>>>>>>> 53c5fbdaa324289e39b4e35feb15a80b0fa09047
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
    ...
    ${this.card.customHr?"":x`<hr />`} ${this.secureLabelFooter}`}};var Ks=`
  :root {
...
<<<<<<< HEAD
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){vt()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};m(kt,"variantStyle",E`
=======
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){bt()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};p(kt,"variantStyle",v`
>>>>>>> 53c5fbdaa324289e39b4e35feb15a80b0fa09047
...
<<<<<<< HEAD
    @media screen and ${ke(po)} {
=======
    @media screen and ${Le(ho)} {
>>>>>>> 53c5fbdaa324289e39b4e35feb15a80b0fa09047
...
`;var ai={title:{tag:"p",slot:"heading-xs"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},stockOffer:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant"},Rt=class extends ${constructor(t){super(t),this.adaptForMobile=this.adaptForMobile.bind(this)}get aemFragmentMapping(){return ai}priceOptionsProvider(t,r){t.dataset.template===Fo&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Zs}adaptForMobile(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards")){this.card.removeAttribute("size");return}let t=this.card.shadowRoot,r=t.querySelector("footer"),o=this.card.getAttribute("size"),n=t.querySelector("footer #stock-checkbox"),i=t.querySelector(".body #stock-checkbox"),a=t.querySelector(".body");if(!o){r?.classList.remove("wide-footer"),n&&n.remove();return}let s=vt();if(r?.classList.toggle("wide-footer",!s),s&&n){i?n.remove():a.appendChild(n);return}!s&&i&&(n?i.remove():r.prepend(i))}postCardUpdateHook(){this.adaptForMobile(),this.adjustTitleWidth(),this.adjustLegal()}async adjustLegal(){if(await this.card.updateComplete,this.legal)return;let t=this.card.querySelector('[slot="heading-m"]');if(!t)return;let r=t.querySelector(`${dt}[data-template="price"]`),o=r.cloneNode(!0);this.legal=o,await r.onceSettled(),r?.options&&(r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),t.appendChild(o))}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}`}};m(Rt,"variantStyle",E`
        :host([variant='plans']) {
            min-height: 348px;
...
`;var po={title:{tag:"p",slot:"heading-xs"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},stockOffer:!0,secureLabel:!0,badge:{tag:"div",slot:"badge"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant"},$e=class extends O{constructor(t){super(t),this.adaptForMobile=this.adaptForMobile.bind(this)}get aemFragmentMapping(){return po}getGlobalCSS(){return qs}adaptForMobile(){if(!this.card.closest("merch-card-collection,overlay-trigger")){this.card.removeAttribute("size");return}let t=this.card.shadowRoot,r=t.querySelector("footer"),o=this.card.getAttribute("size"),n=t.querySelector("footer #stock-checkbox"),i=t.querySelector(".body #stock-checkbox"),a=t.querySelector(".body");if(!o){r?.classList.remove("wide-footer"),n&&n.remove();return}let s=bt();if(r?.classList.toggle("wide-footer",!s),s&&n){i?n.remove():a.appendChild(n);return}!s&&i&&(n?i.remove():r.prepend(i))}postCardUpdateHook(){this.adaptForMobile(),this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
        ...
        ${this.secureLabelFooter}`}};p($e,"variantStyle",v`
    :host([variant^='plans']) {
        min-height: 348px;
        border: 1px solid var(--merch-card-custom-border-color, #DADADA);
        --merch-card-plans-min-width: 244px;
...
<<<<<<< HEAD
`;var tt=class extends ${constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Qs}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return x` ${this.badge}
=======
`;var ot=class extends O{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Ws}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return x` ${this.badge}
>>>>>>> 53c5fbdaa324289e39b4e35feb15a80b0fa09047
...
<<<<<<< HEAD
      ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}postCardUpdateHook(){this.card.isConnected&&(vt()||this.adjustProductBodySlots(),this.adjustTitleWidth())}};m(tt,"variantStyle",E`
=======
      ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}postCardUpdateHook(){this.card.isConnected&&(bt()||this.adjustProductBodySlots(),this.adjustTitleWidth())}};p(ot,"variantStyle",v`
>>>>>>> 53c5fbdaa324289e39b4e35feb15a80b0fa09047
...
`;var Ot=class extends ${constructor(t){super(t)}getGlobalCSS(){return Js}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
    ...
    <hr />
    ${this.secureLabelFooter}`}};m(Ot,"variantStyle",E`
...
`;var si={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},$t=class extends ${constructor(t){super(t)}getGlobalCSS(){return ec}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return si}renderLayout(){return x`${this.cardImage}
            <div class="body">
...
<<<<<<< HEAD
    `);var ci=new Map,Y=(e,t,r=null,o=null)=>{ci.set(e,{class:t,fragmentMapping:r,style:o})};Y("catalog",Lt,ii,Lt.variantStyle);Y("image",uo);Y("inline-heading",mo);Y("mini-compare-chart",kt,null,kt.variantStyle);Y("plans",Rt,ai,Rt.variantStyle);Y("product",tt,null,tt.variantStyle);Y("segment",Ot,null,Ot.variantStyle);Y("special-offers",$t,si,$t.variantStyle);var li=(e,t=!1)=>{let r=ci.get(e.variant);if(!r)return t?void 0:new tt(e);let{class:o,style:n}=r;if(n){let i=new CSSStyleSheet;i.replaceSync(n.cssText),e.shadowRoot.adoptedStyleSheets.push(i)}return new o(e)};function tc(e){return ci.get(e)?.fragmentMapping}var rc=document.createElement("style");rc.innerHTML=`
=======
    `);var ai=new Map,W=(e,t,r=null,o=null)=>{ai.set(e,{class:t,fragmentMapping:r,style:o})};W("catalog",Pt,ni,Pt.variantStyle);W("image",uo);W("inline-heading",mo);W("mini-compare-chart",kt,null,kt.variantStyle);W("plans",$e,po,$e.variantStyle);W("plans-students",$e,po,$e.variantStyle);W("product",ot,null,ot.variantStyle);W("segment",Lt,null,Lt.variantStyle);W("special-offers",Rt,ii,Rt.variantStyle);var si=(e,t=!1)=>{let r=ai.get(e.variant);if(!r)return t?void 0:new ot(e);let{class:o,style:n}=r;if(n){let i=new CSSStyleSheet;i.replaceSync(n.cssText),e.shadowRoot.adoptedStyleSheets.push(i)}return new o(e)};function Ks(e){return ai.get(e)?.fragmentMapping}var Zs=document.createElement("style");Zs.innerHTML=`
>>>>>>> 53c5fbdaa324289e39b4e35feb15a80b0fa09047
:root {
...
>>>>>>> 53c5fbdaa324289e39b4e35feb15a80b0fa09047
    ...
    `);customElements.define("merch-badge",It);var Ar=class extends I{constructor(){super()}render(){return x`
            <slot name="icon"></slot>
...
<<<<<<< HEAD
    `),m(Ar,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Ar);var wr=class extends I{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,r)=>{r>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return x`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows?x`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:x``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};m(wr,"styles",E`
=======
    `),p(Er,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Er);var wr=class extends N{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,r)=>{r>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return x`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${this.isMobile&&this.rows.length>this.mobileRows?x`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:x``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};p(wr,"styles",v`
>>>>>>> 53c5fbdaa324289e39b4e35feb15a80b0fa09047
        :host {
            display: flex;
            flex-wrap: wrap;
...
<<<<<<< HEAD
    `),m(_r,"properties",{offers:{type:Array},selectedOffer:{type:Object},defaults:{type:Object},variant:{type:String,attribute:"variant",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},stock:{type:Boolean,reflect:!0}});customElements.define("merch-offer-select",_r);var dc=E`
=======
    `),p(Ar,"properties",{offers:{type:Array},selectedOffer:{type:Object},defaults:{type:Object},variant:{type:String,attribute:"variant",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},stock:{type:Boolean,reflect:!0}});customElements.define("merch-offer-select",Ar);var ac=v`
>>>>>>> 53c5fbdaa324289e39b4e35feb15a80b0fa09047
    :host {
...
`;var xi={backgroundImage:{attribute:"background-image"},badge:!0,ctas:{slot:"cta",size:"M"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"p",slot:"price"},size:[],subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"}},Dt=class extends ${getGlobalCSS(){return gc}get aemFragmentMapping(){return xi}get stripStyle(){return this.card.backgroundImage?`
        ...
        `:""}renderLayout(){return x` <div style="${this.stripStyle}" class="body">
            ...
            <slot></slot>`}postCardUpdateHook(t){t.has("backgroundImage")&&this.styleBackgroundImage()}styleBackgroundImage(){if(this.card.classList.remove("thin-strip"),this.card.classList.remove("wide-strip"),!this.card.backgroundImage)return;let t=new Image;t.src=this.card.backgroundImage,t.onload=()=>{t.width>8?this.card.classList.add("wide-strip"):t.width===8&&this.card.classList.add("thin-strip")}}};m(Dt,"variantStyle",E`
...
`;var bi={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},Bt=class extends ${getGlobalCSS(){return xc}get aemFragmentMapping(){return bi}renderLayout(){return x` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
<<<<<<< HEAD
    `);customElements.define("ah-try-buy-widget",it);var vc=`
=======
    `);customElements.define("ah-try-buy-widget",it);var pc=`
>>>>>>> 53c5fbdaa324289e39b4e35feb15a80b0fa09047
...
<<<<<<< HEAD
    `);customElements.define("ah-promoted-plans",at);ft({sampleRate:1});Y("ccd-suggested",Dt,xi,Dt.variantStyle);Y("ccd-slice",Bt,bi,Bt.variantStyle);Y("ah-try-buy-widget",it,vi,it.variantStyle);Y("ah-promoted-plans",at,yi,at.variantStyle);
=======
    `);customElements.define("ah-promoted-plans",at);mt({sampleRate:1});W("ccd-suggested",Ut,pi,Ut.variantStyle);W("ccd-slice",Bt,fi,Bt.variantStyle);W("ah-try-buy-widget",it,gi,it.variantStyle);W("ah-promoted-plans",at,xi,at.variantStyle);
>>>>>>> 53c5fbdaa324289e39b4e35feb15a80b0fa09047
