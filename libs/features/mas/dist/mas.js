...
`;var ut=class extends I{constructor(t){super(t)}getGlobalCSS(){return jo}renderLayout(){return x`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
...
`;var cc={mnemonics:{size:"l"},subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"cta",size:"M"}},dt=class extends I{getGlobalCSS(){return Yo}get aemFragmentMapping(){return cc}get stripStyle(){return this.card.backgroundImage?`
