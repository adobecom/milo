...
`,zs=()=>[y`
      ...
      `];var Tt=class extends N{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:t}=this;return t?g`<a href="${t}">
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return Fs}setAriaExpanded(r,o){r.setAttribute("aria-expanded",o)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};p(Pt,"variantStyle",y`
...
`;var uo=class extends O{constructor(t){super(t)}getGlobalCSS(){return Gs}renderLayout(){return g`${this.cardImage}
    <div class="body">
...
`;var mo=class extends O{constructor(t){super(t)}getGlobalCSS(){return Vs}renderLayout(){return g` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var Th=32,kt=class extends O{constructor(r){super(r);p(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);p(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?g`<slot name="secure-transaction-label">
...
`;document.head.appendChild(Zs);var ec=new CSSStyleSheet;ec.replaceSync(":host { display: contents; }");var Qs="fragment",Js="author",fo="aem-fragment",ye,ci=class{constructor(){L(this,ye,new Map)}clear(){b(this,ye).clear()}addByRequestedId(t,r){b(this,ye).set(t,r)}add(...t){t.forEach(r=>{let{id:o}=r;o&&b(this,ye).set(o,r)})}has(t){return b(this,ye).has(t)}get(t){return b(this,ye).get(t)}remove(t){b(this,ye).delete(t)}};ye=new WeakMap;var xr=new ci,br,le,Ee,Ot,$t,Me,oe,we,vr,yr,hi,li=class extends HTMLElement{constructor(){super();L(this,yr);p(this,"cache",xr);L(this,br);L(this,le,null);L(this,Ee,null);L(this,Ot,!1);L(this,$t,null);L(this,Me,null);L(this,oe);L(this,we);L(this,vr,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[ec]}static get observedAttributes(){return[Qs,Js]}attributeChangedCallback(r,o,n){r===Qs&&R(this,oe,n),r===Js&&R(this,vr,["","true"].includes(n))}connectedCallback(){if(!b(this,we)){if(R(this,Me,vt(this)),R(this,br,b(this,Me).log.module(fo)),R(this,$t,`${fo}:${b(this,oe)}${Ce}`),performance.mark(b(this,$t)),!b(this,oe)){de(this,yr,hi).call(this,{message:"Missing fragment id"});return}this.refresh(!1)}}async getFragmentById(r,o,n){let i=`${fo}:${o}${Vt}`,a;try{if(a=await Yr(r,{cache:"default",credentials:"omit"}),!a?.ok){let{startTime:s,duration:c}=performance.measure(i,n);throw new ge("Unexpected fragment response",{response:a,startTime:s,duration:c,...b(this,Me).duration})}return a.json()}catch{let{startTime:c,duration:l}=performance.measure(i,n);throw a||(a={url:r}),new ge("Failed to fetch fragment",{response:a,startTime:c,duration:l,...b(this,Me).duration})}}async refresh(r=!0){if(!(b(this,we)&&!await Promise.race([b(this,we),Promise.resolve(!1)])))return r&&xr.remove(b(this,oe)),R(this,we,this.fetchData().then(()=>{let{references:o,referencesTree:n,placeholders:i}=b(this,le)||{};return this.dispatchEvent(new CustomEvent(Be,{detail:{...this.data,stale:b(this,Ot),references:o,referencesTree:n,placeholders:i},bubbles:!0,composed:!0})),!0}).catch(o=>b(this,le)?(xr.addByRequestedId(b(this,oe),b(this,le)),!0):(de(this,yr,hi).call(this,o),!1))),b(this,we)}async fetchData(){this.classList.remove("error"),R(this,Ee,null);let r=xr.get(b(this,oe));if(r){R(this,le,r);return}R(this,Ot,!0);let{masIOUrl:o,wcsApiKey:n,locale:i}=b(this,Me).settings,a=`${o}/fragment?id=${b(this,oe)}&api_key=${n}&locale=${i}`;r=await this.getFragmentById(a,b(this,oe),b(this,$t)),xr.addByRequestedId(b(this,oe),r),R(this,le,r),R(this,Ot,!1)}get updateComplete(){return b(this,we)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return b(this,Ee)?b(this,Ee):(b(this,vr)?this.transformAuthorData():this.transformPublishData(),b(this,Ee))}transformAuthorData(){let{fields:r,id:o,tags:n}=b(this,le);R(this,Ee,r.reduce((i,{name:a,multiple:s,values:c})=>(i.fields[a]=s?c:c[0],i),{fields:{},id:o,tags:n}))}transformPublishData(){let{fields:r,id:o,tags:n,settings:i}=b(this,le);R(this,Ee,Object.entries(r).reduce((a,[s,c])=>(a.fields[s]=c?.mimeType?c.value:c??"",a),{fields:{},id:o,tags:n,settings:i}))}};br=new WeakMap,le=new WeakMap,Ee=new WeakMap,Ot=new WeakMap,$t=new WeakMap,Me=new WeakMap,oe=new WeakMap,we=new WeakMap,vr=new WeakMap,yr=new WeakSet,hi=function({message:r,context:o}){this.classList.add("error"),b(this,br).error(`aem-fragment: ${r}`,o),this.dispatchEvent(new CustomEvent(ze,{detail:{message:r,...o},bubbles:!0,composed:!0}))};customElements.define(fo,li);var Mt=class extends N{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return g`<div class="plans-badge">
    ...
    `);customElements.define("merch-badge",Mt);var Er=class extends N{constructor(){super()}render(){return g`
            <slot name="icon"></slot>
    ...
    `),p(Ar,"properties",{offers:{type:Array},selectedOffer:{type:Object},defaults:{type:Object},variant:{type:String,attribute:"variant",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},stock:{type:Boolean,reflect:!0}});customElements.define("merch-offer-select",Ar);var ac=y`
    :host {
