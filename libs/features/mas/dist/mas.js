...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return Us}setAriaExpanded(r,o){r.setAttribute("aria-expanded",o)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};p(Pt,"variantStyle",v`
...
`;var mo=class extends O{constructor(t){super(t)}getGlobalCSS(){return zs}renderLayout(){return x`${this.cardImage}
    <div class="body">
...
`;var po=class extends O{constructor(t){super(t)}getGlobalCSS(){return Fs}renderLayout(){return x` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":x`<hr />`} ${this.secureLabelFooter}`}};var Gs=`
  :root {
...
`;var fo={title:{tag:"p",slot:"heading-xs"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},stockOffer:!0,secureLabel:!0,badge:{tag:"div",slot:"badge"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant"},js={...function(){let{whatsIncluded:e,...t}=fo;return t}(),title:{tag:"p",slot:"heading-s"},subtitle:{tag:"p",slot:"subtitle"},secureLabel:!1},le=class extends O{constructor(t){super(t),this.adaptForMobile=this.adaptForMobile.bind(this)}getGlobalCSS(){return Vs}adaptForMobile(){if(!this.card.closest("merch-card-collection,overlay-trigger")){this.card.removeAttribute("size");return}let t=this.card.shadowRoot,r=t.querySelector("footer"),o=this.card.getAttribute("size"),n=t.querySelector("footer #stock-checkbox"),i=t.querySelector(".body #stock-checkbox"),a=t.querySelector(".body");if(!o){r?.classList.remove("wide-footer"),n&&n.remove();return}let s=bt();if(r?.classList.toggle("wide-footer",!s),s&&n){i?n.remove():a.appendChild(n);return}!s&&i&&(n?i.remove():r.prepend(i))}postCardUpdateHook(){this.adaptForMobile(),this.adjustTitleWidth()}get divider(){return this.card.variant==="plans-education"?x`<div class="divider"></div>`:""}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
            ...
            </label>`:""}get icons(){return this.card.querySelector('[slot="icons"]')?x`<slot name="icons"></slot>`:""}connectedCallbackHook(){let t=Kr();t?.addEventListener&&t.addEventListener("change",this.adaptForMobile)}disconnectedCallbackHook(){let t=Kr();t?.removeEventListener&&t.removeEventListener("change",this.adaptForMobile)}renderLayout(){return x` ${this.badge}
        <div class="body">
            ${this.icons}
            <slot name="heading-xs"></slot>
        ...
        ${this.secureLabelFooter}`}};p(le,"variantStyle",v`
    :host([variant^='plans']) {
        min-height: 273px;
...
`;document.head.appendChild(Ks);var Js=new CSSStyleSheet;Js.replaceSync(":host { display: contents; }");var Zs="fragment",Qs="author",go="aem-fragment",Ee,si=class{constructor(){L(this,Ee,new Map)}clear(){b(this,Ee).clear()}addByRequestedId(t,r){b(this,Ee).set(t,r)}add(...t){t.forEach(r=>{let{id:o}=r;o&&b(this,Ee).set(o,r)})}has(t){return b(this,Ee).has(t)}get(t){return b(this,Ee).get(t)}remove(t){b(this,Ee).delete(t)}};Ee=new WeakMap;var xr=new si,br,he,we,Ot,$t,Ne,oe,Ae,vr,yr,li,ci=class extends HTMLElement{constructor(){super();L(this,yr);p(this,"cache",xr);L(this,br);L(this,he,null);L(this,we,null);L(this,Ot,!1);L(this,$t,null);L(this,Ne,null);L(this,oe);L(this,Ae);L(this,vr,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[Js]}static get observedAttributes(){return[Zs,Qs]}attributeChangedCallback(r,o,n){r===Zs&&R(this,oe,n),r===Qs&&R(this,vr,["","true"].includes(n))}connectedCallback(){if(!b(this,Ae)){if(R(this,Ne,vt(this)),R(this,br,b(this,Ne).log.module(go)),R(this,$t,`${go}:${b(this,oe)}${Pe}`),performance.mark(b(this,$t)),!b(this,oe)){ue(this,yr,li).call(this,{message:"Missing fragment id"});return}this.refresh(!1)}}async getFragmentById(r,o,n){let i=`${go}:${o}${Vt}`,a;try{if(a=await Yr(r,{cache:"default",credentials:"omit"}),!a?.ok){let{startTime:s,duration:c}=performance.measure(i,n);throw new xe("Unexpected fragment response",{response:a,startTime:s,duration:c,...b(this,Ne).duration})}return a.json()}catch{let{startTime:c,duration:l}=performance.measure(i,n);throw a||(a={url:r}),new xe("Failed to fetch fragment",{response:a,startTime:c,duration:l,...b(this,Ne).duration})}}async refresh(r=!0){if(!(b(this,Ae)&&!await Promise.race([b(this,Ae),Promise.resolve(!1)])))return r&&xr.remove(b(this,oe)),R(this,Ae,this.fetchData().then(()=>{let{references:o,referencesTree:n,placeholders:i}=b(this,he)||{};return this.dispatchEvent(new CustomEvent(Be,{detail:{...this.data,stale:b(this,Ot),references:o,referencesTree:n,placeholders:i},bubbles:!0,composed:!0})),!0}).catch(o=>b(this,he)?(xr.addByRequestedId(b(this,oe),b(this,he)),!0):(ue(this,yr,li).call(this,o),!1))),b(this,Ae)}async fetchData(){this.classList.remove("error"),R(this,we,null);let r=xr.get(b(this,oe));if(r){R(this,he,r);return}R(this,Ot,!0);let{masIOUrl:o,wcsApiKey:n,locale:i}=b(this,Ne).settings,a=`${o}/fragment?id=${b(this,oe)}&api_key=${n}&locale=${i}`;r=await this.getFragmentById(a,b(this,oe),b(this,$t)),xr.addByRequestedId(b(this,oe),r),R(this,he,r),R(this,Ot,!1)}get updateComplete(){return b(this,Ae)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return b(this,we)?b(this,we):(b(this,vr)?this.transformAuthorData():this.transformPublishData(),b(this,we))}transformAuthorData(){let{fields:r,id:o,tags:n}=b(this,he);R(this,we,r.reduce((i,{name:a,multiple:s,values:c})=>(i.fields[a]=s?c:c[0],i),{fields:{},id:o,tags:n}))}transformPublishData(){let{fields:r,id:o,tags:n,settings:i}=b(this,he);R(this,we,Object.entries(r).reduce((a,[s,c])=>(a.fields[s]=c?.mimeType?c.value:c??"",a),{fields:{},id:o,tags:n,settings:i}))}};br=new WeakMap,he=new WeakMap,we=new WeakMap,Ot=new WeakMap,$t=new WeakMap,Ne=new WeakMap,oe=new WeakMap,Ae=new WeakMap,vr=new WeakMap,yr=new WeakSet,li=function({message:r,context:o}){this.classList.add("error"),b(this,br).error(`aem-fragment: ${r}`,o),this.dispatchEvent(new CustomEvent(ze,{detail:{message:r,...o},bubbles:!0,composed:!0}))};customElements.define(go,ci);var Nt=class extends M{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return x`<div class="plans-badge">
    ...
    `),p(Ar,"properties",{offers:{type:Array},selectedOffer:{type:Object},defaults:{type:Object},variant:{type:String,attribute:"variant",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},stock:{type:Boolean,reflect:!0}});customElements.define("merch-offer-select",Ar);var ic=v`
    :host {
