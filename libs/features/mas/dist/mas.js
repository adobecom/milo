      ...
      `];var ht,Xt=class Xt{constructor(t){p(this,"card");V(this,ht,void 0);this.card=t,this.insertVariantStyle()}getContainer(){return D(this,ht,b(this,ht)??this.card.closest('[class*="-merch-cards"]')??this.card.parentElement),b(this,ht)}insertVariantStyle(){if(!Xt.styleMap[this.card.variant]){Xt.styleMap[this.card.variant]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(t,r){if(!t)return;let n=`--consonant-merch-card-${this.card.variant}-${r}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),o=parseInt(this.getContainer().style.getPropertyValue(n))||0;i>o&&this.getContainer().style.setProperty(n,`${i}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),g`
        ...
        `}get cardImage(){return g` <div class="image">
            ...
            ${this.badge}
              ...
              >`:"";return g`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){}};ht=new WeakMap,p(Xt,"styleMap",{});var C=Xt;var li={};lc(li,{CLASS_NAME_FAILED:()=>Wn,CLASS_NAME_HIDDEN:()=>Sc,CLASS_NAME_PENDING:()=>qn,CLASS_NAME_RESOLVED:()=>Qn,ERROR_MESSAGE_BAD_REQUEST:()=>Zn,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>Nc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Jn,EVENT_AEM_ERROR:()=>ze,EVENT_AEM_LOAD:()=>Ge,EVENT_MAS_ERROR:()=>Xn,EVENT_MAS_READY:()=>jn,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Yn,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>kc,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Cc,EVENT_MERCH_CARD_READY:()=>Bn,EVENT_MERCH_OFFER_READY:()=>wc,EVENT_MERCH_OFFER_SELECT_READY:()=>Kn,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>ut,EVENT_MERCH_SEARCH_CHANGE:()=>Pc,EVENT_MERCH_SIDENAV_SELECT:()=>Ic,EVENT_MERCH_STOCK_CHANGE:()=>Lc,EVENT_MERCH_STORAGE_CHANGE:()=>Rr,EVENT_OFFER_SELECTED:()=>_c,EVENT_TYPE_FAILED:()=>ei,EVENT_TYPE_READY:()=>dt,EVENT_TYPE_RESOLVED:()=>ti,HEADER_X_REQUEST_ID:()=>si,LOG_NAMESPACE:()=>ri,Landscape:()=>fe,MARK_DURATION_SUFFIX:()=>Zt,MARK_START_SUFFIX:()=>Pe,MAS_COMMERCE_SERVICE_INIT_TIME_MEASURE_NAME:()=>Qt,MODAL_TYPE_3_IN_1:()=>Fe,NAMESPACE:()=>yc,PARAM_AOS_API_KEY:()=>Rc,PARAM_ENV:()=>ni,PARAM_LANDSCAPE:()=>ii,PARAM_WCS_API_KEY:()=>Oc,PROVIDER_ENVIRONMENT:()=>ci,SELECTOR_MAS_CHECKOUT_LINK:()=>Wt,SELECTOR_MAS_ELEMENT:()=>qt,SELECTOR_MAS_INLINE_PRICE:()=>Nr,SELECTOR_MAS_SP_BUTTON:()=>Fn,STATE_FAILED:()=>me,STATE_PENDING:()=>Le,STATE_RESOLVED:()=>pe,TAG_NAME_SERVICE:()=>Tc,WCS_PROD_URL:()=>oi,WCS_STAGE_URL:()=>ai,WORKFLOW_STEP:()=>He});var yc="merch",Sc="hidden",dt="wcms:commerce:ready",Tc="mas-commerce-service",Nr='span[is="inline-price"][data-wcs-osi]',Wt='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',Fn="sp-button[data-wcs-osi]",qt=`${Nr},${Wt}`,wc="merch-offer:ready",Kn="merch-offer-select:ready",Bn="merch-card:ready",Yn="merch-card:action-menu-toggle",_c="merch-offer:selected",Lc="merch-stock:change",Rr="merch-storage:change",ut="merch-quantity-selector:change",Pc="merch-search:change",Cc="merch-card-collection:sort",kc="merch-card-collection:showmore",Ic="merch-sidenav:select",Ge="aem:load",ze="aem:error",jn="mas:ready",Xn="mas:error",Wn="placeholder-failed",qn="placeholder-pending",Qn="placeholder-resolved",Zn="Bad WCS request",Jn="Commerce offer not found",Nc="Literals URL not provided",ei="mas:failed",ti="mas:resolved",ri="mas/commerce",ni="commerce.env",ii="commerce.landscape",Rc="commerce.aosKey",Oc="commerce.wcsKey",oi="https://www.adobe.com/web_commerce_artifact",ai="https://www.stage.adobe.com/web_commerce_artifact_stage",me="failed",Le="pending",pe="resolved",fe={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},si="X-Request-Id",Qt="mas-commerce-service:initTime",He={CHECKOUT:"checkout",CHECKOUT_EMAIL:"checkout/email",SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"},ci={PRODUCTION:"PRODUCTION"},Fe={TWP:"twp",D2P:"d2p",CRM:"crm"},Pe=":start",Zt=":duration";function ca(e,t){let r;return function(){let n=this,i=arguments;clearTimeout(r),r=setTimeout(()=>e.apply(n,i),t)}}function Ke(e,t={},r=null,n=null){let i=n?document.createElement(e,{is:n}):document.createElement(e);r instanceof HTMLElement?i.appendChild(r):i.innerHTML=r;for(let[o,a]of Object.entries(t))i.setAttribute(o,a);return i}function Or(){return window.matchMedia("(max-width: 767px)").matches}function la(){return window.matchMedia("(max-width: 1024px)").matches}function re(){let e=document.querySelector("mas-commerce-service");return e?{[Qt]:e.initDuration}:{}}var ha=`
:root {
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return ha}setAriaExpanded(r,n){r.setAttribute("aria-expanded",n)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};p(mt,"variantStyle",_`
...
`;var Mr=class extends C{constructor(t){super(t)}getGlobalCSS(){return da}renderLayout(){return g`${this.cardImage}
    <div class="body">
...
`;var $r=class extends C{constructor(t){super(t)}getGlobalCSS(){return ua}renderLayout(){return g` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var Mc=32,pt=class extends C{constructor(r){super(r);p(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);p(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?g`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){Or()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};p(pt,"variantStyle",_`
...
`;var di={title:{tag:"p",slot:"heading-xs"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},stockOffer:!0,secureLabel:!0,badge:!0,ctas:{slot:"footer",size:"m"},style:"consonant"},ft=class extends C{constructor(t){super(t)}get aemFragmentMapping(){return di}getGlobalCSS(){return pa}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?g`<label id="stock-checkbox">
        ...
        ${this.secureLabelFooter}`}};p(ft,"variantStyle",_`
    :host([variant='plans']) {
      min-height: 348px;
    }
...
`;var Be=class extends C{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return fa}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return g` ${this.badge}
      ...
      ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}postCardUpdateHook(){this.card.isConnected&&(Or()||this.adjustProductBodySlots(),this.adjustTitleWidth())}};p(Be,"variantStyle",_`
...
`;var gt=class extends C{constructor(t){super(t)}getGlobalCSS(){return ga}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return g` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var ui={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},xt=class extends C{constructor(t){super(t)}getGlobalCSS(){return xa}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return ui}renderLayout(){return g`${this.cardImage}
            <div class="body">
...
`;var bt=class extends C{constructor(t){super(t)}getGlobalCSS(){return ba}renderLayout(){return g`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
      ...
      <footer><slot name="footer"></slot></footer>`}};p(bt,"variantStyle",_`
    :host([variant='twp']) {
      padding: 4px 10px 5px 10px;
    }
    .twp-badge {
...
`;var mi={backgroundImage:{attribute:"background-image"},badge:!0,ctas:{slot:"cta",size:"M"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"p",slot:"price"},size:[],subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"}},vt=class extends C{getGlobalCSS(){return va}get aemFragmentMapping(){return mi}get stripStyle(){return this.card.backgroundImage?`
        ...
        `:""}renderLayout(){return g` <div style="${this.stripStyle}" class="body">
            ...
            <slot></slot>`}postCardUpdateHook(t){t.has("backgroundImage")&&this.styleBackgroundImage()}styleBackgroundImage(){if(this.card.classList.remove("thin-strip"),this.card.classList.remove("wide-strip"),!this.card.backgroundImage)return;let t=new Image;t.src=this.card.backgroundImage,t.onload=()=>{t.width>8?this.card.classList.add("wide-strip"):t.width===8&&this.card.classList.add("thin-strip")}}};p(vt,"variantStyle",_`
...
`;var pi={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},At=class extends C{getGlobalCSS(){return Aa}get aemFragmentMapping(){return pi}renderLayout(){return g` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;var fi={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color"},allowedColors:{gray:"--spectrum-gray-100"},size:["single","double","triple"]},Ye=class extends C{getGlobalCSS(){return Ea}get aemFragmentMapping(){return fi}renderLayout(){return g`
  ...
  `);customElements.define("ah-try-buy-widget",Ye);var gi=(e,t=!1)=>{switch(e.variant){case"catalog":return new mt(e);case"image":return new Mr(e);case"inline-heading":return new $r(e);case"mini-compare-chart":return new pt(e);case"plans":return new ft(e);case"product":return new Be(e);case"segment":return new gt(e);case"special-offers":return new xt(e);case"twp":return new bt(e);case"ccd-suggested":return new vt(e);case"ccd-slice":return new At(e);case"ah-try-buy-widget":return new Ye(e);default:return t?void 0:new Be(e)}},ya={catalog:hi,image:null,"inline-heading":null,"mini-compare-chart":null,plans:di,product:null,segment:null,"special-offers":ui,twp:null,"ccd-suggested":mi,"ccd-slice":pi,"ah-try-buy-widget":fi},Sa=()=>{let e=[];return e.push(mt.variantStyle),e.push(pt.variantStyle),e.push(Be.variantStyle),e.push(ft.variantStyle),e.push(gt.variantStyle),e.push(xt.variantStyle),e.push(bt.variantStyle),e.push(vt.variantStyle),e.push(At.variantStyle),e.push(Ye.variantStyle),e};var Ta=document.createElement("style");Ta.innerHTML=`
:root {
...
Caused by: ${this.cause}`),r}};async function Jr(e,t={},r=2,n=100){let i;for(let o=0;o<=r;o++)try{return await fetch(e,t)}catch(a){if(i=a,o>r)break;await new Promise(s=>setTimeout(s,n*(o+1)))}throw i}var ks=new CSSStyleSheet;ks.replaceSync(":host { display: contents; }");var Ps="fragment",Cs="author",en="aem-fragment";async function th(e,t,r){let n=`${en}:${t}${Zt}`,i;try{if(i=await Jr(e,{cache:"default",credentials:"omit"}),!i?.ok){let{startTime:o,duration:a}=performance.measure(n,r);throw new ge("Unexpected fragment response",{response:i,startTime:o,duration:a})}return i.json()}catch{let{startTime:a,duration:s}=performance.measure(n,r);throw i||(i={url:e}),new ge("Failed to fetch fragment",{response:i,startTime:a,duration:s,...re()})}}var xe,uo=class{constructor(){V(this,xe,new Map)}clear(){b(this,xe).clear()}addByRequestedId(t,r){b(this,xe).set(t,r)}add(...t){t.forEach(r=>{let{id:n}=r;n&&b(this,xe).set(n,r)})}has(t){return b(this,xe).has(t)}get(t){return b(this,xe).get(t)}remove(t){b(this,xe).delete(t)}};xe=new WeakMap;var cr=new uo,tn,be,ve,Pt,Ct,lr,ee,kt,Je,It,hr,po,mo=class extends HTMLElement{constructor(){super();V(this,hr);p(this,"cache",cr);V(this,tn,B.module(en));V(this,be,null);V(this,ve,null);V(this,Pt,!1);V(this,Ct,null);V(this,lr,null);V(this,ee,void 0);V(this,kt,void 0);V(this,Je,void 0);V(this,It,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[ks]}static get observedAttributes(){return[Ps,Cs]}attributeChangedCallback(r,n,i){r===Ps&&D(this,ee,i),r===Cs&&D(this,It,["","true"].includes(i))}connectedCallback(){if(!b(this,ee)){de(this,hr,po).call(this,{message:"Missing fragment id"});return}D(this,Ct,`${en}:${b(this,ee)}${Pe}`),performance.mark(b(this,Ct)),D(this,kt,new Promise((r,n)=>{this.dispose=qr(i=>this.activate(i,r,n))}))}async activate(r,n,i){D(this,lr,r);let o=!b(this,It);this.refresh(o).then(a=>n(a)).catch(a=>i(a))}async refresh(r=!0){if(!(b(this,Je)&&!await Promise.race([b(this,Je),Promise.resolve(!1)])))return r&&cr.remove(b(this,ee)),D(this,Je,this.fetchData().then(()=>(this.dispatchEvent(new CustomEvent(Ge,{detail:{...this.data,stale:b(this,Pt)},bubbles:!0,composed:!0})),!0)).catch(n=>b(this,be)?(cr.addByRequestedId(b(this,ee),b(this,be)),!0):(D(this,kt,null),de(this,hr,po).call(this,n),!1))),b(this,Je)}async fetchData(){this.classList.remove("error"),D(this,ve,null);let r=cr.get(b(this,ee));if(r){D(this,be,r);return}D(this,Pt,!0);let{masIOUrl:n,wcsApiKey:i,locale:o}=b(this,lr).settings,a=`${n}/fragment?id=${b(this,ee)}&api_key=${i}&locale=${o}`;r=await th(a,b(this,ee),b(this,Ct)),cr.addByRequestedId(b(this,ee),r),D(this,be,r),D(this,Pt,!1)}get updateComplete(){return b(this,kt)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return b(this,ve)?b(this,ve):(b(this,It)?this.transformAuthorData():this.transformPublishData(),b(this,ve))}transformAuthorData(){let{fields:r,id:n,tags:i}=b(this,be);D(this,ve,r.reduce((o,{name:a,multiple:s,values:c})=>(o.fields[a]=s?c:c[0],o),{fields:{},id:n,tags:i}))}transformPublishData(){let{fields:r,id:n,tags:i}=b(this,be);D(this,ve,Object.entries(r).reduce((o,[a,s])=>(o.fields[a]=s?.mimeType?s.value:s??"",o),{fields:{},id:n,tags:i}))}};tn=new WeakMap,be=new WeakMap,ve=new WeakMap,Pt=new WeakMap,Ct=new WeakMap,lr=new WeakMap,ee=new WeakMap,kt=new WeakMap,Je=new WeakMap,It=new WeakMap,hr=new WeakSet,po=function({message:r,context:n}){this.classList.add("error"),b(this,tn).error(`aem-fragment: ${r}`,n),this.dispatchEvent(new CustomEvent(ze,{detail:{message:r,...n},bubbles:!0,composed:!0}))};customElements.define(en,mo);function rh(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var dr,et=class et extends HTMLAnchorElement{constructor(){super();V(this,dr,!1);this.setAttribute("is",et.is)}get isUptLink(){return!0}initializeWcsData(r,n){this.setAttribute("data-wcs-osi",r),n&&this.setAttribute("data-promotion-code",n),D(this,dr,!0),this.composePromoTermsUrl()}attributeChangedCallback(r,n,i){b(this,dr)&&this.composePromoTermsUrl()}composePromoTermsUrl(){let r=this.getAttribute("data-wcs-osi");if(!r){let u=this.closest("merch-card").querySelector("aem-fragment").getAttribute("fragment");console.error(`Missing 'data-wcs-osi' attribute on upt-link. Fragment: ${u}`);return}let n=q(),i=[r],o=this.getAttribute("data-promotion-code"),{country:a,language:s,env:c}=n.settings,l={country:a,language:s,wcsOsi:i,promotionCode:o},h=n.resolveOfferSelectors(l);Promise.all(h).then(([[u]])=>{let d=`locale=${s}_${a}&country=${a}&offer_id=${u.offerId}`;o&&(d+=`&promotion_code=${encodeURIComponent(o)}`),this.href=`${rh(c)}?${d}`}).catch(u=>{console.error(`Could not resolve offer selectors for id: ${r}.`,u.message)})}static createFrom(r){let n=new et;for(let i of r.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?n.setAttribute("class",i.value.replace("upt-link","").trim()):n.setAttribute(i.name,i.value));return n.innerHTML=r.innerHTML,n.setAttribute("tabindex",0),n}};dr=new WeakMap,p(et,"is","upt-link"),p(et,"tag","a"),p(et,"observedAttributes",["data-wcs-osi","data-promotion-code"]);var Ae=et;window.customElements.get(Ae.is)||window.customElements.define(Ae.is,Ae,{extends:Ae.tag});var nh="#000000",Is="#F8D904",ih="#EAEAEA",oh=/(accent|primary|secondary)(-(outline|link))?/,ah="mas:product_code/",sh="daa-ll",ur="daa-lh",ch=["XL","L","M","S"],fo="...";function tt(e,t,r,n){let i=n[e];if(t[e]&&i){let o={slot:i?.slot},a=t[e];if(i.maxCount&&typeof a=="string"){let[c,l]=Ah(a,i.maxCount,i.withSuffix);c!==a&&(o.title=l,a=c)}let s=Ke(i.tag,o,a);r.append(s)}}function lh(e,t,r){e.mnemonicIcon?.map((i,o)=>({icon:i,alt:e.mnemonicAlt[o]??"",link:e.mnemonicLink[o]??""}))?.forEach(({icon:i,alt:o,link:a})=>{if(a&&!/^https?:/.test(a))try{a=new URL(`https://${a}`).href.toString()}catch{a="#"}let s={slot:"icons",src:i,loading:t.loading,size:r?.size??"l"};o&&(s.alt=o),a&&(s.href=a);let c=Ke("merch-icon",s);t.append(c)})}function hh(e,t){e.badge?(t.setAttribute("badge-text",e.badge),t.setAttribute("badge-color",e.badgeColor||nh),t.setAttribute("badge-background-color",e.badgeBackgroundColor||Is),t.setAttribute("border-color",e.badgeBackgroundColor||Is)):t.setAttribute("border-color",e.borderColor||ih)}function dh(e,t,r){r?.includes(e.size)&&t.setAttribute("size",e.size)}function uh(e,t,r){tt("cardTitle",e,t,{cardTitle:r})}function mh(e,t,r){tt("subtitle",e,t,r)}function ph(e,t,r){if(!e.backgroundColor||e.backgroundColor.toLowerCase()==="default"){t.style.removeProperty("--merch-card-custom-background-color"),t.removeAttribute("background-color");return}r?.[e.backgroundColor]&&(t.style.setProperty("--merch-card-custom-background-color",`var(${r[e.backgroundColor]})`),t.setAttribute("background-color",e.backgroundColor))}function fh(e,t,r){e.borderColor&&r&&e.borderColor!=="transparent"&&t.style.setProperty("--merch-card-custom-border-color",`var(--${e.borderColor})`)}function gh(e,t,r){if(e.backgroundImage){let n={loading:t.loading??"lazy",src:e.backgroundImage};if(e.backgroundImageAltText?n.alt=e.backgroundImageAltText:n.role="none",!r)return;if(r?.attribute){t.setAttribute(r.attribute,e.backgroundImage);return}t.append(Ke(r.tag,{slot:r.slot},Ke("img",n)))}}function xh(e,t,r){tt("prices",e,t,r)}function bh(e,t,r){tt("promoText",e,t,r),tt("description",e,t,r),tt("callout",e,t,r),tt("quantitySelect",e,t,r)}function vh(e,t,r,n){e.showStockCheckbox&&r.stockOffer&&(t.setAttribute("checkbox-label",n.stockCheckboxLabel),t.setAttribute("stock-offer-osis",n.stockOfferOsis)),n.secureLabel&&r.secureLabel&&t.setAttribute("secure-label",n.secureLabel)}function Ah(e,t,r=!0){try{let n=typeof e!="string"?"":e,i=Ns(n);if(i.length<=t)return[n,i];let o=0,a=!1,s=r?t-fo.length<1?1:t-fo.length:t,c=[];for(let u of n){if(o++,u==="<")if(a=!0,n[o]==="/")c.pop();else{let d="";for(let m of n.substring(o)){if(m===" "||m===">")break;d+=m}c.push(d)}if(u==="/"&&n[o]===">"&&c.pop(),u===">"){a=!1;continue}if(!a&&(s--,s===0))break}let l=n.substring(0,o).trim();if(c.length>0){c[0]==="p"&&c.shift();for(let u of c.reverse())l+=`</${u}>`}return[`${l}${r?fo:""}`,i]}catch{let i=typeof e=="string"?e:"",o=Ns(i);return[i,o]}}function Ns(e){if(!e)return"";let t="",r=!1;for(let n of e){if(n==="<"&&(r=!0),n===">"){r=!1;continue}r||(t+=n)}return t}function Eh(e,t){t.querySelectorAll("a.upt-link").forEach(n=>{let i=Ae.createFrom(n);n.replaceWith(i),i.initializeWcsData(e.osi,e.promoCode)})}function yh(e,t,r,n){let o=customElements.get("checkout-button").createCheckoutButton({},e.innerHTML);o.setAttribute("tabindex",0);for(let h of e.attributes)["class","is"].includes(h.name)||o.setAttribute(h.name,h.value);o.firstElementChild?.classList.add("spectrum-Button-label");let a=t.ctas.size??"M",s=`spectrum-Button--${n}`,c=ch.includes(a)?`spectrum-Button--size${a}`:"spectrum-Button--sizeM",l=["spectrum-Button",s,c];return r&&l.push("spectrum-Button--outline"),o.classList.add(...l),o}function Sh(e,t,r,n){let o=customElements.get("checkout-button").createCheckoutButton(e.dataset);e.dataset.analyticsId&&o.setAttribute("data-analytics-id",e.dataset.analyticsId),o.connectedCallback(),o.render();let a="fill";r&&(a="outline");let s=Ke("sp-button",{treatment:a,variant:n,tabIndex:0,size:t.ctas.size??"m",...e.dataset.analyticsId&&{"data-analytics-id":e.dataset.analyticsId}},e.innerHTML);return s.source=o,o.onceSettled().then(c=>{s.setAttribute("data-navigation-url",c.href)}),s.addEventListener("click",c=>{c.defaultPrevented||o.click()}),s}function Th(e,t){return e.classList.add("con-button"),t&&e.classList.add("blue"),e}function wh(e,t,r,n){if(e.ctas){let{slot:i}=r.ctas,o=Ke("div",{slot:i},e.ctas),a=[...o.querySelectorAll("a")].map(s=>{let c=oh.exec(s.className)?.[0]??"accent",l=c.includes("accent"),h=c.includes("primary"),u=c.includes("secondary"),d=c.includes("-outline"),m=c.includes("-link");if(t.consonant)return Th(s,l);if(m)return s;let f;return l?f="accent":h?f="primary":u&&(f="secondary"),t.spectrum==="swc"?Sh(s,r,d,f):yh(s,r,d,f)});o.innerHTML="",o.append(...a),t.append(o)}}function _h(e,t){let{tags:r}=e,n=r?.find(o=>o.startsWith(ah))?.split("/").pop();if(!n)return;t.setAttribute(ur,n),[...t.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((o,a)=>{o.setAttribute(sh,`${o.dataset.analyticsId}-${a+1}`)})}function Lh(e){e.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,r])=>{e.querySelectorAll(`a.${t}`).forEach(n=>{n.classList.remove(t),n.classList.add("spectrum-Link",`spectrum-Link--${r}`)})})}function Ph(e){e.querySelectorAll("[slot]").forEach(n=>{n.remove()}),["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","badge-background-color","badge-color","badge-text","size",ur].forEach(n=>e.removeAttribute(n));let r=["wide-strip","thin-strip"];e.classList.remove(...r)}async function Rs(e,t){let{id:r,fields:n}=e,{variant:i}=n;if(!i)throw new Error(`hydrate: no variant found in payload ${r}`);let o={stockCheckboxLabel:"Add a 30-day free trial of Adobe Stock.*",stockOfferOsis:"",secureLabel:"Secure transaction"};Ph(t),t.id??(t.id=e.id),t.removeAttribute("background-image"),t.removeAttribute("background-color"),t.removeAttribute("badge-background-color"),t.removeAttribute("badge-color"),t.removeAttribute("badge-text"),t.removeAttribute("size"),t.classList.remove("wide-strip"),t.classList.remove("thin-strip"),t.removeAttribute(ur),t.variant=i,await t.updateComplete;let{aemFragmentMapping:a}=t.variantLayout;if(!a)throw new Error(`hydrate: aemFragmentMapping found for ${r}`);a.style==="consonant"&&t.setAttribute("consonant",!0),lh(n,t,a.mnemonics),hh(n,t),dh(n,t,a.size),uh(n,t,a.title),mh(n,t,a),xh(n,t,a),gh(n,t,a.backgroundImage),ph(n,t,a.allowedColors),fh(n,t,a.borderColor),bh(n,t,a),vh(n,t,a,o),Eh(n,t),wh(n,t,a,i),_h(n,t),Lh(t)}var Ch="merch-card",kh=":ready",Ih=":error",go=2e4,rn="merch-card:",Ie,Nt,mr=class extends Q{constructor(){super();V(this,Ie);p(this,"customerSegment");p(this,"marketSegment");p(this,"variantLayout");p(this,"log");p(this,"readyEventDispatched",!1);this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.log=B.module("merch-card")}static getFragmentMapping(r){return ya[r]}firstUpdated(){this.variantLayout=gi(this,!1),this.variantLayout?.connectedCallbackHook(),this.aemFragment?.updateComplete.catch(r=>{de(this,Ie,Nt).call(this,r,{},!1),this.style.display="none"})}willUpdate(r){(r.has("variant")||!this.variantLayout)&&(this.variantLayout=gi(this),this.variantLayout.connectedCallbackHook())}updated(r){(r.has("badgeBackgroundColor")||r.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border",this.computedBorderStyle),this.variantLayout?.postCardUpdateHook(r)}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}get prices(){return Array.from(this.querySelectorAll('span[is="inline-price"][data-wcs-osi]'))}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["twp","ccd-slice","ccd-suggested"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector(Nr)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(Wt)??[]]}async toggleStockOffer({target:r}){if(!this.stockOfferOsis)return;let n=this.checkoutLinks;if(n.length!==0)for(let i of n){await i.onceSettled();let o=i.value?.[0]?.planType;if(!o)return;let a=this.stockOfferOsis[o];if(!a)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==a);r.checked&&s.push(a),i.dataset.wcsOsi=s.join(",")}}handleQuantitySelection(r){let n=this.checkoutLinks;for(let i of n)i.dataset.quantity=r.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(r){let n={...this.filters};Object.keys(n).forEach(i=>{if(r){n[i].order=Math.min(n[i].order||2,2);return}let o=n[i].order;o===1||isNaN(o)||(n[i].order=Number(o)+1)}),this.filters=n}includes(r){return this.textContent.match(new RegExp(r,"i"))!==null}connectedCallback(){super.connectedCallback(),this.id??(this.id=this.querySelector("aem-fragment")?.getAttribute("fragment")),performance.mark(`${rn}${this.id}${Pe}`),this.addEventListener(ut,this.handleQuantitySelection),this.addEventListener(Kn,this.merchCardReady,{once:!0}),this.updateComplete.then(()=>{this.merchCardReady()}),this.storageOptions?.addEventListener("change",this.handleStorageChange),this.addEventListener(ze,this.handleAemFragmentEvents),this.addEventListener(Ge,this.handleAemFragmentEvents),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(ut,this.handleQuantitySelection),this.storageOptions?.removeEventListener(Rr,this.handleStorageChange),this.removeEventListener(ze,this.handleAemFragmentEvents),this.removeEventListener(Ge,this.handleAemFragmentEvents)}async handleAemFragmentEvents(r){if(r.type===ze&&de(this,Ie,Nt).call(this,`AEM fragment cannot be loaded: ${r.detail.message}`,r.detail),r.type===Ge&&r.target.nodeName==="AEM-FRAGMENT"){let n=r.detail;Rs(n,this).then(()=>this.checkReady()).catch(i=>this.log?.error(i))}}async checkReady(){let r=new Promise(a=>setTimeout(()=>a("timeout"),go));if(this.aemFragment){let a=await Promise.race([this.aemFragment.updateComplete,r]);if(a===!1){let s=a==="timeout"?`AEM fragment was not resolved within ${go} timeout`:"AEM fragment cannot be loaded";de(this,Ie,Nt).call(this,s,{},!1);return}}let n=[...this.querySelectorAll(qt)];n.push(...[...this.querySelectorAll(Fn)].map(a=>a.source));let i=Promise.all(n.map(a=>a.onceSettled().catch(()=>a))).then(a=>a.every(s=>s.classList.contains("placeholder-resolved"))),o=await Promise.race([i,r]);if(o===!0)return performance.mark(`${rn}${this.id}${kh}`),this.readyEventDispatched||(this.readyEventDispatched=!0,this.dispatchEvent(new CustomEvent(jn,{bubbles:!0,composed:!0}))),this;{let{duration:a,startTime:s}=performance.measure(`${rn}${this.id}${Ih}`,`${rn}${this.id}${Pe}`),c={duration:a,startTime:s,...re()};o==="timeout"?de(this,Ie,Nt).call(this,`Contains offers that were not resolved within ${go} timeout`,c):de(this,Ie,Nt).call(this,"Contains unresolved offers",c)}}get aemFragment(){return this.querySelector("aem-fragment")}get storageOptions(){return this.querySelector("sp-radio-group#storage")}get storageSpecificOfferSelect(){let r=this.storageOptions?.selected;if(r){let n=this.querySelector(`merch-offer-select[storage="${r}"]`);if(n)return n}return this.querySelector("merch-offer-select")}get offerSelect(){return this.storageOptions?this.storageSpecificOfferSelect:this.querySelector("merch-offer-select")}get quantitySelect(){return this.querySelector("merch-quantity-select")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let r=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(Wt)).length===2&&r&&r.parentElement.classList.add("footer-column")}merchCardReady(){this.offerSelect&&!this.offerSelect.planType||(this.dispatchEvent(new CustomEvent(Bn,{bubbles:!0})),this.displayFooterElementsInColumn())}handleStorageChange(){let r=this.closest("merch-card")?.offerSelect.cloneNode(!0);r&&this.dispatchEvent(new CustomEvent(Rr,{detail:{offerSelect:r},bubbles:!0}))}get dynamicPrice(){return this.querySelector('[slot="price"]')}selectMerchOffer(r){if(r===this.merchOffer)return;this.merchOffer=r;let n=this.dynamicPrice;if(r.price&&n){let i=r.price.cloneNode(!0);n.onceSettled?n.onceSettled().then(()=>{n.replaceWith(i)}):n.replaceWith(i)}}};Ie=new WeakSet,Nt=function(r,n={},i=!0){this.log?.error(`merch-card: ${r}`,n),this.failed=!0,i&&this.dispatchEvent(new CustomEvent(Xn,{detail:{...n,message:r},bubbles:!0,composed:!0}))},p(mr,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:r=>{if(!r)return;let[n,i,o]=r.split(",");return{PUF:n,ABM:i,M2M:o}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:r=>Object.fromEntries(r.split(",").map(n=>{let[i,o,a]=n.split(":"),s=Number(o);return[i,{order:isNaN(s)?void 0:s,size:a}]})),toAttribute:r=>Object.entries(r).map(([n,{order:i,size:o}])=>[n,i,o].filter(a=>a!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:ur,reflect:!0},loading:{type:String}}),p(mr,"styles",[aa,Sa(),...sa()]);customElements.define(Ch,mr);var Rt=class extends Q{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:t}=this;return t?g`<a href="${t}">
    ...
    `);customElements.define("merch-icon",Rt);var Os=_`
    :host {
        box-sizing: border-box;
