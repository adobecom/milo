...
`,pc=()=>[v`
    ...
    `);customElements.define("merch-icon",Nt);var Cr,at,Pr,Lr,Mt,Pn=class extends HTMLElement{constructor(){super();w(this,Cr,"");w(this,at);w(this,Pr,[]);w(this,Lr,[]);w(this,Mt);_(this,Mt,mr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,u(this,at)?this.parentElement.style.borderRadius=u(this,at):u(this,at)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let r=u(this,Pr).map((n,o)=>{let i=u(this,Lr)[o]||"";return`${n} ${i}`}).join(", ");return`linear-gradient(${u(this,Cr)}, ${r})`}connectedCallback(){u(this,Mt).call(this)}attributeChangedCallback(r,n,o){r==="border-radius"&&_(this,at,o?.trim()),r==="colors"&&o?_(this,Pr,o?.split(",").map(i=>i.trim())??[]):r==="positions"&&o?_(this,Lr,o?.split(",").map(i=>i.trim())??[]):r==="angle"&&_(this,Cr,o?.trim()??""),u(this,Mt).call(this)}};Cr=new WeakMap,at=new WeakMap,Pr=new WeakMap,Lr=new WeakMap,Mt=new WeakMap;customElements.define("merch-gradient",Pn);var $t=class extends H{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this)}getOsi(t,r){let i=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION"],PROMOTION:["PROMOTION","BASE"]}[r]||[r]).map(s=>`p[data-plan-type="${t}"] ${Q}[data-offer-type="${s}"]`).join(", ");return this.querySelector(i)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(vt,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(vt,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let r=t.target,n=r?.value?.[0];n&&(r.setAttribute("data-offer-type",n.offerType),r.closest("p").setAttribute("data-plan-type",n.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}render(){return x`<input
                type="checkbox"
                id="addon-checkbox"
                part="checkbox"
...
`;var xd=32,Ut=class extends M{constructor(r){super(r);f(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);f(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
...
`;document.head.appendChild(Sc);var Tc="fragment",Cc="author",Pc="preview",Si="aem-fragment",ve,Ti=class{constructor(){w(this,ve,new Map)}clear(){u(this,ve).clear()}addByRequestedId(t,r){u(this,ve).set(t,r)}put(t,r){u(this,ve).set(t,r)}add(...t){t.forEach(r=>{let{id:n}=r;n&&u(this,ve).set(n,r)})}has(t){return u(this,ve).has(t)}get(t){return u(this,ve).get(t)}remove(t){u(this,ve).delete(t)}};ve=new WeakMap;var Nn=new Ti,zt,ye,Re,X,le,ae,de,Rr,Or,Ft,pe,Lc,kc,Pi,Rc,Ci=class extends HTMLElement{constructor(){super(...arguments);w(this,pe);f(this,"cache",Nn);w(this,zt);w(this,ye,null);w(this,Re,null);w(this,X,{url:null,retryCount:0,stale:!1,measure:null,status:null});w(this,le,null);w(this,ae);w(this,de);w(this,Rr,!1);w(this,Or,0);w(this,Ft)}static get observedAttributes(){return[Tc,Cc,Pc]}attributeChangedCallback(r,n,o){r===Tc&&_(this,ae,o),r===Cc&&_(this,Rr,["","true"].includes(o)),r===Pc&&_(this,Ft,o)}connectedCallback(){if(!u(this,de)){if(u(this,le)??_(this,le,St(this)),_(this,Ft,u(this,le).settings?.preview),u(this,zt)??_(this,zt,u(this,le).log.module(`${Si}[${u(this,ae)}]`)),!u(this,ae)||u(this,ae)==="#"){ne(this,pe,Pi).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(u(this,X)).filter(([r,n])=>n!=null).map(([r,n])=>[`aem-fragment:${r}`,n]))}async refresh(r=!0){if(u(this,de)&&!await Promise.race([u(this,de),Promise.resolve(!1)]))return;r&&Nn.remove(u(this,ae));try{_(this,de,ne(this,pe,Rc).call(this)),await u(this,de)}catch(s){return ne(this,pe,Pi).call(this,s.message),!1}let{references:n,referencesTree:o,placeholders:i,wcs:a}=u(this,ye)||{};return a&&!N("mas.disableWcsCache")&&u(this,le).prefillWcsCache(a),this.dispatchEvent(new CustomEvent(Fe,{detail:{...this.data,references:n,referencesTree:o,placeholders:i,...u(this,X)},bubbles:!0,composed:!0})),u(this,de)}get updateComplete(){return u(this,de)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return u(this,Re)?u(this,Re):(u(this,Rr)?this.transformAuthorData():this.transformPublishData(),u(this,Re))}transformAuthorData(){let{fields:r,id:n,tags:o,settings:i={}}=u(this,ye);_(this,Re,r.reduce((a,{name:s,multiple:c,values:l})=>(a.fields[s]=c?l:l[0],a),{fields:{},id:n,tags:o,settings:i}))}transformPublishData(){let{fields:r,id:n,tags:o,settings:i={}}=u(this,ye);_(this,Re,Object.entries(r).reduce((a,[s,c])=>(a.fields[s]=c?.mimeType?c.value:c??"",a),{fields:{},id:n,tags:o,settings:i}))}async generatePreview(){let{previewFragment:r}=await import("https://mas.adobe.com/studio/libs/fragment-client.js");return await r(u(this,ae),{locale:u(this,le).settings.locale,apiKey:u(this,le).settings.wcsApiKey})}};zt=new WeakMap,ye=new WeakMap,Re=new WeakMap,X=new WeakMap,le=new WeakMap,ae=new WeakMap,de=new WeakMap,Rr=new WeakMap,Or=new WeakMap,Ft=new WeakMap,pe=new WeakSet,Lc=async function(r){zi(this,Or)._++;let n=`${Si}:${u(this,ae)}:${u(this,Or)}`,o=`${n}${je}`,i=`${n}${qe}`;if(u(this,Ft))return await this.generatePreview();performance.mark(o);let a;try{if(u(this,X).stale=!1,u(this,X).url=r,a=await dn(r,{cache:"default",credentials:"omit"}),ne(this,pe,kc).call(this,a),u(this,X).status=a?.status,u(this,X).measure=fe(performance.measure(i,o)),u(this,X).retryCount=a.retryCount,!a?.ok)throw new Se("Unexpected fragment response",{response:a,...u(this,le).duration});return await a.json()}catch(s){if(u(this,X).measure=fe(performance.measure(i,o)),u(this,X).retryCount=s.retryCount,u(this,ye))return u(this,X).stale=!0,u(this,zt).error("Serving stale data",u(this,X)),u(this,ye);let c=s.message??"unknown";throw new Se(`Failed to fetch fragment: ${c}`,{})}},kc=function(r){Object.assign(u(this,X),Yr(r))},Pi=function(r){_(this,de,null),u(this,X).message=r,this.classList.add("error");let n={...u(this,X),...u(this,le).duration};u(this,zt).error(r,n),this.dispatchEvent(new CustomEvent(Ge,{detail:n,bubbles:!0,composed:!0}))},Rc=async function(){this.classList.remove("error"),_(this,Re,null);let r=Nn.get(u(this,ae));if(r)return _(this,ye,r),!0;let{masIOUrl:n,wcsApiKey:o,locale:i}=u(this,le).settings,a=`${n}/fragment?id=${u(this,ae)}&api_key=${o}&locale=${i}`;return r=await ne(this,pe,Lc).call(this,a),Nn.addByRequestedId(u(this,ae),r),_(this,ye,r),!0};customElements.define(Si,Ci);var Gt=class extends H{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return x`<div class="badge">
    ...
    `),f(Ir,"properties",{offers:{type:Array},selectedOffer:{type:Object},defaults:{type:Object},variant:{type:String,attribute:"variant",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},stock:{type:Boolean,reflect:!0}});customElements.define("merch-offer-select",Ir);var Hc=v`
    :host {
