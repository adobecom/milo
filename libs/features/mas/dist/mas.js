...
`;var Gl=32,mt=class extends N{constructor(r){super(r);p(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);p(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
              <span class="secure-transaction-label"
                  >${this.card.secureLabel}</span
              ></slot
          >`:x`<slot name="secure-transaction-label"></slot>`;return x`<footer>${r}<slot name="footer"></slot></footer>`})}getGlobalCSS(){return Qa}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2)return;this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".top-section"),"top-section"),["heading-m","body-m","heading-m-price","body-xxs","price-commitment","offers","promo-text","callout-content"].forEach(i=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${i}"]`),i)),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector("footer"),"footer");let n=this.card.shadowRoot.querySelector(".mini-compare-chart-badge");n&&n.textContent!==""&&this.getContainer().style.setProperty("--consonant-merch-card-mini-compare-chart-top-section-mobile-height","32px")}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;[...this.card.querySelector('[slot="footer-rows"]')?.children].forEach((n,i)=>{let o=Math.max(Gl,parseFloat(window.getComputedStyle(n).height)||0),a=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(i+1)))||0;o>a&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(i+1),`${o}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(n=>{let i=n.querySelector(".footer-row-cell-description");i&&!i.textContent.trim()&&n.remove()})}renderLayout(){return x` <div class="top-section${this.badge?" badge":""}">
            <slot name="icons"></slot> ${this.badge}
        </div>
        <slot name="heading-m"></slot>
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){$r()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};p(mt,"variantStyle",I`
...
`;var pt=class extends N{constructor(t){super(t)}getGlobalCSS(){return es}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
...
`;var je=class extends N{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return ts}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return x` ${this.badge}
      ...
      ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}postCardUpdateHook(){this.card.isConnected&&($r()||this.adjustProductBodySlots(),this.adjustTitleWidth())}};p(je,"variantStyle",I`
...
`;var ft=class extends N{constructor(t){super(t)}getGlobalCSS(){return rs}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
        ${this.promoBottom?"":x`<slot name="promo-text"></slot><slot name="callout-content"></slot>`}
    ...
    <hr />
    ${this.secureLabelFooter}`}};p(ft,"variantStyle",I`
...
`;var xt=class extends N{constructor(t){super(t)}getGlobalCSS(){return is}renderLayout(){return x`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
      ...
      <footer><slot name="footer"></slot></footer>`}};p(xt,"variantStyle",I`
    :host([variant='twp']) {
      padding: 4px 10px 5px 10px;
    }
    .twp-badge {
...
`;var Fl={mnemonics:{size:"l"},subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"cta",size:"m"}},bt=class extends N{getGlobalCSS(){return os}get aemFragmentMapping(){return Fl}renderLayout(){return x`
...
`;var Kl={mnemonics:{size:"m"},backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{slot:"footer",size:"s"},allowedSizes:["wide"]},vt=class extends N{getGlobalCSS(){return as}get aemFragmentMapping(){return Kl}renderLayout(){return x` <div class="content">
                <div class="top-section">
                  <slot name="icons"></slot> 
                  ${this.badge}
                </div>  
    ...
    `);var $i=(e,t=!1)=>{switch(e.variant){case"catalog":return new ut(e);case"image":return new Ur(e);case"inline-heading":return new Dr(e);case"mini-compare-chart":return new mt(e);case"plans":return new pt(e);case"product":return new je(e);case"segment":return new ft(e);case"special-offers":return new gt(e);case"twp":return new xt(e);case"ccd-suggested":return new bt(e);case"ccd-slice":return new vt(e);default:return t?void 0:new je(e)}},ss=()=>{let e=[];return e.push(ut.variantStyle),e.push(mt.variantStyle),e.push(je.variantStyle),e.push(pt.variantStyle),e.push(ft.variantStyle),e.push(gt.variantStyle),e.push(xt.variantStyle),e.push(bt.variantStyle),e.push(vt.variantStyle),e};var cs=document.createElement("style");cs.innerHTML=`
:root {
...
`;document.head.appendChild(cs);var jl="#000000",Yl="#F8D904",Xl=/(accent|primary|secondary)(-(outline|link))?/,Wl="mas:product_code/",ql="daa-ll",Br="daa-lh";function Zl(e,t,r){e.mnemonicIcon?.map((i,o)=>({icon:i,alt:e.mnemonicAlt[o]??"",link:e.mnemonicLink[o]??""}))?.forEach(({icon:i,alt:o,link:a})=>{if(a&&!/^https?:/.test(a))try{a=new URL(`https://${a}`).href.toString()}catch{a="#"}let s={slot:"icons",src:i,size:r?.size??"l"};o&&(s.alt=o),a&&(s.href=a);let c=de("merch-icon",s);t.append(c)})}function Jl(e,t){e.badge&&(t.setAttribute("badge-text",e.badge),t.setAttribute("badge-color",e.badgeColor||jl),t.setAttribute("badge-background-color",e.badgeBackgroundColor||Yl))}function Ql(e,t,r){r?.includes(e.size)&&t.setAttribute("size",e.size)}function eh(e,t,r){e.cardTitle&&r&&t.append(de(r.tag,{slot:r.slot},e.cardTitle))}function th(e,t,r){e.subtitle&&r&&t.append(de(r.tag,{slot:r.slot},e.subtitle))}function rh(e,t,r,n){if(e.backgroundImage)switch(n){case"ccd-slice":r&&t.append(de(r.tag,{slot:r.slot},`<img loading="lazy" src="${e.backgroundImage}" />`));break;case"ccd-suggested":t.setAttribute("background-image",e.backgroundImage);break}}function nh(e,t,r){if(e.prices&&r){let n=de(r.tag,{slot:r.slot},e.prices);t.append(n)}}function ih(e,t,r){if(e.description&&r){let n=de(r.tag,{slot:r.slot},e.description);t.append(n)}}function oh(e,t,r,n){n==="ccd-suggested"&&!e.className&&(e.className="primary-link");let i=Xl.exec(e.className)?.[0]??"accent",o=i.includes("accent"),a=i.includes("primary"),s=i.includes("secondary"),c=i.includes("-outline");if(i.includes("-link"))return e;let l="fill",d;o||t?d="accent":a?d="primary":s&&(d="secondary"),c&&(l="outline"),e.tabIndex=-1;let u=de("sp-button",{treatment:l,variant:d,tabIndex:0,size:r.ctas.size??"m"},e);return u.addEventListener("click",m=>{m.target!==e&&(m.stopPropagation(),e.click())}),u}function ah(e,t){return e.classList.add("con-button"),t&&e.classList.add("blue"),e}function sh(e,t,r,n){if(e.ctas){let{slot:i}=r.ctas,o=de("div",{slot:i},e.ctas),a=[...o.querySelectorAll("a")].map(s=>{let c=s.parentElement.tagName==="STRONG";return t.consonant?ah(s,c):oh(s,c,r,n)});o.innerHTML="",o.append(...a),t.append(o)}}function ch(e,t){let{tags:r}=e,n=r?.find(i=>i.startsWith(Wl))?.split("/").pop();n&&(t.setAttribute(Br,n),t.querySelectorAll("a[data-analytics-id]").forEach((i,o)=>{i.setAttribute(ql,`${i.dataset.analyticsId}-${o+1}`)}))}async function ls(e,t){let{fields:r}=e,{variant:n}=r;if(!n)return;t.querySelectorAll("[slot]").forEach(o=>{o.remove()}),t.removeAttribute("background-image"),t.removeAttribute("badge-background-color"),t.removeAttribute("badge-color"),t.removeAttribute("badge-text"),t.removeAttribute("size"),t.removeAttribute(Br),t.variant=n,await t.updateComplete;let{aemFragmentMapping:i}=t.variantLayout;i&&(ch(r,t),rh(r,t,i.backgroundImage,n),Jl(r,t),sh(r,t,i,n),ih(r,t,i.description),Zl(r,t,i.mnemonics),nh(r,t,i.prices),Ql(r,t,i.allowedSizes),th(r,t,i.subtitle),eh(r,t,i.title))}var lh="merch-card",hh=2e3,Di,Wt,Ui,Xt=class extends oe{constructor(){super();U(this,Wt);p(this,"customerSegment");p(this,"marketSegment");p(this,"variantLayout");U(this,Di,!1);this.filters={},this.types="",this.selected=!1,this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this)}firstUpdated(){this.variantLayout=$i(this,!1),this.variantLayout?.connectedCallbackHook(),this.aemFragment?.updateComplete.catch(()=>{this.style.display="none"})}willUpdate(r){(r.has("variant")||!this.variantLayout)&&(this.variantLayout=$i(this),this.variantLayout.connectedCallbackHook())}updated(r){(r.has("badgeBackgroundColor")||r.has("borderColor"))&&(this.style.border=this.computedBorderStyle),this.variantLayout?.postCardUpdateHook(this)}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}get prices(){return Array.from(this.querySelectorAll('span[is="inline-price"][data-wcs-osi]'))}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["twp","ccd-slice","ccd-suggested"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector('span[is="inline-price"]')}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll('a[is="checkout-link"]')??[]]}async toggleStockOffer({target:r}){if(!this.stockOfferOsis)return;let n=this.checkoutLinks;if(n.length!==0)for(let i of n){await i.onceSettled();let o=i.value?.[0]?.planType;if(!o)return;let a=this.stockOfferOsis[o];if(!a)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==a);r.checked&&s.push(a),i.dataset.wcsOsi=s.join(",")}}handleQuantitySelection(r){let n=this.checkoutLinks;for(let i of n)i.dataset.quantity=r.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(r){let n={...this.filters};Object.keys(n).forEach(i=>{if(r){n[i].order=Math.min(n[i].order||2,2);return}let o=n[i].order;o===1||isNaN(o)||(n[i].order=Number(o)+1)}),this.filters=n}includes(r){return this.textContent.match(new RegExp(r,"i"))!==null}connectedCallback(){super.connectedCallback(),this.addEventListener(gr,this.handleQuantitySelection),this.addEventListener($n,this.merchCardReady,{once:!0}),this.updateComplete.then(()=>{this.merchCardReady()}),this.storageOptions?.addEventListener("change",this.handleStorageChange),this.addEventListener(Ve,this.handleAemFragmentEvents),this.addEventListener(Re,this.handleAemFragmentEvents),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout.disconnectedCallbackHook(),this.removeEventListener(gr,this.handleQuantitySelection),this.storageOptions?.removeEventListener(fr,this.handleStorageChange),this.removeEventListener(Ve,this.handleAemFragmentEvents),this.removeEventListener(Re,this.handleAemFragmentEvents)}async handleAemFragmentEvents(r){if(r.type===Ve&&be(this,Wt,Ui).call(this,"AEM fragment cannot be loaded"),r.type===Re&&r.target.nodeName==="AEM-FRAGMENT"){let n=r.detail;await ls(n,this),this.checkReady()}}async checkReady(){let r=Promise.all([...this.querySelectorAll('span[is="inline-price"][data-wcs-osi],a[is="checkout-link"][data-wcs-osi]')].map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(a=>a.classList.contains("placeholder-resolved"))),n=new Promise(o=>setTimeout(()=>o(!1),hh));if(await Promise.race([r,n])===!0){this.dispatchEvent(new CustomEvent(Bn,{bubbles:!0,composed:!0}));return}be(this,Wt,Ui).call(this,"Contains unresolved offers")}get aemFragment(){return this.querySelector("aem-fragment")}get storageOptions(){return this.querySelector("sp-radio-group#storage")}get storageSpecificOfferSelect(){let r=this.storageOptions?.selected;if(r){let n=this.querySelector(`merch-offer-select[storage="${r}"]`);if(n)return n}return this.querySelector("merch-offer-select")}get offerSelect(){return this.storageOptions?this.storageSpecificOfferSelect:this.querySelector("merch-offer-select")}get quantitySelect(){return this.querySelector("merch-quantity-select")}merchCardReady(){this.offerSelect&&!this.offerSelect.planType||this.dispatchEvent(new CustomEvent(Un,{bubbles:!0}))}handleStorageChange(){let r=this.closest("merch-card")?.offerSelect.cloneNode(!0);r&&this.dispatchEvent(new CustomEvent(fr,{detail:{offerSelect:r},bubbles:!0}))}get dynamicPrice(){return this.querySelector('[slot="price"]')}selectMerchOffer(r){if(r===this.merchOffer)return;this.merchOffer=r;let n=this.dynamicPrice;if(r.price&&n){let i=r.price.cloneNode(!0);n.onceSettled?n.onceSettled().then(()=>{n.replaceWith(i)}):n.replaceWith(i)}}};Di=new WeakMap,Wt=new WeakSet,Ui=function(r){this.dispatchEvent(new CustomEvent(Gn,{detail:r,bubbles:!0,composed:!0}))},p(Xt,"properties",{name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:r=>{let[n,i,o]=r.split(",");return{PUF:n,ABM:i,M2M:o}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:r=>Object.fromEntries(r.split(",").map(n=>{let[i,o,a]=n.split(":"),s=Number(o);return[i,{order:isNaN(s)?void 0:s,size:a}]})),toAttribute:r=>Object.entries(r).map(([n,{order:i,size:o}])=>[n,i,o].filter(a=>a!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:Br,reflect:!0}}),p(Xt,"styles",[Ya,ss(),...Xa()]);customElements.define(lh,Xt);var At=class extends oe{constructor(){super(),this.size="m",this.alt=""}render(){let{href:t}=this;return t?x`<a href="${t}">
    ...
    `);customElements.define("merch-icon",At);var ms=new CSSStyleSheet;ms.replaceSync(":host { display: contents; }");var dh=document.querySelector('meta[name="aem-base-url"]')?.content??"https://odin.adobe.com",hs="fragment",ds="author",uh="ims",us=e=>{throw new Error(`Failed to get fragment: ${e}`)};async function mh(e,t,r,n){let i=r?`${e}/adobe/sites/cf/fragments/${t}`:`${e}/adobe/sites/fragments/${t}`,o=await fetch(i,{cache:"default",credentials:"omit",headers:n}).catch(a=>us(a.message));return o?.ok||us(`${o.status} ${o.statusText}`),o.json()}var Bi,_e,Gi=class{constructor(){U(this,_e,new Map)}clear(){L(this,_e).clear()}add(...t){t.forEach(r=>{let{id:n}=r;n&&L(this,_e).set(n,r)})}has(t){return L(this,_e).has(t)}get(t){return L(this,_e).get(t)}remove(t){L(this,_e).delete(t)}};_e=new WeakMap;var Gr=new Gi,Ye,ue,we,qt,me,Et,pe,Fi,ps,fs,zi=class extends HTMLElement{constructor(){super();U(this,pe);p(this,"cache",Gr);U(this,Ye);U(this,ue);U(this,we);U(this,qt,!1);U(this,me);U(this,Et,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[ms];let r=this.getAttribute(uh);["",!0,"true"].includes(r)&&(F(this,qt,!0),Bi||(Bi={Authorization:`Bearer ${window.adobeid?.authorize?.()}`}))}static get observedAttributes(){return[hs,ds]}attributeChangedCallback(r,n,i){r===hs&&(F(this,we,i),this.refresh(!1)),r===ds&&F(this,Et,["","true"].includes(i))}connectedCallback(){if(!L(this,we)){be(this,pe,Fi).call(this,"Missing fragment id");return}}async refresh(r=!0){L(this,me)&&!await Promise.race([L(this,me),Promise.resolve(!1)])||(r&&Gr.remove(L(this,we)),F(this,me,this.fetchData().then(()=>(this.dispatchEvent(new CustomEvent(Re,{detail:this.data,bubbles:!0,composed:!0})),!0)).catch(n=>(be(this,pe,Fi).call(this,"Network error: failed to load fragment"),F(this,me,null),!1))),L(this,me))}async fetchData(){F(this,Ye,null),F(this,ue,null);let r=Gr.get(L(this,we));r||(r=await mh(dh,L(this,we),L(this,Et),L(this,qt)?Bi:void 0),Gr.add(r)),F(this,Ye,r)}get updateComplete(){return L(this,me)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return L(this,ue)?L(this,ue):(L(this,Et)?be(this,pe,ps).call(this):be(this,pe,fs).call(this),L(this,ue))}};Ye=new WeakMap,ue=new WeakMap,we=new WeakMap,qt=new WeakMap,me=new WeakMap,Et=new WeakMap,pe=new WeakSet,Fi=function(r){this.classList.add("error"),this.dispatchEvent(new CustomEvent(Ve,{detail:r,bubbles:!0,composed:!0}))},ps=function(){let{id:r,tags:n,fields:i}=L(this,Ye);F(this,ue,i.reduce((o,{name:a,multiple:s,values:c})=>(o.fields[a]=s?c:c[0],o),{id:r,tags:n,fields:{}}))},fs=function(){let{id:r,tags:n,fields:i}=L(this,Ye);F(this,ue,Object.entries(i).reduce((o,[a,s])=>(o.fields[a]=s?.mimeType?s.value:s??"",o),{id:r,tags:n,fields:{}}))};customElements.define("aem-fragment",zi);
