...
`,Mo=()=>[C`
        ...
        `}get cardImage(){return x` <div class="image">
            ...
            ${this.badge}
              ...
              >`:"";return x`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){}};nt=new WeakMap,p(Rt,"styleMap",{});var I=Rt;function te(e,t={},r=null,n=null){let i=n?document.createElement(e,{is:n}):document.createElement(e);r instanceof HTMLElement?i.appendChild(r):i.innerHTML=r;for(let[o,a]of Object.entries(t))i.setAttribute(o,a);return i}function fr(){return window.matchMedia("(max-width: 767px)").matches}function Vo(){return window.matchMedia("(max-width: 1024px)").matches}var zn={};Os(zn,{CLASS_NAME_FAILED:()=>kn,CLASS_NAME_HIDDEN:()=>Ys,CLASS_NAME_PENDING:()=>Nn,CLASS_NAME_RESOLVED:()=>On,ERROR_MESSAGE_BAD_REQUEST:()=>br,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>rc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Rn,EVENT_AEM_ERROR:()=>$e,EVENT_AEM_LOAD:()=>Ve,EVENT_MAS_ERROR:()=>In,EVENT_MAS_READY:()=>Cn,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Pn,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>ec,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Qs,EVENT_MERCH_CARD_READY:()=>wn,EVENT_MERCH_OFFER_READY:()=>Ws,EVENT_MERCH_OFFER_SELECT_READY:()=>_n,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>xr,EVENT_MERCH_SEARCH_CHANGE:()=>Js,EVENT_MERCH_SIDENAV_SELECT:()=>tc,EVENT_MERCH_STOCK_CHANGE:()=>Zs,EVENT_MERCH_STORAGE_CHANGE:()=>gr,EVENT_OFFER_SELECTED:()=>qs,EVENT_TYPE_FAILED:()=>Mn,EVENT_TYPE_PENDING:()=>Vn,EVENT_TYPE_READY:()=>it,EVENT_TYPE_RESOLVED:()=>$n,LOG_NAMESPACE:()=>Hn,Landscape:()=>He,NAMESPACE:()=>js,PARAM_AOS_API_KEY:()=>nc,PARAM_ENV:()=>Un,PARAM_LANDSCAPE:()=>Dn,PARAM_WCS_API_KEY:()=>ic,STATE_FAILED:()=>he,STATE_PENDING:()=>de,STATE_RESOLVED:()=>ue,TAG_NAME_SERVICE:()=>Xs,WCS_PROD_URL:()=>Bn,WCS_STAGE_URL:()=>Gn});var js="merch",Ys="hidden",it="wcms:commerce:ready",Xs="mas-commerce-service",Ws="merch-offer:ready",_n="merch-offer-select:ready",wn="merch-card:ready",Pn="merch-card:action-menu-toggle",qs="merch-offer:selected",Zs="merch-stock:change",gr="merch-storage:change",xr="merch-quantity-selector:change",Js="merch-search:change",Qs="merch-card-collection:sort",ec="merch-card-collection:showmore",tc="merch-sidenav:select",Ve="aem:load",$e="aem:error",Cn="mas:ready",In="mas:error",kn="placeholder-failed",Nn="placeholder-pending",On="placeholder-resolved",br="Bad WCS request",Rn="Commerce offer not found",rc="Literals URL not provided",Mn="mas:failed",Vn="mas:pending",$n="mas:resolved",Hn="mas/commerce",Un="commerce.env",Dn="commerce.landscape",nc="commerce.aosKey",ic="commerce.wcsKey",Bn="https://www.adobe.com/web_commerce_artifact",Gn="https://www.stage.adobe.com/web_commerce_artifact_stage",he="failed",de="pending",ue="resolved",He={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"};var $o=`
:root {
...
`;var vr=class extends I{constructor(t){super(t)}getGlobalCSS(){return Ho}renderLayout(){return x`${this.cardImage}
    <div class="body">
