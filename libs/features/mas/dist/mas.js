...
`,qs=()=>[E`
      ...
      `];var Tt=class extends I{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:t}=this;return t?x`<a href="${t}">
              ...
              </a>`:x` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};m(Tt,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),m(Tt,"styles",E`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return Ws}setAriaExpanded(r,o){r.setAttribute("aria-expanded",o)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};m(Pt,"variantStyle",E`
...
`;var Nh=32,Lt=class extends ${constructor(r){super(r);m(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);m(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){bt()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};m(Lt,"variantStyle",E`
...
`;var ai={title:{tag:"p",slot:"heading-xs"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},stockOffer:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant"},kt=class extends ${constructor(t){super(t),this.adaptForMobile=this.adaptForMobile.bind(this)}get aemFragmentMapping(){return ai}priceOptionsProvider(t,r){t.dataset.template===Fo&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Zs}adaptForMobile(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards")){this.card.removeAttribute("size");return}let t=this.card.shadowRoot,r=t.querySelector("footer"),o=this.card.getAttribute("size"),n=t.querySelector("footer #stock-checkbox"),i=t.querySelector(".body #stock-checkbox"),a=t.querySelector(".body");if(!o){r?.classList.remove("wide-footer"),n&&n.remove();return}let s=bt();if(r?.classList.toggle("wide-footer",!s),s&&n){i?n.remove():a.appendChild(n);return}!s&&i&&(n?i.remove():r.prepend(i))}postCardUpdateHook(){this.adaptForMobile(),this.adjustTitleWidth(),this.adjustLegal()}async adjustLegal(){if(this.legal)return;await this.card.updateComplete;let t=this.card.querySelector('[slot="heading-m"]');if(!t)return;let r=t.querySelector(`${ht}[data-template="price"]`),o=r.cloneNode(!0);this.legal=o,await r.onceSettled(),r?.options&&(r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),t.appendChild(o))}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}`}};m(kt,"variantStyle",E`
        :host([variant='plans']) {
            min-height: 348px;
...
`;var tt=class extends ${constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Qs}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return x` ${this.badge}
      ...
      ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}postCardUpdateHook(){this.card.isConnected&&(bt()||this.adjustProductBodySlots(),this.adjustTitleWidth())}};m(tt,"variantStyle",E`
...
`;var Rt=class extends ${constructor(t){super(t)}getGlobalCSS(){return Js}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var si={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Ot=class extends ${constructor(t){super(t)}getGlobalCSS(){return ec}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return si}renderLayout(){return x`${this.cardImage}
            <div class="body">
...
`;document.head.appendChild(rc);var ic=new CSSStyleSheet;ic.replaceSync(":host { display: contents; }");var oc="fragment",nc="author",fo="aem-fragment",ve,hi=class{constructor(){k(this,ve,new Map)}clear(){b(this,ve).clear()}addByRequestedId(t,r){b(this,ve).set(t,r)}add(...t){t.forEach(r=>{let{id:o}=r;o&&b(this,ve).set(o,r)})}has(t){return b(this,ve).has(t)}get(t){return b(this,ve).get(t)}remove(t){b(this,ve).delete(t)}};ve=new WeakMap;var br=new hi,vr,ce,ye,$t,Mt,Oe,ne,Ee,yr,Er,pi,di=class extends HTMLElement{constructor(){super();k(this,Er);m(this,"cache",br);k(this,vr);k(this,ce,null);k(this,ye,null);k(this,$t,!1);k(this,Mt,null);k(this,Oe,null);k(this,ne);k(this,Ee);k(this,yr,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[ic]}static get observedAttributes(){return[oc,nc]}attributeChangedCallback(r,o,n){r===oc&&R(this,ne,n),r===nc&&R(this,yr,["","true"].includes(n))}connectedCallback(){if(!b(this,Ee)){if(R(this,Oe,vt(this)),R(this,vr,b(this,Oe).log.module(fo)),R(this,Mt,`${fo}:${b(this,ne)}${Se}`),performance.mark(b(this,Mt)),!b(this,ne)){le(this,Er,pi).call(this,{message:"Missing fragment id"});return}this.refresh(!1)}}async getFragmentById(r,o,n){let i=`${fo}:${o}${Vt}`,a;try{if(a=await Xr(r,{cache:"default",credentials:"omit"}),!a?.ok){let{startTime:s,duration:c}=performance.measure(i,n);throw new me("Unexpected fragment response",{response:a,startTime:s,duration:c,...b(this,Oe).duration})}return a.json()}catch{let{startTime:c,duration:l}=performance.measure(i,n);throw a||(a={url:r}),new me("Failed to fetch fragment",{response:a,startTime:c,duration:l,...b(this,Oe).duration})}}async refresh(r=!0){if(!(b(this,Ee)&&!await Promise.race([b(this,Ee),Promise.resolve(!1)])))return r&&br.remove(b(this,ne)),R(this,Ee,this.fetchData().then(()=>{let{references:o,referencesTree:n,placeholders:i}=b(this,ce)||{};return this.dispatchEvent(new CustomEvent(Ue,{detail:{...this.data,stale:b(this,$t),references:o,referencesTree:n,placeholders:i},bubbles:!0,composed:!0})),!0}).catch(o=>b(this,ce)?(br.addByRequestedId(b(this,ne),b(this,ce)),!0):(le(this,Er,pi).call(this,o),!1))),b(this,Ee)}async fetchData(){this.classList.remove("error"),R(this,ye,null);let r=br.get(b(this,ne));if(r){R(this,ce,r);return}R(this,$t,!0);let{masIOUrl:o,wcsApiKey:n,locale:i}=b(this,Oe).settings,a=`${o}/fragment?id=${b(this,ne)}&api_key=${n}&locale=${i}`;r=await this.getFragmentById(a,b(this,ne),b(this,Mt)),br.addByRequestedId(b(this,ne),r),R(this,ce,r),R(this,$t,!1)}get updateComplete(){return b(this,Ee)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return b(this,ye)?b(this,ye):(b(this,yr)?this.transformAuthorData():this.transformPublishData(),b(this,ye))}transformAuthorData(){let{fields:r,id:o,tags:n,settings:i={}}=b(this,ce);R(this,ye,r.reduce((a,{name:s,multiple:c,values:l})=>(a.fields[s]=c?l:l[0],a),{fields:{},id:o,tags:n,settings:i}))}transformPublishData(){let{fields:r,id:o,tags:n,settings:i={}}=b(this,ce);R(this,ye,Object.entries(r).reduce((a,[s,c])=>(a.fields[s]=c?.mimeType?c.value:c??"",a),{fields:{},id:o,tags:n,settings:i}))}};vr=new WeakMap,ce=new WeakMap,ye=new WeakMap,$t=new WeakMap,Mt=new WeakMap,Oe=new WeakMap,ne=new WeakMap,Ee=new WeakMap,yr=new WeakMap,Er=new WeakSet,pi=function({message:r,context:o}){this.classList.add("error"),b(this,vr).error(`aem-fragment: ${r}`,o),this.dispatchEvent(new CustomEvent(De,{detail:{message:r,...o},bubbles:!0,composed:!0}))};customElements.define(fo,di);var Nt=class extends I{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor=""}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.variant==="plans"&&this.style.setProperty("border-right","none"),super.connectedCallback()}render(){return x`<div class="plans-badge">
    ...
    `);customElements.define("merch-badge",Nt);var Ar=class extends I{constructor(){super()}render(){return x`
            <slot name="icon"></slot>
