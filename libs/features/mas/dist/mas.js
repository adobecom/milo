...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return va}setAriaExpanded(r,n){r.setAttribute("aria-expanded",n)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};p(ft,"variantStyle",w`
...
`;var Hr=class extends k{constructor(t){super(t)}getGlobalCSS(){return Aa}renderLayout(){return x`${this.cardImage}
    <div class="body">
...
`;var Dr=class extends k{constructor(t){super(t)}getGlobalCSS(){return Ea}renderLayout(){return x` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var Kc=32,gt=class extends k{constructor(r){super(r);p(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);p(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){pt()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};p(gt,"variantStyle",w`
...
`;var Ke=class extends k{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Ta}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return x` ${this.badge}
      ...
      ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}postCardUpdateHook(){this.card.isConnected&&(pt()||this.adjustProductBodySlots(),this.adjustTitleWidth())}};p(Ke,"variantStyle",w`
...
`;var bt=class extends k{constructor(t){super(t)}getGlobalCSS(){return wa}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var bi={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},vt=class extends k{constructor(t){super(t)}getGlobalCSS(){return _a}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return bi}renderLayout(){return x`${this.cardImage}
            <div class="body">
...
`;var At=class extends k{constructor(t){super(t)}getGlobalCSS(){return La}renderLayout(){return x`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
      ...
      <footer><slot name="footer"></slot></footer>`}};p(At,"variantStyle",w`
    :host([variant='twp']) {
      padding: 4px 10px 5px 10px;
    }
    .twp-badge {
...
`;var vi={backgroundImage:{attribute:"background-image"},badge:!0,ctas:{slot:"cta",size:"M"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"p",slot:"price"},size:[],subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"}},Et=class extends k{getGlobalCSS(){return Pa}get aemFragmentMapping(){return vi}get stripStyle(){return this.card.backgroundImage?`
        ...
        `:""}renderLayout(){return x` <div style="${this.stripStyle}" class="body">
            ...
            <slot></slot>`}postCardUpdateHook(t){t.has("backgroundImage")&&this.styleBackgroundImage()}styleBackgroundImage(){if(this.card.classList.remove("thin-strip"),this.card.classList.remove("wide-strip"),!this.card.backgroundImage)return;let t=new Image;t.src=this.card.backgroundImage,t.onload=()=>{t.width>8?this.card.classList.add("wide-strip"):t.width===8&&this.card.classList.add("thin-strip")}}};p(Et,"variantStyle",w`
...
`;var Ai={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},yt=class extends k{getGlobalCSS(){return Ca}get aemFragmentMapping(){return Ai}renderLayout(){return x` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;var Ei={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color"},allowedColors:{gray:"--spectrum-gray-100"},size:["single","double","triple"]},Ye=class extends k{getGlobalCSS(){return ka}get aemFragmentMapping(){return Ei}renderLayout(){return x`
  ...
  `);customElements.define("ah-try-buy-widget",Ye);var yi=(e,t=!1)=>{switch(e.variant){case"catalog":return new ft(e);case"image":return new Hr(e);case"inline-heading":return new Dr(e);case"mini-compare-chart":return new gt(e);case"plans":return new xt(e);case"product":return new Ke(e);case"segment":return new bt(e);case"special-offers":return new vt(e);case"twp":return new At(e);case"ccd-suggested":return new Et(e);case"ccd-slice":return new yt(e);case"ah-try-buy-widget":return new Ye(e);default:return t?void 0:new Ke(e)}},Ia={catalog:gi,image:null,"inline-heading":null,"mini-compare-chart":null,plans:xi,product:null,segment:null,"special-offers":bi,twp:null,"ccd-suggested":vi,"ccd-slice":Ai,"ah-try-buy-widget":Ei},Na=()=>{let e=[];return e.push(ft.variantStyle),e.push(gt.variantStyle),e.push(Ke.variantStyle),e.push(xt.variantStyle),e.push(bt.variantStyle),e.push(vt.variantStyle),e.push(At.variantStyle),e.push(Et.variantStyle),e.push(yt.variantStyle),e.push(Ye.variantStyle),e};var Ra=document.createElement("style");Ra.innerHTML=`
:root {
...
`;document.head.appendChild(Ra);var Si;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(Si||(Si={}));var D;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(D||(D={}));var R;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(R||(R={}));var Ti;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(Ti||(Ti={}));var wi;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(wi||(wi={}));var _i;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(_i||(_i={}));var Li;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(Li||(Li={}));var Ma="tacocat.js";var Br=(e,t)=>String(e??"").toLowerCase()==String(t??"").toLowerCase(),Oa=e=>`${e??""}`.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t]??t)??"";function O(e,t={},{metadata:r=!0,search:n=!0,storage:i=!0}={}){let o;if(n&&o==null){let a=new URLSearchParams(window.location.search),s=St(n)?n:e;o=a.get(s)}if(i&&o==null){let a=St(i)?i:e;o=window.sessionStorage.getItem(a)??window.localStorage.getItem(a)}if(r&&o==null){let a=Yc(St(r)?r:e);o=document.documentElement.querySelector(`meta[name="${a}"]`)?.content}return o??t[e]}var Tt=()=>{};var $a=e=>typeof e=="boolean",Jt=e=>typeof e=="function",Gr=e=>typeof e=="number",Va=e=>e!=null&&typeof e=="object";var St=e=>typeof e=="string",Pi=e=>St(e)&&e,wt=e=>Gr(e)&&Number.isFinite(e)&&e>0;function _t(e,t=r=>r==null||r===""){return e!=null&&Object.entries(e).forEach(([r,n])=>{t(n)&&delete e[r]}),e}function E(e,t){if($a(e))return e;let r=String(e);return r==="1"||r==="true"?!0:r==="0"||r==="false"?!1:t}function we(e,t,r){let n=Object.values(t);return n.find(i=>Br(i,e))??r??n[0]}function Yc(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,r,n)=>`${r}-${n}`).replace(/\W+/gu,"-").toLowerCase()}function Ci(e,t=1){return Gr(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:t}var jc=Date.now(),ki=()=>`(+${Date.now()-jc}ms)`,zr=new Set,Xc=E(O("tacocat.debug",{},{metadata:!1}),typeof process<"u"&&process.env?.DEBUG);function Ua(e){let t=`[${Ma}/${e}]`,r=(a,s,...c)=>a?!0:(i(s,...c),!1),n=Xc?(a,...s)=>{console.debug(`${t} ${a}`,...s,ki())}:()=>{},i=(a,...s)=>{let c=`${t} ${a}`;zr.forEach(([l])=>l(c,...s))};return{assert:r,debug:n,error:i,warn:(a,...s)=>{let c=`${t} ${a}`;zr.forEach(([,l])=>l(c,...s))}}}function qc(e,t){let r=[e,t];return zr.add(r),()=>{zr.delete(r)}}qc((e,...t)=>{console.error(e,...t,ki())},(e,...t)=>{console.warn(e,...t,ki())});var Wc="no promo",Ha="promo-tag",Zc="yellow",Qc="neutral",Jc=(e,t,r)=>{let n=o=>o||Wc,i=r?` (was "${n(t)}")`:"";return`${n(e)}${i}`},el="cancel-context",er=(e,t)=>{let r=e===el,n=!r&&e?.length>0,i=(n||r)&&(t&&t!=e||!t&&!r),o=i&&n||!i&&!!t,a=o?e||t:void 0;return{effectivePromoCode:a,overridenPromoCode:e,className:o?Ha:`${Ha} no-promo`,text:Jc(a,t,i),variant:o?Zc:Qc,isOverriden:i}};var Ii="ABM",Ni="PUF",Ri="M2M",Mi="PERPETUAL",Oi="P3Y",tl="TAX_INCLUSIVE_DETAILS",rl="TAX_EXCLUSIVE",Da={ABM:Ii,PUF:Ni,M2M:Ri,PERPETUAL:Mi,P3Y:Oi},Um={[Ii]:{commitment:D.YEAR,term:R.MONTHLY},[Ni]:{commitment:D.YEAR,term:R.ANNUAL},[Ri]:{commitment:D.MONTH,term:R.MONTHLY},[Mi]:{commitment:D.PERPETUAL,term:void 0},[Oi]:{commitment:D.THREE_MONTHS,term:R.P3Y}},Ba="Value is not an offer",Fr=e=>{if(typeof e!="object")return Ba;let{commitment:t,term:r}=e,n=nl(t,r);return{...e,planType:n}};var nl=(e,t)=>{switch(e){case void 0:return Ba;case"":return"";case D.YEAR:return t===R.MONTHLY?Ii:t===R.ANNUAL?Ni:"";case D.MONTH:return t===R.MONTHLY?Ri:"";case D.PERPETUAL:return Mi;case D.TERM_LICENSE:return t===R.P3Y?Oi:"";default:return""}};function $i(e){let{priceDetails:t}=e,{price:r,priceWithoutDiscount:n,priceWithoutTax:i,priceWithoutDiscountAndTax:o,taxDisplay:a}=t;if(a!==tl)return e;let s={...e,priceDetails:{...t,price:i??r,priceWithoutDiscount:o??n,taxDisplay:rl}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var Vi=function(e,t){return Vi=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(r,n){r.__proto__=n}||function(r,n){for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(r[i]=n[i])},Vi(e,t)};function tr(e,t){if(typeof t!="function"&&t!==null)throw new TypeError("Class extends value "+String(t)+" is not a constructor or null");Vi(e,t);function r(){this.constructor=e}e.prototype=t===null?Object.create(t):(r.prototype=t.prototype,new r)}var y=function(){return y=Object.assign||function(t){for(var r,n=1,i=arguments.length;n<i;n++){r=arguments[n];for(var o in r)Object.prototype.hasOwnProperty.call(r,o)&&(t[o]=r[o])}return t},y.apply(this,arguments)};function Kr(e,t,r){if(r||arguments.length===2)for(var n=0,i=t.length,o;n<i;n++)(o||!(n in t))&&(o||(o=Array.prototype.slice.call(t,0,n)),o[n]=t[n]);return e.concat(o||Array.prototype.slice.call(t))}var A;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(A||(A={}));var I;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(I||(I={}));var je;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(je||(je={}));function Ui(e){return e.type===I.literal}function Ga(e){return e.type===I.argument}function Yr(e){return e.type===I.number}function jr(e){return e.type===I.date}function Xr(e){return e.type===I.time}function qr(e){return e.type===I.select}function Wr(e){return e.type===I.plural}function za(e){return e.type===I.pound}function Zr(e){return e.type===I.tag}function Qr(e){return!!(e&&typeof e=="object"&&e.type===je.number)}function rr(e){return!!(e&&typeof e=="object"&&e.type===je.dateTime)}var Hi=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var il=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function Fa(e){var t={};return e.replace(il,function(r){var n=r.length;switch(r[0]){case"G":t.era=n===4?"long":n===5?"narrow":"short";break;case"y":t.year=n===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":t.month=["numeric","2-digit","short","long","narrow"][n-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":t.day=["numeric","2-digit"][n-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":t.weekday=n===4?"short":n===5?"narrow":"short";break;case"e":if(n<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][n-4];break;case"c":if(n<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][n-4];break;case"a":t.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":t.hourCycle="h12",t.hour=["numeric","2-digit"][n-1];break;case"H":t.hourCycle="h23",t.hour=["numeric","2-digit"][n-1];break;case"K":t.hourCycle="h11",t.hour=["numeric","2-digit"][n-1];break;case"k":t.hourCycle="h24",t.hour=["numeric","2-digit"][n-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":t.minute=["numeric","2-digit"][n-1];break;case"s":t.second=["numeric","2-digit"][n-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":t.timeZoneName=n<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),t}var Ka=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function qa(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var t=e.split(Ka).filter(function(d){return d.length>0}),r=[],n=0,i=t;n<i.length;n++){var o=i[n],a=o.split("/");if(a.length===0)throw new Error("Invalid number skeleton");for(var s=a[0],c=a.slice(1),l=0,h=c;l<h.length;l++){var u=h[l];if(u.length===0)throw new Error("Invalid number skeleton")}r.push({stem:s,options:c})}return r}function ol(e){return e.replace(/^(.*?)-/,"")}var Ya=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,Wa=/^(@+)?(\+|#+)?[rs]?$/g,al=/(\*)(0+)|(#+)(0+)|(0+)/g,Za=/^(0+)$/;function ja(e){var t={};return e[e.length-1]==="r"?t.roundingPriority="morePrecision":e[e.length-1]==="s"&&(t.roundingPriority="lessPrecision"),e.replace(Wa,function(r,n,i){return typeof i!="string"?(t.minimumSignificantDigits=n.length,t.maximumSignificantDigits=n.length):i==="+"?t.minimumSignificantDigits=n.length:n[0]==="#"?t.maximumSignificantDigits=n.length:(t.minimumSignificantDigits=n.length,t.maximumSignificantDigits=n.length+(typeof i=="string"?i.length:0)),""}),t}function Qa(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function sl(e){var t;if(e[0]==="E"&&e[1]==="E"?(t={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(t={notation:"scientific"},e=e.slice(1)),t){var r=e.slice(0,2);if(r==="+!"?(t.signDisplay="always",e=e.slice(2)):r==="+?"&&(t.signDisplay="exceptZero",e=e.slice(2)),!Za.test(e))throw new Error("Malformed concise eng/scientific notation");t.minimumIntegerDigits=e.length}return t}function Xa(e){var t={},r=Qa(e);return r||t}function Ja(e){for(var t={},r=0,n=e;r<n.length;r++){var i=n[r];switch(i.stem){case"percent":case"%":t.style="percent";continue;case"%x100":t.style="percent",t.scale=100;continue;case"currency":t.style="currency",t.currency=i.options[0];continue;case"group-off":case",_":t.useGrouping=!1;continue;case"precision-integer":case".":t.maximumFractionDigits=0;continue;case"measure-unit":case"unit":t.style="unit",t.unit=ol(i.options[0]);continue;case"compact-short":case"K":t.notation="compact",t.compactDisplay="short";continue;case"compact-long":case"KK":t.notation="compact",t.compactDisplay="long";continue;case"scientific":t=y(y(y({},t),{notation:"scientific"}),i.options.reduce(function(c,l){return y(y({},c),Xa(l))},{}));continue;case"engineering":t=y(y(y({},t),{notation:"engineering"}),i.options.reduce(function(c,l){return y(y({},c),Xa(l))},{}));continue;case"notation-simple":t.notation="standard";continue;case"unit-width-narrow":t.currencyDisplay="narrowSymbol",t.unitDisplay="narrow";continue;case"unit-width-short":t.currencyDisplay="code",t.unitDisplay="short";continue;case"unit-width-full-name":t.currencyDisplay="name",t.unitDisplay="long";continue;case"unit-width-iso-code":t.currencyDisplay="symbol";continue;case"scale":t.scale=parseFloat(i.options[0]);continue;case"integer-width":if(i.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");i.options[0].replace(al,function(c,l,h,u,d,m){if(l)t.minimumIntegerDigits=h.length;else{if(u&&d)throw new Error("We currently do not support maximum integer digits");if(m)throw new Error("We currently do not support exact integer digits")}return""});continue}if(Za.test(i.stem)){t.minimumIntegerDigits=i.stem.length;continue}if(Ya.test(i.stem)){if(i.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");i.stem.replace(Ya,function(c,l,h,u,d,m){return h==="*"?t.minimumFractionDigits=l.length:u&&u[0]==="#"?t.maximumFractionDigits=u.length:d&&m?(t.minimumFractionDigits=d.length,t.maximumFractionDigits=d.length+m.length):(t.minimumFractionDigits=l.length,t.maximumFractionDigits=l.length),""});var o=i.options[0];o==="w"?t=y(y({},t),{trailingZeroDisplay:"stripIfInteger"}):o&&(t=y(y({},t),ja(o)));continue}if(Wa.test(i.stem)){t=y(y({},t),ja(i.stem));continue}var a=Qa(i.stem);a&&(t=y(y({},t),a));var s=sl(i.stem);s&&(t=y(y({},t),s))}return t}var nr={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function es(e,t){for(var r="",n=0;n<e.length;n++){var i=e.charAt(n);if(i==="j"){for(var o=0;n+1<e.length&&e.charAt(n+1)===i;)o++,n++;var a=1+(o&1),s=o<2?1:3+(o>>1),c="a",l=cl(t);for((l=="H"||l=="k")&&(s=0);s-- >0;)r+=c;for(;a-- >0;)r=l+r}else i==="J"?r+="H":r+=i}return r}function cl(e){var t=e.hourCycle;if(t===void 0&&e.hourCycles&&e.hourCycles.length&&(t=e.hourCycles[0]),t)switch(t){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var r=e.language,n;r!=="root"&&(n=e.maximize().region);var i=nr[n||""]||nr[r||""]||nr["".concat(r,"-001")]||nr["001"];return i[0]}var Di,ll=new RegExp("^".concat(Hi.source,"*")),hl=new RegExp("".concat(Hi.source,"*$"));function S(e,t){return{start:e,end:t}}var dl=!!String.prototype.startsWith,ul=!!String.fromCodePoint,ml=!!Object.fromEntries,pl=!!String.prototype.codePointAt,fl=!!String.prototype.trimStart,gl=!!String.prototype.trimEnd,xl=!!Number.isSafeInteger,bl=xl?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},Gi=!0;try{ts=os("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Gi=((Di=ts.exec("a"))===null||Di===void 0?void 0:Di[0])==="a"}catch{Gi=!1}var ts,rs=dl?function(t,r,n){return t.startsWith(r,n)}:function(t,r,n){return t.slice(n,n+r.length)===r},zi=ul?String.fromCodePoint:function(){for(var t=[],r=0;r<arguments.length;r++)t[r]=arguments[r];for(var n="",i=t.length,o=0,a;i>o;){if(a=t[o++],a>1114111)throw RangeError(a+" is not a valid code point");n+=a<65536?String.fromCharCode(a):String.fromCharCode(((a-=65536)>>10)+55296,a%1024+56320)}return n},ns=ml?Object.fromEntries:function(t){for(var r={},n=0,i=t;n<i.length;n++){var o=i[n],a=o[0],s=o[1];r[a]=s}return r},is=pl?function(t,r){return t.codePointAt(r)}:function(t,r){var n=t.length;if(!(r<0||r>=n)){var i=t.charCodeAt(r),o;return i<55296||i>56319||r+1===n||(o=t.charCodeAt(r+1))<56320||o>57343?i:(i-55296<<10)+(o-56320)+65536}},vl=fl?function(t){return t.trimStart()}:function(t){return t.replace(ll,"")},Al=gl?function(t){return t.trimEnd()}:function(t){return t.replace(hl,"")};function os(e,t){return new RegExp(e,t)}var Fi;Gi?(Bi=os("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Fi=function(t,r){var n;Bi.lastIndex=r;var i=Bi.exec(t);return(n=i[1])!==null&&n!==void 0?n:""}):Fi=function(t,r){for(var n=[];;){var i=is(t,r);if(i===void 0||ss(i)||Sl(i))break;n.push(i),r+=i>=65536?2:1}return zi.apply(void 0,n)};var Bi,as=function(){function e(t,r){r===void 0&&(r={}),this.message=t,this.position={offset:0,line:1,column:1},this.ignoreTag=!!r.ignoreTag,this.locale=r.locale,this.requiresOtherClause=!!r.requiresOtherClause,this.shouldParseSkeletons=!!r.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(t,r,n){for(var i=[];!this.isEOF();){var o=this.char();if(o===123){var a=this.parseArgument(t,n);if(a.err)return a;i.push(a.val)}else{if(o===125&&t>0)break;if(o===35&&(r==="plural"||r==="selectordinal")){var s=this.clonePosition();this.bump(),i.push({type:I.pound,location:S(s,this.clonePosition())})}else if(o===60&&!this.ignoreTag&&this.peek()===47){if(n)break;return this.error(A.UNMATCHED_CLOSING_TAG,S(this.clonePosition(),this.clonePosition()))}else if(o===60&&!this.ignoreTag&&Ki(this.peek()||0)){var a=this.parseTag(t,r);if(a.err)return a;i.push(a.val)}else{var a=this.parseLiteral(t,r);if(a.err)return a;i.push(a.val)}}}return{val:i,err:null}},e.prototype.parseTag=function(t,r){var n=this.clonePosition();this.bump();var i=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:I.literal,value:"<".concat(i,"/>"),location:S(n,this.clonePosition())},err:null};if(this.bumpIf(">")){var o=this.parseMessage(t+1,r,!0);if(o.err)return o;var a=o.val,s=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!Ki(this.char()))return this.error(A.INVALID_TAG,S(s,this.clonePosition()));var c=this.clonePosition(),l=this.parseTagName();return i!==l?this.error(A.UNMATCHED_CLOSING_TAG,S(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:I.tag,value:i,children:a,location:S(n,this.clonePosition())},err:null}:this.error(A.INVALID_TAG,S(s,this.clonePosition())))}else return this.error(A.UNCLOSED_TAG,S(n,this.clonePosition()))}else return this.error(A.INVALID_TAG,S(n,this.clonePosition()))},e.prototype.parseTagName=function(){var t=this.offset();for(this.bump();!this.isEOF()&&yl(this.char());)this.bump();return this.message.slice(t,this.offset())},e.prototype.parseLiteral=function(t,r){for(var n=this.clonePosition(),i="";;){var o=this.tryParseQuote(r);if(o){i+=o;continue}var a=this.tryParseUnquoted(t,r);if(a){i+=a;continue}var s=this.tryParseLeftAngleBracket();if(s){i+=s;continue}break}var c=S(n,this.clonePosition());return{val:{type:I.literal,value:i,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!El(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(t){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(t==="plural"||t==="selectordinal")break;return null;default:return null}this.bump();var r=[this.char()];for(this.bump();!this.isEOF();){var n=this.char();if(n===39)if(this.peek()===39)r.push(39),this.bump();else{this.bump();break}else r.push(n);this.bump()}return zi.apply(void 0,r)},e.prototype.tryParseUnquoted=function(t,r){if(this.isEOF())return null;var n=this.char();return n===60||n===123||n===35&&(r==="plural"||r==="selectordinal")||n===125&&t>0?null:(this.bump(),zi(n))},e.prototype.parseArgument=function(t,r){var n=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(A.EXPECT_ARGUMENT_CLOSING_BRACE,S(n,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(A.EMPTY_ARGUMENT,S(n,this.clonePosition()));var i=this.parseIdentifierIfPossible().value;if(!i)return this.error(A.MALFORMED_ARGUMENT,S(n,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(A.EXPECT_ARGUMENT_CLOSING_BRACE,S(n,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:I.argument,value:i,location:S(n,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(A.EXPECT_ARGUMENT_CLOSING_BRACE,S(n,this.clonePosition())):this.parseArgumentOptions(t,r,i,n);default:return this.error(A.MALFORMED_ARGUMENT,S(n,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var t=this.clonePosition(),r=this.offset(),n=Fi(this.message,r),i=r+n.length;this.bumpTo(i);var o=this.clonePosition(),a=S(t,o);return{value:n,location:a}},e.prototype.parseArgumentOptions=function(t,r,n,i){var o,a=this.clonePosition(),s=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(s){case"":return this.error(A.EXPECT_ARGUMENT_TYPE,S(a,c));case"number":case"date":case"time":{this.bumpSpace();var l=null;if(this.bumpIf(",")){this.bumpSpace();var h=this.clonePosition(),u=this.parseSimpleArgStyleIfPossible();if(u.err)return u;var d=Al(u.val);if(d.length===0)return this.error(A.EXPECT_ARGUMENT_STYLE,S(this.clonePosition(),this.clonePosition()));var m=S(h,this.clonePosition());l={style:d,styleLocation:m}}var g=this.tryParseArgumentClose(i);if(g.err)return g;var f=S(i,this.clonePosition());if(l&&rs(l?.style,"::",0)){var b=vl(l.style.slice(2));if(s==="number"){var u=this.parseNumberSkeletonFromString(b,l.styleLocation);return u.err?u:{val:{type:I.number,value:n,location:f,style:u.val},err:null}}else{if(b.length===0)return this.error(A.EXPECT_DATE_TIME_SKELETON,f);var _=b;this.locale&&(_=es(b,this.locale));var d={type:je.dateTime,pattern:_,location:l.styleLocation,parsedOptions:this.shouldParseSkeletons?Fa(_):{}},L=s==="date"?I.date:I.time;return{val:{type:L,value:n,location:f,style:d},err:null}}}return{val:{type:s==="number"?I.number:s==="date"?I.date:I.time,value:n,location:f,style:(o=l?.style)!==null&&o!==void 0?o:null},err:null}}case"plural":case"selectordinal":case"select":{var T=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(A.EXPECT_SELECT_ARGUMENT_OPTIONS,S(T,y({},T)));this.bumpSpace();var C=this.parseIdentifierIfPossible(),N=0;if(s!=="select"&&C.value==="offset"){if(!this.bumpIf(":"))return this.error(A.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,S(this.clonePosition(),this.clonePosition()));this.bumpSpace();var u=this.tryParseDecimalInteger(A.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,A.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(u.err)return u;this.bumpSpace(),C=this.parseIdentifierIfPossible(),N=u.val}var U=this.tryParsePluralOrSelectOptions(t,s,r,C);if(U.err)return U;var g=this.tryParseArgumentClose(i);if(g.err)return g;var X=S(i,this.clonePosition());return s==="select"?{val:{type:I.select,value:n,options:ns(U.val),location:X},err:null}:{val:{type:I.plural,value:n,options:ns(U.val),offset:N,pluralType:s==="plural"?"cardinal":"ordinal",location:X},err:null}}default:return this.error(A.INVALID_ARGUMENT_TYPE,S(a,c))}},e.prototype.tryParseArgumentClose=function(t){return this.isEOF()||this.char()!==125?this.error(A.EXPECT_ARGUMENT_CLOSING_BRACE,S(t,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var t=0,r=this.clonePosition();!this.isEOF();){var n=this.char();switch(n){case 39:{this.bump();var i=this.clonePosition();if(!this.bumpUntil("'"))return this.error(A.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,S(i,this.clonePosition()));this.bump();break}case 123:{t+=1,this.bump();break}case 125:{if(t>0)t-=1;else return{val:this.message.slice(r.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(r.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(t,r){var n=[];try{n=qa(t)}catch{return this.error(A.INVALID_NUMBER_SKELETON,r)}return{val:{type:je.number,tokens:n,location:r,parsedOptions:this.shouldParseSkeletons?Ja(n):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(t,r,n,i){for(var o,a=!1,s=[],c=new Set,l=i.value,h=i.location;;){if(l.length===0){var u=this.clonePosition();if(r!=="select"&&this.bumpIf("=")){var d=this.tryParseDecimalInteger(A.EXPECT_PLURAL_ARGUMENT_SELECTOR,A.INVALID_PLURAL_ARGUMENT_SELECTOR);if(d.err)return d;h=S(u,this.clonePosition()),l=this.message.slice(u.offset,this.offset())}else break}if(c.has(l))return this.error(r==="select"?A.DUPLICATE_SELECT_ARGUMENT_SELECTOR:A.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,h);l==="other"&&(a=!0),this.bumpSpace();var m=this.clonePosition();if(!this.bumpIf("{"))return this.error(r==="select"?A.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:A.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,S(this.clonePosition(),this.clonePosition()));var g=this.parseMessage(t+1,r,n);if(g.err)return g;var f=this.tryParseArgumentClose(m);if(f.err)return f;s.push([l,{value:g.val,location:S(m,this.clonePosition())}]),c.add(l),this.bumpSpace(),o=this.parseIdentifierIfPossible(),l=o.value,h=o.location}return s.length===0?this.error(r==="select"?A.EXPECT_SELECT_ARGUMENT_SELECTOR:A.EXPECT_PLURAL_ARGUMENT_SELECTOR,S(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!a?this.error(A.MISSING_OTHER_CLAUSE,S(this.clonePosition(),this.clonePosition())):{val:s,err:null}},e.prototype.tryParseDecimalInteger=function(t,r){var n=1,i=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(n=-1);for(var o=!1,a=0;!this.isEOF();){var s=this.char();if(s>=48&&s<=57)o=!0,a=a*10+(s-48),this.bump();else break}var c=S(i,this.clonePosition());return o?(a*=n,bl(a)?{val:a,err:null}:this.error(r,c)):this.error(t,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var t=this.position.offset;if(t>=this.message.length)throw Error("out of bound");var r=is(this.message,t);if(r===void 0)throw Error("Offset ".concat(t," is at invalid UTF-16 code unit boundary"));return r},e.prototype.error=function(t,r){return{val:null,err:{kind:t,message:this.message,location:r}}},e.prototype.bump=function(){if(!this.isEOF()){var t=this.char();t===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=t<65536?1:2)}},e.prototype.bumpIf=function(t){if(rs(this.message,t,this.offset())){for(var r=0;r<t.length;r++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(t){var r=this.offset(),n=this.message.indexOf(t,r);return n>=0?(this.bumpTo(n),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(t){if(this.offset()>t)throw Error("targetOffset ".concat(t," must be greater than or equal to the current offset ").concat(this.offset()));for(t=Math.min(t,this.message.length);;){var r=this.offset();if(r===t)break;if(r>t)throw Error("targetOffset ".concat(t," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&ss(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var t=this.char(),r=this.offset(),n=this.message.charCodeAt(r+(t>=65536?2:1));return n??null},e}();function Ki(e){return e>=97&&e<=122||e>=65&&e<=90}function El(e){return Ki(e)||e===47}function yl(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function ss(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function Sl(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function Yi(e){e.forEach(function(t){if(delete t.location,qr(t)||Wr(t))for(var r in t.options)delete t.options[r].location,Yi(t.options[r].value);else Yr(t)&&Qr(t.style)||(jr(t)||Xr(t))&&rr(t.style)?delete t.style.location:Zr(t)&&Yi(t.children)})}function cs(e,t){t===void 0&&(t={}),t=y({shouldParseSkeletons:!0,requiresOtherClause:!0},t);var r=new as(e,t).parse();if(r.err){var n=SyntaxError(A[r.err.kind]);throw n.location=r.err.location,n.originalMessage=r.err.message,n}return t?.captureLocation||Yi(r.val),r.val}function ir(e,t){var r=t&&t.cache?t.cache:Cl,n=t&&t.serializer?t.serializer:Pl,i=t&&t.strategy?t.strategy:wl;return i(e,{cache:r,serializer:n})}function Tl(e){return e==null||typeof e=="number"||typeof e=="boolean"}function ls(e,t,r,n){var i=Tl(n)?n:r(n),o=t.get(i);return typeof o>"u"&&(o=e.call(this,n),t.set(i,o)),o}function hs(e,t,r){var n=Array.prototype.slice.call(arguments,3),i=r(n),o=t.get(i);return typeof o>"u"&&(o=e.apply(this,n),t.set(i,o)),o}function ji(e,t,r,n,i){return r.bind(t,e,n,i)}function wl(e,t){var r=e.length===1?ls:hs;return ji(e,this,r,t.cache.create(),t.serializer)}function _l(e,t){return ji(e,this,hs,t.cache.create(),t.serializer)}function Ll(e,t){return ji(e,this,ls,t.cache.create(),t.serializer)}var Pl=function(){return JSON.stringify(arguments)};function Xi(){this.cache=Object.create(null)}Xi.prototype.get=function(e){return this.cache[e]};Xi.prototype.set=function(e,t){this.cache[e]=t};var Cl={create:function(){return new Xi}},Jr={variadic:_l,monadic:Ll};var Xe;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(Xe||(Xe={}));var or=function(e){tr(t,e);function t(r,n,i){var o=e.call(this,r)||this;return o.code=n,o.originalMessage=i,o}return t.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},t}(Error);var qi=function(e){tr(t,e);function t(r,n,i,o){return e.call(this,'Invalid values for "'.concat(r,'": "').concat(n,'". Options are "').concat(Object.keys(i).join('", "'),'"'),Xe.INVALID_VALUE,o)||this}return t}(or);var ds=function(e){tr(t,e);function t(r,n,i){return e.call(this,'Value for "'.concat(r,'" must be of type ').concat(n),Xe.INVALID_VALUE,i)||this}return t}(or);var us=function(e){tr(t,e);function t(r,n){return e.call(this,'The intl string context variable "'.concat(r,'" was not provided to the string "').concat(n,'"'),Xe.MISSING_VALUE,n)||this}return t}(or);var W;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(W||(W={}));function kl(e){return e.length<2?e:e.reduce(function(t,r){var n=t[t.length-1];return!n||n.type!==W.literal||r.type!==W.literal?t.push(r):n.value+=r.value,t},[])}function Il(e){return typeof e=="function"}function ar(e,t,r,n,i,o,a){if(e.length===1&&Ui(e[0]))return[{type:W.literal,value:e[0].value}];for(var s=[],c=0,l=e;c<l.length;c++){var h=l[c];if(Ui(h)){s.push({type:W.literal,value:h.value});continue}if(za(h)){typeof o=="number"&&s.push({type:W.literal,value:r.getNumberFormat(t).format(o)});continue}var u=h.value;if(!(i&&u in i))throw new us(u,a);var d=i[u];if(Ga(h)){(!d||typeof d=="string"||typeof d=="number")&&(d=typeof d=="string"||typeof d=="number"?String(d):""),s.push({type:typeof d=="string"?W.literal:W.object,value:d});continue}if(jr(h)){var m=typeof h.style=="string"?n.date[h.style]:rr(h.style)?h.style.parsedOptions:void 0;s.push({type:W.literal,value:r.getDateTimeFormat(t,m).format(d)});continue}if(Xr(h)){var m=typeof h.style=="string"?n.time[h.style]:rr(h.style)?h.style.parsedOptions:n.time.medium;s.push({type:W.literal,value:r.getDateTimeFormat(t,m).format(d)});continue}if(Yr(h)){var m=typeof h.style=="string"?n.number[h.style]:Qr(h.style)?h.style.parsedOptions:void 0;m&&m.scale&&(d=d*(m.scale||1)),s.push({type:W.literal,value:r.getNumberFormat(t,m).format(d)});continue}if(Zr(h)){var g=h.children,f=h.value,b=i[f];if(!Il(b))throw new ds(f,"function",a);var _=ar(g,t,r,n,i,o),L=b(_.map(function(N){return N.value}));Array.isArray(L)||(L=[L]),s.push.apply(s,L.map(function(N){return{type:typeof N=="string"?W.literal:W.object,value:N}}))}if(qr(h)){var T=h.options[d]||h.options.other;if(!T)throw new qi(h.value,d,Object.keys(h.options),a);s.push.apply(s,ar(T.value,t,r,n,i));continue}if(Wr(h)){var T=h.options["=".concat(d)];if(!T){if(!Intl.PluralRules)throw new or(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,Xe.MISSING_INTL_API,a);var C=r.getPluralRules(t,{type:h.pluralType}).select(d-(h.offset||0));T=h.options[C]||h.options.other}if(!T)throw new qi(h.value,d,Object.keys(h.options),a);s.push.apply(s,ar(T.value,t,r,n,i,d-(h.offset||0)));continue}}return kl(s)}function Nl(e,t){return t?y(y(y({},e||{}),t||{}),Object.keys(e).reduce(function(r,n){return r[n]=y(y({},e[n]),t[n]||{}),r},{})):e}function Rl(e,t){return t?Object.keys(e).reduce(function(r,n){return r[n]=Nl(e[n],t[n]),r},y({},e)):e}function Wi(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function Ml(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:ir(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.NumberFormat).bind.apply(t,Kr([void 0],r,!1)))},{cache:Wi(e.number),strategy:Jr.variadic}),getDateTimeFormat:ir(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.DateTimeFormat).bind.apply(t,Kr([void 0],r,!1)))},{cache:Wi(e.dateTime),strategy:Jr.variadic}),getPluralRules:ir(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.PluralRules).bind.apply(t,Kr([void 0],r,!1)))},{cache:Wi(e.pluralRules),strategy:Jr.variadic})}}var ms=function(){function e(t,r,n,i){var o=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(a){var s=o.formatToParts(a);if(s.length===1)return s[0].value;var c=s.reduce(function(l,h){return!l.length||h.type!==W.literal||typeof l[l.length-1]!="string"?l.push(h.value):l[l.length-1]+=h.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(a){return ar(o.ast,o.locales,o.formatters,o.formats,a,void 0,o.message)},this.resolvedOptions=function(){return{locale:o.resolvedLocale.toString()}},this.getAst=function(){return o.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Rl(e.formats,n),this.formatters=i&&i.formatters||Ml(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=cs,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var ps=ms;var Ol=/[0-9\-+#]/,$l=/[^\d\-+#]/g;function fs(e){return e.search(Ol)}function Vl(e="#.##"){let t={},r=e.length,n=fs(e);t.prefix=n>0?e.substring(0,n):"";let i=fs(e.split("").reverse().join("")),o=r-i,a=e.substring(o,o+1),s=o+(a==="."||a===","?1:0);t.suffix=i>0?e.substring(s,r):"",t.mask=e.substring(n,s),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let c=t.mask.match($l);return t.decimal=c&&c[c.length-1]||".",t.separator=c&&c[1]&&c[0]||",",c=t.mask.split(t.decimal),t.integer=c[0],t.fraction=c[1],t}function Ul(e,t,r){let n=!1,i={value:e};e<0&&(n=!0,i.value=-i.value),i.sign=n?"-":"",i.value=Number(i.value).toFixed(t.fraction&&t.fraction.length),i.value=Number(i.value).toString();let o=t.fraction&&t.fraction.lastIndexOf("0"),[a="0",s=""]=i.value.split(".");return(!s||s&&s.length<=o)&&(s=o<0?"":(+("0."+s)).toFixed(o+1).replace("0.","")),i.integer=a,i.fraction=s,Hl(i,t),(i.result==="0"||i.result==="")&&(n=!1,i.sign=""),!n&&t.maskHasPositiveSign?i.sign="+":n&&t.maskHasPositiveSign?i.sign="-":n&&(i.sign=r&&r.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),i}function Hl(e,t){e.result="";let r=t.integer.split(t.separator),n=r.join(""),i=n&&n.indexOf("0");if(i>-1)for(;e.integer.length<n.length-i;)e.integer="0"+e.integer;else Number(e.integer)===0&&(e.integer="");let o=r[1]&&r[r.length-1].length;if(o){let a=e.integer.length,s=a%o;for(let c=0;c<a;c++)e.result+=e.integer.charAt(c),!((c-s+1)%o)&&c<a-o&&(e.result+=t.separator)}else e.result=e.integer;return e.result+=t.fraction&&e.fraction?t.decimal+e.fraction:"",e}function Dl(e,t,r={}){if(!e||isNaN(Number(t)))return t;let n=Vl(e),i=Ul(t,n,r);return n.prefix+i.sign+i.result+n.suffix}var gs=Dl;var xs=".",Bl=",",vs=/^\s+/,As=/\s+$/,bs="&nbsp;",Zi=e=>e*12,Es=(e,t)=>{let{start:r,end:n,displaySummary:{amount:i,duration:o,minProductQuantity:a,outcomeType:s}={}}=e;if(!(i&&o&&s&&a))return!1;let c=t?new Date(t):new Date;if(!r||!n)return!1;let l=new Date(r),h=new Date(n);return c>=l&&c<=h},qe={MONTH:"MONTH",YEAR:"YEAR"},Gl={[R.ANNUAL]:12,[R.MONTHLY]:1,[R.THREE_YEARS]:36,[R.TWO_YEARS]:24},Qi=(e,t)=>({accept:e,round:t}),zl=[Qi(({divisor:e,price:t})=>t%e==0,({divisor:e,price:t})=>t/e),Qi(({usePrecision:e})=>e,({divisor:e,price:t})=>Math.round(t/e*100)/100),Qi(()=>!0,({divisor:e,price:t})=>Math.ceil(Math.floor(t*100/e)/100))],Ji={[D.YEAR]:{[R.MONTHLY]:qe.MONTH,[R.ANNUAL]:qe.YEAR},[D.MONTH]:{[R.MONTHLY]:qe.MONTH}},Fl=(e,t)=>e.indexOf(`'${t}'`)===0,Kl=(e,t=!0)=>{let r=e.replace(/'.*?'/,"").trim(),n=Ss(r);return!!n?t||(r=r.replace(/[,\.]0+/,n)):r=r.replace(/\s?(#.*0)(?!\s)?/,"$&"+jl(e)),r},Yl=e=>{let t=Xl(e),r=Fl(e,t),n=e.replace(/'.*?'/,""),i=vs.test(n)||As.test(n);return{currencySymbol:t,isCurrencyFirst:r,hasCurrencySpace:i}},ys=e=>e.replace(vs,bs).replace(As,bs),jl=e=>e.match(/#(.?)#/)?.[1]===xs?Bl:xs,Xl=e=>e.match(/'(.*?)'/)?.[1]??"",Ss=e=>e.match(/0(.?)0/)?.[1]??"";function Lt({formatString:e,price:t,usePrecision:r,isIndianPrice:n=!1},i,o=a=>a){let{currencySymbol:a,isCurrencyFirst:s,hasCurrencySpace:c}=Yl(e),l=r?Ss(e):"",h=Kl(e,r),u=r?2:0,d=o(t,{currencySymbol:a}),m=n?d.toLocaleString("hi-IN",{minimumFractionDigits:u,maximumFractionDigits:u}):gs(h,d),g=r?m.lastIndexOf(l):m.length,f=m.substring(0,g),b=m.substring(g+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,m).replace(/SYMBOL/,a),currencySymbol:a,decimals:b,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:i}}var Ts=e=>{let{commitment:t,term:r,usePrecision:n}=e,i=Gl[r]??1;return Lt(e,i>1?qe.MONTH:Ji[t]?.[r],o=>{let a={divisor:i,price:o,usePrecision:n},{round:s}=zl.find(({accept:c})=>c(a));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(a)}`);return s(a)})},ws=({commitment:e,term:t,...r})=>Lt(r,Ji[e]?.[t]),_s=e=>{let{commitment:t,instant:r,price:n,originalPrice:i,priceWithoutDiscount:o,promotion:a,quantity:s=1,term:c}=e;if(t===D.YEAR&&c===R.MONTHLY){if(!a)return Lt(e,qe.YEAR,Zi);let{displaySummary:{outcomeType:l,duration:h,minProductQuantity:u=1}={}}=a;switch(l){case"PERCENTAGE_DISCOUNT":if(s>=u&&Es(a,r)){let d=parseInt(h.replace("P","").replace("M",""));if(isNaN(d))return Zi(n);let m=s*i*d,g=s*o*(12-d),f=Math.floor((m+g)*100)/100;return Lt({...e,price:f},qe.YEAR)}default:return Lt(e,qe.YEAR,()=>Zi(o??n))}}return Lt(e,Ji[t]?.[c])};var ql={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at"},Wl=Ua("ConsonantTemplates/price"),Zl=/<\/?[^>]+(>|$)/g,F={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Pt={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},Ql="TAX_EXCLUSIVE",Jl=e=>Va(e)?Object.entries(e).filter(([,t])=>St(t)||Gr(t)||t===!0).reduce((t,[r,n])=>t+` ${r}${n===!0?"":'="'+Oa(n)+'"'}`,""):"",Z=(e,t,r,n=!1)=>`<span class="${e}${t?"":" "+F.disabled}"${Jl(r)}>${n?ys(t):t??""}</span>`;function eh(e,{accessibleLabel:t,altAccessibleLabel:r,currencySymbol:n,decimals:i,decimalsDelimiter:o,hasCurrencySpace:a,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:h,taxInclusivityLabel:u},d={}){let m=Z(F.currencySymbol,n),g=Z(F.currencySpace,a?"&nbsp;":""),f="";return t?f=`<sr-only class="strikethrough-aria-label">${t}</sr-only>`:r&&(f=`<sr-only class="alt-aria-label">${r}</sr-only>`),c&&(f+=m+g),f+=Z(F.integer,s),f+=Z(F.decimalsDelimiter,o),f+=Z(F.decimals,i),c||(f+=g+m),f+=Z(F.recurrence,l,null,!0),f+=Z(F.unitType,h,null,!0),f+=Z(F.taxInclusivity,u,!0),Z(e,f,{...d})}var Q=({isAlternativePrice:e=!1,displayOptical:t=!1,displayStrikethrough:r=!1,displayAnnual:n=!1,instant:i=void 0}={})=>({country:o,displayFormatted:a=!0,displayRecurrence:s=!0,displayPerUnit:c=!1,displayTax:l=!1,language:h,literals:u={},quantity:d=1}={},{commitment:m,offerSelectorIds:g,formatString:f,price:b,priceWithoutDiscount:_,taxDisplay:L,taxTerm:T,term:C,usePrecision:N,promotion:U}={},X={})=>{Object.entries({country:o,formatString:f,language:h,price:b}).forEach(([gn,xn])=>{if(xn==null)throw new Error(`Argument "${gn}" is missing for osi ${g?.toString()}, country ${o}, language ${h}`)});let K={...ql,...u},Y=`${h.toLowerCase()}-${o.toUpperCase()}`;function B(gn,xn){let bn=K[gn];if(bn==null)return"";try{return new ps(bn.replace(Zl,""),Y).format(xn)}catch{return Wl.error("Failed to format literal:",bn),""}}let le=r&&_?_:b,he=t?Ts:ws;n&&(he=_s);let{accessiblePrice:Ce,recurrenceTerm:ke,...Ie}=he({commitment:m,formatString:f,instant:i,isIndianPrice:o==="IN",originalPrice:b,priceWithoutDiscount:_,price:t?b:le,promotion:U,quantity:d,term:C,usePrecision:N}),Ne="",tt="",Vt="";E(s)&&ke&&(Vt=B(Pt.recurrenceLabel,{recurrenceTerm:ke}));let pn="";E(c)&&(pn=B(Pt.perUnitLabel,{perUnit:"LICENSE"}));let fn="";E(l)&&T&&(fn=B(L===Ql?Pt.taxExclusiveLabel:Pt.taxInclusiveLabel,{taxTerm:T})),r&&(Ne=B(Pt.strikethroughAriaLabel,{strikethroughPrice:Ne})),e&&(tt=B(Pt.alternativePriceAriaLabel,{alternativePrice:tt}));let rt=F.container;if(t&&(rt+=" "+F.containerOptical),r&&(rt+=" "+F.containerStrikethrough),e&&(rt+=" "+F.containerAlternative),n&&(rt+=" "+F.containerAnnual),E(a))return eh(rt,{...Ie,accessibleLabel:Ne,altAccessibleLabel:tt,recurrenceLabel:Vt,perUnitLabel:pn,taxInclusivityLabel:fn},X);let{currencySymbol:ko,decimals:sc,decimalsDelimiter:cc,hasCurrencySpace:Io,integer:lc,isCurrencyFirst:hc}=Ie,nt=[lc,cc,sc];hc?(nt.unshift(Io?"\xA0":""),nt.unshift(ko)):(nt.push(Io?"\xA0":""),nt.push(ko)),nt.push(Vt,pn,fn);let dc=nt.join("");return Z(rt,dc,X)},Ls=()=>(e,t,r)=>{let i=(e.displayOldPrice===void 0||E(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${Q({isAlternativePrice:i})(e,t,r)}${i?"&nbsp;"+Q({displayStrikethrough:!0})(e,t,r):""}`},Ps=()=>(e,t,r)=>{let{instant:n}=e;try{n||(n=new URLSearchParams(document.location.search).get("instant")),n&&(n=new Date(n))}catch{n=void 0}let i={...e,displayTax:!1,displayPerUnit:!1},a=(e.displayOldPrice===void 0||E(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${a?Q({displayStrikethrough:!0})(i,t,r)+"&nbsp;":""}${Q({isAlternativePrice:a})(e,t,r)}${Z(F.containerAnnualPrefix,"&nbsp;(")}${Q({displayAnnual:!0,instant:n})(i,t,r)}${Z(F.containerAnnualSuffix,")")}`},Cs=()=>(e,t,r)=>{let n={...e,displayTax:!1,displayPerUnit:!1};return`${Q({isAlternativePrice:e.displayOldPrice})(e,t,r)}${Z(F.containerAnnualPrefix,"&nbsp;(")}${Q({displayAnnual:!0})(n,t,r)}${Z(F.containerAnnualSuffix,")")}`};var eo=Q(),to=Ls(),ro=Q({displayOptical:!0}),no=Q({displayStrikethrough:!0}),io=Q({displayAnnual:!0}),oo=Q({displayOptical:!0,isAlternativePrice:!0}),ao=Q({isAlternativePrice:!0}),so=Cs(),co=Ps();var th=(e,t)=>{if(!(!wt(e)||!wt(t)))return Math.floor((t-e)/t*100)},ks=()=>(e,t)=>{let{price:r,priceWithoutDiscount:n}=t,i=th(r,n);return i===void 0?'<span class="no-discount"></span>':`<span class="discount">${i}%</span>`};var lo=ks();var{freeze:sr}=Object,rh={V2:"UCv2",V3:"UCv3"},ie=sr({...rh}),nh={CHECKOUT:"checkout",CHECKOUT_EMAIL:"checkout/email",SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"},oe=sr({...nh}),_e={STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"},ho=sr({...D}),uo=sr({...Da}),mo=sr({...R});var We={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,tags:"acom",isProdDomain:!1},Is=1e3;function ih(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function Ns(e){if(e==null)return;let t=typeof e;if(t==="function")return e.name?`function ${e.name}`:"function";if(t==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:n,originatingRequest:i,status:o}=e;return[n,o,i].filter(Boolean).join(" ")}let r=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!We.serializableTypes.includes(r))return r}return e}function oh(e,t){if(!We.ignoredProperties.includes(e))return Ns(t)}var po={append(e){if(e.level!=="error")return;let{message:t,params:r}=e,n=[],i=[],o=t;r.forEach(l=>{l!=null&&(ih(l)?n:i).push(l)}),n.length&&(o+=" "+n.map(Ns).join(" "));let{pathname:a,search:s}=window.location,c=`${We.delimiter}page=${a}${s}`;c.length>Is&&(c=`${c.slice(0,Is)}<trunc>`),o+=c,i.length&&(o+=`${We.delimiter}facts=`,o+=JSON.stringify(i,oh)),window.lana?.log(o,We)}};function Ct(e){Object.assign(We,Object.fromEntries(Object.entries(e).filter(([t,r])=>t in We&&r!==""&&r!==null&&r!==void 0&&!Number.isNaN(r))))}var P=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflow:ie.V3,checkoutWorkflowStep:oe.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,env:_e.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:fe.PUBLISHED});var Rs="mas-commerce-service";function en(e,{once:t=!1}={}){let r=null;function n(){let i=document.querySelector(Rs);i!==r&&(r=i,i&&e(i))}return document.addEventListener(dt,n,{once:t}),Ze(n),()=>document.removeEventListener(dt,n)}function cr(e,{country:t,forceTaxExclusive:r,perpetual:n}){let i;if(e.length<2)i=e;else{let o=t==="GB"||n?"EN":"MULT",[a,s]=e;i=[a.language===o?a:s]}return r&&(i=i.map($i)),i}var Ze=e=>window.setTimeout(e);function kt(e,t=1){if(e==null)return[t];let r=(Array.isArray(e)?e:String(e).split(",")).map(Ci).filter(wt);return r.length||(r=[t]),r}function tn(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(Pi)}function J(){return document.getElementsByTagName(Rs)?.[0]}var fo=Object.freeze({LOCAL:"local",PROD:"prod",STAGE:"stage"});function ah({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||P.language),t??(t=e?.split("_")?.[1]||P.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function go(e={}){let{commerce:t={}}=e,r=_e.PRODUCTION,n=di,i=O("checkoutClientId",t)??P.checkoutClientId,o=we(O("checkoutWorkflow",t),ie,P.checkoutWorkflow),a=oe.CHECKOUT;o===ie.V3&&(a=we(O("checkoutWorkflowStep",t),oe,P.checkoutWorkflowStep));let s=E(O("displayOldPrice",t),P.displayOldPrice),c=E(O("displayPerUnit",t),P.displayPerUnit),l=E(O("displayRecurrence",t),P.displayRecurrence),h=E(O("displayTax",t),P.displayTax),u=E(O("entitlement",t),P.entitlement),d=E(O("modal",t),P.modal),m=E(O("forceTaxExclusive",t),P.forceTaxExclusive),g=O("promotionCode",t)??P.promotionCode,f=kt(O("quantity",t)),b=O("wcsApiKey",t)??P.wcsApiKey,_=t?.env==="stage",L=fe.PUBLISHED;["true",""].includes(t.allowOverride)&&(_=(O(li,t,{metadata:!1})?.toLowerCase()??t?.env)==="stage",L=we(O(hi,t),fe,L)),_&&(r=_e.STAGE,n=ui);let C=O("mas-io-url")??e.masIOUrl??`https://www${r===_e.STAGE?".stage":""}.adobe.com/mas/io`;return{...ah(e),displayOldPrice:s,checkoutClientId:i,checkoutWorkflow:o,checkoutWorkflowStep:a,displayPerUnit:c,displayRecurrence:l,displayTax:h,entitlement:u,extraOptions:P.extraOptions,modal:d,env:r,forceTaxExclusive:m,promotionCode:g,quantity:f,alternativePrice:P.alternativePrice,wcsApiKey:b,wcsURL:n,landscape:L,masIOUrl:C}}var xo={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},bo=new Set,vo=new Set,Ms=new Map,Os={append({level:e,message:t,params:r,timestamp:n,source:i}){console[e](`${n}ms [${i}] %c${t}`,"font-weight: bold;",...r)}},$s={filter:({level:e})=>e!==xo.DEBUG},sh={filter:()=>!1};function ch(e,t,r,n,i){return{level:e,message:t,namespace:r,get params(){return n.length===1&&Jt(n[0])&&(n=n[0](),Array.isArray(n)||(n=[n])),n},source:i,timestamp:performance.now().toFixed(3)}}function lh(e){[...vo].every(t=>t(e))&&bo.forEach(t=>t(e))}function Vs(e){let t=(Ms.get(e)??0)+1;Ms.set(e,t);let r=`${e} #${t}`,n={id:r,namespace:e,module:i=>Vs(`${n.namespace}/${i}`),updateConfig:Ct};return Object.values(xo).forEach(i=>{n[i]=(o,...a)=>lh(ch(i,o,e,a,r))}),Object.seal(n)}function rn(...e){e.forEach(t=>{let{append:r,filter:n}=t;Jt(n)&&vo.add(n),Jt(r)&&bo.add(r)})}function hh(e={}){let{name:t}=e,r=E(O("commerce.debug",{search:!0,storage:!0}),t===fo.LOCAL);return rn(r?Os:$s),t===fo.PROD&&rn(po),j}function dh(){bo.clear(),vo.clear()}var j={...Vs(ci),Level:xo,Plugins:{consoleAppender:Os,debugFilter:$s,quietFilter:sh,lanaAppender:po},init:hh,reset:dh,use:rn};var ge=class e extends Error{constructor(t,r,n){if(super(t,{cause:n}),this.name="MasError",r.response){let i=r.response.headers?.get(mi);i&&(r.requestId=i),r.response.status&&(r.status=r.response.status,r.statusText=r.response.statusText),r.response.url&&(r.url=r.response.url)}delete r.response,this.context=r,Error.captureStackTrace&&Error.captureStackTrace(this,e)}toString(){let t=Object.entries(this.context||{}).map(([n,i])=>`${n}: ${JSON.stringify(i)}`).join(", "),r=`${this.name}: ${this.message}`;return t&&(r+=` (${t})`),this.cause&&(r+=`
Caused by: ${this.cause}`),r}};async function nn(e,t={},r=2,n=100){let i;for(let o=0;o<=r;o++)try{return await fetch(e,t)}catch(a){if(i=a,o>r)break;await new Promise(s=>setTimeout(s,n*(o+1)))}throw i}var Ds=new CSSStyleSheet;Ds.replaceSync(":host { display: contents; }");var Us="fragment",Hs="author",on="aem-fragment";async function uh(e,t,r){let n=`${on}:${t}${Qt}`,i;try{if(i=await nn(e,{cache:"default",credentials:"omit"}),!i?.ok){let{startTime:o,duration:a}=performance.measure(n,r);throw new ge("Unexpected fragment response",{response:i,startTime:o,duration:a})}return i.json()}catch{let{startTime:a,duration:s}=performance.measure(n,r);throw i||(i={url:e}),new ge("Failed to fetch fragment",{response:i,startTime:a,duration:s,...re()})}}var xe,Ao=class{constructor(){$(this,xe,new Map)}clear(){v(this,xe).clear()}addByRequestedId(t,r){v(this,xe).set(t,r)}add(...t){t.forEach(r=>{let{id:n}=r;n&&v(this,xe).set(n,r)})}has(t){return v(this,xe).has(t)}get(t){return v(this,xe).get(t)}remove(t){v(this,xe).delete(t)}};xe=new WeakMap;var lr=new Ao,an,ae,be,It,Nt,hr,te,Rt,Qe,dr,ur,yo,Eo=class extends HTMLElement{constructor(){super();$(this,ur);p(this,"cache",lr);$(this,an,j.module(on));$(this,ae,null);$(this,be,null);$(this,It,!1);$(this,Nt,null);$(this,hr,null);$(this,te);$(this,Rt);$(this,Qe);$(this,dr,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[Ds]}static get observedAttributes(){return[Us,Hs]}attributeChangedCallback(r,n,i){r===Us&&H(this,te,i),r===Hs&&H(this,dr,["","true"].includes(i))}connectedCallback(){if(!v(this,te)){de(this,ur,yo).call(this,{message:"Missing fragment id"});return}H(this,Nt,`${on}:${v(this,te)}${Te}`),performance.mark(v(this,Nt)),H(this,Rt,new Promise((r,n)=>{this.dispose=en(i=>this.activate(i,r,n))}))}async activate(r,n,i){H(this,hr,r),this.refresh(!1).then(o=>n(o)).catch(o=>i(o))}async refresh(r=!0){if(!(v(this,Qe)&&!await Promise.race([v(this,Qe),Promise.resolve(!1)])))return r&&lr.remove(v(this,te)),H(this,Qe,this.fetchData().then(()=>{let{references:n,referencesTree:i,placeholders:o}=v(this,ae)||{};return this.dispatchEvent(new CustomEvent(Be,{detail:{...this.data,stale:v(this,It),references:n,referencesTree:i,placeholders:o},bubbles:!0,composed:!0})),!0}).catch(n=>v(this,ae)?(lr.addByRequestedId(v(this,te),v(this,ae)),!0):(H(this,Rt,null),de(this,ur,yo).call(this,n),!1))),v(this,Qe)}async fetchData(){this.classList.remove("error"),H(this,be,null);let r=lr.get(v(this,te));if(r){H(this,ae,r);return}H(this,It,!0);let{masIOUrl:n,wcsApiKey:i,locale:o}=v(this,hr).settings,a=`${n}/fragment?id=${v(this,te)}&api_key=${i}&locale=${o}`;r=await uh(a,v(this,te),v(this,Nt)),lr.addByRequestedId(v(this,te),r),H(this,ae,r),H(this,It,!1)}get updateComplete(){return v(this,Rt)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return v(this,be)?v(this,be):(v(this,dr)?this.transformAuthorData():this.transformPublishData(),v(this,be))}transformAuthorData(){let{fields:r,id:n,tags:i}=v(this,ae);H(this,be,r.reduce((o,{name:a,multiple:s,values:c})=>(o.fields[a]=s?c:c[0],o),{fields:{},id:n,tags:i}))}transformPublishData(){let{fields:r,id:n,tags:i}=v(this,ae);H(this,be,Object.entries(r).reduce((o,[a,s])=>(o.fields[a]=s?.mimeType?s.value:s??"",o),{fields:{},id:n,tags:i}))}};an=new WeakMap,ae=new WeakMap,be=new WeakMap,It=new WeakMap,Nt=new WeakMap,hr=new WeakMap,te=new WeakMap,Rt=new WeakMap,Qe=new WeakMap,dr=new WeakMap,ur=new WeakSet,yo=function({message:r,context:n}){this.classList.add("error"),v(this,an).error(`aem-fragment: ${r}`,n),this.dispatchEvent(new CustomEvent(Ge,{detail:{message:r,...n},bubbles:!0,composed:!0}))};customElements.define(on,Eo);var mr=class extends q{constructor(){super()}render(){return x`
            <slot name="icon"></slot>
    ...
    `),p(mr,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",mr);var pr=class extends q{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,r)=>{r>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return x`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${this.isMobile&&this.rows.length>this.mobileRows?x`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:x``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};p(pr,"styles",w`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `);customElements.define("merch-icon",Ot);var Fs=w`
    :host {
        box-sizing: border-box;
