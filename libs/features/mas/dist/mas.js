...
`;var po=class extends O{constructor(t){super(t)}getGlobalCSS(){return zs}renderLayout(){return x`${this.cardImage}
    <div class="body">
...
`;var fo=class extends O{constructor(t){super(t)}getGlobalCSS(){return Fs}renderLayout(){return x` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var Xs={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Rt=class extends O{constructor(t){super(t)}getGlobalCSS(){return Ys}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return x`${this.cardImage}
    ...
    `);var ii=new Map,W=(e,t,r=null,o=null)=>{ii.set(e,{class:t,fragmentMapping:r,style:o})};W("catalog",Pt,Bs,Pt.variantStyle);W("image",po);W("inline-heading",fo);W("mini-compare-chart",kt,null,kt.variantStyle);W("plans",Re,ni,Re.variantStyle);W("plans-education",Re,js,Re.variantStyle);W("product",ot,null,ot.variantStyle);W("segment",Lt,null,Lt.variantStyle);W("special-offers",Rt,Xs,Rt.variantStyle);var ai=(e,t=!1)=>{let r=ii.get(e.variant);if(!r)return t?void 0:new ot(e);let{class:o,style:n}=r;if(n){let i=new CSSStyleSheet;i.replaceSync(n.cssText),e.shadowRoot.adoptedStyleSheets.push(i)}return new o(e)};function mo(e){return ii.get(e)?.fragmentMapping}var Ks=document.createElement("style");Ks.innerHTML=`
:root {
...
`;var pi={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color",specialValues:{gradient:"linear-gradient(135deg, #ff4885 0%, #b272eb 50%, #5d89ff 100%)"}}},at=class extends O{getGlobalCSS(){return fc}get aemFragmentMapping(){return pi}renderLayout(){return x`
    ...
    `);customElements.define("ah-promoted-plans",at);mt({sampleRate:1});W("ccd-suggested",Ut,dc,Ut.variantStyle);W("ccd-slice",Bt,mc,Bt.variantStyle);W("ah-try-buy-widget",it,mi,it.variantStyle);W("ah-promoted-plans",at,pi,at.variantStyle);
