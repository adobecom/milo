...
`;var Ro=class extends M{constructor(t){super(t)}getGlobalCSS(){return xc}renderLayout(){return x`${this.cardImage}
    <div class="body">
...
`;var Oo=class extends M{constructor(t){super(t)}getGlobalCSS(){return bc}renderLayout(){return x` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var Ad=32,Ut=class extends M{constructor(r){super(r);f(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);f(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
...
`;var ct=class extends M{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return wc}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return x` ${this.badge}
...
`;var Tc={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Bt=class extends M{constructor(t){super(t)}getGlobalCSS(){return Sc}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return x`${this.cardImage}
            <div class="body">
...
`;document.head.appendChild(Cc);var Pc="fragment",kc="author",Lc="preview",Ti="aem-fragment",ve,Ci=class{constructor(){w(this,ve,new Map)}clear(){u(this,ve).clear()}addByRequestedId(t,r){u(this,ve).set(t,r)}put(t,r){u(this,ve).set(t,r)}add(...t){t.forEach(r=>{let{id:o}=r;o&&u(this,ve).set(o,r)})}has(t){return u(this,ve).has(t)}get(t){return u(this,ve).get(t)}remove(t){u(this,ve).delete(t)}};ve=new WeakMap;var Mo=new Ci,zt,ye,Re,X,he,se,me,Or,Nr,Ft,ue,Rc,Oc,ki,Nc,Pi=class extends HTMLElement{constructor(){super(...arguments);w(this,ue);f(this,"cache",Mo);w(this,zt);w(this,ye,null);w(this,Re,null);w(this,X,{url:null,retryCount:0,stale:!1,measure:null,status:null});w(this,he,null);w(this,se);w(this,me);w(this,Or,!1);w(this,Nr,0);w(this,Ft)}static get observedAttributes(){return[Pc,kc,Lc]}attributeChangedCallback(r,o,n){r===Pc&&_(this,se,n),r===kc&&_(this,Or,["","true"].includes(n)),r===Lc&&_(this,Ft,n)}connectedCallback(){if(!u(this,me)){if(u(this,he)??_(this,he,St(this)),_(this,Ft,u(this,he).settings?.preview),u(this,zt)??_(this,zt,u(this,he).log.module(`${Ti}[${u(this,se)}]`)),!u(this,se)||u(this,se)==="#"){ne(this,ue,ki).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(u(this,X)).filter(([r,o])=>o!=null).map(([r,o])=>[`aem-fragment:${r}`,o]))}async refresh(r=!0){if(u(this,me)&&!await Promise.race([u(this,me),Promise.resolve(!1)]))return;r&&Mo.remove(u(this,se));try{_(this,me,ne(this,ue,Nc).call(this)),await u(this,me)}catch(s){return ne(this,ue,ki).call(this,s.message),!1}let{references:o,referencesTree:n,placeholders:i,wcs:a}=u(this,ye)||{};return a&&!N("mas.disableWcsCache")&&u(this,he).prefillWcsCache(a),this.dispatchEvent(new CustomEvent(Fe,{detail:{...this.data,references:o,referencesTree:n,placeholders:i,...u(this,X)},bubbles:!0,composed:!0})),u(this,me)}get updateComplete(){return u(this,me)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return u(this,Re)?u(this,Re):(u(this,Or)?this.transformAuthorData():this.transformPublishData(),u(this,Re))}transformAuthorData(){let{fields:r,id:o,tags:n,settings:i={}}=u(this,ye);_(this,Re,r.reduce((a,{name:s,multiple:c,values:l})=>(a.fields[s]=c?l:l[0],a),{fields:{},id:o,tags:n,settings:i}))}transformPublishData(){let{fields:r,id:o,tags:n,settings:i={}}=u(this,ye);_(this,Re,Object.entries(r).reduce((a,[s,c])=>(a.fields[s]=c?.mimeType?c.value:c??"",a),{fields:{},id:o,tags:n,settings:i}))}getFragmentClientUrl(){let o=new URLSearchParams(window.location.search).get("maslibs");if(!o||o.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let n=o.trim().toLowerCase();if(n==="local")return"http://localhost:3030/studio/libs/fragment-client.js";if(n==="main")return"https://mas.adobe.com/studio/libs/fragment-client.js";let{hostname:i}=window.location,a=i.endsWith(".page")?"page":"live";return n.includes("--mas--")?`https://${n}.aem.${a}/studio/libs/fragment-client.js`:n.includes("--")?`https://${n}.aem.${a}/studio/libs/fragment-client.js`:`https://${n}--mas--adobecom.aem.${a}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:o}=await import(r);return await o(u(this,se),{locale:u(this,he).settings.locale,apiKey:u(this,he).settings.wcsApiKey})}};zt=new WeakMap,ye=new WeakMap,Re=new WeakMap,X=new WeakMap,he=new WeakMap,se=new WeakMap,me=new WeakMap,Or=new WeakMap,Nr=new WeakMap,Ft=new WeakMap,ue=new WeakSet,Rc=async function(r){Fi(this,Nr)._++;let o=`${Ti}:${u(this,se)}:${u(this,Nr)}`,n=`${o}${je}`,i=`${o}${qe}`;if(u(this,Ft))return await this.generatePreview();performance.mark(n);let a;try{if(u(this,X).stale=!1,u(this,X).url=r,a=await ho(r,{cache:"default",credentials:"omit"}),ne(this,ue,Oc).call(this,a),u(this,X).status=a?.status,u(this,X).measure=xe(performance.measure(i,n)),u(this,X).retryCount=a.retryCount,!a?.ok)throw new Se("Unexpected fragment response",{response:a,...u(this,he).duration});return await a.json()}catch(s){if(u(this,X).measure=xe(performance.measure(i,n)),u(this,X).retryCount=s.retryCount,u(this,ye))return u(this,X).stale=!0,u(this,zt).error("Serving stale data",u(this,X)),u(this,ye);let c=s.message??"unknown";throw new Se(`Failed to fetch fragment: ${c}`,{})}},Oc=function(r){Object.assign(u(this,X),Wr(r))},ki=function(r){_(this,me,null),u(this,X).message=r,this.classList.add("error");let o={...u(this,X),...u(this,he).duration};u(this,zt).error(r,o),this.dispatchEvent(new CustomEvent(Ge,{detail:o,bubbles:!0,composed:!0}))},Nc=async function(){this.classList.remove("error"),_(this,Re,null);let r=Mo.get(u(this,se));if(r)return _(this,ye,r),!0;let{masIOUrl:o,wcsApiKey:n,locale:i}=u(this,he).settings,a=`${o}/fragment?id=${u(this,se)}&api_key=${n}&locale=${i}`;return r=await ne(this,ue,Rc).call(this,a),Mo.addByRequestedId(u(this,se),r),_(this,ye,r),!0};customElements.define(Ti,Pi);var Gt=class extends H{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return x`<div class="badge">
    ...
    `);customElements.define("merch-badge",Gt);var Mr=class extends H{constructor(){super()}render(){return x`
            <slot name="icon"></slot>
