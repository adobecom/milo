...
`;var fi={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},Dt=class extends O{getGlobalCSS(){return uc}get aemFragmentMapping(){return fi}renderLayout(){return g` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;var xi={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color",specialValues:{gradient:"linear-gradient(135deg, #ff4885 0%, #b272eb 50%, #5d89ff 100%)"}}},it=class extends O{getGlobalCSS(){return pc}get aemFragmentMapping(){return xi}renderLayout(){return g`
    ...
    `);customElements.define("ah-promoted-plans",it);dt({sampleRate:1});X("ccd-suggested",Ut,pi,Ut.variantStyle);X("ccd-slice",Dt,fi,Dt.variantStyle);X("ah-try-buy-widget",nt,gi,nt.variantStyle);X("ah-promoted-plans",it,xi,it.variantStyle);
