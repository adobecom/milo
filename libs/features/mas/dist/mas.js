...
`,zs=()=>[v`
      ...
      `];var Tt=class extends H{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:t}=this;return t?x`<a href="${t}">
...
`;var uo=class extends ${constructor(t){super(t)}getGlobalCSS(){return Gs}renderLayout(){return x`${this.cardImage}
    <div class="body">
...
`;var mo=class extends ${constructor(t){super(t)}getGlobalCSS(){return Vs}renderLayout(){return x` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
    ...
    ${this.card.customHr?"":x`<hr />`} ${this.secureLabelFooter}`}};var js=`
  :root {
...
`;var po={title:{tag:"p",slot:"heading-xs"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},stockOffer:!0,secureLabel:!0,badge:{tag:"div",slot:"badge"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant"},Me=class extends ${constructor(t){super(t),this.adaptForMobile=this.adaptForMobile.bind(this)}get aemFragmentMapping(){return po}getGlobalCSS(){return qs}adaptForMobile(){if(!this.card.closest("merch-card-collection,overlay-trigger")){this.card.removeAttribute("size");return}let t=this.card.shadowRoot,r=t.querySelector("footer"),o=this.card.getAttribute("size"),n=t.querySelector("footer #stock-checkbox"),i=t.querySelector(".body #stock-checkbox"),a=t.querySelector(".body");if(!o){r?.classList.remove("wide-footer"),n&&n.remove();return}let s=bt();if(r?.classList.toggle("wide-footer",!s),s&&n){i?n.remove():a.appendChild(n);return}!s&&i&&(n?i.remove():r.prepend(i))}postCardUpdateHook(){this.adaptForMobile(),this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
        ...
        ${this.secureLabelFooter}`}};p(Me,"variantStyle",v`
    :host([variant^='plans']) {
        min-height: 348px;
...
`;var Lt=class extends ${constructor(t){super(t)}getGlobalCSS(){return Ys}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var ii={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Rt=class extends ${constructor(t){super(t)}getGlobalCSS(){return Xs}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return ii}renderLayout(){return x`${this.cardImage}
            <div class="body">
...
`;document.head.appendChild(Zs);var ec=new CSSStyleSheet;ec.replaceSync(":host { display: contents; }");var Qs="fragment",Js="author",fo="aem-fragment",Ee,ci=class{constructor(){R(this,Ee,new Map)}clear(){b(this,Ee).clear()}addByRequestedId(t,r){b(this,Ee).set(t,r)}add(...t){t.forEach(r=>{let{id:o}=r;o&&b(this,Ee).set(o,r)})}has(t){return b(this,Ee).has(t)}get(t){return b(this,Ee).get(t)}remove(t){b(this,Ee).delete(t)}};Ee=new WeakMap;var xr=new ci,br,he,we,Ot,$t,se,te,Ae,vr,yr,hi,li=class extends HTMLElement{constructor(){super();R(this,yr);p(this,"cache",xr);R(this,br);R(this,he,null);R(this,we,null);R(this,Ot,!1);R(this,$t,null);R(this,se,null);R(this,te);R(this,Ae);R(this,vr,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[ec]}static get observedAttributes(){return[Qs,Js]}attributeChangedCallback(r,o,n){r===Qs&&O(this,te,n),r===Js&&O(this,vr,["","true"].includes(n))}connectedCallback(){if(!b(this,Ae)){if(O(this,se,vt(this)),O(this,br,b(this,se).log.module(fo)),O(this,$t,`${fo}:${b(this,te)}${Pe}`),performance.mark(b(this,$t)),!b(this,te)){ue(this,yr,hi).call(this,{message:"Missing fragment id"});return}this.refresh(!1)}}async getFragmentById(r,o,n,i){let a=`${fo}:${o}${Vt}`;if(i)return await this.generatePreview();let s;try{if(s=await Yr(r,{cache:"default",credentials:"omit"}),!s?.ok){let{startTime:c,duration:l}=performance.measure(a,n);throw new xe("Unexpected fragment response",{response:s,startTime:c,duration:l,...b(this,se).duration})}return s.json()}catch{let{startTime:l,duration:h}=performance.measure(a,n);throw s||(s={url:r}),new xe("Failed to fetch fragment",{response:s,startTime:l,duration:h,...b(this,se).duration})}}async refresh(r=!0){if(!(b(this,Ae)&&!await Promise.race([b(this,Ae),Promise.resolve(!1)])))return r&&xr.remove(b(this,te)),O(this,Ae,this.fetchData().then(()=>{let{references:o,referencesTree:n,placeholders:i}=b(this,he)||{};return this.dispatchEvent(new CustomEvent(Be,{detail:{...this.data,stale:b(this,Ot),references:o,referencesTree:n,placeholders:i},bubbles:!0,composed:!0})),!0}).catch(o=>b(this,he)?(xr.addByRequestedId(b(this,te),b(this,he)),!0):(ue(this,yr,hi).call(this,o),!1))),b(this,Ae)}async fetchData(){this.classList.remove("error"),O(this,we,null);let r=xr.get(b(this,te));if(r){O(this,he,r);return}O(this,Ot,!0);let{masIOUrl:o,locale:n,preview:i,wcsApiKey:a}=b(this,se).settings,s=`${o}/fragment?id=${b(this,te)}&api_key=${a}&locale=${n}`;r=await this.getFragmentById(s,b(this,te),b(this,$t),i),xr.addByRequestedId(b(this,te),r),O(this,he,r),O(this,Ot,!1)}get updateComplete(){return b(this,Ae)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return b(this,we)?b(this,we):(b(this,vr)?this.transformAuthorData():this.transformPublishData(),b(this,we))}transformAuthorData(){let{fields:r,id:o,tags:n}=b(this,he);O(this,we,r.reduce((i,{name:a,multiple:s,values:c})=>(i.fields[a]=s?c:c[0],i),{fields:{},id:o,tags:n}))}transformPublishData(){let{fields:r,id:o,tags:n,settings:i}=b(this,he);O(this,we,Object.entries(r).reduce((a,[s,c])=>(a.fields[s]=c?.mimeType?c.value:c??"",a),{fields:{},id:o,tags:n,settings:i}))}async generatePreview(){let{previewFragment:r}=await import("https://mwpw-162398--mas--adobecom.aem.live/studio/libs/fragment-client.js");return await r(b(this,te),{surface:b(this,se).settings.previewSurface,locale:b(this,se).settings.locale,apiKey:b(this,se).settings.wcsApiKey})}};br=new WeakMap,he=new WeakMap,we=new WeakMap,Ot=new WeakMap,$t=new WeakMap,se=new WeakMap,te=new WeakMap,Ae=new WeakMap,vr=new WeakMap,yr=new WeakSet,hi=function({message:r,context:o}){this.classList.add("error"),b(this,br).error(`aem-fragment: ${r}`,o),this.dispatchEvent(new CustomEvent(ze,{detail:{message:r,...o},bubbles:!0,composed:!0}))};customElements.define(fo,li);var Mt=class extends H{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return x`<div class="plans-badge">
            ${this.text}
    ...
    `);customElements.define("merch-badge",Mt);var Er=class extends H{constructor(){super()}render(){return x`
            <slot name="icon"></slot>
...
`;var fi={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},Bt=class extends ${getGlobalCSS(){return uc}get aemFragmentMapping(){return fi}renderLayout(){return x` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
