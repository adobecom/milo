...
`;var ho=class extends O{constructor(t){super(t)}getGlobalCSS(){return Gs}renderLayout(){return g`${this.cardImage}
    <div class="body">
...
`;var uo=class extends O{constructor(t){super(t)}getGlobalCSS(){return Vs}renderLayout(){return g` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var kt=class extends O{constructor(t){super(t)}getGlobalCSS(){return Ys}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return g` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var ii={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Lt=class extends O{constructor(t){super(t)}getGlobalCSS(){return Xs}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return ii}renderLayout(){return g`${this.cardImage}
            <div class="body">
    ...
    `);var ai=new Map,W=(e,t,r=null,o=null)=>{ai.set(e,{class:t,fragmentMapping:r,style:o})};W("catalog",Ct,ni,Ct.variantStyle);W("image",ho);W("inline-heading",uo);W("mini-compare-chart",Pt,null,Pt.variantStyle);W("plans",Oe,mo,Oe.variantStyle);W("plans-students",Oe,mo,Oe.variantStyle);W("product",ot,null,ot.variantStyle);W("segment",kt,null,kt.variantStyle);W("special-offers",Lt,ii,Lt.variantStyle);var si=(e,t=!1)=>{let r=ai.get(e.variant);if(!r)return t?void 0:new ot(e);let{class:o,style:n}=r;if(n){let i=new CSSStyleSheet;i.replaceSync(n.cssText),e.shadowRoot.adoptedStyleSheets.push(i)}return new o(e)};function Ks(e){return ai.get(e)?.fragmentMapping}var Zs=document.createElement("style");Zs.innerHTML=`
:root {
...
`;document.head.appendChild(Zs);var ec=new CSSStyleSheet;ec.replaceSync(":host { display: contents; }");var Qs="fragment",Js="author",po="aem-fragment",ye,ci=class{constructor(){L(this,ye,new Map)}clear(){b(this,ye).clear()}addByRequestedId(t,r){b(this,ye).set(t,r)}add(...t){t.forEach(r=>{let{id:o}=r;o&&b(this,ye).set(o,r)})}has(t){return b(this,ye).has(t)}get(t){return b(this,ye).get(t)}remove(t){b(this,ye).delete(t)}};ye=new WeakMap;var gr=new ci,xr,le,Ee,Rt,Ot,$e,oe,Me,br,vr,hi,li=class extends HTMLElement{constructor(){super();L(this,vr);p(this,"cache",gr);L(this,xr);L(this,le,null);L(this,Ee,null);L(this,Rt,!1);L(this,Ot,null);L(this,$e,null);L(this,oe);L(this,Me);L(this,br,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[ec]}static get observedAttributes(){return[Qs,Js]}attributeChangedCallback(r,o,n){r===Qs&&R(this,oe,n),r===Js&&R(this,br,["","true"].includes(n))}connectedCallback(){if(R(this,$e,bt(this)),R(this,xr,b(this,$e).log.module(po)),R(this,Ot,`${po}:${b(this,oe)}${Te}`),performance.mark(b(this,Ot)),!b(this,oe)){de(this,vr,hi).call(this,{message:"Missing fragment id"});return}this.refresh(!1)}async getFragmentById(r,o,n){let i=`${po}:${o}${Gt}`,a;try{if(a=await Wr(r,{cache:"default",credentials:"omit"}),!a?.ok){let{startTime:s,duration:c}=performance.measure(i,n);throw new ge("Unexpected fragment response",{response:a,startTime:s,duration:c,...b(this,$e).duration})}return a.json()}catch{let{startTime:c,duration:l}=performance.measure(i,n);throw a||(a={url:r}),new ge("Failed to fetch fragment",{response:a,startTime:c,duration:l,...b(this,$e).duration})}}async refresh(r=!0){if(!(b(this,Me)&&!await Promise.race([b(this,Me),Promise.resolve(!1)])))return r&&gr.remove(b(this,oe)),R(this,Me,this.fetchData().then(()=>{let{references:o,referencesTree:n,placeholders:i}=b(this,le)||{};return this.dispatchEvent(new CustomEvent(Be,{detail:{...this.data,stale:b(this,Rt),references:o,referencesTree:n,placeholders:i},bubbles:!0,composed:!0})),!0}).catch(o=>b(this,le)?(gr.addByRequestedId(b(this,oe),b(this,le)),!0):(de(this,vr,hi).call(this,o),!1))),b(this,Me)}async fetchData(){this.classList.remove("error"),R(this,Ee,null);let r=gr.get(b(this,oe));if(r){R(this,le,r);return}R(this,Rt,!0);let{masIOUrl:o,wcsApiKey:n,locale:i}=b(this,$e).settings,a=`${o}/fragment?id=${b(this,oe)}&api_key=${n}&locale=${i}`;r=await this.getFragmentById(a,b(this,oe),b(this,Ot)),gr.addByRequestedId(b(this,oe),r),R(this,le,r),R(this,Rt,!1)}get updateComplete(){return b(this,Me)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return b(this,Ee)?b(this,Ee):(b(this,br)?this.transformAuthorData():this.transformPublishData(),b(this,Ee))}transformAuthorData(){let{fields:r,id:o,tags:n}=b(this,le);R(this,Ee,r.reduce((i,{name:a,multiple:s,values:c})=>(i.fields[a]=s?c:c[0],i),{fields:{},id:o,tags:n}))}transformPublishData(){let{fields:r,id:o,tags:n}=b(this,le);R(this,Ee,Object.entries(r).reduce((i,[a,s])=>(i.fields[a]=s?.mimeType?s.value:s??"",i),{fields:{},id:o,tags:n}))}};xr=new WeakMap,le=new WeakMap,Ee=new WeakMap,Rt=new WeakMap,Ot=new WeakMap,$e=new WeakMap,oe=new WeakMap,Me=new WeakMap,br=new WeakMap,vr=new WeakSet,hi=function({message:r,context:o}){this.classList.add("error"),b(this,xr).error(`aem-fragment: ${r}`,o),this.dispatchEvent(new CustomEvent(ze,{detail:{message:r,...o},bubbles:!0,composed:!0}))};customElements.define(po,li);var $t=class extends M{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return g`<div class="plans-badge">
    ...
    `),p(wr,"properties",{offers:{type:Array},selectedOffer:{type:Object},defaults:{type:Object},variant:{type:String,attribute:"variant",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},stock:{type:Boolean,reflect:!0}});customElements.define("merch-offer-select",wr);var ac=v`
    :host {
...
`;var fi={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},Ut=class extends O{getGlobalCSS(){return uc}get aemFragmentMapping(){return fi}renderLayout(){return g` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;var xi={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color",specialValues:{gradient:"linear-gradient(135deg, #ff4885 0%, #b272eb 50%, #5d89ff 100%)"}}},at=class extends O{getGlobalCSS(){return pc}get aemFragmentMapping(){return xi}renderLayout(){return g`
    ...
    `);customElements.define("ah-promoted-plans",at);ut({sampleRate:1});W("ccd-suggested",Dt,pi,Dt.variantStyle);W("ccd-slice",Ut,fi,Ut.variantStyle);W("ah-try-buy-widget",it,gi,it.variantStyle);W("ah-promoted-plans",at,xi,at.variantStyle);
