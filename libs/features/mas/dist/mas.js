...
`;var Ke=class extends k{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return xa}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return g` ${this.badge}
...
`;var gt=class extends k{constructor(t){super(t)}getGlobalCSS(){return ba}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return g` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var bt=class extends k{constructor(t){super(t)}getGlobalCSS(){return Aa}renderLayout(){return g`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
...
`;var gi={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color"},allowedColors:{gray:"--spectrum-gray-100"},size:["single","double","triple"]},Ye=class extends k{getGlobalCSS(){return Sa}get aemFragmentMapping(){return gi}renderLayout(){return g`
  ...
  `);customElements.define("ah-try-buy-widget",Ye);var xi=(e,t=!1)=>{switch(e.variant){case"catalog":return new mt(e);case"image":return new $r(e);case"inline-heading":return new Vr(e);case"mini-compare-chart":return new pt(e);case"plans":return new ft(e);case"product":return new Ke(e);case"segment":return new gt(e);case"special-offers":return new xt(e);case"twp":return new bt(e);case"ccd-suggested":return new vt(e);case"ccd-slice":return new At(e);case"ah-try-buy-widget":return new Ye(e);default:return t?void 0:new Ke(e)}},Ta={catalog:di,image:null,"inline-heading":null,"mini-compare-chart":null,plans:ui,product:null,segment:null,"special-offers":mi,twp:null,"ccd-suggested":pi,"ccd-slice":fi,"ah-try-buy-widget":gi},wa=()=>{let e=[];return e.push(mt.variantStyle),e.push(pt.variantStyle),e.push(Ke.variantStyle),e.push(ft.variantStyle),e.push(gt.variantStyle),e.push(xt.variantStyle),e.push(bt.variantStyle),e.push(vt.variantStyle),e.push(At.variantStyle),e.push(Ye.variantStyle),e};var _a=document.createElement("style");_a.innerHTML=`
:root {
