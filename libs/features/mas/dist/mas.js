...
`,Oo=()=>[C`
        ...
        `}get cardImage(){return x` <div class="image">
            ...
            ${this.badge}
              ...
              >`:"";return x`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){}};nt=new WeakMap,p(Rt,"styleMap",{});var I=Rt;function Z(e,t={},r=""){let n=document.createElement(e);r instanceof HTMLElement?n.appendChild(r):n.innerHTML=r;for(let[i,o]of Object.entries(t))n.setAttribute(i,o);return n}function pr(){return window.matchMedia("(max-width: 767px)").matches}function Ro(){return window.matchMedia("(max-width: 1024px)").matches}var Dn={};Ns(Dn,{CLASS_NAME_FAILED:()=>Pn,CLASS_NAME_HIDDEN:()=>Ks,CLASS_NAME_PENDING:()=>Cn,CLASS_NAME_RESOLVED:()=>In,ERROR_MESSAGE_BAD_REQUEST:()=>br,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>ec,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Nn,EVENT_AEM_ERROR:()=>Me,EVENT_AEM_LOAD:()=>$e,EVENT_MAS_ERROR:()=>wn,EVENT_MAS_READY:()=>xr,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>_n,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>Js,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Zs,EVENT_MERCH_CARD_READY:()=>Ln,EVENT_MERCH_OFFER_READY:()=>Ys,EVENT_MERCH_OFFER_SELECT_READY:()=>Tn,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>gr,EVENT_MERCH_SEARCH_CHANGE:()=>qs,EVENT_MERCH_SIDENAV_SELECT:()=>Qs,EVENT_MERCH_STOCK_CHANGE:()=>Ws,EVENT_MERCH_STORAGE_CHANGE:()=>fr,EVENT_OFFER_SELECTED:()=>Xs,EVENT_TYPE_FAILED:()=>kn,EVENT_TYPE_PENDING:()=>On,EVENT_TYPE_READY:()=>it,EVENT_TYPE_RESOLVED:()=>Rn,LOG_NAMESPACE:()=>Vn,Landscape:()=>He,NAMESPACE:()=>Fs,PARAM_AOS_API_KEY:()=>tc,PARAM_ENV:()=>$n,PARAM_LANDSCAPE:()=>Mn,PARAM_WCS_API_KEY:()=>rc,STATE_FAILED:()=>he,STATE_PENDING:()=>de,STATE_RESOLVED:()=>ue,TAG_NAME_SERVICE:()=>js,WCS_PROD_URL:()=>Hn,WCS_STAGE_URL:()=>Un});var Fs="merch",Ks="hidden",it="wcms:commerce:ready",js="mas-commerce-service",Ys="merch-offer:ready",Tn="merch-offer-select:ready",Ln="merch-card:ready",_n="merch-card:action-menu-toggle",Xs="merch-offer:selected",Ws="merch-stock:change",fr="merch-storage:change",gr="merch-quantity-selector:change",qs="merch-search:change",Zs="merch-card-collection:sort",Js="merch-card-collection:showmore",Qs="merch-sidenav:select",$e="aem:load",Me="aem:error",xr="mas:ready",wn="mas:error",Pn="placeholder-failed",Cn="placeholder-pending",In="placeholder-resolved",br="Bad WCS request",Nn="Commerce offer not found",ec="Literals URL not provided",kn="mas:failed",On="mas:pending",Rn="mas:resolved",Vn="mas/commerce",$n="commerce.env",Mn="commerce.landscape",tc="commerce.aosKey",rc="commerce.wcsKey",Hn="https://www.adobe.com/web_commerce_artifact",Un="https://www.stage.adobe.com/web_commerce_artifact_stage",he="failed",de="pending",ue="resolved",He={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"};var Vo=`
:root {
...
`;var Ar=class extends I{constructor(t){super(t)}getGlobalCSS(){return Mo}renderLayout(){return x` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var ic=32,at=class extends I{constructor(r){super(r);p(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);p(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
              <span class="secure-transaction-label"
                  >${this.card.secureLabel}</span
              ></slot
          >`:x`<slot name="secure-transaction-label"></slot>`;return x`<footer>${r}<slot name="footer"></slot></footer>`})}getGlobalCSS(){return Ho}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2)return;this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".top-section"),"top-section");let r=["heading-m","body-m","heading-m-price","body-xxs","price-commitment","offers","promo-text","callout-content"];this.card.classList.contains("bullet-list")&&r.push("footer-rows"),r.forEach(i=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${i}"]`),i)),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector("footer"),"footer");let n=this.card.shadowRoot.querySelector(".mini-compare-chart-badge");n&&n.textContent!==""&&this.getContainer().style.setProperty("--consonant-merch-card-mini-compare-chart-top-section-mobile-height","32px")}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;[...this.card.querySelector('[slot="footer-rows"] ul')?.children].forEach((n,i)=>{let o=Math.max(ic,parseFloat(window.getComputedStyle(n).height)||0),a=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(i+1)))||0;o>a&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(i+1),`${o}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(n=>{let i=n.querySelector(".footer-row-cell-description");i&&!i.textContent.trim()&&n.remove()})}renderLayout(){return x` <div class="top-section${this.badge?" badge":""}">
            <slot name="icons"></slot> ${this.badge}
        </div>
        <slot name="heading-m"></slot>
...
`;var sc={mnemonics:{size:"m"},backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{slot:"footer",size:"S"},allowedSizes:["wide"]},ut=class extends I{getGlobalCSS(){return Ko}get aemFragmentMapping(){return sc}renderLayout(){return x` <div class="content">
                <div class="top-section">
                  <slot name="icons"></slot> 
                  ${this.badge}
                </div>  
...
`;document.head.appendChild(Yo);var cc="#000000",lc="#F8D904",hc=/(accent|primary|secondary)(-(outline|link))?/,dc="mas:product_code/",uc="daa-ll",Er="daa-lh",mc=["XL","L","M","S"];function pc(e,t,r){e.mnemonicIcon?.map((i,o)=>({icon:i,alt:e.mnemonicAlt[o]??"",link:e.mnemonicLink[o]??""}))?.forEach(({icon:i,alt:o,link:a})=>{if(a&&!/^https?:/.test(a))try{a=new URL(`https://${a}`).href.toString()}catch{a="#"}let s={slot:"icons",src:i,size:r?.size??"l"};o&&(s.alt=o),a&&(s.href=a);let c=Z("merch-icon",s);t.append(c)})}function fc(e,t){e.badge&&(t.setAttribute("badge-text",e.badge),t.setAttribute("badge-color",e.badgeColor||cc),t.setAttribute("badge-background-color",e.badgeBackgroundColor||lc))}function gc(e,t,r){r?.includes(e.size)&&t.setAttribute("size",e.size)}function xc(e,t,r){e.cardTitle&&r&&t.append(Z(r.tag,{slot:r.slot},e.cardTitle))}function bc(e,t,r){e.subtitle&&r&&t.append(Z(r.tag,{slot:r.slot},e.subtitle))}function vc(e,t,r){if(r?.tag&&e.backgroundImage){let n={loading:"lazy",src:e.backgroundImage};e.backgroundImageAltText?n.alt=e.backgroundImageAltText:n.role="none",t.append(Z(r.tag,{slot:r.slot},Z("img",n)))}r?.attribute&&t.setAttribute(r.attribute,e.backgroundImage)}function Ac(e,t,r){if(e.prices&&r){let n=Z(r.tag,{slot:r.slot},e.prices);t.append(n)}}function Ec(e,t,r){if(e.description&&r){let n=Z(r.tag,{slot:r.slot},e.description);t.append(n)}}function Sc(e,t,r,n){let i=t.ctas.size??"M",o=`spectrum-Button--${n}`,a=r?" spectrum-Button--outline":"";e.classList.add("spectrum-Button-label");let s=mc.includes(i)?` spectrum-Button--size${i}`:" spectrum-Button--sizeM",c=`spectrum-Button ${o}${a}${s}`,l=Z("button",{class:c,tabIndex:0},e);return l.addEventListener("click",h=>{h.target!==e&&(h.stopPropagation(),e.click())}),l}function yc(e,t,r,n){let i="fill";r&&(i="outline");let o=Z("sp-button",{treatment:i,variant:n,tabIndex:0,size:t.ctas.size??"m"},e);return o.addEventListener("click",a=>{a.target!==e&&(a.stopPropagation(),e.click())}),o}function Tc(e,t){return e.classList.add("con-button"),t&&e.classList.add("blue"),e}function Lc(e,t,r,n){if(e.ctas){let{slot:i}=r.ctas,o=Z("div",{slot:i},e.ctas),a=[...o.querySelectorAll("a")].map(s=>{let c=s.parentElement.tagName==="STRONG";if(t.consonant)return Tc(s,c);let l=hc.exec(s.className)?.[0]??"accent",h=l.includes("accent"),d=l.includes("primary"),u=l.includes("secondary"),m=l.includes("-outline");if(l.includes("-link"))return s;let f;return h||c?f="accent":d?f="primary":u&&(f="secondary"),s.tabIndex=-1,t.spectrum==="swc"?yc(s,r,m,f):Sc(s,r,m,f)});o.innerHTML="",o.append(...a),t.append(o)}}function _c(e,t){let{tags:r}=e,n=r?.find(i=>i.startsWith(dc))?.split("/").pop();n&&(t.setAttribute(Er,n),t.querySelectorAll("a[data-analytics-id]").forEach((i,o)=>{i.setAttribute(uc,`${i.dataset.analyticsId}-${o+1}`)}))}function wc(e){[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,r])=>{e.querySelectorAll(`a.${t}`).forEach(n=>{n.classList.remove(t),n.classList.add("spectrum-Link",`spectrum-Link--${r}`)})})}async function Xo(e,t){let{fields:r}=e,{variant:n}=r;if(!n)return;t.id=e.id,t.querySelectorAll("[slot]").forEach(o=>{o.remove()}),t.removeAttribute("background-image"),t.removeAttribute("badge-background-color"),t.removeAttribute("badge-color"),t.removeAttribute("badge-text"),t.removeAttribute("size"),t.classList.remove("wide-strip"),t.classList.remove("thin-strip"),t.removeAttribute(Er),t.variant=n,await t.updateComplete;let{aemFragmentMapping:i}=t.variantLayout;i&&(pc(r,t,i.mnemonics),fc(r,t),gc(r,t,i.allowedSizes),xc(r,t,i.title),bc(r,t,i.subtitle),Ac(r,t,i.prices),vc(r,t,i.backgroundImage,n),Ec(r,t,i.description),Lc(r,t,i,n),_c(r,t),wc(t))}var Pc="merch-card",Cc=":start",Wo=":ready",Ic=1e4,Gn="merch-card:",$t,zn,Vt=class extends te{constructor(){super();G(this,$t);p(this,"customerSegment");p(this,"marketSegment");p(this,"variantLayout");this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this)}firstUpdated(){this.variantLayout=Bn(this,!1),this.variantLayout?.connectedCallbackHook(),this.aemFragment?.updateComplete.catch(()=>{this.style.display="none"})}willUpdate(r){(r.has("variant")||!this.variantLayout)&&(this.variantLayout=Bn(this),this.variantLayout.connectedCallbackHook())}updated(r){(r.has("badgeBackgroundColor")||r.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border",this.computedBorderStyle),this.variantLayout?.postCardUpdateHook(r)}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}get prices(){return Array.from(this.querySelectorAll('span[is="inline-price"][data-wcs-osi]'))}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["twp","ccd-slice","ccd-suggested"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector('span[is="inline-price"]')}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll('a[is="checkout-link"]')??[]]}async toggleStockOffer({target:r}){if(!this.stockOfferOsis)return;let n=this.checkoutLinks;if(n.length!==0)for(let i of n){await i.onceSettled();let o=i.value?.[0]?.planType;if(!o)return;let a=this.stockOfferOsis[o];if(!a)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==a);r.checked&&s.push(a),i.dataset.wcsOsi=s.join(",")}}handleQuantitySelection(r){let n=this.checkoutLinks;for(let i of n)i.dataset.quantity=r.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(r){let n={...this.filters};Object.keys(n).forEach(i=>{if(r){n[i].order=Math.min(n[i].order||2,2);return}let o=n[i].order;o===1||isNaN(o)||(n[i].order=Number(o)+1)}),this.filters=n}includes(r){return this.textContent.match(new RegExp(r,"i"))!==null}connectedCallback(){super.connectedCallback();let r=this.querySelector("aem-fragment")?.getAttribute("fragment");performance.mark(`${Gn}${r}${Cc}`),this.addEventListener(gr,this.handleQuantitySelection),this.addEventListener(Tn,this.merchCardReady,{once:!0}),this.updateComplete.then(()=>{this.merchCardReady()}),this.storageOptions?.addEventListener("change",this.handleStorageChange),this.addEventListener(Me,this.handleAemFragmentEvents),this.addEventListener($e,this.handleAemFragmentEvents),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(gr,this.handleQuantitySelection),this.storageOptions?.removeEventListener(fr,this.handleStorageChange),this.removeEventListener(Me,this.handleAemFragmentEvents),this.removeEventListener($e,this.handleAemFragmentEvents)}async handleAemFragmentEvents(r){if(r.type===Me&&xe(this,$t,zn).call(this,"AEM fragment cannot be loaded"),r.type===$e&&r.target.nodeName==="AEM-FRAGMENT"){let n=r.detail;await Xo(n,this),this.checkReady()}}async checkReady(){let r=[...this.querySelectorAll('span[is="inline-price"][data-wcs-osi],a[is="checkout-link"][data-wcs-osi]')];if(!r.length){performance.mark(`${Gn}${this.id}${Wo}`),this.dispatchEvent(new CustomEvent(xr,{bubbles:!0,composed:!0}));return}let n=Promise.all(r.map(a=>a.onceSettled().catch(()=>a))).then(a=>a.every(s=>s.classList.contains("placeholder-resolved"))),i=new Promise(a=>setTimeout(()=>a(!1),Ic));if(await Promise.race([n,i])===!0){performance.mark(`${Gn}${this.id}${Wo}`),this.dispatchEvent(new CustomEvent(xr,{bubbles:!0,composed:!0}));return}xe(this,$t,zn).call(this,"Contains unresolved offers")}get aemFragment(){return this.querySelector("aem-fragment")}get storageOptions(){return this.querySelector("sp-radio-group#storage")}get storageSpecificOfferSelect(){let r=this.storageOptions?.selected;if(r){let n=this.querySelector(`merch-offer-select[storage="${r}"]`);if(n)return n}return this.querySelector("merch-offer-select")}get offerSelect(){return this.storageOptions?this.storageSpecificOfferSelect:this.querySelector("merch-offer-select")}get quantitySelect(){return this.querySelector("merch-quantity-select")}merchCardReady(){this.offerSelect&&!this.offerSelect.planType||this.dispatchEvent(new CustomEvent(Ln,{bubbles:!0}))}handleStorageChange(){let r=this.closest("merch-card")?.offerSelect.cloneNode(!0);r&&this.dispatchEvent(new CustomEvent(fr,{detail:{offerSelect:r},bubbles:!0}))}get dynamicPrice(){return this.querySelector('[slot="price"]')}selectMerchOffer(r){if(r===this.merchOffer)return;this.merchOffer=r;let n=this.dynamicPrice;if(r.price&&n){let i=r.price.cloneNode(!0);n.onceSettled?n.onceSettled().then(()=>{n.replaceWith(i)}):n.replaceWith(i)}}};$t=new WeakSet,zn=function(r){this.dispatchEvent(new CustomEvent(wn,{detail:r,bubbles:!0,composed:!0}))},p(Vt,"properties",{name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:r=>{let[n,i,o]=r.split(",");return{PUF:n,ABM:i,M2M:o}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:r=>Object.fromEntries(r.split(",").map(n=>{let[i,o,a]=n.split(":"),s=Number(o);return[i,{order:isNaN(s)?void 0:s,size:a}]})),toAttribute:r=>Object.entries(r).map(([n,{order:i,size:o}])=>[n,i,o].filter(a=>a!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:Er,reflect:!0}}),p(Vt,"styles",[ko,jo(),...Oo()]);customElements.define(Pc,Vt);var mt=class extends te{constructor(){super(),this.size="m",this.alt=""}render(){let{href:t}=this;return t?x`<a href="${t}">
