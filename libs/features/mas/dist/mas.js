...
`,Ho=()=>[P`
        ...
        `}get cardImage(){return x` <div class="image">
            ...
            ${this.badge}
              ...
              >`:"";return x`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){}};it=new WeakMap,p(Vt,"styleMap",{});var I=Vt;function le(e,t={},r=null,n=null){let i=n?document.createElement(e,{is:n}):document.createElement(e);r instanceof HTMLElement?i.appendChild(r):i.innerHTML=r;for(let[o,a]of Object.entries(t))i.setAttribute(o,a);return i}function gr(){return window.matchMedia("(max-width: 767px)").matches}function $o(){return window.matchMedia("(max-width: 1024px)").matches}var Fn={};Rs(Fn,{CLASS_NAME_FAILED:()=>kn,CLASS_NAME_HIDDEN:()=>Xs,CLASS_NAME_PENDING:()=>On,CLASS_NAME_RESOLVED:()=>Rn,ERROR_MESSAGE_BAD_REQUEST:()=>vr,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>nc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Vn,EVENT_AEM_ERROR:()=>He,EVENT_AEM_LOAD:()=>Me,EVENT_MAS_ERROR:()=>Nn,EVENT_MAS_READY:()=>In,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Pn,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>tc,EVENT_MERCH_CARD_COLLECTION_SORT:()=>ec,EVENT_MERCH_CARD_READY:()=>Cn,EVENT_MERCH_OFFER_READY:()=>qs,EVENT_MERCH_OFFER_SELECT_READY:()=>wn,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>br,EVENT_MERCH_SEARCH_CHANGE:()=>Qs,EVENT_MERCH_SIDENAV_SELECT:()=>rc,EVENT_MERCH_STOCK_CHANGE:()=>Js,EVENT_MERCH_STORAGE_CHANGE:()=>xr,EVENT_OFFER_SELECTED:()=>Zs,EVENT_TYPE_FAILED:()=>Mn,EVENT_TYPE_PENDING:()=>Hn,EVENT_TYPE_READY:()=>ot,EVENT_TYPE_RESOLVED:()=>$n,LOG_NAMESPACE:()=>Un,Landscape:()=>$e,NAMESPACE:()=>Ys,PARAM_AOS_API_KEY:()=>ic,PARAM_ENV:()=>Dn,PARAM_LANDSCAPE:()=>Bn,PARAM_WCS_API_KEY:()=>oc,STATE_FAILED:()=>he,STATE_PENDING:()=>ue,STATE_RESOLVED:()=>de,TAG_NAME_SERVICE:()=>Ws,WCS_PROD_URL:()=>Gn,WCS_STAGE_URL:()=>zn});var Ys="merch",Xs="hidden",ot="wcms:commerce:ready",Ws="mas-commerce-service",qs="merch-offer:ready",wn="merch-offer-select:ready",Cn="merch-card:ready",Pn="merch-card:action-menu-toggle",Zs="merch-offer:selected",Js="merch-stock:change",xr="merch-storage:change",br="merch-quantity-selector:change",Qs="merch-search:change",ec="merch-card-collection:sort",tc="merch-card-collection:showmore",rc="merch-sidenav:select",Me="aem:load",He="aem:error",In="mas:ready",Nn="mas:error",kn="placeholder-failed",On="placeholder-pending",Rn="placeholder-resolved",vr="Bad WCS request",Vn="Commerce offer not found",nc="Literals URL not provided",Mn="mas:failed",Hn="mas:pending",$n="mas:resolved",Un="mas/commerce",Dn="commerce.env",Bn="commerce.landscape",ic="commerce.aosKey",oc="commerce.wcsKey",Gn="https://www.adobe.com/web_commerce_artifact",zn="https://www.stage.adobe.com/web_commerce_artifact_stage",he="failed",ue="pending",de="resolved",$e={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"};var Uo=`
:root {
...
`;var Ar=class extends I{constructor(t){super(t)}getGlobalCSS(){return Do}renderLayout(){return x`${this.cardImage}
    <div class="body">
...
`;var Er=class extends I{constructor(t){super(t)}getGlobalCSS(){return Bo}renderLayout(){return x` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var sc=32,st=class extends I{constructor(r){super(r);p(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);p(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
              <span class="secure-transaction-label"
                  >${this.card.secureLabel}</span
              ></slot
          >`:x`<slot name="secure-transaction-label"></slot>`;return x`<footer>${r}<slot name="footer"></slot></footer>`})}getGlobalCSS(){return Go}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2)return;this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".top-section"),"top-section"),["heading-m","body-m","heading-m-price","body-xxs","price-commitment","offers","promo-text","callout-content"].forEach(i=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${i}"]`),i)),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector("footer"),"footer");let n=this.card.shadowRoot.querySelector(".mini-compare-chart-badge");n&&n.textContent!==""&&this.getContainer().style.setProperty("--consonant-merch-card-mini-compare-chart-top-section-mobile-height","32px")}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;[...this.card.querySelector('[slot="footer-rows"]')?.children].forEach((n,i)=>{let o=Math.max(sc,parseFloat(window.getComputedStyle(n).height)||0),a=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(i+1)))||0;o>a&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(i+1),`${o}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(n=>{let i=n.querySelector(".footer-row-cell-description");i&&!i.textContent.trim()&&n.remove()})}renderLayout(){return x` <div class="top-section${this.badge?" badge":""}">
            <slot name="icons"></slot> ${this.badge}
        </div>
        <slot name="heading-m"></slot>
...
`;var ct=class extends I{constructor(t){super(t)}getGlobalCSS(){return zo}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
...
`;var lt=class extends I{constructor(t){super(t)}getGlobalCSS(){return Ko}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
        ${this.promoBottom?"":x`<slot name="promo-text"></slot><slot name="callout-content"></slot>`}
...
`;var ut=class extends I{constructor(t){super(t)}getGlobalCSS(){return Yo}renderLayout(){return x`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
...
`;var lc={mnemonics:{size:"l"},subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"cta",size:"M"}},dt=class extends I{getGlobalCSS(){return Xo}get aemFragmentMapping(){return lc}get stripStyle(){return this.card.backgroundImage?`
...
`;var hc={mnemonics:{size:"m"},backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{slot:"footer",size:"S"},allowedSizes:["wide"]},mt=class extends I{getGlobalCSS(){return Wo}get aemFragmentMapping(){return hc}renderLayout(){return x` <div class="content">
                <div class="top-section">
                  <slot name="icons"></slot> 
                  ${this.badge}
                </div>  
    ...
    `);var Kn=(e,t=!1)=>{switch(e.variant){case"catalog":return new at(e);case"image":return new Ar(e);case"inline-heading":return new Er(e);case"mini-compare-chart":return new st(e);case"plans":return new ct(e);case"product":return new Ue(e);case"segment":return new lt(e);case"special-offers":return new ht(e);case"twp":return new ut(e);case"ccd-suggested":return new dt(e);case"ccd-slice":return new mt(e);default:return t?void 0:new Ue(e)}},qo=()=>{let e=[];return e.push(at.variantStyle),e.push(st.variantStyle),e.push(Ue.variantStyle),e.push(ct.variantStyle),e.push(lt.variantStyle),e.push(ht.variantStyle),e.push(ut.variantStyle),e.push(dt.variantStyle),e.push(mt.variantStyle),e};var Zo=document.createElement("style");Zo.innerHTML=`
:root {
...
`,Ge.MISSING_INTL_API,a);var N=r.getPluralRules(t,{type:h.pluralType}).select(d-(h.offset||0));S=h.options[N]||h.options.other}if(!S)throw new Si(h.value,d,Object.keys(h.options),a);s.push.apply(s,Kt(S.value,t,r,n,i,d-(h.offset||0)));continue}}return sl(s)}function ll(e,t){return t?A(A(A({},e||{}),t||{}),Object.keys(e).reduce(function(r,n){return r[n]=A(A({},e[n]),t[n]||{}),r},{})):e}function hl(e,t){return t?Object.keys(e).reduce(function(r,n){return r[n]=ll(e[n],t[n]),r},A({},e)):e}function Ti(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function ul(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:zt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.NumberFormat).bind.apply(t,Cr([void 0],r,!1)))},{cache:Ti(e.number),strategy:Mr.variadic}),getDateTimeFormat:zt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.DateTimeFormat).bind.apply(t,Cr([void 0],r,!1)))},{cache:Ti(e.dateTime),strategy:Mr.variadic}),getPluralRules:zt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.PluralRules).bind.apply(t,Cr([void 0],r,!1)))},{cache:Ti(e.pluralRules),strategy:Mr.variadic})}}var Ra=function(){function e(t,r,n,i){var o=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(a){var s=o.formatToParts(a);if(s.length===1)return s[0].value;var c=s.reduce(function(l,h){return!l.length||h.type!==K.literal||typeof l[l.length-1]!="string"?l.push(h.value):l[l.length-1]+=h.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(a){return Kt(o.ast,o.locales,o.formatters,o.formats,a,void 0,o.message)},this.resolvedOptions=function(){return{locale:o.resolvedLocale.toString()}},this.getAst=function(){return o.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=hl(e.formats,n),this.formatters=i&&i.formatters||ul(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=Pa,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var Va=Ra;var dl=/[0-9\-+#]/,ml=/[^\d\-+#]/g;function Ma(e){return e.search(dl)}function pl(e="#.##"){let t={},r=e.length,n=Ma(e);t.prefix=n>0?e.substring(0,n):"";let i=Ma(e.split("").reverse().join("")),o=r-i,a=e.substring(o,o+1),s=o+(a==="."||a===","?1:0);t.suffix=i>0?e.substring(s,r):"",t.mask=e.substring(n,s),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let c=t.mask.match(ml);return t.decimal=c&&c[c.length-1]||".",t.separator=c&&c[1]&&c[0]||",",c=t.mask.split(t.decimal),t.integer=c[0],t.fraction=c[1],t}function fl(e,t,r){let n=!1,i={value:e};e<0&&(n=!0,i.value=-i.value),i.sign=n?"-":"",i.value=Number(i.value).toFixed(t.fraction&&t.fraction.length),i.value=Number(i.value).toString();let o=t.fraction&&t.fraction.lastIndexOf("0"),[a="0",s=""]=i.value.split(".");return(!s||s&&s.length<=o)&&(s=o<0?"":(+("0."+s)).toFixed(o+1).replace("0.","")),i.integer=a,i.fraction=s,gl(i,t),(i.result==="0"||i.result==="")&&(n=!1,i.sign=""),!n&&t.maskHasPositiveSign?i.sign="+":n&&t.maskHasPositiveSign?i.sign="-":n&&(i.sign=r&&r.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),i}function gl(e,t){e.result="";let r=t.integer.split(t.separator),n=r.join(""),i=n&&n.indexOf("0");if(i>-1)for(;e.integer.length<n.length-i;)e.integer="0"+e.integer;else Number(e.integer)===0&&(e.integer="");let o=r[1]&&r[r.length-1].length;if(o){let a=e.integer.length,s=a%o;for(let c=0;c<a;c++)e.result+=e.integer.charAt(c),!((c-s+1)%o)&&c<a-o&&(e.result+=t.separator)}else e.result=e.integer;return e.result+=t.fraction&&e.fraction?t.decimal+e.fraction:"",e}function xl(e,t,r={}){if(!e||isNaN(Number(t)))return t;let n=pl(e),i=fl(t,n,r);return n.prefix+i.sign+i.result+n.suffix}var Ha=xl;var $a=".",bl=",",Da=/^\s+/,Ba=/\s+$/,Ua="&nbsp;",jt={MONTH:"MONTH",YEAR:"YEAR"},vl={[k.ANNUAL]:12,[k.MONTHLY]:1,[k.THREE_YEARS]:36,[k.TWO_YEARS]:24},Al={CHF:e=>Math.round(e*20)/20},yi=(e,t)=>({accept:e,round:t}),El=[yi(({divisor:e,price:t})=>t%e==0,({divisor:e,price:t})=>t/e),yi(({usePrecision:e})=>e,({divisor:e,price:t})=>Math.ceil(Math.floor(t*1e4/e)/100)/100),yi(()=>!0,({divisor:e,price:t})=>Math.ceil(Math.floor(t*100/e)/100))],Li={[U.YEAR]:{[k.MONTHLY]:jt.MONTH,[k.ANNUAL]:jt.YEAR},[U.MONTH]:{[k.MONTHLY]:jt.MONTH}},Sl=(e,t)=>e.indexOf(`'${t}'`)===0,Tl=(e,t=!0)=>{let r=e.replace(/'.*?'/,"").trim(),n=za(r);return!!n?t||(r=r.replace(/[,\.]0+/,n)):r=r.replace(/\s?(#.*0)(?!\s)?/,"$&"+Ll(e)),r},yl=e=>{let t=_l(e),r=Sl(e,t),n=e.replace(/'.*?'/,""),i=Da.test(n)||Ba.test(n);return{currencySymbol:t,isCurrencyFirst:r,hasCurrencySpace:i}},Ga=e=>e.replace(Da,Ua).replace(Ba,Ua),Ll=e=>e.match(/#(.?)#/)?.[1]===$a?bl:$a,_l=e=>e.match(/'(.*?)'/)?.[1]??"",za=e=>e.match(/0(.?)0/)?.[1]??"";function Hr({formatString:e,price:t,usePrecision:r,isIndianPrice:n=!1},i,o=a=>a){let{currencySymbol:a,isCurrencyFirst:s,hasCurrencySpace:c}=yl(e),l=r?za(e):"",h=Tl(e,r),u=r?2:0,d=o(t,{currencySymbol:a}),m=n?d.toLocaleString("hi-IN",{minimumFractionDigits:u,maximumFractionDigits:u}):Ha(h,d),f=r?m.lastIndexOf(l):m.length,g=m.substring(0,f),L=m.substring(f+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,m).replace(/SYMBOL/,a),currencySymbol:a,decimals:L,decimalsDelimiter:l,hasCurrencySpace:c,integer:g,isCurrencyFirst:s,recurrenceTerm:i}}var Fa=e=>{let{commitment:t,term:r,usePrecision:n}=e,i=vl[r]??1;return Hr(e,i>1?jt.MONTH:Li[t]?.[r],(o,{currencySymbol:a})=>{let s={divisor:i,price:o,usePrecision:n},{round:c}=El.find(({accept:h})=>h(s));if(!c)throw new Error(`Missing rounding rule for: ${JSON.stringify(s)}`);return(Al[a]??(h=>h))(c(s))})},Ka=({commitment:e,term:t,...r})=>Hr(r,Li[e]?.[t]),ja=e=>{let{commitment:t,term:r}=e;return t===U.YEAR&&r===k.MONTHLY?Hr(e,jt.YEAR,n=>n*12):Hr(e,Li[t]?.[r])};var wl={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at {alternativePrice}",strikethroughAriaLabel:"Regularly at {strikethroughPrice}"},Cl=oa("ConsonantTemplates/price"),Pl=/<\/?[^>]+(>|$)/g,z={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},ze={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel"},Il="TAX_EXCLUSIVE",Nl=e=>ia(e)?Object.entries(e).filter(([,t])=>ft(t)||Lr(t)||t===!0).reduce((t,[r,n])=>t+` ${r}${n===!0?"":'="'+ra(n)+'"'}`,""):"",Y=(e,t,r,n=!1)=>`<span class="${e}${t?"":" "+z.disabled}"${Nl(r)}>${n?Ga(t):t??""}</span>`;function kl(e,{accessibleLabel:t,currencySymbol:r,decimals:n,decimalsDelimiter:i,hasCurrencySpace:o,integer:a,isCurrencyFirst:s,recurrenceLabel:c,perUnitLabel:l,taxInclusivityLabel:h},u={}){let d=Y(z.currencySymbol,r),m=Y(z.currencySpace,o?"&nbsp;":""),f="";return s&&(f+=d+m),f+=Y(z.integer,a),f+=Y(z.decimalsDelimiter,i),f+=Y(z.decimals,n),s||(f+=m+d),f+=Y(z.recurrence,c,null,!0),f+=Y(z.unitType,l,null,!0),f+=Y(z.taxInclusivity,h,!0),Y(e,f,{...u,"aria-label":t})}var W=({displayOptical:e=!1,displayStrikethrough:t=!1,displayAnnual:r=!1}={})=>({country:n,displayFormatted:i=!0,displayRecurrence:o=!0,displayPerUnit:a=!1,displayTax:s=!1,language:c,literals:l={}}={},{commitment:h,offerSelectorIds:u,formatString:d,price:m,priceWithoutDiscount:f,taxDisplay:g,taxTerm:L,term:w,usePrecision:b}={},S={})=>{Object.entries({country:n,formatString:d,language:c,price:m}).forEach(([se,Xr])=>{if(Xr==null)throw new Error(`Argument "${se}" is missing for osi ${u?.toString()}, country ${n}, language ${c}`)});let N={...wl,...l},R=`${c.toLowerCase()}-${n.toUpperCase()}`;function V(se,Xr){let Wr=N[se];if(Wr==null)return"";try{return new Va(Wr.replace(Pl,""),R).format(Xr)}catch{return Cl.error("Failed to format literal:",Wr),""}}let $=t&&f?f:m,oe=e?Fa:Ka;r&&(oe=ja);let{accessiblePrice:We,recurrenceTerm:_e,...qe}=oe({commitment:h,formatString:d,term:w,price:e?m:$,usePrecision:b,isIndianPrice:n==="IN"}),J=We,ge="";if(T(o)&&_e){let se=V(ze.recurrenceAriaLabel,{recurrenceTerm:_e});se&&(J+=" "+se),ge=V(ze.recurrenceLabel,{recurrenceTerm:_e})}let ae="";if(T(a)){ae=V(ze.perUnitLabel,{perUnit:"LICENSE"});let se=V(ze.perUnitAriaLabel,{perUnit:"LICENSE"});se&&(J+=" "+se)}let Q="";T(s)&&L&&(Q=V(g===Il?ze.taxExclusiveLabel:ze.taxInclusiveLabel,{taxTerm:L}),Q&&(J+=" "+Q)),t&&(J=V(ze.strikethroughAriaLabel,{strikethroughPrice:J}));let we=z.container;if(e&&(we+=" "+z.containerOptical),t&&(we+=" "+z.containerStrikethrough),r&&(we+=" "+z.containerAnnual),T(i))return kl(we,{...qe,accessibleLabel:J,recurrenceLabel:ge,perUnitLabel:ae,taxInclusivityLabel:Q},S);let{currencySymbol:qi,decimals:Ss,decimalsDelimiter:Ts,hasCurrencySpace:Zi,integer:ys,isCurrencyFirst:Ls}=qe,Ze=[ys,Ts,Ss];Ls?(Ze.unshift(Zi?"\xA0":""),Ze.unshift(qi)):(Ze.push(Zi?"\xA0":""),Ze.push(qi)),Ze.push(ge,ae,Q);let _s=Ze.join("");return Y(we,_s,S)},Ya=()=>(e,t,r)=>{let i=(e.displayOldPrice===void 0||T(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${W()(e,t,r)}${i?"&nbsp;"+W({displayStrikethrough:!0})(e,t,r):""}`},Xa=()=>(e,t,r)=>{let n={...e,displayTax:!1,displayPerUnit:!1};return`${(e.displayOldPrice===void 0||T(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price?W({displayStrikethrough:!0})(n,t,r)+"&nbsp;":""}${W()(e,t,r)}${Y(z.containerAnnualPrefix,"&nbsp;(")}${W({displayAnnual:!0})(n,t,r)}${Y(z.containerAnnualSuffix,")")}`},Wa=()=>(e,t,r)=>{let n={...e,displayTax:!1,displayPerUnit:!1};return`${W()(e,t,r)}${Y(z.containerAnnualPrefix,"&nbsp;(")}${W({displayAnnual:!0})(n,t,r)}${Y(z.containerAnnualSuffix,")")}`};var _i=W(),wi=Ya(),Ci=W({displayOptical:!0}),Pi=W({displayStrikethrough:!0}),Ii=W({displayAnnual:!0}),Ni=Wa(),ki=Xa();var Ol=(e,t)=>{if(!(!xt(e)||!xt(t)))return Math.floor((t-e)/t*100)},qa=()=>(e,t)=>{let{price:r,priceWithoutDiscount:n}=t,i=Ol(r,n);return i===void 0?'<span class="no-discount"></span>':`<span class="discount">${i}%</span>`};var Oi=qa();var{freeze:Yt}=Object,te=Yt({...De}),re=Yt({...Z}),Fe={STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"},Ri=Yt({...U}),Vi=Yt({...sa}),Mi=Yt({...k});var Za="mas-commerce-service";function Ja(e,{once:t=!1}={}){let r=null;function n(){let i=document.querySelector(Za);i!==r&&(r=i,i&&e(i))}return document.addEventListener(ot,n,{once:t}),Te(n),()=>document.removeEventListener(ot,n)}function Xt(e,{country:t,forceTaxExclusive:r,perpetual:n}){let i;if(e.length<2)i=e;else{let o=t==="GB"||n?"EN":"MULT",[a,s]=e;i=[a.language===o?a:s]}return r&&(i=i.map(li)),i}var Te=e=>window.setTimeout(e);function At(e,t=1){if(e==null)return[t];let r=(Array.isArray(e)?e:String(e).split(",")).map(vt).filter(xt);return r.length||(r=[t]),r}function $r(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(ri)}function q(){return document.getElementsByTagName(Za)?.[0]}var Ke={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals"],serializableTypes:["Array","Object"],sampleRate:1,tags:"acom",isProdDomain:!1},Qa=1e3,es=new Set;function Rl(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function ts(e){if(e==null)return;let t=typeof e;if(t==="function")return e.name?`function ${e.name}`:"function";if(t==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:n,originatingRequest:i,status:o}=e;return[n,o,i].filter(Boolean).join(" ")}let r=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!Ke.serializableTypes.includes(r))return r}return e}function Vl(e,t){if(!Ke.ignoredProperties.includes(e))return ts(t)}var Hi={append(e){if(e.level!=="error")return;let{message:t,params:r}=e,n=[],i=[],o=t;r.forEach(l=>{l!=null&&(Rl(l)?n:i).push(l)}),n.length&&(o+=" "+n.map(ts).join(" "));let{pathname:a,search:s}=window.location,c=`${Ke.delimiter}page=${a}${s}`;c.length>Qa&&(c=`${c.slice(0,Qa)}<trunc>`),o+=c,i.length&&(o+=`${Ke.delimiter}facts=`,o+=JSON.stringify(i,Vl)),es.has(o)||(es.add(o),window.lana?.log(o,Ke))}};function Et(e){Object.assign(Ke,Object.fromEntries(Object.entries(e).filter(([t,r])=>t in Ke&&r!==""&&r!==null&&r!==void 0&&!Number.isNaN(r))))}var _=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflow:te.V3,checkoutWorkflowStep:re.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,env:Fe.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsBufferDelay:1,wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:$e.PUBLISHED,wcsBufferLimit:1});var $i=Object.freeze({LOCAL:"local",PROD:"prod",STAGE:"stage"});function Ml({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||_.language),t??(t=e?.split("_")?.[1]||_.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function Ui(e={}){let{commerce:t={}}=e,r=Fe.PRODUCTION,n=Gn,i=O("checkoutClientId",t)??_.checkoutClientId,o=Se(O("checkoutWorkflow",t),te,_.checkoutWorkflow),a=re.CHECKOUT;o===te.V3&&(a=Se(O("checkoutWorkflowStep",t),re,_.checkoutWorkflowStep));let s=T(O("displayOldPrice",t),_.displayOldPrice),c=T(O("displayPerUnit",t),_.displayPerUnit),l=T(O("displayRecurrence",t),_.displayRecurrence),h=T(O("displayTax",t),_.displayTax),u=T(O("entitlement",t),_.entitlement),d=T(O("modal",t),_.modal),m=T(O("forceTaxExclusive",t),_.forceTaxExclusive),f=O("promotionCode",t)??_.promotionCode,g=At(O("quantity",t)),L=O("wcsApiKey",t)??_.wcsApiKey,w=t?.env==="stage",b=$e.PUBLISHED;["true",""].includes(t.allowOverride)&&(w=(O(Dn,t,{metadata:!1})?.toLowerCase()??t?.env)==="stage",b=Se(O(Bn,t),$e,b)),w&&(r=Fe.STAGE,n=zn);let N=vt(O("wcsBufferDelay",t),_.wcsBufferDelay),R=vt(O("wcsBufferLimit",t),_.wcsBufferLimit);return{...Ml(e),displayOldPrice:s,checkoutClientId:i,checkoutWorkflow:o,checkoutWorkflowStep:a,displayPerUnit:c,displayRecurrence:l,displayTax:h,entitlement:u,extraOptions:_.extraOptions,modal:d,env:r,forceTaxExclusive:m,promotionCode:f,quantity:g,wcsApiKey:L,wcsBufferDelay:N,wcsBufferLimit:R,wcsURL:n,landscape:b}}var Di={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Hl=Date.now(),Bi=new Set,Gi=new Set,rs=new Map,ns={append({level:e,message:t,params:r,timestamp:n,source:i}){console[e](`${n}ms [${i}] %c${t}`,"font-weight: bold;",...r)}},is={filter:({level:e})=>e!==Di.DEBUG},$l={filter:()=>!1};function Ul(e,t,r,n,i){return{level:e,message:t,namespace:r,get params(){return n.length===1&&$t(n[0])&&(n=n[0](),Array.isArray(n)||(n=[n])),n},source:i,timestamp:Date.now()-Hl}}function Dl(e){[...Gi].every(t=>t(e))&&Bi.forEach(t=>t(e))}function os(e){let t=(rs.get(e)??0)+1;rs.set(e,t);let r=`${e} #${t}`,n={id:r,namespace:e,module:i=>os(`${n.namespace}/${i}`),updateConfig:Et};return Object.values(Di).forEach(i=>{n[i]=(o,...a)=>Dl(Ul(i,o,e,a,r))}),Object.seal(n)}function Ur(...e){e.forEach(t=>{let{append:r,filter:n}=t;$t(n)&&Gi.add(n),$t(r)&&Bi.add(r)})}function Bl(e={}){let{name:t}=e,r=T(O("commerce.debug",{search:!0,storage:!0}),t===$i.LOCAL);return Ur(r?ns:is),t===$i.PROD&&Ur(Hi),X}function Gl(){Bi.clear(),Gi.clear()}var X={...os(Un),Level:Di,Plugins:{consoleAppender:ns,debugFilter:is,quietFilter:$l,lanaAppender:Hi},init:Bl,reset:Gl,use:Ur};var zl={[he]:kn,[ue]:On,[de]:Rn},Fl={[he]:Mn,[ue]:Hn,[de]:$n},St=class{constructor(t){p(this,"changes",new Map);p(this,"connected",!1);p(this,"dispose",gt);p(this,"error");p(this,"log");p(this,"options");p(this,"promises",[]);p(this,"state",ue);p(this,"timer",null);p(this,"value");p(this,"version",0);p(this,"wrapperElement");this.wrapperElement=t}update(){[he,ue,de].forEach(t=>{this.wrapperElement.classList.toggle(zl[t],t===this.state)})}notify(){(this.state===de||this.state===he)&&(this.state===de?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===he&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]),this.wrapperElement.dispatchEvent(new CustomEvent(Fl[this.state],{bubbles:!0}))}attributeChangedCallback(t,r,n){this.changes.set(t,n),this.requestUpdate()}connectedCallback(){this.dispose=Ja(()=>this.requestUpdate(!0))}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement})),this.dispose(),this.dispose=gt}onceSettled(){let{error:t,promises:r,state:n}=this;return de===n?Promise.resolve(this.wrapperElement):he===n?Promise.reject(t):new Promise((i,o)=>{r.push({resolve:i,reject:o})})}toggleResolved(t,r,n){return t!==this.version?!1:(n!==void 0&&(this.options=n),this.state=de,this.value=r,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:r}),Te(()=>this.notify()),!0)}toggleFailed(t,r,n){return t!==this.version?!1:(n!==void 0&&(this.options=n),this.error=r,this.state=he,this.update(),this.log?.error("Failed:",{element:this.wrapperElement,error:r}),Te(()=>this.notify()),!0)}togglePending(t){return this.version++,t&&(this.options=t),this.state=ue,this.update(),Te(()=>this.notify()),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!q()||this.timer)return;let r=X.module("mas-element"),{error:n,options:i,state:o,value:a,version:s}=this;this.state=ue,this.timer=Te(async()=>{this.timer=null;let c=null;if(this.changes.size&&(c=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:c}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:c})),c||t)try{await this.wrapperElement.render?.()===!1&&this.state===ue&&this.version===s&&(this.state=o,this.error=n,this.value=a,this.update(),this.notify())}catch(l){r.error("Failed to render mas-element: ",l),this.toggleFailed(this.version,l,i)}})}};function as(e={}){return Object.entries(e).forEach(([t,r])=>{(r==null||r===""||r?.length===0)&&delete e[t]}),e}function Dr(e,t={}){let{tag:r,is:n}=e,i=document.createElement(r,{is:n});return i.setAttribute("is",n),Object.assign(i.dataset,as(t)),i}function Br(e,t={}){return e instanceof HTMLElement?(Object.assign(e.dataset,as(t)),e):null}var Kl="download",jl="upgrade";function Gr(e,t={},r=""){let n=q();if(!n)return null;let{checkoutMarketSegment:i,checkoutWorkflow:o,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:l,perpetual:h,promotionCode:u,quantity:d,wcsOsi:m,extraOptions:f}=n.collectCheckoutOptions(t),g=Dr(e,{checkoutMarketSegment:i,checkoutWorkflow:o,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:l,perpetual:h,promotionCode:u,quantity:d,wcsOsi:m,extraOptions:f});return r&&(g.innerHTML=`<span style="pointer-events: none;">${r}</span>`),g}function zr(e){return class extends e{constructor(){super(...arguments);p(this,"checkoutActionHandler");p(this,"masElement",new St(this))}attributeChangedCallback(n,i,o){this.masElement.attributeChangedCallback(n,i,o)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}requestUpdate(n=!1){return this.masElement.requestUpdate(n)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(n={}){if(!this.isConnected)return!1;let i=q();if(!i)return!1;this.dataset.imsCountry||i.imsCountryPromise.then(u=>{u&&(this.dataset.imsCountry=u)},gt),n.imsCountry=null;let o=i.collectCheckoutOptions(n,this);if(!o.wcsOsi.length)return!1;let a;try{a=JSON.parse(o.extraOptions??"{}")}catch(u){this.masElement.log?.error("cannot parse exta checkout options",u)}let s=this.masElement.togglePending(o);this.setCheckoutUrl("");let c=i.resolveOfferSelectors(o),l=await Promise.all(c);l=l.map(u=>Xt(u,o)),o.country=this.dataset.imsCountry||o.country;let h=await i.buildCheckoutAction?.(l.flat(),{...a,...o},this);return this.renderOffers(l.flat(),o,{},h,s)}renderOffers(n,i,o={},a=void 0,s=void 0){if(!this.isConnected)return!1;let c=q();if(!c)return!1;if(i={...JSON.parse(this.dataset.extraOptions??"null"),...i,...o},s??(s=this.masElement.togglePending(i)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),a){this.classList.remove(Kl,jl),this.masElement.toggleResolved(s,n,i);let{url:h,text:u,className:d,handler:m}=a;return h&&this.setCheckoutUrl(h),u&&(this.firstElementChild.innerHTML=u),d&&this.classList.add(...d.split(" ")),m&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=m.bind(this)),!0}else if(n.length){if(this.masElement.toggleResolved(s,n,i)){let h=c.buildCheckoutURL(n,i);return this.setCheckoutUrl(h),!0}}else{let h=new Error(`Not provided: ${i?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,h,i))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(n){}updateOptions(n={}){let i=q();if(!i)return!1;let{checkoutMarketSegment:o,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:h,perpetual:u,promotionCode:d,quantity:m,wcsOsi:f}=i.collectCheckoutOptions(n);return Br(this,{checkoutMarketSegment:o,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:h,perpetual:u,promotionCode:d,quantity:m,wcsOsi:f}),!0}}}var Ye,Wt=class Wt extends zr(HTMLButtonElement){constructor(){super(...arguments);D(this,Ye)}static createCheckoutButton(r={},n=""){return Gr(Wt,r,n)}setCheckoutUrl(r){j(this,Ye,r)}get href(){return y(this,Ye)}get isCheckoutButton(){return!0}clickHandler(r){if(this.checkoutActionHandler){this.checkoutActionHandler?.(r);return}y(this,Ye)&&(window.location.href=y(this,Ye))}};Ye=new WeakMap,p(Wt,"is","checkout-button"),p(Wt,"tag","button");var je=Wt;window.customElements.get(je.is)||window.customElements.define(je.is,je,{extends:je.tag});var Yl="#000000",Xl="#F8D904",Wl=/(accent|primary|secondary)(-(outline|link))?/,ql="mas:product_code/",Zl="daa-ll",Fr="daa-lh",Jl=["XL","L","M","S"];function Ql(e,t,r){e.mnemonicIcon?.map((i,o)=>({icon:i,alt:e.mnemonicAlt[o]??"",link:e.mnemonicLink[o]??""}))?.forEach(({icon:i,alt:o,link:a})=>{if(a&&!/^https?:/.test(a))try{a=new URL(`https://${a}`).href.toString()}catch{a="#"}let s={slot:"icons",src:i,size:r?.size??"l"};o&&(s.alt=o),a&&(s.href=a);let c=le("merch-icon",s);t.append(c)})}function eh(e,t){e.badge&&(t.setAttribute("badge-text",e.badge),t.setAttribute("badge-color",e.badgeColor||Yl),t.setAttribute("badge-background-color",e.badgeBackgroundColor||Xl))}function th(e,t,r){r?.includes(e.size)&&t.setAttribute("size",e.size)}function rh(e,t,r){e.cardTitle&&r&&t.append(le(r.tag,{slot:r.slot},e.cardTitle))}function nh(e,t,r){e.subtitle&&r&&t.append(le(r.tag,{slot:r.slot},e.subtitle))}function ih(e,t,r,n){if(e.backgroundImage)switch(n){case"ccd-slice":r&&t.append(le(r.tag,{slot:r.slot},`<img loading="lazy" src="${e.backgroundImage}" />`));break;case"ccd-suggested":t.setAttribute("background-image",e.backgroundImage);break}}function oh(e,t,r){if(e.prices&&r){let n=le(r.tag,{slot:r.slot},e.prices);t.append(n)}}function ah(e,t,r){if(e.description&&r){let n=le(r.tag,{slot:r.slot},e.description);t.append(n)}}function sh(e,t,r,n){let o=customElements.get("checkout-button").createCheckoutButton({},e.innerHTML);for(let h of e.attributes)["class","is"].includes(h.name)||o.setAttribute(h.name,h.value);o.firstElementChild?.classList.add("spectrum-Button-label");let a=t.ctas.size??"M",s=`spectrum-Button--${n}`,c=Jl.includes(a)?`spectrum-Button--size${a}`:"spectrum-Button--sizeM",l=["spectrum-Button",s,c];return r&&l.push("spectrum-Button--outline"),o.classList.add(...l),o}function ch(e,t,r,n){let i="fill";r&&(i="outline");let o=le("sp-button",{treatment:i,variant:n,tabIndex:0,size:t.ctas.size??"m"},e);return o.addEventListener("click",a=>{a.target!==e&&(a.stopPropagation(),e.click())}),o}function lh(e,t){return e.classList.add("con-button"),t&&e.classList.add("blue"),e}function hh(e,t,r,n){if(e.ctas){let{slot:i}=r.ctas,o=le("div",{slot:i},e.ctas),a=[...o.querySelectorAll("a")].map(s=>{let c=s.parentElement.tagName==="STRONG";if(t.consonant)return lh(s,c);let l=Wl.exec(s.className)?.[0]??"accent",h=l.includes("accent"),u=l.includes("primary"),d=l.includes("secondary"),m=l.includes("-outline");if(l.includes("-link"))return s;let g;return h||c?g="accent":u?g="primary":d&&(g="secondary"),s.tabIndex=-1,t.spectrum==="swc"?ch(s,r,m,g):sh(s,r,m,g)});o.innerHTML="",o.append(...a),t.append(o)}}function uh(e,t){let{tags:r}=e,n=r?.find(i=>i.startsWith(ql))?.split("/").pop();n&&(t.setAttribute(Fr,n),t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]").forEach((i,o)=>{i.setAttribute(Zl,`${i.dataset.analyticsId}-${o+1}`)}))}function dh(e){[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,r])=>{e.querySelectorAll(`a.${t}`).forEach(n=>{n.classList.remove(t),n.classList.add("spectrum-Link",`spectrum-Link--${r}`)})})}async function ss(e,t){let{fields:r}=e,{variant:n}=r;if(!n)return;t.querySelectorAll("[slot]").forEach(o=>{o.remove()}),t.removeAttribute("background-image"),t.removeAttribute("badge-background-color"),t.removeAttribute("badge-color"),t.removeAttribute("badge-text"),t.removeAttribute("size"),t.classList.remove("wide-strip"),t.classList.remove("thin-strip"),t.removeAttribute(Fr),t.variant=n,await t.updateComplete;let{aemFragmentMapping:i}=t.variantLayout;i&&(Ql(r,t,i.mnemonics),eh(r,t),th(r,t,i.allowedSizes),rh(r,t,i.title),nh(r,t,i.subtitle),oh(r,t,i.prices),ih(r,t,i.backgroundImage,n),ah(r,t,i.description),hh(r,t,i,n),uh(r,t),dh(t))}var mh="merch-card",ph=1e4,Fi,Zt,zi,qt=class extends ee{constructor(){super();D(this,Zt);p(this,"customerSegment");p(this,"marketSegment");p(this,"variantLayout");D(this,Fi,!1);this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this)}firstUpdated(){this.variantLayout=Kn(this,!1),this.variantLayout?.connectedCallbackHook(),this.aemFragment?.updateComplete.catch(()=>{this.style.display="none"})}willUpdate(r){(r.has("variant")||!this.variantLayout)&&(this.variantLayout=Kn(this),this.variantLayout.connectedCallbackHook())}updated(r){(r.has("badgeBackgroundColor")||r.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border",this.computedBorderStyle),this.variantLayout?.postCardUpdateHook(r)}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}get prices(){return Array.from(this.querySelectorAll('span[is="inline-price"][data-wcs-osi]'))}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["twp","ccd-slice","ccd-suggested"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector('span[is="inline-price"]')}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll('a[is="checkout-link"]')??[]]}async toggleStockOffer({target:r}){if(!this.stockOfferOsis)return;let n=this.checkoutLinks;if(n.length!==0)for(let i of n){await i.onceSettled();let o=i.value?.[0]?.planType;if(!o)return;let a=this.stockOfferOsis[o];if(!a)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==a);r.checked&&s.push(a),i.dataset.wcsOsi=s.join(",")}}handleQuantitySelection(r){let n=this.checkoutLinks;for(let i of n)i.dataset.quantity=r.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(r){let n={...this.filters};Object.keys(n).forEach(i=>{if(r){n[i].order=Math.min(n[i].order||2,2);return}let o=n[i].order;o===1||isNaN(o)||(n[i].order=Number(o)+1)}),this.filters=n}includes(r){return this.textContent.match(new RegExp(r,"i"))!==null}connectedCallback(){super.connectedCallback(),this.addEventListener(br,this.handleQuantitySelection),this.addEventListener(wn,this.merchCardReady,{once:!0}),this.updateComplete.then(()=>{this.merchCardReady()}),this.storageOptions?.addEventListener("change",this.handleStorageChange),this.addEventListener(He,this.handleAemFragmentEvents),this.addEventListener(Me,this.handleAemFragmentEvents),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(br,this.handleQuantitySelection),this.storageOptions?.removeEventListener(xr,this.handleStorageChange),this.removeEventListener(He,this.handleAemFragmentEvents),this.removeEventListener(Me,this.handleAemFragmentEvents)}async handleAemFragmentEvents(r){if(r.type===He&&xe(this,Zt,zi).call(this,"AEM fragment cannot be loaded"),r.type===Me&&r.target.nodeName==="AEM-FRAGMENT"){let n=r.detail;await ss(n,this),this.checkReady()}}async checkReady(){let r=Promise.all([...this.querySelectorAll('span[is="inline-price"][data-wcs-osi],a[is="checkout-link"][data-wcs-osi]')].map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(a=>a.classList.contains("placeholder-resolved"))),n=new Promise(o=>setTimeout(()=>o(!1),ph));if(await Promise.race([r,n])===!0){this.dispatchEvent(new CustomEvent(In,{bubbles:!0,composed:!0}));return}xe(this,Zt,zi).call(this,"Contains unresolved offers")}get aemFragment(){return this.querySelector("aem-fragment")}get storageOptions(){return this.querySelector("sp-radio-group#storage")}get storageSpecificOfferSelect(){let r=this.storageOptions?.selected;if(r){let n=this.querySelector(`merch-offer-select[storage="${r}"]`);if(n)return n}return this.querySelector("merch-offer-select")}get offerSelect(){return this.storageOptions?this.storageSpecificOfferSelect:this.querySelector("merch-offer-select")}get quantitySelect(){return this.querySelector("merch-quantity-select")}merchCardReady(){this.offerSelect&&!this.offerSelect.planType||this.dispatchEvent(new CustomEvent(Cn,{bubbles:!0}))}handleStorageChange(){let r=this.closest("merch-card")?.offerSelect.cloneNode(!0);r&&this.dispatchEvent(new CustomEvent(xr,{detail:{offerSelect:r},bubbles:!0}))}get dynamicPrice(){return this.querySelector('[slot="price"]')}selectMerchOffer(r){if(r===this.merchOffer)return;this.merchOffer=r;let n=this.dynamicPrice;if(r.price&&n){let i=r.price.cloneNode(!0);n.onceSettled?n.onceSettled().then(()=>{n.replaceWith(i)}):n.replaceWith(i)}}};Fi=new WeakMap,Zt=new WeakSet,zi=function(r){this.dispatchEvent(new CustomEvent(Nn,{detail:r,bubbles:!0,composed:!0}))},p(qt,"properties",{name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:r=>{let[n,i,o]=r.split(",");return{PUF:n,ABM:i,M2M:o}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:r=>Object.fromEntries(r.split(",").map(n=>{let[i,o,a]=n.split(":"),s=Number(o);return[i,{order:isNaN(s)?void 0:s,size:a}]})),toAttribute:r=>Object.entries(r).map(([n,{order:i,size:o}])=>[n,i,o].filter(a=>a!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:Fr,reflect:!0}}),p(qt,"styles",[Mo,qo(),...Ho()]);customElements.define(mh,qt);var Tt=class extends ee{constructor(){super(),this.size="m",this.alt=""}render(){let{href:t}=this;return t?x`<a href="${t}">
    ...
    `);customElements.define("merch-icon",Tt);var us=new CSSStyleSheet;us.replaceSync(":host { display: contents; }");var fh=document.querySelector('meta[name="aem-base-url"]')?.content??"https://odin.adobe.com",cs="fragment",ls="author",gh="ims",hs=e=>{throw new Error(`Failed to get fragment: ${e}`)};async function xh(e,t,r,n){let i=r?`${e}/adobe/sites/cf/fragments/${t}`:`${e}/adobe/sites/fragments/${t}`,o=await fetch(i,{cache:"default",credentials:"omit",headers:n}).catch(a=>hs(a.message));return o?.ok||hs(`${o.status} ${o.statusText}`),o.json()}var Ki,ye,ji=class{constructor(){D(this,ye,new Map)}clear(){y(this,ye).clear()}add(...t){t.forEach(r=>{let{id:n}=r;n&&y(this,ye).set(n,r)})}has(t){return y(this,ye).has(t)}get(t){return y(this,ye).get(t)}remove(t){y(this,ye).delete(t)}};ye=new WeakMap;var Kr=new ji,Xe,me,Le,Jt,pe,yt,fe,Xi,ds,ms,Yi=class extends HTMLElement{constructor(){super();D(this,fe);p(this,"cache",Kr);D(this,Xe);D(this,me);D(this,Le);D(this,Jt,!1);D(this,pe);D(this,yt,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[us];let r=this.getAttribute(gh);["",!0,"true"].includes(r)&&(j(this,Jt,!0),Ki||(Ki={Authorization:`Bearer ${window.adobeid?.authorize?.()}`}))}static get observedAttributes(){return[cs,ls]}attributeChangedCallback(r,n,i){r===cs&&(j(this,Le,i),this.refresh(!1)),r===ls&&j(this,yt,["","true"].includes(i))}connectedCallback(){if(!y(this,Le)){xe(this,fe,Xi).call(this,"Missing fragment id");return}}async refresh(r=!0){y(this,pe)&&!await Promise.race([y(this,pe),Promise.resolve(!1)])||(r&&Kr.remove(y(this,Le)),j(this,pe,this.fetchData().then(()=>(this.dispatchEvent(new CustomEvent(Me,{detail:this.data,bubbles:!0,composed:!0})),!0)).catch(n=>(xe(this,fe,Xi).call(this,"Network error: failed to load fragment"),j(this,pe,null),!1))),y(this,pe))}async fetchData(){j(this,Xe,null),j(this,me,null);let r=Kr.get(y(this,Le));r||(r=await xh(fh,y(this,Le),y(this,yt),y(this,Jt)?Ki:void 0),Kr.add(r)),j(this,Xe,r)}get updateComplete(){return y(this,pe)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return y(this,me)?y(this,me):(y(this,yt)?xe(this,fe,ds).call(this):xe(this,fe,ms).call(this),y(this,me))}};Xe=new WeakMap,me=new WeakMap,Le=new WeakMap,Jt=new WeakMap,pe=new WeakMap,yt=new WeakMap,fe=new WeakSet,Xi=function(r){this.classList.add("error"),this.dispatchEvent(new CustomEvent(He,{detail:r,bubbles:!0,composed:!0}))},ds=function(){let{id:r,tags:n,fields:i}=y(this,Xe);j(this,me,i.reduce((o,{name:a,multiple:s,values:c})=>(o.fields[a]=s?c:c[0],o),{id:r,tags:n,fields:{}}))},ms=function(){let{id:r,tags:n,fields:i}=y(this,Xe);j(this,me,Object.entries(i).reduce((o,[a,s])=>(o.fields[a]=s?.mimeType?s.value:s??"",o),{id:r,tags:n,fields:{}}))};customElements.define("aem-fragment",Yi);var Qt=class Qt extends zr(HTMLAnchorElement){static createCheckoutLink(t={},r=""){return Gr(Qt,t,r)}setCheckoutUrl(t){this.setAttribute("href",t)}get isCheckoutLink(){return!0}clickHandler(t){if(this.checkoutActionHandler){this.checkoutActionHandler?.(t);return}}};p(Qt,"is","checkout-link"),p(Qt,"tag","a");var ne=Qt;window.customElements.get(ne.is)||window.customElements.define(ne.is,ne,{extends:ne.tag});function ps({providers:e,settings:t}){function r(o,a){let{checkoutClientId:s,checkoutWorkflow:c,checkoutWorkflowStep:l,country:h,language:u,promotionCode:d,quantity:m}=t,{checkoutMarketSegment:f,checkoutWorkflow:g=c,checkoutWorkflowStep:L=l,imsCountry:w,country:b=w??h,language:S=u,quantity:N=m,entitlement:R,upgrade:V,modal:$,perpetual:oe,promotionCode:We=d,wcsOsi:_e,extraOptions:qe,...J}=Object.assign({},a?.dataset??{},o??{}),ge=Se(g,te,_.checkoutWorkflow),ae=re.CHECKOUT;ge===te.V3&&(ae=Se(L,re,_.checkoutWorkflowStep));let Q=bt({...J,extraOptions:qe,checkoutClientId:s,checkoutMarketSegment:f,country:b,quantity:At(N,_.quantity),checkoutWorkflow:ge,checkoutWorkflowStep:ae,language:S,entitlement:T(R),upgrade:T(V),modal:T($),perpetual:T(oe),promotionCode:Ut(We).effectivePromoCode,wcsOsi:$r(_e)});if(a)for(let we of e.checkout)we(a,Q);return Q}function n(o,a){if(!Array.isArray(o)||!o.length||!a)return"";let{env:s,landscape:c}=t,{checkoutClientId:l,checkoutMarketSegment:h,checkoutWorkflow:u,checkoutWorkflowStep:d,country:m,promotionCode:f,quantity:g,...L}=r(a),w=window.frameElement?"if":"fp",b={checkoutPromoCode:f,clientId:l,context:w,country:m,env:s,items:[],marketSegment:h,workflowStep:d,landscape:c,...L};if(o.length===1){let[{offerId:S,offerType:N,productArrangementCode:R}]=o,{marketSegments:[V]}=o[0];Object.assign(b,{marketSegment:V,offerType:N,productArrangementCode:R}),b.items.push(g[0]===1?{id:S}:{id:S,quantity:g[0]})}else b.items.push(...o.map(({offerId:S},N)=>({id:S,quantity:g[N]??_.quantity})));return qn(u,b)}let{createCheckoutLink:i}=ne;return{CheckoutLink:ne,CheckoutWorkflow:te,CheckoutWorkflowStep:re,buildCheckoutURL:n,collectCheckoutOptions:r,createCheckoutLink:i}}function bh({interval:e=200,maxAttempts:t=25}={}){let r=X.module("ims");return new Promise(n=>{r.debug("Waing for IMS to be ready");let i=0;function o(){window.adobeIMS?.initialized?n():++i>t?(r.debug("Timeout"),n()):setTimeout(o,e)}o()})}function vh(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function Ah(e){let t=X.module("ims");return e.then(r=>r?window.adobeIMS.getProfile().then(({countryCode:n})=>(t.debug("Got user country:",n),n),n=>{t.error("Unable to get user country:",n)}):null)}function fs({}){let e=bh(),t=vh(e),r=Ah(t);return{imsReadyPromise:e,imsSignedInPromise:t,imsCountryPromise:r}}async function xs(e,t){let{data:r}=t||await Promise.resolve().then(()=>Ms(gs(),1));if(Array.isArray(r)){let n=o=>r.find(a=>yr(a.lang,o)),i=n(e.language)??n(_.language);if(i)return Object.freeze(i)}return{}}var bs=["GB_en","AU_en","FR_fr","AT_de","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GR_el","GR_en","HU_hu","IE_en","IT_it","LU_de","LU_en","LU_fr","NL_nl","NO_nb","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TR_tr","UA_uk","ID_en","ID_in","IN_en","IN_hi","JP_ja","MY_en","MY_ms","NZ_en","TH_en","TH_th"],Sh={INDIVIDUAL_COM:["ZA_en","LT_lt","LV_lv","NG_en","SA_ar","SA_en","ZA_en","SG_en","KR_ko"],TEAM_COM:["ZA_en","LT_lt","LV_lv","NG_en","ZA_en","CO_es","KR_ko"],INDIVIDUAL_EDU:["LT_lt","LV_lv","SA_en","SG_en"],TEAM_EDU:["SG_en","KR_ko"]},er=class er extends HTMLSpanElement{constructor(){super();p(this,"masElement",new St(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-perpetual","data-promotion-code","data-tax-exclusive","data-template","data-wcs-osi"]}static createInlinePrice(r){let n=q();if(!n)return null;let{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:u,template:d,wcsOsi:m}=n.collectPriceOptions(r);return Dr(er,{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:u,template:d,wcsOsi:m})}get isInlinePrice(){return!0}attributeChangedCallback(r,n,i){this.masElement.attributeChangedCallback(r,n,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}resolveDisplayTaxForGeoAndSegment(r,n,i,o){let a=`${r}_${n}`;if(bs.includes(r)||bs.includes(a))return!0;let s=Sh[`${i}_${o}`];return s?!!(s.includes(r)||s.includes(a)):!1}async resolveDisplayTax(r,n){let[i]=await r.resolveOfferSelectors(n),o=Xt(await i,n);if(o?.length){let{country:a,language:s}=n,c=o[0],[l=""]=c.marketSegments;return this.resolveDisplayTaxForGeoAndSegment(a,s,c.customerSegment,l)}}async render(r={}){if(!this.isConnected)return!1;let n=q();if(!n)return!1;let i=n.collectPriceOptions(r,this);if(!i.wcsOsi.length)return!1;let o=this.masElement.togglePending(i);this.innerHTML="";let[a]=n.resolveOfferSelectors(i);return this.renderOffers(Xt(await a,i),i,o)}renderOffers(r,n={},i=void 0){if(!this.isConnected)return;let o=q();if(!o)return!1;let a=o.collectPriceOptions({...this.dataset,...n},this);if(i??(i=this.masElement.togglePending(a)),r.length){if(this.masElement.toggleResolved(i,r,a))return this.innerHTML=o.buildPriceHTML(r,a),!0}else{let s=new Error(`Not provided: ${a?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,s,a))return this.innerHTML="",!0}return!1}updateOptions(r){let n=q();if(!n)return!1;let{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:u,template:d,wcsOsi:m}=n.collectPriceOptions(r);return Br(this,{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:u,template:d,wcsOsi:m}),!0}};p(er,"is","inline-price"),p(er,"tag","span");var ie=er;window.customElements.get(ie.is)||window.customElements.define(ie.is,ie,{extends:ie.tag});function vs({literals:e,providers:t,settings:r}){function n(a,s){let{country:c,displayOldPrice:l,displayPerUnit:h,displayRecurrence:u,displayTax:d,forceTaxExclusive:m,language:f,promotionCode:g,quantity:L}=r,{displayOldPrice:w=l,displayPerUnit:b=h,displayRecurrence:S=u,displayTax:N=d,forceTaxExclusive:R=m,country:V=c,language:$=f,perpetual:oe,promotionCode:We=g,quantity:_e=L,template:qe,wcsOsi:J,...ge}=Object.assign({},s?.dataset??{},a??{}),ae=bt({...ge,country:V,displayOldPrice:T(w),displayPerUnit:T(b),displayRecurrence:T(S),displayTax:T(N),forceTaxExclusive:T(R),language:$,perpetual:T(oe),promotionCode:Ut(We).effectivePromoCode,quantity:At(_e,_.quantity),template:qe,wcsOsi:$r(J)});if(s)for(let Q of t.price)Q(s,ae);return ae}function i(a,s){if(!Array.isArray(a)||!a.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=Oi;break;case"strikethrough":l=Pi;break;case"optical":l=Ci;break;case"annual":l=Ii;break;default:s.country==="AU"&&a[0].planType==="ABM"?l=s.promotionCode?ki:Ni:l=s.promotionCode?wi:_i}let h=n(s);h.literals=Object.assign({},e.price,bt(s.literals??{}));let[u]=a;return u={...u,...u.priceDetails},l(h,u)}let o=ie.createInlinePrice;return{InlinePrice:ie,buildPriceHTML:i,collectPriceOptions:n,createInlinePrice:o}}function As({settings:e}){let t=X.module("wcs"),{env:r,wcsApiKey:n}=e,i=new Map,o=new Map,a;async function s(u,d,m=!0){let f=Vn;t.debug("Fetching:",u);let g="",L,w=(b,S,N)=>`${b}: ${S?.status}, url: ${N.toString()}`;try{if(u.offerSelectorIds=u.offerSelectorIds.sort(),g=new URL(e.wcsURL),g.searchParams.set("offer_selector_ids",u.offerSelectorIds.join(",")),g.searchParams.set("country",u.country),g.searchParams.set("locale",u.locale),g.searchParams.set("landscape",r===Fe.STAGE?"ALL":e.landscape),g.searchParams.set("api_key",n),u.language&&g.searchParams.set("language",u.language),u.promotionCode&&g.searchParams.set("promotion_code",u.promotionCode),u.currency&&g.searchParams.set("currency",u.currency),L=await fetch(g.toString(),{credentials:"omit"}),L.ok){let b=await L.json();t.debug("Fetched:",u,b);let S=b.resolvedOffers??[];S=S.map(wr),d.forEach(({resolve:N},R)=>{let V=S.filter(({offerSelectorIds:$})=>$.includes(R)).flat();V.length&&(d.delete(R),N(V))})}else L.status===404&&u.offerSelectorIds.length>1?(t.debug("Multi-osi 404, fallback to fetch-by-one strategy"),await Promise.allSettled(u.offerSelectorIds.map(b=>s({...u,offerSelectorIds:[b]},d,!1)))):f=vr}catch(b){f=vr,t.error(f,u,b)}m&&d.size&&(t.debug("Missing:",{offerSelectorIds:[...d.keys()]}),d.forEach(b=>{b.reject(new Error(w(f,L,g)))}))}function c(){clearTimeout(a);let u=[...o.values()];o.clear(),u.forEach(({options:d,promises:m})=>s(d,m))}function l(){let u=i.size;i.clear(),t.debug(`Flushed ${u} cache entries`)}function h({country:u,language:d,perpetual:m=!1,promotionCode:f="",wcsOsi:g=[]}){let L=`${d}_${u}`;u!=="GB"&&(d=m?"EN":"MULT");let w=[u,d,f].filter(b=>b).join("-").toLowerCase();return g.map(b=>{let S=`${b}-${w}`;if(!i.has(S)){let N=new Promise((R,V)=>{let $=o.get(w);if(!$){let oe={country:u,locale:L,offerSelectorIds:[]};u!=="GB"&&(oe.language=d),$={options:oe,promises:new Map},o.set(w,$)}f&&($.options.promotionCode=f),$.options.offerSelectorIds.push(b),$.promises.set(b,{resolve:R,reject:V}),$.options.offerSelectorIds.length>=e.wcsBufferLimit?c():(t.debug("Queued:",$.options),a||(a=setTimeout(c,e.wcsBufferDelay)))});i.set(S,N)}return i.get(S)})}return{WcsCommitment:Ri,WcsPlanType:Vi,WcsTerm:Mi,resolveOfferSelectors:h,flushWcsCache:l}}var Wi="mas-commerce-service",Yr,Es,jr=class extends HTMLElement{constructor(){super(...arguments);D(this,Yr);p(this,"promise",null)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(n,i,o)=>{let a=await r?.(n,i,this.imsSignedInPromise,o);return a||null})}async activate(){let r=y(this,Yr,Es),n=Object.freeze(Ui(r));Et(r.lana);let i=X.init(r.hostEnv).module("service");i.debug("Activating:",r);let o={price:{}};try{o.price=await xs(n,r.commerce.priceLiterals)}catch{}let a={checkout:new Set,price:new Set},s={literals:o,providers:a,settings:n};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...ps(s),...fs(s),...vs(s),...As(s),...Fn,Log:X,get defaults(){return _},get log(){return X},get providers(){return{checkout(c){return a.checkout.add(c),()=>a.checkout.delete(c)},price(c){return a.price.add(c),()=>a.price.delete(c)}}},get settings(){return n}})),i.debug("Activated:",{literals:o,settings:n}),Te(()=>{let c=new CustomEvent(ot,{bubbles:!0,cancelable:!1,detail:this});this.dispatchEvent(c)})}connectedCallback(){this.readyPromise||(this.readyPromise=this.activate())}disconnectedCallback(){this.readyPromise=null}flushWcsCache(){this.flushWcsCache(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCache(),document.querySelectorAll('span[is="inline-price"],a[is="checkout-link"]').forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers")}refreshFragments(){this.flushWcsCache(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh()),this.log.debug("Refreshed AEM fragments")}};Yr=new WeakSet,Es=function(){let r={hostEnv:{name:this.getAttribute("host-env")??"prod"},commerce:{env:this.getAttribute("env")},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate"),10),isProdDomain:this.getAttribute("host-env")==="prod"}};return["locale","country","language"].forEach(n=>{let i=this.getAttribute(n);i&&(r[n]=i)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(n=>{let i=this.getAttribute(n);if(i!=null){let o=n.replace(/-([a-z])/g,a=>a[1].toUpperCase());r.commerce[o]=i}}),r},p(jr,"instance");window.customElements.get(Wi)||window.customElements.define(Wi,jr);Et({sampleRate:1});export{je as CheckoutButton,ne as CheckoutLink,te as CheckoutWorkflow,re as CheckoutWorkflowStep,_ as Defaults,ie as InlinePrice,$e as Landscape,X as Log,Wi as TAG_NAME_SERVICE,Ri as WcsCommitment,Vi as WcsPlanType,Mi as WcsTerm,wr as applyPlanType,Ui as getSettings};
