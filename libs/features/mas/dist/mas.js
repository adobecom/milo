...
`;var kn=class extends N{constructor(t){super(t)}getGlobalCSS(){return fc}renderLayout(){return x`${this.cardImage}
    <div class="body">
...
`;var Rn=class extends N{constructor(t){super(t)}getGlobalCSS(){return gc}renderLayout(){return x` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var xd=32,Ut=class extends N{constructor(r){super(r);f(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);f(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
...
`;var Dt=class extends N{constructor(t){super(t)}getGlobalCSS(){return wc}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var _c={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Bt=class extends N{constructor(t){super(t)}getGlobalCSS(){return Ac}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return x`${this.cardImage}
    ...
    `);var Ai=new Map,Y=(e,t,r=null,n=null)=>{Ai.set(e,{class:t,fragmentMapping:r,style:n})};Y("catalog",Ht,uc,Ht.variantStyle);Y("image",kn);Y("inline-heading",Rn);Y("mini-compare-chart",Ut,null,Ut.variantStyle);Y("plans",be,On,be.variantStyle);Y("plans-students",be,yc,be.variantStyle);Y("plans-education",be,vc,be.variantStyle);Y("product",st,null,st.variantStyle);Y("segment",Dt,null,Dt.variantStyle);Y("special-offers",Bt,_c,Bt.variantStyle);var _i=(e,t=!1)=>{let r=Ai.get(e.variant);if(!r)return t?void 0:new st(e);let{class:n,style:o}=r;if(o)try{let i=new CSSStyleSheet;i.replaceSync(o.cssText),e.shadowRoot.adoptedStyleSheets.push(i)}catch{let a=document.createElement("style");a.textContent=o.cssText,e.shadowRoot.appendChild(a)}return new n(e)};function Ln(e){return Ai.get(e)?.fragmentMapping}var Sc=document.createElement("style");Sc.innerHTML=`
:root {
...
`;var jc={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},Yt=class extends N{getGlobalCSS(){return Vc}renderLayout(){return x` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;var Ii={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300"}}},mt=class extends N{getGlobalCSS(){return Yc}get aemFragmentMapping(){return Ii}renderLayout(){return x`            
    ...
    `);customElements.define("fries-card",mt);Y("ccd-suggested",Wt,Gc,Wt.variantStyle);Y("ccd-slice",Yt,jc,Yt.variantStyle);Y("ah-try-buy-widget",dt,Ni,dt.variantStyle);Y("ah-promoted-plans",pt,$i,pt.variantStyle);Y("fries",mt,Ii,mt.variantStyle);
