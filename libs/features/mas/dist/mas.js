...
`;var oc={mnemonics:{size:"m"},backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{slot:"footer",size:"s"},allowedSizes:["wide"]},dt=class extends N{getGlobalCSS(){return Ko}get aemFragmentMapping(){return oc}renderLayout(){return x` <div class="content">
    ...
    `);var zn=(e,t=!1)=>{switch(e.variant){case"catalog":return new it(e);case"image":return new xr(e);case"inline-heading":return new vr(e);case"mini-compare-chart":return new ot(e);case"plans":return new at(e);case"product":return new Me(e);case"segment":return new st(e);case"special-offers":return new ct(e);case"twp":return new lt(e);case"ccd-suggested":return new ht(e);case"ccd-slice":return new dt(e);default:return t?void 0:new Me(e)}},Bo=()=>{let e=[];return e.push(it.variantStyle),e.push(ot.variantStyle),e.push(Me.variantStyle),e.push(at.variantStyle),e.push(st.variantStyle),e.push(ct.variantStyle),e.push(lt.variantStyle),e.push(ht.variantStyle),e.push(dt.variantStyle),e};var Yo=document.createElement("style");Yo.innerHTML=`
:root {
