...
`,Fo=()=>[C`
        ...
        `}get cardImage(){return x` <div class="image">
            ...
            ${this.badge}
              ...
              >`:"";return x`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){}};tt=new WeakMap,p(Ht,"styleMap",{});var I=Ht;function Y(e,t={},r=null,n=null){let i=n?document.createElement(e,{is:n}):document.createElement(e);r instanceof HTMLElement?i.appendChild(r):i.innerHTML=r;for(let[o,a]of Object.entries(t))i.setAttribute(o,a);return i}function br(){return window.matchMedia("(max-width: 767px)").matches}function Ko(){return window.matchMedia("(max-width: 1024px)").matches}var Kn={};Fs(Kn,{CLASS_NAME_FAILED:()=>Rn,CLASS_NAME_HIDDEN:()=>ic,CLASS_NAME_PENDING:()=>Mn,CLASS_NAME_RESOLVED:()=>Vn,ERROR_MESSAGE_BAD_REQUEST:()=>Er,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>mc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>$n,EVENT_AEM_ERROR:()=>Re,EVENT_AEM_LOAD:()=>Oe,EVENT_MAS_ERROR:()=>On,EVENT_MAS_READY:()=>Nn,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>kn,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>uc,EVENT_MERCH_CARD_COLLECTION_SORT:()=>hc,EVENT_MERCH_CARD_READY:()=>In,EVENT_MERCH_OFFER_READY:()=>ac,EVENT_MERCH_OFFER_SELECT_READY:()=>Cn,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>Ar,EVENT_MERCH_SEARCH_CHANGE:()=>lc,EVENT_MERCH_SIDENAV_SELECT:()=>dc,EVENT_MERCH_STOCK_CHANGE:()=>cc,EVENT_MERCH_STORAGE_CHANGE:()=>vr,EVENT_OFFER_SELECTED:()=>sc,EVENT_TYPE_FAILED:()=>Hn,EVENT_TYPE_READY:()=>rt,EVENT_TYPE_RESOLVED:()=>Un,LOG_NAMESPACE:()=>Dn,Landscape:()=>Me,NAMESPACE:()=>nc,PARAM_AOS_API_KEY:()=>pc,PARAM_ENV:()=>Bn,PARAM_LANDSCAPE:()=>Gn,PARAM_WCS_API_KEY:()=>fc,STATE_FAILED:()=>ce,STATE_PENDING:()=>Ee,STATE_RESOLVED:()=>le,TAG_NAME_SERVICE:()=>oc,WCS_PROD_URL:()=>zn,WCS_STAGE_URL:()=>Fn});var nc="merch",ic="hidden",rt="wcms:commerce:ready",oc="mas-commerce-service",ac="merch-offer:ready",Cn="merch-offer-select:ready",In="merch-card:ready",kn="merch-card:action-menu-toggle",sc="merch-offer:selected",cc="merch-stock:change",vr="merch-storage:change",Ar="merch-quantity-selector:change",lc="merch-search:change",hc="merch-card-collection:sort",uc="merch-card-collection:showmore",dc="merch-sidenav:select",Oe="aem:load",Re="aem:error",Nn="mas:ready",On="mas:error",Rn="placeholder-failed",Mn="placeholder-pending",Vn="placeholder-resolved",Er="Bad WCS request",$n="Commerce offer not found",mc="Literals URL not provided",Hn="mas:failed",Un="mas:resolved",Dn="mas/commerce",Bn="commerce.env",Gn="commerce.landscape",pc="commerce.aosKey",fc="commerce.wcsKey",zn="https://www.adobe.com/web_commerce_artifact",Fn="https://www.stage.adobe.com/web_commerce_artifact_stage",ce="failed",Ee="pending",le="resolved",Me={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"};var jo=`
:root {
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return jo}setAriaExpanded(r,n){r.setAttribute("aria-expanded",n)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};p(nt,"variantStyle",C`
...
`;var Sr=class extends I{constructor(t){super(t)}getGlobalCSS(){return Yo}renderLayout(){return x`${this.cardImage}
    <div class="body">
...
`;var yr=class extends I{constructor(t){super(t)}getGlobalCSS(){return Xo}renderLayout(){return x` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var gc=32,it=class extends I{constructor(r){super(r);p(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);p(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
...
`;var Yn={title:{tag:"p",slot:"heading-xs"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},stockOffer:!0,secureLabel:!0,ctas:{slot:"footer",size:"m"}},ot=class extends I{constructor(t){super(t)}get aemFragmentMapping(){return Yn}getGlobalCSS(){return qo}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
...
`;var qn={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},ht=class extends I{getGlobalCSS(){return ra}get aemFragmentMapping(){return qn}renderLayout(){return x` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
    ...
    `);var Zn=(e,t=!1)=>{switch(e.variant){case"catalog":return new nt(e);case"image":return new Sr(e);case"inline-heading":return new yr(e);case"mini-compare-chart":return new it(e);case"plans":return new ot(e);case"product":return new Ve(e);case"segment":return new at(e);case"special-offers":return new st(e);case"twp":return new ct(e);case"ccd-suggested":return new lt(e);case"ccd-slice":return new ht(e);default:return t?void 0:new Ve(e)}},na={catalog:jn,image:null,"inline-heading":null,"mini-compare-chart":null,plans:Yn,product:null,segment:null,"special-offers":Xn,twp:null,"ccd-suggested":Wn,"ccd-slice":qn},ia=()=>{let e=[];return e.push(nt.variantStyle),e.push(it.variantStyle),e.push(Ve.variantStyle),e.push(ot.variantStyle),e.push(at.variantStyle),e.push(st.variantStyle),e.push(ct.variantStyle),e.push(lt.variantStyle),e.push(ht.variantStyle),e};var oa=document.createElement("style");oa.innerHTML=`
:root {
...
`;document.head.appendChild(oa);var xc="#000000",bc="#F8D904",vc=/(accent|primary|secondary)(-(outline|link))?/,Ac="mas:product_code/",Ec="daa-ll",Tr="daa-lh",Sc=["XL","L","M","S"];function Jn(e,t,r,n){if(t[e]&&n[e]){let i=Y(n[e].tag,{slot:n[e]?.slot},t[e]);r.append(i)}}function yc(e,t,r){e.mnemonicIcon?.map((i,o)=>({icon:i,alt:e.mnemonicAlt[o]??"",link:e.mnemonicLink[o]??""}))?.forEach(({icon:i,alt:o,link:a})=>{if(a&&!/^https?:/.test(a))try{a=new URL(`https://${a}`).href.toString()}catch{a="#"}let s={slot:"icons",src:i,loading:t.loading,size:r?.size??"l"};o&&(s.alt=o),a&&(s.href=a);let c=Y("merch-icon",s);t.append(c)})}function Tc(e,t){e.badge&&(t.setAttribute("badge-text",e.badge),t.setAttribute("badge-color",e.badgeColor||xc),t.setAttribute("badge-background-color",e.badgeBackgroundColor||bc))}function Lc(e,t,r){r?.includes(e.size)&&t.setAttribute("size",e.size)}function _c(e,t,r){e.cardTitle&&r&&t.append(Y(r.tag,{slot:r.slot},e.cardTitle))}function wc(e,t,r){e.subtitle&&r&&t.append(Y(r.tag,{slot:r.slot},e.subtitle))}function Pc(e,t,r){if(e.backgroundImage){let n={loading:t.loading??"lazy",src:e.backgroundImage};if(e.backgroundImageAltText?n.alt=e.backgroundImageAltText:n.role="none",!r)return;if(r?.attribute){t.setAttribute(r.attribute,e.backgroundImage);return}t.append(Y(r.tag,{slot:r.slot},Y("img",n)))}}function Cc(e,t,r){if(!e.prices||!r.prices)return;let n=Y(r.prices.tag,{slot:r.prices.slot},e.prices);t.append(n)}function Ic(e,t,r){Jn("promoText",e,t,r),Jn("description",e,t,r),Jn("callout",e,t,r);let n=t.querySelector('[slot="callout-content"]');if(n){let i=Y("div",{},n.querySelector("p").textContent),o=Y("div",{},i);n.querySelector("img")&&o.append(n.querySelector("img"));let a=Y("div",{},o);n.innerHTML="",n.append(a)}}function kc(e,t,r,n){e.showStockCheckbox&&r.stockOffer&&(t.setAttribute("checkbox-label",n.stockCheckboxLabel),t.setAttribute("stock-offer-osis",n.stockOfferOsis)),n.secureLabel&&r.secureLabel&&t.setAttribute("secure-label",n.secureLabel)}function Nc(e,t,r,n){let o=customElements.get("checkout-button").createCheckoutButton({},e.innerHTML);o.setAttribute("tabindex",0);for(let h of e.attributes)["class","is"].includes(h.name)||o.setAttribute(h.name,h.value);o.firstElementChild?.classList.add("spectrum-Button-label");let a=t.ctas.size??"M",s=`spectrum-Button--${n}`,c=Sc.includes(a)?`spectrum-Button--size${a}`:"spectrum-Button--sizeM",l=["spectrum-Button",s,c];return r&&l.push("spectrum-Button--outline"),o.classList.add(...l),o}function Oc(e,t,r,n){let i="fill";r&&(i="outline");let o=Y("sp-button",{treatment:i,variant:n,tabIndex:0,size:t.ctas.size??"m"},e);return o.addEventListener("click",a=>{a.target!==e&&(a.stopPropagation(),e.click())}),o}function Rc(e,t){return e.classList.add("con-button"),t&&e.classList.add("blue"),e}function Mc(e,t,r,n){if(e.ctas){let{slot:i}=r.ctas,o=Y("div",{slot:i},e.ctas),a=[...o.querySelectorAll("a")].map(s=>{let c=s.parentElement.tagName==="STRONG";if(t.consonant)return Rc(s,c);let l=vc.exec(s.className)?.[0]??"accent",h=l.includes("accent"),u=l.includes("primary"),d=l.includes("secondary"),m=l.includes("-outline");if(l.includes("-link"))return s;let f;return h||c?f="accent":u?f="primary":d&&(f="secondary"),t.spectrum==="swc"?Oc(s,r,m,f):Nc(s,r,m,f)});o.innerHTML="",o.append(...a),t.append(o)}}function Vc(e,t){let{tags:r}=e,n=r?.find(i=>i.startsWith(Ac))?.split("/").pop();n&&(t.setAttribute(Tr,n),t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]").forEach((i,o)=>{i.setAttribute(Ec,`${i.dataset.analyticsId}-${o+1}`)}))}function $c(e){e.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,r])=>{e.querySelectorAll(`a.${t}`).forEach(n=>{n.classList.remove(t),n.classList.add("spectrum-Link",`spectrum-Link--${r}`)})})}function Hc(e){e.querySelectorAll("[slot]").forEach(n=>{n.remove()}),["checkbox-label","stock-offer-osis","secure-label","background-image","badge-background-color","badge-color","badge-text","size",Tr].forEach(n=>e.removeAttribute(n));let r=["wide-strip","thin-strip"];e.classList.remove(...r)}async function aa(e,t){let{fields:r}=e,{variant:n}=r;if(!n)return;t.id=e.id;let i={stockCheckboxLabel:"Add a 30-day free trial of Adobe Stock.*",stockOfferOsis:"",secureLabel:"Secure transaction"};Hc(t),t.variant=n,await t.updateComplete;let{aemFragmentMapping:o}=t.variantLayout;o&&(yc(r,t,o.mnemonics),Tc(r,t),Lc(r,t,o.size),_c(r,t,o.title),wc(r,t,o.subtitle),Cc(r,t,o,i),Pc(r,t,o.backgroundImage),Ic(r,t,o),kc(r,t,o,i),Mc(r,t,o,n),Vc(r,t),$c(t))}var Uc="merch-card",Dc=":start",Bc=":ready",Gc=1e4,sa="merch-card:",Dt,Qn,Ut=class extends ee{constructor(){super();F(this,Dt);p(this,"customerSegment");p(this,"marketSegment");p(this,"variantLayout");this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this)}static getFragmentMapping(r){return na[r]}firstUpdated(){this.variantLayout=Zn(this,!1),this.variantLayout?.connectedCallbackHook(),this.aemFragment?.updateComplete.catch(()=>{this.style.display="none"})}willUpdate(r){(r.has("variant")||!this.variantLayout)&&(this.variantLayout=Zn(this),this.variantLayout.connectedCallbackHook())}updated(r){(r.has("badgeBackgroundColor")||r.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border",this.computedBorderStyle),this.variantLayout?.postCardUpdateHook(r)}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}get prices(){return Array.from(this.querySelectorAll('span[is="inline-price"][data-wcs-osi]'))}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["twp","ccd-slice","ccd-suggested"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector('span[is="inline-price"]')}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll('a[is="checkout-link"]')??[]]}async toggleStockOffer({target:r}){if(!this.stockOfferOsis)return;let n=this.checkoutLinks;if(n.length!==0)for(let i of n){await i.onceSettled();let o=i.value?.[0]?.planType;if(!o)return;let a=this.stockOfferOsis[o];if(!a)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==a);r.checked&&s.push(a),i.dataset.wcsOsi=s.join(",")}}handleQuantitySelection(r){let n=this.checkoutLinks;for(let i of n)i.dataset.quantity=r.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(r){let n={...this.filters};Object.keys(n).forEach(i=>{if(r){n[i].order=Math.min(n[i].order||2,2);return}let o=n[i].order;o===1||isNaN(o)||(n[i].order=Number(o)+1)}),this.filters=n}includes(r){return this.textContent.match(new RegExp(r,"i"))!==null}connectedCallback(){super.connectedCallback();let r=this.querySelector("aem-fragment")?.getAttribute("fragment");performance.mark(`${sa}${r}${Dc}`),this.addEventListener(Ar,this.handleQuantitySelection),this.addEventListener(Cn,this.merchCardReady,{once:!0}),this.updateComplete.then(()=>{this.merchCardReady()}),this.storageOptions?.addEventListener("change",this.handleStorageChange),this.addEventListener(Re,this.handleAemFragmentEvents),this.addEventListener(Oe,this.handleAemFragmentEvents),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(Ar,this.handleQuantitySelection),this.storageOptions?.removeEventListener(vr,this.handleStorageChange),this.removeEventListener(Re,this.handleAemFragmentEvents),this.removeEventListener(Oe,this.handleAemFragmentEvents)}async handleAemFragmentEvents(r){if(r.type===Re&&ge(this,Dt,Qn).call(this,"AEM fragment cannot be loaded"),r.type===Oe&&r.target.nodeName==="AEM-FRAGMENT"){let n=r.detail;await aa(n,this),this.checkReady()}}async checkReady(){let r=Promise.all([...this.querySelectorAll('span[is="inline-price"][data-wcs-osi],a[is="checkout-link"][data-wcs-osi]')].map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(a=>a.classList.contains("placeholder-resolved"))),n=new Promise(o=>setTimeout(()=>o(!1),Gc));if(await Promise.race([r,n])===!0){performance.mark(`${sa}${this.id}${Bc}`),this.dispatchEvent(new CustomEvent(Nn,{bubbles:!0,composed:!0}));return}ge(this,Dt,Qn).call(this,"Contains unresolved offers")}get aemFragment(){return this.querySelector("aem-fragment")}get storageOptions(){return this.querySelector("sp-radio-group#storage")}get storageSpecificOfferSelect(){let r=this.storageOptions?.selected;if(r){let n=this.querySelector(`merch-offer-select[storage="${r}"]`);if(n)return n}return this.querySelector("merch-offer-select")}get offerSelect(){return this.storageOptions?this.storageSpecificOfferSelect:this.querySelector("merch-offer-select")}get quantitySelect(){return this.querySelector("merch-quantity-select")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let r=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll('a[is="checkout-link"].con-button')).length===2&&r&&r.parentElement.classList.add("footer-column")}merchCardReady(){this.offerSelect&&!this.offerSelect.planType||(this.dispatchEvent(new CustomEvent(In,{bubbles:!0})),this.displayFooterElementsInColumn())}handleStorageChange(){let r=this.closest("merch-card")?.offerSelect.cloneNode(!0);r&&this.dispatchEvent(new CustomEvent(vr,{detail:{offerSelect:r},bubbles:!0}))}get dynamicPrice(){return this.querySelector('[slot="price"]')}selectMerchOffer(r){if(r===this.merchOffer)return;this.merchOffer=r;let n=this.dynamicPrice;if(r.price&&n){let i=r.price.cloneNode(!0);n.onceSettled?n.onceSettled().then(()=>{n.replaceWith(i)}):n.replaceWith(i)}}};Dt=new WeakSet,Qn=function(r){this.dispatchEvent(new CustomEvent(On,{detail:r,bubbles:!0,composed:!0}))},p(Ut,"properties",{name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:r=>{if(!r)return;let[n,i,o]=r.split(",");return{PUF:n,ABM:i,M2M:o}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:r=>Object.fromEntries(r.split(",").map(n=>{let[i,o,a]=n.split(":"),s=Number(o);return[i,{order:isNaN(s)?void 0:s,size:a}]})),toAttribute:r=>Object.entries(r).map(([n,{order:i,size:o}])=>[n,i,o].filter(a=>a!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:Tr,reflect:!0},loading:{type:String}}),p(Ut,"styles",[zo,ia(),...Fo()]);customElements.define(Uc,Ut);var ut=class extends ee{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:t}=this;return t?x`<a href="${t}">
                  <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />
              </a>`:x` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};p(ut,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),p(ut,"styles",C`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
