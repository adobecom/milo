...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return Ba}setAriaExpanded(r,o){r.setAttribute("aria-expanded",o)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};p(Tt,"variantStyle",A`
...
`;var uo=class extends ${constructor(t){super(t)}getGlobalCSS(){return za}renderLayout(){return g`${this.cardImage}
    <div class="body">
...
`;var mo=class extends ${constructor(t){super(t)}getGlobalCSS(){return Fa}renderLayout(){return g` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var rt=class extends ${constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return ja}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return g` ${this.badge}
      ...
      ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}postCardUpdateHook(){this.card.isConnected&&(gt()||this.adjustProductBodySlots(),this.adjustTitleWidth())}};p(rt,"variantStyle",A`
...
`;var Lt=class extends ${constructor(t){super(t)}getGlobalCSS(){return qa}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return g` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var ni={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Rt=class extends ${constructor(t){super(t)}getGlobalCSS(){return Wa}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return ni}renderLayout(){return g`${this.cardImage}
            <div class="body">
    ...
    `);var ii=new Map,Z=(e,t,r=null,o=null)=>{ii.set(e,{class:t,fragmentMapping:r,style:o})};Z("catalog",Tt,ri,Tt.variantStyle);Z("image",uo);Z("inline-heading",mo);Z("mini-compare-chart",Ct,null,Ct.variantStyle);Z("plans",Pt,oi,Pt.variantStyle);Z("product",rt,null,rt.variantStyle);Z("segment",Lt,null,Lt.variantStyle);Z("special-offers",Rt,ni,Rt.variantStyle);var si=(e,t=!1)=>{let r=ii.get(e.variant);if(!r)return t?void 0:new rt(e);let{class:o,style:n}=r;if(n){let i=new CSSStyleSheet;i.replaceSync(n.cssText),e.shadowRoot.adoptedStyleSheets.push(i)}return new o(e)};function Ya(e){return ii.get(e)?.fragmentMapping}var Xa=document.createElement("style");Xa.innerHTML=`
:root {
...
`;document.head.appendChild(Xa);var Qa=new CSSStyleSheet;Qa.replaceSync(":host { display: contents; }");var Ka="fragment",Za="author",po="aem-fragment",ye,ai=class{constructor(){R(this,ye,new Map)}clear(){b(this,ye).clear()}addByRequestedId(t,r){b(this,ye).set(t,r)}add(...t){t.forEach(r=>{let{id:o}=r;o&&b(this,ye).set(o,r)})}has(t){return b(this,ye).has(t)}get(t){return b(this,ye).get(t)}remove(t){b(this,ye).delete(t)}};ye=new WeakMap;var gr=new ai,xr,le,Ee,kt,Ot,Oe,oe,$e,br,vr,li,ci=class extends HTMLElement{constructor(){super();R(this,vr);p(this,"cache",gr);R(this,xr);R(this,le,null);R(this,Ee,null);R(this,kt,!1);R(this,Ot,null);R(this,Oe,null);R(this,oe);R(this,$e);R(this,br,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[Qa]}static get observedAttributes(){return[Ka,Za]}attributeChangedCallback(r,o,n){r===Ka&&k(this,oe,n),r===Za&&k(this,br,["","true"].includes(n))}connectedCallback(){if(k(this,Oe,xt(this)),k(this,xr,b(this,Oe).log.module(po)),k(this,Ot,`${po}:${b(this,oe)}${Te}`),performance.mark(b(this,Ot)),!b(this,oe)){de(this,vr,li).call(this,{message:"Missing fragment id"});return}this.refresh(!1)}async getFragmentById(r,o,n){let i=`${po}:${o}${Gt}`,s;try{if(s=await Yr(r,{cache:"default",credentials:"omit"}),!s?.ok){let{startTime:a,duration:c}=performance.measure(i,n);throw new ge("Unexpected fragment response",{response:s,startTime:a,duration:c,...b(this,Oe).duration})}return s.json()}catch{let{startTime:c,duration:l}=performance.measure(i,n);throw s||(s={url:r}),new ge("Failed to fetch fragment",{response:s,startTime:c,duration:l,...b(this,Oe).duration})}}async refresh(r=!0){if(!(b(this,$e)&&!await Promise.race([b(this,$e),Promise.resolve(!1)])))return r&&gr.remove(b(this,oe)),k(this,$e,this.fetchData().then(()=>{let{references:o,referencesTree:n,placeholders:i}=b(this,le)||{};return this.dispatchEvent(new CustomEvent(De,{detail:{...this.data,stale:b(this,kt),references:o,referencesTree:n,placeholders:i},bubbles:!0,composed:!0})),!0}).catch(o=>b(this,le)?(gr.addByRequestedId(b(this,oe),b(this,le)),!0):(de(this,vr,li).call(this,o),!1))),b(this,$e)}async fetchData(){this.classList.remove("error"),k(this,Ee,null);let r=gr.get(b(this,oe));if(r){k(this,le,r);return}k(this,kt,!0);let{masIOUrl:o,wcsApiKey:n,locale:i}=b(this,Oe).settings,s=`${o}/fragment?id=${b(this,oe)}&api_key=${n}&locale=${i}`;r=await this.getFragmentById(s,b(this,oe),b(this,Ot)),gr.addByRequestedId(b(this,oe),r),k(this,le,r),k(this,kt,!1)}get updateComplete(){return b(this,$e)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return b(this,Ee)?b(this,Ee):(b(this,br)?this.transformAuthorData():this.transformPublishData(),b(this,Ee))}transformAuthorData(){let{fields:r,id:o,tags:n}=b(this,le);k(this,Ee,r.reduce((i,{name:s,multiple:a,values:c})=>(i.fields[s]=a?c:c[0],i),{fields:{},id:o,tags:n}))}transformPublishData(){let{fields:r,id:o,tags:n}=b(this,le);k(this,Ee,Object.entries(r).reduce((i,[s,a])=>(i.fields[s]=a?.mimeType?a.value:a??"",i),{fields:{},id:o,tags:n}))}};xr=new WeakMap,le=new WeakMap,Ee=new WeakMap,kt=new WeakMap,Ot=new WeakMap,Oe=new WeakMap,oe=new WeakMap,$e=new WeakMap,br=new WeakMap,vr=new WeakSet,li=function({message:r,context:o}){this.classList.add("error"),b(this,xr).error(`aem-fragment: ${r}`,o),this.dispatchEvent(new CustomEvent(Be,{detail:{message:r,...o},bubbles:!0,composed:!0}))};customElements.define(po,ci);var $t=class extends N{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor=""}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.variant==="plans"&&this.style.setProperty("border-right","none"),super.connectedCallback()}render(){return g`<div class="plans-badge">
    ...
    `),p(wr,"properties",{offers:{type:Array},selectedOffer:{type:Object},defaults:{type:Object},variant:{type:String,attribute:"variant",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},stock:{type:Boolean,reflect:!0}});customElements.define("merch-offer-select",wr);var nc=A`
    :host {
...
`;var mi={backgroundImage:{attribute:"background-image"},badge:!0,ctas:{slot:"cta",size:"M"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"p",slot:"price"},size:[],subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"}},Ut=class extends ${getGlobalCSS(){return lc}get aemFragmentMapping(){return mi}get stripStyle(){return this.card.backgroundImage?`
        ...
        `:""}renderLayout(){return g` <div style="${this.stripStyle}" class="body">
            ...
            <slot></slot>`}postCardUpdateHook(t){t.has("backgroundImage")&&this.styleBackgroundImage()}styleBackgroundImage(){if(this.card.classList.remove("thin-strip"),this.card.classList.remove("wide-strip"),!this.card.backgroundImage)return;let t=new Image;t.src=this.card.backgroundImage,t.onload=()=>{t.width>8?this.card.classList.add("wide-strip"):t.width===8&&this.card.classList.add("thin-strip")}}};p(Ut,"variantStyle",A`
...
`;var pi={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},Dt=class extends ${getGlobalCSS(){return hc}get aemFragmentMapping(){return pi}renderLayout(){return g` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;var fi={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color"},allowedColors:{gray:"--spectrum-gray-100"},size:["single","double","triple"]},nt=class extends ${getGlobalCSS(){return dc}get aemFragmentMapping(){return fi}renderLayout(){return g`
  ...
  `);customElements.define("ah-try-buy-widget",nt);dt({sampleRate:1});Z("ccd-suggested",Ut,mi,Ut.variantStyle);Z("ccd-slice",Dt,pi,Dt.variantStyle);Z("ah-try-buy-widget",nt,fi,nt.variantStyle);
