...
`;var Tc={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Bt=class extends N{constructor(t){super(t)}getGlobalCSS(){return _c}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return x`${this.cardImage}
    ...
    `);var Si=new Map,Y=(e,t,r=null,o=null)=>{Si.set(e,{class:t,fragmentMapping:r,style:o})};Y("catalog",Ht,gc,Ht.variantStyle);Y("image",Ro);Y("inline-heading",Oo);Y("mini-compare-chart",Ut,null,Ut.variantStyle);Y("plans",be,Mo,be.variantStyle);Y("plans-students",be,wc,be.variantStyle);Y("plans-education",be,Ec,be.variantStyle);Y("product",ct,null,ct.variantStyle);Y("segment",Dt,null,Dt.variantStyle);Y("special-offers",Bt,Tc,Bt.variantStyle);var _i=(e,t=!1)=>{let r=Si.get(e.variant);if(!r)return t?void 0:new ct(e);let{class:o,style:n}=r;if(n)try{let i=new CSSStyleSheet;i.replaceSync(n.cssText),e.shadowRoot.adoptedStyleSheets.push(i)}catch{let a=document.createElement("style");a.textContent=n.cssText,e.shadowRoot.appendChild(a)}return new o(e)};function Lo(e){return Si.get(e)?.fragmentMapping}var Cc=document.createElement("style");Cc.innerHTML=`
:root {
