...
`;var Xn={size:[],mnemonics:{size:"l"},badge:!0,subtitle:{tag:"h4",slot:"detail-s"},backgroundImage:{attribute:"background-image"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"cta",size:"M"}},lt=class extends I{getGlobalCSS(){return Qo}get aemFragmentMapping(){return Xn}get stripStyle(){return this.card.backgroundImage?`
...
`;var Wn={size:["wide"],mnemonics:{size:"m"},badge:!0,backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{slot:"footer",size:"S"},allowedSizes:["wide"]},ht=class extends I{getGlobalCSS(){return ea}get aemFragmentMapping(){return Wn}renderLayout(){return x` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
