      ...
      `];var ht,Xt=class Xt{constructor(t){p(this,"card");$(this,ht);this.card=t,this.insertVariantStyle()}getContainer(){return H(this,ht,x(this,ht)??this.card.closest('[class*="-merch-cards"]')??this.card.parentElement),x(this,ht)}insertVariantStyle(){if(!Xt.styleMap[this.card.variant]){Xt.styleMap[this.card.variant]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(t,r){if(!t)return;let n=`--consonant-merch-card-${this.card.variant}-${r}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),o=parseInt(this.getContainer().style.getPropertyValue(n))||0;i>o&&this.getContainer().style.setProperty(n,`${i}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),b`
        ...
        `}get cardImage(){return b` <div class="image">
            ...
            ${this.badge}
              ...
              >`:"";return b`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){}};ht=new WeakMap,p(Xt,"styleMap",{});var k=Xt;var fi={};vc(fi,{CLASS_NAME_FAILED:()=>ti,CLASS_NAME_HIDDEN:()=>Rc,CLASS_NAME_PENDING:()=>ri,CLASS_NAME_RESOLVED:()=>ni,ERROR_MESSAGE_BAD_REQUEST:()=>ii,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>Bc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>oi,EVENT_AEM_ERROR:()=>Be,EVENT_AEM_LOAD:()=>Ge,EVENT_MAS_ERROR:()=>ei,EVENT_MAS_READY:()=>Jn,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Qn,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>Dc,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Hc,EVENT_MERCH_CARD_READY:()=>Zn,EVENT_MERCH_OFFER_READY:()=>Oc,EVENT_MERCH_OFFER_SELECT_READY:()=>Wn,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>ut,EVENT_MERCH_SEARCH_CHANGE:()=>Uc,EVENT_MERCH_SIDENAV_SELECT:()=>Gc,EVENT_MERCH_STOCK_CHANGE:()=>Vc,EVENT_MERCH_STORAGE_CHANGE:()=>$r,EVENT_OFFER_SELECTED:()=>$c,EVENT_TYPE_FAILED:()=>ai,EVENT_TYPE_READY:()=>dt,EVENT_TYPE_RESOLVED:()=>si,HEADER_X_REQUEST_ID:()=>mi,LOG_NAMESPACE:()=>ci,Landscape:()=>pe,MARK_DURATION_SUFFIX:()=>Qt,MARK_START_SUFFIX:()=>we,MAS_COMMERCE_SERVICE_INIT_TIME_MEASURE_NAME:()=>Zt,MODAL_TYPE_3_IN_1:()=>Fe,NAMESPACE:()=>Nc,PARAM_AOS_API_KEY:()=>zc,PARAM_ENV:()=>li,PARAM_LANDSCAPE:()=>hi,PARAM_WCS_API_KEY:()=>Fc,PROVIDER_ENVIRONMENT:()=>pi,SELECTOR_MAS_CHECKOUT_LINK:()=>qt,SELECTOR_MAS_ELEMENT:()=>Wt,SELECTOR_MAS_INLINE_PRICE:()=>Or,SELECTOR_MAS_SP_BUTTON:()=>qn,STATE_FAILED:()=>ue,STATE_PENDING:()=>Te,STATE_RESOLVED:()=>me,TAG_NAME_SERVICE:()=>Mc,WCS_PROD_URL:()=>di,WCS_STAGE_URL:()=>ui,WORKFLOW_STEP:()=>ze});var Nc="merch",Rc="hidden",dt="wcms:commerce:ready",Mc="mas-commerce-service",Or='span[is="inline-price"][data-wcs-osi]',qt='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',qn="sp-button[data-wcs-osi]",Wt=`${Or},${qt}`,Oc="merch-offer:ready",Wn="merch-offer-select:ready",Zn="merch-card:ready",Qn="merch-card:action-menu-toggle",$c="merch-offer:selected",Vc="merch-stock:change",$r="merch-storage:change",ut="merch-quantity-selector:change",Uc="merch-search:change",Hc="merch-card-collection:sort",Dc="merch-card-collection:showmore",Gc="merch-sidenav:select",Ge="aem:load",Be="aem:error",Jn="mas:ready",ei="mas:error",ti="placeholder-failed",ri="placeholder-pending",ni="placeholder-resolved",ii="Bad WCS request",oi="Commerce offer not found",Bc="Literals URL not provided",ai="mas:failed",si="mas:resolved",ci="mas/commerce",li="commerce.env",hi="commerce.landscape",zc="commerce.aosKey",Fc="commerce.wcsKey",di="https://www.adobe.com/web_commerce_artifact",ui="https://www.stage.adobe.com/web_commerce_artifact_stage",ue="failed",Te="pending",me="resolved",pe={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},mi="X-Request-Id",Zt="mas-commerce-service:initTime",ze={CHECKOUT:"checkout",CHECKOUT_EMAIL:"checkout/email",SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"},pi={PRODUCTION:"PRODUCTION"},Fe={TWP:"twp",D2P:"d2p",CRM:"crm"},we=":start",Qt=":duration";function ba(e,t){let r;return function(){let n=this,i=arguments;clearTimeout(r),r=setTimeout(()=>e.apply(n,i),t)}}function Ke(e,t={},r=null,n=null){let i=n?document.createElement(e,{is:n}):document.createElement(e);r instanceof HTMLElement?i.appendChild(r):i.innerHTML=r;for(let[o,a]of Object.entries(t))i.setAttribute(o,a);return i}function Vr(){return window.matchMedia("(max-width: 767px)")}function mt(){return Vr().matches}function xa(){return window.matchMedia("(max-width: 1024px)").matches}function re(){let e=document.querySelector("mas-commerce-service");return e?{[Zt]:e.initDuration}:{}}var va=`
:root {
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return va}setAriaExpanded(r,n){r.setAttribute("aria-expanded",n)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};p(pt,"variantStyle",_`
...
`;var Ur=class extends k{constructor(t){super(t)}getGlobalCSS(){return Aa}renderLayout(){return b`${this.cardImage}
    <div class="body">
...
`;var Hr=class extends k{constructor(t){super(t)}getGlobalCSS(){return Ea}renderLayout(){return b` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var Kc=32,ft=class extends k{constructor(r){super(r);p(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);p(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?b`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){mt()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};p(ft,"variantStyle",_`
...
`;var bi={title:{tag:"p",slot:"heading-xs"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},stockOffer:!0,secureLabel:!0,badge:!0,size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant"},gt=class extends k{constructor(t){super(t),this.adaptForMobile=this.adaptForMobile.bind(this)}get aemFragmentMapping(){return bi}getGlobalCSS(){return Sa}adaptForMobile(){let t=this.card.shadowRoot,r=t.querySelector("footer"),n=this.card.getAttribute("size"),i=t.querySelector("footer #stock-checkbox"),o=t.querySelector(".body #stock-checkbox"),a=t.querySelector(".body");if(!n){r.classList.remove("wide-footer"),i&&i.remove();return}let s=mt();if(r&&r.classList.toggle("wide-footer",!s),s&&i){o?i.remove():a.appendChild(i);return}!s&&o&&(i?o.remove():r.prepend(o)),this.card.closest("merch-card-collection,overlay-trigger")||this.card.removeAttribute("size")}postCardUpdateHook(){this.adaptForMobile(),this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?b`<label id="stock-checkbox">
        ...
        ${this.secureLabelFooter}`}};p(gt,"variantStyle",_`
    :host([variant='plans']) {
      min-height: 348px;
    }
...
`;var Ye=class extends k{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Ta}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return b` ${this.badge}
      ...
      ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}postCardUpdateHook(){this.card.isConnected&&(mt()||this.adjustProductBodySlots(),this.adjustTitleWidth())}};p(Ye,"variantStyle",_`
...
`;var bt=class extends k{constructor(t){super(t)}getGlobalCSS(){return wa}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return b` ${this.badge}
    ...
    <hr />
    ${this.secureLabelFooter}`}};p(bt,"variantStyle",_`
...
`;var xi={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},xt=class extends k{constructor(t){super(t)}getGlobalCSS(){return _a}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return xi}renderLayout(){return b`${this.cardImage}
            <div class="body">
...
`;var vt=class extends k{constructor(t){super(t)}getGlobalCSS(){return La}renderLayout(){return b`${this.badge}
      ...
      <footer><slot name="footer"></slot></footer>`}};p(vt,"variantStyle",_`
    :host([variant='twp']) {
      padding: 4px 10px 5px 10px;
    }
    .twp-badge {
...
`;var vi={backgroundImage:{attribute:"background-image"},badge:!0,ctas:{slot:"cta",size:"M"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"p",slot:"price"},size:[],subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"}},At=class extends k{getGlobalCSS(){return Pa}get aemFragmentMapping(){return vi}get stripStyle(){return this.card.backgroundImage?`
        ...
        `:""}renderLayout(){return b` <div style="${this.stripStyle}" class="body">
            ...
            <slot></slot>`}postCardUpdateHook(t){t.has("backgroundImage")&&this.styleBackgroundImage()}styleBackgroundImage(){if(this.card.classList.remove("thin-strip"),this.card.classList.remove("wide-strip"),!this.card.backgroundImage)return;let t=new Image;t.src=this.card.backgroundImage,t.onload=()=>{t.width>8?this.card.classList.add("wide-strip"):t.width===8&&this.card.classList.add("thin-strip")}}};p(At,"variantStyle",_`
...
`;var Ai={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},Et=class extends k{getGlobalCSS(){return Ca}get aemFragmentMapping(){return Ai}renderLayout(){return b` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
Caused by: ${this.cause}`),r}};async function rn(e,t={},r=2,n=100){let i;for(let o=0;o<=r;o++)try{return await fetch(e,t)}catch(a){if(i=a,o>r)break;await new Promise(s=>setTimeout(s,n*(o+1)))}throw i}var Ds=new CSSStyleSheet;Ds.replaceSync(":host { display: contents; }");var Us="fragment",Hs="author",nn="aem-fragment";async function uh(e,t,r){let n=`${nn}:${t}${Qt}`,i;try{if(i=await rn(e,{cache:"default",credentials:"omit"}),!i?.ok){let{startTime:o,duration:a}=performance.measure(n,r);throw new fe("Unexpected fragment response",{response:i,startTime:o,duration:a})}return i.json()}catch{let{startTime:a,duration:s}=performance.measure(n,r);throw i||(i={url:e}),new fe("Failed to fetch fragment",{response:i,startTime:a,duration:s,...re()})}}var ge,Ao=class{constructor(){$(this,ge,new Map)}clear(){x(this,ge).clear()}addByRequestedId(t,r){x(this,ge).set(t,r)}add(...t){t.forEach(r=>{let{id:n}=r;n&&x(this,ge).set(n,r)})}has(t){return x(this,ge).has(t)}get(t){return x(this,ge).get(t)}remove(t){x(this,ge).delete(t)}};ge=new WeakMap;var lr=new Ao,on,be,xe,kt,It,hr,te,Nt,Je,Rt,dr,yo,Eo=class extends HTMLElement{constructor(){super();$(this,dr);p(this,"cache",lr);$(this,on,Y.module(nn));$(this,be,null);$(this,xe,null);$(this,kt,!1);$(this,It,null);$(this,hr,null);$(this,te);$(this,Nt);$(this,Je);$(this,Rt,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[Ds]}static get observedAttributes(){return[Us,Hs]}attributeChangedCallback(r,n,i){r===Us&&H(this,te,i),r===Hs&&H(this,Rt,["","true"].includes(i))}connectedCallback(){if(!x(this,te)){he(this,dr,yo).call(this,{message:"Missing fragment id"});return}H(this,It,`${nn}:${x(this,te)}${we}`),performance.mark(x(this,It)),H(this,Nt,new Promise((r,n)=>{this.dispose=Jr(i=>this.activate(i,r,n))}))}async activate(r,n,i){H(this,hr,r);let o=!x(this,Rt);this.refresh(o).then(a=>n(a)).catch(a=>i(a))}async refresh(r=!0){if(!(x(this,Je)&&!await Promise.race([x(this,Je),Promise.resolve(!1)])))return r&&lr.remove(x(this,te)),H(this,Je,this.fetchData().then(()=>(this.dispatchEvent(new CustomEvent(Ge,{detail:{...this.data,stale:x(this,kt)},bubbles:!0,composed:!0})),!0)).catch(n=>x(this,be)?(lr.addByRequestedId(x(this,te),x(this,be)),!0):(H(this,Nt,null),he(this,dr,yo).call(this,n),!1))),x(this,Je)}async fetchData(){this.classList.remove("error"),H(this,xe,null);let r=lr.get(x(this,te));if(r){H(this,be,r);return}H(this,kt,!0);let{masIOUrl:n,wcsApiKey:i,locale:o}=x(this,hr).settings,a=`${n}/fragment?id=${x(this,te)}&api_key=${i}&locale=${o}`;r=await uh(a,x(this,te),x(this,It)),lr.addByRequestedId(x(this,te),r),H(this,be,r),H(this,kt,!1)}get updateComplete(){return x(this,Nt)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return x(this,xe)?x(this,xe):(x(this,Rt)?this.transformAuthorData():this.transformPublishData(),x(this,xe))}transformAuthorData(){let{fields:r,id:n,tags:i}=x(this,be);H(this,xe,r.reduce((o,{name:a,multiple:s,values:c})=>(o.fields[a]=s?c:c[0],o),{fields:{},id:n,tags:i}))}transformPublishData(){let{fields:r,id:n,tags:i}=x(this,be);H(this,xe,Object.entries(r).reduce((o,[a,s])=>(o.fields[a]=s?.mimeType?s.value:s??"",o),{fields:{},id:n,tags:i}))}};on=new WeakMap,be=new WeakMap,xe=new WeakMap,kt=new WeakMap,It=new WeakMap,hr=new WeakMap,te=new WeakMap,Nt=new WeakMap,Je=new WeakMap,Rt=new WeakMap,dr=new WeakSet,yo=function({message:r,context:n}){this.classList.add("error"),x(this,on).error(`aem-fragment: ${r}`,n),this.dispatchEvent(new CustomEvent(Be,{detail:{message:r,...n},bubbles:!0,composed:!0}))};customElements.define(nn,Eo);var ur=class extends j{constructor(){super()}render(){return b`
    ...
    `),p(ur,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",ur);var mr=class extends j{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,r)=>{r>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return b`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${this.isMobile&&this.rows.length>this.mobileRows?b`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:b``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};p(mr,"styles",_`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `);customElements.define("merch-icon",Ot);var Fs=_`
    :host {
        box-sizing: border-box;
