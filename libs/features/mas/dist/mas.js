...
`;var kn=class extends M{constructor(t){super(t)}getGlobalCSS(){return gc}renderLayout(){return x`${this.cardImage}
    <div class="body">
...
`;var Rn=class extends M{constructor(t){super(t)}getGlobalCSS(){return xc}renderLayout(){return x` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var Sc={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Bt=class extends M{constructor(t){super(t)}getGlobalCSS(){return _c}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return x`${this.cardImage}
    ...
    `);var _i=new Map,Y=(e,t,r=null,n=null)=>{_i.set(e,{class:t,fragmentMapping:r,style:n})};Y("catalog",Ht,fc,Ht.variantStyle);Y("image",kn);Y("inline-heading",Rn);Y("mini-compare-chart",Ut,null,Ut.variantStyle);Y("plans",be,On,be.variantStyle);Y("plans-students",be,Ec,be.variantStyle);Y("plans-education",be,yc,be.variantStyle);Y("product",st,null,st.variantStyle);Y("segment",Dt,null,Dt.variantStyle);Y("special-offers",Bt,Sc,Bt.variantStyle);var Si=(e,t=!1)=>{let r=_i.get(e.variant);if(!r)return t?void 0:new st(e);let{class:n,style:o}=r;if(o)try{let i=new CSSStyleSheet;i.replaceSync(o.cssText),e.shadowRoot.adoptedStyleSheets.push(i)}catch{let a=document.createElement("style");a.textContent=o.cssText,e.shadowRoot.appendChild(a)}return new n(e)};function Ln(e){return _i.get(e)?.fragmentMapping}var Tc=document.createElement("style");Tc.innerHTML=`
:root {
...
`;document.head.appendChild(Tc);var Cc="fragment",Pc="author",Lc="preview",Ti="aem-fragment",ve,Ci=class{constructor(){w(this,ve,new Map)}clear(){u(this,ve).clear()}addByRequestedId(t,r){u(this,ve).set(t,r)}put(t,r){u(this,ve).set(t,r)}add(...t){t.forEach(r=>{let{id:n}=r;n&&u(this,ve).set(n,r)})}has(t){return u(this,ve).has(t)}get(t){return u(this,ve).get(t)}remove(t){u(this,ve).delete(t)}};ve=new WeakMap;var Nn=new Ci,zt,ye,Re,X,le,ae,de,Or,Nr,Ft,pe,kc,Rc,Li,Oc,Pi=class extends HTMLElement{constructor(){super(...arguments);w(this,pe);f(this,"cache",Nn);w(this,zt);w(this,ye,null);w(this,Re,null);w(this,X,{url:null,retryCount:0,stale:!1,measure:null,status:null});w(this,le,null);w(this,ae);w(this,de);w(this,Or,!1);w(this,Nr,0);w(this,Ft)}static get observedAttributes(){return[Cc,Pc,Lc]}attributeChangedCallback(r,n,o){r===Cc&&_(this,ae,o),r===Pc&&_(this,Or,["","true"].includes(o)),r===Lc&&_(this,Ft,o)}connectedCallback(){if(!u(this,de)){if(u(this,le)??_(this,le,St(this)),_(this,Ft,u(this,le).settings?.preview),u(this,zt)??_(this,zt,u(this,le).log.module(`${Ti}[${u(this,ae)}]`)),!u(this,ae)||u(this,ae)==="#"){ne(this,pe,Li).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(u(this,X)).filter(([r,n])=>n!=null).map(([r,n])=>[`aem-fragment:${r}`,n]))}async refresh(r=!0){if(u(this,de)&&!await Promise.race([u(this,de),Promise.resolve(!1)]))return;r&&Nn.remove(u(this,ae));try{_(this,de,ne(this,pe,Oc).call(this)),await u(this,de)}catch(s){return ne(this,pe,Li).call(this,s.message),!1}let{references:n,referencesTree:o,placeholders:i,wcs:a}=u(this,ye)||{};return a&&!N("mas.disableWcsCache")&&u(this,le).prefillWcsCache(a),this.dispatchEvent(new CustomEvent(Fe,{detail:{...this.data,references:n,referencesTree:o,placeholders:i,...u(this,X)},bubbles:!0,composed:!0})),u(this,de)}get updateComplete(){return u(this,de)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return u(this,Re)?u(this,Re):(u(this,Or)?this.transformAuthorData():this.transformPublishData(),u(this,Re))}transformAuthorData(){let{fields:r,id:n,tags:o,settings:i={}}=u(this,ye);_(this,Re,r.reduce((a,{name:s,multiple:c,values:l})=>(a.fields[s]=c?l:l[0],a),{fields:{},id:n,tags:o,settings:i}))}transformPublishData(){let{fields:r,id:n,tags:o,settings:i={}}=u(this,ye);_(this,Re,Object.entries(r).reduce((a,[s,c])=>(a.fields[s]=c?.mimeType?c.value:c??"",a),{fields:{},id:n,tags:o,settings:i}))}async generatePreview(){let{previewFragment:r}=await import("https://mas.adobe.com/studio/libs/fragment-client.js");return await r(u(this,ae),{locale:u(this,le).settings.locale,apiKey:u(this,le).settings.wcsApiKey})}};zt=new WeakMap,ye=new WeakMap,Re=new WeakMap,X=new WeakMap,le=new WeakMap,ae=new WeakMap,de=new WeakMap,Or=new WeakMap,Nr=new WeakMap,Ft=new WeakMap,pe=new WeakSet,kc=async function(r){Fi(this,Nr)._++;let n=`${Ti}:${u(this,ae)}:${u(this,Nr)}`,o=`${n}${je}`,i=`${n}${qe}`;if(u(this,Ft))return await this.generatePreview();performance.mark(o);let a;try{if(u(this,X).stale=!1,u(this,X).url=r,a=await dn(r,{cache:"default",credentials:"omit"}),ne(this,pe,Rc).call(this,a),u(this,X).status=a?.status,u(this,X).measure=fe(performance.measure(i,o)),u(this,X).retryCount=a.retryCount,!a?.ok)throw new Se("Unexpected fragment response",{response:a,...u(this,le).duration});return await a.json()}catch(s){if(u(this,X).measure=fe(performance.measure(i,o)),u(this,X).retryCount=s.retryCount,u(this,ye))return u(this,X).stale=!0,u(this,zt).error("Serving stale data",u(this,X)),u(this,ye);let c=s.message??"unknown";throw new Se(`Failed to fetch fragment: ${c}`,{})}},Rc=function(r){Object.assign(u(this,X),Wr(r))},Li=function(r){_(this,de,null),u(this,X).message=r,this.classList.add("error");let n={...u(this,X),...u(this,le).duration};u(this,zt).error(r,n),this.dispatchEvent(new CustomEvent(Ge,{detail:n,bubbles:!0,composed:!0}))},Oc=async function(){this.classList.remove("error"),_(this,Re,null);let r=Nn.get(u(this,ae));if(r)return _(this,ye,r),!0;let{masIOUrl:n,wcsApiKey:o,locale:i}=u(this,le).settings,a=`${n}/fragment?id=${u(this,ae)}&api_key=${o}&locale=${i}`;return r=await ne(this,pe,kc).call(this,a),Nn.addByRequestedId(u(this,ae),r),_(this,ye,r),!0};customElements.define(Ti,Pi);var Gt=class extends H{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return x`<div class="badge">
    ...
    `),f(Hr,"properties",{offers:{type:Array},selectedOffer:{type:Object},defaults:{type:Object},variant:{type:String,attribute:"variant",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},stock:{type:Boolean,reflect:!0}});customElements.define("merch-offer-select",Hr);var Uc=v`
    :host {
...
`;var Ii={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color",specialValues:{gradient:"linear-gradient(135deg, #ff4885 0%, #b272eb 50%, #5d89ff 100%)"}}},pt=class extends M{getGlobalCSS(){return Yc}get aemFragmentMapping(){return Ii}renderLayout(){return x`
    ...
    `);customElements.define("ah-promoted-plans",pt);var Xc=`
...
`;var Hi={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300"}}},mt=class extends M{getGlobalCSS(){return Xc}get aemFragmentMapping(){return Hi}renderLayout(){return x`            
    ...
    `);customElements.define("fries-card",mt);Y("ccd-suggested",Wt,Vc,Wt.variantStyle);Y("ccd-slice",Yt,qc,Yt.variantStyle);Y("ah-try-buy-widget",dt,$i,dt.variantStyle);Y("ah-promoted-plans",pt,Ii,pt.variantStyle);Y("fries",mt,Hi,mt.variantStyle);
