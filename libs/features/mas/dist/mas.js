...
`,qs=()=>[E`
      ...
      `];var Pt=class extends I{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:t}=this;return t?x`<a href="${t}">
                  <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />
              </a>`:x` <img src="${this.src}" alt="${this.alt}" loading="${this.loading}" />`}};m(Pt,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),m(Pt,"styles",E`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return Ws}setAriaExpanded(r,o){r.setAttribute("aria-expanded",o)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};m(kt,"variantStyle",E`
...
`;var Nh=32,Rt=class extends ${constructor(r){super(r);m(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);m(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
        ...
        <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){yt()?this.removeEmptyRows():(await Promise.all(this.card.prices.map(r=>r.onceSettled())),this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};m(Rt,"variantStyle",E`
...
`;var fo={title:{tag:"p",slot:"heading-xs"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},stockOffer:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant"},Me=class extends ${constructor(t){super(t),this.adaptForMobile=this.adaptForMobile.bind(this)}get aemFragmentMapping(){return fo}priceOptionsProvider(t,r){t.dataset.template===Go&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Zs}adaptForMobile(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards")){this.card.removeAttribute("size");return}let t=this.card.shadowRoot,r=t.querySelector("footer"),o=this.card.getAttribute("size"),n=t.querySelector("footer #stock-checkbox"),i=t.querySelector(".body #stock-checkbox"),a=t.querySelector(".body");if(!o){r?.classList.remove("wide-footer"),n&&n.remove();return}let s=yt();if(r?.classList.toggle("wide-footer",!s),s&&n){i?n.remove():a.appendChild(n);return}!s&&i&&(n?i.remove():r.prepend(i))}postCardUpdateHook(){this.adaptForMobile(),this.adjustTitleWidth(),this.adjustLegal()}async adjustLegal(){if(await this.card.updateComplete,this.legal)return;let t=this.card.querySelector('[slot="heading-m"]');if(!t)return;let r=t.querySelector(`${pt}[data-template="price"]`),o=r.cloneNode(!0);this.legal=o,await r.onceSettled(),r?.options&&(r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),t.appendChild(o))}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}`}};m(Me,"variantStyle",E`
        :host([variant='plans']) {
            min-height: 348px;
...
`;var rt=class extends ${constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Qs}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","body-lower"].forEach(r=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${r}"]`),r))}renderLayout(){return x` ${this.badge}
      ...
      ${this.secureLabelFooter}`}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}postCardUpdateHook(){this.card.isConnected&&(yt()||this.adjustProductBodySlots(),this.adjustTitleWidth())}};m(rt,"variantStyle",E`
...
`;var si={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},$t=class extends ${constructor(t){super(t)}getGlobalCSS(){return ec}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return si}renderLayout(){return x`${this.cardImage}
    ...
    `);var ci=new Map,W=(e,t,r=null,o=null)=>{ci.set(e,{class:t,fragmentMapping:r,style:o})};W("catalog",kt,ai,kt.variantStyle);W("image",uo);W("inline-heading",mo);W("mini-compare-chart",Rt,null,Rt.variantStyle);W("plans",Me,fo,Me.variantStyle);W("plans-students",Me,fo,Me.variantStyle);W("product",rt,null,rt.variantStyle);W("segment",Ot,null,Ot.variantStyle);W("special-offers",$t,si,$t.variantStyle);var li=(e,t=!1)=>{let r=ci.get(e.variant);if(!r)return t?void 0:new rt(e);let{class:o,style:n}=r;if(n){let i=new CSSStyleSheet;i.replaceSync(n.cssText),e.shadowRoot.adoptedStyleSheets.push(i)}return new o(e)};function tc(e){return ci.get(e)?.fragmentMapping}var rc=document.createElement("style");rc.innerHTML=`
:root {
...
`;document.head.appendChild(rc);var ic=new CSSStyleSheet;ic.replaceSync(":host { display: contents; }");var oc="fragment",nc="author",go="aem-fragment",ve,hi=class{constructor(){k(this,ve,new Map)}clear(){b(this,ve).clear()}addByRequestedId(t,r){b(this,ve).set(t,r)}add(...t){t.forEach(r=>{let{id:o}=r;o&&b(this,ve).set(o,r)})}has(t){return b(this,ve).has(t)}get(t){return b(this,ve).get(t)}remove(t){b(this,ve).delete(t)}};ve=new WeakMap;var br=new hi,vr,le,ye,Mt,Nt,Ne,ne,Ee,yr,Er,pi,di=class extends HTMLElement{constructor(){super();k(this,Er);m(this,"cache",br);k(this,vr);k(this,le,null);k(this,ye,null);k(this,Mt,!1);k(this,Nt,null);k(this,Ne,null);k(this,ne);k(this,Ee);k(this,yr,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[ic]}static get observedAttributes(){return[oc,nc]}attributeChangedCallback(r,o,n){r===oc&&R(this,ne,n),r===nc&&R(this,yr,["","true"].includes(n))}connectedCallback(){if(!b(this,Ee)){if(R(this,Ne,Et(this)),R(this,vr,b(this,Ne).log.module(go)),R(this,Nt,`${go}:${b(this,ne)}${Ce}`),performance.mark(b(this,Nt)),!b(this,ne)){se(this,Er,pi).call(this,{message:"Missing fragment id"});return}this.refresh(!1)}}async getFragmentById(r,o,n){let i=`${go}:${o}${Vt}`,a;try{if(a=await Xr(r,{cache:"default",credentials:"omit"}),!a?.ok){let{startTime:s,duration:c}=performance.measure(i,n);throw new me("Unexpected fragment response",{response:a,startTime:s,duration:c,...b(this,Ne).duration})}return a.json()}catch{let{startTime:c,duration:l}=performance.measure(i,n);throw a||(a={url:r}),new me("Failed to fetch fragment",{response:a,startTime:c,duration:l,...b(this,Ne).duration})}}async refresh(r=!0){if(!(b(this,Ee)&&!await Promise.race([b(this,Ee),Promise.resolve(!1)])))return r&&br.remove(b(this,ne)),R(this,Ee,this.fetchData().then(()=>{let{references:o,referencesTree:n,placeholders:i}=b(this,le)||{};return this.dispatchEvent(new CustomEvent(De,{detail:{...this.data,stale:b(this,Mt),references:o,referencesTree:n,placeholders:i},bubbles:!0,composed:!0})),!0}).catch(o=>b(this,le)?(br.addByRequestedId(b(this,ne),b(this,le)),!0):(se(this,Er,pi).call(this,o),!1))),b(this,Ee)}async fetchData(){this.classList.remove("error"),R(this,ye,null);let r=br.get(b(this,ne));if(r){R(this,le,r);return}R(this,Mt,!0);let{masIOUrl:o,wcsApiKey:n,locale:i}=b(this,Ne).settings,a=`${o}/fragment?id=${b(this,ne)}&api_key=${n}&locale=${i}`;r=await this.getFragmentById(a,b(this,ne),b(this,Nt)),br.addByRequestedId(b(this,ne),r),R(this,le,r),R(this,Mt,!1)}get updateComplete(){return b(this,Ee)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return b(this,ye)?b(this,ye):(b(this,yr)?this.transformAuthorData():this.transformPublishData(),b(this,ye))}transformAuthorData(){let{fields:r,id:o,tags:n,settings:i={}}=b(this,le);R(this,ye,r.reduce((a,{name:s,multiple:c,values:l})=>(a.fields[s]=c?l:l[0],a),{fields:{},id:o,tags:n,settings:i}))}transformPublishData(){let{fields:r,id:o,tags:n,settings:i={}}=b(this,le);R(this,ye,Object.entries(r).reduce((a,[s,c])=>(a.fields[s]=c?.mimeType?c.value:c??"",a),{fields:{},id:o,tags:n,settings:i}))}};vr=new WeakMap,le=new WeakMap,ye=new WeakMap,Mt=new WeakMap,Nt=new WeakMap,Ne=new WeakMap,ne=new WeakMap,Ee=new WeakMap,yr=new WeakMap,Er=new WeakSet,pi=function({message:r,context:o}){this.classList.add("error"),b(this,vr).error(`aem-fragment: ${r}`,o),this.dispatchEvent(new CustomEvent(Be,{detail:{message:r,...o},bubbles:!0,composed:!0}))};customElements.define(go,di);var It=class extends I{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return x`<div class="plans-badge">
    ...
    `);customElements.define("merch-badge",It);var wr=class extends I{constructor(){super()}render(){return x`
            <slot name="icon"></slot>
    ...
    `),m(wr,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",wr);var Ar=class extends I{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,r)=>{r>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return x`<slot name="heading"></slot>
            <slot name="content"></slot>
            ${this.isMobile&&this.rows.length>this.mobileRows?x`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:x``}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll("merch-mnemonic-list")}};m(Ar,"styles",E`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
...
`;var vi={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color",specialValues:{}},allowedColors:{gray:"--spectrum-gray-100"},size:["single","double","triple"]},at=class extends ${getGlobalCSS(){return bc}get aemFragmentMapping(){return vi}renderLayout(){return x`
    ...
    `);customElements.define("ah-try-buy-widget",at);var vc=`
...
`;var yi={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color",specialValues:{gradient:"linear-gradient(135deg, #ff4885 0%, #b272eb 50%, #5d89ff 100%)"}}},st=class extends ${getGlobalCSS(){return vc}get aemFragmentMapping(){return yi}renderLayout(){return x`
    ...
    `);customElements.define("ah-promoted-plans",st);gt({sampleRate:1});W("ccd-suggested",Dt,xi,Dt.variantStyle);W("ccd-slice",Bt,bi,Bt.variantStyle);W("ah-try-buy-widget",at,vi,at.variantStyle);W("ah-promoted-plans",st,yi,st.variantStyle);
