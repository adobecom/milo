...
`,Ro=()=>[P`
        ...
        `}get cardImage(){return x` <div class="image">
            ...
            ${this.badge}
              ...
              >`:"";return x`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){}};nt=new WeakMap,p(Rt,"styleMap",{});var I=Rt;function te(e,t={},r=null,n=null){let i=n?document.createElement(e,{is:n}):document.createElement(e);r instanceof HTMLElement?i.appendChild(r):i.innerHTML=r;for(let[o,a]of Object.entries(t))i.setAttribute(o,a);return i}function fr(){return window.matchMedia("(max-width: 767px)").matches}function Mo(){return window.matchMedia("(max-width: 1024px)").matches}var Gn={};Ns(Gn,{CLASS_NAME_FAILED:()=>kn,CLASS_NAME_HIDDEN:()=>js,CLASS_NAME_PENDING:()=>Nn,CLASS_NAME_RESOLVED:()=>On,ERROR_MESSAGE_BAD_REQUEST:()=>br,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>tc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Rn,EVENT_AEM_ERROR:()=>Ve,EVENT_AEM_LOAD:()=>Me,EVENT_MAS_ERROR:()=>In,EVENT_MAS_READY:()=>Pn,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Cn,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>Qs,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Js,EVENT_MERCH_CARD_READY:()=>wn,EVENT_MERCH_OFFER_READY:()=>Xs,EVENT_MERCH_OFFER_SELECT_READY:()=>_n,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>xr,EVENT_MERCH_SEARCH_CHANGE:()=>Zs,EVENT_MERCH_SIDENAV_SELECT:()=>ec,EVENT_MERCH_STOCK_CHANGE:()=>qs,EVENT_MERCH_STORAGE_CHANGE:()=>gr,EVENT_OFFER_SELECTED:()=>Ws,EVENT_TYPE_FAILED:()=>Mn,EVENT_TYPE_READY:()=>it,EVENT_TYPE_RESOLVED:()=>Vn,LOG_NAMESPACE:()=>$n,Landscape:()=>$e,NAMESPACE:()=>Ks,PARAM_AOS_API_KEY:()=>rc,PARAM_ENV:()=>Hn,PARAM_LANDSCAPE:()=>Un,PARAM_WCS_API_KEY:()=>nc,STATE_FAILED:()=>he,STATE_PENDING:()=>Ee,STATE_RESOLVED:()=>de,TAG_NAME_SERVICE:()=>Ys,WCS_PROD_URL:()=>Dn,WCS_STAGE_URL:()=>Bn});var Ks="merch",js="hidden",it="wcms:commerce:ready",Ys="mas-commerce-service",Xs="merch-offer:ready",_n="merch-offer-select:ready",wn="merch-card:ready",Cn="merch-card:action-menu-toggle",Ws="merch-offer:selected",qs="merch-stock:change",gr="merch-storage:change",xr="merch-quantity-selector:change",Zs="merch-search:change",Js="merch-card-collection:sort",Qs="merch-card-collection:showmore",ec="merch-sidenav:select",Me="aem:load",Ve="aem:error",Pn="mas:ready",In="mas:error",kn="placeholder-failed",Nn="placeholder-pending",On="placeholder-resolved",br="Bad WCS request",Rn="Commerce offer not found",tc="Literals URL not provided",Mn="mas:failed",Vn="mas:resolved",$n="mas/commerce",Hn="commerce.env",Un="commerce.landscape",rc="commerce.aosKey",nc="commerce.wcsKey",Dn="https://www.adobe.com/web_commerce_artifact",Bn="https://www.stage.adobe.com/web_commerce_artifact_stage",he="failed",Ee="pending",de="resolved",$e={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"};var Vo=`
:root {
...
`;var st=class extends I{constructor(t){super(t)}getGlobalCSS(){return Do}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
...
`;var cc={mnemonics:{size:"m"},backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{slot:"footer",size:"S"},allowedSizes:["wide"]},ut=class extends I{getGlobalCSS(){return jo}get aemFragmentMapping(){return cc}renderLayout(){return x` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
