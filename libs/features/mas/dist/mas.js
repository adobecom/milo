...
`;var Pt=class extends ${constructor(t){super(t)}getGlobalCSS(){return Wa}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return g` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var ni={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Lt=class extends ${constructor(t){super(t)}getGlobalCSS(){return Ya}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return ni}renderLayout(){return g`${this.cardImage}
            <div class="body">
    ...
    `);var ii=new Map,X=(e,t,r=null,o=null)=>{ii.set(e,{class:t,fragmentMapping:r,style:o})};X("catalog",Tt,oi,Tt.variantStyle);X("image",ho);X("inline-heading",uo);X("mini-compare-chart",Ct,null,Ct.variantStyle);X("plans",$e,mo,$e.variantStyle);X("plans-education",$e,ja,$e.variantStyle);X("product",ot,null,ot.variantStyle);X("segment",Pt,null,Pt.variantStyle);X("special-offers",Lt,ni,Lt.variantStyle);var si=(e,t=!1)=>{let r=ii.get(e.variant);if(!r)return t?void 0:new ot(e);let{class:o,style:n}=r;if(n){let i=new CSSStyleSheet;i.replaceSync(n.cssText),e.shadowRoot.adoptedStyleSheets.push(i)}return new o(e)};function Xa(e){return ii.get(e)?.fragmentMapping}var Ka=document.createElement("style");Ka.innerHTML=`
:root {
...
`;document.head.appendChild(Ka);var Ja=new CSSStyleSheet;Ja.replaceSync(":host { display: contents; }");var Za="fragment",Qa="author",po="aem-fragment",ye,ai=class{constructor(){R(this,ye,new Map)}clear(){b(this,ye).clear()}addByRequestedId(t,r){b(this,ye).set(t,r)}add(...t){t.forEach(r=>{let{id:o}=r;o&&b(this,ye).set(o,r)})}has(t){return b(this,ye).has(t)}get(t){return b(this,ye).get(t)}remove(t){b(this,ye).delete(t)}};ye=new WeakMap;var fr=new ai,gr,le,Ee,Rt,kt,Ne,oe,Me,xr,br,li,ci=class extends HTMLElement{constructor(){super();R(this,br);p(this,"cache",fr);R(this,gr);R(this,le,null);R(this,Ee,null);R(this,Rt,!1);R(this,kt,null);R(this,Ne,null);R(this,oe);R(this,Me);R(this,xr,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[Ja]}static get observedAttributes(){return[Za,Qa]}attributeChangedCallback(r,o,n){r===Za&&k(this,oe,n),r===Qa&&k(this,xr,["","true"].includes(n))}connectedCallback(){if(k(this,Ne,xt(this)),k(this,gr,b(this,Ne).log.module(po)),k(this,kt,`${po}:${b(this,oe)}${Ce}`),performance.mark(b(this,kt)),!b(this,oe)){de(this,br,li).call(this,{message:"Missing fragment id"});return}this.refresh(!1)}async getFragmentById(r,o,n){let i=`${po}:${o}${Ft}`,s;try{if(s=await Wr(r,{cache:"default",credentials:"omit"}),!s?.ok){let{startTime:a,duration:c}=performance.measure(i,n);throw new ge("Unexpected fragment response",{response:s,startTime:a,duration:c,...b(this,Ne).duration})}return s.json()}catch{let{startTime:c,duration:l}=performance.measure(i,n);throw s||(s={url:r}),new ge("Failed to fetch fragment",{response:s,startTime:c,duration:l,...b(this,Ne).duration})}}async refresh(r=!0){if(!(b(this,Me)&&!await Promise.race([b(this,Me),Promise.resolve(!1)])))return r&&fr.remove(b(this,oe)),k(this,Me,this.fetchData().then(()=>{let{references:o,referencesTree:n,placeholders:i}=b(this,le)||{};return this.dispatchEvent(new CustomEvent(Be,{detail:{...this.data,stale:b(this,Rt),references:o,referencesTree:n,placeholders:i},bubbles:!0,composed:!0})),!0}).catch(o=>b(this,le)?(fr.addByRequestedId(b(this,oe),b(this,le)),!0):(de(this,br,li).call(this,o),!1))),b(this,Me)}async fetchData(){this.classList.remove("error"),k(this,Ee,null);let r=fr.get(b(this,oe));if(r){k(this,le,r);return}k(this,Rt,!0);let{masIOUrl:o,wcsApiKey:n,locale:i}=b(this,Ne).settings,s=`${o}/fragment?id=${b(this,oe)}&api_key=${n}&locale=${i}`;r=await this.getFragmentById(s,b(this,oe),b(this,kt)),fr.addByRequestedId(b(this,oe),r),k(this,le,r),k(this,Rt,!1)}get updateComplete(){return b(this,Me)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return b(this,Ee)?b(this,Ee):(b(this,xr)?this.transformAuthorData():this.transformPublishData(),b(this,Ee))}transformAuthorData(){let{fields:r,id:o,tags:n}=b(this,le);k(this,Ee,r.reduce((i,{name:s,multiple:a,values:c})=>(i.fields[s]=a?c:c[0],i),{fields:{},id:o,tags:n}))}transformPublishData(){let{fields:r,id:o,tags:n}=b(this,le);k(this,Ee,Object.entries(r).reduce((i,[s,a])=>(i.fields[s]=a?.mimeType?a.value:a??"",i),{fields:{},id:o,tags:n}))}};gr=new WeakMap,le=new WeakMap,Ee=new WeakMap,Rt=new WeakMap,kt=new WeakMap,Ne=new WeakMap,oe=new WeakMap,Me=new WeakMap,xr=new WeakMap,br=new WeakSet,li=function({message:r,context:o}){this.classList.add("error"),b(this,gr).error(`aem-fragment: ${r}`,o),this.dispatchEvent(new CustomEvent(ze,{detail:{message:r,...o},bubbles:!0,composed:!0}))};customElements.define(po,ci);var Ot=class extends N{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor=""}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.variant==="plans"&&this.style.setProperty("border-right","none"),super.connectedCallback()}render(){return g`<div class="plans-badge">
    ...
    `),p(Ar,"properties",{offers:{type:Array},selectedOffer:{type:Object},defaults:{type:Object},variant:{type:String,attribute:"variant",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},stock:{type:Boolean,reflect:!0}});customElements.define("merch-offer-select",Ar);var ic=A`
    :host {
...
`;var pi={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},Ut=class extends ${getGlobalCSS(){return dc}get aemFragmentMapping(){return pi}renderLayout(){return g` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
