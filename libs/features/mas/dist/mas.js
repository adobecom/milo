...
merch-card[variant="catalog"] .payment-details {
  ...
  line-height: var(--consonant-merch-card-body-line-height);
            ...
            <slot></slot>`}getGlobalCSS(){return mc}setAriaExpanded(r,n){r.setAttribute("aria-expanded",n)}connectedCallbackHook(){this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard)}disconnectedCallbackHook(){this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard)}};f(Ut,"variantStyle",v`
...
`;var xd=32,Dt=class extends M{constructor(r){super(r);f(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);f(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
...
`;var Bt=class extends M{constructor(t){super(t)}getGlobalCSS(){return Ac}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var _c={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},zt=class extends M{constructor(t){super(t)}getGlobalCSS(){return wc}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return x`${this.cardImage}
            <div class="body">
    ...
    `);var wi=new Map,Y=(e,t,r=null,n=null)=>{wi.set(e,{class:t,fragmentMapping:r,style:n})};Y("catalog",Ut,uc,Ut.variantStyle);Y("image",kn);Y("inline-heading",Rn);Y("mini-compare-chart",Dt,null,Dt.variantStyle);Y("plans",be,On,be.variantStyle);Y("plans-students",be,yc,be.variantStyle);Y("plans-education",be,vc,be.variantStyle);Y("product",st,null,st.variantStyle);Y("segment",Bt,null,Bt.variantStyle);Y("special-offers",zt,_c,zt.variantStyle);var _i=(e,t=!1)=>{let r=wi.get(e.variant);if(!r)return t?void 0:new st(e);let{class:n,style:o}=r;if(o)try{let i=new CSSStyleSheet;i.replaceSync(o.cssText),e.shadowRoot.adoptedStyleSheets.push(i)}catch{let a=document.createElement("style");a.textContent=o.cssText,e.shadowRoot.appendChild(a)}return new n(e)};function Ln(e){return wi.get(e)?.fragmentMapping}var Sc=document.createElement("style");Sc.innerHTML=`
:root {
...
`;document.head.appendChild(Sc);var Tc="fragment",Cc="author",Pc="preview",Si="aem-fragment",ve,Ti=class{constructor(){w(this,ve,new Map)}clear(){u(this,ve).clear()}addByRequestedId(t,r){u(this,ve).set(t,r)}put(t,r){u(this,ve).set(t,r)}add(...t){t.forEach(r=>{let{id:n}=r;n&&u(this,ve).set(n,r)})}has(t){return u(this,ve).has(t)}get(t){return u(this,ve).get(t)}remove(t){u(this,ve).delete(t)}};ve=new WeakMap;var Nn=new Ti,Ft,ye,Re,X,le,ae,de,Nr,Mr,Gt,pe,Lc,kc,Pi,Rc,Ci=class extends HTMLElement{constructor(){super(...arguments);w(this,pe);f(this,"cache",Nn);w(this,Ft);w(this,ye,null);w(this,Re,null);w(this,X,{url:null,retryCount:0,stale:!1,measure:null,status:null});w(this,le,null);w(this,ae);w(this,de);w(this,Nr,!1);w(this,Mr,0);w(this,Gt)}static get observedAttributes(){return[Tc,Cc,Pc]}attributeChangedCallback(r,n,o){r===Tc&&_(this,ae,o),r===Cc&&_(this,Nr,["","true"].includes(o)),r===Pc&&_(this,Gt,o)}connectedCallback(){if(!u(this,de)){if(u(this,le)??_(this,le,St(this)),_(this,Gt,u(this,le).settings?.preview),u(this,Ft)??_(this,Ft,u(this,le).log.module(`${Si}[${u(this,ae)}]`)),!u(this,ae)||u(this,ae)==="#"){ne(this,pe,Pi).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(u(this,X)).filter(([r,n])=>n!=null).map(([r,n])=>[`aem-fragment:${r}`,n]))}async refresh(r=!0){if(u(this,de)&&!await Promise.race([u(this,de),Promise.resolve(!1)]))return;r&&Nn.remove(u(this,ae));try{_(this,de,ne(this,pe,Rc).call(this)),await u(this,de)}catch(s){return ne(this,pe,Pi).call(this,s.message),!1}let{references:n,referencesTree:o,placeholders:i,wcs:a}=u(this,ye)||{};return a&&!N("mas.disableWcsCache")&&u(this,le).prefillWcsCache(a),this.dispatchEvent(new CustomEvent(Fe,{detail:{...this.data,references:n,referencesTree:o,placeholders:i,...u(this,X)},bubbles:!0,composed:!0})),u(this,de)}get updateComplete(){return u(this,de)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return u(this,Re)?u(this,Re):(u(this,Nr)?this.transformAuthorData():this.transformPublishData(),u(this,Re))}transformAuthorData(){let{fields:r,id:n,tags:o,settings:i={}}=u(this,ye);_(this,Re,r.reduce((a,{name:s,multiple:c,values:l})=>(a.fields[s]=c?l:l[0],a),{fields:{},id:n,tags:o,settings:i}))}transformPublishData(){let{fields:r,id:n,tags:o,settings:i={}}=u(this,ye);_(this,Re,Object.entries(r).reduce((a,[s,c])=>(a.fields[s]=c?.mimeType?c.value:c??"",a),{fields:{},id:n,tags:o,settings:i}))}async generatePreview(){let{previewFragment:r}=await import("https://mas.adobe.com/studio/libs/fragment-client.js");return await r(u(this,ae),{locale:u(this,le).settings.locale,apiKey:u(this,le).settings.wcsApiKey})}};Ft=new WeakMap,ye=new WeakMap,Re=new WeakMap,X=new WeakMap,le=new WeakMap,ae=new WeakMap,de=new WeakMap,Nr=new WeakMap,Mr=new WeakMap,Gt=new WeakMap,pe=new WeakSet,Lc=async function(r){zi(this,Mr)._++;let n=`${Si}:${u(this,ae)}:${u(this,Mr)}`,o=`${n}${je}`,i=`${n}${qe}`;if(u(this,Gt))return await this.generatePreview();performance.mark(o);let a;try{if(u(this,X).stale=!1,u(this,X).url=r,a=await pn(r,{cache:"default",credentials:"omit"}),ne(this,pe,kc).call(this,a),u(this,X).status=a?.status,u(this,X).measure=fe(performance.measure(i,o)),u(this,X).retryCount=a.retryCount,!a?.ok)throw new Se("Unexpected fragment response",{response:a,...u(this,le).duration});return await a.json()}catch(s){if(u(this,X).measure=fe(performance.measure(i,o)),u(this,X).retryCount=s.retryCount,u(this,ye))return u(this,X).stale=!0,u(this,Ft).error("Serving stale data",u(this,X)),u(this,ye);let c=s.message??"unknown";throw new Se(`Failed to fetch fragment: ${c}`,{})}},kc=function(r){Object.assign(u(this,X),Yr(r))},Pi=function(r){_(this,de,null),u(this,X).message=r,this.classList.add("error");let n={...u(this,X),...u(this,le).duration};u(this,Ft).error(r,n),this.dispatchEvent(new CustomEvent(Ge,{detail:n,bubbles:!0,composed:!0}))},Rc=async function(){this.classList.remove("error"),_(this,Re,null);let r=Nn.get(u(this,ae));if(r)return _(this,ye,r),!0;let{masIOUrl:n,wcsApiKey:o,locale:i}=u(this,le).settings,a=`${n}/fragment?id=${u(this,ae)}&api_key=${o}&locale=${i}`;return r=await ne(this,pe,Lc).call(this,a),Nn.addByRequestedId(u(this,ae),r),_(this,ye,r),!0};customElements.define(Si,Ci);var Vt=class extends H{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent}connectedCallback(){this.borderColor&&this.borderColor!=="Transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-border-radius","4px 0 0 4px"),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="",super.connectedCallback()}render(){return x`<div class="badge">
    ...
    `),f(Ur,"properties",{offers:{type:Array},selectedOffer:{type:Object},defaults:{type:Object},variant:{type:String,attribute:"variant",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},stock:{type:Boolean,reflect:!0}});customElements.define("merch-offer-select",Ur);var Hc=v`
    :host {
...
`;var jc={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},Xt=class extends M{getGlobalCSS(){return Vc}renderLayout(){return x` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;var Ii={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300"}}},mt=class extends M{getGlobalCSS(){return Yc}get aemFragmentMapping(){return Ii}renderLayout(){return x`            
    ...
    `);customElements.define("fries-card",mt);Y("ccd-suggested",Yt,Gc,Yt.variantStyle);Y("ccd-slice",Xt,jc,Xt.variantStyle);Y("ah-try-buy-widget",dt,Mi,dt.variantStyle);Y("ah-promoted-plans",pt,$i,pt.variantStyle);Y("fries",mt,Ii,mt.variantStyle);
