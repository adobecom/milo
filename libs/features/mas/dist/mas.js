      ...
      `];var it,Gt=class Gt{constructor(t){p(this,"card");G(this,it);this.card=t,this.insertVariantStyle()}getContainer(){return K(this,it,L(this,it)??this.card.closest('[class*="-merch-cards"]')??this.card.parentElement),L(this,it)}insertVariantStyle(){if(!Gt.styleMap[this.card.variant]){Gt.styleMap[this.card.variant]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(t,r){if(!t)return;let n=`--consonant-merch-card-${this.card.variant}-${r}-height`,i=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),o=parseInt(this.getContainer().style.getPropertyValue(n))||0;i>o&&this.getContainer().style.setProperty(n,`${i}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),x`
        ...
        `}get cardImage(){return x` <div class="image">
            ...
            ${this.badge}
              ...
              >`:"";return x`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){}};it=new WeakMap,p(Gt,"styleMap",{});var C=Gt;function q(e,t={},r=null,n=null){let i=n?document.createElement(e,{is:n}):document.createElement(e);r instanceof HTMLElement?i.appendChild(r):i.innerHTML=r;for(let[o,a]of Object.entries(t))i.setAttribute(o,a);return i}function Er(){return window.matchMedia("(max-width: 767px)").matches}function Wo(){return window.matchMedia("(max-width: 1024px)").matches}var qn={};Zs(qn,{CLASS_NAME_FAILED:()=>Hn,CLASS_NAME_HIDDEN:()=>dc,CLASS_NAME_PENDING:()=>Un,CLASS_NAME_RESOLVED:()=>Dn,ERROR_MESSAGE_BAD_REQUEST:()=>Bn,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>yc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Gn,EVENT_AEM_ERROR:()=>Me,EVENT_AEM_LOAD:()=>Re,EVENT_MAS_ERROR:()=>Vn,EVENT_MAS_READY:()=>$n,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Mn,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>bc,EVENT_MERCH_CARD_COLLECTION_SORT:()=>xc,EVENT_MERCH_CARD_READY:()=>Rn,EVENT_MERCH_OFFER_READY:()=>mc,EVENT_MERCH_OFFER_SELECT_READY:()=>On,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>Tr,EVENT_MERCH_SEARCH_CHANGE:()=>gc,EVENT_MERCH_SIDENAV_SELECT:()=>vc,EVENT_MERCH_STOCK_CHANGE:()=>fc,EVENT_MERCH_STORAGE_CHANGE:()=>Sr,EVENT_OFFER_SELECTED:()=>pc,EVENT_TYPE_FAILED:()=>zn,EVENT_TYPE_READY:()=>ot,EVENT_TYPE_RESOLVED:()=>Fn,LOG_NAMESPACE:()=>Kn,Landscape:()=>$e,NAMESPACE:()=>hc,PARAM_AOS_API_KEY:()=>Ac,PARAM_ENV:()=>jn,PARAM_LANDSCAPE:()=>Yn,PARAM_WCS_API_KEY:()=>Ec,STATE_FAILED:()=>he,STATE_PENDING:()=>Ee,STATE_RESOLVED:()=>de,TAG_NAME_SERVICE:()=>uc,WCS_PROD_URL:()=>Xn,WCS_STAGE_URL:()=>Wn});var hc="merch",dc="hidden",ot="wcms:commerce:ready",uc="mas-commerce-service",mc="merch-offer:ready",On="merch-offer-select:ready",Rn="merch-card:ready",Mn="merch-card:action-menu-toggle",pc="merch-offer:selected",fc="merch-stock:change",Sr="merch-storage:change",Tr="merch-quantity-selector:change",gc="merch-search:change",xc="merch-card-collection:sort",bc="merch-card-collection:showmore",vc="merch-sidenav:select",Re="aem:load",Me="aem:error",$n="mas:ready",Vn="mas:error",Hn="placeholder-failed",Un="placeholder-pending",Dn="placeholder-resolved",Bn="Bad WCS request",Gn="Commerce offer not found",yc="Literals URL not provided",zn="mas:failed",Fn="mas:resolved",Kn="mas/commerce",jn="commerce.env",Yn="commerce.landscape",Ac="commerce.aosKey",Ec="commerce.wcsKey",Xn="https://www.adobe.com/web_commerce_artifact",Wn="https://www.stage.adobe.com/web_commerce_artifact_stage",he="failed",Ee="pending",de="resolved",$e={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"};var qo=`
:root {
...
`;var wr=class extends C{constructor(t){super(t)}getGlobalCSS(){return Zo}renderLayout(){return x`${this.cardImage}
    <div class="body">
...
`;var Lr=class extends C{constructor(t){super(t)}getGlobalCSS(){return Jo}renderLayout(){return x` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var ei={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},mt=class extends C{getGlobalCSS(){return aa}get aemFragmentMapping(){return ei}renderLayout(){return x` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;document.head.appendChild(ha);var pa=new CSSStyleSheet;pa.replaceSync(":host { display: contents; }");var Tc=document.querySelector('meta[name="aem-base-url"]')?.content??"https://odin.adobe.com",da="fragment",ua="author",wc="ims",ma=e=>{throw new Error(`Failed to get fragment: ${e}`)};async function Lc(e,t,r,n){let i=r?`${e}/adobe/sites/cf/fragments/${t}`:`${e}/adobe/sites/fragments/${t}`,o=Date.now(),a=await fetch(i,{cache:"default",credentials:"omit",headers:n}).catch(c=>ma(`Error fetching fragment ${i}: ${c.message}`)),s=Date.now();return a?.ok||ma(`status: ${a.status} ${a.statusText}, url: ${i}, start: ${o}, end: ${s}`),a.json()}var ni,Se,ii=class{constructor(){G(this,Se,new Map)}clear(){L(this,Se).clear()}add(...t){t.forEach(r=>{let{id:n}=r;n&&L(this,Se).set(n,r)})}has(t){return L(this,Se).has(t)}get(t){return L(this,Se).get(t)}remove(t){L(this,Se).delete(t)}};Se=new WeakMap;var _r=new ii,Ue,ue,Te,zt,me,pt,pe,ai,fa,ga,oi=class extends HTMLElement{constructor(){super();G(this,pe);p(this,"cache",_r);G(this,Ue);G(this,ue);G(this,Te);G(this,zt,!1);G(this,me);G(this,pt,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[pa];let r=this.getAttribute(wc);["",!0,"true"].includes(r)&&(K(this,zt,!0),ni||(ni={Authorization:`Bearer ${window.adobeid?.authorize?.()}`}))}static get observedAttributes(){return[da,ua]}attributeChangedCallback(r,n,i){r===da&&(K(this,Te,i),this.refresh(!1)),r===ua&&K(this,pt,["","true"].includes(i))}connectedCallback(){if(!L(this,Te)){ce(this,pe,ai).call(this,"Missing fragment id");return}}async refresh(r=!0){L(this,me)&&!await Promise.race([L(this,me),Promise.resolve(!1)])||(r&&_r.remove(L(this,Te)),K(this,me,this.fetchData().then(()=>(this.dispatchEvent(new CustomEvent(Re,{detail:this.data,bubbles:!0,composed:!0})),!0)).catch(n=>(ce(this,pe,ai).call(this,n.message),K(this,me,null),!1))),L(this,me))}async fetchData(){K(this,Ue,null),K(this,ue,null);let r=_r.get(L(this,Te));r||(r=await Lc(Tc,L(this,Te),L(this,pt),L(this,zt)?ni:void 0),_r.add(r)),K(this,Ue,r)}get updateComplete(){return L(this,me)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return L(this,ue)?L(this,ue):(L(this,pt)?ce(this,pe,fa).call(this):ce(this,pe,ga).call(this),L(this,ue))}};Ue=new WeakMap,ue=new WeakMap,Te=new WeakMap,zt=new WeakMap,me=new WeakMap,pt=new WeakMap,pe=new WeakSet,ai=function(r){this.classList.add("error"),this.dispatchEvent(new CustomEvent(Me,{detail:r,bubbles:!0,composed:!0}))},fa=function(){let{fields:r,id:n,tags:i}=L(this,Ue);K(this,ue,r.reduce((o,{name:a,multiple:s,values:c})=>(o.fields[a]=s?c:c[0],o),{fields:{},id:n,tags:i}))},ga=function(){let{fields:r,id:n,tags:i}=L(this,Ue);K(this,ue,Object.entries(r).reduce((o,[a,s])=>(o.fields[a]=s?.mimeType?s.value:s??"",o),{fields:{},id:n,tags:i}))};customElements.define("aem-fragment",oi);var Ft;(function(e){e.STAGE="STAGE",e.PRODUCTION="PRODUCTION",e.LOCAL="LOCAL"})(Ft||(Ft={}));var si;(function(e){e.STAGE="STAGE",e.PRODUCTION="PROD",e.LOCAL="LOCAL"})(si||(si={}));var Kt;(function(e){e.DRAFT="DRAFT",e.PUBLISHED="PUBLISHED"})(Kt||(Kt={}));var De;(function(e){e.V2="UCv2",e.V3="UCv3"})(De||(De={}));var ee;(function(e){e.CHECKOUT="checkout",e.CHECKOUT_EMAIL="checkout/email",e.SEGMENTATION="segmentation",e.BUNDLE="bundle",e.COMMITMENT="commitment",e.RECOMMENDATION="recommendation",e.EMAIL="email",e.PAYMENT="payment",e.CHANGE_PLAN_TEAM_PLANS="change-plan/team-upgrade/plans",e.CHANGE_PLAN_TEAM_PAYMENT="change-plan/team-upgrade/payment"})(ee||(ee={}));var ci=function(e){var t;return(t=_c.get(e))!==null&&t!==void 0?t:e},_c=new Map([["countrySpecific","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["offerType","ot"],["marketSegment","ms"]]);var xa=function(e){var t=typeof Symbol=="function"&&Symbol.iterator,r=t&&e[t],n=0;if(r)return r.call(e);if(e&&typeof e.length=="number")return{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}};throw new TypeError(t?"Object is not iterable.":"Symbol.iterator is not defined.")},ba=function(e,t){var r=typeof Symbol=="function"&&e[Symbol.iterator];if(!r)return e;var n=r.call(e),i,o=[],a;try{for(;(t===void 0||t-- >0)&&!(i=n.next()).done;)o.push(i.value)}catch(s){a={error:s}}finally{try{i&&!i.done&&(r=n.return)&&r.call(n)}finally{if(a)throw a.error}}return o};function ft(e,t,r){var n,i;try{for(var o=xa(Object.entries(e)),a=o.next();!a.done;a=o.next()){var s=ba(a.value,2),c=s[0],l=s[1],h=ci(c);l!=null&&r.has(h)&&t.set(h,l)}}catch(d){n={error:d}}finally{try{a&&!a.done&&(i=o.return)&&i.call(o)}finally{if(n)throw n.error}}}function Pr(e){switch(e){case Ft.PRODUCTION:return"https://commerce.adobe.com";default:return"https://commerce-stg.adobe.com"}}function Cr(e,t){var r,n;for(var i in e){var o=e[i];try{for(var a=(r=void 0,xa(Object.entries(o))),s=a.next();!s.done;s=a.next()){var c=ba(s.value,2),l=c[0],h=c[1];if(h!=null){var d=ci(l);t.set("items["+i+"]["+d+"]",h)}}}catch(u){r={error:u}}finally{try{s&&!s.done&&(n=a.return)&&n.call(a)}finally{if(r)throw r.error}}}}var Pc=function(e,t){var r={};for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,n=Object.getOwnPropertySymbols(e);i<n.length;i++)t.indexOf(n[i])<0&&Object.prototype.propertyIsEnumerable.call(e,n[i])&&(r[n[i]]=e[n[i]]);return r},Cc=function(e){var t=typeof Symbol=="function"&&Symbol.iterator,r=t&&e[t],n=0;if(r)return r.call(e);if(e&&typeof e.length=="number")return{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}};throw new TypeError(t?"Object is not iterable.":"Symbol.iterator is not defined.")};function va(e){Nc(e);var t=e.env,r=e.items,n=e.workflowStep,i=Pc(e,["env","items","workflowStep"]),o=new URL(Pr(t));return o.pathname=n+"/",Cr(r,o.searchParams),ft(i,o.searchParams,kc),o.toString()}var kc=new Set(["cli","co","lang","ctx","cUrl","mv","nglwfdata","otac","promoid","rUrl","sdid","spint","trackingid","code","campaignid","appctxid"]),Ic=["env","workflowStep","clientId","country","items"];function Nc(e){var t,r;try{for(var n=Cc(Ic),i=n.next();!i.done;i=n.next()){var o=i.value;if(!e[o])throw new Error('Argument "checkoutData" is not valid, missing: '+o)}}catch(a){t={error:a}}finally{try{i&&!i.done&&(r=n.return)&&r.call(n)}finally{if(t)throw t.error}}return!0}var Oc=function(e,t){var r={};for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,n=Object.getOwnPropertySymbols(e);i<n.length;i++)t.indexOf(n[i])<0&&Object.prototype.propertyIsEnumerable.call(e,n[i])&&(r[n[i]]=e[n[i]]);return r},Rc=function(e){var t=typeof Symbol=="function"&&Symbol.iterator,r=t&&e[t],n=0;if(r)return r.call(e);if(e&&typeof e.length=="number")return{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}};throw new TypeError(t?"Object is not iterable.":"Symbol.iterator is not defined.")},Mc="p_draft_landscape",$c="/store/";function hi(e){Hc(e);var t=e.env,r=e.items,n=e.workflowStep,i=e.ms,o=e.marketSegment,a=e.ot,s=e.offerType,c=e.pa,l=e.productArrangementCode,h=e.landscape,d=Oc(e,["env","items","workflowStep","ms","marketSegment","ot","offerType","pa","productArrangementCode","landscape"]),u={marketSegment:o??i,offerType:s??a,productArrangementCode:l??c},m=new URL(Pr(t));return m.pathname=""+$c+n,n!==ee.SEGMENTATION&&n!==ee.CHANGE_PLAN_TEAM_PLANS&&Cr(r,m.searchParams),n===ee.SEGMENTATION&&ft(u,m.searchParams,li),ft(d,m.searchParams,li),h===Kt.DRAFT&&ft({af:Mc},m.searchParams,li),m.toString()}var li=new Set(["af","ai","apc","appctxid","cli","co","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),Vc=["env","workflowStep","clientId","country"];function Hc(e){var t,r;try{for(var n=Rc(Vc),i=n.next();!i.done;i=n.next()){var o=i.value;if(!e[o])throw new Error('Argument "checkoutData" is not valid, missing: '+o)}}catch(a){t={error:a}}finally{try{i&&!i.done&&(r=n.return)&&r.call(n)}finally{if(t)throw t.error}}if(e.workflowStep!==ee.SEGMENTATION&&e.workflowStep!==ee.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}function di(e,t){switch(e){case De.V2:return va(t);case De.V3:return hi(t);default:return console.warn("Unsupported CheckoutType, will use UCv3 as default. Given type: "+e),hi(t)}}var ui;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(ui||(ui={}));var U;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(U||(U={}));var O;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(O||(O={}));var mi;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(mi||(mi={}));var pi;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(pi||(pi={}));var fi;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(fi||(fi={}));var gi;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(gi||(gi={}));var ya="tacocat.js";var kr=(e,t)=>String(e??"").toLowerCase()==String(t??"").toLowerCase(),Aa=e=>`${e??""}`.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t]??t)??"";function R(e,t={},{metadata:r=!0,search:n=!0,storage:i=!0}={}){let o;if(n&&o==null){let a=new URLSearchParams(window.location.search),s=gt(n)?n:e;o=a.get(s)}if(i&&o==null){let a=gt(i)?i:e;o=window.sessionStorage.getItem(a)??window.localStorage.getItem(a)}if(r&&o==null){let a=Uc(gt(r)?r:e);o=document.documentElement.querySelector(`meta[name="${a}"]`)?.content}return o??t[e]}var xt=()=>{};var Ea=e=>typeof e=="boolean",jt=e=>typeof e=="function",Ir=e=>typeof e=="number",Sa=e=>e!=null&&typeof e=="object";var gt=e=>typeof e=="string",xi=e=>gt(e)&&e,bt=e=>Ir(e)&&Number.isFinite(e)&&e>0;function vt(e,t=r=>r==null||r===""){return e!=null&&Object.entries(e).forEach(([r,n])=>{t(n)&&delete e[r]}),e}function T(e,t){if(Ea(e))return e;let r=String(e);return r==="1"||r==="true"?!0:r==="0"||r==="false"?!1:t}function we(e,t,r){let n=Object.values(t);return n.find(i=>kr(i,e))??r??n[0]}function Uc(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,r,n)=>`${r}-${n}`).replace(/\W+/gu,"-").toLowerCase()}function yt(e,t=1){return Ir(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:t}var Dc=Date.now(),bi=()=>`(+${Date.now()-Dc}ms)`,Nr=new Set,Bc=T(R("tacocat.debug",{},{metadata:!1}),!1);function Ta(e){let t=`[${ya}/${e}]`,r=(a,s,...c)=>a?!0:(i(s,...c),!1),n=Bc?(a,...s)=>{console.debug(`${t} ${a}`,...s,bi())}:()=>{},i=(a,...s)=>{let c=`${t} ${a}`;Nr.forEach(([l])=>l(c,...s))};return{assert:r,debug:n,error:i,warn:(a,...s)=>{let c=`${t} ${a}`;Nr.forEach(([,l])=>l(c,...s))}}}function Gc(e,t){let r=[e,t];return Nr.add(r),()=>{Nr.delete(r)}}Gc((e,...t)=>{console.error(e,...t,bi())},(e,...t)=>{console.warn(e,...t,bi())});var zc="no promo",wa="promo-tag",Fc="yellow",Kc="neutral",jc=(e,t,r)=>{let n=o=>o||zc,i=r?` (was "${n(t)}")`:"";return`${n(e)}${i}`},Yc="cancel-context",Yt=(e,t)=>{let r=e===Yc,n=!r&&e?.length>0,i=(n||r)&&(t&&t!=e||!t&&!r),o=i&&n||!i&&!!t,a=o?e||t:void 0;return{effectivePromoCode:a,overridenPromoCode:e,className:o?wa:`${wa} no-promo`,text:jc(a,t,i),variant:o?Fc:Kc,isOverriden:i}};var vi="ABM",yi="PUF",Ai="M2M",Ei="PERPETUAL",Si="P3Y",Xc="TAX_INCLUSIVE_DETAILS",Wc="TAX_EXCLUSIVE",La={ABM:vi,PUF:yi,M2M:Ai,PERPETUAL:Ei,P3Y:Si},Gm={[vi]:{commitment:U.YEAR,term:O.MONTHLY},[yi]:{commitment:U.YEAR,term:O.ANNUAL},[Ai]:{commitment:U.MONTH,term:O.MONTHLY},[Ei]:{commitment:U.PERPETUAL,term:void 0},[Si]:{commitment:U.THREE_MONTHS,term:O.P3Y}},_a="Value is not an offer",Or=e=>{if(typeof e!="object")return _a;let{commitment:t,term:r}=e,n=qc(t,r);return{...e,planType:n}};var qc=(e,t)=>{switch(e){case void 0:return _a;case"":return"";case U.YEAR:return t===O.MONTHLY?vi:t===O.ANNUAL?yi:"";case U.MONTH:return t===O.MONTHLY?Ai:"";case U.PERPETUAL:return Ei;case U.TERM_LICENSE:return t===O.P3Y?Si:"";default:return""}};function Ti(e){let{priceDetails:t}=e,{price:r,priceWithoutDiscount:n,priceWithoutTax:i,priceWithoutDiscountAndTax:o,taxDisplay:a}=t;if(a!==Xc)return e;let s={...e,priceDetails:{...t,price:i??r,priceWithoutDiscount:o??n,taxDisplay:Wc}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var wi=function(e,t){return wi=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(r,n){r.__proto__=n}||function(r,n){for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(r[i]=n[i])},wi(e,t)};function Xt(e,t){if(typeof t!="function"&&t!==null)throw new TypeError("Class extends value "+String(t)+" is not a constructor or null");wi(e,t);function r(){this.constructor=e}e.prototype=t===null?Object.create(t):(r.prototype=t.prototype,new r)}var A=function(){return A=Object.assign||function(t){for(var r,n=1,i=arguments.length;n<i;n++){r=arguments[n];for(var o in r)Object.prototype.hasOwnProperty.call(r,o)&&(t[o]=r[o])}return t},A.apply(this,arguments)};function Rr(e,t,r){if(r||arguments.length===2)for(var n=0,i=t.length,o;n<i;n++)(o||!(n in t))&&(o||(o=Array.prototype.slice.call(t,0,n)),o[n]=t[n]);return e.concat(o||Array.prototype.slice.call(t))}var v;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(v||(v={}));var I;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(I||(I={}));var Be;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(Be||(Be={}));function Li(e){return e.type===I.literal}function Pa(e){return e.type===I.argument}function Mr(e){return e.type===I.number}function $r(e){return e.type===I.date}function Vr(e){return e.type===I.time}function Hr(e){return e.type===I.select}function Ur(e){return e.type===I.plural}function Ca(e){return e.type===I.pound}function Dr(e){return e.type===I.tag}function Br(e){return!!(e&&typeof e=="object"&&e.type===Be.number)}function Wt(e){return!!(e&&typeof e=="object"&&e.type===Be.dateTime)}var _i=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var Zc=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function ka(e){var t={};return e.replace(Zc,function(r){var n=r.length;switch(r[0]){case"G":t.era=n===4?"long":n===5?"narrow":"short";break;case"y":t.year=n===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":t.month=["numeric","2-digit","short","long","narrow"][n-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":t.day=["numeric","2-digit"][n-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":t.weekday=n===4?"short":n===5?"narrow":"short";break;case"e":if(n<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][n-4];break;case"c":if(n<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][n-4];break;case"a":t.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":t.hourCycle="h12",t.hour=["numeric","2-digit"][n-1];break;case"H":t.hourCycle="h23",t.hour=["numeric","2-digit"][n-1];break;case"K":t.hourCycle="h11",t.hour=["numeric","2-digit"][n-1];break;case"k":t.hourCycle="h24",t.hour=["numeric","2-digit"][n-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":t.minute=["numeric","2-digit"][n-1];break;case"s":t.second=["numeric","2-digit"][n-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":t.timeZoneName=n<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),t}var Ia=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function Ma(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var t=e.split(Ia).filter(function(u){return u.length>0}),r=[],n=0,i=t;n<i.length;n++){var o=i[n],a=o.split("/");if(a.length===0)throw new Error("Invalid number skeleton");for(var s=a[0],c=a.slice(1),l=0,h=c;l<h.length;l++){var d=h[l];if(d.length===0)throw new Error("Invalid number skeleton")}r.push({stem:s,options:c})}return r}function Jc(e){return e.replace(/^(.*?)-/,"")}var Na=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,$a=/^(@+)?(\+|#+)?[rs]?$/g,Qc=/(\*)(0+)|(#+)(0+)|(0+)/g,Va=/^(0+)$/;function Oa(e){var t={};return e[e.length-1]==="r"?t.roundingPriority="morePrecision":e[e.length-1]==="s"&&(t.roundingPriority="lessPrecision"),e.replace($a,function(r,n,i){return typeof i!="string"?(t.minimumSignificantDigits=n.length,t.maximumSignificantDigits=n.length):i==="+"?t.minimumSignificantDigits=n.length:n[0]==="#"?t.maximumSignificantDigits=n.length:(t.minimumSignificantDigits=n.length,t.maximumSignificantDigits=n.length+(typeof i=="string"?i.length:0)),""}),t}function Ha(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function el(e){var t;if(e[0]==="E"&&e[1]==="E"?(t={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(t={notation:"scientific"},e=e.slice(1)),t){var r=e.slice(0,2);if(r==="+!"?(t.signDisplay="always",e=e.slice(2)):r==="+?"&&(t.signDisplay="exceptZero",e=e.slice(2)),!Va.test(e))throw new Error("Malformed concise eng/scientific notation");t.minimumIntegerDigits=e.length}return t}function Ra(e){var t={},r=Ha(e);return r||t}function Ua(e){for(var t={},r=0,n=e;r<n.length;r++){var i=n[r];switch(i.stem){case"percent":case"%":t.style="percent";continue;case"%x100":t.style="percent",t.scale=100;continue;case"currency":t.style="currency",t.currency=i.options[0];continue;case"group-off":case",_":t.useGrouping=!1;continue;case"precision-integer":case".":t.maximumFractionDigits=0;continue;case"measure-unit":case"unit":t.style="unit",t.unit=Jc(i.options[0]);continue;case"compact-short":case"K":t.notation="compact",t.compactDisplay="short";continue;case"compact-long":case"KK":t.notation="compact",t.compactDisplay="long";continue;case"scientific":t=A(A(A({},t),{notation:"scientific"}),i.options.reduce(function(c,l){return A(A({},c),Ra(l))},{}));continue;case"engineering":t=A(A(A({},t),{notation:"engineering"}),i.options.reduce(function(c,l){return A(A({},c),Ra(l))},{}));continue;case"notation-simple":t.notation="standard";continue;case"unit-width-narrow":t.currencyDisplay="narrowSymbol",t.unitDisplay="narrow";continue;case"unit-width-short":t.currencyDisplay="code",t.unitDisplay="short";continue;case"unit-width-full-name":t.currencyDisplay="name",t.unitDisplay="long";continue;case"unit-width-iso-code":t.currencyDisplay="symbol";continue;case"scale":t.scale=parseFloat(i.options[0]);continue;case"integer-width":if(i.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");i.options[0].replace(Qc,function(c,l,h,d,u,m){if(l)t.minimumIntegerDigits=h.length;else{if(d&&u)throw new Error("We currently do not support maximum integer digits");if(m)throw new Error("We currently do not support exact integer digits")}return""});continue}if(Va.test(i.stem)){t.minimumIntegerDigits=i.stem.length;continue}if(Na.test(i.stem)){if(i.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");i.stem.replace(Na,function(c,l,h,d,u,m){return h==="*"?t.minimumFractionDigits=l.length:d&&d[0]==="#"?t.maximumFractionDigits=d.length:u&&m?(t.minimumFractionDigits=u.length,t.maximumFractionDigits=u.length+m.length):(t.minimumFractionDigits=l.length,t.maximumFractionDigits=l.length),""});var o=i.options[0];o==="w"?t=A(A({},t),{trailingZeroDisplay:"stripIfInteger"}):o&&(t=A(A({},t),Oa(o)));continue}if($a.test(i.stem)){t=A(A({},t),Oa(i.stem));continue}var a=Ha(i.stem);a&&(t=A(A({},t),a));var s=el(i.stem);s&&(t=A(A({},t),s))}return t}var qt={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function Da(e,t){for(var r="",n=0;n<e.length;n++){var i=e.charAt(n);if(i==="j"){for(var o=0;n+1<e.length&&e.charAt(n+1)===i;)o++,n++;var a=1+(o&1),s=o<2?1:3+(o>>1),c="a",l=tl(t);for((l=="H"||l=="k")&&(s=0);s-- >0;)r+=c;for(;a-- >0;)r=l+r}else i==="J"?r+="H":r+=i}return r}function tl(e){var t=e.hourCycle;if(t===void 0&&e.hourCycles&&e.hourCycles.length&&(t=e.hourCycles[0]),t)switch(t){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var r=e.language,n;r!=="root"&&(n=e.maximize().region);var i=qt[n||""]||qt[r||""]||qt["".concat(r,"-001")]||qt["001"];return i[0]}var Pi,rl=new RegExp("^".concat(_i.source,"*")),nl=new RegExp("".concat(_i.source,"*$"));function E(e,t){return{start:e,end:t}}var il=!!String.prototype.startsWith,ol=!!String.fromCodePoint,al=!!Object.fromEntries,sl=!!String.prototype.codePointAt,cl=!!String.prototype.trimStart,ll=!!String.prototype.trimEnd,hl=!!Number.isSafeInteger,dl=hl?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},ki=!0;try{Ba=Ka("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),ki=((Pi=Ba.exec("a"))===null||Pi===void 0?void 0:Pi[0])==="a"}catch{ki=!1}var Ba,Ga=il?function(t,r,n){return t.startsWith(r,n)}:function(t,r,n){return t.slice(n,n+r.length)===r},Ii=ol?String.fromCodePoint:function(){for(var t=[],r=0;r<arguments.length;r++)t[r]=arguments[r];for(var n="",i=t.length,o=0,a;i>o;){if(a=t[o++],a>1114111)throw RangeError(a+" is not a valid code point");n+=a<65536?String.fromCharCode(a):String.fromCharCode(((a-=65536)>>10)+55296,a%1024+56320)}return n},za=al?Object.fromEntries:function(t){for(var r={},n=0,i=t;n<i.length;n++){var o=i[n],a=o[0],s=o[1];r[a]=s}return r},Fa=sl?function(t,r){return t.codePointAt(r)}:function(t,r){var n=t.length;if(!(r<0||r>=n)){var i=t.charCodeAt(r),o;return i<55296||i>56319||r+1===n||(o=t.charCodeAt(r+1))<56320||o>57343?i:(i-55296<<10)+(o-56320)+65536}},ul=cl?function(t){return t.trimStart()}:function(t){return t.replace(rl,"")},ml=ll?function(t){return t.trimEnd()}:function(t){return t.replace(nl,"")};function Ka(e,t){return new RegExp(e,t)}var Ni;ki?(Ci=Ka("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Ni=function(t,r){var n;Ci.lastIndex=r;var i=Ci.exec(t);return(n=i[1])!==null&&n!==void 0?n:""}):Ni=function(t,r){for(var n=[];;){var i=Fa(t,r);if(i===void 0||Ya(i)||gl(i))break;n.push(i),r+=i>=65536?2:1}return Ii.apply(void 0,n)};var Ci,ja=function(){function e(t,r){r===void 0&&(r={}),this.message=t,this.position={offset:0,line:1,column:1},this.ignoreTag=!!r.ignoreTag,this.locale=r.locale,this.requiresOtherClause=!!r.requiresOtherClause,this.shouldParseSkeletons=!!r.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(t,r,n){for(var i=[];!this.isEOF();){var o=this.char();if(o===123){var a=this.parseArgument(t,n);if(a.err)return a;i.push(a.val)}else{if(o===125&&t>0)break;if(o===35&&(r==="plural"||r==="selectordinal")){var s=this.clonePosition();this.bump(),i.push({type:I.pound,location:E(s,this.clonePosition())})}else if(o===60&&!this.ignoreTag&&this.peek()===47){if(n)break;return this.error(v.UNMATCHED_CLOSING_TAG,E(this.clonePosition(),this.clonePosition()))}else if(o===60&&!this.ignoreTag&&Oi(this.peek()||0)){var a=this.parseTag(t,r);if(a.err)return a;i.push(a.val)}else{var a=this.parseLiteral(t,r);if(a.err)return a;i.push(a.val)}}}return{val:i,err:null}},e.prototype.parseTag=function(t,r){var n=this.clonePosition();this.bump();var i=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:I.literal,value:"<".concat(i,"/>"),location:E(n,this.clonePosition())},err:null};if(this.bumpIf(">")){var o=this.parseMessage(t+1,r,!0);if(o.err)return o;var a=o.val,s=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!Oi(this.char()))return this.error(v.INVALID_TAG,E(s,this.clonePosition()));var c=this.clonePosition(),l=this.parseTagName();return i!==l?this.error(v.UNMATCHED_CLOSING_TAG,E(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:I.tag,value:i,children:a,location:E(n,this.clonePosition())},err:null}:this.error(v.INVALID_TAG,E(s,this.clonePosition())))}else return this.error(v.UNCLOSED_TAG,E(n,this.clonePosition()))}else return this.error(v.INVALID_TAG,E(n,this.clonePosition()))},e.prototype.parseTagName=function(){var t=this.offset();for(this.bump();!this.isEOF()&&fl(this.char());)this.bump();return this.message.slice(t,this.offset())},e.prototype.parseLiteral=function(t,r){for(var n=this.clonePosition(),i="";;){var o=this.tryParseQuote(r);if(o){i+=o;continue}var a=this.tryParseUnquoted(t,r);if(a){i+=a;continue}var s=this.tryParseLeftAngleBracket();if(s){i+=s;continue}break}var c=E(n,this.clonePosition());return{val:{type:I.literal,value:i,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!pl(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(t){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(t==="plural"||t==="selectordinal")break;return null;default:return null}this.bump();var r=[this.char()];for(this.bump();!this.isEOF();){var n=this.char();if(n===39)if(this.peek()===39)r.push(39),this.bump();else{this.bump();break}else r.push(n);this.bump()}return Ii.apply(void 0,r)},e.prototype.tryParseUnquoted=function(t,r){if(this.isEOF())return null;var n=this.char();return n===60||n===123||n===35&&(r==="plural"||r==="selectordinal")||n===125&&t>0?null:(this.bump(),Ii(n))},e.prototype.parseArgument=function(t,r){var n=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(v.EXPECT_ARGUMENT_CLOSING_BRACE,E(n,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(v.EMPTY_ARGUMENT,E(n,this.clonePosition()));var i=this.parseIdentifierIfPossible().value;if(!i)return this.error(v.MALFORMED_ARGUMENT,E(n,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(v.EXPECT_ARGUMENT_CLOSING_BRACE,E(n,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:I.argument,value:i,location:E(n,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(v.EXPECT_ARGUMENT_CLOSING_BRACE,E(n,this.clonePosition())):this.parseArgumentOptions(t,r,i,n);default:return this.error(v.MALFORMED_ARGUMENT,E(n,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var t=this.clonePosition(),r=this.offset(),n=Ni(this.message,r),i=r+n.length;this.bumpTo(i);var o=this.clonePosition(),a=E(t,o);return{value:n,location:a}},e.prototype.parseArgumentOptions=function(t,r,n,i){var o,a=this.clonePosition(),s=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(s){case"":return this.error(v.EXPECT_ARGUMENT_TYPE,E(a,c));case"number":case"date":case"time":{this.bumpSpace();var l=null;if(this.bumpIf(",")){this.bumpSpace();var h=this.clonePosition(),d=this.parseSimpleArgStyleIfPossible();if(d.err)return d;var u=ml(d.val);if(u.length===0)return this.error(v.EXPECT_ARGUMENT_STYLE,E(this.clonePosition(),this.clonePosition()));var m=E(h,this.clonePosition());l={style:u,styleLocation:m}}var g=this.tryParseArgumentClose(i);if(g.err)return g;var f=E(i,this.clonePosition());if(l&&Ga(l?.style,"::",0)){var S=ul(l.style.slice(2));if(s==="number"){var d=this.parseNumberSkeletonFromString(S,l.styleLocation);return d.err?d:{val:{type:I.number,value:n,location:f,style:d.val},err:null}}else{if(S.length===0)return this.error(v.EXPECT_DATE_TIME_SKELETON,f);var _=S;this.locale&&(_=Da(S,this.locale));var u={type:Be.dateTime,pattern:_,location:l.styleLocation,parsedOptions:this.shouldParseSkeletons?ka(_):{}},b=s==="date"?I.date:I.time;return{val:{type:b,value:n,location:f,style:u},err:null}}}return{val:{type:s==="number"?I.number:s==="date"?I.date:I.time,value:n,location:f,style:(o=l?.style)!==null&&o!==void 0?o:null},err:null}}case"plural":case"selectordinal":case"select":{var y=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(v.EXPECT_SELECT_ARGUMENT_OPTIONS,E(y,A({},y)));this.bumpSpace();var k=this.parseIdentifierIfPossible(),N=0;if(s!=="select"&&k.value==="offset"){if(!this.bumpIf(":"))return this.error(v.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,E(this.clonePosition(),this.clonePosition()));this.bumpSpace();var d=this.tryParseDecimalInteger(v.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,v.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(d.err)return d;this.bumpSpace(),k=this.parseIdentifierIfPossible(),N=d.val}var $=this.tryParsePluralOrSelectOptions(t,s,r,k);if($.err)return $;var g=this.tryParseArgumentClose(i);if(g.err)return g;var V=E(i,this.clonePosition());return s==="select"?{val:{type:I.select,value:n,options:za($.val),location:V},err:null}:{val:{type:I.plural,value:n,options:za($.val),offset:N,pluralType:s==="plural"?"cardinal":"ordinal",location:V},err:null}}default:return this.error(v.INVALID_ARGUMENT_TYPE,E(a,c))}},e.prototype.tryParseArgumentClose=function(t){return this.isEOF()||this.char()!==125?this.error(v.EXPECT_ARGUMENT_CLOSING_BRACE,E(t,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var t=0,r=this.clonePosition();!this.isEOF();){var n=this.char();switch(n){case 39:{this.bump();var i=this.clonePosition();if(!this.bumpUntil("'"))return this.error(v.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,E(i,this.clonePosition()));this.bump();break}case 123:{t+=1,this.bump();break}case 125:{if(t>0)t-=1;else return{val:this.message.slice(r.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(r.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(t,r){var n=[];try{n=Ma(t)}catch{return this.error(v.INVALID_NUMBER_SKELETON,r)}return{val:{type:Be.number,tokens:n,location:r,parsedOptions:this.shouldParseSkeletons?Ua(n):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(t,r,n,i){for(var o,a=!1,s=[],c=new Set,l=i.value,h=i.location;;){if(l.length===0){var d=this.clonePosition();if(r!=="select"&&this.bumpIf("=")){var u=this.tryParseDecimalInteger(v.EXPECT_PLURAL_ARGUMENT_SELECTOR,v.INVALID_PLURAL_ARGUMENT_SELECTOR);if(u.err)return u;h=E(d,this.clonePosition()),l=this.message.slice(d.offset,this.offset())}else break}if(c.has(l))return this.error(r==="select"?v.DUPLICATE_SELECT_ARGUMENT_SELECTOR:v.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,h);l==="other"&&(a=!0),this.bumpSpace();var m=this.clonePosition();if(!this.bumpIf("{"))return this.error(r==="select"?v.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:v.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,E(this.clonePosition(),this.clonePosition()));var g=this.parseMessage(t+1,r,n);if(g.err)return g;var f=this.tryParseArgumentClose(m);if(f.err)return f;s.push([l,{value:g.val,location:E(m,this.clonePosition())}]),c.add(l),this.bumpSpace(),o=this.parseIdentifierIfPossible(),l=o.value,h=o.location}return s.length===0?this.error(r==="select"?v.EXPECT_SELECT_ARGUMENT_SELECTOR:v.EXPECT_PLURAL_ARGUMENT_SELECTOR,E(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!a?this.error(v.MISSING_OTHER_CLAUSE,E(this.clonePosition(),this.clonePosition())):{val:s,err:null}},e.prototype.tryParseDecimalInteger=function(t,r){var n=1,i=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(n=-1);for(var o=!1,a=0;!this.isEOF();){var s=this.char();if(s>=48&&s<=57)o=!0,a=a*10+(s-48),this.bump();else break}var c=E(i,this.clonePosition());return o?(a*=n,dl(a)?{val:a,err:null}:this.error(r,c)):this.error(t,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var t=this.position.offset;if(t>=this.message.length)throw Error("out of bound");var r=Fa(this.message,t);if(r===void 0)throw Error("Offset ".concat(t," is at invalid UTF-16 code unit boundary"));return r},e.prototype.error=function(t,r){return{val:null,err:{kind:t,message:this.message,location:r}}},e.prototype.bump=function(){if(!this.isEOF()){var t=this.char();t===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=t<65536?1:2)}},e.prototype.bumpIf=function(t){if(Ga(this.message,t,this.offset())){for(var r=0;r<t.length;r++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(t){var r=this.offset(),n=this.message.indexOf(t,r);return n>=0?(this.bumpTo(n),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(t){if(this.offset()>t)throw Error("targetOffset ".concat(t," must be greater than or equal to the current offset ").concat(this.offset()));for(t=Math.min(t,this.message.length);;){var r=this.offset();if(r===t)break;if(r>t)throw Error("targetOffset ".concat(t," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&Ya(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var t=this.char(),r=this.offset(),n=this.message.charCodeAt(r+(t>=65536?2:1));return n??null},e}();function Oi(e){return e>=97&&e<=122||e>=65&&e<=90}function pl(e){return Oi(e)||e===47}function fl(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function Ya(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function gl(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function Ri(e){e.forEach(function(t){if(delete t.location,Hr(t)||Ur(t))for(var r in t.options)delete t.options[r].location,Ri(t.options[r].value);else Mr(t)&&Br(t.style)||($r(t)||Vr(t))&&Wt(t.style)?delete t.style.location:Dr(t)&&Ri(t.children)})}function Xa(e,t){t===void 0&&(t={}),t=A({shouldParseSkeletons:!0,requiresOtherClause:!0},t);var r=new ja(e,t).parse();if(r.err){var n=SyntaxError(v[r.err.kind]);throw n.location=r.err.location,n.originalMessage=r.err.message,n}return t?.captureLocation||Ri(r.val),r.val}function Zt(e,t){var r=t&&t.cache?t.cache:El,n=t&&t.serializer?t.serializer:Al,i=t&&t.strategy?t.strategy:bl;return i(e,{cache:r,serializer:n})}function xl(e){return e==null||typeof e=="number"||typeof e=="boolean"}function Wa(e,t,r,n){var i=xl(n)?n:r(n),o=t.get(i);return typeof o>"u"&&(o=e.call(this,n),t.set(i,o)),o}function qa(e,t,r){var n=Array.prototype.slice.call(arguments,3),i=r(n),o=t.get(i);return typeof o>"u"&&(o=e.apply(this,n),t.set(i,o)),o}function Mi(e,t,r,n,i){return r.bind(t,e,n,i)}function bl(e,t){var r=e.length===1?Wa:qa;return Mi(e,this,r,t.cache.create(),t.serializer)}function vl(e,t){return Mi(e,this,qa,t.cache.create(),t.serializer)}function yl(e,t){return Mi(e,this,Wa,t.cache.create(),t.serializer)}var Al=function(){return JSON.stringify(arguments)};function $i(){this.cache=Object.create(null)}$i.prototype.get=function(e){return this.cache[e]};$i.prototype.set=function(e,t){this.cache[e]=t};var El={create:function(){return new $i}},Gr={variadic:vl,monadic:yl};var Ge;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(Ge||(Ge={}));var Jt=function(e){Xt(t,e);function t(r,n,i){var o=e.call(this,r)||this;return o.code=n,o.originalMessage=i,o}return t.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},t}(Error);var Vi=function(e){Xt(t,e);function t(r,n,i,o){return e.call(this,'Invalid values for "'.concat(r,'": "').concat(n,'". Options are "').concat(Object.keys(i).join('", "'),'"'),Ge.INVALID_VALUE,o)||this}return t}(Jt);var Za=function(e){Xt(t,e);function t(r,n,i){return e.call(this,'Value for "'.concat(r,'" must be of type ').concat(n),Ge.INVALID_VALUE,i)||this}return t}(Jt);var Ja=function(e){Xt(t,e);function t(r,n){return e.call(this,'The intl string context variable "'.concat(r,'" was not provided to the string "').concat(n,'"'),Ge.MISSING_VALUE,n)||this}return t}(Jt);var F;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(F||(F={}));function Sl(e){return e.length<2?e:e.reduce(function(t,r){var n=t[t.length-1];return!n||n.type!==F.literal||r.type!==F.literal?t.push(r):n.value+=r.value,t},[])}function Tl(e){return typeof e=="function"}function Qt(e,t,r,n,i,o,a){if(e.length===1&&Li(e[0]))return[{type:F.literal,value:e[0].value}];for(var s=[],c=0,l=e;c<l.length;c++){var h=l[c];if(Li(h)){s.push({type:F.literal,value:h.value});continue}if(Ca(h)){typeof o=="number"&&s.push({type:F.literal,value:r.getNumberFormat(t).format(o)});continue}var d=h.value;if(!(i&&d in i))throw new Ja(d,a);var u=i[d];if(Pa(h)){(!u||typeof u=="string"||typeof u=="number")&&(u=typeof u=="string"||typeof u=="number"?String(u):""),s.push({type:typeof u=="string"?F.literal:F.object,value:u});continue}if($r(h)){var m=typeof h.style=="string"?n.date[h.style]:Wt(h.style)?h.style.parsedOptions:void 0;s.push({type:F.literal,value:r.getDateTimeFormat(t,m).format(u)});continue}if(Vr(h)){var m=typeof h.style=="string"?n.time[h.style]:Wt(h.style)?h.style.parsedOptions:n.time.medium;s.push({type:F.literal,value:r.getDateTimeFormat(t,m).format(u)});continue}if(Mr(h)){var m=typeof h.style=="string"?n.number[h.style]:Br(h.style)?h.style.parsedOptions:void 0;m&&m.scale&&(u=u*(m.scale||1)),s.push({type:F.literal,value:r.getNumberFormat(t,m).format(u)});continue}if(Dr(h)){var g=h.children,f=h.value,S=i[f];if(!Tl(S))throw new Za(f,"function",a);var _=Qt(g,t,r,n,i,o),b=S(_.map(function(N){return N.value}));Array.isArray(b)||(b=[b]),s.push.apply(s,b.map(function(N){return{type:typeof N=="string"?F.literal:F.object,value:N}}))}if(Hr(h)){var y=h.options[u]||h.options.other;if(!y)throw new Vi(h.value,u,Object.keys(h.options),a);s.push.apply(s,Qt(y.value,t,r,n,i));continue}if(Ur(h)){var y=h.options["=".concat(u)];if(!y){if(!Intl.PluralRules)throw new Jt(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,Ge.MISSING_INTL_API,a);var k=r.getPluralRules(t,{type:h.pluralType}).select(u-(h.offset||0));y=h.options[k]||h.options.other}if(!y)throw new Vi(h.value,u,Object.keys(h.options),a);s.push.apply(s,Qt(y.value,t,r,n,i,u-(h.offset||0)));continue}}return Sl(s)}function wl(e,t){return t?A(A(A({},e||{}),t||{}),Object.keys(e).reduce(function(r,n){return r[n]=A(A({},e[n]),t[n]||{}),r},{})):e}function Ll(e,t){return t?Object.keys(e).reduce(function(r,n){return r[n]=wl(e[n],t[n]),r},A({},e)):e}function Hi(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function _l(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Zt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.NumberFormat).bind.apply(t,Rr([void 0],r,!1)))},{cache:Hi(e.number),strategy:Gr.variadic}),getDateTimeFormat:Zt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.DateTimeFormat).bind.apply(t,Rr([void 0],r,!1)))},{cache:Hi(e.dateTime),strategy:Gr.variadic}),getPluralRules:Zt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.PluralRules).bind.apply(t,Rr([void 0],r,!1)))},{cache:Hi(e.pluralRules),strategy:Gr.variadic})}}var Qa=function(){function e(t,r,n,i){var o=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(a){var s=o.formatToParts(a);if(s.length===1)return s[0].value;var c=s.reduce(function(l,h){return!l.length||h.type!==F.literal||typeof l[l.length-1]!="string"?l.push(h.value):l[l.length-1]+=h.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(a){return Qt(o.ast,o.locales,o.formatters,o.formats,a,void 0,o.message)},this.resolvedOptions=function(){return{locale:o.resolvedLocale.toString()}},this.getAst=function(){return o.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Ll(e.formats,n),this.formatters=i&&i.formatters||_l(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=Xa,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var es=Qa;var Pl=/[0-9\-+#]/,Cl=/[^\d\-+#]/g;function ts(e){return e.search(Pl)}function kl(e="#.##"){let t={},r=e.length,n=ts(e);t.prefix=n>0?e.substring(0,n):"";let i=ts(e.split("").reverse().join("")),o=r-i,a=e.substring(o,o+1),s=o+(a==="."||a===","?1:0);t.suffix=i>0?e.substring(s,r):"",t.mask=e.substring(n,s),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let c=t.mask.match(Cl);return t.decimal=c&&c[c.length-1]||".",t.separator=c&&c[1]&&c[0]||",",c=t.mask.split(t.decimal),t.integer=c[0],t.fraction=c[1],t}function Il(e,t,r){let n=!1,i={value:e};e<0&&(n=!0,i.value=-i.value),i.sign=n?"-":"",i.value=Number(i.value).toFixed(t.fraction&&t.fraction.length),i.value=Number(i.value).toString();let o=t.fraction&&t.fraction.lastIndexOf("0"),[a="0",s=""]=i.value.split(".");return(!s||s&&s.length<=o)&&(s=o<0?"":(+("0."+s)).toFixed(o+1).replace("0.","")),i.integer=a,i.fraction=s,Nl(i,t),(i.result==="0"||i.result==="")&&(n=!1,i.sign=""),!n&&t.maskHasPositiveSign?i.sign="+":n&&t.maskHasPositiveSign?i.sign="-":n&&(i.sign=r&&r.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),i}function Nl(e,t){e.result="";let r=t.integer.split(t.separator),n=r.join(""),i=n&&n.indexOf("0");if(i>-1)for(;e.integer.length<n.length-i;)e.integer="0"+e.integer;else Number(e.integer)===0&&(e.integer="");let o=r[1]&&r[r.length-1].length;if(o){let a=e.integer.length,s=a%o;for(let c=0;c<a;c++)e.result+=e.integer.charAt(c),!((c-s+1)%o)&&c<a-o&&(e.result+=t.separator)}else e.result=e.integer;return e.result+=t.fraction&&e.fraction?t.decimal+e.fraction:"",e}function Ol(e,t,r={}){if(!e||isNaN(Number(t)))return t;let n=kl(e),i=Il(t,n,r);return n.prefix+i.sign+i.result+n.suffix}var rs=Ol;var ns=".",Rl=",",os=/^\s+/,as=/\s+$/,is="&nbsp;",Ui=e=>e*12,ss=(e,t)=>{let{start:r,end:n,displaySummary:{amount:i,duration:o,minProductQuantity:a,outcomeType:s}={}}=e;if(!(i&&o&&s&&a))return!1;let c=t?new Date(t):new Date;if(!r||!n)return!1;let l=new Date(r),h=new Date(n);return c>=l&&c<=h},ze={MONTH:"MONTH",YEAR:"YEAR"},Ml={[O.ANNUAL]:12,[O.MONTHLY]:1,[O.THREE_YEARS]:36,[O.TWO_YEARS]:24},Di=(e,t)=>({accept:e,round:t}),$l=[Di(({divisor:e,price:t})=>t%e==0,({divisor:e,price:t})=>t/e),Di(({usePrecision:e})=>e,({divisor:e,price:t})=>Math.round(t/e*100)/100),Di(()=>!0,({divisor:e,price:t})=>Math.ceil(Math.floor(t*100/e)/100))],Bi={[U.YEAR]:{[O.MONTHLY]:ze.MONTH,[O.ANNUAL]:ze.YEAR},[U.MONTH]:{[O.MONTHLY]:ze.MONTH}},Vl=(e,t)=>e.indexOf(`'${t}'`)===0,Hl=(e,t=!0)=>{let r=e.replace(/'.*?'/,"").trim(),n=ls(r);return!!n?t||(r=r.replace(/[,\.]0+/,n)):r=r.replace(/\s?(#.*0)(?!\s)?/,"$&"+Dl(e)),r},Ul=e=>{let t=Bl(e),r=Vl(e,t),n=e.replace(/'.*?'/,""),i=os.test(n)||as.test(n);return{currencySymbol:t,isCurrencyFirst:r,hasCurrencySpace:i}},cs=e=>e.replace(os,is).replace(as,is),Dl=e=>e.match(/#(.?)#/)?.[1]===ns?Rl:ns,Bl=e=>e.match(/'(.*?)'/)?.[1]??"",ls=e=>e.match(/0(.?)0/)?.[1]??"";function At({formatString:e,price:t,usePrecision:r,isIndianPrice:n=!1},i,o=a=>a){let{currencySymbol:a,isCurrencyFirst:s,hasCurrencySpace:c}=Ul(e),l=r?ls(e):"",h=Hl(e,r),d=r?2:0,u=o(t,{currencySymbol:a}),m=n?u.toLocaleString("hi-IN",{minimumFractionDigits:d,maximumFractionDigits:d}):rs(h,u),g=r?m.lastIndexOf(l):m.length,f=m.substring(0,g),S=m.substring(g+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,m).replace(/SYMBOL/,a),currencySymbol:a,decimals:S,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:i}}var hs=e=>{let{commitment:t,term:r,usePrecision:n}=e,i=Ml[r]??1;return At(e,i>1?ze.MONTH:Bi[t]?.[r],o=>{let a={divisor:i,price:o,usePrecision:n},{round:s}=$l.find(({accept:c})=>c(a));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(a)}`);return s(a)})},ds=({commitment:e,term:t,...r})=>At(r,Bi[e]?.[t]),us=e=>{let{commitment:t,instant:r,price:n,originalPrice:i,priceWithoutDiscount:o,promotion:a,quantity:s=1,term:c}=e;if(t===U.YEAR&&c===O.MONTHLY){if(!a)return At(e,ze.YEAR,Ui);let{displaySummary:{outcomeType:l,duration:h,minProductQuantity:d=1}={}}=a;switch(l){case"PERCENTAGE_DISCOUNT":if(s>=d&&ss(a,r)){let u=parseInt(h.replace("P","").replace("M",""));if(isNaN(u))return Ui(n);let m=s*i*u,g=s*o*(12-u),f=Math.floor((m+g)*100)/100;return At({...e,price:f},ze.YEAR)}default:return At(e,ze.YEAR,()=>Ui(o??n))}}return At(e,Bi[t]?.[c])};var Gl={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at {alternativePrice}",strikethroughAriaLabel:"Regularly at {strikethroughPrice}"},zl=Ta("ConsonantTemplates/price"),Fl=/<\/?[^>]+(>|$)/g,z={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Fe={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel"},Kl="TAX_EXCLUSIVE",jl=e=>Sa(e)?Object.entries(e).filter(([,t])=>gt(t)||Ir(t)||t===!0).reduce((t,[r,n])=>t+` ${r}${n===!0?"":'="'+Aa(n)+'"'}`,""):"",Y=(e,t,r,n=!1)=>`<span class="${e}${t?"":" "+z.disabled}"${jl(r)}>${n?cs(t):t??""}</span>`;function Yl(e,{accessibleLabel:t,currencySymbol:r,decimals:n,decimalsDelimiter:i,hasCurrencySpace:o,integer:a,isCurrencyFirst:s,recurrenceLabel:c,perUnitLabel:l,taxInclusivityLabel:h},d={}){let u=Y(z.currencySymbol,r),m=Y(z.currencySpace,o?"&nbsp;":""),g="";return s&&(g+=u+m),g+=Y(z.integer,a),g+=Y(z.decimalsDelimiter,i),g+=Y(z.decimals,n),s||(g+=m+u),g+=Y(z.recurrence,c,null,!0),g+=Y(z.unitType,l,null,!0),g+=Y(z.taxInclusivity,h,!0),Y(e,g,{...d,"aria-label":t})}var Z=({displayOptical:e=!1,displayStrikethrough:t=!1,displayAnnual:r=!1,instant:n=void 0}={})=>({country:i,displayFormatted:o=!0,displayRecurrence:a=!0,displayPerUnit:s=!1,displayTax:c=!1,language:l,literals:h={},quantity:d=1}={},{commitment:u,offerSelectorIds:m,formatString:g,price:f,priceWithoutDiscount:S,taxDisplay:_,taxTerm:b,term:y,usePrecision:k,promotion:N}={},$={})=>{Object.entries({country:i,formatString:g,language:l,price:f}).forEach(([se,en])=>{if(en==null)throw new Error(`Argument "${se}" is missing for osi ${m?.toString()}, country ${i}, language ${l}`)});let V={...Gl,...h},te=`${l.toLowerCase()}-${i.toUpperCase()}`;function J(se,en){let tn=V[se];if(tn==null)return"";try{return new es(tn.replace(Fl,""),te).format(en)}catch{return zl.error("Failed to format literal:",tn),""}}let _t=t&&S?S:f,qe=e?hs:ds;r&&(qe=us);let{accessiblePrice:Pt,recurrenceTerm:ge,...xe}=qe({commitment:u,formatString:g,instant:n,isIndianPrice:i==="IN",originalPrice:f,priceWithoutDiscount:S,price:e?f:_t,promotion:N,quantity:d,term:y,usePrecision:k}),Q=Pt,Ct="";if(T(a)&&ge){let se=J(Fe.recurrenceAriaLabel,{recurrenceTerm:ge});se&&(Q+=" "+se),Ct=J(Fe.recurrenceLabel,{recurrenceTerm:ge})}let Qr="";if(T(s)){Qr=J(Fe.perUnitLabel,{perUnit:"LICENSE"});let se=J(Fe.perUnitAriaLabel,{perUnit:"LICENSE"});se&&(Q+=" "+se)}let kt="";T(c)&&b&&(kt=J(_===Kl?Fe.taxExclusiveLabel:Fe.taxInclusiveLabel,{taxTerm:b}),kt&&(Q+=" "+kt)),t&&(Q=J(Fe.strikethroughAriaLabel,{strikethroughPrice:Q}));let It=z.container;if(e&&(It+=" "+z.containerOptical),t&&(It+=" "+z.containerStrikethrough),r&&(It+=" "+z.containerAnnual),T(o))return Yl(It,{...xe,accessibleLabel:Q,recurrenceLabel:Ct,perUnitLabel:Qr,taxInclusivityLabel:kt},$);let{currencySymbol:so,decimals:Us,decimalsDelimiter:Ds,hasCurrencySpace:co,integer:Bs,isCurrencyFirst:Gs}=xe,Ze=[Bs,Ds,Us];Gs?(Ze.unshift(co?"\xA0":""),Ze.unshift(so)):(Ze.push(co?"\xA0":""),Ze.push(so)),Ze.push(Ct,Qr,kt);let zs=Ze.join("");return Y(It,zs,$)},ms=()=>(e,t,r)=>{let i=(e.displayOldPrice===void 0||T(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${Z()(e,t,r)}${i?"&nbsp;"+Z({displayStrikethrough:!0})(e,t,r):""}`},ps=()=>(e,t,r)=>{let{instant:n}=e;try{n||(n=new URLSearchParams(document.location.search).get("instant")),n&&(n=new Date(n))}catch{n=void 0}let i={...e,displayTax:!1,displayPerUnit:!1};return`${(e.displayOldPrice===void 0||T(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price?Z({displayStrikethrough:!0})(i,t,r)+"&nbsp;":""}${Z()(e,t,r)}${Y(z.containerAnnualPrefix,"&nbsp;(")}${Z({displayAnnual:!0,instant:n})(i,t,r)}${Y(z.containerAnnualSuffix,")")}`},fs=()=>(e,t,r)=>{let n={...e,displayTax:!1,displayPerUnit:!1};return`${Z()(e,t,r)}${Y(z.containerAnnualPrefix,"&nbsp;(")}${Z({displayAnnual:!0})(n,t,r)}${Y(z.containerAnnualSuffix,")")}`};var Gi=Z(),zi=ms(),Fi=Z({displayOptical:!0}),Ki=Z({displayStrikethrough:!0}),ji=Z({displayAnnual:!0}),Yi=fs(),Xi=ps();var Xl=(e,t)=>{if(!(!bt(e)||!bt(t)))return Math.floor((t-e)/t*100)},gs=()=>(e,t)=>{let{price:r,priceWithoutDiscount:n}=t,i=Xl(r,n);return i===void 0?'<span class="no-discount"></span>':`<span class="discount">${i}%</span>`};var Wi=gs();var{freeze:er}=Object,ne=er({...De}),ie=er({...ee}),Ke={STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"},qi=er({...U}),Zi=er({...La}),Ji=er({...O});var xs="mas-commerce-service";function bs(e,{once:t=!1}={}){let r=null;function n(){let i=document.querySelector(xs);i!==r&&(r=i,i&&e(i))}return document.addEventListener(ot,n,{once:t}),je(n),()=>document.removeEventListener(ot,n)}function tr(e,{country:t,forceTaxExclusive:r,perpetual:n}){let i;if(e.length<2)i=e;else{let o=t==="GB"||n?"EN":"MULT",[a,s]=e;i=[a.language===o?a:s]}return r&&(i=i.map(Ti)),i}var je=e=>window.setTimeout(e);function Et(e,t=1){if(e==null)return[t];let r=(Array.isArray(e)?e:String(e).split(",")).map(yt).filter(bt);return r.length||(r=[t]),r}function zr(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(xi)}function X(){return document.getElementsByTagName(xs)?.[0]}function Wl(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var rr,Ye=class Ye extends HTMLAnchorElement{constructor(){super();G(this,rr,!1);this.setAttribute("is",Ye.is)}get isUptLink(){return!0}initializeWcsData(r,n){this.setAttribute("data-wcs-osi",r),n&&this.setAttribute("data-promotion-code",n),K(this,rr,!0),this.composePromoTermsUrl()}attributeChangedCallback(r,n,i){L(this,rr)&&this.composePromoTermsUrl()}composePromoTermsUrl(){let r=this.getAttribute("data-wcs-osi");if(!r){let d=this.closest("merch-card").querySelector("aem-fragment").getAttribute("fragment");console.error(`Missing 'data-wcs-osi' attribute on upt-link. Fragment: ${d}`);return}let n=X(),i=[r],o=this.getAttribute("data-promotion-code"),{country:a,language:s,env:c}=n.settings,l={country:a,language:s,wcsOsi:i,promotionCode:o},h=n.resolveOfferSelectors(l);Promise.all(h).then(([[d]])=>{let u=`locale=${s}_${a}&country=${a}&offer_id=${d.offerId}`;o&&(u+=`&promotion_code=${encodeURIComponent(o)}`),this.href=`${Wl(c)}?${u}`}).catch(d=>{console.error(`Could not resolve offer selectors for id: ${r}.`,d.message)})}static createFrom(r){let n=new Ye;for(let i of r.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?n.setAttribute("class",i.value.replace("upt-link","").trim()):n.setAttribute(i.name,i.value));return n.innerHTML=r.innerHTML,n.setAttribute("tabindex",0),n}};rr=new WeakMap,p(Ye,"is","upt-link"),p(Ye,"tag","a"),p(Ye,"observedAttributes",["data-wcs-osi","data-promotion-code"]);var fe=Ye;window.customElements.get(fe.is)||window.customElements.define(fe.is,fe,{extends:fe.tag});var ql="#000000",Zl="#F8D904",Jl=/(accent|primary|secondary)(-(outline|link))?/,Ql="mas:product_code/",eh="daa-ll",Fr="daa-lh",th=["XL","L","M","S"],Qi="...";function rh(e,t,r){e.mnemonicIcon?.map((i,o)=>({icon:i,alt:e.mnemonicAlt[o]??"",link:e.mnemonicLink[o]??""}))?.forEach(({icon:i,alt:o,link:a})=>{if(a&&!/^https?:/.test(a))try{a=new URL(`https://${a}`).href.toString()}catch{a="#"}let s={slot:"icons",src:i,loading:t.loading,size:r?.size??"l"};o&&(s.alt=o),a&&(s.href=a);let c=q("merch-icon",s);t.append(c)})}function nh(e,t){e.badge&&(t.setAttribute("badge-text",e.badge),t.setAttribute("badge-color",e.badgeColor||ql),t.setAttribute("badge-background-color",e.badgeBackgroundColor||Zl))}function ih(e,t,r){r?.includes(e.size)&&t.setAttribute("size",e.size)}function oh(e,t,r){if(e.cardTitle&&r){let n={slot:r.slot},i=e.cardTitle,{maxCount:o}=r;if(o){let[a,s]=ys(e.cardTitle,o);a!==e.cardTitle&&(n.title=s,i=a)}t.append(q(r.tag,n,i))}}function ah(e,t,r){e.subtitle&&r&&t.append(q(r.tag,{slot:r.slot},e.subtitle))}function sh(e,t,r){if(!e.backgroundColor||e.backgroundColor.toLowerCase()==="default"){t.style.removeProperty("--merch-card-custom-background-color"),t.removeAttribute("background-color");return}r?.[e.backgroundColor]&&(t.style.setProperty("--merch-card-custom-background-color",`var(${r[e.backgroundColor]})`),t.setAttribute("background-color",e.backgroundColor))}function ch(e,t,r){e.borderColor&&r&&e.borderColor!=="transparent"&&t.style.setProperty("--merch-card-custom-border-color",`var(--${e.borderColor})`)}function lh(e,t,r){if(e.backgroundImage){let n={loading:t.loading??"lazy",src:e.backgroundImage};if(e.backgroundImageAltText?n.alt=e.backgroundImageAltText:n.role="none",!r)return;if(r?.attribute){t.setAttribute(r.attribute,e.backgroundImage);return}t.spectrum==="swc"?t.shadowRoot.append(q(r.tag,{slot:r.slot,class:"image"},q("img",n))):t.append(q(r.tag,{slot:r.slot},q("img",n)))}}function hh(e,t,r){if(e.prices&&r){let n=q(r.tag,{slot:r.slot},e.prices);t.append(n)}}function dh(e,t,r){if(e.description&&r){let n={slot:r.slot},i=e.description,{maxCount:o}=r;if(o){let[a,s]=ys(e.description,o,!1);a!==e.description&&(n.title=s,i=a)}t.append(q(r.tag,n,i))}}function ys(e,t,r=!0){try{let n=typeof e!="string"?"":e,i=vs(n);if(i.length<=t)return[n,i];let o=0,a=!1,s=r?t-Qi.length<1?1:t-Qi.length:t,c=[];for(let d of n){if(o++,d==="<")if(a=!0,n[o]==="/")c.pop();else{let u="";for(let m of n.substring(o)){if(m===" "||m===">")break;u+=m}c.push(u)}if(d==="/"&&n[o]===">"&&c.pop(),d===">"){a=!1;continue}if(!a&&(s--,s===0))break}let l=n.substring(0,o).trim();if(c.length>0){c[0]==="p"&&c.shift();for(let d of c.reverse())l+=`</${d}>`}return[`${l}${r?Qi:""}`,i]}catch{let i=typeof e=="string"?e:"",o=vs(i);return[i,o]}}function vs(e){if(!e)return"";let t="",r=!1;for(let n of e){if(n==="<"&&(r=!0),n===">"){r=!1;continue}r||(t+=n)}return t}function uh(e,t){t.querySelectorAll("a.upt-link").forEach(n=>{let i=fe.createFrom(n);n.replaceWith(i),i.initializeWcsData(e.osi,e.promoCode)})}function mh(e,t,r,n){let o=customElements.get("checkout-button").createCheckoutButton({},e.innerHTML);o.setAttribute("tabindex",0);for(let h of e.attributes)["class","is"].includes(h.name)||o.setAttribute(h.name,h.value);o.firstElementChild?.classList.add("spectrum-Button-label");let a=t.ctas.size??"M",s=`spectrum-Button--${n}`,c=th.includes(a)?`spectrum-Button--size${a}`:"spectrum-Button--sizeM",l=["spectrum-Button",s,c];return r&&l.push("spectrum-Button--outline"),o.classList.add(...l),o}function ph(e,t,r,n){let o=customElements.get("checkout-button").createCheckoutButton(e.dataset);o.connectedCallback(),o.render();let a="fill";r&&(a="outline");let s=q("sp-button",{treatment:a,variant:n,tabIndex:0,size:t.ctas.size??"m"},e.innerHTML);return s.source=o,o.onceSettled().then(c=>{s.setAttribute("data-navigation-url",c.href)}),s.addEventListener("click",c=>{c.defaultPrevented||o.click()}),s}function fh(e,t){return e.classList.add("con-button"),t&&e.classList.add("blue"),e}function gh(e,t,r,n){if(e.ctas){let{slot:i}=r.ctas,o=q("div",{slot:i},e.ctas),a=[...o.querySelectorAll("a")].map(s=>{let c=s.parentElement.tagName==="STRONG";if(t.consonant)return fh(s,c);let l=Jl.exec(s.className)?.[0]??"accent",h=l.includes("accent"),d=l.includes("primary"),u=l.includes("secondary"),m=l.includes("-outline");if(l.includes("-link"))return s;let f;return h||c?f="accent":d?f="primary":u&&(f="secondary"),t.spectrum==="swc"?ph(s,r,m,f):mh(s,r,m,f)});o.innerHTML="",o.append(...a),t.append(o)}}function xh(e,t){let{tags:r}=e,n=r?.find(o=>o.startsWith(Ql))?.split("/").pop();if(!n)return;t.setAttribute(Fr,n),[...t.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((o,a)=>{o.setAttribute(eh,`${o.dataset.analyticsId}-${a+1}`)})}function bh(e){e.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,r])=>{e.querySelectorAll(`a.${t}`).forEach(n=>{n.classList.remove(t),n.classList.add("spectrum-Link",`spectrum-Link--${r}`)})})}async function As(e,t){let{fields:r}=e,{variant:n}=r;if(!n)return;t.querySelectorAll("[slot]").forEach(o=>{o.remove()}),t.removeAttribute("background-image"),t.removeAttribute("background-color"),t.removeAttribute("badge-background-color"),t.removeAttribute("badge-color"),t.removeAttribute("badge-text"),t.removeAttribute("size"),t.classList.remove("wide-strip"),t.classList.remove("thin-strip"),t.removeAttribute(Fr),t.variant=n,await t.updateComplete;let{aemFragmentMapping:i}=t.variantLayout;i&&(rh(r,t,i.mnemonics),nh(r,t),ih(r,t,i.size),oh(r,t,i.title),ah(r,t,i.subtitle),hh(r,t,i.prices),lh(r,t,i.backgroundImage),sh(r,t,i.allowedColors),ch(r,t,i.borderColor),dh(r,t,i.description),uh(r,t),gh(r,t,i,n),xh(r,t),bh(t))}var Xe={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals"],serializableTypes:["Array","Object"],sampleRate:1,tags:"acom",isProdDomain:!1},Es=1e3;function vh(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function Ss(e){if(e==null)return;let t=typeof e;if(t==="function")return e.name?`function ${e.name}`:"function";if(t==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:n,originatingRequest:i,status:o}=e;return[n,o,i].filter(Boolean).join(" ")}let r=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!Xe.serializableTypes.includes(r))return r}return e}function yh(e,t){if(!Xe.ignoredProperties.includes(e))return Ss(t)}var eo={append(e){if(e.level!=="error")return;let{message:t,params:r}=e,n=[],i=[],o=t;r.forEach(l=>{l!=null&&(vh(l)?n:i).push(l)}),n.length&&(o+=" "+n.map(Ss).join(" "));let{pathname:a,search:s}=window.location,c=`${Xe.delimiter}page=${a}${s}`;c.length>Es&&(c=`${c.slice(0,Es)}<trunc>`),o+=c,i.length&&(o+=`${Xe.delimiter}facts=`,o+=JSON.stringify(i,yh)),window.lana?.log(o,Xe)}};function St(e){Object.assign(Xe,Object.fromEntries(Object.entries(e).filter(([t,r])=>t in Xe&&r!==""&&r!==null&&r!==void 0&&!Number.isNaN(r))))}var w=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflow:ne.V3,checkoutWorkflowStep:ie.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,env:Ke.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsBufferDelay:1,wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:$e.PUBLISHED,wcsBufferLimit:1});var to=Object.freeze({LOCAL:"local",PROD:"prod",STAGE:"stage"});function Ah({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||w.language),t??(t=e?.split("_")?.[1]||w.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function ro(e={}){let{commerce:t={}}=e,r=Ke.PRODUCTION,n=Xn,i=R("checkoutClientId",t)??w.checkoutClientId,o=we(R("checkoutWorkflow",t),ne,w.checkoutWorkflow),a=ie.CHECKOUT;o===ne.V3&&(a=we(R("checkoutWorkflowStep",t),ie,w.checkoutWorkflowStep));let s=T(R("displayOldPrice",t),w.displayOldPrice),c=T(R("displayPerUnit",t),w.displayPerUnit),l=T(R("displayRecurrence",t),w.displayRecurrence),h=T(R("displayTax",t),w.displayTax),d=T(R("entitlement",t),w.entitlement),u=T(R("modal",t),w.modal),m=T(R("forceTaxExclusive",t),w.forceTaxExclusive),g=R("promotionCode",t)??w.promotionCode,f=Et(R("quantity",t)),S=R("wcsApiKey",t)??w.wcsApiKey,_=t?.env==="stage",b=$e.PUBLISHED;["true",""].includes(t.allowOverride)&&(_=(R(jn,t,{metadata:!1})?.toLowerCase()??t?.env)==="stage",b=we(R(Yn,t),$e,b)),_&&(r=Ke.STAGE,n=Wn);let k=yt(R("wcsBufferDelay",t),w.wcsBufferDelay),N=yt(R("wcsBufferLimit",t),w.wcsBufferLimit);return{...Ah(e),displayOldPrice:s,checkoutClientId:i,checkoutWorkflow:o,checkoutWorkflowStep:a,displayPerUnit:c,displayRecurrence:l,displayTax:h,entitlement:d,extraOptions:w.extraOptions,modal:u,env:r,forceTaxExclusive:m,promotionCode:g,quantity:f,wcsApiKey:S,wcsBufferDelay:k,wcsBufferLimit:N,wcsURL:n,landscape:b}}var no={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Eh=Date.now(),io=new Set,oo=new Set,Ts=new Map,ws={append({level:e,message:t,params:r,timestamp:n,source:i}){console[e](`${n}ms [${i}] %c${t}`,"font-weight: bold;",...r)}},Ls={filter:({level:e})=>e!==no.DEBUG},Sh={filter:()=>!1};function Th(e,t,r,n,i){return{level:e,message:t,namespace:r,get params(){return n.length===1&&jt(n[0])&&(n=n[0](),Array.isArray(n)||(n=[n])),n},source:i,timestamp:Date.now()-Eh}}function wh(e){[...oo].every(t=>t(e))&&io.forEach(t=>t(e))}function _s(e){let t=(Ts.get(e)??0)+1;Ts.set(e,t);let r=`${e} #${t}`,n={id:r,namespace:e,module:i=>_s(`${n.namespace}/${i}`),updateConfig:St};return Object.values(no).forEach(i=>{n[i]=(o,...a)=>wh(Th(i,o,e,a,r))}),Object.seal(n)}function Kr(...e){e.forEach(t=>{let{append:r,filter:n}=t;jt(n)&&oo.add(n),jt(r)&&io.add(r)})}function Lh(e={}){let{name:t}=e,r=T(R("commerce.debug",{search:!0,storage:!0}),t===to.LOCAL);return Kr(r?ws:Ls),t===to.PROD&&Kr(eo),j}function _h(){io.clear(),oo.clear()}var j={..._s(Kn),Level:no,Plugins:{consoleAppender:ws,debugFilter:Ls,quietFilter:Sh,lanaAppender:eo},init:Lh,reset:_h,use:Kr};var Ph="merch-card",Ch=":start",kh=":ready",Ps=2e4,Cs="merch-card:",Tt,jr,nr=class extends re{constructor(){super();G(this,Tt);p(this,"customerSegment");p(this,"marketSegment");p(this,"variantLayout");p(this,"log");this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.log=j.module("merch-card")}static getFragmentMapping(r){return ca[r]}firstUpdated(){this.variantLayout=ri(this,!1),this.variantLayout?.connectedCallbackHook(),this.aemFragment?.updateComplete.catch(()=>{this.style.display="none"})}willUpdate(r){(r.has("variant")||!this.variantLayout)&&(this.variantLayout=ri(this),this.variantLayout.connectedCallbackHook())}updated(r){(r.has("badgeBackgroundColor")||r.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border",this.computedBorderStyle),this.variantLayout?.postCardUpdateHook(r)}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}get prices(){return Array.from(this.querySelectorAll('span[is="inline-price"][data-wcs-osi]'))}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["twp","ccd-slice","ccd-suggested"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector('span[is="inline-price"]')}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll('a[is="checkout-link"]')??[]]}async toggleStockOffer({target:r}){if(!this.stockOfferOsis)return;let n=this.checkoutLinks;if(n.length!==0)for(let i of n){await i.onceSettled();let o=i.value?.[0]?.planType;if(!o)return;let a=this.stockOfferOsis[o];if(!a)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==a);r.checked&&s.push(a),i.dataset.wcsOsi=s.join(",")}}handleQuantitySelection(r){let n=this.checkoutLinks;for(let i of n)i.dataset.quantity=r.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(r){let n={...this.filters};Object.keys(n).forEach(i=>{if(r){n[i].order=Math.min(n[i].order||2,2);return}let o=n[i].order;o===1||isNaN(o)||(n[i].order=Number(o)+1)}),this.filters=n}includes(r){return this.textContent.match(new RegExp(r,"i"))!==null}connectedCallback(){super.connectedCallback();let r=this.querySelector("aem-fragment")?.getAttribute("fragment");performance.mark(`${Cs}${r}${Ch}`),this.addEventListener(Tr,this.handleQuantitySelection),this.addEventListener(On,this.merchCardReady,{once:!0}),this.updateComplete.then(()=>{this.merchCardReady()}),this.storageOptions?.addEventListener("change",this.handleStorageChange),this.addEventListener(Me,this.handleAemFragmentEvents),this.addEventListener(Re,this.handleAemFragmentEvents),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(Tr,this.handleQuantitySelection),this.storageOptions?.removeEventListener(Sr,this.handleStorageChange),this.removeEventListener(Me,this.handleAemFragmentEvents),this.removeEventListener(Re,this.handleAemFragmentEvents)}async handleAemFragmentEvents(r){if(r.type===Me&&(this.log.error(r.detail),ce(this,Tt,jr).call(this,`AEM fragment cannot be loaded: ${r.detail}`)),r.type===Re&&r.target.nodeName==="AEM-FRAGMENT"){let n=r.detail;await As(n,this),this.checkReady()}}async checkReady(){let r=Promise.all([...this.querySelectorAll('span[is="inline-price"][data-wcs-osi],a[is="checkout-link"][data-wcs-osi]')].map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(a=>a.classList.contains("placeholder-resolved"))),n=new Promise(o=>setTimeout(()=>o("timeout"),Ps)),i=await Promise.race([r,n]);if(i===!0){performance.mark(`${Cs}${this.id}${kh}`),this.dispatchEvent(new CustomEvent($n,{bubbles:!0,composed:!0}));return}else i==="timeout"?ce(this,Tt,jr).call(this,`Contains offers that were not resolved within ${Ps} timeout`):ce(this,Tt,jr).call(this,"Contains unresolved offers")}get aemFragment(){return this.querySelector("aem-fragment")}get storageOptions(){return this.querySelector("sp-radio-group#storage")}get storageSpecificOfferSelect(){let r=this.storageOptions?.selected;if(r){let n=this.querySelector(`merch-offer-select[storage="${r}"]`);if(n)return n}return this.querySelector("merch-offer-select")}get offerSelect(){return this.storageOptions?this.storageSpecificOfferSelect:this.querySelector("merch-offer-select")}get quantitySelect(){return this.querySelector("merch-quantity-select")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let r=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll('a[is="checkout-link"].con-button')).length===2&&r&&r.parentElement.classList.add("footer-column")}merchCardReady(){this.offerSelect&&!this.offerSelect.planType||(this.dispatchEvent(new CustomEvent(Rn,{bubbles:!0})),this.displayFooterElementsInColumn())}handleStorageChange(){let r=this.closest("merch-card")?.offerSelect.cloneNode(!0);r&&this.dispatchEvent(new CustomEvent(Sr,{detail:{offerSelect:r},bubbles:!0}))}get dynamicPrice(){return this.querySelector('[slot="price"]')}selectMerchOffer(r){if(r===this.merchOffer)return;this.merchOffer=r;let n=this.dynamicPrice;if(r.price&&n){let i=r.price.cloneNode(!0);n.onceSettled?n.onceSettled().then(()=>{n.replaceWith(i)}):n.replaceWith(i)}}};Tt=new WeakSet,jr=function(r){this.dispatchEvent(new CustomEvent(Vn,{detail:r,bubbles:!0,composed:!0}))},p(nr,"properties",{name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:r=>{let[n,i,o]=r.split(",");return{PUF:n,ABM:i,M2M:o}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:r=>Object.fromEntries(r.split(",").map(n=>{let[i,o,a]=n.split(":"),s=Number(o);return[i,{order:isNaN(s)?void 0:s,size:a}]})),toAttribute:r=>Object.entries(r).map(([n,{order:i,size:o}])=>[n,i,o].filter(a=>a!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:Fr,reflect:!0},loading:{type:String}}),p(nr,"styles",[Yo,la(),...Xo()]);customElements.define(Ph,nr);var wt=class extends re{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}render(){let{href:t}=this;return t?x`<a href="${t}">
    ...
    `);customElements.define("merch-icon",wt);var Ih={[he]:Hn,[Ee]:Un,[de]:Dn},Nh={[he]:zn,[de]:Fn},Lt=class{constructor(t){p(this,"changes",new Map);p(this,"connected",!1);p(this,"dispose",xt);p(this,"error");p(this,"log");p(this,"options");p(this,"promises",[]);p(this,"state",Ee);p(this,"timer",null);p(this,"value");p(this,"version",0);p(this,"wrapperElement");this.wrapperElement=t,this.log=j.module("mas-element")}update(){[he,Ee,de].forEach(t=>{this.wrapperElement.classList.toggle(Ih[t],t===this.state)})}notify(){(this.state===de||this.state===he)&&(this.state===de?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===he&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]),this.wrapperElement.dispatchEvent(new CustomEvent(Nh[this.state],{bubbles:!0,detail:this.error}))}attributeChangedCallback(t,r,n){this.changes.set(t,n),this.requestUpdate()}connectedCallback(){this.dispose=bs(()=>this.requestUpdate(!0))}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement})),this.dispose(),this.dispose=xt}onceSettled(){let{error:t,promises:r,state:n}=this;return de===n?Promise.resolve(this.wrapperElement):he===n?Promise.reject(t):new Promise((i,o)=>{r.push({resolve:i,reject:o})})}toggleResolved(t,r,n){return t!==this.version?!1:(n!==void 0&&(this.options=n),this.state=de,this.value=r,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:r}),je(()=>this.notify()),!0)}toggleFailed(t,r,n){return t!==this.version?!1:(n!==void 0&&(this.options=n),this.error=r,this.state=he,this.update(),this.log?.error("Failed:",{element:this.wrapperElement,error:r}),je(()=>this.notify()),!0)}togglePending(t){return this.version++,t&&(this.options=t),this.state=Ee,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!X()||this.timer)return;let{error:r,options:n,state:i,value:o,version:a}=this;this.state=Ee,this.timer=je(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||t)try{await this.wrapperElement.render?.()===!1&&this.state===Ee&&this.version===a&&(this.state=i,this.error=r,this.value=o,this.update(),this.notify())}catch(c){this.log.error("Failed to render mas-element: ",c),this.toggleFailed(this.version,c,n)}})}};function ks(e={}){return Object.entries(e).forEach(([t,r])=>{(r==null||r===""||r?.length===0)&&delete e[t]}),e}function Yr(e,t={}){let{tag:r,is:n}=e,i=document.createElement(r,{is:n});return i.setAttribute("is",n),Object.assign(i.dataset,ks(t)),i}function Xr(e,t={}){return e instanceof HTMLElement?(Object.assign(e.dataset,ks(t)),e):null}var Oh="download",Rh="upgrade";function Wr(e,t={},r=""){let n=X();if(!n)return null;let{checkoutMarketSegment:i,checkoutWorkflow:o,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:l,perpetual:h,promotionCode:d,quantity:u,wcsOsi:m,extraOptions:g}=n.collectCheckoutOptions(t),f=Yr(e,{checkoutMarketSegment:i,checkoutWorkflow:o,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:l,perpetual:h,promotionCode:d,quantity:u,wcsOsi:m,extraOptions:g});return r&&(f.innerHTML=`<span style="pointer-events: none;">${r}</span>`),f}function qr(e){return class extends e{constructor(){super(...arguments);p(this,"checkoutActionHandler");p(this,"masElement",new Lt(this))}attributeChangedCallback(n,i,o){this.masElement.attributeChangedCallback(n,i,o)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}requestUpdate(n=!1){return this.masElement.requestUpdate(n)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(n={}){let i=X();if(!i)return!1;this.dataset.imsCountry||i.imsCountryPromise.then(d=>{d&&(this.dataset.imsCountry=d)},xt),n.imsCountry=null;let o=i.collectCheckoutOptions(n,this);if(!o.wcsOsi.length)return!1;let a;try{a=JSON.parse(o.extraOptions??"{}")}catch(d){this.masElement.log?.error("cannot parse exta checkout options",d)}let s=this.masElement.togglePending(o);this.setCheckoutUrl("");let c=i.resolveOfferSelectors(o),l=await Promise.all(c);l=l.map(d=>tr(d,o)),o.country=this.dataset.imsCountry||o.country;let h=await i.buildCheckoutAction?.(l.flat(),{...a,...o},this);return this.renderOffers(l.flat(),o,{},h,s)}renderOffers(n,i,o={},a=void 0,s=void 0){let c=X();if(!c)return!1;if(i={...JSON.parse(this.dataset.extraOptions??"null"),...i,...o},s??(s=this.masElement.togglePending(i)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),a){this.classList.remove(Oh,Rh),this.masElement.toggleResolved(s,n,i);let{url:h,text:d,className:u,handler:m}=a;return h&&this.setCheckoutUrl(h),d&&(this.firstElementChild.innerHTML=d),u&&this.classList.add(...u.split(" ")),m&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=m.bind(this)),!0}else if(n.length){if(this.masElement.toggleResolved(s,n,i)){let h=c.buildCheckoutURL(n,i);return this.setCheckoutUrl(h),!0}}else{let h=new Error(`Not provided: ${i?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,h,i))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(n){}updateOptions(n={}){let i=X();if(!i)return!1;let{checkoutMarketSegment:o,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:h,perpetual:d,promotionCode:u,quantity:m,wcsOsi:g}=i.collectCheckoutOptions(n);return Xr(this,{checkoutMarketSegment:o,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:h,perpetual:d,promotionCode:u,quantity:m,wcsOsi:g}),!0}}}var ir=class ir extends qr(HTMLAnchorElement){static createCheckoutLink(t={},r=""){return Wr(ir,t,r)}setCheckoutUrl(t){this.setAttribute("href",t)}get isCheckoutLink(){return!0}clickHandler(t){if(this.checkoutActionHandler){this.checkoutActionHandler?.(t);return}}};p(ir,"is","checkout-link"),p(ir,"tag","a");var oe=ir;window.customElements.get(oe.is)||window.customElements.define(oe.is,oe,{extends:oe.tag});var or=class or extends qr(HTMLButtonElement){static createCheckoutButton(t={},r=""){return Wr(or,t,r)}setCheckoutUrl(t){this.setAttribute("data-href",t)}get href(){return this.getAttribute("data-href")}get isCheckoutButton(){return!0}clickHandler(t){if(this.checkoutActionHandler){this.checkoutActionHandler?.(t);return}this.href&&(window.location.href=this.href)}};p(or,"is","checkout-button"),p(or,"tag","button");var We=or;window.customElements.get(We.is)||window.customElements.define(We.is,We,{extends:We.tag});function Is({providers:e,settings:t}){function r(o,a){let{checkoutClientId:s,checkoutWorkflow:c,checkoutWorkflowStep:l,country:h,language:d,promotionCode:u,quantity:m}=t,{checkoutMarketSegment:g,checkoutWorkflow:f=c,checkoutWorkflowStep:S=l,imsCountry:_,country:b=_??h,language:y=d,quantity:k=m,entitlement:N,upgrade:$,modal:V,perpetual:te,promotionCode:J=u,wcsOsi:_t,extraOptions:qe,...Pt}=Object.assign({},a?.dataset??{},o??{}),ge=we(f,ne,w.checkoutWorkflow),xe=ie.CHECKOUT;ge===ne.V3&&(xe=we(S,ie,w.checkoutWorkflowStep));let Q=vt({...Pt,extraOptions:qe,checkoutClientId:s,checkoutMarketSegment:g,country:b,quantity:Et(k,w.quantity),checkoutWorkflow:ge,checkoutWorkflowStep:xe,language:y,entitlement:T(N),upgrade:T($),modal:T(V),perpetual:T(te),promotionCode:Yt(J).effectivePromoCode,wcsOsi:zr(_t)});if(a)for(let Ct of e.checkout)Ct(a,Q);return Q}function n(o,a){if(!Array.isArray(o)||!o.length||!a)return"";let{env:s,landscape:c}=t,{checkoutClientId:l,checkoutMarketSegment:h,checkoutWorkflow:d,checkoutWorkflowStep:u,country:m,promotionCode:g,quantity:f,...S}=r(a),_=window.frameElement?"if":"fp",b={checkoutPromoCode:g,clientId:l,context:_,country:m,env:s,items:[],marketSegment:h,workflowStep:u,landscape:c,...S};if(o.length===1){let[{offerId:y,offerType:k,productArrangementCode:N}]=o,{marketSegments:[$]}=o[0];Object.assign(b,{marketSegment:$,offerType:k,productArrangementCode:N}),b.items.push(f[0]===1?{id:y}:{id:y,quantity:f[0]})}else b.items.push(...o.map(({offerId:y},k)=>({id:y,quantity:f[k]??w.quantity})));return di(d,b)}let{createCheckoutLink:i}=oe;return{CheckoutLink:oe,CheckoutWorkflow:ne,CheckoutWorkflowStep:ie,buildCheckoutURL:n,collectCheckoutOptions:r,createCheckoutLink:i}}function Mh({interval:e=200,maxAttempts:t=25}={}){let r=j.module("ims");return new Promise(n=>{r.debug("Waing for IMS to be ready");let i=0;function o(){window.adobeIMS?.initialized?n():++i>t?(r.debug("Timeout"),n()):setTimeout(o,e)}o()})}function $h(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function Vh(e){let t=j.module("ims");return e.then(r=>r?window.adobeIMS.getProfile().then(({countryCode:n})=>(t.debug("Got user country:",n),n),n=>{t.error("Unable to get user country:",n)}):null)}function Ns({}){let e=Mh(),t=$h(e),r=Vh(t);return{imsReadyPromise:e,imsSignedInPromise:t,imsCountryPromise:r}}async function Rs(e,t){let{data:r}=t||await Promise.resolve().then(()=>Qs(Os(),1));if(Array.isArray(r)){let n=o=>r.find(a=>kr(a.lang,o)),i=n(e.language)??n(w.language);if(i)return Object.freeze(i)}return{}}var Ms=["GB_en","AU_en","FR_fr","AT_de","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GR_el","GR_en","HU_hu","IE_en","IT_it","LU_de","LU_en","LU_fr","NL_nl","NO_nb","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TR_tr","UA_uk","ID_en","ID_in","IN_en","IN_hi","JP_ja","MY_en","MY_ms","NZ_en","TH_en","TH_th"],Uh={INDIVIDUAL_COM:["ZA_en","LT_lt","LV_lv","NG_en","SA_ar","SA_en","ZA_en","SG_en","KR_ko"],TEAM_COM:["ZA_en","LT_lt","LV_lv","NG_en","ZA_en","CO_es","KR_ko"],INDIVIDUAL_EDU:["LT_lt","LV_lv","SA_en","SG_en"],TEAM_EDU:["SG_en","KR_ko"]},ar=class ar extends HTMLSpanElement{constructor(){super();p(this,"masElement",new Lt(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-perpetual","data-promotion-code","data-tax-exclusive","data-template","data-wcs-osi"]}static createInlinePrice(r){let n=X();if(!n)return null;let{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:d,template:u,wcsOsi:m}=n.collectPriceOptions(r);return Yr(ar,{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:d,template:u,wcsOsi:m})}get isInlinePrice(){return!0}attributeChangedCallback(r,n,i){this.masElement.attributeChangedCallback(r,n,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}resolveDisplayTaxForGeoAndSegment(r,n,i,o){let a=`${r}_${n}`;if(Ms.includes(r)||Ms.includes(a))return!0;let s=Uh[`${i}_${o}`];return s?!!(s.includes(r)||s.includes(a)):!1}async resolveDisplayTax(r,n){let[i]=await r.resolveOfferSelectors(n),o=tr(await i,n);if(o?.length){let{country:a,language:s}=n,c=o[0],[l=""]=c.marketSegments;return this.resolveDisplayTaxForGeoAndSegment(a,s,c.customerSegment,l)}}async render(r={}){if(!this.isConnected)return!1;let n=X();if(!n)return!1;let i=n.collectPriceOptions(r,this);if(!i.wcsOsi.length)return!1;let o=this.masElement.togglePending(i);this.innerHTML="";let[a]=n.resolveOfferSelectors(i);return this.renderOffers(tr(await a,i),i,o)}renderOffers(r,n={},i=void 0){if(!this.isConnected)return;let o=X();if(!o)return!1;let a=o.collectPriceOptions({...this.dataset,...n},this);if(i??(i=this.masElement.togglePending(a)),r.length){if(this.masElement.toggleResolved(i,r,a))return this.innerHTML=o.buildPriceHTML(r,a),!0}else{let s=new Error(`Not provided: ${a?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,s,a))return this.innerHTML="",!0}return!1}updateOptions(r){let n=X();if(!n)return!1;let{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:d,template:u,wcsOsi:m}=n.collectPriceOptions(r);return Xr(this,{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:d,template:u,wcsOsi:m}),!0}};p(ar,"is","inline-price"),p(ar,"tag","span");var ae=ar;window.customElements.get(ae.is)||window.customElements.define(ae.is,ae,{extends:ae.tag});function $s({literals:e,providers:t,settings:r}){function n(a,s){let{country:c,displayOldPrice:l,displayPerUnit:h,displayRecurrence:d,displayTax:u,forceTaxExclusive:m,language:g,promotionCode:f,quantity:S}=r,{displayOldPrice:_=l,displayPerUnit:b=h,displayRecurrence:y=d,displayTax:k=u,forceTaxExclusive:N=m,country:$=c,language:V=g,perpetual:te,promotionCode:J=f,quantity:_t=S,template:qe,wcsOsi:Pt,...ge}=Object.assign({},s?.dataset??{},a??{}),xe=vt({...ge,country:$,displayOldPrice:T(_),displayPerUnit:T(b),displayRecurrence:T(y),displayTax:T(k),forceTaxExclusive:T(N),language:V,perpetual:T(te),promotionCode:Yt(J).effectivePromoCode,quantity:Et(_t,w.quantity),template:qe,wcsOsi:zr(Pt)});if(s)for(let Q of t.price)Q(s,xe);return xe}function i(a,s){if(!Array.isArray(a)||!a.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=Wi;break;case"strikethrough":l=Ki;break;case"optical":l=Fi;break;case"annual":l=ji;break;default:s.country==="AU"&&a[0].planType==="ABM"?l=s.promotionCode?Xi:Yi:l=s.promotionCode?zi:Gi}let h=n(s);h.literals=Object.assign({},e.price,vt(s.literals??{}));let[d]=a;return d={...d,...d.priceDetails},l(h,d)}let o=ae.createInlinePrice;return{InlinePrice:ae,buildPriceHTML:i,collectPriceOptions:n,createInlinePrice:o}}function Vs({settings:e}){let t=j.module("wcs"),{env:r,wcsApiKey:n}=e,i=new Map,o=new Map,a;async function s(d,u,m=!0){let g=Gn;t.debug("Fetching:",d);let f="",S,_,b;try{if(d.offerSelectorIds=d.offerSelectorIds.sort(),f=new URL(e.wcsURL),f.searchParams.set("offer_selector_ids",d.offerSelectorIds.join(",")),f.searchParams.set("country",d.country),f.searchParams.set("locale",d.locale),f.searchParams.set("landscape",r===Ke.STAGE?"ALL":e.landscape),f.searchParams.set("api_key",n),d.language&&f.searchParams.set("language",d.language),d.promotionCode&&f.searchParams.set("promotion_code",d.promotionCode),d.currency&&f.searchParams.set("currency",d.currency),_=Date.now(),S=await fetch(f.toString(),{credentials:"omit"}),b=Date.now(),S.ok){let y=await S.json();t.debug("Fetched:",d,y);let k=y.resolvedOffers??[];k=k.map(Or),u.forEach(({resolve:N},$)=>{let V=k.filter(({offerSelectorIds:te})=>te.includes($)).flat();V.length&&(u.delete($),N(V))})}else S.status===404&&d.offerSelectorIds.length>1?(t.debug("Multi-osi 404, fallback to fetch-by-one strategy"),await Promise.allSettled(d.offerSelectorIds.map(y=>s({...d,offerSelectorIds:[y]},u,!1)))):g=Bn}catch(y){g=`WCS Request error: ${y.message}`,t.error(g,d)}if(m&&u.size){t.debug("Missing:",{offerSelectorIds:[...u.keys()]});let y=S.headers?.get("x-request-id"),k=y?`x-request-id: ${y}`:"",N=`${g}: ${S?.status}, url: ${f.toString()}${k}, start: ${_}, end: ${b}`;u.forEach($=>{$.reject(new Error(N))})}}function c(){clearTimeout(a);let d=[...o.values()];o.clear(),d.forEach(({options:u,promises:m})=>s(u,m))}function l(){let d=i.size;i.clear(),t.debug(`Flushed ${d} cache entries`)}function h({country:d,language:u,perpetual:m=!1,promotionCode:g="",wcsOsi:f=[]}){let S=`${u}_${d}`;d!=="GB"&&(u=m?"EN":"MULT");let _=[d,u,g].filter(b=>b).join("-").toLowerCase();return f.map(b=>{let y=`${b}-${_}`;if(!i.has(y)){let k=new Promise((N,$)=>{let V=o.get(_);if(!V){let te={country:d,locale:S,offerSelectorIds:[]};d!=="GB"&&(te.language=u),V={options:te,promises:new Map},o.set(_,V)}g&&(V.options.promotionCode=g),V.options.offerSelectorIds.push(b),V.promises.set(b,{resolve:N,reject:$}),V.options.offerSelectorIds.length>=e.wcsBufferLimit?c():(t.debug("Queued:",V.options),a||(a=setTimeout(c,e.wcsBufferDelay)))});i.set(y,k)}return i.get(y)})}return{WcsCommitment:qi,WcsPlanType:Zi,WcsTerm:Ji,resolveOfferSelectors:h,flushWcsCache:l}}var ao="mas-commerce-service",Dh="mas:start",Bh="mas:ready",Jr,Hs,Zr=class extends HTMLElement{constructor(){super(...arguments);G(this,Jr);p(this,"promise",null)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(n,i,o)=>{let a=await r?.(n,i,this.imsSignedInPromise,o);return a||null})}async activate(){let r=L(this,Jr,Hs),n=Object.freeze(ro(r));St(r.lana);let i=j.init(r.hostEnv).module("service");i.debug("Activating:",r);let o={price:{}};try{o.price=await Rs(n,r.commerce.priceLiterals)}catch{}let a={checkout:new Set,price:new Set},s={literals:o,providers:a,settings:n};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...Is(s),...Ns(s),...$s(s),...Vs(s),...qn,Log:j,get defaults(){return w},get log(){return j},get providers(){return{checkout(c){return a.checkout.add(c),()=>a.checkout.delete(c)},price(c){return a.price.add(c),()=>a.price.delete(c)}}},get settings(){return n}})),i.debug("Activated:",{literals:o,settings:n}),je(()=>{let c=new CustomEvent(ot,{bubbles:!0,cancelable:!1,detail:this});performance.mark(Bh),this.dispatchEvent(c)})}connectedCallback(){this.readyPromise||(performance.mark(Dh),this.readyPromise=this.activate())}disconnectedCallback(){this.readyPromise=null}flushWcsCache(){this.flushWcsCache(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCache(),document.querySelectorAll('span[is="inline-price"],a[is="checkout-link"]').forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers")}refreshFragments(){this.flushWcsCache(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh()),this.log.debug("Refreshed AEM fragments")}};Jr=new WeakSet,Hs=function(){let r={hostEnv:{name:this.getAttribute("host-env")??"prod"},commerce:{env:this.getAttribute("env")},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate"),10),isProdDomain:this.getAttribute("host-env")==="prod"}};return["locale","country","language"].forEach(n=>{let i=this.getAttribute(n);i&&(r[n]=i)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(n=>{let i=this.getAttribute(n);if(i!=null){let o=n.replace(/-([a-z])/g,a=>a[1].toUpperCase());r.commerce[o]=i}}),r},p(Zr,"instance");window.customElements.get(ao)||window.customElements.define(ao,Zr);St({sampleRate:1});export{We as CheckoutButton,oe as CheckoutLink,ne as CheckoutWorkflow,ie as CheckoutWorkflowStep,w as Defaults,ae as InlinePrice,$e as Landscape,j as Log,ao as TAG_NAME_SERVICE,fe as UptLink,qi as WcsCommitment,Zi as WcsPlanType,Ji as WcsTerm,Or as applyPlanType,ro as getSettings};
