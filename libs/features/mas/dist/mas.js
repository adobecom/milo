...
`;var kn=class extends M{constructor(t){super(t)}getGlobalCSS(){return fc}renderLayout(){return x`${this.cardImage}
    <div class="body">
...
`;var Rn=class extends M{constructor(t){super(t)}getGlobalCSS(){return gc}renderLayout(){return x` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var yd=32,Ut=class extends M{constructor(r){super(r);f(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);f(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
...
`;var On={title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant"},vc={...function(){let{whatsIncluded:e,size:t,...r}=On;return r}(),title:{tag:"h3",slot:"heading-s"},subtitle:{tag:"p",slot:"subtitle"},secureLabel:!1},yc={...function(){let{whatsIncluded:e,size:t,quantitySelect:r,...n}=On;return n}()},ne=class extends M{constructor(t){super(t),this.adaptForMobile=this.adaptForMobile.bind(this)}priceOptionsProvider(t,r){t.dataset.template===oo&&(r.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return bc}adaptForMobile(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}let t=this.card.shadowRoot,r=t.querySelector("footer"),n=this.card.getAttribute("size"),o=t.querySelector("footer #stock-checkbox"),i=t.querySelector(".body #stock-checkbox"),a=t.querySelector(".body");if(!n||!n.includes("wide")){r?.classList.remove("wide-footer"),o&&o.remove();return}let s=_t();if(r?.classList.toggle("wide-footer",!s),s&&o){i?o.remove():a.appendChild(o);return}!s&&i&&(o?i.remove():r.prepend(i))}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",r=>{r.preventDefault(),r.target!==t?t.classList.add("hide-tooltip"):r.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",r=>{r.preventDefault(),r.target!==t?t.classList.add("hide-tooltip"):r.target.classList.remove("hide-tooltip")}))}postCardUpdateHook(){this.adaptForMobile(),this.adjustTitleWidth(),this.adjustLegal(),this.adjustAddon(),this.adjustCallout()}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM.querySelector(`${Q}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?x`<div class="divider"></div>`:$}async adjustLegal(){if(await this.card.updateComplete,this.legalAdjusted)return;this.legalAdjusted=!0;let t=[],r=this.card.querySelector(`[slot="heading-m"] ${Q}[data-template="price"]`);r&&t.push(r),this.card.querySelectorAll(`[slot="body-xs"] ${Q}[data-template="price"]`).forEach(i=>t.push(i));let o=t.map(async i=>{let a=i.cloneNode(!0);await i.onceSettled(),i?.options&&(i.options.displayPerUnit&&(i.dataset.displayPerUnit="false"),i.options.displayTax&&(i.dataset.displayTax="false"),i.options.displayPlanType&&(i.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),i.parentNode.insertBefore(a,i.nextSibling))});await Promise.all(o)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;let r=this.mainPrice;if(!r)return;await r.onceSettled();let n=r.value?.[0]?.planType;n&&(t.planType=n)}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
            ...
            ${this.plansSecureLabelFooter}`}};f(ne,"variantStyle",v`
        :host([variant^='plans']) {
            min-height: 273px;
...
`;var Dt=class extends M{constructor(t){super(t)}getGlobalCSS(){return Ac}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
...
`;var _c={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Bt=class extends M{constructor(t){super(t)}getGlobalCSS(){return wc}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return x`${this.cardImage}
            <div class="body">
    ...
    `);var wi=new Map,Y=(e,t,r=null,n=null,o)=>{wi.set(e,{class:t,fragmentMapping:r,style:n,collectionOptions:o})};Y("catalog",Ht,uc,Ht.variantStyle);Y("image",kn);Y("inline-heading",Rn);Y("mini-compare-chart",Ut,null,Ut.variantStyle);Y("plans",ne,On,ne.variantStyle,ne.collectionOptions);Y("plans-students",ne,yc,ne.variantStyle,ne.collectionOptions);Y("plans-education",ne,vc,ne.variantStyle,ne.collectionOptions);Y("product",st,null,st.variantStyle);Y("segment",Dt,null,Dt.variantStyle);Y("special-offers",Bt,_c,Bt.variantStyle);var _i=(e,t=!1)=>{let r=wi.get(e.variant);if(!r)return t?void 0:new st(e);let{class:n,style:o}=r;if(o)try{let i=new CSSStyleSheet;i.replaceSync(o.cssText),e.shadowRoot.adoptedStyleSheets.push(i)}catch{let a=document.createElement("style");a.textContent=o.cssText,e.shadowRoot.appendChild(a)}return new n(e)};function Ln(e){return wi.get(e)?.fragmentMapping}var Sc=document.createElement("style");Sc.innerHTML=`
:root {
...
`;var jc={backgroundImage:{tag:"div",slot:"image"},badge:!0,ctas:{slot:"footer",size:"S"},description:{tag:"div",slot:"body-s"},mnemonics:{size:"m"},size:["wide"]},Yt=class extends M{getGlobalCSS(){return Vc}renderLayout(){return x` <div class="content">
                <div class="top-section">
                    <slot name="icons"></slot>
                    ${this.badge}
                </div>
...
`;var Mi={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color",specialValues:{}},allowedColors:{gray:"--spectrum-gray-100"},size:["single","double","triple"]},dt=class extends M{getGlobalCSS(){return qc}get aemFragmentMapping(){return Mi}renderLayout(){return x`
    ...
    `);customElements.define("ah-try-buy-widget",dt);var Wc=`
...
`;var $i={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxxs",maxCount:40,withSuffix:!0},description:{tag:"div",slot:"body-xxs",maxCount:200,withSuffix:!1},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"S"},backgroundImage:{tag:"div",slot:"image"},backgroundColor:{attribute:"background-color"},borderColor:{attribute:"border-color",specialValues:{gradient:"linear-gradient(135deg, #ff4885 0%, #b272eb 50%, #5d89ff 100%)"}}},pt=class extends M{getGlobalCSS(){return Wc}get aemFragmentMapping(){return $i}renderLayout(){return x`
    ...
    `);customElements.define("ah-promoted-plans",pt);var Yc=`
...
`;var Ii={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300"}}},mt=class extends M{getGlobalCSS(){return Yc}get aemFragmentMapping(){return Ii}renderLayout(){return x`            
    ...
    `);customElements.define("fries-card",mt);Y("ccd-suggested",Wt,Gc,Wt.variantStyle);Y("ccd-slice",Yt,jc,Yt.variantStyle);Y("ah-try-buy-widget",dt,Mi,dt.variantStyle);Y("ah-promoted-plans",pt,$i,pt.variantStyle);Y("fries",mt,Ii,mt.variantStyle);
