...
var _measure, _MasCommerceService_instances, config_get;
var MasCommerceService = class extends HTMLElement {
  ...
  activate() {
    ...
    const settings = getSettings(config2);
...
var Plans = class extends VariantLayout {
  ...
  get addon() {
    if (this.card.size === "super-wide") return A2;
    return x2`<slot name="addon"></slot>`;
  }
  get plansSecureLabelFooter() {
    if (this.card.size === "super-wide")
      return x2`<footer><slot name="addon"></slot>${this.secureLabel}<slot name="footer"></slot></footer>`;
...
__publicField(Plans, "collectionOptions", {
  customHeaderArea: () => {
    return x2`<slot name="resultsText"></slot>`;
  },
  headerVisibility: {
    search: false,
    sort: false,
...
var _log, _rawData, _data, _fetchInfo, _service2, _fragmentId, _fetchPromise, _author, _fetchCount, _preview, _AemFragment_instances, getFragmentById_fn, applyHeaders_fn, fail_fn, fetchData_fn;
var AemFragment = class extends HTMLElement {
  ...
  connectedCallback() {
    ...
    __privateGet(this, _service2) ?? __privateSet(this, _service2, getService2(this));
    __privateSet(this, _preview, __privateGet(this, _service2).settings?.preview);
    __privateGet(this, _log) ?? __privateSet(this, _log, __privateGet(this, _service2).log.module(
  ...
  async refresh(flushCache = true) {
    ...
    if (wcs && !getParameter("mas.disableWcsCache")) {
      __privateGet(this, _service2).prefillWcsCache(wcs);
    }
    this.dispatchEvent(
  ...
  async generatePreview() {
    ...
    const data = await previewFragment(__privateGet(this, _fragmentId), {
      locale: __privateGet(this, _service2).settings.locale,
      apiKey: __privateGet(this, _service2).settings.wcsApiKey
    });
    return data;
  }
};
...
var idCounter = 0;
var _durationMarkName, _internalId, _log2, _service3, _startMarkName, _MerchCard_instances, fail_fn2;
var MerchCard = class extends s7 {
  ...
  connectedCallback() {
    ...
    registerPriceOptionsProvider(__privateGet(this, _service3));
