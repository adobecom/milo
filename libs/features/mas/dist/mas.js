...
`,Mo=()=>[P`
        ...
        `}get cardImage(){return x` <div class="image">
            ...
            ${this.badge}
              ...
              >`:"";return x`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){}};it=new WeakMap,p(Vt,"styleMap",{});var I=Vt;function le(e,t={},r=null,n=null){let i=n?document.createElement(e,{is:n}):document.createElement(e);r instanceof HTMLElement?i.appendChild(r):i.innerHTML=r;for(let[o,a]of Object.entries(t))i.setAttribute(o,a);return i}function gr(){return window.matchMedia("(max-width: 767px)").matches}function Ho(){return window.matchMedia("(max-width: 1024px)").matches}var Fn={};Os(Fn,{CLASS_NAME_FAILED:()=>Nn,CLASS_NAME_HIDDEN:()=>Ys,CLASS_NAME_PENDING:()=>On,CLASS_NAME_RESOLVED:()=>Rn,ERROR_MESSAGE_BAD_REQUEST:()=>vr,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>rc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Vn,EVENT_AEM_ERROR:()=>He,EVENT_AEM_LOAD:()=>Me,EVENT_MAS_ERROR:()=>kn,EVENT_MAS_READY:()=>In,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Pn,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>ec,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Qs,EVENT_MERCH_CARD_READY:()=>Cn,EVENT_MERCH_OFFER_READY:()=>Ws,EVENT_MERCH_OFFER_SELECT_READY:()=>wn,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>br,EVENT_MERCH_SEARCH_CHANGE:()=>Js,EVENT_MERCH_SIDENAV_SELECT:()=>tc,EVENT_MERCH_STOCK_CHANGE:()=>Zs,EVENT_MERCH_STORAGE_CHANGE:()=>xr,EVENT_OFFER_SELECTED:()=>qs,EVENT_TYPE_FAILED:()=>Mn,EVENT_TYPE_PENDING:()=>Hn,EVENT_TYPE_READY:()=>ot,EVENT_TYPE_RESOLVED:()=>$n,LOG_NAMESPACE:()=>Un,Landscape:()=>$e,NAMESPACE:()=>js,PARAM_AOS_API_KEY:()=>nc,PARAM_ENV:()=>Dn,PARAM_LANDSCAPE:()=>Bn,PARAM_WCS_API_KEY:()=>ic,STATE_FAILED:()=>he,STATE_PENDING:()=>de,STATE_RESOLVED:()=>ue,TAG_NAME_SERVICE:()=>Xs,WCS_PROD_URL:()=>Gn,WCS_STAGE_URL:()=>zn});var js="merch",Ys="hidden",ot="wcms:commerce:ready",Xs="mas-commerce-service",Ws="merch-offer:ready",wn="merch-offer-select:ready",Cn="merch-card:ready",Pn="merch-card:action-menu-toggle",qs="merch-offer:selected",Zs="merch-stock:change",xr="merch-storage:change",br="merch-quantity-selector:change",Js="merch-search:change",Qs="merch-card-collection:sort",ec="merch-card-collection:showmore",tc="merch-sidenav:select",Me="aem:load",He="aem:error",In="mas:ready",kn="mas:error",Nn="placeholder-failed",On="placeholder-pending",Rn="placeholder-resolved",vr="Bad WCS request",Vn="Commerce offer not found",rc="Literals URL not provided",Mn="mas:failed",Hn="mas:pending",$n="mas:resolved",Un="mas/commerce",Dn="commerce.env",Bn="commerce.landscape",nc="commerce.aosKey",ic="commerce.wcsKey",Gn="https://www.adobe.com/web_commerce_artifact",zn="https://www.stage.adobe.com/web_commerce_artifact_stage",he="failed",de="pending",ue="resolved",$e={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"};var $o=`
:root {
...
`;var ac=32,st=class extends I{constructor(r){super(r);p(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);p(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
...
`;var ct=class extends I{constructor(t){super(t)}getGlobalCSS(){return Go}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
...
`;var lt=class extends I{constructor(t){super(t)}getGlobalCSS(){return Fo}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
        ${this.promoBottom?"":x`<slot name="promo-text"></slot><slot name="callout-content"></slot>`}
...
`;var dt=class extends I{constructor(t){super(t)}getGlobalCSS(){return jo}renderLayout(){return x`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
...
`;var cc={mnemonics:{size:"l"},subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"cta",size:"M"}},ut=class extends I{getGlobalCSS(){return Yo}get aemFragmentMapping(){return cc}get stripStyle(){return this.card.backgroundImage?`
...
`;var lc={mnemonics:{size:"m"},backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{slot:"footer",size:"S"},allowedSizes:["wide"]},mt=class extends I{getGlobalCSS(){return Xo}get aemFragmentMapping(){return lc}renderLayout(){return x` <div class="content">
                <div class="top-section">
                  <slot name="icons"></slot> 
                  ${this.badge}
                </div>  
    ...
    `);var Kn=(e,t=!1)=>{switch(e.variant){case"catalog":return new at(e);case"image":return new Ar(e);case"inline-heading":return new Er(e);case"mini-compare-chart":return new st(e);case"plans":return new ct(e);case"product":return new Ue(e);case"segment":return new lt(e);case"special-offers":return new ht(e);case"twp":return new dt(e);case"ccd-suggested":return new ut(e);case"ccd-slice":return new mt(e);default:return t?void 0:new Ue(e)}},Wo=()=>{let e=[];return e.push(at.variantStyle),e.push(st.variantStyle),e.push(Ue.variantStyle),e.push(ct.variantStyle),e.push(lt.variantStyle),e.push(ht.variantStyle),e.push(dt.variantStyle),e.push(ut.variantStyle),e.push(mt.variantStyle),e};var qo=document.createElement("style");qo.innerHTML=`
:root {
...
`,Ge.MISSING_INTL_API,a);var k=r.getPluralRules(t,{type:h.pluralType}).select(u-(h.offset||0));S=h.options[k]||h.options.other}if(!S)throw new Si(h.value,u,Object.keys(h.options),a);s.push.apply(s,Kt(S.value,t,r,n,i,u-(h.offset||0)));continue}}return al(s)}function cl(e,t){return t?A(A(A({},e||{}),t||{}),Object.keys(e).reduce(function(r,n){return r[n]=A(A({},e[n]),t[n]||{}),r},{})):e}function ll(e,t){return t?Object.keys(e).reduce(function(r,n){return r[n]=cl(e[n],t[n]),r},A({},e)):e}function yi(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function hl(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:zt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.NumberFormat).bind.apply(t,Cr([void 0],r,!1)))},{cache:yi(e.number),strategy:Mr.variadic}),getDateTimeFormat:zt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.DateTimeFormat).bind.apply(t,Cr([void 0],r,!1)))},{cache:yi(e.dateTime),strategy:Mr.variadic}),getPluralRules:zt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.PluralRules).bind.apply(t,Cr([void 0],r,!1)))},{cache:yi(e.pluralRules),strategy:Mr.variadic})}}var Oa=function(){function e(t,r,n,i){var o=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(a){var s=o.formatToParts(a);if(s.length===1)return s[0].value;var c=s.reduce(function(l,h){return!l.length||h.type!==K.literal||typeof l[l.length-1]!="string"?l.push(h.value):l[l.length-1]+=h.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(a){return Kt(o.ast,o.locales,o.formatters,o.formats,a,void 0,o.message)},this.resolvedOptions=function(){return{locale:o.resolvedLocale.toString()}},this.getAst=function(){return o.ast},this.locales=r,this.resolvedLocale=e.resolveLocale(r),typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=ll(e.formats,n),this.formatters=i&&i.formatters||hl(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(t){var r=Intl.NumberFormat.supportedLocalesOf(t);return r.length>0?new Intl.Locale(r[0]):new Intl.Locale(typeof t=="string"?t:t[0])},e.__parse=Ca,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var Ra=Oa;var dl=/[0-9\-+#]/,ul=/[^\d\-+#]/g;function Va(e){return e.search(dl)}function ml(e="#.##"){let t={},r=e.length,n=Va(e);t.prefix=n>0?e.substring(0,n):"";let i=Va(e.split("").reverse().join("")),o=r-i,a=e.substring(o,o+1),s=o+(a==="."||a===","?1:0);t.suffix=i>0?e.substring(s,r):"",t.mask=e.substring(n,s),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let c=t.mask.match(ul);return t.decimal=c&&c[c.length-1]||".",t.separator=c&&c[1]&&c[0]||",",c=t.mask.split(t.decimal),t.integer=c[0],t.fraction=c[1],t}function pl(e,t,r){let n=!1,i={value:e};e<0&&(n=!0,i.value=-i.value),i.sign=n?"-":"",i.value=Number(i.value).toFixed(t.fraction&&t.fraction.length),i.value=Number(i.value).toString();let o=t.fraction&&t.fraction.lastIndexOf("0"),[a="0",s=""]=i.value.split(".");return(!s||s&&s.length<=o)&&(s=o<0?"":(+("0."+s)).toFixed(o+1).replace("0.","")),i.integer=a,i.fraction=s,fl(i,t),(i.result==="0"||i.result==="")&&(n=!1,i.sign=""),!n&&t.maskHasPositiveSign?i.sign="+":n&&t.maskHasPositiveSign?i.sign="-":n&&(i.sign=r&&r.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),i}function fl(e,t){e.result="";let r=t.integer.split(t.separator),n=r.join(""),i=n&&n.indexOf("0");if(i>-1)for(;e.integer.length<n.length-i;)e.integer="0"+e.integer;else Number(e.integer)===0&&(e.integer="");let o=r[1]&&r[r.length-1].length;if(o){let a=e.integer.length,s=a%o;for(let c=0;c<a;c++)e.result+=e.integer.charAt(c),!((c-s+1)%o)&&c<a-o&&(e.result+=t.separator)}else e.result=e.integer;return e.result+=t.fraction&&e.fraction?t.decimal+e.fraction:"",e}function gl(e,t,r={}){if(!e||isNaN(Number(t)))return t;let n=ml(e),i=pl(t,n,r);return n.prefix+i.sign+i.result+n.suffix}var Ma=gl;var Ha=".",xl=",",Ua=/^\s+/,Da=/\s+$/,$a="&nbsp;",jt={MONTH:"MONTH",YEAR:"YEAR"},bl={[N.ANNUAL]:12,[N.MONTHLY]:1,[N.THREE_YEARS]:36,[N.TWO_YEARS]:24},vl={CHF:e=>Math.round(e*20)/20},Ti=(e,t)=>({accept:e,round:t}),Al=[Ti(({divisor:e,price:t})=>t%e==0,({divisor:e,price:t})=>t/e),Ti(({usePrecision:e})=>e,({divisor:e,price:t})=>Math.ceil(Math.floor(t*1e4/e)/100)/100),Ti(()=>!0,({divisor:e,price:t})=>Math.ceil(Math.floor(t*100/e)/100))],Li={[U.YEAR]:{[N.MONTHLY]:jt.MONTH,[N.ANNUAL]:jt.YEAR},[U.MONTH]:{[N.MONTHLY]:jt.MONTH}},El=(e,t)=>e.indexOf(`'${t}'`)===0,Sl=(e,t=!0)=>{let r=e.replace(/'.*?'/,"").trim(),n=Ga(r);return!!n?t||(r=r.replace(/[,\.]0+/,n)):r=r.replace(/\s?(#.*0)(?!\s)?/,"$&"+Tl(e)),r},yl=e=>{let t=Ll(e),r=El(e,t),n=e.replace(/'.*?'/,""),i=Ua.test(n)||Da.test(n);return{currencySymbol:t,isCurrencyFirst:r,hasCurrencySpace:i}},Ba=e=>e.replace(Ua,$a).replace(Da,$a),Tl=e=>e.match(/#(.?)#/)?.[1]===Ha?xl:Ha,Ll=e=>e.match(/'(.*?)'/)?.[1]??"",Ga=e=>e.match(/0(.?)0/)?.[1]??"";function Hr({formatString:e,price:t,usePrecision:r,isIndianPrice:n=!1},i,o=a=>a){let{currencySymbol:a,isCurrencyFirst:s,hasCurrencySpace:c}=yl(e),l=r?Ga(e):"",h=Sl(e,r),d=r?2:0,u=o(t,{currencySymbol:a}),m=n?u.toLocaleString("hi-IN",{minimumFractionDigits:d,maximumFractionDigits:d}):Ma(h,u),f=r?m.lastIndexOf(l):m.length,g=m.substring(0,f),L=m.substring(f+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,m).replace(/SYMBOL/,a),currencySymbol:a,decimals:L,decimalsDelimiter:l,hasCurrencySpace:c,integer:g,isCurrencyFirst:s,recurrenceTerm:i}}var za=e=>{let{commitment:t,term:r,usePrecision:n}=e,i=bl[r]??1;return Hr(e,i>1?jt.MONTH:Li[t]?.[r],(o,{currencySymbol:a})=>{let s={divisor:i,price:o,usePrecision:n},{round:c}=Al.find(({accept:h})=>h(s));if(!c)throw new Error(`Missing rounding rule for: ${JSON.stringify(s)}`);return(vl[a]??(h=>h))(c(s))})},Fa=({commitment:e,term:t,...r})=>Hr(r,Li[e]?.[t]),Ka=e=>{let{commitment:t,term:r}=e;return t===U.YEAR&&r===N.MONTHLY?Hr(e,jt.YEAR,n=>n*12):Hr(e,Li[t]?.[r])};var _l={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at {alternativePrice}",strikethroughAriaLabel:"Regularly at {strikethroughPrice}"},wl=ia("ConsonantTemplates/price"),Cl=/<\/?[^>]+(>|$)/g,z={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},ze={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel"},Pl="TAX_EXCLUSIVE",Il=e=>na(e)?Object.entries(e).filter(([,t])=>ft(t)||Lr(t)||t===!0).reduce((t,[r,n])=>t+` ${r}${n===!0?"":'="'+ta(n)+'"'}`,""):"",Y=(e,t,r,n=!1)=>`<span class="${e}${t?"":" "+z.disabled}"${Il(r)}>${n?Ba(t):t??""}</span>`;function kl(e,{accessibleLabel:t,currencySymbol:r,decimals:n,decimalsDelimiter:i,hasCurrencySpace:o,integer:a,isCurrencyFirst:s,recurrenceLabel:c,perUnitLabel:l,taxInclusivityLabel:h},d={}){let u=Y(z.currencySymbol,r),m=Y(z.currencySpace,o?"&nbsp;":""),f="";return s&&(f+=u+m),f+=Y(z.integer,a),f+=Y(z.decimalsDelimiter,i),f+=Y(z.decimals,n),s||(f+=m+u),f+=Y(z.recurrence,c,null,!0),f+=Y(z.unitType,l,null,!0),f+=Y(z.taxInclusivity,h,!0),Y(e,f,{...d,"aria-label":t})}var W=({displayOptical:e=!1,displayStrikethrough:t=!1,displayAnnual:r=!1}={})=>({country:n,displayFormatted:i=!0,displayRecurrence:o=!0,displayPerUnit:a=!1,displayTax:s=!1,language:c,literals:l={}}={},{commitment:h,offerSelectorIds:d,formatString:u,price:m,priceWithoutDiscount:f,taxDisplay:g,taxTerm:L,term:w,usePrecision:b}={},S={})=>{Object.entries({country:n,formatString:u,language:c,price:m}).forEach(([se,Xr])=>{if(Xr==null)throw new Error(`Argument "${se}" is missing for osi ${d?.toString()}, country ${n}, language ${c}`)});let k={..._l,...l},R=`${c.toLowerCase()}-${n.toUpperCase()}`;function V(se,Xr){let Wr=k[se];if(Wr==null)return"";try{return new Ra(Wr.replace(Cl,""),R).format(Xr)}catch{return wl.error("Failed to format literal:",Wr),""}}let $=t&&f?f:m,oe=e?za:Fa;r&&(oe=Ka);let{accessiblePrice:We,recurrenceTerm:_e,...qe}=oe({commitment:h,formatString:u,term:w,price:e?m:$,usePrecision:b,isIndianPrice:n==="IN"}),J=We,ge="";if(y(o)&&_e){let se=V(ze.recurrenceAriaLabel,{recurrenceTerm:_e});se&&(J+=" "+se),ge=V(ze.recurrenceLabel,{recurrenceTerm:_e})}let ae="";if(y(a)){ae=V(ze.perUnitLabel,{perUnit:"LICENSE"});let se=V(ze.perUnitAriaLabel,{perUnit:"LICENSE"});se&&(J+=" "+se)}let Q="";y(s)&&L&&(Q=V(g===Pl?ze.taxExclusiveLabel:ze.taxInclusiveLabel,{taxTerm:L}),Q&&(J+=" "+Q)),t&&(J=V(ze.strikethroughAriaLabel,{strikethroughPrice:J}));let we=z.container;if(e&&(we+=" "+z.containerOptical),t&&(we+=" "+z.containerStrikethrough),r&&(we+=" "+z.containerAnnual),y(i))return kl(we,{...qe,accessibleLabel:J,recurrenceLabel:ge,perUnitLabel:ae,taxInclusivityLabel:Q},S);let{currencySymbol:Wi,decimals:Es,decimalsDelimiter:Ss,hasCurrencySpace:qi,integer:ys,isCurrencyFirst:Ts}=qe,Ze=[ys,Ss,Es];Ts?(Ze.unshift(qi?"\xA0":""),Ze.unshift(Wi)):(Ze.push(qi?"\xA0":""),Ze.push(Wi)),Ze.push(ge,ae,Q);let Ls=Ze.join("");return Y(we,Ls,S)},ja=()=>(e,t,r)=>{let i=(e.displayOldPrice===void 0||y(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${W()(e,t,r)}${i?"&nbsp;"+W({displayStrikethrough:!0})(e,t,r):""}`},Ya=()=>(e,t,r)=>{let n={...e,displayTax:!1,displayPerUnit:!1};return`${(e.displayOldPrice===void 0||y(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price?W({displayStrikethrough:!0})(n,t,r)+"&nbsp;":""}${W()(e,t,r)}${Y(z.containerAnnualPrefix,"&nbsp;(")}${W({displayAnnual:!0})(n,t,r)}${Y(z.containerAnnualSuffix,")")}`},Xa=()=>(e,t,r)=>{let n={...e,displayTax:!1,displayPerUnit:!1};return`${W()(e,t,r)}${Y(z.containerAnnualPrefix,"&nbsp;(")}${W({displayAnnual:!0})(n,t,r)}${Y(z.containerAnnualSuffix,")")}`};var _i=W(),wi=ja(),Ci=W({displayOptical:!0}),Pi=W({displayStrikethrough:!0}),Ii=W({displayAnnual:!0}),ki=Xa(),Ni=Ya();var Nl=(e,t)=>{if(!(!xt(e)||!xt(t)))return Math.floor((t-e)/t*100)},Wa=()=>(e,t)=>{let{price:r,priceWithoutDiscount:n}=t,i=Nl(r,n);return i===void 0?'<span class="no-discount"></span>':`<span class="discount">${i}%</span>`};var Oi=Wa();var{freeze:Yt}=Object,te=Yt({...De}),re=Yt({...Z}),Fe={STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"},Ri=Yt({...U}),Vi=Yt({...aa}),Mi=Yt({...N});var qa="mas-commerce-service";function Za(e,{once:t=!1}={}){let r=null;function n(){let i=document.querySelector(qa);i!==r&&(r=i,i&&e(i))}return document.addEventListener(ot,n,{once:t}),ye(n),()=>document.removeEventListener(ot,n)}function Xt(e,{country:t,forceTaxExclusive:r,perpetual:n}){let i;if(e.length<2)i=e;else{let o=t==="GB"||n?"EN":"MULT",[a,s]=e;i=[a.language===o?a:s]}return r&&(i=i.map(li)),i}var ye=e=>window.setTimeout(e);function At(e,t=1){if(e==null)return[t];let r=(Array.isArray(e)?e:String(e).split(",")).map(vt).filter(xt);return r.length||(r=[t]),r}function $r(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(ri)}function q(){return document.getElementsByTagName(qa)?.[0]}var Ke={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals"],serializableTypes:["Array","Object"],sampleRate:1,tags:"acom",isProdDomain:!1},Ja=1e3,Qa=new Set;function Ol(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function es(e){if(e==null)return;let t=typeof e;if(t==="function")return e.name?`function ${e.name}`:"function";if(t==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:n,originatingRequest:i,status:o}=e;return[n,o,i].filter(Boolean).join(" ")}let r=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!Ke.serializableTypes.includes(r))return r}return e}function Rl(e,t){if(!Ke.ignoredProperties.includes(e))return es(t)}var Hi={append(e){if(e.level!=="error")return;let{message:t,params:r}=e,n=[],i=[],o=t;r.forEach(l=>{l!=null&&(Ol(l)?n:i).push(l)}),n.length&&(o+=" "+n.map(es).join(" "));let{pathname:a,search:s}=window.location,c=`${Ke.delimiter}page=${a}${s}`;c.length>Ja&&(c=`${c.slice(0,Ja)}<trunc>`),o+=c,i.length&&(o+=`${Ke.delimiter}facts=`,o+=JSON.stringify(i,Rl)),Qa.has(o)||(Qa.add(o),window.lana?.log(o,Ke))}};function Et(e){Object.assign(Ke,Object.fromEntries(Object.entries(e).filter(([t,r])=>t in Ke&&r!==""&&r!==null&&r!==void 0&&!Number.isNaN(r))))}var _=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflow:te.V3,checkoutWorkflowStep:re.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,env:Fe.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsBufferDelay:1,wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:$e.PUBLISHED,wcsBufferLimit:1});var $i=Object.freeze({LOCAL:"local",PROD:"prod",STAGE:"stage"});function Vl({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||_.language),t??(t=e?.split("_")?.[1]||_.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function Ui(e={}){let{commerce:t={}}=e,r=Fe.PRODUCTION,n=Gn,i=O("checkoutClientId",t)??_.checkoutClientId,o=Se(O("checkoutWorkflow",t),te,_.checkoutWorkflow),a=re.CHECKOUT;o===te.V3&&(a=Se(O("checkoutWorkflowStep",t),re,_.checkoutWorkflowStep));let s=y(O("displayOldPrice",t),_.displayOldPrice),c=y(O("displayPerUnit",t),_.displayPerUnit),l=y(O("displayRecurrence",t),_.displayRecurrence),h=y(O("displayTax",t),_.displayTax),d=y(O("entitlement",t),_.entitlement),u=y(O("modal",t),_.modal),m=y(O("forceTaxExclusive",t),_.forceTaxExclusive),f=O("promotionCode",t)??_.promotionCode,g=At(O("quantity",t)),L=O("wcsApiKey",t)??_.wcsApiKey,w=t?.env==="stage",b=$e.PUBLISHED;["true",""].includes(t.allowOverride)&&(w=(O(Dn,t,{metadata:!1})?.toLowerCase()??t?.env)==="stage",b=Se(O(Bn,t),$e,b)),w&&(r=Fe.STAGE,n=zn);let k=vt(O("wcsBufferDelay",t),_.wcsBufferDelay),R=vt(O("wcsBufferLimit",t),_.wcsBufferLimit);return{...Vl(e),displayOldPrice:s,checkoutClientId:i,checkoutWorkflow:o,checkoutWorkflowStep:a,displayPerUnit:c,displayRecurrence:l,displayTax:h,entitlement:d,extraOptions:_.extraOptions,modal:u,env:r,forceTaxExclusive:m,promotionCode:f,quantity:g,wcsApiKey:L,wcsBufferDelay:k,wcsBufferLimit:R,wcsURL:n,landscape:b}}var Di={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Ml=Date.now(),Bi=new Set,Gi=new Set,ts=new Map,rs={append({level:e,message:t,params:r,timestamp:n,source:i}){console[e](`${n}ms [${i}] %c${t}`,"font-weight: bold;",...r)}},ns={filter:({level:e})=>e!==Di.DEBUG},Hl={filter:()=>!1};function $l(e,t,r,n,i){return{level:e,message:t,namespace:r,get params(){return n.length===1&&$t(n[0])&&(n=n[0](),Array.isArray(n)||(n=[n])),n},source:i,timestamp:Date.now()-Ml}}function Ul(e){[...Gi].every(t=>t(e))&&Bi.forEach(t=>t(e))}function is(e){let t=(ts.get(e)??0)+1;ts.set(e,t);let r=`${e} #${t}`,n={id:r,namespace:e,module:i=>is(`${n.namespace}/${i}`),updateConfig:Et};return Object.values(Di).forEach(i=>{n[i]=(o,...a)=>Ul($l(i,o,e,a,r))}),Object.seal(n)}function Ur(...e){e.forEach(t=>{let{append:r,filter:n}=t;$t(n)&&Gi.add(n),$t(r)&&Bi.add(r)})}function Dl(e={}){let{name:t}=e,r=y(O("commerce.debug",{search:!0,storage:!0}),t===$i.LOCAL);return Ur(r?rs:ns),t===$i.PROD&&Ur(Hi),X}function Bl(){Bi.clear(),Gi.clear()}var X={...is(Un),Level:Di,Plugins:{consoleAppender:rs,debugFilter:ns,quietFilter:Hl,lanaAppender:Hi},init:Dl,reset:Bl,use:Ur};var Gl={[he]:Nn,[de]:On,[ue]:Rn},zl={[he]:Mn,[de]:Hn,[ue]:$n},St=class{constructor(t){p(this,"changes",new Map);p(this,"connected",!1);p(this,"dispose",gt);p(this,"error");p(this,"log");p(this,"options");p(this,"promises",[]);p(this,"state",de);p(this,"timer",null);p(this,"value");p(this,"version",0);p(this,"wrapperElement");this.wrapperElement=t}update(){[he,de,ue].forEach(t=>{this.wrapperElement.classList.toggle(Gl[t],t===this.state)})}notify(){(this.state===ue||this.state===he)&&(this.state===ue?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===he&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]),this.wrapperElement.dispatchEvent(new CustomEvent(zl[this.state],{bubbles:!0}))}attributeChangedCallback(t,r,n){this.changes.set(t,n),this.requestUpdate()}connectedCallback(){this.dispose=Za(()=>this.requestUpdate(!0))}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement})),this.dispose(),this.dispose=gt}onceSettled(){let{error:t,promises:r,state:n}=this;return ue===n?Promise.resolve(this.wrapperElement):he===n?Promise.reject(t):new Promise((i,o)=>{r.push({resolve:i,reject:o})})}toggleResolved(t,r,n){return t!==this.version?!1:(n!==void 0&&(this.options=n),this.state=ue,this.value=r,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:r}),ye(()=>this.notify()),!0)}toggleFailed(t,r,n){return t!==this.version?!1:(n!==void 0&&(this.options=n),this.error=r,this.state=he,this.update(),this.log?.error("Failed:",{element:this.wrapperElement,error:r}),ye(()=>this.notify()),!0)}togglePending(t){return this.version++,t&&(this.options=t),this.state=de,this.update(),ye(()=>this.notify()),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!q()||this.timer)return;let r=X.module("mas-element"),{error:n,options:i,state:o,value:a,version:s}=this;this.state=de,this.timer=ye(async()=>{this.timer=null;let c=null;if(this.changes.size&&(c=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:c}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:c})),c||t)try{await this.wrapperElement.render?.()===!1&&this.state===de&&this.version===s&&(this.state=o,this.error=n,this.value=a,this.update(),this.notify())}catch(l){r.error("Failed to render mas-element: ",l),this.toggleFailed(this.version,l,i)}})}};function os(e={}){return Object.entries(e).forEach(([t,r])=>{(r==null||r===""||r?.length===0)&&delete e[t]}),e}function Dr(e,t={}){let{tag:r,is:n}=e,i=document.createElement(r,{is:n});return i.setAttribute("is",n),Object.assign(i.dataset,os(t)),i}function Br(e,t={}){return e instanceof HTMLElement?(Object.assign(e.dataset,os(t)),e):null}var Fl="download",Kl="upgrade";function Gr(e,t={},r=""){let n=q();if(!n)return null;let{checkoutMarketSegment:i,checkoutWorkflow:o,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:l,perpetual:h,promotionCode:d,quantity:u,wcsOsi:m,extraOptions:f}=n.collectCheckoutOptions(t),g=Dr(e,{checkoutMarketSegment:i,checkoutWorkflow:o,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:l,perpetual:h,promotionCode:d,quantity:u,wcsOsi:m,extraOptions:f});return r&&(g.innerHTML=`<span style="pointer-events: none;">${r}</span>`),g}function zr(e){return class extends e{constructor(){super(...arguments);p(this,"checkoutActionHandler");p(this,"masElement",new St(this))}attributeChangedCallback(n,i,o){this.masElement.attributeChangedCallback(n,i,o)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}requestUpdate(n=!1){return this.masElement.requestUpdate(n)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(n={}){if(!this.isConnected)return!1;let i=q();if(!i)return!1;this.dataset.imsCountry||i.imsCountryPromise.then(d=>{d&&(this.dataset.imsCountry=d)},gt),n.imsCountry=null;let o=i.collectCheckoutOptions(n,this);if(!o.wcsOsi.length)return!1;let a;try{a=JSON.parse(o.extraOptions??"{}")}catch(d){this.masElement.log?.error("cannot parse exta checkout options",d)}let s=this.masElement.togglePending(o);this.setCheckoutUrl("");let c=i.resolveOfferSelectors(o),l=await Promise.all(c);l=l.map(d=>Xt(d,o)),o.country=this.dataset.imsCountry||o.country;let h=await i.buildCheckoutAction?.(l.flat(),{...a,...o},this);return this.renderOffers(l.flat(),o,{},h,s)}renderOffers(n,i,o={},a=void 0,s=void 0){if(!this.isConnected)return!1;let c=q();if(!c)return!1;if(i={...JSON.parse(this.dataset.extraOptions??"null"),...i,...o},s??(s=this.masElement.togglePending(i)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),a){this.classList.remove(Fl,Kl),this.masElement.toggleResolved(s,n,i);let{url:h,text:d,className:u,handler:m}=a;return h&&this.setCheckoutUrl(h),d&&(this.firstElementChild.innerHTML=d),u&&this.classList.add(...u.split(" ")),m&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=m.bind(this)),!0}else if(n.length){if(this.masElement.toggleResolved(s,n,i)){let h=c.buildCheckoutURL(n,i);return this.setCheckoutUrl(h),!0}}else{let h=new Error(`Not provided: ${i?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,h,i))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(n){}updateOptions(n={}){let i=q();if(!i)return!1;let{checkoutMarketSegment:o,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:h,perpetual:d,promotionCode:u,quantity:m,wcsOsi:f}=i.collectCheckoutOptions(n);return Br(this,{checkoutMarketSegment:o,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:h,perpetual:d,promotionCode:u,quantity:m,wcsOsi:f}),!0}}}var Ye,Wt=class Wt extends zr(HTMLButtonElement){constructor(){super(...arguments);G(this,Ye)}static createCheckoutButton(r={},n=""){return Gr(Wt,r,n)}setCheckoutUrl(r){j(this,Ye,r)}get href(){return T(this,Ye)}get isCheckoutButton(){return!0}clickHandler(r){if(this.checkoutActionHandler){this.checkoutActionHandler?.(r);return}T(this,Ye)&&(window.location.href=T(this,Ye))}};Ye=new WeakMap,p(Wt,"is","checkout-button"),p(Wt,"tag","button");var je=Wt;window.customElements.get(je.is)||window.customElements.define(je.is,je,{extends:je.tag});var jl="#000000",Yl="#F8D904",Xl=/(accent|primary|secondary)(-(outline|link))?/,Wl="mas:product_code/",ql="daa-ll",Fr="daa-lh",Zl=["XL","L","M","S"];function Jl(e,t,r){e.mnemonicIcon?.map((i,o)=>({icon:i,alt:e.mnemonicAlt[o]??"",link:e.mnemonicLink[o]??""}))?.forEach(({icon:i,alt:o,link:a})=>{if(a&&!/^https?:/.test(a))try{a=new URL(`https://${a}`).href.toString()}catch{a="#"}let s={slot:"icons",src:i,size:r?.size??"l"};o&&(s.alt=o),a&&(s.href=a);let c=le("merch-icon",s);t.append(c)})}function Ql(e,t){e.badge&&(t.setAttribute("badge-text",e.badge),t.setAttribute("badge-color",e.badgeColor||jl),t.setAttribute("badge-background-color",e.badgeBackgroundColor||Yl))}function eh(e,t,r){r?.includes(e.size)&&t.setAttribute("size",e.size)}function th(e,t,r){e.cardTitle&&r&&t.append(le(r.tag,{slot:r.slot},e.cardTitle))}function rh(e,t,r){e.subtitle&&r&&t.append(le(r.tag,{slot:r.slot},e.subtitle))}function nh(e,t,r,n){if(e.backgroundImage)switch(n){case"ccd-slice":r&&t.append(le(r.tag,{slot:r.slot},`<img loading="lazy" src="${e.backgroundImage}" />`));break;case"ccd-suggested":t.setAttribute("background-image",e.backgroundImage);break}}function ih(e,t,r){if(e.prices&&r){let n=le(r.tag,{slot:r.slot},e.prices);t.append(n)}}function oh(e,t,r){if(e.description&&r){let n=le(r.tag,{slot:r.slot},e.description);t.append(n)}}function ah(e,t,r,n){let o=customElements.get("checkout-button").createCheckoutButton({},e.innerHTML);o.setAttribute("tabindex",0);for(let h of e.attributes)["class","is"].includes(h.name)||o.setAttribute(h.name,h.value);o.firstElementChild?.classList.add("spectrum-Button-label");let a=t.ctas.size??"M",s=`spectrum-Button--${n}`,c=Zl.includes(a)?`spectrum-Button--size${a}`:"spectrum-Button--sizeM",l=["spectrum-Button",s,c];return r&&l.push("spectrum-Button--outline"),o.classList.add(...l),o}function sh(e,t,r,n){let i="fill";r&&(i="outline");let o=le("sp-button",{treatment:i,variant:n,tabIndex:0,size:t.ctas.size??"m"},e);return o.addEventListener("click",a=>{a.target!==e&&(a.stopPropagation(),e.click())}),o}function ch(e,t){return e.classList.add("con-button"),t&&e.classList.add("blue"),e}function lh(e,t,r,n){if(e.ctas){let{slot:i}=r.ctas,o=le("div",{slot:i},e.ctas),a=[...o.querySelectorAll("a")].map(s=>{let c=s.parentElement.tagName==="STRONG";if(t.consonant)return ch(s,c);let l=Xl.exec(s.className)?.[0]??"accent",h=l.includes("accent"),d=l.includes("primary"),u=l.includes("secondary"),m=l.includes("-outline");if(l.includes("-link"))return s;let g;return h||c?g="accent":d?g="primary":u&&(g="secondary"),t.spectrum==="swc"?sh(s,r,m,g):ah(s,r,m,g)});o.innerHTML="",o.append(...a),t.append(o)}}function hh(e,t){let{tags:r}=e,n=r?.find(i=>i.startsWith(Wl))?.split("/").pop();n&&(t.setAttribute(Fr,n),t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]").forEach((i,o)=>{i.setAttribute(ql,`${i.dataset.analyticsId}-${o+1}`)}))}function dh(e){e.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,r])=>{e.querySelectorAll(`a.${t}`).forEach(n=>{n.classList.remove(t),n.classList.add("spectrum-Link",`spectrum-Link--${r}`)})})}async function as(e,t){let{fields:r}=e,{variant:n}=r;if(!n)return;t.querySelectorAll("[slot]").forEach(o=>{o.remove()}),t.removeAttribute("background-image"),t.removeAttribute("badge-background-color"),t.removeAttribute("badge-color"),t.removeAttribute("badge-text"),t.removeAttribute("size"),t.classList.remove("wide-strip"),t.classList.remove("thin-strip"),t.removeAttribute(Fr),t.variant=n,await t.updateComplete;let{aemFragmentMapping:i}=t.variantLayout;i&&(Jl(r,t,i.mnemonics),Ql(r,t),eh(r,t,i.allowedSizes),th(r,t,i.title),rh(r,t,i.subtitle),ih(r,t,i.prices),nh(r,t,i.backgroundImage,n),oh(r,t,i.description),lh(r,t,i,n),hh(r,t),dh(t))}var uh="merch-card",mh=1e4,Zt,zi,qt=class extends ee{constructor(){super();G(this,Zt);p(this,"customerSegment");p(this,"marketSegment");p(this,"variantLayout");this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this)}firstUpdated(){this.variantLayout=Kn(this,!1),this.variantLayout?.connectedCallbackHook(),this.aemFragment?.updateComplete.catch(()=>{this.style.display="none"})}willUpdate(r){(r.has("variant")||!this.variantLayout)&&(this.variantLayout=Kn(this),this.variantLayout.connectedCallbackHook())}updated(r){(r.has("badgeBackgroundColor")||r.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border",this.computedBorderStyle),this.variantLayout?.postCardUpdateHook(r)}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}get prices(){return Array.from(this.querySelectorAll('span[is="inline-price"][data-wcs-osi]'))}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["twp","ccd-slice","ccd-suggested"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector('span[is="inline-price"]')}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll('a[is="checkout-link"]')??[]]}async toggleStockOffer({target:r}){if(!this.stockOfferOsis)return;let n=this.checkoutLinks;if(n.length!==0)for(let i of n){await i.onceSettled();let o=i.value?.[0]?.planType;if(!o)return;let a=this.stockOfferOsis[o];if(!a)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==a);r.checked&&s.push(a),i.dataset.wcsOsi=s.join(",")}}handleQuantitySelection(r){let n=this.checkoutLinks;for(let i of n)i.dataset.quantity=r.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(r){let n={...this.filters};Object.keys(n).forEach(i=>{if(r){n[i].order=Math.min(n[i].order||2,2);return}let o=n[i].order;o===1||isNaN(o)||(n[i].order=Number(o)+1)}),this.filters=n}includes(r){return this.textContent.match(new RegExp(r,"i"))!==null}connectedCallback(){super.connectedCallback(),this.addEventListener(br,this.handleQuantitySelection),this.addEventListener(wn,this.merchCardReady,{once:!0}),this.updateComplete.then(()=>{this.merchCardReady()}),this.storageOptions?.addEventListener("change",this.handleStorageChange),this.addEventListener(He,this.handleAemFragmentEvents),this.addEventListener(Me,this.handleAemFragmentEvents),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(br,this.handleQuantitySelection),this.storageOptions?.removeEventListener(xr,this.handleStorageChange),this.removeEventListener(He,this.handleAemFragmentEvents),this.removeEventListener(Me,this.handleAemFragmentEvents)}async handleAemFragmentEvents(r){if(r.type===He&&xe(this,Zt,zi).call(this,"AEM fragment cannot be loaded"),r.type===Me&&r.target.nodeName==="AEM-FRAGMENT"){let n=r.detail;await as(n,this),this.checkReady()}}async checkReady(){let r=Promise.all([...this.querySelectorAll('span[is="inline-price"][data-wcs-osi],a[is="checkout-link"][data-wcs-osi]')].map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(a=>a.classList.contains("placeholder-resolved"))),n=new Promise(o=>setTimeout(()=>o(!1),mh));if(await Promise.race([r,n])===!0){this.dispatchEvent(new CustomEvent(In,{bubbles:!0,composed:!0}));return}xe(this,Zt,zi).call(this,"Contains unresolved offers")}get aemFragment(){return this.querySelector("aem-fragment")}get storageOptions(){return this.querySelector("sp-radio-group#storage")}get storageSpecificOfferSelect(){let r=this.storageOptions?.selected;if(r){let n=this.querySelector(`merch-offer-select[storage="${r}"]`);if(n)return n}return this.querySelector("merch-offer-select")}get offerSelect(){return this.storageOptions?this.storageSpecificOfferSelect:this.querySelector("merch-offer-select")}get quantitySelect(){return this.querySelector("merch-quantity-select")}merchCardReady(){this.offerSelect&&!this.offerSelect.planType||this.dispatchEvent(new CustomEvent(Cn,{bubbles:!0}))}handleStorageChange(){let r=this.closest("merch-card")?.offerSelect.cloneNode(!0);r&&this.dispatchEvent(new CustomEvent(xr,{detail:{offerSelect:r},bubbles:!0}))}get dynamicPrice(){return this.querySelector('[slot="price"]')}selectMerchOffer(r){if(r===this.merchOffer)return;this.merchOffer=r;let n=this.dynamicPrice;if(r.price&&n){let i=r.price.cloneNode(!0);n.onceSettled?n.onceSettled().then(()=>{n.replaceWith(i)}):n.replaceWith(i)}}};Zt=new WeakSet,zi=function(r){this.dispatchEvent(new CustomEvent(kn,{detail:r,bubbles:!0,composed:!0}))},p(qt,"properties",{name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:r=>{let[n,i,o]=r.split(",");return{PUF:n,ABM:i,M2M:o}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:r=>Object.fromEntries(r.split(",").map(n=>{let[i,o,a]=n.split(":"),s=Number(o);return[i,{order:isNaN(s)?void 0:s,size:a}]})),toAttribute:r=>Object.entries(r).map(([n,{order:i,size:o}])=>[n,i,o].filter(a=>a!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:Fr,reflect:!0}}),p(qt,"styles",[Vo,Wo(),...Mo()]);customElements.define(uh,qt);var yt=class extends ee{constructor(){super(),this.size="m",this.alt=""}render(){let{href:t}=this;return t?x`<a href="${t}">
    ...
    `);customElements.define("merch-icon",yt);var hs=new CSSStyleSheet;hs.replaceSync(":host { display: contents; }");var ph=document.querySelector('meta[name="aem-base-url"]')?.content??"https://odin.adobe.com",ss="fragment",cs="author",fh="ims",ls=e=>{throw new Error(`Failed to get fragment: ${e}`)};async function gh(e,t,r,n){let i=r?`${e}/adobe/sites/cf/fragments/${t}`:`${e}/adobe/sites/fragments/${t}`,o=await fetch(i,{cache:"default",credentials:"omit",headers:n}).catch(a=>ls(a.message));return o?.ok||ls(`${o.status} ${o.statusText}`),o.json()}var Fi,Te,Ki=class{constructor(){G(this,Te,new Map)}clear(){T(this,Te).clear()}add(...t){t.forEach(r=>{let{id:n}=r;n&&T(this,Te).set(n,r)})}has(t){return T(this,Te).has(t)}get(t){return T(this,Te).get(t)}remove(t){T(this,Te).delete(t)}};Te=new WeakMap;var Kr=new Ki,Xe,me,Le,Jt,pe,Tt,fe,Yi,ds,us,ji=class extends HTMLElement{constructor(){super();G(this,fe);p(this,"cache",Kr);G(this,Xe);G(this,me);G(this,Le);G(this,Jt,!1);G(this,pe);G(this,Tt,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[hs];let r=this.getAttribute(fh);["",!0,"true"].includes(r)&&(j(this,Jt,!0),Fi||(Fi={Authorization:`Bearer ${window.adobeid?.authorize?.()}`}))}static get observedAttributes(){return[ss,cs]}attributeChangedCallback(r,n,i){r===ss&&(j(this,Le,i),this.refresh(!1)),r===cs&&j(this,Tt,["","true"].includes(i))}connectedCallback(){if(!T(this,Le)){xe(this,fe,Yi).call(this,"Missing fragment id");return}}async refresh(r=!0){T(this,pe)&&!await Promise.race([T(this,pe),Promise.resolve(!1)])||(r&&Kr.remove(T(this,Le)),j(this,pe,this.fetchData().then(()=>(this.dispatchEvent(new CustomEvent(Me,{detail:this.data,bubbles:!0,composed:!0})),!0)).catch(n=>(xe(this,fe,Yi).call(this,"Network error: failed to load fragment"),j(this,pe,null),!1))),T(this,pe))}async fetchData(){j(this,Xe,null),j(this,me,null);let r=Kr.get(T(this,Le));r||(r=await gh(ph,T(this,Le),T(this,Tt),T(this,Jt)?Fi:void 0),Kr.add(r)),j(this,Xe,r)}get updateComplete(){return T(this,pe)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return T(this,me)?T(this,me):(T(this,Tt)?xe(this,fe,ds).call(this):xe(this,fe,us).call(this),T(this,me))}};Xe=new WeakMap,me=new WeakMap,Le=new WeakMap,Jt=new WeakMap,pe=new WeakMap,Tt=new WeakMap,fe=new WeakSet,Yi=function(r){this.classList.add("error"),this.dispatchEvent(new CustomEvent(He,{detail:r,bubbles:!0,composed:!0}))},ds=function(){let{id:r,tags:n,fields:i}=T(this,Xe);j(this,me,i.reduce((o,{name:a,multiple:s,values:c})=>(o.fields[a]=s?c:c[0],o),{id:r,tags:n,fields:{}}))},us=function(){let{id:r,tags:n,fields:i}=T(this,Xe);j(this,me,Object.entries(i).reduce((o,[a,s])=>(o.fields[a]=s?.mimeType?s.value:s??"",o),{id:r,tags:n,fields:{}}))};customElements.define("aem-fragment",ji);var Qt=class Qt extends zr(HTMLAnchorElement){static createCheckoutLink(t={},r=""){return Gr(Qt,t,r)}setCheckoutUrl(t){this.setAttribute("href",t)}get isCheckoutLink(){return!0}clickHandler(t){if(this.checkoutActionHandler){this.checkoutActionHandler?.(t);return}}};p(Qt,"is","checkout-link"),p(Qt,"tag","a");var ne=Qt;window.customElements.get(ne.is)||window.customElements.define(ne.is,ne,{extends:ne.tag});function ms({providers:e,settings:t}){function r(o,a){let{checkoutClientId:s,checkoutWorkflow:c,checkoutWorkflowStep:l,country:h,language:d,promotionCode:u,quantity:m}=t,{checkoutMarketSegment:f,checkoutWorkflow:g=c,checkoutWorkflowStep:L=l,imsCountry:w,country:b=w??h,language:S=d,quantity:k=m,entitlement:R,upgrade:V,modal:$,perpetual:oe,promotionCode:We=u,wcsOsi:_e,extraOptions:qe,...J}=Object.assign({},a?.dataset??{},o??{}),ge=Se(g,te,_.checkoutWorkflow),ae=re.CHECKOUT;ge===te.V3&&(ae=Se(L,re,_.checkoutWorkflowStep));let Q=bt({...J,extraOptions:qe,checkoutClientId:s,checkoutMarketSegment:f,country:b,quantity:At(k,_.quantity),checkoutWorkflow:ge,checkoutWorkflowStep:ae,language:S,entitlement:y(R),upgrade:y(V),modal:y($),perpetual:y(oe),promotionCode:Ut(We).effectivePromoCode,wcsOsi:$r(_e)});if(a)for(let we of e.checkout)we(a,Q);return Q}function n(o,a){if(!Array.isArray(o)||!o.length||!a)return"";let{env:s,landscape:c}=t,{checkoutClientId:l,checkoutMarketSegment:h,checkoutWorkflow:d,checkoutWorkflowStep:u,country:m,promotionCode:f,quantity:g,...L}=r(a),w=window.frameElement?"if":"fp",b={checkoutPromoCode:f,clientId:l,context:w,country:m,env:s,items:[],marketSegment:h,workflowStep:u,landscape:c,...L};if(o.length===1){let[{offerId:S,offerType:k,productArrangementCode:R}]=o,{marketSegments:[V]}=o[0];Object.assign(b,{marketSegment:V,offerType:k,productArrangementCode:R}),b.items.push(g[0]===1?{id:S}:{id:S,quantity:g[0]})}else b.items.push(...o.map(({offerId:S},k)=>({id:S,quantity:g[k]??_.quantity})));return qn(d,b)}let{createCheckoutLink:i}=ne;return{CheckoutLink:ne,CheckoutWorkflow:te,CheckoutWorkflowStep:re,buildCheckoutURL:n,collectCheckoutOptions:r,createCheckoutLink:i}}function xh({interval:e=200,maxAttempts:t=25}={}){let r=X.module("ims");return new Promise(n=>{r.debug("Waing for IMS to be ready");let i=0;function o(){window.adobeIMS?.initialized?n():++i>t?(r.debug("Timeout"),n()):setTimeout(o,e)}o()})}function bh(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function vh(e){let t=X.module("ims");return e.then(r=>r?window.adobeIMS.getProfile().then(({countryCode:n})=>(t.debug("Got user country:",n),n),n=>{t.error("Unable to get user country:",n)}):null)}function ps({}){let e=xh(),t=bh(e),r=vh(t);return{imsReadyPromise:e,imsSignedInPromise:t,imsCountryPromise:r}}async function gs(e,t){let{data:r}=t||await Promise.resolve().then(()=>Vs(fs(),1));if(Array.isArray(r)){let n=o=>r.find(a=>Tr(a.lang,o)),i=n(e.language)??n(_.language);if(i)return Object.freeze(i)}return{}}var xs=["GB_en","AU_en","FR_fr","AT_de","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GR_el","GR_en","HU_hu","IE_en","IT_it","LU_de","LU_en","LU_fr","NL_nl","NO_nb","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TR_tr","UA_uk","ID_en","ID_in","IN_en","IN_hi","JP_ja","MY_en","MY_ms","NZ_en","TH_en","TH_th"],Eh={INDIVIDUAL_COM:["ZA_en","LT_lt","LV_lv","NG_en","SA_ar","SA_en","ZA_en","SG_en","KR_ko"],TEAM_COM:["ZA_en","LT_lt","LV_lv","NG_en","ZA_en","CO_es","KR_ko"],INDIVIDUAL_EDU:["LT_lt","LV_lv","SA_en","SG_en"],TEAM_EDU:["SG_en","KR_ko"]},er=class er extends HTMLSpanElement{constructor(){super();p(this,"masElement",new St(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-perpetual","data-promotion-code","data-tax-exclusive","data-template","data-wcs-osi"]}static createInlinePrice(r){let n=q();if(!n)return null;let{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:d,template:u,wcsOsi:m}=n.collectPriceOptions(r);return Dr(er,{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:d,template:u,wcsOsi:m})}get isInlinePrice(){return!0}attributeChangedCallback(r,n,i){this.masElement.attributeChangedCallback(r,n,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}resolveDisplayTaxForGeoAndSegment(r,n,i,o){let a=`${r}_${n}`;if(xs.includes(r)||xs.includes(a))return!0;let s=Eh[`${i}_${o}`];return s?!!(s.includes(r)||s.includes(a)):!1}async resolveDisplayTax(r,n){let[i]=await r.resolveOfferSelectors(n),o=Xt(await i,n);if(o?.length){let{country:a,language:s}=n,c=o[0],[l=""]=c.marketSegments;return this.resolveDisplayTaxForGeoAndSegment(a,s,c.customerSegment,l)}}async render(r={}){if(!this.isConnected)return!1;let n=q();if(!n)return!1;let i=n.collectPriceOptions(r,this);if(!i.wcsOsi.length)return!1;let o=this.masElement.togglePending(i);this.innerHTML="";let[a]=n.resolveOfferSelectors(i);return this.renderOffers(Xt(await a,i),i,o)}renderOffers(r,n={},i=void 0){if(!this.isConnected)return;let o=q();if(!o)return!1;let a=o.collectPriceOptions({...this.dataset,...n},this);if(i??(i=this.masElement.togglePending(a)),r.length){if(this.masElement.toggleResolved(i,r,a))return this.innerHTML=o.buildPriceHTML(r,a),!0}else{let s=new Error(`Not provided: ${a?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,s,a))return this.innerHTML="",!0}return!1}updateOptions(r){let n=q();if(!n)return!1;let{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:d,template:u,wcsOsi:m}=n.collectPriceOptions(r);return Br(this,{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:l,promotionCode:h,quantity:d,template:u,wcsOsi:m}),!0}};p(er,"is","inline-price"),p(er,"tag","span");var ie=er;window.customElements.get(ie.is)||window.customElements.define(ie.is,ie,{extends:ie.tag});function bs({literals:e,providers:t,settings:r}){function n(a,s){let{country:c,displayOldPrice:l,displayPerUnit:h,displayRecurrence:d,displayTax:u,forceTaxExclusive:m,language:f,promotionCode:g,quantity:L}=r,{displayOldPrice:w=l,displayPerUnit:b=h,displayRecurrence:S=d,displayTax:k=u,forceTaxExclusive:R=m,country:V=c,language:$=f,perpetual:oe,promotionCode:We=g,quantity:_e=L,template:qe,wcsOsi:J,...ge}=Object.assign({},s?.dataset??{},a??{}),ae=bt({...ge,country:V,displayOldPrice:y(w),displayPerUnit:y(b),displayRecurrence:y(S),displayTax:y(k),forceTaxExclusive:y(R),language:$,perpetual:y(oe),promotionCode:Ut(We).effectivePromoCode,quantity:At(_e,_.quantity),template:qe,wcsOsi:$r(J)});if(s)for(let Q of t.price)Q(s,ae);return ae}function i(a,s){if(!Array.isArray(a)||!a.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=Oi;break;case"strikethrough":l=Pi;break;case"optical":l=Ci;break;case"annual":l=Ii;break;default:s.country==="AU"&&a[0].planType==="ABM"?l=s.promotionCode?Ni:ki:l=s.promotionCode?wi:_i}let h=n(s);h.literals=Object.assign({},e.price,bt(s.literals??{}));let[d]=a;return d={...d,...d.priceDetails},l(h,d)}let o=ie.createInlinePrice;return{InlinePrice:ie,buildPriceHTML:i,collectPriceOptions:n,createInlinePrice:o}}function vs({settings:e}){let t=X.module("wcs"),{env:r,wcsApiKey:n}=e,i=new Map,o=new Map,a;async function s(d,u,m=!0){let f=Vn;t.debug("Fetching:",d);let g="",L,w=(b,S,k)=>`${b}: ${S?.status}, url: ${k.toString()}`;try{if(d.offerSelectorIds=d.offerSelectorIds.sort(),g=new URL(e.wcsURL),g.searchParams.set("offer_selector_ids",d.offerSelectorIds.join(",")),g.searchParams.set("country",d.country),g.searchParams.set("locale",d.locale),g.searchParams.set("landscape",r===Fe.STAGE?"ALL":e.landscape),g.searchParams.set("api_key",n),d.language&&g.searchParams.set("language",d.language),d.promotionCode&&g.searchParams.set("promotion_code",d.promotionCode),d.currency&&g.searchParams.set("currency",d.currency),L=await fetch(g.toString(),{credentials:"omit"}),L.ok){let b=await L.json();t.debug("Fetched:",d,b);let S=b.resolvedOffers??[];S=S.map(wr),u.forEach(({resolve:k},R)=>{let V=S.filter(({offerSelectorIds:$})=>$.includes(R)).flat();V.length&&(u.delete(R),k(V))})}else L.status===404&&d.offerSelectorIds.length>1?(t.debug("Multi-osi 404, fallback to fetch-by-one strategy"),await Promise.allSettled(d.offerSelectorIds.map(b=>s({...d,offerSelectorIds:[b]},u,!1)))):f=vr}catch(b){f=vr,t.error(f,d,b)}m&&u.size&&(t.debug("Missing:",{offerSelectorIds:[...u.keys()]}),u.forEach(b=>{b.reject(new Error(w(f,L,g)))}))}function c(){clearTimeout(a);let d=[...o.values()];o.clear(),d.forEach(({options:u,promises:m})=>s(u,m))}function l(){let d=i.size;i.clear(),t.debug(`Flushed ${d} cache entries`)}function h({country:d,language:u,perpetual:m=!1,promotionCode:f="",wcsOsi:g=[]}){let L=`${u}_${d}`;d!=="GB"&&(u=m?"EN":"MULT");let w=[d,u,f].filter(b=>b).join("-").toLowerCase();return g.map(b=>{let S=`${b}-${w}`;if(!i.has(S)){let k=new Promise((R,V)=>{let $=o.get(w);if(!$){let oe={country:d,locale:L,offerSelectorIds:[]};d!=="GB"&&(oe.language=u),$={options:oe,promises:new Map},o.set(w,$)}f&&($.options.promotionCode=f),$.options.offerSelectorIds.push(b),$.promises.set(b,{resolve:R,reject:V}),$.options.offerSelectorIds.length>=e.wcsBufferLimit?c():(t.debug("Queued:",$.options),a||(a=setTimeout(c,e.wcsBufferDelay)))});i.set(S,k)}return i.get(S)})}return{WcsCommitment:Ri,WcsPlanType:Vi,WcsTerm:Mi,resolveOfferSelectors:h,flushWcsCache:l}}var Xi="mas-commerce-service",Yr,As,jr=class extends HTMLElement{constructor(){super(...arguments);G(this,Yr);p(this,"promise",null)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(n,i,o)=>{let a=await r?.(n,i,this.imsSignedInPromise,o);return a||null})}async activate(){let r=T(this,Yr,As),n=Object.freeze(Ui(r));Et(r.lana);let i=X.init(r.hostEnv).module("service");i.debug("Activating:",r);let o={price:{}};try{o.price=await gs(n,r.commerce.priceLiterals)}catch{}let a={checkout:new Set,price:new Set},s={literals:o,providers:a,settings:n};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...ms(s),...ps(s),...bs(s),...vs(s),...Fn,Log:X,get defaults(){return _},get log(){return X},get providers(){return{checkout(c){return a.checkout.add(c),()=>a.checkout.delete(c)},price(c){return a.price.add(c),()=>a.price.delete(c)}}},get settings(){return n}})),i.debug("Activated:",{literals:o,settings:n}),ye(()=>{let c=new CustomEvent(ot,{bubbles:!0,cancelable:!1,detail:this});this.dispatchEvent(c)})}connectedCallback(){this.readyPromise||(this.readyPromise=this.activate())}disconnectedCallback(){this.readyPromise=null}flushWcsCache(){this.flushWcsCache(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCache(),document.querySelectorAll('span[is="inline-price"],a[is="checkout-link"]').forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers")}refreshFragments(){this.flushWcsCache(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh()),this.log.debug("Refreshed AEM fragments")}};Yr=new WeakSet,As=function(){let r={hostEnv:{name:this.getAttribute("host-env")??"prod"},commerce:{env:this.getAttribute("env")},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate"),10),isProdDomain:this.getAttribute("host-env")==="prod"}};return["locale","country","language"].forEach(n=>{let i=this.getAttribute(n);i&&(r[n]=i)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(n=>{let i=this.getAttribute(n);if(i!=null){let o=n.replace(/-([a-z])/g,a=>a[1].toUpperCase());r.commerce[o]=i}}),r},p(jr,"instance");window.customElements.get(Xi)||window.customElements.define(Xi,jr);Et({sampleRate:1});export{je as CheckoutButton,ne as CheckoutLink,te as CheckoutWorkflow,re as CheckoutWorkflowStep,_ as Defaults,ie as InlinePrice,$e as Landscape,X as Log,Xi as TAG_NAME_SERVICE,Ri as WcsCommitment,Vi as WcsPlanType,Mi as WcsTerm,wr as applyPlanType,Ui as getSettings};
