...
`;var Tc={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},Bt=class extends N{constructor(t){super(t)}getGlobalCSS(){return Sc}get headingSelector(){return'[slot="detail-m"]'}renderLayout(){return x`${this.cardImage}
    ...
    `);var _i=new Map,Y=(e,t,r=null,n=null)=>{_i.set(e,{class:t,fragmentMapping:r,style:n})};Y("catalog",Ht,gc,Ht.variantStyle);Y("image",Rn);Y("inline-heading",On);Y("mini-compare-chart",Ut,null,Ut.variantStyle);Y("plans",be,Mn,be.variantStyle);Y("plans-students",be,wc,be.variantStyle);Y("plans-education",be,Ec,be.variantStyle);Y("product",ct,null,ct.variantStyle);Y("segment",Dt,null,Dt.variantStyle);Y("special-offers",Bt,Tc,Bt.variantStyle);var Si=(e,t=!1)=>{let r=_i.get(e.variant);if(!r)return t?void 0:new ct(e);let{class:n,style:o}=r;if(o)try{let i=new CSSStyleSheet;i.replaceSync(o.cssText),e.shadowRoot.adoptedStyleSheets.push(i)}catch{let a=document.createElement("style");a.textContent=o.cssText,e.shadowRoot.appendChild(a)}return new n(e)};function Ln(e){return _i.get(e)?.fragmentMapping}var Cc=document.createElement("style");Cc.innerHTML=`
:root {
