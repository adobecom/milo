...
function caasCss() {
    loadStyle('https://www.adobe.com/special/chimera/latest/dist/dexter/app.min.css', loadReact);
}
...
export default function init(a) {
    ...
    const cardStyle = url.searchParams.get('cs');
    const containerSize = url.searchParams.get('c');
    const filter = url.searchParams.get('f');
    const pagination = url.searchParams.get('p');
    const pagniationMethod = url.searchParams.get('pt');
