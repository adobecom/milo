const getConfig = (state) => {
    const originSelection = Array.isArray(state.source)
        ? state.source.join(',')
        : state.source;
    ...
    const config = {
        ...
        sort: {
            ...
            options: [{"label":"AAA","sort":"dateAsc"},{"label":"BBB","sort":"dateAsc"}]
        },
        pagination: {
